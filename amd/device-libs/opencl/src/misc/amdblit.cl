...
__amd_streamOpsDecrement(
    ...
    if (ptrUint) {
      atomic_fetch_sub_explicit (ptrUint, value,  memory_order_relaxed, memory_scope_all_svm_devices);
    } else {
      atomic_fetch_sub_explicit  (ptrUlong, value,  memory_order_relaxed, memory_scope_all_svm_devices);
    }
}
