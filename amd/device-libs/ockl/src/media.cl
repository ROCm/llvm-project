...
#define LERP_CATTR __attribute__((const, target("lerp-inst")))
#define QSAD_CATTR __attribute__((const, target("qsad-insts")))
#define SAD_CATTR __attribute__((const, target("sad-insts")))
