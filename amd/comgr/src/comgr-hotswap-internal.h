...
/// Record an immediate write to PatchContext::Text. Production patch dispatch
/// calls this after every successful per-instruction mutation; tests and any
/// future direct writers must do the same.
