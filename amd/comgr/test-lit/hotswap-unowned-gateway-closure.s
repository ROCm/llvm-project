// COM: A pass-one far rewrite may place an exact materialized set-PC gateway
// COM: in certified NOP padding immediately after a sized function. The
// COM: gateway has no function owner, but its direct-branch entry, terminal
// COM: predecessor, exact instruction shape, and executable-pool destination
// COM: make it as statically known as an ordinary direct branch. Recognizing
...
// SECOND: recognized materialized PC transfer [0x28, 0x38) -> 0x{{[0-9A-F]+}}
// SECOND-NOT: incomplete control-flow targets
...
// INTERIOR-NOT: recognized materialized PC transfer [0x28, 0x38)
...
// Exactly one 20-byte generated gateway reservation. It is unowned .text
// padding immediately after a sized, no-fallthrough function.
.rept 5
  s_nop 0
.endr
