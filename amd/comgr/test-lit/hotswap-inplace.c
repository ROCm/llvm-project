...
// RUN: printf '.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"\n.text\n.globl
// test_noop_kernel\n.p2align 8\n.type
// test_noop_kernel,@function\ntest_noop_kernel:\n  global_load_b32 v0, v[2:3],
// off\n  s_wait_loadcnt 0x0\n  s_endpgm\n.Ltest_noop_kernel_end:\n.size
// test_noop_kernel, .Ltest_noop_kernel_end-test_noop_kernel\n.rodata\n.p2align
...
// RUN: printf '.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"\n.text\n.globl
// test_b64_kernel\n.p2align 8\n.type
// test_b64_kernel,@function\ntest_b64_kernel:\n  cluster_load_b64 v[0:1],
// v[2:3], off\n  s_wait_loadcnt 0x0\n  s_endpgm\n.Ltest_b64_kernel_end:\n.size
// test_b64_kernel, .Ltest_b64_kernel_end-test_b64_kernel\n.rodata\n.p2align
