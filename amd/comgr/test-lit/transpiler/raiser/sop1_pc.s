...
setpc_kernel:
; SETPC: unsupported-instruction-form: s_set_pc_i64 {{.+}} :: reads s[10:11], which no path reaching its block writes
...
; SWAPPC: unsupported-instruction-form: s_swap_pc_i64 {{.+}} :: reads s[10:11], which no path reaching its block writes
