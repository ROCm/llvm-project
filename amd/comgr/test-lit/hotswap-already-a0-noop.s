...
// ENTRY-SYM: FUNC {{.*}} already_a0.stub

// COM: Entry-only pools are stepping-neutral. A later B0-to-A0 request must
// COM: validate that neutral provenance before taking the A0 metadata fast path
// COM: and return the object unchanged.
