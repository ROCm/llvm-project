...
// COM: after its source edge is installed. That text is still inside a known
// COM: descriptor-backed kernel, so a uniform VMEM clause there must survive
// COM: both the first rewrite and the idempotency rewrite.
