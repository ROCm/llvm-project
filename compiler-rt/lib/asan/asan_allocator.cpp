...
// Quarantine deliberately keeps the ROCr block mapped so that use-after-free
// stays detectable, so a freed device allocation is still live memory as far
// as ROCr is concerned.
