...
// FIXME: Temporarily disabled after reverting upstream "[clang] remove lots of \"innocuous\" addrspacecasts" (#197745).
// FIXME: Re-enable after regenerating AMD-specific CHECK lines against the restored IR.
// UNSUPPORTED: target={{.*}}
