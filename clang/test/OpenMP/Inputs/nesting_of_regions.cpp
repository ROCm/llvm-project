...
#pragma omp target teams distribute parallel for
  for (int i = 0; i < 10; ++i) {
#pragma omp scan // omp45-error {{region cannot be closely nested inside 'target teams distribute parallel for' region}} omp50-error {{region cannot be closely nested inside 'target teams distribute parallel for' region}} omp51-error {{region cannot be closely nested inside 'target teams distribute parallel for' region}}
    bar();
  }
#pragma omp target teams distribute parallel for
  for (int i = 0; i < 10; ++i) {
