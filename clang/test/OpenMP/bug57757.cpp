...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4, !tbaa [[INT_TBAA17:![0-9]+]], !alias.scope [[META14]], !noalias [[META18:![0-9]+]]
...
// CHECK-NEXT:    store i32 1, ptr [[TMP2]], align 4, !tbaa [[INT_TBAA17]], !alias.scope [[META14]], !noalias [[META18]]
// CHECK-NEXT:    [[TMP4:%.*]] = tail call i32 @__kmpc_omp_task(ptr nonnull @[[GLOB1]], i32 [[TMP0]], ptr nonnull [[TMP1]]), !noalias [[META14]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP5]], align 8, !tbaa [[ANYPTR_TBAA20:![0-9]+]], !noalias [[META14]]
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP7]], align 8, !tbaa [[INT_TBAA17]], !noalias [[META14]]
// CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[TMP6]], align 4, !tbaa [[FLOAT_TBAA21:![0-9]+]], !noalias [[META14]]
// CHECK-NEXT:    tail call void [[TMP8]](i32 noundef [[TMP9]], float noundef [[TMP10]]) #[[ATTR2:[0-9]+]], !noalias [[META14]], !inline_history [[META22:![0-9]+]]
// CHECK-NEXT:    br [[DOTOMP_OUTLINED__EXIT]]
...
// CHECK: [[INT_TBAA17]] = !{[[META4]], [[META4]], i64 0}
// CHECK: [[META18]] = !{[[META19:![0-9]+]]}
// CHECK: [[META19]] = distinct !{[[META19]], [[META16]], !".omp_outlined.: %.privates."}
// CHECK: [[ANYPTR_TBAA20]] = !{[[META10]], [[META10]], i64 0}
// CHECK: [[FLOAT_TBAA21]] = !{[[META12]], [[META12]], i64 0}
// CHECK: [[META22]] = distinct !{null}
//.
