...
func.func @_QPfoo() {
  ...
  // CHECK: omp.target
  omp.target kernel_type(spmd) host_eval(%c1_3 -> %arg0, %c10 -> %arg1 : i32, i32) map_entries(%map_info -> %arg2 : !fir.ref<!fir.array<1xi32>>)  {
    %c1_2 = arith.constant 1 : index
    %21 = fir.shape %c1_2 : (index) -> !fir.shape<1>

    // CHECK: %[[TARGET_DECL:.*]] = fir.declare
    %target_decl:2 = hlfir.declare %arg2(%21) {uniq_name = "_QFfooEarr"} : (!fir.ref<!fir.array<1xi32>>, !fir.shape<1>) -> (!fir.ref<!fir.array<1xi32>>, !fir.ref<!fir.array<1xi32>>)
    ...
    omp.teams {
      ...
      omp.parallel {
        ...
        omp.distribute {
          ...
          omp.wsloop {
            // CHECK: omp.loop_nest
            omp.loop_nest (%arg3) : i32 = (%arg0) to (%arg1) inclusive step (%arg0) {
