...
!CHECK: @.offload_sizes{{.*}} = private unnamed_addr constant  [4 x i64] [i64 0, i64 24, i64 0, i64 0]
!CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [4 x i64] [i64 32, i64 281474976727557, i64 515, i64 32768]
...
!CHECK: @.offload_sizes{{.*}} = private unnamed_addr constant [4 x i64] [i64 0, i64 24, i64 0, i64 0]
!CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [4 x i64] [i64 32, i64 281474976727045, i64 3, i64 32768]
...
!CHECK: @.offload_sizes{{.*}} = private unnamed_addr constant [8 x i64] [i64 0, i64 40, i64 0, i64 48, i64 0, i64 4, i64 0, i64 0]
!CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [8 x i64] [i64 32, i64 281474976727045, i64 0, i64 281474976727045, i64 3, i64 281474976710659, i64 32768, i64 32768]
...
!CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [7 x i64] [i64 32, i64 281474976727045, i64 0, i64 281474976727045, i64 3, i64 32768, i64 32768]
