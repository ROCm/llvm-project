...
//
// When the option --inline-allocatable-expr-assign is enabled, this pass also
// handles allocatable assignments where the RHS is an hlfir.expr (e.g., from
// an hlfir.elemental operation). Since hlfir.expr values cannot alias with
// memory locations, these assignments can be safely inlined without needing
// alias analysis. The generated code handles allocation/reallocation of the
// LHS allocatable as needed.
//===----------------------------------------------------------------------===//
