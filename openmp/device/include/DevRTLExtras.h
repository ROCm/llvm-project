...
//===----------------------------------------------------------------------===//
//
// Additional OpenMP type definitions, in conjunction with DeviceTypes.h.
//
//===----------------------------------------------------------------------===//
...
namespace ompx {
namespace allocator_api {

inline constexpr uint64_t AlignedAllocMagic = 0x4f4d50414c49474eULL;
