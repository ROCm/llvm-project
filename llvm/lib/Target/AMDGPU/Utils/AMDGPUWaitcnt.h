...
#ifndef LLVM_LIB_TARGET_AMDGPU_UTILS_AMDGPUWAITCNT_H
#define LLVM_LIB_TARGET_AMDGPU_UTILS_AMDGPUWAITCNT_H
...
#endif // LLVM_LIB_TARGET_AMDGPU_UTILS_AMDGPUWAITCNT_H
