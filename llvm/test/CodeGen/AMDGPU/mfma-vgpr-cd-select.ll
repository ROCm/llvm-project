...
; RUN: llc -mtriple=amdgpu9.42 < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.42 < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
