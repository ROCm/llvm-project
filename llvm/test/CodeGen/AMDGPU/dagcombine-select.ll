...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX942 %s
