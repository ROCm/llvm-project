...
;RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefix=GFX12
;RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel=0 -mtriple=amdgcn -mcpu=gfx1310 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefix=GFX13
;RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel=1 -mtriple=amdgcn -mcpu=gfx1310 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefix=GFX13
