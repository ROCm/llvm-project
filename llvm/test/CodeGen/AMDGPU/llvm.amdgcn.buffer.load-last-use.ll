...
;RUN: llc -amdgpu-late-wave-transform=1 < %s -global-isel=1 -mtriple=amdgpu12.00 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefix=GFX12
...
;RUN: llc -amdgpu-late-wave-transform=1 < %s -global-isel=1 -mtriple=amdgpu13.10 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefix=GFX13
