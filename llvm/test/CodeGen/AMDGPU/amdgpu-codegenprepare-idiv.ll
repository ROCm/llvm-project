...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_u32 s5, s4, 0x30008
...
; GFX6-NEXT:    v_mad_f32 v1, -v2, v3, v1
; GFX6-NEXT:    v_cvt_u32_f32_e32 v2, v2
...
; GFX9-NEXT:    v_sub_u32_e32 v5, s9, v1
; GFX9-NEXT:    v_mov_b32_e32 v3, 0
; GFX9-NEXT:    v_sub_u32_e32 v0, s3, v2
...
; GFX6-NEXT:    s_mul_i32 s17, s11, s14
...
; GFX6-NEXT:    s_mul_i32 s15, s11, s5
; GFX6-NEXT:    v_readfirstlane_b32 s17, v2
...
; GFX6-NEXT:    s_add_u32 s4, s15, s4
; GFX6-NEXT:    s_addc_u32 s4, s16, s14
; GFX6-NEXT:    v_readfirstlane_b32 s14, v1
; GFX6-NEXT:    s_addc_u32 s14, s14, 0
; GFX6-NEXT:    s_mul_i32 s5, s10, s5
...
; GFX9-NEXT:    s_mul_hi_u32 s16, s10, s13
; GFX9-NEXT:    s_addc_u32 s12, s12, s17
...
; GFX6-NEXT:    s_mul_i32 s16, s4, s13
; GFX6-NEXT:    s_mul_i32 s5, s5, s12
; GFX6-NEXT:    v_readfirstlane_b32 s17, v0
; GFX6-NEXT:    s_add_i32 s16, s17, s16
; GFX6-NEXT:    s_mul_i32 s4, s4, s12
; GFX6-NEXT:    s_add_i32 s5, s16, s5
; GFX6-NEXT:    v_mov_b32_e32 v2, s4
; GFX6-NEXT:    v_mov_b32_e32 v0, s5
; GFX6-NEXT:    v_mul_hi_u32 v3, s13, v2
; GFX6-NEXT:    v_mul_hi_u32 v2, s12, v2
; GFX6-NEXT:    v_mul_hi_u32 v1, s13, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s12, v0
; GFX6-NEXT:    s_mul_i32 s17, s12, s5
; GFX6-NEXT:    v_readfirstlane_b32 s19, v2
; GFX6-NEXT:    s_add_u32 s17, s19, s17
; GFX6-NEXT:    v_readfirstlane_b32 s18, v0
...
; GFX6-NEXT:    s_addc_u32 s18, 0, s18
; GFX6-NEXT:    v_readfirstlane_b32 s16, v3
; GFX6-NEXT:    s_add_u32 s4, s17, s4
; GFX6-NEXT:    s_addc_u32 s4, s18, s16
; GFX6-NEXT:    v_readfirstlane_b32 s16, v1
; GFX6-NEXT:    s_addc_u32 s16, s16, 0
; GFX6-NEXT:    s_mul_i32 s5, s13, s5
; GFX6-NEXT:    s_add_u32 s4, s4, s5
...
; GFX9-NEXT:    s_mul_hi_u32 s21, s14, s19
...
; GFX9-NEXT:    s_addc_u32 s18, s20, 0
...
; GFX6-NEXT:    s_mul_i32 s15, s9, s12
...
; GFX6-NEXT:    s_add_u32 s4, s13, s4
; GFX6-NEXT:    s_addc_u32 s4, s14, s12
; GFX6-NEXT:    v_readfirstlane_b32 s12, v1
; GFX6-NEXT:    s_addc_u32 s12, s12, 0
; GFX6-NEXT:    s_mul_i32 s5, s8, s5
; GFX6-NEXT:    s_add_u32 s4, s4, s5
...
; GFX9-NEXT:    s_addc_u32 s10, s10, s15
; GFX9-NEXT:    s_addc_u32 s12, s14, 0
...
; GFX6-NEXT:    v_mov_b32_e32 v2, s4
; GFX6-NEXT:    v_mov_b32_e32 v0, s5
; GFX6-NEXT:    v_mul_hi_u32 v3, s9, v2
; GFX6-NEXT:    v_mul_hi_u32 v2, s8, v2
; GFX6-NEXT:    v_mul_hi_u32 v1, s9, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s8, v0
; GFX6-NEXT:    s_mul_i32 s13, s8, s5
; GFX6-NEXT:    v_readfirstlane_b32 s17, v2
...
; GFX6-NEXT:    v_readfirstlane_b32 s12, v3
; GFX6-NEXT:    s_add_u32 s4, s13, s4
; GFX6-NEXT:    s_addc_u32 s4, s16, s12
; GFX6-NEXT:    v_readfirstlane_b32 s12, v1
; GFX6-NEXT:    s_addc_u32 s12, s12, 0
; GFX6-NEXT:    s_mul_i32 s5, s9, s5
; GFX6-NEXT:    s_add_u32 s4, s4, s5
; GFX6-NEXT:    s_addc_u32 s5, 0, s12
...
; GFX9-NEXT:    s_add_u32 s16, s18, s16
; GFX9-NEXT:    s_addc_u32 s15, 0, s15
; GFX9-NEXT:    s_mul_hi_u32 s19, s12, s17
; GFX9-NEXT:    s_mul_i32 s17, s12, s17
; GFX9-NEXT:    s_add_u32 s16, s16, s17
; GFX9-NEXT:    s_mul_hi_u32 s18, s12, s14
