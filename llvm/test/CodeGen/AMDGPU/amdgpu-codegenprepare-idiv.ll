...
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, 1, v5
; GFX6-NEXT:    s_cmp_ge_u32 s0, s15
; GFX6-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX6-NEXT:    s_cselect_b32 s0, s1, s0
; GFX6-NEXT:    v_cndmask_b32_e32 v4, v5, v2, vcc
...
; GFX6-NEXT:    v_mad_f32 v6, -v3, v0, v1
...
; GFX6-NEXT:    v_cvt_u32_f32_e32 v9, v1
; GFX6-NEXT:    v_cvt_f32_u32_e32 v1, s4
; GFX6-NEXT:    s_lshr_b32 s4, s9, 16
; GFX6-NEXT:    v_cvt_f32_u32_e32 v10, s4
; GFX6-NEXT:    v_rcp_f32_e32 v8, v5
; GFX6-NEXT:    v_rcp_f32_e32 v11, v1
; GFX6-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GFX6-NEXT:    v_mul_f32_e32 v8, v7, v8
; GFX6-NEXT:    v_mul_f32_e32 v11, v10, v11
; GFX6-NEXT:    v_trunc_f32_e32 v11, v11
; GFX6-NEXT:    v_cvt_u32_f32_e32 v12, v11
; GFX6-NEXT:    v_trunc_f32_e32 v8, v8
; GFX6-NEXT:    v_mad_f32 v7, -v8, v5, v7
; GFX6-NEXT:    v_cvt_u32_f32_e32 v8, v8
; GFX6-NEXT:    v_mad_f32 v10, -v11, v1, v10
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v10|, v1
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v12, vcc
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v7|, v5
; GFX6-NEXT:    v_addc_u32_e32 v5, vcc, 0, v8, vcc
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v4|, v2
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, 0, v9, vcc
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v6|, v0
; GFX6-NEXT:    v_addc_u32_e32 v0, vcc, 0, v3, vcc
...
; GFX6-NEXT:    v_rcp_f32_e32 v7, v3
; GFX6-NEXT:    v_trunc_f32_e32 v1, v1
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, s8, v0
; GFX6-NEXT:    v_mad_f32 v2, -v1, v4, v2
; GFX6-NEXT:    v_cvt_u32_f32_e32 v1, v1
...
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    v_mad_f32 v2, -v2, v3, v6
...
; GFX6-NEXT:    v_trunc_f32_e32 v8, v8
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v4|, v2
; GFX6-NEXT:    v_mad_f32 v7, -v8, v6, v7
; GFX6-NEXT:    v_cvt_u32_f32_e32 v8, v8
...
; GFX6-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX6-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v8, vcc
; GFX6-NEXT:    v_or_b32_e32 v0, v0, v2
...
; GFX9-NEXT:    v_mad_f32 v8, -v9, v7, v8
; GFX9-NEXT:    v_cvt_u32_f32_e32 v9, v9
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v4, vcc
; GFX9-NEXT:    v_cmp_ge_f32_e64 vcc, |v5|, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v6, vcc
; GFX9-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX9-NEXT:    v_cmp_ge_f32_e64 vcc, |v8|, v7
; GFX9-NEXT:    v_lshl_or_b32 v1, v2, 16, v1
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v9, vcc
...
; GFX6-NEXT:    s_and_b32 s9, s10, 0x7fff
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s9
; GFX6-NEXT:    v_rcp_f32_e32 v1, v2
...
; GFX6-NEXT:    v_mad_f32 v6, -v1, v2, v0
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s5
; GFX6-NEXT:    v_cvt_u32_f32_e32 v7, v1
; GFX6-NEXT:    v_mul_f32_e32 v1, v4, v5
; GFX6-NEXT:    v_cvt_f32_u32_e32 v5, s8
; GFX6-NEXT:    v_rcp_f32_e32 v8, v0
; GFX6-NEXT:    v_trunc_f32_e32 v1, v1
; GFX6-NEXT:    v_mad_f32 v4, -v1, v3, v4
; GFX6-NEXT:    v_cvt_u32_f32_e32 v9, v1
; GFX6-NEXT:    v_mul_f32_e32 v1, v5, v8
; GFX6-NEXT:    v_trunc_f32_e32 v1, v1
; GFX6-NEXT:    v_cvt_u32_f32_e32 v8, v1
; GFX6-NEXT:    v_mad_f32 v1, -v1, v0, v5
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v1|, v0
; GFX6-NEXT:    v_addc_u32_e32 v0, vcc, 0, v8, vcc
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v6|, v2
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, 0, v7, vcc
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v4|, v3
; GFX6-NEXT:    v_addc_u32_e32 v3, vcc, 0, v9, vcc
...
; GFX9-NEXT:    v_rcp_f32_e32 v6, v4
; GFX9-NEXT:    v_mad_f32 v7, -v1, v3, v0
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX9-NEXT:    s_and_b32 s4, s4, 0x7fff
; GFX9-NEXT:    v_cvt_u32_f32_e32 v8, v1
; GFX9-NEXT:    v_mul_f32_e32 v1, v5, v6
; GFX9-NEXT:    v_cvt_f32_u32_e32 v6, s4
; GFX9-NEXT:    v_rcp_f32_e32 v9, v0
; GFX9-NEXT:    v_trunc_f32_e32 v1, v1
; GFX9-NEXT:    v_mad_f32 v5, -v1, v4, v5
; GFX9-NEXT:    v_cvt_u32_f32_e32 v10, v1
; GFX9-NEXT:    v_mul_f32_e32 v1, v6, v9
; GFX9-NEXT:    v_trunc_f32_e32 v1, v1
; GFX9-NEXT:    v_cvt_u32_f32_e32 v9, v1
; GFX9-NEXT:    v_mad_f32 v1, -v1, v0, v6
; GFX9-NEXT:    v_cmp_ge_f32_e64 vcc, |v1|, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, 0, v9, vcc
; GFX9-NEXT:    v_cmp_ge_f32_e64 vcc, |v7|, v3
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    v_mul_hi_u32 v3, v2, v3
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v2, v3
...
; GFX6-NEXT:    s_mul_i32 s2, s3, 0x38f83e5
...
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mul_hi_u32 v3, s11, v2
...
; GFX6-NEXT:    s_mul_i32 s8, s11, 0x100100
...
; GFX6-NEXT:    v_subb_u32_e32 v1, vcc, v4, v2, vcc
...
; GFX6-NEXT:    v_mul_hi_u32 v2, s2, v2
...
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    s_mul_i32 s10, s3, 0xe3e10011
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GFX6-NEXT:    v_addc_u32_e64 v2, s[8:9], 0, 0, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, s10, v1
...
; GFX6-NEXT:    v_mul_hi_u32 v3, s7, v2
; GFX6-NEXT:    v_mul_hi_u32 v2, s6, v2
; GFX6-NEXT:    s_mul_i32 s8, s6, 0x6ca94220
; GFX6-NEXT:    s_mul_i32 s6, s6, 0xfd81e19
...
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    s_mul_i32 s7, s7, 0x6ca94220
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GFX6-NEXT:    v_addc_u32_e64 v3, s[4:5], 0, 0, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, s7, v1
...
; GFX6-NEXT:    s_mul_i32 s12, s8, 0x80080080
; GFX6-NEXT:    s_mul_i32 s8, s8, 0x8008009
; GFX6-NEXT:    v_mul_hi_u32 v1, s10, v0
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s12, v2
; GFX6-NEXT:    s_mul_i32 s7, s11, 0x8008009
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s8, v2
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, s7, v4
; GFX6-NEXT:    s_mul_i32 s6, s10, 0x80080080
; GFX6-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GFX6-NEXT:    v_mul_hi_u32 v0, s11, v0
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, s6, v4
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    s_mul_i32 s9, s11, 0x80080080
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
...
; GFX6-NEXT:    v_subrev_i32_e32 v3, vcc, s10, v5
; GFX6-NEXT:    v_subb_u32_e32 v2, vcc, v2, v6, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v1, v3
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, v0, v2, vcc
; GFX6-NEXT:    v_mov_b32_e32 v7, s11
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s10, v1
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, v2, v7, vcc
...
; GFX6-NEXT:    v_mul_hi_u32 v4, s6, v2
; GFX6-NEXT:    v_mul_hi_u32 v2, s8, v2
; GFX6-NEXT:    s_mul_i32 s9, s8, 0x6ca94220
; GFX6-NEXT:    s_mul_i32 s11, s8, 0xfd81e19
; GFX6-NEXT:    s_mov_b32 s0, s4
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s9, v2
; GFX6-NEXT:    v_mul_hi_u32 v1, s6, v0
; GFX6-NEXT:    s_mul_i32 s4, s7, 0xfd81e19
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s11, v2
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, s4, v4
...
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, s1, v4
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    s_mul_i32 s10, s7, 0x6ca94220
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GFX6-NEXT:    v_addc_u32_e64 v3, s[8:9], 0, 0, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, s10, v1
; GFX6-NEXT:    v_addc_u32_e32 v3, vcc, v0, v3, vcc
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s11, v1
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, v3, v2, vcc
; GFX6-NEXT:    v_ashr_i64 v[2:3], v[0:1], 19
; GFX6-NEXT:    v_lshrrev_b32_e32 v0, 31, v1
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v2, v0
...
; GFX6-NEXT:    s_mov_b32 s4, 0xcccccccc
; GFX6-NEXT:    s_mov_b32 s5, 0xcccccccd
; GFX6-NEXT:    v_mul_hi_u32 v2, v0, s4
; GFX6-NEXT:    v_mul_lo_u32 v3, v0, s4
; GFX6-NEXT:    v_mul_lo_u32 v5, v1, s5
; GFX6-NEXT:    v_mul_hi_u32 v0, v0, s5
; GFX6-NEXT:    v_mul_hi_u32 v4, v1, s5
; GFX6-NEXT:    v_mul_hi_u32 v6, v1, s4
; GFX6-NEXT:    v_mul_lo_u32 v1, v1, s4
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v5, v0
; GFX6-NEXT:    v_addc_u32_e32 v4, vcc, 0, v4, vcc
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
; GFX6-NEXT:    v_addc_u32_e32 v0, vcc, 0, v2, vcc
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v4, v0
; GFX6-NEXT:    v_addc_u32_e64 v2, s[4:5], 0, 0, vcc
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
