...
; CHECK-NEXT:    s_addk_i32 s32, 0x400
; CHECK-NEXT:    buffer_store_dword v40, off, s[0:3], s33 ; 4-byte Folded Spill
; CHECK-NEXT:    v_writelane_b32 v41, s70, 0
...
; CHECK-NEXT:    v_readlane_b32 s70, v41, 0
; CHECK-NEXT:    s_mov_b32 s32, s33
...
; CHECK-NEXT:    s_mov_b64 exec, s[18:19]
; CHECK-NEXT:    v_writelane_b32 v42, s16, 15
; CHECK-NEXT:    s_addk_i32 s32, 0x400
; CHECK-NEXT:    buffer_store_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
...
; CHECK-NEXT:    v_writelane_b32 v42, s30, 13
; CHECK-NEXT:    v_writelane_b32 v42, s31, 14
...
; CHECK-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; CHECK-NEXT:    v_readlane_b32 s30, v42, 13
; CHECK-NEXT:    v_readlane_b32 s31, v42, 14
...
; CHECK-NEXT:    s_mov_b32 s32, s33
; CHECK-NEXT:    v_readlane_b32 s4, v42, 15
; CHECK-NEXT:    s_or_saveexec_b64 s[6:7], -1
...
; CHECK-NEXT:    v_writelane_b32 v40, s70, 13
...
; CHECK-NEXT:    v_readlane_b32 s70, v40, 13
