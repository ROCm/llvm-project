...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global | FileCheck %s --check-prefix=FLAT
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=fiji -mattr=-flat-for-global | FileCheck %s --check-prefix=FLAT
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn-- -mcpu=fiji -global-isel -new-reg-bank-select | FileCheck %s --check-prefix=GISEL
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX11-FLAT,GFX11-FLAT-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX11-FLAT,GFX11-FLAT-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=+real-true16 -global-isel -new-reg-bank-select | FileCheck %s --check-prefixes=GFX11-GISEL,GFX11-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-real-true16 -global-isel -new-reg-bank-select | FileCheck %s --check-prefixes=GFX11-GISEL,GFX11-GISEL-FAKE16
...
; FLAT-NEXT:    s_load_dword s4, s[4:5], 0x2c
...
; FLAT-NEXT:    s_waitcnt lgkmcnt(0)
; FLAT-NEXT:    s_mov_b32 s4, s2
; FLAT-NEXT:    s_mov_b32 s5, s3
...
; GFX11-FLAT:       ; %bb.0:
; GFX11-FLAT-NEXT:    s_clause 0x1
; GFX11-FLAT-NEXT:    s_load_b32 s6, s[4:5], 0x2c
; GFX11-FLAT-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-FLAT-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-FLAT-NEXT:    s_mov_b32 s2, -1
; GFX11-FLAT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FLAT-NEXT:    s_brev_b32 s4, s6
; GFX11-FLAT-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FLAT-NEXT:    v_mov_b32_e32 v0, s4
...
; FLAT:       ; %bb.0:
; FLAT-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; FLAT-NEXT:    s_mov_b32 s6, 0xf000
; FLAT-NEXT:    s_mov_b32 s7, -1
; FLAT-NEXT:    s_waitcnt lgkmcnt(0)
; FLAT-NEXT:    s_mov_b64 s[4:5], s[2:3]
; FLAT-NEXT:    s_brev_b32 s5, s5
; FLAT-NEXT:    s_brev_b32 s4, s4
; FLAT-NEXT:    s_mov_b32 s2, s7
; FLAT-NEXT:    s_mov_b32 s3, s6
; FLAT-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX11-FLAT:       ; %bb.0:
; GFX11-FLAT-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-FLAT-NEXT:    s_mov_b32 s4, 0x31016000
; GFX11-FLAT-NEXT:    s_mov_b32 s5, -1
; GFX11-FLAT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FLAT-NEXT:    s_brev_b32 s2, s2
; GFX11-FLAT-NEXT:    s_brev_b32 s3, s3
; GFX11-FLAT-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FLAT-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX11-FLAT-NEXT:    s_mov_b32 s2, s5
; GFX11-FLAT-NEXT:    s_mov_b32 s3, s4
...
; FLAT:       ; %bb.0:
; FLAT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; FLAT-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x34
; FLAT-NEXT:    s_mov_b32 s3, 0xf000
; FLAT-NEXT:    s_mov_b32 s2, -1
; FLAT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-FLAT-NEXT:    s_clause 0x1
; GFX11-FLAT-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-FLAT-NEXT:    s_load_b128 s[4:7], s[4:5], 0x34
; GFX11-FLAT-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-FLAT-NEXT:    s_mov_b32 s2, -1
; GFX11-FLAT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FLAT-NEXT:    s_brev_b64 s[4:5], s[4:5]
; GFX11-FLAT-NEXT:    s_brev_b64 s[6:7], s[6:7]
; GFX11-FLAT-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX11-FLAT-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v3, s7
