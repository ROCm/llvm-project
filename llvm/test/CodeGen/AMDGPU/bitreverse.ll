...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgpu8.03-- -global-isel | FileCheck %s --check-prefix=GISEL
...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgpu11.00-- -mattr=-real-true16 -global-isel | FileCheck %s --check-prefixes=GFX11-GISEL,GFX11-GISEL-FAKE16
