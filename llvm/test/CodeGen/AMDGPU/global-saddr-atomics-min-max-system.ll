...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-mesa-mesa3d -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-mesa-mesa3d -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-mesa-mesa3d -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX12 %s
