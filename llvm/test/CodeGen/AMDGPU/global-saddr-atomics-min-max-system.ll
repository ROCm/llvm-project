...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1200 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX12 %s
...
; GFX10-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX11-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX12-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_mov_b32_e32 v2, v0
; GFX9-NEXT:    global_load_dword v0, v2, s[2:3] offset:-128
; GFX9-NEXT:    v_mov_b32_e32 v3, s3
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, s2, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v3, vcc
; GFX9-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-NEXT:    global_load_dword v0, v2, s[2:3] offset:-128
; GFX10-NEXT:    v_add_co_u32 v2, s[0:1], s2, v2
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, s[0:1], s3, 0, s[0:1]
; GFX10-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-NEXT:    global_load_b32 v0, v2, s[2:3] offset:-128
; GFX11-NEXT:    v_add_co_u32 v2, s[0:1], s2, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, 0, s[0:1]
; GFX11-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-NEXT:    global_load_b32 v0, v2, s[2:3] offset:-128
; GFX12-NEXT:    v_add_co_u32 v2, s[0:1], s2, v2
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, 0, s[0:1]
; GFX12-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_max_i32_e32 v2, v3, v1
; GFX9-NEXT:    global_atomic_cmpswap v0, v[4:5], v[2:3], off glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_max_i32_e32 v2, v3, v1
; GFX9-NEXT:    global_atomic_cmpswap v0, v[4:5], v[2:3], off offset:-128 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v3
; GFX9-NEXT:    v_mov_b32_e32 v3, v0
...
; GFX9-NEXT:  .LBB5_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v0, v3
; GFX9-NEXT:    v_mov_b32_e32 v1, v4
; GFX9-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:  .LBB6_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB7_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB8_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:  .LBB9_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_min_i32_e32 v2, v3, v1
; GFX9-NEXT:    global_atomic_cmpswap v0, v[4:5], v[2:3], off glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v3
...
; GFX9-NEXT:  .LBB10_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB11_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB12_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v0, v3
; GFX9-NEXT:    v_mov_b32_e32 v1, v4
; GFX9-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:  .LBB13_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v0, v3
; GFX9-NEXT:    v_mov_b32_e32 v1, v4
; GFX9-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_max_u32_e32 v2, v3, v1
; GFX9-NEXT:    global_atomic_cmpswap v0, v[4:5], v[2:3], off glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v3
...
; GFX9-NEXT:  .LBB22_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB23_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB24_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:  .LBB25_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_min_u32_e32 v2, v3, v1
; GFX9-NEXT:    global_atomic_cmpswap v0, v[4:5], v[2:3], off glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v3
...
; GFX9-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX11-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX12-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr addrspace(1) %sbase, i64 %zext.offset
...
; GFX9-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX11-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX12-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr addrspace(1) %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr addrspace(1) %gep0, i64 -128
...
; GFX9-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v0, v3
; GFX9-NEXT:    v_mov_b32_e32 v1, v4
; GFX9-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX9-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v0, v3
; GFX9-NEXT:    v_mov_b32_e32 v1, v4
; GFX9-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX12-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr addrspace(1) %sbase, i64 %zext.offset
...
; GFX11-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX12-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr addrspace(1) %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr addrspace(1) %gep0, i64 -128
