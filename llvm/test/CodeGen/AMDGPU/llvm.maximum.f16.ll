...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1170 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1170,GFX1170-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1170 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1170,GFX1170-FAKE16 %s
...
; GFX7-NEXT:    v_cmp_o_f32_e64 s[6:7], v20, v19
; GFX7-NEXT:    v_max_f32_e32 v19, v22, v21
; GFX7-NEXT:    v_cmp_o_f32_e64 s[8:9], v22, v21
...
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v17, v18, s[4:5]
; GFX7-NEXT:    v_max_f32_e32 v15, v1, v9
; GFX7-NEXT:    v_cndmask_b32_e64 v18, v17, v22, s[10:11]
...
; GFX7-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX7-NEXT:    v_cndmask_b32_e64 v19, v17, v19, s[8:9]
...
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v17, v23, s[6:7]
