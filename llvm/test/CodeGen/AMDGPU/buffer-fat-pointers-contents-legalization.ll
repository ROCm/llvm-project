...
; SDAG-NEXT:    buffer_load_ushort v0, off, s[4:7], 0
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_lshrrev_b16_e32 v1, 8, v0
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    buffer_load_ushort v6, off, s[4:7], 0 offset:4
; SDAG-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; SDAG-NEXT:    s_waitcnt vmcnt(1)
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    buffer_load_dwordx4 v[33:36], off, s[4:7], 0
; SDAG-NEXT:    buffer_load_dwordx4 v[48:51], off, s[4:7], 0 offset:16
; SDAG-NEXT:    s_waitcnt vmcnt(1)
...
; SDAG-NEXT:    v_lshrrev_b16_e32 v1, 6, v1
; SDAG-NEXT:    v_and_b32_e32 v1, 63, v1
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    buffer_load_dword v0, off, s[4:7], 0 glc
; SDAG-NEXT:    buffer_load_ushort v6, off, s[4:7], 0 offset:4 glc
; SDAG-NEXT:    s_waitcnt vmcnt(1)
; SDAG-NEXT:    v_lshrrev_b32_e32 v7, 8, v0
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_and_b32_e32 v1, 0xffff, v6
