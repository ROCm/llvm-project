...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.06-amd-amdhsa < %s | FileCheck -check-prefixes=GFX906 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.08-amd-amdhsa < %s | FileCheck -check-prefixes=GFX908 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdhsa < %s | FileCheck -check-prefixes=GFX90A %s
