...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu13.10 < %s | FileCheck --check-prefixes=GFX13,GFX13-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu13.10 < %s | FileCheck --check-prefixes=GFX13,GFX13-GISEL %s
...
; GFX13-GISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s0
