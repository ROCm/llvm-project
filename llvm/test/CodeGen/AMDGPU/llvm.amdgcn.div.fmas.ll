...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu6.00 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
; XUN: llc -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI %s
...
; GCN-NEXT:    s_load_dword s8, s[4:5], 0x25
; GCN-NEXT:    s_load_dword s4, s[4:5], 0x2e
...
; GCN-NEXT:    s_load_dword s7, s[4:5], 0x25
; GCN-NEXT:    s_load_dword s4, s[4:5], 0x2e
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    s_load_dword s7, s[4:5], 0xd
; GCN-NEXT:    s_load_dword s4, s[4:5], 0x16
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v0, s6
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dword s2, s[4:5], 0x11
; GCN-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x9
; GCN-NEXT:    s_mov_b32 s0, 0xf000
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GCN-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0xb
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
