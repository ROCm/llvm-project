...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
...
; GCN-NEXT:    s_load_dword s8, s[4:5], 0x2e
...
; GCN-NEXT:    s_load_dword s7, s[4:5], 0x16
...
; GCN-NEXT:    s_xor_b64 s[0:1], exec, s[6:7]
