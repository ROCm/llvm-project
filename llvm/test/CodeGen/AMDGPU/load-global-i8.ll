...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s31, 16
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s4, 8
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s40, s31, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s31, s31, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[12:13], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[16:17], s[26:27], 0x80000
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s30
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s2, -1
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s14, s2
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s15, s3
; GCN-NOHSA-SI-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s12, s6
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s13, s7
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[4:7], off, s[12:15], 0 offset:16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s9, 0
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[12:15], 0
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s43, s9
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s40, v4
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s41, v5
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s45, v7
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s44, v6
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s38, s45
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s45, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s30, s41
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x80000
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s45, 8
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[42:43], 0x80000
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s44, 16
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr43
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s30
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s31
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s45, s9
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s44, s41, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s40, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s40, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s40, 8
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s8
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s8, s41, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s6
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s41, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s41, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s41, s9
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[34:35], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[36:37], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s37, s9
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s34
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s35
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s35, s9
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s30
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s31
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s43, s9
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s47, s9
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s39, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s34, s39, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s6, s39
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s22, s38, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s38, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s38, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s5, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s46, s5, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s10, s5
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s4, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s4, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s4, 8
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s9, s39, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v11, s8
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s8, s39, 24
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s52, s5, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[4:5], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[48:49], s[10:11], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[50:51], s[6:7], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[12:13], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[14:15], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[16:17], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[46:47], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[42:43], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[14:15], s[18:19], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[16:17], s[20:21], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[22:23], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[20:21], s[34:35], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[36:37], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
...
; GCN-HSA-NEXT:    s_mov_b32 s43, s5
; GCN-HSA-NEXT:    s_mov_b32 s41, s5
; GCN-HSA-NEXT:    s_mov_b32 s45, s5
; GCN-HSA-NEXT:    s_mov_b32 s47, s5
; GCN-HSA-NEXT:    s_mov_b32 s49, s5
; GCN-HSA-NEXT:    s_mov_b32 s51, s5
; GCN-HSA-NEXT:    ; implicit-def: $sgpr9
; GCN-HSA-NEXT:    ; implicit-def: $sgpr11
; GCN-HSA-NEXT:    ; implicit-def: $sgpr13
...
; GCN-HSA-NEXT:    s_lshr_b32 s4, s31, 16
...
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[28:29], 0x80000
; GCN-HSA-NEXT:    v_readfirstlane_b32 s22, v4
; GCN-HSA-NEXT:    v_readfirstlane_b32 s23, v5
...
; GCN-HSA-NEXT:    s_lshr_b32 s42, s23, 16
; GCN-HSA-NEXT:    s_lshr_b32 s40, s23, 8
; GCN-HSA-NEXT:    s_mov_b32 s2, s23
; GCN-HSA-NEXT:    s_lshr_b32 s14, s22, 16
; GCN-HSA-NEXT:    s_lshr_b32 s16, s22, 24
; GCN-HSA-NEXT:    s_lshr_b32 s18, s22, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[58:59], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[60:61], s[10:11], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[62:63], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_lshr_b32 s44, s7, 16
; GCN-HSA-NEXT:    s_lshr_b32 s46, s7, 8
...
; GCN-HSA-NEXT:    s_lshr_b32 s48, s5, 16
; GCN-HSA-NEXT:    s_lshr_b32 s50, s5, 8
...
; GCN-HSA-NEXT:    s_ashr_i32 s64, s23, 31
; GCN-HSA-NEXT:    s_ashr_i32 s65, s23, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s66, s31, 31
; GCN-HSA-NEXT:    s_ashr_i32 s67, s31, 24
...
; GCN-HSA-NEXT:    s_bfe_i64 s[54:55], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[56:57], s[42:43], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s33, s5, 31
; GCN-HSA-NEXT:    s_ashr_i32 s42, s5, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s43, s7, 31
; GCN-HSA-NEXT:    s_ashr_i32 s68, s7, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[16:17], s[6:7], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[10:11], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[38:39], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[50:51], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[48:49], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[34:35], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[26:27], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[46:47], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[38:39], s[44:45], 0x80000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s62
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s63
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s65
