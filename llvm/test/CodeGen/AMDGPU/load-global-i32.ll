...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn < %s | FileCheck -check-prefix=SI-NOHSA %s
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[0:3], 0 offset:112
...
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v39, 31, v27
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v37, 31, v26
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v43, 31, v25
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v41, 31, v24
; SI-NOHSA-NEXT:    v_mov_b32_e32 v40, v24
; SI-NOHSA-NEXT:    v_mov_b32_e32 v42, v25
; SI-NOHSA-NEXT:    v_mov_b32_e32 v36, v26
; SI-NOHSA-NEXT:    v_mov_b32_e32 v38, v27
; SI-NOHSA-NEXT:    buffer_store_dword v36, off, s[12:15], 0 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    buffer_store_dword v37, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    buffer_store_dword v38, off, s[12:15], 0 offset:8 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    buffer_store_dword v39, off, s[12:15], 0 offset:12 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v39, 31, v9
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v37, 31, v8
; SI-NOHSA-NEXT:    v_mov_b32_e32 v36, v8
; SI-NOHSA-NEXT:    v_mov_b32_e32 v38, v9
; SI-NOHSA-NEXT:    v_mov_b32_e32 v32, v10
; SI-NOHSA-NEXT:    v_mov_b32_e32 v34, v11
; SI-NOHSA-NEXT:    buffer_store_dword v32, off, s[12:15], 0 offset:16 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    buffer_store_dword v33, off, s[12:15], 0 offset:20 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    buffer_store_dword v34, off, s[12:15], 0 offset:24 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    buffer_store_dword v35, off, s[12:15], 0 offset:28 ; 4-byte Folded Spill
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(13) expcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v7
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v33, 31, v6
...
; SI-NOHSA-NEXT:    v_mov_b32_e32 v32, v6
; SI-NOHSA-NEXT:    v_mov_b32_e32 v34, v7
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(12)
...
; SI-NOHSA-NEXT:    v_mov_b32_e32 v8, v2
; SI-NOHSA-NEXT:    v_mov_b32_e32 v10, v3
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(11)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v7, 31, v19
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v5, 31, v18
...
; SI-NOHSA-NEXT:    v_mov_b32_e32 v4, v18
; SI-NOHSA-NEXT:    v_mov_b32_e32 v6, v19
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(10)
...
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v31
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v21, 31, v30
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v27, 31, v29
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v25, 31, v28
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v28
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v29
; SI-NOHSA-NEXT:    v_mov_b32_e32 v20, v30
; SI-NOHSA-NEXT:    v_mov_b32_e32 v22, v31
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(8)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v15
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v14
...
; SI-NOHSA-NEXT:    buffer_load_dword v12, off, s[12:15], 0 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    buffer_load_dword v13, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    buffer_load_dword v14, off, s[12:15], 0 offset:8 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    buffer_load_dword v15, off, s[12:15], 0 offset:12 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:240
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0 offset:192
; SI-NOHSA-NEXT:    s_waitcnt expcnt(1)
; SI-NOHSA-NEXT:    buffer_load_dword v12, off, s[12:15], 0 offset:16 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    buffer_load_dword v13, off, s[12:15], 0 offset:20 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    buffer_load_dword v14, off, s[12:15], 0 offset:24 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    buffer_load_dword v15, off, s[12:15], 0 offset:28 ; 4-byte Folded Reload
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0 offset:144
...
; SI-NOHSA:       ; %bb.0:
; SI-NOHSA-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x9
; SI-NOHSA-NEXT:    s_mov_b32 s11, 0xf000
; SI-NOHSA-NEXT:    s_mov_b32 s10, -1
; SI-NOHSA-NEXT:    v_mov_b32_e32 v1, 0
; SI-NOHSA-NEXT:    s_mov_b32 s2, s10
; SI-NOHSA-NEXT:    s_mov_b32 s3, s11
; SI-NOHSA-NEXT:    v_mov_b32_e32 v3, v1
; SI-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
