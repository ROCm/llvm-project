...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI-NOHSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.00--amdhsa < %s | FileCheck -check-prefix=GCNX3-HSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck -check-prefix=GCNX3-NOHSA %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=r600 -mcpu=redwood < %s | FileCheck -check-prefix=EG %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00--amdhsa < %s | FileCheck -check-prefix=GCN-HSA -check-prefix=GCN-GFX900-HSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.08--amdhsa < %s | FileCheck -check-prefix=GCN-HSA -check-prefix=GCN-GFX908-HSA %s
...
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; SI-NOHSA-NEXT:    s_mov_b32 s2, s6
; SI-NOHSA-NEXT:    s_mov_b32 s3, s7
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOHSA-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; GCNX3-NOHSA-NEXT:    buffer_load_dword v0, off, s[4:7], 0
...
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dwordx2 v[0:1], off, s[4:7], 0
; SI-NOHSA-NEXT:    s_mov_b32 s2, s6
; SI-NOHSA-NEXT:    s_mov_b32 s3, s7
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOHSA-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-NOHSA-NEXT:    s_endpgm
;
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx2 v[0:1], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s2, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s3, s7
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx3 v[0:2], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s2, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s3, s7
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s2, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s3, s7
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0
; SI-NOHSA-NEXT:    s_mov_b32 s4, s0
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0
...
; SI-NOHSA-NEXT:    buffer_load_dword v8, off, s[4:7], 0 offset:32
; SI-NOHSA-NEXT:    s_mov_b32 s4, s0
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dword v8, off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx2 v[8:9], off, s[4:7], 0 offset:32
; SI-NOHSA-NEXT:    s_mov_b32 s4, s0
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx2 v[8:9], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx3 v[8:10], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
...
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:48
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[4:7], 0 offset:16
; SI-NOHSA-NEXT:    s_mov_b32 s4, s0
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
...
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dwordx2 v[2:3], off, s[4:7], 0
; SI-NOHSA-NEXT:    s_mov_b32 s4, s0
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx2 v[2:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dwordx2 v[4:5], off, s[4:7], 0
; SI-NOHSA-NEXT:    s_mov_b32 s4, s0
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx2 v[4:5], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[19:22], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[15:18], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[11:14], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[7:10], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_endpgm
;
...
; SI-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NOHSA-NEXT:    s_mov_b32 s0, s6
; SI-NOHSA-NEXT:    s_mov_b32 s1, s7
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0
...
; GCNX3-HSA-NEXT:    s_add_u32 s4, s0, 64
; GCNX3-HSA-NEXT:    s_addc_u32 s5, s1, 0
...
; GCNX3-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCNX3-NOHSA-NEXT:    s_mov_b32 s0, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s7
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0
...
; SI-NOHSA-NEXT:    s_mov_b32 s0, s6
; SI-NOHSA-NEXT:    s_mov_b32 s1, s7
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 offset:48
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0
; SI-NOHSA-NEXT:    s_mov_b32 s0, s4
; SI-NOHSA-NEXT:    s_mov_b32 s1, s5
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s0, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s7
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s0, s4
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s5
...
; SI-NOHSA-NEXT:    s_mov_b32 s0, s6
; SI-NOHSA-NEXT:    s_mov_b32 s1, s7
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:96
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0 offset:112
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:80
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 offset:64
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[0:3], 0 offset:48
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[0:3], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[0:3], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[0:3], 0 offset:16
; SI-NOHSA-NEXT:    s_mov_b32 s0, s4
; SI-NOHSA-NEXT:    s_mov_b32 s1, s5
...
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v14, 31, v29
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v12, 31, v28
...
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[0:3], 0 offset:80
; SI-NOHSA-NEXT:    s_waitcnt expcnt(6)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v11, v28
; SI-NOHSA-NEXT:    v_mov_b32_e32 v13, v29
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v4, s4
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v5, s5
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[28:31], v[4:5]
...
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[24:27], v[4:5]
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[16:19], v[6:7]
; GCNX3-HSA-NEXT:    s_add_u32 s4, s2, 32
; GCNX3-HSA-NEXT:    s_addc_u32 s5, s3, 0
; GCNX3-HSA-NEXT:    s_add_u32 s2, s2, 16
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s3, 0
...
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[12:15], v[4:5]
...
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v21
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v33, 31, v20
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v32, v20
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v34, v21
...
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v23
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v33, 31, v22
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v32, v22
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v34, v23
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[20:21], v[32:35]
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v9, s5
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v8, s4
; GCNX3-HSA-NEXT:    s_add_u32 s4, s0, 0xc0
; GCNX3-HSA-NEXT:    s_addc_u32 s5, s1, 0
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v11
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v33, 31, v10
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v32, v10
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v34, v11
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v11, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v10, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 0xd0
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[20:23]
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[10:11], v[32:35]
...
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v29
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v9, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v8, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 0xb0
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v28
...
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v31
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v30
...
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v25
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v24
...
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v27
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v26
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v8, v26
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v10, v27
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[20:21], v[8:11]
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(12)
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v19
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v17
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v16
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v8, v16
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v10, v17
...
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[20:23]
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s0, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s7
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[0:3], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[0:3], 0 offset:32
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[0:3], 0 offset:80
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v14, 31, v29
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v12, 31, v28
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v11, v28
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v13, v29
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[11:14], off, s[0:3], 0 offset:32
...
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v10, 31, v22
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v8, 31, v21
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v7, v21
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v9, v22
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v0, v23
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v2, v24
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v12, v[7:10], s[0:1]
...
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[25:28], v12, s[2:3] offset:96
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[8:11], v12, s[2:3] offset:112
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[0:3], v12, s[2:3] offset:80
...
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v44, 31, v28
...
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v3
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v2
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v8, v2
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v10, v3
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a5, v9
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a4, v8
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a6, v10
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a7, v11
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v16
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v15
...
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v8, v15
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v10, v16
...
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v42, 31, v27
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v41, v27
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v43, v28
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a1, v42
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a0, v41
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a2, v43
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a3, v44
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v32, 31, v26
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v30, 31, v25
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v29, v25
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v31, v26
...
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[29:32], s[0:1] offset:192
...
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v44, 31, v1
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v42, 31, v0
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v41, v0
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v43, v1
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(4)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v7
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v28, 31, v5
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[32:35], s[0:1] offset:208
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[41:44], s[0:1] offset:160
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v35, a7
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v34, a6
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v33, a5
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v32, a4
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v6
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v26, 31, v4
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v25, v4
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v27, v5
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v0, v6
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v2, v7
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[32:35], s[0:1] offset:176
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[45:48], s[0:1] offset:128
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[8:11], s[0:1] offset:144
...
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[0:3], s[0:1] offset:48
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(14)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v6, 31, v24
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v4, 31, v23
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v31, 31, v22
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v29, 31, v21
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v28, v21
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v30, v22
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v3, v23
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v5, v24
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[28:31], s[0:1]
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v12, v[3:6], s[0:1] offset:16
...
; SI-NOHSA-NEXT:    s_mov_b32 s7, 0xf000
; SI-NOHSA-NEXT:    s_mov_b32 s6, -1
; SI-NOHSA-NEXT:    v_mov_b32_e32 v25, 0
; SI-NOHSA-NEXT:    v_mov_b32_e32 v27, v25
; SI-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NOHSA-NEXT:    s_mov_b32 s4, s2
; SI-NOHSA-NEXT:    s_mov_b32 s5, s3
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:112
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:96
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0 offset:80
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[4:7], 0 offset:64
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[4:7], 0 offset:48
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[4:7], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[4:7], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[32:35], off, s[4:7], 0
; SI-NOHSA-NEXT:    s_mov_b32 s2, s6
; SI-NOHSA-NEXT:    s_mov_b32 s3, s7
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v0
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v1
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:224
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v2
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v3
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:240
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(8) expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v4
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v5
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:192
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v6
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v7
...
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:160
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v10
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v11
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:176
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(10) expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v12
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v13
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:128
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v14
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v15
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:144
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(11) expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v16
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v17
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:96
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v18
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v19
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:112
...
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:80
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(13) expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v28
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v29
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:32
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v30
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v31
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:48
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(14) expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v32
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v33
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v34
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v35
...
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s3, 0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v4, s10
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v5, s11
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[12:15], v[4:5]
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[28:31], v[0:1]
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v21, s9
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v20, s8
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v35, s5
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v34, s4
; GCNX3-HSA-NEXT:    s_add_u32 s4, s0, 0xc0
; GCNX3-HSA-NEXT:    s_addc_u32 s5, s1, 0
...
; GCNX3-HSA-NEXT:    s_add_u32 s4, s0, 0xa0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v0, v30
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v2, v31
; GCNX3-HSA-NEXT:    s_addc_u32 s5, s1, 0
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[32:33], v[0:3]
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s7, 0xf000
; GCNX3-NOHSA-NEXT:    s_mov_b32 s6, -1
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v25, 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v27, v25
; GCNX3-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[4:7], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[32:35], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s2, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s3, s7
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v1
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:224
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v2
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v3
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:240
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(8)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v4
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v5
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:192
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v6
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v7
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:208
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(9)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v8
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v9
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:160
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v10
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v11
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:176
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(10)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v12
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v13
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:128
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v14
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v15
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:144
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(11)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v16
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v17
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:96
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v18
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v19
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:112
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(12)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v21
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:64
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v22
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v23
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:80
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(13)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v28
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v29
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v30
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v31
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:48
...
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v34
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v35
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_endpgm
;
...
; SI-NOHSA:       ; %bb.0:
; SI-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-NOHSA-NEXT:    s_mov_b32 s10, -1
; SI-NOHSA-NEXT:    s_mov_b32 s7, 0xf000
; SI-NOHSA-NEXT:    s_mov_b32 s6, s10
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0 offset:80
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[4:7], 0 offset:64
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[4:7], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[4:7], 0 offset:48
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[4:7], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[4:7], 0 offset:16
; SI-NOHSA-NEXT:    s_mov_b32 s8, s0
; SI-NOHSA-NEXT:    s_mov_b32 s9, s1
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[8:11], 0 offset:96
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[8:11], 0 offset:112
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[8:11], 0 offset:64
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[8:11], 0 offset:80
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[8:11], 0 offset:32
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[20:23], off, s[8:11], 0 offset:48
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[8:11], 0
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[28:31], off, s[8:11], 0 offset:16
; SI-NOHSA-NEXT:    s_endpgm
;
...
; GCNX3-HSA-NEXT:    s_add_u32 s6, s2, 0x50
; GCNX3-HSA-NEXT:    s_addc_u32 s7, s3, 0
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v9, s7
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v8, s6
; GCNX3-HSA-NEXT:    s_add_u32 s6, s2, 0x70
; GCNX3-HSA-NEXT:    s_addc_u32 s7, s3, 0
...
; GCNX3-HSA-NEXT:    s_addc_u32 s5, s1, 0
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[32:33], v[4:7]
; GCNX3-HSA-NEXT:    s_nop 0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 64
...
; GCNX3-HSA-NEXT:    s_addc_u32 s1, s1, 0
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[16:19]
...
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[24:27]
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
...
; GCNX3-NOHSA:       ; %bb.0:
; GCNX3-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GCNX3-NOHSA-NEXT:    s_mov_b32 s10, -1
; GCNX3-NOHSA-NEXT:    s_mov_b32 s7, 0xf000
; GCNX3-NOHSA-NEXT:    s_mov_b32 s6, s10
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_mov_b32 s8, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s9, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[8:11], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[8:11], 0 offset:112
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[8:11], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[8:11], 0 offset:80
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[8:11], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[20:23], off, s[8:11], 0 offset:48
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[8:11], 0
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[28:31], off, s[8:11], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_endpgm
;
