...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=verde < %s | FileCheck -enable-var-scope -check-prefixes=GCN %s
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
