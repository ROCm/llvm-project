...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,WAVE64,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,WAVE64,GFX10-WAVE64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX10-WAVE32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX11 %s
...
; GFX10-WAVE64:       ; %bb.0: ; %entry
; GFX10-WAVE64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX10-WAVE64-NEXT:    s_mov_b64 s[0:1], exec
; GFX10-WAVE64-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX10-WAVE64-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX10-WAVE64-NEXT:  .LBB10_3: ; %exit
...
; GFX10-WAVE32:       ; %bb.0: ; %entry
; GFX10-WAVE32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX10-WAVE32-NEXT:    s_mov_b32 s0, exec_lo
; GFX10-WAVE32-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX10-WAVE32-NEXT:    s_and_saveexec_b32 s1, s1
...
; GFX10-WAVE32-NEXT:  .LBB10_3: ; %exit
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX11-NEXT:    s_mov_b64 s[0:1], exec
...
; SI-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; SI-NEXT:    ; divergent control-flow edge
...
; GFX10-WAVE64-NEXT:    v_cmp_le_f32_e32 vcc, 0, v1
; GFX10-WAVE64-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX10-WAVE64-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX10-WAVE64-NEXT:    ; divergent control-flow edge
; GFX10-WAVE64-NEXT:    s_cbranch_execz .LBB13_3
; GFX10-WAVE64-NEXT:  .LBB13_1: ; %bb3
; GFX10-WAVE64-NEXT:    v_cmp_ngt_f32_e32 vcc, 0, v0
; GFX10-WAVE64-NEXT:    s_andn2_b64 s[2:3], s[2:3], vcc
...
; GFX10-WAVE32-NEXT:    v_cmp_le_f32_e32 vcc_lo, 0, v1
; GFX10-WAVE32-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX10-WAVE32-NEXT:    s_and_saveexec_b32 s0, s0
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
; GFX10-WAVE32-NEXT:    s_cbranch_execz .LBB13_3
; GFX10-WAVE32-NEXT:  .LBB13_1: ; %bb3
; GFX10-WAVE32-NEXT:    v_cmp_ngt_f32_e32 vcc_lo, 0, v0
; GFX10-WAVE32-NEXT:    s_andn2_b32 s1, s1, vcc_lo
...
; GFX10-WAVE64-NEXT:    v_mul_f32_e32 v0, v0, v1
...
; GFX10-WAVE64-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX10-WAVE64-NEXT:    exp mrt0, v0, v0, v0, v0 done vm
; GFX10-WAVE64-NEXT:    s_endpgm
...
; GFX10-WAVE32-NEXT:    v_mul_f32_e32 v0, v0, v1
...
; GFX10-WAVE32-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX10-WAVE32-NEXT:    exp mrt0, v0, v0, v0, v0 done vm
; GFX10-WAVE32-NEXT:    s_endpgm
...
; WAVE64-LABEL: complex_loop:
; WAVE64:       ; %bb.0: ; %.entry
; WAVE64-NEXT:    s_cmp_lt_i32 s0, 1
; WAVE64-NEXT:    s_mov_b64 s[4:5], -1
; WAVE64-NEXT:    s_mov_b64 s[0:1], 0
; WAVE64-NEXT:    s_cbranch_scc1 .LBB15_6
; WAVE64-NEXT:  ; %bb.1: ; %.lr.ph
; WAVE64-NEXT:    s_mov_b64 s[2:3], exec
; WAVE64-NEXT:    s_mov_b32 s6, 0
; WAVE64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; WAVE64-NEXT:    s_branch .LBB15_3
; WAVE64-NEXT:  .LBB15_2: ; %latch
; WAVE64-NEXT:    ; in Loop: Header=BB15_3 Depth=1
; WAVE64-NEXT:    s_or_b64 exec, exec, s[4:5]
; WAVE64-NEXT:    s_add_i32 s6, s6, 1
; WAVE64-NEXT:    v_cmp_lt_i32_e32 vcc, s6, v1
; WAVE64-NEXT:    v_mov_b32_e32 v2, s6
; WAVE64-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; WAVE64-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; WAVE64-NEXT:    ; divergent control-flow edge
; WAVE64-NEXT:    s_cbranch_execz .LBB15_7
; WAVE64-NEXT:  .LBB15_3: ; %hdr
; WAVE64-NEXT:    ; =>This Inner Loop Header: Depth=1
; WAVE64-NEXT:    v_cmp_le_u32_e32 vcc, s6, v0
; WAVE64-NEXT:    s_xor_b64 s[4:5], vcc, exec
; WAVE64-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; WAVE64-NEXT:    ; divergent control-flow edge
; WAVE64-NEXT:    s_cbranch_execz .LBB15_2
; WAVE64-NEXT:  .LBB15_4: ; %kill
; WAVE64-NEXT:    ; in Loop: Header=BB15_3 Depth=1
; WAVE64-NEXT:    s_andn2_b64 s[2:3], s[2:3], exec
; WAVE64-NEXT:    s_cbranch_scc0 .LBB15_8
; WAVE64-NEXT:  ; %bb.5: ; %kill
; WAVE64-NEXT:    ; in Loop: Header=BB15_3 Depth=1
; WAVE64-NEXT:    s_mov_b64 exec, 0
; WAVE64-NEXT:    s_branch .LBB15_2
; WAVE64-NEXT:  .LBB15_6:
; WAVE64-NEXT:    v_mov_b32_e32 v2, -1
; WAVE64-NEXT:  .LBB15_7: ; %._crit_edge
; WAVE64-NEXT:    s_or_b64 exec, exec, s[0:1]
; WAVE64-NEXT:    exp mrt0, v2, v2, v0, v0 done vm
; WAVE64-NEXT:    s_endpgm
; WAVE64-NEXT:  .LBB15_8:
; WAVE64-NEXT:    s_mov_b64 exec, 0
; WAVE64-NEXT:    exp null, off, off, off, off done vm
...
; GFX10-WAVE32-NEXT:    s_mov_b32 s3, -1
; GFX10-WAVE32-NEXT:    s_mov_b32 s0, 0
; GFX10-WAVE32-NEXT:    s_cbranch_scc1 .LBB15_6
; GFX10-WAVE32-NEXT:  ; %bb.1: ; %.lr.ph
; GFX10-WAVE32-NEXT:    s_mov_b32 s1, exec_lo
; GFX10-WAVE32-NEXT:    s_mov_b32 s2, 0
; GFX10-WAVE32-NEXT:    s_and_b32 s3, s3, exec_lo
...
; GFX10-WAVE32-NEXT:    v_cmp_lt_i32_e32 vcc_lo, s2, v1
; GFX10-WAVE32-NEXT:    v_mov_b32_e32 v2, s2
; GFX10-WAVE32-NEXT:    s_and_saveexec_b32 s3, vcc_lo
; GFX10-WAVE32-NEXT:    s_or_b32 s0, s0, s3
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
; GFX10-WAVE32-NEXT:    s_cbranch_execz .LBB15_7
; GFX10-WAVE32-NEXT:  .LBB15_3: ; %hdr
; GFX10-WAVE32-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-WAVE32-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v0
; GFX10-WAVE32-NEXT:    s_xor_b32 s3, vcc_lo, exec_lo
; GFX10-WAVE32-NEXT:    s_and_saveexec_b32 s3, s3
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
; GFX10-WAVE32-NEXT:    s_cbranch_execz .LBB15_2
; GFX10-WAVE32-NEXT:  .LBB15_4: ; %kill
; GFX10-WAVE32-NEXT:    ; in Loop: Header=BB15_3 Depth=1
...
; GFX11-NEXT:    v_cmpx_lt_i32_e32 s6, v1
; GFX11-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB15_7
; GFX11-NEXT:  .LBB15_3: ; %hdr
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc, s6, v0
; GFX11-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB15_2
; GFX11-NEXT:  .LBB15_4: ; %kill
; GFX11-NEXT:    ; in Loop: Header=BB15_3 Depth=1
; GFX11-NEXT:    s_and_not1_b64 s[2:3], s[2:3], exec
...
; WAVE64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; WAVE64-NEXT:    s_xor_b64 s[4:5], vcc, exec
; WAVE64-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; WAVE64-NEXT:    ; divergent control-flow edge
; WAVE64-NEXT:    s_cbranch_execnz .LBB16_2
; WAVE64-NEXT:  .LBB16_1: ; %bb.1
; WAVE64-NEXT:    s_or_b64 exec, exec, s[4:5]
; WAVE64-NEXT:    s_setpc_b64 s[30:31]
; WAVE64-NEXT:  .LBB16_2: ; %bb.0
...
; GFX10-WAVE32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX10-WAVE32-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; GFX10-WAVE32-NEXT:    s_and_saveexec_b32 s4, s4
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
; GFX10-WAVE32-NEXT:    s_cbranch_execnz .LBB16_2
; GFX10-WAVE32-NEXT:  .LBB16_1: ; %bb.1
; GFX10-WAVE32-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-WAVE32-NEXT:    s_setpc_b64 s[30:31]
; GFX10-WAVE32-NEXT:  .LBB16_2: ; %bb.0
...
; GFX11-NEXT:  .LBB16_1: ; %bb.1
; GFX11-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
; GFX11-NEXT:  .LBB16_2: ; %bb.0
