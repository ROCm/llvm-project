...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,WAVE64,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,WAVE64,GFX10-WAVE64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX10-WAVE32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX11 %s
...
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
...
; GFX10-WAVE64:       ; %bb.0: ; %entry
; GFX10-WAVE64-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX10-WAVE64-NEXT:    s_mov_b64 s[2:3], exec
...
; GFX10-WAVE32:       ; %bb.0: ; %entry
; GFX10-WAVE32-NEXT:    v_cmp_ne_u32_e64 s0, 0, v0
; GFX10-WAVE32-NEXT:    s_mov_b32 s1, exec_lo
; GFX10-WAVE32-NEXT:    s_xor_b32 s2, s0, exec_lo
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX11-NEXT:    s_mov_b64 s[2:3], exec
...
; GFX10-WAVE64-NEXT:    v_cmp_le_f32_e64 s[0:1], 0, v1
; GFX10-WAVE64-NEXT:    s_xor_b64 s[4:5], s[0:1], exec
; GFX10-WAVE64-NEXT:    s_mov_b64 exec, s[4:5]
; GFX10-WAVE64-NEXT:    ; divergent control-flow edge
...
; GFX10-WAVE64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-WAVE64-NEXT:    v_cmp_eq_f32_e32 vcc, 0, v0
; GFX10-WAVE64-NEXT:    s_xor_b64 exec, vcc, exec
; GFX10-WAVE64-NEXT:    ; divergent control-flow edge
...
; GFX10-WAVE32-NEXT:    v_cmp_le_f32_e64 s0, 0, v1
; GFX10-WAVE32-NEXT:    s_xor_b32 s2, s0, exec_lo
; GFX10-WAVE32-NEXT:    s_mov_b32 exec_lo, s2
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
...
; GFX10-WAVE32-NEXT:    s_waitcnt vmcnt(0)
; GFX10-WAVE32-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v0
; GFX10-WAVE32-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
...
; GFX11-NEXT:    v_cmp_le_f32_e64 s[0:1], 0, v1
; GFX11-NEXT:    s_xor_b64 s[4:5], s[0:1], exec
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_mov_b64 exec, s[4:5]
; GFX11-NEXT:    ; divergent control-flow edge
...
; SI-NEXT:    v_cmp_lt_i32_e32 vcc, s6, v1
...
; SI-NEXT:    s_mov_b64 exec, vcc
; SI-NEXT:    ; divergent control-flow edge
; SI-NEXT:    s_cbranch_execz .LBB15_7
; SI-NEXT:  .LBB15_3: ; %hdr
; SI-NEXT:    ; =>This Inner Loop Header: Depth=1
; SI-NEXT:    v_cmp_le_u32_e32 vcc, s6, v0
...
; GFX10-WAVE64-NEXT:    s_mov_b64 s[4:5], -1
; GFX10-WAVE64-NEXT:    s_mov_b64 s[0:1], 0
; GFX10-WAVE64-NEXT:    s_cbranch_scc1 .LBB15_6
; GFX10-WAVE64-NEXT:  ; %bb.1: ; %.lr.ph
; GFX10-WAVE64-NEXT:    s_mov_b64 s[2:3], exec
; GFX10-WAVE64-NEXT:    s_mov_b32 s6, 0
; GFX10-WAVE64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GFX10-WAVE64-NEXT:    v_cmp_lt_i32_e32 vcc, s6, v1
; GFX10-WAVE64-NEXT:    v_mov_b32_e32 v2, s6
; GFX10-WAVE64-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GFX10-WAVE64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX10-WAVE64-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX10-WAVE64-NEXT:    s_mov_b64 exec, vcc
; GFX10-WAVE64-NEXT:    ; divergent control-flow edge
; GFX10-WAVE64-NEXT:    s_cbranch_execz .LBB15_7
; GFX10-WAVE64-NEXT:  .LBB15_3: ; %hdr
; GFX10-WAVE64-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-WAVE64-NEXT:    v_cmp_le_u32_e32 vcc, s6, v0
; GFX10-WAVE64-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX10-WAVE64-NEXT:    s_xor_b64 s[4:5], exec, s[8:9]
; GFX10-WAVE64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX10-WAVE64-NEXT:    s_mov_b64 exec, s[8:9]
; GFX10-WAVE64-NEXT:    ; divergent control-flow edge
; GFX10-WAVE64-NEXT:    s_cbranch_execz .LBB15_2
; GFX10-WAVE64-NEXT:  .LBB15_4: ; %kill
; GFX10-WAVE64-NEXT:    ; in Loop: Header=BB15_3 Depth=1
; GFX10-WAVE64-NEXT:    s_andn2_b64 s[2:3], s[2:3], exec
...
; GFX10-WAVE32-NEXT:    s_xor_b32 s3, exec_lo, vcc_lo
; GFX10-WAVE32-NEXT:    s_and_b32 s3, s3, exec_lo
...
; GFX10-WAVE32-NEXT:    s_xor_b32 s3, exec_lo, s4
; GFX10-WAVE32-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX10-WAVE32-NEXT:    s_mov_b32 exec_lo, s4
; GFX10-WAVE32-NEXT:    ; divergent control-flow edge
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc, s6, v1
; GFX11-NEXT:    v_mov_b32_e32 v2, s6
; GFX11-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GFX11-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b64 s[4:5], exec, s[8:9]
; GFX11-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX11-NEXT:    s_mov_b64 exec, s[8:9]
; GFX11-NEXT:    ; divergent control-flow edge
