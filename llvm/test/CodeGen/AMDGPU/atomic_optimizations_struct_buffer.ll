...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX6 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1310 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX13,GFX13W64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1310 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX13,GFX13W32 %s
...
; GFX10W64-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX10W64-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
...
; GFX10W64-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
...
; GFX10W64-NEXT:    s_or_b64 exec, exec, vcc
...
; GFX10W32-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
...
; GFX10W32-NEXT:    s_bcnt1_i32_b32 s0, s0
...
; GFX10W32-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
...
; GFX11W64-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX11W64-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
...
; GFX11W64-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
...
; GFX11W64-NEXT:    s_or_b64 exec, exec, vcc
...
; GFX11W32-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
...
; GFX12W64-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX12W64-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
...
; GFX12W64-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX12W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX12W64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W64-NEXT:    s_mul_i32 s0, s0, 5
; GFX12W64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W64-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX12W64-NEXT:    s_or_b64 exec, exec, vcc
...
; GFX12W32-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
...
; GFX12W32-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_mul_i32 s0, s0, 5
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12W32-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
...
; GFX13W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13W64-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX13W64-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
; GFX13W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX13W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX13W64-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX13W64-NEXT:    s_mov_b64 exec, s[2:3]
; GFX13W64-NEXT:    ; divergent control-flow edge
; GFX13W64-NEXT:    s_cbranch_execz .LBB0_2
; GFX13W64-NEXT:  .LBB0_1:
; GFX13W64-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34 nv
; GFX13W64-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX13W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX13W64-NEXT:    s_mul_i32 s0, s0, 5
; GFX13W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13W64-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX13W64-NEXT:    s_or_b64 exec, exec, vcc
...
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13W32-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX13W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX13W32-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13W32-NEXT:    s_mov_b32 exec_lo, s1
; GFX13W32-NEXT:    ; divergent control-flow edge
; GFX13W32-NEXT:    s_cbranch_execz .LBB0_2
; GFX13W32-NEXT:  .LBB0_1:
; GFX13W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34 nv
; GFX13W32-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX13W32-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX13W32-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
...
; GFX10W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX10W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W64-NEXT:    s_mul_i32 s0, s2, s0
; GFX10W64-NEXT:    v_mov_b32_e32 v1, s0
; GFX10W64-NEXT:    buffer_atomic_add v1, v2, s[8:11], 0 idxen glc
...
; GFX10W32-NEXT:    v_mov_b32_e32 v2, 0
; GFX10W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W32-NEXT:    s_mul_i32 s1, s0, s1
...
; GFX11W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX11W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W64-NEXT:    s_mul_i32 s0, s2, s0
; GFX11W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11W64-NEXT:    v_mov_b32_e32 v1, s0
; GFX11W64-NEXT:    buffer_atomic_add_u32 v1, v2, s[8:11], 0 idxen glc
...
; GFX11W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W32-NEXT:    s_mul_i32 s1, s0, s1
; GFX11W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W64-NEXT:    s_mul_i32 s0, s2, s0
; GFX12W64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W64-NEXT:    v_mov_b32_e32 v1, s0
; GFX12W64-NEXT:    buffer_atomic_add_u32 v1, v2, s[8:11], null idxen th:TH_ATOMIC_RETURN
...
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_mul_i32 s1, s0, s1
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX13W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX13W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX13W64-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX13W64-NEXT:    s_mov_b64 exec, s[6:7]
; GFX13W64-NEXT:    ; divergent control-flow edge
; GFX13W64-NEXT:    s_cbranch_execz .LBB1_2
; GFX13W64-NEXT:  .LBB1_1:
; GFX13W64-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34 nv
; GFX13W64-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX13W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
; GFX13W64-NEXT:    s_mul_i32 s0, s2, s0
; GFX13W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13W64-NEXT:    v_mov_b32_e32 v1, s0
; GFX13W64-NEXT:    buffer_atomic_add_u32 v1, v2, s[8:11], null idxen th:TH_ATOMIC_RETURN
...
; GFX13W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX13W32-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13W32-NEXT:    s_mov_b32 exec_lo, s2
; GFX13W32-NEXT:    ; divergent control-flow edge
; GFX13W32-NEXT:    s_cbranch_execz .LBB1_2
; GFX13W32-NEXT:  .LBB1_1:
; GFX13W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34 nv
; GFX13W32-NEXT:    s_bcnt1_i32_b32 s1, s1
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    s_mul_i32 s1, s0, s1
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX8-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX10W64-NEXT:    s_xor_b64 s[0:1], exec, vcc
; GFX10W64-NEXT:    s_mov_b64 exec, vcc
; GFX10W64-NEXT:    ; divergent control-flow edge
...
; GFX10W32-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX10W32-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX10W32-NEXT:    ; divergent control-flow edge
...
; GFX11W64-NEXT:    ; implicit-def: $vgpr1
; GFX11W64-NEXT:    s_xor_b64 s[0:1], exec, vcc
; GFX11W64-NEXT:    s_mov_b64 exec, vcc
; GFX11W64-NEXT:    ; divergent control-flow edge
...
; GFX11W32-NEXT:    ; implicit-def: $vgpr1
; GFX11W32-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX11W32-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX11W32-NEXT:    ; divergent control-flow edge
...
; GFX12W64-NEXT:    ; implicit-def: $vgpr1
; GFX12W64-NEXT:    s_xor_b64 s[0:1], exec, vcc
; GFX12W64-NEXT:    s_mov_b64 exec, vcc
; GFX12W64-NEXT:    ; divergent control-flow edge
...
; GFX12W32-NEXT:    ; implicit-def: $vgpr1
; GFX12W32-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX12W32-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12W32-NEXT:    ; divergent control-flow edge
...
; GFX13W64-NEXT:    ; implicit-def: $vgpr1
; GFX13W64-NEXT:    s_xor_b64 s[0:1], exec, vcc
; GFX13W64-NEXT:    s_mov_b64 exec, vcc
; GFX13W64-NEXT:    ; divergent control-flow edge
; GFX13W64-NEXT:    s_cbranch_execz .LBB2_4
; GFX13W64-NEXT:  .LBB2_3:
; GFX13W64-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34 nv
; GFX13W64-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX13W32-NEXT:    ; implicit-def: $vgpr1
; GFX13W32-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX13W32-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX13W32-NEXT:    ; divergent control-flow edge
; GFX13W32-NEXT:    s_cbranch_execz .LBB2_4
; GFX13W32-NEXT:  .LBB2_3:
; GFX13W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34 nv
; GFX13W32-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    buffer_atomic_add_u32 v1, v2, s[8:11], null idxen th:TH_ATOMIC_RETURN
...
; GFX13W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX13W64-NEXT:    v_mov_b32_e32 v3, 1
; GFX13W64-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
; GFX13W64-NEXT:    buffer_atomic_add_u32 v3, v[1:2], s[0:3], null idxen offen th:TH_ATOMIC_RETURN
; GFX13W64-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13W64-NEXT:    s_wait_loadcnt 0x0
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
; GFX13W64-NEXT:    global_store_b32 v1, v3, s[0:1]
; GFX13W64-NEXT:    s_endpgm
;
; GFX13W32-LABEL: add_i32_varying_offset:
; GFX13W32:       ; %bb.0: ; %entry
; GFX13W32-NEXT:    s_load_b128 s[0:3], s[4:5], 0x34 nv
; GFX13W32-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v3, 1
; GFX13W32-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    buffer_atomic_add_u32 v3, v[1:2], s[0:3], null idxen offen th:TH_ATOMIC_RETURN
; GFX13W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13W32-NEXT:    s_wait_loadcnt 0x0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    global_store_b32 v1, v3, s[0:1]
; GFX13W32-NEXT:    s_endpgm
entry:
  %lane = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX13W64-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
; GFX13W64-NEXT:    buffer_atomic_sub_u32 v3, v[1:2], s[0:3], null idxen offen th:TH_ATOMIC_RETURN
; GFX13W64-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13W64-NEXT:    s_wait_loadcnt 0x0
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
; GFX13W64-NEXT:    global_store_b32 v1, v3, s[0:1]
...
; GFX13W32-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    buffer_atomic_sub_u32 v3, v[1:2], s[0:3], null idxen offen th:TH_ATOMIC_RETURN
; GFX13W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13W32-NEXT:    s_wait_loadcnt 0x0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    global_store_b32 v1, v3, s[0:1]
