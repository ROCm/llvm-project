...
; GFX6-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; GFX10W64-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; GFX10W32-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX10W32-NEXT:    s_and_saveexec_b32 s0, s0
...
; GFX11W64-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; GFX11W32-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX11W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11W32-NEXT:    s_and_saveexec_b32 s0, s0
...
; GFX12W64-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; GFX12W32-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_and_saveexec_b32 s0, s0
...
; GFX13W64-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX13W64-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; GFX13W32-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13W32-NEXT:    s_and_saveexec_b32 s0, s0
...
; GFX6-NEXT:    ; implicit-def: $vgpr1
; GFX6-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX6-NEXT:    ; divergent control-flow edge
...
; GFX10W32-NEXT:    s_and_saveexec_b32 s1, s1
; GFX10W32-NEXT:    ; divergent control-flow edge
...
; GFX11W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11W32-NEXT:    s_and_saveexec_b32 s1, s1
; GFX11W32-NEXT:    ; divergent control-flow edge
...
; GFX12W32-NEXT:    s_and_saveexec_b32 s1, s1
; GFX12W32-NEXT:    ; divergent control-flow edge
...
; GFX13W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13W32-NEXT:    s_and_saveexec_b32 s1, s1
; GFX13W32-NEXT:    ; divergent control-flow edge
