...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 -mattr=+flat-for-global < %s | FileCheck -enable-var-scope --check-prefixes=GCN,SI %s

; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,VI %s
