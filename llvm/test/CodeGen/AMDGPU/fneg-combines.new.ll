...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=hawaii -mattr=+flat-for-global < %s | FileCheck -enable-var-scope --check-prefixes=GCN,SI %s

; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -enable-var-scope --check-prefixes=GCN,VI %s
