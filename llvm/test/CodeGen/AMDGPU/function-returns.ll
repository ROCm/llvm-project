...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=hawaii < %s | FileCheck -enable-var-scope -check-prefixes=GFX789,CI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX789,GFX89,GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX789,GFX89,GFX9 %s
...
; CI-NEXT:    v_add_i32_e32 v1, vcc, 36, v0
; CI-NEXT:    buffer_store_dword v22, v1, s[0:3], 0 offen
...
; GFX8-NEXT:    buffer_store_dword v22, v1, s[0:3], 0 offen
...
; CI-NEXT:    v_add_i32_e32 v1, vcc, 0xa0, v0
; CI-NEXT:    buffer_store_dword v21, v1, s[0:3], 0 offen
...
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, 0xa0, v0
; GFX8-NEXT:    buffer_store_dword v21, v1, s[0:3], 0 offen
