...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -enable-misched -asm-verbose -disable-block-placement -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefix=SI %s
...
; SI-NEXT:    v_cmp_gt_i32_e64 s[6:7], 2, v0
...
; SI-NEXT:    s_and_b64 s[10:11], s[6:7], exec
...
; SI-NEXT:  .LBB0_12: ; %else
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    v_mov_b32_e32 v0, 21
; SI-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; SI-NEXT:    s_branch .LBB0_10
entry:
...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_eq_u32_e64 s[0:1], -1, v9
; SI-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; SI-NEXT:    s_xor_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_xor_b64 s[4:5], exec, s[0:1]
...
; SI-NEXT:    v_add_i32_e64 v6, s[0:1], 4, v6
; SI-NEXT:    v_addc_u32_e64 v7, s[0:1], 0, v7, s[0:1]
