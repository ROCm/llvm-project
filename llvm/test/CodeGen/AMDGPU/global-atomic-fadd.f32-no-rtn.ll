...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.08 -stop-after=amdgpu-isel -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -check-prefixes=GFX908_GFX11_GFX12,GFX908 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a -stop-after=amdgpu-isel -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -check-prefixes=GFX90A_GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42 -stop-after=amdgpu-isel -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -check-prefixes=GFX90A_GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -stop-after=amdgpu-isel -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -check-prefixes=GFX908_GFX11_GFX12,GFX11_GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -stop-after=amdgpu-isel -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -check-prefixes=GFX908_GFX11_GFX12,GFX11_GFX12 %s
