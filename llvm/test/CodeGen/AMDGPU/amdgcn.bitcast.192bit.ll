...
; SI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v6
...
; VI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v6
...
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v6
...
; GFX11-NEXT:    v_cmp_ne_u32_e64 s1, 0, v6
...
; GFX11-NEXT:    ; implicit-def: $sgpr8_sgpr9_sgpr10_sgpr11_sgpr12_sgpr13
...
; SI-NEXT:    v_alignbit_b32 v8, v3, v2, 16
...
; SI-NEXT:    v_alignbit_b32 v6, v1, v0, 16
...
; SI-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; SI-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; SI-NEXT:    v_alignbit_b32 v6, v1, v12, 16
; SI-NEXT:    v_alignbit_b32 v10, v3, v13, 16
; SI-NEXT:    v_alignbit_b32 v11, v5, v14, 16
