...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 < %s | FileCheck -check-prefix=GFX10 %s
...
; GCN-NEXT:    v_alignbyte_b32 v0, s4, v0, v1
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_alignbyte_b32 v0, v2, v0, s4
; GCN-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GCN-NEXT:    s_endpgm
;
