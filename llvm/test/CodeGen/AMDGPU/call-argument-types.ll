...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=fiji -mattr=-flat-for-global -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=hawaii -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=CI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -global-isel=0 -mcpu=gfx900 -mattr=-flat-for-global -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -mattr=-flat-for-global -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=HSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -mcpu=gfx900 -mattr=-flat-for-global -amdgpu-scalarize-global-loads=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GISEL %s
...
; VI-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0xa4
...
; CI-NEXT:    s_load_dwordx16 s[8:23], s[2:3], 0x9
; CI-NEXT:    s_load_dwordx16 s[36:51], s[2:3], 0x19
; CI-NEXT:    s_mov_b32 s53, SCRATCH_RSRC_DWORD1
; CI-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x29
...
; CI-NEXT:    v_mov_b32_e32 v5, s13
; CI-NEXT:    v_mov_b32_e32 v6, s14
; CI-NEXT:    v_mov_b32_e32 v7, s15
; CI-NEXT:    v_mov_b32_e32 v8, s16
; CI-NEXT:    v_mov_b32_e32 v9, s17
; CI-NEXT:    v_mov_b32_e32 v10, s18
; CI-NEXT:    v_mov_b32_e32 v11, s19
; CI-NEXT:    v_mov_b32_e32 v12, s20
; CI-NEXT:    v_mov_b32_e32 v13, s21
; CI-NEXT:    v_mov_b32_e32 v14, s22
; CI-NEXT:    v_mov_b32_e32 v15, s23
; CI-NEXT:    v_mov_b32_e32 v16, s36
; CI-NEXT:    v_mov_b32_e32 v17, s37
; CI-NEXT:    v_mov_b32_e32 v18, s38
; CI-NEXT:    v_mov_b32_e32 v19, s39
; CI-NEXT:    v_mov_b32_e32 v20, s40
; CI-NEXT:    v_mov_b32_e32 v21, s41
; CI-NEXT:    v_mov_b32_e32 v22, s42
; CI-NEXT:    v_mov_b32_e32 v23, s43
; CI-NEXT:    v_mov_b32_e32 v24, s44
; CI-NEXT:    v_mov_b32_e32 v25, s45
; CI-NEXT:    v_mov_b32_e32 v26, s46
; CI-NEXT:    v_mov_b32_e32 v27, s47
; CI-NEXT:    v_mov_b32_e32 v28, s48
; CI-NEXT:    v_mov_b32_e32 v29, s49
; CI-NEXT:    v_mov_b32_e32 v30, s50
; CI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; CI-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_load_b64 s[2:3], s[2:3], 0xa4
; GFX11-NEXT:    s_mov_b32 s32, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_add_i32 s2, s32, 8
; GFX11-NEXT:    s_add_i32 s3, s32, 4
; GFX11-NEXT:    scratch_store_b32 off, v0, s2
; GFX11-NEXT:    scratch_store_b32 off, v1, s3
...
; HSA-NEXT:    s_load_dwordx2 s[6:7], s[6:7], 0x80
; HSA-NEXT:    s_mov_b32 s32, 0
; HSA-NEXT:    s_addc_u32 s1, s1, 0
