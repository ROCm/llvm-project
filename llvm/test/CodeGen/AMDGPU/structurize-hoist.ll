...
; GFX900-NEXT:    v_cmp_gt_i32_e32 vcc, s10, v5
; GFX900-NEXT:    flat_store_dword v[1:2], v3
; GFX900-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX900-NEXT:    s_or_b64 s[2:3], s[2:3], s[8:9]
; GFX900-NEXT:    s_mov_b64 s[8:9], 0
; GFX900-NEXT:    ; divergent control-flow edge
...
; GFX900-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX900-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GFX900-NEXT:    s_mov_b64 s[4:5], 0
; GFX900-NEXT:    ; divergent control-flow edge
...
; GFX900-NEXT:    s_xor_b64 s[8:9], s[6:7], exec
; GFX900-NEXT:    s_mov_b64 s[4:5], 0
; GFX900-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
; GFX900-NEXT:    ; divergent control-flow edge
...
; GFX900-NEXT:  .LBB3_2:
; GFX900-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX900-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX900-NEXT:    ; divergent control-flow edge
...
; GFX900-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
; GFX900-NEXT:    s_or_b64 s[6:7], s[6:7], s[8:9]
; GFX900-NEXT:    ; divergent control-flow edge
; GFX900-NEXT:    s_cbranch_execz .LBB3_9
