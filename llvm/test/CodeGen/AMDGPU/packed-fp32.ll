...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -enable-var-scope -check-prefix=GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx90a < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-SDAG,GFX90A-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx90a < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-GISEL,GFX90A-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-SDAG,GFX942-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-GISEL,GFX942-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250,GFX1250-GISEL %s
...
; PACKED-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[28:31], v32, s[0:1] offset:16
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[0:3], v32, s[0:1]
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[24:27], v32, s[0:1] offset:48
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[20:23], v32, s[0:1] offset:32
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[16:19], v32, s[0:1] offset:80
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[4:7], v32, s[0:1] offset:64
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[12:15], v32, s[0:1] offset:112
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[8:11], v32, s[0:1] offset:96
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(7)
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[28:29], v[28:29], s[40:41]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[30:31], v[30:31], s[42:43]
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(6)
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[2:3], v[2:3], s[38:39]
...
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(0)
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[8:9], v[8:9], s[16:17]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[10:11], v[10:11], s[18:19]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[16:17], v[16:17], s[12:13]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[18:19], v[18:19], s[14:15]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[6:7], v[6:7], s[10:11]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[12:13], v[12:13], s[20:21]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[14:15], v[14:15], s[22:23]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[0:1], v[0:1], s[36:37]
; PACKED-SDAG-NEXT:    v_pk_add_f32 v[4:5], v[4:5], s[8:9]
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[8:11], s[0:1] offset:96
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[12:15], s[0:1] offset:112
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[4:7], s[0:1] offset:64
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[16:19], s[0:1] offset:80
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[20:23], s[0:1] offset:32
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[24:27], s[0:1] offset:48
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[0:3], s[0:1]
; PACKED-SDAG-NEXT:    global_store_dwordx4 v32, v[28:31], s[0:1] offset:16
; PACKED-SDAG-NEXT:    s_endpgm
;
...
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[8:11], v32, s[0:1] offset:96
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(7)
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[28:29], v[28:29], s[40:41]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[30:31], v[30:31], s[42:43]
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(6)
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[2:3], v[2:3], s[38:39]
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(5)
...
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(0)
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[8:9], v[8:9], s[16:17]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[10:11], v[10:11], s[18:19]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[16:17], v[16:17], s[12:13]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[18:19], v[18:19], s[14:15]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[6:7], v[6:7], s[10:11]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[12:13], v[12:13], s[20:21]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[14:15], v[14:15], s[22:23]
; PACKED-SDAG-NEXT:    v_pk_mul_f32 v[0:1], v[0:1], s[36:37]
...
; PACKED-SDAG-NEXT:    global_load_dwordx4 v[8:11], v32, s[0:1] offset:96
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(7)
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[28:29], v[28:29], s[40:41], s[40:41]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[30:31], v[30:31], s[42:43], s[42:43]
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(6)
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[2:3], v[2:3], s[38:39], s[38:39]
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(5)
...
; PACKED-SDAG-NEXT:    s_waitcnt vmcnt(0)
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[8:9], v[8:9], s[16:17], s[16:17]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[10:11], v[10:11], s[18:19], s[18:19]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[16:17], v[16:17], s[12:13], s[12:13]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[18:19], v[18:19], s[14:15], s[14:15]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[6:7], v[6:7], s[10:11], s[10:11]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[12:13], v[12:13], s[20:21], s[20:21]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[14:15], v[14:15], s[22:23], s[22:23]
; PACKED-SDAG-NEXT:    v_pk_fma_f32 v[0:1], v[0:1], s[36:37], s[36:37]
...
; GFX1250-SDAG-NEXT:    global_load_b128 v[24:27], v56, s[0:1] offset:64
; GFX1250-SDAG-NEXT:    global_load_b128 v[28:31], v56, s[0:1] offset:112
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[48:49]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[50:51]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[40:41]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[42:43]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[8:9]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[54:55], s[10:11]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[44:45]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[46:47]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[36:37]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[38:39]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x7
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[0:1], v[0:1], v[36:37], v[36:37]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[4:5], v[4:5], v[42:43], v[42:43]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[6:7], v[6:7], v[44:45], v[44:45]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[16:17]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[18:19]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[2:3], v[2:3], v[38:39], v[38:39]
...
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[24:25], v[24:25], v[34:35], v[34:35]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[16:17], v[16:17], v[50:51], v[50:51]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[18:19], v[18:19], v[52:53], v[52:53]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[8:9], v[8:9], v[46:47], v[46:47]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[10:11], v[10:11], v[48:49], v[48:49]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[14:15], v[14:15], v[40:41], v[40:41]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[12:13], v[12:13], v[32:33], v[32:33]
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[20:23], s[0:1] offset:96
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[28:31], s[0:1] offset:112
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[24:27], s[0:1] offset:64
...
; GFX1250-SDAG-NEXT:    s_add_f32 s4, s1, s3
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_3)
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[2:3], v[0:1], s[4:5] op_sel_hi:[1,0]
