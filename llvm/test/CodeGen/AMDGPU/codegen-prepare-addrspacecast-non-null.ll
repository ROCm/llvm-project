...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck %s --check-prefixes=ASM,DAGISEL-ASM
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -global-isel -mcpu=gfx900 < %s | FileCheck %s --check-prefixes=ASM,GISEL-ASM
...
; DAGISEL-ASM-NEXT:    v_cmp_eq_u32_e64 s[12:13], 0, v0
; DAGISEL-ASM-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; DAGISEL-ASM-NEXT:    s_xor_b64 s[16:17], s[12:13], exec
; DAGISEL-ASM-NEXT:    s_mov_b64 s[4:5], 0
; DAGISEL-ASM-NEXT:    s_mov_b64 s[4:5], 0
; DAGISEL-ASM-NEXT:    s_mov_b64 s[4:5], 0
; DAGISEL-ASM-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; DAGISEL-ASM-NEXT:    s_mov_b64 s[10:11], -1
; DAGISEL-ASM-NEXT:    s_mov_b64 s[8:9], 0
; DAGISEL-ASM-NEXT:    s_xor_b64 s[14:15], exec, s[16:17]
; DAGISEL-ASM-NEXT:    s_mov_b64 s[6:7], 0
; DAGISEL-ASM-NEXT:    s_mov_b64 s[4:5], 0
; DAGISEL-ASM-NEXT:    s_mov_b64 exec, s[16:17]
; DAGISEL-ASM-NEXT:    s_mov_b64 s[16:17], 0
; DAGISEL-ASM-NEXT:    ; divergent control-flow edge
; DAGISEL-ASM-NEXT:    s_cbranch_execz .LBB11_2
; DAGISEL-ASM-NEXT:  .LBB11_1: ; %then
; DAGISEL-ASM-NEXT:    s_mov_b64 s[16:17], 0
; DAGISEL-ASM-NEXT:    s_and_b64 s[16:17], s[10:11], exec
; DAGISEL-ASM-NEXT:    v_and_b32_e32 v0, 0xffff, v1
; DAGISEL-ASM-NEXT:    s_or_b64 s[8:9], s[8:9], s[16:17]
; DAGISEL-ASM-NEXT:  .LBB11_2:
; DAGISEL-ASM-NEXT:    s_or_b64 exec, exec, s[14:15]
; DAGISEL-ASM-NEXT:    s_xor_b64 s[14:15], exec, s[12:13]
; DAGISEL-ASM-NEXT:    s_and_b64 s[14:15], s[14:15], exec
; DAGISEL-ASM-NEXT:    s_or_b64 s[6:7], s[6:7], s[14:15]
; DAGISEL-ASM-NEXT:    s_mov_b64 exec, s[12:13]
; DAGISEL-ASM-NEXT:    s_mov_b64 s[12:13], 0
; DAGISEL-ASM-NEXT:    s_mov_b64 s[12:13], 0
; DAGISEL-ASM-NEXT:    ; divergent control-flow edge
; DAGISEL-ASM-NEXT:    s_cbranch_execz .LBB11_4
; DAGISEL-ASM-NEXT:  .LBB11_3:
; DAGISEL-ASM-NEXT:    v_lshrrev_b32_e64 v0, 6, s32
; DAGISEL-ASM-NEXT:    s_and_b64 s[10:11], s[10:11], exec
; DAGISEL-ASM-NEXT:    s_mov_b64 s[12:13], 0
; DAGISEL-ASM-NEXT:    s_or_b64 s[8:9], s[8:9], s[10:11]
; DAGISEL-ASM-NEXT:  .LBB11_4: ; %finally
...
; DAGISEL-ASM-NEXT:    s_xor_b64 s[10:11], exec, s[8:9]
; DAGISEL-ASM-NEXT:    s_or_b64 s[6:7], s[6:7], s[10:11]
...
; DAGISEL-ASM-NEXT:    s_mov_b64 s[6:7], 0
; DAGISEL-ASM-NEXT:    ; divergent control-flow edge
; DAGISEL-ASM-NEXT:    s_cbranch_execnz .LBB11_4
; DAGISEL-ASM-NEXT:  .LBB11_5: ; %end
