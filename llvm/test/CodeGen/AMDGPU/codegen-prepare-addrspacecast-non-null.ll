...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00-amd-amdhsa -global-isel < %s | FileCheck %s --check-prefixes=ASM,GISEL-ASM
...
; DAGISEL-ASM-NEXT:    s_xor_b64 s[4:5], vcc, exec
; DAGISEL-ASM-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; DAGISEL-ASM-NEXT:    v_lshrrev_b32_e64 v0, 6, s32
; DAGISEL-ASM-NEXT:    s_mov_b64 s[6:7], -1
...
; DAGISEL-ASM-NEXT:    s_and_b64 s[6:7], s[6:7], exec
