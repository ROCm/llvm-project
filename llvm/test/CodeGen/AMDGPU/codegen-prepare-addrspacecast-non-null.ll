...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00-amd-amdhsa -global-isel -global-isel-abort=2 < %s | FileCheck %s --check-prefixes=ASM,GISEL-ASM
...
; GISEL-ASM-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; GISEL-ASM-NEXT:    v_lshrrev_b32_e64 v0, 6, s32
; GISEL-ASM-NEXT:    s_and_saveexec_b64 s[4:5], vcc
