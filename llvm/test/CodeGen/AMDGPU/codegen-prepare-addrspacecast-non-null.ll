...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck %s --check-prefixes=ASM,DAGISEL-ASM
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa -global-isel < %s | FileCheck %s --check-prefixes=ASM,GISEL-ASM
...
; GISEL-ASM-NEXT:    s_mov_b64 exec, s[8:9]
; GISEL-ASM-NEXT:    ; divergent control-flow edge
; GISEL-ASM-NEXT:    s_cbranch_execz .LBB11_2
; GISEL-ASM-NEXT:  .LBB11_1: ; %then
; GISEL-ASM-NEXT:    v_and_b32_e32 v0, 0xffff, v1
; GISEL-ASM-NEXT:  .LBB11_2: ; %finally
...
; GISEL-ASM-NEXT:    s_and_b64 s[8:9], exec, vcc
; GISEL-ASM-NEXT:    v_mov_b32_e32 v1, s7
; GISEL-ASM-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GISEL-ASM-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GISEL-ASM-NEXT:    v_mov_b32_e32 v2, 7
; GISEL-ASM-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GISEL-ASM-NEXT:    s_mov_b64 s[6:7], 0
; GISEL-ASM-NEXT:    flat_store_dword v[0:1], v2
; GISEL-ASM-NEXT:    s_waitcnt vmcnt(0)
; GISEL-ASM-NEXT:    s_mov_b64 exec, s[8:9]
; GISEL-ASM-NEXT:    ; divergent control-flow edge
; GISEL-ASM-NEXT:    s_cbranch_execnz .LBB11_2
; GISEL-ASM-NEXT:  .LBB11_3: ; %end
