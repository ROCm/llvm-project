...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9,GX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 < %s | FileCheck -check-prefixes=GFX9,GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 < %s | FileCheck -check-prefix=GFX10 %s
...
; GX900-NEXT:    s_nop 0
; GX900-NEXT:    global_load_dword v1, v[2:3], off offset:4
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    global_load_dword v1, v[2:3], off offset:4
...
; GX900-NEXT:    global_load_dwordx2 v[5:6], v[2:3], off
; GX900-NEXT:    s_nop 0
; GX900-NEXT:    global_load_dword v1, v[0:1], off offset:4
; GX900-NEXT:    s_waitcnt vmcnt(1)
...
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    global_load_dword v1, v[0:1], off offset:4
; GFX942-NEXT:    s_waitcnt vmcnt(1)
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    global_load_dword v2, v[2:3], off
; GFX942-NEXT:    s_waitcnt vmcnt(1)
...
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v6, s[4:5]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    global_store_dwordx2 v6, v[0:1], s[4:5]
...
; GX900-NEXT:    s_waitcnt lgkmcnt(0)
; GX900-NEXT:    global_load_dwordx2 v[1:2], v0, s[4:5]
; GX900-NEXT:    global_load_dwordx2 v[3:4], v0, s[0:1]
; GX900-NEXT:    global_load_dwordx2 v[5:6], v0, s[2:3]
; GX900-NEXT:    s_movk_i32 s0, 0x7fff
; GX900-NEXT:    s_mov_b32 s1, 0x7060302
...
; GX900-NEXT:    v_add3_u32 v13, v13, v8, s0
...
; GX900-NEXT:    v_add3_u32 v15, v15, v2, s0
...
; GX900-NEXT:    v_perm_b32 v2, v4, v2, s1
; GX900-NEXT:    v_perm_b32 v1, v3, v1, s1
; GX900-NEXT:    global_store_dwordx2 v0, v[1:2], s[4:5]
; GX900-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v6, s[0:1]
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v6, s[2:3]
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v6, s[4:5]
; GFX942-NEXT:    s_movk_i32 s0, 0x7fff
; GFX942-NEXT:    s_mov_b32 s1, 0x7060302
...
; GFX942-NEXT:    v_add3_u32 v13, v13, v12, s0
...
; GFX942-NEXT:    v_add3_u32 v15, v15, v3, s0
...
; GFX942-NEXT:    v_add3_u32 v5, v5, v4, s0
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x2
; GFX10-NEXT:    global_load_dwordx2 v[0:1], v6, s[4:5]
...
; GFX11-TRUE16-NEXT:    global_load_b64 v[0:1], v6, s[4:5]
; GFX11-TRUE16-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX11-TRUE16-NEXT:    global_load_b64 v[4:5], v6, s[2:3]
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FAKE16-NEXT:    global_load_b64 v[0:1], v6, s[4:5]
; GFX11-FAKE16-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX11-FAKE16-NEXT:    global_load_b64 v[4:5], v6, s[2:3]
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
