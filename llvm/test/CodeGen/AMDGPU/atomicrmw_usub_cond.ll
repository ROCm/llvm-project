...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12-GISEL %s
...
; GFX9-SDAG-NEXT:    s_mov_b64 s[0:1], -1
...
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[4:5], 1, v3
...
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    s_mov_b64 s[8:9], 0
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[8:9], 1, v1
...
; GFX9-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[4:5], 1, v1
...
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[8:9], 1, v2
; GFX9-SDAG-NEXT:    s_xor_b64 s[10:11], exec, s[8:9]
; GFX9-SDAG-NEXT:    s_or_b64 s[2:3], s[2:3], s[10:11]
; GFX9-SDAG-NEXT:    s_mov_b64 exec, s[8:9]
; GFX9-SDAG-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX9-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v2
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[6:7], 1, v2
...
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[6:7], 1, v4
; GFX9-SDAG-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GFX9-SDAG-NEXT:    s_or_b64 s[4:5], s[4:5], s[8:9]
; GFX9-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-SDAG-NEXT:    s_mov_b64 s[6:7], 0
...
; GFX9-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[6:7], 1, v1
; GFX9-SDAG-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GFX9-SDAG-NEXT:    s_or_b64 s[4:5], s[4:5], s[8:9]
; GFX9-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-SDAG-NEXT:    s_mov_b64 s[6:7], 0
