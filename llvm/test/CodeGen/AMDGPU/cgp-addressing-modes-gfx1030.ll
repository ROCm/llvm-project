...
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgpu10.30-amd-amdhsa < %s | FileCheck -check-prefix=OPT %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30-amd-amdhsa < %s | FileCheck -check-prefix=GCN %s
