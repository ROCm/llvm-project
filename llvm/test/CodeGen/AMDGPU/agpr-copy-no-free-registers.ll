...
; GFX908-NEXT:    v_readfirstlane_b32 s2, v1
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_readfirstlane_b32 s9, v0
; GFX908-NEXT:    s_and_b32 s18, s9, 0xffff
; GFX908-NEXT:    s_cmp_ge_u32 s2, s7
; GFX908-NEXT:    s_cselect_b32 s1, s3, s1
; GFX908-NEXT:    s_cselect_b32 s2, s6, s2
; GFX908-NEXT:    s_add_i32 s3, s1, 1
; GFX908-NEXT:    s_cmp_ge_u32 s2, s7
; GFX908-NEXT:    s_cselect_b32 s19, s3, s1
; GFX908-NEXT:    s_lshr_b32 s0, s0, 16
; GFX908-NEXT:    v_cvt_f32_f16_e32 v15, s0
...
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    global_load_dwordx2 v[8:9], v[0:1], off
; GFX908-NEXT:    v_cmp_gt_i64_e64 s[2:3], s[10:11], -1
; GFX908-NEXT:    v_cmp_lt_i64_e64 s[6:7], s[10:11], 0
; GFX908-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[2:3]
; GFX908-NEXT:    s_mov_b32 s9, s8
; GFX908-NEXT:    v_mov_b32_e32 v2, s8
; GFX908-NEXT:    v_cmp_ne_u32_e64 s[2:3], 1, v4
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_readfirstlane_b32 s12, v8
; GFX908-NEXT:    v_readfirstlane_b32 s13, v9
...
; GFX908-NEXT:    s_add_u32 s9, s12, 1
; GFX908-NEXT:    s_addc_u32 s14, s13, 0
; GFX908-NEXT:    s_mul_i32 s15, s9, s5
; GFX908-NEXT:    s_mul_hi_u32 s16, s9, s4
; GFX908-NEXT:    s_add_i32 s15, s16, s15
; GFX908-NEXT:    s_mul_i32 s14, s14, s4
; GFX908-NEXT:    s_add_i32 s15, s15, s14
; GFX908-NEXT:    s_mul_i32 s9, s9, s4
; GFX908-NEXT:    s_add_u32 s14, s9, s10
; GFX908-NEXT:    s_addc_u32 s15, s15, s11
; GFX908-NEXT:    s_lshl_b64 s[14:15], s[14:15], 5
; GFX908-NEXT:    global_load_dword v18, v16, s[14:15] offset:16 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v17, v16, s[14:15] offset:20 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v10, v16, s[14:15] offset:24 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v10, v16, s[14:15] offset:28 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    ds_read_b64 v[10:11], v16
; GFX908-NEXT:    ds_read_b64 v[12:13], v0
; GFX908-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GFX908-NEXT:    ; kill: killed $sgpr14_sgpr15
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    s_cbranch_vccnz .LBB3_7
; GFX908-NEXT:  ; %bb.6: ; %bb51
; GFX908-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX908-NEXT:    v_cvt_f32_f16_sdwa v19, v18 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX908-NEXT:    v_cvt_f32_f16_e32 v18, v18
; GFX908-NEXT:    v_cvt_f32_f16_sdwa v20, v17 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX908-NEXT:    v_cvt_f32_f16_e32 v17, v17
; GFX908-NEXT:    v_add_f32_e32 v21, v14, v10
; GFX908-NEXT:    v_add_f32_e32 v22, v15, v11
; GFX908-NEXT:    v_add_f32_e32 v23, 0, v10
; GFX908-NEXT:    v_add_f32_e32 v24, 0, v11
; GFX908-NEXT:    v_add_f32_e32 v13, v19, v13
; GFX908-NEXT:    v_add_f32_e32 v12, v18, v12
; GFX908-NEXT:    v_add_f32_e32 v11, v20, v11
; GFX908-NEXT:    v_add_f32_e32 v10, v17, v10
; GFX908-NEXT:    v_add_f32_e32 v3, v3, v22
; GFX908-NEXT:    v_add_f32_e32 v2, v2, v21
; GFX908-NEXT:    v_add_f32_e32 v5, v5, v24
; GFX908-NEXT:    v_add_f32_e32 v4, v4, v23
; GFX908-NEXT:    v_add_f32_e32 v6, v6, v12
; GFX908-NEXT:    v_add_f32_e32 v7, v7, v13
; GFX908-NEXT:    v_add_f32_e32 v8, v8, v10
; GFX908-NEXT:    v_add_f32_e32 v9, v9, v11
; GFX908-NEXT:    s_mov_b64 s[16:17], -1
; GFX908-NEXT:    s_branch .LBB3_8
; GFX908-NEXT:  .LBB3_7: ; in Loop: Header=BB3_5 Depth=2
; GFX908-NEXT:    s_mov_b64 s[16:17], s[6:7]
...
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_add_u32 s10, s10, s19
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    global_load_dwordx2 v[10:11], v[2:3], off
; GFX90A-NEXT:    v_cmp_gt_i64_e64 s[2:3], s[10:11], -1
; GFX90A-NEXT:    s_mov_b32 s13, s12
; GFX90A-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[2:3]
; GFX90A-NEXT:    v_cmp_lt_i64_e64 s[6:7], s[10:11], 0
; GFX90A-NEXT:    v_pk_mov_b32 v[4:5], s[12:13], s[12:13] op_sel:[0,1]
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[2:3], 1, v6
; GFX90A-NEXT:    v_pk_mov_b32 v[6:7], s[12:13], s[12:13] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[8:9], s[12:13], s[12:13] op_sel:[0,1]
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_readfirstlane_b32 s8, v10
; GFX90A-NEXT:    v_readfirstlane_b32 s9, v11
...
; GFX90A-NEXT:    s_add_u32 s13, s8, 1
; GFX90A-NEXT:    s_addc_u32 s14, s9, 0
; GFX90A-NEXT:    s_mul_i32 s15, s13, s5
; GFX90A-NEXT:    s_mul_hi_u32 s16, s13, s4
; GFX90A-NEXT:    s_add_i32 s15, s16, s15
; GFX90A-NEXT:    s_mul_i32 s14, s14, s4
; GFX90A-NEXT:    s_add_i32 s15, s15, s14
; GFX90A-NEXT:    s_mul_i32 s13, s13, s4
; GFX90A-NEXT:    s_add_u32 s14, s13, s10
; GFX90A-NEXT:    s_addc_u32 s15, s15, s11
; GFX90A-NEXT:    s_lshl_b64 s[14:15], s[14:15], 5
; GFX90A-NEXT:    global_load_dword v18, v16, s[14:15] offset:16 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v17, v16, s[14:15] offset:20 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v12, v16, s[14:15] offset:24 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v12, v16, s[14:15] offset:28 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    ds_read_b64 v[12:13], v16
; GFX90A-NEXT:    ds_read_b64 v[14:15], v0
; GFX90A-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GFX90A-NEXT:    ; kill: killed $sgpr14_sgpr15
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_cbranch_vccnz .LBB3_7
; GFX90A-NEXT:  ; %bb.6: ; %bb51
; GFX90A-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX90A-NEXT:    v_cvt_f32_f16_sdwa v19, v18 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX90A-NEXT:    v_cvt_f32_f16_e32 v18, v18
; GFX90A-NEXT:    v_cvt_f32_f16_sdwa v21, v17 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX90A-NEXT:    v_cvt_f32_f16_e32 v20, v17
; GFX90A-NEXT:    v_pk_add_f32 v[22:23], v[0:1], v[12:13]
; GFX90A-NEXT:    v_pk_add_f32 v[24:25], v[12:13], 0 op_sel_hi:[1,0]
; GFX90A-NEXT:    v_pk_add_f32 v[14:15], v[18:19], v[14:15]
; GFX90A-NEXT:    v_pk_add_f32 v[12:13], v[20:21], v[12:13]
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_add_u32 s10, s10, s19
