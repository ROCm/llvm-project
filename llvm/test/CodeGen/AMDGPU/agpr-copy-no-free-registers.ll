...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdhsa -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefix=GFX90A %s
...
; GFX908-NEXT:    v_rcp_f32_e32 v2, v2
