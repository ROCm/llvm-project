...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -global-isel=0 -mtriple=amdgpu13.10 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu13.10 < %s | FileCheck -check-prefixes=GFX12PLUS %s
