...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu13.10 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13PLUS %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu13.10 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13PLUS %s
...
;
; GFX13PLUS-LABEL: atomic_min_flt_1d:
; GFX13PLUS:       ; %bb.0: ; %main_body
; GFX13PLUS-NEXT:    image_atomic_min_num_flt v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX13PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13PLUS-LABEL: atomic_max_flt_1d:
; GFX13PLUS:       ; %bb.0: ; %main_body
; GFX13PLUS-NEXT:    image_atomic_max_num_flt v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX13PLUS-NEXT:    ; return to shader part epilog
main_body:
