...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.00--amdpal -stop-after=irtranslator < %s | FileCheck %s
...
define amdgpu_gfx_whole_wave i32 @multiple_blocks(i1 %active, i32 %a, i32 %b) {
  ...
  ; CHECK-NEXT:   [[PHI:%[0-9]+]]:_(i32) = G_PHI [[ADD]](i32), %bb.2, [[COPY1]](i32), %bb.1
