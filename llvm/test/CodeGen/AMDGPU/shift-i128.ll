...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=kaveri < %s | FileCheck -check-prefix=GCN %s
...
; GCN-NEXT:    s_lshl_b64 s[6:7], s[0:1], s5
; GCN-NEXT:    s_sub_i32 s5, 64, s4
; GCN-NEXT:    s_lshr_b64 s[8:9], s[0:1], s5
; GCN-NEXT:    s_lshl_b64 s[10:11], s[2:3], s4
...
; GCN-NEXT:    s_cselect_b32 s6, s9, s7
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_sub_i32 s5, s4, 64
; GCN-NEXT:    s_lshr_b64 s[6:7], s[2:3], s5
; GCN-NEXT:    s_sub_i32 s5, 64, s4
; GCN-NEXT:    s_lshl_b64 s[8:9], s[2:3], s5
; GCN-NEXT:    s_lshr_b64 s[10:11], s[0:1], s4
; GCN-NEXT:    s_or_b64 s[8:9], s[10:11], s[8:9]
...
; GCN-NEXT:    s_lshr_b64 s[8:9], s[0:1], s4
; GCN-NEXT:    s_sub_i32 s5, s4, 64
...
; GCN-NEXT:    s_lshl_b64 s[20:21], s[2:3], s8
; GCN-NEXT:    s_and_b64 s[16:17], s[18:19], s[16:17]
; GCN-NEXT:    s_sub_i32 s18, 64, s8
; GCN-NEXT:    s_lshr_b64 s[18:19], s[0:1], s18
...
; GCN-NEXT:    s_lshl_b64 s[10:11], s[6:7], s12
...
; GCN-NEXT:    s_cselect_b32 s11, s11, s19
...
; GCN-NEXT:    s_and_b64 s[20:21], s[2:3], exec
; GCN-NEXT:    s_cselect_b32 s7, s10, s18
...
; GCN-NEXT:    v_cmp_lt_u64_e64 s[16:17], s[8:9], 64
; GCN-NEXT:    v_cmp_eq_u64_e64 s[18:19], s[10:11], 0
; GCN-NEXT:    s_lshr_b64 s[20:21], s[0:1], s8
; GCN-NEXT:    s_and_b64 s[16:17], s[18:19], s[16:17]
; GCN-NEXT:    s_sub_i32 s18, 64, s8
; GCN-NEXT:    s_lshl_b64 s[18:19], s[2:3], s18
; GCN-NEXT:    s_or_b64 s[18:19], s[20:21], s[18:19]
; GCN-NEXT:    s_sub_i32 s20, s8, 64
...
; GCN-NEXT:    v_cmp_eq_u64_e64 s[10:11], s[14:15], 0
; GCN-NEXT:    s_sub_i32 s18, 64, s12
; GCN-NEXT:    s_and_b64 s[0:1], s[10:11], s[0:1]
; GCN-NEXT:    s_lshr_b64 s[10:11], s[4:5], s12
...
; GCN-NEXT:    s_and_b64 s[20:21], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s5, s10, s18
; GCN-NEXT:    s_and_b64 s[10:11], s[14:15], exec
...
; GCN-NEXT:    s_and_b64 s[10:11], s[14:15], exec
; GCN-NEXT:    s_cselect_b32 s10, s4, s5
; GCN-NEXT:    s_ashr_i64 s[4:5], s[2:3], s8
; GCN-NEXT:    s_ashr_i32 s8, s3, 31
; GCN-NEXT:    s_and_b64 s[2:3], s[16:17], exec
; GCN-NEXT:    s_cselect_b32 s5, s5, s8
