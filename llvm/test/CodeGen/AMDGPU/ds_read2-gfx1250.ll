...
; RUN: llc -mtriple=amdgpu12.50--amdpal -mattr=+load-store-opt,+unaligned-access-mode < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250,GFX1250-UNALIGNED %s
; RUN: llc -mtriple=amdgpu12.50s--amdpal -mattr=+load-store-opt,+unaligned-access-mode < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250,GFX1250S-UNALIGNED %s
...
; GFX1250-UNALIGNED-LABEL: unaligned_read2_f32:
...
; GFX1250-UNALIGNED-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0 nv
; GFX1250-UNALIGNED-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_and_b32_e32 v2, 0xffc, v0
; GFX1250-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250-UNALIGNED-NEXT:    v_add_nc_u32_e32 v0, s2, v2
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[0:1], v0 offset1:8
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250-UNALIGNED-NEXT:    global_store_b32 v2, v0, s[0:1]
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: unaligned_read2_f32:
; GFX1250S-UNALIGNED:       ; %bb.0:
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
; GFX1250S-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250S-UNALIGNED-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0 nv
; GFX1250S-UNALIGNED-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; GFX1250S-UNALIGNED-NEXT:    v_add_nc_u32_e32 v1, s2, v0
; GFX1250S-UNALIGNED-NEXT:    ds_load_b32 v2, v1
; GFX1250S-UNALIGNED-NEXT:    ds_load_b32 v1, v1 offset:32
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v1, v2, v1
; GFX1250S-UNALIGNED-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-UNALIGNED-LABEL: misaligned_2_simple_read2_f32:
; GFX1250-UNALIGNED:       ; %bb.0:
; GFX1250-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
...
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: misaligned_2_simple_read2_f32:
; GFX1250S-UNALIGNED:       ; %bb.0:
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
...
; GFX1250-UNALIGNED-LABEL: misaligned_read2_f64:
; GFX1250-UNALIGNED:       ; %bb.0:
; GFX1250-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
; GFX1250-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250-UNALIGNED-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0 nv
; GFX1250-UNALIGNED-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_and_b32_e32 v4, 0x1ff8, v0
; GFX1250-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250-UNALIGNED-NEXT:    v_add_nc_u32_e32 v2, s2, v4
...
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: misaligned_read2_f64:
; GFX1250S-UNALIGNED:       ; %bb.0:
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
; GFX1250S-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250S-UNALIGNED-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0 nv
; GFX1250S-UNALIGNED-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_and_b32_e32 v4, 0x1ff8, v0
; GFX1250S-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250S-UNALIGNED-NEXT:    v_add_nc_u32_e32 v2, s2, v4
...
; GFX1250-UNALIGNED-LABEL: sgemm_inner_loop_read2_sequence:
; GFX1250-UNALIGNED:       ; %bb.0:
; GFX1250-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
; GFX1250-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250-UNALIGNED-NEXT:    s_bfe_u32 s0, ttmp6, 0x4000c
; GFX1250-UNALIGNED-NEXT:    s_and_b32 s1, ttmp6, 15
...
; GFX1250-UNALIGNED-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_lshrrev_b32 v0, 8, v0
; GFX1250-UNALIGNED-NEXT:    s_addk_co_i32 s0, 0xc60
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-UNALIGNED-NEXT:    v_mov_b32_e32 v2, s0
; GFX1250-UNALIGNED-NEXT:    v_and_b32_e32 v8, 0xffc, v0
; GFX1250-UNALIGNED-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[0:1], v1 offset1:1
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[2:3], v2 offset1:1
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[4:5], v8 offset1:1
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[6:7], v8 offset0:32 offset1:33
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x3
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x2
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v0, v0, v2
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v2, v0, v3
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[0:1], v8 offset0:64 offset1:65
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x2
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v4
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v5
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x1
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v6
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v7
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250-UNALIGNED-NEXT:    v_dual_add_f32 v0, v2, v0 :: v_dual_mov_b32 v2, 0
...
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: sgemm_inner_loop_read2_sequence:
; GFX1250S-UNALIGNED:       ; %bb.0:
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
; GFX1250S-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250S-UNALIGNED-NEXT:    s_bfe_u32 s0, ttmp6, 0x4000c
; GFX1250S-UNALIGNED-NEXT:    s_and_b32 s1, ttmp6, 15
; GFX1250S-UNALIGNED-NEXT:    s_add_co_i32 s0, s0, 1
; GFX1250S-UNALIGNED-NEXT:    s_getreg_b32 s2, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250S-UNALIGNED-NEXT:    s_mul_i32 s0, ttmp9, s0
...
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_dual_lshrrev_b32 v0, 8, v0 :: v_dual_mov_b32 v2, s0
; GFX1250S-UNALIGNED-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250S-UNALIGNED-NEXT:    v_and_b32_e32 v8, 0xffc, v0
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[0:1], v2 offset:3104
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[2:3], v2 offset:3168
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[4:5], v8
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[6:7], v8 offset:128
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x3
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v0, v0, v1
...
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v2, v0, v3
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[0:1], v8 offset:256
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x2
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v4
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v5
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x1
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v6
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v2, v2, v7
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250S-UNALIGNED-NEXT:    v_dual_add_f32 v0, v2, v0 :: v_dual_mov_b32 v2, 0
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250S-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250S-UNALIGNED-NEXT:    global_store_b32 v2, v0, s[0:1]
; GFX1250S-UNALIGNED-NEXT:    s_endpgm
...
; GFX1250-UNALIGNED-LABEL: misaligned_read2_v2i32:
; GFX1250-UNALIGNED:       ; %bb.0:
; GFX1250-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
...
; GFX1250-UNALIGNED-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0 nv
; GFX1250-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250-UNALIGNED-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[0:1], v0 offset1:1
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250-UNALIGNED-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: misaligned_read2_v2i32:
; GFX1250S-UNALIGNED:       ; %bb.0:
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
...
; GFX1250S-UNALIGNED-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0 nv
; GFX1250S-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250S-UNALIGNED-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[0:1], v0
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250S-UNALIGNED-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1250S-UNALIGNED-NEXT:    s_endpgm
...
; GFX1250-UNALIGNED-LABEL: misaligned_read2_i64:
; GFX1250-UNALIGNED:       ; %bb.0:
; GFX1250-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
...
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: misaligned_read2_i64:
; GFX1250S-UNALIGNED:       ; %bb.0:
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
...
; GFX1250-UNALIGNED-LABEL: ds_read_diff_base_interleaving:
; GFX1250-UNALIGNED:       ; %bb.0: ; %bb
; GFX1250-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
; GFX1250-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; GFX1250-UNALIGNED-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[0:1], v2 offset1:1
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[2:3], v3 offset1:4
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[4:5], v4 offset1:1
; GFX1250-UNALIGNED-NEXT:    ds_load_2addr_b32 v[6:7], v6 offset1:4
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x2
; GFX1250-UNALIGNED-NEXT:    v_dual_mul_f32 v0, v0, v2 :: v_dual_mul_f32 v1, v1, v3
; GFX1250-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_dual_mul_f32 v2, v4, v6 :: v_dual_add_f32 v0, 2.0, v0
; GFX1250-UNALIGNED-NEXT:    v_dual_sub_f32 v0, v0, v2 :: v_dual_mov_b32 v2, 0
; GFX1250-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-UNALIGNED-NEXT:    v_dual_sub_f32 v0, v0, v1 :: v_dual_mul_f32 v1, v5, v7
; GFX1250-UNALIGNED-NEXT:    v_sub_f32_e32 v0, v0, v1
; GFX1250-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250-UNALIGNED-NEXT:    global_store_b32 v2, v0, s[0:1] offset:40
; GFX1250-UNALIGNED-NEXT:    s_endpgm
;
; GFX1250S-UNALIGNED-LABEL: ds_read_diff_base_interleaving:
; GFX1250S-UNALIGNED:       ; %bb.0: ; %bb
; GFX1250S-UNALIGNED-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250S-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250S-UNALIGNED-NEXT:    v_nop
; GFX1250S-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; GFX1250S-UNALIGNED-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[0:1], v2
; GFX1250S-UNALIGNED-NEXT:    ds_load_2addr_b32 v[2:3], v3 offset1:4
; GFX1250S-UNALIGNED-NEXT:    ds_load_b64 v[4:5], v4
; GFX1250S-UNALIGNED-NEXT:    ds_load_2addr_b32 v[6:7], v6 offset1:4
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x2
; GFX1250S-UNALIGNED-NEXT:    v_dual_mul_f32 v0, v0, v2 :: v_dual_mul_f32 v1, v1, v3
; GFX1250S-UNALIGNED-NEXT:    s_wait_dscnt 0x0
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_dual_mul_f32 v2, v4, v6 :: v_dual_add_f32 v0, 2.0, v0
; GFX1250S-UNALIGNED-NEXT:    v_dual_sub_f32 v0, v0, v2 :: v_dual_mov_b32 v2, 0
; GFX1250S-UNALIGNED-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250S-UNALIGNED-NEXT:    v_dual_sub_f32 v0, v0, v1 :: v_dual_mul_f32 v1, v5, v7
; GFX1250S-UNALIGNED-NEXT:    v_sub_f32_e32 v0, v0, v1
; GFX1250S-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX1250S-UNALIGNED-NEXT:    global_store_b32 v2, v0, s[0:1] offset:40
; GFX1250S-UNALIGNED-NEXT:    s_endpgm
