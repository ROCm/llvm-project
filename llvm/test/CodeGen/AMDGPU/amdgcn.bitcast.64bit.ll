...
; SI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v2
...
; VI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v2
...
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v2
...
; VI-NEXT:    v_add_u32_e32 v3, vcc, s10, v3
...
; GFX9-NEXT:    v_add3_u32 v3, v3, v2, s10
...
; GFX9-NEXT:    v_add3_u32 v3, v3, v1, s10
; GFX9-NEXT:    v_or_b32_e32 v4, 0x400000, v1
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v3, v4, vcc
; GFX9-NEXT:    v_perm_b32 v1, v2, v1, s11
; GFX9-NEXT:  .LBB22_2:
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GFX9-NEXT:    s_and_b64 s[8:9], s[8:9], exec
...
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v8
; SI-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_mov_b64 s[4:5], 0
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v8
; VI-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v8
; GFX9-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e64 s1, 0, v8
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e64 s1, 0, v8
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
...
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_alignbit_b32 v2, v1, v4, 16
...
; SI-NEXT:    s_and_b32 s6, s8, 0xffff0000
...
; SI-NEXT:    v_alignbit_b32 v4, v2, v3, 16
; SI-NEXT:    s_mov_b64 s[10:11], 0
; SI-NEXT:  .LBB94_2:
; SI-NEXT:    s_or_b64 exec, exec, s[8:9]
; SI-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
...
; GFX9-NEXT:    v_perm_b32 v0, v0, v3, s10
; GFX9-NEXT:    v_perm_b32 v1, v2, v1, s10
; GFX9-NEXT:  .LBB94_2:
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GFX9-NEXT:    s_and_b64 s[8:9], s[8:9], exec
...
; VI-NEXT:    v_lshrrev_b32_e32 v4, 8, v9
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v7, v10 :: v_dual_add_f32 v1, 0x40c00000, v1
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v0, 0xffff0000, v0
; GFX11-TRUE16-NEXT:    v_bfe_u32 v4, v1, 16, 1
...
; GFX9-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add3_u32 v2, v2, v1, s10
; GFX9-NEXT:    v_or_b32_e32 v3, 0x400000, v1
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; GFX9-NEXT:    s_mov_b32 s11, 0x7060302
; GFX9-NEXT:    v_perm_b32 v10, v1, v0, s11
...
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v3, v4, vcc
; GFX9-NEXT:    v_perm_b32 v11, v1, v2, s11
