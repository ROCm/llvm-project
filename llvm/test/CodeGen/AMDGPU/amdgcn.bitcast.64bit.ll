...
; GFX9-NEXT:    s_mov_b32 s7, 0x7060c0c
; GFX9-NEXT:    v_bfe_u32 v3, v2, 16, 1
; GFX9-NEXT:    s_movk_i32 s6, 0x7fff
; GFX9-NEXT:    v_perm_b32 v0, v0, v0, s7
...
; GFX9-NEXT:    v_perm_b32 v0, v0, v2, s8
; GFX9-NEXT:    v_perm_b32 v2, v1, v1, s7
; GFX9-NEXT:    v_add_f32_e32 v2, 0x40c00000, v2
; GFX9-NEXT:    v_bfe_u32 v3, v2, 16, 1
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v2, v0, v0, 0x7060c0c
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v3, v1, v1, 0x7060c0c
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v2, 16, v0
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v0, v0, 0x7060c0c
...
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_mov_b32_e32 v5, 0x7060c0c
; VI-NEXT:    v_cndmask_b32_e32 v0, v1, v2, vcc
; VI-NEXT:    v_perm_b32 v1, s17, s17, v5
; VI-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
...
; VI-NEXT:    v_perm_b32 v1, s16, s16, v5
; VI-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; VI-NEXT:    v_bfe_u32 v3, v1, 16, 1
; VI-NEXT:    v_add_u32_e32 v3, vcc, v3, v1
; VI-NEXT:    v_add_u32_e32 v3, vcc, 0x7fff, v3
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0x7060c0c
; GFX9-NEXT:    v_perm_b32 v0, s16, s16, v1
; GFX9-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v2, 0x40c00000
; GFX9-NEXT:    v_add_f32_e32 v3, s4, v2
...
; GFX9-NEXT:    v_perm_b32 v1, s17, s17, v1
...
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v8, v8, v1
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v0, v6, v10 :: v_dual_add_nc_u32 v7, v7, v3
...
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v8, v8, v1
...
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v5, v5, v3
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v6, v9, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
...
; VI-NEXT:    v_perm_b32 v1, v2, v3, s7
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v1, v2, v3, 0x40c0c
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v2, v3, 0x40c0c
...
; VI-NEXT:    v_perm_b32 v2, s18, v2, v3
; VI-NEXT:    v_or_b32_e32 v0, v0, v2
; VI-NEXT:    v_mov_b32_e32 v2, s21
; VI-NEXT:    v_perm_b32 v1, s20, v2, v1
...
; VI-NEXT:    v_mov_b32_e32 v1, 0x40c0c
; VI-NEXT:    v_perm_b32 v2, s16, v2, v3
; VI-NEXT:    v_perm_b32 v0, s18, v0, v1
...
; VI-NEXT:    v_mov_b32_e32 v2, s23
; VI-NEXT:    v_perm_b32 v1, s22, v2, v1
; VI-NEXT:    s_add_i32 s20, s20, 3
; VI-NEXT:    v_mov_b32_e32 v2, s21
; VI-NEXT:    v_perm_b32 v2, s20, v2, v3
; VI-NEXT:    v_add_u32_e32 v2, vcc, 0x300, v2
...
; GFX9-NEXT:    v_perm_b32 v2, s18, v2, v3
; GFX9-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX9-NEXT:    v_mov_b32_e32 v2, s21
; GFX9-NEXT:    v_perm_b32 v1, s20, v2, v1
...
; GFX11-NEXT:    v_perm_b32 v1, s18, s19, v1
...
; VI-NEXT:  ; %bb.1: ; %cmp.false
; VI-NEXT:    s_cbranch_execnz .LBB89_4
; VI-NEXT:  .LBB89_2: ; %cmp.true
; VI-NEXT:    v_mov_b32_e32 v0, 0x7060c0c
; VI-NEXT:    s_add_i32 s5, s17, 3
; VI-NEXT:    v_perm_b32 v2, s16, s16, v0
; VI-NEXT:    s_add_i32 s4, s16, 3
; VI-NEXT:    v_perm_b32 v0, s17, s17, v0
; VI-NEXT:    s_and_b32 s5, s5, 0xffff
; VI-NEXT:    v_or_b32_e32 v0, s5, v0
; VI-NEXT:    s_and_b32 s4, s4, 0xffff
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x30000, v0
; VI-NEXT:    v_or_b32_e32 v0, s4, v2
; VI-NEXT:    v_add_u32_e32 v0, vcc, 0x30000, v0
; VI-NEXT:    s_setpc_b64 s[30:31]
; VI-NEXT:  .LBB89_3:
...
; VI-NEXT:  ; %bb.1: ; %cmp.false
; VI-NEXT:    s_cbranch_execnz .LBB93_4
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX9-NEXT:    v_add3_u32 v3, v3, v2, s7
; GFX9-NEXT:    v_or_b32_e32 v4, 0x400000, v2
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; GFX9-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v3, v4, vcc
; GFX9-NEXT:    v_bfe_u32 v3, v1, 16, 1
; GFX9-NEXT:    v_add3_u32 v3, v3, v1, s7
; GFX9-NEXT:    v_or_b32_e32 v4, 0x400000, v1
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v3, v4, vcc
...
; GFX9-NEXT:    v_bfe_u32 v4, v3, 16, 1
; GFX9-NEXT:    v_perm_b32 v0, v0, v0, s6
...
; GFX11-FAKE16-NEXT:  ; %bb.1: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_perm_b32 v2, v1, v1, 0x7060c0c
...
; VI-NEXT:    v_add_u32_e32 v4, vcc, 0x7fff, v4
; VI-NEXT:    v_perm_b32 v3, s17, s17, v3
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v1, v7 :: v_dual_add_nc_u32 v5, 0x7fff, v5
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v3, v5, v10 :: v_dual_add_nc_u32 v6, v6, v0
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v6, 0x7fff, v6
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v1, v6, v9 :: v_dual_add_nc_u32 v8, v8, v4
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v4, v7, vcc_lo
; GFX11-FAKE16-NEXT:    v_and_or_b32 v0, 0xffff0000, v0, v1
; GFX11-FAKE16-NEXT:    v_and_or_b32 v1, 0xffff0000, v5, v2
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_lshr_b32 s11, s16, 8
; VI-NEXT:    s_mov_b32 s8, s17
; VI-NEXT:    s_cbranch_execnz .LBB97_4
; VI-NEXT:  .LBB97_2: ; %cmp.true
; VI-NEXT:    s_lshr_b32 s5, s17, 16
; VI-NEXT:    s_add_i32 s8, s17, 3
...
; VI-NEXT:    v_mov_b32_e32 v1, s4
; VI-NEXT:    v_lshrrev_b64 v[3:4], 24, v[0:1]
; VI-NEXT:    s_lshr_b32 s10, s4, 8
; VI-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; VI-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; VI-NEXT:    s_bfe_u32 s9, s5, 0x80008
; VI-NEXT:    s_branch .LBB97_5
; VI-NEXT:  .LBB97_3:
; VI-NEXT:    ; implicit-def: $sgpr11
...
; GFX9-NEXT:    v_and_b32_sdwa v2, v4, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX9-NEXT:    v_lshl_or_b32 v1, v1, 16, v2
; GFX9-NEXT:    s_setpc_b64 s[30:31]
; GFX9-NEXT:  .LBB103_3:
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v1, v4, 16, v2
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    v_or_b32_e32 v2, 0x400000, v0
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_perm_b32 v0, v9, v9, s7
; VI-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
...
; VI-NEXT:    v_or_b32_e32 v4, 0x400000, v0
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_perm_b32 v0, v8, v8, s7
; VI-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
...
; GFX9-NEXT:    v_perm_b32 v1, v8, v8, s7
; GFX9-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
...
; GFX9-NEXT:    v_perm_b32 v1, v9, v9, s7
; GFX9-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add3_u32 v2, v2, v1, s6
; GFX9-NEXT:    v_or_b32_e32 v3, 0x400000, v1
...
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v3, v4, vcc
; GFX9-NEXT:    v_perm_b32 v11, v1, v2, s8
...
; GFX11-FAKE16-NEXT:  ; %bb.3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v8, v8, 0x7060c0c
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v0, 16, v8
; GFX11-FAKE16-NEXT:    v_perm_b32 v2, v9, v9, 0x7060c0c
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v1, v6, v7, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
...
; VI-NEXT:    v_or_b32_e32 v4, 0x400000, v0
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_perm_b32 v0, s16, s16, v3
; VI-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; VI-NEXT:    v_bfe_u32 v3, v0, 16, 1
...
; GFX9-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GFX9-NEXT:    v_lshl_or_b32 v9, v2, 16, v4
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add_u32_e32 v2, v2, v1
; GFX9-NEXT:    v_add_u32_e32 v2, 0x7fff, v2
; GFX9-NEXT:    v_or_b32_e32 v4, 0x400000, v1
...
; GFX9-NEXT:    s_lshl_b32 s4, s17, 16
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX9-NEXT:    v_add_f32_e32 v1, s4, v3
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add_u32_e32 v2, v2, v1
; GFX9-NEXT:    v_add_u32_e32 v2, 0x7fff, v2
; GFX9-NEXT:    v_or_b32_e32 v3, 0x400000, v1
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v6, 0x7fff, v6
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v6, v6, v10 :: v_dual_add_nc_u32 v7, v7, v3
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v0, v4, v5 :: v_dual_add_nc_u32 v7, 0x7fff, v7
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
