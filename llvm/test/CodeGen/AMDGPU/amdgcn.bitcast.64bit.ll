...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v3, v7, v10, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v1, v9, v11, vcc_lo
...
; GFX9-NEXT:    v_and_b32_sdwa v1, v5, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v2, v7, vcc_lo
...
; GFX9-NEXT:    v_bfe_u32 v3, v2, 16, 1
; GFX9-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GFX9-NEXT:    v_add3_u32 v10, v10, v0, s6
...
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v5, v6, vcc
; GFX9-NEXT:    v_perm_b32 v0, v0, v7, s6
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v3, v7, v10, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v9, v11, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v1, v6, v8, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; VI-NEXT:    v_bfe_u32 v1, v4, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v4
; VI-NEXT:    s_and_b32 s4, s16, 0xffff0000
; VI-NEXT:    v_add_u32_e32 v5, vcc, 0x7fff, v1
...
; VI-NEXT:    v_add_u32_e32 v7, vcc, 0x7fff, v3
...
; VI-NEXT:    v_cndmask_b32_e32 v0, v3, v9, vcc
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
...
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX9-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX9-NEXT:    v_mov_b32_e32 v10, 0xffff0000
; GFX9-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; GFX9-NEXT:    v_and_or_b32 v0, v7, v10, v0
; GFX9-NEXT:    v_and_or_b32 v1, v1, v10, v4
; GFX9-NEXT:    s_setpc_b64 s[30:31]
; GFX9-NEXT:  .LBB95_3:
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v6, v9 :: v_dual_add_nc_u32 v7, 0x7fff, v7
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v5, 0x7fff, v5
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v5, v5, v10 :: v_dual_add_nc_u32 v4, v4, v1
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v4, 0x7fff, v4
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v0, v7, v11, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v2.h
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v1, v4, v8, vcc_lo
...
; GFX11-FAKE16-NEXT:    s_lshl_b32 s3, s1, 16
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v3, v9, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
...
; GFX11-FAKE16-NEXT:    v_and_or_b32 v0, 0xffff0000, v3, v0
...
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v6, 0x7fff, v6
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v5, 0x7fff, v5
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v4, v4, v0
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v7, 0x7fff, v7
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v1, v5, v9, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v2, v6, v11, vcc_lo
...
; VI-NEXT:    v_and_b32_e32 v3, 0xffff0000, v9
; VI-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
...
; VI-NEXT:    v_and_b32_e32 v5, 0xffff0000, v8
; VI-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; VI-NEXT:    v_add_f32_e32 v5, 0x40c00000, v5
...
; VI-NEXT:    v_alignbit_b32 v0, v5, v3, 16
...
; GFX9-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; GFX9-NEXT:    v_and_b32_e32 v3, 0xffff0000, v8
...
; GFX11-FAKE16-NEXT:    v_bfe_u32 v9, v3, 16, 1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v1, v6, v8 :: v_dual_add_f32 v2, 0x40c00000, v2
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v3, v9, v11, vcc_lo
...
; VI-NEXT:    v_add_u32_e32 v3, vcc, v3, v2
; VI-NEXT:    v_add_f32_e32 v0, s4, v0
; VI-NEXT:    v_add_u32_e32 v4, vcc, 0x7fff, v3
; VI-NEXT:    v_bfe_u32 v3, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v3, vcc, v3, v0
; VI-NEXT:    v_add_u32_e32 v3, vcc, 0x7fff, v3
; VI-NEXT:    v_or_b32_e32 v8, 0x400000, v0
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_or_b32_e32 v7, 0x400000, v2
; VI-NEXT:    v_cndmask_b32_e32 v0, v3, v8, vcc
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; VI-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; VI-NEXT:    v_cndmask_b32_e32 v2, v4, v7, vcc
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v4, 0x7fff, v4
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v4, v4, v8 :: v_dual_add_nc_u32 v5, v5, v1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v5, 0x7fff, v5
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v3, v6, v10, vcc_lo
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v2, v7, v2, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v1, v5, v6 :: v_dual_add_nc_u32 v8, 0x7fff, v9
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v9, v2, 16, v1
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v10, v6, 16, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
