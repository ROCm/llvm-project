...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.00 | FileCheck %s -check-prefixes=GFX89,SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02  | FileCheck %s -check-prefixes=GFX89,VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.00 | FileCheck %s -check-prefixes=GFX89,GFX9
; RUN: llc < %s -mtriple=r600 -mcpu=redwood  | FileCheck %s --check-prefix=R600
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 | FileCheck %s -check-prefixes=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=-real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX12,GFX12-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -mattr=-real-true16 | FileCheck %s -check-prefixes=GFX12,GFX12-FAKE16
