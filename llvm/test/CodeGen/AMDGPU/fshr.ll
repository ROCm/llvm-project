...
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti | FileCheck %s -check-prefixes=GFX89,SI
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga  | FileCheck %s -check-prefixes=GFX89,VI
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 | FileCheck %s -check-prefixes=GFX89,GFX9
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=r600 -mcpu=redwood  | FileCheck %s --check-prefix=R600
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 | FileCheck %s -check-prefixes=GFX10
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11-TRUE16
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11-FAKE16
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX12,GFX12-TRUE16
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 | FileCheck %s -check-prefixes=GFX12,GFX12-FAKE16
...
; VI-NEXT:    s_and_b32 s6, s2, 31
; VI-NEXT:    s_mov_b32 s2, s1
; VI-NEXT:    s_mov_b32 s3, s0
; VI-NEXT:    s_lshr_b64 s[0:1], s[2:3], s6
...
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0xb
...
; SI-NEXT:    s_mov_b32 s11, s8
; SI-NEXT:    s_and_b32 s4, s4, 31
; SI-NEXT:    s_lshr_b64 s[6:7], s[6:7], s5
; SI-NEXT:    s_lshr_b64 s[4:5], s[10:11], s4
; SI-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-NEXT:    s_and_b32 s1, s5, 31
; VI-NEXT:    s_mov_b32 s3, s0
; VI-NEXT:    s_and_b32 s0, s4, 31
...
; GFX9-NEXT:    s_and_b32 s1, s9, 31
; GFX9-NEXT:    s_mov_b32 s3, s0
; GFX9-NEXT:    s_and_b32 s0, s8, 31
...
; SI-NEXT:    s_lshr_b64 s[4:5], s[6:7], 7
; SI-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-NEXT:    s_mov_b32 s3, s0
; VI-NEXT:    s_lshr_b64 s[6:7], s[6:7], 9
; VI-NEXT:    s_lshr_b64 s[0:1], s[2:3], 7
...
; GFX9-NEXT:    s_mov_b32 s4, s3
; GFX9-NEXT:    s_mov_b32 s3, s0
; GFX9-NEXT:    s_lshr_b64 s[4:5], s[4:5], 9
; GFX9-NEXT:    s_lshr_b64 s[0:1], s[2:3], 7
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-NEXT:    global_store_dwordx2 v2, v[0:1], s[6:7]
; GFX9-NEXT:    s_endpgm
...
; GFX10-NEXT:    s_mov_b32 s0, s3
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[4:5], 7
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[0:1], 9
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[0:1], 9
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s0
; GFX11-NEXT:    v_mov_b32_e32 v0, s2
; GFX11-NEXT:    global_store_b64 v2, v[0:1], s[4:5]
...
; GFX12-NEXT:    s_lshr_b64 s[0:1], s[0:1], 9
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s0
; GFX12-NEXT:    v_mov_b32_e32 v0, s2
; GFX12-NEXT:    global_store_b64 v2, v[0:1], s[4:5]
...
; GFX10-NEXT:    s_and_b32 s1, s2, 31
; GFX10-NEXT:    s_mov_b32 s9, s0
; GFX10-NEXT:    s_and_b32 s2, s3, 31
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[8:9], s1
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[4:5], s2
...
; GFX11-NEXT:    s_and_b32 s1, s2, 31
; GFX11-NEXT:    s_mov_b32 s9, s0
; GFX11-NEXT:    s_and_b32 s2, s3, 31
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[8:9], s1
...
; GFX12-NEXT:    s_and_b32 s1, s2, 31
; GFX12-NEXT:    s_mov_b32 s9, s0
; GFX12-NEXT:    s_and_b32 s2, s3, 31
; GFX12-NEXT:    s_lshr_b64 s[0:1], s[8:9], s1
...
; GFX10-NEXT:    s_and_b32 s16, s2, 31
; GFX10-NEXT:    s_mov_b32 s3, s9
; GFX10-NEXT:    s_and_b32 s17, s1, 31
; GFX10-NEXT:    s_and_b32 s9, s0, 31
...
; GFX10-NEXT:    s_lshr_b64 s[4:5], s[14:15], s16
; GFX10-NEXT:    s_lshr_b64 s[8:9], s[12:13], s9
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[2:3], s17
...
; GFX11-NEXT:    s_and_b32 s16, s2, 31
; GFX11-NEXT:    s_mov_b32 s3, s9
; GFX11-NEXT:    s_and_b32 s17, s1, 31
; GFX11-NEXT:    s_and_b32 s9, s0, 31
...
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[14:15], s16
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[12:13], s9
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], s17
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12-NEXT:    s_and_b32 s16, s2, 31
; GFX12-NEXT:    s_mov_b32 s3, s9
; GFX12-NEXT:    s_and_b32 s17, s1, 31
; GFX12-NEXT:    s_and_b32 s9, s0, 31
...
; GFX12-NEXT:    s_lshr_b64 s[6:7], s[14:15], s16
; GFX12-NEXT:    s_lshr_b64 s[8:9], s[12:13], s9
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[2:3], s17
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; SI-NEXT:    s_mov_b32 s7, s2
; SI-NEXT:    s_mov_b32 s13, s3
; SI-NEXT:    s_lshr_b64 s[2:3], s[6:7], 9
; SI-NEXT:    s_mov_b32 s6, s5
; SI-NEXT:    s_mov_b32 s7, s1
; SI-NEXT:    s_mov_b32 s5, s0
; SI-NEXT:    s_lshr_b64 s[12:13], s[12:13], 1
; SI-NEXT:    s_lshr_b64 s[6:7], s[6:7], 7
; SI-NEXT:    s_lshr_b64 s[0:1], s[4:5], 1
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    v_mov_b32_e32 v1, s6
...
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x34
; GFX10-NEXT:    s_load_dwordx2 s[18:19], s[4:5], 0x24
; GFX10-NEXT:    s_mov_b32 s1, 33
; GFX10-NEXT:    s_mov_b32 s3, 9
; GFX10-NEXT:    s_mov_b32 s7, 7
; GFX10-NEXT:    s_mov_b32 s17, 1
; GFX10-NEXT:    v_mov_b32_e32 v4, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s15, s15, 31
; GFX10-NEXT:    s_mov_b32 s2, s10
; GFX10-NEXT:    s_and_b32 s4, s14, 31
; GFX10-NEXT:    s_and_b32 s10, s13, 31
; GFX10-NEXT:    s_mov_b32 s16, s8
; GFX10-NEXT:    s_and_b32 s5, s12, 31
; GFX10-NEXT:    s_mov_b32 s0, s11
; GFX10-NEXT:    s_mov_b32 s6, s9
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[2:3], s4
; GFX10-NEXT:    s_lshr_b64 s[4:5], s[16:17], s5
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[0:1], s15
; GFX10-NEXT:    s_lshr_b64 s[6:7], s[6:7], s10
; GFX10-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-NEXT:    v_mov_b32_e32 v2, s2
; GFX10-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-NEXT:    v_mov_b32_e32 v3, s0
; GFX10-NEXT:    global_store_dwordx4 v4, v[0:3], s[18:19]
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_load_b256 s[8:15], s[4:5], 0x34
; GFX11-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
; GFX11-NEXT:    s_mov_b32 s3, 9
; GFX11-NEXT:    s_mov_b32 s1, 33
; GFX11-NEXT:    s_mov_b32 s7, 7
; GFX11-NEXT:    s_mov_b32 s17, 1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s2, s10
; GFX11-NEXT:    s_and_b32 s6, s14, 31
; GFX11-NEXT:    s_and_b32 s15, s15, 31
; GFX11-NEXT:    s_and_b32 s10, s13, 31
; GFX11-NEXT:    s_mov_b32 s16, s8
; GFX11-NEXT:    s_and_b32 s8, s12, 31
; GFX11-NEXT:    s_mov_b32 s0, s11
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
; GFX11-NEXT:    s_mov_b32 s6, s9
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[16:17], s8
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[0:1], s15
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[6:7], s10
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v1, s6
; GFX11-NEXT:    v_dual_mov_b32 v0, s8 :: v_dual_mov_b32 v3, s0
...
; GFX12-NEXT:    s_load_b256 s[8:15], s[4:5], 0x34
; GFX12-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
; GFX12-NEXT:    s_mov_b32 s3, 9
; GFX12-NEXT:    s_mov_b32 s1, 33
; GFX12-NEXT:    s_mov_b32 s7, 7
; GFX12-NEXT:    s_mov_b32 s17, 1
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mov_b32 s2, s10
; GFX12-NEXT:    s_and_b32 s6, s14, 31
; GFX12-NEXT:    s_and_b32 s15, s15, 31
; GFX12-NEXT:    s_and_b32 s10, s13, 31
; GFX12-NEXT:    s_mov_b32 s16, s8
; GFX12-NEXT:    s_and_b32 s8, s12, 31
; GFX12-NEXT:    s_mov_b32 s0, s11
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
; GFX12-NEXT:    s_mov_b32 s6, s9
; GFX12-NEXT:    s_lshr_b64 s[8:9], s[16:17], s8
; GFX12-NEXT:    s_lshr_b64 s[0:1], s[0:1], s15
; GFX12-NEXT:    s_lshr_b64 s[6:7], s[6:7], s10
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v1, s6
; GFX12-NEXT:    v_dual_mov_b32 v0, s8 :: v_dual_mov_b32 v3, s0
