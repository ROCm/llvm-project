...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 < %s | FileCheck -check-prefixes=CI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck -check-prefixes=GFX11,GFX1100 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.50 < %s | FileCheck -check-prefixes=GFX11,GFX1150 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 < %s | FileCheck -check-prefixes=GFX1250 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11 --amdhsa-code-object-version=6 < %s | FileCheck -check-prefixes=GFX11,GFX1100 %s
