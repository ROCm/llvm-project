...
; CHECK-NEXT:    v_lshrrev_b64 v[0:1], v4, v[0:1]
; CHECK-NEXT:    v_cndmask_b32_e32 v4, 63, v6, vcc
; CHECK-NEXT:    v_lshrrev_b64 v[2:3], v4, v[2:3]
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_lshrrev_b64 v[0:1], v6, v[0:1]
; CHECK-NEXT:    v_cndmask_b32_e32 v6, 63, v8, vcc
; CHECK-NEXT:    v_cmp_gt_u64_e32 vcc, 63, v[10:11]
; CHECK-NEXT:    v_lshrrev_b64 v[2:3], v6, v[2:3]
; CHECK-NEXT:    v_cndmask_b32_e32 v6, 63, v10, vcc
; CHECK-NEXT:    v_lshrrev_b64 v[4:5], v6, v[4:5]
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_cmp_gt_u64_e32 vcc, 63, v[10:11]
; CHECK-NEXT:    v_lshrrev_b64 v[0:1], v8, v[0:1]
; CHECK-NEXT:    v_cndmask_b32_e32 v8, 63, v10, vcc
; CHECK-NEXT:    v_cmp_gt_u64_e32 vcc, 63, v[12:13]
; CHECK-NEXT:    v_lshrrev_b64 v[2:3], v8, v[2:3]
; CHECK-NEXT:    v_cndmask_b32_e32 v8, 63, v12, vcc
; CHECK-NEXT:    v_cmp_gt_u64_e32 vcc, 63, v[14:15]
; CHECK-NEXT:    v_lshrrev_b64 v[4:5], v8, v[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v8, 63, v14, vcc
; CHECK-NEXT:    v_lshrrev_b64 v[6:7], v8, v[6:7]
; CHECK-NEXT:    s_setpc_b64 s[30:31]
