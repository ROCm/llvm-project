...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.50 %s -o - | FileCheck --check-prefixes=CHECK-G-UNKNOWN %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.50-unknown-mesa3d %s -o - | FileCheck -check-prefixes=CHECK-G-MESA3D %s
