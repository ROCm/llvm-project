...
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa %s -o - | FileCheck -check-prefix=GFX1250-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.50-amd-amdhsa -global-isel %s -o - | FileCheck -check-prefix=GFX1250-GISEL %s
