...
; GCN-NEXT:    v_mul_lo_u32 v6, s10, v0
...
; GCN-NEXT:    v_mul_hi_u32 v5, v1, v2
; GCN-NEXT:    v_mul_lo_u32 v2, v1, v2
...
; GCN-IR-NEXT:    s_lshr_b64 s[10:11], s[2:3], s14
...
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    v_mul_lo_u32 v2, s4, v0
; GCN-NEXT:    s_mov_b32 s4, s0
...
; GCN-IR-NEXT:    s_mov_b32 s5, s1
; GCN-IR-NEXT:    v_mul_lo_u32 v2, s4, v0
; GCN-IR-NEXT:    s_mov_b32 s4, s0
...
; GCN-NEXT:    s_sub_u32 s1, 0, s6
; GCN-NEXT:    s_mov_b32 s0, s4
; GCN-NEXT:    s_subb_u32 s4, 0, s7
; GCN-NEXT:    v_madmk_f32 v0, v1, 0x4f800000, v0
; GCN-NEXT:    v_rcp_f32_e32 v0, v0
; GCN-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GCN-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
...
; GCN-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GCN-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GCN-NEXT:    v_mul_hi_u32 v2, s1, v0
; GCN-NEXT:    v_readfirstlane_b32 s8, v1
; GCN-NEXT:    v_readfirstlane_b32 s9, v0
; GCN-NEXT:    s_mul_i32 s10, s1, s8
; GCN-NEXT:    v_readfirstlane_b32 s13, v2
; GCN-NEXT:    s_mul_i32 s11, s4, s9
; GCN-NEXT:    s_mul_i32 s12, s1, s9
...
; GCN-NEXT:    s_add_u32 s10, s11, s10
; GCN-NEXT:    s_addc_u32 s4, s12, s4
; GCN-NEXT:    v_readfirstlane_b32 s10, v0
; GCN-NEXT:    s_addc_u32 s10, s10, 0
; GCN-NEXT:    s_mul_i32 s1, s8, s1
; GCN-NEXT:    s_add_u32 s1, s4, s1
; GCN-NEXT:    s_addc_u32 s4, 0, s10
; GCN-NEXT:    s_add_u32 s1, s9, s1
; GCN-NEXT:    s_addc_u32 s4, s8, s4
; GCN-NEXT:    v_mul_hi_u32 v1, s1, 24
...
; GCN-NEXT:    s_mul_i32 s4, s7, s8
; GCN-NEXT:    v_readfirstlane_b32 s5, v0
; GCN-NEXT:    s_add_i32 s9, s5, s4
; GCN-NEXT:    s_sub_i32 s10, 0, s9
; GCN-NEXT:    s_mul_i32 s4, s6, s8
; GCN-NEXT:    s_sub_u32 s11, 24, s4
; GCN-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GCN-NEXT:    s_subb_u32 s10, s10, s7
; GCN-NEXT:    s_sub_u32 s12, s11, s6
; GCN-NEXT:    s_subb_u32 s10, s10, 0
; GCN-NEXT:    s_cmp_ge_u32 s10, s7
; GCN-NEXT:    s_cselect_b32 s13, -1, 0
; GCN-NEXT:    s_cmp_ge_u32 s12, s6
...
; GCN-NEXT:    s_cmp_ge_u32 s11, s6
; GCN-NEXT:    s_cselect_b32 s6, -1, 0
; GCN-NEXT:    s_cmp_eq_u32 s4, s7
; GCN-NEXT:    s_cselect_b32 s4, s6, s5
; GCN-NEXT:    s_cmp_lg_u32 s4, 0
; GCN-NEXT:    s_cselect_b32 s4, s12, 0
; GCN-NEXT:    s_cselect_b32 s5, s10, s8
...
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[6:7], 63, v[4:5]
...
; GCN-IR-NEXT:  .LBB9_2: ; %udiv-preheader
...
; GCN-IR-NEXT:  .LBB10_2: ; %udiv-preheader
...
; GCN-NEXT:    s_mul_i32 s1, s3, 0xaaaaaaab
; GCN-NEXT:    v_add_i32_e32 v3, vcc, s1, v3
; GCN-NEXT:    s_mov_b32 s4, s0
...
; GCN-NEXT:    v_addc_u32_e64 v2, s[0:1], 0, 0, vcc
...
; GCN-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; GCN-NEXT:    v_sub_i32_e64 v3, s[4:5], v2, v0
...
; GCN-IR-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; GCN-IR-NEXT:    v_sub_i32_e64 v3, s[4:5], v2, v0
...
; GCN-IR-NEXT:    v_min_u32_e32 v6, s4, v0
; GCN-IR-NEXT:    s_mov_b32 s8, 0
; GCN-IR-NEXT:    v_sub_i32_e64 v2, s[4:5], 48, v6
; GCN-IR-NEXT:    v_mov_b32_e32 v5, s8
...
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execz .LBB17_4
; GCN-IR-NEXT:  .LBB17_2: ; %udiv-preheader
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 0xffffffcf, v6
