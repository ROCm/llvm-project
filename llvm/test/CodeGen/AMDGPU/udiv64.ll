...
; GCN-NEXT:    v_mul_lo_u32 v2, s5, v1
; GCN-NEXT:    v_mul_hi_u32 v3, s5, v0
; GCN-NEXT:    v_mul_lo_u32 v5, s10, v0
...
; GCN-NEXT:    v_mul_lo_u32 v2, s5, v1
; GCN-NEXT:    v_mul_hi_u32 v3, s5, v0
; GCN-NEXT:    v_mul_lo_u32 v4, s10, v0
; GCN-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GCN-NEXT:    v_mul_lo_u32 v3, s5, v0
...
; GCN-NEXT:    v_addc_u32_e32 v0, vcc, v2, v6, vcc
...
; GCN-NEXT:    v_mul_hi_u32 v14, v5, v9
...
; GCN-NEXT:    v_addc_u32_e32 v9, vcc, v10, v14, vcc
...
; GCN-NEXT:    v_addc_u32_e32 v4, vcc, v6, v10, vcc
...
; GCN-NEXT:    v_cndmask_b32_e32 v6, v8, v6, vcc
; GCN-NEXT:    v_add_i32_e32 v7, vcc, 2, v4
; GCN-NEXT:    v_addc_u32_e32 v8, vcc, 0, v5, vcc
; GCN-NEXT:    v_add_i32_e32 v9, vcc, 1, v4
; GCN-NEXT:    v_addc_u32_e32 v10, vcc, 0, v5, vcc
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GCN-NEXT:    v_cndmask_b32_e32 v6, v9, v7, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v7, v10, v8, vcc
...
; GCN-IR-NEXT:    v_sub_i32_e64 v8, s[6:7], v11, v10
...
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
...
; GCN-IR-NEXT:    s_xor_b64 s[6:7], vcc, -1
; GCN-IR-NEXT:    s_and_saveexec_b64 s[8:9], s[6:7]
; GCN-IR-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GCN-IR-NEXT:    s_cbranch_execz .LBB1_5
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    v_not_b32_e32 v6, v11
; GCN-IR-NEXT:    v_add_i32_e32 v11, vcc, -1, v2
; GCN-IR-NEXT:    v_addc_u32_e32 v12, vcc, -1, v3, vcc
; GCN-IR-NEXT:    v_lshr_b64 v[0:1], v[0:1], v8
; GCN-IR-NEXT:    v_add_i32_e32 v10, vcc, v6, v10
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_addc_u32_e64 v13, s[10:11], -1, 0, vcc
...
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_lshr_b32 s8, s0, 8
...
; GCN-IR-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
...
; GCN-NEXT:    v_sub_i32_e32 v3, vcc, v1, v0
...
; GCN-IR-NEXT:    v_sub_i32_e32 v3, vcc, v1, v0
...
; GCN-NEXT:    s_lshr_b64 s[6:7], s[0:1], 24
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s6
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-NEXT:    s_sub_i32 s4, 0, s6
; GCN-NEXT:    v_rcp_f32_e32 v0, v0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    s_lshr_b64 s[4:5], s[2:3], 24
...
; GCN-IR-NEXT:    s_lshr_b64 s[4:5], s[2:3], 24
; GCN-IR-NEXT:    s_mov_b32 s3, 0xf000
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    v_mul_hi_u32 v1, v0, v1
; GCN-IR-NEXT:    buffer_store_short v2, off, s[0:3], 0 offset:4
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
...
; GCN-NEXT:    v_mul_hi_u32 v12, v3, v9
...
; GCN-NEXT:    v_sub_i32_e32 v6, vcc, v4, v0
...
; GCN-NEXT:    v_cndmask_b32_e32 v5, v7, v6, vcc
; GCN-NEXT:    v_add_i32_e32 v6, vcc, 2, v2
; GCN-NEXT:    v_addc_u32_e64 v7, s[4:5], 0, 0, vcc
; GCN-NEXT:    v_add_i32_e32 v8, vcc, 1, v2
; GCN-NEXT:    v_addc_u32_e64 v9, s[4:5], 0, 0, vcc
...
; GCN-IR-NEXT:    v_mov_b32_e32 v2, 0
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[4:5], s[6:7]
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
...
; GCN-IR-NEXT:    v_lshr_b64 v[8:9], s[8:9], v6
...
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, v11, v8
; GCN-IR-NEXT:    v_subb_u32_e32 v4, vcc, v12, v9, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v2, v6, v2
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v6, 31, v4
; GCN-IR-NEXT:    v_add_i32_e32 v10, vcc, 1, v10
; GCN-IR-NEXT:    v_and_b32_e32 v15, v6, v0
; GCN-IR-NEXT:    v_addc_u32_e32 v13, vcc, 0, v13, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v3, v7, v3
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v6
; GCN-IR-NEXT:    v_and_b32_e32 v14, v6, v1
; GCN-IR-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GCN-IR-NEXT:    v_mov_b32_e32 v7, v5
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v8, v15
; GCN-IR-NEXT:    v_mov_b32_e32 v6, v4
; GCN-IR-NEXT:    v_subb_u32_e32 v9, vcc, v9, v14, vcc
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[8:9]
...
; GCN-IR-NEXT:    v_sub_i32_e64 v6, s[4:5], 48, v8
...
; GCN-IR-NEXT:    v_addc_u32_e64 v9, s[12:13], 0, -1, vcc
...
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, s10, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, 0, v7, vcc
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 1, v8
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v0
; GCN-IR-NEXT:    v_and_b32_e32 v10, 0x8000, v0
; GCN-IR-NEXT:    v_addc_u32_e32 v9, vcc, 0, v9, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v3, v1, v3
; GCN-IR-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GCN-IR-NEXT:    v_mov_b32_e32 v0, v4
; GCN-IR-NEXT:    v_sub_i32_e32 v6, vcc, v6, v10
...
; GCN-NEXT:    s_mov_b32 s6, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mul_hi_u32 v3, s3, v2
; GCN-NEXT:    v_mul_hi_u32 v2, s2, v2
; GCN-NEXT:    v_mul_hi_u32 v1, s2, v0
; GCN-NEXT:    s_mul_i32 s5, s3, 0xaaaaaaab
; GCN-NEXT:    v_mul_hi_u32 v4, s3, v0
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s4, 0xaaaaaaaa
; GCN-NEXT:    s_mov_b32 s5, 0xaaaaaaab
; GCN-NEXT:    v_mul_hi_u32 v2, v0, s4
; GCN-NEXT:    v_mul_lo_u32 v3, v0, s4
; GCN-NEXT:    v_mul_lo_u32 v5, v1, s5
; GCN-NEXT:    v_mul_hi_u32 v0, v0, s5
; GCN-NEXT:    v_mul_hi_u32 v4, v1, s5
; GCN-NEXT:    v_mul_hi_u32 v6, v1, s4
...
; GCN-NEXT:    v_addc_u32_e64 v2, s[4:5], 0, 0, vcc
...
; GCN-IR-NEXT:    v_ffbh_u32_e32 v3, v1
; GCN-IR-NEXT:    v_min_u32_e32 v8, v2, v3
; GCN-IR-NEXT:    v_sub_i32_e64 v6, s[4:5], 59, v8
; GCN-IR-NEXT:    v_subb_u32_e64 v7, s[4:5], 0, 0, s[4:5]
; GCN-IR-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[0:1]
; GCN-IR-NEXT:    v_cmp_lt_u64_e64 s[4:5], 63, v[6:7]
; GCN-IR-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
...
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], v[0:1], v6
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 0xffffffc4, v8
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
; GCN-IR-NEXT:    v_mov_b32_e32 v0, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v1, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
; GCN-IR-NEXT:    v_addc_u32_e64 v9, s[10:11], 0, -1, vcc
...
; GCN-IR-NEXT:    v_or_b32_e32 v6, v6, v4
; GCN-IR-NEXT:    v_or_b32_e32 v2, v0, v2
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, 23, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, 0, v7, vcc
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 1, v8
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v0
; GCN-IR-NEXT:    v_and_b32_e32 v10, 24, v0
; GCN-IR-NEXT:    v_addc_u32_e32 v9, vcc, 0, v9, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v3, v1, v3
; GCN-IR-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GCN-IR-NEXT:    v_mov_b32_e32 v0, v4
...
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    v_readfirstlane_b32 s1, v0
; GCN-NEXT:    s_mulk_i32 s1, 0x5b7f
; GCN-NEXT:    s_sub_i32 s0, s0, s1
; GCN-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GCN-NEXT:    s_cmpk_gt_u32 s0, 0x5b7e
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-NEXT:    s_add_i32 s1, s0, 0xffffa481
; GCN-NEXT:    s_min_u32 s0, s1, s0
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GCN-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
; GCN-NEXT:    s_cmpk_gt_u32 s0, 0x5b7e
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-IR-NEXT:    s_mulk_i32 s1, 0x5b7f
; GCN-IR-NEXT:    s_sub_i32 s0, s0, s1
; GCN-IR-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GCN-IR-NEXT:    s_cmpk_gt_u32 s0, 0x5b7e
; GCN-IR-NEXT:    s_cselect_b64 vcc, -1, 0
; GCN-IR-NEXT:    s_add_i32 s1, s0, 0xffffa481
; GCN-IR-NEXT:    s_min_u32 s0, s1, s0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GCN-IR-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
; GCN-IR-NEXT:    s_cmpk_gt_u32 s0, 0x5b7e
; GCN-IR-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_sub_i32_e32 v4, vcc, v2, v0
...
; GCN-IR-NEXT:    v_mul_u32_u24_e32 v2, v1, v0
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, 24, v2
; GCN-IR-NEXT:    v_add_i32_e32 v3, vcc, 1, v1
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, v2, v0
; GCN-IR-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; GCN-IR-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; GCN-IR-NEXT:    v_add_i32_e32 v3, vcc, 1, v1
; GCN-IR-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v0, v1, v3, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v1, 0
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
  %x.shr = lshr i64 %x, 40
  %result = udiv i64 24, %x.shr
...
; GCN-IR-NEXT:    v_mul_u32_u24_e32 v2, v1, v0
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, 0x8000, v2
; GCN-IR-NEXT:    v_add_i32_e32 v3, vcc, 1, v1
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, v2, v0
; GCN-IR-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
...
; GCN-IR:       ; %bb.0: ; %_udiv-special-cases
; GCN-IR-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-IR-NEXT:    v_lshrrev_b32_e32 v4, 8, v1
; GCN-IR-NEXT:    v_ffbh_u32_e32 v0, v4
; GCN-IR-NEXT:    v_add_i32_e64 v0, s[4:5], 32, v0
; GCN-IR-NEXT:    s_flbit_i32_b32 s4, 0
; GCN-IR-NEXT:    v_min_u32_e32 v8, s4, v0
; GCN-IR-NEXT:    s_mov_b32 s6, 0
; GCN-IR-NEXT:    v_sub_i32_e64 v6, s[4:5], 48, v8
; GCN-IR-NEXT:    v_mov_b32_e32 v5, s6
; GCN-IR-NEXT:    v_subb_u32_e64 v7, s[4:5], 0, 0, s[4:5]
...
; GCN-IR-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GCN-IR-NEXT:    v_cmp_ne_u64_e32 vcc, 63, v[6:7]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, v4, 0, s[4:5]
; GCN-IR-NEXT:    s_xor_b64 s[4:5], s[4:5], -1
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[4:5], vcc
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
; GCN-IR-NEXT:    s_cbranch_execz .LBB17_6
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, 63, v6
; GCN-IR-NEXT:    v_add_i32_e32 v6, vcc, 1, v6
...
; GCN-IR-NEXT:    s_and_saveexec_b64 s[8:9], s[6:7]
; GCN-IR-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GCN-IR-NEXT:    s_cbranch_execz .LBB17_5
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
...
; GCN-IR-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, s10, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v2, vcc, 0, v7, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v0, v4, v0
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v4, 31, v2
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 1, v8
; GCN-IR-NEXT:    v_and_b32_e32 v10, 0x8000, v4
; GCN-IR-NEXT:    v_addc_u32_e32 v9, vcc, 0, v9, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v1, v5, v1
; GCN-IR-NEXT:    v_and_b32_e32 v2, 1, v4
; GCN-IR-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GCN-IR-NEXT:    v_mov_b32_e32 v5, v3
; GCN-IR-NEXT:    v_sub_i32_e32 v6, vcc, v6, v10
; GCN-IR-NEXT:    v_mov_b32_e32 v4, v2
; GCN-IR-NEXT:    v_subbrev_u32_e32 v7, vcc, 0, v7, vcc
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[8:9]
; GCN-IR-NEXT:    s_cbranch_execnz .LBB17_3
; GCN-IR-NEXT:  ; %bb.4: ; %Flow
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[8:9]
; GCN-IR-NEXT:  .LBB17_5: ; %Flow4
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; GCN-IR-NEXT:    v_or_b32_e32 v1, v3, v1
; GCN-IR-NEXT:    v_or_b32_e32 v0, v2, v0
; GCN-IR-NEXT:  .LBB17_6: ; %Flow5
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
  %x.shr = lshr i64 %x, 40
