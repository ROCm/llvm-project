...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-- -mcpu=tahiti  | FileCheck %s --check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-- -mcpu=fiji -mattr=-flat-for-global | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX11,GFX11-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX11,GFX11-FAKE16
...
; SI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; SI-NEXT:    v_cmp_lt_f32_e32 vcc, v5, v0
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cndmask_b32_e32 v0, v2, v3, vcc
; SI-NEXT:    v_cmp_lt_f32_e32 vcc, v1, v4
...
; GFX11-TRUE16-NEXT:    buffer_load_b32 v3, off, s[0:3], 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s10, s6
; GFX11-TRUE16-NEXT:    s_mov_b32 s11, s7
...
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, v7.l, v0.h, s0
...
; GFX11-FAKE16-NEXT:    buffer_load_b32 v2, off, s[4:7], 0
; GFX11-FAKE16-NEXT:    buffer_load_b32 v3, off, s[20:23], 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s10, s6
; GFX11-FAKE16-NEXT:    s_mov_b32 s11, s7
...
; GFX11-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v2, v0
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v3
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v1, v3, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v6, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v1, v5, v7 :: v_dual_and_b32 v0, 0xffff, v0
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s12, s8
; GFX11-TRUE16-NEXT:    s_mov_b32 s13, s9
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v0
; GFX11-TRUE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, 0.5, v1.l
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, v1.l, v0.h, s0
...
; GFX11-FAKE16-NEXT:    buffer_load_b32 v1, off, s[8:11], 0
...
; GFX11-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, 0.5, v1
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v2
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v2, v0, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, 0x3900, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v1, v5, v3 :: v_dual_and_b32 v0, 0xffff, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v0, v1, 16, v0
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v0
; GFX11-TRUE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, 0.5, v1.l
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v2
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GFX11-FAKE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, 0.5, v1
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v2
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v2, v0, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, 0x3900, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v1, v5, v3 :: v_dual_and_b32 v0, 0xffff, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v0, v1, 16, v0
; GFX11-FAKE16-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
...
; SI-NEXT:    v_cmp_nlt_f32_e32 vcc, v1, v0
; SI-NEXT:    v_cndmask_b32_e32 v0, v3, v2, vcc
; SI-NEXT:    v_cmp_nlt_f32_e32 vcc, v6, v5
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, s2
; GFX11-TRUE16-NEXT:    buffer_load_b32 v2, off, s[0:3], 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s7, s3
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(2)
...
; GFX11-TRUE16-NEXT:    buffer_store_b32 v1, off, s[4:7], 0
; GFX11-TRUE16-NEXT:    s_endpgm
;
...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_lshrrev_b32_e32 v7, 16, v2
; SI-NEXT:    v_cmp_lt_f32_e32 vcc, v1, v0
; SI-NEXT:    v_cndmask_b32_e32 v0, v3, v2, vcc
; SI-NEXT:    v_cmp_lt_f32_e32 vcc, v6, v5
; SI-NEXT:    v_cndmask_b32_e32 v1, v4, v7, vcc
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; SI-NEXT:    v_or_b32_e32 v0, v0, v1
