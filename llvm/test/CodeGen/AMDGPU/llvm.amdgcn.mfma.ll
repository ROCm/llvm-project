...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx908 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,NOLIT-SRCC,GFX908,GFX908_A %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx908 < %s | FileCheck -enable-var-scope --check-prefixes=GFX908-GISEL,GFX908-GISEL-NOLIT-SRCC %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx908 -mattr=-mfma-inline-literal-bug < %s | FileCheck -enable-var-scope --check-prefixes=GCN,LIT-SRCC,GFX908,GFX908_A %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx908 -mattr=-mfma-inline-literal-bug < %s | FileCheck -enable-var-scope --check-prefixes=GFX908-GISEL,GFX908-GISEL-LIT-SRCC %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx90a < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX90A,GFX908_A,GFX90A_42 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx90a < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX942,GFX90A_42 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx942 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefix=GFX942-VGPR %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -verify-machineinstrs -mtriple=amdgcn -mcpu=gfx942 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefix=GFX942-VGPR-GISEL %s
...
; NOLIT-SRCC-NEXT:    v_accvgpr_write_b32 a6, v2
...
; LIT-SRCC-NEXT:    v_accvgpr_write_b32 a6, v2
...
; NOLIT-SRCC-NEXT:    v_accvgpr_write_b32 a9, v11
...
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v5, a9
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v4, a8
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v9, a7
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v8, a6
; NOLIT-SRCC-NEXT:    global_store_dwordx4 v10, v[0:3], s[16:17] offset:48
; NOLIT-SRCC-NEXT:    global_store_dwordx4 v10, v[4:7], s[16:17] offset:32
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v3, a3
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v7, a5
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v6, a4
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v2, a2
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v1, a1
; NOLIT-SRCC-NEXT:    v_accvgpr_read_b32 v0, a0
; NOLIT-SRCC-NEXT:    global_store_dwordx4 v10, v[6:9], s[16:17] offset:16
; NOLIT-SRCC-NEXT:    s_nop 0
; NOLIT-SRCC-NEXT:    global_store_dwordx4 v10, v[0:3], s[16:17]
; NOLIT-SRCC-NEXT:    s_endpgm
;
...
; LIT-SRCC-NEXT:    v_accvgpr_write_b32 a9, v11
...
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v5, a9
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v4, a8
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v9, a7
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v8, a6
; LIT-SRCC-NEXT:    global_store_dwordx4 v10, v[0:3], s[16:17] offset:48
; LIT-SRCC-NEXT:    global_store_dwordx4 v10, v[4:7], s[16:17] offset:32
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v3, a3
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v7, a5
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v6, a4
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v2, a2
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v1, a1
; LIT-SRCC-NEXT:    v_accvgpr_read_b32 v0, a0
; LIT-SRCC-NEXT:    global_store_dwordx4 v10, v[6:9], s[16:17] offset:16
; LIT-SRCC-NEXT:    s_nop 0
; LIT-SRCC-NEXT:    global_store_dwordx4 v10, v[0:3], s[16:17]
; LIT-SRCC-NEXT:    s_endpgm
;
