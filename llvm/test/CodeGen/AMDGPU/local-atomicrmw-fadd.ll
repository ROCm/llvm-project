...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_mbcnt_lo_u32_b32 v3, s6, 0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v2
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v3
; GFX12-NEXT:    s_xor_b32 s3, vcc_lo, exec_lo
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_saveexec_b32 s3, s3
; GFX12-NEXT:    ; divergent control-flow edge
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_cvt_f32_ubyte0_e32 v2, s6
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_mov_b64 s[6:7], exec
; GFX942-NEXT:    v_mbcnt_lo_u32_b32 v3, s6, 0
; GFX942-NEXT:    v_mbcnt_hi_u32_b32 v3, s7, v3
...
; GFX942-NEXT:  .LBB28_3:
; GFX942-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX942-NEXT:    v_cvt_f32_ubyte0_e32 v2, s6
...
; GFX11-NEXT:    v_mbcnt_lo_u32_b32 v3, s6, 0
; GFX11-NEXT:    v_readfirstlane_b32 s0, v2
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v3
; GFX11-NEXT:    s_xor_b32 s3, vcc_lo, exec_lo
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s3, s3
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB28_4
; GFX11-NEXT:  .LBB28_3:
; GFX11-NEXT:    s_bcnt1_i32_b32 s6, s6
; GFX11-NEXT:    s_lshl_b32 s1, s1, 4
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v2, s6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX90A-NEXT:    s_xor_b64 s[0:1], s[0:1], exec
...
; GFX90A-NEXT:    s_mov_b64 s[6:7], exec
; GFX90A-NEXT:    v_mbcnt_lo_u32_b32 v3, s6, 0
; GFX90A-NEXT:    v_mbcnt_hi_u32_b32 v3, s7, v3
...
; GFX90A-NEXT:  .LBB28_3:
; GFX90A-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v2, s6
...
; GFX908-NEXT:    s_xor_b64 s[0:1], s[0:1], exec
; GFX908-NEXT:    ; implicit-def: $vgpr2
; GFX908-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX908-NEXT:    ; divergent control-flow edge
...
; GFX908-NEXT:    s_mov_b64 s[6:7], exec
; GFX908-NEXT:    v_mbcnt_lo_u32_b32 v3, s6, 0
; GFX908-NEXT:    v_mbcnt_hi_u32_b32 v3, s7, v3
; GFX908-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; GFX908-NEXT:    v_readfirstlane_b32 s8, v2
; GFX908-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX908-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX908-NEXT:    ; divergent control-flow edge
; GFX908-NEXT:    s_cbranch_execz .LBB28_4
; GFX908-NEXT:  .LBB28_3:
; GFX908-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v2, s6
...
; GFX8-NEXT:    s_mov_b64 s[6:7], exec
; GFX8-NEXT:    v_mbcnt_lo_u32_b32 v3, s6, 0
; GFX8-NEXT:    v_mbcnt_hi_u32_b32 v3, s7, v3
...
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    s_mov_b64 s[2:3], 0
; GFX7-NEXT:    s_and_saveexec_b64 s[12:13], s[0:1]
...
; GFX7-NEXT:    ds_read_b32 v2, v1
; GFX7-NEXT:    s_bcnt1_i32_b64 s0, s[14:15]
...
; GFX7-NEXT:    s_and_saveexec_b64 s[14:15], s[14:15]
; GFX7-NEXT:    s_or_b64 s[10:11], s[10:11], s[14:15]
; GFX7-NEXT:    ; divergent control-flow edge
...
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_add_f32_e32 v5, v3, v4
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_load_dword s14, s[4:5], 0x3
; GFX6-NEXT:    s_mov_b64 s[12:13], exec
; GFX6-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s12, 0
; GFX6-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, s13, v0
; GFX6-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_add_i32 s14, s14, 4
...
; GFX6-NEXT:    s_mov_b32 m0, -1
; GFX6-NEXT:    s_mov_b64 s[2:3], 0
; GFX6-NEXT:    s_and_saveexec_b64 s[10:11], s[0:1]
; GFX6-NEXT:    s_mov_b64 s[8:9], 0
; GFX6-NEXT:    s_mov_b64 s[2:3], 0
; GFX6-NEXT:    ; divergent control-flow edge
; GFX6-NEXT:    s_cbranch_execz .LBB28_3
; GFX6-NEXT:  .LBB28_1:
; GFX6-NEXT:    s_lshl_b32 s0, s14, 3
; GFX6-NEXT:    v_mov_b32_e32 v1, s0
; GFX6-NEXT:    ds_read_b32 v2, v1
; GFX6-NEXT:    s_bcnt1_i32_b64 s0, s[12:13]
...
; GFX6-NEXT:    s_and_saveexec_b64 s[12:13], s[12:13]
; GFX6-NEXT:    s_or_b64 s[8:9], s[8:9], s[12:13]
; GFX6-NEXT:    ; divergent control-flow edge
; GFX6-NEXT:    s_cbranch_execz .LBB28_6
; GFX6-NEXT:  .LBB28_4:
; GFX6-NEXT:    s_lshl_b32 s12, s14, 4
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_add_f32_e32 v5, v3, v4
