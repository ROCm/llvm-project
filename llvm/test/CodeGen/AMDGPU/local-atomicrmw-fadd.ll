...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_mbcnt_lo_u32_b32 v1, s6, 0
...
; GFX90A-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX90A-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v0
...
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    s_add_i32 s3, s3, 4
; GFX908-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX908-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v0
...
; GFX908-NEXT:    s_mov_b64 exec, s[0:1]
; GFX908-NEXT:    ; divergent control-flow edge
...
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_add_f32_e32 v4, v2, v3
; GFX7-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-NEXT:    ds_cmpst_rtn_b32 v4, v5, v2, v4
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v2
...
; GFX7-NEXT:    s_lshl_b64 s[10:11], 1, s3
; GFX7-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[10:11]
; GFX7-NEXT:    v_cmp_ne_u64_e64 s[10:11], s[0:1], 0
; GFX7-NEXT:    v_readfirstlane_b32 s12, v1
; GFX7-NEXT:    v_readlane_b32 s13, v2, s3
; GFX7-NEXT:    s_mov_b32 m0, s3
; GFX7-NEXT:    v_writelane_b32 v0, s12, m0
...
; GFX7-NEXT:    v_mov_b32_e32 v4, v3
; GFX7-NEXT:    v_mov_b32_e32 v3, s2
; GFX7-NEXT:    v_add_f32_e32 v5, v4, v1
; GFX7-NEXT:    ds_cmpst_rtn_b32 v3, v3, v4, v5
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v4
; GFX7-NEXT:    s_xor_b64 s[0:1], vcc, exec
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_add_f32_e32 v4, v2, v3
; GFX6-NEXT:    v_mov_b32_e32 v5, s12
; GFX6-NEXT:    ds_cmpst_rtn_b32 v4, v5, v2, v4
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v2
; GFX6-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX6-NEXT:    s_xor_b64 s[14:15], exec, s[0:1]
; GFX6-NEXT:    v_mov_b32_e32 v2, v4
; GFX6-NEXT:    s_or_b64 s[8:9], s[8:9], s[14:15]
; GFX6-NEXT:    s_mov_b64 exec, s[0:1]
; GFX6-NEXT:    ; divergent control-flow edge
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_ff1_i32_b64 s11, s[0:1]
; GFX6-NEXT:    s_lshl_b64 s[8:9], 1, s11
; GFX6-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[8:9]
; GFX6-NEXT:    v_cmp_ne_u64_e64 s[8:9], s[0:1], 0
; GFX6-NEXT:    v_readfirstlane_b32 s12, v1
; GFX6-NEXT:    v_readlane_b32 s13, v2, s11
; GFX6-NEXT:    s_mov_b32 m0, s11
...
; GFX6-NEXT:    v_mov_b32_e32 v4, v3
; GFX6-NEXT:    v_mov_b32_e32 v3, s10
; GFX6-NEXT:    v_add_f32_e32 v5, v4, v1
; GFX6-NEXT:    ds_cmpst_rtn_b32 v3, v3, v4, v5
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v4
; GFX6-NEXT:    s_xor_b64 s[0:1], vcc, exec
