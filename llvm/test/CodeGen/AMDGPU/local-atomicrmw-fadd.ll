...
; GFX7-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
; GFX7-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX6-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
; GFX6-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX6-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v1
; GFX6-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v3
...
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v3
...
; GFX7-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GFX7-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX7-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX7-NEXT:    s_mov_b64 exec, vcc
; GFX7-NEXT:    ; divergent control-flow edge
...
; GFX6-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GFX6-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX6-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX6-NEXT:    s_mov_b64 exec, vcc
; GFX6-NEXT:    ; divergent control-flow edge
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
...
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
...
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v1
...
; GFX6-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v0
...
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
...
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
...
; GFX942-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
...
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
...
; GFX6-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
; GFX6-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX6-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX6-NEXT:    s_mov_b64 exec, vcc
; GFX6-NEXT:    ; divergent control-flow edge
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v2
...
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v2
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v2
...
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v2
...
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
; GFX908-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX908-NEXT:    v_mov_b32_e32 v2, v4
; GFX908-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX908-NEXT:    s_mov_b64 exec, vcc
...
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
; GFX8-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX8-NEXT:    v_mov_b32_e32 v2, v4
; GFX8-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX8-NEXT:    s_mov_b64 exec, vcc
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v3
...
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v3
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v3
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v3
...
; GFX942-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
...
; GFX908-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
; GFX908-NEXT:    s_xor_b64 s[8:9], exec, vcc
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
...
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
...
; GFX942-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v1
; GFX942-NEXT:    s_xor_b64 s[4:5], exec, vcc
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
...
; GFX12-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_mbcnt_lo_u32_b32 v3, s3, 0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v2
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v3
; GFX12-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_lshl_b32 s1, s1, 4
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_cvt_f32_ubyte0_e32 v2, s3
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_dual_mov_b32 v3, s1 :: v_dual_mul_f32 v2, 0x42280000, v2
...
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v0, s0, vcc_lo
...
; GFX12-NEXT:  .LBB28_7:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX942-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
...
; GFX942-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX942-NEXT:    v_mbcnt_lo_u32_b32 v3, s0, 0
; GFX942-NEXT:    v_mbcnt_hi_u32_b32 v3, s1, v3
; GFX942-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
...
; GFX942-NEXT:    v_cvt_f32_ubyte0_e32 v2, s0
...
; GFX942-NEXT:    v_add_f32_e32 v0, s6, v0
...
; GFX942-NEXT:    v_readlane_b32 s6, v2, s3
; GFX942-NEXT:    v_readfirstlane_b32 s7, v1
; GFX942-NEXT:    s_mov_b32 m0, s3
; GFX942-NEXT:    v_add_f32_e32 v1, s6, v1
; GFX942-NEXT:    v_writelane_b32 v0, s7, m0
...
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX11-NEXT:    v_mbcnt_lo_u32_b32 v3, s3, 0
...
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v2, s3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v3, s1 :: v_dual_mul_f32 v2, 0x42280000, v2
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v0, s0, vcc_lo
; GFX11-NEXT:    ; implicit-def: $vgpr0
; GFX11-NEXT:  .LBB28_5: ; %ComputeLoop
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_ctz_i32_b32 s0, s1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_readfirstlane_b32 s3, v1
; GFX11-NEXT:    v_readlane_b32 s6, v2, s0
; GFX11-NEXT:    s_lshl_b32 s7, 1, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_not1_b32 s1, s1, s7
; GFX11-NEXT:    v_writelane_b32 v0, s3, s0
...
; GFX10-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX10-NEXT:    v_mbcnt_lo_u32_b32 v3, s3, 0
...
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v0, s0, vcc_lo
; GFX10-NEXT:    ; implicit-def: $vgpr0
; GFX10-NEXT:  .LBB28_5: ; %ComputeLoop
; GFX10-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    s_ff1_i32_b32 s0, s1
; GFX10-NEXT:    v_readfirstlane_b32 s3, v1
; GFX10-NEXT:    v_readlane_b32 s6, v2, s0
; GFX10-NEXT:    s_lshl_b32 s7, 1, s0
; GFX10-NEXT:    s_andn2_b32 s1, s1, s7
; GFX10-NEXT:    v_writelane_b32 v0, s3, s0
...
; GFX90A-NEXT:    v_mbcnt_lo_u32_b32 v3, s0, 0
; GFX90A-NEXT:    v_mbcnt_hi_u32_b32 v3, s1, v3
; GFX90A-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
...
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v2, s0
...
; GFX90A-NEXT:    v_add_f32_e32 v0, s6, v0
...
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; GFX90A-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX908-NEXT:    v_mbcnt_lo_u32_b32 v0, s6, 0
; GFX908-NEXT:    v_mbcnt_hi_u32_b32 v0, s7, v0
...
; GFX908-NEXT:    v_mbcnt_lo_u32_b32 v3, s0, 0
; GFX908-NEXT:    v_mbcnt_hi_u32_b32 v3, s1, v3
; GFX908-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
...
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v2, s0
...
; GFX908-NEXT:    v_add_f32_e32 v0, s6, v0
...
; GFX908-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; GFX908-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX8-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
...
; GFX8-NEXT:    v_mbcnt_lo_u32_b32 v3, s0, 0
; GFX8-NEXT:    v_mbcnt_hi_u32_b32 v3, s1, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
...
; GFX8-NEXT:    v_add_f32_e32 v0, s6, v0
...
; GFX7-NEXT:    v_cmp_ne_u32_e64 s[12:13], 0, v0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_add_i32 s7, s7, 4
; GFX7-NEXT:    s_mov_b64 s[2:3], 0
; GFX7-NEXT:    s_mov_b64 s[2:3], 0
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7-NEXT:    s_xor_b64 s[14:15], s[12:13], exec
...
; GFX7-NEXT:    s_xor_b64 s[14:15], exec, s[0:1]
; GFX7-NEXT:    s_or_b64 s[12:13], s[12:13], s[14:15]
...
; GFX7-NEXT:    s_or_b64 s[10:11], s[10:11], vcc
; GFX7-NEXT:    s_mov_b64 exec, s[14:15]
; GFX7-NEXT:    ; divergent control-flow edge
...
; GFX7-NEXT:    v_add_f32_e32 v0, s12, v0
...
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_ff1_i32_b64 s12, s[0:1]
; GFX7-NEXT:    s_lshl_b64 s[10:11], 1, s12
; GFX7-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[10:11]
; GFX7-NEXT:    v_cmp_ne_u64_e64 s[10:11], s[0:1], 0
; GFX7-NEXT:    v_readfirstlane_b32 s7, v1
; GFX7-NEXT:    v_readlane_b32 s13, v2, s12
; GFX7-NEXT:    s_mov_b32 m0, s12
; GFX7-NEXT:    v_writelane_b32 v0, s7, m0
; GFX7-NEXT:    v_add_f32_e32 v1, s13, v1
; GFX7-NEXT:    s_and_b64 vcc, exec, s[10:11]
...
; GFX7-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v5
; GFX7-NEXT:    s_xor_b64 s[0:1], exec, vcc
; GFX7-NEXT:    s_or_b64 s[2:3], s[2:3], s[0:1]
; GFX7-NEXT:    s_mov_b64 exec, vcc
; GFX7-NEXT:    ; divergent control-flow edge
...
; GFX6-NEXT:  .LBB28_1:
; GFX6-NEXT:    s_lshl_b32 s13, s12, 3
...
; GFX6-NEXT:  .LBB28_4:
; GFX6-NEXT:    s_lshl_b32 s12, s12, 4
...
; GFX6-NEXT:    v_add_f32_e32 v0, s11, v0
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_ff1_i32_b64 s12, s[0:1]
; GFX6-NEXT:    s_lshl_b64 s[8:9], 1, s12
; GFX6-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[8:9]
; GFX6-NEXT:    v_cmp_ne_u64_e64 s[8:9], s[0:1], 0
; GFX6-NEXT:    v_readfirstlane_b32 s11, v1
; GFX6-NEXT:    v_readlane_b32 s13, v2, s12
; GFX6-NEXT:    s_mov_b32 m0, s12
; GFX6-NEXT:    v_writelane_b32 v0, s11, m0
; GFX6-NEXT:    v_add_f32_e32 v1, s13, v1
