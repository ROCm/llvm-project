...
; GFX7-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s10, 0
; GFX7-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, s11, v0
...
; GFX7-NEXT:    v_mbcnt_lo_u32_b32_e64 v3, s8, 0
; GFX7-NEXT:    v_mbcnt_hi_u32_b32_e32 v3, s9, v3
; GFX7-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v3
; GFX7-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; GFX7-NEXT:    s_xor_b64 s[12:13], s[0:1], exec
...
; GFX7-NEXT:    s_bcnt1_i32_b64 s8, s[8:9]
; GFX7-NEXT:    v_cvt_f32_ubyte0_e32 v3, s8
...
; GFX7-NEXT:    s_xor_b64 s[12:13], exec, s[8:9]
; GFX7-NEXT:    v_mov_b32_e32 v2, v4
; GFX7-NEXT:    s_or_b64 s[0:1], s[0:1], s[12:13]
...
; GFX6-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s8, 0
; GFX6-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, s9, v0
...
; GFX6-NEXT:    s_and_b64 s[0:1], s[2:3], exec
...
; GFX6-NEXT:    s_xor_b64 s[0:1], s[0:1], exec
; GFX6-NEXT:    s_xor_b64 s[8:9], exec, s[0:1]
...
; GFX6-NEXT:    v_mbcnt_lo_u32_b32_e64 v3, s6, 0
; GFX6-NEXT:    v_mbcnt_hi_u32_b32_e32 v3, s7, v3
; GFX6-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v3
; GFX6-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; GFX6-NEXT:    s_xor_b64 s[12:13], s[0:1], exec
...
; GFX6-NEXT:    s_and_b64 s[6:7], s[2:3], exec
...
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v2
; GFX6-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX6-NEXT:    s_xor_b64 s[12:13], exec, s[6:7]
; GFX6-NEXT:    v_mov_b32_e32 v2, v4
