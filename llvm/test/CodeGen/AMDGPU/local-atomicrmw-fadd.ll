...
; GFX7-NEXT:    s_xor_b64 s[18:19], exec, s[0:1]
; GFX7-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX7-NEXT:    s_mov_b64 exec, s[0:1]
; GFX7-NEXT:    ; divergent control-flow edge
...
; GFX7-NEXT:    v_add_f32_e32 v0, s16, v0
...
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_ff1_i32_b64 s14, s[0:1]
; GFX7-NEXT:    s_lshl_b64 s[12:13], 1, s14
; GFX7-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[12:13]
; GFX7-NEXT:    v_cmp_ne_u64_e64 s[12:13], s[0:1], 0
; GFX7-NEXT:    v_readfirstlane_b32 s7, v1
; GFX7-NEXT:    v_readlane_b32 s15, v2, s14
; GFX7-NEXT:    s_mov_b32 m0, s14
; GFX7-NEXT:    v_writelane_b32 v0, s7, m0
; GFX7-NEXT:    v_add_f32_e32 v1, s15, v1
; GFX7-NEXT:    s_and_b64 vcc, exec, s[12:13]
...
; GFX7-NEXT:    s_xor_b64 s[0:1], exec, s[10:11]
...
; GFX6-NEXT:    v_add_f32_e32 v0, s15, v0
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_ff1_i32_b64 s13, s[0:1]
; GFX6-NEXT:    s_lshl_b64 s[10:11], 1, s13
; GFX6-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[10:11]
; GFX6-NEXT:    v_cmp_ne_u64_e64 s[10:11], s[0:1], 0
; GFX6-NEXT:    v_readfirstlane_b32 s12, v1
; GFX6-NEXT:    v_readlane_b32 s15, v2, s13
; GFX6-NEXT:    s_mov_b32 m0, s13
; GFX6-NEXT:    v_writelane_b32 v0, s12, m0
; GFX6-NEXT:    v_add_f32_e32 v1, s15, v1
...
; GFX6-NEXT:    s_xor_b64 s[0:1], exec, s[8:9]
