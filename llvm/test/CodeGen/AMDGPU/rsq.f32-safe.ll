...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GCN-DAZ,GCN-DAZ-SAFE,SI-DAZ-SAFE %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -denormal-fp-math-f32=ieee < %s          | FileCheck -check-prefixes=GCN-IEEE,GCN-IEEE-SAFE,SI-IEEE-SAFE %s

; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.01 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GCN-DAZ,GCN-DAZ-SAFE,CI-DAZ-SAFE %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.01 -denormal-fp-math-f32=ieee < %s          | FileCheck -check-prefixes=GCN-IEEE,GCN-IEEE-SAFE,CI-IEEE-SAFE %s
