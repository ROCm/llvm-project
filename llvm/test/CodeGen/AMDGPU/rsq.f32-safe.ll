...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GCN-DAZ,GCN-DAZ-SAFE,SI-DAZ-SAFE %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math-f32=ieee < %s          | FileCheck -check-prefixes=GCN-IEEE,GCN-IEEE-SAFE,SI-IEEE-SAFE %s

; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=hawaii -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GCN-DAZ,GCN-DAZ-SAFE,CI-DAZ-SAFE %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=hawaii -denormal-fp-math-f32=ieee < %s          | FileCheck -check-prefixes=GCN-IEEE,GCN-IEEE-SAFE,CI-IEEE-SAFE %s
...
; GCN-DAZ-NEXT:    s_mov_b32 s4, s2
; GCN-DAZ-NEXT:    s_mov_b32 s5, s3
; GCN-DAZ-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; GCN-DAZ-NEXT:    s_mov_b32 s2, s6
; GCN-DAZ-NEXT:    s_mov_b32 s3, s7
...
; GCN-IEEE-NEXT:    s_mov_b32 s4, s2
; GCN-IEEE-NEXT:    s_mov_b32 s5, s3
; GCN-IEEE-NEXT:    buffer_load_dword v0, off, s[4:7], 0
...
; GCN-IEEE-NEXT:    s_mov_b32 s2, s6
; GCN-IEEE-NEXT:    s_mov_b32 s3, s7
...
; GCN-DAZ-NEXT:    s_load_dword s4, s[4:5], 0xb
; GCN-DAZ-NEXT:    s_mov_b32 s3, 0xf000
; GCN-DAZ-NEXT:    s_mov_b32 s2, -1
; GCN-DAZ-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v0, s4
; GCN-DAZ-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GCN-DAZ-NEXT:    s_endpgm
;
...
; GCN-IEEE-NEXT:    s_cselect_b32 s4, 24, 0
; GCN-IEEE-NEXT:    v_mov_b32_e32 v0, s4
...
; GCN-DAZ-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-DAZ-NEXT:    s_mov_b64 s[0:1], s[6:7]
; GCN-DAZ-NEXT:    buffer_load_dword v2, v[0:1], s[0:3], 0 addr64 glc
; GCN-DAZ-NEXT:    s_waitcnt vmcnt(0)
; GCN-DAZ-NEXT:    buffer_load_dword v3, v[0:1], s[0:3], 0 addr64 offset:4 glc
; GCN-DAZ-NEXT:    s_waitcnt vmcnt(0)
; GCN-DAZ-NEXT:    buffer_load_dword v4, v[0:1], s[0:3], 0 addr64 offset:8 glc
; GCN-DAZ-NEXT:    s_waitcnt vmcnt(0)
; GCN-DAZ-NEXT:    s_mov_b32 s0, 0xf800000
; GCN-DAZ-NEXT:    v_mov_b32_e32 v5, 0x260
; GCN-DAZ-NEXT:    v_mul_f32_e32 v6, 0x4f800000, v2
; GCN-DAZ-NEXT:    v_cmp_gt_f32_e32 vcc, s0, v2
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v2, v2, v6, vcc
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v6, v2
; GCN-DAZ-NEXT:    s_mov_b64 s[0:1], s[4:5]
; GCN-DAZ-NEXT:    v_mul_f32_e32 v7, v2, v6
; GCN-DAZ-NEXT:    v_mul_f32_e32 v6, 0.5, v6
; GCN-DAZ-NEXT:    v_fma_f32 v8, -v6, v7, 0.5
; GCN-DAZ-NEXT:    v_fma_f32 v7, v7, v8, v7
; GCN-DAZ-NEXT:    v_fma_f32 v6, v6, v8, v6
; GCN-DAZ-NEXT:    v_fma_f32 v8, -v7, v7, v2
; GCN-DAZ-NEXT:    v_fma_f32 v6, v8, v6, v7
; GCN-DAZ-NEXT:    v_mul_f32_e32 v7, 0x37800000, v6
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v6, v6, v7, vcc
; GCN-DAZ-NEXT:    v_cmp_class_f32_e32 vcc, v2, v5
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v2, v6, v2, vcc
...
; GCN-IEEE-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IEEE-NEXT:    s_mov_b64 s[0:1], s[6:7]
; GCN-IEEE-NEXT:    buffer_load_dword v2, v[0:1], s[0:3], 0 addr64 glc
; GCN-IEEE-NEXT:    s_waitcnt vmcnt(0)
; GCN-IEEE-NEXT:    buffer_load_dword v3, v[0:1], s[0:3], 0 addr64 offset:4 glc
; GCN-IEEE-NEXT:    s_waitcnt vmcnt(0)
; GCN-IEEE-NEXT:    buffer_load_dword v4, v[0:1], s[0:3], 0 addr64 offset:8 glc
; GCN-IEEE-NEXT:    s_waitcnt vmcnt(0)
; GCN-IEEE-NEXT:    s_mov_b32 s0, 0xf800000
; GCN-IEEE-NEXT:    v_mov_b32_e32 v5, 0x260
; GCN-IEEE-NEXT:    v_mul_f32_e32 v6, 0x4f800000, v2
; GCN-IEEE-NEXT:    v_cmp_gt_f32_e32 vcc, s0, v2
; GCN-IEEE-NEXT:    v_cndmask_b32_e32 v2, v2, v6, vcc
; GCN-IEEE-NEXT:    v_sqrt_f32_e32 v6, v2
; GCN-IEEE-NEXT:    v_add_i32_e64 v7, s[0:1], -1, v6
; GCN-IEEE-NEXT:    v_add_i32_e64 v8, s[0:1], 1, v6
; GCN-IEEE-NEXT:    v_fma_f32 v9, -v7, v6, v2
; GCN-IEEE-NEXT:    v_fma_f32 v10, -v8, v6, v2
; GCN-IEEE-NEXT:    v_cmp_ge_f32_e64 s[0:1], 0, v9
; GCN-IEEE-NEXT:    v_cndmask_b32_e64 v6, v6, v7, s[0:1]
; GCN-IEEE-NEXT:    v_cmp_lt_f32_e64 s[0:1], 0, v10
; GCN-IEEE-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[0:1]
; GCN-IEEE-NEXT:    v_mul_f32_e32 v7, 0x37800000, v6
; GCN-IEEE-NEXT:    v_cndmask_b32_e32 v6, v6, v7, vcc
; GCN-IEEE-NEXT:    v_cmp_class_f32_e32 vcc, v2, v5
; GCN-IEEE-NEXT:    v_cndmask_b32_e32 v2, v6, v2, vcc
