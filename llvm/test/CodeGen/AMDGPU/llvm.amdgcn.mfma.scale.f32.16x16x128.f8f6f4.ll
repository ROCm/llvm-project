...
; SDAG-NEXT:    v_mov_b32_e32 v17, s12
; SDAG-NEXT:    v_mov_b32_e32 v18, s13
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], v17, v18 op_sel:[1,1,0] op_sel_hi:[1,0,0] blgp:2
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
...
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], v16, v17 op_sel:[1,1,0] op_sel_hi:[1,0,0] blgp:2
...
; SDAG-NEXT:    v_mov_b32_e32 v17, -2
; SDAG-NEXT:    v_mov_b32_e32 v18, 0x41
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v0, s8
; SDAG-NEXT:    v_mov_b32_e32 v1, s9
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], v18, v17 op_sel:[1,1,0] op_sel_hi:[1,0,0]
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
...
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], v16, v17 op_sel:[1,1,0] op_sel_hi:[1,0,0]
; GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GISEL-NEXT:    s_nop 7
; GISEL-NEXT:    s_nop 2
...
; SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x50
; SDAG-NEXT:    v_mov_b32_e32 v17, -2
; SDAG-NEXT:    v_mov_b32_e32 v18, 1.0
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v0, s8
; SDAG-NEXT:    v_mov_b32_e32 v1, s9
...
; GISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x50
; GISEL-NEXT:    v_mov_b32_e32 v16, 1.0
; GISEL-NEXT:    v_mov_b32_e32 v17, 0.15915494
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[8:9]
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[12:13]
