...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -global-isel=0 --amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=AGPR,AGPR-SDAG %s
