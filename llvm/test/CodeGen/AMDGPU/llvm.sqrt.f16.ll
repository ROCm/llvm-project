...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11-TRUE16,GFX11-TRUE16-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11-TRUE16,GFX11-TRUE16-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11-FAKE16,GFX11-FAKE16-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11-FAKE16,GFX11-FAKE16-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-TRUE16,GFX12-TRUE16-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-TRUE16,GFX12-TRUE16-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-FAKE16,GFX12-FAKE16-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-FAKE16,GFX12-FAKE16-GISEL %s
...
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s4, s2
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX11-TRUE16-SDAG-NEXT:    buffer_load_d16_b16 v0, off, s[4:7], 0
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    v_sqrt_f16_e32 v0.l, v0.l
; GFX11-TRUE16-SDAG-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; GFX11-FAKE16-SDAG-NEXT:    s_mov_b32 s4, s2
; GFX11-FAKE16-SDAG-NEXT:    s_mov_b32 s5, s3
...
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s4, s2
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX12-TRUE16-SDAG-NEXT:    buffer_load_d16_b16 v0, off, s[4:7], null
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX12-TRUE16-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-SDAG-NEXT:    v_sqrt_f16_e32 v0.l, v0.l
; GFX12-TRUE16-SDAG-NEXT:    buffer_store_b16 v0, off, s[0:3], null
...
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s4, s2
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX12-FAKE16-SDAG-NEXT:    buffer_load_u16 v0, off, s[4:7], null
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX12-FAKE16-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-SDAG-NEXT:    v_sqrt_f16_e32 v0, v0
; GFX12-FAKE16-SDAG-NEXT:    buffer_store_b16 v0, off, s[0:3], null
...
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX11-TRUE16-SDAG-NEXT:    buffer_load_b32 v0, off, s[4:7], 0
; GFX11-TRUE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-SDAG-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
; GFX11-TRUE16-SDAG-NEXT:    s_endpgm
;
...
; GFX11-FAKE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX11-FAKE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX11-FAKE16-SDAG-NEXT:    buffer_load_b32 v0, off, s[4:7], 0
; GFX11-FAKE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX11-FAKE16-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s6, -1
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s7, 0x31016000
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s10, s6
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s11, s7
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s8, s2
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s9, s3
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s4, s0
; GFX11-FAKE16-GISEL-NEXT:    buffer_load_b32 v0, off, s[8:11], 0
; GFX11-FAKE16-GISEL-NEXT:    s_mov_b32 s5, s1
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-GISEL-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; GFX11-FAKE16-GISEL-NEXT:    v_sqrt_f16_e32 v0, v0
; GFX11-FAKE16-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-GISEL-NEXT:    v_sqrt_f16_e32 v1, v1
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-FAKE16-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
...
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX12-TRUE16-SDAG-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX12-TRUE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX12-TRUE16-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-TRUE16-SDAG-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX12-TRUE16-SDAG-NEXT:    s_endpgm
;
...
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s5, s3
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s2, s6
; GFX12-FAKE16-SDAG-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX12-FAKE16-SDAG-NEXT:    s_mov_b32 s3, s7
; GFX12-FAKE16-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-FAKE16-SDAG-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX12-FAKE16-SDAG-NEXT:    s_endpgm
;
; GFX12-FAKE16-GISEL-LABEL: sqrt_v2f16:
; GFX12-FAKE16-GISEL:       ; %bb.0: ; %entry
; GFX12-FAKE16-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s6, -1
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s7, 0x31016000
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s10, s6
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s11, s7
; GFX12-FAKE16-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s8, s2
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s9, s3
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s4, s0
; GFX12-FAKE16-GISEL-NEXT:    buffer_load_b32 v0, off, s[8:11], null
; GFX12-FAKE16-GISEL-NEXT:    s_mov_b32 s5, s1
; GFX12-FAKE16-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-GISEL-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; GFX12-FAKE16-GISEL-NEXT:    v_sqrt_f16_e32 v0, v0
; GFX12-FAKE16-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX12-FAKE16-GISEL-NEXT:    v_sqrt_f16_e32 v1, v1
; GFX12-FAKE16-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX12-FAKE16-GISEL-NEXT:    buffer_store_b32 v0, off, s[4:7], null
; GFX12-FAKE16-GISEL-NEXT:    s_endpgm
    ptr addrspace(1) %r,
    ptr addrspace(1) %a) {
entry:
