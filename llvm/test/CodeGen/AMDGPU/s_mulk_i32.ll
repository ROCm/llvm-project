...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00--amdpal < %s | FileCheck -check-prefix=GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02--amdpal -mattr=-flat-for-global,-xnack < %s | FileCheck -check-prefix=GFX8 %s
