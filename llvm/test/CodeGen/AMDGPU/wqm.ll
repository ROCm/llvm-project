...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX9-W64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 -mattr=+wavefrontsize32 < %s | FileCheck -check-prefixes=GFX10-W32 %s
