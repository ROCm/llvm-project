...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-FAKE16 %s
...
; SI-NEXT:    v_and_b32_e32 v31, 0x8000, v30
...
; SI-NEXT:    v_and_b32_e32 v35, 0x8000, v32
; SI-NEXT:    v_lshrrev_b32_e32 v32, 16, v32
; SI-NEXT:    v_and_b32_e32 v32, 0x8000, v32
...
; SI-NEXT:    v_or_b32_e32 v14, v31, v14
