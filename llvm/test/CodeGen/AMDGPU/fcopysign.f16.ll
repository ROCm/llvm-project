...
; GFX9-NEXT:    s_and_b32 s3, s0, 0xffe
...
; GFX9-NEXT:    s_bfe_u32 s3, s7, 0xb0014
; GFX9-NEXT:    s_sub_i32 s6, 0x3f1, s3
; GFX9-NEXT:    v_med3_i32 v1, s6, 0, 13
; GFX9-NEXT:    s_or_b32 s1, s0, 0x1000
; GFX9-NEXT:    v_readfirstlane_b32 s6, v1
; GFX9-NEXT:    s_lshr_b32 s7, s1, s6
; GFX9-NEXT:    s_lshl_b32 s6, s7, s6
; GFX9-NEXT:    s_cmp_lg_u32 s6, s1
...
; GFX9-NEXT:    s_cselect_b32 s1, s1, s6
...
; GFX9-NEXT:    v_bfi_b32 v1, s1, v1, v2
; GFX9-NEXT:    global_store_short v0, v1, s[4:5]
; GFX9-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_cselect_b32 s0, s6, 0x7c00
