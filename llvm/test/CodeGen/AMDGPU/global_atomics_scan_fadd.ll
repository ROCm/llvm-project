...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefix=GFX7LESS %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefix=GFX7LESS-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132-DPP %s
...
; GFX7LESS-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; GFX7LESS-NEXT:    s_xor_b64 s[0:1], s[6:7], exec
...
; GFX7LESS-NEXT:    s_load_dword s5, s[0:1], 0x0
...
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
...
; GFX9-NEXT:    s_bcnt1_i32_b64 s5, s[8:9]
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v0, s5
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX9-NEXT:    v_add_f32_e32 v0, v1, v3
...
; GFX1064-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
...
; GFX1064-NEXT:    s_bcnt1_i32_b64 s5, s[8:9]
...
; GFX1032-NEXT:    v_cmp_ne_u32_e64 s2, 0, v0
...
; GFX7LESS-DPP-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; GFX7LESS-DPP-NEXT:    s_xor_b64 s[0:1], s[6:7], exec
...
; GFX7LESS-DPP-NEXT:    s_load_dword s5, s[0:1], 0x0
; GFX7LESS-DPP-NEXT:    v_mul_f32_e32 v2, 4.0, v0
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v1, s5
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
...
; GFX9-DPP-NEXT:    s_bcnt1_i32_b64 s5, s[8:9]
; GFX9-DPP-NEXT:    v_cvt_f32_ubyte0_e32 v0, s5
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX9-DPP-NEXT:    v_add_f32_e32 v0, v1, v3
...
; GFX1064-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
...
; GFX1064-DPP-NEXT:    s_bcnt1_i32_b64 s5, s[8:9]
...
; GFX1032-DPP-NEXT:    v_cmp_ne_u32_e64 s2, 0, v0
; GFX1032-DPP-NEXT:    s_xor_b32 s0, s2, exec_lo
...
; GFX9-NEXT:    v_add_f32_e32 v2, s8, v2
...
; GFX1064-NEXT:    v_add_f32_e32 v2, s7, v2
...
; GFX1064-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
; GFX1064-NEXT:    s_or_b64 s[0:1], s[0:1], s[6:7]
; GFX1064-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1064-NEXT:    ; divergent control-flow edge
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v1
; GFX9-DPP-NEXT:    s_xor_b64 s[2:3], s[0:1], exec
...
; GFX9-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-DPP-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX9-DPP-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
; GFX9-DPP-NEXT:    v_mov_b32_e32 v1, v0
...
; GFX1164-DPP-NEXT:    s_xor_b64 exec, vcc, exec
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1132-DPP-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
...
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX9-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
; GFX9-NEXT:    s_mov_b64 s[6:7], -1
...
; GFX1064-NEXT:    s_mov_b64 s[6:7], -1
; GFX1064-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX1064-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
...
; GFX1164-NEXT:    s_xor_b64 exec, vcc, exec
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX7LESS-DPP-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; GFX7LESS-DPP-NEXT:    s_xor_b64 s[2:3], s[6:7], exec
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[8:9], -1
; GFX7LESS-DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX7LESS-DPP-NEXT:    ; divergent control-flow edge
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
; GFX9-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[8:9]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX1064-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX1064-DPP-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
; GFX1064-DPP-NEXT:    s_mov_b64 exec, s[8:9]
; GFX1064-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1032-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1032-DPP-NEXT:    s_xor_b32 s1, s2, exec_lo
; GFX1032-DPP-NEXT:    s_mov_b32 exec_lo, s1
; GFX1032-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32 v2, exec_hi, v2
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v2
...
; GFX1132-NEXT:    scratch_store_b32 off, v1, off
; GFX1132-NEXT:    scratch_load_b64 v[0:1], off, off
; GFX1132-NEXT:    v_cmp_ne_u32_e64 s2, 0, v2
; GFX1132-NEXT:    s_xor_b32 s0, s2, exec_lo
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1164-DPP-NEXT:    v_mbcnt_hi_u32_b32 v2, exec_hi, v2
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v2
...
; GFX1132-DPP-NEXT:    scratch_store_b32 off, v1, off
; GFX1132-DPP-NEXT:    scratch_load_b64 v[0:1], off, off
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e64 s2, 0, v2
; GFX1132-DPP-NEXT:    s_xor_b32 s0, s2, exec_lo
; GFX1132-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    s_mov_b32 exec_lo, s0
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:    v_add_f32_e32 v2, s7, v2
...
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1164-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
; GFX1164-NEXT:    s_or_b64 s[0:1], s[0:1], s[6:7]
; GFX1164-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1164-DPP-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX1164-DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
...
; GFX1132-DPP-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX1132-DPP-NEXT:    s_mov_b32 exec_lo, s0
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e64 s2, 0, v0
...
; GFX1164-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX1164-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    v_cmp_ne_u32_e64 s2, 0, v0
; GFX1132-NEXT:    s_xor_b32 s1, s2, exec_lo
; GFX1132-NEXT:    s_mov_b32 exec_lo, s1
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX1164-DPP-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
; GFX1164-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    s_mov_b64 exec, s[8:9]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e64 s2, 0, v0
; GFX1132-DPP-NEXT:    s_xor_b32 s1, s2, exec_lo
; GFX1132-DPP-NEXT:    s_mov_b32 exec_lo, s1
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[8:9], s[0:1], 0
; GFX7LESS-NEXT:    v_add_f64 v[4:5], v[4:5], s[2:3]
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[8:9]
...
; GFX9-DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v1
; GFX9-DPP-NEXT:    s_xor_b64 s[4:5], s[0:1], exec
; GFX9-DPP-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX9-DPP-NEXT:    v_readlane_b32 s7, v4, 63
; GFX9-DPP-NEXT:    v_readlane_b32 s6, v3, 63
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], s[6:7]
; GFX9-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[4:5]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_add_f64 v[9:10], v[11:12], s[2:3]
...
; GFX1164-DPP-NEXT:    s_waitcnt_depctr depctr_va_sdst(0)
; GFX1164-DPP-NEXT:    s_xor_b64 s[2:3], s[0:1], exec
; GFX1164-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
...
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s4, s[2:3]
; GFX7LESS-NEXT:    s_mov_b32 s5, 0x43300000
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, 0xc3300000
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dwordx2 s[10:11], s[0:1], 0x0
; GFX7LESS-NEXT:    v_add_f64 v[0:1], s[4:5], v[0:1]
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    v_mul_f64 v[4:5], 4.0, v[0:1]
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s10
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s11
; GFX7LESS-NEXT:    s_and_b64 s[4:5], s[8:9], exec
...
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[2:3]
; GFX7LESS-DPP-NEXT:    s_mov_b32 s5, 0x43300000
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v1, 0xc3300000
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[10:11], s[0:1], 0x0
; GFX7LESS-DPP-NEXT:    v_add_f64 v[0:1], s[4:5], v[0:1]
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    v_mul_f64 v[4:5], 4.0, v[0:1]
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v2, s10
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v3, s11
; GFX7LESS-DPP-NEXT:    s_and_b64 s[4:5], s[8:9], exec
