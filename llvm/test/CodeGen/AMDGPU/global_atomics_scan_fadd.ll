...
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[6:7], 0
...
; GFX1064-DPP-NEXT:    s_xor_b64 s[2:3], vcc, exec
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX9-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX9-DPP-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[0:1], 0
; GFX1064-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1064-DPP-NEXT:    s_xor_b64 s[8:9], vcc, exec
...
; GFX1164-DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v0, v1
...
; GFX1132-DPP-NEXT:    s_mov_b32 exec_lo, s0
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v0, v1
; GFX1132-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1132-DPP-NEXT:    s_mov_b32 s2, 0
; GFX1132-DPP-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
...
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1164-DPP-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX1164-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1164-DPP-NEXT:    s_mov_b64 s[0:1], 0
; GFX1164-DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
