...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefix=GFX7LESS %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefix=GFX7LESS-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164-DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize32 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132-DPP %s
...
; GFX7LESS-NEXT:    s_mov_b64 s[8:9], -1
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[6:7], s[0:1]
...
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s4, s[2:3]
; GFX7LESS-NEXT:    v_cvt_f32_ubyte0_e32 v0, s4
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s4, s[0:1], 0x0
; GFX7LESS-NEXT:    v_mul_f32_e32 v2, 4.0, v0
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, s4
; GFX7LESS-NEXT:    s_and_b64 s[4:5], s[8:9], exec
...
; GFX7LESS-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GFX7LESS-NEXT:    ; divergent control-flow edge
...
; GFX9-NEXT:    s_and_b64 s[4:5], s[8:9], exec
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; GFX1032-NEXT:    v_cvt_f32_ubyte0_e32 v0, s5
...
; GFX1132-NEXT:    s_and_saveexec_b32 s1, s1
...
; GFX7LESS-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[8:9], -1
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[6:7], s[0:1]
; GFX7LESS-DPP-NEXT:    ; divergent control-flow edge
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB0_3
; GFX7LESS-DPP-NEXT:  .LBB0_1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[2:3]
; GFX7LESS-DPP-NEXT:    v_cvt_f32_ubyte0_e32 v0, s4
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    s_load_dword s4, s[0:1], 0x0
; GFX7LESS-DPP-NEXT:    v_mul_f32_e32 v2, 4.0, v0
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v1, s4
; GFX7LESS-DPP-NEXT:    s_and_b64 s[4:5], s[8:9], exec
...
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX7LESS-DPP-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GFX7LESS-DPP-NEXT:    ; divergent control-flow edge
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX9-DPP-NEXT:    s_mov_b64 s[8:9], -1
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
; GFX9-DPP-NEXT:    s_cbranch_execz .LBB0_3
; GFX9-DPP-NEXT:  .LBB0_1:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX9-DPP-NEXT:    s_bcnt1_i32_b64 s5, s[6:7]
...
; GFX9-DPP-NEXT:    s_and_b64 s[4:5], s[8:9], exec
...
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX9-DPP-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-DPP-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX1064-DPP-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX1064-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_mov_b32 s6, exec_lo
; GFX1032-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1032-DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, s6, 0
; GFX1032-DPP-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1032-DPP-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1032-DPP-NEXT:    s_and_saveexec_b32 s2, s0
; GFX1032-DPP-NEXT:    ; divergent control-flow edge
; GFX1032-DPP-NEXT:    s_cbranch_execz .LBB0_3
; GFX1032-DPP-NEXT:  .LBB0_1:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX1032-DPP-NEXT:    s_bcnt1_i32_b32 s5, s6
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032-DPP-NEXT:    v_cvt_f32_ubyte0_e32 v0, s5
; GFX1032-DPP-NEXT:    s_and_b32 s3, s3, exec_lo
...
; GFX1032-DPP-NEXT:    s_and_saveexec_b32 s3, s3
; GFX1032-DPP-NEXT:    s_or_b32 s2, s2, s3
; GFX1032-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1164-DPP-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX1164-DPP-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
; GFX1164-DPP-NEXT:    s_cbranch_execnz .LBB0_2
; GFX1164-DPP-NEXT:  .LBB0_1:
...
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1132-DPP-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s1, s1
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
; GFX1132-DPP-NEXT:    s_cbranch_execnz .LBB0_2
; GFX1132-DPP-NEXT:  .LBB0_1:
...
; GFX7LESS-NEXT:    s_mov_b64 s[6:7], -1
...
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s2
...
; GFX7LESS-NEXT:    v_add_f32_e32 v2, s8, v2
...
; GFX7LESS-NEXT:  .LBB1_3:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[34:35], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX7LESS-NEXT:    ; divergent control-flow edge
...
; GFX9-NEXT:    v_add_f32_e32 v2, s7, v2
...
; GFX9-NEXT:  .LBB1_3:
; GFX9-NEXT:    s_load_dwordx2 s[4:5], s[34:35], 0x24
; GFX9-NEXT:    v_mov_b32_e32 v3, 0
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dword v1, v3, s[4:5]
; GFX9-NEXT:  .LBB1_4: ; %atomicrmw.start
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX9-NEXT:    global_atomic_cmpswap v0, v3, v[0:1], s[4:5] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
...
; GFX1064-NEXT:    v_add_f32_e32 v2, s8, v2
...
; GFX1064-NEXT:  .LBB1_3:
; GFX1064-NEXT:    s_load_dwordx2 s[4:5], s[34:35], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dword v1, v3, s[4:5]
; GFX1064-NEXT:  .LBB1_4: ; %atomicrmw.start
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX1064-NEXT:    global_atomic_cmpswap v0, v3, v[0:1], s[4:5] glc
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX1064-NEXT:    v_mov_b32_e32 v1, v0
...
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX7LESS-DPP-NEXT:    s_or_b64 s[0:1], s[0:1], s[2:3]
; GFX7LESS-DPP-NEXT:    ; divergent control-flow edge
...
; GFX9-DPP-NEXT:    v_readlane_b32 s6, v3, 63
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GFX9-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX9-DPP-NEXT:    s_mov_b64 s[4:5], -1
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
; GFX9-DPP-NEXT:    s_cbranch_execz .LBB1_3
; GFX9-DPP-NEXT:  .LBB1_1:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[2:3], s[34:35], 0x24
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-DPP-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX9-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DPP-NEXT:    global_load_dword v1, v2, s[2:3]
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[4:5], -1
; GFX1064-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1064-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-DPP-NEXT:    ; divergent control-flow edge
; GFX1064-DPP-NEXT:    s_cbranch_execz .LBB1_3
; GFX1064-DPP-NEXT:  .LBB1_1:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[2:3], s[34:35], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-DPP-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dword v1, v6, s[2:3]
; GFX1064-DPP-NEXT:  .LBB1_2: ; %atomicrmw.start
; GFX1064-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-DPP-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX1064-DPP-NEXT:    global_atomic_cmpswap v0, v6, v[0:1], s[2:3] glc
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v1, v0
; GFX1064-DPP-NEXT:    s_xor_b64 s[4:5], vcc, exec
...
; GFX1164-DPP-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX1164-DPP-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX1164-DPP-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX1164-DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v0, v1
; GFX1164-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1164-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
; GFX1164-DPP-NEXT:    s_cbranch_execnz .LBB1_2
; GFX1164-DPP-NEXT:  .LBB1_1:
; GFX1164-DPP-NEXT:    s_endpgm
...
; GFX1132-DPP-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
; GFX1132-DPP-NEXT:    s_cbranch_execnz .LBB1_2
; GFX1132-DPP-NEXT:  .LBB1_1:
; GFX1132-DPP-NEXT:    s_endpgm
...
; GFX7LESS-NEXT:    s_mov_b64 s[8:9], -1
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[6:7], s[2:3]
; GFX7LESS-NEXT:    ; divergent control-flow edge
; GFX7LESS-NEXT:    s_cbranch_execz .LBB2_3
; GFX7LESS-NEXT:  .LBB2_1:
...
; GFX9-NEXT:    s_mov_b32 s7, 0x43300000
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_mov_b32_e32 v1, 0xc3300000
; GFX9-NEXT:    v_add_f64 v[0:1], s[6:7], v[0:1]
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX9-NEXT:    global_atomic_cmpswap v0, v3, v[0:1], s[6:7] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-NEXT:    s_xor_b64 s[2:3], vcc, exec
...
; GFX1164-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX7LESS-DPP-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[8:9], -1
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[6:7], s[2:3]
; GFX7LESS-DPP-NEXT:    ; divergent control-flow edge
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB2_3
; GFX7LESS-DPP-NEXT:  .LBB2_1:
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], -1
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
; GFX9-DPP-NEXT:    s_cbranch_execz .LBB2_3
; GFX9-DPP-NEXT:  .LBB2_1:
; GFX9-DPP-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX9-DPP-NEXT:    s_mov_b32 s7, 0x43300000
; GFX9-DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v1, 0xc3300000
; GFX9-DPP-NEXT:    v_add_f64 v[0:1], s[6:7], v[0:1]
; GFX9-DPP-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX9-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX9-DPP-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX9-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DPP-NEXT:    s_load_dword s4, s[6:7], 0x0
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX9-DPP-NEXT:    global_atomic_cmpswap v0, v3, v[0:1], s[6:7] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-DPP-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX9-DPP-NEXT:    s_or_b64 s[0:1], s[0:1], s[2:3]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX1064-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1064-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1064-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-DPP-NEXT:    ; divergent control-flow edge
; GFX1064-DPP-NEXT:    s_cbranch_execz .LBB2_3
; GFX1064-DPP-NEXT:  .LBB2_1:
...
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v1, s4
; GFX1064-DPP-NEXT:    v_mul_f32_e32 v2, 4.0, v0
; GFX1064-DPP-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX1032-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1032-DPP-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1032-DPP-NEXT:    s_and_saveexec_b32 s2, s1
; GFX1032-DPP-NEXT:    ; divergent control-flow edge
; GFX1032-DPP-NEXT:    s_cbranch_execz .LBB2_3
; GFX1032-DPP-NEXT:  .LBB2_1:
...
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GFX1164-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1164-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
; GFX1164-DPP-NEXT:    s_cbranch_execnz .LBB2_2
; GFX1164-DPP-NEXT:  .LBB2_1:
; GFX1164-DPP-NEXT:    s_endpgm
...
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
; GFX1132-DPP-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
; GFX1132-DPP-NEXT:    s_cbranch_execnz .LBB2_2
; GFX1132-DPP-NEXT:  .LBB2_1:
; GFX1132-DPP-NEXT:    s_endpgm
...
; GFX1164-NEXT:    v_mov_b32_e32 v1, s0
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32 v2, exec_lo, 0
; GFX1164-NEXT:    s_mov_b64 s[6:7], -1
; GFX1164-NEXT:    s_clause 0x1
; GFX1164-NEXT:    scratch_store_b32 off, v0, off offset:4
; GFX1164-NEXT:    scratch_store_b32 off, v1, off
; GFX1164-NEXT:    scratch_load_b64 v[0:1], off, off
...
; GFX1164-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX1164-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_and_saveexec_b32 s2, s0
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v1, s0
; GFX1164-DPP-NEXT:    v_mbcnt_lo_u32_b32 v2, exec_lo, 0
; GFX1164-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX1164-DPP-NEXT:    s_clause 0x1
; GFX1164-DPP-NEXT:    scratch_store_b32 off, v0, off offset:4
; GFX1164-DPP-NEXT:    scratch_store_b32 off, v1, off
; GFX1164-DPP-NEXT:    scratch_load_b64 v[0:1], off, off
...
; GFX1164-DPP-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX1164-DPP-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1132-DPP-NEXT:    v_dual_mov_b32 v0, 0x43300000 :: v_dual_mov_b32 v1, s0
; GFX1132-DPP-NEXT:    v_mbcnt_lo_u32_b32 v2, exec_lo, 0
; GFX1132-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1132-DPP-NEXT:    s_clause 0x1
; GFX1132-DPP-NEXT:    scratch_store_b32 off, v0, off offset:4
; GFX1132-DPP-NEXT:    scratch_store_b32 off, v1, off
; GFX1132-DPP-NEXT:    scratch_load_b64 v[0:1], off, off
...
; GFX1132-DPP-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s2, s0
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
; GFX1132-DPP-NEXT:    s_cbranch_execz .LBB4_3
; GFX1132-DPP-NEXT:  .LBB4_1:
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-DPP-NEXT:    v_add_f64 v[0:1], 0xc3300000, v[0:1]
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1132-DPP-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[0:1]
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-DPP-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_mul_f32 v2, 4.0, v0
...
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s3, s3
; GFX1132-DPP-NEXT:    s_or_b32 s2, s2, s3
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:  .LBB8_3:
; GFX1164-NEXT:    s_load_b64 s[4:5], s[34:35], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b32 v1, v3, s[4:5]
; GFX1164-NEXT:  .LBB8_4: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX1164-NEXT:    global_atomic_cmpswap_b32 v0, v3, v[0:1], s[4:5] glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX1164-NEXT:    v_mov_b32_e32 v1, v0
; GFX1164-NEXT:    s_xor_b64 s[2:3], vcc, exec
...
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v0, v1
; GFX1164-DPP-NEXT:    s_mov_b64 s[4:5], -1
; GFX1164-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1164-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
; GFX1164-DPP-NEXT:    s_cbranch_execz .LBB8_3
; GFX1164-DPP-NEXT:  .LBB8_1:
; GFX1164-DPP-NEXT:    s_load_b64 s[2:3], s[34:35], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX1164-DPP-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b32 v5, v6, s[2:3]
; GFX1164-DPP-NEXT:  .LBB8_2: ; %atomicrmw.start
; GFX1164-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    v_add_f32_e32 v4, v5, v0
; GFX1164-DPP-NEXT:    global_atomic_cmpswap_b32 v4, v6, v[4:5], s[2:3] glc
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:  .LBB9_1:
; GFX9-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX9-NEXT:    s_bcnt1_i32_b64 s4, s[8:9]
; GFX9-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
...
; GFX1064-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
; GFX1032-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1132-NEXT:    s_and_saveexec_b32 s2, s1
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x0
; GFX7LESS-DPP-NEXT:    v_mul_f64 v[4:5], v[0:1], 4.0
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v3, s5
; GFX7LESS-DPP-NEXT:    s_and_b64 s[4:5], s[8:9], exec
...
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_mov_b64 s[8:9], exec
; GFX9-DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, s8, 0
; GFX9-DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, s9, v0
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX9-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
; GFX9-DPP-NEXT:    s_cbranch_execz .LBB9_3
; GFX9-DPP-NEXT:  .LBB9_1:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX9-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[8:9]
; GFX9-DPP-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
...
; GFX9-DPP-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[6:7], -1
; GFX1064-DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, s8, 0
; GFX1064-DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, s9, v0
; GFX1064-DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1064-DPP-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1064-DPP-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-DPP-NEXT:    ; divergent control-flow edge
; GFX1064-DPP-NEXT:    s_cbranch_execz .LBB9_3
; GFX1064-DPP-NEXT:  .LBB9_1:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX1064-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[8:9]
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-DPP-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:  .LBB9_1:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX1032-DPP-NEXT:    s_bcnt1_i32_b32 s4, s6
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX1032-DPP-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
; GFX1032-DPP-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1132-DPP-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s2, s1
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
; GFX1132-DPP-NEXT:    s_cbranch_execz .LBB9_3
; GFX1132-DPP-NEXT:  .LBB9_1:
; GFX1132-DPP-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v6, 0
...
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s8, s[0:1]
; GFX7LESS-NEXT:    v_readlane_b32 s3, v1, s8
; GFX7LESS-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS-NEXT:    s_lshl_b64 s[8:9], 1, s8
; GFX7LESS-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[8:9]
...
; GFX9-NEXT:    v_readlane_b32 s7, v1, s8
; GFX9-NEXT:    v_readlane_b32 s6, v0, s8
; GFX9-NEXT:    v_add_f64 v[4:5], v[4:5], s[6:7]
; GFX9-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX9-NEXT:    s_andn2_b64 s[4:5], s[4:5], s[6:7]
...
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dwordx2 v[2:3], v6, s[4:5]
...
; GFX1064-NEXT:    v_readlane_b32 s6, v0, s8
; GFX1064-NEXT:    v_readlane_b32 s7, v1, s8
; GFX1064-NEXT:    v_add_f64 v[4:5], v[4:5], s[6:7]
; GFX1064-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX1064-NEXT:    s_andn2_b64 s[4:5], s[4:5], s[6:7]
...
; GFX1064-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dwordx2 v[2:3], v6, s[4:5]
; GFX1064-NEXT:  .LBB10_4: ; %atomicrmw.start
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-NEXT:    v_add_f64 v[0:1], v[2:3], v[4:5]
; GFX1064-NEXT:    global_atomic_cmpswap_x2 v[0:1], v6, v[0:3], s[4:5] glc
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-NEXT:    v_cmp_eq_u64_e32 vcc, v[0:1], v[2:3]
; GFX1064-NEXT:    v_mov_b32_e32 v3, v1
; GFX1064-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_ctz_i32_b64 s8, s[4:5]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1164-NEXT:    v_readlane_b32 s6, v0, s8
; GFX1164-NEXT:    v_readlane_b32 s7, v1, s8
; GFX1164-NEXT:    v_add_f64 v[4:5], v[4:5], s[6:7]
; GFX1164-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_and_not1_b64 s[4:5], s[4:5], s[6:7]
...
; GFX1164-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b64 v[2:3], v6, s[4:5]
; GFX1164-NEXT:  .LBB10_4: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_add_f64 v[0:1], v[2:3], v[4:5]
; GFX1164-NEXT:    global_atomic_cmpswap_b64 v[0:1], v6, v[0:3], s[4:5] glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_cmp_eq_u64_e32 vcc, v[0:1], v[2:3]
; GFX1164-NEXT:    v_mov_b32_e32 v3, v1
; GFX1164-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[0:1], 0
; GFX7LESS-DPP-NEXT:    ; implicit-def: $vgpr0_vgpr1
...
; GFX9-DPP-NEXT:    v_readlane_b32 s1, v4, 63
; GFX9-DPP-NEXT:    v_readlane_b32 s0, v3, 63
...
; GFX9-DPP-NEXT:  .LBB10_1:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[4:5], s[34:35], 0x24
; GFX9-DPP-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX9-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DPP-NEXT:    global_load_dwordx2 v[11:12], v0, s[4:5]
; GFX9-DPP-NEXT:  .LBB10_2: ; %atomicrmw.start
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_add_f64 v[9:10], v[11:12], s[0:1]
; GFX9-DPP-NEXT:    global_atomic_cmpswap_x2 v[1:2], v0, v[9:12], s[4:5] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-DPP-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX9-DPP-NEXT:    s_or_b64 s[2:3], s[2:3], s[6:7]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-DPP-NEXT:  .LBB10_1:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[2:3], s[34:35], 0x24
; GFX1064-DPP-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dwordx2 v[9:10], v2, s[2:3]
; GFX1064-DPP-NEXT:  .LBB10_2: ; %atomicrmw.start
; GFX1064-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-DPP-NEXT:    v_add_f64 v[7:8], v[9:10], v[0:1]
; GFX1064-DPP-NEXT:    global_atomic_cmpswap_x2 v[7:8], v2, v[7:10], s[2:3] glc
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1164-DPP-NEXT:  .LBB10_1:
; GFX1164-DPP-NEXT:    s_load_b64 s[2:3], s[34:35], 0x24
; GFX1164-DPP-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b64 v[8:9], v10, s[2:3]
; GFX1164-DPP-NEXT:  .LBB10_2: ; %atomicrmw.start
; GFX1164-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    v_add_f64 v[6:7], v[8:9], v[0:1]
; GFX1164-DPP-NEXT:    global_atomic_cmpswap_b64 v[6:7], v10, v[6:9], s[2:3] glc
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1132-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v0, v2
; GFX1132-DPP-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1132-DPP-NEXT:    s_and_saveexec_b32 s2, s0
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
; GFX1132-DPP-NEXT:    s_cbranch_execz .LBB10_3
; GFX1132-DPP-NEXT:  .LBB10_1:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[34:35], 0x24
; GFX1132-DPP-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_add_f64 v[0:1], v[2:3], v[4:5]
; GFX9-NEXT:    global_atomic_cmpswap_x2 v[0:1], v6, v[0:3], s[6:7] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, v[0:1], v[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v3, v1
; GFX9-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX1064-NEXT:  .LBB11_1:
; GFX1064-NEXT:    s_bcnt1_i32_b64 s8, s[2:3]
; GFX1064-NEXT:    s_mov_b32 s9, 0x43300000
; GFX1064-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX1064-NEXT:    v_add_f64 v[0:1], 0xc3300000, s[8:9]
; GFX1064-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
...
; GFX9-DPP-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX9-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DPP-NEXT:    s_load_dwordx2 s[4:5], s[6:7], 0x0
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    v_add_f64 v[0:1], v[2:3], v[4:5]
; GFX9-DPP-NEXT:    global_atomic_cmpswap_x2 v[0:1], v6, v[0:3], s[6:7] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_cmp_eq_u64_e32 vcc, v[0:1], v[2:3]
; GFX9-DPP-NEXT:    v_mov_b32_e32 v3, v1
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX1064-DPP-NEXT:  .LBB11_1:
; GFX1064-DPP-NEXT:    s_bcnt1_i32_b64 s8, s[2:3]
; GFX1064-DPP-NEXT:    s_mov_b32 s9, 0x43300000
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX1064-DPP-NEXT:    v_add_f64 v[0:1], 0xc3300000, s[8:9]
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
