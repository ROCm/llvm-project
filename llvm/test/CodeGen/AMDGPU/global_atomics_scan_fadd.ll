...
; GFX7LESS-NEXT:    s_mov_b64 s[4:5], -1
...
; GFX7LESS-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_xor_b64 s[6:7], exec, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
...
; GFX1064-NEXT:    s_xor_b64 s[6:7], exec, s[0:1]
...
; GFX1164-NEXT:    s_mov_b64 s[0:1], -1
...
; GFX1164-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_xor_b64 s[6:7], exec, s[0:1]
; GFX1164-NEXT:    s_or_b64 s[2:3], s[2:3], s[6:7]
...
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_xor_b32 s3, exec_lo, vcc_lo
; GFX1132-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    s_load_b64 s[0:1], s[34:35], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v3, 0
; GFX1132-NEXT:    s_and_b32 s2, s2, exec_lo
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    s_xor_b32 s4, exec_lo, s2
; GFX1132-NEXT:    s_or_b32 s3, s3, s4
