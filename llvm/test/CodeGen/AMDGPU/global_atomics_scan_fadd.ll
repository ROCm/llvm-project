...
; GFX1064-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dword v1, v3, s[2:3]
...
; GFX9-DPP-NEXT:    s_xor_b64 exec, s[0:1], exec
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-DPP-NEXT:    s_xor_b64 exec, s[0:1], exec
; GFX1064-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1032-DPP-NEXT:    s_xor_b32 exec_lo, s2, exec_lo
; GFX1032-DPP-NEXT:    ; divergent control-flow edge
...
; GFX9-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX9-DPP-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX1064-DPP-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
...
; GFX1164-NEXT:    s_xor_b64 exec, s[0:1], exec
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_cvt_f32_f64_e32 v0, v[0:1]
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_xor_b32 exec_lo, s2, exec_lo
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX1164-DPP-NEXT:    s_xor_b64 exec, s[0:1], exec
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1164-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[0:1]
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-DPP-NEXT:    s_xor_b32 exec_lo, s2, exec_lo
; GFX1132-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b32 v1, v3, s[2:3]
...
; GFX1164-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
...
; GFX9-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX9-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[6:7]
...
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX1064-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[6:7]
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v6, 0
...
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v0
; GFX1164-DPP-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
; GFX1164-DPP-NEXT:    s_mov_b64 exec, s[6:7]
; GFX1164-DPP-NEXT:    ; divergent control-flow edge
...
; GFX1064-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dwordx2 v[2:3], v6, s[2:3]
...
; GFX9-DPP-NEXT:    v_readlane_b32 s5, v4, 63
; GFX9-DPP-NEXT:    v_readlane_b32 s4, v3, 63
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX9-DPP-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
; GFX9-DPP-NEXT:    s_mov_b64 exec, s[6:7]
...
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], s[4:5]
...
; GFX1064-NEXT:    s_bcnt1_i32_b64 s6, s[2:3]
; GFX1064-NEXT:    s_mov_b32 s7, 0x43300000
; GFX1064-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX1064-NEXT:    v_add_f64 v[0:1], 0xc3300000, s[6:7]
; GFX1064-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
...
; GFX1064-DPP-NEXT:    s_bcnt1_i32_b64 s6, s[2:3]
; GFX1064-DPP-NEXT:    s_mov_b32 s7, 0x43300000
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
; GFX1064-DPP-NEXT:    v_add_f64 v[0:1], 0xc3300000, s[6:7]
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
