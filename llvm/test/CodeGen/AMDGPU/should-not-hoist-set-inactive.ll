...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck %s -check-prefix=GCN
...
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
...
; GCN-NEXT:    s_and_saveexec_b32 s6, s6
; GCN-NEXT:    s_or_b32 s7, s7, s6
; GCN-NEXT:    s_mov_b32 s6, 0
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execz .LBB0_1
; GCN-NEXT:  .LBB0_4: ; %bb2
