...
; VI-NEXT:    s_mov_b32 s2, 0x40c0c
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_perm_b32 v4, v3, v2, s2
; VI-NEXT:    v_or_b32_e32 v2, v3, v2
; VI-NEXT:    v_and_b32_e32 v2, 0xff, v2
; VI-NEXT:    v_ffbh_u32_e32 v3, v4
; VI-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; VI-NEXT:    v_cndmask_b32_e32 v2, 32, v3, vcc
; VI-NEXT:    flat_store_short v[0:1], v2
; VI-NEXT:    s_endpgm
...
; VI-NEXT:    v_perm_b32 v5, v9, v8, s2
; VI-NEXT:    s_waitcnt vmcnt(5)
; VI-NEXT:    v_lshlrev_b32_e32 v6, 8, v10
; VI-NEXT:    s_waitcnt vmcnt(4)
; VI-NEXT:    v_or_b32_e32 v6, v6, v11
; VI-NEXT:    v_or_b32_e32 v5, v5, v6
; VI-NEXT:    v_ffbh_u32_e32 v5, v5
; VI-NEXT:    s_waitcnt vmcnt(2)
; VI-NEXT:    v_perm_b32 v2, v2, v12, s2
; VI-NEXT:    s_waitcnt vmcnt(1)
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s4, 0x7060c0c
; VI-NEXT:    v_perm_b32 v1, v0, v0, s4
...
; VI-NEXT:    v_perm_b32 v0, v0, v0, s4
...
; VI-NEXT:    v_perm_b32 v1, v1, v1, s4
