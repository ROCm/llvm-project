...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=r600 -mcpu=cypress < %s | FileCheck -check-prefixes=EG %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-GISEL %s
...
; SI-NEXT:    buffer_load_ubyte v4, off, s[4:7], 0 offset:5
; SI-NEXT:    buffer_load_ubyte v5, off, s[4:7], 0 offset:7
; SI-NEXT:    buffer_load_ubyte v6, off, s[4:7], 0 offset:4
; SI-NEXT:    buffer_load_ubyte v7, off, s[4:7], 0 offset:6
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt vmcnt(3)
