...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1011 < %s | FileCheck -check-prefixes=GFX10-DL-XNACK %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1012 < %s | FileCheck -check-prefixes=GFX10-DL-XNACK %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX10-DL-NOXNACK %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1031 < %s | FileCheck -check-prefixes=GFX10-DL-NOXNACK %s
...
; GFX10-DL-XNACK-NEXT:    v_lshrrev_b32_e32 v11, 20, v0
; GFX10-DL-XNACK-NEXT:    v_lshrrev_b32_e32 v13, 28, v0
; GFX10-DL-XNACK-NEXT:    v_lshlrev_b16 v10, 12, v10
...
; GFX10-DL-XNACK-NEXT:    v_lshrrev_b32_e32 v12, 16, v0
; GFX10-DL-XNACK-NEXT:    v_lshrrev_b32_e32 v14, 24, v0
; GFX10-DL-XNACK-NEXT:    v_lshlrev_b16 v6, 12, v6
...
; GFX10-DL-XNACK-NEXT:    v_mul_lo_u16 v1, v1, v0
...
; GFX10-DL-XNACK-NEXT:    v_lshlrev_b16 v3, 8, v3
...
; GFX10-DL-XNACK-NEXT:    v_or_b32_sdwa v3, v10, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
...
; GFX10-DL-XNACK-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-XNACK-NEXT:    v_add_nc_u16 v2, v1, v2
; GFX10-DL-XNACK-NEXT:    v_or_b32_sdwa v1, v3, v9 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX10-DL-XNACK-NEXT:    v_add_nc_u16 v9, v2, v10
