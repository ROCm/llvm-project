...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.01 < %s | FileCheck -enable-var-scope -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 --amdgpu-enable-vopd=0 < %s | FileCheck -enable-var-scope -check-prefix=GFX1250 %s
