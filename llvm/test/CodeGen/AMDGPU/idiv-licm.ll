...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -enable-var-scope -check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 < %s | FileCheck -enable-var-scope -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck -enable-var-scope -check-prefix=GFX11 %s
...
; GFX9-NEXT:    s_add_u32 s6, s0, 4
; GFX9-NEXT:    s_addc_u32 s7, s1, 0
...
; GFX10-NEXT:    s_mul_hi_u32 s7, s5, s4
...
; GFX10-NEXT:    s_mul_hi_u32 s0, s3, s5
; GFX10-NEXT:    s_mul_i32 s1, s0, s2
; GFX10-NEXT:    s_add_i32 s8, s0, 1
; GFX10-NEXT:    s_sub_i32 s1, s3, s1
; GFX10-NEXT:    s_sub_i32 s9, s1, s2
; GFX10-NEXT:    s_cmp_ge_u32 s1, s2
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_hi_u32 s7, s5, s4
...
; GFX11-NEXT:    s_mul_hi_u32 s0, s3, s5
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_i32 s1, s0, s2
; GFX11-NEXT:    s_add_i32 s8, s0, 1
; GFX11-NEXT:    s_sub_i32 s1, s3, s1
; GFX11-NEXT:    s_sub_i32 s9, s1, s2
; GFX11-NEXT:    s_cmp_ge_u32 s1, s2
; GFX11-NEXT:    s_cselect_b32 s0, s8, s0
; GFX11-NEXT:    s_cselect_b32 s1, s9, s1
; GFX11-NEXT:    s_add_i32 s8, s0, 1
; GFX11-NEXT:    s_cmp_ge_u32 s1, s2
; GFX11-NEXT:    s_cselect_b32 s0, s8, s0
; GFX11-NEXT:    s_add_i32 s3, s3, 1
; GFX11-NEXT:    s_xor_b32 s0, s0, s4
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_sub_i32 s1, s0, s4
; GFX11-NEXT:    s_add_u32 s0, s6, 4
; GFX11-NEXT:    v_mov_b32_e32 v1, s1
; GFX11-NEXT:    s_addc_u32 s1, s7, 0
...
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_mov_b64 s[6:7], s[0:1]
; GFX10-NEXT:    s_mul_hi_u32 s0, s3, s4
; GFX10-NEXT:    s_mul_i32 s0, s0, s2
; GFX10-NEXT:    s_sub_i32 s0, s3, s0
; GFX10-NEXT:    s_sub_i32 s1, s0, s2
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mov_b64 s[6:7], s[0:1]
; GFX11-NEXT:    s_mul_hi_u32 s0, s3, s4
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_i32 s0, s0, s2
; GFX11-NEXT:    s_sub_i32 s0, s3, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_sub_i32 s1, s0, s2
...
; GFX9-NEXT:    s_and_b32 s4, 0xffff, s2
; GFX9-NEXT:    s_add_i32 s2, s2, 1
