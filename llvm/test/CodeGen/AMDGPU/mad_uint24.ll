...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX8,SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=fiji -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX8,VI
...
; GCN-NEXT:    s_cselect_b32 s6, s6, 34
...
; GFX8-NEXT:    s_mov_b32 s2, -1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_ashr_i32 s6, s6, 8
; GFX8-NEXT:    s_cmp_lg_u32 s4, 0
; GFX8-NEXT:    s_cselect_b32 s6, s6, 34
...
; GFX8-NEXT:    s_and_b32 s6, s3, 0xffffff
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_add_i32 s2, s0, s6
; GFX8-NEXT:    s_add_i32 s3, s1, s3
; GFX8-NEXT:    s_add_i32 s6, s2, s3
...
; GCN-NEXT:    s_mov_b64 s[16:17], s[6:7]
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    buffer_load_sbyte v2, v[0:1], s[8:11], 0 addr64
; GCN-NEXT:    buffer_load_sbyte v3, v[0:1], s[12:15], 0 addr64
; GCN-NEXT:    buffer_load_sbyte v0, v[0:1], s[16:19], 0 addr64
