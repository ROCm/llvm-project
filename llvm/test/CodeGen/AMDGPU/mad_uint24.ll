...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX8,SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.03 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX8,VI
