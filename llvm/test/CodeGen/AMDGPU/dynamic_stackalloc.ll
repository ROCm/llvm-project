...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX11-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX11-GISEL %s
...
; GFX9-SDAG-NEXT:  .LBB14_1: ; %bb.0
; GFX9-SDAG-NEXT:    v_lshl_add_u32 v1, v1, 2, 15
; GFX9-SDAG-NEXT:    v_and_b32_e32 v1, -16, v1
; GFX9-SDAG-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, v1, s[4:5]
; GFX9-SDAG-NEXT:    s_nop 1
...
; GFX9-SDAG-NEXT:    s_and_b32 s4, s4, 0xfffff000
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-SDAG-NEXT:    v_lshl_add_u32 v3, s6, 6, v1
...
; GFX9-SDAG-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, v3, s[4:5]
; GFX9-SDAG-NEXT:    s_nop 1
; GFX9-SDAG-NEXT:    v_max_u32_dpp v2, v2, v2 row_shr:1 row_mask:0xf bank_mask:0xf
; GFX9-SDAG-NEXT:    s_nop 1
; GFX9-SDAG-NEXT:    v_max_u32_dpp v2, v2, v2 row_shr:2 row_mask:0xf bank_mask:0xf
...
; GFX9-SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; GFX9-SDAG-NEXT:    s_mov_b32 s4, s32
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v3, s4
; GFX9-SDAG-NEXT:    v_lshl_add_u32 v3, s6, 6, v3
; GFX9-SDAG-NEXT:    v_readfirstlane_b32 s32, v3
...
; GFX9-GISEL-NEXT:    s_add_u32 s5, s32, 0xfff
; GFX9-GISEL-NEXT:    s_lshl_b32 s4, s6, 6
; GFX9-GISEL-NEXT:    s_and_b32 s6, s5, 0xfffff000
; GFX9-GISEL-NEXT:    s_add_u32 s32, s6, s4
; GFX9-GISEL-NEXT:    v_lshl_add_u32 v1, v3, 2, 15
; GFX9-GISEL-NEXT:    s_mov_b32 s7, s32
; GFX9-GISEL-NEXT:    v_and_b32_e32 v1, -16, v1
; GFX9-GISEL-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX9-GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, v1, s[4:5]
; GFX9-GISEL-NEXT:    s_nop 1
...
; GFX9-GISEL-NEXT:    s_lshl_b32 s4, s8, 6
...
; GFX9-GISEL-NEXT:    s_add_u32 s32, s7, s4
; GFX9-GISEL-NEXT:    buffer_store_dword v1, v3, s[0:3], 0 offen
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:  .LBB14_2: ; %bb.1
; GFX9-GISEL-NEXT:    s_or_b64 exec, exec, vcc
; GFX9-GISEL-NEXT:    v_lshl_add_u32 v0, v0, 2, 15
; GFX9-GISEL-NEXT:    s_mov_b32 s6, s32
; GFX9-GISEL-NEXT:    v_and_b32_e32 v0, -16, v0
; GFX9-GISEL-NEXT:    s_or_saveexec_b64 s[4:5], -1
...
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, v1, s0
; GFX11-SDAG-NEXT:    s_mov_b32 exec_lo, s0
...
; GFX11-SDAG-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-SDAG-NEXT:    scratch_store_b32 off, v7, s0 dlc
; GFX11-SDAG-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-SDAG-NEXT:    v_add_nc_u32_e64 v1, s0, s3
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_readfirstlane_b32 s32, v1
; GFX11-SDAG-NEXT:  .LBB14_2: ; %bb.1
; GFX11-SDAG-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    v_lshl_add_u32 v0, v0, 2, 15
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, -16, v0
; GFX11-SDAG-NEXT:    s_or_saveexec_b32 s0, -1
...
; GFX11-GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, v1, s0
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v6, s0
; GFX11-GISEL-NEXT:    s_add_u32 s2, s32, 63
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_readlane_b32 s1, v2, 31
; GFX11-GISEL-NEXT:    v_readlane_b32 s3, v3, 31
; GFX11-GISEL-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-GISEL-NEXT:    s_and_not1_b32 s2, s2, 63
...
; GFX11-GISEL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-GISEL-NEXT:    s_add_u32 s32, s0, s3
; GFX11-GISEL-NEXT:    scratch_store_b32 off, v6, s0 dlc
; GFX11-GISEL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-GISEL-NEXT:  .LBB14_2: ; %bb.1
; GFX11-GISEL-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
; GFX11-GISEL-NEXT:    v_lshl_add_u32 v0, v0, 2, 15
; GFX11-GISEL-NEXT:    s_mov_b32 s0, s32
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_and_b32_e32 v0, -16, v0
...
; GFX9-GISEL-NEXT:    s_mov_b64 exec, s[4:5]
; GFX9-GISEL-NEXT:    s_lshl_b32 s4, s9, 6
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, 1
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, s8
; GFX9-GISEL-NEXT:    s_add_u32 s32, s8, s4
; GFX9-GISEL-NEXT:    buffer_store_dword v0, v1, s[0:3], 0 offen
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-SDAG-NEXT:    v_add_nc_u32_e64 v0, s0, s2
...
; GFX11-GISEL-NEXT:    scratch_store_b32 off, v0, s1 dlc
; GFX11-GISEL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-GISEL-NEXT:  .LBB15_2:
; GFX11-GISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-GISEL-NEXT:    s_xor_b32 s1, exec_lo, s0
; GFX11-GISEL-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-GISEL-NEXT:    ; divergent control-flow edge
; GFX11-GISEL-NEXT:    s_cbranch_execz .LBB15_4
; GFX11-GISEL-NEXT:  .LBB15_3: ; %bb.0
