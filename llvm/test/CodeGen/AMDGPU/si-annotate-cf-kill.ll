...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.01 | FileCheck --check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 -mattr=-flat-for-global | FileCheck --check-prefix=FLAT %s
...
; FLAT-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s[4:5]
