...
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa -passes=amdgpu-attributor < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: opt -S -mtriple=amdgpu10.10-amd-amdhsa -passes=amdgpu-attributor < %s | FileCheck -check-prefixes=GFX10 %s
