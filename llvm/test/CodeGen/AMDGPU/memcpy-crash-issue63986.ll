...
; CHECK-NEXT:    v_cmp_lt_u64_e64 s[8:9], s[4:5], 32
...
; CHECK-NEXT:    s_add_u32 s8, 32, s4
; CHECK-NEXT:    s_addc_u32 s9, 0, s5
; CHECK-NEXT:    v_mov_b32_e32 v8, s8
; CHECK-NEXT:    v_mov_b32_e32 v9, s9
...
; CHECK-NEXT:    v_add_co_u32_e32 v14, vcc, s22, v6
; CHECK-NEXT:    s_add_u32 s22, s22, 16
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    v_mov_b32_e32 v15, s23
; CHECK-NEXT:    ; implicit-def: $sgpr4_sgpr5
; CHECK-NEXT:    s_addc_u32 s23, s23, 0
; CHECK-NEXT:    v_addc_co_u32_e32 v15, vcc, v7, v15, vcc
; CHECK-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[22:23], v[0:1]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; CHECK-NEXT:    s_or_b64 s[12:13], s[12:13], vcc
; CHECK-NEXT:    s_xor_b64 s[4:5], exec, s[12:13]
; CHECK-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; CHECK-NEXT:    s_mov_b64 s[18:19], 0
; CHECK-NEXT:    s_or_b64 s[16:17], s[16:17], s[4:5]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_6 Depth=1
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b64 s[22:23], s[6:7], exec
...
; CHECK-NEXT:    s_xor_b64 s[22:23], exec, vcc
; CHECK-NEXT:    s_or_b64 s[16:17], s[16:17], s[22:23]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
