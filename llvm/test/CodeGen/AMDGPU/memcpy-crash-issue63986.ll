...
; CHECK-NEXT:    v_add_co_u32_e32 v4, vcc, s16, v2
; CHECK-NEXT:    v_addc_co_u32_e32 v5, vcc, v5, v3, vcc
...
; CHECK-NEXT:    v_addc_co_u32_e32 v3, vcc, v5, v3, vcc
; CHECK-NEXT:    s_and_b64 vcc, exec, s[6:7]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[2:3], v[6:9]
...
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:  ; %bb.4: ; %loop-memcpy-residual
; CHECK-NEXT:    s_add_u32 s6, 32, s4
; CHECK-NEXT:    s_addc_u32 s7, 0, s5
; CHECK-NEXT:    v_mov_b32_e32 v2, s6
; CHECK-NEXT:    v_mov_b32_e32 v3, s7
; CHECK-NEXT:    flat_load_ubyte v6, v[2:3]
; CHECK-NEXT:    v_add_co_u32_e32 v2, vcc, s6, v4
; CHECK-NEXT:    s_add_u32 s4, s4, 1
; CHECK-NEXT:    v_addc_co_u32_e32 v3, vcc, v5, v3, vcc
; CHECK-NEXT:    s_addc_u32 s5, 0, s5
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_byte v[2:3], v6
; CHECK-NEXT:  .LBB0_5: ; %post-loop-memcpy-expansion
...
; CHECK-NEXT:  ; %bb.9: ; %loop-memcpy-expansion2.preheader
; CHECK-NEXT:    ; in Loop: Header=BB0_8 Depth=1
; CHECK-NEXT:    s_mov_b64 s[10:11], 0
; CHECK-NEXT:    s_mov_b64 s[12:13], 0
; CHECK-NEXT:  .LBB0_10: ; %loop-memcpy-expansion2
...
; CHECK-NEXT:    v_add_co_u32_e32 v10, vcc, s12, v4
