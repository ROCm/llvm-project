...
; GLOBALNESS1-NEXT:    s_mov_b64 s[64:65], s[8:9]
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s11, 3
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s6, 4
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s7, 5
; GLOBALNESS1-NEXT:    s_load_dwordx4 s[8:11], s[8:9], 0x0
; GLOBALNESS1-NEXT:    s_nop 0
; GLOBALNESS1-NEXT:    s_load_dword s6, s[64:65], 0x14
...
; GLOBALNESS1-NEXT:    s_cselect_b64 s[96:97], -1, 0
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[98:99], -1, 0
...
; GLOBALNESS1-NEXT:    s_cselect_b64 s[52:53], -1, 0
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s4, 10
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s5, 11
...
; GLOBALNESS1-NEXT:    v_readlane_b32 s4, v57, 14
; GLOBALNESS1-NEXT:    v_readlane_b32 s5, v57, 15
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_23
...
; GLOBALNESS1-NEXT:    v_readlane_b32 s11, v57, 3
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s37
; GLOBALNESS1-NEXT:    v_readlane_b32 s13, v57, 1
; GLOBALNESS1-NEXT:    v_readlane_b32 s14, v57, 0
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v40
; GLOBALNESS1-NEXT:    ; implicit-def: $sgpr15
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[96:97]
; GLOBALNESS1-NEXT:    s_cbranch_vccz .LBB1_6
; GLOBALNESS1-NEXT:  ; %bb.3: ; %NodeBlock
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS1-NEXT:    s_load_dwordx4 s[4:7], s[64:65], 0x0
...
; GLOBALNESS1-NEXT:    s_branch .LBB1_24
...
; GLOBALNESS1-NEXT:    v_cmp_lt_i32_e32 vcc, -1, v0
; GLOBALNESS1-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[6:7], 0, v0
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS1-NEXT:    s_or_b64 s[50:51], s[50:51], s[4:5]
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[86:87], s[50:51]
; GLOBALNESS1-NEXT:    s_mov_b64 s[50:51], 0
...
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS1-NEXT:    s_cbranch_vccz .LBB1_9
...
; GLOBALNESS1-NEXT:    v_cndmask_b32_e32 v2, 0, v41, vcc
; GLOBALNESS1-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_lt_f64_e64 s[4:5], 0, v[0:1]
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s4, 16
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s5, 17
; GLOBALNESS1-NEXT:    v_cndmask_b32_e64 v41, 0, -1, vcc
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS1-NEXT:    s_or_b64 exec, exec, s[84:85]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS1-NEXT:    v_readlane_b32 s4, v57, 8
; GLOBALNESS1-NEXT:    v_readlane_b32 s5, v57, 9
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_10
; GLOBALNESS1-NEXT:  ; %bb.16: ; %bb6.i.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS1-NEXT:    v_readlane_b32 s4, v57, 16
; GLOBALNESS1-NEXT:    v_readlane_b32 s5, v57, 17
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS1-NEXT:    s_branch .LBB1_10
; GLOBALNESS1-NEXT:  .LBB1_17: ; %bb55.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s80, s64, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s81, s65, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
...
; GLOBALNESS1-NEXT:    v_readlane_b32 s39, v57, 3
...
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s37
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s36
...
; GLOBALNESS1-NEXT:    s_or_b64 s[66:67], s[66:67], vcc
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS1-NEXT:    s_or_b64 exec, exec, s[86:87]
; GLOBALNESS1-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[6:7]
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS1-NEXT:    s_or_b64 s[70:71], s[70:71], vcc
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[4:5], s[70:71]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], 0
; GLOBALNESS1-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GLOBALNESS1-NEXT:    s_mov_b64 s[70:71], 0
; GLOBALNESS1-NEXT:    ; divergent control-flow edge
; GLOBALNESS1-NEXT:    s_cbranch_execz .LBB1_2
; GLOBALNESS1-NEXT:  .LBB1_21: ; %bb67.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS1-NEXT:    v_readlane_b32 s4, v57, 12
; GLOBALNESS1-NEXT:    v_readlane_b32 s5, v57, 13
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS1-NEXT:    s_cbranch_vccz .LBB1_1
; GLOBALNESS1-NEXT:  ; %bb.22: ; %bb69.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS1-NEXT:    global_store_dwordx2 v[44:45], v[42:43], off
; GLOBALNESS1-NEXT:    s_branch .LBB1_1
; GLOBALNESS1-NEXT:  .LBB1_23: ; %bb73.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS1-NEXT:    global_store_dwordx2 v[44:45], v[42:43], off
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS1-NEXT:    s_branch .LBB1_2
; GLOBALNESS1-NEXT:  .LBB1_24:
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS1-NEXT:    s_branch .LBB1_26
; GLOBALNESS1-NEXT:  .LBB1_25:
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[64:65], s[8:9]
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s11, 3
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s6, 4
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s7, 5
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[8:11], s[8:9], 0x0
; GLOBALNESS0-NEXT:    s_nop 0
; GLOBALNESS0-NEXT:    s_load_dword s6, s[64:65], 0x14
...
; GLOBALNESS0-NEXT:    s_cselect_b64 s[96:97], -1, 0
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[98:99], -1, 0
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s4, 10
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s5, 11
...
; GLOBALNESS0-NEXT:    v_readlane_b32 s4, v57, 14
; GLOBALNESS0-NEXT:    v_readlane_b32 s5, v57, 15
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_23
...
; GLOBALNESS0-NEXT:    v_readlane_b32 s11, v57, 3
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s37
; GLOBALNESS0-NEXT:    v_readlane_b32 s13, v57, 1
; GLOBALNESS0-NEXT:    v_readlane_b32 s14, v57, 0
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v31, v40
; GLOBALNESS0-NEXT:    ; implicit-def: $sgpr15
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[96:97]
; GLOBALNESS0-NEXT:    s_cbranch_vccz .LBB1_6
; GLOBALNESS0-NEXT:  ; %bb.3: ; %NodeBlock
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[4:7], s[64:65], 0x0
...
; GLOBALNESS0-NEXT:    s_branch .LBB1_24
...
; GLOBALNESS0-NEXT:    v_cmp_lt_i32_e32 vcc, -1, v0
...
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[86:87], s[50:51]
; GLOBALNESS0-NEXT:    s_mov_b64 s[50:51], 0
...
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS0-NEXT:    s_cbranch_vccz .LBB1_9
...
; GLOBALNESS0-NEXT:    v_cndmask_b32_e32 v2, 0, v41, vcc
; GLOBALNESS0-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_lt_f64_e64 s[4:5], 0, v[0:1]
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s4, 16
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s5, 17
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v41, 0, -1, vcc
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS0-NEXT:    s_or_b64 exec, exec, s[84:85]
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS0-NEXT:    v_readlane_b32 s4, v57, 8
; GLOBALNESS0-NEXT:    v_readlane_b32 s5, v57, 9
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_10
; GLOBALNESS0-NEXT:  ; %bb.16: ; %bb6.i.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS0-NEXT:    v_readlane_b32 s4, v57, 16
; GLOBALNESS0-NEXT:    v_readlane_b32 s5, v57, 17
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS0-NEXT:    s_branch .LBB1_10
; GLOBALNESS0-NEXT:  .LBB1_17: ; %bb55.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_12 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s82, s64, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s83, s65, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
...
; GLOBALNESS0-NEXT:    v_readlane_b32 s39, v57, 3
...
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s37
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s36
...
; GLOBALNESS0-NEXT:    s_or_b64 s[66:67], s[66:67], vcc
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS0-NEXT:    s_or_b64 exec, exec, s[86:87]
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[6:7]
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS0-NEXT:    s_or_b64 s[70:71], s[70:71], vcc
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[4:5], s[70:71]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], 0
; GLOBALNESS0-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GLOBALNESS0-NEXT:    s_mov_b64 s[70:71], 0
; GLOBALNESS0-NEXT:    ; divergent control-flow edge
; GLOBALNESS0-NEXT:    s_cbranch_execz .LBB1_2
; GLOBALNESS0-NEXT:  .LBB1_21: ; %bb67.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS0-NEXT:    v_readlane_b32 s4, v57, 12
; GLOBALNESS0-NEXT:    v_readlane_b32 s5, v57, 13
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS0-NEXT:    s_cbranch_vccz .LBB1_1
; GLOBALNESS0-NEXT:  ; %bb.22: ; %bb69.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS0-NEXT:    global_store_dwordx2 v[44:45], v[42:43], off
; GLOBALNESS0-NEXT:    s_branch .LBB1_1
; GLOBALNESS0-NEXT:  .LBB1_23: ; %bb73.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS0-NEXT:    global_store_dwordx2 v[44:45], v[42:43], off
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS0-NEXT:    s_branch .LBB1_2
; GLOBALNESS0-NEXT:  .LBB1_24:
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS0-NEXT:    s_branch .LBB1_26
; GLOBALNESS0-NEXT:  .LBB1_25:
