...
; GLOBALNESS1-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS1-NEXT:    flat_load_dword v2, v[44:45]
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v0, 0
...
; GLOBALNESS1-NEXT:    s_or_b64 s[6:7], s[54:55], s[4:5]
; GLOBALNESS1-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[70:71], 0, v2
; GLOBALNESS1-NEXT:    s_and_b64 s[96:97], s[4:5], exec
; GLOBALNESS1-NEXT:    s_mov_b64 s[54:55], 0
; GLOBALNESS1-NEXT:    s_mov_b64 exec, s[6:7]
...
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], 0
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS1-NEXT:    s_or_b64 s[8:9], s[8:9], s[4:5]
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[98:99]
; GLOBALNESS1-NEXT:    s_mov_b64 s[98:99], 0
; GLOBALNESS1-NEXT:    s_mov_b64 exec, s[4:5]
; GLOBALNESS1-NEXT:    ; divergent control-flow edge
...
; GLOBALNESS0-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GLOBALNESS0-NEXT:    flat_load_dword v2, v[44:45]
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v0, 0
...
; GLOBALNESS0-NEXT:    s_or_b64 s[6:7], s[54:55], s[4:5]
; GLOBALNESS0-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; GLOBALNESS0-NEXT:    v_cmp_gt_i32_e64 s[70:71], 0, v2
; GLOBALNESS0-NEXT:    s_and_b64 s[96:97], s[4:5], exec
; GLOBALNESS0-NEXT:    s_mov_b64 s[54:55], 0
; GLOBALNESS0-NEXT:    s_mov_b64 exec, s[6:7]
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[8:9], 0
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[58:59], v[0:1], v[0:1] op_sel:[0,1]
; GLOBALNESS0-NEXT:    s_or_b64 s[8:9], s[8:9], s[4:5]
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[98:99]
; GLOBALNESS0-NEXT:    s_mov_b64 s[98:99], 0
; GLOBALNESS0-NEXT:    s_mov_b64 exec, s[4:5]
; GLOBALNESS0-NEXT:    ; divergent control-flow edge
