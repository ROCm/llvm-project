...
; GLOBALNESS1-NEXT:    s_load_dwordx4 s[48:51], s[6:7], 0x0
...
; GLOBALNESS1-NEXT:    global_load_dword v2, v42, s[48:49]
...
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s50, 0
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[52:53], 1, v3
; GLOBALNESS1-NEXT:    s_mov_b32 s68, s14
; GLOBALNESS1-NEXT:    s_mov_b32 s69, s13
; GLOBALNESS1-NEXT:    s_mov_b32 s80, s12
...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[70:71], 1, v1
...
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s80
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s51, 0
...
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[84:85], 0, v0
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v1, 0x3ff00000
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[82:83], s[84:85]
...
; GLOBALNESS1-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[86:87], 0, v2
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[96:97], 1, v0
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s98, s38, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s99, s39, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[50:51], s[4:5], 0x0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[36:37]
...
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[50:51]
...
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[0:1], 0, 0
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_mov_b32 s51, s7
; GLOBALNESS1-NEXT:  .LBB1_26: ; %Flow24
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_or_b64 exec, exec, s[82:83]
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[4:5], s[84:85]
...
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[48:51], s[6:7], 0x0
...
; GLOBALNESS0-NEXT:    global_load_dword v2, v42, s[48:49]
...
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s50, 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[52:53], 1, v3
; GLOBALNESS0-NEXT:    s_mov_b32 s98, s14
; GLOBALNESS0-NEXT:    s_mov_b32 s99, s13
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[70:71], 1, v1
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s51, 0
...
; GLOBALNESS0-NEXT:    v_cmp_gt_i32_e64 s[84:85], 0, v0
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v1, 0x3ff00000
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[82:83], s[84:85]
...
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[86:87], 0, v2
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[96:97], 1, v0
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[70:71]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.22: ; %bb55.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s80, s38, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s81, s39, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[50:51], s[4:5], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[36:37]
; GLOBALNESS0-NEXT:    s_mov_b64 s[8:9], s[80:81]
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], s[34:35]
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s68
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s99
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s98
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_swappc_b64 s[30:31], s[50:51]
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_or_b64 exec, exec, s[82:83]
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[4:5], s[84:85]
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[8:11], s[38:39], 0x0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_mov_b32 s51, s11
