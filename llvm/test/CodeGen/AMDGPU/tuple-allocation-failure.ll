...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdhsa -greedy-regclass-priority-trumps-globalness=1 -o - %s | FileCheck -check-prefixes=GFX90A,GLOBALNESS1 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdhsa -greedy-regclass-priority-trumps-globalness=0 -o - %s | FileCheck -check-prefixes=GFX90A,GLOBALNESS0 %s
