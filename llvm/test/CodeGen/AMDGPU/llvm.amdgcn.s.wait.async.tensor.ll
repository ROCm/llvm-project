...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.50 < %s | FileCheck %s -check-prefix=GFX12
; RUN: llc -global-isel=0 -mtriple=amdgpu13.10 < %s | FileCheck %s -check-prefix=GFX13
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu13.10 < %s | FileCheck %s -check-prefix=GFX13
