...
; RUN: not llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdpal -global-isel=1 < %s 2>&1 | FileCheck -check-prefix=GFX9-GISEL-ERR %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdpal -mattr=+architected-sgprs -global-isel=0 < %s | FileCheck -check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdpal -mattr=+architected-sgprs -global-isel=1 < %s | FileCheck -check-prefix=GFX9 %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdpal -global-isel=0 < %s | FileCheck -check-prefix=GFX1200 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdpal -global-isel=1 < %s | FileCheck -check-prefix=GFX1200 %s
; RUN: llc -mtriple=amdgpu12.50-amd-amdpal -global-isel=0 < %s | FileCheck -check-prefix=GFX1250 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdpal -global-isel=1 < %s | FileCheck -check-prefix=GFX1250 %s
