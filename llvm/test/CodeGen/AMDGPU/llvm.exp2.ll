...
; SI-SDAG-NEXT:    s_cselect_b32 s5, 0xffffffc0, 0
; SI-SDAG-NEXT:    s_and_b64 s[8:9], vcc, exec
; SI-SDAG-NEXT:    v_add_f32_e32 v3, s4, v3
...
; SI-SDAG-NEXT:    v_ldexp_f32_e64 v1, v1, s5
; SI-SDAG-NEXT:    s_cselect_b32 s5, 0xffffffc0, 0
; SI-SDAG-NEXT:    v_ldexp_f32_e64 v0, v3, s5
; SI-SDAG-NEXT:    s_and_b64 s[4:5], vcc, exec
; SI-SDAG-NEXT:    s_cselect_b32 s4, 0xffffffc0, 0
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
...
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v1, vcc
; VI-SDAG-NEXT:    v_add_f32_e32 v2, s6, v2
; VI-SDAG-NEXT:    v_exp_f32_e32 v2, v2
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
; VI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s5, v0
; VI-SDAG-NEXT:    s_cselect_b32 s2, 0xffffffc0, 0
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v3, 0, v1, vcc
; VI-SDAG-NEXT:    v_ldexp_f32 v2, v2, s2
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
; VI-SDAG-NEXT:    v_add_f32_e32 v3, s5, v3
...
; VI-SDAG-NEXT:    v_exp_f32_e32 v0, v0
; VI-SDAG-NEXT:    s_cselect_b32 s2, 0xffffffc0, 0
; VI-SDAG-NEXT:    v_ldexp_f32 v1, v3, s2
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
; VI-SDAG-NEXT:    s_cselect_b32 s2, 0xffffffc0, 0
...
; GFX900-SDAG-NEXT:    v_add_f32_e32 v2, s6, v2
...
; GFX900-SDAG-NEXT:    v_ldexp_f32 v2, v2, s0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    v_add_f32_e32 v4, s5, v4
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
...
; GFX900-SDAG-NEXT:    v_exp_f32_e32 v0, v0
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 0xffffffc0, 0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v1, v4, s0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 0xffffffc0, 0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v0, v0, s0
...
; SI-SDAG-NEXT:    v_add_f32_e32 v2, s3, v2
; SI-SDAG-NEXT:    v_add_f32_e32 v3, s2, v3
; SI-SDAG-NEXT:    v_exp_f32_e32 v2, v2
...
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v1, vcc
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
; VI-SDAG-NEXT:    v_add_f32_e32 v2, s7, v2
; VI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s6, v0
; VI-SDAG-NEXT:    v_exp_f32_e32 v2, v2
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v3, 0, v1, vcc
; VI-SDAG-NEXT:    v_add_f32_e32 v3, s6, v3
; VI-SDAG-NEXT:    v_exp_f32_e32 v4, v3
; VI-SDAG-NEXT:    s_cselect_b32 s2, 0xffffffc0, 0
; VI-SDAG-NEXT:    v_ldexp_f32 v3, v2, s2
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
; VI-SDAG-NEXT:    s_cselect_b32 s2, 0xffffffc0, 0
; VI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s5, v0
...
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
; VI-SDAG-NEXT:    v_add_f32_e32 v4, s5, v4
; VI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
...
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v1, vcc
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    v_add_f32_e32 v2, s7, v2
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s6, v0
; GFX900-SDAG-NEXT:    v_exp_f32_e32 v2, v2
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v3, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_add_f32_e32 v3, s6, v3
; GFX900-SDAG-NEXT:    v_exp_f32_e32 v5, v3
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 0xffffffc0, 0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v3, v2, s0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 0xffffffc0, 0
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s5, v0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v2, v5, s0
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v5, 0, v1, vcc
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    v_add_f32_e32 v5, s5, v5
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
...
; GFX900-SDAG-NEXT:    v_exp_f32_e32 v0, v0
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 0xffffffc0, 0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v1, v5, s0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 0xffffffc0, 0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v0, v0, s0
