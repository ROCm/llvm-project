...
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgpu9.00 | FileCheck --check-prefix=NOHSA-TRAP-GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX803 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgpu9.00-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgpu9.00-amd-amdhsa -mattr=-trap-handler | FileCheck --check-prefix=HSA-NOTRAP-GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgpu11.00-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX1100 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -O0 -mtriple=amdgpu11.00-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX1100-O0 %s
