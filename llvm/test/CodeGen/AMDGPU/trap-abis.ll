...
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgcn -mcpu=gfx900 | FileCheck --check-prefix=NOHSA-TRAP-GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgcn-amd-amdhsa -mcpu=gfx803 | FileCheck --check-prefix=HSA-TRAP-GFX803 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 | FileCheck --check-prefix=HSA-TRAP-GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -mattr=-trap-handler | FileCheck --check-prefix=HSA-NOTRAP-GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 | FileCheck --check-prefix=HSA-TRAP-GFX1100 %s
; RUN: llc -amdgpu-late-wave-transform=1 %s -o - -O0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 | FileCheck --check-prefix=HSA-TRAP-GFX1100-O0 %s
...
; HSA-TRAP-GFX1100-O0-NEXT:    v_writelane_b32 v2, s3, 1
; HSA-TRAP-GFX1100-O0-NEXT:    s_or_saveexec_b32 s6, -1
; HSA-TRAP-GFX1100-O0-NEXT:    scratch_store_b32 off, v2, off offset:8 ; 4-byte Folded Spill
; HSA-TRAP-GFX1100-O0-NEXT:    s_mov_b32 exec_lo, s6
; HSA-TRAP-GFX1100-O0-NEXT:    global_load_b32 v0, v0, s[0:1] glc dlc
; HSA-TRAP-GFX1100-O0-NEXT:    s_waitcnt vmcnt(0)
...
; HSA-TRAP-GFX1100-O0-NEXT:    s_or_saveexec_b32 s6, -1
; HSA-TRAP-GFX1100-O0-NEXT:    scratch_load_b32 v2, off, off offset:8 ; 4-byte Folded Reload
; HSA-TRAP-GFX1100-O0-NEXT:    s_mov_b32 exec_lo, s6
; HSA-TRAP-GFX1100-O0-NEXT:    s_waitcnt vmcnt(0)
; HSA-TRAP-GFX1100-O0-NEXT:    v_readlane_b32 s0, v2, 0
; HSA-TRAP-GFX1100-O0-NEXT:    v_readlane_b32 s1, v2, 1
; HSA-TRAP-GFX1100-O0-NEXT:    scratch_load_b32 v0, off, off offset:4 ; 4-byte Folded Reload
; HSA-TRAP-GFX1100-O0-NEXT:    scratch_load_b32 v1, off, off ; 4-byte Folded Reload
; HSA-TRAP-GFX1100-O0-NEXT:    s_waitcnt vmcnt(0)
; HSA-TRAP-GFX1100-O0-NEXT:    global_store_b32 v0, v1, s[0:1] dlc
; HSA-TRAP-GFX1100-O0-NEXT:    s_waitcnt_vscnt null, 0x0
; HSA-TRAP-GFX1100-O0-NEXT:    s_endpgm
