...
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11GLISEL %s
...
; GFX7SELDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
