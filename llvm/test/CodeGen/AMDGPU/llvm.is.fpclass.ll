...
; RUN:  llc -global-isel=0 -mtriple=amdgpu11.00 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11SELDAG %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.00 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11GLISEL %s
