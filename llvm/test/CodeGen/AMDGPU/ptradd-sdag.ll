...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck %s -check-prefixes=GFX8
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42-amd-amdhsa < %s | FileCheck %s -check-prefixes=GFX942
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30-amd-amdhsa < %s | FileCheck %s -check-prefixes=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck %s -check-prefixes=GFX11
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa < %s | FileCheck %s -check-prefixes=GFX12
