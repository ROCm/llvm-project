...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942  -o - %s | FileCheck -check-prefix=GCN %s
...
; GCN-NEXT:    s_mov_b32 s7, 0x3fb8aa3b
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mul_f32_e32 v6, s6, v1
; GCN-NEXT:    v_rndne_f32_e32 v7, v6
; GCN-NEXT:    v_sub_f32_e32 v8, v6, v7
; GCN-NEXT:    v_fma_f32 v1, s6, v1, -v6
; GCN-NEXT:    v_mov_b32_e32 v6, 0x32a5705f
; GCN-NEXT:    v_mov_b64_e32 v[4:5], s[2:3]
; GCN-NEXT:    v_fmac_f32_e32 v1, s6, v6
; GCN-NEXT:    v_mov_b64_e32 v[2:3], s[0:1]
; GCN-NEXT:    v_add_f32_e32 v1, v8, v1
; GCN-NEXT:    v_cvt_i32_f32_e32 v6, v7
; GCN-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[2:5], v0, v0, v[2:5]
; GCN-NEXT:    v_exp_f32_e32 v1, v1
; GCN-NEXT:    s_mov_b32 s8, 0x42b17218
; GCN-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[2:5], v0, v0, v[2:5]
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GCN-NEXT:    v_ldexp_f32 v1, v1, v6
...
; GCN-NEXT:    v_mul_f32_e32 v7, 0x3fb8aa3b, v1
; GCN-NEXT:    v_fma_f32 v8, v1, s7, -v7
; GCN-NEXT:    v_rndne_f32_e32 v9, v7
; GCN-NEXT:    v_fmac_f32_e32 v8, 0x32a5705f, v1
...
; GCN-NEXT:    v_cmp_nlt_f32_e32 vcc, s8, v1
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_cndmask_b32_e32 v1, v6, v7, vcc
; GCN-NEXT:    v_mul_f32_e32 v7, 0x3fb8aa3b, v1
; GCN-NEXT:    v_fma_f32 v8, v1, s7, -v7
; GCN-NEXT:    v_rndne_f32_e32 v9, v7
; GCN-NEXT:    v_fmac_f32_e32 v8, 0x32a5705f, v1
...
; GCN-NEXT:    v_cmp_nlt_f32_e32 vcc, s8, v1
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_cndmask_b32_e32 v7, v6, v7, vcc
; GCN-NEXT:    v_mul_f32_e32 v1, 0x3fb8aa3b, v7
; GCN-NEXT:    v_fma_f32 v8, v7, s7, -v1
; GCN-NEXT:    v_rndne_f32_e32 v9, v1
; GCN-NEXT:    v_fmac_f32_e32 v8, 0x32a5705f, v7
; GCN-NEXT:    v_sub_f32_e32 v1, v1, v9
; GCN-NEXT:    v_add_f32_e32 v1, v1, v8
; GCN-NEXT:    v_exp_f32_e32 v8, v1
; GCN-NEXT:    v_cvt_i32_f32_e32 v9, v9
; GCN-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v0, v0, v[2:5]
; GCN-NEXT:    v_cmp_ngt_f32_e32 vcc, s6, v7
; GCN-NEXT:    v_ldexp_f32 v4, v8, v9
; GCN-NEXT:    s_nop 0
; GCN-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc
; GCN-NEXT:    v_cmp_nlt_f32_e32 vcc, s8, v7
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_cndmask_b32_e32 v4, v6, v4, vcc
; GCN-NEXT:    v_mul_f32_e32 v5, 0x3fb8aa3b, v4
; GCN-NEXT:    v_fma_f32 v7, v4, s7, -v5
