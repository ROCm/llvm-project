; RUN: opt -S -mtriple=amdgpu7.00-unknown-amdhsa -debug-only=amdgpu-promote-alloca -amdgpu-promote-alloca-to-vector-limit=512 -passes=amdgpu-promote-alloca -amdgpu-promote-alloca-to-vector-max-regs=32 %s -o - 2>&1 | FileCheck %s
; REQUIRES: asserts
