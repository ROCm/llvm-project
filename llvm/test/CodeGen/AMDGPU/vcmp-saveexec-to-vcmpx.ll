...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GCN,GFX1010 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 < %s | FileCheck -check-prefixes=GCN,GFX1030 %s
