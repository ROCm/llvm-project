...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.04 < %s | FileCheck -check-prefix=CI %s
...
; CI-NEXT:    s_load_dword s4, s[4:5], 0xb
...
; CI-NEXT:    buffer_load_sshort v0, off, s[8:11], 0 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_load_sshort v1, off, s[8:11], 0 offset:2 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    v_lshlrev_b32_e32 v3, 1, v3
