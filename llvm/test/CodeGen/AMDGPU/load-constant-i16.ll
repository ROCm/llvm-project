...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck --check-prefix=GCN-NOHSA-SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00--amdhsa < %s | FileCheck --check-prefix=GCN-HSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 < %s | FileCheck --check-prefix=GCN-NOHSA-VI %s
