...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX10-NEXT:    s_add_u32 s0, s8, s7
; GFX10-NEXT:    s_mul_hi_u32 s9, s1, s3
; GFX10-NEXT:    s_mul_i32 s1, s1, s3
; GFX10-NEXT:    s_addc_u32 s3, 0, s6
; GFX10-NEXT:    s_add_u32 s0, s0, s5
; GFX10-NEXT:    s_addc_u32 s0, s3, s4
; GFX10-NEXT:    s_addc_u32 s3, s9, 0
; GFX10-NEXT:    s_add_u32 s0, s0, s1
; GFX10-NEXT:    s_addc_u32 s1, 0, s3
...
; GFX11-NEXT:    s_add_u32 s0, s8, s7
; GFX11-NEXT:    s_mul_hi_u32 s9, s1, s3
; GFX11-NEXT:    s_mul_i32 s1, s1, s3
; GFX11-NEXT:    s_addc_u32 s3, 0, s6
; GFX11-NEXT:    s_add_u32 s0, s0, s5
; GFX11-NEXT:    s_addc_u32 s0, s3, s4
; GFX11-NEXT:    s_addc_u32 s3, s9, 0
; GFX11-NEXT:    s_add_u32 s0, s0, s1
; GFX11-NEXT:    s_addc_u32 s1, 0, s3
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mul_hi_u32 s9, s0, s3
; GFX12-NEXT:    s_mul_i32 s8, s0, s3
; GFX12-NEXT:    s_mul_hi_u32 s4, s0, s2
; GFX12-NEXT:    s_mul_i32 s11, s1, s2
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[4:5], s[8:9]
; GFX12-NEXT:    s_mul_hi_u32 s6, s1, s2
; GFX12-NEXT:    s_mul_hi_i32 s12, s1, s3
; GFX12-NEXT:    s_add_co_u32 s4, s8, s11
; GFX12-NEXT:    s_add_co_ci_u32 s4, s9, s6
; GFX12-NEXT:    s_mul_i32 s10, s1, s3
; GFX12-NEXT:    s_add_co_ci_u32 s11, s12, 0
; GFX12-NEXT:    s_mov_b32 s6, s2
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[4:5], s[10:11]
; GFX12-NEXT:    s_cmp_lt_i32 s1, 0
; GFX12-NEXT:    s_sub_nc_u64 s[6:7], s[8:9], s[6:7]
; GFX12-NEXT:    s_mov_b32 s4, s0
; GFX12-NEXT:    s_cselect_b32 s6, s6, s8
; GFX12-NEXT:    s_cselect_b32 s7, s7, s9
