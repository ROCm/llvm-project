...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=hawaii < %s | FileCheck  -enable-var-scope -check-prefixes=GCN,MUBUF,HAWAII %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck  -enable-var-scope -check-prefixes=GCN,MUBUF,GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=+enable-flat-scratch < %s | FileCheck  -enable-var-scope -check-prefixes=GCN,FLATSCR %s
...
; HAWAII-LABEL: callee_func_sgpr_spill_no_calls:
; HAWAII:       ; %bb.0:
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_or_saveexec_b64 s[4:5], -1
; HAWAII-NEXT:    buffer_store_dword v40, off, s[0:3], s32 ; 4-byte Folded Spill
; HAWAII-NEXT:    s_mov_b64 exec, s[4:5]
; HAWAII-NEXT:    v_writelane_b32 v40, s36, 0
; HAWAII-NEXT:    v_writelane_b32 v40, s37, 1
; HAWAII-NEXT:    v_writelane_b32 v40, s38, 2
; HAWAII-NEXT:    v_writelane_b32 v40, s39, 3
; HAWAII-NEXT:    v_writelane_b32 v40, s48, 4
; HAWAII-NEXT:    v_writelane_b32 v40, s49, 5
; HAWAII-NEXT:    v_writelane_b32 v40, s50, 6
; HAWAII-NEXT:    v_writelane_b32 v40, s51, 7
; HAWAII-NEXT:    v_writelane_b32 v40, s52, 8
; HAWAII-NEXT:    v_writelane_b32 v40, s53, 9
; HAWAII-NEXT:    v_writelane_b32 v40, s54, 10
; HAWAII-NEXT:    v_writelane_b32 v40, s55, 11
; HAWAII-NEXT:    v_writelane_b32 v40, s64, 12
; HAWAII-NEXT:    v_writelane_b32 v40, s65, 13
; HAWAII-NEXT:    v_writelane_b32 v40, s66, 14
; HAWAII-NEXT:    v_writelane_b32 v40, s67, 15
; HAWAII-NEXT:    v_writelane_b32 v40, s68, 16
; HAWAII-NEXT:    v_writelane_b32 v40, s69, 17
; HAWAII-NEXT:    v_writelane_b32 v40, s70, 18
; HAWAII-NEXT:    v_writelane_b32 v40, s71, 19
; HAWAII-NEXT:    v_writelane_b32 v40, s80, 20
; HAWAII-NEXT:    v_writelane_b32 v40, s81, 21
; HAWAII-NEXT:    v_writelane_b32 v40, s82, 22
; HAWAII-NEXT:    v_writelane_b32 v40, s83, 23
...
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; def s[68:83]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; def s[36:51]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; def s[52:67]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; def s[4:19]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; def s[20:27]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; def s[28:29]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; use s[68:83]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; use s[36:51]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; use s[52:67]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; use s[20:27]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; use s[28:29]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    ;;#ASMSTART
; HAWAII-NEXT:    ; use s[4:19]
; HAWAII-NEXT:    ;;#ASMEND
; HAWAII-NEXT:    v_readlane_b32 s83, v40, 23
; HAWAII-NEXT:    v_readlane_b32 s82, v40, 22
; HAWAII-NEXT:    v_readlane_b32 s81, v40, 21
; HAWAII-NEXT:    v_readlane_b32 s80, v40, 20
; HAWAII-NEXT:    v_readlane_b32 s71, v40, 19
; HAWAII-NEXT:    v_readlane_b32 s70, v40, 18
; HAWAII-NEXT:    v_readlane_b32 s69, v40, 17
; HAWAII-NEXT:    v_readlane_b32 s68, v40, 16
; HAWAII-NEXT:    v_readlane_b32 s67, v40, 15
; HAWAII-NEXT:    v_readlane_b32 s66, v40, 14
; HAWAII-NEXT:    v_readlane_b32 s65, v40, 13
; HAWAII-NEXT:    v_readlane_b32 s64, v40, 12
; HAWAII-NEXT:    v_readlane_b32 s55, v40, 11
; HAWAII-NEXT:    v_readlane_b32 s54, v40, 10
; HAWAII-NEXT:    v_readlane_b32 s53, v40, 9
; HAWAII-NEXT:    v_readlane_b32 s52, v40, 8
; HAWAII-NEXT:    v_readlane_b32 s51, v40, 7
; HAWAII-NEXT:    v_readlane_b32 s50, v40, 6
; HAWAII-NEXT:    v_readlane_b32 s49, v40, 5
; HAWAII-NEXT:    v_readlane_b32 s48, v40, 4
; HAWAII-NEXT:    v_readlane_b32 s39, v40, 3
; HAWAII-NEXT:    v_readlane_b32 s38, v40, 2
; HAWAII-NEXT:    v_readlane_b32 s37, v40, 1
; HAWAII-NEXT:    v_readlane_b32 s36, v40, 0
; HAWAII-NEXT:    s_or_saveexec_b64 s[4:5], -1
; HAWAII-NEXT:    buffer_load_dword v40, off, s[0:3], s32 ; 4-byte Folded Reload
; HAWAII-NEXT:    s_mov_b64 exec, s[4:5]
; HAWAII-NEXT:    s_waitcnt vmcnt(0)
; HAWAII-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: callee_func_sgpr_spill_no_calls:
; GFX9:       ; %bb.0:
...
; GFX9-NEXT:    v_writelane_b32 v40, s48, 4
; GFX9-NEXT:    v_writelane_b32 v40, s49, 5
; GFX9-NEXT:    v_writelane_b32 v40, s50, 6
; GFX9-NEXT:    v_writelane_b32 v40, s51, 7
; GFX9-NEXT:    v_writelane_b32 v40, s52, 8
; GFX9-NEXT:    v_writelane_b32 v40, s53, 9
; GFX9-NEXT:    v_writelane_b32 v40, s54, 10
; GFX9-NEXT:    v_writelane_b32 v40, s55, 11
; GFX9-NEXT:    v_writelane_b32 v40, s64, 12
; GFX9-NEXT:    v_writelane_b32 v40, s65, 13
; GFX9-NEXT:    v_writelane_b32 v40, s66, 14
; GFX9-NEXT:    v_writelane_b32 v40, s67, 15
; GFX9-NEXT:    v_writelane_b32 v40, s68, 16
; GFX9-NEXT:    v_writelane_b32 v40, s69, 17
; GFX9-NEXT:    v_writelane_b32 v40, s70, 18
; GFX9-NEXT:    v_writelane_b32 v40, s71, 19
; GFX9-NEXT:    v_writelane_b32 v40, s80, 20
; GFX9-NEXT:    v_writelane_b32 v40, s81, 21
; GFX9-NEXT:    v_writelane_b32 v40, s82, 22
; GFX9-NEXT:    v_writelane_b32 v40, s83, 23
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ;;#ASMEND
...
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; def s[68:83]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; def s[52:67]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; def s[36:51]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; def s[4:19]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; def s[20:27]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; def s[28:29]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; use s[68:83]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; use s[52:67]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; use s[36:51]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; use s[20:27]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; use s[28:29]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    ;;#ASMSTART
; GFX9-NEXT:    ; use s[4:19]
; GFX9-NEXT:    ;;#ASMEND
; GFX9-NEXT:    v_readlane_b32 s83, v40, 23
; GFX9-NEXT:    v_readlane_b32 s82, v40, 22
; GFX9-NEXT:    v_readlane_b32 s81, v40, 21
; GFX9-NEXT:    v_readlane_b32 s80, v40, 20
; GFX9-NEXT:    v_readlane_b32 s71, v40, 19
; GFX9-NEXT:    v_readlane_b32 s70, v40, 18
; GFX9-NEXT:    v_readlane_b32 s69, v40, 17
; GFX9-NEXT:    v_readlane_b32 s68, v40, 16
; GFX9-NEXT:    v_readlane_b32 s67, v40, 15
; GFX9-NEXT:    v_readlane_b32 s66, v40, 14
; GFX9-NEXT:    v_readlane_b32 s65, v40, 13
; GFX9-NEXT:    v_readlane_b32 s64, v40, 12
; GFX9-NEXT:    v_readlane_b32 s55, v40, 11
; GFX9-NEXT:    v_readlane_b32 s54, v40, 10
; GFX9-NEXT:    v_readlane_b32 s53, v40, 9
; GFX9-NEXT:    v_readlane_b32 s52, v40, 8
; GFX9-NEXT:    v_readlane_b32 s51, v40, 7
; GFX9-NEXT:    v_readlane_b32 s50, v40, 6
; GFX9-NEXT:    v_readlane_b32 s49, v40, 5
; GFX9-NEXT:    v_readlane_b32 s48, v40, 4
...
; GFX9-NEXT:    buffer_store_dword v38, off, s[0:3], s33 ; 4-byte Folded Spill
; GFX9-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-NEXT:    v_writelane_b32 v38, s4, 0
...
; GFX9-NEXT:    v_readlane_b32 s4, v38, 0
; GFX9-NEXT:    s_xor_saveexec_b64 s[6:7], -1
; GFX9-NEXT:    buffer_load_dword v38, off, s[0:3], s33 ; 4-byte Folded Reload
; GFX9-NEXT:    s_mov_b64 exec, s[6:7]
...
; FLATSCR-NEXT:    s_mov_b32 s33, s32
; FLATSCR-NEXT:    s_xor_saveexec_b64 s[2:3], -1
; FLATSCR-NEXT:    scratch_store_dword off, v38, s33 ; 4-byte Folded Spill
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
; FLATSCR-NEXT:    v_writelane_b32 v38, s0, 0
; FLATSCR-NEXT:    s_add_i32 s32, s32, 8
; FLATSCR-NEXT:    ;;#ASMSTART
; FLATSCR-NEXT:    ; clobber nonpreserved SGPRs
; FLATSCR-NEXT:    ;;#ASMEND
...
; FLATSCR-NEXT:    ;;#ASMEND
; FLATSCR-NEXT:    s_mov_b32 s32, s33
; FLATSCR-NEXT:    v_readlane_b32 s0, v38, 0
; FLATSCR-NEXT:    s_xor_saveexec_b64 s[2:3], -1
; FLATSCR-NEXT:    scratch_load_dword v38, off, s33 ; 4-byte Folded Reload
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
; FLATSCR-NEXT:    s_mov_b32 s33, s0
; FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; FLATSCR-NEXT:    s_setpc_b64 s[30:31]
...
; MUBUF-NEXT:    s_mov_b32 s33, s32
; MUBUF-NEXT:    s_xor_saveexec_b64 s[6:7], -1
; MUBUF-NEXT:    buffer_store_dword v38, off, s[0:3], s33 ; 4-byte Folded Spill
; MUBUF-NEXT:    s_mov_b64 exec, s[6:7]
; MUBUF-NEXT:    v_writelane_b32 v38, s4, 32
; MUBUF-NEXT:    s_addk_i32 s32, 0x200
; MUBUF-NEXT:    v_writelane_b32 v38, s39, 0
; MUBUF-NEXT:    v_writelane_b32 v38, s48, 1
; MUBUF-NEXT:    v_writelane_b32 v38, s49, 2
; MUBUF-NEXT:    v_writelane_b32 v38, s50, 3
; MUBUF-NEXT:    v_writelane_b32 v38, s51, 4
; MUBUF-NEXT:    v_writelane_b32 v38, s52, 5
; MUBUF-NEXT:    v_writelane_b32 v38, s53, 6
; MUBUF-NEXT:    v_writelane_b32 v38, s54, 7
; MUBUF-NEXT:    v_writelane_b32 v38, s55, 8
; MUBUF-NEXT:    v_writelane_b32 v38, s64, 9
; MUBUF-NEXT:    v_writelane_b32 v38, s65, 10
; MUBUF-NEXT:    v_writelane_b32 v38, s66, 11
; MUBUF-NEXT:    v_writelane_b32 v38, s67, 12
; MUBUF-NEXT:    v_writelane_b32 v38, s68, 13
; MUBUF-NEXT:    v_writelane_b32 v38, s69, 14
; MUBUF-NEXT:    v_writelane_b32 v38, s70, 15
; MUBUF-NEXT:    v_writelane_b32 v38, s71, 16
; MUBUF-NEXT:    v_writelane_b32 v38, s80, 17
; MUBUF-NEXT:    v_writelane_b32 v38, s81, 18
; MUBUF-NEXT:    v_writelane_b32 v38, s82, 19
; MUBUF-NEXT:    v_writelane_b32 v38, s83, 20
; MUBUF-NEXT:    v_writelane_b32 v38, s84, 21
; MUBUF-NEXT:    v_writelane_b32 v38, s85, 22
; MUBUF-NEXT:    v_writelane_b32 v38, s86, 23
; MUBUF-NEXT:    v_writelane_b32 v38, s87, 24
; MUBUF-NEXT:    v_writelane_b32 v38, s96, 25
; MUBUF-NEXT:    v_writelane_b32 v38, s97, 26
; MUBUF-NEXT:    v_writelane_b32 v38, s98, 27
; MUBUF-NEXT:    v_writelane_b32 v38, s99, 28
; MUBUF-NEXT:    v_writelane_b32 v38, s100, 29
; MUBUF-NEXT:    v_writelane_b32 v38, s101, 30
; MUBUF-NEXT:    v_writelane_b32 v38, s102, 31
; MUBUF-NEXT:    ;;#ASMSTART
; MUBUF-NEXT:    ; clobber nonpreserved SGPRs and 64 CSRs
; MUBUF-NEXT:    ;;#ASMEND
; MUBUF-NEXT:    ;;#ASMSTART
; MUBUF-NEXT:    ; clobber all VGPRs except CSR VGPRs
; MUBUF-NEXT:    ;;#ASMEND
; MUBUF-NEXT:    v_readlane_b32 s102, v38, 31
; MUBUF-NEXT:    v_readlane_b32 s101, v38, 30
; MUBUF-NEXT:    v_readlane_b32 s100, v38, 29
; MUBUF-NEXT:    v_readlane_b32 s99, v38, 28
; MUBUF-NEXT:    v_readlane_b32 s98, v38, 27
; MUBUF-NEXT:    v_readlane_b32 s97, v38, 26
; MUBUF-NEXT:    v_readlane_b32 s96, v38, 25
; MUBUF-NEXT:    v_readlane_b32 s87, v38, 24
; MUBUF-NEXT:    v_readlane_b32 s86, v38, 23
; MUBUF-NEXT:    v_readlane_b32 s85, v38, 22
; MUBUF-NEXT:    v_readlane_b32 s84, v38, 21
; MUBUF-NEXT:    v_readlane_b32 s83, v38, 20
; MUBUF-NEXT:    v_readlane_b32 s82, v38, 19
; MUBUF-NEXT:    v_readlane_b32 s81, v38, 18
; MUBUF-NEXT:    v_readlane_b32 s80, v38, 17
; MUBUF-NEXT:    v_readlane_b32 s71, v38, 16
; MUBUF-NEXT:    v_readlane_b32 s70, v38, 15
; MUBUF-NEXT:    v_readlane_b32 s69, v38, 14
; MUBUF-NEXT:    v_readlane_b32 s68, v38, 13
; MUBUF-NEXT:    v_readlane_b32 s67, v38, 12
; MUBUF-NEXT:    v_readlane_b32 s66, v38, 11
; MUBUF-NEXT:    v_readlane_b32 s65, v38, 10
; MUBUF-NEXT:    v_readlane_b32 s64, v38, 9
; MUBUF-NEXT:    v_readlane_b32 s55, v38, 8
; MUBUF-NEXT:    v_readlane_b32 s54, v38, 7
; MUBUF-NEXT:    v_readlane_b32 s53, v38, 6
; MUBUF-NEXT:    v_readlane_b32 s52, v38, 5
; MUBUF-NEXT:    v_readlane_b32 s51, v38, 4
; MUBUF-NEXT:    v_readlane_b32 s50, v38, 3
; MUBUF-NEXT:    v_readlane_b32 s49, v38, 2
; MUBUF-NEXT:    v_readlane_b32 s48, v38, 1
; MUBUF-NEXT:    v_readlane_b32 s39, v38, 0
; MUBUF-NEXT:    s_mov_b32 s32, s33
; MUBUF-NEXT:    v_readlane_b32 s4, v38, 32
; MUBUF-NEXT:    s_xor_saveexec_b64 s[6:7], -1
; MUBUF-NEXT:    buffer_load_dword v38, off, s[0:3], s33 ; 4-byte Folded Reload
; MUBUF-NEXT:    s_mov_b64 exec, s[6:7]
; MUBUF-NEXT:    s_mov_b32 s33, s4
; MUBUF-NEXT:    s_waitcnt vmcnt(0)
; MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
; FLATSCR-NEXT:    s_add_i32 s32, s32, 8
; FLATSCR-NEXT:    v_writelane_b32 v38, s39, 0
; FLATSCR-NEXT:    v_writelane_b32 v38, s48, 1
; FLATSCR-NEXT:    v_writelane_b32 v38, s49, 2
; FLATSCR-NEXT:    v_writelane_b32 v38, s50, 3
; FLATSCR-NEXT:    v_writelane_b32 v38, s51, 4
; FLATSCR-NEXT:    v_writelane_b32 v38, s52, 5
; FLATSCR-NEXT:    v_writelane_b32 v38, s53, 6
; FLATSCR-NEXT:    v_writelane_b32 v38, s54, 7
; FLATSCR-NEXT:    v_writelane_b32 v38, s55, 8
; FLATSCR-NEXT:    v_writelane_b32 v38, s64, 9
; FLATSCR-NEXT:    v_writelane_b32 v38, s65, 10
; FLATSCR-NEXT:    v_writelane_b32 v38, s66, 11
; FLATSCR-NEXT:    v_writelane_b32 v38, s67, 12
; FLATSCR-NEXT:    v_writelane_b32 v38, s68, 13
; FLATSCR-NEXT:    v_writelane_b32 v38, s69, 14
; FLATSCR-NEXT:    v_writelane_b32 v38, s70, 15
; FLATSCR-NEXT:    v_writelane_b32 v38, s71, 16
; FLATSCR-NEXT:    v_writelane_b32 v38, s80, 17
; FLATSCR-NEXT:    v_writelane_b32 v38, s81, 18
; FLATSCR-NEXT:    v_writelane_b32 v38, s82, 19
; FLATSCR-NEXT:    v_writelane_b32 v38, s83, 20
; FLATSCR-NEXT:    v_writelane_b32 v38, s84, 21
; FLATSCR-NEXT:    v_writelane_b32 v38, s85, 22
; FLATSCR-NEXT:    v_writelane_b32 v38, s86, 23
; FLATSCR-NEXT:    v_writelane_b32 v38, s87, 24
; FLATSCR-NEXT:    v_writelane_b32 v38, s96, 25
; FLATSCR-NEXT:    v_writelane_b32 v38, s97, 26
; FLATSCR-NEXT:    v_writelane_b32 v38, s98, 27
; FLATSCR-NEXT:    v_writelane_b32 v38, s99, 28
; FLATSCR-NEXT:    v_writelane_b32 v38, s100, 29
; FLATSCR-NEXT:    v_writelane_b32 v38, s101, 30
; FLATSCR-NEXT:    v_writelane_b32 v38, s102, 31
; FLATSCR-NEXT:    ;;#ASMSTART
; FLATSCR-NEXT:    ; clobber nonpreserved SGPRs and 64 CSRs
; FLATSCR-NEXT:    ;;#ASMEND
; FLATSCR-NEXT:    ;;#ASMSTART
; FLATSCR-NEXT:    ; clobber all VGPRs except CSR VGPRs
; FLATSCR-NEXT:    ;;#ASMEND
; FLATSCR-NEXT:    v_readlane_b32 s102, v38, 31
; FLATSCR-NEXT:    v_readlane_b32 s101, v38, 30
; FLATSCR-NEXT:    v_readlane_b32 s100, v38, 29
; FLATSCR-NEXT:    v_readlane_b32 s99, v38, 28
; FLATSCR-NEXT:    v_readlane_b32 s98, v38, 27
; FLATSCR-NEXT:    v_readlane_b32 s97, v38, 26
; FLATSCR-NEXT:    v_readlane_b32 s96, v38, 25
; FLATSCR-NEXT:    v_readlane_b32 s87, v38, 24
; FLATSCR-NEXT:    v_readlane_b32 s86, v38, 23
; FLATSCR-NEXT:    v_readlane_b32 s85, v38, 22
; FLATSCR-NEXT:    v_readlane_b32 s84, v38, 21
; FLATSCR-NEXT:    v_readlane_b32 s83, v38, 20
; FLATSCR-NEXT:    v_readlane_b32 s82, v38, 19
; FLATSCR-NEXT:    v_readlane_b32 s81, v38, 18
; FLATSCR-NEXT:    v_readlane_b32 s80, v38, 17
; FLATSCR-NEXT:    v_readlane_b32 s71, v38, 16
; FLATSCR-NEXT:    v_readlane_b32 s70, v38, 15
; FLATSCR-NEXT:    v_readlane_b32 s69, v38, 14
; FLATSCR-NEXT:    v_readlane_b32 s68, v38, 13
; FLATSCR-NEXT:    v_readlane_b32 s67, v38, 12
; FLATSCR-NEXT:    v_readlane_b32 s66, v38, 11
; FLATSCR-NEXT:    v_readlane_b32 s65, v38, 10
; FLATSCR-NEXT:    v_readlane_b32 s64, v38, 9
; FLATSCR-NEXT:    v_readlane_b32 s55, v38, 8
; FLATSCR-NEXT:    v_readlane_b32 s54, v38, 7
; FLATSCR-NEXT:    v_readlane_b32 s53, v38, 6
; FLATSCR-NEXT:    v_readlane_b32 s52, v38, 5
; FLATSCR-NEXT:    v_readlane_b32 s51, v38, 4
; FLATSCR-NEXT:    v_readlane_b32 s50, v38, 3
; FLATSCR-NEXT:    v_readlane_b32 s49, v38, 2
; FLATSCR-NEXT:    v_readlane_b32 s48, v38, 1
; FLATSCR-NEXT:    v_readlane_b32 s39, v38, 0
; FLATSCR-NEXT:    s_mov_b32 s32, s33
; FLATSCR-NEXT:    s_xor_saveexec_b64 s[2:3], -1
; FLATSCR-NEXT:    scratch_load_dword v38, off, s33 ; 4-byte Folded Reload
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
...
; FLATSCR-NEXT:    s_setpc_b64 s[30:31]
  ...
  call void asm sideeffect "; clobber all VGPRs except CSR VGPRs",
    "~{v0},~{v1},~{v2},~{v3},~{v4},~{v5},~{v6},~{v7},~{v8},~{v9}
    ,~{v10},~{v11},~{v12},~{v13},~{v14},~{v15},~{v16},~{v17},~{v18},~{v19}
    ,~{v20},~{v21},~{v22},~{v23},~{v24},~{v25},~{v26},~{v27},~{v28},~{v29}
    ,~{v30},~{v31},~{v32},~{v33},~{v34},~{v35},~{v36},~{v37}"()
...
; MUBUF-NEXT:    buffer_store_dword v38, off, s[0:3], s5 ; 4-byte Folded Spill
; MUBUF-NEXT:    s_mov_b64 exec, s[6:7]
; MUBUF-NEXT:    v_writelane_b32 v38, s4, 32
; MUBUF-NEXT:    s_add_i32 s32, s32, 0x40300
; MUBUF-NEXT:    v_writelane_b32 v38, s39, 0
...
; MUBUF-NEXT:    s_xor_saveexec_b64 s[6:7], -1
; MUBUF-NEXT:    s_add_i32 s5, s33, 0x40100
; MUBUF-NEXT:    buffer_load_dword v38, off, s[0:3], s5 ; 4-byte Folded Reload
; MUBUF-NEXT:    s_mov_b64 exec, s[6:7]
; MUBUF-NEXT:    s_mov_b32 s33, s4
; MUBUF-NEXT:    s_waitcnt vmcnt(0)
; MUBUF-NEXT:    s_setpc_b64 s[30:31]
...
; FLATSCR-NEXT:    scratch_store_dword off, v38, s1 ; 4-byte Folded Spill
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
; FLATSCR-NEXT:    s_addk_i32 s32, 0x100c
; FLATSCR-NEXT:    v_writelane_b32 v38, s39, 0
; FLATSCR-NEXT:    v_writelane_b32 v38, s48, 1
...
; FLATSCR-NEXT:    s_xor_saveexec_b64 s[2:3], -1
; FLATSCR-NEXT:    s_add_i32 s1, s33, 0x1004
; FLATSCR-NEXT:    scratch_load_dword v38, off, s1 ; 4-byte Folded Reload
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
; FLATSCR-NEXT:    s_mov_b32 s33, s0
; FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; FLATSCR-NEXT:    s_setpc_b64 s[30:31]
