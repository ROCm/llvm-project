...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 < %s | FileCheck  -enable-var-scope -check-prefixes=GCN,MUBUF,HAWAII %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck  -enable-var-scope -check-prefixes=GCN,MUBUF,GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -mattr=+enable-flat-scratch < %s | FileCheck  -enable-var-scope -check-prefixes=GCN,FLATSCR %s
