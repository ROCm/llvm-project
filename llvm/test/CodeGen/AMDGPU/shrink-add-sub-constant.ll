...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn < %s | FileCheck --check-prefixes=SI,SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn < %s | FileCheck --check-prefixes=SI,SI-GISEL %s
...
; SI-SDAG-NEXT:    s_mov_b32 s0, 0xffff0000
; SI-SDAG-NEXT:    v_bfi_b32 v2, s0, v2, v3
