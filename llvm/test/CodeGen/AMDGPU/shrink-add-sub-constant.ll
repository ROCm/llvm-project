...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck --check-prefixes=SI,SI-SDAG %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu8.02 < %s | FileCheck --check-prefixes=VI,VI-SDAG %s
