...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck --check-prefixes=SI,SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck --check-prefixes=SI,SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck --check-prefixes=VI,VI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck --check-prefixes=VI,VI-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck --check-prefixes=GFX10,GFX10-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-FAKE16 %s
...
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
; SI-SDAG-NEXT:    v_subrev_i32_e32 v2, vcc, 64, v2
; SI-SDAG-NEXT:    v_subrev_i32_e32 v3, vcc, 64, v3
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    buffer_store_dword v3, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    v_subrev_i32_e32 v2, vcc, 64, v2
; SI-SDAG-NEXT:    v_subrev_i32_e32 v3, vcc, 64, v3
; SI-SDAG-NEXT:    buffer_store_short v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    buffer_store_short v3, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SI-SDAG-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_mov_b32 s2, 0xffff0000
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_subrev_i32_e32 v3, vcc, 64, v2
; SI-SDAG-NEXT:    v_bfi_b32 v2, s2, v2, v3
...
; SI-SDAG-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
; SI-SDAG-NEXT:    s_mov_b32 s0, 0xffff
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_add_i32_e32 v3, vcc, -7, v2
; SI-SDAG-NEXT:    v_bfi_b32 v2, s0, v3, v2
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
