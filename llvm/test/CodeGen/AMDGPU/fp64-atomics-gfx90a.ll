...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.0a -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX90A
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.42 -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX942
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.50 -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX1250
