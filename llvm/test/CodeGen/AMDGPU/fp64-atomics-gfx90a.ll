...
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX90A
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx942 -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX942
; RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX1250
...
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x0
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
