...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50 < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50 -mattr=+safe-smem-prefetch < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-SDAG %s
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50 -mattr=+safe-cu-prefetch < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
...
; GFX1250-SPREFETCH-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-SPREFETCH-NEXT:    v_nop
; GFX1250-SPREFETCH-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; GFX1250-SPREFETCH-GISEL-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-SPREFETCH-GISEL-NEXT:    v_nop
; GFX1250-SPREFETCH-GISEL-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; GL2-ONLY-NEXT:    s_mov_b64 s[64:65], 0
; GL2-ONLY-NEXT:    v_nop
; GL2-ONLY-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; SAFE-CU-NEXT:    s_mov_b64 s[64:65], 0
; SAFE-CU-NEXT:    v_nop
; SAFE-CU-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
