...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=hawaii -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds < %s | FileCheck -check-prefix=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds < %s | FileCheck -check-prefix=GFX8 %s
...
; GFX7-NEXT:    buffer_store_dword v1, v0, s[12:15], 0 offen
...
; GFX8-NEXT:    buffer_store_dword v1, v0, s[88:91], 0 offen
