...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds < %s | FileCheck -check-prefix=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds < %s | FileCheck -check-prefix=GFX8 %s
