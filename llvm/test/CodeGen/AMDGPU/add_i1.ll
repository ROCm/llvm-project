...
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX9-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; GFX9-NEXT:    v_cmp_lt_u32_e64 s[8:9], 15, v0
; GFX9-NEXT:    s_xor_b64 s[12:13], s[8:9], exec
...
; GFX10-NEXT:    v_cmp_lt_u32_e64 s5, 15, v0
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_xor_b32 s2, exec_lo, s5
...
; GFX11-NEXT:    s_mov_b32 s6, 0
; GFX11-NEXT:    s_mov_b32 s6, 0
; GFX11-NEXT:    v_cmp_lt_u32_e64 s7, 15, v0
; GFX11-NEXT:    s_xor_b32 s9, s7, exec_lo
...
; GFX11-NEXT:  .LBB2_2:
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_xor_b32 s2, exec_lo, s7
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b32 s2, s2, exec_lo
; GFX11-NEXT:    s_or_b32 s6, s6, s2
; GFX11-NEXT:    s_mov_b32 exec_lo, s7
; GFX11-NEXT:    s_mov_b32 s2, 0
; GFX11-NEXT:    s_mov_b32 s2, 0
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB2_4
; GFX11-NEXT:  .LBB2_3: ; %else
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_mov_b32 s2, 0
