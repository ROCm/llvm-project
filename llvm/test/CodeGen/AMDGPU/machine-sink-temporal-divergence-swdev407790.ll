...
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s4, v46
; CHECK-NEXT:    s_add_i32 s4, s4, 1
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s4, v42
...
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s68, v46
; CHECK-NEXT:    s_add_i32 s4, s68, 5
; CHECK-NEXT:    s_lshl_b32 s5, s68, 5
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, s4, v42
; CHECK-NEXT:    s_add_i32 s68, s68, 1
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_read_u8 v57, v0
; CHECK-NEXT:    v_or3_b32 v58, s5, v43, s68
; CHECK-NEXT:    v_mov_b32_e32 v59, s68
; CHECK-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; CHECK-NEXT:    s_mov_b32 s101, 0
; CHECK-NEXT:    s_or_b32 s85, s85, s6
; CHECK-NEXT:    s_xor_b32 s5, exec_lo, s85
; CHECK-NEXT:    s_and_b32 s5, s5, exec_lo
; CHECK-NEXT:    s_or_b32 s87, s87, s5
...
; CHECK-NEXT:    v_add_nc_u32_e32 v59, s102, v46
; CHECK-NEXT:    s_mov_b32 s102, s4
...
; CHECK-NEXT:    s_or_b32 s80, s80, s5
; CHECK-NEXT:    s_xor_b32 s5, exec_lo, s80
; CHECK-NEXT:    s_and_b32 s5, s5, exec_lo
...
; CHECK-NEXT:    s_and_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_or_b32 s84, s84, s4
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s84
...
; CHECK-NEXT:    s_xor_b32 s4, exec_lo, s83
; CHECK-NEXT:    s_and_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_or_b32 s98, s98, s4
; CHECK-NEXT:    s_mov_b32 exec_lo, s83
; CHECK-NEXT:    s_mov_b32 s83, 0
; CHECK-NEXT:    s_mov_b32 s84, 0
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    s_xor_b32 s4, exec_lo, s81
; CHECK-NEXT:    s_and_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_or_b32 s100, s100, s4
; CHECK-NEXT:    s_mov_b32 exec_lo, s81
; CHECK-NEXT:    s_mov_b32 s81, 0
; CHECK-NEXT:    s_mov_b32 s98, 0
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_le_u32_e64 s53, v47, v41
; CHECK-NEXT:    s_xor_b32 exec_lo, s53, exec_lo
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    s_xor_b32 s4, exec_lo, vcc_lo
; CHECK-NEXT:    s_and_b32 s68, s4, exec_lo
; CHECK-NEXT:    s_mov_b32 exec_lo, vcc_lo
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    s_or_b32 s55, s55, vcc_lo
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
...
; CHECK-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; CHECK-NEXT:    s_mov_b32 s69, 0
; CHECK-NEXT:    s_or_b32 s64, s64, s6
; CHECK-NEXT:    s_xor_b32 s5, exec_lo, s64
; CHECK-NEXT:    s_and_b32 s5, s5, exec_lo
...
; CHECK-NEXT:    s_xor_b32 s4, exec_lo, s65
; CHECK-NEXT:    s_and_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_or_b32 s67, s67, s4
; CHECK-NEXT:    s_mov_b32 exec_lo, s65
; CHECK-NEXT:    s_mov_b32 s65, 0
; CHECK-NEXT:    s_mov_b32 s66, 0
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    s_xor_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_or_b32 s54, s54, s4
; CHECK-NEXT:    s_xor_b32 s4, exec_lo, s54
; CHECK-NEXT:    s_and_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_or_b32 s68, s68, s4
