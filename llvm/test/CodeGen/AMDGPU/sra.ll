...
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck %s -check-prefixes=VI
...
; VI-NEXT:    s_lshr_b32 s10, s1, 16
; VI-NEXT:    s_ashr_i32 s11, s0, 16
; VI-NEXT:    s_sext_i32_i16 s0, s0
; VI-NEXT:    s_ashr_i32 s8, s9, s8
; VI-NEXT:    s_ashr_i32 s2, s2, s3
; VI-NEXT:    s_ashr_i32 s3, s11, s10
; VI-NEXT:    s_ashr_i32 s0, s0, s1
; VI-NEXT:    s_lshl_b32 s1, s8, 16
...
; VI-NEXT:    s_mov_b32 s4, s2
; VI-NEXT:    s_mov_b32 s5, s3
; VI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:48
; VI-NEXT:    buffer_load_dwordx4 v[3:6], off, s[4:7], 0 offset:16
; VI-NEXT:    buffer_load_dwordx4 v[7:10], off, s[4:7], 0
; VI-NEXT:    buffer_load_dwordx4 v[11:14], off, s[4:7], 0 offset:32
; VI-NEXT:    s_mov_b32 s4, s0
; VI-NEXT:    s_mov_b32 s5, s1
...
; VI-NEXT:    buffer_store_dwordx4 v[3:6], off, s[4:7], 0 offset:16
; VI-NEXT:    buffer_store_dwordx4 v[7:10], off, s[4:7], 0
; VI-NEXT:    s_endpgm
;
; EG-LABEL: ashr_v4i64:
; EG:       ; %bb.0:
