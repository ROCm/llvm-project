...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=bonaire < %s | FileCheck -check-prefixes=GFX7 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-vopd=0 < %s | FileCheck -check-prefixes=GFX11 %s
...
; CHECK-NEXT:    s_load_dword s6, s[4:5], 0x13
; CHECK-NEXT:    s_load_dword s4, s[4:5], 0x1c
...
; GFX7-NEXT:    s_load_dword s4, s[4:5], 0x1c
...
; CHECK-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0xd
; CHECK-NEXT:    v_mov_b32_e32 v0, 7
...
; CHECK-NEXT:    ds_cmpst_rtn_b32 v0, v1, v0, v2
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
