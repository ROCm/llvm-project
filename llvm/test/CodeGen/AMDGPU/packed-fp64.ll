...
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_pk_add_f64 v[4:7], v[4:7], v[0:3]
...
; GFX1251-NEXT:    global_load_b128 v[4:7], v0, s[0:1] scale_offset
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_pk_mul_f64 v[4:7], v[4:7], v[0:3]
; GFX1251-NEXT:    global_store_b128 v0, v[4:7], s[0:1] scale_offset
; GFX1251-NEXT:    s_endpgm
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr inbounds <2 x double>, ptr addrspace(1) %a, i32 %id
...
; GFX1251-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v0, s8
...
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v7, s15 :: v_dual_mov_b32 v8, s0
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v9, s1 :: v_dual_mov_b32 v10, s2
; GFX1251-SDAG-NEXT:    v_mov_b32_e32 v11, s3
; GFX1251-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX1251-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1251-SDAG-NEXT:    s_load_b512 s[8:23], s[4:5], 0x1a4 nv
; GFX1251-SDAG-NEXT:    s_load_b512 s[36:51], s[4:5], 0x1e4 nv
; GFX1251-SDAG-NEXT:    s_load_b512 s[52:67], s[4:5], 0x124 nv
; GFX1251-SDAG-NEXT:    v_lshlrev_b32_e32 v40, 8, v0
; GFX1251-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-NEXT:    s_clause 0xf
; GFX1251-SDAG-NEXT:    global_load_b128 v[36:39], v40, s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_load_b128 v[32:35], v40, s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_load_b128 v[28:31], v40, s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_load_b128 v[24:27], v40, s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_load_b128 v[20:23], v40, s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_load_b128 v[16:19], v40, s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_load_b128 v[8:11], v40, s[0:1]
; GFX1251-SDAG-NEXT:    global_load_b128 v[12:15], v40, s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v40, s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v40, s[0:1] offset:64
; GFX1251-SDAG-NEXT:    global_load_b128 v[42:45], v40, s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_load_b128 v[46:49], v40, s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_load_b128 v[50:53], v40, s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_load_b128 v[54:57], v40, s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_load_b128 v[58:61], v40, s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_load_b128 v[62:65], v40, s[0:1] offset:144
...
; GFX1251-SDAG-NEXT:    s_load_b512 s[16:31], s[4:5], 0x164 nv
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xf
...
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[58:59]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[56:57]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xb
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[20:23], v[20:23], v[66:69], v[66:69]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[54:55]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[52:53]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
...
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[26:27]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[24:25]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[0:3], v[0:3], v[70:73], v[70:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[30:31]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[28:29]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x5
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[42:45], v[42:45], v[66:69], v[66:69]
...
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[10:11]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[8:9]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[54:57], v[54:57], v[70:73], v[70:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[14:15]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[12:13]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
...
; GFX1251-SDAG-NEXT:    s_clause 0xf
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[42:45], s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[46:49], s[0:1] offset:112
...
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[12:15], s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[50:53], s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[8:11], s[0:1]
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[16:19], s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[54:57], s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[20:23], s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[24:27], s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[28:31], s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[32:35], s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[36:39], s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[58:61], s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_store_b128 v40, v[62:65], s[0:1] offset:144
; GFX1251-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1251-SDAG-NEXT:    s_endpgm
;
...
; GFX1251-NEXT:    global_load_b128 v[4:7], v0, s[0:1] scale_offset
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_pk_fma_f64 v[4:7], v[4:7], v[0:3], v[0:3]
; GFX1251-NEXT:    global_store_b128 v0, v[4:7], s[0:1] scale_offset
; GFX1251-NEXT:    s_endpgm
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr inbounds <2 x double>, ptr addrspace(1) %a, i32 %id
...
; GFX1251-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
...
; GFX1251-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[16:19], v56, s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_load_b128 v[20:23], v56, s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_load_b128 v[24:27], v56, s[0:1]
; GFX1251-SDAG-NEXT:    global_load_b128 v[28:31], v56, s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_load_b128 v[32:35], v56, s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_load_b128 v[36:39], v56, s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_load_b128 v[40:43], v56, s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_load_b128 v[44:47], v56, s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_load_b128 v[48:51], v56, s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_load_b128 v[52:55], v56, s[0:1] offset:176
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xb
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v56, s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v56, s[0:1] offset:144
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1251-SDAG-NEXT:    v_pk_add_f64 v[0:3], v[0:3], 0 neg_lo:[1,1] neg_hi:[1,1]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_add_f64 v[4:7], v[4:7], 0 neg_lo:[1,1] neg_hi:[1,1]
...
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[16:19], s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[20:23], s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[24:27], s[0:1]
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[28:31], s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[32:35], s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[36:39], s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[40:43], s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[44:47], s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[48:51], s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[52:55], s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[0:3], s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[4:7], s[0:1] offset:144
; GFX1251-SDAG-NEXT:    s_endpgm
;
...
; GFX1251-GISEL-NEXT:    global_load_b128 v[20:23], v56, s[0:1]
; GFX1251-GISEL-NEXT:    global_load_b128 v[16:19], v56, s[0:1] offset:16
...
; GFX1251-GISEL-NEXT:    global_store_b128 v56, v[20:23], s[0:1]
; GFX1251-GISEL-NEXT:    global_load_b128 v[20:23], v56, s[0:1] offset:224
; GFX1251-GISEL-NEXT:    global_store_b128 v56, v[16:19], s[0:1] offset:16
; GFX1251-GISEL-NEXT:    global_load_b128 v[16:19], v56, s[0:1] offset:240
...
; GFX1251-GISEL-NEXT:    global_store_b128 v56, v[20:23], s[0:1] offset:224
; GFX1251-GISEL-NEXT:    global_store_b128 v56, v[16:19], s[0:1] offset:240
; GFX1251-GISEL-NEXT:    s_endpgm
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr inbounds <32 x double>, ptr addrspace(1) %a, i32 %id
...
; GFX1251-GISEL-NEXT:    v_and_b32_e32 v6, 0x3ff, v0
; GFX1251-GISEL-NEXT:    v_readfirstlane_b32 s0, v2
; GFX1251-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1251-GISEL-NEXT:    v_readfirstlane_b32 s1, v3
; GFX1251-GISEL-NEXT:    v_readfirstlane_b32 s2, v4
...
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX1251-GISEL-NEXT:    global_store_b128 v6, v[0:3], s[8:9] scale_offset
; GFX1251-GISEL-NEXT:    s_endpgm
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr inbounds <2 x double>, ptr addrspace(1) %a, i32 %id
