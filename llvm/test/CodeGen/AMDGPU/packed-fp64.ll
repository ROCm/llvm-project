...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1251 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1251,GFX1251-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1251 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1251,GFX1251-GISEL %s
...
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[72:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[74:75]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[70:71]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[68:69]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xf
; GFX1251-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[40:43], v[40:43], v[66:69], v[66:69]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[80:81]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[82:83]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xe
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[36:39], v[36:39], v[70:73], v[70:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[76:77]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[78:79]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xd
