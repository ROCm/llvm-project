...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.31-amd-amdhsa < %s | FileCheck %s
...
; CHECK-NEXT:    s_xor_b32 s9, exec_lo, s7
; CHECK-NEXT:    s_or_b32 s5, s5, s9
...
; CHECK-NEXT:    s_or_b32 s10, s4, s9
; CHECK-NEXT:    s_mov_b32 s4, 0
; CHECK-NEXT:    s_xor_b32 s9, exec_lo, s10
; CHECK-NEXT:    s_mov_b32 exec_lo, s10
; CHECK-NEXT:    ; divergent control-flow edge
; CHECK-NEXT:    s_cbranch_execz .LBB0_1
; CHECK-NEXT:  .LBB0_3: ; %for.body51.preheader
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    v_mov_b32_e32 v6, v2
; CHECK-NEXT:    s_mov_b32 s10, 4
...
; CHECK-NEXT:    s_or_b32 s12, s6, vcc_lo
; CHECK-NEXT:    s_mov_b32 s6, 0
; CHECK-NEXT:    s_xor_b32 s11, exec_lo, s12
; CHECK-NEXT:    s_or_b32 s8, s8, s11
