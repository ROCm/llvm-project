...
; RUN: llc -global-isel=0 -mtriple=amdgpu7.00-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,GFX7,GFX7-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu7.00-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,GFX7,GFX7-GISEL %s

; Test legal f16, no f16 fmed3. Should expand to min/max sequence
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,GFX8,GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,GFX8,GFX8-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9-GISEL %s
...
; GFX8-NEXT:    v_min_f16_e32 v0, v3, v0
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_max_f16_e32 v2, 2.0, v0
; GFX8-NEXT:    v_min_f16_e32 v0, 2.0, v0
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v1, 0x4c00
; GFX8-NEXT:    v_max_f16_e32 v2, 0, v1
; GFX8-NEXT:    v_min_f16_e32 v1, 0, v1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_max_f16_e32 v1, 0, v0
; GFX8-NEXT:    v_min_f16_e32 v0, 0, v0
; GFX8-NEXT:    v_max_f16_e32 v0, 2.0, v0
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_max_f16_e64 v3, |v0|, |v1|
; GFX8-NEXT:    v_min_f16_e64 v0, |v0|, |v1|
; GFX8-NEXT:    v_max_f16_e64 v0, v0, |v2|
; GFX8-NEXT:    v_min_f16_e32 v0, v3, v0
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_cvt_f32_f16_e32 v5, v2
; GFX8-NEXT:    flat_store_dword v[3:4], v5
; GFX8-NEXT:    v_max_f16_e32 v3, v0, v1
; GFX8-NEXT:    v_min_f16_e32 v0, v0, v1
; GFX8-NEXT:    v_max_f16_e32 v0, v0, v2
