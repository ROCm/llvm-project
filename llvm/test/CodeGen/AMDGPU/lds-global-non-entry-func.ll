...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -o - -amdgpu-enable-lower-module-lds=false %s 2> %t | FileCheck -check-prefixes=GFX8,GFX8-SDAG %s
; RUN: FileCheck -check-prefix=ERR %s < %t

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -o - -amdgpu-enable-lower-module-lds=false %s 2> %t | FileCheck -check-prefixes=GFX8,GFX8-GISEL %s
; RUN: FileCheck -check-prefix=ERR %s < %t

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -o - -amdgpu-enable-lower-module-lds=false %s 2> %t | FileCheck -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: FileCheck -check-prefix=ERR %s < %t

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -o - -amdgpu-enable-lower-module-lds=false %s 2> %t | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: FileCheck -check-prefix=ERR %s < %t
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx900 < %s 2> %t | FileCheck -check-prefixes=CHECK,SDAG %s
; RUN: FileCheck -check-prefix=ERR %s < %t

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx900 < %s 2> %t | FileCheck -check-prefixes=CHECK,GISEL %s
; RUN: FileCheck -check-prefix=ERR %s < %t
...
; GFX8-SDAG-NEXT:    s_mov_b32 m0, -1
; GFX8-SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX8-SDAG-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX8-SDAG-NEXT:    ; divergent control-flow edge
; GFX8-SDAG-NEXT:    s_cbranch_execz .LBB2_2
; GFX8-SDAG-NEXT:  .LBB2_1: ; %bb0
; GFX8-SDAG-NEXT:    v_mov_b32_e32 v0, 0
; GFX8-SDAG-NEXT:    s_mov_b64 s[8:9], 0xc8
; GFX8-SDAG-NEXT:    ds_write_b32 v0, v0
; GFX8-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    s_trap 2
; GFX8-SDAG-NEXT:  .LBB2_2:
; GFX8-SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-SDAG-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX8-SDAG-NEXT:    ; divergent control-flow edge
; GFX8-SDAG-NEXT:    s_cbranch_execz .LBB2_4
; GFX8-SDAG-NEXT:  .LBB2_3: ; %bb1
...
; GFX9-SDAG-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX9-SDAG-NEXT:    ; divergent control-flow edge
; GFX9-SDAG-NEXT:    s_cbranch_execz .LBB2_2
; GFX9-SDAG-NEXT:  .LBB2_1: ; %bb0
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-SDAG-NEXT:    ds_write_b32 v0, v0
; GFX9-SDAG-NEXT:    s_trap 2
; GFX9-SDAG-NEXT:  .LBB2_2:
...
; SDAG-NEXT:    s_mov_b64 s[12:13], -1
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    s_and_saveexec_b64 s[10:11], vcc
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execz .LBB2_3
; SDAG-NEXT:  .LBB2_1: ; %bb0
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    ds_write_b32 v0, v0
; SDAG-NEXT:    s_cbranch_execnz .LBB2_8
; SDAG-NEXT:  ; %bb.2:
; SDAG-NEXT:    s_and_b64 s[6:7], s[12:13], exec
; SDAG-NEXT:  .LBB2_3:
; SDAG-NEXT:    s_or_b64 exec, exec, s[10:11]
; SDAG-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
; SDAG-NEXT:    ; divergent control-flow edge
...
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
; SDAG-NEXT:    ; divergent control-flow edge
