...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -check-prefixes=SICI,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=bonaire < %s | FileCheck -check-prefixes=SICI,CI %s
...
; SICI-LABEL: fnearbyint_f16:
; SICI:       ; %bb.0:
; SICI-NEXT:    s_load_dword s2, s[4:5], 0xb
; SICI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SICI-NEXT:    s_mov_b32 s3, 0xf000
; SICI-NEXT:    s_waitcnt lgkmcnt(0)
; SICI-NEXT:    v_cvt_f32_f16_e32 v0, s2
; SICI-NEXT:    s_mov_b32 s2, -1
; SICI-NEXT:    v_rndne_f32_e32 v0, v0
; SICI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; SICI-NEXT:    buffer_store_short v0, off, s[0:3], 0
; SICI-NEXT:    s_endpgm
;
...
; SICI:       ; %bb.0: ; %entry
; SICI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SICI-NEXT:    s_load_dword s4, s[4:5], 0xb
; SICI-NEXT:    s_mov_b32 s3, 0xf000
; SICI-NEXT:    s_mov_b32 s2, -1
; SICI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SICI-NEXT:    s_mov_b32 s6, 0xf000
; SICI-NEXT:    s_mov_b32 s7, -1
; SICI-NEXT:    s_waitcnt lgkmcnt(0)
; SICI-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SICI-NEXT:    s_mov_b32 s2, s7
; SICI-NEXT:    s_mov_b32 s3, s6
...
; SICI:       ; %bb.0: ; %entry
; SICI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SICI-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0xd
; SICI-NEXT:    s_mov_b32 s3, 0xf000
; SICI-NEXT:    s_mov_b32 s2, -1
; SICI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    v_bfi_b32 v5, s14, v10, v11
...
; SI-NEXT:    v_bfi_b32 v5, s14, v10, v13
