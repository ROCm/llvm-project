...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9 %s
...
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], v0, v5
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], v4, v2
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
