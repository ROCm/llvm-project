...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_dwordx2 v[2:3], off, s[12:15], 0 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    s_mov_b32 s2, s10
; SI-NEXT:    s_mov_b32 s3, s11
; SI-NEXT:    s_mov_b32 s8, s0
...
; GFX11-NEXT:    s_mov_b32 s12, s4
; GFX11-NEXT:    s_mov_b32 s13, s5
; GFX11-NEXT:    buffer_load_b64 v[0:1], off, s[8:11], 0 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_load_b64 v[2:3], off, s[12:15], 0 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_mov_b32 s8, s6
; GFX11-NEXT:    s_mov_b32 s9, s7
; GFX11-NEXT:    s_mov_b32 s2, s10
; GFX11-NEXT:    buffer_load_b64 v[4:5], off, s[8:11], 0 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_mov_b32 s3, s11
...
; GFX1170-NEXT:    s_mov_b32 s12, s4
; GFX1170-NEXT:    s_mov_b32 s13, s5
; GFX1170-NEXT:    buffer_load_b64 v[0:1], off, s[8:11], 0 glc dlc
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    buffer_load_b64 v[2:3], off, s[12:15], 0 glc dlc
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_mov_b32 s8, s6
; GFX1170-NEXT:    s_mov_b32 s9, s7
; GFX1170-NEXT:    s_mov_b32 s2, s10
; GFX1170-NEXT:    buffer_load_b64 v[4:5], off, s[8:11], 0 glc dlc
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_mov_b32 s3, s11
...
; GFX1170-NEXT:    v_min_num_f64 v[0:1], v[0:1], v[2:3]
; GFX1170-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX1170-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_mov_b32 s12, s4
; GFX12-NEXT:    s_mov_b32 s13, s5
; GFX12-NEXT:    buffer_load_b64 v[0:1], off, s[8:11], null scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b64 v[2:3], off, s[12:15], null scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_mov_b32 s8, s6
; GFX12-NEXT:    s_mov_b32 s9, s7
; GFX12-NEXT:    s_mov_b32 s2, s10
; GFX12-NEXT:    buffer_load_b64 v[4:5], off, s[8:11], null scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_mov_b32 s3, s11
...
; GFX1250-NEXT:    s_mov_b32 s4, s12
; GFX1250-NEXT:    s_mov_b32 s5, s13
; GFX1250-NEXT:    buffer_load_b64 v[0:1], off, s[0:3], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_load_b64 v[2:3], off, s[4:7], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s0, s14
; GFX1250-NEXT:    s_mov_b32 s1, s15
; GFX1250-NEXT:    s_mov_b32 s10, s2
; GFX1250-NEXT:    buffer_load_b64 v[4:5], off, s[0:3], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s11, s3
