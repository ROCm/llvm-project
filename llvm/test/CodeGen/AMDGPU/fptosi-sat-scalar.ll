...
; GFX11-NEXT:    s_xor_b64 s[4:5], s[4:5], s[2:3]
; GFX11-NEXT:    s_sub_u32 s3, s4, s2
; GFX11-NEXT:    s_subb_u32 s2, s5, s2
; GFX11-NEXT:    s_and_b32 s4, s1, exec_lo
; GFX11-NEXT:    s_cselect_b32 s3, 0, s3
; GFX11-NEXT:    s_and_b32 s4, s6, exec_lo
; GFX11-NEXT:    s_cselect_b32 s3, -1, s3
; GFX11-NEXT:    s_and_b32 s4, s0, exec_lo
; GFX11-NEXT:    s_cselect_b32 s3, 0, s3
; GFX11-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX11-NEXT:    s_cselect_b32 s1, 0x80000000, s2
...
; GFX7-ISEL-NEXT:    v_bfrev_b32_e32 v7, -2
; GFX7-ISEL-NEXT:    v_floor_f64_e32 v[4:5], v[4:5]
; GFX7-ISEL-NEXT:    v_fma_f64 v[2:3], v[4:5], s[8:9], v[2:3]
; GFX7-ISEL-NEXT:    v_cvt_i32_f64_e32 v8, v[4:5]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e32 v4, v8, v6, vcc
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v4, v4, v7, s[4:5]
