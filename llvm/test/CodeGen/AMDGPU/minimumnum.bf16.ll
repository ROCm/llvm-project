...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v2, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v3, v5
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v2, v4
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v3, v5
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v3, v5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v4, v6
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v7, v8
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.h, v1.h, v0.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 0x8000, v0.h
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4)
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v3, v5
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v4, v6
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v7, v8
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v1.h, v1.h, v0.h, vcc_lo
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 0x8000, v0.h
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v7, v5
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v0.l
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v8, v9
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v2.h, v2.h, v0.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v7, v5
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v0.l
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v8, v9
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v2.h, v2.h, v0.h, vcc_lo
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v9, v6
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v9, v6
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v8.h
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v13, 16, v13
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v14, 16, v14
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v6, v5
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v8.h
...
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v13, 16, v13
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v14, 16, v14
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v6, v5
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v19, v21
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v22, v23
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v21, v22
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v19.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v24.l, v19.l
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v24, 16, v24
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v22, v23
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v21, v17
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v19, v21
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v22, v23
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v21, v22
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v19.h
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v24.l, v19.l
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v24, 16, v24
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v22, v23
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s1, v21, v17
...
; GFX10-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v35, v33
...
; GFX10-NEXT:    v_cmp_lt_f32_e64 s5, v54, v53
...
; GFX10-NEXT:    v_cmp_eq_u16_e64 s4, 0x8000, v9
; GFX10-NEXT:    v_cmp_lt_f32_e64 s5, v52, v51
...
; GFX10-NEXT:    v_cmp_lt_f32_e64 s7, v51, v50
...
; GFX10-NEXT:    v_cmp_lt_f32_e64 s4, v50, v24
...
; GFX10-NEXT:    v_cmp_lt_f32_e64 s7, v49, v24
...
; GFX10-NEXT:    v_cmp_lt_f32_e64 s7, v50, v49
; GFX10-NEXT:    v_lshlrev_b32_e32 v21, 16, v17
; GFX10-NEXT:    v_cndmask_b32_e64 v16, v16, v0, s6
; GFX10-NEXT:    v_cmp_eq_u16_e64 s6, 0x8000, v3
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s28, v71, v113
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s17, v52, v86
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s18, v53, v86
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v53.l, v51.h
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s22, v65, v99
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s40, v81, v87
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s41, v82, v53
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s2, 0x8000, v13.h
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s19, v54, v96
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s43, v84, v54
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s21, v64, v98
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s23, v66, v100
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s25, v68, v102
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s26, v69, v103
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s27, v70, v112
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v54, 16, v54
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s24, v67, v101
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s4, 0x8000, v32.l
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s42, v83, v86
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s1, 0x8000, v14.h
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v12.h
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s5, 0x8000, v32.h
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s7, 0x8000, v33.h
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s9, 0x8000, v34.h
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s10, 0x8000, v35.l
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s11, 0x8000, v36.l
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s8, 0x8000, v34.l
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s13, 0x8000, v37.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v83, 16, v83
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v54, 16, v54
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v53, v55
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v52, v54
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v31.l, v31.l, v15.l, s0
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 0x8000, v15.h
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s2, v50, v48
; GFX11-TRUE16-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v27
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v51, v49
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e64 s1, 0x8000, v10.h
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v24, v11
...
; GFX11-FAKE16-NEXT:    v_cmp_lt_f32_e64 s15, v14, v98
...
; GFX11-FAKE16-NEXT:    v_cmp_lt_f32_e64 s15, v97, v14
...
; GFX11-FAKE16-NEXT:    v_cmp_eq_u16_e64 s14, 0x8000, v54
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX11-FAKE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v38, v32
...
; GFX11-FAKE16-NEXT:    v_cmp_eq_u16_e64 s0, 0x8000, v10
; GFX11-FAKE16-NEXT:    v_cmp_lt_f32_e64 s2, v50, v38
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_cmp_lt_f32_e64 s1, v32, v29
; GFX11-FAKE16-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v28
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s28, v71, v113
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s17, v52, v86
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s18, v53, v86
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v53.l, v51.h
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s22, v65, v99
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s40, v81, v87
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s41, v82, v53
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s2, 0x8000, v13.h
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s19, v54, v96
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s43, v84, v54
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s21, v64, v98
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s23, v66, v100
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s25, v68, v102
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s26, v69, v103
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s27, v70, v112
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v54, 16, v54
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s24, v67, v101
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s4, 0x8000, v32.l
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s42, v83, v86
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s1, 0x8000, v14.h
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s3, 0x8000, v12.h
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s5, 0x8000, v32.h
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s7, 0x8000, v33.h
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s9, 0x8000, v34.h
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s10, 0x8000, v35.l
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s11, 0x8000, v36.l
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s8, 0x8000, v34.l
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s13, 0x8000, v37.l
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v83, 16, v83
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v54, 16, v54
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v53, v55
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v52, v54
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v31.l, v31.l, v15.l, s0
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 0x8000, v15.h
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s2, v50, v48
; GFX12-TRUE16-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v27
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v51, v49
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e64 s1, 0x8000, v10.h
...
; GFX12-TRUE16-NEXT:    v_cmp_lt_f32_e64 s0, v24, v11
...
; GFX12-FAKE16-NEXT:    v_cmp_lt_f32_e64 s15, v14, v98
...
; GFX12-FAKE16-NEXT:    v_cmp_lt_f32_e64 s15, v97, v14
...
; GFX12-FAKE16-NEXT:    v_cmp_eq_u16_e64 s14, 0x8000, v54
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX12-FAKE16-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v38, v32
...
; GFX12-FAKE16-NEXT:    v_cmp_eq_u16_e64 s0, 0x8000, v10
; GFX12-FAKE16-NEXT:    v_cmp_lt_f32_e64 s2, v50, v38
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX12-FAKE16-NEXT:    v_cmp_lt_f32_e64 s1, v32, v29
; GFX12-FAKE16-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v28
