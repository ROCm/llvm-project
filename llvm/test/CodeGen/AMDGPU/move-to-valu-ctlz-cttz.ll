...
; GFX9-NEXT:    global_load_ubyte v5, v1, s[2:3] offset:2
; GFX9-NEXT:    global_load_ubyte v6, v1, s[2:3] offset:1
; GFX9-NEXT:    global_load_ubyte v7, v1, s[2:3] offset:4
; GFX9-NEXT:    global_load_ubyte v8, v1, s[2:3]
; GFX9-NEXT:    s_mov_b32 s2, 0x40c0c
; GFX9-NEXT:    s_waitcnt vmcnt(6)
; GFX9-NEXT:    v_perm_b32 v0, v2, v0, s2
; GFX9-NEXT:    s_waitcnt vmcnt(5)
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, 8, v3
; GFX9-NEXT:    s_waitcnt vmcnt(3)
; GFX9-NEXT:    v_perm_b32 v3, v5, v4, s2
; GFX9-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NEXT:    v_lshlrev_b32_e32 v4, 8, v6
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_or_b32_e32 v2, v2, v7
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v8
; GFX9-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX9-NEXT:    v_or_b32_e32 v2, v3, v4
...
; GFX10-NEXT:    global_load_ubyte v3, v1, s[2:3] offset:3
; GFX10-NEXT:    global_load_ubyte v4, v1, s[2:3] offset:2
; GFX10-NEXT:    global_load_ubyte v5, v1, s[2:3]
; GFX10-NEXT:    global_load_ubyte v6, v1, s[2:3] offset:7
; GFX10-NEXT:    global_load_ubyte v7, v1, s[2:3] offset:6
...
; GFX10-NEXT:    v_perm_b32 v3, v4, v3, 0x40c0c
; GFX10-NEXT:    s_waitcnt vmcnt(3)
; GFX10-NEXT:    v_or_b32_e32 v0, v0, v5
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_perm_b32 v4, v7, v6, 0x40c0c
...
; GFX10-NEXT:    global_load_ubyte v8, v1, s[2:3]
; GFX10-NEXT:    s_waitcnt vmcnt(7)
; GFX10-NEXT:    v_lshlrev_b32_e32 v0, 8, v0
; GFX10-NEXT:    s_waitcnt vmcnt(5)
; GFX10-NEXT:    v_perm_b32 v2, v3, v2, 0x40c0c
; GFX10-NEXT:    s_waitcnt vmcnt(4)
; GFX10-NEXT:    v_lshlrev_b32_e32 v3, 8, v4
; GFX10-NEXT:    s_waitcnt vmcnt(3)
; GFX10-NEXT:    v_or_b32_e32 v0, v0, v5
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_perm_b32 v4, v7, v6, 0x40c0c
