...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 | FileCheck %s -check-prefix=GFX1100
...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 | FileCheck %s -check-prefix=G_GFX1100
...
; GFX1030-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
...
; GFX1100-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
