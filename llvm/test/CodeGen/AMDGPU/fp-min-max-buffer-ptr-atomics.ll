...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 | FileCheck %s -check-prefix=GFX1100
...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -mtriple=amdgpu11.00 | FileCheck %s -check-prefix=G_GFX1100
