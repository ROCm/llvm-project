...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -check-prefix=SDAG-GCN -check-prefix=SDAG-VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -check-prefix=SDAG-GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -check-prefix=SDAG-GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -check-prefix=SDAG-GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -check-prefix=SDAG-GFX12-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -new-reg-bank-select -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -check-prefix=GISEL-GCN -check-prefix=GISEL-VI %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -new-reg-bank-select -mcpu=gfx1100 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -check-prefix=GISEL-GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -new-reg-bank-select -mcpu=gfx1100 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -check-prefix=GISEL-GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -new-reg-bank-select -mcpu=gfx1200 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -check-prefix=GISEL-GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -new-reg-bank-select -mcpu=gfx1200 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -check-prefix=GISEL-GFX12-FAKE16 %s
...
; GFX12-TRUE16-NEXT:    s_mov_b32 s5, s3
; GFX12-TRUE16-NEXT:    s_mov_b32 s2, s6
; GFX12-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[4:7], null
; GFX12-TRUE16-NEXT:    s_mov_b32 s3, s7
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s4, s2
; GFX12-FAKE16-NEXT:    s_mov_b32 s5, s3
; GFX12-FAKE16-NEXT:    s_mov_b32 s2, s6
; GFX12-FAKE16-NEXT:    buffer_load_u16 v0, off, s[4:7], null
; GFX12-FAKE16-NEXT:    s_mov_b32 s3, s7
...
; SDAG-GCN-NEXT:    s_mov_b32 s4, s2
; SDAG-GCN-NEXT:    s_mov_b32 s5, s3
; SDAG-GCN-NEXT:    buffer_load_ushort v0, off, s[4:7], 0
; SDAG-GCN-NEXT:    s_mov_b32 s2, s6
; SDAG-GCN-NEXT:    s_mov_b32 s3, s7
; SDAG-GCN-NEXT:    s_waitcnt vmcnt(0)
; SDAG-GCN-NEXT:    v_rsq_f16_e32 v0, v0
; SDAG-GCN-NEXT:    buffer_store_short v0, off, s[0:3], 0
...
; SDAG-GFX11-TRUE16-NEXT:    s_mov_b32 s4, s2
; SDAG-GFX11-TRUE16-NEXT:    s_mov_b32 s5, s3
; SDAG-GFX11-TRUE16-NEXT:    s_mov_b32 s2, s6
; SDAG-GFX11-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[4:7], 0
; SDAG-GFX11-TRUE16-NEXT:    s_mov_b32 s3, s7
; SDAG-GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; SDAG-GFX11-TRUE16-NEXT:    v_rsq_f16_e32 v0.l, v0.l
; SDAG-GFX11-TRUE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; SDAG-GFX11-FAKE16-NEXT:    s_mov_b32 s4, s2
; SDAG-GFX11-FAKE16-NEXT:    s_mov_b32 s5, s3
; SDAG-GFX11-FAKE16-NEXT:    s_mov_b32 s2, s6
; SDAG-GFX11-FAKE16-NEXT:    buffer_load_u16 v0, off, s[4:7], 0
; SDAG-GFX11-FAKE16-NEXT:    s_mov_b32 s3, s7
; SDAG-GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; SDAG-GFX11-FAKE16-NEXT:    v_rsq_f16_e32 v0, v0
; SDAG-GFX11-FAKE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; SDAG-GFX12-TRUE16-NEXT:    s_mov_b32 s4, s2
; SDAG-GFX12-TRUE16-NEXT:    s_mov_b32 s5, s3
; SDAG-GFX12-TRUE16-NEXT:    s_mov_b32 s2, s6
; SDAG-GFX12-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[4:7], null
; SDAG-GFX12-TRUE16-NEXT:    s_mov_b32 s3, s7
...
; SDAG-GFX12-FAKE16-NEXT:    s_mov_b32 s4, s2
; SDAG-GFX12-FAKE16-NEXT:    s_mov_b32 s5, s3
; SDAG-GFX12-FAKE16-NEXT:    s_mov_b32 s2, s6
; SDAG-GFX12-FAKE16-NEXT:    buffer_load_u16 v0, off, s[4:7], null
; SDAG-GFX12-FAKE16-NEXT:    s_mov_b32 s3, s7
