...
; GFX7-NEXT:  .LBB0_1: ; %if
; GFX7-NEXT:    v_add_i32_e64 v2, s[4:5], 28, v2
; GFX7-NEXT:    v_addc_u32_e64 v3, s[4:5], 0, v3, s[4:5]
...
; GFX8-NEXT:  .LBB0_1: ; %if
; GFX8-NEXT:    v_add_u32_e64 v2, s[4:5], 28, v2
; GFX8-NEXT:    v_addc_u32_e64 v3, s[4:5], 0, v3, s[4:5]
...
; GFX7-NEXT:    v_mov_b32_e32 v4, 0
; GFX7-NEXT:    s_xor_b64 exec, s[4:5], exec
; GFX7-NEXT:    ; divergent control-flow edge
...
; GFX8-NEXT:    v_mov_b32_e32 v4, 0
; GFX8-NEXT:    s_xor_b64 exec, s[4:5], exec
; GFX8-NEXT:    ; divergent control-flow edge
...
; GFX10-NEXT:    v_add_co_u32 v2, s4, 0x800, v2
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, s4
...
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-NEXT:    s_xor_b64 exec, s[4:5], exec
; GFX9-NEXT:    ; divergent control-flow edge
...
; GFX10-NEXT:    v_add_co_u32 v2, s4, 0x1000, v2
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, s4
...
; GFX7-NEXT:  .LBB5_1: ; %if
; GFX7-NEXT:    v_add_i32_e64 v2, s[4:5], v2, v4
; GFX7-NEXT:    v_addc_u32_e64 v3, s[4:5], v3, v5, s[4:5]
...
; GFX8-NEXT:  .LBB5_1: ; %if
; GFX8-NEXT:    v_add_u32_e64 v2, s[4:5], v2, v4
; GFX8-NEXT:    v_addc_u32_e64 v3, s[4:5], v3, v5, s[4:5]
...
; GFX9-NEXT:  .LBB5_1: ; %if
; GFX9-NEXT:    v_add_co_u32_e64 v2, s[4:5], v2, v4
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[4:5], v3, v5, s[4:5]
...
; GFX10-NEXT:    v_add_co_u32 v2, s4, v2, v4
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v5, s4
