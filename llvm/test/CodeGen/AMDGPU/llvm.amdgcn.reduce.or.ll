...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu6.00 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX6DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu7.00 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX7DAGISEL %s
