...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -O2 -mtriple=amdgpu12.00 < %s | FileCheck --check-prefix=GISEL12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -O2 -mtriple=amdgpu12.00 < %s | FileCheck --check-prefix=DAGISEL12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -O2 -mtriple=amdgpu10.30 < %s | FileCheck --check-prefix=GISEL10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -O2 -mtriple=amdgpu10.30 < %s | FileCheck --check-prefix=DAGISEL10 %s
...
; GISEL12-NEXT:    s_xor_b32 s3, s8, exec_lo
...
; GISEL12-NEXT:    v_dual_mov_b32 v11, s8 :: v_dual_add_nc_u32 v10, 43, v2
; GISEL12-NEXT:  .LBB3_4: ; %tail
; GISEL12-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GISEL12-NEXT:    v_cmp_lt_i32_e32 vcc_lo, v12, v13
; GISEL12-NEXT:    ; implicit-def: $vgpr8
; GISEL12-NEXT:    s_xor_b32 s3, vcc_lo, exec_lo
; GISEL12-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GISEL12-NEXT:    ; divergent control-flow edge
; GISEL12-NEXT:    s_cbranch_execz .LBB3_6
; GISEL12-NEXT:  .LBB3_5: ; %tail.else
...
; GISEL12-NEXT:    s_xor_b32 s4, exec_lo, s3
; GISEL12-NEXT:    s_mov_b32 exec_lo, s3
; GISEL12-NEXT:    ; divergent control-flow edge
; GISEL12-NEXT:    s_cbranch_execz .LBB3_8
; GISEL12-NEXT:  .LBB3_7: ; %tail.then
; GISEL12-NEXT:    s_mov_b32 s3, 44
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    v_mov_b32_e32 v8, s3
; GISEL12-NEXT:  .LBB3_8: ; %tail.end
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GISEL12-NEXT:    s_mov_b32 exec_lo, s5
; GISEL12-NEXT:    s_setpc_b64 s[6:7]
...
; DAGISEL12-NEXT:  .LBB3_6:
; DAGISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; DAGISEL12-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; DAGISEL12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; DAGISEL12-NEXT:    s_xor_b32 s4, exec_lo, s3
; DAGISEL12-NEXT:    s_mov_b32 exec_lo, s3
; DAGISEL12-NEXT:    ; divergent control-flow edge
; DAGISEL12-NEXT:    s_cbranch_execz .LBB3_8
; DAGISEL12-NEXT:  .LBB3_7: ; %tail.then
; DAGISEL12-NEXT:    v_mov_b32_e32 v8, 44
; DAGISEL12-NEXT:  .LBB3_8: ; %tail.end
; DAGISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; DAGISEL12-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; DAGISEL12-NEXT:    s_mov_b32 exec_lo, s5
; DAGISEL12-NEXT:    s_setpc_b64 s[6:7]
...
; GISEL10-NEXT:    v_mov_b32_e32 v11, s8
; GISEL10-NEXT:  .LBB3_4: ; %tail
; GISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GISEL10-NEXT:    v_cmp_lt_i32_e32 vcc_lo, v12, v13
; GISEL10-NEXT:    ; implicit-def: $vgpr8
; GISEL10-NEXT:    s_xor_b32 s3, vcc_lo, exec_lo
; GISEL10-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GISEL10-NEXT:    ; divergent control-flow edge
; GISEL10-NEXT:    s_cbranch_execz .LBB3_6
; GISEL10-NEXT:  .LBB3_5: ; %tail.else
; GISEL10-NEXT:    s_mov_b32 s4, 15
; GISEL10-NEXT:    v_mov_b32_e32 v8, s4
; GISEL10-NEXT:  .LBB3_6:
; GISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GISEL10-NEXT:    s_xor_b32 s4, exec_lo, s3
; GISEL10-NEXT:    s_mov_b32 exec_lo, s3
; GISEL10-NEXT:    ; divergent control-flow edge
; GISEL10-NEXT:    s_cbranch_execz .LBB3_8
; GISEL10-NEXT:  .LBB3_7: ; %tail.then
; GISEL10-NEXT:    s_mov_b32 s3, 44
; GISEL10-NEXT:    v_mov_b32_e32 v8, s3
; GISEL10-NEXT:  .LBB3_8: ; %tail.end
; GISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GISEL10-NEXT:    s_mov_b32 exec_lo, s5
; GISEL10-NEXT:    s_setpc_b64 s[6:7]
;
...
; DAGISEL10-NEXT:  .LBB3_6:
; DAGISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; DAGISEL10-NEXT:    s_xor_b32 s4, exec_lo, s3
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s3
; DAGISEL10-NEXT:    ; divergent control-flow edge
; DAGISEL10-NEXT:    s_cbranch_execz .LBB3_8
; DAGISEL10-NEXT:  .LBB3_7: ; %tail.then
; DAGISEL10-NEXT:    v_mov_b32_e32 v8, 44
; DAGISEL10-NEXT:  .LBB3_8: ; %tail.end
; DAGISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s5
; DAGISEL10-NEXT:    s_setpc_b64 s[6:7]
entry:
...
; GISEL12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL12-NEXT:    s_xor_b32 s0, s9, exec_lo
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_and_b32 s4, exec_lo, s0
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_xor_b32 exec_lo, s4, exec_lo
; GISEL12-NEXT:    ; divergent control-flow edge
; GISEL12-NEXT:    s_cbranch_execz .LBB5_2
; GISEL12-NEXT:  .LBB5_1: ; %shader
; GISEL12-NEXT:    s_or_saveexec_b32 s9, -1
...
; GISEL10-NEXT:    s_xor_b32 s0, s9, exec_lo
; GISEL10-NEXT:    s_and_b32 s4, exec_lo, s0
; GISEL10-NEXT:    s_xor_b32 exec_lo, s4, exec_lo
; GISEL10-NEXT:    ; divergent control-flow edge
; GISEL10-NEXT:    s_cbranch_execz .LBB5_2
; GISEL10-NEXT:  .LBB5_1: ; %shader
; GISEL10-NEXT:    s_or_saveexec_b32 s9, -1
...
; DAGISEL10:       ; %bb.0: ; %entry
; DAGISEL10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAGISEL10-NEXT:    s_or_saveexec_b32 s10, -1
...
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_xor_b32 s1, s6, exec_lo
; GISEL12-NEXT:    s_mov_b32 s4, s0
; GISEL12-NEXT:    s_mov_b32 s0, s3
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_and_b32 s1, exec_lo, s1
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_xor_b32 exec_lo, s1, exec_lo
; GISEL12-NEXT:    ; divergent control-flow edge
; GISEL12-NEXT:    s_cbranch_execz .LBB6_2
; GISEL12-NEXT:  .LBB6_1: ; %shader
...
; DAGISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; DAGISEL12-NEXT:    s_and_b32 s1, exec_lo, s6
; DAGISEL12-NEXT:    s_mov_b32 s4, s0
; DAGISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; DAGISEL12-NEXT:    s_xor_b32 s0, exec_lo, s1
; DAGISEL12-NEXT:    s_mov_b32 exec_lo, s1
; DAGISEL12-NEXT:    ; divergent control-flow edge
; DAGISEL12-NEXT:    s_cbranch_execz .LBB6_2
; DAGISEL12-NEXT:  .LBB6_1: ; %shader
...
; GISEL10-NEXT:    s_xor_b32 s1, s6, exec_lo
; GISEL10-NEXT:    s_mov_b32 s4, s0
; GISEL10-NEXT:    s_mov_b32 s0, s3
; GISEL10-NEXT:    s_and_b32 s1, exec_lo, s1
; GISEL10-NEXT:    s_xor_b32 exec_lo, s1, exec_lo
; GISEL10-NEXT:    ; divergent control-flow edge
; GISEL10-NEXT:    s_cbranch_execz .LBB6_2
; GISEL10-NEXT:  .LBB6_1: ; %shader
...
; DAGISEL10-NEXT:    s_and_b32 s1, exec_lo, s6
; DAGISEL10-NEXT:    s_mov_b32 s4, s0
; DAGISEL10-NEXT:    s_xor_b32 s0, exec_lo, s1
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s1
; DAGISEL10-NEXT:    ; divergent control-flow edge
; DAGISEL10-NEXT:    s_cbranch_execz .LBB6_2
; DAGISEL10-NEXT:  .LBB6_1: ; %shader
