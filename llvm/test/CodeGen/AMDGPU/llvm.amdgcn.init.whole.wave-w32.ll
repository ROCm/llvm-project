...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -O2 -mtriple=amdgpu12.00 < %s | FileCheck --check-prefix=DAGISEL12 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -O2 -mtriple=amdgpu10.30 < %s | FileCheck --check-prefix=GISEL10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -O2 -mtriple=amdgpu10.30 < %s | FileCheck --check-prefix=DAGISEL10 %s
