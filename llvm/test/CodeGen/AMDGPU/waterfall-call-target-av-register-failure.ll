...
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -mtriple=amdgpu9.0a-amd-amdhsa -verify-machineinstrs < %s | FileCheck %s
...
; CHECK-NEXT:    buffer_store_dword v3, off, s[0:3], s33 offset:16 ; 4-byte Folded Spill
...
; CHECK-NEXT:    v_writelane_b32 v3, s15, 0
; CHECK-NEXT:    v_writelane_b32 v3, s14, 1
; CHECK-NEXT:    v_writelane_b32 v3, s13, 2
; CHECK-NEXT:    v_writelane_b32 v3, s12, 3
; CHECK-NEXT:    v_writelane_b32 v3, s10, 4
; CHECK-NEXT:    v_writelane_b32 v3, s11, 5
; CHECK-NEXT:    v_writelane_b32 v3, s8, 6
; CHECK-NEXT:    v_writelane_b32 v3, s9, 7
; CHECK-NEXT:    v_writelane_b32 v3, s6, 8
; CHECK-NEXT:    v_writelane_b32 v3, s7, 9
; CHECK-NEXT:    v_writelane_b32 v3, s4, 10
; CHECK-NEXT:    v_writelane_b32 v3, s5, 11
...
; CHECK-NEXT:  ; %bb.1: ; %bb1
; CHECK-NEXT:    s_or_saveexec_b64 s[34:35], -1
; CHECK-NEXT:    buffer_load_dword v3, off, s[0:3], s33 offset:12 ; 4-byte Folded Reload
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    s_mov_b64 s[4:5], exec
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v3, s4, 12
; CHECK-NEXT:    v_writelane_b32 v3, s5, 13
; CHECK-NEXT:    s_or_saveexec_b64 s[34:35], -1
; CHECK-NEXT:    buffer_store_dword v3, off, s[0:3], s33 offset:12 ; 4-byte Folded Spill
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
...
; CHECK-NEXT:    v_writelane_b32 v3, s6, 14
; CHECK-NEXT:    v_writelane_b32 v3, s7, 15
...
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_readlane_b32 s16, v3, 14
; CHECK-NEXT:    v_readlane_b32 s17, v3, 15
; CHECK-NEXT:    v_readlane_b32 s15, v3, 0
; CHECK-NEXT:    v_readlane_b32 s14, v3, 1
; CHECK-NEXT:    v_readlane_b32 s13, v3, 2
; CHECK-NEXT:    v_readlane_b32 s12, v3, 3
; CHECK-NEXT:    v_readlane_b32 s10, v3, 4
; CHECK-NEXT:    v_readlane_b32 s11, v3, 5
; CHECK-NEXT:    v_readlane_b32 s8, v3, 6
; CHECK-NEXT:    v_readlane_b32 s9, v3, 7
; CHECK-NEXT:    v_readlane_b32 s6, v3, 8
; CHECK-NEXT:    v_readlane_b32 s7, v3, 9
; CHECK-NEXT:    v_readlane_b32 s4, v3, 10
; CHECK-NEXT:    v_readlane_b32 s5, v3, 11
...
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_readlane_b32 s4, v3, 16
; CHECK-NEXT:    v_readlane_b32 s5, v3, 17
...
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_readlane_b32 s4, v3, 12
; CHECK-NEXT:    v_readlane_b32 s5, v3, 13
...
; CHECK-NEXT:    buffer_load_dword v3, off, s[0:3], s33 offset:16 ; 4-byte Folded Reload
; CHECK-NEXT:    s_mov_b64 exec, -1
