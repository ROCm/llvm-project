...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX67,GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=bonaire < %s | FileCheck -check-prefixes=GFX67,GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GFX89,GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX89,GFX9 %s
...
; GFX67:       ; %bb.0:
; GFX67-NEXT:    s_mov_b32 s17, 0
; GFX67-NEXT:    s_mov_b32 s16, s1
; GFX67-NEXT:    s_mov_b32 s1, s17
; GFX67-NEXT:    s_load_dwordx16 s[0:15], s[0:1], 0x0
; GFX67-NEXT:    s_load_dwordx16 s[16:31], s[16:17], 0x20
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_add_i32 s0, s0, s16
; GFX67-NEXT:    s_add_i32 s1, s1, s17
; GFX67-NEXT:    s_add_i32 s2, s2, s18
; GFX67-NEXT:    s_add_i32 s3, s3, s19
; GFX67-NEXT:    s_add_i32 s4, s4, s20
; GFX67-NEXT:    s_add_i32 s5, s5, s21
; GFX67-NEXT:    s_add_i32 s6, s6, s22
; GFX67-NEXT:    s_add_i32 s7, s7, s23
; GFX67-NEXT:    s_add_i32 s8, s8, s24
; GFX67-NEXT:    s_add_i32 s9, s9, s25
; GFX67-NEXT:    s_add_i32 s10, s10, s26
; GFX67-NEXT:    s_add_i32 s11, s11, s27
; GFX67-NEXT:    s_add_i32 s12, s12, s28
; GFX67-NEXT:    s_add_i32 s13, s13, s29
; GFX67-NEXT:    s_add_i32 s14, s14, s30
; GFX67-NEXT:    s_add_i32 s15, s15, s31
; GFX67-NEXT:    v_mov_b32_e32 v0, s0
; GFX67-NEXT:    v_mov_b32_e32 v1, s1
; GFX67-NEXT:    v_mov_b32_e32 v2, s2
; GFX67-NEXT:    v_mov_b32_e32 v3, s3
...
; GFX8-NEXT:    s_add_i32 s3, s3, s19
; GFX8-NEXT:    s_add_i32 s4, s4, s20
; GFX8-NEXT:    s_add_i32 s5, s5, s21
; GFX8-NEXT:    s_add_i32 s6, s6, s22
; GFX8-NEXT:    s_add_i32 s7, s7, s23
; GFX8-NEXT:    s_add_i32 s8, s8, s24
; GFX8-NEXT:    s_add_i32 s9, s9, s25
; GFX8-NEXT:    s_add_i32 s10, s10, s26
; GFX8-NEXT:    s_add_i32 s11, s11, s27
; GFX8-NEXT:    s_add_i32 s12, s12, s28
...
; GFX67-NEXT:    s_lshr_b32 s3, s1, 16
; GFX67-NEXT:    s_add_i32 s0, s0, s1
...
; GFX67-NEXT:    s_lshr_b32 s5, s2, 16
; GFX67-NEXT:    s_add_i32 s4, s4, s5
; GFX67-NEXT:    s_add_i32 s0, s0, s2
; GFX67-NEXT:    s_add_i32 s1, s1, s3
...
; GFX67-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x0
; GFX67-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x4
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s2, s4, 16
; GFX67-NEXT:    s_lshr_b32 s3, s5, 16
; GFX67-NEXT:    s_lshr_b32 s6, s0, 16
; GFX67-NEXT:    s_lshr_b32 s7, s1, 16
; GFX67-NEXT:    s_add_i32 s3, s3, s7
; GFX67-NEXT:    s_add_i32 s1, s5, s1
; GFX67-NEXT:    s_add_i32 s2, s2, s6
; GFX67-NEXT:    s_add_i32 s0, s4, s0
; GFX67-NEXT:    s_lshl_b32 s3, s3, 16
; GFX67-NEXT:    s_lshl_b32 s2, s2, 16
; GFX67-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX67-NEXT:    s_and_b32 s1, s1, 0xffff
...
; GFX67-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x8
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s3, s4, 16
; GFX67-NEXT:    s_lshr_b32 s9, s0, 16
; GFX67-NEXT:    s_lshr_b32 s7, s5, 16
; GFX67-NEXT:    s_lshr_b32 s8, s6, 16
; GFX67-NEXT:    s_lshr_b32 s10, s1, 16
; GFX67-NEXT:    s_lshr_b32 s11, s2, 16
; GFX67-NEXT:    s_add_i32 s3, s3, s9
; GFX67-NEXT:    s_add_i32 s0, s4, s0
; GFX67-NEXT:    s_add_i32 s8, s8, s11
; GFX67-NEXT:    s_add_i32 s2, s6, s2
...
; GFX67-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x8
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s8, s4, 16
; GFX67-NEXT:    s_lshr_b32 s12, s0, 16
; GFX67-NEXT:    s_lshr_b32 s9, s5, 16
; GFX67-NEXT:    s_lshr_b32 s10, s6, 16
; GFX67-NEXT:    s_lshr_b32 s11, s7, 16
; GFX67-NEXT:    s_lshr_b32 s13, s1, 16
; GFX67-NEXT:    s_lshr_b32 s14, s2, 16
; GFX67-NEXT:    s_lshr_b32 s15, s3, 16
; GFX67-NEXT:    s_add_i32 s8, s8, s12
; GFX67-NEXT:    s_add_i32 s0, s4, s0
; GFX67-NEXT:    s_add_i32 s11, s11, s15
; GFX67-NEXT:    s_add_i32 s3, s7, s3
...
; GFX67-NEXT:    s_mov_b32 s1, 0
; GFX67-NEXT:    s_mov_b32 s3, s1
; GFX67-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x0
; GFX67-NEXT:    s_load_dwordx8 s[12:19], s[2:3], 0x10
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s0, s4, 16
; GFX67-NEXT:    s_lshr_b32 s24, s12, 16
; GFX67-NEXT:    s_lshr_b32 s1, s5, 16
; GFX67-NEXT:    s_lshr_b32 s25, s13, 16
; GFX67-NEXT:    s_add_i32 s0, s0, s24
; GFX67-NEXT:    s_add_i32 s4, s4, s12
; GFX67-NEXT:    s_lshr_b32 s2, s8, 16
; GFX67-NEXT:    s_lshr_b32 s28, s16, 16
; GFX67-NEXT:    s_add_i32 s1, s1, s25
; GFX67-NEXT:    s_add_i32 s5, s5, s13
; GFX67-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX67-NEXT:    s_lshl_b32 s0, s0, 16
; GFX67-NEXT:    s_lshr_b32 s20, s6, 16
; GFX67-NEXT:    s_lshr_b32 s3, s9, 16
; GFX67-NEXT:    s_lshr_b32 s26, s14, 16
; GFX67-NEXT:    s_lshr_b32 s29, s17, 16
; GFX67-NEXT:    s_add_i32 s2, s2, s28
; GFX67-NEXT:    s_add_i32 s8, s8, s16
; GFX67-NEXT:    s_add_i32 s6, s6, s14
; GFX67-NEXT:    s_lshl_b32 s1, s1, 16
; GFX67-NEXT:    s_or_b32 s0, s4, s0
; GFX67-NEXT:    s_and_b32 s4, s5, 0xffff
; GFX67-NEXT:    s_lshr_b32 s22, s10, 16
; GFX67-NEXT:    s_lshr_b32 s30, s18, 16
; GFX67-NEXT:    s_add_i32 s3, s3, s29
; GFX67-NEXT:    s_add_i32 s9, s9, s17
; GFX67-NEXT:    s_add_i32 s20, s20, s26
; GFX67-NEXT:    s_or_b32 s1, s4, s1
; GFX67-NEXT:    s_and_b32 s4, s6, 0xffff
; GFX67-NEXT:    s_and_b32 s6, s8, 0xffff
; GFX67-NEXT:    s_lshl_b32 s2, s2, 16
; GFX67-NEXT:    s_lshr_b32 s21, s7, 16
; GFX67-NEXT:    s_lshr_b32 s23, s11, 16
; GFX67-NEXT:    s_lshr_b32 s27, s15, 16
; GFX67-NEXT:    s_lshr_b32 s31, s19, 16
; GFX67-NEXT:    s_add_i32 s22, s22, s30
; GFX67-NEXT:    s_add_i32 s10, s10, s18
; GFX67-NEXT:    s_lshl_b32 s3, s3, 16
; GFX67-NEXT:    s_add_i32 s7, s7, s15
; GFX67-NEXT:    s_lshl_b32 s5, s20, 16
; GFX67-NEXT:    s_or_b32 s2, s6, s2
; GFX67-NEXT:    s_and_b32 s6, s9, 0xffff
; GFX67-NEXT:    s_add_i32 s23, s23, s31
; GFX67-NEXT:    s_add_i32 s11, s11, s19
; GFX67-NEXT:    s_add_i32 s21, s21, s27
; GFX67-NEXT:    s_or_b32 s4, s4, s5
; GFX67-NEXT:    s_and_b32 s5, s7, 0xffff
; GFX67-NEXT:    s_or_b32 s3, s6, s3
; GFX67-NEXT:    s_and_b32 s6, s10, 0xffff
; GFX67-NEXT:    s_lshl_b32 s7, s22, 16
; GFX67-NEXT:    s_lshl_b32 s23, s23, 16
; GFX67-NEXT:    s_lshl_b32 s16, s21, 16
; GFX67-NEXT:    s_or_b32 s6, s6, s7
; GFX67-NEXT:    s_and_b32 s7, s11, 0xffff
; GFX67-NEXT:    s_or_b32 s5, s5, s16
...
; GFX67-NEXT:    s_lshr_b32 s2, s0, 16
; GFX67-NEXT:    s_lshr_b32 s3, s1, 16
; GFX67-NEXT:    v_cvt_f32_f16_e32 v0, s3
...
; GFX67-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x4
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s4, s1, 16
; GFX67-NEXT:    s_lshr_b32 s5, s3, 16
; GFX67-NEXT:    v_cvt_f32_f16_e32 v0, s5
...
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s11, s7, 16
; GFX67-NEXT:    s_lshr_b32 s12, s3, 16
...
; GFX67-NEXT:    v_cvt_f32_f16_e32 v1, s3
; GFX67-NEXT:    s_lshr_b32 s10, s6, 16
; GFX67-NEXT:    s_lshr_b32 s13, s2, 16
; GFX67-NEXT:    s_lshr_b32 s9, s5, 16
; GFX67-NEXT:    s_lshr_b32 s12, s1, 16
...
; GFX67-NEXT:    s_lshr_b32 s8, s4, 16
; GFX67-NEXT:    s_lshr_b32 s11, s0, 16
; GFX67-NEXT:    v_cvt_f16_f32_e32 v7, v0
; GFX67-NEXT:    v_add_f32_e32 v0, v2, v1
; GFX67-NEXT:    v_cvt_f16_f32_e32 v2, v0
; GFX67-NEXT:    v_add_f32_e32 v0, v4, v3
; GFX67-NEXT:    v_cvt_f32_f16_e32 v1, s1
; GFX67-NEXT:    v_cvt_f32_f16_e32 v3, s5
; GFX67-NEXT:    v_cvt_f32_f16_e32 v4, s0
; GFX67-NEXT:    v_cvt_f32_f16_e32 v8, s4
...
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_lshr_b32 s23, s11, 16
; GFX67-NEXT:    s_lshr_b32 s28, s19, 16
; GFX67-NEXT:    v_cvt_f32_f16_e32 v0, s28
; GFX67-NEXT:    v_cvt_f32_f16_e32 v1, s23
; GFX67-NEXT:    v_cvt_f32_f16_e32 v2, s11
; GFX67-NEXT:    v_cvt_f32_f16_e32 v3, s18
; GFX67-NEXT:    v_cvt_f32_f16_e32 v4, s10
; GFX67-NEXT:    v_add_f32_e32 v0, v1, v0
; GFX67-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX67-NEXT:    v_cvt_f32_f16_e32 v1, s19
; GFX67-NEXT:    s_lshr_b32 s22, s10, 16
; GFX67-NEXT:    s_lshr_b32 s29, s18, 16
; GFX67-NEXT:    s_lshr_b32 s3, s9, 16
; GFX67-NEXT:    s_lshr_b32 s28, s17, 16
...
; GFX67-NEXT:    v_add_f32_e32 v0, v4, v3
; GFX67-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX67-NEXT:    v_cvt_f32_f16_e32 v1, s17
; GFX67-NEXT:    v_cvt_f32_f16_e32 v2, s9
; GFX67-NEXT:    v_cvt_f32_f16_e32 v3, s16
; GFX67-NEXT:    v_cvt_f32_f16_e32 v4, s8
; GFX67-NEXT:    s_lshr_b32 s2, s8, 16
; GFX67-NEXT:    s_lshr_b32 s23, s16, 16
; GFX67-NEXT:    s_lshr_b32 s21, s7, 16
; GFX67-NEXT:    s_lshr_b32 s27, s15, 16
; GFX67-NEXT:    v_lshlrev_b32_e32 v5, 16, v0
; GFX67-NEXT:    v_add_f32_e32 v0, v2, v1
...
; GFX67-NEXT:    v_cvt_f32_f16_e32 v4, s1
; GFX67-NEXT:    s_lshr_b32 s0, s4, 16
; GFX67-NEXT:    s_lshr_b32 s24, s12, 16
...
; GFX67-NEXT:    v_cvt_f32_f16_e32 v1, s13
; GFX67-NEXT:    v_cvt_f32_f16_e32 v3, s5
; GFX67-NEXT:    v_cvt_f32_f16_e32 v4, s12
; GFX67-NEXT:    v_cvt_f32_f16_e32 v16, s4
...
; GFX8-NEXT:    v_mov_b32_e32 v0, s1
; GFX8-NEXT:    v_add_f32_e32 v0, s3, v0
...
; GFX8-NEXT:    s_and_b32 s1, s2, 0xffff0000
