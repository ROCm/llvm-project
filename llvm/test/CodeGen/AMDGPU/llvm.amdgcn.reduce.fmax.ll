...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel=1 -global-isel-abort=2 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10GISEL,GFX1064GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10  -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX10GISEL,GFX1032GISEL %s
