...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX9,NOT-GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX10,NOT-GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX11,GFX1100,NOT-GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.50 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX11,GFX1150,NOT-GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX1250 %s
