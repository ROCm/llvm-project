...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=GENERIC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -O0 < %s | FileCheck -check-prefix=NOOPT %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI-MOVREL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefixes=VI,VI-MOVREL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -amdgpu-vgpr-index-mode < %s | FileCheck -check-prefixes=VI,VI-IDXMODE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefix=GFX9-IDXMODE %s
