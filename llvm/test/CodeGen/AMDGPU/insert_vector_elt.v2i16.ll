...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefixes=CIVI,VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01-amd-amdhsa < %s | FileCheck -check-prefixes=CIVI,CI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
