...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX9_W64
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize32 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1010_W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1010_W64
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize32 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1100_W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1100_W64
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -mtriple=amdgpu9.00 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=W64-O0
...
; GFX9_W64-NEXT:    s_xor_b64 exec, vcc, exec
...
; GFX9_W64-NEXT:    v_readfirstlane_b32 s10, v6
; GFX9_W64-NEXT:    v_readfirstlane_b32 s11, v7
; GFX9_W64-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[8:9], v[4:5]
; GFX9_W64-NEXT:    v_cmp_eq_u64_e64 s[6:7], s[10:11], v[6:7]
; GFX9_W64-NEXT:    s_and_b64 s[4:5], s[4:5], s[6:7]
; GFX9_W64-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX9_W64-NEXT:    s_nop 0
...
; GFX9_W64-NEXT:    s_or_b64 exec, exec, vcc
; GFX9_W64-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1010_W32-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
...
; GFX1010_W64-NEXT:    s_xor_b64 exec, vcc, exec
...
; GFX1100_W32-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
...
; GFX1100_W64-NEXT:    s_xor_b64 exec, vcc, exec
...
; W64-O0-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
