...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX9_W64
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1010_W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1010_W64
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize32 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1100_W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=GFX1100_W64
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -mtriple=amdgcn -mcpu=gfx900 -verify-machine-dom-info -o - %s | FileCheck %s --check-prefix=W64-O0
...
; GFX9_W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9_W64-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX9_W64-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX9_W64-NEXT:    ; divergent control-flow edge
; GFX9_W64-NEXT:    s_cbranch_execz .LBB2_6
; GFX9_W64-NEXT:  .LBB2_3: ; %bb1
...
; GFX1010_W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1010_W32-NEXT:    s_xor_b32 s5, vcc_lo, exec_lo
; GFX1010_W32-NEXT:    s_and_saveexec_b32 s8, s5
; GFX1010_W32-NEXT:    ; divergent control-flow edge
; GFX1010_W32-NEXT:    s_cbranch_execz .LBB2_6
; GFX1010_W32-NEXT:  .LBB2_3: ; %bb1
...
; GFX1010_W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1010_W64-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX1010_W64-NEXT:    s_and_saveexec_b64 s[8:9], s[6:7]
; GFX1010_W64-NEXT:    ; divergent control-flow edge
; GFX1010_W64-NEXT:    s_cbranch_execz .LBB2_6
; GFX1010_W64-NEXT:  .LBB2_3: ; %bb1
...
; GFX1100_W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1100_W32-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1100_W32-NEXT:    s_and_saveexec_b32 s5, s0
; GFX1100_W32-NEXT:    ; divergent control-flow edge
; GFX1100_W32-NEXT:    s_cbranch_execz .LBB2_6
; GFX1100_W32-NEXT:  .LBB2_3: ; %bb1
...
; GFX1100_W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1100_W64-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1100_W64-NEXT:    s_and_saveexec_b64 s[6:7], s[0:1]
; GFX1100_W64-NEXT:    ; divergent control-flow edge
; GFX1100_W64-NEXT:    s_cbranch_execz .LBB2_6
; GFX1100_W64-NEXT:  .LBB2_3: ; %bb1
...
; W64-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v1, s4
