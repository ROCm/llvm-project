...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx600 | FileCheck %s --check-prefix=GCN
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global | FileCheck %s --check-prefix=TONGA
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx900 -mattr=-flat-for-global | FileCheck %s --check-prefix=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=r600 -mcpu=redwood | FileCheck %s --check-prefix=EG
...
; GFX9-NEXT:    s_mul_hi_u32 s2, s0, s8
...
; GFX9-NEXT:    s_cmp_ge_u32 s0, s3
; GFX9-NEXT:    s_cselect_b32 s0, s8, s2
...
; TONGA:       ; %bb.0:
; TONGA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; TONGA-NEXT:    s_mov_b32 s6, 0xf000
; TONGA-NEXT:    s_mov_b32 s7, -1
; TONGA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX9-NEXT:    s_mov_b32 s6, 0xf000
; GFX9-NEXT:    s_mov_b32 s7, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    v_mul_lo_u32 v8, v8, v9
; GCN-NEXT:    v_xor_b32_e32 v1, v1, v11
; GCN-NEXT:    v_cndmask_b32_e64 v4, v4, v10, s[0:1]
; GCN-NEXT:    v_sub_i32_e32 v10, vcc, v2, v6
; GCN-NEXT:    v_sub_i32_e32 v1, vcc, v1, v11
; GCN-NEXT:    v_cndmask_b32_e64 v2, v2, v10, s[0:1]
; GCN-NEXT:    v_add_i32_e32 v10, vcc, 1, v4
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v6
; GCN-NEXT:    v_cndmask_b32_e32 v2, v4, v10, vcc
; GCN-NEXT:    v_mul_hi_u32 v4, v9, v8
...
; TONGA-NEXT:    v_mul_lo_u32 v8, v8, v9
; TONGA-NEXT:    v_xor_b32_e32 v1, v1, v11
; TONGA-NEXT:    v_cndmask_b32_e64 v4, v4, v10, s[0:1]
; TONGA-NEXT:    v_sub_u32_e32 v10, vcc, v2, v6
; TONGA-NEXT:    v_sub_u32_e32 v1, vcc, v1, v11
; TONGA-NEXT:    v_cndmask_b32_e64 v2, v2, v10, s[0:1]
; TONGA-NEXT:    v_add_u32_e32 v10, vcc, 1, v4
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v6
; TONGA-NEXT:    v_cndmask_b32_e32 v2, v4, v10, vcc
; TONGA-NEXT:    v_mul_hi_u32 v4, v9, v8
...
; GCN-NEXT:    s_mov_b32 s4, s2
; GCN-NEXT:    s_mov_b32 s5, s3
; GCN-NEXT:    buffer_load_sbyte v0, off, s[4:7], 0 offset:1
; GCN-NEXT:    buffer_load_sbyte v1, off, s[4:7], 0
; GCN-NEXT:    s_mov_b32 s4, s0
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    s_waitcnt vmcnt(1)
...
; TONGA-NEXT:    buffer_load_sbyte v1, off, s[4:7], 0
; TONGA-NEXT:    s_mov_b32 s4, s0
; TONGA-NEXT:    s_mov_b32 s5, s1
; TONGA-NEXT:    s_waitcnt vmcnt(1)
...
; GFX9-NEXT:    buffer_load_sbyte v1, off, s[4:7], 0
; GFX9-NEXT:    s_mov_b32 s2, s6
; GFX9-NEXT:    s_mov_b32 s3, s7
; GFX9-NEXT:    s_waitcnt vmcnt(1)
...
; GCN-NEXT:    s_mov_b32 s4, s2
; GCN-NEXT:    s_mov_b32 s5, s3
; GCN-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 offset:2
; GCN-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:6
; GCN-NEXT:    buffer_load_ushort v2, off, s[4:7], 0 offset:4
; GCN-NEXT:    buffer_load_ushort v3, off, s[4:7], 0
; GCN-NEXT:    s_mov_b32 s4, s0
; GCN-NEXT:    s_mov_b32 s5, s1
...
; TONGA-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:6
...
; GCN-NEXT:    buffer_load_sbyte v0, off, s[0:3], 0 offset:6
; GCN-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 offset:4
; GCN-NEXT:    buffer_load_sbyte v2, off, s[0:3], 0 offset:2
; GCN-NEXT:    buffer_load_ushort v3, off, s[0:3], 0
...
; TONGA-NEXT:    buffer_load_sbyte v0, off, s[0:3], 0 offset:6
; TONGA-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 offset:4
; TONGA-NEXT:    buffer_load_sbyte v2, off, s[0:3], 0 offset:2
; TONGA-NEXT:    buffer_load_ushort v3, off, s[0:3], 0
...
; GFX9-NEXT:    s_mov_b32 s0, s10
; GFX9-NEXT:    s_mov_b32 s1, s11
; GFX9-NEXT:    buffer_load_sbyte v0, off, s[0:3], 0 offset:6
; GFX9-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 offset:4
; GFX9-NEXT:    buffer_load_sbyte v2, off, s[0:3], 0 offset:2
; GFX9-NEXT:    buffer_load_ushort v3, off, s[0:3], 0
; GFX9-NEXT:    s_mov_b32 s0, s8
; GFX9-NEXT:    s_waitcnt vmcnt(3)
; GFX9-NEXT:    v_readfirstlane_b32 s1, v0
; GFX9-NEXT:    s_waitcnt vmcnt(2)
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_readfirstlane_b32 s2, v1
; GFX9-NEXT:    s_bfe_i32 s2, s2, 0x190000
; GFX9-NEXT:    s_abs_i32 s3, s2
; GFX9-NEXT:    v_cvt_f32_u32_e32 v1, s3
; GFX9-NEXT:    v_readfirstlane_b32 s0, v0
