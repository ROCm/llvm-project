...
; TONGA-NEXT:    v_sub_u32_e32 v10, vcc, v1, v3
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v2
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[0:1], v1, v3
; TONGA-NEXT:    v_cndmask_b32_e32 v6, v6, v9, vcc
; TONGA-NEXT:    v_cndmask_b32_e64 v5, v5, v11, s[0:1]
; TONGA-NEXT:    v_cndmask_b32_e32 v0, v0, v8, vcc
; TONGA-NEXT:    v_add_u32_e32 v8, vcc, 1, v6
; TONGA-NEXT:    v_add_u32_e32 v9, vcc, 1, v5
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v1, v10, s[0:1]
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v2
...
; GCN-NEXT:    v_max_i32_e32 v0, v0, v10
; GCN-NEXT:    v_sub_i32_e32 v16, vcc, 0, v5
; GCN-NEXT:    v_mul_lo_u32 v13, v13, v9
; GCN-NEXT:    v_rcp_f32_e32 v10, v14
...
; GCN-NEXT:    v_add_i32_e32 v9, vcc, v9, v13
; GCN-NEXT:    v_mul_hi_u32 v9, v0, v9
; GCN-NEXT:    v_mul_lo_u32 v16, v16, v10
; GCN-NEXT:    v_sub_i32_e32 v13, vcc, 0, v6
; GCN-NEXT:    v_mul_lo_u32 v14, v9, v4
; GCN-NEXT:    v_max_i32_e32 v12, v6, v13
; GCN-NEXT:    v_cvt_f32_u32_e32 v13, v12
; GCN-NEXT:    v_sub_i32_e32 v15, vcc, 0, v2
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v0, v14
; GCN-NEXT:    v_add_i32_e32 v14, vcc, 1, v9
; GCN-NEXT:    v_cmp_ge_u32_e64 s[0:1], v0, v4
; GCN-NEXT:    v_cndmask_b32_e64 v9, v9, v14, s[0:1]
; GCN-NEXT:    v_sub_i32_e32 v14, vcc, v0, v4
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v14, s[0:1]
; GCN-NEXT:    v_cmp_ge_u32_e64 s[0:1], v0, v4
; GCN-NEXT:    v_mul_hi_u32 v4, v10, v16
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, 0, v7
; GCN-NEXT:    v_max_i32_e32 v15, v2, v15
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v10, v4
; GCN-NEXT:    v_mul_hi_u32 v4, v1, v4
; GCN-NEXT:    v_rcp_f32_e32 v10, v13
; GCN-NEXT:    v_max_i32_e32 v13, v7, v0
; GCN-NEXT:    v_add_i32_e32 v14, vcc, 1, v9
; GCN-NEXT:    v_mul_lo_u32 v0, v4, v5
; GCN-NEXT:    v_mul_f32_e32 v10, 0x4f7ffffe, v10
; GCN-NEXT:    v_cvt_u32_f32_e32 v10, v10
; GCN-NEXT:    v_ashrrev_i32_e32 v8, 31, v8
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v1, v0
; GCN-NEXT:    v_add_i32_e32 v1, vcc, 1, v4
; GCN-NEXT:    v_cmp_ge_u32_e64 s[2:3], v0, v5
; GCN-NEXT:    v_cndmask_b32_e64 v1, v4, v1, s[2:3]
; GCN-NEXT:    v_sub_i32_e32 v4, vcc, v0, v5
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v4, s[2:3]
; GCN-NEXT:    v_cmp_ge_u32_e64 s[2:3], v0, v5
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, v13
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, 0, v12
; GCN-NEXT:    v_mul_lo_u32 v5, v5, v10
; GCN-NEXT:    v_rcp_f32_e32 v0, v0
; GCN-NEXT:    v_add_i32_e32 v4, vcc, 1, v1
; GCN-NEXT:    v_mul_hi_u32 v5, v10, v5
; GCN-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GCN-NEXT:    v_cvt_u32_f32_e32 v16, v0
; GCN-NEXT:    v_cndmask_b32_e64 v1, v1, v4, s[2:3]
; GCN-NEXT:    v_add_i32_e32 v0, vcc, v10, v5
; GCN-NEXT:    v_mul_hi_u32 v10, v15, v0
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, 0, v13
; GCN-NEXT:    v_mul_lo_u32 v5, v5, v16
; GCN-NEXT:    v_mul_lo_u32 v4, v10, v12
; GCN-NEXT:    v_cndmask_b32_e64 v0, v9, v14, s[0:1]
; GCN-NEXT:    v_ashrrev_i32_e32 v11, 31, v11
; GCN-NEXT:    v_mul_hi_u32 v5, v16, v5
; GCN-NEXT:    v_sub_i32_e32 v4, vcc, v15, v4
; GCN-NEXT:    v_xor_b32_e32 v0, v0, v8
; GCN-NEXT:    v_xor_b32_e32 v2, v2, v6
; GCN-NEXT:    v_add_i32_e32 v6, vcc, 1, v10
; GCN-NEXT:    v_cmp_ge_u32_e64 s[0:1], v4, v12
; GCN-NEXT:    v_sub_i32_e32 v9, vcc, 0, v3
; GCN-NEXT:    v_xor_b32_e32 v1, v1, v11
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v0, v8
; GCN-NEXT:    v_cndmask_b32_e64 v6, v10, v6, s[0:1]
; GCN-NEXT:    v_sub_i32_e32 v8, vcc, v4, v12
; GCN-NEXT:    v_add_i32_e32 v5, vcc, v16, v5
; GCN-NEXT:    v_max_i32_e32 v9, v3, v9
; GCN-NEXT:    v_sub_i32_e32 v1, vcc, v1, v11
; GCN-NEXT:    v_cndmask_b32_e64 v4, v4, v8, s[0:1]
; GCN-NEXT:    v_add_i32_e32 v8, vcc, 1, v6
; GCN-NEXT:    v_mul_hi_u32 v5, v9, v5
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v12
; GCN-NEXT:    v_ashrrev_i32_e32 v2, 31, v2
; GCN-NEXT:    v_cndmask_b32_e32 v4, v6, v8, vcc
; GCN-NEXT:    v_xor_b32_e32 v4, v4, v2
; GCN-NEXT:    v_sub_i32_e32 v2, vcc, v4, v2
; GCN-NEXT:    v_mul_lo_u32 v4, v5, v13
; GCN-NEXT:    v_xor_b32_e32 v3, v3, v7
; GCN-NEXT:    v_add_i32_e32 v6, vcc, 1, v5
; GCN-NEXT:    v_sub_i32_e32 v4, vcc, v9, v4
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, v4, v13
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v13
; GCN-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v4, v4, v7, vcc
; GCN-NEXT:    v_add_i32_e32 v6, vcc, 1, v5
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v13
; GCN-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; GCN-NEXT:    v_cndmask_b32_e32 v4, v5, v6, vcc
...
; TONGA-NEXT:    v_max_i32_e32 v0, v0, v10
; TONGA-NEXT:    v_sub_u32_e32 v16, vcc, 0, v5
; TONGA-NEXT:    v_mul_lo_u32 v13, v13, v9
; TONGA-NEXT:    v_rcp_f32_e32 v10, v14
; TONGA-NEXT:    v_sub_u32_e32 v12, vcc, 0, v1
; TONGA-NEXT:    v_mul_hi_u32 v13, v9, v13
...
; TONGA-NEXT:    v_mul_hi_u32 v9, v0, v9
; TONGA-NEXT:    v_mul_lo_u32 v16, v16, v10
; TONGA-NEXT:    v_sub_u32_e32 v13, vcc, 0, v6
; TONGA-NEXT:    v_mul_lo_u32 v14, v9, v4
; TONGA-NEXT:    v_max_i32_e32 v12, v6, v13
; TONGA-NEXT:    v_cvt_f32_u32_e32 v13, v12
; TONGA-NEXT:    v_sub_u32_e32 v15, vcc, 0, v2
; TONGA-NEXT:    v_sub_u32_e32 v0, vcc, v0, v14
; TONGA-NEXT:    v_add_u32_e32 v14, vcc, 1, v9
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[0:1], v0, v4
; TONGA-NEXT:    v_cndmask_b32_e64 v9, v9, v14, s[0:1]
; TONGA-NEXT:    v_sub_u32_e32 v14, vcc, v0, v4
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v0, v14, s[0:1]
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[0:1], v0, v4
; TONGA-NEXT:    v_mul_hi_u32 v4, v10, v16
; TONGA-NEXT:    v_sub_u32_e32 v0, vcc, 0, v7
; TONGA-NEXT:    v_max_i32_e32 v15, v2, v15
; TONGA-NEXT:    v_add_u32_e32 v4, vcc, v10, v4
; TONGA-NEXT:    v_mul_hi_u32 v4, v1, v4
; TONGA-NEXT:    v_rcp_f32_e32 v10, v13
; TONGA-NEXT:    v_max_i32_e32 v13, v7, v0
; TONGA-NEXT:    v_add_u32_e32 v14, vcc, 1, v9
; TONGA-NEXT:    v_mul_lo_u32 v0, v4, v5
; TONGA-NEXT:    v_mul_f32_e32 v10, 0x4f7ffffe, v10
; TONGA-NEXT:    v_cvt_u32_f32_e32 v10, v10
; TONGA-NEXT:    v_ashrrev_i32_e32 v8, 31, v8
; TONGA-NEXT:    v_sub_u32_e32 v0, vcc, v1, v0
; TONGA-NEXT:    v_add_u32_e32 v1, vcc, 1, v4
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[2:3], v0, v5
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v4, v1, s[2:3]
; TONGA-NEXT:    v_sub_u32_e32 v4, vcc, v0, v5
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v0, v4, s[2:3]
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[2:3], v0, v5
; TONGA-NEXT:    v_cvt_f32_u32_e32 v0, v13
; TONGA-NEXT:    v_sub_u32_e32 v5, vcc, 0, v12
; TONGA-NEXT:    v_mul_lo_u32 v5, v5, v10
; TONGA-NEXT:    v_rcp_f32_e32 v0, v0
; TONGA-NEXT:    v_add_u32_e32 v4, vcc, 1, v1
; TONGA-NEXT:    v_mul_hi_u32 v5, v10, v5
; TONGA-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; TONGA-NEXT:    v_cvt_u32_f32_e32 v16, v0
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v1, v4, s[2:3]
; TONGA-NEXT:    v_add_u32_e32 v0, vcc, v10, v5
; TONGA-NEXT:    v_mul_hi_u32 v10, v15, v0
; TONGA-NEXT:    v_sub_u32_e32 v5, vcc, 0, v13
; TONGA-NEXT:    v_mul_lo_u32 v5, v5, v16
; TONGA-NEXT:    v_mul_lo_u32 v4, v10, v12
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v9, v14, s[0:1]
; TONGA-NEXT:    v_ashrrev_i32_e32 v11, 31, v11
; TONGA-NEXT:    v_mul_hi_u32 v5, v16, v5
; TONGA-NEXT:    v_sub_u32_e32 v4, vcc, v15, v4
; TONGA-NEXT:    v_xor_b32_e32 v0, v0, v8
; TONGA-NEXT:    v_xor_b32_e32 v2, v2, v6
; TONGA-NEXT:    v_add_u32_e32 v6, vcc, 1, v10
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[0:1], v4, v12
; TONGA-NEXT:    v_sub_u32_e32 v9, vcc, 0, v3
; TONGA-NEXT:    v_xor_b32_e32 v1, v1, v11
; TONGA-NEXT:    v_sub_u32_e32 v0, vcc, v0, v8
; TONGA-NEXT:    v_cndmask_b32_e64 v6, v10, v6, s[0:1]
; TONGA-NEXT:    v_sub_u32_e32 v8, vcc, v4, v12
; TONGA-NEXT:    v_add_u32_e32 v5, vcc, v16, v5
; TONGA-NEXT:    v_max_i32_e32 v9, v3, v9
; TONGA-NEXT:    v_sub_u32_e32 v1, vcc, v1, v11
; TONGA-NEXT:    v_cndmask_b32_e64 v4, v4, v8, s[0:1]
; TONGA-NEXT:    v_add_u32_e32 v8, vcc, 1, v6
; TONGA-NEXT:    v_mul_hi_u32 v5, v9, v5
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v12
; TONGA-NEXT:    v_ashrrev_i32_e32 v2, 31, v2
; TONGA-NEXT:    v_cndmask_b32_e32 v4, v6, v8, vcc
; TONGA-NEXT:    v_xor_b32_e32 v4, v4, v2
; TONGA-NEXT:    v_sub_u32_e32 v2, vcc, v4, v2
; TONGA-NEXT:    v_mul_lo_u32 v4, v5, v13
; TONGA-NEXT:    v_xor_b32_e32 v3, v3, v7
; TONGA-NEXT:    v_add_u32_e32 v6, vcc, 1, v5
; TONGA-NEXT:    v_sub_u32_e32 v4, vcc, v9, v4
; TONGA-NEXT:    v_sub_u32_e32 v7, vcc, v4, v13
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v13
; TONGA-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; TONGA-NEXT:    v_cndmask_b32_e32 v4, v4, v7, vcc
; TONGA-NEXT:    v_add_u32_e32 v6, vcc, 1, v5
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v13
; TONGA-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; TONGA-NEXT:    v_cndmask_b32_e32 v4, v5, v6, vcc
