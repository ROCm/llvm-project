...
; GCN-NEXT:    s_mov_b32 s4, s2
; GCN-NEXT:    s_mov_b32 s5, s3
; GCN-NEXT:    buffer_load_sbyte v0, off, s[4:7], 0 offset:6
; GCN-NEXT:    buffer_load_ushort v1, off, s[4:7], 0 offset:4
; GCN-NEXT:    buffer_load_sbyte v2, off, s[4:7], 0 offset:2
; GCN-NEXT:    buffer_load_ushort v3, off, s[4:7], 0
; GCN-NEXT:    s_mov_b32 s4, s0
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    s_waitcnt vmcnt(3)
...
; TONGA-NEXT:    s_mov_b32 s4, s2
; TONGA-NEXT:    s_mov_b32 s5, s3
; TONGA-NEXT:    buffer_load_sbyte v0, off, s[4:7], 0 offset:6
; TONGA-NEXT:    buffer_load_ushort v1, off, s[4:7], 0 offset:4
; TONGA-NEXT:    buffer_load_sbyte v2, off, s[4:7], 0 offset:2
; TONGA-NEXT:    buffer_load_ushort v3, off, s[4:7], 0
; TONGA-NEXT:    s_mov_b32 s4, s0
; TONGA-NEXT:    s_mov_b32 s5, s1
; TONGA-NEXT:    s_waitcnt vmcnt(3)
