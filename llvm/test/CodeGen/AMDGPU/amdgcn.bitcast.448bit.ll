...
; SI-NEXT:    s_mov_b64 exec, s[4:5]
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_writelane_b32 v14, s30, 0
; SI-NEXT:    v_writelane_b32 v14, s31, 1
; SI-NEXT:    v_writelane_b32 v14, s34, 2
; SI-NEXT:    v_writelane_b32 v14, s35, 3
; SI-NEXT:    v_writelane_b32 v14, s36, 4
; SI-NEXT:    v_writelane_b32 v14, s37, 5
; SI-NEXT:    v_writelane_b32 v14, s38, 6
; SI-NEXT:    v_writelane_b32 v14, s39, 7
; SI-NEXT:    v_writelane_b32 v14, s48, 8
; SI-NEXT:    v_writelane_b32 v14, s49, 9
...
; SI-NEXT:    v_writelane_b32 v14, s50, 10
; SI-NEXT:    s_and_b64 s[4:5], vcc, exec
; SI-NEXT:    v_writelane_b32 v14, s51, 11
...
; SI-NEXT:    s_and_b32 s4, s16, 0xffff
; SI-NEXT:    s_lshl_b32 vcc_lo, s89, 16
; SI-NEXT:    s_or_b32 vcc_hi, s5, s7
; SI-NEXT:    s_and_b32 s5, s19, 0xffff
; SI-NEXT:    s_lshl_b32 s7, s75, 16
; SI-NEXT:    s_or_b32 s40, s4, vcc_lo
; SI-NEXT:    s_and_b32 s4, s18, 0xffff
; SI-NEXT:    s_lshl_b32 s30, s90, 16
; SI-NEXT:    s_or_b32 s31, s5, s7
; SI-NEXT:    s_and_b32 s5, s21, 0xffff
; SI-NEXT:    s_lshl_b32 s7, s76, 16
; SI-NEXT:    s_or_b32 s14, s4, s30
; SI-NEXT:    s_and_b32 s4, s20, 0xffff
; SI-NEXT:    s_lshl_b32 s34, s91, 16
; SI-NEXT:    s_or_b32 s35, s5, s7
; SI-NEXT:    s_and_b32 s5, s23, 0xffff
; SI-NEXT:    s_lshl_b32 s7, s77, 16
; SI-NEXT:    s_or_b32 s12, s4, s34
; SI-NEXT:    s_and_b32 s4, s22, 0xffff
; SI-NEXT:    s_lshl_b32 s36, s92, 16
; SI-NEXT:    s_or_b32 s37, s5, s7
; SI-NEXT:    s_and_b32 s5, s25, 0xffff
; SI-NEXT:    s_lshl_b32 s7, s78, 16
; SI-NEXT:    s_or_b32 s10, s4, s36
; SI-NEXT:    s_and_b32 s4, s24, 0xffff
; SI-NEXT:    s_lshl_b32 s38, s93, 16
; SI-NEXT:    s_or_b32 s39, s5, s7
; SI-NEXT:    s_and_b32 s5, s27, 0xffff
; SI-NEXT:    s_lshl_b32 s7, s79, 16
; SI-NEXT:    s_or_b32 s8, s4, s38
; SI-NEXT:    s_and_b32 s4, s26, 0xffff
; SI-NEXT:    s_lshl_b32 s48, s94, 16
; SI-NEXT:    s_or_b32 s49, s5, s7
; SI-NEXT:    s_and_b32 s5, s29, 0xffff
; SI-NEXT:    s_lshl_b32 s7, s88, 16
; SI-NEXT:    s_or_b32 s6, s4, s48
; SI-NEXT:    s_and_b32 s4, s28, 0xffff
; SI-NEXT:    s_lshl_b32 s50, s95, 16
; SI-NEXT:    s_or_b32 s51, s5, s7
; SI-NEXT:    s_or_b32 s4, s4, s50
; SI-NEXT:    s_lshr_b64 s[42:43], vcc, 16
; SI-NEXT:    s_lshr_b64 s[44:45], s[30:31], 16
; SI-NEXT:    s_lshr_b64 s[46:47], s[34:35], 16
; SI-NEXT:    s_lshr_b64 s[56:57], s[36:37], 16
; SI-NEXT:    s_lshr_b64 s[58:59], s[38:39], 16
; SI-NEXT:    s_lshr_b64 s[60:61], s[48:49], 16
; SI-NEXT:    s_lshr_b64 s[62:63], s[50:51], 16
; SI-NEXT:    s_mov_b32 s41, vcc_hi
; SI-NEXT:    s_mov_b32 s15, s31
; SI-NEXT:    s_mov_b32 s13, s35
; SI-NEXT:    s_mov_b32 s11, s37
; SI-NEXT:    s_mov_b32 s9, s39
; SI-NEXT:    s_mov_b32 s7, s49
; SI-NEXT:    s_mov_b32 s5, s51
...
; SI-NEXT:    v_readlane_b32 s51, v14, 11
; SI-NEXT:    v_readlane_b32 s50, v14, 10
; SI-NEXT:    v_readlane_b32 s49, v14, 9
; SI-NEXT:    v_readlane_b32 s48, v14, 8
; SI-NEXT:    v_readlane_b32 s39, v14, 7
; SI-NEXT:    v_readlane_b32 s38, v14, 6
; SI-NEXT:    v_readlane_b32 s37, v14, 5
; SI-NEXT:    v_readlane_b32 s36, v14, 4
; SI-NEXT:    v_readlane_b32 s35, v14, 3
; SI-NEXT:    v_readlane_b32 s34, v14, 2
; SI-NEXT:    v_readlane_b32 s31, v14, 1
; SI-NEXT:    v_readlane_b32 s30, v14, 0
; SI-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; SI-NEXT:    buffer_load_dword v14, off, s[0:3], s32 ; 4-byte Folded Reload
; SI-NEXT:    s_mov_b64 exec, s[4:5]
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    v_alignbit_b32 v17, v13, v17, 16
; SI-NEXT:  .LBB58_2: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; SI-NEXT:    v_lshlrev_b32_e32 v14, 16, v14
...
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; SI-NEXT:    v_or_b32_e32 v29, v1, v0
...
; SI-NEXT:    v_or_b32_e32 v30, v5, v4
; SI-NEXT:    v_cvt_f32_f16_e32 v5, s22
; SI-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; SI-NEXT:    v_add_f32_e32 v1, 0x38000000, v1
; SI-NEXT:    v_cvt_f16_f32_e32 v28, v1
; SI-NEXT:    v_add_f32_e32 v8, 0x38000000, v5
; SI-NEXT:    v_cvt_f32_f16_e32 v1, s29
; SI-NEXT:    v_cvt_f32_f16_e32 v5, s14
; SI-NEXT:    v_or_b32_e32 v31, v3, v2
...
; SI-NEXT:    v_or_b32_e32 v11, v5, v3
...
; SI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; SI-NEXT:    v_lshlrev_b32_e32 v5, 16, v35
; SI-NEXT:    v_cvt_f32_f16_e32 v12, s17
; SI-NEXT:    v_add_f32_e32 v1, 0x38000000, v1
...
; SI-NEXT:    v_add_f32_e32 v1, 0x38000000, v12
; SI-NEXT:    v_cvt_f16_f32_e32 v1, v1
...
; SI-NEXT:    v_lshr_b64 v[14:15], v[12:13], 16
; SI-NEXT:    v_or_b32_e32 v12, v49, v12
...
; SI-NEXT:    v_mov_b32_e32 v33, s13
; SI-NEXT:    v_mov_b32_e32 v34, s11
; SI-NEXT:    v_mov_b32_e32 v35, s10
...
; SI-NEXT:    v_or_b32_e32 v5, v5, v6
; SI-NEXT:    v_and_b32_e32 v6, 0xffff, v39
...
; VI-NEXT:    s_lshr_b32 s12, s29, 16
; VI-NEXT:    v_mov_b32_e32 v0, 0x200
; VI-NEXT:    v_mov_b32_e32 v13, s12
; VI-NEXT:    s_lshr_b32 s11, s28, 16
; VI-NEXT:    v_add_f16_e32 v12, s29, v0
...
; VI-NEXT:    s_lshr_b32 s10, s27, 16
; VI-NEXT:    v_add_f16_e32 v11, s28, v0
...
; VI-NEXT:    v_add_f16_e32 v10, s27, v0
...
; VI-NEXT:    v_add_f16_e32 v7, s24, v0
...
; VI-NEXT:    v_add_f16_e32 v6, s23, v0
...
; VI-NEXT:    v_or_b32_e32 v7, v6, v7
; VI-NEXT:    v_mov_b32_e32 v6, s5
; VI-NEXT:    v_add_f16_sdwa v19, v5, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    s_lshr_b32 s4, s21, 16
...
; VI-NEXT:    v_add_f16_sdwa v16, v2, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v2, s18, v0
; VI-NEXT:    v_add_f16_sdwa v17, v3, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v3, s19, v0
; VI-NEXT:    v_add_f16_sdwa v18, v4, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
