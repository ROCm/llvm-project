...
; GFX950-NEXT:    v_cndmask_b32_e32 v1, v9, v10, vcc
; GFX950-NEXT:    v_cmp_u_f64_e32 vcc, v[2:3], v[6:7]
; GFX950-NEXT:    s_nop 1
; GFX950-NEXT:    v_cndmask_b32_e64 v2, v4, 0, vcc
; GFX950-NEXT:    v_cndmask_b32_e32 v3, v5, v10, vcc
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX950-NEXT:    v_cndmask_b32_e32 v1, v13, v14, vcc
; GFX950-NEXT:    v_cmp_u_f64_e32 vcc, v[2:3], v[8:9]
; GFX950-NEXT:    s_nop 1
; GFX950-NEXT:    v_cndmask_b32_e64 v2, v6, 0, vcc
; GFX950-NEXT:    v_cndmask_b32_e32 v3, v7, v14, vcc
...
; GFX950-NEXT:    v_cndmask_b32_e32 v5, v7, v14, vcc
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_cndmask_b32_e64 v3, v9, v18, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v4, v10, 0, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v11, v18, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v12, 0, s[8:9]
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v13, v18, s[8:9]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v9, v18, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v10, 0, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v11, v18, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v12, 0, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v13, v18, s[8:9]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    v_cndmask_b32_e32 v1, v17, v18, vcc
; GFX900-NEXT:    v_cndmask_b32_e64 v2, v8, 0, s[4:5]
; GFX900-NEXT:    v_cndmask_b32_e64 v3, v9, v18, s[4:5]
; GFX900-NEXT:    v_cndmask_b32_e64 v4, v10, 0, s[6:7]
; GFX900-NEXT:    v_cndmask_b32_e64 v5, v11, v18, s[6:7]
; GFX900-NEXT:    v_cndmask_b32_e64 v6, v12, 0, s[8:9]
; GFX900-NEXT:    v_cndmask_b32_e64 v7, v13, v18, s[8:9]
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX950-NEXT:    v_cndmask_b32_e32 v1, v17, v18, vcc
; GFX950-NEXT:    v_cmp_u_f64_e32 vcc, v[2:3], v[10:11]
; GFX950-NEXT:    s_nop 1
; GFX950-NEXT:    v_cndmask_b32_e64 v2, v8, 0, vcc
; GFX950-NEXT:    v_cndmask_b32_e32 v3, v9, v18, vcc
...
; GFX950-NEXT:    v_cndmask_b32_e32 v5, v9, v18, vcc
...
; GFX950-NEXT:    v_cndmask_b32_e32 v7, v9, v18, vcc
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
