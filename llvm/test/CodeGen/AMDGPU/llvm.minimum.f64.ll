...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.03-amd-amdhsa < %s | FileCheck -check-prefixes=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GFX9,GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.50-amd-amdhsa < %s | FileCheck -check-prefixes=GFX9,GFX950 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30-amd-amdhsa < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.70-amd-amdhsa < %s | FileCheck -check-prefixes=GFX1170 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa < %s | FileCheck -check-prefixes=GFX12 %s
