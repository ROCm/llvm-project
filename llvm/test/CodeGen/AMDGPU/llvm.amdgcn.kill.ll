...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX11-12,GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX11-12,GFX12 %s
...
; GFX12-NEXT:    s_add_co_i32 s1, s0, 1
; GFX12-NEXT:    s_cmp_lt_i32 s0, 1
; GFX12-NEXT:    s_mov_b32 s0, s1
; GFX12-NEXT:    s_cbranch_scc1 .LBB25_1
; GFX12-NEXT:  ; %bb.2: ; %endloop15
; GFX12-NEXT:    s_endpgm
main_body:
  br label %loop3
...
; SI-NEXT:    s_cbranch_vccnz .LBB26_3
...
; SI-NEXT:  .LBB26_3: ; %bb35
; SI-NEXT:    exp mrt0, v0, v0, v0, v0 done vm
; SI-NEXT:    s_endpgm
;
; GFX10-LABEL: kill_with_loop_exit:
; GFX10:       ; %bb.0: ; %.entry
; GFX10-NEXT:    v_cmp_gt_f32_e64 s[2:3], 0x43000000, s0
...
; GFX10-NEXT:    s_cbranch_vccnz .LBB26_3
...
; GFX10-NEXT:  .LBB26_3: ; %bb35
; GFX10-NEXT:    exp mrt0, v0, v0, v0, v0 done vm
; GFX10-NEXT:    s_endpgm
;
; GFX11-LABEL: kill_with_loop_exit:
; GFX11:       ; %bb.0: ; %.entry
; GFX11-NEXT:    v_cmp_gt_f32_e64 s[2:3], 0x43000000, s0
