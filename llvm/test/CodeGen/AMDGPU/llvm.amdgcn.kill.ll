...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX11-12,GFX11-12-SDAG,GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX11-12,GFX11-12-SDAG,GFX12,GFX12-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-12,GFX12,GFX12-GISEL %s
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-12-SDAG-LABEL: gs_const:
; GFX11-12-SDAG:       ; %bb.0:
; GFX11-12-SDAG-NEXT:    s_mov_b64 s[0:1], exec
; GFX11-12-SDAG-NEXT:    s_and_not1_b64 s[0:1], s[0:1], exec
; GFX11-12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX11-12-SDAG-NEXT:    s_mov_b32 m0, 0
; GFX11-12-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-12-SDAG-NEXT:    s_endpgm
; GFX11-12-SDAG-NEXT:  ; %bb.1:
; GFX11-12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX11-12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: gs_const:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, exec
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[2:3]
; GFX12-GISEL-NEXT:    s_and_b64 exec, exec, s[0:1]
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], s[0:1], exec
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    s_mov_b32 m0, 0
; GFX12-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  ; %bb.1:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: true:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, exec
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], exec, s[2:3]
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  ; %bb.1:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    s_endpgm
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-12-SDAG-LABEL: andn2:
; GFX11-12-SDAG:       ; %bb.0:
; GFX11-12-SDAG-NEXT:    v_cmp_lt_i32_e32 vcc, v0, v1
; GFX11-12-SDAG-NEXT:    v_cmp_lt_i32_e64 s[0:1], v2, v3
; GFX11-12-SDAG-NEXT:    s_mov_b64 s[2:3], exec
; GFX11-12-SDAG-NEXT:    s_xor_b64 s[0:1], vcc, s[0:1]
; GFX11-12-SDAG-NEXT:    s_and_not1_b64 s[2:3], s[2:3], s[0:1]
; GFX11-12-SDAG-NEXT:    s_and_b64 exec, exec, s[2:3]
; GFX11-12-SDAG-NEXT:    s_mov_b32 m0, 0
; GFX11-12-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-12-SDAG-NEXT:    s_endpgm
; GFX11-12-SDAG-NEXT:  ; %bb.1:
...
; GFX11-12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: andn2:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    v_cmp_lt_i32_e32 vcc, v0, v1
; GFX12-GISEL-NEXT:    v_cmp_lt_i32_e64 s[0:1], v2, v3
; GFX12-GISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX12-GISEL-NEXT:    s_xor_b64 s[0:1], vcc, s[0:1]
; GFX12-GISEL-NEXT:    s_xor_b64 s[0:1], s[0:1], exec
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], s[2:3], s[0:1]
; GFX12-GISEL-NEXT:    s_and_b64 exec, exec, s[2:3]
; GFX12-GISEL-NEXT:    s_mov_b32 m0, 0
; GFX12-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  ; %bb.1:
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-12-SDAG-LABEL: ord:
; GFX11-12-SDAG:       ; %bb.0:
; GFX11-12-SDAG-NEXT:    v_cmp_o_f32_e32 vcc, v0, v0
; GFX11-12-SDAG-NEXT:    s_mov_b64 s[0:1], exec
; GFX11-12-SDAG-NEXT:    s_and_not1_b64 s[2:3], exec, vcc
; GFX11-12-SDAG-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[2:3]
; GFX11-12-SDAG-NEXT:    s_and_b64 exec, exec, s[0:1]
; GFX11-12-SDAG-NEXT:    s_mov_b32 m0, 0
; GFX11-12-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-12-SDAG-NEXT:    s_endpgm
; GFX11-12-SDAG-NEXT:  ; %bb.1:
...
; GFX11-12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: ord:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    v_cmp_o_f32_e32 vcc, 0, v0
; GFX12-GISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, vcc
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[2:3]
; GFX12-GISEL-NEXT:    s_and_b64 exec, exec, s[0:1]
; GFX12-GISEL-NEXT:    s_mov_b32 m0, 0
; GFX12-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-12-SDAG-LABEL: uno:
; GFX11-12-SDAG:       ; %bb.0:
; GFX11-12-SDAG-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX11-12-SDAG-NEXT:    s_mov_b64 s[0:1], exec
; GFX11-12-SDAG-NEXT:    s_and_not1_b64 s[2:3], exec, vcc
; GFX11-12-SDAG-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[2:3]
; GFX11-12-SDAG-NEXT:    s_and_b64 exec, exec, s[0:1]
...
; GFX11-12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: uno:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    v_cmp_u_f32_e32 vcc, 0, v0
; GFX12-GISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, vcc
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[2:3]
; GFX12-GISEL-NEXT:    s_and_b64 exec, exec, s[0:1]
...
; FIXME: Re-enable test after amdgcn.wqm.vote RegBankLegalize support for GISEL
...
; SI-NEXT:    s_andn2_b64 exec, exec, vcc
; SI-NEXT:    s_cbranch_scc0 .LBB22_1
; SI-NEXT:    s_endpgm
; SI-NEXT:  .LBB22_1:
; SI-NEXT:    s_mov_b64 exec, 0
; SI-NEXT:    exp null, off, off, off, off done vm
...
; GFX10-NEXT:    s_andn2_b64 exec, exec, vcc
; GFX10-NEXT:    s_cbranch_scc0 .LBB22_1
; GFX10-NEXT:    s_endpgm
; GFX10-NEXT:  .LBB22_1:
; GFX10-NEXT:    s_mov_b64 exec, 0
; GFX10-NEXT:    exp null, off, off, off, off done vm
...
; GFX11-NEXT:    s_and_not1_b64 exec, exec, vcc
; GFX11-NEXT:    s_cbranch_scc0 .LBB22_1
; GFX11-NEXT:    s_endpgm
; GFX11-NEXT:  .LBB22_1:
; GFX11-NEXT:    s_mov_b64 exec, 0
; GFX11-NEXT:    exp mrt0, off, off, off, off done
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: test_sgpr:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_cmp_le_f32 s0, 1.0
; GFX12-SDAG-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[2:3], exec, s[0:1]
; GFX12-SDAG-NEXT:    s_cbranch_scc0 .LBB22_1
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-SDAG-NEXT:  .LBB22_1:
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:    export mrt0, off, off, off, off done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: test_sgpr:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_cmp_le_f32 s0, 1.0
; GFX12-GISEL-NEXT:    s_cselect_b64 s[0:1], exec, 0
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_cbranch_scc0 .LBB22_1
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  .LBB22_1:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: test_non_inline_imm_sgpr:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_cmp_le_f32 s0, 0x3fc00000
; GFX12-SDAG-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[2:3], exec, s[0:1]
; GFX12-SDAG-NEXT:    s_cbranch_scc0 .LBB23_1
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-SDAG-NEXT:  .LBB23_1:
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:    export mrt0, off, off, off, off done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: test_non_inline_imm_sgpr:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_cmp_le_f32 s0, 0x3fc00000
; GFX12-GISEL-NEXT:    s_cselect_b64 s[0:1], exec, 0
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_cbranch_scc0 .LBB23_1
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  .LBB23_1:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    export mrt0, off, off, off, off done
; GFX12-GISEL-NEXT:    s_endpgm
...
; GFX10-NEXT:    s_cbranch_scc0 .LBB24_4
; GFX10-NEXT:  ; %bb.2: ; %loop3
; GFX10-NEXT:    ; in Loop: Header=BB24_1 Depth=1
; GFX10-NEXT:    s_and_b64 exec, exec, s[0:1]
...
; GFX11-NEXT:    ; in Loop: Header=BB24_1 Depth=1
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: test_scc_liveness:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-SDAG-NEXT:    s_mov_b32 s2, 0
; GFX12-SDAG-NEXT:  .LBB24_1: ; %loop3
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_cmp_gt_i32 s2, 0
; GFX12-SDAG-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[4:5], exec, s[4:5]
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[4:5]
; GFX12-SDAG-NEXT:    s_cbranch_scc0 .LBB24_4
; GFX12-SDAG-NEXT:  ; %bb.2: ; %loop3
; GFX12-SDAG-NEXT:    ; in Loop: Header=BB24_1 Depth=1
; GFX12-SDAG-NEXT:    s_and_b64 exec, exec, s[0:1]
; GFX12-SDAG-NEXT:    s_add_co_i32 s3, s2, 1
; GFX12-SDAG-NEXT:    s_cmp_lt_i32 s2, 1
; GFX12-SDAG-NEXT:    s_mov_b32 s2, s3
; GFX12-SDAG-NEXT:    s_cbranch_scc1 .LBB24_1
; GFX12-SDAG-NEXT:  ; %bb.3: ; %endloop15
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-SDAG-NEXT:  .LBB24_4:
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:    export mrt0, off, off, off, off done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: test_scc_liveness:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-GISEL-NEXT:    s_mov_b32 s2, 0
; GFX12-GISEL-NEXT:  .LBB24_1: ; %loop3
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_cmp_gt_i32 s2, 0
; GFX12-GISEL-NEXT:    s_cselect_b64 s[4:5], exec, 0
; GFX12-GISEL-NEXT:    s_cselect_b32 s3, 1, 0
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[4:5], exec, s[4:5]
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[4:5]
; GFX12-GISEL-NEXT:    s_cbranch_scc0 .LBB24_4
; GFX12-GISEL-NEXT:  ; %bb.2: ; %loop3
; GFX12-GISEL-NEXT:    ; in Loop: Header=BB24_1 Depth=1
; GFX12-GISEL-NEXT:    s_and_b64 exec, exec, s[0:1]
; GFX12-GISEL-NEXT:    s_xor_b32 s3, s3, 1
; GFX12-GISEL-NEXT:    s_add_co_i32 s2, s2, 1
; GFX12-GISEL-NEXT:    s_cmp_lg_u32 s3, 0
; GFX12-GISEL-NEXT:    s_cbranch_scc1 .LBB24_1
; GFX12-GISEL-NEXT:  ; %bb.3: ; %endloop15
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  .LBB24_4:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    export mrt0, off, off, off, off done
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
...
; SI-NEXT:    s_cbranch_scc0 .LBB25_6
; SI-NEXT:  ; %bb.4: ; %bb33
; SI-NEXT:    s_mov_b64 exec, 0
; SI-NEXT:  .LBB25_5: ; %bb35
...
; GFX10-NEXT:    s_cbranch_scc0 .LBB25_6
; GFX10-NEXT:  ; %bb.4: ; %bb33
; GFX10-NEXT:    s_mov_b64 exec, 0
; GFX10-NEXT:  .LBB25_5: ; %bb35
...
; GFX11-NEXT:    s_cbranch_scc0 .LBB25_6
; GFX11-NEXT:  ; %bb.4: ; %bb33
; GFX11-NEXT:    s_mov_b64 exec, 0
; GFX11-NEXT:  .LBB25_5: ; %bb35
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: kill_with_loop_exit:
; GFX12-SDAG:       ; %bb.0: ; %.entry
; GFX12-SDAG-NEXT:    s_cmp_lt_f32 s0, 0x43000000
; GFX12-SDAG-NEXT:    s_cselect_b64 s[4:5], -1, 0
...
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: kill_with_loop_exit:
; GFX12-GISEL:       ; %bb.0: ; %.entry
; GFX12-GISEL-NEXT:    s_cmp_lt_f32 s0, 0x43000000
; GFX12-GISEL-NEXT:    s_cselect_b32 s0, 1, 0
; GFX12-GISEL-NEXT:    s_cmp_lt_f32 s1, 0x43000000
; GFX12-GISEL-NEXT:    s_cselect_b32 s1, 1, 0
; GFX12-GISEL-NEXT:    s_and_b32 s1, s0, s1
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 1.0
...
; GFX12-GISEL-NEXT:    s_cbranch_scc0 .LBB25_6
; GFX12-GISEL-NEXT:  ; %bb.4: ; %bb33
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:  .LBB25_5: ; %bb35
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-GISEL-NEXT:    export mrt0, v0, v0, v0, v0 done
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  .LBB25_6:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    export mrt0, off, off, off, off done
; GFX12-GISEL-NEXT:    s_endpgm
.entry:
