...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX8,GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX8,GFX8-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx908 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx908 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12-GISEL %s
...
; GFX8-SDAG-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x2c
; GFX8-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; GFX8-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s7
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s5
; GFX8-SDAG-NEXT:    v_max_f32_e32 v1, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s6
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v2, 1.0, s4
...
; GFX9-SDAG-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x2c
; GFX9-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX9-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_max_f32_e64 v0, s11, s11
; GFX9-SDAG-NEXT:    v_max_f32_e64 v1, s9, s9
; GFX9-SDAG-NEXT:    v_max_f32_e32 v1, v1, v0
; GFX9-SDAG-NEXT:    v_max_f32_e64 v0, s10, s10
; GFX9-SDAG-NEXT:    v_max_f32_e64 v2, s8, s8
...
; GFX8-SDAG:       ; %bb.0:
; GFX8-SDAG-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x24
; GFX8-SDAG-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x34
; GFX8-SDAG-NEXT:    s_mov_b32 s11, 0xf000
; GFX8-SDAG-NEXT:    s_mov_b32 s10, -1
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s6
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s2
; GFX8-SDAG-NEXT:    v_max_f32_e32 v2, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s5
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s1
; GFX8-SDAG-NEXT:    v_max_f32_e32 v1, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s4
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v3, 1.0, s0
; GFX8-SDAG-NEXT:    v_max_f32_e32 v0, v3, v0
; GFX8-SDAG-NEXT:    buffer_store_dwordx3 v[0:2], off, s[8:11], 0
; GFX8-SDAG-NEXT:    s_endpgm
;
...
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s7
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s3
...
; GFX8-SDAG-NEXT:    v_max_f32_e32 v1, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s4
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v4, 1.0, s0
; GFX8-SDAG-NEXT:    v_max_f32_e32 v0, v4, v0
; GFX8-SDAG-NEXT:    buffer_store_dwordx4 v[0:3], off, s[8:11], 0
; GFX8-SDAG-NEXT:    s_endpgm
;
...
; GFX8-SDAG:       ; %bb.0:
; GFX8-SDAG-NEXT:    s_load_dwordx2 s[16:17], s[4:5], 0x24
; GFX8-SDAG-NEXT:    s_load_dwordx16 s[0:15], s[4:5], 0x44
; GFX8-SDAG-NEXT:    s_mov_b32 s19, 0xf000
; GFX8-SDAG-NEXT:    s_mov_b32 s18, -1
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s11
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s3
; GFX8-SDAG-NEXT:    v_max_f32_e32 v3, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s10
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s2
; GFX8-SDAG-NEXT:    v_max_f32_e32 v2, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s9
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v1, 1.0, s1
; GFX8-SDAG-NEXT:    v_max_f32_e32 v1, v1, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v0, 1.0, s8
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v4, 1.0, s0
; GFX8-SDAG-NEXT:    v_max_f32_e32 v0, v4, v0
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v4, 1.0, s15
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v5, 1.0, s7
; GFX8-SDAG-NEXT:    v_max_f32_e32 v7, v5, v4
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v4, 1.0, s14
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v5, 1.0, s6
; GFX8-SDAG-NEXT:    v_max_f32_e32 v6, v5, v4
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v4, 1.0, s13
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v5, 1.0, s5
; GFX8-SDAG-NEXT:    v_max_f32_e32 v5, v5, v4
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v4, 1.0, s12
; GFX8-SDAG-NEXT:    v_mul_f32_e64 v8, 1.0, s4
; GFX8-SDAG-NEXT:    v_max_f32_e32 v4, v8, v4
; GFX8-SDAG-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:16
; GFX8-SDAG-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0
; GFX8-SDAG-NEXT:    s_endpgm
;
...
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    s_load_b64 s[16:17], s[4:5], 0x24
; GFX12-SDAG-NEXT:    s_load_b512 s[0:15], s[4:5], 0x44
; GFX12-SDAG-NEXT:    s_mov_b32 s19, 0x31016000
; GFX12-SDAG-NEXT:    s_mov_b32 s18, -1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v0, s11, s11
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v1, s3, s3
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v2, s10, s10
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v4, s2, s2
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v5, s9, s9
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v6, s1, s1
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v7, s15, s15
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v10, s7, s7
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v11, s14, s14
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v12, s6, s6
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v13, s13, s13
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v14, s5, s5
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v15, s12, s12
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v16, s4, s4
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v8, s8, s8
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v9, s0, s0
; GFX12-SDAG-NEXT:    v_dual_max_num_f32 v3, v1, v0 :: v_dual_max_num_f32 v2, v4, v2
...
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    buffer_store_b128 v[4:7], off, s[16:19], null offset:16
; GFX12-SDAG-NEXT:    buffer_store_b128 v[0:3], off, s[16:19], null
; GFX12-SDAG-NEXT:    s_endpgm
;
...
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0xa4
; GFX9-SDAG-NEXT:    s_load_dwordx16 s[36:51], s[4:5], 0x64
; GFX9-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX9-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_max_f32_e64 v0, s11, s11
; GFX9-SDAG-NEXT:    v_max_f32_e64 v1, s39, s39
; GFX9-SDAG-NEXT:    v_max_f32_e32 v3, v1, v0
; GFX9-SDAG-NEXT:    v_max_f32_e64 v0, s10, s10
; GFX9-SDAG-NEXT:    v_max_f32_e64 v1, s38, s38
; GFX9-SDAG-NEXT:    v_max_f32_e32 v2, v1, v0
; GFX9-SDAG-NEXT:    v_max_f32_e64 v0, s9, s9
; GFX9-SDAG-NEXT:    v_max_f32_e64 v1, s37, s37
; GFX9-SDAG-NEXT:    v_max_f32_e32 v1, v1, v0
; GFX9-SDAG-NEXT:    v_max_f32_e64 v0, s8, s8
; GFX9-SDAG-NEXT:    v_max_f32_e64 v4, s36, s36
; GFX9-SDAG-NEXT:    v_max_f32_e32 v0, v4, v0
; GFX9-SDAG-NEXT:    v_max_f32_e64 v4, s15, s15
; GFX9-SDAG-NEXT:    v_max_f32_e64 v5, s43, s43
; GFX9-SDAG-NEXT:    v_max_f32_e32 v7, v5, v4
; GFX9-SDAG-NEXT:    v_max_f32_e64 v4, s14, s14
; GFX9-SDAG-NEXT:    v_max_f32_e64 v5, s42, s42
; GFX9-SDAG-NEXT:    v_max_f32_e32 v6, v5, v4
; GFX9-SDAG-NEXT:    v_max_f32_e64 v4, s13, s13
; GFX9-SDAG-NEXT:    v_max_f32_e64 v5, s41, s41
; GFX9-SDAG-NEXT:    v_max_f32_e32 v5, v5, v4
; GFX9-SDAG-NEXT:    v_max_f32_e64 v4, s12, s12
; GFX9-SDAG-NEXT:    v_max_f32_e64 v8, s40, s40
; GFX9-SDAG-NEXT:    v_max_f32_e32 v4, v8, v4
; GFX9-SDAG-NEXT:    v_max_f32_e64 v8, s19, s19
; GFX9-SDAG-NEXT:    v_max_f32_e64 v9, s47, s47
; GFX9-SDAG-NEXT:    v_max_f32_e32 v11, v9, v8
; GFX9-SDAG-NEXT:    v_max_f32_e64 v8, s18, s18
; GFX9-SDAG-NEXT:    v_max_f32_e64 v9, s46, s46
; GFX9-SDAG-NEXT:    v_max_f32_e32 v10, v9, v8
; GFX9-SDAG-NEXT:    v_max_f32_e64 v8, s17, s17
; GFX9-SDAG-NEXT:    v_max_f32_e64 v9, s45, s45
; GFX9-SDAG-NEXT:    v_max_f32_e32 v9, v9, v8
; GFX9-SDAG-NEXT:    v_max_f32_e64 v8, s16, s16
; GFX9-SDAG-NEXT:    v_max_f32_e64 v12, s44, s44
; GFX9-SDAG-NEXT:    v_max_f32_e32 v8, v12, v8
; GFX9-SDAG-NEXT:    v_max_f32_e64 v12, s23, s23
; GFX9-SDAG-NEXT:    v_max_f32_e64 v13, s51, s51
; GFX9-SDAG-NEXT:    v_max_f32_e32 v15, v13, v12
; GFX9-SDAG-NEXT:    v_max_f32_e64 v12, s22, s22
; GFX9-SDAG-NEXT:    v_max_f32_e64 v13, s50, s50
; GFX9-SDAG-NEXT:    v_max_f32_e32 v14, v13, v12
; GFX9-SDAG-NEXT:    v_max_f32_e64 v12, s21, s21
; GFX9-SDAG-NEXT:    v_max_f32_e64 v13, s49, s49
; GFX9-SDAG-NEXT:    v_max_f32_e32 v13, v13, v12
; GFX9-SDAG-NEXT:    v_max_f32_e64 v12, s20, s20
; GFX9-SDAG-NEXT:    v_max_f32_e64 v16, s48, s48
...
; GFX12-SDAG-NEXT:    s_load_b64 s[36:37], s[4:5], 0x24
; GFX12-SDAG-NEXT:    s_load_b512 s[16:31], s[4:5], 0xa4
; GFX12-SDAG-NEXT:    s_load_b512 s[0:15], s[4:5], 0x64
; GFX12-SDAG-NEXT:    s_mov_b32 s38, -1
; GFX12-SDAG-NEXT:    s_mov_b32 s39, 0x31016000
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v8, s7, s7
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v9, s22, s22
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v10, s6, s6
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v11, s21, s21
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v12, s5, s5
; GFX12-SDAG-NEXT:    v_dual_max_num_f32 v3, v1, v0 :: v_dual_max_num_f32 v2, v4, v2
; GFX12-SDAG-NEXT:    v_max_num_f32_e32 v7, v8, v7
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v0, s27, s27
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v4, s11, s11
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v8, s26, s26
; GFX12-SDAG-NEXT:    v_max_num_f32_e32 v1, v6, v5
; GFX12-SDAG-NEXT:    v_dual_max_num_f32 v6, v10, v9 :: v_dual_max_num_f32 v5, v12, v11
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v9, s10, s10
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v12, s25, s25
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v13, s9, s9
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v18, s20, s20
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v19, s4, s4
; GFX12-SDAG-NEXT:    v_max_num_f32_e32 v10, v9, v8
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v8, s15, s15
; GFX12-SDAG-NEXT:    v_max_num_f32_e32 v9, v13, v12
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v12, s30, s30
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v13, s14, s14
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v20, s29, s29
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v21, s13, s13
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v22, s28, s28
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v23, s12, s12
; GFX12-SDAG-NEXT:    v_max_num_f32_e32 v11, v4, v0
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v4, s31, s31
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v0, s24, s24
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v24, s8, s8
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v16, s16, s16
; GFX12-SDAG-NEXT:    v_max_num_f32_e64 v17, s0, s0
...
; GFX12-SDAG-NEXT:    buffer_store_b128 v[12:15], off, s[36:39], null offset:48
; GFX12-SDAG-NEXT:    buffer_store_b128 v[8:11], off, s[36:39], null offset:32
; GFX12-SDAG-NEXT:    buffer_store_b128 v[4:7], off, s[36:39], null offset:16
; GFX12-SDAG-NEXT:    buffer_store_b128 v[0:3], off, s[36:39], null
; GFX12-SDAG-NEXT:    s_endpgm
;
...
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v0, s8, s8
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v1, s36, s36
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v2, s9, s9
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v3, s37, s37
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v4, s10, s10
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v5, s38, s38
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v6, s11, s11
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v7, s39, s39
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v8, s12, s12
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v9, s40, s40
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v10, s13, s13
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v11, s41, s41
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s3, v1
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s5, v2
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s6, v3
...
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s12, v9
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s13, v10
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s24, v11
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v0, s14, s14
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v1, s42, s42
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v2, s15, s15
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v3, s43, s43
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v4, s16, s16
; GFX12-GISEL-NEXT:    s_max_num_f32 s4, s2, s3
; GFX12-GISEL-NEXT:    s_max_num_f32 s5, s5, s6
; GFX12-GISEL-NEXT:    s_max_num_f32 s6, s7, s8
; GFX12-GISEL-NEXT:    s_max_num_f32 s7, s9, s10
; GFX12-GISEL-NEXT:    s_max_num_f32 s8, s11, s12
; GFX12-GISEL-NEXT:    s_max_num_f32 s9, s13, s24
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s3, v1
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s11, v2
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s12, v3
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s13, v4
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v0, s44, s44
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v1, s17, s17
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v2, s45, s45
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v3, s18, s18
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v4, s46, s46
...
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v0, s19, s19
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v1, s47, s47
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v2, s20, s20
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v3, s48, s48
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v4, s21, s21
; GFX12-GISEL-NEXT:    s_max_num_f32 s10, s2, s3
...
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s17, v3
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s18, v4
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v0, s49, s49
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v1, s22, s22
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v2, s50, s50
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v3, s23, s23
; GFX12-GISEL-NEXT:    v_max_num_f32_e64 v4, s51, s51
...
; GFX8-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    s_lshr_b32 s5, s4, 16
; GFX8-SDAG-NEXT:    v_max_f16_e64 v0, s5, s5
; GFX8-SDAG-NEXT:    v_max_f16_e64 v1, s4, s4
...
; GFX9-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-SDAG-NEXT:    s_load_dword s4, s[4:5], 0x2c
; GFX9-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX9-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-SDAG-NEXT:    s_lshr_b32 s5, s4, 16
; GFX9-SDAG-NEXT:    v_max_f16_e64 v0, s5, s5
; GFX9-SDAG-NEXT:    v_max_f16_e64 v1, s4, s4
...
; GFX12-SDAG-NEXT:    v_max_num_f64_e64 v[0:1], s[4:5], s[4:5]
; GFX12-SDAG-NEXT:    s_mov_b32 s3, 0x31016000
; GFX12-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
