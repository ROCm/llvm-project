...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=r600 -mcpu=redwood < %s | FileCheck --check-prefix=R600 %s
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_load_dword s6, s[4:5], 0x26
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x13
...
; GFX6-NEXT:    s_cselect_b32 s0, s5, s4
