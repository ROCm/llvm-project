...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.31-amd-amdhsa -verify-coalescing < %s | FileCheck %s
...
; CHECK-NEXT:    ; implicit-def: $sgpr28_sgpr29_sgpr30_sgpr31
...
; CHECK-NEXT:    ; implicit-def: $sgpr20_sgpr21_sgpr22_sgpr23
