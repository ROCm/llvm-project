...
; GCN-NEXT:    v_mul_hi_u32 v0, v0, s14
; GCN-NEXT:    s_mul_i32 s17, s11, s14
...
; GCN-NEXT:    s_add_u32 s4, s15, s4
; GCN-NEXT:    s_addc_u32 s4, s16, s14
...
; GCN-IR-NEXT:    s_mov_b64 s[12:13], -1
; GCN-IR-NEXT:    s_mov_b64 s[10:11], 0
; GCN-IR-NEXT:    s_xor_b64 s[22:23], exec, s[24:25]
; GCN-IR-NEXT:    s_mov_b64 s[16:17], 0
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
; GCN-IR-NEXT:    s_mov_b64 s[6:7], 0
; GCN-IR-NEXT:    s_mov_b64 exec, s[24:25]
...
; GCN-IR-NEXT:    s_or_b64 s[18:19], s[18:19], s[4:5]
; GCN-IR-NEXT:    s_and_b64 s[4:5], exec, vcc
; GCN-IR-NEXT:    s_xor_b64 s[4:5], vcc, -1
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-IR-NEXT:    s_or_b64 s[14:15], s[14:15], s[4:5]
; GCN-IR-NEXT:    s_xor_b64 s[4:5], exec, s[18:19]
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[4:5], v2
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-IR-NEXT:    s_or_b64 s[16:17], s[16:17], s[4:5]
; GCN-IR-NEXT:    s_mov_b64 exec, s[18:19]
; GCN-IR-NEXT:    s_mov_b64 s[4:5], 0
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB1_9
; GCN-IR-NEXT:  .LBB1_3:
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[16:17]
...
; GCN-IR-NEXT:    s_mov_b64 s[4:5], 0
; GCN-IR-NEXT:    v_addc_u32_e64 v17, s[4:5], -1, 0, vcc
...
; GCN-IR-NEXT:  .LBB1_8:
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, v5, 0, s[20:21]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, v4, 0, s[20:21]
; GCN-IR-NEXT:    s_mov_b64 s[24:25], 0
...
; GCN-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0xd
; GCN-NEXT:    s_mov_b32 s11, 0xf000
; GCN-NEXT:    s_mov_b32 s10, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i32 s0, s5, 8
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s0
; GCN-NEXT:    s_ashr_i32 s1, s1, 8
; GCN-NEXT:    v_cvt_f32_i32_e32 v1, s1
; GCN-NEXT:    s_xor_b32 s0, s1, s0
; GCN-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GCN-NEXT:    s_ashr_i32 s0, s0, 30
; GCN-NEXT:    s_ashr_i32 s2, s3, 8
; GCN-NEXT:    s_ashr_i32 s3, s7, 8
; GCN-NEXT:    v_mul_f32_e32 v2, v1, v2
; GCN-NEXT:    v_trunc_f32_e32 v2, v2
; GCN-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GCN-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GCN-NEXT:    s_or_b32 s4, s0, 1
; GCN-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v1|, |v0|
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s0, s4, 0
; GCN-NEXT:    v_add_i32_e32 v0, vcc, s0, v2
; GCN-NEXT:    v_cvt_f32_i32_e32 v2, s3
; GCN-NEXT:    v_cvt_f32_i32_e32 v3, s2
; GCN-NEXT:    s_xor_b32 s0, s2, s3
; GCN-NEXT:    s_ashr_i32 s0, s0, 30
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x9
; GCN-IR-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0xd
; GCN-IR-NEXT:    s_mov_b32 s11, 0xf000
; GCN-IR-NEXT:    s_mov_b32 s10, -1
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i32 s0, s5, 8
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s0
; GCN-IR-NEXT:    s_ashr_i32 s1, s1, 8
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v1, s1
; GCN-IR-NEXT:    s_xor_b32 s0, s1, s0
; GCN-IR-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GCN-IR-NEXT:    s_ashr_i32 s0, s0, 30
; GCN-IR-NEXT:    s_ashr_i32 s2, s3, 8
; GCN-IR-NEXT:    s_ashr_i32 s3, s7, 8
; GCN-IR-NEXT:    v_mul_f32_e32 v2, v1, v2
; GCN-IR-NEXT:    v_trunc_f32_e32 v2, v2
; GCN-IR-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GCN-IR-NEXT:    s_or_b32 s4, s0, 1
; GCN-IR-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v1|, |v0|
; GCN-IR-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-IR-NEXT:    s_cselect_b32 s0, s4, 0
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, s0, v2
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v2, s3
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v3, s2
; GCN-IR-NEXT:    s_xor_b32 s0, s2, s3
; GCN-IR-NEXT:    s_ashr_i32 s0, s0, 30
...
; GCN-IR-NEXT:    v_subb_u32_e64 v15, s[4:5], 0, 0, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[12:13], exec
...
; GCN-IR-NEXT:    v_add_i32_e32 v5, vcc, 1, v2
; GCN-IR-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GCN-IR-NEXT:    s_and_b64 s[20:21], exec, vcc
; GCN-IR-NEXT:    s_or_b64 s[18:19], s[18:19], s[20:21]
; GCN-IR-NEXT:    s_and_b64 s[20:21], exec, vcc
; GCN-IR-NEXT:    s_xor_b64 s[20:21], vcc, -1
; GCN-IR-NEXT:    s_and_b64 s[20:21], s[20:21], exec
; GCN-IR-NEXT:    s_mov_b64 s[4:5], 0
; GCN-IR-NEXT:    v_sub_i32_e64 v2, s[4:5], 63, v2
; GCN-IR-NEXT:    s_or_b64 s[14:15], s[14:15], s[20:21]
; GCN-IR-NEXT:    s_mov_b64 s[4:5], 0x8000
; GCN-IR-NEXT:    s_xor_b64 s[20:21], exec, s[18:19]
...
; GCN-IR-NEXT:  .LBB12_3:
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[16:17]
; GCN-IR-NEXT:    s_xor_b64 s[16:17], exec, s[14:15]
; GCN-IR-NEXT:    s_and_b64 s[16:17], s[16:17], exec
; GCN-IR-NEXT:    s_or_b64 s[8:9], s[8:9], s[16:17]
; GCN-IR-NEXT:    s_mov_b64 exec, s[14:15]
; GCN-IR-NEXT:    s_mov_b64 s[14:15], 0
; GCN-IR-NEXT:    s_mov_b64 s[14:15], 0
; GCN-IR-NEXT:    ; divergent control-flow edge
...
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], s[4:5], v5
; GCN-IR-NEXT:    v_subb_u32_e64 v15, s[4:5], 0, 0, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
...
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, s4, v4
...
; GCN-IR-NEXT:    s_xor_b64 s[10:11], vcc, -1
...
; GCN-IR-NEXT:    s_mov_b32 s7, 0xf000
; GCN-IR-NEXT:    s_mov_b32 s6, -1
; GCN-IR-NEXT:    s_ashr_i32 s4, s3, 8
...
; GCN-NEXT:    s_ashr_i32 s0, s3, 31
; GCN-NEXT:    s_or_b32 s2, s0, 1
; GCN-NEXT:    s_mov_b32 s0, 0x46b6fe00
; GCN-NEXT:    v_mul_f32_e32 v1, 0x38331158, v0
; GCN-NEXT:    v_trunc_f32_e32 v1, v1
; GCN-NEXT:    v_mad_f32 v0, -v1, s0, v0
; GCN-NEXT:    v_cvt_i32_f32_e32 v1, v1
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v0|, s0
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s0, s2, 0
; GCN-NEXT:    v_add_i32_e32 v0, vcc, s0, v1
; GCN-NEXT:    v_bfe_i32 v0, v0, 0, 24
...
; GCN-IR-NEXT:    s_ashr_i32 s0, s3, 31
; GCN-IR-NEXT:    s_or_b32 s2, s0, 1
; GCN-IR-NEXT:    s_mov_b32 s0, 0x46b6fe00
; GCN-IR-NEXT:    v_mul_f32_e32 v1, 0x38331158, v0
; GCN-IR-NEXT:    v_trunc_f32_e32 v1, v1
; GCN-IR-NEXT:    v_mad_f32 v0, -v1, s0, v0
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v1, v1
; GCN-IR-NEXT:    s_mov_b32 s5, s1
; GCN-IR-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v0|, s0
; GCN-IR-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-IR-NEXT:    s_cselect_b32 s0, s2, 0
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, s0, v1
; GCN-IR-NEXT:    v_bfe_i32 v0, v0, 0, 24
