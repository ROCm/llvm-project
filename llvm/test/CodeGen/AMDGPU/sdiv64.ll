...
; GCN-NEXT:    s_mul_i32 s14, s4, s10
; GCN-NEXT:    v_readfirstlane_b32 s17, v2
; GCN-NEXT:    s_mul_i32 s15, s5, s11
; GCN-NEXT:    s_add_i32 s14, s17, s14
; GCN-NEXT:    s_mul_i32 s16, s4, s11
; GCN-NEXT:    s_add_i32 s14, s14, s15
; GCN-NEXT:    v_mul_hi_u32 v2, v0, s14
; GCN-NEXT:    v_mul_hi_u32 v0, v0, s16
; GCN-NEXT:    s_mul_i32 s15, s11, s14
; GCN-NEXT:    v_readfirstlane_b32 s17, v2
; GCN-NEXT:    v_readfirstlane_b32 s18, v0
; GCN-NEXT:    v_mul_hi_u32 v0, v1, s16
; GCN-NEXT:    v_mul_hi_u32 v1, v1, s14
; GCN-NEXT:    s_add_u32 s15, s18, s15
; GCN-NEXT:    s_addc_u32 s17, 0, s17
; GCN-NEXT:    s_mul_i32 s16, s10, s16
; GCN-NEXT:    v_readfirstlane_b32 s18, v0
...
; GCN-NEXT:    s_add_u32 s14, s11, s4
; GCN-NEXT:    s_addc_u32 s15, s10, s5
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i32 s4, s3, 31
; GCN-NEXT:    s_add_u32 s2, s2, s4
; GCN-NEXT:    s_mov_b32 s5, s4
; GCN-NEXT:    s_addc_u32 s3, s3, s4
; GCN-NEXT:    s_xor_b64 s[10:11], s[2:3], s[4:5]
; GCN-NEXT:    v_mov_b32_e32 v0, s15
; GCN-NEXT:    v_mul_hi_u32 v1, s10, v0
; GCN-NEXT:    v_mov_b32_e32 v2, s14
; GCN-NEXT:    v_mul_hi_u32 v3, s10, v2
; GCN-NEXT:    s_mov_b32 s2, s13
; GCN-NEXT:    v_readfirstlane_b32 s13, v1
; GCN-NEXT:    v_mul_hi_u32 v1, s11, v2
; GCN-NEXT:    s_mul_i32 s3, s10, s15
; GCN-NEXT:    v_readfirstlane_b32 s16, v3
; GCN-NEXT:    v_mul_hi_u32 v0, s11, v0
; GCN-NEXT:    s_add_u32 s3, s16, s3
; GCN-NEXT:    s_addc_u32 s13, 0, s13
; GCN-NEXT:    s_mul_i32 s14, s11, s14
; GCN-NEXT:    v_readfirstlane_b32 s16, v1
; GCN-NEXT:    s_add_u32 s3, s3, s14
; GCN-NEXT:    s_addc_u32 s3, s13, s16
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    s_addc_u32 s13, s13, 0
; GCN-NEXT:    s_mul_i32 s14, s11, s15
; GCN-NEXT:    s_add_u32 s14, s3, s14
; GCN-NEXT:    v_mov_b32_e32 v0, s14
; GCN-NEXT:    v_mul_hi_u32 v0, s8, v0
; GCN-NEXT:    s_addc_u32 s15, 0, s13
; GCN-NEXT:    s_mov_b32 s3, s12
; GCN-NEXT:    s_mul_i32 s12, s8, s15
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    s_add_i32 s12, s13, s12
; GCN-NEXT:    s_mul_i32 s13, s9, s14
; GCN-NEXT:    s_add_i32 s16, s12, s13
; GCN-NEXT:    s_sub_i32 s17, s11, s16
; GCN-NEXT:    s_mul_i32 s12, s8, s14
; GCN-NEXT:    s_sub_u32 s10, s10, s12
; GCN-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GCN-NEXT:    s_subb_u32 s17, s17, s9
; GCN-NEXT:    s_sub_u32 s18, s10, s8
; GCN-NEXT:    s_subb_u32 s17, s17, 0
; GCN-NEXT:    s_cmp_ge_u32 s17, s9
; GCN-NEXT:    s_cselect_b32 s19, -1, 0
; GCN-NEXT:    s_cmp_ge_u32 s18, s8
; GCN-NEXT:    s_cselect_b32 s18, -1, 0
; GCN-NEXT:    s_cmp_eq_u32 s17, s9
...
; GCN-NEXT:    s_subb_u32 s11, s11, s16
; GCN-NEXT:    s_cmp_ge_u32 s11, s9
; GCN-NEXT:    s_cselect_b32 s12, -1, 0
; GCN-NEXT:    s_cmp_ge_u32 s10, s8
; GCN-NEXT:    s_cselect_b32 s8, -1, 0
; GCN-NEXT:    s_cmp_eq_u32 s11, s9
; GCN-NEXT:    s_cselect_b32 s8, s8, s12
; GCN-NEXT:    s_cmp_lg_u32 s8, 0
; GCN-NEXT:    s_cselect_b32 s9, s18, s15
; GCN-NEXT:    s_cselect_b32 s8, s17, s14
; GCN-NEXT:    s_xor_b64 s[4:5], s[4:5], s[6:7]
; GCN-NEXT:    s_xor_b64 s[6:7], s[8:9], s[4:5]
...
; GCN-IR-NEXT:    s_sub_u32 s14, s16, s20
; GCN-IR-NEXT:    s_subb_u32 s15, 0, 0
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[18:19], s[14:15], 63
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[22:23], s[14:15], 63
...
; GCN-IR-NEXT:    s_lshr_b64 s[14:15], s[12:13], s18
; GCN-IR-NEXT:    s_add_u32 s18, s2, -1
; GCN-IR-NEXT:    s_addc_u32 s19, s3, -1
; GCN-IR-NEXT:    s_not_b64 s[8:9], s[16:17]
...
; GCN-IR-NEXT:    s_and_b64 s[20:21], s[16:17], s[2:3]
...
; GCN-NEXT:    v_mul_hi_u32 v12, v6, v7
; GCN-NEXT:    v_mul_lo_u32 v7, v6, v7
; GCN-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; GCN-NEXT:    v_addc_u32_e32 v8, vcc, v10, v11, vcc
...
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    s_mul_i32 s14, s5, s11
; GCN-NEXT:    v_readfirstlane_b32 s16, v2
; GCN-NEXT:    s_mul_i32 s15, s10, s13
; GCN-NEXT:    s_add_i32 s14, s16, s14
; GCN-NEXT:    s_add_i32 s14, s14, s15
; GCN-NEXT:    s_mul_i32 s15, s5, s13
; GCN-NEXT:    v_mul_hi_u32 v2, v0, s14
; GCN-NEXT:    v_mul_hi_u32 v0, v0, s15
; GCN-NEXT:    s_mul_i32 s16, s13, s14
; GCN-NEXT:    v_readfirstlane_b32 s17, v2
; GCN-NEXT:    v_readfirstlane_b32 s18, v0
...
; GCN-NEXT:    s_addc_u32 s17, 0, s17
; GCN-NEXT:    s_mul_i32 s15, s11, s15
; GCN-NEXT:    v_readfirstlane_b32 s18, v0
...
; GCN-NEXT:    s_addc_u32 s11, s11, s15
; GCN-NEXT:    s_mul_i32 s14, s5, s13
; GCN-NEXT:    s_mul_i32 s5, s5, s11
; GCN-NEXT:    v_readfirstlane_b32 s15, v1
...
; GCN-NEXT:    v_mul_hi_u32 v3, s13, v1
; GCN-NEXT:    s_mul_i32 s15, s13, s5
; GCN-NEXT:    s_mul_i32 s14, s11, s14
; GCN-NEXT:    v_readfirstlane_b32 s17, v0
...
; GCN-NEXT:    s_add_u32 s14, s15, s14
; GCN-NEXT:    s_addc_u32 s10, s16, s10
; GCN-NEXT:    v_readfirstlane_b32 s14, v0
; GCN-NEXT:    s_addc_u32 s14, s14, 0
; GCN-NEXT:    s_mul_i32 s5, s11, s5
; GCN-NEXT:    s_add_u32 s5, s10, s5
; GCN-NEXT:    s_addc_u32 s10, 0, s14
; GCN-NEXT:    s_add_u32 s13, s13, s5
; GCN-NEXT:    s_addc_u32 s14, s11, s10
; GCN-NEXT:    s_add_u32 s10, s3, s4
; GCN-NEXT:    s_mov_b32 s5, s4
; GCN-NEXT:    s_addc_u32 s11, s4, s4
; GCN-NEXT:    s_xor_b64 s[10:11], s[10:11], s[4:5]
; GCN-NEXT:    v_mov_b32_e32 v0, s14
; GCN-NEXT:    v_mul_hi_u32 v1, s10, v0
; GCN-NEXT:    v_mov_b32_e32 v2, s13
; GCN-NEXT:    v_mul_hi_u32 v3, s10, v2
; GCN-NEXT:    s_mul_i32 s3, s10, s14
; GCN-NEXT:    v_readfirstlane_b32 s15, v1
; GCN-NEXT:    v_mul_hi_u32 v1, s11, v2
; GCN-NEXT:    v_readfirstlane_b32 s16, v3
; GCN-NEXT:    v_mul_hi_u32 v0, s11, v0
...
; GCN-NEXT:    s_addc_u32 s3, s15, s16
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    s_addc_u32 s13, s13, 0
; GCN-NEXT:    s_mul_i32 s14, s11, s14
; GCN-NEXT:    s_add_u32 s14, s3, s14
...
; GCN-IR-NEXT:    s_xor_b64 s[10:11], s[8:9], s[4:5]
; GCN-IR-NEXT:    s_mov_b32 s6, s3
; GCN-IR-NEXT:    s_mov_b32 s7, s3
; GCN-IR-NEXT:    s_sub_u32 s12, s10, s9
; GCN-IR-NEXT:    s_subb_u32 s13, s11, s9
...
; GCN-IR-NEXT:    s_mov_b64 s[16:17], 0
; GCN-IR-NEXT:    s_mov_b32 s9, 0
; GCN-IR-NEXT:  .LBB5_3: ; %udiv-do-while
; GCN-IR-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-IR-NEXT:    s_lshl_b64 s[14:15], s[14:15], 1
; GCN-IR-NEXT:    s_lshr_b32 s8, s11, 31
; GCN-IR-NEXT:    s_lshl_b64 s[10:11], s[10:11], 1
...
; GCN-NEXT:    s_lshr_b64 s[8:9], s[6:7], 24
; GCN-NEXT:    s_abs_i32 s9, s8
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s9
; GCN-NEXT:    s_mov_b32 s4, s0
...
; GCN-IR-NEXT:    s_lshr_b64 s[8:9], s[6:7], 24
; GCN-IR-NEXT:    s_abs_i32 s9, s8
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, s9
; GCN-IR-NEXT:    s_mov_b32 s4, s0
; GCN-IR-NEXT:    s_sub_i32 s0, 0, s9
...
; GCN-NEXT:    s_sub_u32 s8, 0, s6
; GCN-NEXT:    s_subb_u32 s9, 0, s7
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    v_madmk_f32 v0, v1, 0x4f800000, v0
; GCN-NEXT:    v_rcp_f32_e32 v0, v0
; GCN-NEXT:    s_mov_b32 s2, -1
...
; GCN-NEXT:    v_mul_hi_u32 v0, v1, s14
...
; GCN-NEXT:    s_add_u32 s8, s11, s8
; GCN-NEXT:    s_addc_u32 s9, s10, s9
; GCN-NEXT:    v_mul_hi_u32 v1, s8, 24
; GCN-NEXT:    v_mul_hi_u32 v0, s9, 24
; GCN-NEXT:    s_mul_i32 s9, s9, 24
; GCN-NEXT:    v_readfirstlane_b32 s10, v1
; GCN-NEXT:    v_readfirstlane_b32 s8, v0
; GCN-NEXT:    s_add_u32 s9, s10, s9
; GCN-NEXT:    s_addc_u32 s10, 0, s8
...
; GCN-IR-NEXT:    s_and_b64 s[18:19], s[12:13], exec
...
; GCN-NEXT:    v_mul_lo_u32 v7, v5, v3
; GCN-NEXT:    v_mul_lo_u32 v8, v5, v4
...
; GCN-IR-NEXT:    s_xor_b64 exec, s[4:5], exec
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execz .LBB14_4
; GCN-IR-NEXT:  .LBB14_2: ; %udiv-preheader
...
; GCN-IR-NEXT:    s_xor_b64 exec, s[4:5], exec
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execz .LBB19_4
; GCN-IR-NEXT:  .LBB19_2: ; %udiv-preheader
; GCN-IR-NEXT:    v_add_i32_e32 v10, vcc, 0xffffffcf, v6
; GCN-IR-NEXT:    v_lshr_b64 v[4:5], v[4:5], v7
; GCN-IR-NEXT:    v_addc_u32_e64 v11, s[10:11], 0, -1, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v6, 0
...
; GCN-IR-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB19_3
; GCN-IR-NEXT:  .LBB19_4: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; GCN-IR-NEXT:    v_or_b32_e32 v3, v3, v1
; GCN-IR-NEXT:    v_or_b32_e32 v2, v2, v0
; GCN-IR-NEXT:  .LBB19_5: ; %udiv-end
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v2, v8
; GCN-IR-NEXT:    v_xor_b32_e32 v1, v3, v9
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v0, v8
