...
; GCN-NEXT:    v_mul_lo_u32 v10, v6, v10
...
; GCN-NEXT:    v_addc_u32_e32 v10, vcc, v11, v15, vcc
...
; GCN-NEXT:    v_xor_b32_e32 v0, v0, v10
...
; GCN-NEXT:    v_mul_hi_u32 v7, v0, v6
...
; GCN-NEXT:    v_addc_u32_e32 v5, vcc, v7, v12, vcc
; GCN-NEXT:    v_addc_u32_e32 v7, vcc, 0, v11, vcc
; GCN-NEXT:    v_add_i32_e32 v5, vcc, v5, v6
; GCN-NEXT:    v_addc_u32_e32 v6, vcc, 0, v7, vcc
; GCN-NEXT:    v_mul_lo_u32 v7, v3, v6
...
; GCN-NEXT:    v_sub_i32_e32 v9, vcc, v1, v7
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v0, v8
; GCN-NEXT:    v_subb_u32_e64 v8, s[4:5], v9, v2, vcc
; GCN-NEXT:    v_subb_u32_e32 v1, vcc, v1, v7, vcc
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, v0, v3
...
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v2
; GCN-NEXT:    v_cndmask_b32_e32 v7, v9, v7, vcc
; GCN-NEXT:    v_add_i32_e32 v8, vcc, 2, v5
; GCN-NEXT:    v_addc_u32_e32 v9, vcc, 0, v6, vcc
; GCN-NEXT:    v_add_i32_e32 v11, vcc, 1, v5
; GCN-NEXT:    v_addc_u32_e32 v12, vcc, 0, v6, vcc
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v7
; GCN-NEXT:    v_cndmask_b32_e32 v7, v12, v9, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v8, v11, v8, vcc
...
; GCN-NEXT:    v_cndmask_b32_e32 v1, v5, v8, vcc
; GCN-NEXT:    v_xor_b32_e32 v2, v10, v4
...
; GCN-IR-NEXT:    v_xor_b32_e32 v5, v0, v10
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v2, v11
; GCN-IR-NEXT:    v_xor_b32_e32 v4, v1, v10
...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v2, v7, 0, s[4:5]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v3, v6, 0, s[4:5]
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[6:7], vcc
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
; GCN-IR-NEXT:    s_cbranch_execz .LBB1_6
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, 63, v8
...
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    v_not_b32_e32 v4, v15
; GCN-IR-NEXT:    v_add_i32_e32 v15, vcc, -1, v0
; GCN-IR-NEXT:    v_addc_u32_e32 v16, vcc, -1, v1, vcc
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], v[6:7], v8
; GCN-IR-NEXT:    v_add_i32_e32 v14, vcc, v4, v14
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
...
; GCN-NEXT:    v_add_i32_e32 v3, vcc, v0, v2
; GCN-NEXT:    v_addc_u32_e32 v0, vcc, v1, v2, vcc
; GCN-NEXT:    v_xor_b32_e32 v0, v0, v2
; GCN-NEXT:    v_xor_b32_e32 v1, v3, v2
; GCN-NEXT:    v_cvt_f32_u32_e32 v3, v1
; GCN-NEXT:    v_cvt_f32_u32_e32 v4, v0
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, 0, v1
; GCN-NEXT:    v_subb_u32_e32 v6, vcc, 0, v0, vcc
...
; GCN-NEXT:    v_mul_hi_u32 v13, v4, v8
; GCN-NEXT:    v_mul_lo_u32 v8, v4, v8
...
; GCN-NEXT:    v_addc_u32_e32 v8, vcc, v9, v13, vcc
...
; GCN-NEXT:    v_subb_u32_e64 v6, s[4:5], v6, v0, vcc
; GCN-NEXT:    v_subb_u32_e32 v4, vcc, 0, v4, vcc
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, v5, v1
...
; GCN-NEXT:    v_cndmask_b32_e64 v7, 0, -1, vcc
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v6, v0
; GCN-NEXT:    v_cndmask_b32_e32 v6, v8, v7, vcc
; GCN-NEXT:    v_add_i32_e32 v7, vcc, 2, v3
; GCN-NEXT:    v_addc_u32_e64 v8, s[4:5], 0, 0, vcc
; GCN-NEXT:    v_add_i32_e32 v9, vcc, 1, v3
; GCN-NEXT:    v_addc_u32_e64 v10, s[4:5], 0, 0, vcc
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GCN-NEXT:    v_cndmask_b32_e32 v6, v10, v8, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v7, v9, v7, vcc
...
; GCN-NEXT:    v_cndmask_b32_e32 v1, v3, v7, vcc
; GCN-NEXT:    v_xor_b32_e32 v3, v0, v2
; GCN-NEXT:    v_xor_b32_e32 v0, v1, v2
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v0, v2
; GCN-NEXT:    v_subb_u32_e32 v1, vcc, v3, v2, vcc
...
; GCN-IR-NEXT:    v_add_i32_e32 v6, vcc, 0xffffffc5, v12
...
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    v_add_i32_e32 v13, vcc, -1, v0
; GCN-IR-NEXT:    v_addc_u32_e32 v14, vcc, -1, v1, vcc
; GCN-IR-NEXT:    v_lshr_b64 v[8:9], 24, v6
; GCN-IR-NEXT:    v_sub_i32_e32 v12, vcc, 58, v12
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
...
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v3, v10
; GCN-IR-NEXT:    v_xor_b32_e32 v1, v2, v11
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v0, v10
; GCN-IR-NEXT:    v_subb_u32_e32 v1, vcc, v1, v11, vcc
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
  %result = sdiv i64 24, %x
...
; GCN-NEXT:    v_subb_u32_e32 v4, vcc, 0, v4, vcc
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, v5, v0
; GCN-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v6, vcc
...
; GCN-IR-NEXT:    v_ffbh_u32_e32 v3, v1
; GCN-IR-NEXT:    v_min_u32_e32 v12, v2, v3
; GCN-IR-NEXT:    v_add_i32_e32 v6, vcc, 0xffffffd0, v12
; GCN-IR-NEXT:    v_addc_u32_e64 v7, s[6:7], 0, -1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[0:1]
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, 63, v[6:7]
; GCN-IR-NEXT:    v_cmp_ne_u64_e64 s[6:7], 63, v[6:7]
...
; GCN-IR-NEXT:    v_sub_i32_e32 v12, vcc, 47, v12
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
; GCN-IR-NEXT:    v_mov_b32_e32 v6, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
...
; GCN-IR-NEXT:    v_min_u32_e32 v10, v0, v1
...
; GCN-IR-NEXT:    s_xor_b64 s[6:7], s[4:5], -1
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, v5, 0, s[4:5]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, v4, 0, s[4:5]
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[6:7], vcc
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
...
; GCN-IR-NEXT:    v_add_i32_e32 v10, vcc, 0xffffffcf, v10
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
; GCN-IR-NEXT:    v_mov_b32_e32 v4, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v3, 0
; GCN-IR-NEXT:    s_movk_i32 s10, 0x7fff
; GCN-IR-NEXT:    v_addc_u32_e64 v11, s[12:13], 0, -1, vcc
...
; GCN-IR-NEXT:    v_and_b32_e32 v12, 0x8000, v4
...
; GCN-IR-NEXT:    v_sub_i32_e32 v6, vcc, v6, v12
...
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 1, v2
; GCN-IR-NEXT:    v_sub_i32_e32 v5, vcc, v3, v0
; GCN-IR-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; GCN-IR-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 1, v2
; GCN-IR-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v0
