...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.04 < %s | FileCheck -check-prefix=GCN1 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=GCN2 %s
...
; GCN1-NEXT:    v_mov_b32_e32 v4, s3
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    v_cmp_eq_u64_e32 vcc, s[6:7], v[0:1]
...
; GCN2-NEXT:    v_mov_b32_e32 v4, s3
; GCN2-NEXT:    s_waitcnt vmcnt(0)
; GCN2-NEXT:    v_cmp_eq_u64_e32 vcc, s[6:7], v[0:1]
