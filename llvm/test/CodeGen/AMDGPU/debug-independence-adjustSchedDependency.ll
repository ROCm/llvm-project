...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa < %s             -filetype=obj -o %t.with_debug.o
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa < %t.no_debug.ll -filetype=obj -o %t.no_debug.o
