...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a < %s | FileCheck -enable-var-scope --check-prefix=GCN %s
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_accvgpr_write_b32 a0, v40 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a1, v41 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a2, v42 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a3, v43 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a4, v44 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a5, v45 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a6, v46 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a7, v47 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a8, v56 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a9, v57 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a10, v58 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a11, v59 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a12, v60 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a13, v61 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a14, v62 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a15, v63 ; Reload Reuse
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; def v1
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    ;;#ASMSTART
...
; GCN-NEXT:    ; use v[6:37]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    v_accvgpr_read_b32 v63, a15 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v62, a14 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v61, a13 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v60, a12 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v59, a11 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v58, a10 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v57, a9 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v56, a8 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v47, a7 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v46, a6 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v45, a5 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v44, a4 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v43, a3 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v42, a2 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v41, a1 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v40, a0 ; Reload Reuse
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_setpc_b64 s[30:31]
  %gep.0 = getelementptr inbounds [512 x i32], ptr addrspace(3) %lds, i32 0, i32 10
  %gep.1 = getelementptr inbounds [512 x i32], ptr addrspace(3) %lds, i32 0, i32 24
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_accvgpr_write_b32 a2, v40 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a3, v41 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a4, v42 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a5, v43 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a6, v44 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a7, v45 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a8, v46 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a9, v47 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a10, v56 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a11, v57 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a12, v58 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a13, v59 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a14, v60 ; Reload Reuse
...
; GCN-NEXT:    ; def v[6:37]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    buffer_store_dword v6, off, s[0:3], s32 ; 4-byte Folded Spill
; GCN-NEXT:    s_nop 0
; GCN-NEXT:    buffer_store_dword v7, off, s[0:3], s32 offset:4 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v8, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v9, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v10, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v11, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v12, off, s[0:3], s32 offset:24 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v13, off, s[0:3], s32 offset:28 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v14, off, s[0:3], s32 offset:32 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:36 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v16, off, s[0:3], s32 offset:40 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v17, off, s[0:3], s32 offset:44 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v18, off, s[0:3], s32 offset:48 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v19, off, s[0:3], s32 offset:52 ; 4-byte Folded Spill
; GCN-NEXT:    buffer_store_dword v20, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
...
; GCN-NEXT:    v_accvgpr_write_b32 a28, v27 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a27, v28 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a26, v29 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a25, v30 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a24, v31 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a23, v32 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a22, v33 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a21, v34 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a20, v35 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_write_b32 a19, v36 ; Reload Reuse
; GCN-NEXT:    buffer_load_dword v6, off, s[0:3], s32 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v7, off, s[0:3], s32 offset:4 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:8 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v9, off, s[0:3], s32 offset:12 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v10, off, s[0:3], s32 offset:16 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v11, off, s[0:3], s32 offset:20 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v12, off, s[0:3], s32 offset:24 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v13, off, s[0:3], s32 offset:28 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v14, off, s[0:3], s32 offset:32 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v15, off, s[0:3], s32 offset:36 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v16, off, s[0:3], s32 offset:40 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v17, off, s[0:3], s32 offset:44 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v18, off, s[0:3], s32 offset:48 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v19, off, s[0:3], s32 offset:52 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v20, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v21, off, s[0:3], s32 offset:60 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v22, off, s[0:3], s32 offset:64 ; 4-byte Folded Reload
; GCN-NEXT:    buffer_load_dword v23, off, s[0:3], s32 offset:68 ; 4-byte Folded Reload
; GCN-NEXT:    v_accvgpr_read_b32 v24, a31 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v25, a30 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v26, a29 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v27, a28 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v28, a27 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v29, a26 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v30, a25 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v31, a24 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v32, a23 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v33, a22 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v34, a21 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v35, a20 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v36, a19 ; Reload Reuse
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_accvgpr_read_b32 v37, a18 ; Reload Reuse
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; use v[6:37]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    v_accvgpr_read_b32 v63, a17 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v62, a16 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v61, a15 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v60, a14 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v59, a13 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v58, a12 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v57, a11 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v56, a10 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v47, a9 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v46, a8 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v45, a7 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v44, a6 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v43, a5 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v42, a4 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v41, a3 ; Reload Reuse
; GCN-NEXT:    v_accvgpr_read_b32 v40, a2 ; Reload Reuse
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_setpc_b64 s[30:31]
  %gep.0 = getelementptr inbounds [512 x i64], ptr addrspace(3) %lds, i32 0, i32 10
  %gep.1 = getelementptr inbounds [512 x i64], ptr addrspace(3) %lds, i32 0, i32 24
