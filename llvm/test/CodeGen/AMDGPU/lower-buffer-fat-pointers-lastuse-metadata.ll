...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 < %s | FileCheck --check-prefix=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=+cumode < %s | FileCheck --check-prefix=GFX12 %s
...
; GFX12-NEXT:    s_load_b32 s7, s[4:5], 0x10
; GFX12-NEXT:    s_mov_b32 s6, 0
; GFX12-NEXT:    s_mov_b32 s10, 0
; GFX12-NEXT:    s_mov_b32 s9, s6
; GFX12-NEXT:    s_mov_b32 s13, s6
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-NEXT:    s_mov_b32 s11, s2
; GFX12-NEXT:    s_mov_b32 s12, s1
; GFX12-NEXT:    s_mov_b32 s8, s3
; GFX12-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX12-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GFX12-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen th:TH_LOAD_LU
; GFX12-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_or_b64 s[6:7], s[8:9], s[6:7]
; GFX12-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
...
; GFX12-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX12-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GFX12-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    s_load_b128 s[0:3], s[4:5], 0x20
; GFX12-NEXT:    s_load_b32 s7, s[4:5], 0x30
