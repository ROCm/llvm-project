...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -amdgpu-loop-prefetch < %s | FileCheck --check-prefix=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -amdgpu-loop-prefetch -mattr=+safe-smem-prefetch < %s | FileCheck --check-prefix=GFX12-SPREFETCH %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -amdgpu-loop-prefetch -mattr=+safe-smem-prefetch -amdgpu-expert-scheduling-mode < %s | FileCheck --check-prefix=GFX12ES2-SPREFETCH %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 -amdgpu-loop-prefetch < %s | FileCheck --check-prefix=GFX1250 %s
