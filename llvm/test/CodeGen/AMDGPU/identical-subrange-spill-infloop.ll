...
; CHECK-NEXT:    s_load_dwordx16 s[4:19], s[68:69], 0xf0
...
; CHECK-NEXT:    v_writelane_b32 v7, s5, 1
; CHECK-NEXT:    v_writelane_b32 v7, s6, 2
; CHECK-NEXT:    v_writelane_b32 v7, s7, 3
; CHECK-NEXT:    v_writelane_b32 v7, s8, 4
; CHECK-NEXT:    v_writelane_b32 v7, s9, 5
; CHECK-NEXT:    v_writelane_b32 v7, s10, 6
; CHECK-NEXT:    v_writelane_b32 v7, s11, 7
; CHECK-NEXT:    v_writelane_b32 v7, s12, 8
; CHECK-NEXT:    v_writelane_b32 v7, s13, 9
; CHECK-NEXT:    v_writelane_b32 v7, s14, 10
; CHECK-NEXT:    v_writelane_b32 v7, s15, 11
; CHECK-NEXT:    v_writelane_b32 v7, s16, 12
; CHECK-NEXT:    v_writelane_b32 v7, s17, 13
; CHECK-NEXT:    v_writelane_b32 v7, s18, 14
; CHECK-NEXT:    v_writelane_b32 v7, s19, 15
