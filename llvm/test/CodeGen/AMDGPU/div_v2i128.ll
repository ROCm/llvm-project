...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -o - %s | FileCheck -check-prefix=SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -o - %s | FileCheck -check-prefix=GISEL %s
...
; SDAG-NEXT:    s_mov_b64 s[20:21], 0x7f
...
; SDAG-NEXT:    v_cndmask_b32_e64 v0, v10, v3, s[4:5]
...
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v9, v8, vcc
; SDAG-NEXT:    v_xor_b32_e32 v10, 0x7f, v2
; SDAG-NEXT:    v_subb_u32_e32 v8, vcc, 0, v20, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[20:21], v[2:3]
; SDAG-NEXT:    v_cndmask_b32_e64 v22, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, 0, v20, vcc
; SDAG-NEXT:    v_or_b32_e32 v20, v10, v8
; SDAG-NEXT:    v_or_b32_e32 v21, v3, v9
...
; SDAG-NEXT:    v_cndmask_b32_e32 v10, v10, v22, vcc
...
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; SDAG-NEXT:    v_ashrrev_i32_e32 v25, 31, v11
; SDAG-NEXT:    s_or_b64 s[60:61], vcc, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v26, v24
; SDAG-NEXT:    v_mov_b32_e32 v27, v25
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_xor_b64 s[4:5], s[60:61], exec
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    s_mov_b64 s[56:57], 0
; SDAG-NEXT:    s_mov_b64 s[46:47], 0
; SDAG-NEXT:    s_mov_b64 s[14:15], -1
; SDAG-NEXT:    s_mov_b64 s[44:45], 0
; SDAG-NEXT:    s_mov_b64 s[40:41], 0
; SDAG-NEXT:    s_mov_b64 s[26:27], 0
; SDAG-NEXT:    s_mov_b64 s[22:23], 0
; SDAG-NEXT:    s_mov_b64 s[18:19], 0
; SDAG-NEXT:    s_mov_b64 s[16:17], 0
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[60:61]
; SDAG-NEXT:    s_mov_b64 s[8:9], 0
; SDAG-NEXT:    s_mov_b64 s[58:59], 0
; SDAG-NEXT:    s_mov_b64 s[42:43], 0
; SDAG-NEXT:    s_mov_b64 s[8:9], 0
; SDAG-NEXT:    s_mov_b64 s[28:29], 0
; SDAG-NEXT:    s_mov_b64 s[24:25], 0
; SDAG-NEXT:    s_mov_b64 s[12:13], 0
; SDAG-NEXT:    s_mov_b64 s[10:11], 0
; SDAG-NEXT:    s_mov_b64 exec, s[60:61]
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB0_15
; SDAG-NEXT:  .LBB0_1:
...
; SDAG-NEXT:  .LBB0_2: ; %udiv-bb15
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_add_i32_e32 v30, vcc, 1, v2
; SDAG-NEXT:    v_sub_i32_e64 v10, s[4:5], 63, v2
...
; SDAG-NEXT:    s_or_b64 s[56:57], s[56:57], vcc
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_or_b64 s[46:47], s[46:47], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[56:57]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[58:59], s[58:59], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[56:57]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB0_17
; SDAG-NEXT:  .LBB0_3:
; SDAG-NEXT:    s_or_b64 exec, exec, s[58:59]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[46:47]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[42:43], s[42:43], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[46:47]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execz .LBB0_6
; SDAG-NEXT:  .LBB0_4: ; %udiv-preheader4
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[14:15], exec
; SDAG-NEXT:    s_or_b64 s[44:45], s[44:45], s[4:5]
; SDAG-NEXT:  .LBB0_5: ; %udiv-do-while3
...
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; SDAG-NEXT:    s_or_b64 s[42:43], s[42:43], s[6:7]
; SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB0_5
; SDAG-NEXT:  .LBB0_6: ; %udiv-loop-exit2
; SDAG-NEXT:    s_or_b64 exec, exec, s[42:43]
...
; SDAG-NEXT:    v_or_b32_e32 v18, v8, v2
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:  .LBB0_7: ; %udiv-end1
...
; SDAG-NEXT:    v_ffbh_u32_e32 v28, v7
...
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[20:21], v[8:9]
...
; SDAG-NEXT:    s_or_b64 s[4:5], s[6:7], vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[12:13]
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; SDAG-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v28, v20
; SDAG-NEXT:    v_mov_b32_e32 v29, v21
; SDAG-NEXT:    s_or_b64 s[40:41], s[40:41], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[26:27], s[26:27], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[40:41]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[28:29], s[28:29], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[40:41]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB0_16
; SDAG-NEXT:  .LBB0_8:
; SDAG-NEXT:    s_or_b64 exec, exec, s[28:29]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[26:27]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[10:11], s[10:11], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[26:27]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execz .LBB0_14
; SDAG-NEXT:  .LBB0_9: ; %udiv-bb1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_lshl_b64 v[14:15], v[6:7], v34
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, 64, v34
; SDAG-NEXT:    v_lshl_b64 v[16:17], v[4:5], v34
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[9:10]
...
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v34
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v9, v7, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v8, v6, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, 0, v16, s[4:5]
; SDAG-NEXT:    s_or_b64 s[22:23], s[22:23], vcc
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_or_b64 s[18:19], s[18:19], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[22:23]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[24:25], s[24:25], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[22:23]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB0_18
; SDAG-NEXT:  .LBB0_10:
; SDAG-NEXT:    s_or_b64 exec, exec, s[24:25]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[18:19]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[12:13], s[12:13], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[18:19]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execz .LBB0_13
; SDAG-NEXT:  .LBB0_11: ; %udiv-preheader
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_add_i32_e32 v34, vcc, -1, v23
; SDAG-NEXT:    v_mov_b32_e32 v14, 0
; SDAG-NEXT:    v_mov_b32_e32 v15, 0
; SDAG-NEXT:    v_mov_b32_e32 v13, 0
; SDAG-NEXT:    v_lshl_b64 v[48:49], v[6:7], v12
; SDAG-NEXT:    v_lshr_b64 v[6:7], v[6:7], v35
; SDAG-NEXT:    v_addc_u32_e32 v35, vcc, -1, v22, vcc
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[14:15], exec
; SDAG-NEXT:    s_or_b64 s[16:17], s[16:17], s[4:5]
; SDAG-NEXT:  .LBB0_12: ; %udiv-do-while
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_or_b32_e32 v6, v6, v38
; SDAG-NEXT:    v_or_b32_e32 v8, v8, v39
; SDAG-NEXT:    v_or_b32_e32 v9, v15, v9
; SDAG-NEXT:    v_or_b32_e32 v11, v5, v11
; SDAG-NEXT:    v_sub_i32_e32 v5, vcc, v34, v6
; SDAG-NEXT:    v_or_b32_e32 v8, v14, v8
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v35, v7, vcc
...
; SDAG-NEXT:    v_and_b32_e32 v16, v5, v23
; SDAG-NEXT:    v_and_b32_e32 v38, v5, v22
; SDAG-NEXT:    v_and_b32_e32 v39, v5, v2
; SDAG-NEXT:    v_and_b32_e32 v48, v5, v3
; SDAG-NEXT:    v_sub_i32_e32 v6, vcc, v6, v16
; SDAG-NEXT:    v_subb_u32_e32 v7, vcc, v7, v38, vcc
...
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; SDAG-NEXT:    s_or_b64 s[12:13], s[12:13], s[6:7]
; SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB0_12
; SDAG-NEXT:  .LBB0_13: ; %udiv-loop-exit
; SDAG-NEXT:    s_or_b64 exec, exec, s[12:13]
; SDAG-NEXT:    v_lshl_b64 v[2:3], v[8:9], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v6, 31, v11
; SDAG-NEXT:    v_lshl_b64 v[4:5], v[10:11], 1
; SDAG-NEXT:    v_or_b32_e32 v2, v2, v6
; SDAG-NEXT:    v_or_b32_e32 v5, v13, v5
; SDAG-NEXT:    v_or_b32_e32 v4, v12, v4
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:  .LBB0_14: ; %udiv-end
; SDAG-NEXT:    s_or_b64 exec, exec, s[10:11]
; SDAG-NEXT:    v_xor_b32_e32 v6, v27, v26
; SDAG-NEXT:    v_xor_b32_e32 v7, v25, v24
; SDAG-NEXT:    v_xor_b32_e32 v8, v29, v28
; SDAG-NEXT:    v_xor_b32_e32 v9, v21, v20
; SDAG-NEXT:    v_xor_b32_e32 v10, v1, v6
; SDAG-NEXT:    v_xor_b32_e32 v11, v0, v7
; SDAG-NEXT:    v_xor_b32_e32 v1, v19, v6
; SDAG-NEXT:    v_xor_b32_e32 v0, v18, v7
; SDAG-NEXT:    v_xor_b32_e32 v12, v3, v8
; SDAG-NEXT:    v_xor_b32_e32 v13, v2, v9
; SDAG-NEXT:    v_xor_b32_e32 v5, v5, v8
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v0, v7
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v1, v6, vcc
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v11, v7, vcc
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v10, v6, vcc
; SDAG-NEXT:    v_xor_b32_e32 v4, v4, v9
; SDAG-NEXT:    v_sub_i32_e32 v4, vcc, v4, v9
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v5, v8, vcc
; SDAG-NEXT:    v_subb_u32_e32 v6, vcc, v13, v9, vcc
; SDAG-NEXT:    v_subb_u32_e32 v7, vcc, v12, v8, vcc
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_setpc_b64 s[30:31]
; SDAG-NEXT:  .LBB0_15:
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v1, v17, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v0, v16, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v19, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v18, 0, vcc
; SDAG-NEXT:    s_branch .LBB0_1
; SDAG-NEXT:  .LBB0_16:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v7, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v6, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v5, v5, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v4, v4, 0, vcc
; SDAG-NEXT:    s_branch .LBB0_8
; SDAG-NEXT:  .LBB0_17:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v8, 0
; SDAG-NEXT:    v_mov_b32_e32 v9, 0
; SDAG-NEXT:    s_branch .LBB0_3
; SDAG-NEXT:  .LBB0_18:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_mov_b64 s[22:23], 0x7f
...
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, 0, v28, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[22:23], v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v22, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v19, vcc, 0, v28, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e32 v20, v23, v22, vcc
; SDAG-NEXT:    v_and_b32_e32 v20, 1, v20
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v20
; SDAG-NEXT:    s_or_b64 s[6:7], s[6:7], vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v20, 0, -1, s[6:7]
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v20
; SDAG-NEXT:    s_or_b64 s[60:61], vcc, s[4:5]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_xor_b64 s[4:5], s[60:61], exec
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
...
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB2_15
; SDAG-NEXT:  .LBB2_1:
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; SDAG-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SDAG-NEXT:    s_or_b64 s[40:41], s[40:41], s[6:7]
; SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execz .LBB2_7
; SDAG-NEXT:  .LBB2_2: ; %udiv-bb15
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_add_i32_e32 v26, vcc, 1, v16
; SDAG-NEXT:    v_sub_i32_e64 v20, s[4:5], 63, v16
; SDAG-NEXT:    v_addc_u32_e32 v27, vcc, 0, v17, vcc
; SDAG-NEXT:    v_lshl_b64 v[20:21], v[0:1], v20
; SDAG-NEXT:    v_addc_u32_e32 v28, vcc, 0, v18, vcc
; SDAG-NEXT:    v_addc_u32_e32 v29, vcc, 0, v19, vcc
; SDAG-NEXT:    v_or_b32_e32 v17, v26, v28
; SDAG-NEXT:    v_sub_i32_e32 v19, vcc, 0x7f, v16
; SDAG-NEXT:    v_or_b32_e32 v18, v27, v29
; SDAG-NEXT:    v_lshl_b64 v[22:23], v[2:3], v19
; SDAG-NEXT:    v_sub_i32_e32 v16, vcc, 64, v19
; SDAG-NEXT:    v_lshl_b64 v[24:25], v[0:1], v19
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[17:18]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v21, v17, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v18, v3, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v16, v2, s[6:7]
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB2_17
; SDAG-NEXT:  .LBB2_3:
; SDAG-NEXT:    s_or_b64 exec, exec, s[58:59]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[46:47]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:  .LBB2_4: ; %udiv-preheader4
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[12:13], exec
; SDAG-NEXT:    s_or_b64 s[44:45], s[44:45], s[4:5]
; SDAG-NEXT:  .LBB2_5: ; %udiv-do-while3
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB2_5
; SDAG-NEXT:  .LBB2_6: ; %udiv-loop-exit2
; SDAG-NEXT:    s_or_b64 exec, exec, s[42:43]
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:  .LBB2_7: ; %udiv-end1
; SDAG-NEXT:    s_or_b64 exec, exec, s[40:41]
; SDAG-NEXT:    v_or_b32_e32 v9, v13, v15
; SDAG-NEXT:    v_or_b32_e32 v8, v12, v14
; SDAG-NEXT:    v_or_b32_e32 v11, v5, v7
; SDAG-NEXT:    v_or_b32_e32 v10, v4, v6
; SDAG-NEXT:    v_ffbh_u32_e32 v16, v14
; SDAG-NEXT:    v_ffbh_u32_e32 v17, v15
; SDAG-NEXT:    v_ffbh_u32_e32 v18, v12
; SDAG-NEXT:    v_ffbh_u32_e32 v19, v13
...
; SDAG-NEXT:    v_add_i32_e64 v8, s[6:7], 32, v16
; SDAG-NEXT:    v_add_i32_e64 v9, s[6:7], 32, v18
; SDAG-NEXT:    v_add_i32_e64 v10, s[6:7], 32, v20
; SDAG-NEXT:    v_add_i32_e64 v11, s[6:7], 32, v22
; SDAG-NEXT:    s_or_b64 s[6:7], vcc, s[4:5]
; SDAG-NEXT:    v_min_u32_e32 v8, v8, v17
; SDAG-NEXT:    v_min_u32_e32 v9, v9, v19
; SDAG-NEXT:    v_min_u32_e32 v10, v10, v21
; SDAG-NEXT:    v_min_u32_e32 v11, v11, v23
...
; SDAG-NEXT:    v_cndmask_b32_e32 v8, v9, v8, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v17, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v10, v11, v10, vcc
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, v8, v10
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, v16, v9, vcc
; SDAG-NEXT:    v_xor_b32_e32 v16, 0x7f, v8
; SDAG-NEXT:    v_subb_u32_e32 v10, vcc, 0, v24, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[22:23], v[8:9]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v11, vcc, 0, v24, vcc
...
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v18
; SDAG-NEXT:    s_or_b64 s[4:5], s[6:7], vcc
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[16:17]
; SDAG-NEXT:    s_or_b64 s[6:7], s[4:5], vcc
; SDAG-NEXT:    s_or_b64 s[28:29], s[28:29], s[6:7]
; SDAG-NEXT:    s_xor_b64 s[6:7], s[6:7], exec
; SDAG-NEXT:    s_or_b64 s[24:25], s[24:25], s[6:7]
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[28:29]
; SDAG-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SDAG-NEXT:    s_or_b64 s[26:27], s[26:27], s[6:7]
; SDAG-NEXT:    s_mov_b64 exec, s[28:29]
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB2_16
; SDAG-NEXT:  .LBB2_8:
; SDAG-NEXT:    s_or_b64 exec, exec, s[26:27]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[24:25]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[8:9], s[8:9], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[24:25]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execz .LBB2_14
; SDAG-NEXT:  .LBB2_9: ; %udiv-bb1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_add_i32_e32 v22, vcc, 1, v8
; SDAG-NEXT:    v_sub_i32_e64 v16, s[4:5], 63, v8
; SDAG-NEXT:    v_addc_u32_e32 v23, vcc, 0, v9, vcc
; SDAG-NEXT:    v_lshl_b64 v[16:17], v[4:5], v16
; SDAG-NEXT:    v_addc_u32_e32 v24, vcc, 0, v10, vcc
; SDAG-NEXT:    v_addc_u32_e32 v25, vcc, 0, v11, vcc
; SDAG-NEXT:    v_or_b32_e32 v9, v22, v24
; SDAG-NEXT:    v_sub_i32_e32 v26, vcc, 0x7f, v8
; SDAG-NEXT:    v_or_b32_e32 v10, v23, v25
; SDAG-NEXT:    v_lshl_b64 v[18:19], v[6:7], v26
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, 64, v26
...
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v17, v9, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v16, v8, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v11, 0, v21, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v26
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v9, v7, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v8, v6, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, 0, v20, s[4:5]
; SDAG-NEXT:    s_or_b64 s[18:19], s[18:19], vcc
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_or_b64 s[16:17], s[16:17], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[18:19]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[20:21], s[20:21], s[4:5]
; SDAG-NEXT:    s_mov_b64 exec, s[18:19]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB2_18
; SDAG-NEXT:  .LBB2_10:
; SDAG-NEXT:    s_or_b64 exec, exec, s[20:21]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[16:17]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[10:11], s[10:11], s[4:5]
...
; SDAG-NEXT:  .LBB2_11: ; %udiv-preheader
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_mov_b32_e32 v5, 0
; SDAG-NEXT:    s_and_b64 s[4:5], s[12:13], exec
; SDAG-NEXT:    s_or_b64 s[14:15], s[14:15], s[4:5]
; SDAG-NEXT:  .LBB2_12: ; %udiv-do-while
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; SDAG-NEXT:    s_or_b64 s[10:11], s[10:11], s[6:7]
; SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB2_12
; SDAG-NEXT:  .LBB2_13: ; %udiv-loop-exit
; SDAG-NEXT:    s_or_b64 exec, exec, s[10:11]
; SDAG-NEXT:    v_lshl_b64 v[6:7], v[8:9], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v8, 31, v11
; SDAG-NEXT:    v_lshl_b64 v[4:5], v[10:11], 1
; SDAG-NEXT:    v_or_b32_e32 v6, v6, v8
; SDAG-NEXT:    v_or_b32_e32 v5, v17, v5
; SDAG-NEXT:    v_or_b32_e32 v4, v16, v4
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:  .LBB2_14: ; %udiv-end
; SDAG-NEXT:    s_or_b64 exec, exec, s[8:9]
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_setpc_b64 s[30:31]
; SDAG-NEXT:  .LBB2_15:
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v3, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v1, v1, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v0, v0, 0, vcc
; SDAG-NEXT:    s_branch .LBB2_1
; SDAG-NEXT:  .LBB2_16:
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v7, v7, 0, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v6, v6, 0, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v5, v5, 0, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v4, v4, 0, s[4:5]
; SDAG-NEXT:    s_branch .LBB2_8
; SDAG-NEXT:  .LBB2_17:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_mov_b32_e32 v21, 0
; SDAG-NEXT:    s_branch .LBB2_3
; SDAG-NEXT:  .LBB2_18:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
; SDAG-NEXT:    v_mov_b32_e32 v17, 0
...
; SDAG-NEXT:    v_ffbh_u32_e32 v2, v16
; SDAG-NEXT:    v_ffbh_u32_e32 v21, v17
; SDAG-NEXT:    v_cndmask_b32_e64 v1, v3, v1, s[4:5]
; SDAG-NEXT:    v_or_b32_e32 v18, v16, v0
; SDAG-NEXT:    v_sub_i32_e32 v22, vcc, 0, v8
; SDAG-NEXT:    v_ffbh_u32_e32 v23, v0
; SDAG-NEXT:    v_add_i32_e64 v2, s[4:5], 32, v2
; SDAG-NEXT:    v_or_b32_e32 v19, v17, v1
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, 0, v9, vcc
; SDAG-NEXT:    v_add_i32_e64 v23, s[4:5], 32, v23
; SDAG-NEXT:    v_min_u32_e32 v2, v2, v21
; SDAG-NEXT:    v_ffbh_u32_e32 v21, v1
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[18:19]
; SDAG-NEXT:    v_cmp_gt_i32_e64 s[6:7], 0, v11
; SDAG-NEXT:    v_cndmask_b32_e64 v28, v9, v24, s[6:7]
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, 0, v10, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v29, v8, v22, s[6:7]
; SDAG-NEXT:    v_min_u32_e32 v18, v23, v21
; SDAG-NEXT:    v_add_i32_e64 v2, s[8:9], 64, v2
; SDAG-NEXT:    v_addc_u32_e64 v19, s[8:9], 0, 0, s[8:9]
; SDAG-NEXT:    v_subb_u32_e32 v21, vcc, 0, v11, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v10, v9, s[6:7]
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v19, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v2, v2, v18, vcc
; SDAG-NEXT:    v_ffbh_u32_e32 v18, v29
; SDAG-NEXT:    v_ffbh_u32_e32 v22, v28
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v11, v21, s[6:7]
; SDAG-NEXT:    v_or_b32_e32 v10, v29, v8
; SDAG-NEXT:    v_add_i32_e32 v18, vcc, 32, v18
; SDAG-NEXT:    v_ffbh_u32_e32 v21, v8
; SDAG-NEXT:    v_or_b32_e32 v11, v28, v9
; SDAG-NEXT:    v_min_u32_e32 v18, v18, v22
; SDAG-NEXT:    v_add_i32_e32 v21, vcc, 32, v21
; SDAG-NEXT:    v_ffbh_u32_e32 v22, v9
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[10:11]
; SDAG-NEXT:    v_min_u32_e32 v10, v21, v22
; SDAG-NEXT:    v_add_i32_e64 v11, s[6:7], 64, v18
...
; SDAG-NEXT:    s_or_b64 s[6:7], vcc, s[4:5]
; SDAG-NEXT:    v_sub_i32_e32 v10, vcc, v10, v2
; SDAG-NEXT:    v_subb_u32_e32 v11, vcc, v18, v19, vcc
; SDAG-NEXT:    v_xor_b32_e32 v2, 0x7f, v10
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, 0, v20, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[20:21], v[10:11]
; SDAG-NEXT:    v_cndmask_b32_e64 v22, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v19, vcc, 0, v20, vcc
; SDAG-NEXT:    v_or_b32_e32 v20, v2, v18
; SDAG-NEXT:    v_or_b32_e32 v21, v11, v19
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[18:19]
; SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[20:21]
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[18:19]
; SDAG-NEXT:    v_cndmask_b32_e32 v2, v2, v22, vcc
...
; SDAG-NEXT:    s_or_b64 s[60:61], vcc, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v31, v30
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    s_xor_b64 s[4:5], s[60:61], exec
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    s_mov_b64 s[56:57], 0
...
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB4_15
; SDAG-NEXT:  .LBB4_1:
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; SDAG-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; SDAG-NEXT:  .LBB4_2: ; %udiv-bb15
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_add_i32_e32 v32, vcc, 1, v10
; SDAG-NEXT:    v_sub_i32_e64 v2, s[4:5], 63, v10
; SDAG-NEXT:    v_addc_u32_e32 v33, vcc, 0, v11, vcc
; SDAG-NEXT:    v_lshl_b64 v[2:3], v[16:17], v2
...
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v22
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v3, v1, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, v0, s[6:7]
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB4_17
; SDAG-NEXT:  .LBB4_3:
; SDAG-NEXT:    s_or_b64 exec, exec, s[58:59]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[46:47]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:  .LBB4_4: ; %udiv-preheader4
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_add_i32_e32 v36, vcc, -1, v29
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_mov_b32_e32 v21, 0
; SDAG-NEXT:    v_mov_b32_e32 v11, 0
; SDAG-NEXT:    v_lshl_b64 v[26:27], v[0:1], v10
; SDAG-NEXT:    v_lshr_b64 v[48:49], v[0:1], v37
; SDAG-NEXT:    v_addc_u32_e32 v37, vcc, -1, v28, vcc
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[14:15], exec
; SDAG-NEXT:    s_or_b64 s[44:45], s[44:45], s[4:5]
; SDAG-NEXT:  .LBB4_5: ; %udiv-do-while3
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_lshrrev_b32_e32 v49, 31, v3
; SDAG-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; SDAG-NEXT:    v_or_b32_e32 v19, v23, v19
; SDAG-NEXT:    v_or_b32_e32 v18, v22, v18
...
; SDAG-NEXT:    v_and_b32_e32 v24, v10, v29
; SDAG-NEXT:    v_and_b32_e32 v26, v10, v28
; SDAG-NEXT:    v_and_b32_e32 v48, v10, v8
; SDAG-NEXT:    v_and_b32_e32 v49, v10, v9
; SDAG-NEXT:    v_and_b32_e32 v10, 1, v10
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB4_5
; SDAG-NEXT:  .LBB4_6: ; %udiv-loop-exit2
; SDAG-NEXT:    s_or_b64 exec, exec, s[42:43]
; SDAG-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v20, 31, v19
; SDAG-NEXT:    v_lshl_b64 v[18:19], v[18:19], 1
...
; SDAG-NEXT:    v_cndmask_b32_e64 v4, v6, v19, s[4:5]
; SDAG-NEXT:    v_ffbh_u32_e32 v19, v10
...
; SDAG-NEXT:    v_ffbh_u32_e32 v22, v4
; SDAG-NEXT:    v_add_i32_e64 v19, s[4:5], 32, v19
...
; SDAG-NEXT:    v_cmp_gt_i32_e64 s[4:5], 0, v15
; SDAG-NEXT:    v_cndmask_b32_e64 v35, v13, v23, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v36, v12, v21, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[6:7]
; SDAG-NEXT:    v_min_u32_e32 v7, v22, v24
; SDAG-NEXT:    v_add_i32_e64 v12, s[8:9], 64, v19
; SDAG-NEXT:    v_addc_u32_e64 v13, s[8:9], 0, 0, s[8:9]
; SDAG-NEXT:    v_subb_u32_e32 v19, vcc, 0, v15, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v6, v14, v20, s[4:5]
; SDAG-NEXT:    v_ffbh_u32_e32 v14, v36
; SDAG-NEXT:    v_ffbh_u32_e32 v20, v35
...
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v20
; SDAG-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v37, v32
; SDAG-NEXT:    s_or_b64 s[40:41], s[40:41], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], s[4:5], exec
; SDAG-NEXT:    s_or_b64 s[26:27], s[26:27], s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[40:41]
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB4_16
; SDAG-NEXT:  .LBB4_8:
; SDAG-NEXT:    s_or_b64 exec, exec, s[28:29]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[26:27]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[13:14]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v12, v18, v12, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v13, 0, v23, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v15
; SDAG-NEXT:    v_cndmask_b32_e64 v15, v14, v5, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, v12, v4, s[6:7]
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB4_18
; SDAG-NEXT:  .LBB4_10:
; SDAG-NEXT:    s_or_b64 exec, exec, s[24:25]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[18:19]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:  .LBB4_11: ; %udiv-preheader
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    v_addc_u32_e32 v51, vcc, -1, v35, vcc
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[14:15], exec
; SDAG-NEXT:    s_or_b64 s[16:17], s[16:17], s[4:5]
; SDAG-NEXT:  .LBB4_12: ; %udiv-do-while
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_lshl_b64 v[26:27], v[26:27], 1
...
; SDAG-NEXT:    v_and_b32_e32 v40, v23, v35
; SDAG-NEXT:    v_and_b32_e32 v23, v23, v36
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB4_12
; SDAG-NEXT:  .LBB4_13: ; %udiv-loop-exit
; SDAG-NEXT:    s_or_b64 exec, exec, s[12:13]
; SDAG-NEXT:    v_lshl_b64 v[14:15], v[14:15], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v22, 31, v13
; SDAG-NEXT:    v_lshl_b64 v[20:21], v[12:13], 1
; SDAG-NEXT:    v_or_b32_e32 v14, v14, v22
; SDAG-NEXT:    v_or_b32_e32 v12, v19, v21
; SDAG-NEXT:    v_or_b32_e32 v13, v18, v20
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:  .LBB4_14: ; %udiv-end
; SDAG-NEXT:    s_or_b64 exec, exec, s[10:11]
; SDAG-NEXT:    v_mul_lo_u32 v9, v34, v9
; SDAG-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v34, v8, 0
; SDAG-NEXT:    v_mul_lo_u32 v25, v33, v8
; SDAG-NEXT:    v_mul_lo_u32 v26, v3, v29
; SDAG-NEXT:    v_mul_lo_u32 v27, v2, v28
; SDAG-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v29, v34, 0
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_mul_lo_u32 v3, v13, v7
; SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v6, 0
; SDAG-NEXT:    v_mul_lo_u32 v6, v12, v6
; SDAG-NEXT:    v_mul_lo_u32 v38, v15, v36
; SDAG-NEXT:    v_mul_lo_u32 v39, v14, v35
; SDAG-NEXT:    v_add_i32_e32 v9, vcc, v22, v9
; SDAG-NEXT:    v_mad_u64_u32 v[23:24], s[4:5], v28, v34, v[19:20]
; SDAG-NEXT:    v_sub_i32_e32 v18, vcc, v16, v18
; SDAG-NEXT:    v_add_i32_e64 v3, s[4:5], v8, v3
; SDAG-NEXT:    v_add_i32_e64 v22, s[4:5], v9, v25
; SDAG-NEXT:    v_mov_b32_e32 v19, v23
; SDAG-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v29, v33, v[19:20]
; SDAG-NEXT:    v_xor_b32_e32 v23, v18, v30
; SDAG-NEXT:    v_add_i32_e64 v8, s[4:5], v3, v6
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v2, v29, v[21:22]
; SDAG-NEXT:    v_add_i32_e64 v21, s[4:5], v24, v16
; SDAG-NEXT:    v_addc_u32_e64 v22, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v15, vcc, v17, v15, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v36, v[7:8]
; SDAG-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v36, v13, 0
; SDAG-NEXT:    v_add_i32_e64 v3, s[4:5], v26, v3
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v28, v33, v[21:22]
; SDAG-NEXT:    v_xor_b32_e32 v17, v15, v31
; SDAG-NEXT:    v_add_i32_e64 v7, s[4:5], v38, v7
; SDAG-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v35, v13, v[19:20]
; SDAG-NEXT:    v_add_i32_e64 v3, s[4:5], v27, v3
; SDAG-NEXT:    v_add_i32_e64 v7, s[4:5], v39, v7
; SDAG-NEXT:    v_mov_b32_e32 v19, v13
; SDAG-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v36, v12, v[19:20]
; SDAG-NEXT:    v_add_i32_e64 v2, s[4:5], v8, v2
; SDAG-NEXT:    v_addc_u32_e64 v8, s[4:5], v9, v3, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v0, vcc, v0, v2, vcc
; SDAG-NEXT:    v_add_i32_e64 v2, s[4:5], v14, v16
; SDAG-NEXT:    v_addc_u32_e64 v3, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v8, vcc, v1, v8, vcc
; SDAG-NEXT:    v_xor_b32_e32 v9, v0, v30
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v35, v12, v[2:3]
; SDAG-NEXT:    v_xor_b32_e32 v3, v8, v31
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v23, v30
; SDAG-NEXT:    v_add_i32_e64 v6, s[4:5], v1, v6
; SDAG-NEXT:    v_addc_u32_e64 v7, s[4:5], v2, v7, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v17, v31, vcc
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v9, v30, vcc
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v3, v31, vcc
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, v10, v18
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, v11, v15, vcc
; SDAG-NEXT:    v_xor_b32_e32 v8, v8, v32
; SDAG-NEXT:    v_subb_u32_e32 v4, vcc, v4, v6, vcc
; SDAG-NEXT:    v_xor_b32_e32 v6, v9, v37
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v5, v7, vcc
; SDAG-NEXT:    v_xor_b32_e32 v7, v4, v32
; SDAG-NEXT:    v_xor_b32_e32 v9, v5, v37
; SDAG-NEXT:    v_sub_i32_e32 v4, vcc, v8, v32
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v6, v37, vcc
; SDAG-NEXT:    v_subb_u32_e32 v6, vcc, v7, v32, vcc
; SDAG-NEXT:    v_subb_u32_e32 v7, vcc, v9, v37, vcc
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:  .LBB4_15:
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v1, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v0, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v33, v17, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v34, v16, 0, vcc
; SDAG-NEXT:    s_branch .LBB4_1
; SDAG-NEXT:  .LBB4_16:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v15, v5, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v14, v4, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v12, v11, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v13, v10, 0, vcc
; SDAG-NEXT:    s_branch .LBB4_8
; SDAG-NEXT:  .LBB4_17:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v10, 0
; SDAG-NEXT:    v_mov_b32_e32 v11, 0
; SDAG-NEXT:    s_branch .LBB4_3
; SDAG-NEXT:  .LBB4_18:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v18, 0
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
...
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB5_15
; SDAG-NEXT:  .LBB5_1:
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; SDAG-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB5_17
; SDAG-NEXT:  .LBB5_3:
; SDAG-NEXT:    s_or_b64 exec, exec, s[58:59]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[46:47]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:  .LBB5_4: ; %udiv-preheader4
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[12:13], exec
; SDAG-NEXT:    s_or_b64 s[44:45], s[44:45], s[4:5]
; SDAG-NEXT:  .LBB5_5: ; %udiv-do-while3
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB5_5
; SDAG-NEXT:  .LBB5_6: ; %udiv-loop-exit2
; SDAG-NEXT:    s_or_b64 exec, exec, s[42:43]
; SDAG-NEXT:    v_lshl_b64 v[16:17], v[16:17], 1
...
; SDAG-NEXT:    v_cndmask_b32_e32 v20, v21, v20, vcc
; SDAG-NEXT:    v_sub_i32_e32 v18, vcc, v18, v20
; SDAG-NEXT:    v_subb_u32_e32 v19, vcc, v22, v19, vcc
; SDAG-NEXT:    v_xor_b32_e32 v22, 0x7f, v18
; SDAG-NEXT:    v_subb_u32_e32 v20, vcc, 0, v30, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[22:23], v[18:19]
; SDAG-NEXT:    v_cndmask_b32_e64 v24, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v21, vcc, 0, v30, vcc
...
; SDAG-NEXT:    v_and_b32_e32 v24, 1, v24
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v24
; SDAG-NEXT:    s_or_b64 s[4:5], s[6:7], vcc
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[22:23]
; SDAG-NEXT:    s_or_b64 s[6:7], s[4:5], vcc
; SDAG-NEXT:    s_or_b64 s[28:29], s[28:29], s[6:7]
...
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB5_16
; SDAG-NEXT:  .LBB5_8:
; SDAG-NEXT:    s_or_b64 exec, exec, s[26:27]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[24:25]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[19:20]
...
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v28
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v19, v7, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v18, v6, s[6:7]
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB5_18
; SDAG-NEXT:  .LBB5_10:
; SDAG-NEXT:    s_or_b64 exec, exec, s[20:21]
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[16:17]
; SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; SDAG-NEXT:  .LBB5_11: ; %udiv-preheader
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_and_b64 s[4:5], s[12:13], exec
; SDAG-NEXT:    s_or_b64 s[14:15], s[14:15], s[4:5]
; SDAG-NEXT:  .LBB5_12: ; %udiv-do-while
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    ; divergent control-flow edge
; SDAG-NEXT:    s_cbranch_execnz .LBB5_12
; SDAG-NEXT:  .LBB5_13: ; %udiv-loop-exit
; SDAG-NEXT:    s_or_b64 exec, exec, s[10:11]
; SDAG-NEXT:    v_lshl_b64 v[18:19], v[18:19], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v26, 31, v21
; SDAG-NEXT:    v_lshl_b64 v[24:25], v[20:21], 1
; SDAG-NEXT:    v_or_b32_e32 v18, v18, v26
; SDAG-NEXT:    v_or_b32_e32 v20, v23, v25
; SDAG-NEXT:    v_or_b32_e32 v21, v22, v24
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:  .LBB5_14: ; %udiv-end
; SDAG-NEXT:    s_or_b64 exec, exec, s[8:9]
; SDAG-NEXT:    v_mul_lo_u32 v27, v33, v11
; SDAG-NEXT:    v_mad_u64_u32 v[25:26], s[4:5], v33, v10, 0
; SDAG-NEXT:    v_mul_lo_u32 v28, v32, v10
; SDAG-NEXT:    v_mul_lo_u32 v29, v17, v8
; SDAG-NEXT:    v_mul_lo_u32 v30, v16, v9
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v8, v33, 0
; SDAG-NEXT:    v_mov_b32_e32 v24, 0
; SDAG-NEXT:    v_mul_lo_u32 v17, v21, v15
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v21, v14, 0
; SDAG-NEXT:    v_mul_lo_u32 v31, v20, v14
; SDAG-NEXT:    v_mul_lo_u32 v19, v19, v12
; SDAG-NEXT:    v_mul_lo_u32 v34, v18, v13
; SDAG-NEXT:    v_add_i32_e32 v26, vcc, v26, v27
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v9, v33, v[23:24]
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v0, v22
; SDAG-NEXT:    v_add_i32_e64 v11, s[4:5], v11, v17
; SDAG-NEXT:    v_add_i32_e64 v26, s[4:5], v26, v28
; SDAG-NEXT:    v_mov_b32_e32 v23, v14
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v8, v32, v[23:24]
; SDAG-NEXT:    v_add_i32_e64 v11, s[4:5], v11, v31
; SDAG-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v16, v8, v[25:26]
; SDAG-NEXT:    v_add_i32_e64 v14, s[4:5], v15, v23
...
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v12, v21, 0
...
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v13, v21, v[23:24]
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v30, v17
; SDAG-NEXT:    v_add_i32_e64 v18, s[4:5], v34, v11
; SDAG-NEXT:    v_mov_b32_e32 v23, v14
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v12, v20, v[23:24]
...
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v13, v20, v[8:9]
...
; SDAG-NEXT:  .LBB5_15:
; SDAG-NEXT:    s_mov_b64 s[60:61], 0
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v3, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v16, v2, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v32, v1, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v33, v0, 0, vcc
; SDAG-NEXT:    s_branch .LBB5_1
; SDAG-NEXT:  .LBB5_16:
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
...
; SDAG-NEXT:    s_branch .LBB5_8
; SDAG-NEXT:  .LBB5_17:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v18, 0
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
; SDAG-NEXT:    s_branch .LBB5_3
; SDAG-NEXT:  .LBB5_18:
; SDAG-NEXT:    s_mov_b64 s[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v22, 0
; SDAG-NEXT:    v_mov_b32_e32 v23, 0
