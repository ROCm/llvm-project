...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx700 -o - %s | FileCheck -check-prefix=SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx700 -o - %s | FileCheck -check-prefix=GISEL %s
...
; SDAG-NEXT:    s_xor_b64 s[4:5], s[14:15], exec
...
; SDAG-NEXT:    s_xor_b64 exec, s[12:13], exec
; SDAG-NEXT:    ; divergent control-flow edge
