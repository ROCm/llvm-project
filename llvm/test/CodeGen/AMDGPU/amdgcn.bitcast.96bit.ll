...
; SI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v3
; SI-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_xor_b64 s[8:9], exec, s[10:11]
; SI-NEXT:    s_mov_b64 s[4:5], 0
...
; SI-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
...
; VI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v3
; VI-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_xor_b64 s[8:9], exec, s[10:11]
; VI-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v3
...
; GFX11-NEXT:    v_cmp_ne_u32_e64 s1, 0, v3
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_xor_b32 s3, s1, exec_lo
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b32 s2, exec_lo, s3
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e64 s1, 0, v3
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v11, v0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v12, v1
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_xor_b32 s3, s1, exec_lo
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_xor_b32 s2, exec_lo, s3
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
...
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s2
...
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e64 s1, 0, v3
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v13, v0
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v14, v1
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_xor_b32 s3, s1, exec_lo
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_xor_b32 s2, exec_lo, s3
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
...
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s2
...
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v12
; SI-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_mov_b64 s[4:5], 0
; SI-NEXT:    s_mov_b64 s[4:5], 0
...
; SI-NEXT:    s_mov_b32 s11, 0x3000000
; SI-NEXT:    v_or_b32_e32 v2, v3, v2
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v12
; VI-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_mov_b64 s[4:5], 0
; VI-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-NEXT:    s_movk_i32 s10, 0x300
...
; GFX9-NEXT:    v_add_u16_sdwa v1, v1, s10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX9-NEXT:    v_add_u16_sdwa v2, v2, s10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX9-NEXT:    v_add_u16_sdwa v3, v3, s10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e64 s1, 0, v12
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, 0
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e64 s1, 0, v12
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
...
; VI-NEXT:    s_movk_i32 s10, 0x7fff
; VI-NEXT:    v_add_u32_e32 v4, vcc, v4, v2
; VI-NEXT:    v_add_u32_e32 v4, vcc, s10, v4
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX9-NEXT:    v_add3_u32 v4, v4, v3, s10
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v6, v7 :: v_dual_lshlrev_b32 v1, 16, v1
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v3, v3, v6 :: v_dual_add_f32 v4, 0x40c00000, v4
...
; GFX9-NEXT:    s_mov_b64 s[10:11], 0
; GFX9-NEXT:    s_movk_i32 s10, 0x200
; GFX9-NEXT:    v_pk_add_f16 v2, v2, s10 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v1, v1, s10 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v0, v0, s10 op_sel_hi:[1,0]
; GFX9-NEXT:  .LBB14_2:
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GFX9-NEXT:    s_and_b64 s[8:9], s[8:9], exec
...
; SI-NEXT:    v_add_i32_e32 v4, vcc, s10, v4
...
; SI-NEXT:    v_or_b32_e32 v4, v5, v4
; SI-NEXT:    v_or_b32_e32 v0, v1, v0
; SI-NEXT:    v_add_i32_e32 v8, vcc, s11, v8
; SI-NEXT:    v_add_i32_e32 v4, vcc, s11, v4
...
; VI-NEXT:    s_movk_i32 s10, 0x7fff
; VI-NEXT:    v_add_u32_e32 v2, vcc, v2, v1
; VI-NEXT:    v_add_u32_e32 v2, vcc, s10, v2
; VI-NEXT:    v_or_b32_e32 v3, 0x400000, v1
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; VI-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; VI-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
...
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, s10, v1
; VI-NEXT:    v_or_b32_e32 v2, 0x400000, v0
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_cndmask_b32_e32 v0, v1, v2, vcc
...
; GFX9-NEXT:    s_movk_i32 s10, 0x7fff
; GFX9-NEXT:    v_add3_u32 v1, v1, v0, s10
...
; GFX9-NEXT:    v_bfe_u32 v5, v4, 16, 1
; GFX9-NEXT:    v_add3_u32 v5, v5, v4, s10
; GFX9-NEXT:    v_or_b32_e32 v6, 0x400000, v4
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v4, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v5, v6, vcc
...
; GFX9-NEXT:    v_add3_u32 v6, v6, v5, s10
...
; GFX9-NEXT:    v_add3_u32 v7, v7, v6, s10
; GFX9-NEXT:    v_or_b32_e32 v8, 0x400000, v6
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v6, v6
; GFX9-NEXT:    s_mov_b32 s11, 0x7060302
; GFX9-NEXT:    v_cndmask_b32_e32 v7, v7, v8, vcc
; GFX9-NEXT:    v_perm_b32 v1, v2, v3, s11
; GFX9-NEXT:    v_perm_b32 v0, v0, v4, s11
; GFX9-NEXT:    v_perm_b32 v11, v5, v7, s11
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v17, 0x7fc07fc0 :: v_dual_lshlrev_b32 v2, 16, v2
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v6, s10 :: v_dual_mov_b32 v7, s9
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v10, s3 :: v_dual_mov_b32 v5, s11
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, s12 :: v_dual_mov_b32 v11, s4
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v10, s3 :: v_dual_mov_b32 v5, s11
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v2, s12 :: v_dual_mov_b32 v11, s4
...
; GFX9-NEXT:    s_mov_b64 s[10:11], 0
; GFX9-NEXT:    s_movk_i32 s10, 0x200
; GFX9-NEXT:    v_pk_add_f16 v16, v16, s10 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v15, v15, s10 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v13, v13, s10 op_sel_hi:[1,0]
...
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; SI-NEXT:    v_lshlrev_b32_e32 v2, 16, v6
; SI-NEXT:    s_mov_b32 s10, 0x30000
; SI-NEXT:    v_or_b32_e32 v1, v2, v1
; SI-NEXT:    v_add_i32_e32 v4, vcc, s10, v1
...
; VI-NEXT:    v_add_u32_e32 v5, vcc, s10, v5
; VI-NEXT:    v_and_b32_e32 v1, 0xffff0000, v1
...
; VI-NEXT:    v_add_u32_e32 v6, vcc, s10, v6
; VI-NEXT:    v_and_b32_e32 v2, 0xffff0000, v2
...
; GFX9-NEXT:    v_add3_u32 v5, v5, v1, s10
...
; GFX9-NEXT:    v_add3_u32 v6, v6, v2, s10
; GFX9-NEXT:    v_or_b32_e32 v7, 0x400000, v2
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v6, v7, vcc
; GFX9-NEXT:    s_mov_b32 s10, 0x7060302
; GFX9-NEXT:    v_perm_b32 v2, v5, v2, s10
; GFX9-NEXT:    v_perm_b32 v1, v4, v1, s10
; GFX9-NEXT:    v_perm_b32 v0, v3, v0, s10
; GFX9-NEXT:  .LBB48_2:
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GFX9-NEXT:    s_and_b64 s[8:9], s[8:9], exec
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v0, v6, v7 :: v_dual_lshlrev_b32 v1, 16, v1
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v9, v9, v10 :: v_dual_add_f32 v4, 0x40c00000, v4
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
