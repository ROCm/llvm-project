...
; GFX942-NEXT:    s_and_b64 s[0:1], s[2:3], exec
...
; GFX90A-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX8-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s4
; GFX12-NEXT:    s_mov_b32 s4, 0
; GFX12-NEXT:    s_and_b32 s0, s5, exec_lo
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s4
; GFX11-NEXT:    s_mov_b32 s4, 0
; GFX11-NEXT:    s_and_b32 s0, s5, exec_lo
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_mov_b32 s6, s4
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_mov_b32 s6, s4
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, s4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s6, s4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX7-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX6-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GFX908-NEXT:    s_and_b64 s[4:5], s[6:7], exec
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
...
; GFX12-TRUE16-NEXT:    s_mov_b32 s4, -1
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-TRUE16-NEXT:    s_and_b32 s0, s4, exec_lo
; GFX12-TRUE16-NEXT:    s_mov_b32 s4, 0
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s4, -1
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:    s_and_b32 s0, s4, exec_lo
; GFX12-FAKE16-NEXT:    s_mov_b32 s4, 0
...
; GFX11-TRUE16-NEXT:    s_and_b32 s0, s4, exec_lo
; GFX11-TRUE16-NEXT:    s_mov_b32 s4, 0
; GFX11-TRUE16-NEXT:    .p2align 6
...
; GFX11-FAKE16-NEXT:    s_and_b32 s0, s4, exec_lo
; GFX11-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX11-FAKE16-NEXT:    .p2align 6
...
; GFX10-NEXT:    s_and_b32 s4, s8, exec_lo
; GFX10-NEXT:    s_mov_b32 s8, 0
