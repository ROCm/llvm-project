...
; GFX12-TRUE16-NEXT:    s_mov_b32 s7, 0
...
; GFX12-TRUE16-NEXT:    s_xor_b32 s8, vcc_lo, exec_lo
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_xor_b32 s9, exec_lo, s8
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 s7, s7, s9
; GFX12-TRUE16-NEXT:    s_mov_b32 exec_lo, s8
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s7
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s7, 0
...
; GFX12-FAKE16-NEXT:    s_xor_b32 s8, vcc_lo, exec_lo
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_xor_b32 s9, exec_lo, s8
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 s7, s7, s9
; GFX12-FAKE16-NEXT:    s_mov_b32 exec_lo, s8
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s7
...
; GFX11-TRUE16-NEXT:    s_xor_b32 s8, vcc_lo, exec_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_xor_b32 s9, exec_lo, s8
; GFX11-TRUE16-NEXT:    s_or_b32 s7, s7, s9
; GFX11-TRUE16-NEXT:    s_mov_b32 exec_lo, s8
...
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s7
...
; GFX11-FAKE16-NEXT:    s_xor_b32 s8, vcc_lo, exec_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_xor_b32 s9, exec_lo, s8
; GFX11-FAKE16-NEXT:    s_or_b32 s7, s7, s9
; GFX11-FAKE16-NEXT:    s_mov_b32 exec_lo, s8
...
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s7
...
; GFX7-NEXT:    s_or_b64 s[4:5], s[4:5], s[12:13]
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_lshlrev_b32 v4, 16, v0
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_xor_b32 s9, exec_lo, s8
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_lshlrev_b32 v4, 16, v0
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b32 s9, exec_lo, s8
...
; GFX7-NEXT:    buffer_atomic_cmpswap v[1:2], v6, s[16:19], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX6-NEXT:    v_max_f32_e32 v2, v2, v3
...
; GFX6-NEXT:    buffer_atomic_cmpswap v[1:2], v6, s[16:19], 0 offen glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    v_add3_u32 v7, v7, v6, s16
