...
; GFX7-NEXT:    v_or_b32_e32 v6, v5, v2
; GFX7-NEXT:    v_lshlrev_b32_e32 v2, 16, v7
; GFX7-NEXT:    v_or_b32_e32 v5, v1, v2
; GFX7-NEXT:    v_mov_b32_e32 v1, v5
...
; GFX6-NEXT:    v_or_b32_e32 v6, v5, v2
; GFX6-NEXT:    v_lshlrev_b32_e32 v2, 16, v7
; GFX6-NEXT:    v_or_b32_e32 v5, v1, v2
; GFX6-NEXT:    v_mov_b32_e32 v1, v5
...
; GFX942-NEXT:    buffer_load_ushort v6, v2, s[0:3], 0 offen offset:1026
...
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshl_or_b32 v0, v6, 16, v0
...
; GFX90A-NEXT:    buffer_load_ushort v6, v2, s[16:19], 0 offen offset:1026
...
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A-NEXT:    s_waitcnt vmcnt(1)
; GFX90A-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_lshl_or_b32 v0, v6, 16, v0
...
; GFX908-NEXT:    buffer_load_ushort v6, v2, s[16:19], 0 offen offset:1026
...
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
; GFX908-NEXT:    s_waitcnt vmcnt(1)
; GFX908-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_lshl_or_b32 v0, v6, 16, v0
...
; GFX942-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshl_or_b32 v1, v6, 16, v0
...
; GFX90A-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_lshl_or_b32 v1, v6, 16, v0
...
; GFX908-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_lshl_or_b32 v1, v6, 16, v0
