...
; GFX942-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
...
; GFX942-NEXT:    s_and_b64 s[0:1], s[8:9], exec
...
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:    s_and_saveexec_b64 s[0:1], s[8:9]
...
; GFX90A-NEXT:    s_and_b64 s[4:5], s[12:13], exec
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_and_saveexec_b64 s[4:5], s[12:13]
...
; GFX908-NEXT:    s_and_b64 s[4:5], s[12:13], exec
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_and_saveexec_b64 s[4:5], s[12:13]
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_and_saveexec_b64 s[4:5], s[12:13]
...
; GFX11-NEXT:    s_and_saveexec_b32 s5, s5
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_saveexec_b32 s5, s5
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_and_b32 s0, s6, exec_lo
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_saveexec_b32 s0, s5
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-NEXT:    s_and_saveexec_b32 s0, s5
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s7, s7
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 s6, s6, s7
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s7, s7
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 s6, s6, s7
...
; GFX942-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s7, s7
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s7, s7
...
; GFX10-NEXT:    s_and_saveexec_b32 s7, s7
...
; GFX8-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GFX7-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GFX6-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GFX12-TRUE16-NEXT:    s_mov_b32 s5, -1
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-TRUE16-NEXT:    s_and_b32 s0, s5, exec_lo
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s5
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_mov_b32 s7, s5
...
; GFX12-FAKE16-NEXT:    s_and_b32 s0, s6, exec_lo
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s0, s5
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX942-NEXT:    v_and_b32_e32 v8, -4, v4
; GFX942-NEXT:    v_and_b32_e32 v4, 3, v4
; GFX942-NEXT:    v_lshlrev_b32_e32 v9, 3, v4
; GFX942-NEXT:    s_mov_b32 s0, 0xffff
; GFX942-NEXT:    v_lshlrev_b32_e64 v4, v9, s0
...
; GFX942-NEXT:    s_and_b64 s[0:1], vcc, s[0:1]
; GFX942-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX942-NEXT:    buffer_load_dword v7, v8, s[4:7], 0 offen
; GFX942-NEXT:    s_xor_b64 exec, exec, s[0:1]
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshrrev_b32_e32 v4, v9, v7
; GFX942-NEXT:    v_max_f16_e32 v4, v4, v4
; GFX942-NEXT:    v_max_f16_e32 v4, v4, v11
; GFX942-NEXT:    v_lshlrev_b32_e32 v4, v9, v4
...
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v9, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s5, -1
...
; GFX11-TRUE16-NEXT:    s_and_b32 s0, s5, exec_lo
; GFX11-TRUE16-NEXT:    .p2align 6
...
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s5
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s7, s5
...
; GFX11-FAKE16-NEXT:    s_and_b32 s0, s6, exec_lo
; GFX11-FAKE16-NEXT:    .p2align 6
...
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, s5
...
; GFX10-NEXT:    s_and_b32 s4, s10, exec_lo
...
; GFX10-NEXT:    s_and_saveexec_b32 s4, s9
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_lshrrev_b32_e32 v4, v9, v7
; GFX90A-NEXT:    v_max_f16_e32 v4, v4, v4
; GFX90A-NEXT:    v_max_f16_e32 v4, v4, v11
; GFX90A-NEXT:    v_lshlrev_b32_e32 v4, v9, v4
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_e32 v4, v8, v6
; GFX908-NEXT:    v_max_f16_e32 v4, v4, v4
; GFX908-NEXT:    v_max_f16_e32 v4, v4, v10
; GFX908-NEXT:    v_lshlrev_b32_e32 v4, v8, v4
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_e32 v4, v8, v6
; GFX8-NEXT:    v_max_f16_e32 v4, v4, v4
; GFX8-NEXT:    v_max_f16_e32 v4, v4, v10
; GFX8-NEXT:    v_lshlrev_b32_e32 v4, v8, v4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_and_saveexec_b64 s[4:5], s[12:13]
...
; GFX6-NEXT:    s_and_b64 s[4:5], s[12:13], exec
...
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_and_saveexec_b64 s[4:5], s[12:13]
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    v_and_or_b32 v0, v1, s5, v0
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-FAKE16-NEXT:    s_and_b32 s4, s16, -4
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_lshlrev_b32 v5, 16, v0
; GFX12-FAKE16-NEXT:    s_and_b32 s4, s16, 3
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_lshl_b32 s4, s4, 3
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX942-NEXT:    s_and_saveexec_b64 s[10:11], s[10:11]
...
; GFX11-TRUE16-NEXT:    v_and_or_b32 v0, v1, s5, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_lshlrev_b32 v5, 16, v0
; GFX11-FAKE16-NEXT:    s_and_b32 s4, s16, 3
; GFX11-FAKE16-NEXT:    s_lshl_b32 s4, s4, 3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_lshl_b32 s5, 0xffff, s4
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[10:11], s[10:11]
...
; GFX908-NEXT:    s_and_saveexec_b64 s[10:11], s[10:11]
...
; GFX12-FAKE16-NEXT:    s_and_b32 s4, s16, -4
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_lshlrev_b32 v3, 16, v0
; GFX12-FAKE16-NEXT:    s_and_b32 s4, s16, 3
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_lshl_b32 s4, s4, 3
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-FAKE16-NEXT:    s_and_b32 s4, s16, -4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_lshlrev_b32 v3, 16, v0
; GFX11-FAKE16-NEXT:    s_and_b32 s4, s16, 3
; GFX11-FAKE16-NEXT:    s_lshl_b32 s4, s4, 3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_lshl_b32 s5, 0xffff, s4
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_mov_b32 s7, s5
; GFX12-TRUE16-NEXT:    s_mov_b32 s4, 0
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v6, 3, v4
...
; GFX12-TRUE16-NEXT:    s_and_b32 s0, s6, exec_lo
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshrrev_b32_sdwa v4, v9, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX942-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX942-NEXT:    v_lshlrev_b32_sdwa v4, v9, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_and_or_b32 v6, v7, v10, v4
; GFX942-NEXT:    v_mov_b64_e32 v[4:5], v[6:7]
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s7, s5
; GFX11-TRUE16-NEXT:    s_mov_b32 s4, 0
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v6, 3, v4
...
; GFX11-TRUE16-NEXT:    s_and_b32 s0, s6, exec_lo
...
; GFX7-NEXT:    v_and_b32_e32 v4, 3, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v9, 3, v4
; GFX7-NEXT:    v_lshl_b32_e32 v4, 0xffff, v9
...
; GFX7-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX7-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX7-NEXT:    buffer_load_dword v5, v8, s[8:11], 0 offen
; GFX7-NEXT:    s_xor_b64 exec, exec, s[4:5]
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_lshrrev_b32_e32 v4, v9, v5
; GFX7-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX7-NEXT:    v_mul_f32_e32 v4, 1.0, v4
; GFX7-NEXT:    v_max_f32_e32 v4, v4, v11
; GFX7-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v4, v9, v4
...
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, v9, v6
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-NEXT:    v_and_b32_e32 v4, 3, v4
; GFX6-NEXT:    v_lshlrev_b32_e32 v9, 3, v4
; GFX6-NEXT:    v_lshl_b32_e32 v4, 0xffff, v9
...
; GFX6-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX6-NEXT:    buffer_load_dword v5, v8, s[8:11], 0 offen
; GFX6-NEXT:    s_xor_b64 exec, exec, s[4:5]
...
; GFX6-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX6-NEXT:    v_lshrrev_b32_e32 v0, v9, v6
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr bfloat, ptr addrspace(7) %ptr, i32 256
  %result = atomicrmw fmax ptr addrspace(7) %gep, bfloat %val syncscope("agent") seq_cst, !amdgpu.no.fine.grained.memory !0
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s5, s5
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 s4, s4, s5
; GFX12-TRUE16-NEXT:    ; divergent control-flow edge
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s5, s5
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 s4, s4, s5
; GFX12-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX12-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-FAKE16-NEXT:    s_mov_b32 s6, exec_lo
; GFX12-FAKE16-NEXT:    s_mov_b32 s5, -1
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_mov_b32 s7, s6
; GFX12-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX12-FAKE16-NEXT:    s_mov_b32 s0, 0
...
; GFX12-FAKE16-NEXT:    s_and_b32 s0, s5, exec_lo
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_mov_b32 s6, exec_lo
; GFX11-FAKE16-NEXT:    s_mov_b32 s5, -1
; GFX11-FAKE16-NEXT:    s_mov_b32 s7, s6
; GFX11-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, 0
...
; GFX11-FAKE16-NEXT:    s_and_b32 s0, s5, exec_lo
; GFX11-FAKE16-NEXT:    .p2align 6
...
; GFX10-NEXT:    s_and_b32 s4, s9, exec_lo
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s4, s4
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 s5, s5, s4
; GFX12-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX942-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GFX942-NEXT:    ; divergent control-flow edge
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s4, s4
; GFX11-FAKE16-NEXT:    s_or_b32 s5, s5, s4
; GFX11-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX7-NEXT:    v_max_f32_e32 v3, v3, v1
; GFX7-NEXT:    v_alignbit_b32 v4, v4, v6, 16
; GFX7-NEXT:    v_alignbit_b32 v3, v5, v3, 16
; GFX7-NEXT:    v_mov_b32_e32 v6, v4
...
; GFX6-NEXT:    v_max_f32_e32 v3, v3, v1
; GFX6-NEXT:    v_alignbit_b32 v4, v4, v6, 16
; GFX6-NEXT:    v_alignbit_b32 v3, v5, v3, 16
; GFX6-NEXT:    v_mov_b32_e32 v6, v4
...
; GFX12-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v6, v8, vcc_lo
...
; GFX942-NEXT:    v_lshlrev_b32_e32 v2, 16, v0
; GFX942-NEXT:    v_and_b32_e32 v3, 0xffff0000, v0
; GFX942-NEXT:    s_movk_i32 s6, 0x7fff
; GFX942-NEXT:    s_mov_b32 s7, 0x7060302
; GFX942-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_and_b32_e32 v0, 0xffff, v4
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v2
; GFX942-NEXT:    v_bfe_u32 v5, v0, 16, 1
; GFX942-NEXT:    v_add3_u32 v5, v5, v0, s6
; GFX942-NEXT:    v_or_b32_e32 v6, 0x400000, v0
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-NEXT:  .LBB20_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v6, v8, vcc_lo
...
; GFX11-FAKE16-NEXT:  .LBB20_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    v_cndmask_b32_e32 v0, v6, v8, vcc_lo
...
; GFX90A-NEXT:    v_max_f32_e32 v0, v0, v2
; GFX90A-NEXT:    v_bfe_u32 v5, v0, 16, 1
; GFX90A-NEXT:    v_add3_u32 v5, v5, v0, s6
; GFX90A-NEXT:    v_or_b32_e32 v6, 0x400000, v0
; GFX90A-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
...
; GFX90A-NEXT:    v_perm_b32 v0, v5, v0, s7
...
; GFX908-NEXT:    v_max_f32_e32 v0, v0, v2
; GFX908-NEXT:    v_bfe_u32 v5, v0, 16, 1
; GFX908-NEXT:    v_add3_u32 v5, v5, v0, s6
; GFX908-NEXT:    v_or_b32_e32 v6, 0x400000, v0
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX908-NEXT:    v_cndmask_b32_e32 v0, v5, v6, vcc
...
; GFX908-NEXT:    v_perm_b32 v0, v5, v0, s7
