; RUN: llc -amdgpu-late-wave-transform=1 -O0 -amdgpu-spill-sgpr-to-vgpr=1 -mtriple=amdgpu6.00 < %s | FileCheck -enable-var-scope -check-prefix=TOVGPR -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -amdgpu-spill-sgpr-to-vgpr=1 -mtriple=amdgpu8.02  < %s | FileCheck -enable-var-scope -check-prefix=TOVGPR -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -amdgpu-spill-sgpr-to-vgpr=0 -mtriple=amdgpu6.00 < %s | FileCheck -enable-var-scope -check-prefix=TOVMEM -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -amdgpu-spill-sgpr-to-vgpr=0 -mtriple=amdgpu8.02 < %s | FileCheck -enable-var-scope -check-prefix=TOVMEM -check-prefix=GCN %s
