...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -mattr=+architected-sgprs -global-isel=0 < %s | FileCheck -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -mattr=+architected-sgprs -global-isel=1 < %s | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -global-isel=0 < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -global-isel=1 < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa -global-isel=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa -global-isel=1 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
...
; GFX1250-NEXT:    s_and_b32 s3, ttmp6, 15
; GFX1250-NEXT:    s_add_co_i32 s2, s2, 1
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250-NEXT:    s_mul_i32 s2, ttmp9, s2
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_getreg_b32 s4, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-NEXT:    s_add_co_i32 s3, s3, s2
; GFX1250-NEXT:    s_cmp_eq_u32 s4, 0
; GFX1250-NEXT:    s_cselect_b32 s2, ttmp9, s3
...
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s4
; GFX1250-GISEL-NEXT:    s_add_co_i32 s8, s8, s5
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s6, 0
; GFX1250-GISEL-NEXT:    s_cselect_b32 s5, s7, s8
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v2, s5
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1250-GISEL-NEXT:    global_store_b32 v0, v2, s[2:3]
...
; GFX1250-SDAG-NEXT:    s_mul_i32 s4, s5, s4
...
; GFX1250-SDAG-NEXT:    s_add_co_i32 s8, s8, s4
...
; GFX1250-SDAG-NEXT:    s_cselect_b32 s5, s5, s8
...
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s8, 0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s9
; GFX1250-GISEL-NEXT:    s_wait_xcnt 0x0
...
; GFX1250-GISEL-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1250-GISEL-NEXT:    global_store_b32 v0, v2, s[2:3]
; GFX1250-GISEL-NEXT:    global_store_b32 v0, v3, s[6:7]
; GFX1250-GISEL-NEXT:    s_endpgm
