...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa -mattr=+architected-sgprs -global-isel=1 < %s | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -global-isel=0 < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa -global-isel=1 < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa -global-isel=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa -global-isel=1 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
