...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -mattr=+architected-sgprs -global-isel=0 < %s | FileCheck -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -mattr=+architected-sgprs -global-isel=1 -new-reg-bank-select < %s | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -global-isel=1 -new-reg-bank-select < %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
...
; GFX9-SDAG-LABEL: workgroup_id_xy:
; GFX9-SDAG:       ; %bb.0:
...
;
; GFX9-GISEL-LABEL: workgroup_id_xy:
; GFX9-GISEL:       ; %bb.0:
...
; GFX9-GISEL-NEXT:    global_store_dword v1, v2, s[2:3]
...
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    s_bfe_u32 s5, ttmp6, 0x40010
; GFX1250-SDAG-NEXT:    s_bfe_u32 s8, ttmp6, 0x4000c
; GFX1250-SDAG-NEXT:    s_and_b32 s4, ttmp7, 0xffff
; GFX1250-SDAG-NEXT:    s_add_co_i32 s5, s5, 1
; GFX1250-SDAG-NEXT:    s_add_co_i32 s8, s8, 1
; GFX1250-SDAG-NEXT:    s_bfe_u32 s6, ttmp6, 0x40004
; GFX1250-SDAG-NEXT:    s_and_b32 s7, ttmp6, 15
; GFX1250-SDAG-NEXT:    s_mul_i32 s5, s4, s5
; GFX1250-SDAG-NEXT:    s_mul_i32 s8, ttmp9, s8
; GFX1250-SDAG-NEXT:    s_getreg_b32 s9, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-SDAG-NEXT:    s_add_co_i32 s6, s6, s5
; GFX1250-SDAG-NEXT:    s_add_co_i32 s7, s7, s8
; GFX1250-SDAG-NEXT:    s_cmp_eq_u32 s9, 0
; GFX1250-SDAG-NEXT:    s_cselect_b32 s5, ttmp9, s7
...
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
; GFX1250-SDAG-NEXT:    s_bfe_u32 s7, ttmp6, 0x40014
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10 nv
; GFX1250-SDAG-NEXT:    s_bfe_u32 s10, ttmp6, 0x40010
; GFX1250-SDAG-NEXT:    s_bfe_u32 s13, ttmp6, 0x4000c
; GFX1250-SDAG-NEXT:    s_lshr_b32 s6, ttmp7, 16
; GFX1250-SDAG-NEXT:    s_and_b32 s9, ttmp7, 0xffff
; GFX1250-SDAG-NEXT:    s_add_co_i32 s7, s7, 1
; GFX1250-SDAG-NEXT:    s_add_co_i32 s10, s10, 1
; GFX1250-SDAG-NEXT:    s_add_co_i32 s13, s13, 1
; GFX1250-SDAG-NEXT:    s_bfe_u32 s8, ttmp6, 0x40008
; GFX1250-SDAG-NEXT:    s_bfe_u32 s11, ttmp6, 0x40004
; GFX1250-SDAG-NEXT:    s_and_b32 s12, ttmp6, 15
; GFX1250-SDAG-NEXT:    s_mul_i32 s7, s6, s7
; GFX1250-SDAG-NEXT:    s_mul_i32 s10, s9, s10
; GFX1250-SDAG-NEXT:    s_mul_i32 s13, ttmp9, s13
; GFX1250-SDAG-NEXT:    s_getreg_b32 s14, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-SDAG-NEXT:    s_add_co_i32 s8, s8, s7
; GFX1250-SDAG-NEXT:    s_add_co_i32 s11, s11, s10
; GFX1250-SDAG-NEXT:    s_add_co_i32 s12, s12, s13
; GFX1250-SDAG-NEXT:    s_cmp_eq_u32 s14, 0
; GFX1250-SDAG-NEXT:    s_cselect_b32 s7, ttmp9, s12
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s7
; GFX1250-SDAG-NEXT:    s_cselect_b32 s7, s9, s11
