...
; GCN-NEXT:    v_add_u32_e32 v0, vcc, v2, v0
...
; GCN-NEXT:    buffer_store_dword v1, v0, s[0:3], 0 offen
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    s_addk_i32 s32, 0xd800
...
; GCN-NEXT:    buffer_store_dword v1, v0, s[0:3], 0 offen
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    s_addk_i32 s32, 0xf300
; GCN-NEXT:    s_mov_b32 s33, s4
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    s_lshr_b32 flat_scratch_hi, s4, 8
; GCN-NEXT:    s_add_u32 s0, s0, s7
; GCN-NEXT:    s_addc_u32 s1, s1, 0
; GCN-NEXT:    s_mov_b32 flat_scratch_lo, s5
; GCN-NEXT:    s_getpc_b64 s[4:5]
; GCN-NEXT:    s_add_u32 s4, s4, needs_align16_default_stack_align@gotpcrel32@lo+4
; GCN-NEXT:    s_addc_u32 s5, s5, needs_align16_default_stack_align@gotpcrel32@hi+12
...
; GCN-NEXT:    s_mov_b32 flat_scratch_lo, s5
; GCN-NEXT:    s_getpc_b64 s[4:5]
; GCN-NEXT:    s_add_u32 s4, s4, needs_align16_stack_align4@gotpcrel32@lo+4
; GCN-NEXT:    s_addc_u32 s5, s5, needs_align16_stack_align4@gotpcrel32@hi+12
; GCN-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; GCN-NEXT:    v_mov_b32_e32 v0, 2
; GCN-NEXT:    buffer_store_byte v0, off, s[0:3], 0
; GCN-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    s_addk_i32 s32, 0xc000
; GCN-NEXT:    s_mov_b32 s33, s4
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    s_addk_i32 s32, 0xa000
; GCN-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NEXT:    s_mov_b64 exec, s[6:7]
; GCN-NEXT:    s_add_i32 s32, s32, 0xfffba000
; GCN-NEXT:    s_mov_b32 s33, s4
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    s_setpc_b64 s[30:31]
  %local_val = alloca i32, align 128, addrspace(5)
