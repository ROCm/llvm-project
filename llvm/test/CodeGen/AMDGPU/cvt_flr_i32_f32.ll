...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu6.00 -global-isel < %s | FileCheck -check-prefix=SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck -check-prefix=GFX11-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -global-isel < %s | FileCheck -check-prefix=GFX11-GISEL %s
