...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.06-amd-amdhsa -o - %s | FileCheck -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.06-amd-amdhsa -O0 -o - %s | FileCheck -check-prefix=GCN-O0 %s
