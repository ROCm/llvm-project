...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx906  < %s | FileCheck -check-prefix=GFX906-SDAG  %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx942  < %s | FileCheck -check-prefix=GFX942-SDAG  %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1012 < %s | FileCheck -check-prefix=GFX1012-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck -check-prefix=GFX1100-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -check-prefix=GFX1250-SDAG %s

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx906  < %s | FileCheck -check-prefix=GFX906-ISEL  %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx942  < %s | FileCheck -check-prefix=GFX942-ISEL  %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1012 < %s | FileCheck -check-prefix=GFX1012-ISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck -check-prefix=GFX1100-ISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -check-prefix=GFX1250-ISEL %s
...
; GFX1100-SDAG-NEXT:    ds_load_b64 v[0:1], v0
; GFX1100-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-SDAG-NEXT:    v_mov_b32_e32 v4, s6
; GFX1100-SDAG-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX1100-SDAG-NEXT:    v_readfirstlane_b32 s4, v0
; GFX1100-SDAG-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1100-SDAG-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1100-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[4:5]
...
; GFX1250-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[4:5]
...
; GFX1100-SDAG-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1100-SDAG-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1100-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[4:5] offset:-120
; GFX1100-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    v_readfirstlane_b32 s5, v1
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1250-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[4:5] offset:-120
; GFX1250-SDAG-NEXT:    s_endpgm
;
