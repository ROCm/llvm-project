...
; RUN: llc -amdgpu-late-wave-transform=1 -verify-machineinstrs -mtriple=amdgpu9.42-amd-amdhsa -amdgpu-mfma-vgpr-form < %s | FileCheck %s
...
; CHECK-NEXT:    v_mov_b32_e32 v64, 1.0
...
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[0:31], v64, v65, v[0:31]
; CHECK-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[32:63], v64, v65, v[0:31]
; CHECK-NEXT:    s_nop 15
; CHECK-NEXT:    s_nop 1
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[20:21], v[20:21], v[4:7]
; CHECK-NEXT:    v_mov_b64_e32 v[22:23], s[0:1]
; CHECK-NEXT:    s_mov_b32 s0, 0x7e007e00
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[20:21], v[22:23], v[4:7]
; CHECK-NEXT:    v_mov_b64_e32 v[24:25], s[0:1]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[20:21], v[20:21], v[0:3]
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[20:21], v[24:25], v[4:7]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[20:21], v[20:21], v[8:11]
; CHECK-NEXT:    s_nop 3
; CHECK-NEXT:    v_cvt_f16_f32_e32 v0, v0
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[20:21], v[20:21], v[2:5]
; CHECK-NEXT:    s_nop 0
...
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    v_cvt_f16_f32_e32 v18, v4
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[10:13], v[20:21], v[20:21], v[10:13]
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[20:21], v[20:21], v[14:17]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[14:17], v[20:21], v[22:23], v[14:17]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[20:21], v[20:21], v[10:13]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[20:21], v[20:21], v[4:7]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v1, v8
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[20:21], v[20:21], v[14:17]
; CHECK-NEXT:    global_store_short v[2:3], v1, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[22:23], v[20:21], v[8:11]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[2:3], v18, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[24:25], v[20:21], v[4:7]
; CHECK-NEXT:    global_store_short v[2:3], v0, off
; CHECK-NEXT:    v_cvt_f16_f32_e32 v0, v8
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[2:3], v0, off
...
; CHECK:       ; %bb.0:
; CHECK-NEXT:    v_mov_b32_e32 v66, 2.0
...
; CHECK-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; CHECK-NEXT:    v_mfma_f32_32x32x1_2b_f32 a[32:63], v66, v1, a[0:31]
; CHECK-NEXT:    v_mov_b32_e32 v66, 0x41000000
; CHECK-NEXT:    v_mov_b32_e32 v1, 0x41800000
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 7, v0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_nop 13
; CHECK-NEXT:    global_store_dwordx4 v0, a[60:63], s[0:1] offset:112
; CHECK-NEXT:    global_store_dwordx4 v0, a[56:59], s[0:1] offset:96
; CHECK-NEXT:    global_store_dwordx4 v0, a[52:55], s[0:1] offset:80
; CHECK-NEXT:    global_store_dwordx4 v0, a[48:51], s[0:1] offset:64
; CHECK-NEXT:    global_store_dwordx4 v0, a[44:47], s[0:1] offset:48
; CHECK-NEXT:    global_store_dwordx4 v0, a[40:43], s[0:1] offset:32
; CHECK-NEXT:    global_store_dwordx4 v0, a[36:39], s[0:1] offset:16
; CHECK-NEXT:    global_store_dwordx4 v0, a[32:35], s[0:1]
; CHECK-NEXT:    v_mfma_f32_32x32x1_2b_f32 a[0:31], v66, v1, a[0:31]
; CHECK-NEXT:    s_nop 15
; CHECK-NEXT:    s_nop 1
...
attributes #0 = { nounwind "amdgpu-flat-work-group-size"="1,256" "amdgpu-waves-per-eu"="3,3" }
