...
; VI-NEXT:    s_load_dword s2, s[8:9], 0x2c
; VI-NEXT:    s_load_dword s3, s[8:9], 0x8
; VI-NEXT:    s_add_i32 s12, s12, s17
; VI-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_mov_b32 flat_scratch_lo, s13
; VI-NEXT:    v_mac_f32_e64 v2, s3, 2.0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    flat_store_dword v[0:1], v2
...
; GFX10-NEXT:    global_store_dword v0, v1, s[0:1] offset:4
...
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; VI-DENORM-NEXT:    s_lshr_b32 s3, s2, 16
; VI-DENORM-NEXT:    s_add_u32 s0, s0, 2
; VI-DENORM-NEXT:    v_mov_b32_e32 v0, s3
; VI-DENORM-NEXT:    s_addc_u32 s1, s1, 0
...
; VI-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
; VI-FLUSH-NEXT:    s_lshr_b32 s3, s2, 16
; VI-FLUSH-NEXT:    s_add_u32 s0, s0, 2
; VI-FLUSH-NEXT:    v_mov_b32_e32 v2, s3
; VI-FLUSH-NEXT:    s_addc_u32 s1, s1, 0
; VI-FLUSH-NEXT:    v_mov_b32_e32 v0, s0
; VI-FLUSH-NEXT:    v_mac_f16_e64 v2, s2, 2.0
; VI-FLUSH-NEXT:    v_mov_b32_e32 v1, s1
; VI-FLUSH-NEXT:    flat_store_short v[0:1], v2
...
; GFX10-DENORM-NEXT:    v_fma_f16 v1, s2, 2.0, s3
; GFX10-DENORM-NEXT:    global_store_short v0, v1, s[0:1] offset:2
...
; GFX10-FLUSH-NEXT:    v_add_f16_e32 v0, s2, v0
...
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-DENORM-TRUE16-NEXT:    v_fma_f16 v0.l, s2, 2.0, s3
; GFX11-DENORM-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1] offset:2 dlc
...
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-DENORM-FAKE16-NEXT:    v_fma_f16 v1, s2, 2.0, s3
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v0, v1, s[0:1] offset:2 dlc
...
; GFX11-FLUSH-TRUE16-NEXT:    v_add_f16_e32 v0.l, s2, v0.l
...
; GFX11-FLUSH-FAKE16-NEXT:    v_add_f16_e32 v0, s2, v0
