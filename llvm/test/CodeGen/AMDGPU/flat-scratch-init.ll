...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa --mattr=+enable-flat-scratch < %s | FileCheck -check-prefixes=GCN,FLAT_SCR_OPT %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa --mattr=+architected-flat-scratch < %s | FileCheck -check-prefixes=GCN,FLAT_SCR_ARCH %s
