...
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, v0, v2
; GCN-NEXT:    v_subbrev_u32_e64 v6, s[4:5], 0, v4, vcc
; GCN-NEXT:    v_subb_u32_e32 v4, vcc, v4, v3, vcc
...
; GCN-NEXT:    v_sub_i32_e32 v8, vcc, v5, v2
...
; GCN-IR-NEXT:    v_sub_i32_e64 v8, s[6:7], v10, v12
...
; GCN-NEXT:    v_mul_hi_u32 v4, s7, v0
...
; GCN-NEXT:    s_mul_i32 s10, s7, 0xaaaaaaaa
; GCN-NEXT:    v_add_i32_e32 v0, vcc, v2, v0
; GCN-NEXT:    v_addc_u32_e64 v1, s[8:9], 0, 0, vcc
...
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v6, 31, v4
; GCN-IR-NEXT:    v_add_i32_e32 v10, vcc, 1, v10
; GCN-IR-NEXT:    v_and_b32_e32 v12, 0x8000, v6
...
; GCN-IR-NEXT:    v_min_u32_e32 v10, s4, v2
...
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    v_lshr_b64 v[8:9], v[0:1], v6
; GCN-IR-NEXT:    v_add_i32_e32 v1, vcc, 0xffffffcf, v10
; GCN-IR-NEXT:    s_mov_b64 s[8:9], 0
; GCN-IR-NEXT:    v_mov_b32_e32 v6, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v7, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
; GCN-IR-NEXT:    s_movk_i32 s10, 0x7fff
; GCN-IR-NEXT:    v_addc_u32_e64 v10, s[12:13], 0, -1, vcc
...
; GCN-IR-NEXT:    v_and_b32_e32 v11, 0x8000, v6
; GCN-IR-NEXT:    v_addc_u32_e32 v10, vcc, 0, v10, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v3, v7, v3
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v6
; GCN-IR-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GCN-IR-NEXT:    v_mov_b32_e32 v7, v5
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v8, v11
; GCN-IR-NEXT:    v_mov_b32_e32 v6, v4
; GCN-IR-NEXT:    v_subbrev_u32_e32 v9, vcc, 0, v9, vcc
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[8:9]
