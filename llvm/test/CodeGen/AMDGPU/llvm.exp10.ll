...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GCN,GCN-SDAG,VI,VI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GCN,GCN-GISEL,VI,VI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GCN-SDAG,GFX900,GFX900-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GCN-GISEL,GFX900,GFX900-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=SI,SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=SI,SI-GISEL %s
...
; SI-SDAG-NEXT:    v_mul_f32_e32 v1, s4, v0
...
; SI-SDAG-NEXT:    v_cvt_i32_f32_e32 v1, v2
...
; SI-SDAG-NEXT:    v_rndne_f32_e32 v2, v1
; SI-SDAG-NEXT:    v_sub_f32_e32 v3, v1, v2
; SI-SDAG-NEXT:    v_fma_f32 v1, s5, v0, -v1
; SI-SDAG-NEXT:    v_fma_f32 v1, s5, v4, v1
...
; SI-SDAG-NEXT:    v_fma_f32 v0, s4, v4, v0
; SI-SDAG-NEXT:    v_add_f32_e32 v0, v7, v0
; SI-SDAG-NEXT:    v_exp_f32_e32 v0, v0
; SI-SDAG-NEXT:    v_cvt_i32_f32_e32 v4, v6
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v1, v1, v2
; SI-SDAG-NEXT:    v_mov_b32_e32 v2, 0xc23369f4
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s5, v2
; SI-SDAG-NEXT:    v_mov_b32_e32 v3, 0x421a209b
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; SI-SDAG-NEXT:    v_mov_b32_e32 v5, 0x7f800000
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s5, v3
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v1, v5, v1, vcc
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v0, v0, v4
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s4, v2
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s4, v3
...
; SI-SDAG-NEXT:    v_mul_f32_e32 v1, s5, v0
; SI-SDAG-NEXT:    v_fma_f32 v5, s4, v4, v5
; SI-SDAG-NEXT:    v_rndne_f32_e32 v2, v1
...
; SI-SDAG-NEXT:    v_fma_f32 v0, s6, v4, v0
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v1, v1, v2
; SI-SDAG-NEXT:    v_mov_b32_e32 v2, 0xc23369f4
; SI-SDAG-NEXT:    v_add_f32_e32 v0, v9, v0
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s5, v2
; SI-SDAG-NEXT:    v_mov_b32_e32 v3, 0x421a209b
; SI-SDAG-NEXT:    v_exp_f32_e32 v4, v0
...
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v4, v4, v6
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s6, v2
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v4, vcc
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s6, v3
...
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, 0x40549a78
; SI-SDAG-NEXT:    v_mov_b32_e32 v4, 0x33979a37
; SI-SDAG-NEXT:    v_mov_b32_e32 v5, 0xc23369f4
; SI-SDAG-NEXT:    v_mov_b32_e32 v6, 0x421a209b
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mul_f32_e32 v1, s7, v0
; SI-SDAG-NEXT:    v_rndne_f32_e32 v2, v1
; SI-SDAG-NEXT:    v_sub_f32_e32 v3, v1, v2
; SI-SDAG-NEXT:    v_fma_f32 v1, s7, v0, -v1
; SI-SDAG-NEXT:    v_fma_f32 v1, s7, v4, v1
; SI-SDAG-NEXT:    v_add_f32_e32 v1, v3, v1
; SI-SDAG-NEXT:    v_exp_f32_e32 v1, v1
; SI-SDAG-NEXT:    v_cvt_i32_f32_e32 v2, v2
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s7, v5
; SI-SDAG-NEXT:    v_mov_b32_e32 v8, 0x7f800000
; SI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v1, v1, v2
; SI-SDAG-NEXT:    v_mul_f32_e32 v2, s6, v0
; SI-SDAG-NEXT:    v_rndne_f32_e32 v3, v2
; SI-SDAG-NEXT:    v_sub_f32_e32 v7, v2, v3
; SI-SDAG-NEXT:    v_fma_f32 v2, s6, v0, -v2
; SI-SDAG-NEXT:    v_fma_f32 v2, s6, v4, v2
; SI-SDAG-NEXT:    v_add_f32_e32 v2, v7, v2
; SI-SDAG-NEXT:    v_exp_f32_e32 v2, v2
; SI-SDAG-NEXT:    v_cvt_i32_f32_e32 v7, v3
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s7, v6
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v3, v8, v1, vcc
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v1, v2, v7
; SI-SDAG-NEXT:    v_mul_f32_e32 v2, s5, v0
; SI-SDAG-NEXT:    v_rndne_f32_e32 v7, v2
; SI-SDAG-NEXT:    v_sub_f32_e32 v9, v2, v7
; SI-SDAG-NEXT:    v_fma_f32 v2, s5, v0, -v2
; SI-SDAG-NEXT:    v_fma_f32 v2, s5, v4, v2
; SI-SDAG-NEXT:    v_add_f32_e32 v2, v9, v2
; SI-SDAG-NEXT:    v_exp_f32_e32 v9, v2
; SI-SDAG-NEXT:    v_cvt_i32_f32_e32 v7, v7
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s6, v5
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s6, v6
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v2, v8, v1, vcc
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v1, v9, v7
...
; SI-SDAG-NEXT:    v_exp_f32_e32 v0, v0
; SI-SDAG-NEXT:    v_cvt_i32_f32_e32 v4, v9
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s5, v5
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s5, v6
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v1, v8, v1, vcc
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v0, v0, v4
; SI-SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s4, v5
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; SI-SDAG-NEXT:    v_cmp_ngt_f32_e32 vcc, s4, v6
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
