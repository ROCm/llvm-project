...
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=verde < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx942 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX942 %s
...
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX942-NEXT:    s_mov_b32 s3, 0xf000
; GFX942-NEXT:    s_load_dword s4, s[4:5], 0x2c
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 0
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
  %y = fadd float %x, 0.0
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 0.5
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
  %y = fadd float %x, 0.5
  store float %y, ptr addrspace(1) %out
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 1.0
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
  %y = fadd float %x, 1.0
  store float %y, ptr addrspace(1) %out
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 2.0
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
  %y = fadd float %x, 2.0
  store float %y, ptr addrspace(1) %out
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 4.0
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
  %y = fadd float %x, 4.0
  store float %y, ptr addrspace(1) %out
...
; GFX942-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; GFX942-NEXT:    s_mov_b32 s2, s6
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 1
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 2
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 16
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_add_i32 s4, s4, -16
; GFX942-NEXT:    v_mov_b32_e32 v0, s4
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
  %xbc = bitcast float %x to i32
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 63
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
...
; GFX942-NEXT:    s_mov_b32 s2, -1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e64 v0, s4, 64
; GFX942-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX942-NEXT:    s_endpgm
