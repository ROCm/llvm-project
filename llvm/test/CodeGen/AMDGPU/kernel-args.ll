...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 | FileCheck -check-prefixes=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.00--amdhsa | FileCheck -check-prefixes=GFX9 %s
