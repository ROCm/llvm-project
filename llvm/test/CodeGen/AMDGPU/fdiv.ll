...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX67,GFX6,GFX6-FASTFMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX67,GFX6,GFX6-SLOWFMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX67,GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GCN,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GCN,GFX11 %s
...
; GFX67-NEXT:    s_mov_b32 s6, 0xf000
; GFX67-NEXT:    s_mov_b32 s7, -1
...
; GFX67-NEXT:    s_mov_b32 s2, s7
; GFX67-NEXT:    s_mov_b32 s3, s6
...
; GFX7:       ; %bb.0: ; %entry
; GFX7-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX7-NEXT:    s_mov_b32 s6, 0xf000
; GFX7-NEXT:    s_mov_b32 s7, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    s_mov_b32 s2, s7
; GFX7-NEXT:    s_mov_b32 s3, s6
...
; GFX6-FASTFMA-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0xb
; GFX6-FASTFMA-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-FASTFMA-NEXT:    s_mov_b32 s2, -1
; GFX6-FASTFMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v0, s5
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v1, s[8:9], s7, s7, v0
; GFX6-FASTFMA-NEXT:    v_rcp_f32_e32 v2, v1
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v3, s7
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v3, vcc, s5, v3, s5
; GFX6-FASTFMA-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
; GFX6-FASTFMA-NEXT:    v_fma_f32 v4, -v1, v2, 1.0
; GFX6-FASTFMA-NEXT:    v_fma_f32 v2, v4, v2, v2
; GFX6-FASTFMA-NEXT:    v_mul_f32_e32 v4, v3, v2
...
; GFX6-FASTFMA-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; GFX6-FASTFMA-NEXT:    v_div_fmas_f32 v1, v1, v2, v4
; GFX6-FASTFMA-NEXT:    v_div_fixup_f32 v1, v1, s7, v0
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v0, s4
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v2, s[8:9], s6, s6, v0
; GFX6-FASTFMA-NEXT:    v_rcp_f32_e32 v3, v2
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v4, s6
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v4, vcc, s4, v4, s4
; GFX6-FASTFMA-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
...
; GFX6-FASTFMA-NEXT:    v_div_fixup_f32 v0, v2, s6, v0
...
; GFX7-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0xb
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    s_mov_b32 s2, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v0, s5
; GFX7-NEXT:    v_div_scale_f32 v1, s[8:9], s7, s7, v0
; GFX7-NEXT:    v_rcp_f32_e32 v2, v1
; GFX7-NEXT:    v_mov_b32_e32 v3, s7
; GFX7-NEXT:    v_div_scale_f32 v3, vcc, s5, v3, s5
; GFX7-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
; GFX7-NEXT:    v_fma_f32 v4, -v1, v2, 1.0
; GFX7-NEXT:    v_fma_f32 v2, v4, v2, v2
; GFX7-NEXT:    v_mul_f32_e32 v4, v3, v2
...
; GFX7-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; GFX7-NEXT:    v_div_fmas_f32 v1, v1, v2, v4
; GFX7-NEXT:    v_div_fixup_f32 v1, v1, s7, v0
; GFX7-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-NEXT:    v_div_scale_f32 v2, s[8:9], s6, s6, v0
; GFX7-NEXT:    v_rcp_f32_e32 v3, v2
; GFX7-NEXT:    v_mov_b32_e32 v4, s6
; GFX7-NEXT:    v_div_scale_f32 v4, vcc, s4, v4, s4
; GFX7-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
...
; GFX7-NEXT:    v_div_fixup_f32 v0, v2, s6, v0
...
; GFX67:       ; %bb.0: ; %entry
; GFX67-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX67-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0xb
...
; GFX6-FASTFMA:       ; %bb.0:
; GFX6-FASTFMA-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x9
; GFX6-FASTFMA-NEXT:    s_mov_b32 s11, 0xf000
; GFX6-FASTFMA-NEXT:    s_mov_b32 s10, -1
; GFX6-FASTFMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-FASTFMA-NEXT:    s_load_dwordx8 s[0:7], s[14:15], 0x0
; GFX6-FASTFMA-NEXT:    s_mov_b32 s8, s12
; GFX6-FASTFMA-NEXT:    s_mov_b32 s9, s13
; GFX6-FASTFMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v0, s3
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v1, s[12:13], s7, s7, v0
; GFX6-FASTFMA-NEXT:    v_rcp_f32_e32 v2, v1
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX6-FASTFMA-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; GFX6-FASTFMA-NEXT:    v_div_fmas_f32 v1, v1, v2, v4
; GFX6-FASTFMA-NEXT:    v_div_fixup_f32 v3, v1, s7, v0
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v0, s2
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v1, s[12:13], s6, s6, v0
; GFX6-FASTFMA-NEXT:    v_rcp_f32_e32 v2, v1
; GFX6-FASTFMA-NEXT:    v_mov_b32_e32 v4, s6
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v4, vcc, s2, v4, s2
; GFX6-FASTFMA-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
; GFX6-FASTFMA-NEXT:    v_fma_f32 v5, -v1, v2, 1.0
; GFX6-FASTFMA-NEXT:    v_fma_f32 v2, v5, v2, v2
; GFX6-FASTFMA-NEXT:    v_mul_f32_e32 v5, v4, v2
; GFX6-FASTFMA-NEXT:    v_fma_f32 v6, -v1, v5, v4
; GFX6-FASTFMA-NEXT:    v_fma_f32 v5, v6, v2, v5
; GFX6-FASTFMA-NEXT:    v_fma_f32 v1, -v1, v5, v4
; GFX6-FASTFMA-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; GFX6-FASTFMA-NEXT:    v_div_fmas_f32 v1, v1, v2, v5
; GFX6-FASTFMA-NEXT:    v_div_fixup_f32 v2, v1, s6, v0
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x9
; GFX7-NEXT:    s_mov_b32 s11, 0xf000
; GFX7-NEXT:    s_mov_b32 s10, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_load_dwordx8 s[0:7], s[14:15], 0x0
; GFX7-NEXT:    s_mov_b32 s8, s12
; GFX7-NEXT:    s_mov_b32 s9, s13
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v0, s3
; GFX7-NEXT:    v_div_scale_f32 v1, s[12:13], s7, s7, v0
; GFX7-NEXT:    v_rcp_f32_e32 v2, v1
; GFX7-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX7-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; GFX7-NEXT:    v_div_fmas_f32 v1, v1, v2, v4
; GFX7-NEXT:    v_div_fixup_f32 v3, v1, s7, v0
; GFX7-NEXT:    v_mov_b32_e32 v0, s2
; GFX7-NEXT:    v_div_scale_f32 v1, s[12:13], s6, s6, v0
; GFX7-NEXT:    v_rcp_f32_e32 v2, v1
; GFX7-NEXT:    v_mov_b32_e32 v4, s6
; GFX7-NEXT:    v_div_scale_f32 v4, vcc, s2, v4, s2
; GFX7-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
; GFX7-NEXT:    v_fma_f32 v5, -v1, v2, 1.0
; GFX7-NEXT:    v_fma_f32 v2, v5, v2, v2
; GFX7-NEXT:    v_mul_f32_e32 v5, v4, v2
; GFX7-NEXT:    v_fma_f32 v6, -v1, v5, v4
; GFX7-NEXT:    v_fma_f32 v5, v6, v2, v5
; GFX7-NEXT:    v_fma_f32 v1, -v1, v5, v4
; GFX7-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; GFX7-NEXT:    v_div_fmas_f32 v1, v1, v2, v5
; GFX7-NEXT:    v_div_fixup_f32 v2, v1, s6, v0
...
; GFX67-NEXT:    s_mov_b32 s15, 0xf000
; GFX67-NEXT:    s_mov_b32 s14, -1
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX67-NEXT:    s_mov_b32 s12, s8
; GFX67-NEXT:    s_mov_b32 s13, s9
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    v_rcp_f32_e32 v0, s7
...
; GFX67-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0
; GFX67-NEXT:    s_endpgm
;
...
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v0, s[4:5], s6, s6, 1.0
; GFX6-FASTFMA-NEXT:    v_rcp_f32_e32 v1, v0
; GFX6-FASTFMA-NEXT:    v_fma_f32 v2, -v0, v1, 1.0
; GFX6-FASTFMA-NEXT:    v_fma_f32 v1, v2, v1, v1
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v2, vcc, 1.0, s6, 1.0
; GFX6-FASTFMA-NEXT:    v_mul_f32_e32 v3, v2, v1
; GFX6-FASTFMA-NEXT:    v_fma_f32 v4, -v0, v3, v2
; GFX6-FASTFMA-NEXT:    v_fma_f32 v3, v4, v1, v3
...
; GFX7-NEXT:    v_div_scale_f32 v0, s[4:5], s6, s6, 1.0
; GFX7-NEXT:    v_rcp_f32_e32 v1, v0
; GFX7-NEXT:    v_fma_f32 v2, -v0, v1, 1.0
; GFX7-NEXT:    v_fma_f32 v1, v2, v1, v1
; GFX7-NEXT:    v_div_scale_f32 v2, vcc, 1.0, s6, 1.0
; GFX7-NEXT:    v_mul_f32_e32 v3, v2, v1
; GFX7-NEXT:    v_fma_f32 v4, -v0, v3, v2
; GFX7-NEXT:    v_fma_f32 v3, v4, v1, v3
