...
; GFX9-NEXT:    v_min_f16_e32 v2, v4, v0
...
; GFX9-NEXT:    v_min_f16_e32 v4, v0, v2
; GFX9-NEXT:    s_nop 0
; GFX9-NEXT:    v_cndmask_b32_sdwa v1, v5, v6, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX9-NEXT:    v_cmp_o_f16_e32 vcc, v0, v2
; GFX9-NEXT:    s_nop 1
...
; GFX10-NEXT:    v_min_f16_e32 v2, v4, v0
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v4, v0
; GFX10-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v2, vcc_lo
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v3
; GFX10-NEXT:    v_cndmask_b32_e32 v2, 0x7e00, v5, vcc_lo
; GFX10-NEXT:    v_cmp_o_f16_sdwa vcc_lo, v1, v3 src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-NEXT:    v_mov_b32_e32 v1, 0x7e00
; GFX10-NEXT:    v_min_f16_e32 v3, v0, v2
; GFX10-NEXT:    v_cndmask_b32_sdwa v1, v1, v5, vcc_lo dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
...
; GFX9-NEXT:    v_pk_min_f16 v10, v0, v4
...
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v9, v11, vcc
; GFX9-NEXT:    v_perm_b32 v4, v0, v10, s0
; GFX9-NEXT:    v_pk_min_f16 v4, v4, v6
; GFX9-NEXT:    v_cmp_o_f16_e32 vcc, v10, v8
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 16, v4
; GFX9-NEXT:    s_nop 0
...
; GFX9-NEXT:    v_pk_min_f16 v6, v3, v7
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 16, v8
; GFX9-NEXT:    v_perm_b32 v7, v3, v6, s0
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v9, v8, vcc
; GFX9-NEXT:    v_cmp_o_f16_sdwa vcc, v1, v5 src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v9, v10, vcc
; GFX9-NEXT:    v_perm_b32 v5, v1, v8, s0
; GFX9-NEXT:    v_cmp_o_f16_e32 vcc, v4, v0
; GFX9-NEXT:    v_pk_min_f16 v5, v5, v7
; GFX9-NEXT:    s_nop 0
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v9, v2, vcc
; GFX9-NEXT:    v_cmp_o_f16_e32 vcc, v8, v6
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v9, v5, vcc
; GFX9-NEXT:    v_cmp_o_f16_e32 vcc, v1, v3
; GFX9-NEXT:    v_min_f16_e32 v4, v0, v2
; GFX9-NEXT:    s_nop 0
; GFX9-NEXT:    v_cndmask_b32_sdwa v1, v9, v5, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX9-NEXT:    v_cmp_o_f16_e32 vcc, v0, v2
; GFX9-NEXT:    s_nop 1
...
; GFX10-NEXT:    v_perm_b32 v9, v0, v6, 0x5040100
; GFX10-NEXT:    v_lshrrev_b32_e32 v12, 16, v11
; GFX10-NEXT:    v_pk_min_f16 v4, v9, v4
; GFX10-NEXT:    v_lshrrev_b32_e32 v9, 16, v10
...
; GFX10-NEXT:    v_cndmask_b32_e32 v3, 0x7e00, v9, vcc_lo
...
; GFX10-NEXT:    v_perm_b32 v5, v1, v7, 0x5040100
; GFX10-NEXT:    v_cndmask_b32_e32 v4, 0x7e00, v4, vcc_lo
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
; GFX10-NEXT:    v_perm_b32 v2, v3, v10, 0x5040100
; GFX10-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v13, vcc_lo
; GFX10-NEXT:    v_pk_min_f16 v2, v5, v2
; GFX10-NEXT:    v_min_f16_e32 v6, v4, v0
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v4, v0
; GFX10-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v6, vcc_lo
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v7, v10
; GFX10-NEXT:    v_cndmask_b32_e32 v4, 0x7e00, v2, vcc_lo
; GFX10-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v3
; GFX10-NEXT:    v_mov_b32_e32 v1, 0x7e00
; GFX10-NEXT:    v_min_f16_e32 v3, v0, v4
...
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v11, 16, v2
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v2, v6
; GFX11-SDAG-FAKE16-NEXT:    v_pk_min_f16 v10, v0, v4
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v12, 16, v8
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v13, 16, v4
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v14, 16, v0
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v2, 0x7e00, v8, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v11, v9
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v15, 16, v10
; GFX11-SDAG-FAKE16-NEXT:    v_pk_min_f16 v11, v1, v5
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v16, 16, v1
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v6, 0x7e00, v12, vcc_lo
...
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v17, 16, v11
...
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v4, 0x7e00, v15, vcc_lo
...
; GFX11-SDAG-FAKE16-NEXT:    v_perm_b32 v9, v4, v0, 0x5040100
; GFX11-SDAG-FAKE16-NEXT:    v_pk_min_f16 v8, v9, v8
; GFX11-SDAG-FAKE16-NEXT:    v_pk_min_f16 v9, v3, v7
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v12, 16, v8
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v14, 16, v9
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v3, 0x7e00, v9, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v13, v10
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v7, 0x7e00, v14, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v5
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v11, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v16, v15
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v5, 0x7e00, v17, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v8, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v4, v6
; GFX11-SDAG-FAKE16-NEXT:    v_perm_b32 v4, v7, v3, 0x5040100
; GFX11-SDAG-FAKE16-NEXT:    v_perm_b32 v6, v5, v1, 0x5040100
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v2, 0x7e00, v12, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-FAKE16-NEXT:    v_pk_min_f16 v4, v6, v4
; GFX11-SDAG-FAKE16-NEXT:    v_min_f16_e32 v8, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v8, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v3
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 16, v4
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v4, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_min_f16_e32 v2, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v2, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v5, v7
; GFX11-SDAG-FAKE16-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v3, vcc_lo
; GFX11-SDAG-FAKE16-NEXT:    v_min_f16_e32 v2, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v1
