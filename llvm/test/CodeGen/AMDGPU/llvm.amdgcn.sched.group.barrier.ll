...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -misched-cluster=0 -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -misched-cluster=0 -amdgpu-mfma-vgpr-form=0 -amdgpu-igrouplp-exact-solver-max-branches=250000 < %s | FileCheck -check-prefix=EXACTCUTOFF %s
...
; GCN-NEXT:    s_load_dword s4, s[4:5], 0x54
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; EXACTCUTOFF-NEXT:    s_load_dword s4, s[4:5], 0x54
; EXACTCUTOFF-NEXT:    s_waitcnt lgkmcnt(0)
...
; EXACTCUTOFF-NEXT:    v_fma_f32 v3, s4, v3, -v4
...
; EXACTCUTOFF-NEXT:    v_fmac_f32_e32 v3, s4, v7
