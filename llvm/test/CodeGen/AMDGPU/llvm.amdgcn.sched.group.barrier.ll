...
; GISEL-NEXT:    v_accvgpr_read_b32 v36, a132
; GISEL-NEXT:    v_accvgpr_read_b32 v37, a133
; GISEL-NEXT:    v_accvgpr_read_b32 v38, a134
; GISEL-NEXT:    v_accvgpr_read_b32 v39, a135
; GISEL-NEXT:    v_accvgpr_read_b32 v40, a136
; GISEL-NEXT:    v_accvgpr_read_b32 v41, a137
; GISEL-NEXT:    v_accvgpr_read_b32 v42, a138
; GISEL-NEXT:    v_accvgpr_read_b32 v43, a139
; GISEL-NEXT:    v_accvgpr_read_b32 v44, a140
; GISEL-NEXT:    v_accvgpr_read_b32 v45, a141
; GISEL-NEXT:    v_accvgpr_read_b32 v46, a142
; GISEL-NEXT:    v_accvgpr_read_b32 v47, a143
; GISEL-NEXT:    v_accvgpr_read_b32 v48, a144
; GISEL-NEXT:    v_accvgpr_read_b32 v49, a145
; GISEL-NEXT:    v_accvgpr_read_b32 v50, a146
; GISEL-NEXT:    v_accvgpr_read_b32 v51, a147
; GISEL-NEXT:    v_accvgpr_read_b32 v52, a148
; GISEL-NEXT:    v_accvgpr_read_b32 v53, a149
; GISEL-NEXT:    v_accvgpr_read_b32 v54, a150
; GISEL-NEXT:    v_accvgpr_read_b32 v55, a151
; GISEL-NEXT:    v_accvgpr_read_b32 v56, a152
; GISEL-NEXT:    v_accvgpr_read_b32 v57, a153
; GISEL-NEXT:    v_accvgpr_read_b32 v58, a154
; GISEL-NEXT:    v_accvgpr_read_b32 v59, a155
; GISEL-NEXT:    v_accvgpr_read_b32 v60, a156
; GISEL-NEXT:    v_accvgpr_read_b32 v61, a157
; GISEL-NEXT:    v_accvgpr_read_b32 v62, a158
; GISEL-NEXT:    v_accvgpr_read_b32 v63, a159
...
; SDAG-NEXT:    v_mov_b32_e32 v2, 0x3fb8aa3b
; SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; SDAG-NEXT:    v_mov_b32_e32 v6, 0x32a5705f
; SDAG-NEXT:    v_lshlrev_b32_e32 v0, 7, v0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mul_f32_e32 v3, s0, v2
; SDAG-NEXT:    v_rndne_f32_e32 v4, v3
; SDAG-NEXT:    v_sub_f32_e32 v5, v3, v4
; SDAG-NEXT:    v_fma_f32 v3, s0, v2, -v3
; SDAG-NEXT:    v_fmac_f32_e32 v3, s0, v6
...
; SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s0, v4
; SDAG-NEXT:    v_mov_b32_e32 v7, 0x42b17218
...
; SDAG-NEXT:    v_cndmask_b32_e32 v3, v8, v3, vcc
; SDAG-NEXT:    v_cmp_nlt_f32_e32 vcc, s3, v4
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000400) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000400) size(1) SyncID(0)
; SDAG-NEXT:    s_nop 4
...
; SDAG-NEXT:    v_rndne_f32_e32 v10, v3
; SDAG-NEXT:    v_sub_f32_e32 v11, v3, v10
; SDAG-NEXT:    v_fma_f32 v3, s3, v2, -v3
; SDAG-NEXT:    v_fmac_f32_e32 v3, s3, v6
; SDAG-NEXT:    v_add_f32_e32 v3, v11, v3
; SDAG-NEXT:    v_exp_f32_e32 v3, v3
; SDAG-NEXT:    v_cvt_i32_f32_e32 v10, v10
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
...
; SDAG-NEXT:    ds_read_b128 a[16:19], v9 offset:57408
; SDAG-NEXT:    ds_read_b128 a[0:3], v9 offset:57344
; SDAG-NEXT:    ds_read_b128 a[4:7], v9 offset:57360
...
; GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GISEL-NEXT:    v_mov_b32_e32 v34, 0x3fb8aa3b
; GISEL-NEXT:    v_lshlrev_b32_e32 v32, 7, v0
; GISEL-NEXT:    v_mov_b32_e32 v35, 0x32a5705f
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_mul_f32_e32 v0, s0, v34
; GISEL-NEXT:    v_fma_f32 v1, s0, v34, -v0
; GISEL-NEXT:    v_rndne_f32_e32 v2, v0
; GISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GISEL-NEXT:    v_fmac_f32_e32 v1, s0, v35
; GISEL-NEXT:    v_sub_f32_e32 v0, v0, v2
; GISEL-NEXT:    v_add_f32_e32 v0, v0, v1
; GISEL-NEXT:    v_cvt_i32_f32_e32 v1, v2
; GISEL-NEXT:    v_exp_f32_e32 v0, v0
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_add_u32_e32 v33, s6, v32
; GISEL-NEXT:    v_mov_b32_e32 v36, 0xc2ce8ed0
...
; GISEL-NEXT:    v_cmp_lt_f32_e32 vcc, s0, v36
...
; GISEL-NEXT:    v_mul_f32_e32 v39, s1, v34
; GISEL-NEXT:    v_fma_f32 v40, s1, v34, -v39
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v38, v0, a[0:31]
; GISEL-NEXT:    v_rndne_f32_e32 v41, v39
; GISEL-NEXT:    v_fmac_f32_e32 v40, s1, v35
; GISEL-NEXT:    v_sub_f32_e32 v39, v39, v41
; GISEL-NEXT:    v_add_f32_e32 v39, v39, v40
; GISEL-NEXT:    v_cvt_i32_f32_e32 v40, v41
; GISEL-NEXT:    v_exp_f32_e32 v39, v39
; GISEL-NEXT:    v_cmp_lt_f32_e32 vcc, s1, v36
; GISEL-NEXT:    s_cmp_lg_u64 vcc, 0
; GISEL-NEXT:    v_cmp_gt_f32_e32 vcc, s1, v37
; GISEL-NEXT:    v_ldexp_f32 v39, v39, v40
; GISEL-NEXT:    v_readfirstlane_b32 s0, v39
; GISEL-NEXT:    s_cselect_b32 s0, 0, s0
; GISEL-NEXT:    s_cmp_lg_u64 vcc, 0
; GISEL-NEXT:    s_cselect_b32 s0, 0x7f800000, s0
; GISEL-NEXT:    v_mov_b32_e32 v39, s0
; GISEL-NEXT:    v_add_u32_e32 v32, s7, v32
; GISEL-NEXT:    v_cmp_lt_f32_e32 vcc, s2, v36
; GISEL-NEXT:    s_cmp_lg_u64 vcc, 0
; GISEL-NEXT:    v_cmp_gt_f32_e32 vcc, s2, v37
; GISEL-NEXT:    v_accvgpr_read_b32 v0, a0
; GISEL-NEXT:    v_accvgpr_read_b32 v1, a1
; GISEL-NEXT:    v_accvgpr_read_b32 v2, a2
; GISEL-NEXT:    v_accvgpr_read_b32 v3, a3
...
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v38, v39, a[0:31]
...
; GISEL-NEXT:    v_mul_f32_e32 v32, s2, v34
; GISEL-NEXT:    v_fma_f32 v39, s2, v34, -v32
; GISEL-NEXT:    v_rndne_f32_e32 v40, v32
; GISEL-NEXT:    v_fmac_f32_e32 v39, s2, v35
; GISEL-NEXT:    v_sub_f32_e32 v32, v32, v40
...
; GISEL-NEXT:    v_accvgpr_read_b32 v30, a30
; GISEL-NEXT:    v_accvgpr_read_b32 v31, a31
; GISEL-NEXT:    ds_read_b128 a[0:3], v40 offset:32768
; GISEL-NEXT:    ds_read_b128 a[4:7], v40 offset:32784
; GISEL-NEXT:    ds_read_b128 a[8:11], v40 offset:32800
; GISEL-NEXT:    ds_read_b128 a[12:15], v40 offset:32816
; GISEL-NEXT:    ds_read_b128 a[16:19], v40 offset:32832
; GISEL-NEXT:    ds_read_b128 a[20:23], v40 offset:32848
; GISEL-NEXT:    ds_read_b128 a[24:27], v40 offset:32864
; GISEL-NEXT:    ds_read_b128 a[28:31], v40 offset:32880
; GISEL-NEXT:    s_cselect_b32 s0, 0, s0
; GISEL-NEXT:    s_cmp_lg_u64 vcc, 0
; GISEL-NEXT:    s_cselect_b32 s0, 0x7f800000, s0
; GISEL-NEXT:    v_mov_b32_e32 v33, s0
...
; EXACTCUTOFF-NEXT:    v_rndne_f32_e32 v10, v3
; EXACTCUTOFF-NEXT:    v_sub_f32_e32 v11, v3, v10
; EXACTCUTOFF-NEXT:    v_fma_f32 v3, s3, v2, -v3
; EXACTCUTOFF-NEXT:    v_fmac_f32_e32 v3, s3, v6
; EXACTCUTOFF-NEXT:    v_add_f32_e32 v3, v11, v3
; EXACTCUTOFF-NEXT:    v_exp_f32_e32 v3, v3
; EXACTCUTOFF-NEXT:    v_cvt_i32_f32_e32 v10, v10
; EXACTCUTOFF-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
...
; EXACTCUTOFF-NEXT:    ds_read_b128 a[16:19], v9 offset:57408
; EXACTCUTOFF-NEXT:    ds_read_b128 a[0:3], v9 offset:57344
; EXACTCUTOFF-NEXT:    ds_read_b128 a[4:7], v9 offset:57360
