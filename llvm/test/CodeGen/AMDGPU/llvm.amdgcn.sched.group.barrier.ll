...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx90a -misched-cluster=0 -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=GCN,SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgcn -mcpu=gfx90a -misched-cluster=0 -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=GCN,GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx90a -misched-cluster=0 -amdgpu-mfma-vgpr-form=0 -amdgpu-igrouplp-exact-solver-max-branches=250000 < %s | FileCheck -check-prefix=EXACTCUTOFF %s
...
; SDAG-NEXT:    ; kill: killed $sgpr0 killed $sgpr1
...
; EXACTCUTOFF-NEXT:    ; kill: killed $sgpr0 killed $sgpr1
...
; SDAG-NEXT:    v_lshlrev_b32_e32 v32, 7, v0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    global_load_dwordx4 v[28:31], v32, s[0:1] offset:16
; SDAG-NEXT:    global_load_dwordx4 v[0:3], v32, s[0:1]
...
; SDAG-NEXT:    v_mul_lo_u32 v5, v5, v5
; SDAG-NEXT:    v_mul_lo_u32 v4, v4, v4
; SDAG-NEXT:    global_load_dwordx4 v[16:19], v32, s[0:1] offset:48
; SDAG-NEXT:    s_waitcnt vmcnt(2)
; SDAG-NEXT:    v_mul_lo_u32 v11, v11, v11
; SDAG-NEXT:    v_mul_lo_u32 v10, v10, v10
; SDAG-NEXT:    v_mul_lo_u32 v9, v9, v9
...
; SDAG-NEXT:    global_store_dwordx4 v32, v[16:19], s[2:3] offset:48
; SDAG-NEXT:    global_store_dwordx4 v32, v[24:27], s[2:3] offset:32
; SDAG-NEXT:    global_store_dwordx4 v32, v[28:31], s[2:3] offset:16
; SDAG-NEXT:    global_store_dwordx4 v32, v[0:3], s[2:3]
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
...
; SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; SDAG-NEXT:    v_lshlrev_b32_e32 v16, 7, v0
; SDAG-NEXT:    ; kill: killed $sgpr0 killed $sgpr1
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    global_load_dwordx4 v[12:15], v16, s[0:1] offset:32
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_mul_lo_u32 v13, v13, v13
...
; SDAG-NEXT:    v_mul_lo_u32 v15, v15, v15
; SDAG-NEXT:    v_mul_lo_u32 v14, v14, v14
; SDAG-NEXT:    global_store_dwordx4 v16, v[12:15], s[2:3] offset:32
...
; SDAG-NEXT:    global_load_dwordx4 v[0:3], v16, s[0:1] offset:112
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_mul_lo_u32 v3, v3, v3
; SDAG-NEXT:    v_mul_lo_u32 v2, v2, v2
; SDAG-NEXT:    v_mul_lo_u32 v1, v1, v1
; SDAG-NEXT:    v_mul_lo_u32 v0, v0, v0
; SDAG-NEXT:    global_store_dwordx4 v16, v[0:3], s[2:3] offset:112
; SDAG-NEXT:    global_load_dwordx4 v[0:3], v16, s[0:1] offset:96
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_mul_lo_u32 v3, v3, v3
; SDAG-NEXT:    v_mul_lo_u32 v2, v2, v2
; SDAG-NEXT:    v_mul_lo_u32 v1, v1, v1
; SDAG-NEXT:    v_mul_lo_u32 v0, v0, v0
; SDAG-NEXT:    global_store_dwordx4 v16, v[0:3], s[2:3] offset:96
; SDAG-NEXT:    global_load_dwordx4 v[0:3], v16, s[0:1] offset:80
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_mul_lo_u32 v3, v3, v3
; SDAG-NEXT:    v_mul_lo_u32 v2, v2, v2
; SDAG-NEXT:    v_mul_lo_u32 v1, v1, v1
; SDAG-NEXT:    v_mul_lo_u32 v0, v0, v0
; SDAG-NEXT:    global_store_dwordx4 v16, v[0:3], s[2:3] offset:80
; SDAG-NEXT:    global_load_dwordx4 v[4:7], v16, s[0:1] offset:48
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
...
; SDAG-NEXT:    v_mul_lo_u32 v5, v5, v5
; SDAG-NEXT:    v_mul_lo_u32 v4, v4, v4
; SDAG-NEXT:    global_store_dwordx4 v16, v[4:7], s[2:3] offset:48
; SDAG-NEXT:    global_load_dwordx4 v[8:11], v16, s[0:1] offset:16
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
...
; SDAG-NEXT:    v_mul_lo_u32 v11, v11, v11
; SDAG-NEXT:    v_mul_lo_u32 v10, v10, v10
; SDAG-NEXT:    global_store_dwordx4 v16, v[8:11], s[2:3] offset:16
; SDAG-NEXT:    global_load_dwordx4 v[8:11], v16, s[0:1] offset:64
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
...
; SDAG-NEXT:    v_mul_lo_u32 v9, v9, v9
; SDAG-NEXT:    v_mul_lo_u32 v8, v8, v8
; SDAG-NEXT:    global_store_dwordx4 v16, v[8:11], s[2:3] offset:64
; SDAG-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
; SDAG-NEXT:    s_endpgm
;
...
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    global_load_dwordx4 v[4:7], v12, s[0:1] offset:96
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mul_lo_u32 v4, v4, v4
; GISEL-NEXT:    v_mul_lo_u32 v5, v5, v5
; GISEL-NEXT:    v_mul_lo_u32 v6, v6, v6
; GISEL-NEXT:    v_mul_lo_u32 v7, v7, v7
; GISEL-NEXT:    global_store_dwordx4 v12, v[4:7], s[2:3] offset:96
; GISEL-NEXT:    global_load_dwordx4 v[4:7], v12, s[0:1] offset:16
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mul_lo_u32 v4, v4, v4
; GISEL-NEXT:    v_mul_lo_u32 v5, v5, v5
; GISEL-NEXT:    v_mul_lo_u32 v6, v6, v6
; GISEL-NEXT:    v_mul_lo_u32 v7, v7, v7
; GISEL-NEXT:    global_store_dwordx4 v12, v[4:7], s[2:3] offset:16
; GISEL-NEXT:    global_load_dwordx4 v[4:7], v12, s[0:1] offset:64
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mul_lo_u32 v4, v4, v4
; GISEL-NEXT:    global_load_dwordx4 v[8:11], v12, s[0:1] offset:80
; GISEL-NEXT:    v_mul_lo_u32 v5, v5, v5
; GISEL-NEXT:    v_mul_lo_u32 v6, v6, v6
; GISEL-NEXT:    v_mul_lo_u32 v7, v7, v7
; GISEL-NEXT:    s_waitcnt vmcnt(0)
...
; GISEL-NEXT:    v_mul_lo_u32 v10, v10, v10
; GISEL-NEXT:    v_mul_lo_u32 v11, v11, v11
; GISEL-NEXT:    global_store_dwordx4 v12, v[8:11], s[2:3] offset:80
; GISEL-NEXT:    global_load_dwordx4 v[8:11], v12, s[0:1] offset:48
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mul_lo_u32 v10, v10, v10
; GISEL-NEXT:    v_mul_lo_u32 v8, v8, v8
; GISEL-NEXT:    v_mul_lo_u32 v9, v9, v9
; GISEL-NEXT:    v_mul_lo_u32 v11, v11, v11
; GISEL-NEXT:    global_store_dwordx4 v12, v[8:11], s[2:3] offset:48
...
; GISEL-NEXT:    global_load_dwordx4 v[0:3], v12, s[0:1]
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mul_lo_u32 v0, v0, v0
; GISEL-NEXT:    v_mul_lo_u32 v1, v1, v1
; GISEL-NEXT:    v_mul_lo_u32 v2, v2, v2
; GISEL-NEXT:    v_mul_lo_u32 v3, v3, v3
; GISEL-NEXT:    global_store_dwordx4 v12, v[0:3], s[2:3]
; GISEL-NEXT:    global_load_dwordx4 v[0:3], v12, s[0:1] offset:32
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mul_lo_u32 v0, v0, v0
; GISEL-NEXT:    v_mul_lo_u32 v1, v1, v1
; GISEL-NEXT:    v_mul_lo_u32 v2, v2, v2
; GISEL-NEXT:    v_mul_lo_u32 v3, v3, v3
; GISEL-NEXT:    global_store_dwordx4 v12, v[0:3], s[2:3] offset:32
; GISEL-NEXT:    global_store_dwordx4 v12, v[4:7], s[2:3] offset:64
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000020) size(1) SyncID(0)
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000002) size(2) SyncID(0)
; GISEL-NEXT:    ; sched_group_barrier mask(0x00000040) size(1) SyncID(0)
