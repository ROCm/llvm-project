...
; GFX1250-NEXT:    v_cmp_ne_u32_e64 s1, 1, v6
...
; GFX1250-NEXT:  .LBB28_2: ; %atomicrmw.end
...
; GFX1250-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_cmp_ne_u32_e64 s4, 1, v4
; GFX1250-NEXT:    s_xor_b32 s6, s4, exec_lo
; GFX1250-NEXT:    s_xor_b32 s5, exec_lo, s6
...
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    s_xor_b32 s5, exec_lo, s4
; GFX1250-NEXT:    s_and_b32 s5, s5, exec_lo
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    s_or_b32 s0, s0, s5
...
; GFX1250-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc_lo
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_cmp_ne_u32_e64 s1, 1, v4
; GFX1250-NEXT:    s_xor_b32 s3, s1, exec_lo
; GFX1250-NEXT:    s_xor_b32 s2, exec_lo, s3
; GFX1250-NEXT:    s_mov_b32 exec_lo, s3
; GFX1250-NEXT:    s_mov_b32 s3, 0
; GFX1250-NEXT:    ; divergent control-flow edge
...
; GFX1250-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:  .LBB62_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:  .LBB63_2: ; %atomicrmw.end
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
