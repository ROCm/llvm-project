...
; RUN:llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX1250,FAKE16 %s
; RUN:llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX1250,REAL16 %s
...
; GFX1250-NEXT:  .LBB34_1: ; %atomicrmw.check.private
; GFX1250-NEXT:    v_xor_b32_e32 v6, src_flat_scratch_base_hi, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_cmp_gt_u32_e64 s0, 0x4000000, v6
; GFX1250-NEXT:    s_xor_b32 exec_lo, s0, exec_lo
; GFX1250-NEXT:    ; divergent control-flow edge
; GFX1250-NEXT:    s_cbranch_execz .LBB34_3
; GFX1250-NEXT:  .LBB34_2: ; %atomicrmw.global
; GFX1250-NEXT:    global_atomic_add_f64 v[4:5], v[0:1], v[2:3], off th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1250-NEXT:  .LBB34_3:
...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_cndmask_b32_e64 v8, -1, v4, s0
; GFX1250-NEXT:    scratch_load_b64 v[4:5], v8, off
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_add_f64_e32 v[6:7], v[4:5], v[2:3]
; GFX1250-NEXT:    scratch_store_b64 v8, v[6:7], off
...
; GFX1250-NEXT:  .LBB34_6: ; %atomicrmw.shared
...
; GFX1250-NEXT:  .LBB35_1: ; %atomicrmw.check.private
; GFX1250-NEXT:    v_xor_b32_e32 v6, src_flat_scratch_base_hi, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_cmp_gt_u32_e64 s0, 0x4000000, v6
; GFX1250-NEXT:    s_xor_b32 exec_lo, s0, exec_lo
...
; GFX1250-NEXT:  .LBB35_2: ; %atomicrmw.global
; GFX1250-NEXT:    global_atomic_add_f64 v[4:5], v[0:1], v[2:3], off th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1250-NEXT:  .LBB35_3:
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    s_xor_b32 s1, exec_lo, s0
...
; GFX1250-NEXT:  .LBB35_6: ; %atomicrmw.shared
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    v_cndmask_b32_e32 v0, -1, v0, vcc_lo
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    ds_add_rtn_f64 v[4:5], v0, v[2:3]
...
; GFX1250-NEXT:  .LBB38_1: ; %atomicrmw.global
...
; GFX1250-NEXT:  .LBB38_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
...
; GFX1250-NEXT:  .LBB39_1: ; %atomicrmw.global
; GFX1250-NEXT:    flat_atomic_min_num_f64 v[4:5], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
...
; GFX1250-NEXT:  .LBB39_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB42_1: ; %atomicrmw.global
...
; GFX1250-NEXT:  .LBB42_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB43_1: ; %atomicrmw.global
; GFX1250-NEXT:    flat_atomic_max_num_f64 v[4:5], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
...
; GFX1250-NEXT:  .LBB43_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB52_1: ; %atomicrmw.global
...
; GFX1250-NEXT:  .LBB52_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB53_1: ; %atomicrmw.global
; GFX1250-NEXT:    flat_atomic_min_i64 v[4:5], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
...
; GFX1250-NEXT:  .LBB53_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB54_1: ; %atomicrmw.global
...
; GFX1250-NEXT:  .LBB54_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB55_1: ; %atomicrmw.global
; GFX1250-NEXT:    flat_atomic_max_i64 v[4:5], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
...
; GFX1250-NEXT:  .LBB55_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB56_1: ; %atomicrmw.global
...
; GFX1250-NEXT:  .LBB56_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB57_1: ; %atomicrmw.global
; GFX1250-NEXT:    flat_atomic_min_u64 v[4:5], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
...
; GFX1250-NEXT:  .LBB57_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB58_1: ; %atomicrmw.global
...
; GFX1250-NEXT:  .LBB58_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:  .LBB59_1: ; %atomicrmw.global
; GFX1250-NEXT:    flat_atomic_max_u64 v[4:5], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
...
; GFX1250-NEXT:  .LBB59_3: ; %atomicrmw.private
; GFX1250-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v4, src_flat_scratch_base_lo, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
