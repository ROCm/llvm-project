...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12,GFX12-GI
...
; GFX11-FAKE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v0, v0, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v0, v0, s0, 0x7fff
...
; GFX12-FAKE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v0, v0, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12-FAKE16-NEXT:    v_perm_b32 v0, v3, v0, 0x5040100
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v0, v0, s0, 0x7fff
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v0, v0
; GFX9-NEXT:    s_movk_i32 s4, 0x8000
; GFX9-NEXT:    v_mov_b32_e32 v8, 0x7fff
; GFX9-NEXT:    v_med3_i32 v4, v4, s4, v8
; GFX9-NEXT:    v_med3_i32 v5, v5, s4, v8
; GFX9-NEXT:    v_med3_i32 v6, v6, s4, v8
; GFX9-NEXT:    v_med3_i32 v7, v7, s4, v8
; GFX9-NEXT:    v_med3_i32 v3, v3, s4, v8
; GFX9-NEXT:    v_med3_i32 v2, v2, s4, v8
; GFX9-NEXT:    v_med3_i32 v1, v1, s4, v8
; GFX9-NEXT:    v_med3_i32 v0, v0, s4, v8
; GFX9-NEXT:    s_mov_b32 s4, 0x5040100
...
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v3, v3
; GFX11-FAKE16-NEXT:    s_movk_i32 s0, 0x8000
; GFX11-FAKE16-NEXT:    v_med3_i32 v4, v4, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v5, v5, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v6, v6, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v0, v0, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v7, v7, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v7, v0, 0x5040100
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v1, v6, 0x5040100
...
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v5, v5
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v0, v0.l
; GFX11-TRUE16-NEXT:    v_med3_i32 v1, v6, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v6, v8
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v7, v7
; GFX11-TRUE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v4, v4, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v5, v5, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v0, v0
; GFX11-TRUE16-NEXT:    v_med3_i32 v6, v6, s0, 0x7fff
; GFX11-TRUE16-NEXT:    v_med3_i32 v7, v7, s0, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, v5 :: v_dual_mov_b32 v3, v4
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:    s_movk_i32 s0, 0x8000
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    v_med3_i32 v4, v4, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v5, v5, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v6, v6, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v0, v0, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v7, v7, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX12-FAKE16-NEXT:    v_perm_b32 v0, v7, v0, 0x5040100
; GFX12-FAKE16-NEXT:    v_perm_b32 v1, v1, v6, 0x5040100
...
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v0, v0.l
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    v_med3_i32 v1, v6, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v6, v8
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v7, v7
; GFX12-TRUE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v4, v4, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v5, v5, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v0, v0
; GFX12-TRUE16-NEXT:    v_med3_i32 v6, v6, s0, 0x7fff
; GFX12-TRUE16-NEXT:    v_med3_i32 v7, v7, s0, 0x7fff
...
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v2, v5 :: v_dual_mov_b32 v3, v4
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
