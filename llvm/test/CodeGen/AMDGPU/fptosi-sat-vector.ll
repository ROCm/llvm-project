...
; RUN: llc < %s -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx700 | FileCheck %s --check-prefixes=GFX7,GFX7-ISEL
; RUN: llc < %s -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx700 | FileCheck %s --check-prefixes=GFX7,GFX7-GI
; RUN: llc < %s -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 | FileCheck %s --check-prefixes=GFX9
; RUN: llc < %s -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX11,GFX11-FAKE16
; RUN: llc < %s -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX11,GFX11-TRUE16
; RUN: llc < %s -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12,GFX12-ISEL,GFX12-FAKE16
; RUN: llc < %s -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12,GFX12-ISEL,GFX12-TRUE16
; RUN: llc < %s -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12,GFX12-GI
...
; GFX7-ISEL-NEXT:    s_mov_b32 s9, 0xc3e00000
; GFX7-ISEL-NEXT:    s_mov_b32 s10, -1
; GFX7-ISEL-NEXT:    s_mov_b32 s11, 0x43dfffff
; GFX7-ISEL-NEXT:    v_ldexp_f64 v[8:9], v[4:5], s4
; GFX7-ISEL-NEXT:    v_ldexp_f64 v[10:11], v[6:7], s4
; GFX7-ISEL-NEXT:    s_mov_b32 s4, 0
; GFX7-ISEL-NEXT:    v_cmp_nle_f64_e32 vcc, s[8:9], v[0:1]
; GFX7-ISEL-NEXT:    v_cmp_nle_f64_e64 s[8:9], s[8:9], v[2:3]
...
; GFX7-ISEL-NEXT:    v_cmp_lt_f64_e64 s[4:5], s[10:11], v[0:1]
; GFX7-ISEL-NEXT:    v_cmp_lt_f64_e64 s[10:11], s[10:11], v[2:3]
; GFX7-ISEL-NEXT:    v_cvt_i32_f64_e32 v15, v[10:11]
; GFX7-ISEL-NEXT:    v_cvt_i32_f64_e32 v14, v[8:9]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v15, v12, s[8:9]
; GFX7-ISEL-NEXT:    v_cvt_u32_f64_e32 v4, v[4:5]
; GFX7-ISEL-NEXT:    v_cvt_u32_f64_e32 v2, v[6:7]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v0, v13, s[10:11]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e32 v8, v14, v12, vcc
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v3, v0, 0, s[12:13]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v4, 0, vcc
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s[8:9]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s[4:5]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v0, -1, s[4:5]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v2, v2, -1, s[10:11]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v1, v8, 0, s[6:7]
...
; GFX9-NEXT:    s_mov_b32 s9, 0xc3e00000
; GFX9-NEXT:    s_mov_b32 s10, -1
; GFX9-NEXT:    s_mov_b32 s11, 0x43dfffff
; GFX9-NEXT:    v_ldexp_f64 v[8:9], v[4:5], s4
; GFX9-NEXT:    v_ldexp_f64 v[10:11], v[6:7], s4
; GFX9-NEXT:    s_mov_b32 s4, 0
; GFX9-NEXT:    v_cmp_nle_f64_e32 vcc, s[8:9], v[0:1]
; GFX9-NEXT:    v_cmp_nle_f64_e64 s[8:9], s[8:9], v[2:3]
...
; GFX9-NEXT:    v_cmp_lt_f64_e64 s[4:5], s[10:11], v[0:1]
; GFX9-NEXT:    v_cmp_lt_f64_e64 s[10:11], s[10:11], v[2:3]
; GFX9-NEXT:    v_cvt_i32_f64_e32 v15, v[10:11]
; GFX9-NEXT:    v_cvt_i32_f64_e32 v14, v[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v15, v12, s[8:9]
; GFX9-NEXT:    v_cvt_u32_f64_e32 v4, v[4:5]
; GFX9-NEXT:    v_cvt_u32_f64_e32 v2, v[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v13, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v14, v12, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v0, 0, s[12:13]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v4, 0, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, -1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, -1, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v8, 0, s[6:7]
...
; GFX7-ISEL-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[16:17], v[10:11]
...
; GFX7-ISEL-NEXT:    v_cmp_nge_f64_e64 s[6:7], s[18:19], v[8:9]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e32 v0, v14, v12, vcc
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v0, v13, s[4:5]
...
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v15, v12, s[6:7]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v0, v0, v13, s[8:9]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v3, v0, 0, s[12:13]
...
; GFX9-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[16:17], v[10:11]
...
; GFX9-NEXT:    v_cmp_nge_f64_e64 s[6:7], s[18:19], v[8:9]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v14, v12, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v13, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v0, 0, s[10:11]
; GFX9-NEXT:    v_cvt_u32_f64_e32 v2, v[4:5]
; GFX9-NEXT:    v_cvt_u32_f64_e32 v4, v[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v15, v12, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v13, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v0, 0, s[12:13]
...
; GFX11-TRUE16-NEXT:    v_med3_i16 v2.h, v1.l, -1, 0
...
; GFX12-TRUE16-NEXT:    v_med3_i16 v2.h, v1.l, -1, 0
...
; GFX11-TRUE16-NEXT:    v_med3_i16 v4.l, v1.l, -1, 0
; GFX11-TRUE16-NEXT:    v_med3_i16 v4.h, v2.l, -1, 0
; GFX11-TRUE16-NEXT:    v_cvt_i16_f16_e32 v1.l, v1.h
; GFX11-TRUE16-NEXT:    v_cvt_i16_f16_e32 v1.h, v2.h
; GFX11-TRUE16-NEXT:    v_cvt_i16_f16_e32 v2.l, v3.h
; GFX11-TRUE16-NEXT:    v_med3_i16 v2.h, v0.h, -1, 0
; GFX11-TRUE16-NEXT:    v_med3_i16 v0.l, v0.l, -1, 0
; GFX11-TRUE16-NEXT:    v_med3_i16 v6.l, v3.l, -1, 0
; GFX11-TRUE16-NEXT:    v_med3_i16 v3.l, v1.l, -1, 0
; GFX11-TRUE16-NEXT:    v_med3_i16 v5.l, v1.h, -1, 0
; GFX11-TRUE16-NEXT:    v_med3_i16 v7.l, v2.l, -1, 0
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v2.h
...
; GFX12-TRUE16-NEXT:    v_med3_i16 v4.l, v1.l, -1, 0
; GFX12-TRUE16-NEXT:    v_med3_i16 v4.h, v2.l, -1, 0
; GFX12-TRUE16-NEXT:    v_cvt_i16_f16_e32 v1.l, v1.h
; GFX12-TRUE16-NEXT:    v_cvt_i16_f16_e32 v1.h, v2.h
; GFX12-TRUE16-NEXT:    v_cvt_i16_f16_e32 v2.l, v3.h
; GFX12-TRUE16-NEXT:    v_med3_i16 v2.h, v0.h, -1, 0
; GFX12-TRUE16-NEXT:    v_med3_i16 v0.l, v0.l, -1, 0
; GFX12-TRUE16-NEXT:    v_med3_i16 v6.l, v3.l, -1, 0
; GFX12-TRUE16-NEXT:    v_med3_i16 v3.l, v1.l, -1, 0
; GFX12-TRUE16-NEXT:    v_med3_i16 v5.l, v1.h, -1, 0
; GFX12-TRUE16-NEXT:    v_med3_i16 v7.l, v2.l, -1, 0
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v2.h
...
; GFX12-ISEL-NEXT:    s_cvt_hi_f32_f16 s9, s3
; GFX12-ISEL-NEXT:    s_cvt_f32_f16 s0, s0
; GFX12-ISEL-NEXT:    s_cvt_f32_f16 s1, s1
...
; GFX12-ISEL-NEXT:    s_cvt_i32_f32 s9, s9
; GFX12-ISEL-NEXT:    s_cvt_i32_f32 s0, s0
; GFX12-ISEL-NEXT:    s_cvt_i32_f32 s1, s1
; GFX12-ISEL-NEXT:    s_cvt_i32_f32 s2, s2
; GFX12-ISEL-NEXT:    s_cvt_i32_f32 s3, s3
; GFX12-ISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-ISEL-NEXT:    s_ashr_i32 s7, s4, 31
; GFX12-ISEL-NEXT:    s_ashr_i32 s8, s5, 31
; GFX12-ISEL-NEXT:    s_ashr_i32 s10, s6, 31
; GFX12-ISEL-NEXT:    s_ashr_i32 s11, s9, 31
...
; GFX12-ISEL-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s7
; GFX12-ISEL-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, s13
; GFX12-ISEL-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v7, s8
...
; GFX12-ISEL-NEXT:    v_dual_mov_b32 v14, s9 :: v_dual_mov_b32 v15, s11
; GFX12-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
