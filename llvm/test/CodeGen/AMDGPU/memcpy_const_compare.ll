...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx90a < %s | FileCheck %s
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_add_u32 s2, s0, s6
; CHECK-NEXT:    s_addc_u32 s3, s1, s7
; CHECK-NEXT:    s_getpc_b64 s[0:1]
