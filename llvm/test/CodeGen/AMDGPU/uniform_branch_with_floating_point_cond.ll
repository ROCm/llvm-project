...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -stop-after=amdgpu-isel < %s | FileCheck %s
...
define void @test() {
  ...
  ; CHECK: bb.0.entry:
  ; CHECK-NEXT:   successors: %bb.5(0x50000000), %bb.1(0x30000000)
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   [[V_CMP_LT_F32_e64_:%[0-9]+]]:sreg_32 = nofpexcept V_CMP_LT_F32_e64 0, killed [[FLAT_LOAD_DWORD]], 0, killed [[S_MOV_B32_1]], 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 1092616192, implicit $exec
  ; CHECK-NEXT:   SI_BRCOND %bb.3, killed [[V_CMP_LT_F32_e64_]], implicit-def dead $exec, implicit-def dead $vcc, implicit $exec
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.3.bb3:
  ; CHECK-NEXT:   successors: %bb.4(0x50000000), %bb.5(0x30000000)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PHI:%[0-9]+]]:vgpr_32 = PHI [[V_MOV_B32_e32_]], %bb.1, [[V_MOV_B32_e32_1]], %bb.2
  ; CHECK-NEXT:   [[S_MOV_B32_2:%[0-9]+]]:sgpr_32 = S_MOV_B32 0
  ; CHECK-NEXT:   [[V_CMP_NEQ_F32_e64_:%[0-9]+]]:sreg_32 = nofpexcept V_CMP_NEQ_F32_e64 0, [[PHI]], 0, killed [[S_MOV_B32_2]], 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   SI_BRCOND %bb.5, killed [[V_CMP_NEQ_F32_e64_]], implicit-def dead $exec, implicit-def dead $vcc, implicit $exec
