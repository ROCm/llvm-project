...
; GFX8-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX8-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-NEXT:    v_lshlrev_b32_e32 v4, 5, v0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v0, s3
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, s2, v4
; GFX8-NEXT:    v_addc_u32_e32 v9, vcc, 0, v0, vcc
; GFX8-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, s4, v4
; GFX8-NEXT:    v_addc_u32_e32 v13, vcc, 0, v5, vcc
...
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, v10, v14
; GFX8-NEXT:    v_subb_u32_e32 v3, vcc, v11, v15, vcc
; GFX8-NEXT:    v_mov_b32_e32 v7, s1
; GFX8-NEXT:    v_sub_u32_e32 v0, vcc, v8, v12
; GFX8-NEXT:    v_mov_b32_e32 v6, s0
; GFX8-NEXT:    v_subb_u32_e32 v1, vcc, v9, v13, vcc
