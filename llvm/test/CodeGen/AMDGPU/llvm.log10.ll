...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX689,SI,GFX689-SDAG,SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX689,SI,GFX689-GISEL,SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck  -check-prefixes=GFX689,VI,GFX689-SDAG,VI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck  -check-prefixes=GFX689,VI,GFX689-GISEL,VI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX689,GFX900,GFX689-SDAG,GFX900-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX689,GFX900,GFX689-GISEL,GFX900-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1100,GFX1100-SDAG,GFX1100-SDAG-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1100,GFX1100-SDAG,GFX1100-SDAG-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1100,GFX1100-GISEL,GFX1100-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1100,GFX1100-GISEL,GFX1100-GISEL-FAKE16 %s
...
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, 0x800000
; SI-SDAG-NEXT:    v_mov_b32_e32 v1, 0x411a209b
; SI-SDAG-NEXT:    s_mov_b32 s6, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s7, -1
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-SDAG-NEXT:    s_mov_b32 s2, s7
; SI-SDAG-NEXT:    s_mov_b32 s3, s6
; SI-SDAG-NEXT:    s_and_b64 s[6:7], vcc, exec
; SI-SDAG-NEXT:    s_mov_b32 s5, 0x3e9a209a
; SI-SDAG-NEXT:    v_mul_f32_e32 v4, 0x3e9a209a, v3
; SI-SDAG-NEXT:    s_cselect_b32 s6, 32, 0
; SI-SDAG-NEXT:    v_fma_f32 v5, v3, s5, -v4
...
; SI-SDAG-NEXT:    v_fma_f32 v3, v5, s5, -v2
...
; SI-SDAG-NEXT:    v_mov_b32_e32 v3, s7
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v3, s5, v3
; SI-SDAG-NEXT:    v_log_f32_e32 v3, v3
...
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v6, s4, v6
; SI-SDAG-NEXT:    v_fma_f32 v5, v3, s10, v5
...
; SI-SDAG-NEXT:    s_cselect_b32 s4, 32, 0
; SI-SDAG-NEXT:    v_fma_f32 v4, v6, s7, -v3
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s4
; SI-SDAG-NEXT:    v_fma_f32 v4, v6, s10, v4
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v0, s6, v0
...
; SI-SDAG-NEXT:    v_fma_f32 v5, v4, s7, -v3
; SI-SDAG-NEXT:    v_fma_f32 v5, v4, s10, v5
...
; SI-SDAG-NEXT:    v_mul_f32_e32 v4, 0x3e9a209a, v3
; SI-SDAG-NEXT:    s_cselect_b32 s7, 32, 0
; SI-SDAG-NEXT:    v_fma_f32 v5, v3, s10, -v4
; SI-SDAG-NEXT:    v_mov_b32_e32 v6, s7
; SI-SDAG-NEXT:    v_fma_f32 v5, v3, s11, v5
; SI-SDAG-NEXT:    s_mov_b32 s12, 0x7f800000
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v6, s6, v6
; SI-SDAG-NEXT:    v_add_f32_e32 v4, v4, v5
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v5, 0, v1, vcc
; SI-SDAG-NEXT:    v_log_f32_e32 v6, v6
; SI-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v3|, s12
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v3, v3, v4, vcc
; SI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s5, v0
; SI-SDAG-NEXT:    s_and_b64 s[6:7], vcc, exec
; SI-SDAG-NEXT:    s_cselect_b32 s6, 32, 0
...
; SI-SDAG-NEXT:    s_cselect_b32 s5, 32, 0
; SI-SDAG-NEXT:    v_fma_f32 v6, v7, s10, -v5
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; SI-SDAG-NEXT:    v_mov_b32_e32 v1, s5
; SI-SDAG-NEXT:    v_fma_f32 v6, v7, s11, v6
; SI-SDAG-NEXT:    v_ldexp_f32_e32 v1, s4, v1
; SI-SDAG-NEXT:    v_add_f32_e32 v5, v5, v6
; SI-SDAG-NEXT:    v_log_f32_e32 v6, v1
; SI-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v7|, s12
...
; SI-SDAG-NEXT:    v_fma_f32 v5, v6, s10, -v4
; SI-SDAG-NEXT:    v_fma_f32 v5, v6, s11, v5
; SI-SDAG-NEXT:    v_add_f32_e32 v4, v4, v5
; SI-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v6|, s12
