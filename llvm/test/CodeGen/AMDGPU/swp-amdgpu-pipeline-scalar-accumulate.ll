; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -amdgpu-enable-pipeliner --verify-machineinstrs -pass-remarks-analysis=pipeliner %s -o /dev/null 2>&1 | FileCheck %s
