...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00--amdpal -enable-ipra=0 < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10--amdpal -enable-ipra=0 < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00--amdpal -enable-ipra=0 < %s | FileCheck --check-prefix=GFX11 %s
