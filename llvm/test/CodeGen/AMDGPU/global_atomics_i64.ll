...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=bonaire -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=CI %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=GFX12 %s
...
; CI-NEXT:    s_mov_b32 s4, 0xf000
; CI-NEXT:    s_mov_b32 s5, -1
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_mov_b32_e32 v0, s2
; CI-NEXT:    v_mov_b32_e32 v1, s3
; CI-NEXT:    s_mov_b32 s2, s5
; CI-NEXT:    s_mov_b32 s3, s4
...
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_add_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
...
; CI-NEXT:    buffer_atomic_add_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_and_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_and_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_sub_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_sub_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_smax_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_smax_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_umax_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_umax_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_smin_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_smin_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_umin_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_umin_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_or_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_or_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_swap_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_swap_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    s_mov_b64 s[8:9], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    buffer_atomic_xor_x2 v[0:1], v[2:3], s[8:11], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    buffer_atomic_xor_x2 v[0:1], v[2:3], s[8:11], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s10, -1
; CI-NEXT:    s_mov_b32 s8, s2
...
; CI-NEXT:    buffer_atomic_cmpswap_x2 v[0:3], off, s[8:11], 0 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s8, s2
; CI-NEXT:    s_mov_b32 s9, s3
...
; VI-NEXT:    buffer_atomic_cmpswap_x2 v[0:3], off, s[8:11], 0 offset:32 glc
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    buffer_wbinvl1_vol
...
; CI-NEXT:    s_mov_b64 s[0:1], s[8:9]
; CI-NEXT:    v_mov_b32_e32 v0, s12
; CI-NEXT:    v_mov_b32_e32 v1, s13
; CI-NEXT:    v_mov_b32_e32 v2, s4
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    v_mov_b32_e32 v5, s7
; CI-NEXT:    buffer_atomic_cmpswap_x2 v[0:3], v[4:5], s[0:3], 0 addr64 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
...
; CI-NEXT:    v_mov_b32_e32 v3, s5
; CI-NEXT:    v_mov_b32_e32 v5, s7
; CI-NEXT:    buffer_atomic_cmpswap_x2 v[0:3], v[4:5], s[0:3], 0 addr64 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s2, -1
; CI-NEXT:    s_mov_b32 s0, s10
...
; CI-NEXT:    s_mov_b32 s4, s0
; CI-NEXT:    s_mov_b32 s5, s1
; CI-NEXT:    buffer_load_dwordx2 v[0:1], off, s[4:7], 0 offset:32 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_wbinvl1_vol
; CI-NEXT:    s_mov_b32 s4, s2
; CI-NEXT:    s_mov_b32 s5, s3
...
; CI-NEXT:    s_mov_b32 s6, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_lshl_b64 s[8:9], s[4:5], 3
; CI-NEXT:    v_mov_b32_e32 v0, s8
; CI-NEXT:    s_mov_b64 s[4:5], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v1, s9
