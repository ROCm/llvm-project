...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.04 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=CI %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=GFX12 %s
