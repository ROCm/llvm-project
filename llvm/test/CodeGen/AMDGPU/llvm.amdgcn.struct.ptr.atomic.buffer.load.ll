...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.50 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.50 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-FAKE16
...
; GFX11-NEXT:    v_cmp_eq_u32_e64 s5, v2, v0
...
; GFX12-NEXT:    v_cmp_eq_u32_e64 s5, v2, v0
...
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    buffer_load_b32 v2, v1, s[0:3], s4 idxen offset:4 th:TH_LOAD_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_cmp_eq_u32_e64 s6, v2, v0
...
; GFX11-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX11-GISEL-TRUE16-NEXT:    s_xor_b32 s2, exec_lo, s1
; GFX11-GISEL-TRUE16-NEXT:    s_or_b32 s0, s0, s2
; GFX11-GISEL-TRUE16-NEXT:    s_mov_b32 exec_lo, s1
; GFX11-GISEL-TRUE16-NEXT:    ; divergent control-flow edge
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_execnz .LBB5_1
; GFX11-GISEL-TRUE16-NEXT:  .LBB5_2: ; %bb2
...
; GFX11-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX11-GISEL-FAKE16-NEXT:    s_xor_b32 s2, exec_lo, s1
; GFX11-GISEL-FAKE16-NEXT:    s_or_b32 s0, s0, s2
; GFX11-GISEL-FAKE16-NEXT:    s_mov_b32 exec_lo, s1
; GFX11-GISEL-FAKE16-NEXT:    ; divergent control-flow edge
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_execnz .LBB5_1
; GFX11-GISEL-FAKE16-NEXT:  .LBB5_2: ; %bb2
...
; GFX11-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX12-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX12-GISEL-TRUE16-NEXT:    s_xor_b32 s2, exec_lo, s1
; GFX12-GISEL-TRUE16-NEXT:    s_or_b32 s0, s0, s2
; GFX12-GISEL-TRUE16-NEXT:    s_mov_b32 exec_lo, s1
...
; GFX12-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX12-GISEL-FAKE16-NEXT:    s_xor_b32 s2, exec_lo, s1
; GFX12-GISEL-FAKE16-NEXT:    s_or_b32 s0, s0, s2
; GFX12-GISEL-FAKE16-NEXT:    s_mov_b32 exec_lo, s1
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cmp_eq_u64_e64 s5, v[3:4], v[0:1]
; GFX11-NEXT:    s_xor_b32 s6, exec_lo, s5
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s4, s4, s6
; GFX11-NEXT:    s_mov_b32 exec_lo, s5
...
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_cmp_eq_u64_e64 s5, v[4:5], v[0:1]
...
; GFX12-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    v_cmp_eq_u64_e64 s5, v[4:5], v[0:1]
...
; GFX12-GISEL-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-TRUE16-NEXT:    v_cmp_eq_u64_e64 s5, v[4:5], v[0:1]
...
; GFX12-GISEL-TRUE16-NEXT:  .LBB6_2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    v_cmp_eq_u64_e64 s5, v[4:5], v[0:1]
...
; GFX12-GISEL-FAKE16-NEXT:  .LBB6_2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
bb:
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX11-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e64 s5, s5, v0
; GFX11-GISEL-TRUE16-NEXT:    s_xor_b32 s6, exec_lo, s5
; GFX11-GISEL-TRUE16-NEXT:    s_or_b32 s4, s4, s6
; GFX11-GISEL-TRUE16-NEXT:    s_mov_b32 exec_lo, s5
; GFX11-GISEL-TRUE16-NEXT:    ; divergent control-flow edge
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_execnz .LBB8_1
; GFX11-GISEL-TRUE16-NEXT:  .LBB8_2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e64 s5, s5, v0
; GFX11-GISEL-FAKE16-NEXT:    s_xor_b32 s6, exec_lo, s5
; GFX11-GISEL-FAKE16-NEXT:    s_or_b32 s4, s4, s6
; GFX11-GISEL-FAKE16-NEXT:    s_mov_b32 exec_lo, s5
; GFX11-GISEL-FAKE16-NEXT:    ; divergent control-flow edge
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_execnz .LBB8_1
; GFX11-GISEL-FAKE16-NEXT:  .LBB8_2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:  .LBB8_2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:  .LBB8_2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
bb:
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
  br label %bb1
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cmp_eq_u32_e64 s5, v5, v0
; GFX11-NEXT:    s_xor_b32 s6, exec_lo, s5
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s4, s4, s6
; GFX11-NEXT:    s_mov_b32 exec_lo, s5
