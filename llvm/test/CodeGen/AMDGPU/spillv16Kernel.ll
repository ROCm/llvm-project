...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=+real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX1250-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=-real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX1250-FAKE16
...
; GFX1250-TRUE16-NEXT:    scratch_load_u16 v1, off, off offset:2 nv ; 2-byte Folded Reload
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-FAKE16-NEXT:    scratch_load_b32 v0, off, off offset:4 nv ; 4-byte Folded Reload
; GFX1250-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
