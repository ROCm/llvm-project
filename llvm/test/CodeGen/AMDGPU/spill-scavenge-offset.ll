...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=verde -enable-misched=0 -post-RA-scheduler=0 -amdgpu-spill-sgpr-to-vgpr=0 < %s | FileCheck -check-prefixes=CHECK,GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -sgpr-regalloc=basic -vgpr-regalloc=basic -mtriple=amdgcn -mcpu=tonga -enable-misched=0 -post-RA-scheduler=0 -amdgpu-spill-sgpr-to-vgpr=0 < %s | FileCheck --check-prefix=CHECK %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mattr=-xnack,+enable-flat-scratch -mcpu=gfx900 -enable-misched=0 -post-RA-scheduler=0 -amdgpu-spill-sgpr-to-vgpr=0 < %s | FileCheck -check-prefixes=CHECK,GFX9-FLATSCR,FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1030 -enable-misched=0 -post-RA-scheduler=0 -amdgpu-spill-sgpr-to-vgpr=0 -mattr=+enable-flat-scratch < %s | FileCheck -check-prefixes=CHECK,GFX10-FLATSCR,FLATSCR %s
;
...
; GFX6-NEXT:    s_mov_b32 s8, 0x84000
...
; GFX6-NEXT:    s_mov_b32 s10, 0x84400
...
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    s_mov_b64 exec, s[6:7]
; GFX6-NEXT:    s_mov_b64 s[34:35], s[4:5]
...
; GFX6-NEXT:    ;;#ASMEND
; GFX6-NEXT:    s_mov_b32 s0, 0x80400
...
; GFX6-NEXT:    v_mov_b32_e32 v2, v14
; GFX6-NEXT:    v_mov_b32_e32 v3, v15
...
; GFX6-NEXT:    v_mov_b32_e32 v15, v3
; GFX6-NEXT:    s_mov_b32 s0, 0x80400
; GFX6-NEXT:    v_mov_b32_e32 v14, v2
; GFX6-NEXT:    v_mov_b32_e32 v13, v1
; GFX6-NEXT:    v_mov_b32_e32 v12, v0
...
; GFX6-NEXT:    s_mov_b64 exec, 15
; GFX6-NEXT:    buffer_store_dword v4, off, s[40:43], 0
; GFX6-NEXT:    s_mov_b32 s6, 0x84000
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NEXT:    s_mov_b64 exec, 15
; GFX6-NEXT:    buffer_store_dword v4, off, s[40:43], 0
; GFX6-NEXT:    s_mov_b32 s6, 0x84400
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    buffer_load_dword v4, off, s[40:43], s6 ; 4-byte Folded Reload
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_readlane_b32 s0, v4, 0
...
; GFX6-NEXT:    buffer_load_dword v9, off, s[40:43], s0 offset:8 ; 4-byte Folded Reload
; GFX6-NEXT:    buffer_load_dword v10, off, s[40:43], s0 offset:12 ; 4-byte Folded Reload
; GFX6-NEXT:    s_mov_b32 s0, 0x80800
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_store_dwordx4 v[7:10], v[5:6], s[36:39], 0 addr64 offset:64
; GFX6-NEXT:    buffer_store_dwordx4 v[16:19], v[5:6], s[36:39], 0 addr64 offset:48
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], v[5:6], s[36:39], 0 addr64 offset:32
; GFX6-NEXT:    s_waitcnt expcnt(2)
; GFX6-NEXT:    buffer_load_dword v7, off, s[40:43], s0 ; 4-byte Folded Reload
; GFX6-NEXT:    buffer_load_dword v8, off, s[40:43], s0 offset:4 ; 4-byte Folded Reload
; GFX6-NEXT:    buffer_load_dword v9, off, s[40:43], s0 offset:8 ; 4-byte Folded Reload
...
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 ; 16-byte Folded Spill
; GFX9-FLATSCR-NEXT:    global_load_dwordx4 v[0:3], v5, s[38:39] offset:176
...
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 ; 16-byte Folded Spill
; GFX9-FLATSCR-NEXT:    global_load_dwordx4 v[0:3], v5, s[38:39] offset:128
...
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 ; 16-byte Folded Spill
; GFX9-FLATSCR-NEXT:    global_load_dwordx4 v[15:18], v5, s[38:39] offset:96
...
; GFX9-FLATSCR-NEXT:    global_store_dwordx4 v5, v[15:18], s[36:37] offset:96
; GFX9-FLATSCR-NEXT:    scratch_load_dwordx4 v[15:18], off, s0 ; 16-byte Folded Reload
; GFX9-FLATSCR-NEXT:    s_movk_i32 s0, 0x20b0
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; GFX9-FLATSCR-NEXT:    global_store_dwordx4 v5, v[15:18], s[36:37] offset:80
; GFX9-FLATSCR-NEXT:    global_store_dwordx4 v5, v[11:14], s[36:37] offset:64
; GFX9-FLATSCR-NEXT:    scratch_load_dwordx4 v[11:14], off, s0 ; 16-byte Folded Reload
; GFX9-FLATSCR-NEXT:    s_movk_i32 s0, 0x20a0
; GFX9-FLATSCR-NEXT:    scratch_load_dwordx4 v[6:9], off, s0 ; 16-byte Folded Reload
; GFX9-FLATSCR-NEXT:    s_movk_i32 s0, 0x2090
...
; GFX9-FLATSCR-NEXT:    global_store_dwordx4 v5, v[0:3], s[36:37]
; GFX9-FLATSCR-NEXT:    scratch_load_dwordx4 v[0:3], off, s0 ; 16-byte Folded Reload
; GFX9-FLATSCR-NEXT:    s_movk_i32 s0, 0x2070
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; GFX9-FLATSCR-NEXT:    global_store_dwordx4 v5, v[0:3], s[36:37] offset:240
; GFX9-FLATSCR-NEXT:    scratch_load_dwordx4 v[0:3], off, s0 ; 16-byte Folded Reload
; GFX9-FLATSCR-NEXT:    s_movk_i32 s0, 0x2060
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-FLATSCR-NEXT:    ;;#ASMEND
; GFX10-FLATSCR-NEXT:    ;;#ASMSTART
; GFX10-FLATSCR-NEXT:    ; def s33
; GFX10-FLATSCR-NEXT:    ;;#ASMEND
; GFX10-FLATSCR-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
...
; GFX10-FLATSCR-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
; GFX10-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
