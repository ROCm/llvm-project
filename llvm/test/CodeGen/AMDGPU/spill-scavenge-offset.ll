...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 --amdgpu-xnack=false -mattr=+enable-flat-scratch -enable-misched=0 -post-RA-scheduler=0 -amdgpu-spill-sgpr-to-vgpr=0 < %s | FileCheck -check-prefixes=CHECK,GFX9-FLATSCR,FLATSCR %s
...
; GFX9-FLATSCR-NEXT:    s_waitcnt vmcnt(0)
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 ; 16-byte Folded Spill
; GFX9-FLATSCR-NEXT:    global_load_dwordx4 v[7:10], v5, s[38:39] offset:32
...
; GFX9-FLATSCR-NEXT:    global_store_dwordx4 v5, v[7:10], s[36:37] offset:32
