...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx908 < %s | FileCheck -enable-var-scope -check-prefixes=GFX908 %s
...
; GFX908-NEXT:    v_accvgpr_write_b32 a2, v6
; GFX908-NEXT:    v_accvgpr_write_b32 a3, v7
; GFX908-NEXT:    v_accvgpr_write_b32 a4, v8
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
