...
; RUN: llc -amdgpu-late-wave-transform=1 -march=amdgcn < %s | FileCheck -check-prefixes=SI,GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -march=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=VI,GCN %s
