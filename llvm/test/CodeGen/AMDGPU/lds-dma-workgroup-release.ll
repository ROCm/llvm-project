...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck %s --check-prefixes=GFX900
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a < %s | FileCheck %s --check-prefixes=GFX90A
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -mattr=+tgsplit < %s | FileCheck %s --check-prefixes=GFX90A-TGSPLIT
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck %s --check-prefixes=GFX942
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx942 -mattr=+tgsplit < %s | FileCheck %s --check-prefixes=GFX942-TGSPLIT
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck %s -check-prefixes=GFX10WGP
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+cumode < %s | FileCheck %s -check-prefixes=GFX10CU
...
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x3c
...
; GFX900-NEXT:    s_nop 0
; GFX900-NEXT:    buffer_load_dword v1, s[8:11], 0 offen lds
...
; GFX10WGP-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x3c
; GFX10WGP-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x24
...
; GFX10WGP-NEXT:    buffer_load_dword v1, s[8:11], 0 offen lds
; GFX10WGP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10CU-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x3c
; GFX10CU-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x24
...
; GFX10CU-NEXT:    buffer_load_dword v1, s[8:11], 0 offen lds
; GFX10CU-NEXT:    s_waitcnt vmcnt(0)
