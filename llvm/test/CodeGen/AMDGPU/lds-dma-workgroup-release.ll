...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck %s --check-prefixes=GFX900
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx90a < %s | FileCheck %s --check-prefixes=GFX90A
; RUN: sed 's/attributes #0 = { nounwind }/attributes #0 = { nounwind "amdgpu-tg-split" }/' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx90a | FileCheck %s --check-prefixes=GFX90A-TGSPLIT
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 < %s | FileCheck %s --check-prefixes=GFX942
; RUN: sed 's/attributes #0 = { nounwind }/attributes #0 = { nounwind "amdgpu-tg-split" }/' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 | FileCheck %s --check-prefixes=GFX942-TGSPLIT
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 < %s | FileCheck %s -check-prefixes=GFX10WGP
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 -mattr=+cumode < %s | FileCheck %s -check-prefixes=GFX10CU
...
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x18
...
; GFX900-NEXT:    s_nop 0
; GFX900-NEXT:    buffer_load_dword v1, s[4:7], 0 offen lds
...
; GFX90A-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x18
...
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    buffer_load_dword v1, s[4:7], 0 offen lds
...
; GFX90A-TGSPLIT-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x18
; GFX90A-TGSPLIT-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v1, 0x800
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v0, 0
; GFX90A-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 m0, s10
; GFX90A-TGSPLIT-NEXT:    s_nop 0
; GFX90A-TGSPLIT-NEXT:    buffer_load_dword v1, s[4:7], 0 offen lds
...
; GFX10WGP-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x18
; GFX10WGP-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x0
...
; GFX10WGP-NEXT:    buffer_load_dword v1, s[4:7], 0 offen lds
; GFX10WGP-NEXT:    s_waitcnt vmcnt(0)
; GFX10WGP-NEXT:    global_store_dword v0, v2, s[0:1]
; GFX10WGP-NEXT:    global_load_dword v1, v0, s[0:1] glc
; GFX10WGP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10WGP-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX10WGP-NEXT:    s_endpgm
;
...
; GFX10CU-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x18
; GFX10CU-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x0
...
; GFX10CU-NEXT:    buffer_load_dword v1, s[4:7], 0 offen lds
; GFX10CU-NEXT:    s_waitcnt vmcnt(0)
; GFX10CU-NEXT:    global_store_dword v0, v2, s[0:1]
; GFX10CU-NEXT:    global_load_dword v1, v0, s[0:1]
; GFX10CU-NEXT:    s_waitcnt vmcnt(0)
; GFX10CU-NEXT:    v_mov_b32_e32 v1, s11
; GFX10CU-NEXT:    ds_read_b32 v1, v1
; GFX10CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10CU-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX10CU-NEXT:    s_endpgm
                                       ptr addrspace(3) inreg %lds1,
                                       ptr addrspace(3) inreg %lds2,
