...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck %s --check-prefixes=GFX900
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdhsa < %s | FileCheck %s --check-prefixes=GFX90A
; RUN: sed 's/attributes #0 = { nounwind }/attributes #0 = { nounwind "amdgpu-tg-split" }/' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdhsa | FileCheck %s --check-prefixes=GFX90A-TGSPLIT
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 < %s | FileCheck %s --check-prefixes=GFX942
; RUN: sed 's/attributes #0 = { nounwind }/attributes #0 = { nounwind "amdgpu-tg-split" }/' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42-amd-amdhsa | FileCheck %s --check-prefixes=GFX942-TGSPLIT
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa < %s | FileCheck %s -check-prefixes=GFX10WGP
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa -mattr=+cumode < %s | FileCheck %s -check-prefixes=GFX10CU
