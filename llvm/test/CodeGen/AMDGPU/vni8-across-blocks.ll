...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42 < %s | FileCheck --check-prefix=GFX942 %s
...
; GFX942-NEXT:    s_mov_b32 s0, 0xff0000
; GFX942-NEXT:    v_cmp_lt_u32_e32 vcc, 14, v0
...
; GFX942-NEXT:    v_and_or_b32 v3, v0, s0, v2
...
; GFX942-NEXT:    v_cmp_lt_u32_e32 vcc, 14, v2
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-NEXT:    v_cmp_lt_u32_e64 s[0:1], 6, v2
...
; GFX942-NEXT:    v_lshrrev_b32_e32 v8, 8, v1
; GFX942-NEXT:    v_lshrrev_b32_e32 v9, 24, v0
...
; GFX942-NEXT:    v_cmp_lt_u32_e64 s[0:1], 6, v4
; GFX942-NEXT:    v_mov_b32_e32 v6, 8
; GFX942-NEXT:    v_mov_b32_e32 v7, 7
; GFX942-NEXT:    v_mov_b32_e32 v8, 6
; GFX942-NEXT:    v_mov_b32_e32 v1, 5
; GFX942-NEXT:    v_mov_b32_e32 v9, 4
; GFX942-NEXT:    v_mov_b32_e32 v10, 3
; GFX942-NEXT:    v_mov_b32_e32 v11, 2
; GFX942-NEXT:    v_mov_b32_e32 v0, 1
; GFX942-NEXT:    s_xor_b64 s[2:3], s[0:1], exec
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshrrev_b32_e32 v17, 24, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v15, 16, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v16, 8, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v14, 24, v2
; GFX942-NEXT:    v_lshrrev_b32_e32 v13, 16, v2
...
; GFX942-NEXT:  .LBB10_3: ; %bb.2
; GFX942-NEXT:    s_mov_b32 s2, 0xc0c0004
; GFX942-NEXT:    v_perm_b32 v2, v0, v11, s2
; GFX942-NEXT:    v_perm_b32 v3, v10, v9, s2
; GFX942-NEXT:    v_lshl_or_b32 v2, v3, 16, v2
; GFX942-NEXT:    v_perm_b32 v3, v1, v8, s2
; GFX942-NEXT:    v_perm_b32 v4, v7, v6, s2
; GFX942-NEXT:    v_lshl_or_b32 v3, v4, 16, v3
...
; GFX942-NEXT:    v_mov_b32_e32 v17, v6
; GFX942-NEXT:  .LBB10_4: ; %bb.3
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_mov_b32 s0, 0xc0c0004
; GFX942-NEXT:    v_perm_b32 v0, v2, v12, s0
; GFX942-NEXT:    v_perm_b32 v1, v13, v14, s0
; GFX942-NEXT:    v_lshl_or_b32 v0, v1, 16, v0
; GFX942-NEXT:    v_perm_b32 v1, v3, v16, s0
; GFX942-NEXT:    v_perm_b32 v2, v15, v17, s0
...
; GFX942-NEXT:  .LBB11_1: ; %bb.1
; GFX942-NEXT:    v_lshlrev_b32_e32 v4, 3, v0
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v4, s[10:11]
; GFX942-NEXT:    v_cmp_lt_u32_e64 s[0:1], 6, v0
; GFX942-NEXT:    s_xor_b64 exec, s[0:1], exec
; GFX942-NEXT:    ; divergent control-flow edge
; GFX942-NEXT:    s_cbranch_execz .LBB11_3
; GFX942-NEXT:  .LBB11_2: ; %bb.2
; GFX942-NEXT:    v_mov_b32_e32 v0, 0
; GFX942-NEXT:    global_store_dwordx2 v0, v[2:3], s[12:13]
; GFX942-NEXT:  .LBB11_3: ; %bb.3
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    global_store_dwordx2 v1, v[4:5], s[14:15]
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
  %gep1 = getelementptr <8 x i8>, ptr addrspace(1) %src1, i32 %idx
...
; GFX942-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX942-NEXT:    v_lshlrev_b32_e32 v0, 3, v2
; GFX942-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x44
; GFX942-NEXT:    v_cmp_lt_u32_e32 vcc, 14, v2
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v0, s[8:9]
; GFX942-NEXT:    s_xor_b64 s[0:1], vcc, exec
...
; GFX942-NEXT:  .LBB13_1: ; %bb.1
; GFX942-NEXT:    s_movk_i32 s0, 0xff00
; GFX942-NEXT:    v_mov_b32_e32 v6, 8
; GFX942-NEXT:    v_and_b32_sdwa v5, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    v_lshlrev_b16_sdwa v6, v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    s_mov_b32 s0, 0x6070504
...
; GFX942-NEXT:    v_perm_b32 v7, v0, v0, s0
; GFX942-NEXT:    v_cmp_lt_u32_e64 s[0:1], 6, v2
; GFX942-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX942-NEXT:    s_mov_b32 s4, 0xc0c0001
...
; GFX942-NEXT:    v_perm_b32 v6, 0, v0, s4
; GFX942-NEXT:    s_mov_b32 s5, 0xffff0000
; GFX942-NEXT:    v_perm_b32 v1, 0, v1, s4
; GFX942-NEXT:    v_and_or_b32 v7, v0, s5, v6
...
; GFX942-NEXT:    s_movk_i32 s1, 0xff00
...
; GFX942-NEXT:    v_and_b32_sdwa v2, v0, s1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX942-NEXT:    v_and_b32_sdwa v7, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX942-NEXT:    global_store_dword v1, v3, s[2:3]
; GFX942-NEXT:    global_store_dword v1, v0, s[2:3] offset:8
; GFX942-NEXT:    global_store_dword v1, v4, s[2:3] offset:16
; GFX942-NEXT:    global_store_dword v1, v2, s[2:3] offset:24
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
  %gep1 = getelementptr <8 x i8>, ptr addrspace(1) %src1, i32 %idx
