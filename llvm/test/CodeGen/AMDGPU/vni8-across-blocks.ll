...
; GFX942-NEXT:    v_cmp_lt_u32_e32 vcc, 6, v0
...
; GFX942-NEXT:    v_cmp_lt_u32_e32 vcc, 6, v4
; GFX942-NEXT:    s_xor_b64 s[2:3], vcc, exec
...
; GFX942-NEXT:    s_or_b64 s[2:3], s[0:1], s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshrrev_b32_e32 v12, 24, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v4, 16, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v13, 8, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v15, 24, v2
; GFX942-NEXT:    v_lshrrev_b32_e32 v14, 16, v2
; GFX942-NEXT:    v_lshrrev_b32_e32 v16, 8, v2
; GFX942-NEXT:  .LBB10_2:
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_xor_b64 s[0:1], exec, s[2:3]
; GFX942-NEXT:    s_mov_b64 exec, s[2:3]
...
; GFX942-NEXT:    v_mov_b32_e32 v16, v11
...
; GFX942-NEXT:    v_perm_b32 v0, v2, v16, s0
; GFX942-NEXT:    v_perm_b32 v1, v14, v15, s0
; GFX942-NEXT:    v_lshl_or_b32 v0, v1, 16, v0
; GFX942-NEXT:    v_perm_b32 v1, v3, v13, s0
; GFX942-NEXT:    v_perm_b32 v2, v4, v12, s0
; GFX942-NEXT:    v_mov_b32_e32 v5, 0
; GFX942-NEXT:    v_lshl_or_b32 v1, v2, 16, v1
; GFX942-NEXT:    global_store_dwordx2 v5, v[0:1], s[14:15]
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
  %gep1 = getelementptr <8 x i8>, ptr addrspace(1) %src1, i32 %idx
...
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v0, s[8:9]
; GFX942-NEXT:    s_xor_b64 s[6:7], s[2:3], exec
...
; GFX942-NEXT:    v_mov_b32_e32 v6, 8
; GFX942-NEXT:    s_movk_i32 s4, 0xff00
...
; GFX942-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
...
; GFX942-NEXT:    s_or_b64 exec, exec, vcc
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_pk_fma_f32 v[2:3], v[2:3], v[2:3], v[2:3]
; GFX942-NEXT:    global_store_dwordx2 v1, v[2:3], s[6:7]
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
