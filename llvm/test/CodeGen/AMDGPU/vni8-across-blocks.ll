...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v2, v0, v0, s4
; GFX942-NEXT:  .LBB0_2: ; %bb.2
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    global_store_byte_d16_hi v1, v2, s[6:7] offset:2
; GFX942-NEXT:    global_store_short v1, v2, s[6:7]
...
; GFX942-NEXT:    s_mov_b32 s1, 0x40c0c
; GFX942-NEXT:    v_perm_b32 v2, v0, v10, s0
; GFX942-NEXT:    v_perm_b32 v3, v9, v8, s1
; GFX942-NEXT:    v_or_b32_e32 v2, v2, v3
; GFX942-NEXT:    v_perm_b32 v3, v1, v7, s0
; GFX942-NEXT:    v_perm_b32 v11, v6, v5, s1
; GFX942-NEXT:    v_mov_b32_e32 v4, 0
; GFX942-NEXT:    v_or_b32_e32 v3, v3, v11
...
; GFX942-NEXT:    v_perm_b32 v1, v11, v13, s1
; GFX942-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX942-NEXT:    v_perm_b32 v1, v3, v14, s0
; GFX942-NEXT:    v_perm_b32 v2, v15, v16, s1
; GFX942-NEXT:    v_mov_b32_e32 v4, 0
...
; GFX942-NEXT:    v_perm_b32 v4, v0, v0, s6
; GFX942-NEXT:    s_mov_b32 s6, 0x7050c0c
; GFX942-NEXT:    v_perm_b32 v5, v0, v0, s6
; GFX942-NEXT:    s_mov_b32 s6, 0x5070c0c
...
; GFX942-NEXT:    v_or_b32_sdwa v5, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    v_or_b32_sdwa v1, v1, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    global_store_dword v3, v0, s[12:13]
; GFX942-NEXT:    global_store_dword v3, v4, s[12:13] offset:8
; GFX942-NEXT:    global_store_dword v3, v5, s[12:13] offset:16
; GFX942-NEXT:    global_store_dword v3, v1, s[12:13] offset:24
...
; GFX942-NEXT:  ; %bb.3: ; %bb.2
; GFX942-NEXT:    s_movk_i32 s2, 0xff00
; GFX942-NEXT:    v_and_b32_sdwa v2, v0, s2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    s_mov_b32 s2, 0x6050c0c
; GFX942-NEXT:    v_perm_b32 v3, v0, v0, s2
; GFX942-NEXT:    s_mov_b32 s2, 0xc0c0001
; GFX942-NEXT:    v_perm_b32 v4, 0, v0, s2
; GFX942-NEXT:    s_mov_b32 s2, 0xffff0000
; GFX942-NEXT:    v_and_or_b32 v5, v0, s2, v4
; GFX942-NEXT:    s_mov_b32 s2, 0x5060c0c
; GFX942-NEXT:    v_or_b32_sdwa v2, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX942-NEXT:    v_perm_b32 v6, v0, v0, s2
; GFX942-NEXT:    s_mov_b32 s2, 0x6070c0c
; GFX942-NEXT:    v_mov_b32_e32 v1, 0
; GFX942-NEXT:    v_or_b32_sdwa v3, v2, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    v_or_b32_sdwa v2, v2, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    v_perm_b32 v6, v0, v0, s2
; GFX942-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX942-NEXT:    global_store_dword v1, v3, s[14:15]
; GFX942-NEXT:    global_store_dword v1, v2, s[14:15] offset:8
; GFX942-NEXT:    global_store_dword v1, v5, s[14:15] offset:16
; GFX942-NEXT:    global_store_dword v1, v4, s[14:15] offset:24
; GFX942-NEXT:  .LBB13_4: ; %bb.3
; GFX942-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX942-NEXT:    s_mov_b32 s2, 0x7040c0c
; GFX942-NEXT:    v_mov_b32_e32 v2, 8
; GFX942-NEXT:    v_perm_b32 v3, v0, v0, s2
; GFX942-NEXT:    s_movk_i32 s2, 0xff00
; GFX942-NEXT:    v_lshlrev_b16_sdwa v2, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_and_b32_sdwa v4, v0, s2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    s_mov_b32 s2, 0x4070c0c
...
; GFX942-NEXT:    s_mov_b32 s2, 0x6040c0c
; GFX942-NEXT:    v_or_b32_sdwa v3, v2, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    v_or_b32_sdwa v2, v2, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    v_perm_b32 v5, v0, v0, s2
; GFX942-NEXT:    s_mov_b32 s2, 0x4060c0c
; GFX942-NEXT:    v_mov_b32_e32 v1, 0
; GFX942-NEXT:    v_or_b32_sdwa v4, v0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
...
; GFX942-NEXT:    v_or_b32_sdwa v0, v4, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX942-NEXT:    global_store_dword v1, v3, s[0:1]
; GFX942-NEXT:    global_store_dword v1, v2, s[0:1] offset:8
; GFX942-NEXT:    global_store_dword v1, v5, s[0:1] offset:16
; GFX942-NEXT:    global_store_dword v1, v0, s[0:1] offset:24
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
  %gep1 = getelementptr <8 x i8>, ptr addrspace(1) %src1, i32 %idx
