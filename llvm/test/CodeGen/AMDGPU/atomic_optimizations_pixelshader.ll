...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1  -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX89,GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX89,GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1010 -mattr=+wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1010 -mattr=+wavefrontsize32 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=+wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=+wavefrontsize32 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132 %s
...
; GFX7-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[8:9]
; GFX7-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v0
; GFX7-NEXT:    s_wqm_b64 s[8:9], -1
; GFX7-NEXT:    ; implicit-def: $vgpr0
; GFX7-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX7-NEXT:    s_mov_b64 s[10:11], 0
; GFX7-NEXT:    s_mov_b64 s[14:15], 0
; GFX7-NEXT:    s_mov_b64 s[12:13], 0
; GFX7-NEXT:    s_xor_b64 s[10:11], exec, s[16:17]
; GFX7-NEXT:    s_mov_b64 s[18:19], 0
...
; GFX7-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX7-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GFX7-NEXT:    s_xor_b64 s[16:17], exec, s[14:15]
; GFX7-NEXT:    s_and_b64 s[16:17], s[16:17], exec
; GFX7-NEXT:    s_or_b64 s[12:13], s[12:13], s[16:17]
...
; GFX7-NEXT:  .LBB0_2:
; GFX7-NEXT:    s_mov_b64 s[14:15], 0
; GFX7-NEXT:    s_bcnt1_i32_b64 s14, exec
; GFX7-NEXT:    s_mul_i32 s14, s14, 5
...
; GFX7-NEXT:    s_and_b64 s[4:5], s[8:9], s[8:9]
...
; GFX89-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[8:9]
; GFX89-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v0
; GFX89-NEXT:    s_wqm_b64 s[8:9], -1
; GFX89-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX89-NEXT:    s_mov_b64 s[10:11], 0
; GFX89-NEXT:    s_mov_b64 s[14:15], 0
; GFX89-NEXT:    s_mov_b64 s[12:13], 0
; GFX89-NEXT:    s_xor_b64 s[10:11], exec, s[16:17]
; GFX89-NEXT:    ; implicit-def: $vgpr0
; GFX89-NEXT:    s_mov_b64 s[18:19], 0
; GFX89-NEXT:    s_mov_b64 exec, s[16:17]
; GFX89-NEXT:    s_mov_b64 s[16:17], 0
; GFX89-NEXT:    ; divergent control-flow edge
; GFX89-NEXT:    s_cbranch_execz .LBB0_4
; GFX89-NEXT:  .LBB0_1:
; GFX89-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX89-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX89-NEXT:    s_mov_b64 s[16:17], 0
; GFX89-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX89-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX89-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GFX89-NEXT:    s_xor_b64 s[16:17], exec, s[14:15]
; GFX89-NEXT:    s_and_b64 s[16:17], s[16:17], exec
; GFX89-NEXT:    s_or_b64 s[12:13], s[12:13], s[16:17]
; GFX89-NEXT:    ; implicit-def: $vgpr1
; GFX89-NEXT:    s_mov_b64 exec, s[14:15]
; GFX89-NEXT:    s_mov_b64 s[14:15], 0
; GFX89-NEXT:    ; divergent control-flow edge
; GFX89-NEXT:    s_cbranch_execz .LBB0_3
; GFX89-NEXT:  .LBB0_2:
; GFX89-NEXT:    s_mov_b64 s[14:15], 0
; GFX89-NEXT:    s_bcnt1_i32_b64 s14, exec
; GFX89-NEXT:    s_mul_i32 s14, s14, 5
; GFX89-NEXT:    v_mov_b32_e32 v1, s14
...
; GFX89-NEXT:    s_and_b64 s[4:5], s[8:9], s[8:9]
...
; GFX1064-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[8:9]
; GFX1064-NEXT:    s_wqm_b64 s[8:9], -1
; GFX1064-NEXT:    s_mov_b64 s[14:15], 0
; GFX1064-NEXT:    s_mov_b64 s[12:13], 0
; GFX1064-NEXT:    s_mov_b64 s[18:19], 0
; GFX1064-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v0
; GFX1064-NEXT:    ; implicit-def: $vgpr0
; GFX1064-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX1064-NEXT:    s_xor_b64 s[10:11], exec, s[16:17]
; GFX1064-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1064-NEXT:    s_mov_b64 s[16:17], 0
...
; GFX1064-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX1064-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GFX1064-NEXT:    s_xor_b64 s[16:17], exec, s[14:15]
; GFX1064-NEXT:    s_and_b64 s[16:17], s[16:17], exec
; GFX1064-NEXT:    s_or_b64 s[12:13], s[12:13], s[16:17]
...
; GFX1064-NEXT:    s_and_b64 s[4:5], s[8:9], s[8:9]
...
; GFX1032-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s8
; GFX1032-NEXT:    s_wqm_b32 s8, -1
; GFX1032-NEXT:    s_mov_b32 s11, 0
; GFX1032-NEXT:    s_mov_b32 s10, 0
; GFX1032-NEXT:    s_mov_b32 s13, 0
; GFX1032-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v0
; GFX1032-NEXT:    ; implicit-def: $vgpr0
; GFX1032-NEXT:    s_xor_b32 s12, vcc_lo, exec_lo
; GFX1032-NEXT:    s_xor_b32 s9, exec_lo, s12
; GFX1032-NEXT:    s_mov_b32 exec_lo, s12
...
; GFX1032-NEXT:    s_and_b32 s4, s8, s8
...
; GFX1164-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[8:9]
; GFX1164-NEXT:    s_wqm_b64 s[8:9], -1
; GFX1164-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1164-NEXT:    s_mov_b64 s[14:15], 0
; GFX1164-NEXT:    s_mov_b64 s[12:13], 0
; GFX1164-NEXT:    s_mov_b64 s[18:19], 0
; GFX1164-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v0
; GFX1164-NEXT:    ; implicit-def: $vgpr0
; GFX1164-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_xor_b64 s[10:11], exec, s[16:17]
; GFX1164-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1164-NEXT:    s_mov_b64 s[16:17], 0
...
; GFX1164-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GFX1164-NEXT:    s_xor_b64 s[16:17], exec, s[14:15]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_and_b64 s[16:17], s[16:17], exec
; GFX1164-NEXT:    s_or_b64 s[12:13], s[12:13], s[16:17]
; GFX1164-NEXT:    s_mov_b64 exec, s[14:15]
; GFX1164-NEXT:    s_mov_b64 s[14:15], 0
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:    v_mov_b32_e32 v1, s14
...
; GFX1164-NEXT:    s_and_b64 s[4:5], s[8:9], s[8:9]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1132-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s8
; GFX1132-NEXT:    s_wqm_b32 s8, -1
; GFX1132-NEXT:    s_mov_b32 s11, 0
; GFX1132-NEXT:    s_mov_b32 s10, 0
; GFX1132-NEXT:    s_mov_b32 s13, 0
; GFX1132-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v0
; GFX1132-NEXT:    ; implicit-def: $vgpr0
; GFX1132-NEXT:    s_xor_b32 s12, vcc_lo, exec_lo
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_xor_b32 s9, exec_lo, s12
; GFX1132-NEXT:    s_mov_b32 exec_lo, s12
...
; GFX1132-NEXT:    s_xor_b32 s12, vcc_lo, exec_lo
; GFX1132-NEXT:    s_or_b32 s11, s11, s12
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    s_xor_b32 s12, exec_lo, s11
; GFX1132-NEXT:    s_and_b32 s12, s12, exec_lo
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_or_b32 s10, s10, s12
; GFX1132-NEXT:    s_mov_b32 exec_lo, s11
; GFX1132-NEXT:    s_mov_b32 s11, 0
; GFX1132-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    v_mov_b32_e32 v1, s11
...
; GFX1132-NEXT:    s_and_b32 s4, s8, s8
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX8-NEXT:    s_xor_b64 s[18:19], vcc, exec
; GFX8-NEXT:    s_or_b64 s[14:15], s[14:15], s[18:19]
; GFX8-NEXT:    s_xor_b64 s[18:19], exec, s[14:15]
; GFX8-NEXT:    s_and_b64 s[18:19], s[18:19], exec
; GFX8-NEXT:    s_or_b64 s[12:13], s[12:13], s[18:19]
...
; GFX8-NEXT:    s_and_b64 s[4:5], s[8:9], s[8:9]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[8:9]
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GFX9-NEXT:    s_wqm_b64 s[8:9], -1
...
; GFX9-NEXT:    s_xor_b64 s[10:11], exec, s[16:17]
...
; GFX9-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, v0, s[16:17]
; GFX9-NEXT:    s_nop 1
...
; GFX9-NEXT:    s_xor_b64 s[18:19], vcc, exec
; GFX9-NEXT:    s_or_b64 s[14:15], s[14:15], s[18:19]
; GFX9-NEXT:    s_xor_b64 s[18:19], exec, s[14:15]
; GFX9-NEXT:    s_and_b64 s[18:19], s[18:19], exec
; GFX9-NEXT:    s_or_b64 s[12:13], s[12:13], s[18:19]
...
; GFX9-NEXT:    s_and_b64 s[4:5], s[8:9], s[8:9]
...
; GFX1064-NEXT:    s_mov_b64 s[8:9], exec
; GFX1064-NEXT:    s_mov_b64 s[10:11], 0
; GFX1064-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[8:9]
; GFX1064-NEXT:    s_wqm_b64 s[8:9], -1
; GFX1064-NEXT:    s_mov_b64 s[14:15], 0
; GFX1064-NEXT:    s_mov_b64 s[12:13], 0
; GFX1064-NEXT:    s_mov_b64 s[18:19], 0
; GFX1064-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
...
; GFX1064-NEXT:  .LBB1_1:
; GFX1064-NEXT:    s_mov_b64 s[16:17], 0
; GFX1064-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX1064-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s[16:17]
...
; GFX1064-NEXT:    v_readlane_b32 s18, v1, 31
...
; GFX1064-NEXT:    v_readlane_b32 s18, v1, 15
; GFX1064-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1064-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX1064-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX1064-NEXT:    v_readlane_b32 s19, v1, 31
; GFX1064-NEXT:    v_writelane_b32 v3, s18, 16
; GFX1064-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1064-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1064-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX1064-NEXT:    v_readlane_b32 s20, v1, 47
; GFX1064-NEXT:    v_writelane_b32 v3, s19, 32
; GFX1064-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1064-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1064-NEXT:    s_or_saveexec_b64 s[18:19], -1
; GFX1064-NEXT:    v_readlane_b32 s16, v1, 63
; GFX1064-NEXT:    v_writelane_b32 v3, s20, 48
; GFX1064-NEXT:    s_mov_b64 exec, s[18:19]
; GFX1064-NEXT:    s_xor_b64 s[18:19], vcc, exec
; GFX1064-NEXT:    ; implicit-def: $vgpr0
; GFX1064-NEXT:    s_or_b64 s[14:15], s[14:15], s[18:19]
; GFX1064-NEXT:    s_xor_b64 s[18:19], exec, s[14:15]
; GFX1064-NEXT:    s_and_b64 s[18:19], s[18:19], exec
; GFX1064-NEXT:    s_or_b64 s[12:13], s[12:13], s[18:19]
; GFX1064-NEXT:    s_mov_b64 exec, s[14:15]
; GFX1064-NEXT:    s_mov_b64 s[14:15], 0
; GFX1064-NEXT:    ; divergent control-flow edge
...
; GFX1032-NEXT:    s_mov_b32 s8, exec_lo
; GFX1032-NEXT:    s_mov_b32 s9, 0
; GFX1032-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s8
; GFX1032-NEXT:    s_wqm_b32 s8, -1
; GFX1032-NEXT:    s_mov_b32 s11, 0
; GFX1032-NEXT:    s_mov_b32 s10, 0
; GFX1032-NEXT:    s_mov_b32 s13, 0
; GFX1032-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
...
; GFX1032-NEXT:  .LBB1_1:
; GFX1032-NEXT:    s_mov_b32 s12, 0
; GFX1032-NEXT:    s_or_saveexec_b32 s12, -1
; GFX1032-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s12
...
; GFX1032-NEXT:    v_readlane_b32 s13, v1, 15
; GFX1032-NEXT:    s_mov_b32 exec_lo, s12
; GFX1032-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1032-NEXT:    s_or_saveexec_b32 s14, -1
; GFX1032-NEXT:    v_readlane_b32 s12, v1, 31
; GFX1032-NEXT:    v_writelane_b32 v3, s13, 16
; GFX1032-NEXT:    s_mov_b32 exec_lo, s14
; GFX1032-NEXT:    s_xor_b32 s13, vcc_lo, exec_lo
; GFX1032-NEXT:    ; implicit-def: $vgpr0
; GFX1032-NEXT:    s_or_b32 s11, s11, s13
; GFX1032-NEXT:    s_xor_b32 s13, exec_lo, s11
; GFX1032-NEXT:    s_and_b32 s13, s13, exec_lo
; GFX1032-NEXT:    s_or_b32 s10, s10, s13
; GFX1032-NEXT:    s_mov_b32 exec_lo, s11
; GFX1032-NEXT:    s_mov_b32 s11, 0
; GFX1032-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:    s_mov_b64 s[8:9], exec
; GFX1164-NEXT:    s_mov_b64 s[10:11], 0
; GFX1164-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[8:9]
; GFX1164-NEXT:    s_wqm_b64 s[8:9], -1
; GFX1164-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1164-NEXT:    s_mov_b64 s[14:15], 0
; GFX1164-NEXT:    s_mov_b64 s[12:13], 0
; GFX1164-NEXT:    s_mov_b64 s[18:19], 0
; GFX1164-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
...
; GFX1164-NEXT:  .LBB1_1:
; GFX1164-NEXT:    s_mov_b64 s[16:17], 0
; GFX1164-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s[16:17]
...
; GFX1164-NEXT:    v_readlane_b32 s18, v1, 31
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1164-NEXT:    v_readlane_b32 s18, v1, 15
; GFX1164-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX1164-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX1164-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX1164-NEXT:    v_readlane_b32 s19, v1, 31
; GFX1164-NEXT:    v_writelane_b32 v3, s18, 16
; GFX1164-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1164-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GFX1164-NEXT:    v_readlane_b32 s20, v1, 47
; GFX1164-NEXT:    v_writelane_b32 v3, s19, 32
; GFX1164-NEXT:    s_mov_b64 exec, s[16:17]
; GFX1164-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_or_saveexec_b64 s[18:19], -1
; GFX1164-NEXT:    v_readlane_b32 s16, v1, 63
; GFX1164-NEXT:    v_writelane_b32 v3, s20, 48
; GFX1164-NEXT:    s_mov_b64 exec, s[18:19]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_xor_b64 s[18:19], vcc, exec
; GFX1164-NEXT:    ; implicit-def: $vgpr0
; GFX1164-NEXT:    s_or_b64 s[14:15], s[14:15], s[18:19]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_xor_b64 s[18:19], exec, s[14:15]
; GFX1164-NEXT:    s_and_b64 s[18:19], s[18:19], exec
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_or_b64 s[12:13], s[12:13], s[18:19]
; GFX1164-NEXT:    s_mov_b64 exec, s[14:15]
; GFX1164-NEXT:    s_mov_b64 s[14:15], 0
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    s_mov_b32 s8, exec_lo
; GFX1132-NEXT:    s_mov_b32 s9, 0
; GFX1132-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s8
; GFX1132-NEXT:    s_wqm_b32 s8, -1
; GFX1132-NEXT:    s_mov_b32 s11, 0
; GFX1132-NEXT:    s_mov_b32 s10, 0
; GFX1132-NEXT:    s_mov_b32 s13, 0
; GFX1132-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
...
; GFX1132-NEXT:    v_readlane_b32 s13, v1, 15
; GFX1132-NEXT:    s_mov_b32 exec_lo, s12
; GFX1132-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_or_saveexec_b32 s14, -1
; GFX1132-NEXT:    v_readlane_b32 s12, v1, 31
; GFX1132-NEXT:    v_writelane_b32 v3, s13, 16
; GFX1132-NEXT:    s_mov_b32 exec_lo, s14
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    s_xor_b32 s13, vcc_lo, exec_lo
; GFX1132-NEXT:    ; implicit-def: $vgpr0
; GFX1132-NEXT:    s_or_b32 s11, s11, s13
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    s_xor_b32 s13, exec_lo, s11
; GFX1132-NEXT:    s_and_b32 s13, s13, exec_lo
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_or_b32 s10, s10, s13
; GFX1132-NEXT:    s_mov_b32 exec_lo, s11
; GFX1132-NEXT:    s_mov_b32 s11, 0
; GFX1132-NEXT:    ; divergent control-flow edge
