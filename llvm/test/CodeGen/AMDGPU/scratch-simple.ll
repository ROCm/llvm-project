...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=verde -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,SI,SIVI,MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx803 -mattr=-flat-for-global -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,VI,SIVI,MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,MUBUF,GFX9-MUBUF,GFX9_10-MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -filetype=obj -amdgpu-use-divergent-register-indexing < %s | llvm-readobj -r - | FileCheck --check-prefix=RELS %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1010 -mattr=-flat-for-global -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,MUBUF,GFX10_W32-MUBUF,GFX9_10-MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1010 -mattr=-flat-for-global,+wavefrontsize64 -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,MUBUF,GFX10_W64-MUBUF,GFX9_10-MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global,+enable-flat-scratch -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,FLATSCR,GFX9-FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1030 -mattr=-flat-for-global,+enable-flat-scratch -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,FLATSCR,GFX10-FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx900 -mattr=-flat-for-global,+enable-flat-scratch -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,FLATSCR,GFX9-FLATSCR-PAL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx1030 -mattr=-flat-for-global,+enable-flat-scratch -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,FLATSCR,GFX10-FLATSCR-PAL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-flat-for-global,+enable-flat-scratch -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,GFX11-FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx1100 -mattr=-flat-for-global,+enable-flat-scratch -amdgpu-use-divergent-register-indexing < %s | FileCheck --check-prefixes=GCN,GFX9PLUS,GFX11-FLATSCR %s
...
; GFX9-FLATSCR-NEXT:    s_add_u32 flat_scratch_lo, s0, s2
; GFX9-FLATSCR-NEXT:    s_addc_u32 flat_scratch_hi, s1, 0
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v5, 0xbf20e7f4
; GFX9-FLATSCR-NEXT:    s_mov_b32 s0, 0
...
; GFX9-FLATSCR-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:320
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v22, 0xbeae29dc
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v6, v3
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v7, v2
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v8, v1
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v11, 0x3eae29dc
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v12, 0x3eae29d8
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v13, 0x3e319356
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v14, 0x3e31934f
...
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:288
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v24, 0xbefcd89f
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v25, 0xbefcd8a3
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v23, v22
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v5, 0xb702e758
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v6, 0xb7043519
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v7, 0xbe31934f
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v8, 0xbe319356
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[11:14], s0 offset:240
...
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v19, 0x3f20e7f5
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v20, v16
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v21, v30
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v12, 0x3703c499
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 offset:304
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[22:25], s0 offset:272
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:256
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[27:30], s0 offset:208
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[18:21], s0 offset:192
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v5, v4
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v9, v12
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v10, v13
; GFX9-FLATSCR-NEXT:    scratch_load_dword v32, v5, off
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v26, v8
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[8:11], s0 offset:720
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v5, 0xbf523be1
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v8, 0x3f3d349c
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v6, v2
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v7, v16
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v21, v3
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v14, v11
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v15, v18
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v29, v0
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v30, v27
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v31, v1
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v0, 0x3f20e7f4
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:784
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v23, v17
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v7, 0xbf5f2ee2
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v8, v1
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v25, v22
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[18:21], s0 offset:736
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[12:15], s0 offset:816
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v18, v24
; GFX9-FLATSCR-NEXT:    v_mov_b32_e32 v19, v22
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[28:31], s0 offset:768
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 offset:832
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:752
; GFX9-FLATSCR-NEXT:    v_add_u32_e32 v0, 0x200, v4
; GFX9-FLATSCR-NEXT:    scratch_store_dwordx4 off, v[23:26], s0 offset:800
...
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v5, 0xbf20e7f4
...
; GFX9-FLATSCR-PAL-NEXT:    s_mov_b32 s0, 0
; GFX9-FLATSCR-PAL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:320
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v22, 0xbeae29dc
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v6, v3
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v7, v2
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v8, v1
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v11, 0x3eae29dc
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v12, 0x3eae29d8
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v13, 0x3e319356
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v14, 0x3e31934f
...
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:288
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v24, 0xbefcd89f
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v25, 0xbefcd8a3
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v23, v22
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v5, 0xb702e758
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v6, 0xb7043519
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v7, 0xbe31934f
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v8, 0xbe319356
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[11:14], s0 offset:240
...
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v19, 0x3f20e7f5
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v20, v16
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v21, v30
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v12, 0x3703c499
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 offset:304
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[22:25], s0 offset:272
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:256
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[27:30], s0 offset:208
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[18:21], s0 offset:192
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v5, v4
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v9, v12
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v10, v13
; GFX9-FLATSCR-PAL-NEXT:    scratch_load_dword v32, v5, off
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v26, v8
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[8:11], s0 offset:720
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v5, 0xbf523be1
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v8, 0x3f3d349c
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v6, v2
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v7, v16
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v21, v3
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v14, v11
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v15, v18
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v29, v0
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v30, v27
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v31, v1
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v0, 0x3f20e7f4
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:784
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v23, v17
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v7, 0xbf5f2ee2
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v8, v1
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v25, v22
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[18:21], s0 offset:736
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[12:15], s0 offset:816
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v18, v24
; GFX9-FLATSCR-PAL-NEXT:    v_mov_b32_e32 v19, v22
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[28:31], s0 offset:768
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], s0 offset:832
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[5:8], s0 offset:752
; GFX9-FLATSCR-PAL-NEXT:    v_add_u32_e32 v0, 0x200, v4
; GFX9-FLATSCR-PAL-NEXT:    scratch_store_dwordx4 off, v[23:26], s0 offset:800
