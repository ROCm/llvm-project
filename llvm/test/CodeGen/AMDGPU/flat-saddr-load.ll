...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.50-mesa-mesa3d -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL,GFX1250-GISEL-TRUE16 %s
...
; GFX1250-NOECC:       ; %bb.0:
; GFX1250-NOECC-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SE
...
; GFX1250-NOECC-SDAG-TRUE16-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SE
...
; GFX1250-NOECC-SDAG-FAKE16-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SE
