...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL,GFX1250-GISEL-TRUE16 %s
...
; GFX1250-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v0.h, 0
...
; GFX1250-GISEL-TRUE16-NEXT:    v_lshl_or_b32 v0, 0, 16, v0
