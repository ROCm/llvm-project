...
; GFX7-GISEL:       ; %bb.0: ; %entry
; GFX7-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v6, v2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v0, v6, 0
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v7, v1
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v0, v3, v[9:10]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v4, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v7, v6, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v5, v[1:2]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v9, v4, v[6:7]
; GFX7-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-GISEL:       ; %bb.0: ; %entry
; GFX8-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v6, v2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v0, v6, 0
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v7, v1
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v0, v3, v[9:10]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v4, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v7, v6, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v5, v[1:2]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v9, v4, v[6:7]
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[25:26], s4, v0, v8, 0
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[23:24], s4, v4, v13, v[23:24]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr18
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[28:29], s4, v19, v16, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr21
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr24
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[17:18], s4, v0, v9, v[26:27]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s4, v5, v12, v[23:24]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s4, v25, v22, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr18
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s4, v19, v6, v[29:30]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s4, v1, v8, v[17:18]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s4, v25, v3, v[14:15]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s4, v13, v28, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s4, v2, v16, v[4:5]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s4, v6, v22, v[7:8]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s4, v13, v3, v[1:2]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s4, v4, v28, v[1:2]
; GFX10-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[25:26], null, v0, v8, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr24
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr27
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[30:31], null, v6, v15, v[17:18]
...
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[20:21], null, v4, v13, v[23:24]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr31
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[28:29], null, v19, v16, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr18
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr21
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[23:24], null, v7, v14, v[30:31]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v0, v9, v[26:27]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v25, v22, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[26:27], null, v3, v10, v[17:18]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v5, v12, v[20:21]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr30
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v19, v23, v[29:30]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v1, v8, v[6:7]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v13, v28, 0
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v25, v2, v[14:15]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v26, v16, v[3:4]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v9, v22, v[5:6]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v13, v7, v[1:2]
...
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[34:35], s[4:5], v10, v27, v[32:33]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[32:33], s[4:5], v2, v18, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[36:37], s[4:5], v11, v26, v[34:35]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr34
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v2, v19, v[33:34]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[33:34], s[4:5], v32, v31, 0
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr35
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[26:27], s[4:5], v32, v36, v[34:35]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[34:35], s[4:5], v3, v18, v[10:11]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr36
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v4, v20, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v34, v31, v[26:27]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[34:35], s[4:5], v12, v28, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v12, v29, v[35:36]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[26:27], s[4:5], v13, v28, v[2:3]
; GFX7-GISEL-NEXT:    buffer_load_dword v13, off, s[0:3], s32
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[27:28], s[4:5], v4, v21, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v34, 0
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v10, v26, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v20, v[27:28]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[19:20], s[4:5], v3, v34, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v22, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v30, 0
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v6, v23, v[4:5]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX7-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v13, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v7, v22, v[20:21]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v30, v[4:5]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v3, v10, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v3, v12, v[5:6]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v24, 0
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v11, v10, v[13:14]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v0, v16, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v8, v25, v[6:7]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v0, v17, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v5, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[25:26], s[4:5], v9, v24, v[13:14]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v33, v4, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v1, v16, v[21:22]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr13
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v25, v[7:8]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v2, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v33, v20, v[12:13]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v5, v[0:1]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v6, v19, v[8:9]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v18, v4, v[15:16]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v7, v11, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v12, v2, v[13:14]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v7, v5, v[1:2]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v3, v11, v[8:9]
; GFX7-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[34:35], s[4:5], v10, v27, v[32:33]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[32:33], s[4:5], v2, v18, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[36:37], s[4:5], v11, v26, v[34:35]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr34
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v2, v19, v[33:34]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[33:34], s[4:5], v32, v31, 0
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr35
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[26:27], s[4:5], v32, v36, v[34:35]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[34:35], s[4:5], v3, v18, v[10:11]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr36
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v4, v20, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v34, v31, v[26:27]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[34:35], s[4:5], v12, v28, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v12, v29, v[35:36]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[26:27], s[4:5], v13, v28, v[2:3]
; GFX8-GISEL-NEXT:    buffer_load_dword v13, off, s[0:3], s32
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[27:28], s[4:5], v4, v21, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v34, 0
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v10, v26, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v20, v[27:28]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[19:20], s[4:5], v3, v34, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v22, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v30, 0
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v6, v23, v[4:5]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX8-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v13, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v7, v22, v[20:21]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v30, v[4:5]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v3, v10, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v3, v12, v[5:6]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v24, 0
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v11, v10, v[13:14]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v0, v16, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v8, v25, v[6:7]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v0, v17, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v5, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[25:26], s[4:5], v9, v24, v[13:14]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v33, v4, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v1, v16, v[21:22]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr13
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v25, v[7:8]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v2, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v33, v20, v[12:13]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v5, v[0:1]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v6, v19, v[8:9]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v18, v4, v[15:16]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v7, v11, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v12, v2, v[13:14]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v7, v5, v[1:2]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v3, v11, v[8:9]
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-GISEL:       ; %bb.0: ; %entry
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-GISEL-NEXT:    buffer_load_dword v36, off, s[0:3], s32
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[51:52], s4, v8, v24, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[64:65], s4, v12, v28, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr50
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr53
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr66
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[32:33], s4, v14, v36, v[32:33]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr36
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[38:39], s4, v6, v23, v[35:36]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[35:36], s4, v34, v31, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr33
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[32:33], s4, v2, v18, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr38
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s4, v34, v14, v[36:37]
...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s4, v2, v19, v[33:34]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[21:22], s4, v4, v21, v[37:38]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[30:31], s4, v10, v27, v[49:50]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[33:34], s4, v8, v25, v[52:53]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[37:38], s4, v12, v29, v[65:66]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr22
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr31
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr34
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr38
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[49:50], s4, v3, v18, v[6:7]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[20:21], s4, v5, v20, v[21:22]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s4, v0, v16, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s4, v11, v26, v[30:31]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s4, v32, v48, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[21:22], s4, v9, v24, v[33:34]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[18:19], s4, v13, v28, v[37:38]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s4, v36, v64, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr13
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr19
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s4, v0, v17, v[3:4]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s4, v2, v51, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s4, v32, v10, v[6:7]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s4, v36, v18, v[9:10]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[17:18], s4, v5, v35, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s4, v1, v16, v[3:4]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s4, v11, v8, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s4, v2, v21, v[12:13]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s4, v49, v48, v[6:7]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s4, v20, v64, v[9:10]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s4, v5, v14, v[18:19]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr13
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s4, v0, v51, v[1:2]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s4, v3, v17, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s4, v11, v9, v[4:5]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s4, v6, v35, v[12:13]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s4, v14, v8, v[4:5]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s4, v3, v6, v[1:2]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s4, v4, v17, v[1:2]
; GFX10-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[34:35], null, v0, v16, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[37:38], null, v2, v18, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[51:52], null, v6, v22, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[67:68], null, v10, v26, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[80:81], null, v12, v28, 0
...
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[48:49], null, v4, v20, 0
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[86:87], null, v10, v27, v[68:69]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[96:97], null, v12, v29, v[81:82]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[81:82], null, v51, v31, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[68:69], null, v48, v80, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr87
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr97
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[84:85], null, v14, v55, v[32:33]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[32:33], null, v0, v17, v[35:36]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[35:36], null, v2, v19, v[38:39]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[38:39], null, v6, v23, v[52:53]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr85
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr39
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[52:53], null, v37, v67, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr36
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr33
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[98:99], null, v15, v30, v[84:85]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[14:15], null, v4, v21, v[49:50]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[29:30], null, v8, v25, v[65:66]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[49:50], null, v7, v22, v[38:39]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[21:22], null, v11, v26, v[86:87]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[10:11], null, v13, v28, v[96:97]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v34, v64, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr30
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[22:23], null, v3, v18, v[35:36]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[11:12], null, v51, v98, v[82:83]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v5, v20, v[14:15]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v9, v24, v[29:30]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v52, v81, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[14:15], null, v37, v21, v[53:54]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[17:18], null, v48, v10, v[69:70]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v6, v68, 0
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr18
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr5
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr15
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[19:20], null, v49, v31, v[11:12]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[20:21], null, v1, v16, v[32:33]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v34, v13, v[7:8]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v22, v67, v[14:15]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[12:13], null, v2, v80, v[17:18]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v52, v19, v[4:5]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr14
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v20, v64, v[0:1]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v9, v3, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[15:16], null, v6, v12, v[10:11]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr16
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v7, v81, v[13:14]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v4, v68, v[15:16]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v9, v5, v[1:2]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[1:2], null, v6, v3, v[7:8]
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
