...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
...
; GCN-NEXT:    v_mov_b64_e32 v[0:1], s[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], s[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], s[24:25]
; GCN-NEXT:    v_accvgpr_write_b32 a0, s4
; GCN-NEXT:    v_mov_b64_e32 v[6:7], s[26:27]
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b64_e32 v[34:35], s[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[32:33], s[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[38:39], s[26:27]
; GCN-NEXT:    v_mov_b64_e32 v[30:31], s[18:19]
; GCN-NEXT:    v_mov_b64_e32 v[36:37], s[24:25]
; GCN-NEXT:    v_mov_b64_e32 v[28:29], s[16:17]
; GCN-NEXT:    v_mov_b64_e32 v[26:27], s[14:15]
; GCN-NEXT:    v_mov_b64_e32 v[24:25], s[12:13]
; GCN-NEXT:    v_mov_b64_e32 v[22:23], s[10:11]
; GCN-NEXT:    v_mov_b64_e32 v[20:21], s[8:9]
; GCN-NEXT:    v_mov_b64_e32 v[18:19], s[6:7]
; GCN-NEXT:    v_mov_b64_e32 v[16:17], s[4:5]
; GCN-NEXT:    v_mov_b32_e32 v40, s16
; GCN-NEXT:    v_mov_b32_e32 v41, s17
; GCN-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31]
; GCN-NEXT:    v_mov_b32_e32 v42, s18
; GCN-NEXT:    v_mov_b32_e32 v43, s19
...
; GCN-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b64_e32 v[16:17], s[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[18:19], s[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[20:21], s[24:25]
; GCN-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GCN-NEXT:    v_mov_b64_e32 v[22:23], s[26:27]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], s[6:7]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], s[8:9]
; GCN-NEXT:    v_mov_b64_e32 v[6:7], s[10:11]
; GCN-NEXT:    v_mov_b64_e32 v[8:9], s[12:13]
; GCN-NEXT:    v_mov_b64_e32 v[10:11], s[14:15]
; GCN-NEXT:    v_mov_b64_e32 v[12:13], s[16:17]
; GCN-NEXT:    v_mov_b64_e32 v[14:15], s[18:19]
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; GCN-NEXT:    s_nop 0
