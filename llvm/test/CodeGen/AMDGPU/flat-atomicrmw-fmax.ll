...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx942 < %s | FileCheck -check-prefix=GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1010 < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx90a < %s | FileCheck -check-prefix=GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx908 < %s | FileCheck -check-prefix=GFX908 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=tonga < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=hawaii < %s | FileCheck -check-prefix=GFX7 %s
...
; GFX942-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
...
; GFX908-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
...
; GFX908-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX908-NEXT:    ; divergent control-flow edge
...
; GFX12-NEXT:    s_mov_b32 s0, -1
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s1, v7
; GFX12-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX12-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX12-NEXT:    ; divergent control-flow edge
...
; GFX12-NEXT:    v_max_num_f64_e32 v[2:3], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v6, -1, v6, vcc_lo
...
; GFX12-NEXT:    flat_load_b64 v[4:5], v[6:7]
...
; GFX12-NEXT:    v_max_num_f64_e32 v[0:1], v[4:5], v[4:5]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_max_num_f64_e32 v[2:3], v[0:1], v[8:9]
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    flat_atomic_cmpswap_b64 v[0:1], v[6:7], v[2:5] th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX11-NEXT:    s_mov_b64 s[0:1], src_private_base
; GFX11-NEXT:    s_mov_b32 s0, -1
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s1, v7
; GFX11-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX11-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX11-NEXT:    ; divergent control-flow edge
...
; GFX11-NEXT:    v_max_f64 v[2:3], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v6, -1, v6, vcc_lo
...
; GFX11-NEXT:    flat_load_b64 v[4:5], v[6:7]
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    flat_atomic_cmpswap_b64 v[0:1], v[6:7], v[2:5] glc
; GFX11-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-NEXT:    buffer_gl1_inv
; GFX11-NEXT:    buffer_gl0_inv
...
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, s5, v7
; GFX908-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX908-NEXT:    s_mov_b64 s[4:5], -1
; GFX908-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX908-NEXT:    ; divergent control-flow edge
...
; GFX908-NEXT:    v_max_f64 v[2:3], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v6, -1, v6, vcc
...
; GFX908-NEXT:    flat_load_dwordx2 v[4:5], v[6:7]
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s4, v7
; GFX8-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX8-NEXT:    s_mov_b64 s[4:5], -1
; GFX8-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX8-NEXT:    ; divergent control-flow edge
...
; GFX8-NEXT:    v_max_f64 v[2:3], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v6, -1, v6, vcc
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, 4, v6
...
; GFX8-NEXT:    flat_atomic_cmpswap_x2 v[0:1], v[6:7], v[2:5] glc
; GFX8-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX90A-NEXT:    ; divergent control-flow edge
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s1, s1
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s1, s1
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s1, s1
...
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s1, s1
...
; GFX942-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GFX908-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v7, v8, vcc
...
; GFX12-TRUE16-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-TRUE16-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 s1, s1, s0
; GFX12-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX11-FAKE16-NEXT:    s_or_b32 s1, s1, s0
; GFX11-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX7-NEXT:    v_lshrrev_b32_e32 v5, 16, v5
; GFX7-NEXT:    v_alignbit_b32 v4, v6, v4, 16
...
; GFX942-NEXT:    v_add3_u32 v2, v2, v0, s2
; GFX942-NEXT:    v_or_b32_e32 v7, 0x400000, v0
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v2, v7, vcc
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v8, vcc
; GFX942-NEXT:    v_perm_b32 v2, v2, v0, s3
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    flat_atomic_cmpswap v0, v[4:5], v[2:3] sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX908-NEXT:    v_add3_u32 v6, v6, v2, s6
; GFX908-NEXT:    v_or_b32_e32 v7, 0x400000, v2
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; GFX908-NEXT:    v_cndmask_b32_e32 v2, v6, v7, vcc
; GFX908-NEXT:    v_and_b32_e32 v6, 0xffff0000, v3
; GFX908-NEXT:    v_max_f32_e32 v6, v6, v5
; GFX908-NEXT:    v_bfe_u32 v7, v6, 16, 1
; GFX908-NEXT:    v_add3_u32 v7, v7, v6, s6
; GFX908-NEXT:    v_or_b32_e32 v8, 0x400000, v6
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v6, v6
; GFX908-NEXT:    v_cndmask_b32_e32 v6, v7, v8, vcc
...
; GFX908-NEXT:    v_add3_u32 v6, v6, v0, s6
; GFX908-NEXT:    v_or_b32_e32 v7, 0x400000, v0
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX908-NEXT:    v_cndmask_b32_e32 v0, v6, v7, vcc
...
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v6, v6
; GFX908-NEXT:    v_cndmask_b32_e32 v6, v7, v8, vcc
; GFX908-NEXT:    v_perm_b32 v0, v6, v0, s7
; GFX908-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
