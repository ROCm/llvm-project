...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdpal -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdpal -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42-amd-amdpal < %s | FileCheck -check-prefix=GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdpal -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdpal -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdpal < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a-amd-amdpal < %s | FileCheck -check-prefix=GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.08-amd-amdpal < %s | FileCheck -check-prefix=GFX908 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02-amd-amdpal < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01-amd-amdpal < %s | FileCheck -check-prefix=GFX7 %s
...
; GFX942-NEXT:  .LBB0_2: ; %atomicrmw.end
...
; GFX90A-NEXT:  .LBB0_2: ; %atomicrmw.end
...
; GFX908-NEXT:  .LBB0_2: ; %atomicrmw.end
...
; GFX8-NEXT:  .LBB0_2: ; %atomicrmw.end
...
; GFX942-NEXT:  .LBB1_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB1_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB1_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB1_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB2_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB2_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB2_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB2_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB3_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB3_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB3_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB3_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB6_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB6_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB7_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB7_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB8_2: ; %atomicrmw.end
...
; GFX10-NEXT:  .LBB8_2: ; %atomicrmw.end
...
; GFX7-NEXT:  .LBB8_2: ; %atomicrmw.end
...
; GFX942-NEXT:  .LBB10_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB10_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB11_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB11_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB14_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB14_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB17_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB17_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB17_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s1, v1
...
; GFX12-NEXT:  .LBB18_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX12-NEXT:    v_max_num_f64_e32 v[8:9], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
; GFX12-NEXT:    scratch_load_b64 v[4:5], v10, off
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[4:5], v[4:5]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[6:7], v[8:9]
; GFX12-NEXT:    scratch_store_b64 v10, v[6:7], off
; GFX12-NEXT:  .LBB18_2:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB18_5
...
; GFX12-NEXT:  .LBB18_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX942-NEXT:    v_cmp_eq_u32_e32 vcc, s1, v1
...
; GFX942-NEXT:    v_max_f64 v[8:9], v[2:3], v[2:3]
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX942-NEXT:    scratch_load_dwordx2 v[4:5], v10, off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_max_f64 v[6:7], v[4:5], v[4:5]
; GFX942-NEXT:    v_max_f64 v[6:7], v[6:7], v[8:9]
; GFX942-NEXT:    scratch_store_dwordx2 v10, v[6:7], off
; GFX942-NEXT:  .LBB18_2:
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    flat_atomic_max_f64 v[4:5], v[0:1], v[2:3] sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB18_4: ; %atomicrmw.phi
...
; GFX11-NEXT:  .LBB18_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX11-NEXT:    v_max_f64 v[8:9], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[4:5], v10, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_max_f64 v[6:7], v[4:5], v[4:5]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_max_f64 v[6:7], v[6:7], v[8:9]
; GFX11-NEXT:    scratch_store_b64 v10, v[6:7], off
; GFX11-NEXT:  .LBB18_2:
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX11-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB18_5
...
; GFX11-NEXT:  .LBB18_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX10-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
; GFX10-NEXT:    buffer_load_dword v5, v10, s[0:3], 0 offen offset:4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_max_f64 v[8:9], v[4:5], v[4:5]
; GFX10-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX10-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX10-NEXT:    buffer_store_dword v7, v10, s[0:3], 0 offen offset:4
; GFX10-NEXT:  .LBB18_2:
...
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    flat_atomic_fmax_x2 v[4:5], v[0:1], v[2:3] glc
; GFX10-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB18_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX90A-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_load_dword v5, v10, s[0:3], 0 offen offset:4
; GFX90A-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_max_f64 v[8:9], v[4:5], v[4:5]
; GFX90A-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX90A-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_store_dword v7, v10, s[0:3], 0 offen offset:4
; GFX90A-NEXT:  .LBB18_2:
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    flat_atomic_max_f64 v[4:5], v[0:1], v[2:3] glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, s5, v1
...
; GFX908-NEXT:  .LBB18_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX908-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX908-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
; GFX908-NEXT:    buffer_load_dword v5, v10, s[0:3], 0 offen offset:4
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_max_f64 v[8:9], v[4:5], v[4:5]
; GFX908-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX908-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX908-NEXT:    buffer_store_dword v7, v10, s[0:3], 0 offen offset:4
; GFX908-NEXT:  .LBB18_2:
; GFX908-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX908-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX908-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX908-NEXT:    s_mov_b64 exec, s[8:9]
; GFX908-NEXT:    ; divergent control-flow edge
; GFX908-NEXT:    s_cbranch_execz .LBB18_5
...
; GFX908-NEXT:  .LBB18_5: ; %atomicrmw.phi
...
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s4, v1
...
; GFX8-NEXT:  .LBB18_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX8-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 4, v10
; GFX8-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
; GFX8-NEXT:    buffer_load_dword v5, v11, s[0:3], 0 offen
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_max_f64 v[8:9], v[4:5], v[4:5]
; GFX8-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX8-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX8-NEXT:    buffer_store_dword v7, v11, s[0:3], 0 offen
; GFX8-NEXT:  .LBB18_2:
...
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB18_5
...
; GFX8-NEXT:  .LBB18_5: ; %atomicrmw.phi
...
; GFX7-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX7-NEXT:    v_add_i32_e32 v11, vcc, 4, v10
; GFX7-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
; GFX7-NEXT:    buffer_load_dword v5, v11, s[0:3], 0 offen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_max_f64 v[8:9], v[4:5], v[4:5]
; GFX7-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX7-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX7-NEXT:    buffer_store_dword v7, v11, s[0:3], 0 offen
; GFX7-NEXT:  .LBB18_2:
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    flat_atomic_fmax_x2 v[4:5], v[0:1], v[2:3] glc
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB18_4: ; %atomicrmw.phi
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s1, v9
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX12-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB19_2
; GFX12-NEXT:  .LBB19_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[8:9]
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc_lo
; GFX12-NEXT:    scratch_load_b64 v[0:1], v10, off
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_max_num_f64_e32 v[4:5], v[0:1], v[0:1]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_max_num_f64_e32 v[4:5], v[4:5], v[6:7]
; GFX12-NEXT:    scratch_store_b64 v10, v[4:5], off
; GFX12-NEXT:  .LBB19_2:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB19_5
; GFX12-NEXT:  .LBB19_3: ; %atomicrmw.global
; GFX12-NEXT:    flat_load_b64 v[6:7], v[8:9]
; GFX12-NEXT:    s_and_b32 s1, s1, exec_lo
...
; GFX12-NEXT:  .LBB19_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    v_cmp_eq_u32_e32 vcc, s1, v5
; GFX942-NEXT:    s_xor_b64 s[0:1], vcc, exec
...
; GFX942-NEXT:    v_max_f64 v[8:9], v[2:3], v[2:3]
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v10, -1, v4, vcc
; GFX942-NEXT:    scratch_load_dwordx2 v[0:1], v10, off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_max_f64 v[6:7], v[0:1], v[0:1]
; GFX942-NEXT:    v_max_f64 v[6:7], v[6:7], v[8:9]
; GFX942-NEXT:    scratch_store_dwordx2 v10, v[6:7], off
; GFX942-NEXT:  .LBB19_2:
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB19_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s1, v9
; GFX11-NEXT:    s_mov_b32 s1, -1
; GFX11-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX11-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB19_2
; GFX11-NEXT:  .LBB19_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[8:9]
; GFX11-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[0:1], v10, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_max_f64 v[4:5], v[0:1], v[0:1]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX11-NEXT:    scratch_store_b64 v10, v[4:5], off
; GFX11-NEXT:  .LBB19_2:
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b32 s0, exec_lo, s2
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB19_5
; GFX11-NEXT:  .LBB19_3: ; %atomicrmw.global
; GFX11-NEXT:    flat_load_b64 v[6:7], v[8:9]
; GFX11-NEXT:    s_and_b32 s1, s1, exec_lo
...
; GFX11-NEXT:  .LBB19_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s5, v5
; GFX10-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; GFX10-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX10-NEXT:    ; divergent control-flow edge
...
; GFX10-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX10-NEXT:    v_cndmask_b32_e32 v10, -1, v4, vcc_lo
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    buffer_load_dword v0, v10, s[0:3], 0 offen
; GFX10-NEXT:    buffer_load_dword v1, v10, s[0:3], 0 offen offset:4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX10-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX10-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX10-NEXT:    buffer_store_dword v7, v10, s[0:3], 0 offen offset:4
; GFX10-NEXT:  .LBB19_2:
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB19_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v10, -1, v4, vcc
; GFX90A-NEXT:    buffer_load_dword v0, v10, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_load_dword v1, v10, s[0:3], 0 offen offset:4
; GFX90A-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX90A-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX90A-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_store_dword v7, v10, s[0:3], 0 offen offset:4
; GFX90A-NEXT:  .LBB19_2:
...
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, s5, v9
; GFX908-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX908-NEXT:    s_mov_b64 s[4:5], -1
...
; GFX908-NEXT:  .LBB19_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; GFX908-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc
; GFX908-NEXT:    buffer_load_dword v0, v10, s[0:3], 0 offen
; GFX908-NEXT:    buffer_load_dword v1, v10, s[0:3], 0 offen offset:4
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_max_f64 v[6:7], v[0:1], v[0:1]
; GFX908-NEXT:    v_max_f64 v[4:5], v[6:7], v[4:5]
; GFX908-NEXT:    buffer_store_dword v4, v10, s[0:3], 0 offen
; GFX908-NEXT:    buffer_store_dword v5, v10, s[0:3], 0 offen offset:4
; GFX908-NEXT:  .LBB19_2:
; GFX908-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX908-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX908-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GFX908-NEXT:    flat_load_dwordx2 v[6:7], v[8:9]
; GFX908-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GFX908-NEXT:    v_max_f64 v[4:5], v[4:5], v[0:1]
...
; GFX908-NEXT:  .LBB19_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s4, v9
; GFX8-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX8-NEXT:    s_mov_b64 s[4:5], -1
...
; GFX8-NEXT:  .LBB19_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; GFX8-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 4, v10
; GFX8-NEXT:    buffer_load_dword v0, v10, s[0:3], 0 offen
; GFX8-NEXT:    buffer_load_dword v1, v11, s[0:3], 0 offen
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    buffer_store_dword v5, v11, s[0:3], 0 offen
; GFX8-NEXT:  .LBB19_2:
; GFX8-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX8-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX8-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB19_5
...
; GFX8-NEXT:    v_max_f64 v[4:5], v[4:5], v[0:1]
...
; GFX8-NEXT:  .LBB19_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, s4, v5
; GFX7-NEXT:    s_xor_b64 s[4:5], vcc, exec
...
; GFX7-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX7-NEXT:    v_cndmask_b32_e32 v10, -1, v4, vcc
; GFX7-NEXT:    v_add_i32_e32 v11, vcc, 4, v10
; GFX7-NEXT:    buffer_load_dword v0, v10, s[0:3], 0 offen
; GFX7-NEXT:    buffer_load_dword v1, v11, s[0:3], 0 offen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX7-NEXT:    v_max_f64 v[6:7], v[8:9], v[6:7]
; GFX7-NEXT:    buffer_store_dword v6, v10, s[0:3], 0 offen
; GFX7-NEXT:    buffer_store_dword v7, v11, s[0:3], 0 offen
; GFX7-NEXT:  .LBB19_2:
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB19_4: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:  .LBB20_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[8:9]
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc_lo
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB20_5
...
; GFX12-NEXT:  .LBB20_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB20_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB20_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[8:9]
; GFX11-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[0:1], v10, off
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB20_5
...
; GFX11-NEXT:  .LBB20_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB20_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB20_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; GFX908-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc
; GFX908-NEXT:    buffer_load_dword v0, v10, s[0:3], 0 offen
...
; GFX908-NEXT:    s_mov_b64 exec, s[8:9]
; GFX908-NEXT:    ; divergent control-flow edge
; GFX908-NEXT:    s_cbranch_execz .LBB20_5
...
; GFX908-NEXT:  .LBB20_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB20_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; GFX8-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v10, -1, v8, vcc
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 4, v10
...
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB20_5
...
; GFX8-NEXT:  .LBB20_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB20_4: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:  .LBB21_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
; GFX12-NEXT:    scratch_load_b64 v[4:5], v8, off
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_max_num_f64_e32 v[4:5], v[4:5], v[4:5]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_max_num_f64_e32 v[4:5], v[4:5], v[6:7]
; GFX12-NEXT:    scratch_store_b64 v8, v[4:5], off
; GFX12-NEXT:  .LBB21_2:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB21_5
...
; GFX12-NEXT:  .LBB21_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX942-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX942-NEXT:    scratch_load_dwordx2 v[4:5], v8, off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX942-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX942-NEXT:    scratch_store_dwordx2 v8, v[4:5], off
; GFX942-NEXT:  .LBB21_2:
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_xor_b64 s[2:3], exec, s[0:1]
; GFX942-NEXT:    s_mov_b64 exec, s[0:1]
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB21_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB21_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX11-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[4:5], v8, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX11-NEXT:    scratch_store_b64 v8, v[4:5], off
; GFX11-NEXT:  .LBB21_2:
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b32 s0, exec_lo, s2
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB21_5
...
; GFX11-NEXT:  .LBB21_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX10-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX10-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
; GFX10-NEXT:    buffer_load_dword v5, v8, s[0:3], 0 offen offset:4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX10-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX10-NEXT:    buffer_store_dword v4, v8, s[0:3], 0 offen
; GFX10-NEXT:    buffer_store_dword v5, v8, s[0:3], 0 offen offset:4
; GFX10-NEXT:  .LBB21_2:
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_xor_b32 s5, exec_lo, s4
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB21_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX90A-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_load_dword v5, v8, s[0:3], 0 offen offset:4
; GFX90A-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX90A-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX90A-NEXT:    buffer_store_dword v4, v8, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_store_dword v5, v8, s[0:3], 0 offen offset:4
; GFX90A-NEXT:  .LBB21_2:
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GFX90A-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX908-NEXT:  .LBB21_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX908-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX908-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
; GFX908-NEXT:    buffer_load_dword v5, v8, s[0:3], 0 offen offset:4
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX908-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX908-NEXT:    buffer_store_dword v4, v8, s[0:3], 0 offen
; GFX908-NEXT:    buffer_store_dword v5, v8, s[0:3], 0 offen offset:4
; GFX908-NEXT:  .LBB21_2:
; GFX908-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX908-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX908-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GFX908-NEXT:  .LBB21_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB21_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX8-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 4, v8
; GFX8-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
; GFX8-NEXT:    buffer_load_dword v5, v9, s[0:3], 0 offen
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    buffer_store_dword v5, v9, s[0:3], 0 offen
; GFX8-NEXT:  .LBB21_2:
; GFX8-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX8-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX8-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB21_5
...
; GFX8-NEXT:  .LBB21_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX7-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX7-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX7-NEXT:    v_add_i32_e32 v9, vcc, 4, v8
; GFX7-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
; GFX7-NEXT:    buffer_load_dword v5, v9, s[0:3], 0 offen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX7-NEXT:    v_max_f64 v[4:5], v[4:5], v[6:7]
; GFX7-NEXT:    buffer_store_dword v4, v8, s[0:3], 0 offen
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB21_4: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:  .LBB22_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB22_5
...
; GFX12-NEXT:  .LBB22_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB22_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB22_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX11-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[4:5], v8, off
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB22_5
...
; GFX11-NEXT:  .LBB22_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB22_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB22_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX908-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX908-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
...
; GFX908-NEXT:    s_mov_b64 exec, s[8:9]
; GFX908-NEXT:    ; divergent control-flow edge
; GFX908-NEXT:    s_cbranch_execz .LBB22_5
...
; GFX908-NEXT:  .LBB22_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB22_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX8-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 4, v8
...
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB22_5
...
; GFX8-NEXT:  .LBB22_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB22_4: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds double, ptr %ptr, i64 255
...
; GFX12-NEXT:  .LBB23_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX12-NEXT:    v_max_num_f64_e32 v[6:7], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB23_5
...
; GFX12-NEXT:  .LBB23_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB23_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB23_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX11-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[4:5], v8, off
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB23_5
...
; GFX11-NEXT:  .LBB23_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB23_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:  .LBB23_4: ; %atomicrmw.phi
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB23_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX908-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX908-NEXT:    buffer_load_dword v4, v8, s[0:3], 0 offen
...
; GFX908-NEXT:  .LBB23_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB23_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX8-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 4, v8
...
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB23_5
...
; GFX8-NEXT:  .LBB23_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB23_4: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds double, ptr %ptr, i64 -256
...
; GFX12-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX12-NEXT:    v_max_num_f64_e32 v[8:9], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB24_5
; GFX12-NEXT:  .LBB24_3: ; %atomicrmw.global
; GFX12-NEXT:    flat_load_b64 v[6:7], v[0:1]
; GFX12-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX12-NEXT:  .LBB24_4: ; %atomicrmw.start
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    v_max_num_f64_e32 v[4:5], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    v_max_num_f64_e32 v[8:9], v[6:7], v[6:7]
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s1
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execnz .LBB24_4
; GFX12-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB24_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v0, v4
; GFX942-NEXT:    v_mov_b32_e32 v1, v5
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX11-NEXT:    v_max_f64 v[8:9], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[4:5], v10, off
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB24_5
; GFX11-NEXT:  .LBB24_3: ; %atomicrmw.global
; GFX11-NEXT:    flat_load_b64 v[6:7], v[0:1]
; GFX11-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX11-NEXT:  .LBB24_4: ; %atomicrmw.start
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX11-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_max_f64 v[8:9], v[6:7], v[6:7]
...
; GFX11-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX10-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX10-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
; GFX10-NEXT:    s_clause 0x1
...
; GFX10-NEXT:    s_mov_b32 exec_lo, s4
; GFX10-NEXT:    ; divergent control-flow edge
; GFX10-NEXT:    s_cbranch_execnz .LBB24_4
; GFX10-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    v_mov_b32_e32 v0, v4
; GFX10-NEXT:    v_mov_b32_e32 v1, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
...
; GFX90A-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX90A-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX90A-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_load_dword v5, v10, s[0:3], 0 offen offset:4
...
; GFX90A-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v4
; GFX90A-NEXT:    v_mov_b32_e32 v1, v5
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
...
; GFX908-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX908-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX908-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
...
; GFX908-NEXT:    s_mov_b64 exec, s[8:9]
; GFX908-NEXT:    ; divergent control-flow edge
; GFX908-NEXT:    s_cbranch_execz .LBB24_5
...
; GFX908-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    v_mov_b32_e32 v0, v4
; GFX908-NEXT:    v_mov_b32_e32 v1, v5
; GFX908-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX8-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 4, v10
...
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB24_5
; GFX8-NEXT:  .LBB24_3: ; %atomicrmw.global
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, 4, v0
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; GFX8-NEXT:    flat_load_dword v7, v[4:5]
; GFX8-NEXT:    flat_load_dword v6, v[0:1]
; GFX8-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX8-NEXT:  .LBB24_4: ; %atomicrmw.start
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_max_f64 v[8:9], v[6:7], v[6:7]
...
; GFX8-NEXT:    s_mov_b64 exec, s[4:5]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execnz .LBB24_4
; GFX8-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    v_mov_b32_e32 v0, v4
; GFX8-NEXT:    v_mov_b32_e32 v1, v5
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX7-NEXT:  .LBB24_1: ; %atomicrmw.private
; GFX7-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX7-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX7-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX7-NEXT:    v_add_i32_e32 v11, vcc, 4, v10
...
; GFX7-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX7-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX7-NEXT:    s_mov_b64 exec, s[8:9]
; GFX7-NEXT:    ; divergent control-flow edge
; GFX7-NEXT:    s_cbranch_execz .LBB24_5
; GFX7-NEXT:  .LBB24_3: ; %atomicrmw.global
...
; GFX7-NEXT:  .LBB24_4: ; %atomicrmw.start
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_max_f64 v[8:9], v[6:7], v[6:7]
; GFX7-NEXT:    v_max_f64 v[4:5], v[8:9], v[4:5]
...
; GFX7-NEXT:    s_mov_b64 exec, s[4:5]
; GFX7-NEXT:    ; divergent control-flow edge
; GFX7-NEXT:    s_cbranch_execnz .LBB24_4
; GFX7-NEXT:  .LBB24_5: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    v_mov_b32_e32 v0, v4
; GFX7-NEXT:    v_mov_b32_e32 v1, v5
; GFX7-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:  .LBB25_1: ; %atomicrmw.private
; GFX12-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX12-NEXT:    v_max_num_f64_e32 v[8:9], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB25_5
; GFX12-NEXT:  .LBB25_3: ; %atomicrmw.global
; GFX12-NEXT:    flat_load_b64 v[6:7], v[0:1]
; GFX12-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX12-NEXT:  .LBB25_4: ; %atomicrmw.start
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    v_max_num_f64_e32 v[4:5], v[2:3], v[2:3]
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    v_max_num_f64_e32 v[8:9], v[6:7], v[6:7]
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s1
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execnz .LBB25_4
; GFX12-NEXT:  .LBB25_5: ; %atomicrmw.phi
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:  .LBB25_4: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v0, v4
; GFX942-NEXT:    v_mov_b32_e32 v1, v5
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:  .LBB25_1: ; %atomicrmw.private
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GFX11-NEXT:    v_max_f64 v[8:9], v[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc_lo
; GFX11-NEXT:    scratch_load_b64 v[4:5], v10, off
...
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB25_5
; GFX11-NEXT:  .LBB25_3: ; %atomicrmw.global
; GFX11-NEXT:    flat_load_b64 v[6:7], v[0:1]
; GFX11-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX11-NEXT:  .LBB25_4: ; %atomicrmw.start
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX11-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_max_f64 v[8:9], v[6:7], v[6:7]
...
; GFX11-NEXT:  .LBB25_5: ; %atomicrmw.phi
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:  .LBB25_4: ; %atomicrmw.phi
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    v_mov_b32_e32 v0, v4
; GFX10-NEXT:    v_mov_b32_e32 v1, v5
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:  .LBB25_4: ; %atomicrmw.phi
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v4
; GFX90A-NEXT:    v_mov_b32_e32 v1, v5
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
...
; GFX908-NEXT:  .LBB25_1: ; %atomicrmw.private
; GFX908-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX908-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX908-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX908-NEXT:    buffer_load_dword v4, v10, s[0:3], 0 offen
...
; GFX908-NEXT:  .LBB25_5: ; %atomicrmw.phi
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    v_mov_b32_e32 v0, v4
; GFX908-NEXT:    v_mov_b32_e32 v1, v5
; GFX908-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:  .LBB25_1: ; %atomicrmw.private
; GFX8-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GFX8-NEXT:    v_max_f64 v[6:7], v[2:3], v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 4, v10
...
; GFX8-NEXT:    s_mov_b64 exec, s[8:9]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execz .LBB25_5
; GFX8-NEXT:  .LBB25_3: ; %atomicrmw.global
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, 4, v0
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; GFX8-NEXT:    flat_load_dword v7, v[4:5]
; GFX8-NEXT:    flat_load_dword v6, v[0:1]
; GFX8-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX8-NEXT:  .LBB25_4: ; %atomicrmw.start
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    v_max_f64 v[4:5], v[2:3], v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_max_f64 v[8:9], v[6:7], v[6:7]
...
; GFX8-NEXT:    s_mov_b64 exec, s[4:5]
; GFX8-NEXT:    ; divergent control-flow edge
; GFX8-NEXT:    s_cbranch_execnz .LBB25_4
; GFX8-NEXT:  .LBB25_5: ; %atomicrmw.phi
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    v_mov_b32_e32 v0, v4
; GFX8-NEXT:    v_mov_b32_e32 v1, v5
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:  .LBB25_4: ; %atomicrmw.phi
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:    v_mov_b32_e32 v0, v4
; GFX7-NEXT:    v_mov_b32_e32 v1, v5
; GFX7-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-TRUE16-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX942-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX11-TRUE16-NEXT:  .LBB26_2: ; %atomicrmw.end
...
; GFX11-FAKE16-NEXT:  .LBB26_2: ; %atomicrmw.end
...
; GFX10-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
...
; GFX8-NEXT:  .LBB26_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX12-TRUE16-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v3, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB27_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v3, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB30_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB31_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds half, ptr %ptr, i64 -1024
  %unused = atomicrmw fmax ptr %gep, half %val syncscope("agent") seq_cst, !amdgpu.no.fine.grained.memory !0
...
; GFX12-TRUE16-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX942-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX10-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB32_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds half, ptr %ptr, i64 1023
...
; GFX12-TRUE16-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB33_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds half, ptr %ptr, i64 1023
...
; GFX12-TRUE16-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v3, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_lshrrev_b32_e32 v0, v3, v4
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB34_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB35_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds half, ptr %ptr, i64 1023
...
; GFX12-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX942-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v3, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX10-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_lshrrev_b32_e32 v0, v3, v4
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX11-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX908-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v4, v2
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_lshrrev_b32_e32 v0, v4, v2
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB38_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds bfloat, ptr %ptr, i64 1023
...
; GFX12-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds bfloat, ptr %ptr, i64 -1024
  %unused = atomicrmw fmax ptr %gep, bfloat %val syncscope("agent") seq_cst, !amdgpu.no.fine.grained.memory !0
...
; GFX12-TRUE16-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v3.l
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX11-TRUE16-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v3.l
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX908-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB42_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds bfloat, ptr %ptr, i64 1023
...
; GFX12-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB43_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds bfloat, ptr %ptr, i64 1023
...
; GFX12-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, v4, v2
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_lshrrev_b32_e32 v0, v4, v2
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB44_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB45_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX942-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    v_mov_b32_e32 v0, v3
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v0, v3
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    flat_atomic_cmpswap v4, v[0:1], v[5:6] glc
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX7-NEXT:  .LBB46_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX12-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB47_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 16, v5
; GFX7-NEXT:    v_or_b32_e32 v0, v0, v1
...
; GFX12-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB48_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 16, v5
; GFX7-NEXT:    v_or_b32_e32 v0, v0, v1
...
; GFX12-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB49_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB50_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds <2 x half>, ptr %ptr, i64 511
...
; GFX12-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB51_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds <2 x half>, ptr %ptr, i64 -512
  %unused = atomicrmw fmax ptr %gep, <2 x half> %val syncscope("agent") seq_cst, !amdgpu.no.fine.grained.memory !0
...
; GFX12-NEXT:  .LBB52_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB52_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB52_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB52_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB52_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB52_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB53_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB53_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB53_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB53_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB53_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB53_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX942-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB54_2: ; %atomicrmw.end
...
; GFX11-FAKE16-NEXT:  .LBB54_2: ; %atomicrmw.end
...
; GFX10-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    v_mov_b32_e32 v0, v3
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    v_mov_b32_e32 v0, v3
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB54_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX12-TRUE16-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB55_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    v_mul_f32_e32 v0, 1.0, v5
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX7-NEXT:    v_mul_f32_e32 v1, 1.0, v4
...
; GFX12-TRUE16-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB56_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    v_mul_f32_e32 v0, 1.0, v5
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX7-NEXT:    v_mul_f32_e32 v1, 1.0, v4
...
; GFX12-TRUE16-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB57_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-TRUE16-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB58_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds <2 x bfloat>, ptr %ptr, i64 511
...
; GFX12-TRUE16-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX8-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:  .LBB59_2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr inbounds <2 x bfloat>, ptr %ptr, i64 -512
  %unused = atomicrmw fmax ptr %gep, <2 x bfloat> %val syncscope("agent") seq_cst, !amdgpu.no.fine.grained.memory !0
...
; GFX12-TRUE16-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v0, v3
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v0, v3
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v3
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB60_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    v_mov_b32_e32 v0, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:  .LBB61_2: ; %atomicrmw.end
; GFX908-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
