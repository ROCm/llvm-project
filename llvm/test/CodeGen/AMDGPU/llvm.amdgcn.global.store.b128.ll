...
; GFX-SDAG-NEXT:    ds_read_b64 v[4:5], v0
; GFX-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX-SDAG-NEXT:    v_mov_b32_e32 v6, s6
; GFX-SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX-SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX-SDAG-NEXT:    v_readfirstlane_b32 s0, v4
; GFX-SDAG-NEXT:    v_readfirstlane_b32 s1, v5
; GFX-SDAG-NEXT:    s_nop 4
; GFX-SDAG-NEXT:    global_store_dwordx4 v6, v[0:3], s[0:1]
...
; GFX-SDAG-NEXT:    v_readfirstlane_b32 s1, v5
; GFX-SDAG-NEXT:    s_nop 4
; GFX-SDAG-NEXT:    global_store_dwordx4 v6, v[0:3], s[0:1] offset:-120 sc0
; GFX-SDAG-NEXT:    s_endpgm
;
