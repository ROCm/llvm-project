...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu7.04 < %s | FileCheck %s -check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck %s -check-prefix=VI
