...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu7.04 < %s | FileCheck %s -check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck %s -check-prefix=VI
...
; SI:    s_load_dword s4, s[4:5], 0xb
; SI:    s_mov_b32 s3, 0xf000
; SI:    s_mov_b32 s2, -1
; SI:    v_cvt_pknorm_i16_f32_e64 v0, s4, s4
; SI:    s_endpgm
;
...
; SI:  ; %bb.0:
; SI:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI:    s_load_dwordx2 s[4:5], s[4:5], 0xd
; SI:    s_mov_b32 s11, 0xf000
; SI:    s_mov_b32 s10, 0
; SI:    v_lshlrev_b32_e32 v0, 2, v0
; SI:    s_mov_b64 s[8:9], s[2:3]
; SI:    v_mov_b32_e32 v1, 0
; SI:    s_mov_b64 s[6:7], s[10:11]
; SI:    buffer_load_dword v2, v[0:1], s[8:11], 0 addr64 glc
; SI:    buffer_load_dword v3, v[0:1], s[4:7], 0 addr64 glc
; SI:    s_mov_b64 s[2:3], s[10:11]
