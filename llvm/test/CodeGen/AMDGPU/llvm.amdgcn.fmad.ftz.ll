...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu6.00 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.02 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.02 -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.00 -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX9-SDAG %s
...
; GFX6-LABEL: mad_f32:
; GFX6:  ; %bb.0:
; GFX6:    s_mov_b32 s8, 0xf000
; GFX6:    s_mov_b32 s9, -1
; GFX6:    s_mov_b32 s2, s9
; GFX6:    s_mov_b32 s3, s8
; GFX6:    v_mov_b32_e32 v0, s6
; GFX6:    v_mov_b32_e32 v1, s4
; GFX6:    v_mac_f32_e32 v0, s5, v1
; GFX6:    s_endpgm
;
; GFX8-LABEL: mad_f32:
; GFX8:  ; %bb.0:
...
; GFX6:  ; %bb.0:
; GFX6:    s_mov_b32 s6, 0xf000
; GFX6:    s_mov_b32 s7, -1
; GFX6:    s_mov_b32 s2, s7
; GFX6:    s_mov_b32 s3, s6
