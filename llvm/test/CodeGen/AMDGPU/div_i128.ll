...
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v7, v13, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v12, v6, v12, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[6:7], v22, v[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v13, v9, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v12, v8, s[4:5]
...
; GFX9-NEXT:    v_or_b32_e32 v10, v10, v15
; GFX9-NEXT:    v_or_b32_e32 v12, v12, v14
; GFX9-NEXT:    v_sub_co_u32_e32 v14, vcc, v26, v10
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v27, v11, vcc
...
; GFX9-NEXT:    v_sub_co_u32_e32 v10, vcc, v10, v14
...
; GFX9-G-NEXT:    v_xor_b32_e32 v8, v16, v0
; GFX9-G-NEXT:    v_xor_b32_e32 v0, v17, v4
; GFX9-G-NEXT:    v_xor_b32_e32 v9, v16, v1
; GFX9-G-NEXT:    v_xor_b32_e32 v1, v17, v5
; GFX9-G-NEXT:    v_sub_co_u32_e32 v18, vcc, v0, v17
; GFX9-G-NEXT:    v_xor_b32_e32 v4, v17, v6
; GFX9-G-NEXT:    v_subb_co_u32_e32 v19, vcc, v1, v17, vcc
; GFX9-G-NEXT:    v_sub_co_u32_e64 v10, s[4:5], v8, v16
; GFX9-G-NEXT:    v_xor_b32_e32 v2, v16, v2
; GFX9-G-NEXT:    v_xor_b32_e32 v5, v17, v7
; GFX9-G-NEXT:    v_subb_co_u32_e32 v4, vcc, v4, v17, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e64 v11, s[4:5], v9, v16, s[4:5]
; GFX9-G-NEXT:    v_xor_b32_e32 v3, v16, v3
; GFX9-G-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v17, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e64 v12, s[4:5], v2, v16, s[4:5]
; GFX9-G-NEXT:    v_or_b32_e32 v0, v18, v4
; GFX9-G-NEXT:    v_or_b32_e32 v1, v19, v5
; GFX9-G-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v3, v16, s[4:5]
...
; GFX9-G-NEXT:    v_ffbh_u32_e32 v6, v12
; GFX9-G-NEXT:    v_min_u32_e32 v2, v2, v3
; GFX9-G-NEXT:    v_ffbh_u32_e32 v3, v13
; GFX9-G-NEXT:    v_add_u32_e32 v6, 32, v6
; GFX9-G-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GFX9-G-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[12:13]
; GFX9-G-NEXT:    v_add_u32_e32 v2, 64, v2
; GFX9-G-NEXT:    v_min_u32_e32 v3, v3, v6
; GFX9-G-NEXT:    v_cndmask_b32_e32 v1, v3, v2, vcc
...
; GFX9-G-NEXT:    v_cndmask_b32_e64 v6, v10, 0, s[10:11]
; GFX9-G-NEXT:    v_cndmask_b32_e64 v7, v11, 0, s[10:11]
; GFX9-G-NEXT:    v_cndmask_b32_e64 v8, v12, 0, s[10:11]
; GFX9-G-NEXT:    v_cndmask_b32_e64 v9, v13, 0, s[10:11]
...
; GFX9-G-NEXT:    v_mov_b32_e32 v3, s11
; GFX9-G-NEXT:    v_add_co_u32_e32 v2, vcc, -1, v18
; GFX9-G-NEXT:    v_addc_co_u32_e32 v3, vcc, -1, v19, vcc
; GFX9-G-NEXT:    v_addc_co_u32_e32 v24, vcc, -1, v4, vcc
; GFX9-G-NEXT:    v_mov_b32_e32 v11, 0
; GFX9-G-NEXT:    v_mov_b32_e32 v1, s9
; GFX9-G-NEXT:    v_addc_co_u32_e32 v25, vcc, -1, v5, vcc
...
; GFX9-G-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX9-G-NEXT:    v_or_b32_e32 v6, v0, v6
; GFX9-G-NEXT:    v_or_b32_e32 v7, v1, v7
...
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v14, 31, v9
; GFX9-G-NEXT:    v_or_b32_e32 v12, v12, v14
; GFX9-G-NEXT:    v_sub_co_u32_e32 v14, vcc, v2, v12
; GFX9-G-NEXT:    v_subb_co_u32_e32 v14, vcc, v3, v13, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v14, vcc, v24, v0, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v14, vcc, v25, v1, vcc
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v26, 31, v14
; GFX9-G-NEXT:    v_and_b32_e32 v14, v26, v18
; GFX9-G-NEXT:    v_and_b32_e32 v15, v26, v19
; GFX9-G-NEXT:    v_sub_co_u32_e32 v12, vcc, v12, v14
; GFX9-G-NEXT:    v_subb_co_u32_e32 v13, vcc, v13, v15, vcc
; GFX9-G-NEXT:    v_and_b32_e32 v14, v26, v4
; GFX9-G-NEXT:    v_and_b32_e32 v15, v26, v5
; GFX9-G-NEXT:    v_subb_co_u32_e32 v14, vcc, v0, v14, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v15, vcc, v1, v15, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e32 v15, v13, v15, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v14, v12, v14, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[12:13], v18, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v15, v1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v14, v0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v15, 0, v13, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v14, 0, v12, vcc
...
; GFX9-NEXT:    v_sub_co_u32_e32 v16, vcc, v22, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v16, vcc, v23, v3, vcc
...
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, v2, v16
...
; GFX9-G-NEXT:    v_ffbh_u32_e32 v9, v6
; GFX9-G-NEXT:    v_add_u32_e32 v10, 64, v8
; GFX9-G-NEXT:    v_ffbh_u32_e32 v8, v7
; GFX9-G-NEXT:    v_add_u32_e32 v9, 32, v9
; GFX9-G-NEXT:    v_min_u32_e32 v11, v8, v9
; GFX9-G-NEXT:    v_ffbh_u32_e32 v9, v0
; GFX9-G-NEXT:    s_or_b64 s[10:11], vcc, s[4:5]
; GFX9-G-NEXT:    v_ffbh_u32_e32 v8, v1
; GFX9-G-NEXT:    v_add_u32_e32 v9, 32, v9
; GFX9-G-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[6:7]
; GFX9-G-NEXT:    v_min_u32_e32 v8, v8, v9
; GFX9-G-NEXT:    v_ffbh_u32_e32 v9, v2
; GFX9-G-NEXT:    v_add_u32_e32 v12, 64, v8
; GFX9-G-NEXT:    v_ffbh_u32_e32 v8, v3
; GFX9-G-NEXT:    v_add_u32_e32 v9, 32, v9
; GFX9-G-NEXT:    v_cndmask_b32_e32 v10, v11, v10, vcc
; GFX9-G-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX9-G-NEXT:    v_min_u32_e32 v13, v8, v9
; GFX9-G-NEXT:    v_cndmask_b32_e32 v11, v13, v12, vcc
; GFX9-G-NEXT:    v_sub_co_u32_e32 v12, vcc, v10, v11
...
; GFX9-G-NEXT:    v_add_co_u32_e32 v12, vcc, -1, v4
; GFX9-G-NEXT:    v_addc_co_u32_e32 v13, vcc, -1, v5, vcc
; GFX9-G-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v18
; GFX9-G-NEXT:    v_addc_co_u32_e32 v22, vcc, -1, v6, vcc
; GFX9-G-NEXT:    v_cndmask_b32_e64 v2, v2, v0, s[4:5]
; GFX9-G-NEXT:    v_cndmask_b32_e64 v3, v3, v1, s[4:5]
; GFX9-G-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-G-NEXT:    v_mov_b32_e32 v11, s9
; GFX9-G-NEXT:    v_mov_b32_e32 v10, s8
; GFX9-G-NEXT:    v_addc_co_u32_e32 v23, vcc, -1, v7, vcc
...
; GFX9-G-NEXT:    v_or_b32_e32 v14, v10, v14
; GFX9-G-NEXT:    v_or_b32_e32 v15, v11, v15
; GFX9-G-NEXT:    v_lshlrev_b64 v[10:11], 1, v[16:17]
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v16, 31, v3
; GFX9-G-NEXT:    v_lshlrev_b64 v[2:3], 1, v[2:3]
; GFX9-G-NEXT:    v_or_b32_e32 v10, v10, v16
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v16, 31, v9
; GFX9-G-NEXT:    v_or_b32_e32 v2, v2, v16
; GFX9-G-NEXT:    v_sub_co_u32_e32 v16, vcc, v12, v2
; GFX9-G-NEXT:    v_subb_co_u32_e32 v16, vcc, v13, v3, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v16, vcc, v22, v10, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v16, vcc, v23, v11, vcc
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v24, 31, v16
; GFX9-G-NEXT:    v_and_b32_e32 v16, v24, v4
; GFX9-G-NEXT:    v_and_b32_e32 v17, v24, v5
; GFX9-G-NEXT:    v_sub_co_u32_e32 v2, vcc, v2, v16
; GFX9-G-NEXT:    v_subb_co_u32_e32 v3, vcc, v3, v17, vcc
; GFX9-G-NEXT:    v_and_b32_e32 v16, v24, v6
; GFX9-G-NEXT:    v_and_b32_e32 v17, v24, v7
; GFX9-G-NEXT:    v_subb_co_u32_e32 v16, vcc, v10, v16, vcc
...
; GFX9-G-NEXT:    v_and_b32_e32 v0, 1, v24
