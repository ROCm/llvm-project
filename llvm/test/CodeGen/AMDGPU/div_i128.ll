...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu9.00-amd-amdhsa -o - %s | FileCheck -check-prefixes=GFX9-G %s
; RUN: llc -amdgpu-late-wave-transform=0 -O0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu9.00-amd-amdhsa -o - %s | FileCheck -check-prefixes=GFX9-G-O0 %s
...
; GFX9-NEXT:    s_xor_b64 exec, s[6:7], exec
; GFX9-NEXT:    ; divergent control-flow edge
...
; GFX9-O0-NEXT:    s_mov_b64 exec, s[20:21]
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_readlane_b32 s6, v31, 6
; GFX9-O0-NEXT:    v_readlane_b32 s7, v31, 7
