...
; GCN-NEXT:    s_wait_loadcnt_dscnt 0x0
; GCN-NEXT:    s_wait_kmcnt 0x0
; GCN-NEXT:    v_tanh_bf16_e32 v0.h, v0.l
; GCN-NEXT:    v_nop
; GCN-NEXT:    v_mov_b16_e32 v0.l, 0
; GCN-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instid1(VALU_DEP_1)
...
; GCN-NEXT:    s_wait_loadcnt_dscnt 0x0
; GCN-NEXT:    s_wait_kmcnt 0x0
; GCN-NEXT:    v_tanh_f16_e32 v0.l, v0.l
; GCN-NEXT:    s_set_pc_i64 s[30:31]
