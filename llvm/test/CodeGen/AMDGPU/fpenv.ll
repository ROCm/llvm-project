...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -global-isel=1 < %s | FileCheck -check-prefixes=GFX6-ISEL %s
; RUN: llc -mtriple=amdgpu8.03 -global-isel=0 < %s | FileCheck -check-prefixes=GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -global-isel=1 < %s | FileCheck -check-prefixes=GFX8-ISEL %s
; RUN: llc -mtriple=amdgpu9.00 -global-isel=0 < %s | FileCheck -check-prefixes=GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -global-isel=1 < %s | FileCheck -check-prefixes=GFX9-ISEL %s
; RUN: llc -mtriple=amdgpu10.30 -global-isel=0 < %s | FileCheck -check-prefixes=GFX10-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 -global-isel=1 < %s | FileCheck -check-prefixes=GFX10-ISEL %s
; RUN: llc -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -global-isel=0 < %s | FileCheck -check-prefixes=GFX11-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -global-isel=1 < %s | FileCheck -check-prefixes=GFX11-ISEL %s
