...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX90A
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=+enable-flat-scratch,+precise-memory < %s | FileCheck --check-prefixes=GFX9-FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX11
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX12
...
; GFX9-FLATSCR-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX9-FLATSCR-NEXT:    s_or_b64 s[0:1], s[0:1], s[2:3]
; GFX9-FLATSCR-NEXT:    ; divergent control-flow edge
; GFX9-FLATSCR-NEXT:    s_cbranch_execnz .LBB0_1
; GFX9-FLATSCR-NEXT:  .LBB0_2: ; %atomicrmw.end
...
; GFX9-FLATSCR-NEXT:  .LBB1_2: ; %atomicrmw.end
; GFX9-FLATSCR-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX90A-NEXT:    ; divergent control-flow edge
...
; GFX9-FLATSCR-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX9-FLATSCR-NEXT:    ; divergent control-flow edge
; GFX9-FLATSCR-NEXT:    s_cbranch_execnz .LBB5_2
; GFX9-FLATSCR-NEXT:  .LBB5_1:
; GFX9-FLATSCR-NEXT:    s_endpgm
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX90A-NEXT:    ; divergent control-flow edge
...
; GFX9-FLATSCR-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9-FLATSCR-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX9-FLATSCR-NEXT:    ; implicit-def: $vgpr1
; GFX9-FLATSCR-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX9-FLATSCR-NEXT:    ; divergent control-flow edge
; GFX9-FLATSCR-NEXT:    s_cbranch_execz .LBB7_2
; GFX9-FLATSCR-NEXT:  .LBB7_1:
