...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX90A
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -mattr=+enable-flat-scratch,+precise-memory < %s | FileCheck --check-prefixes=GFX9-FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX11
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=+precise-memory < %s | FileCheck %s -check-prefixes=GFX12
...
; GFX9-FLATSCR-NEXT:    s_load_dword s2, s[4:5], 0x2c
; GFX9-FLATSCR-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-FLATSCR-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX9-FLATSCR-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX9-FLATSCR-NEXT:    s_or_b64 exec, exec, vcc
...
; GFX12-NEXT:  .LBB7_1:
; GFX12-NEXT:    s_load_b32 s1, s[4:5], 0x2c
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_mul_i32 s0, s0, 5
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v1, s1
