...
; CHECK-NEXT:    v_cmp_le_i32_e32 vcc, s3, v0
...
; CHECK-NEXT:    v_lshl_add_u64 v[2:3], v[2:3], 2, v[4:5]
...
; CHECK-NEXT:    v_lshl_add_u64 v[2:3], v[4:5], 2, v[2:3]
; CHECK-NEXT:    global_load_dwordx4 v[2:5], v[2:3], off
...
; CHECK-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; CHECK-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 2, v[4:5]
