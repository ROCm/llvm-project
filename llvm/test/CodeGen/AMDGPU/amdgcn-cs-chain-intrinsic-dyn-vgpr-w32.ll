...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.00-amd-amdpal < %s | FileCheck -check-prefix=GISEL-GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu12.00-amd-amdpal < %s | FileCheck -check-prefix=DAGISEL-GFX12 %s
