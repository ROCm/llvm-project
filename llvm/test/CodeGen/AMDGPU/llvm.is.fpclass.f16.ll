...
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu7.04 < %s  | FileCheck --check-prefixes=GFX7CHECK,GFX7SELDAG %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu7.04 < %s  | FileCheck --check-prefixes=GFX7CHECK,GFX7GLISEL %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.03 < %s  | FileCheck --check-prefixes=GFX8CHECK,GFX8SELDAG %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu8.03 < %s  | FileCheck --check-prefixes=GFX8CHECK,GFX8GLISEL %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.08 < %s  | FileCheck --check-prefixes=GFX9CHECK,GFX9SELDAG %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu9.08 < %s  | FileCheck --check-prefixes=GFX9CHECK,GFX9GLISEL %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu10.31 < %s | FileCheck --check-prefixes=GFX10CHECK,GFX10SELDAG %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu10.31 < %s | FileCheck --check-prefixes=GFX10CHECK,GFX10GLISEL %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11SELDAG,GFX11SELDAG-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11SELDAG,GFX11SELDAG-FAKE16 %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11GLISEL,GFX11GLISEL-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11GLISEL,GFX11GLISEL-FAKE16 %s
