...
; GCN: s_cbranch_vccz [[ENDIF:.LBB[0-9]+_[0-9]+]]
...
; GCN: s_addc_u32
; GCN: s_and_b64
; GCN: s_cselect_b64 s{{\[[0-9]+:[0-9]+\]}}, s{{\[[0-9]+:[0-9]+\]}}, s{{\[[0-9]+:[0-9]+\]}}
...
; Under LWT, cost model rejects if-conversion ("Not enough available ILP")
