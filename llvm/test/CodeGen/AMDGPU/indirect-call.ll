...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00-amd-amdhsa < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00-amd-amdhsa -global-isel < %s | FileCheck -check-prefix=GISEL %s
...
; GISEL-NEXT:    s_mov_b64 s[38:39], s[6:7]
; GISEL-NEXT:    s_mov_b64 s[48:49], s[4:5]
; GISEL-NEXT:    s_xor_b64 s[54:55], vcc, exec
; GISEL-NEXT:    s_xor_b64 exec, s[54:55], exec
; GISEL-NEXT:    ; divergent control-flow edge
; GISEL-NEXT:    s_cbranch_execz .LBB5_4
; GISEL-NEXT:  .LBB5_1: ; %bb1
