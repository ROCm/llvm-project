...
; RUN: llc < %s -mtriple=amdgpu6.00-amd-mesa3d -global-isel=0 -fast-isel=0 | FileCheck %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.00-amd-mesa3d -global-isel=1 -fast-isel=0 | FileCheck %s
; RUN: llc < %s -mtriple=amdgpu6.00-amd-mesa3d -global-isel=0 -fast-isel=1 | FileCheck %s
