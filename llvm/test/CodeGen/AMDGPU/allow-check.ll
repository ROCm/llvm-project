...
; RUN: llc < %s -mtriple=amdgcn-amd-mesa3d -mcpu=gfx600 -global-isel=0 -fast-isel=0 | FileCheck %s
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn-amd-mesa3d -mcpu=gfx600 -global-isel=1 -fast-isel=0 | FileCheck %s
; RUN: llc < %s -mtriple=amdgcn-amd-mesa3d -mcpu=gfx600 -global-isel=0 -fast-isel=1 | FileCheck %s
