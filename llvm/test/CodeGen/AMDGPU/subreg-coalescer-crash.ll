...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -o - %s | FileCheck -check-prefixes=GCN,GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -o - %s | FileCheck -check-prefixes=GCN,GFX8 %s
