...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.00 | FileCheck %s -check-prefixes=GFX678910,GFX6789,GFX678,GFX67,GFX6
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu7.01 | FileCheck %s -check-prefixes=GFX678910,GFX6789,GFX78910,GFX678,GFX789,GFX67,GFX78,GFX7
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 | FileCheck %s -check-prefixes=GFX678910,GFX6789,GFX78910,GFX678,GFX789,GFX8910,GFX78,GFX89,GFX8
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.00 | FileCheck %s -check-prefixes=GFX678910,GFX6789,GFX78910,GFX789,GFX8910,GFX89,GFX910,GFX9
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 | FileCheck %s -check-prefixes=GFX678910,GFX78910,GFX8910,GFX910,GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -amdgpu-enable-vopd=0 | FileCheck %s -check-prefixes=GFX11
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -amdgpu-enable-vopd=0 | FileCheck %s -check-prefixes=GFX1200_GFX1250,GFX1200
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.50 -amdgpu-enable-vopd=0 -mattr=-wait-xcnt | FileCheck %s -check-prefixes=GFX1200_GFX1250,GFX1250
