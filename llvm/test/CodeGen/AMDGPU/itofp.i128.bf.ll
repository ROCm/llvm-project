...
; GCN-NEXT:    v_cndmask_b32_e64 v7, v6, v2, s[4:5]
...
; GCN-NEXT:    v_cmp_gt_i32_e64 s[4:5], 26, v6
...
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 26, v6
; GCN-NEXT:    s_xor_b64 s[6:7], s[4:5], exec
...
; GCN-NEXT:    v_cndmask_b32_e64 v15, v8, v0, s[6:7]
; GCN-NEXT:    v_lshlrev_b64 v[7:8], v7, v[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v9, v9, v1, s[6:7]
...
; GCN-NEXT:    v_cndmask_b32_e64 v8, v8, v11, s[4:5]
; GCN-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v14
; GCN-NEXT:    v_cndmask_b32_e64 v7, v7, v10, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e64 v5, v8, v5, s[6:7]
; GCN-NEXT:    v_cndmask_b32_e64 v4, v7, v4, s[6:7]
...
; GCN-NEXT:    v_cmp_ne_u64_e64 s[4:5], 0, v[0:1]
...
; GCN-NEXT:    v_add_co_u32_e64 v4, s[4:5], 1, v0
; GCN-NEXT:    v_addc_co_u32_e64 v1, s[4:5], 0, v1, s[4:5]
; GCN-NEXT:    v_and_b32_e32 v7, 0x4000000, v4
; GCN-NEXT:    v_mov_b32_e32 v8, 0
; GCN-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[7:8]
...
; GCN-NEXT:    v_lshl_add_u32 v2, v2, 23, 1.0
...
; GCN-NEXT:    v_cmp_u_f32_e64 s[4:5], v1, v1
...
; GCN-NEXT:    v_cndmask_b32_e64 v6, v5, v4, s[4:5]
...
; GCN-NEXT:    v_cmp_gt_i32_e64 s[4:5], 26, v5
; GCN-NEXT:    s_xor_b64 s[6:7], s[4:5], exec
; GCN-NEXT:    s_mov_b64 exec, s[4:5]
; GCN-NEXT:    ; divergent control-flow edge
...
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 26, v5
; GCN-NEXT:    s_xor_b64 s[6:7], s[4:5], exec
; GCN-NEXT:    s_or_b64 s[10:11], s[10:11], s[4:5]
; GCN-NEXT:    s_mov_b64 exec, s[6:7]
; GCN-NEXT:    ; divergent control-flow edge
...
; GCN-NEXT:    v_cndmask_b32_e64 v14, v7, v0, s[6:7]
; GCN-NEXT:    v_lshlrev_b64 v[6:7], v6, v[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v8, v8, v1, s[6:7]
; GCN-NEXT:    v_or_b32_e32 v10, v12, v10
...
; GCN-NEXT:    v_cndmask_b32_e64 v3, v7, v3, s[6:7]
...
; GCN-NEXT:    v_add_co_u32_e64 v0, s[4:5], 1, v0
; GCN-NEXT:    v_addc_co_u32_e64 v1, s[4:5], 0, v1, s[4:5]
; GCN-NEXT:    v_and_b32_e32 v2, 0x4000000, v0
; GCN-NEXT:    v_mov_b32_e32 v3, 0
; GCN-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[2:3]
; GCN-NEXT:    v_alignbit_b32 v2, v1, v0, 2
; GCN-NEXT:    s_xor_b64 s[6:7], s[4:5], exec
; GCN-NEXT:    s_or_b64 s[4:5], s[8:9], s[4:5]
; GCN-NEXT:    s_mov_b64 exec, s[6:7]
; GCN-NEXT:    ; divergent control-flow edge
...
; GCN-NEXT:    v_cndmask_b32_e64 v2, 0, v0, s[4:5]
; GCN-NEXT:  .LBB1_10: ; %itofp-if-end26
; GCN-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-NEXT:    v_and_b32_e32 v0, 0x7fffff, v2
...
; GCN-NEXT:    v_alignbit_b32 v2, v1, v0, 3
