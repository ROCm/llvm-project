...
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, v5, v6
; CHECK-NEXT:    v_sub_i32_e32 v4, vcc, v4, v7
; CHECK-NEXT:    v_subb_u32_e64 v5, s[4:5], v5, v6, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v2
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[4:5]
; CHECK-NEXT:    v_subb_u32_e32 v7, vcc, v9, v3, vcc
...
; CHECK-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v7, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v3, v14, v12, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v4, v15, v16, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v12, v10, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, v4, v2
...
; CHECK-NEXT:    v_subb_u32_e32 v7, vcc, v9, v6, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v2, v6
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v9, v4, vcc
; CHECK-NEXT:    v_sub_i32_e32 v3, vcc, v3, v5
; CHECK-NEXT:    v_subbrev_u32_e32 v4, vcc, 0, v7, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v10, v8, vcc
...
; GISEL-NEXT:    v_subb_u32_e64 v8, s[4:5], v1, v11, vcc
; GISEL-NEXT:    v_sub_i32_e64 v1, s[4:5], v1, v11
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v8, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v0, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v8, v10
...
; GISEL-NEXT:    v_addc_u32_e32 v12, vcc, 0, v7, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v10
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v13, v0, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, 1, v11
...
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v3, v2
...
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, v5, v6
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v7, v4, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v5, v9
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[4:5]
; CGP-NEXT:    v_subb_u32_e32 v7, vcc, v11, v10, vcc
...
; CGP-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v7, vcc
...
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; CGP-NEXT:    v_cndmask_b32_e32 v5, v12, v8, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v6, v13, v14, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CGP-NEXT:    v_cndmask_b32_e32 v2, v2, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v3, v3, v6, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v5, v3, v6
; GISEL-NEXT:    v_mul_hi_u32 v7, v3, v6
; GISEL-NEXT:    v_mul_lo_u32 v9, 0, v6
; GISEL-NEXT:    v_mul_lo_u32 v10, v1, v2
; GISEL-NEXT:    v_mul_hi_u32 v12, v1, v2
; GISEL-NEXT:    v_mul_lo_u32 v15, 0, v2
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, 1, v6
; GISEL-NEXT:    v_addc_u32_e32 v17, vcc, 0, v13, vcc
; GISEL-NEXT:    v_add_i32_e32 v18, vcc, 1, v2
; GISEL-NEXT:    v_addc_u32_e32 v19, vcc, 0, v8, vcc
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v7, v11
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v12, v14
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v16
...
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v0, v10
; GISEL-NEXT:    v_subb_u32_e64 v10, s[6:7], 0, v9, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[6:7]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v5
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[8:9], 0, v10
; GISEL-NEXT:    v_add_i32_e64 v5, s[10:11], 1, v18
; GISEL-NEXT:    v_addc_u32_e64 v10, s[10:11], 0, v19, s[10:11]
; GISEL-NEXT:    v_sub_i32_e64 v7, s[10:11], 0, v7
...
; GISEL-NEXT:    v_subbrev_u32_e32 v4, vcc, 0, v9, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v18, v5, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v17, v14, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v19, v10, s[4:5]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v13, v4, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v8, v5, s[4:5]
; GISEL-NEXT:    s_setpc_b64 s[30:31]
;
