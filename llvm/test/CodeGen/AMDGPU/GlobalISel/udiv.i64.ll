...
; CHECK-NEXT:    v_mul_lo_u32 v10, v3, v0
; CHECK-NEXT:    v_mul_lo_u32 v9, v2, v0
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, v7, v10
; CHECK-NEXT:    v_sub_i32_e32 v8, vcc, v4, v9
; CHECK-NEXT:    v_subb_u32_e64 v9, s[4:5], v5, v7, vcc
...
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, 1, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v7, v7, v10, s[4:5]
; CHECK-NEXT:    v_addc_u32_e32 v10, vcc, 0, v1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v3
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v8, v2
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v5, v3
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v11, v8, vcc
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, 1, v9
; CHECK-NEXT:    v_addc_u32_e32 v8, vcc, 0, v10, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v9, v5, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v5, v10, v8, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v14, v5, v0
; CGP-NEXT:    v_mul_lo_u32 v13, v4, v0
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v12
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v14
; CGP-NEXT:    v_sub_i32_e32 v12, vcc, v10, v13
; CGP-NEXT:    v_subb_u32_e64 v13, s[4:5], v11, v3, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v12, vcc, v12, v4
...
; CGP-NEXT:    v_cndmask_b32_e64 v11, v11, v14, s[4:5]
...
; CGP-NEXT:    v_cndmask_b32_e32 v3, v15, v12, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v12, v7, v2
; CGP-NEXT:    v_mul_lo_u32 v11, v6, v2
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v10
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v12
; CGP-NEXT:    v_sub_i32_e32 v10, vcc, v8, v11
; CGP-NEXT:    v_subb_u32_e64 v11, s[4:5], v9, v5, vcc
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, 1, v2
; CGP-NEXT:    v_cndmask_b32_e64 v9, v9, v12, s[4:5]
; CGP-NEXT:    v_addc_u32_e32 v12, vcc, 0, v3, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v7
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v10, v6
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, -1, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v11, v7, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v7, v12, v10, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; CGP-NEXT:    v_cndmask_b32_e32 v2, v2, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v3, v3, v7, vcc
; CGP-NEXT:  .LBB2_6:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; CGP-NEXT:    s_mov_b64 exec, s[6:7]
...
; CHECK-NEXT:    v_mul_lo_u32 v6, v7, v1
; CHECK-NEXT:    v_mul_lo_u32 v10, v8, v0
; CHECK-NEXT:    v_mul_lo_u32 v9, v7, v0
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v6
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v10
; CHECK-NEXT:    v_sub_i32_e32 v6, vcc, v3, v9
; CHECK-NEXT:    v_subb_u32_e64 v9, s[4:5], v4, v2, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v9, v6, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v6, v10, v8, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v4, v12, v1
; CGP-NEXT:    v_mul_lo_u32 v14, v13, v0
; CGP-NEXT:    v_mul_lo_u32 v6, v12, v0
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v14
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v8, v6
; CGP-NEXT:    v_subb_u32_e64 v6, s[4:5], v9, v3, vcc
; CGP-NEXT:    v_sub_i32_e64 v3, s[4:5], v9, v3
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v6, v13
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v3, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v12
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v4, v12
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v6, v13
; CGP-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v3, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v6, v9, v14, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v9, vcc, 1, v0
; CGP-NEXT:    v_addc_u32_e32 v14, vcc, 0, v1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v13
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v12
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v13
; CGP-NEXT:    v_cndmask_b32_e32 v3, v15, v4, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, 1, v9
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, 0, v14, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CGP-NEXT:    v_cndmask_b32_e32 v3, v9, v4, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v4, v14, v13, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v9, v10, v2
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v12
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v5, v9
; CGP-NEXT:    v_subb_u32_e64 v9, s[4:5], v7, v4, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v7, v7, v12, s[4:5]
; CGP-NEXT:    v_addc_u32_e32 v12, vcc, 0, v3, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v6, v12, v11, vcc
