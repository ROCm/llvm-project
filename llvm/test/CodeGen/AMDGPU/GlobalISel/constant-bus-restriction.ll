...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -enable-var-scope -check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10-mesa-mesa3d < %s | FileCheck -enable-var-scope -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00-mesa-mesa3d -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX10PLUS,GFX11 %s
