...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX6-IEEE,GFX6-IEEE-FASTFMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX6-FLUSH,GFX6-FLUSH-FASTFMA %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.01 < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX6-IEEE,GFX6-IEEE-SLOWFMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.01 < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX6-FLUSH,GFX6-FLUSH-SLOWFMA %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03 < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX89-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03 < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX89-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00 < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX89-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00 < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX89-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10 < %t.ieee | FileCheck -check-prefixes=GFX10,GFX10-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10 < %t.preservesign | FileCheck -check-prefixes=GFX10,GFX10-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 < %t.ieee | FileCheck -check-prefixes=GFX11,GFX11-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 < %t.preservesign | FileCheck -check-prefixes=GFX11,GFX11-FLUSH %s
