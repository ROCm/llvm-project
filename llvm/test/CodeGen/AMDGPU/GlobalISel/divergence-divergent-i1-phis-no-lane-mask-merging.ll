...
; GFX10-NEXT:  ; %bb.1:
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, 6, v2
...
; GFX10-NEXT:    v_cndmask_b32_e64 v0, 1.0, 0, s4
...
; GFX10-NEXT:  .LBB3_3: ; %loop_start
; GFX10-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    s_cmpk_le_i32 s4, 0x3e8
...
; GFX10-NEXT:    v_cmp_ne_u32_e64 s14, 0, v2
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_readfirstlane_b32 s13, v3
; GFX10-NEXT:    s_add_i32 s12, s13, s12
; GFX10-NEXT:    s_xor_b32 s13, exec_lo, s14
; GFX10-NEXT:    s_or_b32 s3, s3, s13
; GFX10-NEXT:    s_mov_b32 exec_lo, s14
; GFX10-NEXT:    ; divergent control-flow edge
; GFX10-NEXT:    s_cbranch_execnz .LBB4_2
; GFX10-NEXT:  .LBB4_3: ; %.preheader._crit_edge
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GFX10-NEXT:    v_cmp_eq_u32_e64 s2, s12, v1
