...
; CHECK-NEXT:    v_mul_hi_u32 v14, v3, v7
...
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v6, v14
...
; CHECK-NEXT:    v_mul_lo_u32 v9, v11, v7
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v6, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
...
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, v11, v6, vcc
; CHECK-NEXT:    v_mul_hi_u32 v6, v10, v3
; CHECK-NEXT:    v_mul_lo_u32 v7, v10, v4
; CHECK-NEXT:    v_xor_b32_e32 v8, v5, v12
...
; CHECK-NEXT:    v_mul_lo_u32 v7, v8, v4
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
...
; CHECK-NEXT:    v_mul_hi_u32 v7, v8, v4
...
; CHECK-NEXT:    v_subb_u32_e64 v5, s[4:5], v8, v4, vcc
; CHECK-NEXT:    v_sub_i32_e64 v4, s[4:5], v8, v4
...
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s5, v5, v[3:4]
; CHECK-NEXT:    v_mul_hi_u32 v2, v5, v0
; CHECK-NEXT:    v_mul_lo_u32 v4, v6, v0
; CHECK-NEXT:    v_mul_hi_u32 v0, v6, v0
...
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CHECK-NEXT:    v_mul_hi_u32 v4, v5, v1
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
...
; GISEL-NEXT:    v_mul_hi_u32 v11, v15, v5
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v11, v12
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v0, v1
; GISEL-NEXT:    v_mul_hi_u32 v1, v14, v5
...
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v4, v16, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v15, v11
; GISEL-NEXT:    v_subb_u32_e64 v13, s[4:5], v14, v12, vcc
; GISEL-NEXT:    v_sub_i32_e64 v1, s[4:5], v14, v12
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[6:7], v19, v15, 0
; GISEL-NEXT:    ; implicit-def: $vgpr12
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[8:9], v14, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v21, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v13, v4
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v19, v18, v[11:12]
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v20, v15, v[0:1]
; GISEL-NEXT:    v_mul_hi_u32 v0, v15, v10
...
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v14, v21, s[4:5]
...
; GISEL-NEXT:    v_mul_hi_u32 v12, v15, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v12
; GISEL-NEXT:    v_mul_lo_u32 v12, v18, v11
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v11, v18, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v15, v0
; GISEL-NEXT:    v_addc_u32_e32 v15, vcc, v18, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v19, v14, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v16, v1, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr12
; GISEL-NEXT:    v_xor_b32_e32 v16, v9, v8
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v15, v[11:12]
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v17, v13, vcc
; GISEL-NEXT:    v_xor_b32_e32 v12, v13, v16
; GISEL-NEXT:    v_ashrrev_i32_e32 v13, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v20, v14, v[0:1]
...
; GISEL-NEXT:    v_mul_lo_u32 v4, v17, v2
; GISEL-NEXT:    v_xor_b32_e32 v10, v1, v13
...
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v3, v17, v2
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v4, v1
; GISEL-NEXT:    v_mul_lo_u32 v4, v10, v2
...
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v11, v16
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v12, v16, vcc
...
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v9, v7
; CGP-NEXT:    v_mul_lo_u32 v9, v10, v6
...
; CGP-NEXT:    v_mul_hi_u32 v9, v10, v6
...
; CGP-NEXT:    v_subb_u32_e64 v7, s[4:5], v10, v6, vcc
...
; CHECK-NEXT:    v_mul_lo_u32 v5, v9, v2
; CHECK-NEXT:    v_mul_hi_u32 v2, v9, v2
; CHECK-NEXT:    v_mul_lo_u32 v6, v7, v3
; CHECK-NEXT:    v_mul_hi_u32 v10, v7, v3
; CHECK-NEXT:    v_mul_lo_u32 v11, v9, v3
...
; CHECK-NEXT:    v_mul_hi_u32 v0, v7, v2
; CHECK-NEXT:    v_mul_lo_u32 v4, v7, v3
; CHECK-NEXT:    v_xor_b32_e32 v6, v1, v8
; CHECK-NEXT:    v_mul_lo_u32 v1, v9, v2
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CHECK-NEXT:    v_mul_hi_u32 v1, v9, v2
; CHECK-NEXT:    v_mul_hi_u32 v2, v7, v3
...
; GISEL-NEXT:    v_mul_lo_u32 v12, v9, v4
; GISEL-NEXT:    v_mul_hi_u32 v13, v9, v4
; GISEL-NEXT:    v_mul_lo_u32 v4, v8, v14
; GISEL-NEXT:    v_mul_hi_u32 v6, v8, v14
; GISEL-NEXT:    v_mul_lo_u32 v10, v9, v14
...
; GISEL-NEXT:    v_mul_hi_u32 v6, v18, v0
...
; GISEL-NEXT:    v_cndmask_b32_e32 v6, v20, v1, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr13
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v7, v9, v[12:13]
; GISEL-NEXT:    v_xor_b32_e32 v12, v5, v10
; GISEL-NEXT:    v_xor_b32_e32 v13, v6, v10
; GISEL-NEXT:    v_ashrrev_i32_e32 v14, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], s6, v8, v[0:1]
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v2, v14
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v3, v14, vcc
; GISEL-NEXT:    v_mul_hi_u32 v2, v8, v11
; GISEL-NEXT:    v_mul_lo_u32 v3, v8, v5
; GISEL-NEXT:    v_xor_b32_e32 v15, v0, v14
...
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v2, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v2, v9, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
...
; GISEL-NEXT:    v_xor_b32_e32 v8, v1, v14
; GISEL-NEXT:    v_mul_lo_u32 v1, v8, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v8, v0
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v3, v15, v2
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v0, v1
; GISEL-NEXT:    v_mul_hi_u32 v1, v8, v2
...
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v13, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], 0, v9, v[2:3]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v15, v5
; GISEL-NEXT:    v_sub_i32_e64 v5, s[4:5], v8, v6
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v8, v6, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v10, v8, v4
; CGP-NEXT:    v_mul_lo_u32 v11, v9, v4
; CGP-NEXT:    v_mul_lo_u32 v4, v8, v13
; CGP-NEXT:    v_mul_hi_u32 v6, v8, v13
...
; CGP-NEXT:    v_mul_lo_u32 v19, v6, v13
...
; CGP-NEXT:    v_mul_hi_u32 v6, v18, v0
...
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v4, v16, 0
; CGP-NEXT:    v_add_i32_e32 v20, vcc, v1, v0
; CGP-NEXT:    ; implicit-def: $vgpr15
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v20, v[14:15]
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v18, v13
...
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_add_i32_e32 v14, vcc, 1, v16
...
; CGP-NEXT:    v_add_i32_e32 v19, vcc, 1, v14
; CGP-NEXT:    v_addc_u32_e32 v21, vcc, 0, v15, vcc
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], -1, v8, v[0:1]
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v18
; CGP-NEXT:    v_cndmask_b32_e32 v0, v14, v19, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v15, v21, vcc
; CGP-NEXT:    v_mul_lo_u32 v6, v8, v5
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; CGP-NEXT:    v_cndmask_b32_e32 v0, v16, v0, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v20, v1, vcc
; CGP-NEXT:    v_add_i32_e64 v6, s[4:5], v10, v6
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v6, s[4:5], v6, v11
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[4:5]
; CGP-NEXT:    v_mul_hi_u32 v11, v8, v5
; CGP-NEXT:    v_add_i32_e64 v6, s[4:5], v10, v6
...
; CGP-NEXT:    v_mul_lo_u32 v3, v8, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v8, v2
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v7
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v6, v7
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v2, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v8, v5
...
; CGP-NEXT:    v_subb_u32_e64 v5, s[4:5], v8, v2, vcc
...
; CHECK-NEXT:    v_mul_lo_u32 v8, v10, v5
; CHECK-NEXT:    v_mul_hi_u32 v5, v10, v5
; CHECK-NEXT:    v_mul_lo_u32 v9, v11, v6
; CHECK-NEXT:    v_mul_hi_u32 v14, v11, v6
...
; GISEL-NEXT:    v_mul_lo_u32 v20, v18, v11
; GISEL-NEXT:    v_mul_hi_u32 v21, v18, v11
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v17, v9, v[14:15]
...
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v13
; GISEL-NEXT:    v_add_i32_e32 v19, vcc, v9, v12
; GISEL-NEXT:    v_addc_u32_e32 v18, vcc, v18, v11, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v14, v18, v11
; GISEL-NEXT:    v_mul_hi_u32 v11, v18, v11
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v14, v19, v12
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v13, v0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v14, v16, v11
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v13, v12
...
; GISEL-NEXT:    v_sub_i32_e32 v11, vcc, v16, v11
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v5, v0, v[14:15]
; GISEL-NEXT:    v_subb_u32_e64 v15, s[4:5], v1, v12, vcc
...
; GISEL-NEXT:    v_sub_i32_e64 v19, s[6:7], 0, v8
; GISEL-NEXT:    v_cvt_u32_f32_e32 v18, v11
; GISEL-NEXT:    v_subb_u32_e64 v20, s[6:7], 0, v7, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[6:7], v19, v16, 0
; GISEL-NEXT:    ; implicit-def: $vgpr12
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[8:9], v1, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v21, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v15, v5
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[6:7], v19, v18, v[11:12]
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v20, v16, v[13:14]
; GISEL-NEXT:    v_mul_hi_u32 v12, v16, v10
; GISEL-NEXT:    v_mul_lo_u32 v13, v16, v11
; GISEL-NEXT:    v_add_i32_e64 v12, s[6:7], v12, v13
; GISEL-NEXT:    v_mul_lo_u32 v13, v18, v10
...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v12, v13, vcc
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v0
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, 0, v17, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s[8:9]
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, 1, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v1, v1, v21, s[4:5]
; GISEL-NEXT:    v_addc_u32_e32 v21, vcc, 0, v13, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v12, v15, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v13, v21, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v13
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v16, v10
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v18, v11, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v19, v13, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v0, v5, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v15, v17, v12, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr12
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v14, v[11:12]
; GISEL-NEXT:    v_xor_b32_e32 v16, v9, v4
; GISEL-NEXT:    v_xor_b32_e32 v11, v5, v16
; GISEL-NEXT:    v_xor_b32_e32 v12, v15, v16
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v20, v13, v[0:1]
...
; GISEL-NEXT:    v_xor_b32_e32 v5, v0, v15
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v3, v5, v2
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v4, v1
...
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v1, v0
; GISEL-NEXT:    ; implicit-def: $vgpr4
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v8, v17, v[3:4]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v11, v16
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v12, v16, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v14, v[9:10]
...
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v18, v16, v[13:14]
; CGP-NEXT:    v_mul_hi_u32 v12, v16, v10
; CGP-NEXT:    v_xor_b32_e32 v14, v8, v17
; CGP-NEXT:    v_mul_lo_u32 v8, v15, v10
; CGP-NEXT:    v_mul_lo_u32 v13, v16, v11
...
; CGP-NEXT:    v_mul_lo_u32 v13, v15, v11
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v12
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, v15, v10, vcc
; CGP-NEXT:    v_mul_hi_u32 v11, v14, v8
; CGP-NEXT:    v_mul_lo_u32 v12, v14, v10
; CGP-NEXT:    v_xor_b32_e32 v13, v9, v17
; CGP-NEXT:    v_mul_lo_u32 v9, v13, v8
...
; CGP-NEXT:    v_subb_u32_e64 v10, s[4:5], v13, v9, vcc
; CGP-NEXT:    v_sub_i32_e64 v9, s[4:5], v13, v9
...
; CGP-NEXT:    v_mul_lo_u32 v11, v13, v8
; CGP-NEXT:    v_mul_hi_u32 v8, v13, v8
; CGP-NEXT:    v_mul_lo_u32 v12, v6, v9
; CGP-NEXT:    v_mul_hi_u32 v16, v6, v9
; CGP-NEXT:    v_mul_lo_u32 v17, v13, v9
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v10, v5
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v10, v6, v9
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v11, v5
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v13, v8, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v5, 0
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v13, v4, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr9
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v11, v13, v[8:9]
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v5, v[3:4]
; GISEL-NEXT:    v_and_b32_e32 v12, 0xffffff, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v5, v7
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v6, v13, v7
; GISEL-NEXT:    v_mul_hi_u32 v7, v5, v8
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v4, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v7, v13, v8
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v4, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v4, v[6:7]
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v6, v11
...
; GISEL-NEXT:    v_sub_i32_e32 v16, vcc, v12, v5
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v2, 0
; GISEL-NEXT:    ; implicit-def: $vgpr8
; GISEL-NEXT:    v_subb_u32_e64 v5, s[4:5], 0, v10, vcc
; GISEL-NEXT:    v_sub_i32_e64 v10, s[4:5], 0, v10
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v9, v[7:8]
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v15, v2, v[11:12]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v5
; GISEL-NEXT:    v_mul_hi_u32 v5, v2, v6
; GISEL-NEXT:    v_mul_lo_u32 v12, v9, v6
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v12, v2, v7
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v8, v5
...
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v2, v5
; GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v9, v6, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v14, v12, 0
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v16, v1
; GISEL-NEXT:    ; implicit-def: $vgpr7
; GISEL-NEXT:    v_subbrev_u32_e32 v10, vcc, 0, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v14, v17, v[6:7]
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, 1, v0
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v4, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v1
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v15, v12, v[8:9]
; GISEL-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v10
; GISEL-NEXT:    v_cndmask_b32_e32 v2, -1, v6, vcc
; GISEL-NEXT:    v_mul_hi_u32 v6, v12, v5
; GISEL-NEXT:    v_mul_lo_u32 v8, v12, v1
; GISEL-NEXT:    v_mul_lo_u32 v15, v17, v5
...
; GISEL-NEXT:    v_mul_hi_u32 v15, v12, v1
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v8, v6
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v3, v15, v[6:7]
