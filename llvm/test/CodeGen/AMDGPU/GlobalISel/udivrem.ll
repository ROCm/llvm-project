...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-codegenprepare-disable-idiv-expansion=1 -amdgpu-bypass-slow-div=0 -mtriple=amdgpu8.02-amd-amdhsa < %s | FileCheck --check-prefix=GFX8 %s
