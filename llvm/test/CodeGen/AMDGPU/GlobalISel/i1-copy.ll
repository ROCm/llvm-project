...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.00-amd-amdpal < %s | FileCheck -check-prefixes=WAVE64 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.10-amd-amdpal < %s | FileCheck -check-prefixes=WAVE32 %s
