...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=irtranslator -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -enable-var-scope -check-prefix=GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=irtranslator -mtriple=amdgpu9.08-mesa-mesa3d -o - %s | FileCheck -enable-var-scope -check-prefix=GFX908 %s
