...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03-amd-amdhsa -amdgpu-ir-lower-kernel-arguments=0 -stop-after=irtranslator %s -o - | FileCheck -check-prefix=HSA-VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03-- -amdgpu-ir-lower-kernel-arguments=0 -stop-after=irtranslator %s -o - | FileCheck -check-prefix=LEGACY-MESA-VI %s
