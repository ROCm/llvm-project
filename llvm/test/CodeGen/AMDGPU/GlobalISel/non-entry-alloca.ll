...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -amdgpu-load-store-vectorizer=0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,DEFAULTSIZE %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -amdgpu-load-store-vectorizer=0 -mtriple=amdgpu9.00-amd-amdhsa -amdgpu-assume-dynamic-stack-object-size=1024 < %s | FileCheck -check-prefixes=GCN,ASSUME1024 %s
