...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-load-store-vectorizer=0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GCN,DEFAULTSIZE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-load-store-vectorizer=0 -mtriple=amdgpu9.00-amd-amdhsa -amdgpu-assume-dynamic-stack-object-size=1024 < %s | FileCheck -check-prefixes=GCN,ASSUME1024 %s
...
; GCN-NEXT:  .LBB3_1: ; %bb.0
; GCN-NEXT:    s_add_u32 s4, s32, 0xfff
...
; GCN-NEXT:    v_add_u32_e32 v2, s4, v2
; GCN-NEXT:    buffer_load_dword v2, v2, s[0:3], 0 offen
; GCN-NEXT:    v_and_b32_e32 v3, 0x3ff, v31
; GCN-NEXT:    s_add_u32 s32, s4, 0x1000
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_add_u32_e32 v2, v2, v3
; GCN-NEXT:    global_store_dword v[0:1], v2, off
