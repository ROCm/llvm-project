...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.0a < %s | FileCheck %s -check-prefix=GFX90A
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.42 < %s | FileCheck %s -check-prefix=GFX942
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.50 < %s | FileCheck %s -check-prefix=GFX1250
