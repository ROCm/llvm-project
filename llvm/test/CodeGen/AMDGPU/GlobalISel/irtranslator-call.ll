...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -global-isel-abort=2 -stop-after=irtranslator -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -enable-var-scope %s
