...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 %s -o - | FileCheck -check-prefixes=GCN %s
...
; GCN-NEXT:    v_perm_b32 v1, v3, v1, s4
; GCN-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GCN-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GCN-NEXT:    s_mov_b32 s4, 0x5040100
; GCN-NEXT:    v_perm_b32 v0, v4, v0, s4
; GCN-NEXT:    v_perm_b32 v1, v5, v1, s4
; GCN-NEXT:    v_perm_b32 v2, v6, v2, s4
; GCN-NEXT:    v_perm_b32 v3, v7, v3, s4
; GCN-NEXT:    s_setpc_b64 s[30:31]
entry:
