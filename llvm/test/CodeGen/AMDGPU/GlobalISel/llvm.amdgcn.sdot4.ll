...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.11 < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.12 < %s | FileCheck --check-prefix=GFX10 %s
