...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -global-isel-abort=2 -mtriple=amdgpu9.06 < %s | FileCheck --check-prefix=GFX906 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -global-isel-abort=2 -mtriple=amdgpu10.11 < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -global-isel-abort=2 -mtriple=amdgpu10.12 < %s | FileCheck --check-prefix=GFX10 %s
