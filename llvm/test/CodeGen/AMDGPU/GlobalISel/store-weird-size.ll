...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx90a -O0 -global-isel=true -stop-after=legalizer -o - %s | FileCheck -check-prefix=UNPACKED %s
...
define void @store_i55(ptr addrspace(1) %ptr, i55 %arg) #0 {
  ...
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 32
  ...
  ; UNPACKED-NEXT:   [[C4:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; UNPACKED-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[PTR_ADD]], [[C4]](i64)
  ; UNPACKED-NEXT:   G_STORE [[TRUNC1]](i32), [[PTR_ADD]](p1) :: (store (s16) into %ir.ptr + 4, align 4, addrspace 1)
  ; UNPACKED-NEXT:   G_STORE [[LSHR1]](i32), [[PTR_ADD1]](p1) :: (store (s8) into %ir.ptr + 6, align 2, basealign 4, addrspace 1)
  ; UNPACKED-NEXT:   SI_RETURN
...
define void @store_i56(ptr addrspace(1) %ptr, i56 %arg) #0 {
  ...
  ; UNPACKED-NEXT:   [[LSHR1:%[0-9]+]]:_(i32) = G_LSHR [[TRUNC]], [[C2]](i32)
  ; UNPACKED-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; UNPACKED-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[PTR_ADD]], [[C3]](i64)
...
define void @store_i65(ptr addrspace(1) %ptr, i65 %arg) #0 {
  ...
  ; UNPACKED-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY4]](i32), [[DEF]](i32)
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 -1
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; UNPACKED-NEXT:   [[AND:%[0-9]+]]:_(i64) = G_AND [[MV1]], [[C]]
...
define void @store_i95(ptr addrspace(1) %ptr, i95 %arg) #0 {
  ...
  ; UNPACKED-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY4]](i32), [[DEF]](i32)
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 -1
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 2147483647
  ; UNPACKED-NEXT:   [[AND:%[0-9]+]]:_(i64) = G_AND [[MV1]], [[C]]
  ; UNPACKED-NEXT:   [[AND1:%[0-9]+]]:_(i64) = G_AND [[MV2]], [[C1]]
  ; UNPACKED-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
  ; UNPACKED-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[MV]], [[C2]](i64)
...
define void @store_i97(ptr addrspace(1) %ptr, i97 %arg) #0 {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 -1
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 8589934591
  ; UNPACKED-NEXT:   [[MV1:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY2]](i32), [[COPY3]](i32)
  ; UNPACKED-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; UNPACKED-NEXT:   [[AND:%[0-9]+]]:_(i64) = G_AND [[MV1]], [[C]]
  ; UNPACKED-NEXT:   [[AND1:%[0-9]+]]:_(i64) = G_AND [[MV2]], [[C1]]
  ; UNPACKED-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
  ; UNPACKED-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[MV]], [[C2]](i64)
  ; UNPACKED-NEXT:   G_STORE [[AND]](i64), [[MV]](p1) :: (store (s64) into %ir.ptr, align 4, addrspace 1)
  ; UNPACKED-NEXT:   [[C3:%[0-9]+]]:_(i32) = G_CONSTANT i32 32
...
define void @store_i127(ptr addrspace(1) %ptr, i127 %arg) #0 {
  ...
  ; UNPACKED-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 -1
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 9223372036854775807
  ; UNPACKED-NEXT:   [[MV1:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY2]](i32), [[COPY3]](i32)
  ; UNPACKED-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; UNPACKED-NEXT:   [[AND:%[0-9]+]]:_(i64) = G_AND [[MV1]], [[C]]
  ; UNPACKED-NEXT:   [[AND1:%[0-9]+]]:_(i64) = G_AND [[MV2]], [[C1]]
