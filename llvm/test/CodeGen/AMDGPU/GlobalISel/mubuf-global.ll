...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu7.01-mesa-mesa3d -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.00-mesa-mesa3d -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GFX12 %s
