...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -global-isel < %s | FileCheck -check-prefixes=CHECK,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 -global-isel < %s | FileCheck -check-prefixes=CHECK,GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 -global-isel < %s | FileCheck -check-prefixes=CHECK,GFX11,GFX11-FAKE16 %s
...
; GFX10-NEXT:  .LBB19_3: ; %A
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, 1, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc_lo
; GFX10-NEXT:  .LBB19_4: ; %exit
...
; GFX11-NEXT:  .LBB19_3: ; %A
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, 1, v2
; GFX11-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc_lo
; GFX11-NEXT:  .LBB19_4: ; %exit
