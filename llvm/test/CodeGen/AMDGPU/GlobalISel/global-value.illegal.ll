; RUN: not llc -amdgpu-late-wave-transform=1 -global-isel -global-isel-abort=1 -mtriple=amdgpu7.01-amd-amdhsa -filetype=null %s 2>&1 | FileCheck -check-prefix=ERR %s
