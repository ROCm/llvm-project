...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=irtranslator -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -enable-var-scope -check-prefix=GCN %s
