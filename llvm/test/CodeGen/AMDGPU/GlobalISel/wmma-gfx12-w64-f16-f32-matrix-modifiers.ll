...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.70 -mattr=+wavefrontsize64,+real-true16 < %s | FileCheck %s --check-prefixes=GCN,GFX1170,GFX1170-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.70 -mattr=+wavefrontsize64,-real-true16 < %s | FileCheck %s --check-prefixes=GCN,GFX1170,GFX1170-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.00 -mattr=+wavefrontsize64,+real-true16 < %s | FileCheck %s --check-prefixes=GCN,GFX12,GFX12-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.00 -mattr=+wavefrontsize64,-real-true16 < %s | FileCheck %s --check-prefixes=GCN,GFX12,GFX12-FAKE16
