...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu6.01 < %s | FileCheck -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.00 < %s | FileCheck -check-prefix=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.00 < %s | FileCheck -check-prefix=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.50 < %s | FileCheck -check-prefix=GFX1250 %s
