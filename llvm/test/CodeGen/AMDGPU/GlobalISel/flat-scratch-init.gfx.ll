...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mattr=+enable-flat-scratch -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -check-prefix=MESA %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mattr=+enable-flat-scratch -mtriple=amdgpu9.00-amd-amdpal < %s | FileCheck -check-prefix=PAL %s
