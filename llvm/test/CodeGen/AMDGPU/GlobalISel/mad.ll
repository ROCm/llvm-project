...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu7.01-amd-amdpal -o - %s | FileCheck --check-prefix=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.0a-amd-amdpal -o - %s | FileCheck --check-prefix=GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.00-amd-amdpal -o - %s | FileCheck --check-prefix=GFX11 %s
