...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -global-isel < %s | FileCheck %s
...
; CHECK-NEXT:  .LBB19_3: ; %A
; CHECK-NEXT:    v_cmp_le_u32_e32 vcc, 1, v2
; CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc
; CHECK-NEXT:  .LBB19_4: ; %exit
; CHECK-NEXT:    s_or_b64 exec, exec, s[2:3]
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v3
