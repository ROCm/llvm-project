...
; RUN: llc -amdgpu-late-wave-transform=1 --global-isel=1 -mtriple=amdgpu11.00--amdpal -stop-after=irtranslator %s -o - | FileCheck %s --check-prefix=GFX11
; RUN: llc -amdgpu-late-wave-transform=1 --global-isel=1 -mtriple=amdgpu10.30--amdpal -stop-after=irtranslator %s -o - | FileCheck %s --check-prefix=GFX10
