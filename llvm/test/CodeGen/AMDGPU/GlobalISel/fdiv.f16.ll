...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX6,GFX6-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX6,GFX6-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX89,GFX8,GFX8-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX89,GFX8,GFX8-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX89,GFX9,GFX9-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX89,GFX9,GFX9-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10,GFX10-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10,GFX10-FLUSH %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11,GFX11-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11,GFX11-FLUSH %s
