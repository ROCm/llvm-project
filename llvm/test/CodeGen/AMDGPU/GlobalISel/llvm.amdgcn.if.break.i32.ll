...
; XFAIL: *
; Structurizer-only intrinsic; LWT never lowers SI_IF_BREAK.
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10--amdhsa < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00--amdhsa -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefix=GFX11 %s
