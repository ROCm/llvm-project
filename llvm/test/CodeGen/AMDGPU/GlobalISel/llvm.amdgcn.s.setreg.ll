...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.01 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.02 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX789 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX789 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX11 %s
