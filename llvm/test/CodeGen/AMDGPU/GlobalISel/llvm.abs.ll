...
; GFX1250-NEXT:    v_sub_nc_u16 v0.h, 0, v0.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_max_i16 v0.l, v0.l, v0.h
...
; GFX1250-NEXT:    v_sub_nc_u16 v0.l, 0, v2.l
; GFX1250-NEXT:    v_sub_nc_u16 v0.h, 0, v1.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_max_i16 v0.l, v2.l, v0.l
; GFX1250-NEXT:    v_max_i16 v1.l, v1.l, v0.h
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %res = call <2 x i8> @llvm.abs.v2i8(<2 x i8> %arg, i1 false)
  ret <2 x i8> %res
}
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_bfe_i32 v3, v0, 0, 8
; GFX1250-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX1250-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_sub_nc_u16 v0.l, 0, v3.l
; GFX1250-NEXT:    v_sub_nc_u16 v0.h, 0, v1.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_sub_nc_u16 v1.h, 0, v2.l
; GFX1250-NEXT:    v_max_i16 v0.l, v3.l, v0.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_max_i16 v1.l, v1.l, v0.h
; GFX1250-NEXT:    v_max_i16 v2.l, v2.l, v1.h
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %res = call <3 x i8> @llvm.abs.v3i8(<3 x i8> %arg, i1 false)
  ret <3 x i8> %res
}
...
; GFX1250-NEXT:    v_sub_nc_u16 v1.h, 0, v1.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_pk_max_i16 v0, v0, v2
; GFX1250-NEXT:    v_max_i16 v1.l, v1.l, v1.h
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %res = call <3 x i16> @llvm.abs.v3i16(<3 x i16> %arg, i1 false)
  ret <3 x i16> %res
}
