...
; GFX9-NEXT:    v_and_or_b32 v0, v4, v0, v3
...
; GFX7-NEXT:    v_lshl_b32_e32 v4, s0, v0
; GFX7-NEXT:    v_lshl_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_cndmask_b32_e32 v5, v1, v2, vcc
; GFX7-NEXT:    v_bfi_b32 v0, v0, 0, v5
...
; GFX7-NEXT:    buffer_store_dwordx2 v[1:2], off, s[0:3], 0
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_cndmask_b32 v1, v1, v5
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v4
; GFX11-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_cndmask_b32 v0, v0, v5
; GFX11-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX11-NEXT:    s_endpgm
  %vec = load <4 x i16>, ptr addrspace(4) %ptr
  %insert = insertelement <4 x i16> %vec, i16 %val, i32 %idx
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x0
; GFX9-NEXT:    v_lshrrev_b32_e32 v5, 1, v1
; GFX9-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX9-NEXT:    v_mov_b32_e32 v4, 0xffff
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_and_or_b32 v0, v4, v1, v0
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x0
; GFX8-NEXT:    v_lshrrev_b32_e32 v5, 1, v1
; GFX8-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX8-NEXT:    v_mov_b32_e32 v4, 0xffff
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-NEXT:    v_and_or_b32 v0, v4, v3, v0
; GFX10-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x0
; GFX9-NEXT:    v_lshrrev_b32_e32 v7, 1, v0
; GFX9-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX9-NEXT:    v_mov_b32_e32 v6, 0xffff
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_and_or_b32 v0, v6, v0, v5
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v0, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v0, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v5, 0
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x0
; GFX8-NEXT:    v_lshrrev_b32_e32 v7, 1, v0
; GFX8-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX8-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX8-NEXT:    v_mov_b32_e32 v6, 0xffff
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v3, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v7
...
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v5, 0
...
; GFX7-NEXT:    v_mov_b32_e32 v1, s0
; GFX7-NEXT:    s_and_b32 s0, s4, 0xffff
; GFX7-NEXT:    v_lshl_b32_e32 v6, s0, v0
; GFX7-NEXT:    v_cndmask_b32_e32 v7, v1, v2, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v5
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v3, s[0:1]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v5
; GFX7-NEXT:    v_lshl_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v4, s[2:3]
; GFX7-NEXT:    v_bfi_b32 v0, v0, 0, v7
...
; GFX9-NEXT:    v_mov_b32_e32 v4, s2
; GFX9-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, v1, v7
...
; GFX8-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX8-NEXT:    v_mov_b32_e32 v7, 0xffff
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, v1, v7
...
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v5, v7, s[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v0, 0
; GFX8-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX7-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s[0:1]
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v5, v0, s[2:3]
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
; GFX7-NEXT:    s_mov_b32 s2, -1
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    v_cndmask_b32_e32 v2, v2, v0, vcc
...
; GFX10-NEXT:    v_and_or_b32 v0, v6, v5, v0
; GFX10-NEXT:    v_mov_b32_e32 v5, 0
; GFX10-NEXT:    v_mov_b32_e32 v6, 0
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v2, v0, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v7
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v3, v0, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s1
; GFX10-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc_lo
...
; GFX11-NEXT:    v_and_or_b32 v0, v6, v5, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v5, 0 :: v_dual_cndmask_b32 v2, v2, v0
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v7
; GFX11-NEXT:    v_mov_b32_e32 v6, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v3, v0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s1
; GFX11-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc_lo
; GFX11-NEXT:    global_store_b128 v[5:6], v[1:4], off
; GFX11-NEXT:    s_endpgm
  %vec = load <8 x i16>, ptr addrspace(4) %ptr
  %insert = insertelement <8 x i16> %vec, i16 %val, i32 %idx
  store <8 x i16> %insert, ptr addrspace(1) null
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v8, 1, v2
; GFX9-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX9-NEXT:    v_mov_b32_e32 v7, 0xffff
; GFX9-NEXT:    s_and_b32 s0, s2, 0xffff
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, 4, v2
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, v2, v7
...
; GFX8-NEXT:    v_lshrrev_b32_e32 v8, 1, v2
; GFX8-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX8-NEXT:    v_mov_b32_e32 v7, 0xffff
; GFX8-NEXT:    s_and_b32 s0, s2, 0xffff
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, 4, v2
...
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, v2, v7
...
; GFX8-NEXT:    v_bfi_b32 v2, v2, 0, v7
...
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v2, s[2:3]
...
; GFX7-NEXT:    v_cndmask_b32_e32 v4, v4, v1, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v5, v1, s[0:1]
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v6, v1, s[2:3]
...
; GFX10-NEXT:    v_and_or_b32 v7, v1, v7, v0
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v4, v7, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v5, v7, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v6, v7, s1
...
; GFX11-NEXT:    v_and_or_b32 v7, v1, v7, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_cndmask_b32 v4, v4, v7
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v2
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v5, v7, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v6, v7, s1
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 1, v3
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, v1, v0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v6, v0, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v7, v0, s[2:3]
...
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v6, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v7, s[2:3]
; GFX8-NEXT:    v_bfi_b32 v0, v0, 0, v1
; GFX8-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v5, v0, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v10
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v6, v0, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v7, v0, s[2:3]
...
; GFX7-NEXT:    v_or_b32_e32 v8, v1, v2
; GFX7-NEXT:    v_cndmask_b32_e32 v1, v5, v8, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v2, v6, v8, s[0:1]
; GFX7-NEXT:    v_cndmask_b32_e64 v3, v7, v8, s[2:3]
...
; GFX10-NEXT:    v_lshrrev_b32_e32 v10, 1, v3
; GFX10-NEXT:    v_and_b32_e32 v0, 1, v3
...
; GFX10-NEXT:    v_and_or_b32 v0, v1, v2, v0
; GFX10-NEXT:    v_cndmask_b32_e32 v1, v5, v0, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v10
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v6, v0, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v7, v0, s1
...
; GFX11-NEXT:    v_lshrrev_b32_e32 v10, 1, v3
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_dual_cndmask_b32 v1, v4, v5 :: v_dual_lshlrev_b32 v0, 4, v0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_and_or_b32 v0, v1, v2, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v1, v5, v0, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v10
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v6, v0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v7, v0, s1
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx8 s[8:15], s[2:3], 0x0
; GFX9-NEXT:    v_lshrrev_b32_e32 v11, 1, v0
; GFX9-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX9-NEXT:    s_and_b32 s0, s4, 0xffff
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v0, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v0, s[10:11]
; GFX9-NEXT:    v_mov_b32_e32 v11, 16
; GFX9-NEXT:    v_mov_b32_e32 v12, 0
; GFX9-NEXT:    global_store_dwordx4 v[9:10], v[1:4], off
; GFX9-NEXT:    global_store_dwordx4 v[11:12], v[5:8], off
; GFX9-NEXT:    s_endpgm
;
; GFX8-LABEL: insertelement_s_v16i16_s_v:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx8 s[8:15], s[2:3], 0x0
; GFX8-NEXT:    v_lshrrev_b32_e32 v11, 1, v0
; GFX8-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX8-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX8-NEXT:    s_and_b32 s0, s4, 0xffff
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_mov_b32_e32 v10, 0xffff
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v11
; GFX8-NEXT:    v_mov_b32_e32 v3, s10
; GFX8-NEXT:    v_lshlrev_b32_e64 v9, v0, s0
; GFX8-NEXT:    v_lshlrev_b32_e32 v0, v0, v10
...
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v11
; GFX8-NEXT:    v_mov_b32_e32 v6, s13
; GFX8-NEXT:    v_cndmask_b32_e64 v10, v10, v5, s[4:5]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v11
; GFX8-NEXT:    v_mov_b32_e32 v7, s14
; GFX8-NEXT:    v_mov_b32_e32 v8, s15
; GFX8-NEXT:    v_cndmask_b32_e64 v10, v10, v6, s[6:7]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v10, v10, v7, s[8:9]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v11
...
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v5, v0, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v0, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v8, v0, s[10:11]
; GFX8-NEXT:    v_mov_b32_e32 v11, 16
; GFX8-NEXT:    v_mov_b32_e32 v12, 0
; GFX8-NEXT:    flat_store_dwordx4 v[9:10], v[1:4]
; GFX8-NEXT:    flat_store_dwordx4 v[11:12], v[5:8]
; GFX8-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    v_lshl_b32_e32 v10, s0, v0
; GFX7-NEXT:    v_cndmask_b32_e32 v11, v1, v2, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v9
; GFX7-NEXT:    v_mov_b32_e32 v4, s11
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v3, s[0:1]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v9
; GFX7-NEXT:    v_mov_b32_e32 v5, s12
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v4, s[2:3]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v9
; GFX7-NEXT:    v_mov_b32_e32 v6, s13
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v5, s[4:5]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v9
; GFX7-NEXT:    v_mov_b32_e32 v7, s14
; GFX7-NEXT:    v_mov_b32_e32 v8, s15
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v6, s[6:7]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v9
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v7, s[8:9]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v9
; GFX7-NEXT:    v_lshl_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v8, s[10:11]
; GFX7-NEXT:    v_bfi_b32 v0, v0, 0, v11
...
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v5, v0, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v0, s[8:9]
; GFX7-NEXT:    v_cndmask_b32_e64 v8, v8, v0, s[10:11]
; GFX7-NEXT:    buffer_store_dwordx4 v[1:4], off, s[0:3], 0
; GFX7-NEXT:    s_mov_b64 s[0:1], 16
...
; GFX10-NEXT:    v_and_or_b32 v0, v9, v10, v0
; GFX10-NEXT:    v_mov_b32_e32 v9, 0
; GFX10-NEXT:    v_mov_b32_e32 v10, 0
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v2, v0, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v13
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v3, v0, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v5, v0, s2
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s3
; GFX10-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v7, v0, s4
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v8, v0, s5
; GFX10-NEXT:    global_store_dwordx4 v[9:10], v[1:4], off
...
; GFX11-NEXT:    v_and_or_b32 v0, v9, v10, v0
...
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v3, v0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v4, v4, v0, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v5, v0, s2
; GFX11-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v7, v7, v0, s4
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v8, v0, s5
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b128 v[9:10], v[1:4], off
; GFX11-NEXT:    global_store_b128 v[11:12], v[5:8], off
; GFX11-NEXT:    s_endpgm
  %vec = load <16 x i16>, ptr addrspace(4) %ptr
  %insert = insertelement <16 x i16> %vec, i16 %val, i32 %idx
  store <16 x i16> %insert, ptr addrspace(1) null
...
; GFX9-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX9-NEXT:    v_mov_b32_e32 v11, 0xffff
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_mov_b32_e32 v4, s2
; GFX9-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, v1, v11
...
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v11, s[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v11, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v11, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v11, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v11, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v9, v11, s[10:11]
; GFX9-NEXT:    v_mov_b32_e32 v10, 16
; GFX9-NEXT:    v_mov_b32_e32 v11, 0
; GFX9-NEXT:    global_store_dwordx4 v[0:1], v[2:5], off
; GFX9-NEXT:    global_store_dwordx4 v[10:11], v[6:9], off
...
; GFX8-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX8-NEXT:    v_mov_b32_e32 v11, 0xffff
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, v1, v11
...
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v5, v11, s[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v0, 0
; GFX8-NEXT:    v_mov_b32_e32 v1, 0
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v2, v11, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v11, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v11, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v8, v11, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v9, v11, s[10:11]
; GFX8-NEXT:    v_mov_b32_e32 v10, 16
; GFX8-NEXT:    v_mov_b32_e32 v11, 0
; GFX8-NEXT:    flat_store_dwordx4 v[0:1], v[2:5]
...
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    v_cndmask_b32_e32 v2, v2, v0, vcc
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v0, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v8, v8, v0, s[8:9]
; GFX7-NEXT:    v_cndmask_b32_e64 v9, v9, v0, s[10:11]
; GFX7-NEXT:    buffer_store_dwordx4 v[2:5], off, s[0:3], 0
; GFX7-NEXT:    s_mov_b64 s[0:1], 16
...
; GFX10-NEXT:    v_and_or_b32 v13, v10, v1, v0
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-NEXT:    v_mov_b32_e32 v10, 16
; GFX10-NEXT:    v_cndmask_b32_e32 v3, v3, v13, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v4, v13, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v5, v13, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v6, v13, s2
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v7, v13, s3
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v2, v13, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s4
; GFX10-NEXT:    v_cndmask_b32_e64 v9, v9, v13, s5
; GFX10-NEXT:    global_store_dwordx4 v[0:1], v[2:5], off
; GFX10-NEXT:    global_store_dwordx4 v[10:11], v[6:9], off
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_and_or_b32 v13, v10, v1, v0
; GFX11-NEXT:    v_mov_b32_e32 v10, 16
; GFX11-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-NEXT:    v_cndmask_b32_e32 v3, v3, v13, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v12
; GFX11-NEXT:    v_cndmask_b32_e64 v4, v4, v13, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v5, v13, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v6, v13, s2
; GFX11-NEXT:    v_cndmask_b32_e64 v7, v7, v13, s3
; GFX11-NEXT:    v_cndmask_b32_e32 v2, v2, v13, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s4
; GFX11-NEXT:    v_cndmask_b32_e64 v9, v9, v13, s5
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b128 v[0:1], v[2:5], off
; GFX11-NEXT:    global_store_b128 v[10:11], v[6:9], off
; GFX11-NEXT:    s_endpgm
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v14, 1, v2
; GFX9-NEXT:    v_and_b32_e32 v2, 1, v2
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, v2, v13
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v14
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v14
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v14
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v14
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v14
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v14
; GFX9-NEXT:    v_not_b32_e32 v2, v2
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    v_mov_b32_e32 v11, 16
...
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v3, v4, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v5, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v6, s[2:3]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v7, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v8, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v9, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v10, s[10:11]
; GFX9-NEXT:    v_and_or_b32 v2, v13, v2, v15
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v4, v2, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v14
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v2, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v2, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v3, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v2, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v9, v2, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v10, v2, s[10:11]
; GFX9-NEXT:    global_store_dwordx4 v[0:1], v[3:6], off
...
; GFX8-NEXT:    v_lshrrev_b32_e32 v14, 1, v2
; GFX8-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX8-NEXT:    v_mov_b32_e32 v13, 0xffff
; GFX8-NEXT:    s_and_b32 s0, s2, 0xffff
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, 4, v2
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v14
; GFX8-NEXT:    v_lshlrev_b32_e64 v15, v2, s0
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, v2, v13
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v14
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v14
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v14
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v14
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v14
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v14
; GFX8-NEXT:    v_mov_b32_e32 v0, 0
; GFX8-NEXT:    v_mov_b32_e32 v1, 0
; GFX8-NEXT:    v_mov_b32_e32 v11, 16
; GFX8-NEXT:    v_mov_b32_e32 v12, 0
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_cndmask_b32_e32 v13, v3, v4, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v13, v5, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v13, v6, s[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v13, v7, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v13, v8, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v13, v9, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v13, v10, s[10:11]
; GFX8-NEXT:    v_bfi_b32 v2, v2, 0, v13
...
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v2, s[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v3, v2, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v2, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v8, v2, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v9, v2, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v10, v10, v2, s[10:11]
; GFX8-NEXT:    flat_store_dwordx4 v[0:1], v[3:6]
...
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v6, v1, s[2:3]
; GFX7-NEXT:    v_cndmask_b32_e32 v3, v3, v1, vcc
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v1, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v8, v8, v1, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v9, v9, v1, s[8:9]
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v1, s[10:11]
; GFX7-NEXT:    buffer_store_dwordx4 v[3:6], off, s[12:15], 0
; GFX7-NEXT:    s_mov_b64 s[12:13], 16
; GFX7-NEXT:    buffer_store_dwordx4 v[7:10], off, s[12:15], 0
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_lshrrev_b32_e32 v13, 1, v2
...
; GFX10-NEXT:    v_cmp_eq_u32_e64 s0, 2, v13
; GFX10-NEXT:    v_cmp_eq_u32_e64 s1, 3, v13
; GFX10-NEXT:    v_cmp_eq_u32_e64 s3, 4, v13
; GFX10-NEXT:    v_cmp_eq_u32_e64 s4, 5, v13
; GFX10-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX10-NEXT:    v_cmp_eq_u32_e64 s2, 6, v13
; GFX10-NEXT:    v_lshlrev_b32_e64 v2, v1, 0xffff
; GFX10-NEXT:    v_lshlrev_b32_e64 v1, v1, s5
; GFX10-NEXT:    v_cmp_eq_u32_e64 s5, 7, v13
; GFX10-NEXT:    v_not_b32_e32 v2, v2
...
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v7, v2, s3
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v8, v2, s4
; GFX10-NEXT:    v_cndmask_b32_e32 v3, v3, v2, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v9, v9, v2, s2
; GFX10-NEXT:    v_cndmask_b32_e64 v10, v10, v2, s5
; GFX10-NEXT:    global_store_dwordx4 v[0:1], v[3:6], off
...
; GFX11-NEXT:    v_lshrrev_b32_e32 v13, 1, v2
; GFX11-NEXT:    s_and_b32 s5, s2, 0xffff
; GFX11-NEXT:    v_dual_mov_b32 v12, 0 :: v_dual_and_b32 v1, 1, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 1, v13
; GFX11-NEXT:    v_cmp_eq_u32_e64 s0, 2, v13
; GFX11-NEXT:    v_cmp_eq_u32_e64 s1, 3, v13
; GFX11-NEXT:    v_cmp_eq_u32_e64 s3, 4, v13
; GFX11-NEXT:    v_cmp_eq_u32_e64 s4, 5, v13
; GFX11-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX11-NEXT:    v_cmp_eq_u32_e64 s2, 6, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_lshlrev_b32_e64 v2, v1, 0xffff
; GFX11-NEXT:    v_lshlrev_b32_e64 v1, v1, s5
; GFX11-NEXT:    v_cmp_eq_u32_e64 s5, 7, v13
; GFX11-NEXT:    v_not_b32_e32 v2, v2
...
; GFX11-NEXT:    v_dual_mov_b32 v11, 16 :: v_dual_mov_b32 v0, 0
; GFX11-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_cndmask_b32 v4, v4, v2
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v13
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v5, v2, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v6, v2, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v7, v7, v2, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v8, v2, s4
; GFX11-NEXT:    v_cndmask_b32_e32 v3, v3, v2, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v9, v9, v2, s2
; GFX11-NEXT:    v_cndmask_b32_e64 v10, v10, v2, s5
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b128 v[0:1], v[3:6], off
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v16, 1, v3
; GFX9-NEXT:    v_and_b32_e32 v1, 1, v3
; GFX9-NEXT:    v_mov_b32_e32 v0, 0xffff
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v16
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v16
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v16
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v16
; GFX9-NEXT:    v_not_b32_e32 v0, v0
; GFX9-NEXT:    v_mov_b32_e32 v12, 0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v7, s[2:3]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v8, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v9, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v10, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v11, s[10:11]
; GFX9-NEXT:    v_and_or_b32 v17, v1, v0, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v5, v17, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v17, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v17, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v4, v17, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v8, v17, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v9, v17, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v10, v17, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v11, v17, s[10:11]
; GFX9-NEXT:    global_store_dwordx4 v[12:13], v[4:7], off
; GFX9-NEXT:    global_store_dwordx4 v[14:15], v[0:3], off
; GFX9-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    v_lshrrev_b32_e32 v16, 1, v3
; GFX8-NEXT:    v_and_b32_e32 v1, 1, v3
; GFX8-NEXT:    v_mov_b32_e32 v0, 0xffff
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
...
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v16
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v16
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v16
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v16
; GFX8-NEXT:    v_mov_b32_e32 v12, 0
...
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v10, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v11, s[10:11]
; GFX8-NEXT:    v_bfi_b32 v0, v0, 0, v1
; GFX8-NEXT:    v_or_b32_e32 v17, v0, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v5, v17, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v17, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v17, s[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v17, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v8, v17, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v9, v17, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v10, v17, s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v11, v17, s[10:11]
...
; GFX7-NEXT:    v_cndmask_b32_e32 v0, v4, v12, vcc
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v8, v12, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v9, v12, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v10, v12, s[8:9]
; GFX7-NEXT:    v_cndmask_b32_e64 v8, v11, v12, s[10:11]
; GFX7-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0
; GFX7-NEXT:    s_mov_b64 s[12:13], 16
; GFX7-NEXT:    buffer_store_dwordx4 v[5:8], off, s[12:15], 0
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v8, v16, s2
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v9, v16, s3
; GFX10-NEXT:    v_cndmask_b32_e32 v0, v4, v16, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v10, v16, s4
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v11, v16, s5
; GFX10-NEXT:    global_store_dwordx4 v[12:13], v[0:3], off
; GFX10-NEXT:    global_store_dwordx4 v[14:15], v[5:8], off
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v2, 0xffff, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3)
...
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v8, v16, s2
; GFX11-NEXT:    v_cndmask_b32_e32 v0, v4, v16, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v9, v16, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v7, v10, v16, s4
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v11, v16, s5
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX11-NEXT:    global_store_b128 v[14:15], v[5:8], off
; GFX11-NEXT:    s_endpgm
  %vec = load <16 x i16>, ptr addrspace(1) %ptr
  %insert = insertelement <16 x i16> %vec, i16 %val, i32 %idx
  store <16 x i16> %insert, ptr addrspace(1) null
