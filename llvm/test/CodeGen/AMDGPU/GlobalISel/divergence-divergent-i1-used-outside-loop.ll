...
; GFX10-NEXT:  .LBB1_3: ; %is.eq.zero
; GFX10-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GFX10-NEXT:    global_load_dword v0, v[1:2], off
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_cmp_eq_u32_e64 s4, 0, v0
...
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    v_cndmask_b32_e64 v0, 1.0, 0, vcc_lo
; GFX10-NEXT:    flat_store_dword v[2:3], v0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-NEXT:    v_cndmask_b32_e64 v0, 1.0, 0, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v1, 2.0, -1.0, vcc_lo
; GFX10-NEXT:    flat_store_dword v[2:3], v0
...
; GFX10-NEXT:    s_xor_b32 s11, vcc_lo, exec_lo
; GFX10-NEXT:    s_xor_b32 s5, exec_lo, s11
; GFX10-NEXT:    s_or_b32 s9, s9, s5
; GFX10-NEXT:    s_mov_b32 exec_lo, s11
; GFX10-NEXT:    ; divergent control-flow edge
; GFX10-NEXT:    s_cbranch_execz .LBB4_4
; GFX10-NEXT:  .LBB4_3: ; %loop.cond
...
; GFX10-NEXT:  .LBB4_4: ; %loop.exit.guard
...
; GFX10-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; GFX10-NEXT:    s_xor_b32 s4, s4, exec_lo
; GFX10-NEXT:    s_xor_b32 s8, exec_lo, s4
; GFX10-NEXT:    s_mov_b32 exec_lo, s4
; GFX10-NEXT:    ; divergent control-flow edge
; GFX10-NEXT:    s_cbranch_execz .LBB5_3
; GFX10-NEXT:  .LBB5_2: ; %if.block.0
...
; GFX10-NEXT:    ; divergent control-flow edge
; GFX10-NEXT:    s_cbranch_execz .LBB7_5
; GFX10-NEXT:  .LBB7_4: ; %break.body
; GFX10-NEXT:    v_mov_b32_e32 v0, 10
; GFX10-NEXT:    global_store_dword v[4:5], v0, off
; GFX10-NEXT:  .LBB7_5: ; %exit
; GFX10-NEXT:    s_endpgm
entry:
  br label %A
