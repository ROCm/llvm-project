...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu8.02 -amdgpu-dpp-combine=false < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.10 -amdgpu-dpp-combine=false < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -amdgpu-dpp-combine=false < %s | FileCheck -check-prefix=GFX11 %s
