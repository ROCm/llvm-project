...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 -mem-intrinsic-expand-size=3 %s -o - | FileCheck -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 -mem-intrinsic-expand-size=5 %s -o - | FileCheck -check-prefix=GCN %s
