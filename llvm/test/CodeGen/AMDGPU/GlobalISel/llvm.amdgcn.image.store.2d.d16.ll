...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.02-mesa-mesa3d -o - %s | FileCheck -check-prefix=UNPACKED %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -global-isel-abort=2 -mtriple=amdgpu8.10-mesa-mesa3d -o - %s | FileCheck -check-prefix=GFX81 %s
