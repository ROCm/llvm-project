...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu7.01-- < %t.bc | FileCheck --check-prefixes=ALL,UNKNOWN-OS %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu8.02--  < %t.bc | FileCheck --check-prefixes=ALL,UNKNOWN-OS %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu7.01-unknown-mesa3d < %t.bc | FileCheck -check-prefixes=ALL,MESA3D %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu8.02-unknown-mesa3d < %t.bc | FileCheck -check-prefixes=ALL,MESA3D %s
