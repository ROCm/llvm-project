...
; UNALIGNED_GFX9-NEXT:    s_load_dword s0, s[0:1], 0x0
; UNALIGNED_GFX9-NEXT:    s_add_u32 flat_scratch_lo, s2, s5
; UNALIGNED_GFX9-NEXT:    s_addc_u32 flat_scratch_hi, s3, 0
...
; UNALIGNED_GFX10-NEXT:    s_add_u32 s2, s2, s5
; UNALIGNED_GFX10-NEXT:    s_addc_u32 s3, s3, 0
; UNALIGNED_GFX10-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s2
; UNALIGNED_GFX10-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s3
; UNALIGNED_GFX10-NEXT:    s_load_dword s0, s[0:1], 0x0
...
; UNALIGNED_GFX940-NEXT:    s_load_dword s0, s[0:1], 0x0
...
; UNALIGNED_GFX940-NEXT:    v_mov_b32_e32 v0, s0
; UNALIGNED_GFX940-NEXT:    scratch_load_dword v0, v0, off sc0 sc1
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    s_endpgm
;
; UNALIGNED_GFX11-LABEL: store_load_sindex_kernel:
; UNALIGNED_GFX11:       ; %bb.0: ; %bb
; UNALIGNED_GFX11-NEXT:    s_load_b32 s0, s[0:1], 0x0
...
; UNALIGNED_GFX12-NEXT:    s_load_b32 s0, s[0:1], 0x0
...
; UNALIGNED_GFX12-NEXT:    scratch_store_b32 v0, v1, off scope:SCOPE_SYS
; UNALIGNED_GFX12-NEXT:    s_wait_storecnt 0x0
; UNALIGNED_GFX12-NEXT:    scratch_load_b32 v0, v2, off scope:SCOPE_SYS
...
; UNALIGNED_GFX9:       ; %bb.0: ; %bb
; UNALIGNED_GFX9-NEXT:    s_add_u32 flat_scratch_lo, s0, s3
...
; UNALIGNED_GFX10:       ; %bb.0: ; %bb
; UNALIGNED_GFX10-NEXT:    s_add_u32 s0, s0, s3
...
; UNALIGNED_GFX11-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_lshlrev_b32 v1, 2, v1
...
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    v_mov_b32_e32 v0, s0
; UNALIGNED_GFX940-NEXT:    scratch_load_dword v0, v0, off offset:256 sc0 sc1
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    s_endpgm
;
...
; UNALIGNED_GFX11-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; UNALIGNED_GFX11-NEXT:    s_and_b32 s1, s0, 15
; UNALIGNED_GFX11-NEXT:    s_lshl_b32 s0, s0, 2
; UNALIGNED_GFX11-NEXT:    s_lshl_b32 s1, s1, 2
; UNALIGNED_GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; UNALIGNED_GFX11-NEXT:    scratch_store_b32 off, v0, s0 dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; UNALIGNED_GFX11-NEXT:    scratch_load_b32 v0, v1, off offset:256 glc dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX11-NEXT:    s_endpgm
;
...
; UNALIGNED_GFX12-NEXT:    s_wait_alu 0xfffe
; UNALIGNED_GFX12-NEXT:    v_mov_b32_e32 v2, s0
; UNALIGNED_GFX12-NEXT:    scratch_store_b32 v0, v1, off offset:256 scope:SCOPE_SYS
; UNALIGNED_GFX12-NEXT:    s_wait_storecnt 0x0
; UNALIGNED_GFX12-NEXT:    scratch_load_b32 v0, v2, off offset:256 scope:SCOPE_SYS
; UNALIGNED_GFX12-NEXT:    s_wait_loadcnt 0x0
; UNALIGNED_GFX12-NEXT:    s_endpgm
bb:
...
; UNALIGNED_GFX11-NEXT:    scratch_load_b32 v0, v1, s0 glc dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX11-NEXT:    s_endpgm
;
...
; UNALIGNED_GFX12-NEXT:    s_wait_alu 0xfffe
; UNALIGNED_GFX12-NEXT:    v_mov_b32_e32 v2, s0
; UNALIGNED_GFX12-NEXT:    scratch_store_b32 v0, v1, off offset:16384 scope:SCOPE_SYS
; UNALIGNED_GFX12-NEXT:    s_wait_storecnt 0x0
; UNALIGNED_GFX12-NEXT:    scratch_load_b32 v0, v2, off offset:16384 scope:SCOPE_SYS
; UNALIGNED_GFX12-NEXT:    s_wait_loadcnt 0x0
; UNALIGNED_GFX12-NEXT:    s_endpgm
bb:
...
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    v_mov_b32_e32 v0, 0x3e80
; UNALIGNED_GFX940-NEXT:    v_mov_b32_e32 v1, 15
; UNALIGNED_GFX940-NEXT:    scratch_store_dword v0, v1, off offset:4 sc0 sc1
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    scratch_load_dword v0, v0, off offset:4 sc0 sc1
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    s_endpgm
;
; UNALIGNED_GFX11-LABEL: store_load_large_imm_offset_kernel:
; UNALIGNED_GFX11:       ; %bb.0: ; %bb
; UNALIGNED_GFX11-NEXT:    v_dual_mov_b32 v0, 13 :: v_dual_mov_b32 v1, 0x3e80
; UNALIGNED_GFX11-NEXT:    v_mov_b32_e32 v2, 15
; UNALIGNED_GFX11-NEXT:    scratch_store_b32 off, v0, off offset:4 dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; UNALIGNED_GFX11-NEXT:    scratch_store_b32 v1, v2, off offset:4 dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; UNALIGNED_GFX11-NEXT:    scratch_load_b32 v0, v1, off offset:4 glc dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX11-NEXT:    s_endpgm
;
...
; UNALIGNED_GFX940-NEXT:    v_mov_b32_e32 v0, 0x3e80
; UNALIGNED_GFX940-NEXT:    v_mov_b32_e32 v1, 15
; UNALIGNED_GFX940-NEXT:    scratch_store_dword v0, v1, s32 offset:4 sc0 sc1
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    scratch_load_dword v0, v0, s32 offset:4 sc0 sc1
; UNALIGNED_GFX940-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; UNALIGNED_GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; UNALIGNED_GFX11-NEXT:    scratch_store_b32 v1, v2, s32 offset:4 dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; UNALIGNED_GFX11-NEXT:    scratch_load_b32 v0, v1, s32 offset:4 glc dlc
; UNALIGNED_GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED_GFX11-NEXT:    s_setpc_b64 s[30:31]
;
