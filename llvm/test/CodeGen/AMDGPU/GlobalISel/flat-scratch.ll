...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00-amd-amdhsa -global-isel -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds -mattr=-unaligned-access-mode,-promote-alloca,+enable-flat-scratch < %s | FileCheck -check-prefixes=UNALIGNED_GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.30-amd-amdhsa -global-isel -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds -mattr=-unaligned-access-mode,-promote-alloca,+enable-flat-scratch < %s | FileCheck -check-prefixes=UNALIGNED_GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.42-amd-amdhsa -global-isel -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds -mattr=-unaligned-access-mode,-promote-alloca < %s | FileCheck -check-prefixes=UNALIGNED_GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00-amd-amdhsa -global-isel -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds -mattr=-unaligned-access-mode,-promote-alloca < %s | FileCheck -check-prefixes=UNALIGNED_GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.00-amd-amdhsa -global-isel -disable-promote-alloca-to-vector -disable-promote-alloca-to-lds -mattr=+real-true16,-unaligned-access-mode,-promote-alloca < %s | FileCheck -check-prefixes=UNALIGNED_GFX12 %s
