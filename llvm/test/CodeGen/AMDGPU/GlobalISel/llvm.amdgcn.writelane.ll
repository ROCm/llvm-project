...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu7.00-mesa-mesa3d < %s | FileCheck -check-prefix=GFX7 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.00-mesa-mesa3d -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefix=GFX10 %s
