...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.08-mesa-mesa3d -stop-after=instruction-select -o - %s | FileCheck %s -check-prefix=GFX908
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.0a-mesa-mesa3d -stop-after=instruction-select -o - %s | FileCheck %s -check-prefix=GFX90A
