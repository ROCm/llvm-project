...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03-amd-mesa3d < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10-amd-mesa3d < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.70-amd-mesa3d -mattr=-real-true16 < %s | FileCheck -check-prefix=GFX1170 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.00-amd-mesa3d -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.00-amd-mesa3d -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-FAKE16 %s
