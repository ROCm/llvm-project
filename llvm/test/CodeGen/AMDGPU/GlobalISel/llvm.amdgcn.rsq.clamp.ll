...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.70 < %s | FileCheck -check-prefix=GFX1170 %s
