...
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu7.04 < %s | FileCheck --check-prefix=CI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu8.02 < %s | FileCheck --check-prefix=VI %s
...
; CI-NEXT:    ; implicit-def: $sgpr16_sgpr17
; CI-NEXT:    ; implicit-def: $sgpr16
; CI-NEXT:    v_rcp_f64_e32 v[4:5], v[2:3]
; CI-NEXT:    v_fma_f64 v[6:7], -v[2:3], v[4:5], 1.0
; CI-NEXT:    v_fma_f64 v[4:5], v[4:5], v[6:7], v[4:5]
...
; CI-NEXT:    ; implicit-def: $sgpr18_sgpr19
; CI-NEXT:    ; implicit-def: $sgpr18
; CI-NEXT:    v_rcp_f64_e32 v[4:5], v[2:3]
; CI-NEXT:    v_fma_f64 v[6:7], -v[2:3], v[4:5], 1.0
; CI-NEXT:    v_fma_f64 v[4:5], v[4:5], v[6:7], v[4:5]
...
; VI-NEXT:    ; implicit-def: $sgpr16_sgpr17
; VI-NEXT:    ; implicit-def: $sgpr16
; VI-NEXT:    v_rcp_f64_e32 v[4:5], v[2:3]
; VI-NEXT:    v_fma_f64 v[6:7], -v[2:3], v[4:5], 1.0
; VI-NEXT:    v_fma_f64 v[4:5], v[4:5], v[6:7], v[4:5]
...
; VI-NEXT:    ; implicit-def: $sgpr18_sgpr19
; VI-NEXT:    ; implicit-def: $sgpr18
; VI-NEXT:    v_rcp_f64_e32 v[4:5], v[2:3]
; VI-NEXT:    v_fma_f64 v[6:7], -v[2:3], v[4:5], 1.0
; VI-NEXT:    v_fma_f64 v[4:5], v[4:5], v[6:7], v[4:5]
