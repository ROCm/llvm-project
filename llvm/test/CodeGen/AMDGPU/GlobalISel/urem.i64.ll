...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-codegenprepare-disable-idiv-expansion=1 -mtriple=amdgpu6.00-amd-amdpal -denormal-fp-math-f32=preserve-sign -mattr=+mad-mac-f32-insts < %s | FileCheck -check-prefixes=CHECK,GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-codegenprepare-disable-idiv-expansion=0 -mtriple=amdgpu6.00-amd-amdpal -denormal-fp-math-f32=preserve-sign -mattr=+mad-mac-f32-insts < %s | FileCheck -check-prefixes=CHECK,CGP %s
...
; CHECK-NEXT:    v_or_b32_e32 v7, v5, v3
...
; CHECK-NEXT:    v_mul_hi_u32 v10, v7, v0
; CHECK-NEXT:    v_mul_lo_u32 v12, v8, v0
; CHECK-NEXT:    v_mul_lo_u32 v11, v7, v0
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v12
; CHECK-NEXT:    v_mul_hi_u32 v10, v0, v11
; CHECK-NEXT:    v_mul_lo_u32 v12, v0, v9
; CHECK-NEXT:    v_mul_lo_u32 v13, v1, v11
...
; CHECK-NEXT:    v_mul_hi_u32 v13, v0, v9
...
; CHECK-NEXT:    v_mul_hi_u32 v9, v7, v0
; CHECK-NEXT:    v_mul_lo_u32 v10, v7, v1
; CHECK-NEXT:    v_mul_lo_u32 v8, v8, v0
; CHECK-NEXT:    v_mul_lo_u32 v7, v7, v0
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CHECK-NEXT:    v_mul_hi_u32 v9, v0, v7
; CHECK-NEXT:    v_mul_lo_u32 v10, v0, v8
...
; CHECK-NEXT:    v_mul_lo_u32 v9, v5, v0
...
; CHECK-NEXT:    v_mul_lo_u32 v8, v5, v1
...
; CHECK-NEXT:    v_mul_hi_u32 v7, v2, v0
...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v4, v8
; CHECK-NEXT:    v_subb_u32_e64 v7, s[4:5], v5, v0, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v8, vcc, v1, v2
; CHECK-NEXT:    v_subbrev_u32_e64 v9, s[4:5], 0, v0, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v3, vcc, v8, v2
; CHECK-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[4:5]
; CHECK-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v8, v3, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v8, v9, v0, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v0, v2
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v2
; CHECK-NEXT:    v_cndmask_b32_e32 v5, v0, v1, vcc
...
; CGP-NEXT:    v_or_b32_e32 v3, v11, v5
...
; CGP-NEXT:    s_mov_b64 exec, vcc
; CGP-NEXT:    ; divergent control-flow edge
...
; CGP-NEXT:    v_subb_u32_e32 v12, vcc, 0, v5, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v13, v3, v1
; CGP-NEXT:    v_mul_hi_u32 v14, v3, v0
...
; CGP-NEXT:    v_mul_hi_u32 v13, v3, v0
; CGP-NEXT:    v_mul_lo_u32 v14, v3, v1
...
; CGP-NEXT:    v_mul_hi_u32 v13, v0, v3
; CGP-NEXT:    v_mul_lo_u32 v14, v0, v12
; CGP-NEXT:    v_mul_lo_u32 v15, v1, v3
...
; CGP-NEXT:    v_mul_lo_u32 v13, v11, v0
...
; CGP-NEXT:    v_mul_lo_u32 v12, v11, v1
...
; CGP-NEXT:    v_mul_hi_u32 v3, v4, v0
...
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v10, v12
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v11, v0, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v12, vcc, v1, v4
; CGP-NEXT:    v_subbrev_u32_e64 v13, s[4:5], 0, v0, vcc
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v13, v5
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, v12, v4
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v12, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v12, v13, v0, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v11
; CGP-NEXT:    v_cndmask_b32_e32 v0, v1, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v3, v12, vcc
; CGP-NEXT:  .LBB2_2:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; CGP-NEXT:    s_mov_b64 exec, s[6:7]
; CGP-NEXT:    ; divergent control-flow edge
...
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v0, v4
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; CGP-NEXT:    v_cndmask_b32_e32 v1, v0, v1, vcc
; CGP-NEXT:    v_mov_b32_e32 v0, v1
; CGP-NEXT:    v_mov_b32_e32 v1, v2
; CGP-NEXT:  .LBB2_4: ; %.split
; CGP-NEXT:    s_or_b64 exec, exec, s[4:5]
; CGP-NEXT:    v_or_b32_e32 v5, v9, v7
...
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, 0, v6
; CGP-NEXT:    v_subb_u32_e32 v10, vcc, 0, v7, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v12, v2, v13
; CGP-NEXT:    v_mul_lo_u32 v14, v2, v11
; CGP-NEXT:    v_mul_lo_u32 v15, v3, v13
; CGP-NEXT:    v_mul_hi_u32 v13, v3, v13
...
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v3, v11, vcc
; CGP-NEXT:    v_mul_hi_u32 v11, v5, v2
; CGP-NEXT:    v_mul_lo_u32 v12, v5, v3
; CGP-NEXT:    v_mul_lo_u32 v10, v10, v2
...
; CGP-NEXT:    v_mul_lo_u32 v13, v3, v5
...
; CGP-NEXT:    v_mul_hi_u32 v5, v6, v2
...
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v8, v10
; CGP-NEXT:    v_subb_u32_e64 v5, s[4:5], v9, v2, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v10, vcc, v3, v6
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v11, v7
; CGP-NEXT:    v_sub_i32_e32 v7, vcc, v10, v6
...
; CGP-NEXT:    v_cndmask_b32_e32 v7, v10, v7, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v10, v11, v2, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; CGP-NEXT:    v_cndmask_b32_e32 v2, v3, v7, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v3, v5, v10, vcc
; CGP-NEXT:  .LBB2_6:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; CGP-NEXT:    s_mov_b64 exec, s[6:7]
...
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v2, v6
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v6
; CGP-NEXT:    v_cndmask_b32_e32 v3, v2, v3, vcc
; CGP-NEXT:    v_mov_b32_e32 v2, v3
; CGP-NEXT:    v_mov_b32_e32 v3, v4
...
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    v_lshl_b64 v[7:8], v[0:1], v2
; CHECK-NEXT:    v_mov_b32_e32 v5, 0
; CHECK-NEXT:    v_or_b32_e32 v6, v4, v8
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[5:6]
; CHECK-NEXT:    ; implicit-def: $vgpr0_vgpr1
; CHECK-NEXT:    s_xor_b64 s[6:7], vcc, exec
; CHECK-NEXT:    s_mov_b64 exec, vcc
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    v_sub_i32_e32 v2, vcc, 0, v7
; CHECK-NEXT:    v_subb_u32_e32 v6, vcc, 0, v8, vcc
; CHECK-NEXT:    v_mac_f32_e32 v0, 0x4f800000, v1
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; CHECK-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; CHECK-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
...
; CHECK-NEXT:    v_mul_lo_u32 v12, v6, v0
; CHECK-NEXT:    v_mul_lo_u32 v11, v2, v0
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v12
; CHECK-NEXT:    v_mul_hi_u32 v10, v0, v11
; CHECK-NEXT:    v_mul_lo_u32 v12, v0, v9
...
; CHECK-NEXT:    v_mul_lo_u32 v10, v2, v1
; CHECK-NEXT:    v_mul_lo_u32 v6, v6, v0
; CHECK-NEXT:    v_mul_lo_u32 v2, v2, v0
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v9, v6
; CHECK-NEXT:    v_mul_hi_u32 v9, v0, v2
; CHECK-NEXT:    v_mul_lo_u32 v10, v0, v6
; CHECK-NEXT:    v_mul_lo_u32 v11, v1, v2
; CHECK-NEXT:    v_mul_hi_u32 v2, v1, v2
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v11
...
; CHECK-NEXT:    v_mul_lo_u32 v9, v4, v0
; CHECK-NEXT:    v_mul_hi_u32 v0, v4, v0
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v9
...
; CHECK-NEXT:    v_mul_hi_u32 v2, v7, v0
; CHECK-NEXT:    v_mul_lo_u32 v1, v7, v1
; CHECK-NEXT:    v_mul_lo_u32 v6, v7, v0
; CHECK-NEXT:    v_mul_lo_u32 v0, v8, v0
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v2, v1
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v3, v6
; CHECK-NEXT:    v_subb_u32_e64 v2, s[4:5], v4, v0, vcc
; CHECK-NEXT:    v_sub_i32_e64 v0, s[4:5], v4, v0
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v8
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v2, v8
; CHECK-NEXT:    v_subb_u32_e32 v0, vcc, v0, v8, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v4, v4, v6, s[4:5]
; CHECK-NEXT:    v_sub_i32_e32 v6, vcc, v1, v7
; CHECK-NEXT:    v_subbrev_u32_e64 v9, s[4:5], 0, v0, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v6, v7
; CHECK-NEXT:    v_subb_u32_e32 v0, vcc, v0, v8, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v9, v8
; CHECK-NEXT:    v_sub_i32_e32 v8, vcc, v6, v7
; CHECK-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[4:5]
; CHECK-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
...
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v6, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v2, v8, vcc
; CHECK-NEXT:  .LBB7_2:
; CHECK-NEXT:    s_or_b64 exec, exec, s[6:7]
; CHECK-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; CHECK-NEXT:    s_mov_b64 exec, s[6:7]
...
; CHECK-NEXT:  .LBB7_3:
; CHECK-NEXT:    v_cvt_f32_u32_e32 v0, v7
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, 0, v7
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; CHECK-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; CHECK-NEXT:    v_cvt_u32_f32_e32 v0, v0
; CHECK-NEXT:    v_mul_lo_u32 v1, v1, v0
...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v0, v7
...
; CGP-NEXT:    v_lshl_b64 v[12:13], v[0:1], v4
; CGP-NEXT:    v_mov_b32_e32 v5, v2
; CGP-NEXT:    v_mov_b32_e32 v7, v3
; CGP-NEXT:    v_or_b32_e32 v3, v9, v13
; CGP-NEXT:    v_mov_b32_e32 v2, 0
; CGP-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
...
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, 0, v12
; CGP-NEXT:    v_subb_u32_e32 v4, vcc, 0, v13, vcc
; CGP-NEXT:    v_mac_f32_e32 v0, 0x4f800000, v1
; CGP-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; CGP-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; CGP-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
...
; CGP-NEXT:    v_mul_hi_u32 v14, v3, v0
; CGP-NEXT:    v_mul_lo_u32 v16, v4, v0
; CGP-NEXT:    v_mul_lo_u32 v15, v3, v0
...
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v14, v17
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v17, v0, v6
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v16, v14
...
; CGP-NEXT:    v_mul_hi_u32 v6, v3, v0
; CGP-NEXT:    v_mul_lo_u32 v14, v3, v1
...
; CGP-NEXT:    v_mul_lo_u32 v14, v0, v4
; CGP-NEXT:    v_mul_lo_u32 v15, v1, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v1, v3
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v14
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v4, v8, v1
; CGP-NEXT:    v_mul_lo_u32 v6, v9, v0
; CGP-NEXT:    v_mul_hi_u32 v0, v9, v0
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v6
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v6, v8, v1
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; CGP-NEXT:    v_mul_lo_u32 v4, v9, v1
...
; CGP-NEXT:    v_mul_lo_u32 v1, v12, v1
; CGP-NEXT:    v_mul_lo_u32 v4, v12, v0
; CGP-NEXT:    v_mul_lo_u32 v0, v13, v0
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v8, v4
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v9, v0, vcc
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v9, v0
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v13
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v12
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v3, v13
; CGP-NEXT:    v_subb_u32_e32 v0, vcc, v0, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v4, v4, v6, s[4:5]
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v1, v12
; CGP-NEXT:    v_subbrev_u32_e64 v9, s[4:5], 0, v0, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v13
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v6, v12
; CGP-NEXT:    v_subb_u32_e32 v0, vcc, v0, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v9, v13
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v6, v12
; CGP-NEXT:    v_cndmask_b32_e64 v14, v14, v15, s[4:5]
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; CGP-NEXT:    v_cndmask_b32_e32 v6, v6, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v9, v9, v0, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CGP-NEXT:    v_cndmask_b32_e32 v0, v1, v6, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v3, v9, vcc
; CGP-NEXT:  .LBB8_2:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; CGP-NEXT:    s_mov_b64 exec, s[6:7]
...
; CGP-NEXT:    s_or_b64 exec, exec, s[4:5]
; CGP-NEXT:    v_or_b32_e32 v9, v7, v11
; CGP-NEXT:    v_mov_b32_e32 v8, 0
; CGP-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; CGP-NEXT:    ; implicit-def: $vgpr2_vgpr3
; CGP-NEXT:    s_xor_b64 s[6:7], vcc, exec
; CGP-NEXT:    s_mov_b64 exec, vcc
; CGP-NEXT:    ; divergent control-flow edge
...
; CGP-NEXT:    v_mul_lo_u32 v14, v6, v2
; CGP-NEXT:    v_mul_lo_u32 v13, v4, v2
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v12, v9
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v14
; CGP-NEXT:    v_mul_hi_u32 v12, v2, v13
; CGP-NEXT:    v_mul_lo_u32 v14, v2, v9
; CGP-NEXT:    v_mul_lo_u32 v15, v3, v13
; CGP-NEXT:    v_mul_hi_u32 v13, v3, v13
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v14
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
...
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v14, v12
; CGP-NEXT:    v_mul_lo_u32 v14, v3, v9
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v15
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v12, v4, v3
...
; CGP-NEXT:    v_mul_lo_u32 v13, v3, v4
...
; CGP-NEXT:    v_mul_lo_u32 v9, v7, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v7, v2
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v9
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v9, v5, v3
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v4, v11
; CGP-NEXT:    v_subb_u32_e32 v2, vcc, v2, v11, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v6, v6, v7, s[4:5]
; CGP-NEXT:    v_sub_i32_e32 v7, vcc, v3, v10
; CGP-NEXT:    v_subbrev_u32_e64 v9, s[4:5], 0, v2, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v11
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v10
; CGP-NEXT:    v_subb_u32_e32 v2, vcc, v2, v11, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v9, v11
; CGP-NEXT:    v_sub_i32_e32 v11, vcc, v7, v10
; CGP-NEXT:    v_cndmask_b32_e64 v12, v12, v13, s[4:5]
; CGP-NEXT:    v_subbrev_u32_e32 v2, vcc, 0, v2, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v12
; CGP-NEXT:    v_cndmask_b32_e32 v7, v7, v11, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v9, v9, v2, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; CGP-NEXT:    v_cndmask_b32_e32 v2, v3, v7, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v3, v4, v9, vcc
; CGP-NEXT:  .LBB8_6:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; CGP-NEXT:    s_mov_b64 exec, s[6:7]
...
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v2, v10
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v10
; CGP-NEXT:    v_cndmask_b32_e32 v7, v2, v3, vcc
; CGP-NEXT:    v_mov_b32_e32 v2, v7
; CGP-NEXT:    v_mov_b32_e32 v3, v8
