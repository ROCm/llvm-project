...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v5, v0
; CHECK-NEXT:    v_sub_i32_e32 v4, vcc, v4, v7
; CHECK-NEXT:    v_subb_u32_e64 v5, s[4:5], v5, v0, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v4, v2
...
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v9, v6, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v11, v0
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v10, v3
...
; CGP-NEXT:    v_sub_i32_e32 v11, vcc, v2, v4
; CGP-NEXT:    v_subbrev_u32_e64 v12, s[4:5], 0, v1, vcc
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v1, v5, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v13, v10, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v0, v2, v4, vcc
...
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v9, v2
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v8, v5
...
; CGP-NEXT:    v_sub_i32_e32 v9, vcc, v4, v6
...
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v8, v1
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v4, v0
; CHECK-NEXT:    v_sub_i32_e32 v2, vcc, v3, v7
; CHECK-NEXT:    v_subb_u32_e64 v3, s[4:5], v4, v0, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[4:5]
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v1, v6, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v6
...
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, -1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v8, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; CHECK-NEXT:    v_sub_i32_e32 v5, vcc, v7, v5
; CHECK-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v6
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v9, v4, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v7, v5, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v8, v1, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v6, v9
; GISEL-NEXT:    v_cvt_f32_u32_e32 v7, v10
...
; GISEL-NEXT:    v_sub_i32_e32 v8, vcc, 0, v9
; GISEL-NEXT:    v_subb_u32_e32 v11, vcc, 0, v10, vcc
; GISEL-NEXT:    v_mul_lo_u32 v12, v8, v6
; GISEL-NEXT:    v_mul_hi_u32 v13, v8, v6
; GISEL-NEXT:    v_mul_lo_u32 v14, v8, v7
...
; GISEL-NEXT:    v_mul_lo_u32 v16, v7, v13
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v16
; GISEL-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v12, v1, v7
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v6, v11
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v6, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v11, v9, v6
; GISEL-NEXT:    v_mul_lo_u32 v7, v9, v7
; GISEL-NEXT:    v_mul_lo_u32 v6, v10, v6
...
; GISEL-NEXT:    v_sub_i32_e64 v8, s[4:5], v0, v9
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v1, v10, vcc
; GISEL-NEXT:    v_subbrev_u32_e64 v11, vcc, 0, v1, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v11, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, -1, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v8, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v11, v10
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v12, v13, vcc
; GISEL-NEXT:    v_sub_i32_e32 v9, vcc, v8, v9
; GISEL-NEXT:    v_subb_u32_e64 v1, s[4:5], v1, v10, s[4:5]
; GISEL-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v12
...
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v13, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v9, v0
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v8, v12
...
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v12, vcc, v4, v2
; CGP-NEXT:    v_subbrev_u32_e64 v13, s[4:5], 0, v1, vcc
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v1, v3, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v3
; CGP-NEXT:    v_cndmask_b32_e32 v0, v9, v0, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v12, v2
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v13, v3
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v12, v2
; CGP-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v13, v3
; CGP-NEXT:    v_cndmask_b32_e32 v3, v14, v9, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CGP-NEXT:    v_cndmask_b32_e32 v2, v12, v2, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v13, v1, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; CGP-NEXT:    v_cndmask_b32_e32 v0, v4, v2, vcc
...
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v7, v2
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v5, v6
; CGP-NEXT:    v_subb_u32_e64 v5, s[4:5], v7, v2, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v9
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[4:5]
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v3, v10, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v10
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v7, vcc, v4, v9
; CGP-NEXT:    v_subbrev_u32_e64 v8, s[4:5], 0, v3, vcc
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v3, v10, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v5, v10
; CGP-NEXT:    v_cndmask_b32_e32 v2, v6, v2, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v7, v9
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v8, v10
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v9, vcc, v7, v9
; CGP-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v3, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v10
; CGP-NEXT:    v_cndmask_b32_e32 v6, v11, v6, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; CGP-NEXT:    v_cndmask_b32_e32 v6, v7, v9, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v4, v7, v6
; GISEL-NEXT:    v_cvt_u32_f32_e32 v5, v5
...
; GISEL-NEXT:    v_mul_lo_u32 v18, v6, v16
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v14, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v18, vcc, v4, v18
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v14, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v19, vcc, v19, v4
; GISEL-NEXT:    v_mul_lo_u32 v4, v11, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v20, 0, 1, s[6:7]
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v17, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v20, vcc, v20, v4
; GISEL-NEXT:    v_and_b32_e32 v4, 0xffffff, v0
; GISEL-NEXT:    v_and_b32_e32 v0, 0xffffff, v2
; GISEL-NEXT:    v_mul_hi_u32 v2, v6, v16
...
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v15
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, v6, v2, vcc
; GISEL-NEXT:    v_mul_lo_u32 v6, v7, v12
...
; GISEL-NEXT:    v_mul_hi_u32 v16, v12, v6
; GISEL-NEXT:    v_mul_lo_u32 v17, v2, v6
; GISEL-NEXT:    v_mul_hi_u32 v6, v2, v6
...
; GISEL-NEXT:    v_mul_lo_u32 v9, v12, v7
; GISEL-NEXT:    v_mul_hi_u32 v10, v12, v7
; GISEL-NEXT:    v_mul_lo_u32 v14, v2, v7
; GISEL-NEXT:    v_mul_hi_u32 v7, v2, v7
; GISEL-NEXT:    v_mul_lo_u32 v15, v5, v8
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v18, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v15, v19
; GISEL-NEXT:    v_mul_hi_u32 v15, v5, v8
; GISEL-NEXT:    v_mul_lo_u32 v19, v11, v8
...
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v8, v10
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v12, v6
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, v2, v7, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v10, v4, v2
; GISEL-NEXT:    v_mul_hi_u32 v11, v4, v2
; GISEL-NEXT:    v_mul_lo_u32 v12, 0, v2
; GISEL-NEXT:    v_mul_hi_u32 v2, 0, v2
; GISEL-NEXT:    v_mul_lo_u32 v13, v0, v8
...
; GISEL-NEXT:    v_mul_hi_u32 v11, v1, v5
; GISEL-NEXT:    v_mul_lo_u32 v5, 0, v5
...
; GISEL-NEXT:    v_sub_i32_e32 v8, vcc, 0, v5
; GISEL-NEXT:    v_sub_i32_e32 v4, vcc, v4, v7
; GISEL-NEXT:    v_subb_u32_e64 v7, s[4:5], 0, v2, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[4:5]
; GISEL-NEXT:    v_sub_i32_e64 v9, s[4:5], v0, v10
; GISEL-NEXT:    v_subb_u32_e64 v5, s[6:7], 0, v5, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v9, v1
...
; GISEL-NEXT:    v_cndmask_b32_e32 v10, -1, v0, vcc
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v4, v3
; GISEL-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v6, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, -1, vcc
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v9, v1
...
; GISEL-NEXT:    v_sub_i32_e32 v3, vcc, v0, v3
...
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v6, v14, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v6, v8, v15, s[4:5]
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v4, v0, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v2, v9, v1, s[4:5]
