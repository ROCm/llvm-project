...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.00-amd-amdhsa -o - %s | FileCheck -enable-var-scope -check-prefix=MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mattr=+enable-flat-scratch -mtriple=amdgpu9.00-amd-amdhsa -o - %s | FileCheck -enable-var-scope -check-prefix=FLATSCR %s
