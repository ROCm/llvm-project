...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu7.01-amd-amdpal < %s | FileCheck --check-prefixes=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.00-amd-amdpal < %s | FileCheck --check-prefixes=GFX12 %s
