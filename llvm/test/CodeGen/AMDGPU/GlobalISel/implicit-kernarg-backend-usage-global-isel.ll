...
; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=GFX8V4 %s
; RUN: sed 's/CODE_OBJECT_VERSION/500/g' %s | llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=GFX8V5 %s
; RUN: sed 's/CODE_OBJECT_VERSION/600/g' %s | llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=GFX8V5 %s

; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.06-amd-amdhsa | FileCheck --check-prefixes=GFX9V4 %s
; RUN: sed 's/CODE_OBJECT_VERSION/500/g' %s | llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.06-amd-amdhsa | FileCheck --check-prefixes=GFX9V5 %s
; RUN: sed 's/CODE_OBJECT_VERSION/600/g' %s | llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.06-amd-amdhsa | FileCheck --check-prefixes=GFX9V5 %s
