...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu6.00-amd- < %s | FileCheck -check-prefix=GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu8.03-amd- < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu10.10-amd-amdhsa < %s | FileCheck -check-prefix=GFX10WGP %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu10.10-amd-amdhsa -mattr=+cumode < %s | FileCheck -check-prefix=GFX10CU %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX11WGP %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=si-memory-legalizer -mtriple=amdgpu11.00-amd-amdhsa -mattr=+cumode < %s | FileCheck -check-prefix=GFX11CU %s
