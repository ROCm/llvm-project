...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -stop-after=irtranslator -mtriple=amdgcn-mesa-mesa3d -mcpu=fiji -o - %s | FileCheck -enable-var-scope %s
...
define i1 @i1_func_void() #0 {
  ...
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i1) = G_LOAD [[DEF]](p1) :: (load (i1) from `ptr addrspace(1) poison`, addrspace 1)
...
define i7 @i7_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i7) = G_LOAD [[DEF]](p1) :: (load (i7) from `ptr addrspace(1) poison`, addrspace 1)
...
define i8 @i8_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i8) = G_LOAD [[DEF]](p1) :: (load (i8) from `ptr addrspace(1) poison`, addrspace 1)
...
define i16 @i16_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i16) = G_LOAD [[DEF]](p1) :: (load (i16) from `ptr addrspace(1) poison`, addrspace 1)
...
define i24 @i24_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i24) = G_LOAD [[DEF]](p1) :: (load (i24) from `ptr addrspace(1) poison`, align 4, addrspace 1)
...
define <2 x i24> @v2i24_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x i24>) = G_LOAD [[DEF]](p1) :: (load (<2 x i24>) from `ptr addrspace(1) poison`, align 8, addrspace 1)
...
define <3 x i24> @v3i24_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<3 x i24>) = G_LOAD [[DEF]](p1) :: (load (<3 x i24>) from `ptr addrspace(1) poison`, align 16, addrspace 1)
...
define i32 @i32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p1) :: (load (i32) from `ptr addrspace(1) poison`, addrspace 1)
...
define i48 @i48_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i48) = G_LOAD [[DEF]](p1) :: (load (i48) from `ptr addrspace(1) poison`, align 8, addrspace 1)
...
define i64 @i64_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i64) = G_LOAD [[DEF]](p1) :: (load (i64) from `ptr addrspace(1) poison`, addrspace 1)
...
define float @f32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(f32) = G_LOAD [[DEF]](p1) :: (load (f32) from `ptr addrspace(1) poison`, addrspace 1)
...
define double @f64_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(f64) = G_LOAD [[DEF]](p1) :: (load (f64) from `ptr addrspace(1) poison`, addrspace 1)
...
define <2 x double> @v2f64_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x f64>) = G_LOAD [[DEF]](p1) :: (load (<2 x f64>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <2 x i32> @v2i32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x i32>) = G_LOAD [[DEF]](p1) :: (load (<2 x i32>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <3 x i32> @v3i32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<3 x i32>) = G_LOAD [[DEF]](p1) :: (load (<3 x i32>) from `ptr addrspace(1) poison`, align 16, addrspace 1)
...
define <4 x i32> @v4i32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<4 x i32>) = G_LOAD [[DEF]](p1) :: (load (<4 x i32>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <5 x i32> @v5i32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<5 x i32>) = G_LOAD [[DEF]](p1) :: (volatile load (<5 x i32>) from `ptr addrspace(1) poison`, align 32, addrspace 1)
...
define <2 x i64> @v2i64_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x i64>) = G_LOAD [[DEF]](p1) :: (load (<2 x i64>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <2 x i16> @v2i16_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x i16>) = G_LOAD [[DEF]](p1) :: (load (<2 x i16>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <2 x half> @v2f16_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x f16>) = G_LOAD [[DEF]](p1) :: (load (<2 x f16>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <3 x i16> @v3i16_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<3 x i16>) = G_LOAD [[DEF]](p1) :: (load (<3 x i16>) from `ptr addrspace(1) poison`, align 8, addrspace 1)
...
define <4 x i16> @v4i16_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<4 x i16>) = G_LOAD [[DEF]](p1) :: (load (<4 x i16>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <4 x half> @v4f16_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<4 x f16>) = G_LOAD [[DEF]](p1) :: (load (<4 x f16>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <2 x i8> @v2i8_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<2 x i8>) = G_LOAD [[DEF]](p1) :: (load (<2 x i8>) from `ptr addrspace(1) poison`, addrspace 1)
...
define <3 x i8> @v3i8_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<3 x i8>) = G_LOAD [[DEF]](p1) :: (load (<3 x i8>) from `ptr addrspace(1) poison`, align 4, addrspace 1)
...
define {i8, i32} @struct_i8_i32_func_void() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i8) = G_LOAD [[DEF]](p1) :: (load (i8) from `ptr addrspace(1) poison`, align 4, addrspace 1)
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 4
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[DEF]], [[C]](i64)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[PTR_ADD]](p1) :: (load (i32) from `ptr addrspace(1) poison` + 4, addrspace 1)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[LOAD]](i8)
  ; CHECK-NEXT:   $vgpr0 = COPY [[ANYEXT]](i32)
...
define void @void_func_sret_struct_i8_i32(ptr addrspace(5) sret({ i8, i32 }) %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p1) :: (volatile load (i32) from `ptr addrspace(1) poison`, addrspace 1)
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 4
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p5) = nuw nusw inbounds G_PTR_ADD [[COPY]], [[C]](i32)
  ; CHECK-NEXT:   G_STORE [[LOAD]](i8), [[COPY]](p5) :: (store (i8) into %ir.arg0, addrspace 5)
  ; CHECK-NEXT:   G_STORE [[LOAD1]](i32), [[PTR_ADD]](p5) :: (store (i32) into %ir.gep1, addrspace 5)
...
define { <32 x i32>, i32 } @struct_v32i32_i32_func_void() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p5) = nuw inbounds G_PTR_ADD [[COPY]], [[C1]](i32)
...
define { <3 x i32>, i32 } @v3i32_struct_func_void_wasted_reg() #0 {
  ...
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p3) :: (volatile load (i32) from `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p3) :: (volatile load (i32) from `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   [[LOAD2:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p3) :: (volatile load (i32) from `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   [[LOAD3:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p3) :: (volatile load (i32) from `ptr addrspace(3) poison`, addrspace 3)
...
define { <3 x float>, i32 } @v3f32_struct_func_void_wasted_reg() #0 {
  ...
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i32) = G_CONSTANT i32 2
  ; CHECK-NEXT:   [[DEF2:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(f32) = G_LOAD [[DEF]](p3) :: (volatile load (f32) from `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:_(f32) = G_LOAD [[DEF]](p3) :: (volatile load (f32) from `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   [[LOAD2:%[0-9]+]]:_(f32) = G_LOAD [[DEF]](p3) :: (volatile load (f32) from `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   [[LOAD3:%[0-9]+]]:_(i32) = G_LOAD [[DEF]](p3) :: (volatile load (i32) from `ptr addrspace(3) poison`, addrspace 3)
...
define void @void_func_sret_max_known_zero_bits(ptr addrspace(5) sret(i8) %arg0) #0 {
  ...
  ; CHECK-NEXT:   G_STORE [[LSHR]](i32), [[DEF]](p3) :: (volatile store (i32) into `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   G_STORE [[LSHR1]](i32), [[DEF]](p3) :: (volatile store (i32) into `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   G_STORE [[LSHR2]](i32), [[DEF]](p3) :: (volatile store (i32) into `ptr addrspace(3) poison`, addrspace 3)
  ; CHECK-NEXT:   SI_RETURN
...
define %struct.with.ptrs @ptr_in_struct_func_void() #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(p5) = COPY $vgpr0
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<32 x i32>) = G_LOAD [[DEF]](p1) :: (volatile load (<32 x i32>) from `ptr addrspace(1) poison`, addrspace 1)
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 128
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[DEF]], [[C]](i64)
  ...
  ; CHECK-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p1) = nuw inbounds G_PTR_ADD [[DEF]], [[C2]](i64)
