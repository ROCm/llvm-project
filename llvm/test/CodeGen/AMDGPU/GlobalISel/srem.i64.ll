...
; CHECK-NEXT:    v_mul_hi_u32 v2, v10, v6
; CHECK-NEXT:    v_mul_lo_u32 v3, v9, v6
; CHECK-NEXT:    v_mul_hi_u32 v6, v9, v6
; CHECK-NEXT:    v_mul_lo_u32 v8, v10, v7
; CHECK-NEXT:    v_mul_hi_u32 v13, v10, v7
...
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v6, v13
...
; CHECK-NEXT:    v_mul_lo_u32 v5, v10, v7
...
; CHECK-NEXT:    v_mul_hi_u32 v6, v10, v7
...
; CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CHECK-NEXT:    v_mul_hi_u32 v5, v8, v4
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v6, v3
...
; GISEL-NEXT:    v_mul_lo_u32 v13, v14, v9
...
; GISEL-NEXT:    v_mul_hi_u32 v11, v17, v9
...
; GISEL-NEXT:    v_mul_hi_u32 v10, v13, v9
...
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v10, v11
...
; GISEL-NEXT:    v_sub_i32_e32 v11, vcc, v13, v9
; GISEL-NEXT:    v_subb_u32_e64 v13, s[4:5], v12, v10, vcc
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v12, v10
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v19, v18, 0
; GISEL-NEXT:    v_cvt_u32_f32_e32 v21, v1
; GISEL-NEXT:    ; implicit-def: $vgpr10
; GISEL-NEXT:    v_subb_u32_e32 v20, vcc, 0, v7, vcc
; GISEL-NEXT:    v_mul_hi_u32 v22, v18, v8
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v21, v[9:10]
; GISEL-NEXT:    v_mul_lo_u32 v23, v21, v8
; GISEL-NEXT:    v_mul_hi_u32 v24, v21, v8
; GISEL-NEXT:    v_sub_i32_e32 v5, vcc, v14, v5
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v20, v18, v[0:1]
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v2, v15, v8
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v15, v9
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v2, v0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v3, v13, v2
...
; GISEL-NEXT:    v_mul_hi_u32 v1, v14, v2
...
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v7, v15, v[2:3]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v13, v8
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v14, v4, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v17, v14, v3
; CGP-NEXT:    v_mul_lo_u32 v18, v5, v3
...
; CGP-NEXT:    v_mul_hi_u32 v11, v14, v2
...
; CGP-NEXT:    v_xor_b32_e32 v12, v10, v15
...
; CGP-NEXT:    v_mul_hi_u32 v15, v12, v5
; CGP-NEXT:    v_mul_lo_u32 v16, v7, v5
...
; CGP-NEXT:    v_mul_hi_u32 v9, v12, v4
; CGP-NEXT:    v_mul_lo_u32 v10, v12, v5
; CGP-NEXT:    v_xor_b32_e32 v11, v6, v13
...
; CGP-NEXT:    v_xor_b32_e32 v9, v8, v13
; CGP-NEXT:    v_mul_lo_u32 v8, v9, v4
...
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v8, v6
; CGP-NEXT:    ; implicit-def: $vgpr6
...
; CGP-NEXT:    v_subb_u32_e64 v6, s[4:5], v9, v5, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v6, v16, v1, vcc
...
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v13, v6
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v4, v0, 0
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v1, v6
; CGP-NEXT:    ; implicit-def: $vgpr15
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v6, v[14:15]
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v18, v13
; CGP-NEXT:    ; implicit-def: $vgpr6
; CGP-NEXT:    v_subb_u32_e64 v14, s[4:5], v19, v0, vcc
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v19, v0
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_sub_i32_e32 v16, vcc, v13, v4
...
; CGP-NEXT:    v_sub_i32_e32 v20, vcc, v16, v4
...
; CGP-NEXT:    v_cndmask_b32_e32 v0, v16, v20, vcc
...
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CGP-NEXT:    v_mul_hi_u32 v9, v8, v5
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v2, 0
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v7, v3
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v2
; CGP-NEXT:    ; implicit-def: $vgpr7
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v9, v[6:7]
...
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v5, v13
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
...
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, v10, v5, vcc
; CHECK-NEXT:    v_mul_hi_u32 v5, v9, v2
; CHECK-NEXT:    v_mul_lo_u32 v6, v9, v3
; CHECK-NEXT:    v_xor_b32_e32 v7, v4, v11
...
; CHECK-NEXT:    v_mul_hi_u32 v6, v7, v3
...
; GISEL-NEXT:    v_mul_lo_u32 v13, v15, v8
...
; GISEL-NEXT:    v_mul_lo_u32 v0, v15, v8
; GISEL-NEXT:    v_mul_lo_u32 v13, v18, v9
; GISEL-NEXT:    v_mul_hi_u32 v8, v15, v8
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
...
; GISEL-NEXT:    v_addc_u32_e32 v8, vcc, v15, v8, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v9, v14, v8
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
...
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v9, v10
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v0, v1
...
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v14, v8
...
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v19, v18, 0
; GISEL-NEXT:    v_cvt_u32_f32_e32 v21, v1
; GISEL-NEXT:    ; implicit-def: $vgpr11
; GISEL-NEXT:    v_subb_u32_e32 v20, vcc, 0, v8, vcc
; GISEL-NEXT:    v_mul_hi_u32 v22, v18, v9
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v21, v[10:11]
; GISEL-NEXT:    v_mul_lo_u32 v23, v21, v9
; GISEL-NEXT:    v_mul_hi_u32 v24, v21, v9
; GISEL-NEXT:    v_sub_i32_e32 v5, vcc, v15, v5
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v20, v18, v[0:1]
...
; GISEL-NEXT:    v_mul_lo_u32 v7, v21, v9
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v24, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v19, v15, 0
; GISEL-NEXT:    v_addc_u32_e32 v7, vcc, v21, v7, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v12, v5, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v14, v0, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr11
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v7, v[10:11]
; GISEL-NEXT:    v_ashrrev_i32_e32 v13, 31, v3
; GISEL-NEXT:    v_xor_b32_e32 v5, v5, v4
; GISEL-NEXT:    v_xor_b32_e32 v12, v12, v4
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v20, v15, v[0:1]
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v2, v13
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v3, v13, vcc
; GISEL-NEXT:    v_mul_hi_u32 v2, v15, v9
...
; GISEL-NEXT:    v_xor_b32_e32 v15, v1, v13
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v3, v14, v2
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v7, v1
; GISEL-NEXT:    v_mul_lo_u32 v7, v15, v2
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v7
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v0, v1
; GISEL-NEXT:    v_mul_hi_u32 v1, v15, v2
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v6, v7, 0
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
...
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v8, v7, v[2:3]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v14, v9
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v15, v4, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v18, v4, v11
...
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v17, v4, v[13:14]
; CGP-NEXT:    v_mul_hi_u32 v12, v4, v10
; CGP-NEXT:    v_xor_b32_e32 v14, v8, v16
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, v15, v10, vcc
; CGP-NEXT:    v_mul_hi_u32 v10, v14, v4
; CGP-NEXT:    v_mul_lo_u32 v11, v14, v8
; CGP-NEXT:    v_xor_b32_e32 v13, v9, v16
...
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v12, v10
; CGP-NEXT:    ; implicit-def: $vgpr10
...
; CGP-NEXT:    v_subb_u32_e64 v8, s[4:5], v13, v9, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v15, v4, v9
; CGP-NEXT:    v_mul_lo_u32 v16, v6, v9
...
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v4, v[11:12]
; CGP-NEXT:    v_mul_hi_u32 v10, v4, v8
; CGP-NEXT:    v_xor_b32_e32 v12, v5, v13
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v10, v5
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v10, v4, v9
...
; CGP-NEXT:    v_xor_b32_e32 v9, v7, v13
...
; GISEL-NEXT:    v_mul_hi_u32 v4, v5, v7
...
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v13, v6, vcc
...
; GISEL-NEXT:    v_mac_f32_e32 v7, 0x4f800000, v10
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v10, v7
; GISEL-NEXT:    ; implicit-def: $vgpr6
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, 0, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v1, v9, v[5:6]
; GISEL-NEXT:    v_mul_f32_e32 v5, 0x5f7ffffc, v10
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v13, v[6:7]
; GISEL-NEXT:    v_mul_hi_u32 v4, v12, v5
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v15, v12, v[10:11]
; GISEL-NEXT:    v_mul_lo_u32 v10, v13, v5
; GISEL-NEXT:    v_sub_i32_e64 v7, s[4:5], 0, v9
...
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v4, s[4:5], v4, v10
...
; GISEL-NEXT:    v_subbrev_u32_e32 v12, vcc, 0, v7, vcc
; GISEL-NEXT:    ; implicit-def: $vgpr6
...
; GISEL-NEXT:    v_cndmask_b32_e32 v6, -1, v14, vcc
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v13, v1
; GISEL-NEXT:    v_subbrev_u32_e32 v14, vcc, 0, v12, vcc
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v7, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v4, v11, v4
; GISEL-NEXT:    v_mul_hi_u32 v15, v10, v5
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v3, v11, v[5:6]
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v16, v12, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], 0, v10, v[7:8]
