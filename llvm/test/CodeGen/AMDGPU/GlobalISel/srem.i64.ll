...
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, v3, v1, vcc
; CHECK-NEXT:    v_xor_b32_e32 v0, v0, v1
; CHECK-NEXT:    v_xor_b32_e32 v1, v3, v1
; CHECK-NEXT:    v_cvt_f32_u32_e32 v3, v0
; CHECK-NEXT:    v_cvt_f32_u32_e32 v7, v1
; CHECK-NEXT:    v_sub_i32_e32 v14, vcc, 0, v0
; CHECK-NEXT:    v_subb_u32_e32 v15, vcc, 0, v1, vcc
; CHECK-NEXT:    v_mac_f32_e32 v3, 0x4f800000, v7
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; CHECK-NEXT:    v_mul_f32_e32 v3, 0x5f7ffffc, v3
; CHECK-NEXT:    v_mul_f32_e32 v7, 0x2f800000, v3
; CHECK-NEXT:    v_trunc_f32_e32 v7, v7
; CHECK-NEXT:    v_mac_f32_e32 v3, 0xcf800000, v7
; CHECK-NEXT:    v_cvt_u32_f32_e32 v3, v3
; CHECK-NEXT:    v_cvt_u32_f32_e32 v13, v7
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v14, v3, 0
; CHECK-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v13, v[8:9]
; CHECK-NEXT:    v_mul_hi_u32 v8, v3, v7
; CHECK-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v15, v3, v[9:10]
; CHECK-NEXT:    v_mul_lo_u32 v9, v13, v7
; CHECK-NEXT:    v_mul_hi_u32 v7, v13, v7
; CHECK-NEXT:    v_mul_lo_u32 v10, v3, v11
; CHECK-NEXT:    v_mul_hi_u32 v12, v3, v11
; CHECK-NEXT:    v_mul_lo_u32 v16, v13, v11
...
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, v7, v16
; CHECK-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
...
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v4, v14
; CHECK-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v15, v3, v[9:10]
; CHECK-NEXT:    v_mul_hi_u32 v9, v3, v7
; CHECK-NEXT:    v_xor_b32_e32 v15, v8, v14
; CHECK-NEXT:    v_mul_lo_u32 v8, v13, v7
; CHECK-NEXT:    v_mul_lo_u32 v10, v3, v11
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, v5, v14, vcc
; CHECK-NEXT:    v_mul_hi_u32 v7, v13, v7
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CHECK-NEXT:    v_mul_hi_u32 v9, v3, v11
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v10, v8
...
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v10, v8
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v7
; CHECK-NEXT:    v_addc_u32_e32 v7, vcc, v13, v8, vcc
; CHECK-NEXT:    v_mul_hi_u32 v8, v15, v3
; CHECK-NEXT:    v_mul_lo_u32 v9, v15, v7
; CHECK-NEXT:    v_xor_b32_e32 v5, v5, v14
...
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v8, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CHECK-NEXT:    v_mul_hi_u32 v10, v15, v7
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
...
; CHECK-NEXT:    v_mul_hi_u32 v11, v5, v7
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v0, v3, 0
; CHECK-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v11, v9
; CHECK-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v0, v11, v[8:9]
; CHECK-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v3, v[9:10]
; CHECK-NEXT:    v_sub_i32_e32 v3, vcc, v15, v7
; CHECK-NEXT:    v_subb_u32_e64 v7, s[4:5], v5, v11, vcc
; CHECK-NEXT:    v_sub_i32_e64 v5, s[4:5], v5, v11
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v0
...
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, v3, v0
; CHECK-NEXT:    v_subbrev_u32_e64 v10, s[4:5], 0, v5, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v10, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v10, v1
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v5, v1, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v5, v1, vcc
; CGP-NEXT:    v_xor_b32_e32 v0, v0, v1
; CGP-NEXT:    v_xor_b32_e32 v1, v3, v1
; CGP-NEXT:    v_cvt_f32_u32_e32 v3, v0
; CGP-NEXT:    v_cvt_f32_u32_e32 v5, v1
; CGP-NEXT:    v_sub_i32_e32 v18, vcc, 0, v0
; CGP-NEXT:    v_subb_u32_e32 v19, vcc, 0, v1, vcc
; CGP-NEXT:    v_mac_f32_e32 v3, 0x4f800000, v5
; CGP-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; CGP-NEXT:    v_mul_f32_e32 v3, 0x5f7ffffc, v3
; CGP-NEXT:    v_mul_f32_e32 v5, 0x2f800000, v3
; CGP-NEXT:    v_trunc_f32_e32 v5, v5
; CGP-NEXT:    v_mac_f32_e32 v3, 0xcf800000, v5
; CGP-NEXT:    v_cvt_u32_f32_e32 v3, v3
; CGP-NEXT:    v_cvt_u32_f32_e32 v5, v5
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v3, 0
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v18, v5, v[13:14]
; CGP-NEXT:    v_mul_hi_u32 v13, v3, v12
; CGP-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v19, v3, v[14:15]
; CGP-NEXT:    v_mul_lo_u32 v14, v5, v12
; CGP-NEXT:    v_mul_hi_u32 v12, v5, v12
; CGP-NEXT:    v_mul_lo_u32 v15, v3, v16
; CGP-NEXT:    v_mul_hi_u32 v17, v3, v16
; CGP-NEXT:    v_mul_lo_u32 v20, v5, v16
...
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v10, v18
; CGP-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v19, v3, v[14:15]
; CGP-NEXT:    v_mul_hi_u32 v14, v3, v12
; CGP-NEXT:    v_xor_b32_e32 v17, v13, v18
; CGP-NEXT:    v_mul_lo_u32 v13, v5, v12
; CGP-NEXT:    v_mul_lo_u32 v15, v3, v16
; CGP-NEXT:    v_addc_u32_e32 v11, vcc, v11, v18, vcc
; CGP-NEXT:    v_mul_hi_u32 v12, v5, v12
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v14, v15
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v14, v3, v16
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v15, v13
...
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v12
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v5, v13, vcc
; CGP-NEXT:    v_mul_hi_u32 v12, v17, v3
; CGP-NEXT:    v_mul_lo_u32 v13, v17, v5
; CGP-NEXT:    v_xor_b32_e32 v19, v11, v18
; CGP-NEXT:    v_mul_lo_u32 v11, v19, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v19, v3
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v12, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v12, v17, v5
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v13, v11
; CGP-NEXT:    v_mul_lo_u32 v13, v19, v5
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v12
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v13
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v12, v13
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v11
; CGP-NEXT:    v_mul_hi_u32 v5, v19, v5
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v0, v3, 0
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v13
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v0, v5, v[12:13]
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v1, v3, v[13:14]
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v17, v11
; CGP-NEXT:    v_subb_u32_e64 v5, s[4:5], v19, v15, vcc
; CGP-NEXT:    v_sub_i32_e64 v11, s[4:5], v19, v15
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v5, v1
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v0
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v5, v1
; CGP-NEXT:    v_subb_u32_e32 v11, vcc, v11, v1, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v12, v12, v13, s[4:5]
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v3, v0
; CGP-NEXT:    v_subbrev_u32_e64 v14, s[4:5], 0, v11, vcc
...
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v11, v1, vcc
...
; CGP-NEXT:    v_xor_b32_e32 v0, v0, v18
; CGP-NEXT:    v_xor_b32_e32 v1, v1, v18
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v0, v18
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v1, v18, vcc
; CGP-NEXT:  .LBB2_2:
...
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v7, v3, vcc
; CGP-NEXT:    v_xor_b32_e32 v2, v2, v3
; CGP-NEXT:    v_xor_b32_e32 v3, v5, v3
; CGP-NEXT:    v_cvt_f32_u32_e32 v5, v2
; CGP-NEXT:    v_cvt_f32_u32_e32 v7, v3
; CGP-NEXT:    v_sub_i32_e32 v16, vcc, 0, v2
; CGP-NEXT:    v_subb_u32_e32 v17, vcc, 0, v3, vcc
; CGP-NEXT:    v_mac_f32_e32 v5, 0x4f800000, v7
...
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v5, 0
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v7, v[11:12]
; CGP-NEXT:    v_mul_hi_u32 v11, v5, v10
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v17, v5, v[12:13]
; CGP-NEXT:    v_mul_lo_u32 v12, v7, v10
; CGP-NEXT:    v_mul_hi_u32 v10, v7, v10
; CGP-NEXT:    v_mul_lo_u32 v13, v5, v14
; CGP-NEXT:    v_mul_hi_u32 v15, v5, v14
...
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v18
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; CGP-NEXT:    v_mul_hi_u32 v13, v7, v14
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v8, v16
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v17, v5, v[12:13]
; CGP-NEXT:    v_mul_hi_u32 v12, v5, v10
; CGP-NEXT:    v_xor_b32_e32 v15, v11, v16
; CGP-NEXT:    v_mul_lo_u32 v11, v7, v10
; CGP-NEXT:    v_mul_lo_u32 v13, v5, v14
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v12, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v12, v5, v14
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v13, v11
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v10
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, v7, v11, vcc
; CGP-NEXT:    v_mul_hi_u32 v10, v15, v5
; CGP-NEXT:    v_mul_lo_u32 v11, v15, v7
; CGP-NEXT:    v_xor_b32_e32 v17, v9, v16
; CGP-NEXT:    v_mul_lo_u32 v9, v17, v5
; CGP-NEXT:    v_mul_hi_u32 v5, v17, v5
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v10, v15, v7
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
; CGP-NEXT:    v_mul_lo_u32 v11, v17, v7
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v10, v11
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v9
; CGP-NEXT:    v_mul_hi_u32 v7, v17, v7
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v2, v5, 0
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v7, v11
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v2, v7, v[10:11]
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v3, v5, v[11:12]
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, v15, v9
; CGP-NEXT:    v_subb_u32_e64 v7, s[4:5], v17, v13, vcc
; CGP-NEXT:    v_sub_i32_e64 v9, s[4:5], v17, v13
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v3
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v5, v2
...
; CGP-NEXT:    v_xor_b32_e32 v2, v2, v16
; CGP-NEXT:    v_xor_b32_e32 v3, v3, v16
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v2, v16
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v3, v16, vcc
; CGP-NEXT:  .LBB2_6:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; CGP-NEXT:    s_mov_b64 exec, s[6:7]
...
; CHECK-NEXT:  .LBB7_1:
; CHECK-NEXT:    v_ashrrev_i32_e32 v1, 31, v8
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v7, v1
; CHECK-NEXT:    v_addc_u32_e32 v2, vcc, v8, v1, vcc
; CHECK-NEXT:    v_xor_b32_e32 v0, v0, v1
...
; CHECK-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v14, v2, 0
; CHECK-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v6, v[9:10]
; CHECK-NEXT:    v_mul_hi_u32 v9, v2, v8
; CHECK-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v2, v[10:11]
; CHECK-NEXT:    v_mul_lo_u32 v10, v6, v8
; CHECK-NEXT:    v_mul_hi_u32 v8, v6, v8
; CHECK-NEXT:    v_mul_lo_u32 v11, v2, v12
; CHECK-NEXT:    v_mul_hi_u32 v13, v2, v12
; CHECK-NEXT:    v_mul_lo_u32 v16, v6, v12
...
; CHECK-NEXT:    v_mul_hi_u32 v11, v6, v12
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v8
; CHECK-NEXT:    v_addc_u32_e32 v6, vcc, v6, v9, vcc
; CHECK-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v14, v2, 0
; CHECK-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v6, v[9:10]
; CHECK-NEXT:    v_ashrrev_i32_e32 v14, 31, v4
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v3, v14
; CHECK-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v2, v[10:11]
; CHECK-NEXT:    v_mul_hi_u32 v10, v2, v8
; CHECK-NEXT:    v_xor_b32_e32 v15, v9, v14
...
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CHECK-NEXT:    v_mul_hi_u32 v10, v2, v12
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
...
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v8
; CHECK-NEXT:    v_addc_u32_e32 v6, vcc, v6, v9, vcc
; CHECK-NEXT:    v_mul_hi_u32 v8, v15, v2
; CHECK-NEXT:    v_mul_lo_u32 v9, v15, v6
; CHECK-NEXT:    v_xor_b32_e32 v4, v4, v14
...
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v10, vcc, v10, v9
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v8
; CHECK-NEXT:    v_mul_hi_u32 v6, v4, v6
; CHECK-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v0, v2, 0
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v6, v10
; CHECK-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v0, v6, v[9:10]
; CHECK-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v1, v2, v[10:11]
; CHECK-NEXT:    v_sub_i32_e32 v2, vcc, v15, v8
; CHECK-NEXT:    v_subb_u32_e64 v6, s[4:5], v4, v12, vcc
; CHECK-NEXT:    v_sub_i32_e64 v4, s[4:5], v4, v12
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v6, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v6, v1
; CHECK-NEXT:    v_subb_u32_e32 v4, vcc, v4, v1, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v8, v8, v9, s[4:5]
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, v2, v0
; CHECK-NEXT:    v_subbrev_u32_e64 v10, s[4:5], 0, v4, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v10, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
...
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v13, v1, vcc
; CGP-NEXT:    v_xor_b32_e32 v0, v0, v1
; CGP-NEXT:    v_xor_b32_e32 v1, v3, v1
; CGP-NEXT:    v_cvt_f32_u32_e32 v3, v0
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v17, v3
; CGP-NEXT:    v_cvt_u32_f32_e32 v6, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v18, v17, 0
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v18, v6, v[4:5]
; CGP-NEXT:    v_mul_hi_u32 v4, v17, v3
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v19, v17, v[13:14]
; CGP-NEXT:    v_mul_lo_u32 v13, v6, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v6, v3
; CGP-NEXT:    v_mul_lo_u32 v14, v17, v15
; CGP-NEXT:    v_mul_hi_u32 v16, v17, v15
; CGP-NEXT:    v_mul_lo_u32 v20, v6, v15
...
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v20
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; CGP-NEXT:    v_mul_hi_u32 v14, v6, v15
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v13, v4
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v14, v4
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v17, v3
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v6, v4, vcc
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v18, v17, 0
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v18, v6, v[4:5]
; CGP-NEXT:    v_ashrrev_i32_e32 v18, 31, v9
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v8, v18
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v19, v17, v[13:14]
; CGP-NEXT:    v_mul_hi_u32 v13, v17, v3
; CGP-NEXT:    v_xor_b32_e32 v19, v4, v18
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v13, v4
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v13, v17, v15
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v14, v4
...
; CGP-NEXT:    v_mul_hi_u32 v6, v19, v3
; CGP-NEXT:    v_mul_lo_u32 v13, v19, v4
...
; CGP-NEXT:    v_mul_hi_u32 v14, v19, v4
...
; CGP-NEXT:    v_mul_hi_u32 v15, v9, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v0, v6, 0
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v15, v13
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v0, v15, v[4:5]
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v19, v3
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v1, v6, v[13:14]
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v9, v15, vcc
; CGP-NEXT:    v_sub_i32_e64 v6, s[4:5], v9, v15
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v1
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v0
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v4, v1
; CGP-NEXT:    v_subb_u32_e32 v6, vcc, v6, v1, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v9, v9, v13, s[4:5]
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v3, v0
; CGP-NEXT:    v_subbrev_u32_e64 v14, s[4:5], 0, v6, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v14, v1
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v13, v0
; CGP-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v14, v1
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v6, v1, vcc
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v13, v0
; CGP-NEXT:    v_cndmask_b32_e64 v15, v15, v16, s[4:5]
; CGP-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v15
...
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v9, v4, 0
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v9, v6, v[12:13]
; CGP-NEXT:    v_mul_hi_u32 v12, v4, v11
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v17, v4, v[13:14]
; CGP-NEXT:    v_mul_lo_u32 v13, v6, v11
; CGP-NEXT:    v_mul_hi_u32 v11, v6, v11
; CGP-NEXT:    v_mul_lo_u32 v14, v4, v15
; CGP-NEXT:    v_mul_hi_u32 v16, v4, v15
; CGP-NEXT:    v_mul_lo_u32 v18, v6, v15
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v14
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v6, v12, vcc
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v9, v4, 0
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v9, v6, v[12:13]
; CGP-NEXT:    v_ashrrev_i32_e32 v9, 31, v7
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v5, v9
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v17, v4, v[13:14]
; CGP-NEXT:    v_mul_hi_u32 v13, v4, v11
; CGP-NEXT:    v_xor_b32_e32 v16, v12, v9
...
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v13, v12
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v13, v4, v15
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v14, v12
; CGP-NEXT:    v_mul_lo_u32 v14, v6, v15
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v11, v13
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v11
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v6, v12, vcc
; CGP-NEXT:    v_mul_hi_u32 v11, v16, v4
; CGP-NEXT:    v_mul_lo_u32 v12, v16, v6
; CGP-NEXT:    v_xor_b32_e32 v15, v7, v9
; CGP-NEXT:    v_mul_lo_u32 v7, v15, v4
...
; CGP-NEXT:    v_mul_lo_u32 v12, v15, v6
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v13, v15, v6
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v2, v4, 0
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v11
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v2, v13, v[7:8]
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v3, v4, v[11:12]
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v16, v6
; CGP-NEXT:    v_subb_u32_e64 v6, s[4:5], v15, v13, vcc
; CGP-NEXT:    v_sub_i32_e64 v7, s[4:5], v15, v13
...
; CGP-NEXT:    v_subbrev_u32_e64 v13, s[4:5], 0, v7, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v13, v3
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v12, v2
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v13, v3
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v7, v3, vcc
