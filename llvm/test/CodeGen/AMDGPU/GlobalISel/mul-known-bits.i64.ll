...
; RUN:  llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel=1 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX10 %s
; RUN:  llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -global-isel=1 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX11 %s
