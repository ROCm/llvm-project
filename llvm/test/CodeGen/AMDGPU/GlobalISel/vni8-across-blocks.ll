...
; GFX906-NEXT:    global_load_dword v5, v2, s[0:1]
; GFX906-NEXT:    v_cmp_le_u32_e32 vcc, 15, v0
; GFX906-NEXT:    v_mov_b32_e32 v1, 0xff
; GFX906-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX906-NEXT:    s_waitcnt vmcnt(0)
; GFX906-NEXT:    v_and_b32_e32 v0, 0xff, v5
; GFX906-NEXT:    v_lshlrev_b32_sdwa v6, v3, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_1
; GFX906-NEXT:    v_lshlrev_b32_sdwa v5, v4, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_2
; GFX906-NEXT:    v_or3_b32 v0, v0, v6, v5
; GFX906-NEXT:    s_mov_b64 exec, s[0:1]
; GFX906-NEXT:    ; divergent control-flow edge
...
; GFX906-NEXT:    s_or_b64 exec, exec, vcc
...
; GFX906-NEXT:    v_and_b32_sdwa v0, v0, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX906-NEXT:    v_or_b32_sdwa v0, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
; GFX906-NEXT:    s_xor_b64 exec, vcc, exec
; GFX906-NEXT:    ; divergent control-flow edge
; GFX906-NEXT:    s_cbranch_execz .LBB1_2
; GFX906-NEXT:  .LBB1_1: ; %bb.1
...
; GFX906-NEXT:    v_cmp_le_u32_e32 vcc, 15, v0
; GFX906-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX906-NEXT:    s_waitcnt vmcnt(0)
...
; GFX906-NEXT:    ; implicit-def: $vgpr1
; GFX906-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX906-NEXT:    v_lshlrev_b32_e32 v3, 3, v0
; GFX906-NEXT:    v_cmp_le_u32_e64 s[0:1], 15, v0
; GFX906-NEXT:    s_xor_b64 s[4:5], s[0:1], exec
; GFX906-NEXT:    s_mov_b64 s[2:3], s[0:1]
; GFX906-NEXT:    s_waitcnt lgkmcnt(0)
; GFX906-NEXT:    global_load_dwordx2 v[1:2], v3, s[8:9]
; GFX906-NEXT:    s_mov_b64 exec, s[4:5]
; GFX906-NEXT:    ; divergent control-flow edge
; GFX906-NEXT:    s_cbranch_execz .LBB8_2
; GFX906-NEXT:  .LBB8_1: ; %bb.1
; GFX906-NEXT:    global_load_dwordx2 v[1:2], v3, s[10:11]
; GFX906-NEXT:    v_cmp_le_u32_e32 vcc, 7, v0
; GFX906-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX906-NEXT:    s_or_b64 s[2:3], s[0:1], s[2:3]
; GFX906-NEXT:  .LBB8_2:
; GFX906-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX906-NEXT:    s_xor_b64 s[0:1], exec, s[2:3]
; GFX906-NEXT:    s_mov_b64 exec, s[2:3]
; GFX906-NEXT:    ; divergent control-flow edge
; GFX906-NEXT:    s_cbranch_execz .LBB8_4
; GFX906-NEXT:  .LBB8_3: ; %bb.2
; GFX906-NEXT:    v_mov_b32_e32 v0, 0
; GFX906-NEXT:    s_waitcnt vmcnt(0)
...
; GFX906-NEXT:    v_cmp_le_u32_e64 s[0:1], 15, v0
; GFX906-NEXT:    s_xor_b64 s[2:3], s[0:1], exec
; GFX906-NEXT:    s_waitcnt lgkmcnt(0)
