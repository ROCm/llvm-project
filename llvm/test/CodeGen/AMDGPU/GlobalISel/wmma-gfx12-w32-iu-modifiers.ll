...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.70 < %s | FileCheck %s --check-prefixes=GCN,GFX1170
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.00 < %s | FileCheck %s --check-prefixes=GCN,GFX12
