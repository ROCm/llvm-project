...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10-amd-amdpal < %s | FileCheck --check-prefix=GFX10_W32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10-amd-amdpal -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GFX10_W64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00-amd-amdpal -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11_W32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00-amd-amdpal -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefixes=GFX11_W64 %s
...
; GFX10_W32-NEXT:    v_lshlrev_b32_e32 v1, 2, v0
; GFX10_W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX10_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W32-NEXT:    global_load_dwordx3 v[1:3], v1, s[0:1]
; GFX10_W32-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10_W32-NEXT:    s_mov_b32 s0, 0
; GFX10_W32-NEXT:    s_cmp_lg_u32 s0, 0
; GFX10_W32-NEXT:    s_cselect_b32 s0, -1, 0
; GFX10_W32-NEXT:    v_mov_b32_e32 v0, s0
; GFX10_W32-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
; GFX10_W32-NEXT:    ; divergent control-flow edge
; GFX10_W32-NEXT:    s_cbranch_execz .LBB13_2
; GFX10_W32-NEXT:  .LBB13_1: ; %bb
; GFX10_W32-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x50
; GFX10_W32-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10_W32-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
; GFX10_W32-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX10_W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX10_W32-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10_W64-NEXT:    s_or_b64 exec, exec, vcc
; GFX10_W64-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX10_W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX10_W64-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11_W32-NEXT:    s_mov_b32 s0, 0
; GFX11_W32-NEXT:    s_cmp_lg_u32 s0, 0
; GFX11_W32-NEXT:    s_cselect_b32 s0, -1, 0
; GFX11_W32-NEXT:    v_mov_b32_e32 v3, s0
; GFX11_W32-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
; GFX11_W32-NEXT:    ; divergent control-flow edge
; GFX11_W32-NEXT:    s_cbranch_execz .LBB13_2
; GFX11_W32-NEXT:  .LBB13_1: ; %bb
; GFX11_W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x50
; GFX11_W32-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11_W32-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
; GFX11_W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX11_W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v3
; GFX11_W32-NEXT:    s_waitcnt vmcnt(0)
; GFX11_W32-NEXT:    v_div_fmas_f32 v0, v0, v1, v2
...
; GFX11_W64-NEXT:    s_mov_b32 s0, 0
; GFX11_W64-NEXT:    s_cmp_lg_u32 s0, 0
; GFX11_W64-NEXT:    s_cselect_b32 s0, -1, 0
; GFX11_W64-NEXT:    v_mov_b32_e32 v3, s0
; GFX11_W64-NEXT:    s_xor_b64 exec, vcc, exec
; GFX11_W64-NEXT:    ; divergent control-flow edge
; GFX11_W64-NEXT:    s_cbranch_execz .LBB13_2
; GFX11_W64-NEXT:  .LBB13_1: ; %bb
...
; GFX11_W64-NEXT:    s_or_b64 exec, exec, vcc
; GFX11_W64-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX11_W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; GFX11_W64-NEXT:    s_waitcnt vmcnt(0)
; GFX11_W64-NEXT:    v_div_fmas_f32 v0, v0, v1, v2
