...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1010 -global-isel < %s | FileCheck %s --check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1200 -global-isel < %s | FileCheck %s --check-prefix=GFX12
