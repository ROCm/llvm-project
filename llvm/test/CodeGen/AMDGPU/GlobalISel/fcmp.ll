...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel < %s | FileCheck %s --check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.00 -global-isel < %s | FileCheck %s --check-prefix=GFX12
