...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1010 -global-isel -global-isel-abort=2 < %s | FileCheck %s --check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1200 -global-isel -global-isel-abort=2 < %s | FileCheck %s --check-prefix=GFX12
