...
; XFAIL: *
; Structurizer-only intrinsic; LWT never lowers SI_END_CF.
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.00--amdhsa < %s | FileCheck -check-prefix=GCN %s
