...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -O0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=WAVE64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -O0 -mtriple=amdgpu10.31-amd-amdhsa < %s | FileCheck -check-prefix=WAVE32 %s
