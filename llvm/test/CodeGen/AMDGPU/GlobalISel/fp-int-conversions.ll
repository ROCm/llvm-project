...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu10.10 < %s | FileCheck %s --check-prefixes=GCN,FAKE16,PREGFX12,PREGFX12-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=GCN,PREGFX12,TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck %s --check-prefixes=GCN,FAKE16,PREGFX12,PREGFX12-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu12.00 < %s | FileCheck %s --check-prefixes=GCN,FAKE16,GFX12
...
define amdgpu_ps float @fptosi_v4f32_to_v4i8_bitcast_f32(<4 x float> %v) {
; TRUE16-LABEL: fptosi_v4f32_to_v4i8_bitcast_f32:
; TRUE16:  ; %bb.0:
; TRUE16:    v_cvt_i32_f32_e32 v1, v1
; TRUE16:    v_cvt_i32_f32_e32 v2, v2
; TRUE16:    v_cvt_i32_f32_e32 v3, v3
; TRUE16:    v_cvt_i32_f32_e32 v0, v0
; TRUE16:    v_and_b32_e32 v1, 0xff, v1
; TRUE16:    v_and_b32_e32 v2, 0xff, v2
...
;
; GFX12-LABEL: fptosi_v4f32_to_v4i8_bitcast_f32:
; GFX12:  ; %bb.0:
; GFX12:    v_cvt_i32_f32_e32 v1, v1
; GFX12:    v_cvt_i32_f32_e32 v2, v2
; GFX12:    v_cvt_i32_f32_e32 v3, v3
; GFX12:    v_cvt_i32_f32_e32 v0, v0
; GFX12:    v_and_b32_e32 v1, 0xff, v1
; GFX12:    v_and_b32_e32 v2, 0xff, v2
...
; GFX12:    ; return to shader part epilog
  %cvt = fptosi <4 x float> %v to <4 x i8>
