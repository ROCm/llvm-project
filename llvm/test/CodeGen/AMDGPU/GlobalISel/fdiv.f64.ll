...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu6.00 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GCN,GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu6.00 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GCN,GFX6 %s

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu8.03 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GCN,GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu8.03 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GCN,GFX8 %s

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.00 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GCN,GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.00 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GCN,GFX9 %s

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.10 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.10 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX10 %s

; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.00 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu11.00 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX11 %s
