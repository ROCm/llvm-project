...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu8.03-amd-amdpal -o - < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.00-amd-amdpal -o - < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu10.10-amd-amdpal -o - < %s | FileCheck --check-prefixes=GCN %s
