...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -new-reg-bank-select -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -new-reg-bank-select -mtriple=amdgcn-amd-amdpal -mcpu=fiji < %s | FileCheck --check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -new-reg-bank-select -mtriple=amdgcn-amd-amdpal -mcpu=tahiti < %s | FileCheck --check-prefix=GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -new-reg-bank-select -mtriple=amdgcn-amd-amdpal -mcpu=gfx1010 < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -new-reg-bank-select -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %load = load i1, ptr addrspace(1) %ptr
  %ext = zext i1 %load to i32
  ret i32 %ext
}

define i32 @zextload_global_i8_to_i32(ptr addrspace(1) %ptr) {
...
define i32 @zextload_global_i16_to_i32(ptr addrspace(1) %ptr) {
...
define i64 @zextload_global_i1_to_i64(ptr addrspace(1) %ptr) {
...
define i64 @zextload_global_i8_to_i64(ptr addrspace(1) %ptr) {
...
define i64 @zextload_global_i16_to_i64(ptr addrspace(1) %ptr) {
...
define i64 @zextload_global_i32_to_i64(ptr addrspace(1) %ptr) {
...
define i96 @zextload_global_i32_to_i96(ptr addrspace(1) %ptr) {
...
define i128 @zextload_global_i32_to_i128(ptr addrspace(1) %ptr) {
