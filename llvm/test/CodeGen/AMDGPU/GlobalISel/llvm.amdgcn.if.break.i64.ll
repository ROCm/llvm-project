...
; Structurizer-only intrinsic; so this test will never run for LWT pipeline.
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu7.01--amdhsa < %s | FileCheck -check-prefix=GCN %s
