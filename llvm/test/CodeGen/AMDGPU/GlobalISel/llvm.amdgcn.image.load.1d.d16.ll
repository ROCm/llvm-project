...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.02-mesa-mesa3d < %s | FileCheck -check-prefix=GFX8-UNPACKED %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu8.10-mesa-mesa3d < %s | FileCheck -check-prefix=GFX8-PACKED %s
