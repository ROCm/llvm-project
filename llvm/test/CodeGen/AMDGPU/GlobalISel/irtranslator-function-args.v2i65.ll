...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgcn -mcpu=fiji -stop-after=irtranslator -o - %s | FileCheck %s
...
define void @void_func_v2i65(<2 x i65> %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[TRUNC:%[0-9]+]]:_(i65) = G_TRUNC [[MV]](s96)
  ; CHECK-NEXT:   [[MV1:%[0-9]+]]:_(s96) = G_MERGE_VALUES [[COPY3]](i32), [[COPY4]](i32), [[COPY5]](i32)
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i65) = G_TRUNC [[MV1]](s96)
  ; CHECK-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<2 x i65>) = G_BUILD_VECTOR [[TRUNC]](i65), [[TRUNC1]](i65)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   G_STORE [[BUILD_VECTOR]](<2 x i65>), [[DEF]](p1) :: (store (<2 x i65>) into `ptr addrspace(1) poison`, align 32, addrspace 1)
