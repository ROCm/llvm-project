...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -amdgpu-enable-remove-incompatible-functions=0 -mtriple=amdgpu7.00-amd-amdhsa -stop-after=legalizer -o - %s | FileCheck %s
