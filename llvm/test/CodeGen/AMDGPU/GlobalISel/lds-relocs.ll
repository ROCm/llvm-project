; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.00-mesa-mesa3d -amdgpu-enable-lower-module-lds=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GCN %s
