...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -stop-after=amdgpu-regbanklegalize -regbankselect-fast -o - %s | FileCheck -check-prefix=FAST %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -stop-after=amdgpu-regbanklegalize -regbankselect-greedy -o - %s | FileCheck -check-prefix=GREEDY %s
