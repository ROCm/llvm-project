...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -stop-after=amdgpu-reg-bank-legalize -regbankselect-fast -o - %s | FileCheck -check-prefix=FAST %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -stop-after=amdgpu-reg-bank-legalize -regbankselect-greedy -o - %s | FileCheck -check-prefix=GREEDY %s
