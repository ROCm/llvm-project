...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -o - %s | FileCheck -check-prefix=CHECK %s

define amdgpu_cs void @max_8_vgprs(ptr addrspace(1) %p) "amdgpu-num-vgpr"="8" nounwind {
; CHECK-LABEL: max_8_vgprs:
; CHECK:       ; %bb.0:
...
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    scratch_load_b32 v0, off, off ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_cs void @max_13_vgprs_branch(ptr addrspace(1) %p, i32 %tmp) "amdgpu-num-vgpr"="13" nounwind {
; CHECK-LABEL: max_13_vgprs_branch:
; CHECK:       ; %bb.0: ; %.entry
...
; CHECK-NEXT:    global_load_b32 v2, v[0:1], off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    scratch_store_b32 off, v2, off offset:40 ; 4-byte Folded Spill
; CHECK-NEXT:    global_load_b32 v2, v[0:1], off offset:16 scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    scratch_store_b32 off, v2, off offset:44 ; 4-byte Folded Spill
; CHECK-NEXT:    global_load_b32 v2, v[0:1], off offset:48 scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    scratch_store_b32 off, v2, off offset:48 ; 4-byte Folded Spill
; CHECK-NEXT:    global_load_b32 v2, v[0:1], off offset:96 scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    scratch_store_b32 off, v2, off offset:52 ; 4-byte Folded Spill
; CHECK-NEXT:    global_load_b32 v2, v[0:1], off offset:160 scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    scratch_store_b32 off, v2, off offset:56 ; 4-byte Folded Spill
; CHECK-NEXT:    global_load_b32 v0, v[0:1], off offset:240 scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    scratch_store_b32 off, v0, off offset:60 ; 4-byte Folded Spill
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:40 ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:44 ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:48 ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:52 ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:56 ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:60 ; 4-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x0
; CHECK-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; CHECK-NEXT:    s_wait_storecnt 0x0
; CHECK-NEXT:    scratch_load_b32 v0, off, off offset:12 ; 4-byte Folded Reload
...
; CHECK-NEXT:    scratch_load_b128 v[0:3], off, s33 offset:276
; CHECK-NEXT:    scratch_load_b128 v[4:7], off, s33 offset:292
; CHECK-NEXT:    scratch_load_b128 v[8:11], off, s33 offset:308
; CHECK-NEXT:    scratch_load_b128 v[12:15], off, s33 offset:324
; CHECK-NEXT:    scratch_load_b128 v[16:19], off, s33 offset:340
; CHECK-NEXT:    scratch_load_b128 v[20:23], off, s33 offset:356
; CHECK-NEXT:    scratch_load_b128 v[24:27], off, s33 offset:372
; CHECK-NEXT:    scratch_load_b128 v[28:31], off, s33 offset:388
; CHECK-NEXT:    s_getpc_b64 s[0:1]
; CHECK-NEXT:    s_wait_alu depctr_sa_sdst(0)
; CHECK-NEXT:    s_sext_i32_i16 s1, s1
...
; CHECK-NEXT:    s_wait_loadcnt 0x2
; CHECK-NEXT:    scratch_load_b128 v[19:22], off, s33 offset:148 ; 16-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x2
; CHECK-NEXT:    scratch_load_b128 v[23:26], off, s33 offset:164 ; 16-byte Folded Reload
; CHECK-NEXT:    s_wait_loadcnt 0x2
; CHECK-NEXT:    s_clause 0x5 ; 96-byte Folded Reload
; CHECK-NEXT:    scratch_load_b128 v[27:30], off, s33 offset:180
; CHECK-NEXT:    scratch_load_b128 v[31:34], off, s33 offset:196
; CHECK-NEXT:    scratch_load_b128 v[35:38], off, s33 offset:212
; CHECK-NEXT:    scratch_load_b128 v[39:42], off, s33 offset:228
; CHECK-NEXT:    scratch_load_b128 v[43:46], off, s33 offset:244
; CHECK-NEXT:    scratch_load_b128 v[47:50], off, s33 offset:260
