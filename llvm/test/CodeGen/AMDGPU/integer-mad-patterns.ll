...
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v2, v1, v2
; GFX6-GISEL-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; GFX6-GISEL-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GFX6-GISEL-NEXT:    v_add_i32_e32 v3, vcc, 1, v0
; GFX6-GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v1, vcc
; GFX6-GISEL-NEXT:    v_mul_hi_u32 v1, v5, v3
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v4, v5, v0
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v2, v2, v3
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v0, v5, v3
...
; GFX90A-GISEL-NEXT:    v_add_u32_e32 v5, v5, v8
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v8, vcc, 1, v0
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v1, vcc
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v6, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v5, v8, v[0:1]
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v8, 0
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v7, vcc, 1, v4
; GFX90A-GISEL-NEXT:    v_add_u32_e32 v6, v3, v6
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v5, vcc
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v3, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v7, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v6, v7, v[4:5]
...
; GFX6-SDAG-NEXT:    v_mul_hi_u32 v10, v0, v4
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v1, v1, v4
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v12, v2, v6
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v0, v0, v4
; GFX6-SDAG-NEXT:    v_add_i32_e32 v5, vcc, v10, v5
; GFX6-SDAG-NEXT:    v_add_i32_e32 v1, vcc, v5, v1
; GFX6-SDAG-NEXT:    v_add_i32_e32 v2, vcc, v12, v2
...
; GFX6-SDAG-NEXT:    v_mul_hi_u32 v6, v2, v12
; GFX6-SDAG-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; GFX6-SDAG-NEXT:    v_mul_hi_u32 v7, v0, v11
; GFX6-SDAG-NEXT:    v_add_i32_e32 v4, vcc, v6, v5
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v5, v3, v12
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v6, v0, v8
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v8, v2, v12
; GFX6-SDAG-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v5, v1, v11
; GFX6-SDAG-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v7, v0, v11
; GFX6-SDAG-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; GFX6-SDAG-NEXT:    v_add_i32_e32 v6, vcc, v7, v0
; GFX6-SDAG-NEXT:    v_addc_u32_e32 v5, vcc, v5, v1, vcc
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v1, v6, v1
; GFX6-SDAG-NEXT:    v_mul_hi_u32 v7, v6, v0
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v9, v5, v0
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v0, v6, v0
; GFX6-SDAG-NEXT:    v_add_i32_e32 v1, vcc, v7, v1
; GFX6-SDAG-NEXT:    v_add_i32_e32 v1, vcc, v1, v9
; GFX6-SDAG-NEXT:    v_add_i32_e32 v7, vcc, v8, v2
; GFX6-SDAG-NEXT:    v_addc_u32_e32 v4, vcc, v4, v3, vcc
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v3, v7, v3
; GFX6-SDAG-NEXT:    v_mul_hi_u32 v8, v7, v2
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v9, v4, v2
; GFX6-SDAG-NEXT:    v_mul_lo_u32 v2, v7, v2
; GFX6-SDAG-NEXT:    v_add_i32_e32 v3, vcc, v8, v3
; GFX6-SDAG-NEXT:    v_add_i32_e32 v3, vcc, v3, v9
...
; GFX6-GISEL-NEXT:    v_mul_hi_u32 v6, v0, v4
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v5, v0, v5
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v7, v0, v4
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v4, v1, v4
; GFX6-GISEL-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; GFX6-GISEL-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; GFX6-GISEL-NEXT:    v_add_i32_e32 v5, vcc, 1, v12
; GFX6-GISEL-NEXT:    v_addc_u32_e32 v6, vcc, 0, v9, vcc
; GFX6-GISEL-NEXT:    v_mul_hi_u32 v8, v2, v5
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v6, v2, v6
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v9, v2, v5
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v5, v3, v5
; GFX6-GISEL-NEXT:    v_add_i32_e32 v6, vcc, v8, v6
; GFX6-GISEL-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; GFX6-GISEL-NEXT:    v_add_i32_e32 v6, vcc, 1, v0
; GFX6-GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v1, vcc
; GFX6-GISEL-NEXT:    v_mul_hi_u32 v1, v7, v6
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v8, v7, v0
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v4, v4, v6
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v0, v7, v6
; GFX6-GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v8
; GFX6-GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v4
; GFX6-GISEL-NEXT:    v_add_i32_e32 v4, vcc, 1, v2
; GFX6-GISEL-NEXT:    v_addc_u32_e32 v2, vcc, 0, v3, vcc
; GFX6-GISEL-NEXT:    v_mul_hi_u32 v3, v9, v4
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v6, v9, v2
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v2, v9, v4
; GFX6-GISEL-NEXT:    v_mul_lo_u32 v4, v5, v4
; GFX6-GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v6
; GFX6-GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; GFX6-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v11, v9, v4
; GFX7-SDAG-NEXT:    v_add_i32_e32 v10, vcc, v1, v10
; GFX7-SDAG-NEXT:    v_add_i32_e32 v12, vcc, 1, v2
; GFX7-SDAG-NEXT:    v_addc_u32_e32 v13, vcc, 0, v3, vcc
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v3, v12, v7
; GFX7-SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v12, v6, 0
; GFX7-SDAG-NEXT:    v_add_i32_e32 v11, vcc, v10, v11
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v14, v13, v6
; GFX7-SDAG-NEXT:    v_add_i32_e32 v10, vcc, v2, v3
...
; GFX7-SDAG-NEXT:    v_addc_u32_e32 v9, vcc, v11, v9, vcc
; GFX7-SDAG-NEXT:    v_add_i32_e32 v14, vcc, v10, v14
; GFX7-SDAG-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; GFX7-SDAG-NEXT:    v_add_i32_e32 v5, vcc, v1, v12
; GFX7-SDAG-NEXT:    v_addc_u32_e32 v10, vcc, v14, v13, vcc
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v12, v5, v7
; GFX7-SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v5, v6, 0
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v9, v9, v4
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v4, v10, v6
; GFX7-SDAG-NEXT:    v_add_i32_e32 v5, vcc, v8, v12
...
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v6, v7, v14
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v0, v2, v11
...
; GFX7-GISEL-NEXT:    v_add_i32_e32 v5, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v5, v6, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, 0, v3, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v15, v4, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v7, v[2:3]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v9, v6, v[3:4]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v12, vcc, v1, v5
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v12, v6, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v11, v9, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v0, vcc, 1, v0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v7, v[3:4]
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v3, vcc, 0, v10, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v9, v6, v[4:5]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v8, v0, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v3, v[5:6]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v3, vcc, 1, v1
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v0, v[6:7]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v3, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v11, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v15, vcc, 1, v8
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v7, v[6:7]
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v6, vcc, 0, v13, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v13, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v3, v[0:1]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v15, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v13, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v14, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v4, v6, v[1:2]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v5, v14, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v15, v[7:8]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v13, v[11:12]
...
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v11, v9, v4
; GFX8-SDAG-NEXT:    v_add_u32_e32 v10, vcc, v1, v10
; GFX8-SDAG-NEXT:    v_add_u32_e32 v12, vcc, 1, v2
; GFX8-SDAG-NEXT:    v_addc_u32_e32 v13, vcc, 0, v3, vcc
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v3, v12, v7
; GFX8-SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v12, v6, 0
; GFX8-SDAG-NEXT:    v_add_u32_e32 v11, vcc, v10, v11
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v14, v13, v6
; GFX8-SDAG-NEXT:    v_add_u32_e32 v10, vcc, v2, v3
...
; GFX8-SDAG-NEXT:    v_addc_u32_e32 v9, vcc, v11, v9, vcc
; GFX8-SDAG-NEXT:    v_add_u32_e32 v14, vcc, v10, v14
; GFX8-SDAG-NEXT:    v_add_u32_e32 v3, vcc, v3, v5
; GFX8-SDAG-NEXT:    v_add_u32_e32 v5, vcc, v1, v12
; GFX8-SDAG-NEXT:    v_addc_u32_e32 v10, vcc, v14, v13, vcc
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v12, v5, v7
; GFX8-SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v5, v6, 0
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v9, v9, v4
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v4, v10, v6
; GFX8-SDAG-NEXT:    v_add_u32_e32 v5, vcc, v8, v12
...
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v6, v7, v14
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v0, v2, v11
...
; GFX8-GISEL-NEXT:    v_add_u32_e32 v5, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v5, v6, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, 0, v3, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v15, v4, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v7, v[2:3]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v9, v6, v[3:4]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v12, vcc, v1, v5
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v12, v6, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v11, v9, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v0, vcc, 1, v0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v7, v[3:4]
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v3, vcc, 0, v10, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v9, v6, v[4:5]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v8, v0, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v3, v[5:6]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v3, vcc, 1, v1
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v0, v[6:7]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v3, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v11, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v15, vcc, 1, v8
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v7, v[6:7]
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v6, vcc, 0, v13, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v13, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v3, v[0:1]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v15, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v13, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v14, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v4, v6, v[1:2]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v5, v14, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v15, v[7:8]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v13, v[11:12]
...
; GFX900-SDAG:       ; %bb.0: ; %entry
; GFX900-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-SDAG-NEXT:    v_add_co_u32_e32 v8, vcc, 1, v0
; GFX900-SDAG-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_add_co_u32_e32 v12, vcc, 1, v2
; GFX900-SDAG-NEXT:    v_addc_co_u32_e32 v13, vcc, 0, v3, vcc
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v10, v9, v4
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v11, v8, v5
; GFX900-SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v4, 0
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v14, v13, v6
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v15, v12, v7
; GFX900-SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v12, v6, 0
; GFX900-SDAG-NEXT:    v_add3_u32 v10, v1, v11, v10
; GFX900-SDAG-NEXT:    v_add3_u32 v1, v3, v15, v14
; GFX900-SDAG-NEXT:    v_add_co_u32_e32 v3, vcc, v0, v8
; GFX900-SDAG-NEXT:    v_addc_co_u32_e32 v8, vcc, v10, v9, vcc
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v9, v3, v5
; GFX900-SDAG-NEXT:    v_add_co_u32_e32 v5, vcc, v2, v12
; GFX900-SDAG-NEXT:    v_addc_co_u32_e32 v11, vcc, v1, v13, vcc
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v8, v8, v4
; GFX900-SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v3, v4, 0
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v11, v11, v6
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v7, v5, v7
; GFX900-SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v5, v6, 0
; GFX900-SDAG-NEXT:    v_add3_u32 v4, v4, v9, v8
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v10, v3, v10
; GFX900-SDAG-NEXT:    v_add3_u32 v6, v6, v7, v11
...
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v11, v4, v0
; GFX900-SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v0, v[3:4]
; GFX900-SDAG-NEXT:    v_mul_lo_u32 v6, v7, v6
; GFX900-SDAG-NEXT:    v_add3_u32 v8, v9, v8, v2
; GFX900-SDAG-NEXT:    v_add3_u32 v1, v11, v1, v10
...
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v5, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v5, v6, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v3, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v15, v4, v[11:12]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v7, v[2:3]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v9, v6, v[3:4]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v12, vcc, v1, v5
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v12, v6, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v9, vcc, v11, v9, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v0, vcc, 1, v0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v7, v[3:4]
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v10, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v9, v6, v[4:5]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v8, v0, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v3, v[5:6]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v3, vcc, 1, v1
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v0, v[6:7]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v3, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v11, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v15, vcc, 1, v8
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v7, v[6:7]
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v13, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v13, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v3, v[0:1]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v15, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v13, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v14, vcc, 0, v14, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v4, v6, v[1:2]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v5, v14, v[3:4]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v15, v[7:8]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v13, v[11:12]
...
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v12, vcc, v2, v14
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v14, vcc, v3, v15, vcc
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v12, v7, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v6, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v6, v[10:11]
; GFX90A-GISEL-NEXT:    v_add_u32_e32 v5, v5, v12
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v12, vcc, 1, v0
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v10, vcc, 0, v1, vcc
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v10, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v12, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v9, v12, v[0:1]
; GFX90A-GISEL-NEXT:    v_add_u32_e32 v12, v7, v10
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v7, vcc, 1, v2
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v3, vcc
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v2, 0
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v8, vcc, 1, v8
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v4, v7, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v7, v[0:1]
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v9, vcc
; GFX90A-GISEL-NEXT:    v_add_u32_e32 v11, v11, v2
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v6, v7, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v6, v8, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v8, v[2:3]
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v8, vcc, 1, v4
; GFX90A-GISEL-NEXT:    v_add_u32_e32 v1, v1, v6
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v5, vcc
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v6, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v8, 0
; GFX90A-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v8, v[4:5]
...
; GFX10-GISEL-NEXT:    v_add_co_u32 v3, s4, v2, v15
...
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v15, null, v12, v16, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v16, null, v13, v17, s4
; GFX10-GISEL-NEXT:    v_add_co_u32 v17, vcc_lo, v2, 1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[1:2], null, v1, v5, v[9:10]
; GFX10-GISEL-NEXT:    v_add_co_u32 v9, s4, v0, 1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v3, v7, v[11:12]
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v0, null, 0, v12, s4
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v13, vcc_lo
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[11:12], null, v8, v9, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v10, v17, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v15, v4, v[1:2]
; GFX10-GISEL-NEXT:    v_add_co_u32 v15, vcc_lo, v8, 1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v16, v6, v[2:3]
; GFX10-GISEL-NEXT:    v_add_co_u32 v16, s4, v10, 1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v8, v0, v[12:13]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v10, v3, v[14:15]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v11, v15, 0
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v13, v16, 0
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v10, null, 0, v4, vcc_lo
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v12, null, 0, v5, s4
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[8:9], null, v4, v9, v[6:7]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v5, v17, v[7:8]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v11, v10, v[1:2]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v13, v12, v[3:4]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v8, v15, v[5:6]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v4, v16, v[9:10]
...
; GFX11-GISEL-NEXT:    v_add_co_u32 v3, vcc_lo, v0, v11
...
; GFX11-GISEL-NEXT:    v_add_co_u32 v14, s0, v2, v15
...
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v18, null, v12, v16, vcc_lo
; GFX11-GISEL-NEXT:    v_add_co_u32 v19, vcc_lo, v2, 1
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v17, null, v13, v17, s0
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[1:2], null, v3, v5, v[9:10]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v14, v7, v[11:12]
; GFX11-GISEL-NEXT:    v_add_co_u32 v9, s0, v0, 1
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v0, null, 0, v12, s0
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v13, vcc_lo
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[11:12], null, v8, v9, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v10, v19, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[15:16], null, v18, v4, v[1:2]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v17, v6, v[2:3]
; GFX11-GISEL-NEXT:    v_add_co_u32 v16, vcc_lo, v8, 1
; GFX11-GISEL-NEXT:    v_add_co_u32 v17, s0, v10, 1
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v8, v0, v[12:13]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[6:7], null, v10, v3, v[14:15]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v11, v16, 0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v13, v17, 0
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v10, null, 0, v15, vcc_lo
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v12, null, 0, v4, s0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[7:8], null, v15, v9, v[5:6]
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v13, v12, v[3:4]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v7, v16, v[4:5]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v8, v17, v[9:10]
...
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v12, v2, v6
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v13, v2, v7
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v11, v0, v4
; GFX1200-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v14, v3, v6
; GFX1200-GISEL-NEXT:    v_add3_u32 v8, v9, v10, v8
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v9, v2, v6
; GFX1200-GISEL-NEXT:    v_add_co_u32 v0, vcc_lo, v11, v0
; GFX1200-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX1200-GISEL-NEXT:    v_add3_u32 v10, v13, v14, v12
; GFX1200-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-GISEL-NEXT:    v_add_co_ci_u32_e64 v1, null, v8, v1, vcc_lo
; GFX1200-GISEL-NEXT:    v_add_co_u32 v2, vcc_lo, v9, v2
; GFX1200-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-GISEL-NEXT:    v_add_co_ci_u32_e64 v3, null, v10, v3, vcc_lo
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v12, v0, v4
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v5, v0, v5
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v1, v1, v4
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v13, v2, v6
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v7, v2, v7
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v3, v3, v6
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v0, v0, v4
; GFX1200-GISEL-NEXT:    v_add_co_u32 v4, vcc_lo, v11, 1
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v2, v2, v6
; GFX1200-GISEL-NEXT:    v_add3_u32 v1, v5, v1, v12
; GFX1200-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-GISEL-NEXT:    v_add_co_ci_u32_e64 v5, null, 0, v8, vcc_lo
; GFX1200-GISEL-NEXT:    v_add_co_u32 v6, vcc_lo, v9, 1
; GFX1200-GISEL-NEXT:    v_add3_u32 v3, v7, v3, v13
; GFX1200-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-GISEL-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v10, vcc_lo
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v8, v0, v4
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v5, v0, v5
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v9, v1, v4
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v10, v2, v6
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v7, v2, v7
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v11, v3, v6
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v4, v0, v4
; GFX1200-GISEL-NEXT:    v_add_co_u32 v0, vcc_lo, v0, 1
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v6, v2, v6
; GFX1200-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-GISEL-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX1200-GISEL-NEXT:    v_add_co_u32 v2, vcc_lo, v2, 1
; GFX1200-GISEL-NEXT:    v_add3_u32 v5, v5, v9, v8
; GFX1200-GISEL-NEXT:    v_add3_u32 v7, v7, v11, v10
; GFX1200-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-GISEL-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, vcc_lo
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v8, v4, v0
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v1, v4, v1
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v5, v5, v0
; GFX1200-GISEL-NEXT:    v_mul_hi_u32 v9, v6, v2
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v3, v6, v3
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v7, v7, v2
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v0, v4, v0
; GFX1200-GISEL-NEXT:    v_mul_lo_u32 v2, v6, v2
; GFX1200-GISEL-NEXT:    v_add3_u32 v1, v1, v5, v8
; GFX1200-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1200-GISEL-NEXT:    v_add3_u32 v3, v3, v7, v9
; GFX1200-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
