...
; GFX6DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[8:9]
...
; GFX7DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[8:9]
...
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    v_mul_hi_u32 v2, s2, v1
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX6DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX6DAGISEL-NEXT:    s_add_u32 s5, s6, s5
; GFX6DAGISEL-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX6DAGISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX6DAGISEL-NEXT:    v_mul_hi_u32 v0, s2, v0
; GFX6DAGISEL-NEXT:    s_mul_i32 s2, s2, s6
; GFX6DAGISEL-NEXT:    s_mul_i32 s3, s3, s6
; GFX6DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX6DAGISEL-NEXT:    s_add_u32 s3, s6, s3
; GFX6DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX7DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX7DAGISEL-NEXT:    s_add_u32 s5, s6, s5
; GFX7DAGISEL-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX7DAGISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX7DAGISEL-NEXT:    v_mul_hi_u32 v0, s2, v0
; GFX7DAGISEL-NEXT:    s_mul_i32 s2, s2, s6
; GFX7DAGISEL-NEXT:    s_mul_i32 s3, s3, s6
; GFX7DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX7DAGISEL-NEXT:    s_add_u32 s3, s6, s3
; GFX7DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX8DAGISEL-NEXT:    s_add_u32 s5, s6, s5
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX8DAGISEL-NEXT:    s_mul_i32 s2, s2, s6
; GFX8DAGISEL-NEXT:    s_mul_i32 s3, s3, s6
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX8DAGISEL-NEXT:    s_add_u32 s3, s6, s3
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX1032DAGISEL-NEXT:    s_bcnt1_i32_b32 s4, s4
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    s_mul_hi_u32 s5, s6, s4
...
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_mul_hi_u32 s7, s4, s6
