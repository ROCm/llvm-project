...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefix=GISEL_W64 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 -global-isel=0 < %s | FileCheck -check-prefix=SDAG_W64 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefix=GISEL_W32 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=0 < %s | FileCheck -check-prefix=SDAG_W32 %s
