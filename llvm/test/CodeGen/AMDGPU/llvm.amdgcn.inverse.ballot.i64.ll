...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 -global-isel=1 < %s | FileCheck -check-prefix=GISEL_W64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 -global-isel=0 < %s | FileCheck -check-prefix=SDAG_W64 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=1 < %s | FileCheck -check-prefix=GISEL_W32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=0 < %s | FileCheck -check-prefix=SDAG_W32 %s
...
; GISEL_W64-NEXT:    s_and_b64 s[2:3], exec, s[2:3]
; GISEL_W64-NEXT:    s_xor_b64 exec, s[2:3], exec
; GISEL_W64-NEXT:    ; divergent control-flow edge
; GISEL_W64-NEXT:    s_cbranch_execz .LBB6_2
; GISEL_W64-NEXT:  .LBB6_1: ; %if
; GISEL_W64-NEXT:    s_add_u32 s0, s0, 1
; GISEL_W64-NEXT:    s_addc_u32 s1, s1, 0
; GISEL_W64-NEXT:    v_mov_b32_e32 v2, s0
; GISEL_W64-NEXT:    v_mov_b32_e32 v3, s1
; GISEL_W64-NEXT:  .LBB6_2: ; %endif
...
; GISEL_W32-NEXT:    s_and_b32 s2, exec_lo, s2
; GISEL_W32-NEXT:    s_xor_b32 exec_lo, s2, exec_lo
; GISEL_W32-NEXT:    ; divergent control-flow edge
; GISEL_W32-NEXT:    s_cbranch_execz .LBB6_2
; GISEL_W32-NEXT:  .LBB6_1: ; %if
; GISEL_W32-NEXT:    s_add_u32 s0, s0, 1
; GISEL_W32-NEXT:    s_addc_u32 s1, s1, 0
; GISEL_W32-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s1
; GISEL_W32-NEXT:  .LBB6_2: ; %endif
