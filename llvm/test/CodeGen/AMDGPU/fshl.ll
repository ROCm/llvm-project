...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02  | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.00 | FileCheck %s --check-prefix=GFX9
...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 | FileCheck %s --check-prefix=GFX11
...
; SI-NEXT:    s_lshr_b32 s7, s4, 1
; SI-NEXT:    s_lshr_b64 s[4:5], s[8:9], 1
...
; GFX10-NEXT:    s_not_b32 s8, s2
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[4:5], 1
; GFX10-NEXT:    s_mov_b32 s2, s0
; GFX10-NEXT:    s_and_b32 s0, s8, 31
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mov_b32 s11, s1
; GFX10-NEXT:    s_not_b32 s6, s6
; GFX10-NEXT:    s_mov_b32 s10, s3
; GFX10-NEXT:    s_mov_b32 s3, s0
; GFX10-NEXT:    s_not_b32 s4, s7
; GFX10-NEXT:    s_and_b32 s13, s6, 31
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[2:3], 1
; GFX10-NEXT:    s_lshr_b64 s[6:7], s[10:11], 1
; GFX10-NEXT:    s_lshr_b32 s5, s1, 1
; GFX10-NEXT:    s_lshr_b32 s1, s0, 1
; GFX10-NEXT:    s_and_b32 s12, s4, 31
; GFX10-NEXT:    s_mov_b32 s0, s2
; GFX10-NEXT:    s_mov_b32 s4, s6
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[0:1], s13
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[4:5], s12
...
; GFX11-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s11, s1
; GFX11-NEXT:    s_not_b32 s7, s7
; GFX11-NEXT:    s_not_b32 s6, s6
; GFX11-NEXT:    s_mov_b32 s10, s3
; GFX11-NEXT:    s_mov_b32 s3, s0
; GFX11-NEXT:    s_and_b32 s12, s7, 31
; GFX11-NEXT:    s_and_b32 s13, s6, 31
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], 1
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[10:11], 1
; GFX11-NEXT:    s_lshr_b32 s9, s1, 1
; GFX11-NEXT:    s_lshr_b32 s1, s0, 1
; GFX11-NEXT:    s_mov_b32 s0, s2
; GFX11-NEXT:    s_mov_b32 s8, s6
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[0:1], s13
...
; SI-NEXT:    s_lshr_b64 s[4:5], s[6:7], 25
; SI-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-NEXT:    s_mov_b32 s3, s0
; VI-NEXT:    s_lshr_b64 s[6:7], s[6:7], 23
; VI-NEXT:    s_lshr_b64 s[0:1], s[2:3], 25
; VI-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX9-NEXT:    s_lshr_b64 s[0:1], s[2:3], 25
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-NEXT:    global_store_dwordx2 v2, v[0:1], s[6:7]
; GFX9-NEXT:    s_endpgm
...
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[4:5], 25
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[0:1], 23
...
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[0:1], 23
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mov_b32 s16, s15
; GFX10-NEXT:    s_mov_b32 s15, s10
; GFX10-NEXT:    s_not_b32 s2, s2
; GFX10-NEXT:    s_lshr_b64 s[14:15], s[14:15], 1
; GFX10-NEXT:    s_mov_b32 s17, s11
; GFX10-NEXT:    s_lshr_b32 s5, s11, 1
; GFX10-NEXT:    s_not_b32 s4, s3
; GFX10-NEXT:    s_lshr_b32 s3, s10, 1
; GFX10-NEXT:    s_mov_b32 s11, s9
; GFX10-NEXT:    s_and_b32 s19, s2, 31
; GFX10-NEXT:    s_mov_b32 s10, s13
; GFX10-NEXT:    s_mov_b32 s2, s14
; GFX10-NEXT:    s_mov_b32 s13, s8
; GFX10-NEXT:    s_lshr_b32 s18, s9, 1
; GFX10-NEXT:    s_lshr_b64 s[16:17], s[16:17], 1
...
; GFX10-NEXT:    s_lshr_b64 s[12:13], s[12:13], 1
; GFX10-NEXT:    s_and_b32 s9, s4, 31
; GFX10-NEXT:    s_mov_b32 s4, s16
; GFX10-NEXT:    s_mov_b32 s11, s18
; GFX10-NEXT:    s_lshr_b32 s13, s8, 1
; GFX10-NEXT:    s_and_b32 s0, s0, 31
; GFX10-NEXT:    s_and_b32 s3, s1, 31
; GFX10-NEXT:    s_lshr_b64 s[4:5], s[4:5], s9
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[12:13], s0
; GFX10-NEXT:    s_lshr_b64 s[8:9], s[10:11], s3
; GFX10-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX11-NEXT:    s_lshr_b64 s[14:15], s[14:15], 1
; GFX11-NEXT:    s_mov_b32 s17, s11
; GFX11-NEXT:    s_lshr_b32 s7, s11, 1
; GFX11-NEXT:    s_not_b32 s6, s3
; GFX11-NEXT:    s_lshr_b32 s3, s10, 1
; GFX11-NEXT:    s_mov_b32 s11, s9
; GFX11-NEXT:    s_and_b32 s19, s2, 31
; GFX11-NEXT:    s_mov_b32 s10, s13
; GFX11-NEXT:    s_mov_b32 s2, s14
; GFX11-NEXT:    s_mov_b32 s13, s8
; GFX11-NEXT:    s_lshr_b32 s18, s9, 1
; GFX11-NEXT:    s_lshr_b64 s[16:17], s[16:17], 1
; GFX11-NEXT:    s_not_b32 s1, s1
; GFX11-NEXT:    s_not_b32 s0, s0
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[10:11], 1
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], s19
; GFX11-NEXT:    s_lshr_b64 s[12:13], s[12:13], 1
; GFX11-NEXT:    s_and_b32 s9, s6, 31
; GFX11-NEXT:    s_mov_b32 s6, s16
; GFX11-NEXT:    s_mov_b32 s11, s18
; GFX11-NEXT:    s_lshr_b32 s13, s8, 1
; GFX11-NEXT:    s_and_b32 s0, s0, 31
; GFX11-NEXT:    s_and_b32 s3, s1, 31
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[6:7], s9
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[12:13], s0
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[10:11], s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v1, s8
...
; SI-NEXT:    s_lshr_b64 s[2:3], s[6:7], 23
; SI-NEXT:    s_mov_b32 s6, s5
; SI-NEXT:    s_mov_b32 s7, s1
; SI-NEXT:    s_mov_b32 s5, s0
; SI-NEXT:    s_lshr_b64 s[12:13], s[12:13], 31
; SI-NEXT:    s_lshr_b64 s[6:7], s[6:7], 25
; SI-NEXT:    s_lshr_b64 s[0:1], s[4:5], 31
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    v_mov_b32_e32 v1, s6
