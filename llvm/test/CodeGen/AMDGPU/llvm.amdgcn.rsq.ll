...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu6.00 -global-isel=1 < %s | FileCheck -check-prefixes=SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu8.02 -global-isel=1 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.00 -global-isel=1 < %s | FileCheck -check-prefixes=GFX12-GISEL %s
