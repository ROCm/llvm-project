...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx600 -global-isel=1 < %s | FileCheck -check-prefixes=SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12-GISEL %s
