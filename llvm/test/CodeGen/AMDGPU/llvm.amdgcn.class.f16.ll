...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI-GISEL %s
...
; VI-SDAG:       ; %bb.0: ; %entry
; VI-SDAG-NEXT:    s_load_dword s4, s[8:9], 0x28
; VI-SDAG-NEXT:    s_load_dword s5, s[8:9], 0x4c
...
; VI-GISEL-NEXT:    s_load_dword s5, s[8:9], 0x28
...
; VI-GISEL-NEXT:    v_cmp_class_f16_e64 s[4:5], |s5|, v0
; VI-GISEL-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; VI-GISEL:       ; %bb.0: ; %entry
; VI-GISEL-NEXT:    s_load_dword s4, s[8:9], 0x8
; VI-GISEL-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; VI-GISEL-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-GISEL-NEXT:    s_mov_b32 s2, -1
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    v_cmp_class_f16_e64 s[4:5], s4, 1
; VI-GISEL-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; VI-GISEL-NEXT:    s_cselect_b32 s4, -1, 0
; VI-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; VI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; VI-GISEL-NEXT:    s_mov_b32 s2, -1
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    v_cmp_class_f16_e64 s[4:5], s4, 64
; VI-GISEL-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; VI-GISEL-NEXT:    s_cselect_b32 s4, -1, 0
; VI-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; VI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; VI-GISEL-NEXT:    s_mov_b32 s2, -1
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    v_cmp_class_f16_e32 vcc, s4, v0
; VI-GISEL-NEXT:    s_and_b64 s[4:5], vcc, exec
; VI-GISEL-NEXT:    s_cselect_b32 s4, -1, 0
; VI-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; VI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; VI-GISEL-NEXT:    s_endpgm
