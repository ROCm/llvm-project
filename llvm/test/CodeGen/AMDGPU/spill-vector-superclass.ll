...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 1114122 /* regdef:VGPR_32 */, def renamable $vgpr0
  ...
  ; GCN-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 2359305 /* reguse:VReg_64 */, renamable $vgpr0_vgpr1
  ; GCN-NEXT:   S_ENDPGM 0
