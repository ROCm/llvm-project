...
; RUN: llc -amdgpu-late-wave-transform=0 -O3 -global-isel -mtriple=amdgpu8.03 %s -o - | FileCheck %s --check-prefixes=GFX8,GISEL-GFX8
; RUN: llc -amdgpu-late-wave-transform=0 -O3 -global-isel -mtriple=amdgpu9.42 %s -o - | FileCheck %s --check-prefixes=GFX942,GISEL-GFX942
; RUN: llc -amdgpu-late-wave-transform=0 -O3 -global-isel -mtriple=amdgpu12.00 %s -o - | FileCheck %s --check-prefixes=GFX12,GISEL-GFX12
