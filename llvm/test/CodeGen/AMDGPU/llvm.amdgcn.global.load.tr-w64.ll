...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefix=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu12.00 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefix=GFX12 %s
