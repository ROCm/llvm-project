...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -enable-var-scope -check-prefixes=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck --check-prefixes=GCN-O0 %s
