...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope %s
...
; CHECK-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:  .LBB3_3: ; %UnifiedReturnBlock
