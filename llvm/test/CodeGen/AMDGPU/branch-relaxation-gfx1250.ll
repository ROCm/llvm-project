...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -amdgpu-s-branch-bits=4 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+use-add-pc64-inst -amdgpu-s-branch-bits=4 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN-ADD-PC64 %s


; FIXME: We should use llvm-mc for this, but we can't even parse our own output.
;        See PR33579.
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -amdgpu-s-branch-bits=4 -amdgpu-long-branch-factor=0 -o %t.o -filetype=obj -simplifycfg-require-and-preserve-domtree=1 %s
...
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v2
; GCN-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GCN-NEXT:    s_xor_b32 s0, exec_lo, s1
...
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GCN-ADD-PC64-NEXT:    v_add_nc_u64_e32 v[0:1], s[0:1], v[0:1]
; GCN-ADD-PC64-NEXT:    s_mov_b32 s0, 0
; GCN-ADD-PC64-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v2
; GCN-ADD-PC64-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GCN-ADD-PC64-NEXT:    s_xor_b32 s0, exec_lo, s1
; GCN-ADD-PC64-NEXT:    s_mov_b32 exec_lo, s1
; GCN-ADD-PC64-NEXT:    s_mov_b32 s1, 0
; GCN-ADD-PC64-NEXT:    ; divergent control-flow edge
; GCN-ADD-PC64-NEXT:    s_cbranch_execnz .LBB3_1
; GCN-ADD-PC64-NEXT:  .LBB3_3: ; %bb
...
; GCN-NEXT:    v_cmp_lt_u32_e32 vcc_lo, 15, v0
; GCN-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GCN-NEXT:    s_xor_b32 s3, exec_lo, s0
...
; GCN-ADD-PC64-NEXT:    s_mov_b32 s1, 0
; GCN-ADD-PC64-NEXT:    s_mov_b32 s1, 0
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GCN-ADD-PC64-NEXT:    v_cmp_lt_u32_e32 vcc_lo, 15, v0
; GCN-ADD-PC64-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GCN-ADD-PC64-NEXT:    s_xor_b32 s3, exec_lo, s0
; GCN-ADD-PC64-NEXT:    s_mov_b32 exec_lo, s0
; GCN-ADD-PC64-NEXT:    s_mov_b32 s0, 0
; GCN-ADD-PC64-NEXT:    ; divergent control-flow edge
; GCN-ADD-PC64-NEXT:    s_cbranch_execnz .LBB8_1
; GCN-ADD-PC64-NEXT:  .LBB8_4: ; %entry
...
; GCN-NEXT:    s_mov_b32 s1, 0
; GCN-NEXT:    s_mov_b32 s1, 0
; GCN-NEXT:    s_xor_b32 s3, s0, exec_lo
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GCN-NEXT:    s_add_co_u32 s4, s4, (.LBB9_3-.Lpost_getpc11)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s5, s5, (.LBB9_3-.Lpost_getpc11)>>32
...
; GCN-NEXT:    s_add_co_u32 s4, s4, (.LBB9_2-.Lpost_getpc12)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s5, s5, (.LBB9_2-.Lpost_getpc12)>>32
; GCN-NEXT:    s_set_pc_i64 s[4:5]
; GCN-NEXT:  .LBB9_3:
; GCN-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GCN-NEXT:    s_xor_b32 s2, exec_lo, s0
...
; GCN-ADD-PC64-NEXT:    s_mov_b32 s1, 0
; GCN-ADD-PC64-NEXT:    s_mov_b32 s1, 0
; GCN-ADD-PC64-NEXT:    s_xor_b32 s3, s0, exec_lo
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GCN-ADD-PC64-NEXT:    s_xor_b32 s2, exec_lo, s3
; GCN-ADD-PC64-NEXT:    s_mov_b32 exec_lo, s3
...
; GCN-NEXT:    s_add_co_u32 s6, s6, (.LBB10_3-.Lpost_getpc16)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s7, s7, (.LBB10_3-.Lpost_getpc16)>>32
...
; GCN-NEXT:    s_add_co_u32 s6, s6, (.LBB10_4-.Lpost_getpc14)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s7, s7, (.LBB10_4-.Lpost_getpc14)>>32
; GCN-NEXT:    s_set_pc_i64 s[6:7]
; GCN-NEXT:  .LBB10_2:
...
; GCN-NEXT:    s_add_co_u32 s0, s0, (.LBB10_2-.Lpost_getpc15)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB10_2-.Lpost_getpc15)>>32
; GCN-NEXT:    s_set_pc_i64 s[0:1]
...
; GCN-ADD-PC64-NEXT:    s_add_pc_i64 .LBB10_3-.Lpost_addpc16
...
; GCN-ADD-PC64-NEXT:    s_cbranch_scc1 .LBB10_2
...
; GCN-ADD-PC64-NEXT:    s_sleep 0
; GCN-ADD-PC64-NEXT:    s_sleep 0
; GCN-ADD-PC64-NEXT:    s_cbranch_vccz .LBB10_4
; GCN-ADD-PC64-NEXT:  ; %bb.10: ; %bb13
; GCN-ADD-PC64-NEXT:    s_add_pc_i64 .LBB10_2-.Lpost_addpc15
; GCN-ADD-PC64-NEXT:  .Lpost_addpc15:
; GCN-ADD-PC64-NEXT:  .LBB10_4: ; %bb14
