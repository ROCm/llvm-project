...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1030 %s -o - | FileCheck %s
...
; CHECK-NEXT:    s_and_b32 s4, s7, exec_lo
...
; CHECK-NEXT:    flat_store_byte v[4:5], v13
...
; CHECK-NEXT:    v_cmp_ne_u32_e64 s4, 0, v12
; CHECK-NEXT:    s_xor_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, -1, v1, s4
; CHECK-NEXT:    v_add_co_u32 v2, s4, v2, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, -1, v3, s4
; CHECK-NEXT:    s_and_b32 s4, s7, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    v_add_co_u32 v8, s4, v10, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, -1, v11, s4
...
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v12
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
; CHECK-NEXT:    s_or_b32 s8, s8, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    v_cmpx_ne_u64_e32 0, v[12:13]
; CHECK-NEXT:    s_or_b32 s8, s8, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    global_load_ubyte v13, v[4:5], off
; CHECK-NEXT:    v_add_co_u32 v6, s4, v6, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, -1, v7, s4
...
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s4
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s9, s4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    s_mov_b32 s6, 0
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_byte v[9:10], v12
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s10
; CHECK-NEXT:    v_cmp_ne_u32_e64 s4, 0, v11
; CHECK-NEXT:    s_xor_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
; CHECK-NEXT:    s_or_b32 s9, s9, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    v_add_co_u32 v7, s4, v9, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v8, null, -1, v10, s4
; CHECK-NEXT:    v_add_co_u32 v9, s4, v0, v9
; CHECK-NEXT:    v_add_co_ci_u32_e64 v10, null, v1, v10, s4
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[7:8]
; CHECK-NEXT:    s_xor_b32 s4, s5, exec_lo
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[9:10], v[3:6]
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
; CHECK-NEXT:    s_or_b32 s9, s9, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    global_load_ubyte v13, v[10:11], off
; CHECK-NEXT:    v_add_co_u32 v6, s4, v6, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, -1, v7, s4
; CHECK-NEXT:    v_add_co_u32 v10, s4, v10, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v11, s4
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    buffer_load_ubyte v12, v4, s[0:3], 0 offen
...
; CHECK-NEXT:    v_add_nc_u32_e32 v2, -16, v2
; CHECK-NEXT:    v_add_co_u32 v5, s4, v3, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, -1, v4, s4
...
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v5
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v6, vcc_lo
; CHECK-NEXT:    v_add_nc_u32_e32 v2, v2, v3
; CHECK-NEXT:    s_and_b32 s4, s7, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[6:7]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_byte v[4:5], v13, off
; CHECK-NEXT:    v_add_co_u32 v4, s5, v4, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v5, s5
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
; CHECK-NEXT:    s_or_b32 s10, s10, s4
...
; CHECK-NEXT:  .LBB7_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v9, v2
; CHECK-NEXT:    s_and_b32 s4, s8, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    s_add_u32 s6, s10, 16
; CHECK-NEXT:    s_addc_u32 s7, s11, 0
; CHECK-NEXT:    v_add_co_u32 v14, vcc_lo, v0, s10
; CHECK-NEXT:    v_cmp_lt_u64_e64 s4, s[6:7], v[7:8]
; CHECK-NEXT:    v_add_co_ci_u32_e64 v15, null, s11, v1, vcc_lo
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:  .LBB7_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s9
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB7_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    s_mov_b64 s[6:7], 0
; CHECK-NEXT:    s_and_b32 s4, s8, exec_lo
...
; CHECK-NEXT:    v_add_nc_u32_e32 v2, 1, v2
; CHECK-NEXT:    s_add_u32 s6, s8, 1
; CHECK-NEXT:    s_addc_u32 s7, s9, 0
; CHECK-NEXT:    v_add_co_u32 v3, vcc_lo, v0, s8
; CHECK-NEXT:    v_cmp_lt_u64_e64 s4, s[6:7], v[5:6]
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, s9, v1, vcc_lo
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:  .LBB7_6: ; %dynamic-memcpy-post-expansion
...
; CHECK-NEXT:  .LBB9_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v9, v2
; CHECK-NEXT:    s_and_b32 s4, s8, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:  .LBB9_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s9
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB9_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    s_mov_b64 s[6:7], 0
; CHECK-NEXT:    s_and_b32 s4, s8, exec_lo
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v3
...
; CHECK-NEXT:  .LBB9_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_mov_b32 s5, 0
; CHECK-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc_lo
; CHECK-NEXT:    v_cmp_ge_u64_e32 vcc_lo, v[1:2], v[9:10]
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s4
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    flat_load_ubyte v12, v[9:10]
; CHECK-NEXT:    v_add_co_u32 v5, s4, v5, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, -1, v6, s4
; CHECK-NEXT:    v_add_co_u32 v9, s4, v9, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v10, null, -1, v10, s4
...
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    v_add_co_u32 v1, s4, v1, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v2, null, -1, v2, s4
; CHECK-NEXT:    v_add3_u32 v0, v3, v0, -16
; CHECK-NEXT:    s_and_b32 s4, s6, exec_lo
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB10_6: ; %memmove_bwd_main_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    v_add_co_u32 v3, s4, v1, v7
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, v2, v8, s4
; CHECK-NEXT:    v_add_co_u32 v7, s4, v7, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v8, null, -1, v8, s4
...
; CHECK-NEXT:    v_add_co_u32 v5, vcc_lo, v5, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, -1, v6, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v0, 1
...
; CHECK-NEXT:    s_and_saveexec_b32 s8, s6
; CHECK-NEXT:    s_mov_b32 s6, 0
; CHECK-NEXT:    ; divergent control-flow edge
; CHECK-NEXT:    s_cbranch_execz .LBB11_3
; CHECK-NEXT:  .LBB11_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v9, v0
; CHECK-NEXT:    s_and_b32 s9, s7, exec_lo
...
; CHECK-NEXT:    v_add_nc_u32_e32 v9, 16, v9
; CHECK-NEXT:    v_cmpx_lt_u64_e32 s[4:5], v[7:8]
; CHECK-NEXT:    s_or_b32 s8, s8, s9
; CHECK-NEXT:    ; divergent control-flow edge
; CHECK-NEXT:    s_cbranch_execnz .LBB11_2
; CHECK-NEXT:  .LBB11_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB11_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b32 s7, s7, exec_lo
...
; CHECK-NEXT:    v_cmpx_lt_u64_e32 s[4:5], v[5:6]
; CHECK-NEXT:    s_or_b32 s6, s6, s7
; CHECK-NEXT:    ; divergent control-flow edge
; CHECK-NEXT:    s_cbranch_execnz .LBB11_5
; CHECK-NEXT:  .LBB11_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_cmp_ne_u32_e64 s4, 0, v8
; CHECK-NEXT:    s_xor_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s9, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s9
; CHECK-NEXT:    v_cmp_ne_u32_e64 s4, 0, v9
; CHECK-NEXT:    s_xor_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
; CHECK-NEXT:    s_or_b32 s8, s8, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:    v_sub_co_u32 v0, s4, 0, v5
; CHECK-NEXT:    v_add_nc_u32_e32 v4, v1, v4
; CHECK-NEXT:    v_sub_co_ci_u32_e64 v1, null, 0, v3, s4
; CHECK-NEXT:    s_and_b32 s4, s6, exec_lo
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, s4
; CHECK-NEXT:    v_add_nc_u32_e32 v4, -16, v4
; CHECK-NEXT:    v_cmp_eq_u64_e64 s4, 0, v[0:1]
; CHECK-NEXT:    s_xor_b32 s4, s4, exec_lo
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[10:13], v3
...
; CHECK-NEXT:  .LBB13_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v9, v0
; CHECK-NEXT:    s_and_b32 s9, s7, exec_lo
...
; CHECK-NEXT:  .LBB13_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB13_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b32 s7, s7, exec_lo
; CHECK-NEXT:    v_add_co_u32 v1, vcc_lo, v1, v3
...
; CHECK-NEXT:  .LBB13_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:  .LBB14_1: ; %dynamic-memcpy-expansion-main-body.preheader
...
; CHECK-NEXT:    v_cmpx_lt_u64_e32 s[4:5], v[2:3]
; CHECK-NEXT:    s_or_b32 s8, s8, s9
; CHECK-NEXT:    ; divergent control-flow edge
; CHECK-NEXT:    s_cbranch_execnz .LBB14_2
; CHECK-NEXT:  .LBB14_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB14_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v2, -16, v4
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b32 s7, s7, exec_lo
; CHECK-NEXT:    v_add_nc_u32_e32 v0, v0, v2
...
; CHECK-NEXT:  .LBB14_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[5:6]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_byte v12, v4, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v4, -1, v4
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
; CHECK-NEXT:    s_or_b32 s9, s9, s4
; CHECK-NEXT:    ; divergent control-flow edge
...
; CHECK-NEXT:  .LBB16_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v9, v0
; CHECK-NEXT:    s_and_b32 s9, s7, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:  .LBB16_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB16_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b32 s7, s7, exec_lo
; CHECK-NEXT:    v_add_co_u32 v1, vcc_lo, v1, v3
...
; CHECK-NEXT:  .LBB16_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:  .LBB17_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v7, v1
; CHECK-NEXT:    v_mov_b32_e32 v8, v0
; CHECK-NEXT:    s_and_b32 s9, s7, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:  .LBB17_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB17_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v2, -16, v4
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b32 s7, s7, exec_lo
; CHECK-NEXT:    v_add_nc_u32_e32 v0, v0, v2
...
; CHECK-NEXT:  .LBB17_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:  .LBB18_1: ; %dynamic-memcpy-expansion-main-body.preheader
; CHECK-NEXT:    v_mov_b32_e32 v9, v0
; CHECK-NEXT:    s_and_b32 s9, s7, exec_lo
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:  .LBB18_3: ; %dynamic-memcpy-expansion-residual-cond
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; CHECK-NEXT:    s_and_saveexec_b32 s4, s4
...
; CHECK-NEXT:  .LBB18_4: ; %dynamic-memcpy-expansion-residual-body.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_and_b32 s7, s7, exec_lo
; CHECK-NEXT:    v_add_co_u32 v1, vcc_lo, v1, v3
...
; CHECK-NEXT:  .LBB18_6: ; %dynamic-memcpy-post-expansion
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    buffer_load_dword v10, v3, s[0:3], 0 offen offset:12
...
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    buffer_store_dword v11, v9, s[0:3], 0 offen offset:8
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    buffer_store_dword v12, v9, s[0:3], 0 offen offset:4
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_store_dword v13, v9, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v9, 16, v9
; CHECK-NEXT:    v_cmpx_ne_u64_e32 0, v[6:7]
; CHECK-NEXT:    s_or_b32 s7, s7, s4
; CHECK-NEXT:    ; divergent control-flow edge
