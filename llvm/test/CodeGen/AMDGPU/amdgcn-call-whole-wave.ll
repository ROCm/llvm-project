...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu12.00--amdpal < %s | FileCheck %s --check-prefix=DAGISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.00--amdpal < %s | FileCheck %s --check-prefix=GISEL
