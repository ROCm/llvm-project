...
; VI-NEXT:    v_perm_b32 v4, v0, v1, s4
...
; GFX9-NEXT:    v_perm_b32 v4, v0, v1, s4
; GFX9-NEXT:    v_perm_b32 v5, v2, v3, s4
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v4, v0, v1, 0xc0c0004
; GFX11-FAKE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; SI-NEXT:    v_add_i32_e32 v1, vcc, 0x30000, v0
; SI-NEXT:    v_add_i32_e32 v3, vcc, 0x30000, v2
; SI-NEXT:  .LBB48_4: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[6:7]
; SI-NEXT:    v_mul_f32_e32 v0, 1.0, v3
; SI-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
...
; GFX11-TRUE16-NEXT:  .LBB56_1: ; %cmp.false
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-FAKE16-NEXT:  .LBB56_1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-FAKE16-NEXT:  .LBB56_3: ; %cmp.true
...
; GFX11-TRUE16-NEXT:  .LBB58_1: ; %cmp.false
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_perm_b32 v0, v4, v1, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v0, v5, 16, v0
...
; GFX11-TRUE16-NEXT:  .LBB58_3: ; %cmp.true
; GFX11-TRUE16-NEXT:    v_add_nc_u16 v0.l, v4.l, 3
; GFX11-TRUE16-NEXT:    v_add_nc_u16 v0.h, v2.l, 3
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 8, v1.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v3.l
...
; GFX11-FAKE16-NEXT:  .LBB58_1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_perm_b32 v4, v0, v1, 0xc0c0004
; GFX11-FAKE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, v5, 16, v4
...
; GFX11-FAKE16-NEXT:  .LBB58_3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v0, v0, 3
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v2, v2, 3
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v3, 8, v3
...
; GFX11-TRUE16-NEXT:  .LBB76_1: ; %cmp.false
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-FAKE16-NEXT:  .LBB76_1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-FAKE16-NEXT:  .LBB76_3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v1, 16, v0
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v0, 0xffff0000, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v1, 0x40c00000, v1 :: v_dual_add_f32 v0, 0x40c00000, v0
...
; GFX11-TRUE16-NEXT:  .LBB78_1: ; %cmp.false
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_perm_b32 v0, v4, v1, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v0, v5, 16, v0
...
; GFX11-TRUE16-NEXT:  .LBB78_3: ; %cmp.true
; GFX11-TRUE16-NEXT:    v_add_nc_u16 v0.l, v4.l, 3
; GFX11-TRUE16-NEXT:    v_add_nc_u16 v0.h, v2.l, 3
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 8, v1.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v3.l
...
; GFX11-FAKE16-NEXT:  .LBB78_1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_perm_b32 v4, v0, v1, 0xc0c0004
; GFX11-FAKE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, v5, 16, v4
...
; GFX11-FAKE16-NEXT:  .LBB78_3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v0, v0, 3
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v2, v2, 3
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v3, 8, v3
...
; GFX11-TRUE16-NEXT:  .LBB80_1: ; %cmp.false
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-FAKE16-NEXT:  .LBB80_1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-FAKE16-NEXT:  .LBB80_3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v0, 3, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
...
; GFX11-TRUE16-NEXT:  .LBB82_1: ; %cmp.false
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_perm_b32 v0, v4, v1, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v0, v5, 16, v0
...
; GFX11-TRUE16-NEXT:  .LBB82_3: ; %cmp.true
; GFX11-TRUE16-NEXT:    v_add_nc_u16 v0.l, v4.l, 3
; GFX11-TRUE16-NEXT:    v_add_nc_u16 v0.h, v2.l, 3
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 8, v1.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v3.l
...
; GFX11-FAKE16-NEXT:  .LBB82_1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_perm_b32 v4, v0, v1, 0xc0c0004
; GFX11-FAKE16-NEXT:    v_perm_b32 v5, v2, v3, 0xc0c0004
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, v5, 16, v4
...
; GFX11-FAKE16-NEXT:  .LBB82_3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v0, v0, 3
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v2, v2, 3
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v3, 8, v3
