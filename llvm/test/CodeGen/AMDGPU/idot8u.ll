...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00 < %s | FileCheck -check-prefixes=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.06 < %s | FileCheck -check-prefixes=GFX9-DL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.11 < %s | FileCheck -check-prefixes=GFX10-DL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.12 < %s | FileCheck -check-prefixes=GFX10-DL %s
...
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_bfe_u32 v15, v0, 20, 4
; GFX9-NEXT:    v_bfe_u32 v16, v0, 16, 4
; GFX9-NEXT:    v_lshrrev_b32_e32 v17, 28, v0
; GFX9-NEXT:    v_bfe_u32 v18, v0, 24, 4
...
; GFX9-NEXT:    v_mul_lo_u16_sdwa v1, v4, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_e32 v4, v0, v10
...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v15, v0, 20, 4
; GFX9-DL-NEXT:    v_bfe_u32 v16, v0, 16, 4
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v17, 28, v0
; GFX9-DL-NEXT:    v_bfe_u32 v18, v0, 24, 4
...
; GFX9-DL-NEXT:    v_mul_lo_u16_sdwa v1, v4, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-DL-NEXT:    v_or_b32_e32 v4, v0, v10
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_bfe_u32 v1, v0, 4, 4
; GFX10-DL-NEXT:    v_bfe_u32 v13, v0, 12, 4
; GFX10-DL-NEXT:    v_bfe_u32 v15, v0, 20, 4
; GFX10-DL-NEXT:    v_bfe_u32 v14, v0, 8, 4
; GFX10-DL-NEXT:    v_and_b32_e32 v12, 15, v0
; GFX10-DL-NEXT:    v_mul_lo_u16 v1, v3, v1
; GFX10-DL-NEXT:    v_mul_lo_u16 v6, v6, v13
; GFX10-DL-NEXT:    v_bfe_u32 v16, v0, 16, 4
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v17, 28, v0
; GFX10-DL-NEXT:    v_bfe_u32 v13, v0, 24, 4
; GFX10-DL-NEXT:    v_mul_lo_u16 v0, v8, v15
...
; GFX10-DL-NEXT:    v_or_b32_e32 v0, v8, v0
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_add_nc_u16 v2, v1, v2
; GFX10-DL-NEXT:    v_lshl_or_b32 v1, v5, 16, v0
; GFX10-DL-NEXT:    v_lshlrev_b32_e32 v0, 16, v6
; GFX10-DL-NEXT:    v_add_nc_u16 v5, v2, v3
