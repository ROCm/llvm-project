...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck -check-prefix=VI %s
...
; VI-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 offset:1
; VI-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_and_b32 s5, s5, 0x7fffff
; VI-NEXT:    v_cvt_f32_u32_e32 v0, s5
; VI-NEXT:    s_sub_i32 s2, 0, s5
; VI-NEXT:    s_and_b32 s4, s4, 0x7fffff
; VI-NEXT:    v_rcp_f32_e32 v0, v0
...
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_and_b32 s5, s5, 0x1ffffff
; VI-NEXT:    v_cvt_f32_u32_e32 v0, s5
; VI-NEXT:    s_sub_i32 s2, 0, s5
; VI-NEXT:    s_and_b32 s4, s4, 0x1ffffff
; VI-NEXT:    v_rcp_f32_e32 v0, v0
; VI-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; VI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; VI-NEXT:    v_mul_lo_u32 v1, s2, v0
