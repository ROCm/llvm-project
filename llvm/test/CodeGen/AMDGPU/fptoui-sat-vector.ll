...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel=1 -mtriple=amdgpu7.00 | FileCheck %s --check-prefixes=GFX7,GFX7-GI
...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel=1 -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12,GFX12-GI
