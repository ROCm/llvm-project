...
; GCN-NEXT:    s_and_b64 s[12:13], s[4:5], exec
; GCN-NEXT:  .LBB0_3: ; %LOOP
; GCN-NEXT:    ; Parent Loop BB0_2 Depth=1
; GCN-NEXT:    ; => This Inner Loop Header: Depth=2
; GCN-NEXT:    v_cmp_lt_i32_e64 s[12:13], v0, v4
; GCN-NEXT:    s_xor_b64 s[14:15], exec, s[12:13]
; GCN-NEXT:    s_and_b64 s[14:15], s[14:15], exec
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s[0:1]
; GCN-NEXT:    s_or_b64 s[10:11], s[10:11], s[14:15]
; GCN-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execz .LBB0_1
; GCN-NEXT:  .LBB0_4: ; %ENDIF
; GCN-NEXT:    ; in Loop: Header=BB0_3 Depth=2
; GCN-NEXT:    v_add_i32_e32 v0, vcc, 1, v0
; GCN-NEXT:    v_cmp_eq_u32_e64 s[12:13], v5, v0
; GCN-NEXT:    s_xor_b64 s[14:15], exec, s[12:13]
; GCN-NEXT:    s_and_b64 s[14:15], s[14:15], exec
