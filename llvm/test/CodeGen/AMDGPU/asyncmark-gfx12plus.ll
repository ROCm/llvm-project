...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck %s -check-prefixes=SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck %s -check-prefixes=GISEL
...
; SDAG-NEXT:    s_mov_b32 s12, 2
; SDAG-NEXT:    s_wait_kmcnt 0x0
; SDAG-NEXT:    s_load_b32 s14, s[0:1], 0x0
; SDAG-NEXT:    s_add_co_i32 s6, s10, 4
; SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; SDAG-NEXT:    v_dual_mov_b32 v1, s10 :: v_dual_mov_b32 v4, s6
; SDAG-NEXT:    s_load_b32 s13, s[8:9], 0x0
...
; SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 8
; SDAG-NEXT:    s_mov_b32 s8, s10
; SDAG-NEXT:    ; asyncmark
; SDAG-NEXT:    s_wait_kmcnt 0x0
; SDAG-NEXT:    v_dual_mov_b32 v8, s14 :: v_dual_mov_b32 v6, s13
; SDAG-NEXT:    s_wait_loadcnt 0x0
; SDAG-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v5, v2
; SDAG-NEXT:  .LBB2_1: ; %loop_body
; SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; SDAG-NEXT:    s_add_co_i32 s9, s8, 8
; SDAG-NEXT:    s_wait_loadcnt 0x0
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-NEXT:    v_dual_mov_b32 v4, v5 :: v_dual_mov_b32 v7, v3
; SDAG-NEXT:    v_dual_mov_b32 v9, s9 :: v_dual_add_nc_u32 v10, v6, v8
; SDAG-NEXT:    s_clause 0x1
; SDAG-NEXT:    global_load_b32 v3, v0, s[4:5]
; SDAG-NEXT:    global_load_b32 v5, v0, s[0:1]
; SDAG-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v6, v1
; SDAG-NEXT:    global_load_async_to_lds_b32 v9, v0, s[4:5] offset:4 nv
; SDAG-NEXT:    v_mov_b32_e32 v9, s8
; SDAG-NEXT:    ; asyncmark
; SDAG-NEXT:    ; wait_asyncmark(2)
; SDAG-NEXT:    s_wait_asynccnt 0x2
; SDAG-NEXT:    s_add_co_i32 s12, s12, 1
; SDAG-NEXT:    s_add_co_i32 s8, s8, 4
; SDAG-NEXT:    ds_load_b32 v9, v9
; SDAG-NEXT:    s_mov_b64 s[14:15], s[6:7]
; SDAG-NEXT:    s_wait_xcnt 0x0
; SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 4
; SDAG-NEXT:    s_add_nc_u64 s[4:5], s[4:5], 4
; SDAG-NEXT:    s_add_nc_u64 s[6:7], s[6:7], 4
; SDAG-NEXT:    s_cmp_lt_i32 s12, s11
; SDAG-NEXT:    s_wait_dscnt 0x0
; SDAG-NEXT:    v_add_nc_u32_e32 v9, v10, v9
; SDAG-NEXT:    global_store_b32 v0, v9, s[14:15]
...
; SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; SDAG-NEXT:    v_dual_add_nc_u32 v2, v7, v4 :: v_dual_mov_b32 v0, s1
...
; SDAG-NEXT:    s_wait_loadcnt 0x0
; SDAG-NEXT:    s_wait_xcnt 0x0
; SDAG-NEXT:    v_add_nc_u32_e32 v1, v3, v5
; SDAG-NEXT:    s_wait_dscnt 0x0
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-NEXT:    v_add_nc_u32_e32 v0, v1, v0
