...
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 | FileCheck --check-prefix=GFX9-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 | FileCheck --check-prefix=GFX9-NOEXPAND %s
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 | FileCheck --check-prefix=GFX10-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 | FileCheck --check-prefix=GFX10-NOEXPAND %s
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 | FileCheck --check-prefix=GFX11-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 | FileCheck --check-prefix=GFX11-NOEXPAND %s
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 | FileCheck --check-prefix=GFX12-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 | FileCheck --check-prefix=GFX12-NOEXPAND %s
...
; GFX9-EXPAND-NEXT:    s_nop 0
; GFX9-EXPAND-NEXT:    s_load_dword s1, s[2:3], 0x0
; GFX9-EXPAND-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-EXPAND-NEXT:    s_add_i32 s0, s0, s1
; GFX9-EXPAND-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX9-NOEXPAND-NEXT:    s_nop 0
; GFX9-NOEXPAND-NEXT:    s_load_dword s1, s[2:3], 0x0
; GFX9-NOEXPAND-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NOEXPAND-NEXT:    s_add_i32 s0, s0, s1
; GFX9-NOEXPAND-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX10-EXPAND-NEXT:    s_nop 0
; GFX10-EXPAND-NEXT:    s_load_dword s1, s[2:3], 0x0
; GFX10-EXPAND-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-EXPAND-NEXT:    s_add_i32 s0, s0, s1
; GFX10-EXPAND-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX10-NOEXPAND-NEXT:    s_nop 0
; GFX10-NOEXPAND-NEXT:    s_load_dword s1, s[2:3], 0x0
; GFX10-NOEXPAND-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NOEXPAND-NEXT:    s_add_i32 s0, s0, s1
; GFX10-NOEXPAND-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX9-EXPAND-NEXT:    s_nop 0
; GFX9-EXPAND-NEXT:    s_load_dword s4, s[4:5], 0x24
; GFX9-EXPAND-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-EXPAND-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-EXPAND-NEXT:    s_load_dword s0, s[0:1], 0x0
; GFX9-EXPAND-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX9-NOEXPAND-NEXT:    s_nop 0
; GFX9-NOEXPAND-NEXT:    s_load_dword s4, s[4:5], 0x24
; GFX9-NOEXPAND-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-NOEXPAND-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NOEXPAND-NEXT:    s_load_dword s0, s[0:1], 0x0
; GFX9-NOEXPAND-NEXT:    v_mov_b32_e32 v0, s4
