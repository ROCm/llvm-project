...
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 | FileCheck --check-prefix=GFX9-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 | FileCheck --check-prefix=GFX9-NOEXPAND %s
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 | FileCheck --check-prefix=GFX10-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 | FileCheck --check-prefix=GFX10-NOEXPAND %s
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 | FileCheck --check-prefix=GFX11-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 | FileCheck --check-prefix=GFX11-NOEXPAND %s
; RUN: sed 's/ATTRS/\"amdgpu-expand-waitcnt-profiling\"/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 | FileCheck --check-prefix=GFX12-EXPAND %s
; RUN: sed 's/ATTRS//g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 | FileCheck --check-prefix=GFX12-NOEXPAND %s
