...
; GCN-NEXT:    v_mov_b32_e32 v4, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    global_load_dwordx4 v[10:13], v4, s[10:11] offset:48
; GCN-NEXT:    global_load_dwordx4 v[14:17], v4, s[10:11] offset:32
; GCN-NEXT:    global_load_dwordx4 v[6:9], v4, s[10:11]
; GCN-NEXT:    global_load_dwordx4 v[0:3], v4, s[10:11] offset:16
...
; GCN-NEXT:    v_mul_lo_u32 v5, s4, v5
; GCN-NEXT:    v_mul_hi_u32 v12, s4, v4
; GCN-NEXT:    v_mul_lo_u32 v13, s5, v4
; GCN-NEXT:    v_mul_lo_u32 v4, s4, v4
...
; GCN-NEXT:    v_subrev_co_u32_e64 v12, s[0:1], s4, v4
; GCN-NEXT:    v_subbrev_co_u32_e64 v14, s[2:3], 0, v11, s[0:1]
; GCN-NEXT:    v_cmp_le_u32_e64 s[2:3], s5, v14
; GCN-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[2:3]
; GCN-NEXT:    v_cmp_le_u32_e64 s[2:3], s4, v12
; GCN-NEXT:    v_subb_co_u32_e64 v11, s[0:1], v11, v13, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[2:3]
; GCN-NEXT:    v_cmp_eq_u32_e64 s[2:3], s5, v14
; GCN-NEXT:    v_subrev_co_u32_e64 v13, s[0:1], s4, v12
...
; GCN-NEXT:    s_xor_b64 s[4:5], s[2:3], s[0:1]
; GCN-NEXT:    v_cvt_f32_u32_e32 v6, s4
; GCN-NEXT:    v_cvt_f32_u32_e32 v7, s5
; GCN-NEXT:    s_sub_u32 s0, 0, s4
; GCN-NEXT:    s_subb_u32 s1, 0, s5
...
; GCN-NEXT:    v_mul_lo_u32 v7, s4, v7
; GCN-NEXT:    v_mul_hi_u32 v12, s4, v6
; GCN-NEXT:    v_mul_lo_u32 v13, s5, v6
; GCN-NEXT:    v_mul_lo_u32 v6, s4, v6
...
; GCN-NEXT:    v_subb_co_u32_e64 v11, s[0:1], v12, v13, vcc
; GCN-NEXT:    v_subrev_co_u32_e64 v12, s[0:1], s4, v6
; GCN-NEXT:    v_subbrev_co_u32_e64 v14, s[2:3], 0, v11, s[0:1]
; GCN-NEXT:    v_cmp_le_u32_e64 s[2:3], s5, v14
; GCN-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[2:3]
; GCN-NEXT:    v_cmp_le_u32_e64 s[2:3], s4, v12
...
; GCN-NEXT:    v_cndmask_b32_e64 v15, v15, v16, s[2:3]
; GCN-NEXT:    v_subbrev_co_u32_e64 v11, s[0:1], 0, v11, s[0:1]
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s5, v7
; GCN-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v15
; GCN-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s4, v6
; GCN-NEXT:    v_cndmask_b32_e64 v12, v12, v13, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, s5, v7
...
; GCN-NEXT:    v_cvt_f32_u32_e32 v9, s5
; GCN-NEXT:    s_sub_u32 s0, 0, s4
; GCN-NEXT:    s_subb_u32 s1, 0, s5
...
; GCN-NEXT:    v_mul_lo_u32 v9, s4, v9
; GCN-NEXT:    v_mul_hi_u32 v12, s4, v8
; GCN-NEXT:    v_mul_lo_u32 v13, s5, v8
; GCN-NEXT:    v_mul_lo_u32 v8, s4, v8
...
; GCN-NEXT:    v_subb_co_u32_e64 v11, s[0:1], v12, v13, vcc
; GCN-NEXT:    v_subrev_co_u32_e64 v12, s[0:1], s4, v8
; GCN-NEXT:    v_subbrev_co_u32_e64 v14, s[2:3], 0, v11, s[0:1]
; GCN-NEXT:    v_cmp_le_u32_e64 s[2:3], s5, v14
; GCN-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[2:3]
; GCN-NEXT:    v_cmp_le_u32_e64 s[2:3], s4, v12
...
; GCN-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v15
; GCN-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s4, v8
; GCN-NEXT:    v_cndmask_b32_e64 v12, v12, v13, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, s5, v1
; GCN-NEXT:    v_cndmask_b32_e32 v9, v9, v13, vcc
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GCN-NEXT:    v_cndmask_b32_e64 v11, v14, v11, s[0:1]
...
; GCN-NEXT:    v_mul_lo_u32 v1, s4, v1
; GCN-NEXT:    v_mul_hi_u32 v12, s4, v0
; GCN-NEXT:    v_mul_lo_u32 v13, s5, v0
; GCN-NEXT:    v_mul_lo_u32 v0, s4, v0
...
; GCN-NEXT:    v_subrev_co_u32_e64 v12, s[0:1], s4, v0
...
; GCN-NEXT:  .LBB12_12:
; GCN-NEXT:    v_mov_b32_e32 v0, 0
; GCN-NEXT:    global_store_dwordx4 v0, v[8:11], s[8:9] offset:16
; GCN-NEXT:    global_store_dwordx4 v0, v[4:7], s[8:9]
; GCN-NEXT:    s_endpgm
; GCN-NEXT:  .LBB12_13:
