...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s -check-prefixes=GFX9,SDAG,GFX9-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.00 < %s | FileCheck %s -check-prefixes=GFX9,GFX9-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu10.10 < %s | FileCheck %s -check-prefixes=GFX10,SDAG,GFX10-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu10.10 < %s | FileCheck %s -check-prefixes=GFX10,GFX10-GISEL
; RUN: not llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.08 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.08 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.0a < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.0a < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.4 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.4 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.42 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.42 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.50 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
; RUN: not llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.50 < %s 2>&1 | FileCheck %s -check-prefix=NOPOPS
...
; GFX9-SDAG-LABEL: test_if:
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    s_bitcmp1_b32 s0, 0
; GFX9-SDAG-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX9-SDAG-NEXT:    s_mov_b32 s0, src_pops_exiting_wave_id
; GFX9-SDAG-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GFX9-SDAG-NEXT:    s_cbranch_vccz .LBB2_2
; GFX9-SDAG-NEXT:  ; %bb.1: ; %body
; GFX9-SDAG-NEXT:    s_mov_b32 s0, src_pops_exiting_wave_id
