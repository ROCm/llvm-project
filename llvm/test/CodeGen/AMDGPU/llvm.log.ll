...
; VI-SDAG-NEXT:    v_ldexp_f32 v1, s4, v1
...
; GFX900-SDAG-NEXT:    v_fma_f32 v4, v1, s0, -v3
; GFX900-SDAG-NEXT:    v_fma_f32 v4, v1, s1, v4
; GFX900-SDAG-NEXT:    s_mov_b32 s0, 0x7f800000
; GFX900-SDAG-NEXT:    v_add_f32_e32 v3, v3, v4
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v1|, s0
...
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x9
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, 0x800000
; SI-SDAG-NEXT:    v_mov_b32_e32 v1, 0x41b17218
...
; VI-SDAG-NEXT:    v_ldexp_f32 v3, s6, v3
; VI-SDAG-NEXT:    v_log_f32_e32 v3, v3
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v1, vcc
...
; VI-SDAG-NEXT:    s_cselect_b32 s2, 32, 0
; VI-SDAG-NEXT:    v_add_f32_e32 v5, v6, v5
; VI-SDAG-NEXT:    v_mov_b32_e32 v6, s2
; VI-SDAG-NEXT:    v_ldexp_f32 v6, s5, v6
...
; GFX900-SDAG-NEXT:    v_ldexp_f32 v3, s6, v3
...
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v7, s0
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v3, s6, -v5
; GFX900-SDAG-NEXT:    v_ldexp_f32 v7, s5, v7
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v3, s7, v6
...
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 32, 0
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v7, s6, -v3
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v7, s7, v5
; GFX900-SDAG-NEXT:    v_ldexp_f32 v1, s4, v1
...
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v5, s6, -v3
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v5, s7, v6
...
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, 0x41b17218, s2
...
; GFX1100-SDAG-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1100-SDAG-NEXT:    s_cselect_b32 s3, 32, 0
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v2, s6, s2
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v4, s5, s3
...
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v5, s4, s2
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
...
; VI-SDAG-NEXT:    s_cselect_b32 s2, 32, 0
; VI-SDAG-NEXT:    v_mov_b32_e32 v3, s2
; VI-SDAG-NEXT:    v_ldexp_f32 v3, s7, v3
; VI-SDAG-NEXT:    v_log_f32_e32 v3, v3
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v1, vcc
; VI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s6, v0
; VI-SDAG-NEXT:    s_and_b64 s[2:3], vcc, exec
...
; VI-SDAG-NEXT:    v_add_f32_e32 v5, v6, v5
; VI-SDAG-NEXT:    v_mov_b32_e32 v6, s2
; VI-SDAG-NEXT:    v_ldexp_f32 v6, s6, v6
; VI-SDAG-NEXT:    v_log_f32_e32 v6, v6
; VI-SDAG-NEXT:    v_mul_f32_e32 v4, 0x3f317000, v4
; VI-SDAG-NEXT:    v_add_f32_e32 v5, v7, v5
...
; VI-SDAG-NEXT:    v_add_f32_e32 v4, v4, v5
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v5, 0, v1, vcc
; VI-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v3|, s7
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v3, v3, v4, vcc
...
; VI-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v7|, s7
...
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v0, 0x800000
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v1, 0x41b17218
; GFX900-SDAG-NEXT:    s_mov_b32 s8, 0x3377d1cf
; GFX900-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s7, v0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 32, 0
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v3, s0
; GFX900-SDAG-NEXT:    v_ldexp_f32 v3, s7, v3
; GFX900-SDAG-NEXT:    v_log_f32_e32 v3, v3
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s6, v0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v5, 0x3f317217, v3
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 32, 0
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v3, s7, -v5
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v7, s0
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v3, s8, v6
; GFX900-SDAG-NEXT:    s_mov_b32 s9, 0x7f800000
; GFX900-SDAG-NEXT:    v_ldexp_f32 v7, s6, v7
; GFX900-SDAG-NEXT:    v_add_f32_e32 v5, v5, v6
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v6, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_log_f32_e32 v7, v7
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v3|, s9
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s5, v0
; GFX900-SDAG-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 32, 0
...
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v8, s0
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v7, s7, -v2
; GFX900-SDAG-NEXT:    v_ldexp_f32 v8, s5, v8
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v7, s8, v5
...
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v7|, s9
...
; GFX900-SDAG-NEXT:    s_cselect_b32 s0, 32, 0
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v8, s7, -v6
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v8, s8, v7
; GFX900-SDAG-NEXT:    v_ldexp_f32 v1, s4, v1
; GFX900-SDAG-NEXT:    v_add_f32_e32 v6, v6, v7
; GFX900-SDAG-NEXT:    v_log_f32_e32 v7, v1
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v8|, s9
...
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v7, s7, -v5
; GFX900-SDAG-NEXT:    v_fma_f32 v6, v7, s8, v6
; GFX900-SDAG-NEXT:    v_add_f32_e32 v5, v5, v6
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e64 vcc, |v7|, s9
...
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, 0x41b17218, s3
; GFX1100-SDAG-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v2, s7, s2
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v4, 0, 0x41b17218, s8
; GFX1100-SDAG-NEXT:    s_cselect_b32 s3, 32, 0
; GFX1100-SDAG-NEXT:    s_and_b32 s8, s8, exec_lo
; GFX1100-SDAG-NEXT:    s_cselect_b32 s2, 32, 0
; GFX1100-SDAG-NEXT:    s_and_b32 s7, s9, exec_lo
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v3, s6, s3
; GFX1100-SDAG-NEXT:    s_cselect_b32 s3, 32, 0
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v6, s5, s2
; GFX1100-SDAG-NEXT:    v_ldexp_f32 v7, s4, s3
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v2, v2
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v3, v3
