...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX7LESS,GFX7LESS_ITERATIVE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX8,GFX8_ITERATIVE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9_ITERATIVE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064,GFX1064_ITERATIVE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032,GFX1032_ITERATIVE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164,GFX1164-TRUE16,GFX1164_ITERATIVE,GFX1164_ITERATIVE-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164,GFX1164-FAKE16,GFX1164_ITERATIVE,GFX1164_ITERATIVE-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132,GFX1132-TRUE16,GFX1132_ITERATIVE,GFX1132_ITERATIVE-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132,GFX1132-FAKE16,GFX1132_ITERATIVE,GFX1132_ITERATIVE-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=+real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1264,GFX1264-TRUE16,GFX1264_ITERATIVE,GFX1264_ITERATIVE-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=-real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1264,GFX1264-FAKE16,GFX1264_ITERATIVE,GFX1264_ITERATIVE-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=+real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1232,GFX1232-TRUE16,GFX1232_ITERATIVE,GFX1232_ITERATIVE-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=-real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefixes=GFX1232,GFX1232-FAKE16,GFX1232_ITERATIVE,GFX1232_ITERATIVE-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX7LESS,GFX7LESS_DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX8,GFX8_DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9_DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064,GFX1064_DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032,GFX1032_DPP %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164,GFX1164-TRUE16,GFX1164_DPP,GFX1164_DPP-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164,GFX1164-FAKE16,GFX1164_DPP,GFX1164_DPP-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132,GFX1132-TRUE16,GFX1132_DPP,GFX1132_DPP-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132,GFX1132-FAKE16,GFX1132_DPP,GFX1132_DPP-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=+real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1264,GFX1264-TRUE16,GFX1264_DPP,GFX1264_DPP-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=-real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1264,GFX1264-FAKE16,GFX1264_DPP,GFX1264_DPP-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=+real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1232,GFX1232-TRUE16,GFX1232_DPP,GFX1232_DPP-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -mattr=-real-true16 -mattr=+wavefrontsize32 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1232,GFX1232-FAKE16,GFX1232_DPP,GFX1232_DPP-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu13.10 -mattr=+real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1364,GFX1364-TRUE16,GFX1364_DPP,GFX1364_DPP-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu13.10 -mattr=-real-true16 -mattr=+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1364,GFX1364-FAKE16,GFX1364_DPP,GFX1364_DPP-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu13.10 -mattr=+real-true16 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1332,GFX1332-TRUE16,GFX1332_DPP,GFX1332_DPP-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu13.10 -mattr=-real-true16 -mattr=-flat-for-global -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1332,GFX1332-FAKE16,GFX1332_DPP,GFX1332_DPP-FAKE16 %s
...
; GFX1132-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_mov_b32 v1, v2
...
; GFX1132_ITERATIVE-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_mov_b32 v1, v2
...
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
; GFX1132-NEXT:    v_mov_b32_e32 v2, v4
...
; GFX1364-NEXT:  .LBB19_2: ; %atomicrmw.end
; GFX1364-NEXT:    s_or_b64 exec, exec, s[2:3]
...
; GFX1332-NEXT:    s_and_b64 s[4:5], s[2:3], -4
; GFX1332-NEXT:    s_and_b32 s2, s2, 3
; GFX1332-NEXT:    s_load_b32 s3, s[4:5], 0x0
; GFX1332-NEXT:    s_lshl_b32 s9, s2, 3
; GFX1332-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1332-NEXT:    s_lshl_b32 s2, 0xffff, s9
; GFX1332-NEXT:    s_not_b32 s2, s2
; GFX1332-NEXT:    s_wait_kmcnt 0x0
...
; GFX1332-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1332-NEXT:    v_lshrrev_b32_e32 v0, s9, v1
; GFX1332-NEXT:    v_pk_add_bf16 v0, v0, s8
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1332-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX1332-NEXT:    v_lshlrev_b32_e32 v0, s9, v0
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1332-NEXT:    v_and_or_b32 v0, v1, s2, v0
; GFX1332-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, v0
; GFX1332-NEXT:    buffer_atomic_cmpswap_b32 v[2:3], off, s[4:7], null th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1332-NEXT:    s_wait_loadcnt 0x0
; GFX1332-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v2, v1
