...
; GFX1264-NEXT:  .LBB12_1: ; %atomicrmw.start
...
; GFX1264-NEXT:    s_cbranch_execnz .LBB12_1
...
; GFX1232-NEXT:  .LBB12_1: ; %atomicrmw.start
...
; GFX1232-NEXT:    s_cbranch_execnz .LBB12_1
...
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:  .LBB13_1: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, v2
; GFX7LESS-NEXT:    s_andn2_b64 exec, exec, s[8:9]
; GFX7LESS-NEXT:    s_cbranch_execnz .LBB13_1
; GFX7LESS-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
...
; GFX1064-NEXT:    v_mov_b32_e32 v1, s3
; GFX1064-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-NEXT:  .LBB13_1: ; %atomicrmw.start
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1064-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX1064-NEXT:    s_andn2_b64 exec, exec, s[2:3]
; GFX1064-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1064-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1064-NEXT:    s_or_b64 exec, exec, s[2:3]
...
; GFX1032-NEXT:    s_mov_b32 s6, -1
; GFX1032-NEXT:  .LBB13_1: ; %atomicrmw.start
; GFX1032-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1032-NEXT:    s_or_b32 s9, vcc_lo, s9
; GFX1032-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
; GFX1032-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1032-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1032-NEXT:    s_or_b32 exec_lo, exec_lo, s9
; GFX1032-NEXT:    v_lshrrev_b32_e32 v0, s2, v2
; GFX1032-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX1164-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, s8, v2
; GFX1164-TRUE16-NEXT:    v_add_f16_e32 v0.h, v1.l, v0.l
; GFX1164-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v0.h
; GFX1164-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX1164-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, s8, v1
; GFX1164-TRUE16-NEXT:    v_and_or_b32 v1, v2, s9, v1
; GFX1164-TRUE16-NEXT:    v_mov_b32_e32 v4, v2
; GFX1164-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1164-TRUE16-NEXT:    v_mov_b32_e32 v3, v1
; GFX1164-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[3:4], off, s[4:7], 0 glc
; GFX1164-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v2
; GFX1164-TRUE16-NEXT:    v_mov_b32_e32 v2, v3
...
; GFX1164-TRUE16-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1164-TRUE16-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1164-TRUE16-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1164-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s8, v3
...
; GFX1164-FAKE16-NEXT:  .LBB13_1: ; %atomicrmw.start
...
; GFX1164-FAKE16-NEXT:    s_cbranch_execnz .LBB13_1
...
; GFX1132-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, s2, v2
; GFX1132-TRUE16-NEXT:    v_add_f16_e32 v0.h, v1.l, v0.l
; GFX1132-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v0.h
; GFX1132-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX1132-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, s2, v1
; GFX1132-TRUE16-NEXT:    v_and_or_b32 v1, v2, s3, v1
; GFX1132-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-TRUE16-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v3, v1
; GFX1132-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[3:4], off, s[4:7], 0 glc
; GFX1132-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v2
; GFX1132-TRUE16-NEXT:    v_mov_b32_e32 v2, v3
...
; GFX1132-TRUE16-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1132-TRUE16-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1132-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; GFX1132-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s2, v3
...
; GFX1132-FAKE16-NEXT:  .LBB13_1: ; %atomicrmw.start
...
; GFX1132-FAKE16-NEXT:    s_cbranch_execnz .LBB13_1
...
; GFX1264-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, s8, v2
; GFX1264-TRUE16-NEXT:    v_add_f16_e32 v0.h, v1.l, v0.l
; GFX1264-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1264-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v0.h
; GFX1264-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX1264-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1264-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, s8, v1
; GFX1264-TRUE16-NEXT:    v_and_or_b32 v1, v2, s9, v1
; GFX1264-TRUE16-NEXT:    v_mov_b32_e32 v4, v2
; GFX1264-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1264-TRUE16-NEXT:    v_mov_b32_e32 v3, v1
; GFX1264-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[3:4], off, s[4:7], null th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1264-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1264-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v2
; GFX1264-TRUE16-NEXT:    v_mov_b32_e32 v2, v3
...
; GFX1264-TRUE16-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1264-TRUE16-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1264-TRUE16-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1264-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s8, v3
...
; GFX1264-FAKE16-NEXT:  .LBB13_1: ; %atomicrmw.start
...
; GFX1264-FAKE16-NEXT:    s_cbranch_execnz .LBB13_1
...
; GFX1232-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, s2, v2
; GFX1232-TRUE16-NEXT:    v_add_f16_e32 v0.h, v1.l, v0.l
; GFX1232-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1232-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v0.h
; GFX1232-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX1232-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1232-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, s2, v1
; GFX1232-TRUE16-NEXT:    v_and_or_b32 v1, v2, s3, v1
; GFX1232-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1232-TRUE16-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v3, v1
; GFX1232-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[3:4], off, s[4:7], null th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1232-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1232-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v2
; GFX1232-TRUE16-NEXT:    v_mov_b32_e32 v2, v3
...
; GFX1232-TRUE16-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1232-TRUE16-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1232-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; GFX1232-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s2, v3
...
; GFX1232-FAKE16-NEXT:  .LBB13_1: ; %atomicrmw.start
...
; GFX1232-FAKE16-NEXT:    s_cbranch_execnz .LBB13_1
...
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
; GFX7LESS-NEXT:    s_mov_b32 s5, s3
; GFX7LESS-NEXT:  .LBB16_1: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX7LESS-NEXT:    s_andn2_b64 exec, exec, s[8:9]
; GFX7LESS-NEXT:    s_cbranch_execnz .LBB16_1
; GFX7LESS-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
...
; GFX1064-NEXT:  .LBB16_1: ; %atomicrmw.start
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1064-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX1064-NEXT:    s_andn2_b64 exec, exec, s[2:3]
; GFX1064-NEXT:    s_cbranch_execnz .LBB16_1
; GFX1064-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1064-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1064-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1064-NEXT:    s_mov_b32 s10, -1
...
; GFX1032-NEXT:  .LBB16_1: ; %atomicrmw.start
; GFX1032-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1032-NEXT:    s_cbranch_execnz .LBB16_1
; GFX1032-NEXT:  ; %bb.2: ; %atomicrmw.end
...
; GFX1164-NEXT:    .p2align 6
; GFX1164-NEXT:  .LBB16_1: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_and_not1_b64 exec, exec, s[2:3]
; GFX1164-NEXT:    s_cbranch_execnz .LBB16_1
; GFX1164-NEXT:  ; %bb.2: ; %atomicrmw.end
...
; GFX1132-NEXT:    .p2align 6
; GFX1132-NEXT:  .LBB16_1: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1132-NEXT:    s_cbranch_execnz .LBB16_1
; GFX1132-NEXT:  ; %bb.2: ; %atomicrmw.end
