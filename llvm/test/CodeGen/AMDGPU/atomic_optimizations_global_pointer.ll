...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v5, 0
; GFX8_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_shr:2 row_mask:0xf bank_mask:0xf
; GFX8_DPP-NEXT:    v_mov_b32_dpp v6, v2 row_shr:2 row_mask:0xf bank_mask:0xf
; GFX8_DPP-NEXT:    v_add_u32_e32 v3, vcc, v3, v4
; GFX8_DPP-NEXT:    v_mov_b32_e32 v4, 0
; GFX8_DPP-NEXT:    v_addc_u32_e32 v2, vcc, v2, v6, vcc
; GFX8_DPP-NEXT:    s_nop 0
; GFX8_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_shr:4 row_mask:0xf bank_mask:0xf
; GFX8_DPP-NEXT:    v_mov_b32_dpp v5, v2 row_shr:4 row_mask:0xf bank_mask:0xf
; GFX8_DPP-NEXT:    v_add_u32_e32 v3, vcc, v3, v4
; GFX8_DPP-NEXT:    v_mov_b32_e32 v4, 0
; GFX8_DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX8_DPP-NEXT:    v_addc_u32_e32 v2, vcc, v2, v5, vcc
; GFX8_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_shr:8 row_mask:0xf bank_mask:0xf
; GFX8_DPP-NEXT:    s_nop 0
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v5, 0
; GFX8_DPP-NEXT:    v_addc_u32_e32 v2, vcc, v2, v6, vcc
; GFX8_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_bcast:15 row_mask:0xa bank_mask:0xf
; GFX8_DPP-NEXT:    s_nop 0
; GFX8_DPP-NEXT:    v_mov_b32_dpp v5, v2 row_bcast:15 row_mask:0xa bank_mask:0xf
; GFX8_DPP-NEXT:    v_add_u32_e32 v3, vcc, v3, v4
; GFX8_DPP-NEXT:    v_addc_u32_e32 v4, vcc, v2, v5, vcc
; GFX8_DPP-NEXT:    v_mov_b32_e32 v5, 0
; GFX8_DPP-NEXT:    v_mov_b32_e32 v6, 0
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, 0
; GFX9_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_shr:2 row_mask:0xf bank_mask:0xf
; GFX9_DPP-NEXT:    v_mov_b32_dpp v6, v2 row_shr:2 row_mask:0xf bank_mask:0xf
; GFX9_DPP-NEXT:    v_add_co_u32_e32 v3, vcc, v3, v4
; GFX9_DPP-NEXT:    v_mov_b32_e32 v4, 0
; GFX9_DPP-NEXT:    v_addc_co_u32_e32 v2, vcc, v2, v6, vcc
; GFX9_DPP-NEXT:    s_nop 0
; GFX9_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_shr:4 row_mask:0xf bank_mask:0xf
; GFX9_DPP-NEXT:    v_mov_b32_dpp v5, v2 row_shr:4 row_mask:0xf bank_mask:0xf
; GFX9_DPP-NEXT:    v_add_co_u32_e32 v3, vcc, v3, v4
; GFX9_DPP-NEXT:    v_mov_b32_e32 v4, 0
; GFX9_DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX9_DPP-NEXT:    v_addc_co_u32_e32 v2, vcc, v2, v5, vcc
; GFX9_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_shr:8 row_mask:0xf bank_mask:0xf
; GFX9_DPP-NEXT:    s_nop 0
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, 0
; GFX9_DPP-NEXT:    v_addc_co_u32_e32 v2, vcc, v2, v6, vcc
; GFX9_DPP-NEXT:    v_mov_b32_dpp v4, v3 row_bcast:15 row_mask:0xa bank_mask:0xf
; GFX9_DPP-NEXT:    s_nop 0
; GFX9_DPP-NEXT:    v_mov_b32_dpp v5, v2 row_bcast:15 row_mask:0xa bank_mask:0xf
; GFX9_DPP-NEXT:    v_add_co_u32_e32 v3, vcc, v3, v4
; GFX9_DPP-NEXT:    v_addc_co_u32_e32 v4, vcc, v2, v5, vcc
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, 0
; GFX9_DPP-NEXT:    v_mov_b32_e32 v6, 0
...
; GFX8_DPP-NEXT:    s_mov_b32 s4, s2
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8_DPP-NEXT:    v_mov_b32_e32 v7, s14
; GFX8_DPP-NEXT:    v_mov_b32_e32 v8, s15
; GFX8_DPP-NEXT:    s_mov_b32 s5, s3
...
; GFX8_DPP-NEXT:    v_subrev_u32_e32 v9, vcc, s10, v11
; GFX8_DPP-NEXT:    v_subb_u32_e32 v10, vcc, v12, v0, vcc
; GFX8_DPP-NEXT:    v_mov_b32_e32 v7, v9
; GFX8_DPP-NEXT:    v_mov_b32_e32 v8, v10
; GFX8_DPP-NEXT:    v_mov_b32_e32 v9, v11
; GFX8_DPP-NEXT:    v_mov_b32_e32 v10, v12
; GFX8_DPP-NEXT:    buffer_atomic_cmpswap_x2 v[7:10], off, s[4:7], 0 glc
; GFX8_DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX8_DPP-NEXT:    buffer_wbinvl1_vol
; GFX8_DPP-NEXT:    v_cmp_eq_u64_e32 vcc, v[7:8], v[11:12]
...
; GFX9_DPP-NEXT:    s_mov_b32 s4, s2
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9_DPP-NEXT:    v_mov_b32_e32 v7, s14
; GFX9_DPP-NEXT:    v_mov_b32_e32 v8, s15
; GFX9_DPP-NEXT:    s_mov_b32 s5, s3
...
; GFX9_DPP-NEXT:    v_subrev_co_u32_e32 v9, vcc, s10, v11
; GFX9_DPP-NEXT:    v_subb_co_u32_e32 v10, vcc, v12, v0, vcc
; GFX9_DPP-NEXT:    v_mov_b32_e32 v8, v10
; GFX9_DPP-NEXT:    v_swap_b32 v7, v9
; GFX9_DPP-NEXT:    v_mov_b32_e32 v10, v12
; GFX9_DPP-NEXT:    buffer_atomic_cmpswap_x2 v[7:10], off, s[4:7], 0 glc
; GFX9_DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9_DPP-NEXT:    buffer_wbinvl1_vol
; GFX9_DPP-NEXT:    v_cmp_eq_u64_e32 vcc, v[7:8], v[11:12]
