...
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s10, s[6:7]
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:    s_mul_i32 s10, s10, 5
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
...
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_subrev_i32_e32 v1, vcc, s10, v2
...
; GFX8-NEXT:    v_subrev_u32_e32 v1, vcc, s10, v2
...
; GFX9-NEXT:    v_subrev_u32_e32 v1, s10, v2
...
; GFX1064-NEXT:    s_bcnt1_i32_b64 s10, s[6:7]
; GFX1064-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064-NEXT:    s_mul_i32 s10, s10, 5
; GFX1064-NEXT:    s_mov_b32 s6, -1
; GFX1064-NEXT:    s_mov_b32 s5, s3
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    v_subrev_nc_u32_e32 v1, s10, v2
...
; GFX1164-NEXT:    s_bcnt1_i32_b64 s10, s[6:7]
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mul_i32 s10, s10, 5
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_mov_b32 s5, s3
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    v_subrev_nc_u32_e32 v1, s10, v2
...
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:    s_mul_i32 s11, s10, s5
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
; GFX7LESS-NEXT:    s_mov_b32 s5, s3
...
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_subrev_i32_e32 v1, vcc, s11, v2
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, v1
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, v2
; GFX7LESS-NEXT:    buffer_atomic_cmpswap v[0:1], off, s[4:7], 0 glc
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
...
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX7LESS-NEXT:    s_waitcnt expcnt(0) lgkmcnt(0)
; GFX7LESS-NEXT:    v_mul_lo_u32 v1, s10, v3
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
...
; GFX8-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mul_lo_u32 v1, s10, v3
; GFX8-NEXT:    v_readfirstlane_b32 s4, v0
; GFX8-NEXT:    s_mov_b32 s3, 0xf000
; GFX8-NEXT:    s_mov_b32 s2, -1
...
; GFX9-NEXT:    s_mov_b32 s7, 0xf000
; GFX9-NEXT:    s_mov_b32 s6, -1
; GFX9-NEXT:    s_mul_i32 s11, s10, s5
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-NEXT:    s_mov_b32 s4, s2
; GFX9-NEXT:    s_mov_b32 s5, s3
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_subrev_u32_e32 v1, s11, v2
; GFX9-NEXT:    v_mov_b32_e32 v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, v2
; GFX9-NEXT:    buffer_atomic_cmpswap v[0:1], off, s[4:7], 0 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mul_lo_u32 v1, s10, v3
; GFX9-NEXT:    v_readfirstlane_b32 s4, v0
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_mov_b32 s2, -1
...
; GFX1064-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064-NEXT:    s_mul_i32 s11, s10, s5
; GFX1064-NEXT:    s_mov_b32 s6, -1
; GFX1064-NEXT:    s_mov_b32 s5, s3
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    v_mov_b32_e32 v2, s4
...
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-NEXT:    v_subrev_nc_u32_e32 v1, s11, v2
; GFX1064-NEXT:    v_mov_b32_e32 v0, v1
; GFX1064-NEXT:    v_mov_b32_e32 v1, v2
; GFX1064-NEXT:    buffer_atomic_cmpswap v[0:1], off, s[4:7], 0 glc
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1064-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    v_mul_lo_u32 v1, s10, v3
; GFX1064-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1064-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX1164-NEXT:    s_bcnt1_i32_b64 s5, s[6:7]
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mul_i32 s11, s10, s5
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_mov_b32 s5, s3
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_mov_b32_e32 v2, s4
...
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-NEXT:    v_subrev_nc_u32_e32 v1, s11, v2
; GFX1164-NEXT:    v_mov_b32_e32 v0, v1
; GFX1164-NEXT:    v_mov_b32_e32 v1, v2
; GFX1164-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], off, s[4:7], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1164-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_mul_lo_u32 v1, s10, v3
; GFX1164-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1164-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[2:3], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v3, s10, m0
; GFX7LESS_ITERATIVE-NEXT:    s_add_i32 s10, s10, s6
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[2:3]
...
; GFX7LESS_ITERATIVE-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS_ITERATIVE-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS_ITERATIVE-NEXT:    v_subrev_i32_e32 v1, vcc, s10, v2
...
; GFX8_ITERATIVE-NEXT:    s_mov_b32 m0, s2
; GFX8_ITERATIVE-NEXT:    v_readlane_b32 s3, v0, s2
; GFX8_ITERATIVE-NEXT:    v_writelane_b32 v3, s10, m0
...
; GFX8_ITERATIVE-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8_ITERATIVE-NEXT:    v_subrev_u32_e32 v1, vcc, s10, v2
...
; GFX9_ITERATIVE-NEXT:    s_mov_b32 m0, s2
; GFX9_ITERATIVE-NEXT:    v_readlane_b32 s3, v0, s2
; GFX9_ITERATIVE-NEXT:    v_writelane_b32 v3, s10, m0
...
; GFX9_ITERATIVE-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9_ITERATIVE-NEXT:    v_subrev_u32_e32 v1, s10, v2
...
; GFX1064_ITERATIVE-NEXT:    v_writelane_b32 v3, s10, s2
; GFX1064_ITERATIVE-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX1064_ITERATIVE-NEXT:    s_add_i32 s10, s10, s6
; GFX1064_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
...
; GFX1064_ITERATIVE-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064_ITERATIVE-NEXT:    v_subrev_nc_u32_e32 v1, s10, v2
...
; GFX1164_ITERATIVE-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX1164_ITERATIVE-NEXT:    s_add_i32 s10, s10, s6
; GFX1164_ITERATIVE-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[2:3]
...
; GFX1164_ITERATIVE-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164_ITERATIVE-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164_ITERATIVE-NEXT:    v_subrev_nc_u32_e32 v1, s10, v2
...
; GFX8_DPP-NEXT:    s_nop 1
; GFX8_DPP-NEXT:    v_add_u32_dpp v2, vcc, v2, v2 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX8_DPP-NEXT:    v_readlane_b32 s10, v2, 63
; GFX8_DPP-NEXT:    s_nop 0
; GFX8_DPP-NEXT:    v_mov_b32_dpp v1, v2 wave_shr:1 row_mask:0xf bank_mask:0xf
; GFX8_DPP-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX8_DPP-NEXT:    v_subrev_u32_e32 v4, vcc, s10, v5
...
; GFX9_DPP-NEXT:    s_nop 1
; GFX9_DPP-NEXT:    v_add_u32_dpp v2, v2, v2 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9_DPP-NEXT:    v_readlane_b32 s10, v2, 63
; GFX9_DPP-NEXT:    s_nop 0
; GFX9_DPP-NEXT:    v_mov_b32_dpp v1, v2 wave_shr:1 row_mask:0xf bank_mask:0xf
; GFX9_DPP-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX9_DPP-NEXT:    v_subrev_u32_e32 v4, s10, v5
...
; GFX1064_DPP-NEXT:    v_subrev_nc_u32_e32 v5, s10, v6
...
; GFX1164_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1164_DPP-NEXT:    v_readlane_b32 s6, v1, 47
; GFX1164_DPP-NEXT:    v_readlane_b32 s10, v1, 63
; GFX1164_DPP-NEXT:    v_writelane_b32 v3, s7, 32
; GFX1164_DPP-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164_DPP-NEXT:    v_subrev_nc_u32_e32 v5, s10, v6
...
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_subrev_i32_e32 v2, vcc, s10, v4
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    v_subrev_u32_e32 v2, vcc, s10, v4
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_subrev_co_u32_e32 v2, vcc, s10, v4
...
; GFX1064-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064-NEXT:    s_mul_i32 s10, s6, 5
; GFX1064-NEXT:    s_mov_b32 s6, -1
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-NEXT:    v_sub_co_u32 v2, vcc, v4, s10
...
; GFX1164-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mul_i32 s10, s6, 5
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    v_sub_co_u32 v2, vcc, v4, s10
...
; GFX1064-NEXT:    s_mul_hi_u32 s13, s8, s6
; GFX1064-NEXT:    s_mul_i32 s12, s8, s6
; GFX1064-NEXT:    s_add_i32 s13, s13, s7
; GFX1064-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064-NEXT:    s_mov_b32 s6, -1
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX1064-NEXT:    v_subrev_co_ci_u32_e32 v3, vcc, s13, v5, vcc
; GFX1064-NEXT:    v_mov_b32_e32 v0, v2
; GFX1064-NEXT:    v_mov_b32_e32 v1, v3
; GFX1064-NEXT:    v_mov_b32_e32 v2, v4
; GFX1064-NEXT:    v_mov_b32_e32 v3, v5
...
; GFX1032-NEXT:    s_mul_hi_u32 s12, s8, s6
; GFX1032-NEXT:    s_mul_i32 s11, s8, s6
; GFX1032-NEXT:    s_add_i32 s12, s12, s7
; GFX1032-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032-NEXT:    s_mov_b32 s6, -1
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX1164-NEXT:    s_mul_hi_u32 s13, s8, s6
; GFX1164-NEXT:    s_mul_i32 s12, s8, s6
; GFX1164-NEXT:    s_add_i32 s13, s13, s7
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX1164-NEXT:    v_subrev_co_ci_u32_e64 v3, null, s13, v5, vcc
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_mov_b32_e32 v0, v2
; GFX1164-NEXT:    v_mov_b32_e32 v1, v3
; GFX1164-NEXT:    v_mov_b32_e32 v2, v4
...
; GFX1132-NEXT:    s_mul_hi_u32 s12, s8, s6
; GFX1132-NEXT:    s_mul_i32 s11, s8, s6
; GFX1132-NEXT:    s_add_i32 s12, s12, s7
; GFX1132-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132-NEXT:    s_mov_b32 s6, -1
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v5, s5
...
; GFX7LESS_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS_ITERATIVE-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x0
; GFX7LESS_ITERATIVE-NEXT:    v_mov_b32_e32 v8, s9
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s6, -1
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s4, s2
; GFX7LESS_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s12
; GFX7LESS_ITERATIVE-NEXT:    v_mov_b32_e32 v5, s13
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s5, s3
...
; GFX8_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8_ITERATIVE-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x0
; GFX8_ITERATIVE-NEXT:    v_mov_b32_e32 v8, s9
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s7, 0xf000
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s6, -1
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s4, s2
; GFX8_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s12
; GFX8_ITERATIVE-NEXT:    v_mov_b32_e32 v5, s13
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s5, s3
...
; GFX9_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9_ITERATIVE-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x0
; GFX9_ITERATIVE-NEXT:    v_mov_b32_e32 v8, s9
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s7, 0xf000
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s6, -1
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s4, s2
; GFX9_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s12
; GFX9_ITERATIVE-NEXT:    v_mov_b32_e32 v5, s13
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s5, s3
...
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8_DPP-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x0
; GFX8_DPP-NEXT:    s_mov_b32 s7, 0xf000
; GFX8_DPP-NEXT:    s_mov_b32 s6, -1
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, s11
; GFX8_DPP-NEXT:    s_mov_b32 s4, s2
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8_DPP-NEXT:    v_mov_b32_e32 v10, s12
; GFX8_DPP-NEXT:    v_mov_b32_e32 v11, s13
; GFX8_DPP-NEXT:    s_mov_b32 s5, s3
...
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9_DPP-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x0
; GFX9_DPP-NEXT:    s_mov_b32 s7, 0xf000
; GFX9_DPP-NEXT:    s_mov_b32 s6, -1
; GFX9_DPP-NEXT:    s_mov_b32 s4, s2
; GFX9_DPP-NEXT:    s_mov_b32 s5, s3
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9_DPP-NEXT:    v_mov_b32_e32 v10, s12
; GFX9_DPP-NEXT:    v_mov_b32_e32 v11, s13
