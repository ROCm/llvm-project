...
; RUN: llc -filetype=obj -mtriple=amdgcn -mcpu=gfx125f < %s | llvm-readobj --file-header - | FileCheck --check-prefixes=ALL,ARCH-GCN,GFX125F %s
...
; GFX125F:       EF_AMDGPU_MACH_AMDGCN_GFX125F (0xEB)
