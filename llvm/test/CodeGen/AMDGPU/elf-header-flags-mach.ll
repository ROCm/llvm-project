...
; RUN: llc -filetype=obj -mtriple=amdgpu12.50s -mcpu=gfx1250-strict < %s | llvm-readobj --file-header - | FileCheck --check-prefixes=ALL,ARCH-GCN,GFX1250-STRICT %s
...
; GFX1250-STRICT: EF_AMDGPU_MACH_AMDGCN_GFX1250_STRICT (0xEB)
