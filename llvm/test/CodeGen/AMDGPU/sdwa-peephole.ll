...
; NOSDWA:       ; %bb.0: ; %entry
; NOSDWA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; NOSDWA-NEXT:    s_mov_b32 s4, 0x706050c
; NOSDWA-NEXT:    s_waitcnt lgkmcnt(0)
; NOSDWA-NEXT:    v_mov_b32_e32 v0, s0
; NOSDWA-NEXT:    v_mov_b32_e32 v1, s1
; NOSDWA-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; NOSDWA-NEXT:    s_mov_b32 s0, 0xc0c0104
; NOSDWA-NEXT:    s_mov_b32 s1, 0x7060c0c
; NOSDWA-NEXT:    v_mov_b32_e32 v2, s2
; NOSDWA-NEXT:    v_mov_b32_e32 v3, s3
; NOSDWA-NEXT:    s_waitcnt vmcnt(0)
; NOSDWA-NEXT:    v_perm_b32 v4, v0, v0, s0
; NOSDWA-NEXT:    v_perm_b32 v0, v0, v0, s1
; NOSDWA-NEXT:    v_perm_b32 v5, v1, v1, s4
; NOSDWA-NEXT:    v_and_b32_e32 v6, 0xff, v1
; NOSDWA-NEXT:    v_or_b32_e32 v0, v4, v0
; NOSDWA-NEXT:    v_or_b32_e32 v4, v6, v5
; NOSDWA-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; NOSDWA-NEXT:    v_perm_b32 v1, v1, v1, s1
...
; GFX89:       ; %bb.0: ; %entry
; GFX89-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s4, 0x706050c
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; GFX89-NEXT:    s_mov_b32 s0, 0xc0c0104
; GFX89-NEXT:    s_mov_b32 s1, 0x7060c0c
; GFX89-NEXT:    v_mov_b32_e32 v2, s2
; GFX89-NEXT:    v_mov_b32_e32 v3, s3
; GFX89-NEXT:    s_waitcnt vmcnt(0)
; GFX89-NEXT:    v_perm_b32 v4, v0, v0, s0
; GFX89-NEXT:    v_perm_b32 v0, v0, v0, s1
; GFX89-NEXT:    v_perm_b32 v5, v1, v1, s4
; GFX89-NEXT:    v_or_b32_e32 v0, v4, v0
; GFX89-NEXT:    v_or_b32_sdwa v4, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX89-NEXT:    v_perm_b32 v1, v1, v1, s1
; GFX89-NEXT:    v_or_b32_sdwa v1, v4, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; GFX9-NEXT:    s_mov_b32 s4, 0x706050c
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dwordx2 v[0:1], v2, s[0:1]
; GFX9-NEXT:    s_mov_b32 s0, 0xc0c0104
; GFX9-NEXT:    s_mov_b32 s1, 0x7060c0c
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_perm_b32 v3, v0, v0, s0
; GFX9-NEXT:    v_perm_b32 v0, v0, v0, s1
; GFX9-NEXT:    v_perm_b32 v4, v1, v1, s4
; GFX9-NEXT:    v_or_b32_e32 v0, v3, v0
; GFX9-NEXT:    v_or_b32_sdwa v3, v1, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_perm_b32 v1, v1, v1, s1
...
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_perm_b32 v3, v1, v1, 0x706050c
; GFX10-NEXT:    v_perm_b32 v4, v0, v0, 0xc0c0104
; GFX10-NEXT:    v_perm_b32 v0, v0, v0, 0x7060c0c
; GFX10-NEXT:    v_or_b32_sdwa v3, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX10-NEXT:    v_perm_b32 v1, v1, v1, 0x7060c0c
