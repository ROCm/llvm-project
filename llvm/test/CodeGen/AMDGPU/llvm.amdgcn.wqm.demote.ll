...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize32 < %s | FileCheck -check-prefixes=GFX10-32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10-64 %s
...
; GFX10-64-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
...
; SI-NEXT:    v_cmp_gt_f32_e32 vcc, 0, v1
; SI-NEXT:    s_xor_b64 s[14:15], vcc, exec
; SI-NEXT:    s_mov_b64 exec, s[14:15]
; SI-NEXT:    ; divergent control-flow edge
; SI-NEXT:    s_cbranch_execz .LBB3_3
; SI-NEXT:  .LBB3_1: ; %.demote
...
; GFX10-32-NEXT:    v_cmp_gt_f32_e32 vcc_lo, 0, v1
; GFX10-32-NEXT:    s_xor_b32 s13, vcc_lo, exec_lo
; GFX10-32-NEXT:    s_mov_b32 exec_lo, s13
; GFX10-32-NEXT:    ; divergent control-flow edge
; GFX10-32-NEXT:    s_cbranch_execz .LBB3_3
; GFX10-32-NEXT:  .LBB3_1: ; %.demote
...
; GFX10-64-NEXT:    v_cmp_gt_f32_e32 vcc, 0, v1
; GFX10-64-NEXT:    s_xor_b64 s[14:15], vcc, exec
; GFX10-64-NEXT:    s_mov_b64 exec, s[14:15]
; GFX10-64-NEXT:    ; divergent control-flow edge
; GFX10-64-NEXT:    s_cbranch_execz .LBB3_3
; GFX10-64-NEXT:  .LBB3_1: ; %.demote
...
; SI-NEXT:  .LBB6_1: ; %.demote0
; SI-NEXT:    s_andn2_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cbranch_scc0 .LBB6_7
; SI-NEXT:  ; %bb.2: ; %.demote0
; SI-NEXT:    s_wqm_b64 s[2:3], s[0:1]
; SI-NEXT:    s_and_b64 exec, exec, s[2:3]
...
; SI-NEXT:    s_xor_b64 exec, s[2:3], exec
; SI-NEXT:    ; divergent control-flow edge
; SI-NEXT:    s_cbranch_execz .LBB6_6
; SI-NEXT:  .LBB6_4: ; %.demote1
; SI-NEXT:    s_andn2_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cbranch_scc0 .LBB6_7
...
; GFX9-NEXT:  .LBB6_1: ; %.demote0
; GFX9-NEXT:    s_andn2_b64 s[0:1], s[0:1], exec
; GFX9-NEXT:    s_cbranch_scc0 .LBB6_7
; GFX9-NEXT:  ; %bb.2: ; %.demote0
; GFX9-NEXT:    s_wqm_b64 s[2:3], s[0:1]
; GFX9-NEXT:    s_and_b64 exec, exec, s[2:3]
...
; GFX9-NEXT:    s_xor_b64 exec, s[2:3], exec
; GFX9-NEXT:    ; divergent control-flow edge
; GFX9-NEXT:    s_cbranch_execz .LBB6_6
; GFX9-NEXT:  .LBB6_4: ; %.demote1
; GFX9-NEXT:    s_andn2_b64 s[0:1], s[0:1], exec
; GFX9-NEXT:    s_cbranch_scc0 .LBB6_7
...
; GFX10-32-NEXT:    s_xor_b32 exec_lo, s1, exec_lo
; GFX10-32-NEXT:    ; divergent control-flow edge
; GFX10-32-NEXT:    s_cbranch_execz .LBB6_6
; GFX10-32-NEXT:  .LBB6_4: ; %.demote1
; GFX10-32-NEXT:    s_andn2_b32 s0, s0, exec_lo
; GFX10-32-NEXT:    s_cbranch_scc0 .LBB6_7
...
; GFX10-64-NEXT:  .LBB6_1: ; %.demote0
; GFX10-64-NEXT:    s_andn2_b64 s[0:1], s[0:1], exec
; GFX10-64-NEXT:    s_cbranch_scc0 .LBB6_7
; GFX10-64-NEXT:  ; %bb.2: ; %.demote0
; GFX10-64-NEXT:    s_wqm_b64 s[2:3], s[0:1]
; GFX10-64-NEXT:    s_and_b64 exec, exec, s[2:3]
...
; GFX10-64-NEXT:    s_xor_b64 exec, s[2:3], exec
; GFX10-64-NEXT:    ; divergent control-flow edge
; GFX10-64-NEXT:    s_cbranch_execz .LBB6_6
; GFX10-64-NEXT:  .LBB6_4: ; %.demote1
; GFX10-64-NEXT:    s_andn2_b64 s[0:1], s[0:1], exec
; GFX10-64-NEXT:    s_cbranch_scc0 .LBB6_7
...
; SI-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SI-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
...
; GFX9-NEXT:    v_cmp_lt_i32_e32 vcc, s6, v1
...
; GFX10-32-NEXT:    s_add_i32 s1, s1, 1
; GFX10-32-NEXT:    v_cmp_lt_i32_e32 vcc_lo, s1, v1
; GFX10-32-NEXT:    s_xor_b32 s3, exec_lo, vcc_lo
; GFX10-32-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX10-32-NEXT:    s_or_b32 s2, s2, s3
; GFX10-32-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX10-32-NEXT:    ; divergent control-flow edge
; GFX10-32-NEXT:    s_cbranch_execz .LBB7_8
; GFX10-32-NEXT:  .LBB7_5: ; %.continue0
; GFX10-32-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-32-NEXT:    v_cndmask_b32_e64 v0, s1, 0, s0
...
; GFX10-64-NEXT:    v_cmp_lt_i32_e32 vcc, s6, v1
; GFX10-64-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GFX10-64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX10-64-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; GFX10-64-NEXT:    s_mov_b64 exec, vcc
; GFX10-64-NEXT:    ; divergent control-flow edge
; GFX10-64-NEXT:    s_cbranch_execz .LBB7_8
; GFX10-64-NEXT:  .LBB7_5: ; %.continue0
; GFX10-64-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-64-NEXT:    v_cndmask_b32_e64 v0, s6, 0, s[0:1]
