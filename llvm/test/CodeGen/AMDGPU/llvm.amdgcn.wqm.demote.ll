...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32 < %s | FileCheck -check-prefixes=GFX10-32 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10-64 %s
...
; SI-NEXT:    s_and_saveexec_b64 s[14:15], s[14:15]
...
; GFX10-32-NEXT:    s_and_saveexec_b32 s13, s13
...
; SI-NEXT:    v_cmp_lt_i32_e32 vcc, s8, v1
...
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX9-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX9-NEXT:    s_and_saveexec_b64 s[6:7], s[2:3]
...
; GFX9-NEXT:    v_cmp_lt_i32_e32 vcc, s8, v1
...
; GFX10-32-NEXT:    s_and_saveexec_b32 s4, s2
...
; GFX10-64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX10-64-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX10-64-NEXT:    s_and_saveexec_b64 s[6:7], s[2:3]
...
; GFX10-64-NEXT:    v_cmp_lt_i32_e32 vcc, s8, v1
...
; GFX10-64-NEXT:    v_cndmask_b32_e64 v0, s8, 0, s[0:1]
