...
; RUN: llc -amdgpu-late-wave-transform=1 < %s | FileCheck %s -check-prefix=ISA
...
; ISA-NEXT:    ; implicit-def: $sgpr11
; ISA-NEXT:    ; implicit-def: $vgpr2
; ISA-NEXT:    ; implicit-def: $vgpr2
...
; ISA-NEXT:    ; in Loop: Header=BB0_4 Depth=1
; ISA-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[2:3]
...
; ISA-NEXT:    s_xor_b64 s[0:1], exec, vcc
; ISA-NEXT:    s_mov_b64 exec, vcc
; ISA-NEXT:    ; divergent control-flow edge
; ISA-NEXT:    s_cbranch_execz .LBB0_9
; ISA-NEXT:  .LBB0_8: ; %if1
; ISA-NEXT:    v_sqrt_f32_e32 v1, v0
; ISA-NEXT:  .LBB0_9: ; %endloop
...
; ISA-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v1
; ISA-NEXT:    s_cbranch_scc0 .LBB1_1
; ISA-NEXT:  ; %bb.3: ; %endif1
; ISA-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; ISA-NEXT:    s_mov_b64 s[4:5], 0
; ISA-NEXT:    v_mov_b32_e32 v1, v0
