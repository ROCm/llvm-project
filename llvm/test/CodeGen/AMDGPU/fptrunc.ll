...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -check-prefixes=SI %s
...
; GFX10-SDAG-NEXT:    s_cselect_b32 s4, s2, s4
...
; GFX11-SDAG-NEXT:    s_cselect_b32 s4, s2, s4
