...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -global-isel=0 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI-SDAG,VI-SAFE-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=tonga -global-isel=1 -new-reg-bank-select -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI-GISEL,VI-SAFE-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -global-isel=0 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI-SDAG,VI-UNSAFE-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1030 -global-isel=0 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX10-SDAG,GFX10-SAFE-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1030 -global-isel=1 -new-reg-bank-select -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX10-GISEL,GFX10-SAFE-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1030 -global-isel=0 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX10-SDAG,GFX10-UNSAFE-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11-SDAG,GFX11-SAFE-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -new-reg-bank-select -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11-GISEL,GFX11-SAFE-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -check-prefixes=GFX11-SDAG,GFX11-UNSAFE-SDAG-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -check-prefixes=GFX11-SDAG,GFX11-UNSAFE-SDAG-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -new-reg-bank-select -mattr=-flat-for-global,+real-true16 < %s | FileCheck -check-prefixes=GFX11-GISEL,GFX11-UNSAFE-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -new-reg-bank-select -mattr=-flat-for-global,-real-true16 < %s | FileCheck -check-prefixes=GFX11-GISEL,GFX11-UNSAFE-GISEL-FAKE16 %s
...
; VI-SDAG-NEXT:    s_mov_b32 s4, 0xf000
; VI-SDAG-NEXT:    s_mov_b32 s5, -1
; VI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v0, s[2:3]
; VI-SDAG-NEXT:    s_mov_b32 s2, s5
; VI-SDAG-NEXT:    s_mov_b32 s3, s4
...
; SI-NEXT:    s_movk_i32 s8, 0x7e00
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_lshr_b32 s0, s7, 8
; SI-NEXT:    s_and_b32 s1, s7, 0x1ff
; SI-NEXT:    s_and_b32 s9, s0, 0xffe
...
; GFX10-SDAG-NEXT:    s_lshr_b32 s2, s3, 16
; GFX10-SDAG-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-SDAG-NEXT:    s_and_b32 s5, s2, 0x8000
; GFX10-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX10-SDAG-NEXT:    s_or_b32 s4, s5, s4
...
; GFX11-SDAG-NEXT:    s_cselect_b32 s4, s4, s5
; GFX11-SDAG-NEXT:    s_lshr_b32 s2, s3, 16
; GFX11-SDAG-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-SDAG-NEXT:    s_and_b32 s5, s2, 0x8000
; GFX11-SDAG-NEXT:    s_mov_b32 s2, -1
; GFX11-SDAG-NEXT:    s_or_b32 s4, s5, s4
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-SDAG-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x34
; VI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; VI-SDAG-NEXT:    s_mov_b32 s2, -1
; VI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-SDAG:       ; %bb.0:
; VI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-SDAG-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x54
; VI-SDAG-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x44
; VI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; VI-SDAG-NEXT:    s_mov_b32 s2, -1
; VI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    v_cvt_f32_f64_e32 v3, s[6:7]
; SI-NEXT:    v_cvt_f32_f64_e32 v2, s[4:5]
...
; VI-SDAG:       ; %bb.0:
; VI-SDAG-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x24
; VI-SDAG-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x44
; VI-SDAG-NEXT:    s_mov_b32 s11, 0xf000
; VI-SDAG-NEXT:    s_mov_b32 s10, -1
; VI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v3, s[6:7]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v2, s[4:5]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v1, s[2:3]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v0, s[0:1]
; VI-SDAG-NEXT:    buffer_store_dwordx4 v[0:3], off, s[8:11], 0
; VI-SDAG-NEXT:    s_endpgm
;
...
; SI-NEXT:    v_cvt_f32_f64_e32 v1, s[2:3]
; SI-NEXT:    v_cvt_f32_f64_e32 v0, s[0:1]
; SI-NEXT:    v_cvt_f32_f64_e32 v7, s[14:15]
; SI-NEXT:    v_cvt_f32_f64_e32 v6, s[12:13]
; SI-NEXT:    v_cvt_f32_f64_e32 v5, s[10:11]
; SI-NEXT:    v_cvt_f32_f64_e32 v4, s[8:9]
...
; VI-SDAG:       ; %bb.0:
; VI-SDAG-NEXT:    s_load_dwordx2 s[16:17], s[4:5], 0x24
; VI-SDAG-NEXT:    s_load_dwordx16 s[0:15], s[4:5], 0x64
; VI-SDAG-NEXT:    s_mov_b32 s19, 0xf000
; VI-SDAG-NEXT:    s_mov_b32 s18, -1
; VI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v7, s[14:15]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v6, s[12:13]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v5, s[10:11]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v4, s[8:9]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v3, s[6:7]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v2, s[4:5]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v1, s[2:3]
; VI-SDAG-NEXT:    v_cvt_f32_f64_e32 v0, s[0:1]
; VI-SDAG-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:16
; VI-SDAG-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0
; VI-SDAG-NEXT:    s_endpgm
;
