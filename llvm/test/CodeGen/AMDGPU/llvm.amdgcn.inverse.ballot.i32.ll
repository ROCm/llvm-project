...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=1 < %s | FileCheck  -check-prefixes=GFX11,GISEL %s
...
; RUN: not llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -global-isel=1 < %s 2>&1 | FileCheck  -check-prefix=GISEL-ERR %s
