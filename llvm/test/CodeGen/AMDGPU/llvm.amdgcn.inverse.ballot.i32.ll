...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=1 < %s | FileCheck  -check-prefixes=GFX11,GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize32 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX11,SDAG %s

; RUN: not llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -global-isel=1 < %s 2>&1 | FileCheck  -check-prefix=GISEL-ERR %s
...
; GFX11-LABEL: inverse_ballot_branch:
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    v_mov_b32_e32 v2, s0
; GFX11-NEXT:    s_and_b32 s1, exec_lo, s1
; GFX11-NEXT:    s_xor_b32 exec_lo, s1, exec_lo
; GFX11-NEXT:    ; divergent control-flow edge
; GFX11-NEXT:    s_cbranch_execz .LBB6_2
; GFX11-NEXT:  .LBB6_1: ; %if
; GFX11-NEXT:    s_add_i32 s0, s0, 1
; GFX11-NEXT:    v_mov_b32_e32 v2, s0
; GFX11-NEXT:  .LBB6_2: ; %endif
