...
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu6.00 -mattr=+mad-mac-f32-insts  < %s | FileCheck --check-prefix=SI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu7.04 < %s | FileCheck --check-prefix=CI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu8.02 < %s | FileCheck --check-prefix=VI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu9.00 < %s | FileCheck --check-prefix=GFX9 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu10.10 < %s | FileCheck --check-prefix=GFX10 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu11.50 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX1150,GFX1150-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu11.50 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX1150,GFX1150-FAKE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu12.00 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX1200,GFX1200-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgpu12.00 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX1200,GFX1200-FAKE16 %s
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v4, -10, v6
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v4, v7, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v2, s1
...
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr7
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr7
...
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v4, -10, v6
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v4, v7, v4
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr7
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr7
...
; GFX1200-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v2, s1
...
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr7
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr7
...
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v4, -10, v6
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v4, v7, v4
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr7
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr7
...
; GFX1150-NEXT:    ; implicit-def: $vgpr8
; GFX1150-NEXT:    ; implicit-def: $vgpr8
...
; GFX1200-NEXT:    ; implicit-def: $vgpr8
; GFX1200-NEXT:    ; implicit-def: $vgpr8
...
; CI-NEXT:    ; implicit-def: $vgpr14_vgpr15
; CI-NEXT:    ; implicit-def: $vgpr14
...
; VI-NEXT:    ; implicit-def: $vgpr14_vgpr15
...
; GFX9-NEXT:    ; implicit-def: $vgpr14_vgpr15
...
; GFX1200-NEXT:    ; implicit-def: $vgpr10
...
; GFX11-TRUE16-NEXT:    s_cbranch_vccz .LBB9_13
; GFX11-TRUE16-NEXT:  ; %bb.9: ; %frem.compute
...
; GFX11-TRUE16-NEXT:    s_cbranch_vccnz .LBB9_14
; GFX11-TRUE16-NEXT:  ; %bb.10: ; %frem.loop_body.preheader
; GFX11-TRUE16-NEXT:    s_sub_i32 s2, s2, s3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_add_i32 s2, s2, 11
; GFX11-TRUE16-NEXT:  .LBB9_11: ; %frem.loop_body
; GFX11-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX11-TRUE16-NEXT:  ; %bb.12:
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v9, s2
; GFX11-TRUE16-NEXT:    s_branch .LBB9_15
; GFX11-TRUE16-NEXT:  .LBB9_13: ; %frem.else
...
; GFX11-TRUE16-NEXT:  .LBB9_14:
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v10, v7
; GFX11-TRUE16-NEXT:  .LBB9_15: ; %frem.loop_exit
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v7, -10, v9
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v7, v10, v7
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-TRUE16-NEXT:    s_denorm_mode 12
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr5
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr5
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v2, -10, v4
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v2, v5, v2
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-TRUE16-NEXT:    s_and_b32 s8, s5, 0x7fff
; GFX1150-TRUE16-NEXT:    s_cvt_f32_f16 s7, s4
; GFX1150-TRUE16-NEXT:    s_cvt_f32_f16 s8, s8
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr1
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-TRUE16-NEXT:    s_cmp_gt_f32 s7, s8
; GFX1150-TRUE16-NEXT:    s_cbranch_scc0 .LBB9_13
; GFX1150-TRUE16-NEXT:  ; %bb.9: ; %frem.compute
...
; GFX1150-TRUE16-NEXT:    s_denorm_mode 12
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr6
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr6
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1150-TRUE16-NEXT:    s_cbranch_vccnz .LBB9_14
; GFX1150-TRUE16-NEXT:  ; %bb.10: ; %frem.loop_body.preheader
; GFX1150-TRUE16-NEXT:    s_sub_i32 s7, s7, s8
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-TRUE16-NEXT:    s_add_i32 s7, s7, 11
; GFX1150-TRUE16-NEXT:  .LBB9_11: ; %frem.loop_body
; GFX1150-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX1150-TRUE16-NEXT:    s_cbranch_scc1 .LBB9_11
; GFX1150-TRUE16-NEXT:  ; %bb.12:
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v5, s7
; GFX1150-TRUE16-NEXT:    s_branch .LBB9_15
; GFX1150-TRUE16-NEXT:  .LBB9_13: ; %frem.else
; GFX1150-TRUE16-NEXT:    s_cmp_eq_f32 s7, s8
...
; GFX1150-TRUE16-NEXT:  .LBB9_14:
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v6, v3
; GFX1150-TRUE16-NEXT:  .LBB9_15: ; %frem.loop_exit
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v3, -10, v5
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v3, v6, v3
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-FAKE16-NEXT:    s_denorm_mode 12
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr5
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr5
; GFX1150-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1150-FAKE16-NEXT:    s_denorm_mode 12
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr6
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr6
; GFX1150-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1200-TRUE16-NEXT:    s_denorm_mode 12
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr5
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr5
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v2, -10, v4
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v2, v5, v2
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1200-TRUE16-NEXT:    s_and_b32 s8, s5, 0x7fff
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-TRUE16-NEXT:    s_cmp_gt_f32 s7, s8
; GFX1200-TRUE16-NEXT:    s_cbranch_scc0 .LBB9_13
; GFX1200-TRUE16-NEXT:  ; %bb.9: ; %frem.compute
...
; GFX1200-TRUE16-NEXT:    s_denorm_mode 12
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr6
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr6
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1200-TRUE16-NEXT:    s_cbranch_vccnz .LBB9_14
; GFX1200-TRUE16-NEXT:  ; %bb.10: ; %frem.loop_body.preheader
; GFX1200-TRUE16-NEXT:    s_sub_co_i32 s7, s7, s8
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-TRUE16-NEXT:    s_add_co_i32 s7, s7, 11
; GFX1200-TRUE16-NEXT:  .LBB9_11: ; %frem.loop_body
; GFX1200-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1200-TRUE16-NEXT:    s_cbranch_scc1 .LBB9_11
; GFX1200-TRUE16-NEXT:  ; %bb.12:
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v5, s7
; GFX1200-TRUE16-NEXT:    s_branch .LBB9_15
; GFX1200-TRUE16-NEXT:  .LBB9_13: ; %frem.else
; GFX1200-TRUE16-NEXT:    s_cmp_eq_f32 s7, s8
...
; GFX1200-TRUE16-NEXT:  .LBB9_14:
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v6, v3
; GFX1200-TRUE16-NEXT:  .LBB9_15: ; %frem.loop_exit
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v3, -10, v5
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v3, v6, v3
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1200-FAKE16-NEXT:    s_denorm_mode 12
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr5
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr5
; GFX1200-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1200-FAKE16-NEXT:    s_denorm_mode 12
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr6
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr6
; GFX1200-FAKE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e64 v5, |v0.l|
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v6, v5, 11
; GFX11-TRUE16-NEXT:    v_frexp_mant_f32_e32 v5, v4
; GFX11-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v4, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v5, v5, 1
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v6, -10, v8
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v6, v9, v6
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr9
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e64 v8, |v5.l|
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e64 v7, |v6.l|
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_cmp_gt_f32_e32 vcc_lo, v8, v7
; GFX11-TRUE16-NEXT:    s_cbranch_vccz .LBB10_13
; GFX11-TRUE16-NEXT:  ; %bb.9: ; %frem.compute52
...
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v9, v8, 11
; GFX11-TRUE16-NEXT:    v_frexp_mant_f32_e32 v8, v7
; GFX11-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v7, v7
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v8, v8, 1
...
; GFX11-TRUE16-NEXT:    s_cbranch_vccnz .LBB10_14
; GFX11-TRUE16-NEXT:  ; %bb.10: ; %frem.loop_body60.preheader
; GFX11-TRUE16-NEXT:    s_sub_i32 s2, s2, s3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_add_i32 s2, s2, 11
; GFX11-TRUE16-NEXT:  .LBB10_11: ; %frem.loop_body60
; GFX11-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX11-TRUE16-NEXT:    s_branch .LBB10_15
; GFX11-TRUE16-NEXT:  .LBB10_13: ; %frem.else53
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v9, -10, v11
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v9, v12, v9
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e64 v8, |v3.l|
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr10
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_cmp_gt_f32_e32 vcc_lo, v9, v8
; GFX11-TRUE16-NEXT:    s_cbranch_vccz .LBB10_21
; GFX11-TRUE16-NEXT:  ; %bb.17: ; %frem.compute19
; GFX11-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v11, v9
; GFX11-TRUE16-NEXT:    v_frexp_mant_f32_e32 v9, v9
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_readfirstlane_b32 s2, v11
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v10, v9, 11
; GFX11-TRUE16-NEXT:    v_frexp_mant_f32_e32 v9, v8
; GFX11-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v8, v8
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v9, v9, 1
...
; GFX11-TRUE16-NEXT:  ; %bb.20:
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v12, s2
; GFX11-TRUE16-NEXT:    s_branch .LBB10_23
; GFX11-TRUE16-NEXT:  .LBB10_21: ; %frem.else20
; GFX11-TRUE16-NEXT:    v_and_b16 v0.h, 0x8000, v1.l
...
; GFX11-TRUE16-NEXT:  .LBB10_22:
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v13, v10
; GFX11-TRUE16-NEXT:  .LBB10_23: ; %frem.loop_exit28
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v10, -10, v12
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v10, v13, v10
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr13
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e64 v12, |v9.l|
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e64 v11, |v10.l|
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_cmp_gt_f32_e32 vcc_lo, v12, v11
; GFX11-TRUE16-NEXT:    s_cbranch_vccz .LBB10_29
; GFX11-TRUE16-NEXT:  ; %bb.25: ; %frem.compute
; GFX11-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v14, v12
; GFX11-TRUE16-NEXT:    v_frexp_mant_f32_e32 v12, v12
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_readfirstlane_b32 s2, v14
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v13, v12, 11
; GFX11-TRUE16-NEXT:    v_frexp_mant_f32_e32 v12, v11
; GFX11-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v11, v11
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v12, v12, 1
...
; GFX11-TRUE16-NEXT:    s_cbranch_vccnz .LBB10_30
; GFX11-TRUE16-NEXT:  ; %bb.26: ; %frem.loop_body.preheader
; GFX11-TRUE16-NEXT:    s_sub_i32 s2, s2, s3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_add_i32 s2, s2, 11
; GFX11-TRUE16-NEXT:  .LBB10_27: ; %frem.loop_body
; GFX11-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX11-TRUE16-NEXT:  ; %bb.28:
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v15, s2
; GFX11-TRUE16-NEXT:    s_branch .LBB10_31
; GFX11-TRUE16-NEXT:  .LBB10_29: ; %frem.else
; GFX11-TRUE16-NEXT:    v_and_b16 v0.h, 0x8000, v9.l
; GFX11-TRUE16-NEXT:    v_cmp_eq_f32_e32 vcc_lo, v12, v11
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v11.l, v9.l, v0.h, vcc_lo
; GFX11-TRUE16-NEXT:    s_branch .LBB10_32
; GFX11-TRUE16-NEXT:  .LBB10_30:
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v16, v13
; GFX11-TRUE16-NEXT:  .LBB10_31: ; %frem.loop_exit
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v13, -10, v15
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v13, v16, v13
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v1, v1, 1
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v2, v0, 11
; GFX1150-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v0, s8
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1150-TRUE16-NEXT:    v_readfirstlane_b32 s6, v3
; GFX1150-TRUE16-NEXT:    v_div_scale_f32 v5, null, v1, v1, 1.0
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1150-TRUE16-NEXT:    v_readfirstlane_b32 s8, v0
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v0, -1, v0
; GFX1150-TRUE16-NEXT:    v_rcp_f32_e32 v6, v5
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_not_b32_e32 v4, v0
...
; GFX1150-TRUE16-NEXT:    s_and_b32 s10, s6, 0x7fff
; GFX1150-TRUE16-NEXT:    s_cvt_f32_f16 s9, s5
; GFX1150-TRUE16-NEXT:    s_cvt_f32_f16 s10, s10
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr1
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-TRUE16-NEXT:    s_cmp_gt_f32 s9, s10
; GFX1150-TRUE16-NEXT:    s_cbranch_scc0 .LBB10_13
; GFX1150-TRUE16-NEXT:  ; %bb.9: ; %frem.compute52
...
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v2, v2, 1
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v3, v1, 11
; GFX1150-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v1, s10
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1150-TRUE16-NEXT:    v_readfirstlane_b32 s9, v4
; GFX1150-TRUE16-NEXT:    v_div_scale_f32 v6, null, v2, v2, 1.0
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1150-TRUE16-NEXT:    v_readfirstlane_b32 s10, v1
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v1, -1, v1
; GFX1150-TRUE16-NEXT:    v_rcp_f32_e32 v7, v6
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_not_b32_e32 v5, v1
...
; GFX1150-TRUE16-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v5
; GFX1150-TRUE16-NEXT:    v_div_fixup_f32 v4, v4, v2, 1.0
; GFX1150-TRUE16-NEXT:    s_cbranch_vccnz .LBB10_14
; GFX1150-TRUE16-NEXT:  ; %bb.10: ; %frem.loop_body60.preheader
; GFX1150-TRUE16-NEXT:    s_sub_i32 s9, s9, s10
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-TRUE16-NEXT:    s_add_i32 s9, s9, 11
; GFX1150-TRUE16-NEXT:  .LBB10_11: ; %frem.loop_body60
; GFX1150-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v6, v3
; GFX1150-TRUE16-NEXT:    s_add_i32 s9, s9, -11
...
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v3, v3, 11
; GFX1150-TRUE16-NEXT:    s_cbranch_scc1 .LBB10_11
; GFX1150-TRUE16-NEXT:  ; %bb.12:
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v5, s9
; GFX1150-TRUE16-NEXT:    s_branch .LBB10_15
; GFX1150-TRUE16-NEXT:  .LBB10_13: ; %frem.else53
...
; GFX1150-TRUE16-NEXT:  ; %bb.17: ; %frem.compute19
...
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v3, v3, 1
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v4, v2, 11
; GFX1150-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v2, s10
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1150-TRUE16-NEXT:    v_readfirstlane_b32 s9, v5
; GFX1150-TRUE16-NEXT:    v_div_scale_f32 v7, null, v3, v3, 1.0
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1150-TRUE16-NEXT:    v_readfirstlane_b32 s10, v2
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v2, -1, v2
; GFX1150-TRUE16-NEXT:    v_rcp_f32_e32 v8, v7
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_not_b32_e32 v6, v2
...
; GFX1150-TRUE16-NEXT:  ; %bb.20:
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v6, s9
; GFX1150-TRUE16-NEXT:    s_branch .LBB10_23
; GFX1150-TRUE16-NEXT:  .LBB10_21: ; %frem.else20
; GFX1150-TRUE16-NEXT:    s_cmp_eq_f32 s9, s10
...
; GFX1150-TRUE16-NEXT:    s_and_b32 s12, s9, 0x7fff
; GFX1150-TRUE16-NEXT:    s_cvt_f32_f16 s11, s7
; GFX1150-TRUE16-NEXT:    s_cvt_f32_f16 s12, s12
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr3
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-TRUE16-NEXT:    s_cmp_gt_f32 s11, s12
; GFX1150-TRUE16-NEXT:    s_cbranch_scc0 .LBB10_29
; GFX1150-TRUE16-NEXT:  ; %bb.25: ; %frem.compute
; GFX1150-TRUE16-NEXT:    v_frexp_mant_f32_e32 v4, s12
...
; GFX1150-TRUE16-NEXT:    s_denorm_mode 12
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr8
; GFX1150-TRUE16-NEXT:    ; implicit-def: $vgpr8
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1150-TRUE16-NEXT:    s_cbranch_vccnz .LBB10_30
; GFX1150-TRUE16-NEXT:  ; %bb.26: ; %frem.loop_body.preheader
; GFX1150-TRUE16-NEXT:    s_sub_i32 s11, s11, s12
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-TRUE16-NEXT:    s_add_i32 s11, s11, 11
; GFX1150-TRUE16-NEXT:  .LBB10_27: ; %frem.loop_body
; GFX1150-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX1150-TRUE16-NEXT:  ; %bb.28:
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v7, s11
; GFX1150-TRUE16-NEXT:    s_branch .LBB10_31
; GFX1150-TRUE16-NEXT:  .LBB10_29: ; %frem.else
; GFX1150-TRUE16-NEXT:    s_cmp_eq_f32 s11, s12
...
; GFX1150-TRUE16-NEXT:  .LBB10_30:
; GFX1150-TRUE16-NEXT:    v_mov_b32_e32 v8, v5
; GFX1150-TRUE16-NEXT:  .LBB10_31: ; %frem.loop_exit
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-TRUE16-NEXT:    v_add_nc_u32_e32 v5, -10, v7
; GFX1150-TRUE16-NEXT:    v_ldexp_f32 v5, v8, v5
; GFX1150-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-FAKE16-NEXT:    s_denorm_mode 12
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr8
; GFX1150-FAKE16-NEXT:    ; implicit-def: $vgpr8
; GFX1150-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v1, v1, 1
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v2, v0, 11
; GFX1200-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v0, s8
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1200-TRUE16-NEXT:    v_readfirstlane_b32 s6, v3
; GFX1200-TRUE16-NEXT:    v_div_scale_f32 v5, null, v1, v1, 1.0
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1200-TRUE16-NEXT:    v_readfirstlane_b32 s8, v0
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v0, -1, v0
; GFX1200-TRUE16-NEXT:    v_rcp_f32_e32 v6, v5
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_not_b32_e32 v4, v0
...
; GFX1200-TRUE16-NEXT:    s_and_b32 s10, s6, 0x7fff
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-TRUE16-NEXT:    s_cbranch_scc0 .LBB10_13
; GFX1200-TRUE16-NEXT:  ; %bb.9: ; %frem.compute52
...
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v2, v2, 1
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v3, v1, 11
; GFX1200-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v1, s10
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1200-TRUE16-NEXT:    v_readfirstlane_b32 s9, v4
; GFX1200-TRUE16-NEXT:    v_div_scale_f32 v6, null, v2, v2, 1.0
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1200-TRUE16-NEXT:    v_readfirstlane_b32 s10, v1
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v1, -1, v1
; GFX1200-TRUE16-NEXT:    v_rcp_f32_e32 v7, v6
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_not_b32_e32 v5, v1
...
; GFX1200-TRUE16-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v5
; GFX1200-TRUE16-NEXT:    v_div_fixup_f32 v4, v4, v2, 1.0
; GFX1200-TRUE16-NEXT:    s_cbranch_vccnz .LBB10_14
; GFX1200-TRUE16-NEXT:  ; %bb.10: ; %frem.loop_body60.preheader
; GFX1200-TRUE16-NEXT:    s_sub_co_i32 s9, s9, s10
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-TRUE16-NEXT:    s_add_co_i32 s9, s9, 11
; GFX1200-TRUE16-NEXT:  .LBB10_11: ; %frem.loop_body60
; GFX1200-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v6, v3
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-TRUE16-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc_lo
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v3, v3, 11
; GFX1200-TRUE16-NEXT:    s_cbranch_scc1 .LBB10_11
; GFX1200-TRUE16-NEXT:  ; %bb.12:
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v5, s9
; GFX1200-TRUE16-NEXT:    s_branch .LBB10_15
; GFX1200-TRUE16-NEXT:  .LBB10_13: ; %frem.else53
...
; GFX1200-TRUE16-NEXT:  ; %bb.17: ; %frem.compute19
...
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v3, v3, 1
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v4, v2, 11
; GFX1200-TRUE16-NEXT:    v_frexp_exp_i32_f32_e32 v2, s10
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1200-TRUE16-NEXT:    v_readfirstlane_b32 s9, v5
; GFX1200-TRUE16-NEXT:    v_div_scale_f32 v7, null, v3, v3, 1.0
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1200-TRUE16-NEXT:    v_readfirstlane_b32 s10, v2
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v2, -1, v2
; GFX1200-TRUE16-NEXT:    v_rcp_f32_e32 v8, v7
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_not_b32_e32 v6, v2
...
; GFX1200-TRUE16-NEXT:  ; %bb.20:
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v6, s9
; GFX1200-TRUE16-NEXT:    s_branch .LBB10_23
; GFX1200-TRUE16-NEXT:  .LBB10_21: ; %frem.else20
; GFX1200-TRUE16-NEXT:    s_cmp_eq_f32 s9, s10
...
; GFX1200-TRUE16-NEXT:    s_and_b32 s12, s9, 0x7fff
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-TRUE16-NEXT:    s_cvt_f32_f16 s11, s7
; GFX1200-TRUE16-NEXT:    s_cvt_f32_f16 s12, s12
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr3
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_2)
; GFX1200-TRUE16-NEXT:    s_cmp_gt_f32 s11, s12
; GFX1200-TRUE16-NEXT:    s_cbranch_scc0 .LBB10_29
; GFX1200-TRUE16-NEXT:  ; %bb.25: ; %frem.compute
; GFX1200-TRUE16-NEXT:    v_frexp_mant_f32_e32 v4, s12
...
; GFX1200-TRUE16-NEXT:    s_denorm_mode 12
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr8
; GFX1200-TRUE16-NEXT:    ; implicit-def: $vgpr8
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1200-TRUE16-NEXT:    s_cbranch_vccnz .LBB10_30
; GFX1200-TRUE16-NEXT:  ; %bb.26: ; %frem.loop_body.preheader
; GFX1200-TRUE16-NEXT:    s_sub_co_i32 s11, s11, s12
; GFX1200-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-TRUE16-NEXT:    s_add_co_i32 s11, s11, 11
; GFX1200-TRUE16-NEXT:  .LBB10_27: ; %frem.loop_body
; GFX1200-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1200-TRUE16-NEXT:  ; %bb.28:
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v7, s11
; GFX1200-TRUE16-NEXT:    s_branch .LBB10_31
; GFX1200-TRUE16-NEXT:  .LBB10_29: ; %frem.else
; GFX1200-TRUE16-NEXT:    s_cmp_eq_f32 s11, s12
...
; GFX1200-TRUE16-NEXT:  .LBB10_30:
; GFX1200-TRUE16-NEXT:    v_mov_b32_e32 v8, v5
; GFX1200-TRUE16-NEXT:  .LBB10_31: ; %frem.loop_exit
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-TRUE16-NEXT:    v_add_nc_u32_e32 v5, -10, v7
; GFX1200-TRUE16-NEXT:    v_ldexp_f32 v5, v8, v5
; GFX1200-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1200-FAKE16-NEXT:    s_denorm_mode 12
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr8
; GFX1200-FAKE16-NEXT:    ; implicit-def: $vgpr8
; GFX1200-FAKE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX1150-NEXT:    s_denorm_mode 12
; GFX1150-NEXT:    ; implicit-def: $vgpr7
; GFX1150-NEXT:    ; implicit-def: $vgpr7
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; CI-NEXT:    ; implicit-def: $vgpr18_vgpr19
; CI-NEXT:    ; implicit-def: $vgpr18
...
; CI-NEXT:    ; implicit-def: $vgpr20_vgpr21
; CI-NEXT:    ; implicit-def: $vgpr20
...
; VI-NEXT:    ; implicit-def: $vgpr18_vgpr19
; VI-NEXT:    ; implicit-def: $vgpr18
...
; GFX9-NEXT:    ; implicit-def: $vgpr18_vgpr19
; GFX9-NEXT:    ; implicit-def: $vgpr18
...
; GFX10-NEXT:    ; implicit-def: $vgpr16_vgpr17
; GFX10-NEXT:    ; implicit-def: $vgpr16
...
; GFX11-NEXT:    ; implicit-def: $vgpr16_vgpr17
; GFX11-NEXT:    ; implicit-def: $vgpr16
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
...
; GFX1150-NEXT:    ; implicit-def: $vgpr14_vgpr15
; GFX1150-NEXT:    ; implicit-def: $vgpr14
...
; GFX1150-NEXT:    ; implicit-def: $vgpr16_vgpr17
; GFX1150-NEXT:    ; implicit-def: $vgpr16
...
; GFX1200-NEXT:    ; implicit-def: $vgpr14_vgpr15
; GFX1200-NEXT:    ; implicit-def: $vgpr14
...
; GFX1200-NEXT:    ; implicit-def: $vgpr16_vgpr17
; GFX1200-NEXT:    ; implicit-def: $vgpr16
...
; CI-NEXT:    ; implicit-def: $vgpr9_vgpr10
...
; CI-NEXT:    ; implicit-def: $vgpr11_vgpr12
; CI-NEXT:    v_ldexp_f64 v[6:7], v[5:6], 26
...
; VI-NEXT:    ; implicit-def: $vgpr9_vgpr10
...
; VI-NEXT:    ; implicit-def: $vgpr11_vgpr12
; VI-NEXT:    v_ldexp_f64 v[6:7], v[5:6], 26
...
; GFX9-NEXT:    ; implicit-def: $vgpr9_vgpr10
...
; GFX9-NEXT:    ; implicit-def: $vgpr11_vgpr12
; GFX9-NEXT:    v_ldexp_f64 v[6:7], v[5:6], 26
