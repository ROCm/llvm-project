...
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx600 -mattr=+mad-mac-f32-insts  < %s | FileCheck --check-prefix=SI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=bonaire < %s | FileCheck --check-prefix=CI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck --check-prefix=VI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck --check-prefix=GFX9 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck --check-prefix=GFX10 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1150 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX1150,GFX1150-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1150 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX1150,GFX1150-FAKE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX1200,GFX1200-TRUE16 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -enable-misched=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX1200,GFX1200-FAKE16 %s
...
; GFX1150-NEXT:    global_load_b128 v[1:4], v4, s[6:7] offset:64
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v0
; GFX1150-NEXT:    s_and_b32 s6, s8, 0x7fffffff
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s7, v1
...
; GFX1150-NEXT:    s_cmp_eq_f32 s6, s11
...
; GFX1150-NEXT:    s_and_b32 s9, s5, 0x7fffffff
...
; GFX1150-NEXT:    v_frexp_mant_f32_e64 v3, |s5|
; GFX1150-NEXT:    v_frexp_exp_i32_f32_e32 v6, s5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1150-NEXT:    v_ldexp_f32 v4, v4, 1
; GFX1150-NEXT:    v_ldexp_f32 v5, v3, 12
...
; GFX1150-NEXT:    s_and_b32 s12, 0x80000000, s5
; GFX1150-NEXT:    s_cmp_eq_f32 s9, s11
; GFX1150-NEXT:    v_mov_b32_e32 v3, s12
; GFX1150-NEXT:    s_cselect_b32 vcc_lo, -1, 0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_cndmask_b32_e32 v3, s5, v3, vcc_lo
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_ldexp_f32 v3, v4, v3
; GFX1150-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, s5
; GFX1150-NEXT:  .LBB12_32:
; GFX1150-NEXT:    s_cmp_lg_f32 s7, 0
; GFX1150-NEXT:    v_mov_b32_e32 v4, 0
...
; GFX1200-NEXT:    s_and_b32 s9, s6, 0x7fffffff
...
; GFX1200-NEXT:    v_frexp_mant_f32_e64 v3, |s6|
; GFX1200-NEXT:    v_frexp_exp_i32_f32_e32 v6, s6
; GFX1200-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1200-NEXT:    v_ldexp_f32 v4, v4, 1
; GFX1200-NEXT:    v_ldexp_f32 v5, v3, 12
...
; GFX1200-NEXT:    s_and_b32 s12, 0x80000000, s6
; GFX1200-NEXT:    s_cmp_eq_f32 s9, s11
; GFX1200-NEXT:    s_cselect_b32 s6, s12, s6
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_mov_b32_e32 v3, s6
...
; GFX1200-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1200-NEXT:    v_ldexp_f32 v3, v4, v3
; GFX1200-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, s6
; GFX1200-NEXT:  .LBB12_32:
; GFX1200-NEXT:    s_cmp_lg_f32 s7, 0
; GFX1200-NEXT:    v_mov_b32_e32 v4, 0
