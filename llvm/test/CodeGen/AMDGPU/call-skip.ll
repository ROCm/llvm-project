...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01-amd-amdhsa -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01-amd-amdhsa -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GISEL %s
...
; GISEL-NEXT:    s_xor_b64 exec, vcc, exec
; GISEL-NEXT:    ; divergent control-flow edge
; GISEL-NEXT:    s_cbranch_execnz .LBB3_2
; GISEL-NEXT:  .LBB3_1: ; %end
; GISEL-NEXT:    s_endpgm
; GISEL-NEXT:  .LBB3_2: ; %call
