...
; SDAG-NEXT:    s_mov_b64 s[16:17], 0
; SDAG-NEXT:    s_xor_b64 s[16:17], exec, s[18:19]
; SDAG-NEXT:    s_mov_b64 s[20:21], 0
; SDAG-NEXT:    s_mov_b64 exec, s[18:19]
; SDAG-NEXT:    s_mov_b64 s[18:19], 0
...
; SDAG-NEXT:  .LBB2_1: ; %call
; SDAG-NEXT:    s_mov_b64 s[6:7], 0
; SDAG-NEXT:    ;;#ASMSTART
; SDAG-NEXT:    ; sample asm
; SDAG-NEXT:    ;;#ASMEND
; SDAG-NEXT:  .LBB2_2: ; %end
