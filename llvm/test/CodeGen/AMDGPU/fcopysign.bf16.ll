...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx600 | FileCheck %s -check-prefixes=GCN
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=hawaii | FileCheck %s -check-prefixes=GFX7
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=tonga | FileCheck %s -check-prefixes=GFX8
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx900 | FileCheck %s -check-prefixes=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1010 | FileCheck %s -check-prefixes=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11FAKE16
...
; GFX11FAKE16:       ; %bb.0:
; GFX11FAKE16-NEXT:    s_lshr_b32 s5, s4, 16
; GFX11FAKE16-NEXT:    v_lshlrev_b32_e64 v0, 16, s4
; GFX11FAKE16-NEXT:    v_lshlrev_b32_e64 v1, 16, s5
; GFX11FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11FAKE16-NEXT:    v_bfi_b32 v0, 0x7fffffff, s1, v0
...
; GCN-NEXT:    v_bfe_u32 v0, v0, 16, 15
; GCN-NEXT:    v_or_b32_e32 v0, s0, v0
; GCN-NEXT:    s_and_b32 s0, s5, 0x8000
; GCN-NEXT:    v_bfe_u32 v1, v1, 16, 15
; GCN-NEXT:    v_or_b32_e32 v1, s0, v1
; GCN-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GCN-NEXT:    v_or_b32_e32 v0, v0, v1
...
; GFX7-NEXT:    s_and_b32 s0, s4, 0x8000
; GFX7-NEXT:    v_bfe_u32 v0, v0, 16, 15
; GFX7-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX7-NEXT:    s_and_b32 s0, s5, 0x8000
; GFX7-NEXT:    v_bfe_u32 v1, v1, 16, 15
; GFX7-NEXT:    v_or_b32_e32 v1, s0, v1
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX7-NEXT:    v_or_b32_e32 v0, v0, v1
...
; GFX8-NEXT:    s_cselect_b32 s0, s5, s8
; GFX8-NEXT:    s_bitcmp1_b32 s1, 0
; GFX8-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX8-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GFX8-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX8-NEXT:    v_cmp_u_f64_e64 s[2:3], s[2:3], s[2:3]
; GFX8-NEXT:    s_cselect_b32 s5, 1, -1
; GFX8-NEXT:    s_add_i32 s5, s1, s5
; GFX8-NEXT:    s_and_b64 s[6:7], s[8:9], exec
; GFX8-NEXT:    s_cselect_b32 s1, s1, s5
; GFX8-NEXT:    s_bfe_u32 s5, s1, 0x10010
; GFX8-NEXT:    s_add_i32 s5, s5, s1
; GFX8-NEXT:    s_addk_i32 s5, 0x7fff
; GFX8-NEXT:    s_bitset1_b32 s1, 22
; GFX8-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX8-NEXT:    s_cselect_b32 s1, s1, s5
; GFX8-NEXT:    s_lshr_b32 s1, s1, 16
; GFX8-NEXT:    s_lshr_b64 s[0:1], s[0:1], 16
...
; GFX9-NEXT:    v_cmp_u_f64_e64 s[2:3], s[2:3], s[2:3]
...
; GFX9-NEXT:    s_add_i32 s10, s5, s6
; GFX9-NEXT:    s_and_b64 s[6:7], s[8:9], exec
...
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX9-NEXT:    s_cselect_b32 s2, s5, s8
