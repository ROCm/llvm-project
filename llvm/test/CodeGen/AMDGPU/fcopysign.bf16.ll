...
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v10
; GFX8-NEXT:    v_or_b32_e32 v7, 0x400000, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v5, -1, 1, s[6:7]
; GFX8-NEXT:    v_add_u32_e64 v5, s[6:7], v8, v5
; GFX8-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, -1, 1, s[6:7]
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_movk_i32 s4, 0x7fff
; GFX9-NEXT:    v_bfe_u32 v7, v0, 16, 1
; GFX9-NEXT:    v_add3_u32 v7, v7, v0, s4
...
; GFX8-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[0:1]
; GFX8-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX8-NEXT:    v_bfi_b32 v1, s4, v11, v7
; GFX8-NEXT:    v_cndmask_b32_e32 v0, v10, v9, vcc
; GFX8-NEXT:    v_alignbit_b32 v0, v2, v0, 16
...
; GFX9-NEXT:    v_and_b32_e32 v13, 1, v11
...
; GFX9-NEXT:    v_cvt_f32_f64_e32 v13, v[2:3]
; GFX9-NEXT:    v_bfe_u32 v12, v10, 16, 1
; GFX9-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[0:1]|, |v[8:9]|
; GFX9-NEXT:    v_cmp_nlg_f64_e32 vcc, v[0:1], v[8:9]
; GFX9-NEXT:    v_and_b32_e32 v15, 1, v13
; GFX9-NEXT:    v_add3_u32 v12, v12, v10, s8
; GFX9-NEXT:    v_or_b32_e32 v10, 0x400000, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v8, -1, 1, s[6:7]
; GFX9-NEXT:    v_add_u32_e32 v14, v11, v8
; GFX9-NEXT:    v_cvt_f64_f32_e32 v[8:9], v13
; GFX9-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v11, v14, v11, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v15
; GFX9-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[2:3]|, |v[8:9]|
; GFX9-NEXT:    v_cmp_nlg_f64_e32 vcc, v[2:3], v[8:9]
; GFX9-NEXT:    v_bfe_u32 v14, v11, 16, 1
; GFX9-NEXT:    v_add3_u32 v14, v14, v11, s8
; GFX9-NEXT:    v_or_b32_e32 v11, 0x400000, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v8, -1, 1, s[6:7]
; GFX9-NEXT:    v_add_u32_e32 v8, v13, v8
; GFX9-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v8, v13, vcc
; GFX9-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[0:1]
; GFX9-NEXT:    v_bfe_u32 v9, v8, 16, 1
; GFX9-NEXT:    v_add3_u32 v9, v9, v8, s8
; GFX9-NEXT:    v_or_b32_e32 v8, 0x400000, v8
; GFX9-NEXT:    s_mov_b32 s4, 0x7060302
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v14, v11, vcc
; GFX9-NEXT:    v_cmp_u_f64_e32 vcc, v[2:3], v[2:3]
...
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v12, v10, vcc
; GFX9-NEXT:    v_alignbit_b32 v1, s4, v1, 16
...
; GFX9-NEXT:    v_bfi_b32 v0, s4, v0, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v5, v6, vcc
; GFX9-NEXT:    v_alignbit_b32 v2, s4, v2, 16
; GFX9-NEXT:    v_bfi_b32 v1, s4, v1, v2
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_bfe_u32 v9, v3, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v2
; GFX8-NEXT:    s_movk_i32 s4, 0x7fff
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v9, v3
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, 0x7fff, v7
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, s4, v9
; GFX8-NEXT:    v_or_b32_e32 v8, 0x400000, v3
; GFX8-NEXT:    v_cmp_u_f32_e32 vcc, v3, v3
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v9, v8, vcc
; GFX8-NEXT:    v_bfe_u32 v9, v0, 16, 1
; GFX8-NEXT:    v_bfe_u32 v11, v1, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v9, v0
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, v11, v1
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, s4, v9
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 0x7fff, v11
; GFX8-NEXT:    v_or_b32_e32 v10, 0x400000, v1
; GFX8-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX8-NEXT:    v_or_b32_e32 v8, 0x400000, v0
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v11, v10, vcc
; GFX8-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
...
; GFX9-NEXT:    v_add3_u32 v10, v10, v0, s4
...
; GFX10-NEXT:    v_bfe_u32 v7, v3, 16, 1
; GFX10-NEXT:    v_add3_u32 v10, v10, v1, 0x7fff
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v6, v8, vcc_lo
; GFX10-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX10-NEXT:    v_or_b32_e32 v13, 0x400000, v1
; GFX10-NEXT:    v_add3_u32 v7, v7, v3, 0x7fff
; GFX10-NEXT:    v_or_b32_e32 v11, 0x400000, v3
; GFX10-NEXT:    v_cndmask_b32_e32 v0, v9, v12, vcc_lo
; GFX10-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX10-NEXT:    v_cndmask_b32_e32 v1, v10, v13, vcc_lo
; GFX10-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX10-NEXT:    v_perm_b32 v0, v1, v0, 0x7060302
...
; GFX11TRUE16-NEXT:    v_bfe_u32 v10, v1, 16, 1
...
; GFX11TRUE16-NEXT:    v_add3_u32 v10, v10, v1, 0x7fff
; GFX11TRUE16-NEXT:    v_or_b32_e32 v13, 0x400000, v1
; GFX11TRUE16-NEXT:    v_cndmask_b32_e32 v0, v8, v11, vcc_lo
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11TRUE16-NEXT:    v_or_b32_e32 v9, 0x400000, v3
; GFX11TRUE16-NEXT:    v_add3_u32 v6, v6, v3, 0x7fff
; GFX11TRUE16-NEXT:    v_cndmask_b32_e32 v2, v7, v12, vcc_lo
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11TRUE16-NEXT:    v_cndmask_b32_e32 v1, v10, v13, vcc_lo
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11TRUE16-NEXT:    v_mov_b16_e32 v1.l, v0.h
...
; GFX11FAKE16-NEXT:    v_add3_u32 v9, v9, v0, 0x7fff
; GFX11FAKE16-NEXT:    v_or_b32_e32 v12, 0x400000, v0
; GFX11FAKE16-NEXT:    v_cndmask_b32_e32 v2, v6, v8, vcc_lo
; GFX11FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11FAKE16-NEXT:    v_add3_u32 v10, v10, v1, 0x7fff
; GFX11FAKE16-NEXT:    v_or_b32_e32 v13, 0x400000, v1
; GFX11FAKE16-NEXT:    v_cndmask_b32_e32 v0, v9, v12, vcc_lo
; GFX11FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11FAKE16-NEXT:    v_cndmask_b32_e32 v1, v10, v13, vcc_lo
; GFX11FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11FAKE16-NEXT:    v_perm_b32 v0, v1, v0, 0x7060302
...
; GFX8-NEXT:    v_and_b32_e32 v15, 1, v13
...
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v15
...
; GFX8-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[6:7]
; GFX8-NEXT:    v_add_u32_e64 v10, s[6:7], v13, v10
; GFX8-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e32 v10, v10, v13, vcc
; GFX8-NEXT:    v_bfe_u32 v11, v10, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, v11, v10
; GFX8-NEXT:    v_cvt_f32_f64_e32 v13, v[0:1]
; GFX8-NEXT:    v_add_u32_e32 v15, vcc, s8, v11
; GFX8-NEXT:    v_cmp_u_f64_e32 vcc, v[6:7], v[6:7]
; GFX8-NEXT:    v_or_b32_e32 v16, 0x400000, v10
; GFX8-NEXT:    v_cvt_f64_f32_e32 v[10:11], v13
; GFX8-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[0:1]|, |v[10:11]|
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v15, v16, vcc
; GFX8-NEXT:    v_cmp_nlg_f64_e32 vcc, v[0:1], v[10:11]
; GFX8-NEXT:    v_cvt_f32_f64_e32 v10, v[2:3]
; GFX8-NEXT:    v_lshrrev_b32_e32 v15, 16, v6
; GFX8-NEXT:    v_and_b32_e32 v6, 1, v13
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v6, -1, 1, s[6:7]
; GFX8-NEXT:    v_add_u32_e64 v6, s[6:7], v13, v6
; GFX8-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e32 v11, v6, v13, vcc
; GFX8-NEXT:    v_cvt_f64_f32_e32 v[6:7], v10
; GFX8-NEXT:    v_bfe_u32 v13, v11, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, v13, v11
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, s8, v13
; GFX8-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[2:3]|, |v[6:7]|
; GFX8-NEXT:    v_cmp_nlg_f64_e32 vcc, v[2:3], v[6:7]
; GFX8-NEXT:    v_and_b32_e32 v16, 1, v10
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v16
; GFX8-NEXT:    v_or_b32_e32 v11, 0x400000, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v6, -1, 1, s[6:7]
; GFX8-NEXT:    v_add_u32_e64 v6, s[6:7], v10, v6
; GFX8-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; GFX8-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[0:1]
; GFX8-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v0, v13, v11, vcc
; GFX8-NEXT:    v_cmp_u_f64_e32 vcc, v[4:5], v[4:5]
; GFX8-NEXT:    v_alignbit_b32 v0, v2, v0, 16
; GFX8-NEXT:    v_bfi_b32 v0, s4, v0, v8
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v14, v12, vcc
; GFX8-NEXT:    v_alignbit_b32 v1, v15, v1, 16
; GFX8-NEXT:    v_bfi_b32 v1, s4, v1, v9
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v15
; GFX9-NEXT:    v_cvt_f32_f64_e32 v15, v[0:1]
...
; GFX9-NEXT:    v_and_b32_e32 v17, 1, v15
; GFX9-NEXT:    v_add3_u32 v14, v14, v12, s8
; GFX9-NEXT:    v_or_b32_e32 v12, 0x400000, v12
; GFX9-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[6:7]
; GFX9-NEXT:    v_add_u32_e32 v16, v13, v10
; GFX9-NEXT:    v_cvt_f64_f32_e32 v[10:11], v15
; GFX9-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v16, v13, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v17
; GFX9-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[0:1]|, |v[10:11]|
; GFX9-NEXT:    v_cmp_nlg_f64_e32 vcc, v[0:1], v[10:11]
; GFX9-NEXT:    v_cvt_f32_f64_e32 v17, v[2:3]
; GFX9-NEXT:    v_bfe_u32 v16, v13, 16, 1
; GFX9-NEXT:    v_add3_u32 v16, v16, v13, s8
; GFX9-NEXT:    v_or_b32_e32 v13, 0x400000, v13
; GFX9-NEXT:    v_and_b32_e32 v19, 1, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[6:7]
; GFX9-NEXT:    v_add_u32_e32 v18, v15, v10
; GFX9-NEXT:    v_cvt_f64_f32_e32 v[10:11], v17
; GFX9-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v15, v18, v15, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v19
; GFX9-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[2:3]|, |v[10:11]|
; GFX9-NEXT:    v_cmp_nlg_f64_e32 vcc, v[2:3], v[10:11]
; GFX9-NEXT:    v_bfe_u32 v18, v15, 16, 1
; GFX9-NEXT:    v_add3_u32 v18, v18, v15, s8
; GFX9-NEXT:    v_or_b32_e32 v15, 0x400000, v15
; GFX9-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[6:7]
; GFX9-NEXT:    v_add_u32_e32 v10, v17, v10
; GFX9-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; GFX9-NEXT:    s_mov_b32 s4, 0x7060302
; GFX9-NEXT:    s_mov_b32 s5, 0x7fff7fff
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v18, v15, vcc
; GFX9-NEXT:    v_cmp_u_f64_e32 vcc, v[2:3], v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v11, v10, vcc
; GFX9-NEXT:    v_cmp_u_f64_e32 vcc, v[4:5], v[4:5]
; GFX9-NEXT:    v_perm_b32 v0, v1, v0, s4
; GFX9-NEXT:    v_bfi_b32 v0, s5, v0, v8
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v14, v12, vcc
; GFX9-NEXT:    v_cmp_u_f64_e32 vcc, v[6:7], v[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v16, v13, vcc
; GFX9-NEXT:    v_perm_b32 v1, v2, v1, s4
...
; GFX8-NEXT:    v_bfe_u32 v7, v5, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v4
; GFX8-NEXT:    s_movk_i32 s4, 0x7fff
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v5
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 0x7fff, v6
...
; GFX8-NEXT:    v_bfi_b32 v0, s4, v0, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v6, v4, vcc
...
; GFX10-NEXT:    v_bfe_u32 v7, v5, 16, 1
; GFX10-NEXT:    v_add3_u32 v10, v10, v3, 0x7fff
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v6, v8, vcc_lo
; GFX10-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX10-NEXT:    v_or_b32_e32 v13, 0x400000, v3
; GFX10-NEXT:    v_add3_u32 v7, v7, v5, 0x7fff
; GFX10-NEXT:    v_or_b32_e32 v11, 0x400000, v5
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v9, v12, vcc_lo
; GFX10-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX10-NEXT:    v_cndmask_b32_e32 v3, v10, v13, vcc_lo
...
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11TRUE16-NEXT:    v_add3_u32 v8, v8, v2, 0x7fff
; GFX11TRUE16-NEXT:    v_add3_u32 v7, v7, v4, 0x7fff
; GFX11TRUE16-NEXT:    v_or_b32_e32 v12, 0x400000, v4
; GFX11TRUE16-NEXT:    v_add3_u32 v10, v10, v3, 0x7fff
; GFX11TRUE16-NEXT:    v_or_b32_e32 v13, 0x400000, v3
; GFX11TRUE16-NEXT:    v_cndmask_b32_e32 v2, v8, v11, vcc_lo
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v4, v4
; GFX11TRUE16-NEXT:    v_bfe_u32 v6, v5, 16, 1
; GFX11TRUE16-NEXT:    v_or_b32_e32 v9, 0x400000, v5
; GFX11TRUE16-NEXT:    v_cndmask_b32_e32 v4, v7, v12, vcc_lo
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
...
; GFX11TRUE16-NEXT:    v_cndmask_b32_e32 v3, v10, v13, vcc_lo
...
; GFX11FAKE16-NEXT:    v_bfe_u32 v7, v5, 16, 1
; GFX11FAKE16-NEXT:    v_or_b32_e32 v8, 0x400000, v4
; GFX11FAKE16-NEXT:    v_bfe_u32 v9, v2, 16, 1
; GFX11FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v4, v4
; GFX11FAKE16-NEXT:    v_add3_u32 v6, v6, v4, 0x7fff
...
; GFX11FAKE16-NEXT:    v_add3_u32 v9, v9, v2, 0x7fff
; GFX11FAKE16-NEXT:    v_or_b32_e32 v12, 0x400000, v2
; GFX11FAKE16-NEXT:    v_cndmask_b32_e32 v4, v6, v8, vcc_lo
; GFX11FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11FAKE16-NEXT:    v_add3_u32 v10, v10, v3, 0x7fff
; GFX11FAKE16-NEXT:    v_or_b32_e32 v13, 0x400000, v3
; GFX11FAKE16-NEXT:    v_cndmask_b32_e32 v2, v9, v12, vcc_lo
; GFX11FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11FAKE16-NEXT:    v_cndmask_b32_e32 v3, v10, v13, vcc_lo
