...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-codegenprepare-widen-constant-loads=0 -mtriple=amdgpu6.00 < %s | FileCheck -enable-var-scope --check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-codegenprepare-widen-constant-loads=0 -mtriple=amdgpu8.02 < %s | FileCheck -enable-var-scope --check-prefix=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-codegenprepare-widen-constant-loads=0 -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-codegenprepare-widen-constant-loads=0 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-FAKE16 %s
