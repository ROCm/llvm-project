...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12-GISEL %s
...
; GFX11-NEXT:    s_load_b256 s[36:43], s[2:3], 0x40
; GFX11-NEXT:    s_load_b512 s[16:31], s[0:1], 0x0
; GFX11-NEXT:    s_load_b512 s[0:15], s[2:3], 0x0
; GFX11-NEXT:    v_mov_b32_e32 v0, 0xbc00bc00
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    buffer_load_b32 v1, off, s[36:39], 0
; GFX11-NEXT:    buffer_load_b32 v2, off, s[28:31], 0
; GFX11-NEXT:    image_sample_lz v3, v0, s[20:27], s[16:19] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-NEXT:    buffer_load_b32 v4, off, s[4:7], 0
; GFX11-NEXT:    image_sample_lz v0, v0, s[8:15], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX11-NEXT:    buffer_store_b32 v0, off, s[40:43], 0
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_load_b256 s[36:43], s[2:3], 0x40
; GFX12-NEXT:    s_load_b512 s[16:31], s[0:1], 0x0
; GFX12-NEXT:    s_load_b512 s[0:15], s[2:3], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    buffer_load_b32 v1, off, s[36:39], null
; GFX12-NEXT:    buffer_load_b32 v2, off, s[28:31], null
; GFX12-NEXT:    image_sample_lz v3, v0, s[20:27], s[16:19] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-NEXT:    buffer_load_b32 v4, off, s[4:7], null
; GFX12-NEXT:    image_sample_lz v0, v0, s[8:15], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX12-NEXT:    buffer_store_b32 v0, off, s[40:43], null
; GFX12-NEXT:    s_endpgm
;
...
; GFX12-GISEL-NEXT:    s_load_b512 s[16:31], s[2:3], 0x0
; GFX12-GISEL-NEXT:    s_load_b256 s[36:43], s[2:3], 0x40
; GFX12-GISEL-NEXT:    s_load_b512 s[0:15], s[0:1], 0x0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b32 v2, off, s[20:23], null
; GFX12-GISEL-NEXT:    buffer_load_b32 v3, off, s[36:39], null
; GFX12-GISEL-NEXT:    image_sample_lz v1, v0, s[24:31], s[16:19] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-GISEL-NEXT:    image_sample_lz v0, v0, s[4:11], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-GISEL-NEXT:    buffer_load_b32 v4, off, s[12:15], null
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x2
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s1, v2
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x1
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s2, v3
...
; GFX11-NEXT:    s_load_b256 s[4:11], s[0:1], 0x40
...
; GFX12-NEXT:    s_load_b256 s[4:11], s[0:1], 0x40
; GFX12-NEXT:    s_load_b128 s[0:3], s[0:1], 0x10
...
; GFX12-NEXT:    buffer_load_b32 v2, off, s[0:3], null
; GFX12-NEXT:    s_wait_bvhcnt 0x0
