...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12-GISEL %s
