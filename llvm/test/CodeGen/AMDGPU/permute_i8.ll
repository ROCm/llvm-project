...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0x1060c0c
; GFX10-NEXT:    v_mov_b32_e32 v1, 0x50c0c
; GFX10-NEXT:    v_mov_b32_e32 v4, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
; GFX10-NEXT:    s_load_dwordx2 s[8:9], s[0:1], 0x0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_perm_b32 v2, s5, s5, 0xc07060c
; GFX10-NEXT:    s_and_b32 s2, s8, 0xff
; GFX10-NEXT:    s_bfe_u32 s0, s8, 0x80008
; GFX10-NEXT:    s_lshl_b32 s1, s4, 8
; GFX10-NEXT:    v_perm_b32 v0, s8, s4, v0
; GFX10-NEXT:    v_or_b32_e32 v2, s2, v2
; GFX10-NEXT:    v_perm_b32 v3, s9, s5, v1
; GFX10-NEXT:    s_or_b32 s0, s0, s1
; GFX10-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX10-NEXT:    v_or_b32_sdwa v1, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX10-NEXT:    v_or_b32_e32 v0, s0, v3
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0xc07060c
; GFX9-NEXT:    v_mov_b32_e32 v3, 0x1060c0c
...
; GFX9-NEXT:    v_perm_b32 v0, s9, s9, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v3, 0x50c0c
; GFX9-NEXT:    v_perm_b32 v0, s5, v0, v3
...
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_perm_b32 v0, v9, v9, 0x6040c0c
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    s_mov_b32 s5, 0x6040c0c
; GFX9-NEXT:    s_mov_b32 s6, 0xc0c0006
; GFX9-NEXT:    s_mov_b32 s4, 0x2000706
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_perm_b32 v1, v9, v9, s5
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_perm_b32 v2, v10, v4, s6
; GFX9-NEXT:    v_or_b32_e32 v1, v2, v1
; GFX9-NEXT:    v_perm_b32 v0, v10, v9, s4
; GFX9-NEXT:    global_store_dword v[5:6], v1, off
; GFX9-NEXT:    global_store_dword v[7:8], v0, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    global_load_ushort v9, v[0:1], off offset:10
; GFX10-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_lshl_or_b32 v0, v9, 16, v8
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0x60c0c
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x60c0c
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-NEXT:    v_mov_b32_e32 v1, 0x3040c0c
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0x3040c0c
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
