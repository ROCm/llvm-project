...
; GFX7-NEXT:    v_bfe_i32 v6, v2, 16, 8
...
; GFX7-NEXT:    v_bfe_i32 v5, v0, 8, 8
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_i32_i24 v8, v1, v3, s0
; GFX7-NEXT:    v_mad_i32_i24 v4, v4, v5, v8
; GFX7-NEXT:    v_bfe_i32 v6, v2, 16, 8
; GFX7-NEXT:    v_bfe_i32 v7, v0, 16, 8
; GFX7-NEXT:    v_mad_i32_i24 v1, v1, v3, v4
; GFX7-NEXT:    v_ashrrev_i32_e32 v2, 24, v2
; GFX7-NEXT:    v_ashrrev_i32_e32 v0, 24, v0
; GFX7-NEXT:    v_mad_i32_i24 v1, v6, v7, v1
; GFX7-NEXT:    v_mad_i32_i24 v0, v2, v0, v1
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_i32_i24 v0, v2, v0, s0
...
; GFX7-NEXT:    v_bfe_i32 v4, v2, 0, 8
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_ashrrev_i32_e32 v3, 24, v0
...
; GFX7-NEXT:    v_bfe_i32 v5, v0, 8, 8
; GFX7-NEXT:    v_bfe_i32 v3, v0, 0, 8
; GFX7-NEXT:    v_mul_i32_i24_e32 v4, v4, v5
; GFX7-NEXT:    v_bfe_i32 v6, v2, 16, 8
; GFX7-NEXT:    v_bfe_i32 v7, v0, 16, 8
; GFX7-NEXT:    v_mad_i32_i24 v1, v1, v3, v4
; GFX7-NEXT:    v_ashrrev_i32_e32 v2, 24, v2
...
; GFX7-NEXT:    s_sext_i32_i16 s0, s6
; GFX7-NEXT:    s_mov_b32 s10, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    v_mad_i32_i24 v1, v1, s0, v5
; GFX7-NEXT:    v_bfe_i32 v0, v0, 16, 8
; GFX7-NEXT:    v_bfe_i32 v2, v2, 16, 8
; GFX7-NEXT:    v_mad_i32_i24 v1, v3, v4, v1
; GFX7-NEXT:    v_mad_i32_i24 v0, v2, v0, v1
; GFX7-NEXT:    buffer_store_dword v0, off, s[8:11], 0
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_mul_i32_i24_sdwa v2, sext(v1), s3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX7-NEXT:    v_bfe_i32 v2, v2, 8, 8
; GFX7-NEXT:    s_waitcnt vmcnt(1)
; GFX7-NEXT:    v_bfe_i32 v1, v3, 8, 8
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_i32_i24 v4, v1, v1, s0
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_bfe_i32 v0, v0, 16, 8
; GFX7-NEXT:    v_bfe_i32 v3, v3, 16, 8
; GFX7-NEXT:    v_mad_i32_i24 v1, v2, v1, v4
...
; GFX7-NEXT:    s_waitcnt vmcnt(1)
; GFX7-NEXT:    v_bfe_i32 v6, v4, 0, 8
; GFX7-NEXT:    v_bfe_i32 v4, v4, 8, 8
; GFX7-NEXT:    v_mad_i32_i24 v1, v5, v3, v1
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_bfe_i32 v7, v0, 0, 8
; GFX7-NEXT:    v_bfe_i32 v0, v0, 8, 8
; GFX7-NEXT:    v_mad_i32_i24 v1, v6, v4, v1
; GFX7-NEXT:    v_mad_i32_i24 v0, v7, v0, v1
...
; GFX7-NEXT:    v_mul_u32_u24_e32 v4, v5, v4
; GFX7-NEXT:    v_bfe_u32 v7, v0, 16, 8
; GFX7-NEXT:    v_ashrrev_i32_e32 v2, 24, v2
; GFX7-NEXT:    v_and_b32_e32 v6, 0xffff, v6
; GFX7-NEXT:    v_mad_u32_u24 v1, v1, v3, v4
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, 24, v0
; GFX7-NEXT:    v_mad_u32_u24 v1, v7, v6, v1
; GFX7-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX7-NEXT:    v_mad_u32_u24 v0, v2, v0, v1
...
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v6, 8, v1
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v7, 8, v0
...
; GFX9-NODL-NEXT:    v_and_b32_sdwa v8, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v1, 24, v1
...
; GFX9-NODL-NEXT:    v_bfe_i32 v0, v0, 0, 16
...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v7, 8, v0
...
; GFX9-DL-NEXT:    v_and_b32_sdwa v8, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX9-DL-NEXT:    v_bfe_i32 v0, v0, 0, 16
...
; GFX11-DL-TRUE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, 8, v2
; GFX11-DL-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, v5.l
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 24, v2
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v4.l
; GFX11-DL-TRUE16-NEXT:    v_bfe_i32 v4, v6, 0, 8
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-DL-TRUE16-NEXT:    v_mul_lo_u16 v0.l, v0.l, v0.h
...
; GFX11-DL-TRUE16-NEXT:    v_mad_u16 v0.l, v1.h, v1.l, v0.l
; GFX11-DL-TRUE16-NEXT:    v_bfe_i32 v1, v5, 0, 8
; GFX11-DL-TRUE16-NEXT:    v_mad_u16 v0.l, v0.h, v2.l, v0.l
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-DL-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-DL-TRUE16-NEXT:    v_mad_u16 v0.l, v0.h, v3.l, v0.l
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
