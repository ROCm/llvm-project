...
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; GFX11-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr1_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr3_hi16
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr4_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr2_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5_hi16
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 8
...
; GFX12-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr1_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr3_hi16
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    s_wait_expcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr4_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr2_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5_hi16
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 8
...
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr13_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5_hi16
...
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr2_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr8_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr12_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr10_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr18_hi16
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr9_hi16
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v5.l
...
; GFX11-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr6_hi16
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr13_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5_hi16
...
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr2_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr8_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr12_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr10_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr18_hi16
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr9_hi16
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v5.l
...
; GFX12-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr6_hi16
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
