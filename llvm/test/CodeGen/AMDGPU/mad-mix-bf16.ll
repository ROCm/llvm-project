...
; GFX1250-NEXT:    v_xor_b16 v2.l, 0x8000, v0.h
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_fma_mix_f32_bf16 v0, |v2|, v1, v0 op_sel_hi:[1,1,1]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %src0.arg.bc = bitcast i32 %src0.arg to <2 x bfloat>
...
; GFX1250-NEXT:    v_mov_b16_e32 v3.h, v0.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_fma_mix_f32_bf16 v0, v3, v1, v2 op_sel_hi:[0,1,1]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %src0.bf16 = bitcast half %src0 to bfloat
  %src0.ext = fpext bfloat %src0.bf16 to float
  %src1.ext = fpext bfloat %src1 to float
...
; GFX1250-NEXT:    v_xor_b16 v1.l, 0x8000, v0.h
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:    v_xor_b16 v1.l, 0x8000, v0.h
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_fma_mix_f32_bf16 v0, |v1|, v0, neg(0) op_sel_hi:[1,1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %src0.arg.bc = bitcast i32 %src0.arg to <2 x bfloat>
  %src0 = extractelement <2 x bfloat> %src0.arg.bc, i32 1
  %src0.neg = fneg bfloat %src0
