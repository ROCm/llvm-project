...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.30--amdhsa -global-isel < %s | FileCheck -check-prefixes=GFX10  %s
; RUN: llc -mtriple=amdgpu11.00--amdhsa < %s | FileCheck -check-prefixes=GFX11 -enable-var-scope %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00--amdhsa -global-isel < %s | FileCheck -check-prefixes=GFX11 %s
