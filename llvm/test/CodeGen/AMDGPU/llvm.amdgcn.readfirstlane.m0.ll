...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn--amdhsa -mcpu=gfx1030 -global-isel < %s | FileCheck -check-prefixes=GFX10  %s
; RUN: llc -mtriple=amdgcn--amdhsa -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GFX11 -enable-var-scope %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn--amdhsa -mcpu=gfx1100 -global-isel < %s | FileCheck -check-prefixes=GFX11 %s
