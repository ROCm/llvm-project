...
; GFX8-NEXT:    v_lshlrev_b32_sdwa v3, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
...
; GFX8-NEXT:    s_movk_i32 s1, 0x2800
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, s1, v2
; GFX8-NEXT:    v_add_u32_e64 v14, s[0:1], s0, v2
...
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, v9, v5, vcc
...
; GFX9-NEXT:    v_lshlrev_b32_sdwa v0, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
...
; GFX8-NEXT:    s_movk_i32 s4, 0x2800
...
; GFX8-NEXT:    s_movk_i32 s5, 0x800
; GFX8-NEXT:    s_movk_i32 s6, 0x1000
; GFX8-NEXT:    s_movk_i32 s7, 0x1800
; GFX8-NEXT:    s_movk_i32 s8, 0x2000
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX8-NEXT:    v_addc_u32_e64 v9, vcc, -1, v3, s[0:1]
...
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v13, vcc, -1, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[12:13], v[12:13]
...
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v17, vcc, -1, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[8:9], v[16:17]
; GFX8-NEXT:    v_add_u32_e32 v16, vcc, s5, v2
; GFX8-NEXT:    s_mov_b64 s[2:3], vcc
; GFX8-NEXT:    v_addc_u32_e64 v21, vcc, -1, v3, s[0:1]
; GFX8-NEXT:    s_addk_i32 s9, 0x2000
; GFX8-NEXT:    s_cmp_gt_u32 s9, 0x3fffff
; GFX8-NEXT:    s_waitcnt vmcnt(3)
; GFX8-NEXT:    v_add_u32_e32 v22, vcc, v14, v6
; GFX8-NEXT:    v_addc_u32_e32 v23, vcc, v15, v7, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, s6, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v17, vcc, 0, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[14:15], v[20:21]
; GFX8-NEXT:    flat_load_dwordx2 v[16:17], v[16:17]
; GFX8-NEXT:    v_add_u32_e32 v20, vcc, s7, v2
; GFX8-NEXT:    s_mov_b64 s[2:3], vcc
; GFX8-NEXT:    v_addc_u32_e64 v7, vcc, 0, v3, s[0:1]
; GFX8-NEXT:    s_waitcnt vmcnt(4)
; GFX8-NEXT:    v_add_u32_e32 v22, vcc, v12, v22
; GFX8-NEXT:    v_addc_u32_e32 v13, vcc, v13, v23, vcc
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, s8, v2
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_addc_u32_e64 v21, vcc, 0, v3, s[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[6:7], v[6:7]
; GFX8-NEXT:    flat_load_dwordx2 v[20:21], v[20:21]
; GFX8-NEXT:    s_waitcnt vmcnt(5)
; GFX8-NEXT:    v_add_u32_e32 v22, vcc, v18, v22
; GFX8-NEXT:    v_addc_u32_e32 v23, vcc, v19, v13, vcc
; GFX8-NEXT:    v_addc_u32_e64 v13, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e32 v18, vcc, s4, v2
; GFX8-NEXT:    flat_load_dwordx2 v[12:13], v[12:13]
...
; GFX90A-NEXT:    s_mov_b64 s[0:1], vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v18, vcc, s3, v6
; GFX90A-NEXT:    v_addc_co_u32_e64 v9, s[0:1], -1, v7, s[0:1]
; GFX90A-NEXT:    v_addc_co_u32_e32 v19, vcc, 0, v7, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[28:29], v[8:9], off offset:-2048
; GFX90A-NEXT:    global_load_dwordx2 v[30:31], v[8:9], off
; GFX90A-NEXT:    v_add_co_u32_e32 v20, vcc, s4, v6
; GFX90A-NEXT:    v_addc_co_u32_e32 v21, vcc, 0, v7, vcc
...
; GFX8-NEXT:    s_movk_i32 s1, 0x1c00
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s1, v2
; GFX8-NEXT:    v_add_u32_e64 v6, s[0:1], s0, v2
; GFX8-NEXT:    s_movk_i32 s2, 0x800
; GFX8-NEXT:    v_addc_u32_e64 v7, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v8, s[0:1], s2, v2
; GFX8-NEXT:    s_movk_i32 s3, 0xc00
; GFX8-NEXT:    v_addc_u32_e64 v9, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v10, s[0:1], s3, v2
; GFX8-NEXT:    s_movk_i32 s4, 0x1000
; GFX8-NEXT:    v_addc_u32_e64 v11, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v12, s[0:1], s4, v2
; GFX8-NEXT:    s_movk_i32 s5, 0x1400
; GFX8-NEXT:    v_addc_u32_e64 v13, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v14, s[0:1], s5, v2
; GFX8-NEXT:    s_movk_i32 s6, 0x1800
; GFX8-NEXT:    v_addc_u32_e64 v15, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v16, s[0:1], s6, v2
; GFX8-NEXT:    v_addc_u32_e64 v17, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v3, vcc
; GFX8-NEXT:    s_movk_i32 s0, 0x2000
; GFX8-NEXT:    flat_load_dword v18, v[2:3]
; GFX8-NEXT:    flat_load_dword v6, v[6:7]
; GFX8-NEXT:    flat_load_dword v7, v[8:9]
; GFX8-NEXT:    flat_load_dword v8, v[10:11]
; GFX8-NEXT:    flat_load_dword v9, v[12:13]
; GFX8-NEXT:    flat_load_dword v10, v[14:15]
; GFX8-NEXT:    flat_load_dword v11, v[16:17]
; GFX8-NEXT:    flat_load_dword v12, v[4:5]
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v2
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, 0x2400, v2
; GFX8-NEXT:    flat_load_dword v4, v[4:5]
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dword v2, v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(8)
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v6, v18
...
; GFX8-NEXT:    s_waitcnt vmcnt(4)
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v10, v3
; GFX8-NEXT:    s_waitcnt vmcnt(3)
...
; GFX10-NEXT:    v_add_co_u32 v8, vcc_lo, 0x1800, v0
; GFX10-NEXT:    v_add_co_ci_u32_e32 v9, vcc_lo, 0, v1, vcc_lo
...
; GFX10-NEXT:    global_load_dword v17, v[8:9], off offset:1024
; GFX10-NEXT:    v_add_co_u32 v2, vcc_lo, v0, 0x2000
; GFX10-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v1, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v0, vcc_lo, 0x2000, v0
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GFX10-NEXT:    s_clause 0x2
; GFX10-NEXT:    global_load_dword v4, v[2:3], off offset:-2048
...
; GFX10-NEXT:    s_waitcnt vmcnt(2)
; GFX10-NEXT:    v_add3_u32 v0, v4, v0, v17
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add3_u32 v0, v5, v0, v6
...
; GFX8-NEXT:    flat_load_dwordx2 v[6:7], v[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[4:5], v[4:5]
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, s0, v2
; GFX8-NEXT:    v_addc_u32_e32 v9, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[8:9], v[8:9]
...
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v2
; GFX8-NEXT:    s_mov_b32 s2, 0x7ffffc00
; GFX8-NEXT:    s_mov_b64 s[0:1], vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, s2, v2
; GFX8-NEXT:    v_addc_u32_e64 v5, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dword v8, v[2:3]
; GFX8-NEXT:    flat_load_dword v4, v[4:5]
; GFX8-NEXT:    flat_load_dword v5, v[6:7]
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, 0x80000000, v2
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dword v2, v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v4, v8
; GFX8-NEXT:    s_waitcnt vmcnt(1)
...
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, s0, v0
; GFX9-NEXT:    s_mov_b64 s[0:1], vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, 0x80000000, v0
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[0:1], 0, v1, s[0:1]
...
; GFX8-NEXT:    v_and_b32_e32 v8, 0xffff8000, v0
; GFX8-NEXT:    v_mov_b32_e32 v1, s37
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, s36, v8
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX8-NEXT:    v_mov_b32_e32 v9, s39
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, s38, v8
; GFX8-NEXT:    v_addc_u32_e64 v3, s[0:1], 0, v1, s[0:1]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[0:1], 0, v1, s[2:3]
; GFX8-NEXT:    v_addc_u32_e32 v13, vcc, 0, v9, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[2:3], v[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[4:5], v[4:5]
; GFX8-NEXT:    flat_load_dwordx2 v[6:7], v[6:7]
...
; GFX8-NEXT:    v_addc_u32_e64 v9, s[0:1], 0, v13, s[0:1]
...
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, s36, v16
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v0, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0x1000, v1
; GFX9-NEXT:    s_mov_b64 s[0:1], vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, 0x2000, v1
; GFX9-NEXT:    v_addc_co_u32_e64 v1, s[0:1], 0, v3, s[0:1]
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v3, vcc
; GFX9-NEXT:    v_mov_b32_e32 v10, s39
; GFX9-NEXT:    global_load_dwordx2 v[4:5], v[0:1], off
; GFX9-NEXT:    global_load_dwordx2 v[6:7], v[0:1], off offset:2048
; GFX9-NEXT:    global_load_dwordx2 v[8:9], v[2:3], off
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, s38, v16
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v10, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0x2000, v1
; GFX9-NEXT:    s_mov_b64 s[0:1], vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, 0x3000, v1
; GFX9-NEXT:    v_addc_co_u32_e64 v1, s[0:1], 0, v3, s[0:1]
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v3, vcc
; GFX9-NEXT:    global_load_dwordx2 v[10:11], v[0:1], off offset:2048
...
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v2
; GFX8-NEXT:    s_movk_i32 s1, 0x3000
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, s1, v2
; GFX8-NEXT:    s_movk_i32 s2, 0x2800
; GFX8-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, s2, v2
; GFX8-NEXT:    v_addc_u32_e32 v9, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[10:11], v[2:3]
...
; GFX8-NEXT:    flat_load_dwordx2 v[8:9], v[8:9]
; GFX8-NEXT:    s_movk_i32 s0, 0x2000
; GFX8-NEXT:    s_movk_i32 s1, 0x1800
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, s1, v2
; GFX8-NEXT:    v_add_u32_e64 v14, s[0:1], s0, v2
; GFX8-NEXT:    v_addc_u32_e64 v15, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_addc_u32_e32 v13, vcc, 0, v3, vcc
...
; GFX8-NEXT:    v_addc_u32_e32 v17, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[16:17], v[16:17]
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, 0x800, v2
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[2:3], v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(6)
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v4, v10
...
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v2
; GFX8-NEXT:    v_add_u32_e64 v3, s[0:1], -1, v5
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, -1, v5, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[4:5], v[4:5]
; GFX8-NEXT:    flat_load_dwordx2 v[2:3], v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v4
