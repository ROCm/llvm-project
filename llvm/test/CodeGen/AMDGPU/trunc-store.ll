...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=verde < %s | FileCheck -check-prefixes=GCN,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GCN,VI %s
...
; SI-NEXT:    s_load_dwordx16 s[36:51], s[4:5], 0x39
