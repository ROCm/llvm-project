...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=GCN,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefixes=GCN,VI %s
