...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00-- < %s | FileCheck -check-prefix=GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03-- < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-- < %s | FileCheck -check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-- < %s | FileCheck -check-prefix=GFX10 %s
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_ashrrev_i32_e32 v5, 16, v2
; GFX7-NEXT:    v_ashrrev_i32_e32 v4, 16, v1
; GFX7-NEXT:    v_sub_i32_e32 v6, vcc, 0, v5
; GFX7-NEXT:    v_ashrrev_i32_e32 v3, 16, v0
...
; GFX6-NEXT:    v_ashrrev_i32_e32 v4, 16, v0
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_ashrrev_i32_e32 v7, 16, v3
; GFX7-NEXT:    v_ashrrev_i32_e32 v6, 16, v2
; GFX7-NEXT:    v_sub_i32_e32 v8, vcc, 0, v7
; GFX7-NEXT:    v_ashrrev_i32_e32 v5, 16, v1
; GFX7-NEXT:    v_max_i32_e32 v7, v8, v7
; GFX7-NEXT:    v_sub_i32_e32 v8, vcc, 0, v6
; GFX7-NEXT:    v_ashrrev_i32_e32 v4, 16, v0
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_ashrrev_i32_e32 v15, 16, v7
; GFX6-NEXT:    v_ashrrev_i32_e32 v14, 16, v6
; GFX6-NEXT:    v_sub_i32_e32 v16, vcc, 0, v15
; GFX6-NEXT:    v_ashrrev_i32_e32 v13, 16, v5
; GFX6-NEXT:    v_max_i32_e32 v15, v16, v15
; GFX6-NEXT:    v_sub_i32_e32 v16, vcc, 0, v14
; GFX6-NEXT:    v_ashrrev_i32_e32 v12, 16, v4
; GFX6-NEXT:    v_max_i32_e32 v14, v16, v14
; GFX6-NEXT:    v_sub_i32_e32 v16, vcc, 0, v13
; GFX6-NEXT:    v_ashrrev_i32_e32 v11, 16, v3
...
; GFX6-NEXT:    v_ashrrev_i32_e32 v8, 16, v0
...
; GFX6-NEXT:    v_or_b32_e32 v5, v5, v13
; GFX6-NEXT:    v_or_b32_e32 v6, v6, v8
; GFX6-NEXT:    v_or_b32_e32 v7, v7, v15
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_ashrrev_i32_e32 v14, 16, v6
; GFX7-NEXT:    v_sub_i32_e32 v16, vcc, 0, v15
; GFX7-NEXT:    v_ashrrev_i32_e32 v13, 16, v5
; GFX7-NEXT:    v_max_i32_e32 v15, v16, v15
; GFX7-NEXT:    v_sub_i32_e32 v16, vcc, 0, v14
; GFX7-NEXT:    v_ashrrev_i32_e32 v12, 16, v4
...
; GFX7-NEXT:    v_lshlrev_b32_e32 v8, 16, v14
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_ashrrev_i32_e32 v18, 16, v15
; GFX6-NEXT:    v_ashrrev_i32_e32 v16, 16, v14
; GFX6-NEXT:    v_sub_i32_e32 v19, vcc, 0, v18
; GFX6-NEXT:    v_ashrrev_i32_e32 v17, 16, v13
; GFX6-NEXT:    v_max_i32_e32 v18, v19, v18
; GFX6-NEXT:    v_sub_i32_e32 v19, vcc, 0, v16
; GFX6-NEXT:    v_max_i32_e32 v16, v19, v16
; GFX6-NEXT:    v_sub_i32_e32 v19, vcc, 0, v17
; GFX6-NEXT:    v_max_i32_e32 v17, v19, v17
; GFX6-NEXT:    v_ashrrev_i32_e32 v19, 16, v12
; GFX6-NEXT:    v_sub_i32_e32 v20, vcc, 0, v19
; GFX6-NEXT:    v_max_i32_e32 v19, v20, v19
; GFX6-NEXT:    v_ashrrev_i32_e32 v20, 16, v11
; GFX6-NEXT:    v_sub_i32_e32 v21, vcc, 0, v20
; GFX6-NEXT:    v_max_i32_e32 v20, v21, v20
; GFX6-NEXT:    v_ashrrev_i32_e32 v21, 16, v10
; GFX6-NEXT:    v_sub_i32_e32 v22, vcc, 0, v21
; GFX6-NEXT:    v_max_i32_e32 v21, v22, v21
; GFX6-NEXT:    v_ashrrev_i32_e32 v22, 16, v9
; GFX6-NEXT:    v_sub_i32_e32 v23, vcc, 0, v22
; GFX6-NEXT:    v_max_i32_e32 v22, v23, v22
; GFX6-NEXT:    v_ashrrev_i32_e32 v23, 16, v8
; GFX6-NEXT:    v_sub_i32_e32 v24, vcc, 0, v23
; GFX6-NEXT:    v_max_i32_e32 v23, v24, v23
; GFX6-NEXT:    v_ashrrev_i32_e32 v24, 16, v7
; GFX6-NEXT:    v_sub_i32_e32 v25, vcc, 0, v24
; GFX6-NEXT:    v_max_i32_e32 v24, v25, v24
; GFX6-NEXT:    v_ashrrev_i32_e32 v25, 16, v6
; GFX6-NEXT:    v_sub_i32_e32 v26, vcc, 0, v25
; GFX6-NEXT:    v_max_i32_e32 v25, v26, v25
; GFX6-NEXT:    v_ashrrev_i32_e32 v26, 16, v5
; GFX6-NEXT:    v_sub_i32_e32 v27, vcc, 0, v26
; GFX6-NEXT:    v_max_i32_e32 v26, v27, v26
; GFX6-NEXT:    v_ashrrev_i32_e32 v27, 16, v4
; GFX6-NEXT:    v_sub_i32_e32 v28, vcc, 0, v27
; GFX6-NEXT:    v_max_i32_e32 v27, v28, v27
; GFX6-NEXT:    v_ashrrev_i32_e32 v28, 16, v3
; GFX6-NEXT:    v_sub_i32_e32 v29, vcc, 0, v28
; GFX6-NEXT:    v_max_i32_e32 v28, v29, v28
; GFX6-NEXT:    v_ashrrev_i32_e32 v29, 16, v2
; GFX6-NEXT:    v_sub_i32_e32 v30, vcc, 0, v29
; GFX6-NEXT:    v_max_i32_e32 v29, v30, v29
; GFX6-NEXT:    v_ashrrev_i32_e32 v30, 16, v1
; GFX6-NEXT:    v_sub_i32_e32 v31, vcc, 0, v30
; GFX6-NEXT:    v_max_i32_e32 v30, v31, v30
; GFX6-NEXT:    v_ashrrev_i32_e32 v31, 16, v0
...
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v13
; GFX6-NEXT:    v_bfe_i32 v12, v12, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v13, v32, v13
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v12
; GFX6-NEXT:    v_bfe_i32 v11, v11, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v12, v32, v12
...
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v9
; GFX6-NEXT:    v_bfe_i32 v8, v8, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v9, v32, v9
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v8
; GFX6-NEXT:    v_bfe_i32 v7, v7, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v8, v32, v8
...
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v5
; GFX6-NEXT:    v_bfe_i32 v4, v4, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v5, v32, v5
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v4
; GFX6-NEXT:    v_bfe_i32 v3, v3, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v4, v32, v4
...
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v1
; GFX6-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v1, v32, v1
; GFX6-NEXT:    v_sub_i32_e32 v32, vcc, 0, v0
; GFX6-NEXT:    v_max_i32_e32 v0, v32, v0
; GFX6-NEXT:    v_lshlrev_b32_e32 v31, 16, v31
; GFX6-NEXT:    v_lshlrev_b32_e32 v30, 16, v30
; GFX6-NEXT:    v_lshlrev_b32_e32 v29, 16, v29
; GFX6-NEXT:    v_lshlrev_b32_e32 v28, 16, v28
; GFX6-NEXT:    v_lshlrev_b32_e32 v27, 16, v27
; GFX6-NEXT:    v_lshlrev_b32_e32 v26, 16, v26
; GFX6-NEXT:    v_lshlrev_b32_e32 v25, 16, v25
; GFX6-NEXT:    v_lshlrev_b32_e32 v24, 16, v24
; GFX6-NEXT:    v_lshlrev_b32_e32 v23, 16, v23
; GFX6-NEXT:    v_lshlrev_b32_e32 v22, 16, v22
; GFX6-NEXT:    v_lshlrev_b32_e32 v21, 16, v21
; GFX6-NEXT:    v_lshlrev_b32_e32 v20, 16, v20
; GFX6-NEXT:    v_lshlrev_b32_e32 v18, 16, v18
; GFX6-NEXT:    v_lshlrev_b32_e32 v17, 16, v17
; GFX6-NEXT:    v_lshlrev_b32_e32 v19, 16, v19
; GFX6-NEXT:    v_lshlrev_b32_e32 v16, 16, v16
; GFX6-NEXT:    v_or_b32_e32 v0, v0, v31
; GFX6-NEXT:    v_or_b32_e32 v1, v1, v30
; GFX6-NEXT:    v_or_b32_e32 v2, v2, v29
; GFX6-NEXT:    v_or_b32_e32 v3, v3, v28
; GFX6-NEXT:    v_or_b32_e32 v4, v4, v27
; GFX6-NEXT:    v_or_b32_e32 v5, v5, v26
; GFX6-NEXT:    v_or_b32_e32 v6, v6, v25
; GFX6-NEXT:    v_or_b32_e32 v7, v7, v24
; GFX6-NEXT:    v_or_b32_e32 v8, v8, v23
; GFX6-NEXT:    v_or_b32_e32 v9, v9, v22
; GFX6-NEXT:    v_or_b32_e32 v10, v10, v21
; GFX6-NEXT:    v_or_b32_e32 v11, v11, v20
; GFX6-NEXT:    v_or_b32_e32 v12, v12, v19
; GFX6-NEXT:    v_or_b32_e32 v13, v13, v17
; GFX6-NEXT:    v_or_b32_e32 v14, v14, v16
; GFX6-NEXT:    v_or_b32_e32 v15, v15, v18
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
; GFX7-LABEL: v_abs_v32i16:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_ashrrev_i32_e32 v18, 16, v15
; GFX7-NEXT:    v_ashrrev_i32_e32 v16, 16, v14
; GFX7-NEXT:    v_sub_i32_e32 v19, vcc, 0, v18
; GFX7-NEXT:    v_ashrrev_i32_e32 v17, 16, v13
; GFX7-NEXT:    v_max_i32_e32 v18, v19, v18
; GFX7-NEXT:    v_sub_i32_e32 v19, vcc, 0, v16
; GFX7-NEXT:    v_max_i32_e32 v16, v19, v16
; GFX7-NEXT:    v_sub_i32_e32 v19, vcc, 0, v17
; GFX7-NEXT:    v_max_i32_e32 v17, v19, v17
; GFX7-NEXT:    v_ashrrev_i32_e32 v19, 16, v12
; GFX7-NEXT:    v_sub_i32_e32 v20, vcc, 0, v19
; GFX7-NEXT:    v_max_i32_e32 v19, v20, v19
; GFX7-NEXT:    v_ashrrev_i32_e32 v20, 16, v11
; GFX7-NEXT:    v_sub_i32_e32 v21, vcc, 0, v20
; GFX7-NEXT:    v_max_i32_e32 v20, v21, v20
; GFX7-NEXT:    v_ashrrev_i32_e32 v21, 16, v10
; GFX7-NEXT:    v_sub_i32_e32 v22, vcc, 0, v21
; GFX7-NEXT:    v_max_i32_e32 v21, v22, v21
; GFX7-NEXT:    v_ashrrev_i32_e32 v22, 16, v9
; GFX7-NEXT:    v_sub_i32_e32 v23, vcc, 0, v22
; GFX7-NEXT:    v_max_i32_e32 v22, v23, v22
; GFX7-NEXT:    v_ashrrev_i32_e32 v23, 16, v8
; GFX7-NEXT:    v_sub_i32_e32 v24, vcc, 0, v23
; GFX7-NEXT:    v_max_i32_e32 v23, v24, v23
; GFX7-NEXT:    v_ashrrev_i32_e32 v24, 16, v7
; GFX7-NEXT:    v_sub_i32_e32 v25, vcc, 0, v24
; GFX7-NEXT:    v_max_i32_e32 v24, v25, v24
; GFX7-NEXT:    v_ashrrev_i32_e32 v25, 16, v6
; GFX7-NEXT:    v_sub_i32_e32 v26, vcc, 0, v25
; GFX7-NEXT:    v_max_i32_e32 v25, v26, v25
; GFX7-NEXT:    v_ashrrev_i32_e32 v26, 16, v5
; GFX7-NEXT:    v_sub_i32_e32 v27, vcc, 0, v26
; GFX7-NEXT:    v_max_i32_e32 v26, v27, v26
; GFX7-NEXT:    v_ashrrev_i32_e32 v27, 16, v4
; GFX7-NEXT:    v_sub_i32_e32 v28, vcc, 0, v27
; GFX7-NEXT:    v_max_i32_e32 v27, v28, v27
; GFX7-NEXT:    v_ashrrev_i32_e32 v28, 16, v3
; GFX7-NEXT:    v_sub_i32_e32 v29, vcc, 0, v28
; GFX7-NEXT:    v_max_i32_e32 v28, v29, v28
; GFX7-NEXT:    v_ashrrev_i32_e32 v29, 16, v2
; GFX7-NEXT:    v_sub_i32_e32 v30, vcc, 0, v29
; GFX7-NEXT:    v_max_i32_e32 v29, v30, v29
; GFX7-NEXT:    v_ashrrev_i32_e32 v30, 16, v1
; GFX7-NEXT:    v_sub_i32_e32 v31, vcc, 0, v30
; GFX7-NEXT:    v_max_i32_e32 v30, v31, v30
; GFX7-NEXT:    v_ashrrev_i32_e32 v31, 16, v0
...
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v13
; GFX7-NEXT:    v_bfe_i32 v12, v12, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v13, v32, v13
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v12
; GFX7-NEXT:    v_bfe_i32 v11, v11, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v12, v32, v12
...
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v9
; GFX7-NEXT:    v_bfe_i32 v8, v8, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v9, v32, v9
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v8
; GFX7-NEXT:    v_bfe_i32 v7, v7, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v8, v32, v8
...
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v5
; GFX7-NEXT:    v_bfe_i32 v4, v4, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v5, v32, v5
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v4
; GFX7-NEXT:    v_bfe_i32 v3, v3, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v4, v32, v4
...
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v1
; GFX7-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v1, v32, v1
; GFX7-NEXT:    v_sub_i32_e32 v32, vcc, 0, v0
; GFX7-NEXT:    v_max_i32_e32 v0, v32, v0
...
; GFX7-NEXT:    v_or_b32_e32 v0, v0, v31
; GFX7-NEXT:    v_or_b32_e32 v1, v1, v30
; GFX7-NEXT:    v_or_b32_e32 v2, v2, v29
; GFX7-NEXT:    v_or_b32_e32 v3, v3, v28
; GFX7-NEXT:    v_or_b32_e32 v4, v4, v27
; GFX7-NEXT:    v_or_b32_e32 v5, v5, v26
; GFX7-NEXT:    v_or_b32_e32 v6, v6, v25
; GFX7-NEXT:    v_or_b32_e32 v7, v7, v24
; GFX7-NEXT:    v_or_b32_e32 v8, v8, v23
; GFX7-NEXT:    v_or_b32_e32 v9, v9, v22
; GFX7-NEXT:    v_or_b32_e32 v10, v10, v21
; GFX7-NEXT:    v_or_b32_e32 v11, v11, v20
; GFX7-NEXT:    v_or_b32_e32 v12, v12, v19
; GFX7-NEXT:    v_or_b32_e32 v13, v13, v17
