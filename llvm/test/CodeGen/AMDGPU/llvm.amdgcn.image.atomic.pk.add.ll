...
; RUN: llc -mtriple=amdgpu12.00 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -mtriple=amdgpu13.10 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu13.10 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX12PLUS %s
