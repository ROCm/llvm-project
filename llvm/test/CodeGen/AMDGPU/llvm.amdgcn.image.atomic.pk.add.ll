...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -global-isel-abort=2 -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -mtriple=amdgcn -global-isel=0 -mcpu=gfx1310 < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 -global-isel-abort=2 -mcpu=gfx1310 < %s | FileCheck -check-prefixes=GFX12PLUS %s
