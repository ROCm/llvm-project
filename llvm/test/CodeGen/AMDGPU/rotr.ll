...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=r600 -mcpu=redwood < %s | FileCheck --check-prefixes=R600 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GFX10 %s
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_and_b32 s6, s3, 31
; GFX11-NEXT:    s_and_b32 s7, s2, 31
...
; SI-NEXT:    s_lshr_b64 s[4:5], s[4:5], s15
...
; SI-NEXT:    s_load_dwordx16 s[0:15], s[4:5], 0x11
; SI-NEXT:    s_mov_b32 s19, 0xf000
; SI-NEXT:    s_mov_b32 s18, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_and_b32 s22, s11, 31
; SI-NEXT:    s_mov_b32 s20, s3
; SI-NEXT:    s_mov_b32 s21, s3
; SI-NEXT:    s_and_b32 s23, s10, 31
; SI-NEXT:    s_mov_b32 s3, s2
; SI-NEXT:    s_and_b32 s24, s9, 31
; SI-NEXT:    s_mov_b32 s10, s1
; SI-NEXT:    s_mov_b32 s11, s1
; SI-NEXT:    s_and_b32 s25, s8, 31
; SI-NEXT:    s_mov_b32 s1, s0
; SI-NEXT:    s_and_b32 s26, s15, 31
; SI-NEXT:    s_mov_b32 s8, s7
; SI-NEXT:    s_mov_b32 s9, s7
; SI-NEXT:    s_and_b32 s27, s14, 31
; SI-NEXT:    s_mov_b32 s7, s6
; SI-NEXT:    s_and_b32 s28, s13, 31
; SI-NEXT:    s_mov_b32 s14, s5
; SI-NEXT:    s_mov_b32 s15, s5
; SI-NEXT:    s_and_b32 s29, s12, 31
; SI-NEXT:    s_mov_b32 s5, s4
; SI-NEXT:    s_lshr_b64 s[12:13], s[20:21], s22
; SI-NEXT:    s_lshr_b64 s[2:3], s[2:3], s23
; SI-NEXT:    s_lshr_b64 s[10:11], s[10:11], s24
; SI-NEXT:    s_lshr_b64 s[8:9], s[8:9], s26
; SI-NEXT:    s_lshr_b64 s[6:7], s[6:7], s27
; SI-NEXT:    s_lshr_b64 s[14:15], s[14:15], s28
; SI-NEXT:    s_lshr_b64 s[4:5], s[4:5], s29
; SI-NEXT:    s_lshr_b64 s[0:1], s[0:1], s25
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s6, s19, 31
; GFX10-NEXT:    s_mov_b32 s3, s11
; GFX10-NEXT:    s_and_b32 s17, s17, 31
; GFX10-NEXT:    s_mov_b32 s5, s9
; GFX10-NEXT:    s_mov_b32 s2, s11
; GFX10-NEXT:    s_mov_b32 s4, s9
; GFX10-NEXT:    s_and_b32 s7, s18, 31
; GFX10-NEXT:    s_mov_b32 s11, s10
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
...
; GFX10-NEXT:    s_mov_b32 s9, s8
; GFX10-NEXT:    s_lshr_b64 s[6:7], s[10:11], s7
; GFX10-NEXT:    s_and_b32 s3, s23, 31
; GFX10-NEXT:    s_mov_b32 s10, s15
; GFX10-NEXT:    s_mov_b32 s11, s15
; GFX10-NEXT:    s_and_b32 s5, s22, 31
; GFX10-NEXT:    s_mov_b32 s15, s14
; GFX10-NEXT:    s_lshr_b64 s[8:9], s[8:9], s16
; GFX10-NEXT:    s_lshr_b64 s[10:11], s[10:11], s3
; GFX10-NEXT:    s_lshr_b64 s[14:15], s[14:15], s5
; GFX10-NEXT:    s_and_b32 s3, s21, 31
; GFX10-NEXT:    s_mov_b32 s16, s13
; GFX10-NEXT:    s_and_b32 s5, s20, 31
; GFX10-NEXT:    s_mov_b32 s18, s12
; GFX10-NEXT:    s_mov_b32 s19, s12
; GFX10-NEXT:    s_mov_b32 s17, s13
; GFX10-NEXT:    s_lshr_b64 s[12:13], s[18:19], s5
; GFX10-NEXT:    s_lshr_b64 s[16:17], s[16:17], s3
...
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_and_b32 s6, s19, 31
; GFX11-NEXT:    s_mov_b32 s3, s11
; GFX11-NEXT:    s_and_b32 s17, s17, 31
; GFX11-NEXT:    s_mov_b32 s5, s9
; GFX11-NEXT:    s_mov_b32 s2, s11
; GFX11-NEXT:    s_mov_b32 s4, s9
; GFX11-NEXT:    s_and_b32 s7, s18, 31
; GFX11-NEXT:    s_mov_b32 s11, s10
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
...
; GFX11-NEXT:    s_mov_b32 s9, s8
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[10:11], s7
; GFX11-NEXT:    s_and_b32 s3, s23, 31
; GFX11-NEXT:    s_mov_b32 s10, s15
; GFX11-NEXT:    s_mov_b32 s11, s15
; GFX11-NEXT:    s_and_b32 s5, s22, 31
; GFX11-NEXT:    s_mov_b32 s15, s14
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[8:9], s16
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[10:11], s3
; GFX11-NEXT:    s_lshr_b64 s[14:15], s[14:15], s5
; GFX11-NEXT:    s_and_b32 s3, s21, 31
; GFX11-NEXT:    s_mov_b32 s16, s13
; GFX11-NEXT:    s_and_b32 s5, s20, 31
; GFX11-NEXT:    s_mov_b32 s18, s12
; GFX11-NEXT:    s_mov_b32 s19, s12
; GFX11-NEXT:    s_mov_b32 s17, s13
; GFX11-NEXT:    s_lshr_b64 s[12:13], s[18:19], s5
; GFX11-NEXT:    s_lshr_b64 s[16:17], s[16:17], s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s16
; GFX11-NEXT:    v_dual_mov_b32 v0, s12 :: v_dual_mov_b32 v3, s10
