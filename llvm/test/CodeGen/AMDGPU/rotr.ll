...
; SI-NEXT:    s_lshr_b64 s[8:9], s[8:9], s7
...
; SI-NEXT:    s_lshr_b64 s[12:13], s[12:13], s7
; SI-NEXT:    s_and_b32 s3, s5, 31
; SI-NEXT:    s_mov_b32 s6, s1
; SI-NEXT:    s_mov_b32 s7, s1
; SI-NEXT:    s_lshr_b64 s[6:7], s[6:7], s3
...
; SI-NEXT:    s_and_b32 s10, s10, 31
; SI-NEXT:    s_mov_b32 s3, s2
; SI-NEXT:    s_and_b32 s11, s11, 31
; SI-NEXT:    s_lshr_b64 s[2:3], s[2:3], s10
; SI-NEXT:    s_lshr_b64 s[20:21], s[20:21], s11
; SI-NEXT:    s_and_b32 s3, s9, 31
; SI-NEXT:    s_mov_b32 s10, s1
; SI-NEXT:    s_mov_b32 s11, s1
; SI-NEXT:    s_lshr_b64 s[10:11], s[10:11], s3
; SI-NEXT:    s_and_b32 s3, s8, 31
; SI-NEXT:    s_mov_b32 s1, s0
; SI-NEXT:    s_lshr_b64 s[0:1], s[0:1], s3
; SI-NEXT:    s_and_b32 s1, s15, 31
; SI-NEXT:    s_mov_b32 s8, s7
; SI-NEXT:    s_mov_b32 s9, s7
; SI-NEXT:    s_lshr_b64 s[8:9], s[8:9], s1
; SI-NEXT:    s_and_b32 s1, s14, 31
; SI-NEXT:    s_mov_b32 s7, s6
; SI-NEXT:    s_lshr_b64 s[6:7], s[6:7], s1
; SI-NEXT:    s_and_b32 s1, s13, 31
; SI-NEXT:    s_mov_b32 s14, s5
; SI-NEXT:    s_mov_b32 s15, s5
; SI-NEXT:    s_lshr_b64 s[14:15], s[14:15], s1
; SI-NEXT:    s_and_b32 s1, s12, 31
; SI-NEXT:    s_mov_b32 s5, s4
; SI-NEXT:    s_lshr_b64 s[4:5], s[4:5], s1
; SI-NEXT:    v_mov_b32_e32 v0, s4
