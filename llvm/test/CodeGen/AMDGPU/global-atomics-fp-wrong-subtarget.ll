...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -filetype=obj < %s | llvm-objdump --triple=amdgpu8.03--amdhsa -d - | FileCheck -check-prefix=DISASSEMBLY-VI %s
