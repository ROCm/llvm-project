...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.50 -global-isel=1 -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -enable-var-scope --check-prefix=GISEL %s

; RUN: llc -mtriple=amdgpu9.50 -global-isel=0 < %s | FileCheck -enable-var-scope --check-prefixes=GCN-VGPR,SDAG-VGPR %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.50 -global-isel=1 < %s | FileCheck -enable-var-scope --check-prefixes=GCN-VGPR,GISEL-VGPR %s
