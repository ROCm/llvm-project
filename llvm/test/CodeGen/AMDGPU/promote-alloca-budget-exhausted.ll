...
; RUN: opt -S -mtriple=amdgpu7.00-unknown-amdhsa -amdgpu-promote-alloca-to-vector-limit=128 -passes=amdgpu-promote-alloca-to-vector -amdgpu-promote-alloca-to-vector-max-regs=32 %s -o - | FileCheck %s
