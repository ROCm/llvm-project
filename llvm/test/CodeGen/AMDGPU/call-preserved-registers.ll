...
; FLATSCR-NEXT:    s_add_u32 s0, s0, void_func_void_clobber_vcc@rel32@lo+4
; FLATSCR-NEXT:    s_addc_u32 s1, s1, void_func_void_clobber_vcc@rel32@hi+12
...
; FLATSCR-NEXT:    s_mov_b32 s32, 0
; FLATSCR-NEXT:    s_getpc_b64 s[0:1]
; FLATSCR-NEXT:    s_add_u32 s0, s0, void_func_void_clobber_s33@rel32@lo+4
; FLATSCR-NEXT:    s_addc_u32 s1, s1, void_func_void_clobber_s33@rel32@hi+12
; FLATSCR-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; FLATSCR-NEXT:    s_endpgm
...
; FLATSCR-NEXT:    s_mov_b32 s32, 0
; FLATSCR-NEXT:    s_getpc_b64 s[0:1]
; FLATSCR-NEXT:    s_add_u32 s0, s0, void_func_void_clobber_s34@rel32@lo+4
; FLATSCR-NEXT:    s_addc_u32 s1, s1, void_func_void_clobber_s34@rel32@hi+12
; FLATSCR-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; FLATSCR-NEXT:    s_endpgm
