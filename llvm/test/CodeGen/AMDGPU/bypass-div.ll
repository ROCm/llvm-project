...
; GFX9-NEXT:    v_sub_co_u32_e32 v13, vcc, 0, v10
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, 0, v9, vcc
...
; GFX9-NEXT:    v_mul_lo_u32 v5, v14, v12
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v12, 0
; GFX9-NEXT:    v_add3_u32 v3, v3, v6, v5
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v12, v3, 0
; GFX9-NEXT:    v_mul_hi_u32 v15, v12, v2
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v3, 0
...
; GFX9-NEXT:    v_mul_lo_u32 v6, v14, v12
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v12, 0
...
; GFX9-NEXT:    v_xor_b32_e32 v14, v0, v8
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v2, v7
; GFX9-NEXT:    v_xor_b32_e32 v13, v1, v8
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v11, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v2, 0
; GFX9-NEXT:    v_mul_hi_u32 v7, v14, v5
...
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v1, v6, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
...
; GFX9-NEXT:    v_sub_u32_e32 v5, v13, v1
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v14, v0
...
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v6, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v5, v9
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v7, v6, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, 2, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v3, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, 1, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v12, vcc, 0, v3, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v12, v7, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v3, v5, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v2, v6, vcc
; GFX9-NEXT:    v_xor_b32_e32 v5, v8, v4
...
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v4, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v5, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v12, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, v11, v5, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v0, v6, 0
; GFX9-NEXT:    v_mul_hi_u32 v10, v0, v8
...
; GFX9-NEXT:    v_addc_co_u32_e32 v4, vcc, v5, v9, vcc
...
; GFX9-NEXT:    v_sub_co_u32_e32 v5, vcc, v0, v2
; GFX9-NEXT:    v_subbrev_co_u32_e32 v4, vcc, 0, v4, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v3
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v8, v5, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, 2, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, 1, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v10, vcc, 0, v7, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v10, v8, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v9, v5, vcc
...
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v2, 0
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v5, 0
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v13, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v4, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v3, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v6, vcc
...
; GFX9-NEXT:    v_xor_b32_e32 v8, v0, v6
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v2, v5
; GFX9-NEXT:    v_xor_b32_e32 v7, v1, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v11, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v2, 0
; GFX9-NEXT:    v_mul_hi_u32 v11, v8, v4
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v7, v4, 0
...
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v1, v5, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
...
; GFX9-NEXT:    v_sub_u32_e32 v2, v7, v1
...
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v9
; GFX9-NEXT:    v_subb_co_u32_e64 v2, s[4:5], v2, v9, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v5, v7, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v7, vcc, v3, v10
...
; GFX9-NEXT:    v_xor_b32_e32 v4, v0, v6
; GFX9-NEXT:    v_xor_b32_e32 v5, v1, v6
; GFX9-NEXT:    v_sub_co_u32_e32 v4, vcc, v4, v6
; GFX9-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX9-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX9-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v6, vcc
...
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v5, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v7, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v6, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v7, v3
...
; GFX9-NEXT:    v_sub_co_u32_e32 v14, vcc, 0, v3
; GFX9-NEXT:    v_subb_co_u32_e32 v15, vcc, 0, v2, vcc
...
; GFX9-NEXT:    v_mul_lo_u32 v7, v15, v13
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v14, v13, 0
; GFX9-NEXT:    v_add3_u32 v8, v6, v8, v7
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v8, 0
; GFX9-NEXT:    v_mul_hi_u32 v16, v13, v5
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v12, v5, 0
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v8, 0
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v16, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, v6, v11, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v9, vcc
...
; GFX9-NEXT:    v_mul_lo_u32 v7, v14, v12
; GFX9-NEXT:    v_mul_lo_u32 v8, v15, v13
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v14, v13, 0
; GFX9-NEXT:    v_add3_u32 v8, v6, v7, v8
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v8, 0
; GFX9-NEXT:    v_mul_hi_u32 v14, v13, v5
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v12, v5, 0
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v8, 0
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v14, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, v6, v11, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v9, vcc
...
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v13, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, v12, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v11, v5, 0
; GFX9-NEXT:    v_mul_hi_u32 v12, v11, v7
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v10, v7, 0
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v5, 0
; GFX9-NEXT:    v_xor_b32_e32 v4, v9, v4
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v1, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v6, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v0, v5
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v7, v2, v5
; GFX9-NEXT:    v_mul_lo_u32 v8, v3, v6
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v5, 0
; GFX9-NEXT:    v_add3_u32 v1, v1, v8, v7
; GFX9-NEXT:    v_sub_u32_e32 v7, v10, v1
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v11, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v7, s[4:5], v7, v2, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v10, v1, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v8, vcc, v0, v3
; GFX9-NEXT:    v_subbrev_co_u32_e64 v10, s[4:5], 0, v7, vcc
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], v10, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v12, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v12, s[4:5], 2, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v13, s[4:5], 0, v6, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v14, s[4:5], 1, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v15, s[4:5], 0, v6, s[4:5]
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v11
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v1, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v15, v13, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v0, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v12, v14, v12, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], v1, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v2, vcc, v7, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v14, s[6:7]
; GFX9-NEXT:    v_sub_co_u32_e32 v3, vcc, v8, v3
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v13
; GFX9-NEXT:    v_subbrev_co_u32_e32 v2, vcc, 0, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v12, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v10, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v11, s[6:7]
; GFX9-NEXT:    v_xor_b32_e32 v5, v5, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v2, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v8, v3, s[4:5]
; GFX9-NEXT:    v_xor_b32_e32 v6, v6, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v2, s[6:7]
; GFX9-NEXT:    v_sub_co_u32_e32 v7, vcc, v5, v4
; GFX9-NEXT:    v_xor_b32_e32 v11, v0, v9
; GFX9-NEXT:    v_subb_co_u32_e32 v8, vcc, v6, v4, vcc
; GFX9-NEXT:    v_xor_b32_e32 v10, v1, v9
; GFX9-NEXT:    v_sub_co_u32_e32 v5, vcc, v11, v9
; GFX9-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX9-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX9-NEXT:    v_subb_co_u32_e32 v6, vcc, v10, v9, vcc
...
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v5, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v9, vcc, v0, v2
; GFX9-NEXT:    v_subbrev_co_u32_e64 v10, s[4:5], 0, v8, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v10, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[4:5]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[4:5]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], v10, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v4, v5, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[4:5], 2, v6
; GFX9-NEXT:    v_addc_co_u32_e64 v11, s[4:5], 0, v7, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v12, s[4:5], 1, v6
; GFX9-NEXT:    v_addc_co_u32_e64 v13, s[4:5], 0, v7, s[4:5]
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v4
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v1, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v13, v11, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v12, v5, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v0, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], v1, v3
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v10, v3, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v7, v4, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v1, v3, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v9, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v6, v11, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v0, v1, s[6:7]
; GFX9-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX9-NEXT:    ; implicit-def: $vgpr0_vgpr1
...
; GFX9-NEXT:    v_mul_hi_u32 v10, v1, v8
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v2, v8, 0
...
; GFX9-NEXT:    v_sub_co_u32_e32 v5, vcc, v1, v3
; GFX9-NEXT:    v_subbrev_co_u32_e32 v4, vcc, 0, v4, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v0
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v8, v5, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, 2, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, 1, v6
