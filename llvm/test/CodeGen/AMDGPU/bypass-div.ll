...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=GFX9 %s
...
; GFX9-NEXT:    v_or_b32_e32 v0, v4, v3
...
; GFX9-NEXT:    v_add3_u32 v14, v1, v7, v6
; GFX9-NEXT:    v_mul_hi_u32 v15, v11, v0
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v14, 0
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v0, 0
; GFX9-NEXT:    v_add_co_u32_e32 v15, vcc, v15, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v16, vcc, 0, v7, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v3, v14, 0
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v15, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v16, v1, vcc
...
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v12, 0
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v0, 0
; GFX9-NEXT:    v_add_co_u32_e32 v13, vcc, v13, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v14, vcc, 0, v7, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v3, v12, 0
...
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, v3, v1, vcc
; GFX9-NEXT:    v_ashrrev_i32_e32 v11, 31, v4
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v5, v11
; GFX9-NEXT:    v_xor_b32_e32 v12, v0, v11
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v12, v7, 0
; GFX9-NEXT:    v_mul_hi_u32 v13, v12, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v11, vcc
; GFX9-NEXT:    v_xor_b32_e32 v14, v3, v11
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v14, v6, 0
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v13, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v13, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v7, 0
; GFX9-NEXT:    v_add_co_u32_e32 v3, vcc, v6, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v13, v4, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v3, vcc, v3, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v4, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v6, v9, v3
; GFX9-NEXT:    v_mul_lo_u32 v7, v10, v4
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v3, 0
; GFX9-NEXT:    v_add3_u32 v1, v1, v7, v6
; GFX9-NEXT:    v_sub_u32_e32 v6, v14, v1
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v12, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v6, s[4:5], v6, v9, vcc
; GFX9-NEXT:    v_sub_co_u32_e64 v7, s[4:5], v0, v10
...
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[4:5]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], v6, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v12, v7, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v7, s[4:5], 2, v3
; GFX9-NEXT:    v_addc_co_u32_e64 v12, s[4:5], 0, v4, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v13, s[4:5], 1, v3
; GFX9-NEXT:    v_addc_co_u32_e64 v15, s[4:5], 0, v4, s[4:5]
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v14, v1, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v6
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v15, v12, s[4:5]
...
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v13, v7, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v4, v6, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; GFX9-NEXT:    v_xor_b32_e32 v3, v11, v8
; GFX9-NEXT:    v_xor_b32_e32 v4, v0, v3
...
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v3, v0, vcc
; GFX9-NEXT:    v_xor_b32_e32 v8, v3, v0
...
; GFX9-NEXT:    v_add3_u32 v13, v1, v7, v6
; GFX9-NEXT:    v_mul_hi_u32 v14, v10, v0
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v13, 0
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v0, 0
; GFX9-NEXT:    v_add_co_u32_e32 v14, vcc, v14, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v15, vcc, 0, v7, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v3, v13, 0
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v14, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v15, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX9-NEXT:    v_mul_lo_u32 v7, v12, v10
; GFX9-NEXT:    v_mul_hi_u32 v12, v10, v0
; GFX9-NEXT:    v_add3_u32 v11, v1, v6, v7
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v11, 0
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v0, 0
; GFX9-NEXT:    v_add_co_u32_e32 v12, vcc, v12, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v13, vcc, 0, v7, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v3, v11, 0
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v13, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v10, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, v3, v1, vcc
; GFX9-NEXT:    v_ashrrev_i32_e32 v10, 31, v4
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v5, v10
; GFX9-NEXT:    v_xor_b32_e32 v11, v0, v10
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v11, v7, 0
; GFX9-NEXT:    v_mul_hi_u32 v12, v11, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v10, vcc
; GFX9-NEXT:    v_xor_b32_e32 v13, v3, v10
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v13, v6, 0
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v12, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v7, 0
; GFX9-NEXT:    v_add_co_u32_e32 v3, vcc, v6, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v12, v4, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v3, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v3, v8, v0
; GFX9-NEXT:    v_mul_lo_u32 v4, v9, v1
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v9, v0, 0
; GFX9-NEXT:    v_add3_u32 v1, v1, v4, v3
; GFX9-NEXT:    v_sub_u32_e32 v3, v13, v1
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v11, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v3, s[4:5], v3, v8, vcc
; GFX9-NEXT:    v_sub_co_u32_e64 v4, s[4:5], v0, v9
; GFX9-NEXT:    v_subbrev_co_u32_e64 v6, s[6:7], 0, v3, s[4:5]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v6, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v4, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], v6, v8
; GFX9-NEXT:    v_subb_co_u32_e64 v3, s[4:5], v3, v8, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v11, s[6:7]
; GFX9-NEXT:    v_sub_co_u32_e64 v11, s[4:5], v4, v9
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v6, v3, s[4:5]
...
; GFX9-NEXT:    v_sub_u32_e32 v0, v5, v0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v7, v10, s[4:5]
...
; GFX9-NEXT:    v_mov_b32_e32 v5, v0
; GFX9-NEXT:    v_or_b32_e32 v0, v6, v7
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
...
; GFX9-NEXT:  .LBB8_1:
; GFX9-NEXT:    v_ashrrev_i32_e32 v9, 31, v7
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v4, v9
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, v7, v9, vcc
; GFX9-NEXT:    v_xor_b32_e32 v10, v1, v9
; GFX9-NEXT:    v_xor_b32_e32 v11, v0, v9
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, v11
; GFX9-NEXT:    v_cvt_f32_u32_e32 v1, v10
; GFX9-NEXT:    v_sub_co_u32_e32 v13, vcc, 0, v11
...
; GFX9-NEXT:    v_mul_lo_u32 v2, v14, v12
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v12, 0
; GFX9-NEXT:    v_add3_u32 v15, v1, v7, v2
; GFX9-NEXT:    v_mul_hi_u32 v16, v12, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v12, v15, 0
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v3, v0, 0
; GFX9-NEXT:    v_add_co_u32_e32 v16, vcc, v16, v1
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v15, 0
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v2, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v16, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v2, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX9-NEXT:    v_mul_hi_u32 v14, v12, v0
; GFX9-NEXT:    v_add3_u32 v13, v1, v2, v7
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v12, v13, 0
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v3, v0, 0
...
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v2, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, v3, v1, vcc
; GFX9-NEXT:    v_ashrrev_i32_e32 v8, 31, v6
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v5, v8
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v6, v8, vcc
; GFX9-NEXT:    v_xor_b32_e32 v6, v0, v8
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v6, v7, 0
; GFX9-NEXT:    v_mul_hi_u32 v12, v6, v2
; GFX9-NEXT:    v_xor_b32_e32 v13, v3, v8
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v2, 0
; GFX9-NEXT:    v_add_co_u32_e32 v12, vcc, v12, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v14, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v7, 0
...
; GFX9-NEXT:    v_mul_lo_u32 v12, v11, v3
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v11, v2, 0
; GFX9-NEXT:    v_add3_u32 v1, v1, v12, v7
; GFX9-NEXT:    v_sub_u32_e32 v7, v13, v1
; GFX9-NEXT:    v_sub_co_u32_e32 v6, vcc, v6, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v7, s[4:5], v7, v10, vcc
; GFX9-NEXT:    v_sub_co_u32_e64 v12, s[4:5], v6, v11
; GFX9-NEXT:    v_subbrev_co_u32_e64 v14, s[6:7], 0, v7, s[4:5]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v14, v10
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], v14, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v15, s[6:7]
; GFX9-NEXT:    v_add_co_u32_e64 v15, s[6:7], 2, v2
; GFX9-NEXT:    v_addc_co_u32_e64 v16, s[6:7], 0, v3, s[6:7]
; GFX9-NEXT:    v_add_co_u32_e64 v17, s[6:7], 1, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v13, vcc, v13, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v18, s[6:7], 0, v3, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v13, v10
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v6, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v18, v16, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v13, v10
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v1, v16, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v17, v15, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v3, v0, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc
; GFX9-NEXT:    v_xor_b32_e32 v2, v8, v9
...
; GFX9-NEXT:    v_subb_co_u32_e64 v2, s[4:5], v7, v10, s[4:5]
; GFX9-NEXT:    v_sub_co_u32_e64 v3, s[4:5], v12, v11
; GFX9-NEXT:    v_subbrev_co_u32_e64 v2, s[4:5], 0, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v14, v2, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v12, v3, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v13, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v6, v3, vcc
; GFX9-NEXT:    v_xor_b32_e32 v6, v2, v8
; GFX9-NEXT:    v_xor_b32_e32 v2, v3, v8
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, v2, v8
; GFX9-NEXT:    v_subb_co_u32_e32 v3, vcc, v6, v8, vcc
; GFX9-NEXT:  .LBB8_2:
; GFX9-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX9-NEXT:    s_xor_b64 s[4:5], exec, s[10:11]
...
; GFX9-NEXT:    v_sub_co_u32_e32 v9, vcc, v5, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v8, s[4:5], v8, v6, vcc
; GFX9-NEXT:    v_sub_co_u32_e64 v10, s[4:5], v9, v4
; GFX9-NEXT:    v_subbrev_co_u32_e64 v11, s[6:7], 0, v8, s[4:5]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v11, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[6:7], v10, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], v11, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v12, s[6:7]
; GFX9-NEXT:    v_add_co_u32_e64 v12, s[6:7], 2, v2
; GFX9-NEXT:    v_addc_co_u32_e64 v13, s[6:7], 0, v3, s[6:7]
; GFX9-NEXT:    v_add_co_u32_e64 v14, s[6:7], 1, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v7, vcc, v7, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v15, s[6:7], 0, v3, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v7, v6
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v9, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v15, v13, s[6:7]
...
; GFX9-NEXT:    v_sub_co_u32_e64 v6, s[4:5], v10, v4
; GFX9-NEXT:    v_subbrev_co_u32_e64 v2, s[4:5], 0, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v11, v2, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v7, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v10, v6, s[6:7]
...
; GFX9-NEXT:    v_subb_co_u32_e64 v8, s[4:5], v8, v4, vcc
; GFX9-NEXT:    v_sub_co_u32_e64 v9, s[4:5], v0, v3
; GFX9-NEXT:    v_subbrev_co_u32_e64 v8, s[4:5], 0, v8, s[4:5]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v8, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[4:5]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], v8, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v10, v9, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e64 v9, s[4:5], 2, v6
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v5, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v10, s[4:5], 0, v7, s[4:5]
