...
; GFX9-NEXT:  .LBB2_2:
; GFX9-NEXT:    s_or_b64 exec, exec, vcc
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, vcc
; GFX9-NEXT:    s_mov_b64 exec, vcc
; GFX9-NEXT:    ; divergent control-flow edge
...
; GFX9-NEXT:    v_mul_hi_u32 v3, v1, v3
; GFX9-NEXT:    v_add_u32_e32 v1, v1, v3
; GFX9-NEXT:    v_mul_hi_u32 v3, v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    v_mul_lo_u32 v4, v3, v2
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v5, s[4:5]
; GFX9-NEXT:    v_sub_u32_e32 v4, v0, v2
; GFX9-NEXT:    v_add_u32_e32 v5, 1, v3
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v0, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v0, v4, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v3, v5, s[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v3, v1
; GFX9-NEXT:  .LBB8_2:
; GFX9-NEXT:    s_or_b64 exec, exec, vcc
; GFX9-NEXT:    s_xor_b64 s[10:11], exec, vcc
; GFX9-NEXT:    s_mov_b64 exec, vcc
; GFX9-NEXT:    ; divergent control-flow edge
; GFX9-NEXT:    s_cbranch_execz .LBB8_4
; GFX9-NEXT:  .LBB8_3:
; GFX9-NEXT:    v_ashrrev_i32_e32 v9, 31, v3
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v2, v9
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v3, v9, vcc
; GFX9-NEXT:    v_xor_b32_e32 v2, v2, v9
; GFX9-NEXT:    v_xor_b32_e32 v3, v4, v9
; GFX9-NEXT:    v_cvt_f32_u32_e32 v4, v3
; GFX9-NEXT:    v_cvt_f32_u32_e32 v5, v2
; GFX9-NEXT:    v_sub_co_u32_e32 v12, vcc, 0, v3
; GFX9-NEXT:    v_subb_co_u32_e32 v13, vcc, 0, v2, vcc
; GFX9-NEXT:    v_madmk_f32 v4, v5, 0x4f800000, v4
; GFX9-NEXT:    v_rcp_f32_e32 v4, v4
; GFX9-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
; GFX9-NEXT:    v_mul_f32_e32 v5, 0x2f800000, v4
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v11, v4
; GFX9-NEXT:    v_mul_lo_u32 v7, v12, v10
; GFX9-NEXT:    v_mul_lo_u32 v6, v13, v11
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v11, 0
; GFX9-NEXT:    v_add3_u32 v14, v5, v7, v6
; GFX9-NEXT:    v_mul_hi_u32 v15, v11, v4
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v14, 0
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v10, v4, 0
; GFX9-NEXT:    v_add_co_u32_e32 v15, vcc, v15, v5
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v14, 0
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v6, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v15, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, v6, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v5, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v6, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v5, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, v11, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v10, vcc, v10, v5, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v11, 0
; GFX9-NEXT:    v_mul_lo_u32 v6, v12, v10
; GFX9-NEXT:    v_mul_lo_u32 v7, v13, v11
; GFX9-NEXT:    v_mul_hi_u32 v13, v11, v4
; GFX9-NEXT:    v_add3_u32 v12, v5, v6, v7
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v12, 0
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v10, v4, 0
...
; GFX9-NEXT:    v_addc_co_u32_e32 v4, vcc, v12, v5, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v4, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v6, v2, v4
; GFX9-NEXT:    v_mul_lo_u32 v10, v3, v5
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v4, 0
; GFX9-NEXT:    v_add3_u32 v1, v1, v10, v6
; GFX9-NEXT:    v_sub_u32_e32 v6, v11, v1
; GFX9-NEXT:    v_sub_co_u32_e32 v8, vcc, v8, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v6, s[4:5], v6, v2, vcc
; GFX9-NEXT:    v_sub_co_u32_e64 v10, s[4:5], v8, v3
...
; GFX9-NEXT:    v_sub_co_u32_e64 v0, s[8:9], v0, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v11, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v8, v3, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v1, s[8:9], v5, v4, s[8:9]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v10, v3, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v9, v2, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v6, v0, vcc
...
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v3
