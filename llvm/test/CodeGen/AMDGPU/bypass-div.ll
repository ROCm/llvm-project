...
; GFX9-NEXT:    v_sub_u32_e32 v7, v1, v2
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v2
...
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v4, v6, 0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v11, v9, s[4:5]
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
...
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v5, v0
; GFX9-NEXT:    v_subb_co_u32_e64 v5, s[4:5], v6, v3, vcc
...
; GFX9-NEXT:  .LBB8_1:
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, v7
; GFX9-NEXT:    v_sub_u32_e32 v1, 0, v7
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_mul_lo_u32 v1, v1, v0
...
; GFX9-NEXT:    v_mul_hi_u32 v0, v5, v0
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    v_mul_lo_u32 v2, v0, v7
; GFX9-NEXT:    v_add_u32_e32 v3, 1, v0
; GFX9-NEXT:    v_sub_u32_e32 v2, v5, v2
; GFX9-NEXT:    v_sub_u32_e32 v8, v2, v7
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, v8, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v3, s[4:5]
; GFX9-NEXT:    v_sub_u32_e32 v3, v2, v7
; GFX9-NEXT:    v_add_u32_e32 v8, 1, v0
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v7
...
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v7, v8
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, v6, v8, vcc
; GFX9-NEXT:    v_xor_b32_e32 v9, v1, v8
; GFX9-NEXT:    v_xor_b32_e32 v10, v0, v8
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, v10
; GFX9-NEXT:    v_cvt_f32_u32_e32 v1, v9
...
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v5, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v7, vcc
; GFX9-NEXT:    v_xor_b32_e32 v4, v0, v7
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v6, 0
; GFX9-NEXT:    v_mul_hi_u32 v5, v4, v2
; GFX9-NEXT:    v_xor_b32_e32 v11, v3, v7
...
; GFX9-NEXT:    v_or_b32_e32 v0, v6, v5
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
...
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, 0, v5, vcc
; GFX9-NEXT:    v_madmk_f32 v0, v1, 0x4f800000, v0
; GFX9-NEXT:    v_rcp_f32_e32 v0, v0
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GFX9-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
...
; GFX9-NEXT:    v_subb_co_u32_e32 v6, vcc, v6, v1, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v14, s[6:7], 0, v3, s[6:7]
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v6, v5
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v7, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v14, v12, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, -1, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v6, v5
...
; GFX9-NEXT:    v_subb_co_u32_e64 v2, s[4:5], v8, v5, s[4:5]
; GFX9-NEXT:    v_sub_co_u32_e64 v4, s[4:5], v9, v4
; GFX9-NEXT:    v_subbrev_co_u32_e64 v2, s[4:5], 0, v2, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v10, v2, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v6, v2, vcc
...
; GFX9-NEXT:    v_sub_u32_e32 v7, v1, v3
