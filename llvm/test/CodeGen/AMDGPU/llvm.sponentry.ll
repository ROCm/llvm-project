...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn--amdpal -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=CHECK,DAGISEL
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn--amdpal -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck %s --check-prefixes=CHECK,DAGISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn--amdpal -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=CHECK,GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn--amdpal -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck %s --check-prefixes=CHECK,GISEL
...
; DAGISEL-NEXT:    s_and_saveexec_b32 s0, s0
...
; DAGISEL-NEXT:    s_cmovk_i32 s1, 0x1c0
; DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
...
; GISEL-NEXT:    v_cmpx_gt_i32_e32 0x43, v0
; GISEL-NEXT:  ; %bb.1: ; %if.then
; GISEL-NEXT:    s_getreg_b32 s1, hwreg(HW_REG_WAVE_HW_ID2, 8, 2)
; GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GISEL-NEXT:    s_cmp_lg_u32 0, s1
; GISEL-NEXT:    s_cmovk_i32 s1, 0x1c0
