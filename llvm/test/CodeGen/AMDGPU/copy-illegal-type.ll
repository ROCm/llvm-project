...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global -amdgpu-sdwa-peephole=0 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=VI %s
...
; SI-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 offset:2
...
; VI-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 offset:2
...
; VI-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:2
; VI-NEXT:    s_mov_b32 s4, s0
; VI-NEXT:    s_mov_b32 s5, s1
; VI-NEXT:    s_waitcnt vmcnt(1)
...
; SI-NEXT:    s_mov_b32 s4, s2
; SI-NEXT:    s_mov_b32 s5, s3
; SI-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 offset:3
; SI-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:2
; SI-NEXT:    buffer_load_ubyte v2, off, s[4:7], 0 offset:1
; SI-NEXT:    buffer_load_ubyte v3, off, s[4:7], 0
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
...
; VI-NEXT:    s_mov_b32 s4, s2
; VI-NEXT:    s_mov_b32 s5, s3
; VI-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 offset:3
; VI-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:2
; VI-NEXT:    buffer_load_ubyte v2, off, s[4:7], 0 offset:1
; VI-NEXT:    buffer_load_ubyte v3, off, s[4:7], 0
; VI-NEXT:    s_mov_b32 s4, s0
; VI-NEXT:    s_mov_b32 s5, s1
