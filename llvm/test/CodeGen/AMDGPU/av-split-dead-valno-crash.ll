...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 -stress-regalloc=18 < %s | FileCheck %s
...
; CHECK-NEXT:    v_accvgpr_write_b32 a6, v1 ; Reload Reuse
; CHECK-NEXT:    v_accvgpr_write_b32 a7, v0 ; Reload Reuse
; CHECK-NEXT:    v_mov_b32_e32 v1, 0xbe927e4f
; CHECK-NEXT:    v_mov_b32_e32 v0, 0xa17f65f6
...
; CHECK-NEXT:    s_and_b64 s[8:9], exec, 0
; CHECK-NEXT:    v_mov_b32_e32 v2, 0
; CHECK-NEXT:    v_mov_b64_e32 v[20:21], s[14:15]
...
; CHECK-NEXT:    v_mov_b64_e32 v[0:1], s[16:17]
...
; CHECK-NEXT:    global_store_dwordx2 v2, v[22:23], s[12:13]
...
; CHECK-NEXT:    v_accvgpr_read_b32 v1, a6 ; Reload Reuse
; CHECK-NEXT:    v_accvgpr_read_b32 v0, a7 ; Reload Reuse
...
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[26:27], v[0:1]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[28:29]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[4:5]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[6:7]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[8:9]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[10:11]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[12:13]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[14:15]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[16:17]
; CHECK-NEXT:    v_fma_f64 v[0:1], 0, v[0:1], v[18:19]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    v_cmp_nlg_f64_e64 s[10:11], 0, v[28:29]
; CHECK-NEXT:    v_accvgpr_write_b32 a0, v26
; CHECK-NEXT:    v_cndmask_b32_e64 v29, v25, 0, s[18:19]
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[10:11]
; CHECK-NEXT:    s_and_b64 s[10:11], exec, s[18:19]
; CHECK-NEXT:    v_mov_b32_e32 v1, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v28, v24, 0, s[18:19]
; CHECK-NEXT:    s_cselect_b32 s21, s21, 0
; CHECK-NEXT:    s_cselect_b32 s20, s20, 0
; CHECK-NEXT:    v_accvgpr_write_b32 a1, v27
; CHECK-NEXT:    global_store_dwordx2 v2, v[0:1], s[12:13]
