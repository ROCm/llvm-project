...
; CHECK-NEXT:    v_accvgpr_read_b32 v31, a6 ; Reload Reuse
; CHECK-NEXT:    v_accvgpr_read_b32 v30, a7 ; Reload Reuse
...
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[30:31]
; CHECK-NEXT:    v_mov_b64_e32 v[30:31], v[6:7]
; CHECK-NEXT:    v_fmac_f64_e32 v[30:31], 0, v[28:29]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[8:9]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[30:31]
; CHECK-NEXT:    v_mov_b64_e32 v[30:31], v[10:11]
; CHECK-NEXT:    v_fmac_f64_e32 v[30:31], 0, v[28:29]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[12:13]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[30:31]
; CHECK-NEXT:    v_mov_b64_e32 v[30:31], v[14:15]
; CHECK-NEXT:    v_fmac_f64_e32 v[30:31], 0, v[28:29]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[16:17]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[30:31]
; CHECK-NEXT:    v_mov_b64_e32 v[30:31], v[18:19]
; CHECK-NEXT:    v_fmac_f64_e32 v[30:31], 0, v[28:29]
...
; CHECK-NEXT:  ; %bb.11: ; %._crit_edge2105.i.i.i2330.loopexit
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    v_cmp_nlg_f64_e64 s[2:3], 0, v[28:29]
; CHECK-NEXT:    v_cndmask_b32_e64 v29, v25, 0, s[12:13]
; CHECK-NEXT:    v_cndmask_b32_e64 v28, v24, 0, s[12:13]
; CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[2:3]
; CHECK-NEXT:    s_and_b64 s[2:3], exec, s[12:13]
; CHECK-NEXT:    v_mov_b32_e32 v3, v2
; CHECK-NEXT:    s_cselect_b32 s15, s15, 0
; CHECK-NEXT:    s_cselect_b32 s14, s14, 0
; CHECK-NEXT:    v_accvgpr_write_b32 a0, v26
; CHECK-NEXT:    v_accvgpr_write_b32 a1, v27
; CHECK-NEXT:    global_store_dwordx2 v0, v[2:3], s[8:9]
