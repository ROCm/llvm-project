...
; VI-NEXT:    v_or_b32_e32 v3, 0x40a0, v0
...
; SI-NEXT:    v_cndmask_b32_e64 v7, v7, v6, s[0:1]
...
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    v_cndmask_b32_sdwa v6, v3, v5, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX900-NEXT:    v_cndmask_b32_e64 v3, v3, v5, s[0:1]
...
; GFX900-NEXT:    v_perm_b32 v3, v6, v3, s14
; GFX900-NEXT:    v_cndmask_b32_sdwa v6, v0, v5, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX900-NEXT:    v_cndmask_b32_e64 v0, v0, v5, s[10:11]
; GFX900-NEXT:    v_perm_b32 v2, v2, v7, s14
; GFX900-NEXT:    v_perm_b32 v1, v1, v8, s14
; GFX900-NEXT:    v_perm_b32 v0, v6, v0, s14
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_cndmask_b32_sdwa v6, v3, v5, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX942-NEXT:    v_perm_b32 v3, v6, v3, s14
; GFX942-NEXT:    v_cndmask_b32_sdwa v6, v0, v5, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    v_cndmask_b32_e64 v0, v0, v5, s[10:11]
; GFX942-NEXT:    v_perm_b32 v2, v2, v7, s14
; GFX942-NEXT:    v_perm_b32 v1, v1, v8, s14
; GFX942-NEXT:    v_perm_b32 v0, v6, v0, s14
...
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    v_dual_lshrrev_b32 v5, 16, v3 :: v_dual_lshrrev_b32 v6, 16, v2
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v3, v3, s4, s2
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1250-FAKE16-NEXT:    s_cmp_eq_u32 s5, 5
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v2, v2, s4, s2
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
...
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v5, v5, s4, s3
...
; GFX1250-FAKE16-NEXT:    v_perm_b32 v3, v5, v3, 0x5040100
...
; SI-NEXT:    v_cndmask_b32_e64 v11, v11, v6, s[0:1]
...
; GFX900-NEXT:    s_waitcnt vmcnt(1)
; GFX900-NEXT:    v_cndmask_b32_sdwa v10, v3, v9, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX900-NEXT:    s_mov_b64 vcc, s[4:5]
...
; GFX900-NEXT:    v_cndmask_b32_e64 v3, v3, v9, s[0:1]
...
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_cndmask_b32_sdwa v10, v3, v9, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    s_mov_b64 vcc, s[4:5]
...
; GFX942-NEXT:    v_cndmask_b32_e64 v3, v3, v9, s[0:1]
...
; GFX942-NEXT:    v_perm_b32 v3, v10, v3, s30
...
; GFX1250-FAKE16-NEXT:    v_lshrrev_b32_e32 v9, 16, v3
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v3, v3, s4, s2
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1250-FAKE16-NEXT:    s_cmp_eq_u32 s5, 5
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v2, v2, s4, s2
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1250-FAKE16-NEXT:    s_cmp_eq_u32 s5, 2
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v10, v10, s4, s2
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1250-FAKE16-NEXT:    s_cmp_eq_u32 s5, 3
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v1, v1, s4, s2
; GFX1250-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
...
; GFX1250-FAKE16-NEXT:    v_cndmask_b32_e64 v9, v9, s4, s3
...
; GFX1250-FAKE16-NEXT:    v_perm_b32 v3, v9, v3, 0x5040100
