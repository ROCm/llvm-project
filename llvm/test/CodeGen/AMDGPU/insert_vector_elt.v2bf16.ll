...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=tahiti < %s | FileCheck -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=tonga < %s | FileCheck -check-prefix=VI %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 < %s | FileCheck -check-prefix=GFX1250 %s
...
; SI-NEXT:    s_mov_b32 s4, 0x100f000
...
; GFX942-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    s_load_dword s4, s[4:5], 0x30
; GFX942-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX942-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    s_load_dword s4, s[4:5], 0x10
; GFX942-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX942-NEXT:    v_lshlrev_b32_e32 v2, 3, v0
...
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v2, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v0, s4, v0, v3
; GFX942-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GFX942-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v2, s[2:3]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v1, s4, v1, v3
; GFX942-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GFX942-NEXT:    s_endpgm
;
...
; SI-NEXT:    s_and_b32 s3, s8, 0xffff
; SI-NEXT:    s_lshl_b32 s8, s9, 4
; SI-NEXT:    s_or_b32 s2, s3, s2
; SI-NEXT:    s_lshl_b64 s[0:1], 0xffff, s8
; SI-NEXT:    v_mov_b32_e32 v4, s2
; SI-NEXT:    v_mov_b32_e32 v5, s2
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_bfi_b32 v3, s1, v4, v3
; SI-NEXT:    v_bfi_b32 v2, s0, v5, v2
; SI-NEXT:    buffer_store_dwordx2 v[2:3], v[0:1], s[4:7], 0 addr64
; SI-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v2, s[2:3]
; GFX942-NEXT:    s_lshl_b32 s2, s5, 4
; GFX942-NEXT:    s_pack_ll_b32_b16 s4, s4, s4
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v1, s4, v1, v5
...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_store_dwordx4 v[4:7], v[8:9], s[4:7], 0 addr64 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[0:3], v[8:9], s[4:7], 0 addr64
; SI-NEXT:    s_endpgm
;
...
; SI-NEXT:    v_or_b32_e32 v0, v0, v6
; SI-NEXT:    buffer_store_dwordx4 v[0:3], v[4:5], s[8:11], 0 addr64 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[7:10], v[4:5], s[8:11], 0 addr64
; SI-NEXT:    s_endpgm
;
