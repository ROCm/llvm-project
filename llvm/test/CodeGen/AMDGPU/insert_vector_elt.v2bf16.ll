...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00-amd-amdhsa < %s | FileCheck -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02-amd-amdhsa < %s | FileCheck -check-prefix=VI %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-REAL16 %s
