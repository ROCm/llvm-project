...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v5, s7 :: v_dual_mov_b32 v15, s3
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v3, s13
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v4, s17 :: v_dual_mov_b32 v6, s10
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v11, s5 :: v_dual_mov_b32 v7, s12
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v8, s16 :: v_dual_mov_b32 v9, s11
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v10, s15 :: v_dual_mov_b32 v12, s9
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v13, s4 :: v_dual_mov_b32 v14, s14
...
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v5, s7 :: v_dual_mov_b32 v15, s3
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v3, s13
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v4, s17 :: v_dual_mov_b32 v6, s10
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v11, s5 :: v_dual_mov_b32 v7, s12
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v8, s16 :: v_dual_mov_b32 v9, s11
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v10, s15 :: v_dual_mov_b32 v12, s9
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v13, s4 :: v_dual_mov_b32 v14, s14
...
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v10, s16
...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v7, s9
...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v14, s14 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v15, s15
; GFX1250-FAKE16-NEXT:    s_clause 0x3
; GFX1250-FAKE16-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:48
; GFX1250-FAKE16-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:32
; GFX1250-FAKE16-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:16
...
; GFX1250-REAL16-NEXT:    v_mov_b32_e32 v10, s16
...
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1250-REAL16-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v7, s9
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v9, s11
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v10, s12 :: v_dual_mov_b32 v11, s13
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v14, s14 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1250-REAL16-NEXT:    v_mov_b32_e32 v15, s15
; GFX1250-REAL16-NEXT:    s_clause 0x3
; GFX1250-REAL16-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:48
; GFX1250-REAL16-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:32
; GFX1250-REAL16-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:16
...
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v28, s33
...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v7, s9
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v12, s14 :: v_dual_mov_b32 v13, s15
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v14, s16 :: v_dual_mov_b32 v15, s17
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v16, s18 :: v_dual_mov_b32 v17, s19
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v18, s20 :: v_dual_mov_b32 v19, s21
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v20, s22 :: v_dual_mov_b32 v21, s23
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v22, s24 :: v_dual_mov_b32 v23, s25
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v24, s26 :: v_dual_mov_b32 v25, s27
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v26, s28 :: v_dual_mov_b32 v27, s29
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v30, s30 :: v_dual_mov_b32 v31, s31
; GFX1250-FAKE16-NEXT:    s_clause 0x1
...
; GFX1250-FAKE16-NEXT:    v_ashrrev_i32_e32 v29, 31, v28
; GFX1250-FAKE16-NEXT:    s_clause 0x5
...
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-REAL16-NEXT:    v_mov_b32_e32 v28, s33
...
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v7, s9
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v12, s14 :: v_dual_mov_b32 v13, s15
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v14, s16 :: v_dual_mov_b32 v15, s17
; GFX1250-REAL16-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-REAL16-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v16, s18 :: v_dual_mov_b32 v17, s19
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v18, s20 :: v_dual_mov_b32 v19, s21
; GFX1250-REAL16-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v20, s22 :: v_dual_mov_b32 v21, s23
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v22, s24 :: v_dual_mov_b32 v23, s25
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v24, s26 :: v_dual_mov_b32 v25, s27
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v26, s28 :: v_dual_mov_b32 v27, s29
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v30, s30 :: v_dual_mov_b32 v31, s31
; GFX1250-REAL16-NEXT:    s_clause 0x1
...
; GFX1250-REAL16-NEXT:    v_ashrrev_i32_e32 v29, 31, v28
; GFX1250-REAL16-NEXT:    s_clause 0x5
...
; GFX6-NEXT:    s_mov_b32 s16, s5
; GFX6-NEXT:    s_bfe_i64 s[34:35], s[4:5], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[30:31], s[16:17], 0x10000
...
; GFX6-NEXT:    ; implicit-def: $sgpr43
; GFX6-NEXT:    v_mov_b32_e32 v12, s40
; GFX6-NEXT:    v_mov_b32_e32 v13, s41
; GFX6-NEXT:    ; implicit-def: $sgpr41
...
; GFX6-NEXT:    s_lshr_b32 s38, s5, 24
; GFX6-NEXT:    s_lshr_b32 s36, s5, 25
; GFX6-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v9, s16
...
; GFX6-NEXT:    v_mov_b32_e32 v17, s37
; GFX6-NEXT:    s_mov_b32 s37, s7
; GFX6-NEXT:    s_lshr_b32 s38, s5, 18
; GFX6-NEXT:    s_lshr_b32 s36, s5, 19
; GFX6-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
...
; GFX6-NEXT:    v_mov_b32_e32 v9, s37
; GFX6-NEXT:    s_mov_b32 s37, s7
; GFX6-NEXT:    s_lshr_b32 s38, s5, 16
...
; GFX6-NEXT:    s_lshr_b32 s36, s5, 13
; GFX6-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
...
; GFX6-NEXT:    v_mov_b32_e32 v9, s37
; GFX6-NEXT:    s_mov_b32 s37, s7
; GFX6-NEXT:    s_lshr_b32 s38, s5, 10
...
; GFX6-NEXT:    ; implicit-def: $sgpr29
; GFX6-NEXT:    s_lshr_b32 s22, s4, 28
; GFX6-NEXT:    s_lshr_b32 s24, s4, 29
; GFX6-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
...
; GFX6-NEXT:    ; implicit-def: $sgpr25
; GFX6-NEXT:    s_lshr_b32 s18, s4, 26
; GFX6-NEXT:    s_lshr_b32 s20, s4, 27
; GFX6-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
...
; GFX6-NEXT:    ; implicit-def: $sgpr21
; GFX6-NEXT:    s_lshr_b32 s14, s4, 24
; GFX6-NEXT:    s_lshr_b32 s16, s4, 25
; GFX6-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:256
; GFX6-NEXT:    s_waitcnt expcnt(0)
