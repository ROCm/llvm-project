...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- < %s | FileCheck -check-prefix=GFX6 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-REAL16 %s
...
; GFX6-NEXT:    s_mov_b32 s4, s2
; GFX6-NEXT:    s_mov_b32 s5, s3
; GFX6-NEXT:    buffer_load_ushort v0, off, s[4:7], 0
; GFX6-NEXT:    s_mov_b32 s2, s6
; GFX6-NEXT:    s_mov_b32 s3, s7
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX6-NEXT:    s_mov_b32 s4, s2
; GFX6-NEXT:    s_mov_b32 s5, s3
; GFX6-NEXT:    buffer_load_ubyte v2, off, s[4:7], 0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX6-NEXT:    s_mov_b32 s4, s2
; GFX6-NEXT:    s_mov_b32 s5, s3
; GFX6-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX6-NEXT:    s_mov_b32 s4, s2
; GFX6-NEXT:    s_mov_b32 s5, s3
; GFX6-NEXT:    buffer_load_ubyte v4, off, s[4:7], 0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX6-NEXT:    s_mov_b32 s4, s2
; GFX6-NEXT:    s_mov_b32 s5, s3
; GFX6-NEXT:    buffer_load_ushort v12, off, s[4:7], 0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    s_bfe_u32 s33, s2, 0x1001c
; GFX12-NEXT:    s_bfe_u32 s34, s2, 0x1001e
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s33 :: v_dual_mov_b32 v3, s16
; GFX12-NEXT:    v_dual_mov_b32 v2, s34 :: v_dual_mov_b32 v5, s15
; GFX12-NEXT:    s_bfe_u32 s3, s2, 0x10003
; GFX12-NEXT:    s_bfe_u32 s4, s2, 0x10001
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v6, s30 :: v_dual_mov_b32 v9, s2
...
; GFX1250-NEXT:    s_bfe_u32 s33, s2, 0x1001c
; GFX1250-NEXT:    s_bfe_u32 s34, s2, 0x1001e
...
; GFX1250-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s33
; GFX1250-NEXT:    v_dual_mov_b32 v1, s17 :: v_dual_mov_b32 v2, s34
; GFX1250-NEXT:    v_dual_mov_b32 v3, s16 :: v_dual_mov_b32 v4, s31
...
; GFX1250-NEXT:    s_bfe_u32 s2, s2, 0x10015
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v10, s28 :: v_dual_mov_b32 v9, s2
...
; GFX12-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_ashr_i32 s30, s2, 31
; GFX12-NEXT:    s_bfe_i32 s31, s2, 0x1001e
; GFX12-NEXT:    s_bfe_i32 s33, s2, 0x1001c
; GFX12-NEXT:    s_bfe_i32 s34, s2, 0x1001d
; GFX12-NEXT:    s_bfe_i32 s26, s2, 0x1001b
; GFX12-NEXT:    s_bfe_i32 s27, s2, 0x1001a
; GFX12-NEXT:    s_bfe_i32 s28, s2, 0x10019
; GFX12-NEXT:    s_bfe_i32 s29, s2, 0x10018
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s34
; GFX12-NEXT:    v_dual_mov_b32 v0, s33 :: v_dual_mov_b32 v3, s30
; GFX12-NEXT:    v_dual_mov_b32 v2, s31 :: v_dual_mov_b32 v5, s28
; GFX12-NEXT:    s_bfe_i32 s3, s2, 0x10003
; GFX12-NEXT:    s_bfe_i32 s4, s2, 0x10002
; GFX12-NEXT:    s_bfe_i32 s5, s2, 0x10001
; GFX12-NEXT:    s_bfe_i32 s6, s2, 0x10000
...
; GFX12-NEXT:    s_bfe_i32 s25, s2, 0x10014
; GFX12-NEXT:    v_dual_mov_b32 v4, s29 :: v_dual_mov_b32 v7, s26
; GFX12-NEXT:    s_bfe_i32 s2, s2, 0x10015
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v6, s27 :: v_dual_mov_b32 v9, s2
; GFX12-NEXT:    v_dual_mov_b32 v8, s25 :: v_dual_mov_b32 v11, s23
...
; GFX1250-NEXT:    s_load_b32 s2, s[2:3], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_ashr_i32 s30, s2, 31
; GFX1250-NEXT:    s_bfe_i32 s31, s2, 0x1001e
; GFX1250-NEXT:    s_bfe_i32 s33, s2, 0x1001c
; GFX1250-NEXT:    s_bfe_i32 s34, s2, 0x1001d
; GFX1250-NEXT:    s_bfe_i32 s26, s2, 0x1001b
; GFX1250-NEXT:    s_bfe_i32 s27, s2, 0x1001a
; GFX1250-NEXT:    s_bfe_i32 s28, s2, 0x10019
; GFX1250-NEXT:    s_bfe_i32 s29, s2, 0x10018
; GFX1250-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s33
; GFX1250-NEXT:    v_dual_mov_b32 v1, s34 :: v_dual_mov_b32 v2, s31
; GFX1250-NEXT:    v_dual_mov_b32 v3, s30 :: v_dual_mov_b32 v4, s29
; GFX1250-NEXT:    s_bfe_i32 s25, s2, 0x10014
; GFX1250-NEXT:    v_dual_mov_b32 v5, s28 :: v_dual_mov_b32 v6, s27
; GFX1250-NEXT:    v_dual_mov_b32 v7, s26 :: v_dual_mov_b32 v8, s25
; GFX1250-NEXT:    s_bfe_i32 s3, s2, 0x10003
; GFX1250-NEXT:    s_bfe_i32 s4, s2, 0x10002
; GFX1250-NEXT:    s_bfe_i32 s5, s2, 0x10001
; GFX1250-NEXT:    s_bfe_i32 s6, s2, 0x10000
...
; GFX1250-NEXT:    s_bfe_i32 s2, s2, 0x10015
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v10, s24 :: v_dual_mov_b32 v9, s2
...
; GFX6-NEXT:    s_bfe_u32 s57, s5, 0x1000a
; GFX6-NEXT:    s_bfe_u32 s58, s5, 0x10008
; GFX6-NEXT:    s_bfe_u32 s59, s5, 0x1000e
; GFX6-NEXT:    s_bfe_u32 s60, s5, 0x1000c
; GFX6-NEXT:    s_bfe_u32 s61, s5, 0x10012
; GFX6-NEXT:    s_bfe_u32 s62, s5, 0x10010
; GFX6-NEXT:    s_bfe_u32 s63, s5, 0x10016
; GFX6-NEXT:    s_bfe_u32 s64, s5, 0x10014
; GFX6-NEXT:    s_bfe_u32 s65, s5, 0x1001a
; GFX6-NEXT:    s_bfe_u32 s66, s5, 0x10018
; GFX6-NEXT:    s_bfe_u32 s67, s5, 0x1001e
; GFX6-NEXT:    s_bfe_u32 s68, s5, 0x1001c
...
; GFX6-NEXT:    v_mov_b32_e32 v6, s65
; GFX6-NEXT:    v_mov_b32_e32 v7, s35
; GFX6-NEXT:    v_mov_b32_e32 v8, s64
; GFX6-NEXT:    v_mov_b32_e32 v9, s34
; GFX6-NEXT:    v_mov_b32_e32 v10, s63
; GFX6-NEXT:    v_mov_b32_e32 v11, s33
; GFX6-NEXT:    v_mov_b32_e32 v12, s62
; GFX6-NEXT:    v_mov_b32_e32 v13, s31
; GFX6-NEXT:    v_mov_b32_e32 v14, s61
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_u32 s2, s12, 0x10003
; GFX8-NEXT:    s_bfe_u32 s3, s12, 0x10001
; GFX8-NEXT:    s_bfe_u32 s4, s12, 0x10007
; GFX8-NEXT:    s_bfe_u32 s5, s12, 0x10005
; GFX8-NEXT:    s_bfe_u32 s6, s12, 0x1000b
; GFX8-NEXT:    s_bfe_u32 s7, s12, 0x10009
; GFX8-NEXT:    s_bfe_u32 s10, s12, 0x1000f
; GFX8-NEXT:    s_bfe_u32 s11, s12, 0x1000d
; GFX8-NEXT:    s_bfe_u32 s14, s12, 0x10013
; GFX8-NEXT:    s_bfe_u32 s15, s12, 0x10011
; GFX8-NEXT:    s_bfe_u32 s16, s12, 0x10017
; GFX8-NEXT:    s_bfe_u32 s17, s12, 0x1001b
; GFX8-NEXT:    s_bfe_u32 s18, s12, 0x10019
; GFX8-NEXT:    s_lshr_b32 s19, s12, 31
; GFX8-NEXT:    s_bfe_u32 s20, s12, 0x1001d
; GFX8-NEXT:    s_bfe_u32 s21, s13, 0x10003
; GFX8-NEXT:    s_bfe_u32 s22, s13, 0x10001
; GFX8-NEXT:    s_bfe_u32 s23, s13, 0x10007
; GFX8-NEXT:    s_bfe_u32 s24, s13, 0x10005
; GFX8-NEXT:    s_bfe_u32 s25, s13, 0x1000b
; GFX8-NEXT:    s_bfe_u32 s26, s13, 0x10009
; GFX8-NEXT:    s_bfe_u32 s27, s13, 0x1000f
; GFX8-NEXT:    s_bfe_u32 s28, s13, 0x1000d
; GFX8-NEXT:    s_bfe_u32 s29, s13, 0x10013
; GFX8-NEXT:    s_bfe_u32 s30, s13, 0x10011
; GFX8-NEXT:    s_bfe_u32 s31, s13, 0x10017
; GFX8-NEXT:    s_bfe_u32 s33, s13, 0x1001b
; GFX8-NEXT:    s_bfe_u32 s34, s13, 0x10019
; GFX8-NEXT:    s_lshr_b32 s35, s13, 31
; GFX8-NEXT:    s_bfe_u32 s36, s13, 0x1001d
; GFX8-NEXT:    s_and_b32 s9, s12, 1
; GFX8-NEXT:    s_bfe_u32 s8, s12, 0x10002
; GFX8-NEXT:    s_bfe_u32 s37, s12, 0x10006
; GFX8-NEXT:    s_bfe_u32 s38, s12, 0x10004
; GFX8-NEXT:    s_bfe_u32 s39, s12, 0x1000a
; GFX8-NEXT:    s_bfe_u32 s40, s12, 0x10008
; GFX8-NEXT:    s_bfe_u32 s41, s12, 0x1000e
; GFX8-NEXT:    s_bfe_u32 s42, s12, 0x1000c
; GFX8-NEXT:    s_bfe_u32 s43, s12, 0x10012
; GFX8-NEXT:    s_bfe_u32 s44, s12, 0x10010
; GFX8-NEXT:    s_bfe_u32 s45, s12, 0x10016
; GFX8-NEXT:    s_bfe_u32 s46, s12, 0x10015
; GFX8-NEXT:    s_bfe_u32 s47, s12, 0x10014
; GFX8-NEXT:    s_bfe_u32 s48, s12, 0x1001a
; GFX8-NEXT:    s_bfe_u32 s49, s12, 0x10018
; GFX8-NEXT:    s_bfe_u32 s50, s12, 0x1001e
; GFX8-NEXT:    s_bfe_u32 s51, s12, 0x1001c
; GFX8-NEXT:    s_and_b32 s52, s13, 1
; GFX8-NEXT:    s_bfe_u32 s53, s13, 0x10002
; GFX8-NEXT:    s_bfe_u32 s54, s13, 0x10006
; GFX8-NEXT:    s_bfe_u32 s55, s13, 0x10004
; GFX8-NEXT:    s_bfe_u32 s56, s13, 0x1000a
; GFX8-NEXT:    s_bfe_u32 s57, s13, 0x10008
; GFX8-NEXT:    s_bfe_u32 s58, s13, 0x1000e
; GFX8-NEXT:    s_bfe_u32 s59, s13, 0x1000c
; GFX8-NEXT:    s_bfe_u32 s60, s13, 0x10012
; GFX8-NEXT:    s_bfe_u32 s61, s13, 0x10010
; GFX8-NEXT:    s_bfe_u32 s62, s13, 0x10016
; GFX8-NEXT:    s_bfe_u32 s63, s13, 0x10015
; GFX8-NEXT:    s_bfe_u32 s64, s13, 0x10014
; GFX8-NEXT:    s_bfe_u32 s65, s13, 0x1001a
; GFX8-NEXT:    s_bfe_u32 s66, s13, 0x10018
; GFX8-NEXT:    s_bfe_u32 s12, s13, 0x1001e
; GFX8-NEXT:    s_bfe_u32 s13, s13, 0x1001c
...
; GFX8-NEXT:    s_add_u32 s12, s0, 0xe0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s13, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s12
...
; GFX8-NEXT:    v_mov_b32_e32 v5, s13
; GFX8-NEXT:    s_add_u32 s12, s0, 0xd0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s13, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s12
...
; GFX8-NEXT:    v_mov_b32_e32 v5, s13
; GFX8-NEXT:    s_add_u32 s12, s0, 0xa0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s13, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s12
...
; GFX8-NEXT:    v_mov_b32_e32 v5, s13
; GFX8-NEXT:    s_add_u32 s12, s0, 0x80
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s13, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s12
...
; GFX6-NEXT:    s_bfe_i32 s45, s5, 0x1000b
; GFX6-NEXT:    s_bfe_i32 s46, s5, 0x1000a
; GFX6-NEXT:    s_bfe_i32 s47, s5, 0x10009
; GFX6-NEXT:    s_bfe_i32 s48, s5, 0x10008
; GFX6-NEXT:    s_bfe_i32 s49, s5, 0x1000f
; GFX6-NEXT:    s_bfe_i32 s50, s5, 0x1000e
; GFX6-NEXT:    s_bfe_i32 s51, s5, 0x1000d
; GFX6-NEXT:    s_bfe_i32 s52, s5, 0x1000c
; GFX6-NEXT:    s_bfe_i32 s53, s5, 0x10013
; GFX6-NEXT:    s_bfe_i32 s54, s5, 0x10012
; GFX6-NEXT:    s_bfe_i32 s55, s5, 0x10011
; GFX6-NEXT:    s_bfe_i32 s56, s5, 0x10010
; GFX6-NEXT:    s_bfe_i32 s57, s5, 0x10017
; GFX6-NEXT:    s_bfe_i32 s58, s5, 0x10016
; GFX6-NEXT:    s_bfe_i32 s59, s5, 0x10015
; GFX6-NEXT:    s_bfe_i32 s60, s5, 0x10014
; GFX6-NEXT:    s_bfe_i32 s61, s5, 0x1001b
; GFX6-NEXT:    s_bfe_i32 s62, s5, 0x1001a
; GFX6-NEXT:    s_bfe_i32 s63, s5, 0x10019
; GFX6-NEXT:    s_bfe_i32 s64, s5, 0x10018
; GFX6-NEXT:    s_ashr_i32 s65, s5, 31
; GFX6-NEXT:    s_bfe_i32 s66, s5, 0x1001e
; GFX6-NEXT:    s_bfe_i32 s67, s5, 0x1001d
; GFX6-NEXT:    s_bfe_i32 s68, s5, 0x1001c
; GFX6-NEXT:    s_bfe_i32 s5, s5, 0x10004
; GFX6-NEXT:    v_mov_b32_e32 v0, s68
; GFX6-NEXT:    v_mov_b32_e32 v1, s67
; GFX6-NEXT:    v_mov_b32_e32 v2, s66
; GFX6-NEXT:    v_mov_b32_e32 v3, s65
...
; GFX6-NEXT:    v_mov_b32_e32 v10, s58
; GFX6-NEXT:    v_mov_b32_e32 v11, s57
; GFX6-NEXT:    v_mov_b32_e32 v12, s56
; GFX6-NEXT:    v_mov_b32_e32 v13, s55
; GFX6-NEXT:    v_mov_b32_e32 v14, s54
; GFX6-NEXT:    v_mov_b32_e32 v15, s53
; GFX6-NEXT:    v_mov_b32_e32 v16, s52
; GFX6-NEXT:    v_mov_b32_e32 v17, s51
; GFX6-NEXT:    v_mov_b32_e32 v18, s50
; GFX6-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v0, s48
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_i32 s2, s14, 0x10003
; GFX8-NEXT:    s_bfe_i32 s3, s14, 0x10002
; GFX8-NEXT:    s_bfe_i32 s4, s14, 0x10001
; GFX8-NEXT:    s_bfe_i32 s5, s14, 0x10000
; GFX8-NEXT:    s_bfe_i32 s6, s14, 0x10007
; GFX8-NEXT:    s_bfe_i32 s7, s14, 0x10006
; GFX8-NEXT:    s_bfe_i32 s8, s14, 0x10005
; GFX8-NEXT:    s_bfe_i32 s9, s14, 0x10004
; GFX8-NEXT:    s_bfe_i32 s10, s14, 0x1000b
; GFX8-NEXT:    s_bfe_i32 s11, s14, 0x1000a
; GFX8-NEXT:    s_bfe_i32 s12, s14, 0x10009
; GFX8-NEXT:    s_bfe_i32 s13, s14, 0x10008
; GFX8-NEXT:    s_bfe_i32 s16, s14, 0x1000f
; GFX8-NEXT:    s_bfe_i32 s17, s14, 0x1000e
; GFX8-NEXT:    s_bfe_i32 s18, s14, 0x1000d
; GFX8-NEXT:    s_bfe_i32 s19, s14, 0x1000c
; GFX8-NEXT:    s_bfe_i32 s20, s14, 0x10013
; GFX8-NEXT:    s_bfe_i32 s21, s14, 0x10012
; GFX8-NEXT:    s_bfe_i32 s22, s14, 0x10011
; GFX8-NEXT:    s_bfe_i32 s23, s14, 0x10010
; GFX8-NEXT:    s_bfe_i32 s24, s14, 0x10017
; GFX8-NEXT:    s_bfe_i32 s25, s14, 0x10016
; GFX8-NEXT:    s_bfe_i32 s26, s14, 0x10015
; GFX8-NEXT:    s_bfe_i32 s27, s14, 0x10014
; GFX8-NEXT:    s_bfe_i32 s28, s14, 0x1001b
; GFX8-NEXT:    s_bfe_i32 s29, s14, 0x1001a
; GFX8-NEXT:    s_bfe_i32 s30, s14, 0x10019
; GFX8-NEXT:    s_bfe_i32 s31, s14, 0x10018
; GFX8-NEXT:    s_ashr_i32 s33, s14, 31
; GFX8-NEXT:    s_bfe_i32 s34, s14, 0x1001e
; GFX8-NEXT:    s_bfe_i32 s35, s14, 0x1001d
; GFX8-NEXT:    s_bfe_i32 s36, s14, 0x1001c
; GFX8-NEXT:    s_bfe_i32 s37, s15, 0x10003
; GFX8-NEXT:    s_bfe_i32 s38, s15, 0x10002
; GFX8-NEXT:    s_bfe_i32 s39, s15, 0x10001
; GFX8-NEXT:    s_bfe_i32 s40, s15, 0x10000
; GFX8-NEXT:    s_bfe_i32 s41, s15, 0x10007
; GFX8-NEXT:    s_bfe_i32 s42, s15, 0x10006
; GFX8-NEXT:    s_bfe_i32 s43, s15, 0x10005
; GFX8-NEXT:    s_bfe_i32 s44, s15, 0x10004
; GFX8-NEXT:    s_bfe_i32 s45, s15, 0x1000b
; GFX8-NEXT:    s_bfe_i32 s46, s15, 0x1000a
; GFX8-NEXT:    s_bfe_i32 s47, s15, 0x10009
; GFX8-NEXT:    s_bfe_i32 s48, s15, 0x10008
; GFX8-NEXT:    s_bfe_i32 s49, s15, 0x1000f
; GFX8-NEXT:    s_bfe_i32 s50, s15, 0x1000e
; GFX8-NEXT:    s_bfe_i32 s51, s15, 0x1000d
; GFX8-NEXT:    s_bfe_i32 s52, s15, 0x1000c
; GFX8-NEXT:    s_bfe_i32 s53, s15, 0x10013
; GFX8-NEXT:    s_bfe_i32 s54, s15, 0x10012
; GFX8-NEXT:    s_bfe_i32 s55, s15, 0x10011
; GFX8-NEXT:    s_bfe_i32 s56, s15, 0x10010
; GFX8-NEXT:    s_bfe_i32 s57, s15, 0x10017
; GFX8-NEXT:    s_bfe_i32 s58, s15, 0x10016
; GFX8-NEXT:    s_bfe_i32 s59, s15, 0x10015
; GFX8-NEXT:    s_bfe_i32 s60, s15, 0x10014
; GFX8-NEXT:    s_bfe_i32 s61, s15, 0x1001b
; GFX8-NEXT:    s_bfe_i32 s62, s15, 0x1001a
; GFX8-NEXT:    s_bfe_i32 s63, s15, 0x10019
; GFX8-NEXT:    s_bfe_i32 s64, s15, 0x10018
; GFX8-NEXT:    s_ashr_i32 s14, s15, 31
; GFX8-NEXT:    s_bfe_i32 s65, s15, 0x1001e
; GFX8-NEXT:    s_bfe_i32 s66, s15, 0x1001d
; GFX8-NEXT:    s_bfe_i32 s15, s15, 0x1001c
; GFX8-NEXT:    v_mov_b32_e32 v3, s14
...
; GFX12-NEXT:    v_mov_b32_e32 v1, 0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    global_load_d16_u8 v8, v1, s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_and_b32 v0, 0xffff, v8
; GFX12-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_and_b32 v12, 1, v8
; GFX12-NEXT:    v_mov_b32_e32 v7, v1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX12-NEXT:    v_lshrrev_b32_e32 v2, 7, v0
; GFX12-NEXT:    v_bfe_u32 v0, v0, 6, 1
; GFX12-NEXT:    v_bfe_u32 v6, v8, 5, 1
; GFX12-NEXT:    v_bfe_u32 v4, v8, 4, 1
; GFX12-NEXT:    v_mov_b32_e32 v9, v1
; GFX12-NEXT:    v_mov_b32_e32 v11, v1
; GFX12-NEXT:    v_bfe_u32 v10, v8, 3, 1
; GFX12-NEXT:    v_bfe_u32 v14, v8, 1, 1
; GFX12-NEXT:    v_bfe_u32 v8, v8, 2, 1
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_u8 v8, v1, s[2:3] nv
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_and_b32_e32 v0, 0xffff, v8
; GFX1250-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_bitop2_b32 v12, 1, v8 bitop3:0x40
; GFX1250-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v15, v1
...
; GFX1250-NEXT:    v_bfe_u32 v6, v8, 5, 1
; GFX1250-NEXT:    v_bfe_u32 v4, v8, 4, 1
; GFX1250-NEXT:    v_dual_mov_b32 v11, v1 :: v_dual_mov_b32 v13, v1
; GFX1250-NEXT:    v_bfe_u32 v10, v8, 3, 1
; GFX1250-NEXT:    v_bfe_u32 v14, v8, 1, 1
; GFX1250-NEXT:    v_bfe_u32 v8, v8, 2, 1
; GFX1250-NEXT:    s_clause 0x3
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v7, s5
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v4, s2 :: v_dual_mov_b32 v9, s7
; GFX12-NEXT:    v_dual_mov_b32 v5, s3 :: v_dual_mov_b32 v6, s4
; GFX12-NEXT:    v_mov_b32_e32 v11, s9
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v8, s6 :: v_dual_mov_b32 v13, s11
; GFX12-NEXT:    v_dual_mov_b32 v10, s8 :: v_dual_mov_b32 v15, s13
; GFX12-NEXT:    v_dual_mov_b32 v12, s10 :: v_dual_mov_b32 v3, s15
...
; GFX1250-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_ashrrev_i32 v1, 31, v0
; GFX1250-NEXT:    v_mov_b32_e32 v3, s15
; GFX1250-NEXT:    s_clause 0x3
...
; GFX6-NEXT:    buffer_load_ushort v29, off, s[0:3], 0
; GFX6-NEXT:    v_mov_b32_e32 v1, 0
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX8-NEXT:    s_bfe_u32 s6, s2, 0x10009
; GFX8-NEXT:    s_bfe_u32 s7, s2, 0x1000d
; GFX8-NEXT:    s_bfe_u32 s8, s2, 0x10007
; GFX8-NEXT:    s_bfe_u32 s9, s2, 0x10003
; GFX8-NEXT:    s_bfe_u32 s10, s2, 0x10001
; GFX8-NEXT:    s_and_b32 s11, s2, 1
; GFX8-NEXT:    s_bfe_u32 s12, s2, 0x10002
; GFX8-NEXT:    s_bfe_u32 s13, s2, 0x10004
; GFX8-NEXT:    s_bfe_u32 s14, s2, 0x10006
; GFX8-NEXT:    s_bfe_u32 s15, s2, 0x1000c
...
; GFX6-NEXT:    s_mov_b32 s0, s6
; GFX6-NEXT:    s_mov_b32 s1, s7
; GFX6-NEXT:    buffer_load_ushort v1, off, s[0:3], 0
; GFX6-NEXT:    s_mov_b32 s0, s4
; GFX6-NEXT:    s_mov_b32 s1, s5
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    v_dual_mov_b32 v12, s10 :: v_dual_mov_b32 v17, s15
; GFX12-NEXT:    v_dual_mov_b32 v14, s12 :: v_dual_mov_b32 v19, s17
...
; GFX12-NEXT:    v_dual_mov_b32 v16, s14 :: v_dual_mov_b32 v21, s19
; GFX12-NEXT:    v_dual_mov_b32 v18, s16 :: v_dual_mov_b32 v23, s21
; GFX12-NEXT:    v_dual_mov_b32 v20, s18 :: v_dual_mov_b32 v25, s23
; GFX12-NEXT:    v_dual_mov_b32 v22, s20 :: v_dual_mov_b32 v27, s25
; GFX12-NEXT:    v_dual_mov_b32 v24, s22 :: v_dual_mov_b32 v29, s27
; GFX12-NEXT:    v_dual_mov_b32 v26, s24 :: v_dual_mov_b32 v31, s29
; GFX12-NEXT:    v_dual_mov_b32 v28, s26 :: v_dual_mov_b32 v3, s31
; GFX12-NEXT:    v_mov_b32_e32 v30, s28
...
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dword s6, s[6:7], 0x0
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    v_mov_b32_e32 v1, 0
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NEXT:    s_mov_b32 s0, s4
; GFX6-NEXT:    s_mov_b32 s1, s5
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_u32 s4, s6, 0x10001
; GFX6-NEXT:    s_bfe_u32 s5, s6, 0x10003
; GFX6-NEXT:    s_bfe_u32 s7, s6, 0x10005
; GFX6-NEXT:    s_bfe_u32 s8, s6, 0x10007
; GFX6-NEXT:    s_bfe_u32 s9, s6, 0x10009
; GFX6-NEXT:    s_bfe_u32 s10, s6, 0x1000b
; GFX6-NEXT:    s_bfe_u32 s11, s6, 0x1000d
; GFX6-NEXT:    s_bfe_u32 s12, s6, 0x1000f
; GFX6-NEXT:    s_bfe_u32 s13, s6, 0x10011
; GFX6-NEXT:    s_bfe_u32 s14, s6, 0x10013
; GFX6-NEXT:    s_bfe_u32 s15, s6, 0x10015
; GFX6-NEXT:    s_bfe_u32 s16, s6, 0x10017
; GFX6-NEXT:    s_bfe_u32 s17, s6, 0x10019
; GFX6-NEXT:    s_bfe_u32 s18, s6, 0x1001b
; GFX6-NEXT:    s_bfe_u32 s19, s6, 0x1001d
; GFX6-NEXT:    s_lshr_b32 s20, s6, 31
; GFX6-NEXT:    s_and_b32 s21, s6, 1
; GFX6-NEXT:    s_bfe_u32 s22, s6, 0x10002
; GFX6-NEXT:    s_bfe_u32 s23, s6, 0x10004
; GFX6-NEXT:    s_bfe_u32 s24, s6, 0x10006
; GFX6-NEXT:    s_bfe_u32 s25, s6, 0x10008
; GFX6-NEXT:    s_bfe_u32 s26, s6, 0x1000a
; GFX6-NEXT:    s_bfe_u32 s27, s6, 0x1000c
; GFX6-NEXT:    s_bfe_u32 s28, s6, 0x1000e
; GFX6-NEXT:    s_bfe_u32 s29, s6, 0x10010
; GFX6-NEXT:    s_bfe_u32 s30, s6, 0x10012
; GFX6-NEXT:    s_bfe_u32 s31, s6, 0x10014
; GFX6-NEXT:    s_bfe_u32 s33, s6, 0x10016
; GFX6-NEXT:    s_bfe_u32 s34, s6, 0x10018
; GFX6-NEXT:    s_bfe_u32 s35, s6, 0x1001a
; GFX6-NEXT:    s_bfe_u32 s36, s6, 0x1001e
; GFX6-NEXT:    s_bfe_u32 s6, s6, 0x1001c
; GFX6-NEXT:    v_mov_b32_e32 v0, s36
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshr_b32 s3, s2, 31
; GFX8-NEXT:    s_bfe_u32 s4, s2, 0x1001d
; GFX8-NEXT:    s_bfe_u32 s5, s2, 0x1001b
; GFX8-NEXT:    s_bfe_u32 s6, s2, 0x10019
; GFX8-NEXT:    s_bfe_u32 s7, s2, 0x10017
; GFX8-NEXT:    s_bfe_u32 s8, s2, 0x10013
; GFX8-NEXT:    s_bfe_u32 s9, s2, 0x10011
; GFX8-NEXT:    s_bfe_u32 s10, s2, 0x1000f
; GFX8-NEXT:    s_bfe_u32 s11, s2, 0x1000d
; GFX8-NEXT:    s_bfe_u32 s12, s2, 0x1000b
; GFX8-NEXT:    s_bfe_u32 s13, s2, 0x10009
; GFX8-NEXT:    s_bfe_u32 s14, s2, 0x10007
; GFX8-NEXT:    s_bfe_u32 s15, s2, 0x10005
; GFX8-NEXT:    s_bfe_u32 s16, s2, 0x10003
; GFX8-NEXT:    s_bfe_u32 s17, s2, 0x10001
; GFX8-NEXT:    s_and_b32 s18, s2, 1
; GFX8-NEXT:    s_bfe_u32 s19, s2, 0x10002
; GFX8-NEXT:    s_bfe_u32 s20, s2, 0x10004
; GFX8-NEXT:    s_bfe_u32 s21, s2, 0x10006
; GFX8-NEXT:    s_bfe_u32 s22, s2, 0x10008
; GFX8-NEXT:    s_bfe_u32 s23, s2, 0x1000a
; GFX8-NEXT:    s_bfe_u32 s24, s2, 0x1000c
; GFX8-NEXT:    s_bfe_u32 s25, s2, 0x1000e
; GFX8-NEXT:    s_bfe_u32 s26, s2, 0x10010
; GFX8-NEXT:    s_bfe_u32 s27, s2, 0x10012
; GFX8-NEXT:    s_bfe_u32 s28, s2, 0x10014
; GFX8-NEXT:    s_bfe_u32 s29, s2, 0x10015
; GFX8-NEXT:    s_bfe_u32 s30, s2, 0x10016
; GFX8-NEXT:    s_bfe_u32 s31, s2, 0x10018
; GFX8-NEXT:    s_bfe_u32 s33, s2, 0x1001a
; GFX8-NEXT:    s_bfe_u32 s34, s2, 0x1001c
; GFX8-NEXT:    s_bfe_u32 s2, s2, 0x1001e
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX6-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dword s18, s[2:3], 0x0
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshr_b32 s20, s18, 30
; GFX6-NEXT:    s_lshr_b32 s22, s18, 31
; GFX6-NEXT:    s_lshr_b32 s24, s18, 28
; GFX6-NEXT:    s_lshr_b32 s26, s18, 29
; GFX6-NEXT:    s_lshr_b32 s28, s18, 26
; GFX6-NEXT:    s_lshr_b32 s30, s18, 27
; GFX6-NEXT:    s_lshr_b32 s34, s18, 24
; GFX6-NEXT:    s_lshr_b32 s36, s18, 25
; GFX6-NEXT:    s_lshr_b32 s38, s18, 22
; GFX6-NEXT:    s_lshr_b32 s40, s18, 23
; GFX6-NEXT:    s_lshr_b32 s42, s18, 20
; GFX6-NEXT:    s_lshr_b32 s4, s18, 21
; GFX6-NEXT:    s_lshr_b32 s6, s18, 18
; GFX6-NEXT:    s_lshr_b32 s8, s18, 19
; GFX6-NEXT:    s_lshr_b32 s10, s18, 16
; GFX6-NEXT:    s_lshr_b32 s12, s18, 17
; GFX6-NEXT:    s_lshr_b32 s14, s18, 14
; GFX6-NEXT:    s_lshr_b32 s16, s18, 15
; GFX6-NEXT:    s_lshr_b32 s44, s18, 12
; GFX6-NEXT:    s_lshr_b32 s46, s18, 13
; GFX6-NEXT:    s_lshr_b32 s48, s18, 10
; GFX6-NEXT:    s_lshr_b32 s50, s18, 11
; GFX6-NEXT:    s_lshr_b32 s52, s18, 8
; GFX6-NEXT:    s_lshr_b32 s54, s18, 9
; GFX6-NEXT:    s_lshr_b32 s56, s18, 6
; GFX6-NEXT:    s_lshr_b32 s58, s18, 7
; GFX6-NEXT:    s_lshr_b32 s60, s18, 4
; GFX6-NEXT:    s_lshr_b32 s62, s18, 5
; GFX6-NEXT:    s_lshr_b32 s64, s18, 2
; GFX6-NEXT:    s_bfe_i64 s[66:67], s[18:19], 0x10000
; GFX6-NEXT:    s_lshr_b32 s68, s18, 3
...
; GFX6-NEXT:    s_lshr_b32 s18, s18, 1
; GFX6-NEXT:    v_mov_b32_e32 v2, s20
; GFX6-NEXT:    v_mov_b32_e32 v3, s21
...
; GFX6-NEXT:    s_bfe_i64 s[20:21], s[40:41], 0x10000
...
; GFX6-NEXT:    s_bfe_i64 s[20:21], s[42:43], 0x10000
...
; GFX6-NEXT:    s_bfe_i64 s[20:21], s[68:69], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[22:23], s[64:65], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[24:25], s[62:63], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[26:27], s[60:61], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[28:29], s[58:59], 0x10000
...
; GFX8-NEXT:    s_lshr_b32 s46, s2, 26
; GFX8-NEXT:    s_lshr_b32 s48, s2, 27
; GFX8-NEXT:    s_lshr_b32 s50, s2, 24
; GFX8-NEXT:    s_lshr_b32 s52, s2, 25
; GFX8-NEXT:    s_lshr_b32 s54, s2, 22
; GFX8-NEXT:    s_lshr_b32 s56, s2, 23
; GFX8-NEXT:    s_lshr_b32 s58, s2, 20
; GFX8-NEXT:    s_lshr_b32 s60, s2, 21
; GFX8-NEXT:    s_lshr_b32 s62, s2, 18
...
; GFX12-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_lshr_b32 s4, s2, 30
; GFX12-NEXT:    s_lshr_b32 s6, s2, 31
; GFX12-NEXT:    s_lshr_b32 s8, s2, 28
; GFX12-NEXT:    s_lshr_b32 s10, s2, 29
; GFX12-NEXT:    s_lshr_b32 s12, s2, 26
; GFX12-NEXT:    s_lshr_b32 s14, s2, 27
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX12-NEXT:    s_lshr_b32 s16, s2, 24
; GFX12-NEXT:    s_lshr_b32 s18, s2, 25
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
...
; GFX12-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:192
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v3, s23
; GFX12-NEXT:    v_dual_mov_b32 v1, s5 :: v_dual_mov_b32 v2, s22
; GFX12-NEXT:    v_mov_b32_e32 v5, s25
; GFX12-NEXT:    s_lshr_b32 s42, s2, 12
; GFX12-NEXT:    s_lshr_b32 s44, s2, 13
; GFX12-NEXT:    s_lshr_b32 s46, s2, 10
; GFX12-NEXT:    s_lshr_b32 s48, s2, 11
...
; GFX12-NEXT:    s_lshr_b32 s52, s2, 9
...
; GFX12-NEXT:    v_dual_mov_b32 v10, s30 :: v_dual_mov_b32 v13, s35
; GFX12-NEXT:    s_lshr_b32 s54, s2, 6
; GFX12-NEXT:    s_lshr_b32 s56, s2, 7
...
; GFX12-NEXT:    v_dual_mov_b32 v12, s34 :: v_dual_mov_b32 v15, s37
; GFX12-NEXT:    v_dual_mov_b32 v14, s36 :: v_dual_mov_b32 v17, s39
; GFX12-NEXT:    s_lshr_b32 s58, s2, 4
; GFX12-NEXT:    s_lshr_b32 s60, s2, 5
; GFX12-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v16, s38 :: v_dual_mov_b32 v19, s41
; GFX12-NEXT:    v_dual_mov_b32 v18, s40 :: v_dual_mov_b32 v21, s43
; GFX12-NEXT:    s_lshr_b32 s62, s2, 2
; GFX12-NEXT:    s_lshr_b32 s64, s2, 3
; GFX12-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v20, s42 :: v_dual_mov_b32 v23, s45
; GFX12-NEXT:    v_mov_b32_e32 v22, s44
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:176
; GFX12-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:160
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:144
...
; GFX12-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:112
; GFX12-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:96
; GFX12-NEXT:    v_dual_mov_b32 v0, s46 :: v_dual_mov_b32 v3, s49
; GFX12-NEXT:    v_dual_mov_b32 v1, s47 :: v_dual_mov_b32 v2, s48
; GFX12-NEXT:    v_mov_b32_e32 v5, s51
; GFX12-NEXT:    s_lshr_b32 s66, s2, 1
; GFX12-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v4, s50 :: v_dual_mov_b32 v7, s53
; GFX12-NEXT:    v_dual_mov_b32 v6, s52 :: v_dual_mov_b32 v9, s55
...
; GFX12-NEXT:    v_dual_mov_b32 v12, s58 :: v_dual_mov_b32 v15, s61
; GFX12-NEXT:    v_dual_mov_b32 v14, s60 :: v_dual_mov_b32 v17, s63
; GFX12-NEXT:    v_dual_mov_b32 v16, s62 :: v_dual_mov_b32 v19, s65
; GFX12-NEXT:    v_dual_mov_b32 v18, s64 :: v_dual_mov_b32 v21, s3
; GFX12-NEXT:    v_dual_mov_b32 v20, s2 :: v_dual_mov_b32 v23, s67
; GFX12-NEXT:    v_mov_b32_e32 v22, s66
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:80
; GFX12-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:64
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:48
...
; GFX1250-NEXT:    s_load_b32 s2, s[2:3], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_lshr_b32 s4, s2, 30
; GFX1250-NEXT:    s_lshr_b32 s6, s2, 31
; GFX1250-NEXT:    s_lshr_b32 s8, s2, 28
; GFX1250-NEXT:    s_lshr_b32 s10, s2, 29
; GFX1250-NEXT:    s_lshr_b32 s12, s2, 26
; GFX1250-NEXT:    s_lshr_b32 s14, s2, 27
; GFX1250-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s16, s2, 24
; GFX1250-NEXT:    s_lshr_b32 s18, s2, 25
; GFX1250-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v2, s4
; GFX1250-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
...
; GFX1250-NEXT:    s_lshr_b32 s22, s2, 23
; GFX1250-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v7, s9 :: v_dual_mov_b32 v8, s10
; GFX1250-NEXT:    v_dual_mov_b32 v9, s11 :: v_dual_mov_b32 v10, s12
; GFX1250-NEXT:    s_lshr_b32 s24, s2, 20
; GFX1250-NEXT:    s_lshr_b32 s26, s2, 21
; GFX1250-NEXT:    v_dual_mov_b32 v11, s13 :: v_dual_mov_b32 v12, s14
; GFX1250-NEXT:    v_dual_mov_b32 v13, s15 :: v_dual_mov_b32 v14, s16
; GFX1250-NEXT:    s_lshr_b32 s28, s2, 18
; GFX1250-NEXT:    s_lshr_b32 s30, s2, 19
; GFX1250-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v15, s17 :: v_dual_mov_b32 v16, s18
; GFX1250-NEXT:    s_bfe_i64 s[4:5], s[20:21], 0x10000
; GFX1250-NEXT:    v_mov_b32_e32 v17, s19
; GFX1250-NEXT:    s_lshr_b32 s34, s2, 16
; GFX1250-NEXT:    s_lshr_b32 s36, s2, 17
; GFX1250-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s38, s2, 14
; GFX1250-NEXT:    s_lshr_b32 s40, s2, 15
; GFX1250-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-NEXT:    s_clause 0x3
...
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_mov_b32_e32 v6, s24
; GFX1250-NEXT:    s_lshr_b32 s42, s2, 12
; GFX1250-NEXT:    s_lshr_b32 s44, s2, 13
; GFX1250-NEXT:    s_lshr_b32 s46, s2, 10
; GFX1250-NEXT:    s_lshr_b32 s48, s2, 11
; GFX1250-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v7, s25 :: v_dual_mov_b32 v8, s26
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v9, s27 :: v_dual_mov_b32 v10, s28
; GFX1250-NEXT:    s_lshr_b32 s50, s2, 8
; GFX1250-NEXT:    s_lshr_b32 s52, s2, 9
; GFX1250-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v11, s29 :: v_dual_mov_b32 v12, s30
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v13, s31 :: v_dual_mov_b32 v14, s34
; GFX1250-NEXT:    s_lshr_b32 s54, s2, 6
; GFX1250-NEXT:    s_lshr_b32 s56, s2, 7
...
; GFX1250-NEXT:    v_dual_mov_b32 v15, s35 :: v_dual_mov_b32 v16, s36
; GFX1250-NEXT:    v_dual_mov_b32 v17, s37 :: v_dual_mov_b32 v18, s38
; GFX1250-NEXT:    s_lshr_b32 s58, s2, 4
; GFX1250-NEXT:    s_lshr_b32 s60, s2, 5
; GFX1250-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v19, s39 :: v_dual_mov_b32 v20, s40
; GFX1250-NEXT:    v_dual_mov_b32 v21, s41 :: v_dual_mov_b32 v22, s42
; GFX1250-NEXT:    s_lshr_b32 s62, s2, 2
; GFX1250-NEXT:    s_lshr_b32 s64, s2, 3
; GFX1250-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v23, s43 :: v_dual_mov_b32 v24, s44
; GFX1250-NEXT:    v_mov_b32_e32 v25, s45
; GFX1250-NEXT:    s_clause 0x5
...
; GFX1250-NEXT:    s_wait_xcnt 0x5
; GFX1250-NEXT:    v_dual_mov_b32 v2, s46 :: v_dual_mov_b32 v3, s47
; GFX1250-NEXT:    v_dual_mov_b32 v4, s48 :: v_dual_mov_b32 v5, s49
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_mov_b32_e32 v6, s50
; GFX1250-NEXT:    s_lshr_b32 s66, s2, 1
; GFX1250-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v7, s51 :: v_dual_mov_b32 v8, s52
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v9, s53 :: v_dual_mov_b32 v10, s54
; GFX1250-NEXT:    s_bfe_i64 s[64:65], s[64:65], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v11, s55 :: v_dual_mov_b32 v12, s56
; GFX1250-NEXT:    s_wait_xcnt 0x2
...
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v17, s61 :: v_dual_mov_b32 v18, s62
; GFX1250-NEXT:    v_dual_mov_b32 v19, s63 :: v_dual_mov_b32 v20, s64
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v21, s65 :: v_dual_mov_b32 v22, s2
; GFX1250-NEXT:    v_dual_mov_b32 v23, s3 :: v_dual_mov_b32 v24, s66
; GFX1250-NEXT:    v_mov_b32_e32 v25, s67
; GFX1250-NEXT:    s_clause 0x5
...
; GFX6-NEXT:    s_lshr_b32 s20, s4, 31
; GFX6-NEXT:    s_bfe_u32 s21, s5, 0x10003
; GFX6-NEXT:    s_bfe_u32 s22, s5, 0x10005
; GFX6-NEXT:    s_bfe_u32 s23, s5, 0x10007
; GFX6-NEXT:    s_bfe_u32 s24, s5, 0x10009
; GFX6-NEXT:    s_bfe_u32 s25, s5, 0x1000b
; GFX6-NEXT:    s_bfe_u32 s26, s5, 0x1000d
; GFX6-NEXT:    s_bfe_u32 s27, s5, 0x1000f
; GFX6-NEXT:    s_bfe_u32 s28, s5, 0x10011
; GFX6-NEXT:    s_bfe_u32 s29, s5, 0x10013
; GFX6-NEXT:    s_bfe_u32 s30, s5, 0x10015
; GFX6-NEXT:    s_bfe_u32 s31, s5, 0x10017
; GFX6-NEXT:    s_bfe_u32 s33, s5, 0x10019
; GFX6-NEXT:    s_bfe_u32 s34, s5, 0x1001b
; GFX6-NEXT:    s_bfe_u32 s35, s5, 0x1001d
; GFX6-NEXT:    s_lshr_b32 s36, s5, 31
; GFX6-NEXT:    s_bfe_u32 s37, s5, 0x10001
; GFX6-NEXT:    s_bfe_u32 s38, s4, 0x10001
; GFX6-NEXT:    s_and_b32 s39, s4, 1
; GFX6-NEXT:    s_and_b32 s40, s5, 1
; GFX6-NEXT:    s_bfe_u32 s41, s4, 0x10002
; GFX6-NEXT:    s_bfe_u32 s42, s4, 0x10004
; GFX6-NEXT:    s_bfe_u32 s43, s4, 0x10006
; GFX6-NEXT:    s_bfe_u32 s44, s4, 0x10008
; GFX6-NEXT:    s_bfe_u32 s45, s4, 0x1000a
; GFX6-NEXT:    s_bfe_u32 s46, s4, 0x1000c
; GFX6-NEXT:    s_bfe_u32 s47, s4, 0x1000e
; GFX6-NEXT:    s_bfe_u32 s48, s4, 0x10010
; GFX6-NEXT:    s_bfe_u32 s49, s4, 0x10012
; GFX6-NEXT:    s_bfe_u32 s50, s4, 0x10014
...
; GFX8-NEXT:    v_mov_b32_e32 v3, v1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_load_dwordx2 s[36:37], s[2:3], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshr_b32 s35, s37, 31
; GFX8-NEXT:    s_bfe_u32 s38, s37, 0x1001d
; GFX8-NEXT:    s_bfe_u32 s39, s37, 0x1001b
; GFX8-NEXT:    s_bfe_u32 s40, s37, 0x10019
; GFX8-NEXT:    s_bfe_u32 s41, s37, 0x10017
; GFX8-NEXT:    s_bfe_u32 s42, s37, 0x10013
; GFX8-NEXT:    s_bfe_u32 s43, s37, 0x10011
; GFX8-NEXT:    s_bfe_u32 s44, s37, 0x1000f
; GFX8-NEXT:    s_bfe_u32 s45, s37, 0x1000d
; GFX8-NEXT:    s_bfe_u32 s46, s37, 0x1000b
; GFX8-NEXT:    s_bfe_u32 s47, s37, 0x10009
; GFX8-NEXT:    s_bfe_u32 s48, s37, 0x10007
; GFX8-NEXT:    s_bfe_u32 s49, s37, 0x10005
; GFX8-NEXT:    s_bfe_u32 s34, s37, 0x10003
; GFX8-NEXT:    s_bfe_u32 s31, s37, 0x10001
; GFX8-NEXT:    s_lshr_b32 s29, s36, 31
; GFX8-NEXT:    s_bfe_u32 s27, s36, 0x1001d
; GFX8-NEXT:    s_bfe_u32 s26, s36, 0x1001b
; GFX8-NEXT:    s_bfe_u32 s23, s36, 0x10019
; GFX8-NEXT:    s_bfe_u32 s21, s36, 0x10017
; GFX8-NEXT:    s_bfe_u32 s18, s36, 0x10013
; GFX8-NEXT:    s_bfe_u32 s17, s36, 0x10011
; GFX8-NEXT:    s_bfe_u32 s15, s36, 0x1000f
; GFX8-NEXT:    s_bfe_u32 s13, s36, 0x1000d
; GFX8-NEXT:    s_bfe_u32 s11, s36, 0x1000b
; GFX8-NEXT:    s_bfe_u32 s9, s36, 0x10009
; GFX8-NEXT:    s_bfe_u32 s8, s36, 0x10007
; GFX8-NEXT:    s_bfe_u32 s6, s36, 0x10005
; GFX8-NEXT:    s_bfe_u32 s4, s36, 0x10003
; GFX8-NEXT:    s_bfe_u32 s2, s36, 0x10001
; GFX8-NEXT:    s_and_b32 s3, s36, 1
; GFX8-NEXT:    s_bfe_u32 s5, s36, 0x10002
; GFX8-NEXT:    s_bfe_u32 s7, s36, 0x10004
; GFX8-NEXT:    s_bfe_u32 s10, s36, 0x10006
; GFX8-NEXT:    s_bfe_u32 s12, s36, 0x10008
; GFX8-NEXT:    s_bfe_u32 s14, s36, 0x1000a
; GFX8-NEXT:    s_bfe_u32 s16, s36, 0x1000c
; GFX8-NEXT:    s_bfe_u32 s19, s36, 0x1000e
; GFX8-NEXT:    s_bfe_u32 s20, s36, 0x10010
; GFX8-NEXT:    s_bfe_u32 s22, s36, 0x10012
; GFX8-NEXT:    s_bfe_u32 s24, s36, 0x10014
; GFX8-NEXT:    s_bfe_u32 s25, s36, 0x10015
; GFX8-NEXT:    s_bfe_u32 s28, s36, 0x10016
; GFX8-NEXT:    s_bfe_u32 s30, s36, 0x10018
; GFX8-NEXT:    s_bfe_u32 s33, s36, 0x1001a
; GFX8-NEXT:    s_bfe_u32 s50, s36, 0x1001c
; GFX8-NEXT:    s_bfe_u32 s51, s36, 0x1001e
; GFX8-NEXT:    s_and_b32 s52, s37, 1
; GFX8-NEXT:    s_bfe_u32 s53, s37, 0x10002
; GFX8-NEXT:    s_bfe_u32 s54, s37, 0x10004
; GFX8-NEXT:    s_bfe_u32 s55, s37, 0x10006
; GFX8-NEXT:    s_bfe_u32 s56, s37, 0x10008
; GFX8-NEXT:    s_bfe_u32 s57, s37, 0x1000a
; GFX8-NEXT:    s_bfe_u32 s58, s37, 0x1000c
; GFX8-NEXT:    s_bfe_u32 s59, s37, 0x1000e
; GFX8-NEXT:    s_bfe_u32 s60, s37, 0x10010
; GFX8-NEXT:    s_bfe_u32 s61, s37, 0x10012
; GFX8-NEXT:    s_bfe_u32 s62, s37, 0x10016
; GFX8-NEXT:    s_bfe_u32 s63, s37, 0x10018
; GFX8-NEXT:    s_bfe_u32 s64, s37, 0x1001a
; GFX8-NEXT:    s_bfe_u32 s65, s37, 0x1001c
; GFX8-NEXT:    s_bfe_u32 s66, s37, 0x1001e
; GFX8-NEXT:    s_bfe_u32 s36, s37, 0x10015
; GFX8-NEXT:    s_bfe_u32 s37, s37, 0x10014
; GFX8-NEXT:    v_mov_b32_e32 v2, s36
; GFX8-NEXT:    s_add_u32 s36, s0, 0x1a0
...
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x1e0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
...
; GFX8-NEXT:    v_mov_b32_e32 v2, s38
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x1d0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s64
...
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x1b0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s62
...
; GFX8-NEXT:    v_mov_b32_e32 v2, s42
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x180
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s60
; GFX8-NEXT:    v_mov_b32_e32 v2, s43
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x170
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s59
; GFX8-NEXT:    v_mov_b32_e32 v2, s44
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x160
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s58
; GFX8-NEXT:    v_mov_b32_e32 v2, s45
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x150
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s57
; GFX8-NEXT:    v_mov_b32_e32 v2, s46
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x140
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s56
...
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x130
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s55
; GFX8-NEXT:    v_mov_b32_e32 v2, s48
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_add_u32 s36, s0, 0x120
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_addc_u32 s37, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s36
; GFX8-NEXT:    v_mov_b32_e32 v0, s54
...
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s24
; GFX8-NEXT:    s_add_u32 s24, s0, 0xa0
; GFX8-NEXT:    v_mov_b32_e32 v2, s25
...
; GFX1250-NEXT:    s_bfe_u32 s6, s3, 0x10006
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v4, s4
; GFX1250-NEXT:    s_bfe_u32 s4, s3, 0x10005
; GFX1250-NEXT:    s_bfe_u32 s6, s3, 0x10004
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_load_dwordx4 s[88:91], s[4:5], 0x9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dwordx2 s[8:9], s[90:91], 0x0
; GFX6-NEXT:    s_mov_b32 s91, 0xf000
; GFX6-NEXT:    s_mov_b32 s90, -1
; GFX6-NEXT:    s_mov_b32 s5, 0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshr_b32 s0, s9, 30
; GFX6-NEXT:    s_lshr_b32 s82, s8, 30
; GFX6-NEXT:    s_lshr_b32 s86, s8, 31
; GFX6-NEXT:    s_lshr_b32 s6, s8, 28
; GFX6-NEXT:    s_lshr_b32 s10, s8, 29
; GFX6-NEXT:    s_lshr_b32 s12, s8, 26
; GFX6-NEXT:    s_lshr_b32 s14, s8, 27
; GFX6-NEXT:    s_lshr_b32 s16, s8, 24
; GFX6-NEXT:    s_lshr_b32 s18, s8, 25
; GFX6-NEXT:    s_lshr_b32 s22, s8, 22
; GFX6-NEXT:    s_lshr_b32 s20, s8, 23
; GFX6-NEXT:    s_lshr_b32 s78, s8, 20
; GFX6-NEXT:    s_lshr_b32 s76, s8, 21
; GFX6-NEXT:    s_lshr_b32 s80, s8, 18
; GFX6-NEXT:    s_lshr_b32 s84, s8, 19
; GFX6-NEXT:    s_lshr_b32 vcc_lo, s8, 16
; GFX6-NEXT:    s_lshr_b32 s94, s8, 17
; GFX6-NEXT:    s_lshr_b32 s92, s8, 14
; GFX6-NEXT:    s_lshr_b32 s2, s8, 15
; GFX6-NEXT:    ; implicit-def: $vgpr28 : SGPR spill to VGPR lane
; GFX6-NEXT:    v_writelane_b32 v28, s2, 0
; GFX6-NEXT:    v_writelane_b32 v28, s3, 1
; GFX6-NEXT:    s_lshr_b32 s2, s8, 12
; GFX6-NEXT:    s_lshr_b32 s4, s8, 13
; GFX6-NEXT:    v_writelane_b32 v28, s4, 2
; GFX6-NEXT:    v_writelane_b32 v28, s5, 3
; GFX6-NEXT:    s_lshr_b32 s4, s8, 10
; GFX6-NEXT:    v_writelane_b32 v28, s4, 4
; GFX6-NEXT:    v_writelane_b32 v28, s5, 5
; GFX6-NEXT:    s_lshr_b32 s4, s8, 11
; GFX6-NEXT:    v_writelane_b32 v28, s4, 6
; GFX6-NEXT:    v_writelane_b32 v28, s5, 7
; GFX6-NEXT:    s_lshr_b32 s4, s8, 8
; GFX6-NEXT:    v_writelane_b32 v28, s4, 8
; GFX6-NEXT:    v_writelane_b32 v28, s5, 9
; GFX6-NEXT:    s_lshr_b32 s4, s8, 9
; GFX6-NEXT:    v_writelane_b32 v28, s4, 10
; GFX6-NEXT:    v_writelane_b32 v28, s5, 11
; GFX6-NEXT:    s_lshr_b32 s4, s8, 6
; GFX6-NEXT:    v_writelane_b32 v28, s4, 12
; GFX6-NEXT:    v_writelane_b32 v28, s5, 13
; GFX6-NEXT:    s_lshr_b32 s4, s8, 7
; GFX6-NEXT:    v_writelane_b32 v28, s4, 14
; GFX6-NEXT:    v_writelane_b32 v28, s5, 15
; GFX6-NEXT:    s_lshr_b32 s4, s8, 4
; GFX6-NEXT:    v_writelane_b32 v28, s4, 16
; GFX6-NEXT:    v_writelane_b32 v28, s5, 17
; GFX6-NEXT:    s_lshr_b32 s4, s8, 5
; GFX6-NEXT:    v_writelane_b32 v28, s4, 18
; GFX6-NEXT:    v_writelane_b32 v28, s5, 19
; GFX6-NEXT:    s_lshr_b32 s4, s8, 2
; GFX6-NEXT:    v_writelane_b32 v28, s4, 20
; GFX6-NEXT:    v_writelane_b32 v28, s5, 21
; GFX6-NEXT:    s_lshr_b32 s4, s8, 3
; GFX6-NEXT:    v_writelane_b32 v28, s4, 22
; GFX6-NEXT:    v_writelane_b32 v28, s5, 23
; GFX6-NEXT:    s_lshr_b32 s4, s8, 1
; GFX6-NEXT:    v_writelane_b32 v28, s4, 24
; GFX6-NEXT:    v_writelane_b32 v28, s5, 25
; GFX6-NEXT:    s_mov_b32 s4, s9
; GFX6-NEXT:    s_lshr_b32 s26, s9, 29
; GFX6-NEXT:    s_lshr_b32 s3, s9, 28
; GFX6-NEXT:    s_lshr_b32 s38, s9, 26
; GFX6-NEXT:    s_lshr_b32 s28, s9, 27
; GFX6-NEXT:    s_lshr_b32 s34, s9, 25
; GFX6-NEXT:    s_lshr_b32 s46, s9, 24
; GFX6-NEXT:    s_lshr_b32 s40, s9, 22
; GFX6-NEXT:    s_lshr_b32 s30, s9, 23
; GFX6-NEXT:    s_lshr_b32 s42, s9, 20
; GFX6-NEXT:    s_lshr_b32 s74, s9, 21
; GFX6-NEXT:    s_ashr_i32 s19, s9, 31
; GFX6-NEXT:    s_bfe_i64 s[64:65], s[4:5], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[56:57], s[8:9], 0x10000
; GFX6-NEXT:    s_lshr_b32 s8, s9, 18
; GFX6-NEXT:    s_lshr_b32 s72, s9, 19
; GFX6-NEXT:    s_lshr_b32 s70, s9, 17
; GFX6-NEXT:    s_lshr_b32 s62, s9, 16
; GFX6-NEXT:    s_lshr_b32 s58, s9, 14
; GFX6-NEXT:    s_lshr_b32 s44, s9, 15
; GFX6-NEXT:    s_lshr_b32 s24, s9, 12
; GFX6-NEXT:    s_lshr_b32 s36, s9, 13
; GFX6-NEXT:    s_lshr_b32 s48, s9, 10
; GFX6-NEXT:    s_lshr_b32 s50, s9, 11
; GFX6-NEXT:    s_lshr_b32 s52, s9, 8
; GFX6-NEXT:    s_lshr_b32 s54, s9, 9
; GFX6-NEXT:    v_mov_b32_e32 v2, s56
; GFX6-NEXT:    v_mov_b32_e32 v3, s57
; GFX6-NEXT:    s_lshr_b32 s56, s9, 6
; GFX6-NEXT:    s_lshr_b32 s60, s9, 7
; GFX6-NEXT:    v_mov_b32_e32 v0, s64
; GFX6-NEXT:    v_mov_b32_e32 v1, s65
; GFX6-NEXT:    s_lshr_b32 s64, s9, 4
; GFX6-NEXT:    s_lshr_b32 s66, s9, 5
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[4:5], 0x10000
; GFX6-NEXT:    s_lshr_b32 s68, s9, 2
; GFX6-NEXT:    v_mov_b32_e32 v16, s0
; GFX6-NEXT:    v_mov_b32_e32 v17, s1
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[82:83], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[82:83], s[86:87], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v24, s0
; GFX6-NEXT:    v_mov_b32_e32 v25, s1
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[6:7], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[10:11], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v26, s82
; GFX6-NEXT:    v_mov_b32_e32 v27, s83
; GFX6-NEXT:    s_bfe_i64 s[10:11], s[12:13], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[12:13], s[14:15], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v8, s0
; GFX6-NEXT:    v_mov_b32_e32 v9, s1
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[16:17], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[14:15], s[18:19], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v10, s6
; GFX6-NEXT:    v_mov_b32_e32 v11, s7
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[20:21], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[16:17], s[22:23], 0x10000
; GFX6-NEXT:    s_lshr_b32 s82, s9, 3
; GFX6-NEXT:    s_lshr_b32 s86, s9, 1
; GFX6-NEXT:    v_mov_b32_e32 v18, s19
; GFX6-NEXT:    s_mov_b32 s27, s5
; GFX6-NEXT:    v_mov_b32_e32 v4, s10
; GFX6-NEXT:    v_mov_b32_e32 v5, s11
; GFX6-NEXT:    s_mov_b32 s4, s3
; GFX6-NEXT:    s_mov_b32 s39, s5
; GFX6-NEXT:    v_mov_b32_e32 v6, s12
; GFX6-NEXT:    v_mov_b32_e32 v7, s13
; GFX6-NEXT:    s_mov_b32 s29, s5
; GFX6-NEXT:    s_mov_b32 s35, s5
; GFX6-NEXT:    v_mov_b32_e32 v20, s0
; GFX6-NEXT:    v_mov_b32_e32 v21, s1
; GFX6-NEXT:    s_mov_b32 s47, s5
; GFX6-NEXT:    s_mov_b32 s41, s5
; GFX6-NEXT:    v_mov_b32_e32 v22, s14
; GFX6-NEXT:    v_mov_b32_e32 v23, s15
; GFX6-NEXT:    s_mov_b32 s31, s5
; GFX6-NEXT:    v_mov_b32_e32 v12, s16
; GFX6-NEXT:    v_mov_b32_e32 v13, s17
; GFX6-NEXT:    s_mov_b32 s43, s5
; GFX6-NEXT:    v_mov_b32_e32 v14, s6
; GFX6-NEXT:    v_mov_b32_e32 v15, s7
; GFX6-NEXT:    s_mov_b32 s75, s5
; GFX6-NEXT:    v_mov_b32_e32 v19, s19
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[76:77], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[78:79], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[16:19], off, s[88:91], 0 offset:496
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v16, s6
; GFX6-NEXT:    v_mov_b32_e32 v17, s7
; GFX6-NEXT:    s_mov_b32 s9, s5
; GFX6-NEXT:    v_mov_b32_e32 v18, s0
; GFX6-NEXT:    v_mov_b32_e32 v19, s1
; GFX6-NEXT:    s_mov_b32 s73, s5
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[80:81], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[84:85], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[24:27], off, s[88:91], 0 offset:240
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v24, s0
; GFX6-NEXT:    v_mov_b32_e32 v25, s1
; GFX6-NEXT:    s_mov_b32 s71, s5
; GFX6-NEXT:    v_mov_b32_e32 v26, s6
; GFX6-NEXT:    v_mov_b32_e32 v27, s7
; GFX6-NEXT:    s_mov_b32 s63, s5
; GFX6-NEXT:    s_bfe_i64 s[0:1], vcc, 0x10000
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[94:95], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[88:91], 0 offset:224
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v8, s0
; GFX6-NEXT:    v_mov_b32_e32 v9, s1
; GFX6-NEXT:    s_mov_b32 s59, s5
; GFX6-NEXT:    v_mov_b32_e32 v10, s6
; GFX6-NEXT:    v_mov_b32_e32 v11, s7
; GFX6-NEXT:    s_mov_b32 s45, s5
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[92:93], 0x10000
; GFX6-NEXT:    v_readlane_b32 s6, v28, 0
; GFX6-NEXT:    v_readlane_b32 s7, v28, 1
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[4:7], off, s[88:91], 0 offset:208
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v4, s0
; GFX6-NEXT:    v_mov_b32_e32 v5, s1
; GFX6-NEXT:    s_mov_b32 s25, s5
; GFX6-NEXT:    v_mov_b32_e32 v6, s6
; GFX6-NEXT:    v_mov_b32_e32 v7, s7
; GFX6-NEXT:    s_mov_b32 s37, s5
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[2:3], 0x10000
; GFX6-NEXT:    v_readlane_b32 s2, v28, 2
; GFX6-NEXT:    v_readlane_b32 s3, v28, 3
; GFX6-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[20:23], off, s[88:91], 0 offset:192
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v20, s0
; GFX6-NEXT:    v_mov_b32_e32 v21, s1
; GFX6-NEXT:    s_mov_b32 s49, s5
; GFX6-NEXT:    v_mov_b32_e32 v22, s2
; GFX6-NEXT:    v_mov_b32_e32 v23, s3
; GFX6-NEXT:    s_mov_b32 s51, s5
; GFX6-NEXT:    v_readlane_b32 s0, v28, 4
; GFX6-NEXT:    v_readlane_b32 s1, v28, 5
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x10000
; GFX6-NEXT:    v_readlane_b32 s2, v28, 6
; GFX6-NEXT:    v_readlane_b32 s3, v28, 7
; GFX6-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], off, s[88:91], 0 offset:176
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v12, s0
; GFX6-NEXT:    v_mov_b32_e32 v13, s1
; GFX6-NEXT:    s_mov_b32 s53, s5
; GFX6-NEXT:    v_mov_b32_e32 v14, s2
; GFX6-NEXT:    v_mov_b32_e32 v15, s3
; GFX6-NEXT:    s_mov_b32 s55, s5
; GFX6-NEXT:    v_readlane_b32 s0, v28, 8
; GFX6-NEXT:    v_readlane_b32 s1, v28, 9
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x10000
; GFX6-NEXT:    v_readlane_b32 s2, v28, 10
; GFX6-NEXT:    v_readlane_b32 s3, v28, 11
; GFX6-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[16:19], off, s[88:91], 0 offset:160
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v16, s0
; GFX6-NEXT:    v_mov_b32_e32 v17, s1
; GFX6-NEXT:    s_mov_b32 s57, s5
; GFX6-NEXT:    v_mov_b32_e32 v18, s2
; GFX6-NEXT:    v_mov_b32_e32 v19, s3
; GFX6-NEXT:    s_mov_b32 s61, s5
; GFX6-NEXT:    v_readlane_b32 s0, v28, 12
; GFX6-NEXT:    v_readlane_b32 s1, v28, 13
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x10000
; GFX6-NEXT:    v_readlane_b32 s2, v28, 14
; GFX6-NEXT:    v_readlane_b32 s3, v28, 15
; GFX6-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[24:27], off, s[88:91], 0 offset:144
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v24, s0
; GFX6-NEXT:    v_mov_b32_e32 v25, s1
; GFX6-NEXT:    s_mov_b32 s65, s5
; GFX6-NEXT:    v_mov_b32_e32 v26, s2
; GFX6-NEXT:    v_mov_b32_e32 v27, s3
; GFX6-NEXT:    s_mov_b32 s67, s5
; GFX6-NEXT:    v_readlane_b32 s0, v28, 16
; GFX6-NEXT:    v_readlane_b32 s1, v28, 17
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x10000
; GFX6-NEXT:    v_readlane_b32 s2, v28, 18
; GFX6-NEXT:    v_readlane_b32 s3, v28, 19
; GFX6-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[88:91], 0 offset:128
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v8, s0
; GFX6-NEXT:    v_mov_b32_e32 v9, s1
; GFX6-NEXT:    s_mov_b32 s69, s5
; GFX6-NEXT:    v_mov_b32_e32 v10, s2
; GFX6-NEXT:    v_mov_b32_e32 v11, s3
; GFX6-NEXT:    s_mov_b32 s83, s5
; GFX6-NEXT:    s_mov_b32 s87, s5
; GFX6-NEXT:    v_readlane_b32 s0, v28, 22
; GFX6-NEXT:    v_readlane_b32 s1, v28, 23
; GFX6-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x10000
; GFX6-NEXT:    v_readlane_b32 s2, v28, 20
; GFX6-NEXT:    v_readlane_b32 s3, v28, 21
; GFX6-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX6-NEXT:    v_readlane_b32 s6, v28, 24
; GFX6-NEXT:    v_readlane_b32 s7, v28, 25
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[10:11], s[4:5], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[12:13], s[38:39], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[14:15], s[26:27], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[16:17], s[46:47], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[18:19], s[28:29], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[26:27], s[40:41], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[28:29], s[34:35], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[34:35], s[42:43], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[4:5], s[86:87], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[20:21], s[82:83], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[22:23], s[68:69], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[38:39], s[66:67], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[40:41], s[64:65], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[42:43], s[60:61], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[46:47], s[56:57], 0x10000
...
; GFX6-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[56:57], s[58:59], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[58:59], s[62:63], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[60:61], s[70:71], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[62:63], s[72:73], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[64:65], s[74:75], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[4:7], off, s[88:91], 0 offset:112
; GFX6-NEXT:    buffer_store_dwordx4 v[20:23], off, s[88:91], 0 offset:96
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], off, s[88:91], 0 offset:80
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v12, s2
; GFX6-NEXT:    v_mov_b32_e32 v13, s3
; GFX6-NEXT:    v_mov_b32_e32 v14, s0
; GFX6-NEXT:    v_mov_b32_e32 v15, s1
; GFX6-NEXT:    v_mov_b32_e32 v4, s6
; GFX6-NEXT:    v_mov_b32_e32 v5, s7
; GFX6-NEXT:    buffer_store_dwordx4 v[16:19], off, s[88:91], 0 offset:64
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v16, s10
; GFX6-NEXT:    v_mov_b32_e32 v17, s11
; GFX6-NEXT:    buffer_store_dwordx4 v[24:27], off, s[88:91], 0 offset:48
; GFX6-NEXT:    v_mov_b32_e32 v6, s12
; GFX6-NEXT:    v_mov_b32_e32 v18, s14
; GFX6-NEXT:    v_mov_b32_e32 v19, s15
; GFX6-NEXT:    v_mov_b32_e32 v7, s13
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[88:91], 0 offset:32
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], off, s[88:91], 0 offset:16
...
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s34
; GFX6-NEXT:    v_mov_b32_e32 v22, s30
; GFX6-NEXT:    v_mov_b32_e32 v23, s31
; GFX6-NEXT:    v_mov_b32_e32 v3, s35
; GFX6-NEXT:    buffer_store_dwordx4 v[16:19], off, s[88:91], 0 offset:480
; GFX6-NEXT:    buffer_store_dwordx4 v[6:9], off, s[88:91], 0 offset:464
; GFX6-NEXT:    buffer_store_dwordx4 v[10:13], off, s[88:91], 0 offset:448
; GFX6-NEXT:    buffer_store_dwordx4 v[20:23], off, s[88:91], 0 offset:432
; GFX6-NEXT:    v_mov_b32_e32 v4, s64
; GFX6-NEXT:    v_mov_b32_e32 v5, s65
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:416
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s8
; GFX6-NEXT:    v_mov_b32_e32 v3, s9
; GFX6-NEXT:    v_mov_b32_e32 v4, s62
; GFX6-NEXT:    v_mov_b32_e32 v5, s63
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:400
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s58
; GFX6-NEXT:    v_mov_b32_e32 v3, s59
; GFX6-NEXT:    v_mov_b32_e32 v4, s60
; GFX6-NEXT:    v_mov_b32_e32 v5, s61
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:384
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s56
; GFX6-NEXT:    v_mov_b32_e32 v3, s57
; GFX6-NEXT:    v_mov_b32_e32 v4, s44
; GFX6-NEXT:    v_mov_b32_e32 v5, s45
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:368
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s24
; GFX6-NEXT:    v_mov_b32_e32 v3, s25
; GFX6-NEXT:    v_mov_b32_e32 v4, s36
; GFX6-NEXT:    v_mov_b32_e32 v5, s37
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:352
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s48
; GFX6-NEXT:    v_mov_b32_e32 v3, s49
; GFX6-NEXT:    v_mov_b32_e32 v4, s50
; GFX6-NEXT:    v_mov_b32_e32 v5, s51
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:336
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s52
; GFX6-NEXT:    v_mov_b32_e32 v3, s53
; GFX6-NEXT:    v_mov_b32_e32 v4, s54
; GFX6-NEXT:    v_mov_b32_e32 v5, s55
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:320
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s46
; GFX6-NEXT:    v_mov_b32_e32 v3, s47
; GFX6-NEXT:    v_mov_b32_e32 v4, s42
; GFX6-NEXT:    v_mov_b32_e32 v5, s43
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:304
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s40
; GFX6-NEXT:    v_mov_b32_e32 v3, s41
; GFX6-NEXT:    v_mov_b32_e32 v4, s38
; GFX6-NEXT:    v_mov_b32_e32 v5, s39
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:288
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s22
; GFX6-NEXT:    v_mov_b32_e32 v3, s23
; GFX6-NEXT:    v_mov_b32_e32 v4, s20
; GFX6-NEXT:    v_mov_b32_e32 v5, s21
; GFX6-NEXT:    buffer_store_dwordx4 v[2:5], off, s[88:91], 0 offset:272
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s4
; GFX6-NEXT:    v_mov_b32_e32 v3, s5
; GFX6-NEXT:    buffer_store_dwordx4 v[0:3], off, s[88:91], 0 offset:256
; GFX6-NEXT:    s_endpgm
;
; GFX8-LABEL: constant_sextload_v64i1_to_v64i64:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8-NEXT:    ; implicit-def: $vgpr6 : SGPR spill to VGPR lane
; GFX8-NEXT:    ; implicit-def: $vgpr7 : SGPR spill to VGPR lane
; GFX8-NEXT:    s_mov_b32 s85, 0
; GFX8-NEXT:    s_mov_b32 vcc_hi, s85
; GFX8-NEXT:    s_mov_b32 s55, s85
; GFX8-NEXT:    s_mov_b32 s53, s85
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_load_dwordx2 s[16:17], s[2:3], 0x0
; GFX8-NEXT:    s_mov_b32 s51, s85
; GFX8-NEXT:    s_mov_b32 s49, s85
; GFX8-NEXT:    s_mov_b32 s39, s85
; GFX8-NEXT:    s_mov_b32 s37, s85
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshr_b32 s2, s17, 30
; GFX8-NEXT:    v_writelane_b32 v6, s2, 0
; GFX8-NEXT:    v_writelane_b32 v6, s3, 1
; GFX8-NEXT:    s_lshr_b32 s2, s17, 31
; GFX8-NEXT:    v_writelane_b32 v6, s2, 2
; GFX8-NEXT:    v_writelane_b32 v6, s3, 3
; GFX8-NEXT:    s_lshr_b32 s2, s17, 28
; GFX8-NEXT:    v_writelane_b32 v6, s2, 4
; GFX8-NEXT:    v_writelane_b32 v6, s3, 5
; GFX8-NEXT:    s_lshr_b32 s2, s17, 29
; GFX8-NEXT:    v_writelane_b32 v6, s2, 6
; GFX8-NEXT:    v_writelane_b32 v6, s3, 7
; GFX8-NEXT:    s_lshr_b32 s2, s17, 26
; GFX8-NEXT:    v_writelane_b32 v6, s2, 8
; GFX8-NEXT:    v_writelane_b32 v6, s3, 9
; GFX8-NEXT:    s_lshr_b32 s2, s17, 27
; GFX8-NEXT:    v_writelane_b32 v6, s2, 10
; GFX8-NEXT:    v_writelane_b32 v6, s3, 11
; GFX8-NEXT:    s_lshr_b32 s2, s17, 25
; GFX8-NEXT:    v_writelane_b32 v6, s2, 12
; GFX8-NEXT:    v_writelane_b32 v6, s3, 13
; GFX8-NEXT:    s_lshr_b32 s2, s17, 14
; GFX8-NEXT:    v_writelane_b32 v6, s2, 14
; GFX8-NEXT:    v_writelane_b32 v6, s3, 15
; GFX8-NEXT:    s_lshr_b32 s2, s17, 15
; GFX8-NEXT:    v_writelane_b32 v6, s2, 16
; GFX8-NEXT:    v_writelane_b32 v6, s3, 17
; GFX8-NEXT:    s_lshr_b32 s2, s17, 12
; GFX8-NEXT:    v_writelane_b32 v6, s2, 18
; GFX8-NEXT:    v_writelane_b32 v6, s3, 19
; GFX8-NEXT:    s_lshr_b32 s2, s17, 13
; GFX8-NEXT:    v_writelane_b32 v6, s2, 20
; GFX8-NEXT:    v_writelane_b32 v6, s3, 21
; GFX8-NEXT:    s_lshr_b32 s2, s17, 10
; GFX8-NEXT:    v_writelane_b32 v6, s2, 22
; GFX8-NEXT:    v_writelane_b32 v6, s3, 23
; GFX8-NEXT:    s_lshr_b32 s2, s17, 11
; GFX8-NEXT:    v_writelane_b32 v6, s2, 24
; GFX8-NEXT:    v_writelane_b32 v6, s3, 25
; GFX8-NEXT:    s_lshr_b32 s2, s17, 8
; GFX8-NEXT:    v_writelane_b32 v6, s2, 26
; GFX8-NEXT:    v_writelane_b32 v6, s3, 27
; GFX8-NEXT:    s_lshr_b32 s2, s17, 9
; GFX8-NEXT:    v_writelane_b32 v6, s2, 28
; GFX8-NEXT:    v_writelane_b32 v6, s3, 29
; GFX8-NEXT:    s_lshr_b32 s2, s17, 6
; GFX8-NEXT:    v_writelane_b32 v6, s2, 30
; GFX8-NEXT:    v_writelane_b32 v6, s3, 31
; GFX8-NEXT:    s_lshr_b32 s2, s17, 7
; GFX8-NEXT:    v_writelane_b32 v6, s2, 32
; GFX8-NEXT:    v_writelane_b32 v6, s3, 33
; GFX8-NEXT:    s_lshr_b32 s2, s17, 4
; GFX8-NEXT:    v_writelane_b32 v6, s2, 34
; GFX8-NEXT:    v_writelane_b32 v6, s3, 35
; GFX8-NEXT:    s_lshr_b32 s2, s17, 5
; GFX8-NEXT:    v_writelane_b32 v6, s2, 36
; GFX8-NEXT:    v_writelane_b32 v6, s3, 37
; GFX8-NEXT:    s_lshr_b32 s2, s17, 2
; GFX8-NEXT:    v_writelane_b32 v6, s2, 38
; GFX8-NEXT:    v_writelane_b32 v6, s3, 39
; GFX8-NEXT:    s_lshr_b32 s2, s17, 3
; GFX8-NEXT:    v_writelane_b32 v6, s2, 40
; GFX8-NEXT:    s_lshr_b32 s84, s17, 24
; GFX8-NEXT:    s_lshr_b32 vcc_lo, s17, 22
; GFX8-NEXT:    s_lshr_b32 s54, s17, 23
; GFX8-NEXT:    s_lshr_b32 s52, s17, 20
; GFX8-NEXT:    s_lshr_b32 s50, s17, 21
; GFX8-NEXT:    s_lshr_b32 s48, s17, 18
; GFX8-NEXT:    s_lshr_b32 s38, s17, 19
; GFX8-NEXT:    s_lshr_b32 s36, s17, 16
; GFX8-NEXT:    s_lshr_b32 s34, s17, 17
; GFX8-NEXT:    v_writelane_b32 v6, s3, 41
; GFX8-NEXT:    s_lshr_b32 s86, s17, 1
; GFX8-NEXT:    s_mov_b32 s82, s17
; GFX8-NEXT:    s_lshr_b32 s80, s16, 30
; GFX8-NEXT:    s_lshr_b32 s70, s16, 31
; GFX8-NEXT:    s_lshr_b32 s66, s16, 28
; GFX8-NEXT:    s_lshr_b32 s62, s16, 29
; GFX8-NEXT:    s_lshr_b32 s60, s16, 26
; GFX8-NEXT:    s_lshr_b32 s58, s16, 27
; GFX8-NEXT:    s_lshr_b32 s56, s16, 24
; GFX8-NEXT:    s_lshr_b32 s44, s16, 25
; GFX8-NEXT:    s_lshr_b32 s42, s16, 22
; GFX8-NEXT:    s_lshr_b32 s40, s16, 23
; GFX8-NEXT:    s_lshr_b32 s64, s16, 20
; GFX8-NEXT:    s_lshr_b32 s68, s16, 21
; GFX8-NEXT:    s_lshr_b32 s72, s16, 18
; GFX8-NEXT:    s_lshr_b32 s74, s16, 19
; GFX8-NEXT:    s_lshr_b32 s76, s16, 16
; GFX8-NEXT:    s_lshr_b32 s78, s16, 17
; GFX8-NEXT:    s_lshr_b32 s30, s16, 14
; GFX8-NEXT:    s_lshr_b32 s46, s16, 15
; GFX8-NEXT:    s_lshr_b32 s28, s16, 12
; GFX8-NEXT:    s_lshr_b32 s26, s16, 13
; GFX8-NEXT:    s_lshr_b32 s24, s16, 10
; GFX8-NEXT:    s_lshr_b32 s22, s16, 11
; GFX8-NEXT:    s_lshr_b32 s20, s16, 8
; GFX8-NEXT:    s_lshr_b32 s18, s16, 9
; GFX8-NEXT:    s_lshr_b32 s14, s16, 6
; GFX8-NEXT:    s_lshr_b32 s12, s16, 7
; GFX8-NEXT:    s_lshr_b32 s10, s16, 4
; GFX8-NEXT:    s_lshr_b32 s8, s16, 5
; GFX8-NEXT:    s_lshr_b32 s6, s16, 2
; GFX8-NEXT:    s_lshr_b32 s4, s16, 3
; GFX8-NEXT:    s_lshr_b32 s2, s16, 1
; GFX8-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s16, 42
; GFX8-NEXT:    v_writelane_b32 v6, s17, 43
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 44
; GFX8-NEXT:    v_writelane_b32 v6, s3, 45
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[4:5], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 46
; GFX8-NEXT:    v_writelane_b32 v6, s3, 47
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[6:7], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 48
; GFX8-NEXT:    v_writelane_b32 v6, s3, 49
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[8:9], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 50
; GFX8-NEXT:    v_writelane_b32 v6, s3, 51
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[10:11], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 52
; GFX8-NEXT:    v_writelane_b32 v6, s3, 53
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[12:13], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 54
; GFX8-NEXT:    v_writelane_b32 v6, s3, 55
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[14:15], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 56
; GFX8-NEXT:    v_writelane_b32 v6, s3, 57
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[18:19], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 58
; GFX8-NEXT:    v_writelane_b32 v6, s3, 59
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[20:21], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 60
; GFX8-NEXT:    v_writelane_b32 v6, s3, 61
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[22:23], 0x10000
; GFX8-NEXT:    v_writelane_b32 v6, s2, 62
; GFX8-NEXT:    v_writelane_b32 v6, s3, 63
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[24:25], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 0
; GFX8-NEXT:    v_writelane_b32 v7, s3, 1
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[26:27], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 2
; GFX8-NEXT:    v_writelane_b32 v7, s3, 3
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[28:29], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 4
; GFX8-NEXT:    v_writelane_b32 v7, s3, 5
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[46:47], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 6
; GFX8-NEXT:    v_writelane_b32 v7, s3, 7
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[30:31], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 8
; GFX8-NEXT:    v_writelane_b32 v7, s3, 9
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[78:79], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 10
; GFX8-NEXT:    v_writelane_b32 v7, s3, 11
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[76:77], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 12
; GFX8-NEXT:    v_writelane_b32 v7, s3, 13
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[74:75], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 14
; GFX8-NEXT:    v_writelane_b32 v7, s3, 15
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[72:73], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 16
; GFX8-NEXT:    v_writelane_b32 v7, s3, 17
; GFX8-NEXT:    s_bfe_i64 s[2:3], s[68:69], 0x10000
; GFX8-NEXT:    v_writelane_b32 v7, s2, 18
; GFX8-NEXT:    v_writelane_b32 v7, s3, 19
; GFX8-NEXT:    v_readlane_b32 s2, v6, 40
; GFX8-NEXT:    v_readlane_b32 s3, v6, 41
; GFX8-NEXT:    s_bfe_i64 s[68:69], s[56:57], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[56:57], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 38
; GFX8-NEXT:    v_readlane_b32 s3, v6, 39
; GFX8-NEXT:    s_bfe_i64 s[46:47], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 36
; GFX8-NEXT:    v_readlane_b32 s3, v6, 37
; GFX8-NEXT:    s_bfe_i64 s[30:31], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 34
; GFX8-NEXT:    v_readlane_b32 s3, v6, 35
; GFX8-NEXT:    s_bfe_i64 s[26:27], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 32
; GFX8-NEXT:    v_readlane_b32 s3, v6, 33
; GFX8-NEXT:    s_bfe_i64 s[24:25], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 30
; GFX8-NEXT:    v_readlane_b32 s3, v6, 31
; GFX8-NEXT:    s_bfe_i64 s[22:23], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 28
; GFX8-NEXT:    v_readlane_b32 s3, v6, 29
; GFX8-NEXT:    s_bfe_i64 s[14:15], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 26
; GFX8-NEXT:    v_readlane_b32 s3, v6, 27
; GFX8-NEXT:    s_bfe_i64 s[16:17], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 24
; GFX8-NEXT:    v_readlane_b32 s3, v6, 25
; GFX8-NEXT:    s_bfe_i64 s[18:19], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 22
; GFX8-NEXT:    v_readlane_b32 s3, v6, 23
; GFX8-NEXT:    s_bfe_i64 s[20:21], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 20
; GFX8-NEXT:    v_readlane_b32 s3, v6, 21
; GFX8-NEXT:    s_bfe_i64 s[28:29], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 18
; GFX8-NEXT:    v_readlane_b32 s3, v6, 19
; GFX8-NEXT:    s_bfe_i64 s[76:77], s[40:41], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[40:41], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 16
; GFX8-NEXT:    v_readlane_b32 s3, v6, 17
; GFX8-NEXT:    s_bfe_i64 s[74:75], s[42:43], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[42:43], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 14
; GFX8-NEXT:    v_readlane_b32 s3, v6, 15
; GFX8-NEXT:    s_bfe_i64 s[72:73], s[44:45], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[44:45], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 12
; GFX8-NEXT:    v_readlane_b32 s3, v6, 13
; GFX8-NEXT:    s_bfe_i64 s[78:79], s[64:65], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[64:65], s[58:59], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[58:59], s[60:61], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[60:61], s[62:63], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[62:63], s[66:67], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[66:67], s[70:71], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[70:71], s[80:81], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[80:81], s[86:87], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[86:87], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 10
; GFX8-NEXT:    s_mov_b32 s35, s85
; GFX8-NEXT:    v_readlane_b32 s3, v6, 11
; GFX8-NEXT:    s_bfe_i64 s[12:13], s[34:35], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[34:35], s[36:37], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[36:37], s[38:39], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[38:39], s[48:49], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[48:49], s[50:51], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[50:51], s[52:53], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[52:53], s[54:55], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[54:55], vcc, 0x10000
; GFX8-NEXT:    s_bfe_i64 vcc, s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 8
; GFX8-NEXT:    v_readlane_b32 s3, v6, 9
; GFX8-NEXT:    s_bfe_i64 s[10:11], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 6
; GFX8-NEXT:    v_readlane_b32 s3, v6, 7
; GFX8-NEXT:    s_bfe_i64 s[8:9], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 4
; GFX8-NEXT:    v_readlane_b32 s3, v6, 5
; GFX8-NEXT:    s_bfe_i64 s[6:7], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 2
; GFX8-NEXT:    v_readlane_b32 s3, v6, 3
; GFX8-NEXT:    s_bfe_i64 s[4:5], s[2:3], 0x10000
; GFX8-NEXT:    v_readlane_b32 s2, v6, 0
; GFX8-NEXT:    s_mov_b32 s83, s85
; GFX8-NEXT:    v_readlane_b32 s3, v6, 1
...
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v7, 18
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    v_readlane_b32 s3, v7, 19
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 0xa0
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v7, 16
; GFX8-NEXT:    v_mov_b32_e32 v0, s78
; GFX8-NEXT:    v_mov_b32_e32 v1, s79
; GFX8-NEXT:    v_readlane_b32 s3, v7, 17
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v7, 14
; GFX8-NEXT:    v_readlane_b32 s3, v7, 15
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 0x90
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v7, 12
; GFX8-NEXT:    v_readlane_b32 s3, v7, 13
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v7, 10
; GFX8-NEXT:    v_readlane_b32 s3, v7, 11
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 0x80
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v7, 8
; GFX8-NEXT:    v_readlane_b32 s3, v7, 9
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v7, 6
; GFX8-NEXT:    v_readlane_b32 s3, v7, 7
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 0x70
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v7, 4
; GFX8-NEXT:    v_readlane_b32 s3, v7, 5
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v7, 2
; GFX8-NEXT:    v_readlane_b32 s3, v7, 3
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 0x60
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v7, 0
; GFX8-NEXT:    v_readlane_b32 s3, v7, 1
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v6, 62
; GFX8-NEXT:    v_readlane_b32 s3, v6, 63
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 0x50
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v6, 60
; GFX8-NEXT:    v_readlane_b32 s3, v6, 61
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v6, 58
; GFX8-NEXT:    v_readlane_b32 s3, v6, 59
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 64
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v6, 56
; GFX8-NEXT:    v_readlane_b32 s3, v6, 57
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v6, 54
; GFX8-NEXT:    v_readlane_b32 s3, v6, 55
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 48
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v6, 52
; GFX8-NEXT:    v_readlane_b32 s3, v6, 53
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v6, 50
; GFX8-NEXT:    v_readlane_b32 s3, v6, 51
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 32
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v6, 48
; GFX8-NEXT:    v_readlane_b32 s3, v6, 49
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v6, 46
; GFX8-NEXT:    v_readlane_b32 s3, v6, 47
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_add_u32 s2, s0, 16
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NEXT:    v_readlane_b32 s2, v6, 42
; GFX8-NEXT:    v_readlane_b32 s3, v6, 43
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    v_mov_b32_e32 v5, s1
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_readlane_b32 s2, v6, 44
; GFX8-NEXT:    v_readlane_b32 s3, v6, 45
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
...
; GFX12-NEXT:    s_mov_b32 s47, 0
; GFX12-NEXT:    s_mov_b32 s39, s49
; GFX12-NEXT:    s_mov_b32 s59, s49
; GFX12-NEXT:    s_mov_b32 s41, 0
; GFX12-NEXT:    s_mov_b32 s31, 0
; GFX12-NEXT:    s_mov_b32 s29, 0
; GFX12-NEXT:    s_mov_b32 s23, 0
; GFX12-NEXT:    s_mov_b32 s19, 0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_load_b64 s[6:7], s[2:3], 0x0
; GFX12-NEXT:    s_mov_b32 s3, s49
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_lshr_b32 s76, s7, 30
; GFX12-NEXT:    s_lshr_b32 s82, s7, 31
; GFX12-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX12-NEXT:    s_lshr_b32 s74, s7, 28
; GFX12-NEXT:    s_lshr_b32 s68, s7, 29
; GFX12-NEXT:    s_lshr_b32 s56, s7, 27
; GFX12-NEXT:    s_lshr_b32 s48, s7, 24
; GFX12-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s76
; GFX12-NEXT:    s_lshr_b32 s62, s7, 26
; GFX12-NEXT:    v_mov_b32_e32 v2, s77
; GFX12-NEXT:    s_bfe_i64 s[76:77], s[82:83], 0x10000
; GFX12-NEXT:    s_lshr_b32 s54, s7, 25
; GFX12-NEXT:    s_bfe_i64 s[74:75], s[74:75], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[68:69], s[68:69], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX12-NEXT:    s_lshr_b32 s46, s7, 22
; GFX12-NEXT:    s_lshr_b32 s40, s7, 23
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v3, s76 :: v_dual_mov_b32 v4, s77
; GFX12-NEXT:    v_mov_b32_e32 v5, s74
; GFX12-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX12-NEXT:    s_lshr_b32 s30, s7, 20
; GFX12-NEXT:    s_lshr_b32 s28, s7, 21
; GFX12-NEXT:    s_lshr_b32 s22, s7, 18
; GFX12-NEXT:    s_lshr_b32 s18, s7, 19
; GFX12-NEXT:    s_lshr_b32 s2, s7, 17
; GFX12-NEXT:    s_lshr_b32 s4, s7, 14
; GFX12-NEXT:    s_lshr_b32 s8, s7, 15
; GFX12-NEXT:    v_dual_mov_b32 v6, s75 :: v_dual_mov_b32 v7, s68
; GFX12-NEXT:    v_dual_mov_b32 v8, s69 :: v_dual_mov_b32 v9, s62
; GFX12-NEXT:    v_dual_mov_b32 v12, s57 :: v_dual_mov_b32 v13, s48
; GFX12-NEXT:    v_mov_b32_e32 v14, s49
; GFX12-NEXT:    s_bfe_i64 s[48:49], s[54:55], 0x10000
; GFX12-NEXT:    s_lshr_b32 s10, s7, 12
; GFX12-NEXT:    s_lshr_b32 s12, s7, 13
; GFX12-NEXT:    v_dual_mov_b32 v10, s63 :: v_dual_mov_b32 v11, s56
; GFX12-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX12-NEXT:    s_lshr_b32 s38, s7, 16
; GFX12-NEXT:    s_lshr_b32 s14, s7, 10
; GFX12-NEXT:    s_lshr_b32 s16, s7, 11
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v15, s48 :: v_dual_mov_b32 v16, s49
; GFX12-NEXT:    v_mov_b32_e32 v17, s46
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
...
; GFX12-NEXT:    s_lshr_b32 s24, s7, 9
; GFX12-NEXT:    v_dual_mov_b32 v18, s47 :: v_dual_mov_b32 v19, s40
; GFX12-NEXT:    v_dual_mov_b32 v20, s41 :: v_dual_mov_b32 v21, s30
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX12-NEXT:    s_lshr_b32 s26, s7, 6
; GFX12-NEXT:    s_lshr_b32 s34, s7, 7
; GFX12-NEXT:    v_dual_mov_b32 v22, s31 :: v_dual_mov_b32 v23, s28
; GFX12-NEXT:    v_dual_mov_b32 v24, s29 :: v_dual_mov_b32 v25, s22
; GFX12-NEXT:    v_dual_mov_b32 v26, s23 :: v_dual_mov_b32 v27, s18
; GFX12-NEXT:    v_mov_b32_e32 v28, s19
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[38:39], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX12-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s8
; GFX12-NEXT:    v_dual_mov_b32 v4, s9 :: v_dual_mov_b32 v5, s10
; GFX12-NEXT:    s_lshr_b32 s36, s7, 4
; GFX12-NEXT:    s_lshr_b32 s42, s7, 5
; GFX12-NEXT:    s_lshr_b32 s44, s7, 2
; GFX12-NEXT:    s_lshr_b32 s50, s7, 3
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v6, s11 :: v_dual_mov_b32 v7, s12
; GFX12-NEXT:    v_mov_b32_e32 v8, s13
; GFX12-NEXT:    s_lshr_b32 s52, s7, 1
; GFX12-NEXT:    s_mov_b32 s58, s7
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v29, s18 :: v_dual_mov_b32 v30, s19
; GFX12-NEXT:    v_mov_b32_e32 v31, s2
; GFX12-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX12-NEXT:    s_clause 0x5
...
; GFX12-NEXT:    s_lshr_b32 s60, s6, 30
; GFX12-NEXT:    s_lshr_b32 s64, s6, 31
; GFX12-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v14, s21 :: v_dual_mov_b32 v15, s24
; GFX12-NEXT:    v_dual_mov_b32 v16, s25 :: v_dual_mov_b32 v17, s26
; GFX12-NEXT:    s_lshr_b32 s66, s6, 28
; GFX12-NEXT:    s_lshr_b32 s70, s6, 29
; GFX12-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v18, s27 :: v_dual_mov_b32 v19, s34
; GFX12-NEXT:    v_dual_mov_b32 v20, s35 :: v_dual_mov_b32 v21, s36
; GFX12-NEXT:    s_lshr_b32 s72, s6, 26
; GFX12-NEXT:    s_lshr_b32 s78, s6, 27
; GFX12-NEXT:    s_bfe_i64 s[64:65], s[64:65], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v22, s37 :: v_dual_mov_b32 v23, s42
...
; GFX12-NEXT:    v_dual_mov_b32 v1, s44 :: v_dual_mov_b32 v2, s45
; GFX12-NEXT:    v_dual_mov_b32 v3, s50 :: v_dual_mov_b32 v4, s51
; GFX12-NEXT:    v_mov_b32_e32 v5, s58
; GFX12-NEXT:    s_lshr_b32 s80, s6, 24
; GFX12-NEXT:    s_lshr_b32 s86, s6, 25
; GFX12-NEXT:    s_lshr_b32 s88, s6, 22
; GFX12-NEXT:    s_lshr_b32 s94, s6, 23
; GFX12-NEXT:    s_bfe_i64 s[70:71], s[70:71], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v6, s59 :: v_dual_mov_b32 v7, s52
; GFX12-NEXT:    v_dual_mov_b32 v8, s53 :: v_dual_mov_b32 v9, s60
; GFX12-NEXT:    s_lshr_b32 s96, s6, 20
; GFX12-NEXT:    s_lshr_b32 s100, s6, 21
; GFX12-NEXT:    s_bfe_i64 s[78:79], s[78:79], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[72:73], s[72:73], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v10, s61 :: v_dual_mov_b32 v11, s64
; GFX12-NEXT:    v_dual_mov_b32 v12, s65 :: v_dual_mov_b32 v13, s66
; GFX12-NEXT:    s_lshr_b32 s98, s6, 18
; GFX12-NEXT:    s_lshr_b32 s92, s6, 19
...
; GFX12-NEXT:    v_dual_mov_b32 v14, s67 :: v_dual_mov_b32 v15, s70
; GFX12-NEXT:    v_dual_mov_b32 v16, s71 :: v_dual_mov_b32 v17, s72
; GFX12-NEXT:    s_lshr_b32 s90, s6, 16
; GFX12-NEXT:    s_lshr_b32 s84, s6, 17
; GFX12-NEXT:    s_bfe_i64 s[100:101], s[100:101], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[96:97], s[96:97], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v18, s73 :: v_dual_mov_b32 v19, s78
; GFX12-NEXT:    v_dual_mov_b32 v20, s79 :: v_dual_mov_b32 v21, s80
; GFX12-NEXT:    s_lshr_b32 s102, s6, 14
; GFX12-NEXT:    s_lshr_b32 s76, s6, 15
; GFX12-NEXT:    s_lshr_b32 s82, s6, 8
; GFX12-NEXT:    s_lshr_b32 s54, s6, 4
; GFX12-NEXT:    s_lshr_b32 s38, s6, 1
; GFX12-NEXT:    s_bfe_i64 s[92:93], s[92:93], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[98:99], s[98:99], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v22, s81 :: v_dual_mov_b32 v23, s86
...
; GFX12-NEXT:    v_dual_mov_b32 v3, s94 :: v_dual_mov_b32 v4, s95
; GFX12-NEXT:    v_mov_b32_e32 v5, s96
; GFX12-NEXT:    s_lshr_b32 s74, s6, 12
; GFX12-NEXT:    s_lshr_b32 s68, s6, 13
; GFX12-NEXT:    s_lshr_b32 s62, s6, 10
; GFX12-NEXT:    s_lshr_b32 s56, s6, 11
; GFX12-NEXT:    s_bfe_i64 s[84:85], s[84:85], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[90:91], s[90:91], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v6, s97 :: v_dual_mov_b32 v7, s100
; GFX12-NEXT:    v_dual_mov_b32 v8, s101 :: v_dual_mov_b32 v9, s98
; GFX12-NEXT:    s_lshr_b32 s48, s6, 9
; GFX12-NEXT:    s_lshr_b32 s46, s6, 6
; GFX12-NEXT:    s_lshr_b32 s40, s6, 7
; GFX12-NEXT:    s_lshr_b32 s30, s6, 5
; GFX12-NEXT:    s_lshr_b32 s28, s6, 2
; GFX12-NEXT:    s_lshr_b32 s22, s6, 3
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[6:7], 0x10000
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[82:83], s[102:103], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v10, s99 :: v_dual_mov_b32 v11, s92
; GFX12-NEXT:    v_dual_mov_b32 v12, s93 :: v_dual_mov_b32 v13, s90
; GFX12-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[68:69], s[68:69], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[74:75], s[74:75], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v14, s91 :: v_dual_mov_b32 v15, s84
; GFX12-NEXT:    v_dual_mov_b32 v16, s85 :: v_dual_mov_b32 v17, s82
; GFX12-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v18, s83 :: v_dual_mov_b32 v19, s76
; GFX12-NEXT:    v_dual_mov_b32 v20, s77 :: v_dual_mov_b32 v21, s74
; GFX12-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v22, s75 :: v_dual_mov_b32 v23, s68
...
; GFX12-NEXT:    v_dual_mov_b32 v3, s56 :: v_dual_mov_b32 v4, s57
; GFX12-NEXT:    v_mov_b32_e32 v5, s54
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v6, s55 :: v_dual_mov_b32 v7, s48
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v8, s49 :: v_dual_mov_b32 v9, s46
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v10, s47 :: v_dual_mov_b32 v11, s40
; GFX12-NEXT:    v_dual_mov_b32 v12, s41 :: v_dual_mov_b32 v13, s38
; GFX12-NEXT:    v_dual_mov_b32 v14, s39 :: v_dual_mov_b32 v15, s30
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v16, s31 :: v_dual_mov_b32 v17, s28
; GFX12-NEXT:    v_dual_mov_b32 v18, s29 :: v_dual_mov_b32 v19, s22
; GFX12-NEXT:    v_dual_mov_b32 v20, s23 :: v_dual_mov_b32 v21, s18
; GFX12-NEXT:    v_dual_mov_b32 v22, s19 :: v_dual_mov_b32 v23, s6
...
; GFX1250-NEXT:    s_mov_b32 s47, 0
; GFX1250-NEXT:    s_mov_b32 s39, s49
; GFX1250-NEXT:    s_mov_b32 s59, s49
; GFX1250-NEXT:    s_mov_b32 s41, 0
; GFX1250-NEXT:    s_mov_b32 s31, 0
; GFX1250-NEXT:    s_mov_b32 s29, 0
; GFX1250-NEXT:    s_mov_b32 s23, 0
; GFX1250-NEXT:    s_mov_b32 s19, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_load_b64 s[6:7], s[2:3], 0x0 nv
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s3, s49
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_lshr_b32 s76, s7, 30
; GFX1250-NEXT:    s_lshr_b32 s82, s7, 31
; GFX1250-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s74, s7, 28
; GFX1250-NEXT:    s_lshr_b32 s68, s7, 29
; GFX1250-NEXT:    s_lshr_b32 s56, s7, 27
; GFX1250-NEXT:    s_lshr_b32 s48, s7, 24
; GFX1250-NEXT:    v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v0, s76
; GFX1250-NEXT:    s_lshr_b32 s62, s7, 26
; GFX1250-NEXT:    v_mov_b32_e32 v1, s77
; GFX1250-NEXT:    s_bfe_i64 s[76:77], s[82:83], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s54, s7, 25
; GFX1250-NEXT:    s_bfe_i64 s[74:75], s[74:75], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[68:69], s[68:69], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s46, s7, 22
; GFX1250-NEXT:    s_lshr_b32 s40, s7, 23
; GFX1250-NEXT:    v_dual_mov_b32 v2, s76 :: v_dual_mov_b32 v3, s77
; GFX1250-NEXT:    v_mov_b32_e32 v4, s74
; GFX1250-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s30, s7, 20
; GFX1250-NEXT:    s_lshr_b32 s28, s7, 21
; GFX1250-NEXT:    s_lshr_b32 s22, s7, 18
; GFX1250-NEXT:    s_lshr_b32 s18, s7, 19
; GFX1250-NEXT:    s_lshr_b32 s2, s7, 17
; GFX1250-NEXT:    s_lshr_b32 s4, s7, 14
; GFX1250-NEXT:    s_lshr_b32 s8, s7, 15
; GFX1250-NEXT:    v_dual_mov_b32 v5, s75 :: v_dual_mov_b32 v6, s68
; GFX1250-NEXT:    v_dual_mov_b32 v7, s69 :: v_dual_mov_b32 v8, s62
; GFX1250-NEXT:    v_dual_mov_b32 v11, s57 :: v_dual_mov_b32 v14, s48
; GFX1250-NEXT:    v_mov_b32_e32 v15, s49
; GFX1250-NEXT:    s_bfe_i64 s[48:49], s[54:55], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s10, s7, 12
; GFX1250-NEXT:    s_lshr_b32 s12, s7, 13
; GFX1250-NEXT:    v_dual_mov_b32 v9, s63 :: v_dual_mov_b32 v10, s56
; GFX1250-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s38, s7, 16
; GFX1250-NEXT:    s_lshr_b32 s14, s7, 10
; GFX1250-NEXT:    s_lshr_b32 s16, s7, 11
; GFX1250-NEXT:    v_dual_mov_b32 v16, s48 :: v_dual_mov_b32 v17, s49
; GFX1250-NEXT:    v_mov_b32_e32 v18, s46
; GFX1250-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
...
; GFX1250-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s20, s7, 8
; GFX1250-NEXT:    s_lshr_b32 s24, s7, 9
; GFX1250-NEXT:    v_dual_mov_b32 v19, s47 :: v_dual_mov_b32 v20, s40
; GFX1250-NEXT:    v_dual_mov_b32 v21, s41 :: v_dual_mov_b32 v22, s30
; GFX1250-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX1250-NEXT:    s_lshr_b32 s26, s7, 6
; GFX1250-NEXT:    s_lshr_b32 s34, s7, 7
; GFX1250-NEXT:    v_dual_mov_b32 v23, s31 :: v_dual_mov_b32 v24, s28
; GFX1250-NEXT:    v_dual_mov_b32 v25, s29 :: v_dual_mov_b32 v26, s22
; GFX1250-NEXT:    v_dual_mov_b32 v27, s23 :: v_dual_mov_b32 v28, s18
; GFX1250-NEXT:    v_mov_b32_e32 v29, s19
; GFX1250-NEXT:    s_bfe_i64 s[18:19], s[38:39], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX1250-NEXT:    s_clause 0x1
...
; GFX1250-NEXT:    v_dual_mov_b32 v1, s5 :: v_dual_mov_b32 v2, s8
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v3, s9 :: v_dual_mov_b32 v4, s10
; GFX1250-NEXT:    s_lshr_b32 s36, s7, 4
; GFX1250-NEXT:    s_lshr_b32 s42, s7, 5
; GFX1250-NEXT:    s_lshr_b32 s44, s7, 2
; GFX1250-NEXT:    s_lshr_b32 s50, s7, 3
; GFX1250-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v5, s11 :: v_dual_mov_b32 v6, s12
; GFX1250-NEXT:    v_mov_b32_e32 v7, s13
; GFX1250-NEXT:    s_lshr_b32 s52, s7, 1
; GFX1250-NEXT:    s_mov_b32 s58, s7
; GFX1250-NEXT:    v_dual_mov_b32 v30, s18 :: v_dual_mov_b32 v31, s19
...
; GFX1250-NEXT:    v_dual_mov_b32 v10, s16 :: v_dual_mov_b32 v11, s17
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_mov_b32_e32 v14, s20
; GFX1250-NEXT:    s_lshr_b32 s60, s6, 30
; GFX1250-NEXT:    s_lshr_b32 s64, s6, 31
; GFX1250-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v15, s21 :: v_dual_mov_b32 v16, s24
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v17, s25 :: v_dual_mov_b32 v18, s26
; GFX1250-NEXT:    s_lshr_b32 s66, s6, 28
; GFX1250-NEXT:    s_lshr_b32 s70, s6, 29
; GFX1250-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v19, s27 :: v_dual_mov_b32 v20, s34
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v21, s35 :: v_dual_mov_b32 v22, s36
; GFX1250-NEXT:    s_lshr_b32 s72, s6, 26
; GFX1250-NEXT:    s_lshr_b32 s78, s6, 27
; GFX1250-NEXT:    s_bfe_i64 s[64:65], s[64:65], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v23, s37 :: v_dual_mov_b32 v24, s42
...
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_mov_b32_e32 v4, s58
; GFX1250-NEXT:    s_lshr_b32 s80, s6, 24
; GFX1250-NEXT:    s_lshr_b32 s86, s6, 25
; GFX1250-NEXT:    s_lshr_b32 s88, s6, 22
; GFX1250-NEXT:    s_lshr_b32 s94, s6, 23
; GFX1250-NEXT:    s_bfe_i64 s[70:71], s[70:71], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v5, s59 :: v_dual_mov_b32 v6, s52
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v7, s53 :: v_dual_mov_b32 v8, s60
; GFX1250-NEXT:    s_lshr_b32 s96, s6, 20
; GFX1250-NEXT:    s_lshr_b32 s100, s6, 21
; GFX1250-NEXT:    s_bfe_i64 s[78:79], s[78:79], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[72:73], s[72:73], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v9, s61 :: v_dual_mov_b32 v10, s64
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v11, s65 :: v_dual_mov_b32 v14, s66
; GFX1250-NEXT:    s_lshr_b32 s98, s6, 18
; GFX1250-NEXT:    s_lshr_b32 s92, s6, 19
...
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v17, s71 :: v_dual_mov_b32 v18, s72
; GFX1250-NEXT:    s_lshr_b32 s90, s6, 16
; GFX1250-NEXT:    s_lshr_b32 s84, s6, 17
; GFX1250-NEXT:    s_bfe_i64 s[100:101], s[100:101], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[96:97], s[96:97], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v19, s73 :: v_dual_mov_b32 v20, s78
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v21, s79 :: v_dual_mov_b32 v22, s80
; GFX1250-NEXT:    s_lshr_b32 s102, s6, 14
; GFX1250-NEXT:    s_lshr_b32 s76, s6, 15
; GFX1250-NEXT:    s_lshr_b32 s82, s6, 8
; GFX1250-NEXT:    s_lshr_b32 s54, s6, 4
; GFX1250-NEXT:    s_lshr_b32 s38, s6, 1
; GFX1250-NEXT:    s_bfe_i64 s[92:93], s[92:93], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[98:99], s[98:99], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v23, s81 :: v_dual_mov_b32 v24, s86
...
; GFX1250-NEXT:    v_dual_mov_b32 v2, s94 :: v_dual_mov_b32 v3, s95
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_mov_b32_e32 v4, s96
; GFX1250-NEXT:    s_lshr_b32 s74, s6, 12
; GFX1250-NEXT:    s_lshr_b32 s68, s6, 13
; GFX1250-NEXT:    s_lshr_b32 s62, s6, 10
; GFX1250-NEXT:    s_lshr_b32 s56, s6, 11
; GFX1250-NEXT:    s_bfe_i64 s[84:85], s[84:85], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[90:91], s[90:91], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v5, s97 :: v_dual_mov_b32 v6, s100
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v7, s101 :: v_dual_mov_b32 v8, s98
; GFX1250-NEXT:    s_lshr_b32 s48, s6, 9
; GFX1250-NEXT:    s_lshr_b32 s46, s6, 6
; GFX1250-NEXT:    s_lshr_b32 s40, s6, 7
; GFX1250-NEXT:    s_lshr_b32 s30, s6, 5
; GFX1250-NEXT:    s_lshr_b32 s28, s6, 2
; GFX1250-NEXT:    s_lshr_b32 s22, s6, 3
; GFX1250-NEXT:    s_bfe_i64 s[18:19], s[6:7], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[6:7], s[38:39], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[38:39], s[54:55], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[54:55], s[82:83], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[82:83], s[102:103], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v9, s99 :: v_dual_mov_b32 v10, s92
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v11, s93 :: v_dual_mov_b32 v14, s90
; GFX1250-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[68:69], s[68:69], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[74:75], s[74:75], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v15, s91 :: v_dual_mov_b32 v16, s84
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v17, s85 :: v_dual_mov_b32 v18, s82
; GFX1250-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v19, s83 :: v_dual_mov_b32 v20, s76
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v21, s77 :: v_dual_mov_b32 v22, s74
; GFX1250-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v23, s75 :: v_dual_mov_b32 v24, s68
...
; GFX1250-NEXT:    v_dual_mov_b32 v2, s56 :: v_dual_mov_b32 v3, s57
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_mov_b32_e32 v4, s54
; GFX1250-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v5, s55 :: v_dual_mov_b32 v6, s48
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v7, s49 :: v_dual_mov_b32 v8, s46
; GFX1250-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v9, s47 :: v_dual_mov_b32 v10, s40
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v11, s41 :: v_dual_mov_b32 v14, s38
; GFX1250-NEXT:    v_dual_mov_b32 v15, s39 :: v_dual_mov_b32 v16, s30
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v17, s31 :: v_dual_mov_b32 v18, s28
; GFX1250-NEXT:    v_dual_mov_b32 v19, s29 :: v_dual_mov_b32 v20, s22
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v21, s23 :: v_dual_mov_b32 v22, s18
; GFX1250-NEXT:    v_dual_mov_b32 v23, s19 :: v_dual_mov_b32 v24, s6
; GFX1250-NEXT:    v_mov_b32_e32 v25, s7
; GFX1250-NEXT:    s_clause 0x5
