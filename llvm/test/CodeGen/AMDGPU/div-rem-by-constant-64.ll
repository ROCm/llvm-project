...
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, 3, v[3:4]
...
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v5, null, 0, v3, vcc_lo
; GFX1030-NEXT:    ; implicit-def: $vgpr4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, v2, 3, 0
; GFX1030-NEXT:    v_mad_u64_u32 v[3:4], null, v5, 3, v[3:4]
...
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v1, s6, v[2:3]
; GFX9-NEXT:    v_alignbit_b32 v2, v5, v4, 1
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v2, 3, 0
; GFX9-NEXT:    ; implicit-def: $vgpr4
...
; GFX1030-NEXT:    v_lshrrev_b32_e32 v5, 1, v4
; GFX1030-NEXT:    ; implicit-def: $vgpr4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, v2, 3, 0
; GFX1030-NEXT:    v_mad_u64_u32 v[3:4], null, v5, 3, v[3:4]
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v2
...
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v1, s6, v[2:3]
; GFX9-NEXT:    v_alignbit_b32 v2, v5, v4, 2
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v2, 6, 0
; GFX9-NEXT:    ; implicit-def: $vgpr4
; GFX9-NEXT:    v_lshrrev_b32_e32 v5, 2, v5
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, 6, v[3:4]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v3, vcc
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1030-NEXT:    v_lshrrev_b32_e32 v5, 2, v4
; GFX1030-NEXT:    ; implicit-def: $vgpr4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, v2, 6, 0
; GFX1030-NEXT:    v_mad_u64_u32 v[3:4], null, v5, 6, v[3:4]
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v2
; GFX1030-NEXT:    v_sub_co_ci_u32_e64 v1, null, v1, v3, vcc_lo
; GFX1030-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GFX9-NEXT:    ; implicit-def: $vgpr4
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, s6, v[3:4]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v3, vcc
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v5, null, 0, v5, vcc_lo
; GFX1030-NEXT:    ; implicit-def: $vgpr4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, 0x7fffffff, v2, 0
; GFX1030-NEXT:    v_mad_u64_u32 v[3:4], null, 0x7fffffff, v5, v[3:4]
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v2
; GFX1030-NEXT:    v_sub_co_ci_u32_e64 v1, null, v1, v3, vcc_lo
; GFX1030-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GFX9-NEXT:    v_alignbit_b32 v2, v5, v2, 30
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v2, s6, 0
; GFX9-NEXT:    ; implicit-def: $vgpr4
...
; GFX1030-NEXT:    v_lshrrev_b32_e32 v5, 30, v4
; GFX1030-NEXT:    ; implicit-def: $vgpr4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, 0x7fffffff, v2, 0
; GFX1030-NEXT:    v_mad_u64_u32 v[3:4], null, 0x7fffffff, v5, v[3:4]
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v2
