...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck %s -check-prefix=GFX9-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu10.30-amd-amdhsa < %s | FileCheck %s -check-prefix=GFX10-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck %s -check-prefix=GFX11-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu12.00-amd-amdhsa < %s | FileCheck %s -check-prefix=GFX12-SDAG
