...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck %s -check-prefix=GFX9-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1030 < %s | FileCheck %s -check-prefix=GFX10-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 < %s | FileCheck %s -check-prefix=GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 < %s | FileCheck %s -check-prefix=GFX12-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck %s -check-prefix=GFX9-SDAG
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1030 < %s | FileCheck %s -check-prefix=GFX10-SDAG
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 < %s | FileCheck %s -check-prefix=GFX11-SDAG
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 < %s | FileCheck %s -check-prefix=GFX12-SDAG
...
; GFX9-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v4
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX9-SDAG-NEXT:    v_cmp_ne_u32_e64 s[8:9], 1, v4
...
; GFX10-SDAG-NEXT:    v_cmp_ne_u32_e64 s5, 1, v4
...
; GFX11-SDAG-NEXT:    v_cmp_ne_u32_e64 s1, 1, v4
...
; GFX12-SDAG-NEXT:    v_cmp_ne_u32_e64 s1, 1, v4
...
; GFX10-SDAG-NEXT:    v_cmp_ne_u32_e64 s5, 1, v1
; GFX10-SDAG-NEXT:    s_xor_b32 s6, exec_lo, s5
; GFX10-SDAG-NEXT:    s_or_b32 s4, s4, s6
; GFX10-SDAG-NEXT:    s_mov_b32 exec_lo, s5
; GFX10-SDAG-NEXT:    s_mov_b32 s5, 0
...
; GFX11-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v4
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc_lo
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    v_cmp_ne_u32_e64 s1, 1, v4
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v4, v3
; GFX11-SDAG-NEXT:    s_xor_b32 s2, exec_lo, s1
; GFX11-SDAG-NEXT:    s_or_b32 s0, s0, s2
...
; GFX10-SDAG-NEXT:    v_cmp_ne_u32_e64 s4, 1, v2
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    v_cmp_ne_u32_e64 s6, 1, v2
...
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_cmp_ne_u32_e64 s6, 1, v2
...
; GFX10-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v0, v1
; GFX10-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX10-SDAG-NEXT:    v_cmp_ne_u32_e64 s4, 1, v1
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v1, v0
; GFX10-SDAG-NEXT:    s_xor_b32 s5, exec_lo, s4
; GFX10-SDAG-NEXT:    s_or_b32 s3, s3, s5
; GFX10-SDAG-NEXT:    s_mov_b32 exec_lo, s4
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    v_cmp_ne_u32_e64 s4, 1, v1
...
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_cmp_ne_u32_e64 s4, 1, v1
...
; GFX10-SDAG-NEXT:    v_cmp_ne_u32_e64 s5, 1, v3
