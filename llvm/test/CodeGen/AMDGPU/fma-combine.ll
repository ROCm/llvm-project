...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math-f32=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-NOFMA,TAHITI %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=verde -denormal-fp-math-f32=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-NOFMA,VERDE %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math-f32=ieee < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-FMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-NOFMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -denormal-fp-math-f32=ieee < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-FMA %s
...
; SI-NEXT:    buffer_store_dwordx2 v[6:7], v[0:1], s[4:7], 0 addr64
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_store_dwordx2 v[2:3], v[0:1], s[4:7], 0 addr64 offset:8
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    s_endpgm
;
...
; SI-NOFMA-NEXT:    s_mov_b32 s4, s2
; SI-NOFMA-NEXT:    s_mov_b32 s5, s3
; SI-NOFMA-NEXT:    s_mov_b32 s11, s7
; SI-NOFMA-NEXT:    buffer_load_dword v0, off, s[4:7], 0 glc
; SI-NOFMA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOFMA-NEXT:    buffer_load_dword v1, off, s[8:11], 0 glc
; SI-NOFMA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOFMA-NEXT:    s_mov_b32 s2, s6
; SI-NOFMA-NEXT:    s_mov_b32 s3, s7
; SI-NOFMA-NEXT:    v_mac_f32_e32 v1, v0, v1
; SI-NOFMA-NEXT:    buffer_store_dword v1, off, s[0:3], 0
...
; SI-FMA-NEXT:    s_mov_b32 s4, s2
; SI-FMA-NEXT:    s_mov_b32 s5, s3
; SI-FMA-NEXT:    s_mov_b32 s11, s7
; SI-FMA-NEXT:    buffer_load_dword v0, off, s[4:7], 0 glc
; SI-FMA-NEXT:    s_waitcnt vmcnt(0)
; SI-FMA-NEXT:    buffer_load_dword v1, off, s[8:11], 0 glc
; SI-FMA-NEXT:    s_waitcnt vmcnt(0)
; SI-FMA-NEXT:    s_mov_b32 s2, s6
; SI-FMA-NEXT:    s_mov_b32 s3, s7
...
; SI-NOFMA-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NOFMA-NEXT:    s_mov_b32 s12, s4
; SI-NOFMA-NEXT:    s_mov_b32 s13, s5
; SI-NOFMA-NEXT:    s_mov_b32 s4, s6
; SI-NOFMA-NEXT:    s_mov_b32 s5, s7
; SI-NOFMA-NEXT:    s_mov_b32 s6, s10
; SI-NOFMA-NEXT:    s_mov_b32 s7, s11
; SI-NOFMA-NEXT:    s_mov_b32 s8, s2
; SI-NOFMA-NEXT:    s_mov_b32 s9, s3
; SI-NOFMA-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; SI-NOFMA-NEXT:    buffer_load_dword v1, off, s[12:15], 0
; SI-NOFMA-NEXT:    buffer_load_dword v2, off, s[8:11], 0
...
; SI-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; SI-FMA-NEXT:    s_mov_b32 s12, s4
; SI-FMA-NEXT:    s_mov_b32 s13, s5
; SI-FMA-NEXT:    s_mov_b32 s4, s6
; SI-FMA-NEXT:    s_mov_b32 s5, s7
; SI-FMA-NEXT:    s_mov_b32 s6, s10
; SI-FMA-NEXT:    s_mov_b32 s7, s11
; SI-FMA-NEXT:    s_mov_b32 s8, s2
; SI-FMA-NEXT:    s_mov_b32 s9, s3
; SI-FMA-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; SI-FMA-NEXT:    buffer_load_dword v1, off, s[12:15], 0
; SI-FMA-NEXT:    buffer_load_dword v2, off, s[8:11], 0
...
; TAHITI-NEXT:    s_mov_b32 s14, -1
; TAHITI-NEXT:    s_mov_b32 s11, 0xf000
; TAHITI-NEXT:    s_mov_b32 s10, s14
; TAHITI-NEXT:    s_mov_b32 s18, s14
...
; TAHITI-NEXT:    s_mov_b32 s2, s14
; TAHITI-NEXT:    s_mov_b32 s3, s11
...
; VERDE-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; VERDE-NEXT:    s_mov_b32 s6, s10
; VERDE-NEXT:    s_mov_b32 s7, s11
; VERDE-NEXT:    buffer_load_dwordx2 v[2:3], off, s[4:7], 0
; VERDE-NEXT:    s_mov_b32 s8, s2
; VERDE-NEXT:    s_mov_b32 s9, s3
; VERDE-NEXT:    buffer_load_dwordx2 v[4:5], off, s[8:11], 0
; VERDE-NEXT:    s_mov_b32 s2, s10
; VERDE-NEXT:    s_mov_b32 s3, s11
...
; VERDE-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; VERDE-NEXT:    s_endpgm
;
; SI-FMA-LABEL: test_f64_interp:
; SI-FMA:       ; %bb.0:
; SI-FMA-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x9
; SI-FMA-NEXT:    s_mov_b32 s14, -1
; SI-FMA-NEXT:    s_mov_b32 s11, 0xf000
; SI-FMA-NEXT:    s_mov_b32 s10, s14
; SI-FMA-NEXT:    s_mov_b32 s18, s14
; SI-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; SI-FMA-NEXT:    s_mov_b32 s8, s6
; SI-FMA-NEXT:    s_mov_b32 s9, s7
; SI-FMA-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
...
; SI-FMA-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-FMA-NEXT:    s_endpgm
;
...
; SI-NEXT:    buffer_store_dwordx4 v[0:3], v[12:13], s[4:7], 0 addr64
; SI-NEXT:    s_endpgm
;
