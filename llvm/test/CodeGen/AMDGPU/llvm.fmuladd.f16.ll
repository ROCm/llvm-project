...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign < %s | FileCheck --check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=fiji -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=VI-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign < %s | FileCheck --check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=fiji -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=VI-DENORM %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1010 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX10-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1010 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX10-DENORM %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-FLUSH,GFX11-FLUSH-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-FLUSH,GFX11-FLUSH-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-DENORM,GFX11-DENORM-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-DENORM,GFX11-DENORM-FAKE16 %s
...
; VI-FLUSH-NEXT:    s_mov_b32 s12, s4
; VI-FLUSH-NEXT:    s_mov_b32 s13, s5
; VI-FLUSH-NEXT:    s_mov_b32 s4, s6
; VI-FLUSH-NEXT:    s_mov_b32 s5, s7
; VI-FLUSH-NEXT:    s_mov_b32 s6, s10
; VI-FLUSH-NEXT:    s_mov_b32 s7, s11
; VI-FLUSH-NEXT:    buffer_load_ushort v0, off, s[8:11], 0
; VI-FLUSH-NEXT:    buffer_load_ushort v1, off, s[12:15], 0
...
; VI-DENORM-NEXT:    s_mov_b32 s8, s2
; VI-DENORM-NEXT:    s_mov_b32 s9, s3
; VI-DENORM-NEXT:    s_mov_b32 s12, s4
; VI-DENORM-NEXT:    s_mov_b32 s13, s5
...
; VI-DENORM-NEXT:    buffer_load_ushort v0, off, s[8:11], 0
; VI-DENORM-NEXT:    buffer_load_ushort v1, off, s[12:15], 0
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s0, s10
; GFX10-FLUSH-NEXT:    s_mov_b32 s1, s11
; GFX10-FLUSH-NEXT:    s_mov_b32 s4, s12
; GFX10-FLUSH-NEXT:    s_mov_b32 s5, s13
; GFX10-FLUSH-NEXT:    buffer_load_ushort v0, off, s[0:3], 0
; GFX10-FLUSH-NEXT:    buffer_load_ushort v1, off, s[4:7], 0
...
; GFX10-DENORM-NEXT:    s_mov_b32 s4, s12
; GFX10-DENORM-NEXT:    s_mov_b32 s5, s13
; GFX10-DENORM-NEXT:    s_mov_b32 s0, s10
; GFX10-DENORM-NEXT:    s_mov_b32 s1, s11
; GFX10-DENORM-NEXT:    s_mov_b32 s16, s14
; GFX10-DENORM-NEXT:    s_mov_b32 s17, s15
; GFX10-DENORM-NEXT:    buffer_load_ushort v0, off, s[4:7], 0
; GFX10-DENORM-NEXT:    buffer_load_ushort v1, off, s[0:3], 0
; GFX10-DENORM-NEXT:    buffer_load_ushort v2, off, s[16:19], 0
; GFX10-DENORM-NEXT:    s_mov_b32 s10, s2
; GFX10-DENORM-NEXT:    s_mov_b32 s11, s3
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_fmac_f16_e32 v2, v1, v0
...
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s8, s2
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s12, s4
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s13, s5
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[8:11], 0
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[12:15], 0
...
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s2, s10
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[4:7], 0
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s3, s11
...
; GFX11-FLUSH-TRUE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s8, s2
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s12, s4
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s13, s5
; GFX11-FLUSH-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], 0
; GFX11-FLUSH-FAKE16-NEXT:    buffer_load_u16 v1, off, s[12:15], 0
...
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s2, s10
; GFX11-FLUSH-FAKE16-NEXT:    buffer_load_u16 v2, off, s[4:7], 0
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s3, s11
...
; GFX11-FLUSH-FAKE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s12, s4
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s13, s5
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s8, s2
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s16, s6
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s17, s7
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[12:15], 0
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[8:11], 0
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[16:19], 0
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s2, s10
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s3, s11
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-TRUE16-NEXT:    v_fmac_f16_e32 v1.l, v0.h, v0.l
; GFX11-DENORM-TRUE16-NEXT:    buffer_store_b16 v1, off, s[0:3], 0
...
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s12, s4
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s13, s5
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s8, s2
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s16, s6
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s17, s7
; GFX11-DENORM-FAKE16-NEXT:    buffer_load_u16 v0, off, s[12:15], 0
; GFX11-DENORM-FAKE16-NEXT:    buffer_load_u16 v1, off, s[8:11], 0
; GFX11-DENORM-FAKE16-NEXT:    buffer_load_u16 v2, off, s[16:19], 0
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s2, s10
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s3, s11
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_fmac_f16_e32 v2, v1, v0
; GFX11-DENORM-FAKE16-NEXT:    buffer_store_b16 v2, off, s[0:3], 0
...
; VI-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
; VI-FLUSH-NEXT:    s_mov_b32 s4, s2
; VI-FLUSH-NEXT:    s_mov_b32 s5, s3
; VI-FLUSH-NEXT:    s_mov_b32 s11, s7
; VI-FLUSH-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 glc
; VI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; VI-FLUSH-NEXT:    buffer_load_ushort v1, off, s[8:11], 0 glc
; VI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; VI-FLUSH-NEXT:    s_mov_b32 s2, s6
; VI-FLUSH-NEXT:    s_mov_b32 s3, s7
...
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; VI-DENORM-NEXT:    s_mov_b32 s4, s2
; VI-DENORM-NEXT:    s_mov_b32 s5, s3
; VI-DENORM-NEXT:    s_mov_b32 s11, s7
; VI-DENORM-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 glc
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    buffer_load_ushort v1, off, s[8:11], 0 glc
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    s_movk_i32 s4, 0x4200
; VI-DENORM-NEXT:    s_mov_b32 s2, s6
; VI-DENORM-NEXT:    s_mov_b32 s3, s7
...
; GFX10-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-FLUSH-NEXT:    s_mov_b32 s4, s2
; GFX10-FLUSH-NEXT:    s_mov_b32 s5, s3
; GFX10-FLUSH-NEXT:    s_mov_b32 s2, s6
; GFX10-FLUSH-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 glc dlc
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FLUSH-NEXT:    buffer_load_ushort v1, off, s[8:11], 0 glc dlc
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FLUSH-NEXT:    s_mov_b32 s3, s7
...
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DENORM-NEXT:    s_mov_b32 s4, s2
; GFX10-DENORM-NEXT:    s_mov_b32 s5, s3
; GFX10-DENORM-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    buffer_load_ushort v1, off, s[8:11], 0 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    s_mov_b32 s2, s6
; GFX10-DENORM-NEXT:    s_mov_b32 s3, s7
...
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s2, s10
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[8:11], 0 glc dlc
; GFX11-FLUSH-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s2, s10
; GFX11-FLUSH-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], 0 glc dlc
; GFX11-FLUSH-FAKE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s8, s2
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[8:11], 0 glc dlc
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-DENORM-TRUE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s8, s2
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX11-DENORM-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], 0 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-DENORM-FAKE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
    ptr addrspace(1) %r,
    ptr addrspace(1) %b,
    ptr addrspace(1) %c) {
...
; VI-FLUSH-NEXT:    buffer_load_dword v2, off, s[8:11], 0
...
; VI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; VI-FLUSH-NEXT:    v_mac_f16_sdwa v3, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-FLUSH-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; VI-FLUSH-NEXT:    v_mac_f16_e32 v1, v2, v0
...
; VI-DENORM-NEXT:    s_mov_b32 s6, s10
; VI-DENORM-NEXT:    s_mov_b32 s7, s11
; VI-DENORM-NEXT:    buffer_load_dword v0, off, s[12:15], 0
; VI-DENORM-NEXT:    buffer_load_dword v1, off, s[4:7], 0
; VI-DENORM-NEXT:    buffer_load_dword v2, off, s[8:11], 0
...
; VI-DENORM-NEXT:    v_fma_f16 v3, v5, v3, v4
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s4, s12
; GFX10-FLUSH-NEXT:    s_mov_b32 s5, s13
; GFX10-FLUSH-NEXT:    buffer_load_dword v0, off, s[0:3], 0
; GFX10-FLUSH-NEXT:    buffer_load_dword v1, off, s[4:7], 0
; GFX10-FLUSH-NEXT:    s_mov_b32 s12, s14
; GFX10-FLUSH-NEXT:    s_mov_b32 s13, s15
; GFX10-FLUSH-NEXT:    s_mov_b32 s14, s2
; GFX10-FLUSH-NEXT:    s_mov_b32 s15, s3
...
; GFX10-DENORM-NEXT:    buffer_load_dword v1, off, s[0:3], 0
; GFX10-DENORM-NEXT:    buffer_load_dword v2, off, s[16:19], 0
; GFX10-DENORM-NEXT:    s_mov_b32 s10, s2
; GFX10-DENORM-NEXT:    s_mov_b32 s11, s3
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_pk_fma_f16 v0, v1, v0, v2
...
; GFX11-FLUSH-NEXT:    s_mov_b32 s8, s2
; GFX11-FLUSH-NEXT:    s_mov_b32 s9, s3
; GFX11-FLUSH-NEXT:    s_mov_b32 s12, s4
; GFX11-FLUSH-NEXT:    s_mov_b32 s13, s5
; GFX11-FLUSH-NEXT:    buffer_load_b32 v0, off, s[8:11], 0
; GFX11-FLUSH-NEXT:    buffer_load_b32 v1, off, s[12:15], 0
...
; GFX11-DENORM-NEXT:    s_mov_b32 s12, s4
; GFX11-DENORM-NEXT:    s_mov_b32 s13, s5
; GFX11-DENORM-NEXT:    s_mov_b32 s8, s2
; GFX11-DENORM-NEXT:    s_mov_b32 s9, s3
; GFX11-DENORM-NEXT:    s_mov_b32 s16, s6
; GFX11-DENORM-NEXT:    s_mov_b32 s17, s7
; GFX11-DENORM-NEXT:    buffer_load_b32 v0, off, s[12:15], 0
; GFX11-DENORM-NEXT:    buffer_load_b32 v1, off, s[8:11], 0
; GFX11-DENORM-NEXT:    buffer_load_b32 v2, off, s[16:19], 0
; GFX11-DENORM-NEXT:    s_mov_b32 s2, s10
; GFX11-DENORM-NEXT:    s_mov_b32 s3, s11
; GFX11-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-NEXT:    v_pk_fma_f16 v0, v1, v0, v2
