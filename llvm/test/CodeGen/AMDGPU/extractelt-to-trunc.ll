...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=gfx600 | FileCheck %s -check-prefix=GCN
...
; GCN-NEXT:    s_mov_b32 s3, s7
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_add_f64 v[0:1], v[0:1], s[8:9]
; GCN-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GCN-NEXT:    s_endpgm
   %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GCN-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 glc
; GCN-NEXT:    s_waitcnt vmcnt(0)
