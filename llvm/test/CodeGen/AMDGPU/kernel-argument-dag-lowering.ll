...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdhsa -mcpu=gfx900 -amdgpu-ir-lower-kernel-arguments=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN %s
...
; GCN-NEXT:    s_and_b32 s6, s2, 0x3fff8000
; GCN-NEXT:    s_lshl_b64 s[2:3], s[4:5], 30
; GCN-NEXT:    s_and_b32 s4, s3, 0x1fff
; GCN-NEXT:    v_mov_b32_e32 v1, s4
; GCN-NEXT:    s_or_b32 s4, s5, s6
