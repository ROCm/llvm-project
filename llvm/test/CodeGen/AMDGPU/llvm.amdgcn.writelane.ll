...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdhsa -mcpu=gfx802 < %s | FileCheck -check-prefixes=GFX802-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdhsa -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GFX1010-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdhsa -mcpu=gfx1100 -amdgpu-enable-vopd=0 < %s | FileCheck -check-prefixes=GFX1100-SDAG %s

; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn--amdhsa -mcpu=gfx802 -global-isel -new-reg-bank-select -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX802-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn--amdhsa -mcpu=gfx1010 -global-isel -new-reg-bank-select -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX1010-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn--amdhsa -mcpu=gfx1100 -amdgpu-enable-vopd=0 -global-isel -new-reg-bank-select -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX1100-GISEL %s
...
; GFX802-SDAG-NEXT:    s_load_dword s4, s[0:1], 0x0
...
; GFX802-SDAG-NEXT:    s_add_i32 s12, s12, s17
; GFX802-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GFX802-SDAG-NEXT:    v_mov_b32_e32 v2, 42
; GFX802-SDAG-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX802-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX802-SDAG-NEXT:    s_mov_b32 m0, s4
...
; GFX802-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GFX802-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; GFX802-SDAG-NEXT:    v_writelane_b32 v3, s3, m0
; GFX802-SDAG-NEXT:    v_writelane_b32 v2, s2, m0
; GFX802-SDAG-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; GFX802-SDAG-NEXT:    s_endpgm
;
...
; GFX802-SDAG-NEXT:    s_load_dword s4, s[8:9], 0x10
; GFX802-SDAG-NEXT:    s_add_i32 s12, s12, s17
; GFX802-SDAG-NEXT:    v_mov_b32_e32 v3, 0x40450000
; GFX802-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GFX802-SDAG-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX802-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX802-SDAG-NEXT:    s_mov_b32 m0, s4
; GFX802-SDAG-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
