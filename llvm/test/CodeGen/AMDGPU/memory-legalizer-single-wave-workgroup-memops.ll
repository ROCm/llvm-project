...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx942 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX942
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX10,GFX10-W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize64 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX10,GFX10-W64
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX12,GFX12-W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX12,GFX12-W64
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -stop-after=si-memory-legalizer < %s -o - | FileCheck %s --check-prefixes=GFX1250
...
define amdgpu_kernel void @wg_ld_seq_cst_single32(ptr addrspace(1) %p) #0 {
  ...
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX9-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX12-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_ld_seq_cst_single64(ptr addrspace(1) %p) #1 {
  ...
  ; GFX10-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Vmcnt_0_Lgkmcnt_0
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ...
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W64-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W32-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 8, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W64-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_ld_seq_cst_multi(ptr addrspace(1) %p) #2 {
  ...
  ; GFX942-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX942-NEXT:   S_WAITCNT_lds_direct
  ; GFX942-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ...
  ; GFX12-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 8, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 1)
  ; GFX12-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_ld_acquire_single64(ptr addrspace(1) %p) #1 {
  ...
  ; GFX9-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX9-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX942-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX942-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX10-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W32-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Vmcnt_0
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W64-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX12-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W32-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 8, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W64-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 32 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX1250-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX1250-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_ld_monotonic_single64(ptr addrspace(1) %p) #1 {
  ...
  ; GFX9-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX9-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") monotonic (s32) from %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX942-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX942-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") monotonic (s32) from %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX10-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") monotonic (s32) from %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX12-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 8, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") monotonic (s32) from %ir.p.load, addrspace 1)
  ; GFX12-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 32 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX1250-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX1250-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") monotonic (s32) from %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_st_seq_cst_single32(ptr addrspace(1) %p, i32 %x) #0 {
  ...
  ; GFX9-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx12 0, killed $sgpr2, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-W32-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx1250 0, killed $sgpr2, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_st_seq_cst_single64(ptr addrspace(1) %p, i32 %x) #1 {
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_st_seq_cst_multi(ptr addrspace(1) %p, i32 %x) #2 {
  ...
  ; GFX942-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX942-NEXT:   S_WAITCNT_lds_direct
  ; GFX942-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 1, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_st_release_single64(ptr addrspace(1) %p, i32 %x) #1 {
  ...
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX9-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX9-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX942-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX942-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_rmw_add_seq_cst_single32(ptr addrspace(1) %p) #0 {
  ...
  ; GFX9: bb.0 (%ir-block.0):
  ; GFX9-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX9-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX9-NEXT: {{  $}}
  ; GFX9-NEXT:   $sgpr0_sgpr1 = S_MOV_B64 $exec
  ; GFX9-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ; GFX9-NEXT:   $vgpr0 = V_MBCNT_HI_U32_B32_e64 $sgpr1, killed $vgpr0, implicit $exec
  ...
  ; GFX9-NEXT:   dead renamable $sgpr2_sgpr3 = S_AND_SAVEEXEC_B64 killed renamable $sgpr2_sgpr3, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX9-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX9-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX9-NEXT: {{  $}}
  ; GFX9-NEXT: bb.2 (%ir-block.13):
  ; GFX9-NEXT:   S_ENDPGM 0
  ; GFX9-NEXT: {{  $}}
  ; GFX9-NEXT: bb.1 (%ir-block.8):
  ...
  ; GFX9-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ; GFX942-LABEL: name: wg_rmw_add_seq_cst_single32
  ; GFX942: bb.0 (%ir-block.0):
  ; GFX942-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX942-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX942-NEXT: {{  $}}
  ; GFX942-NEXT:   $sgpr0_sgpr1 = S_MOV_B64 $exec
  ; GFX942-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ; GFX942-NEXT:   $vgpr0 = V_MBCNT_HI_U32_B32_e64 $sgpr1, killed $vgpr0, implicit $exec
  ...
  ; GFX942-NEXT:   dead renamable $sgpr2_sgpr3 = S_AND_SAVEEXEC_B64 killed renamable $sgpr2_sgpr3, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX942-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX942-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX942-NEXT: {{  $}}
  ; GFX942-NEXT: bb.2 (%ir-block.13):
  ; GFX942-NEXT:   S_ENDPGM 0
  ; GFX942-NEXT: {{  $}}
  ; GFX942-NEXT: bb.1 (%ir-block.8):
  ...
  ; GFX942-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-W32-LABEL: name: wg_rmw_add_seq_cst_single32
  ; GFX10-W32: bb.0 (%ir-block.0):
  ; GFX10-W32-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX10-W32-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-W32-NEXT: {{  $}}
  ; GFX10-W32-NEXT:   $sgpr0 = S_MOV_B32 $exec_lo
  ; GFX10-W32-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ...
  ; GFX10-W32-NEXT:   dead renamable $sgpr1 = S_AND_SAVEEXEC_B32 killed renamable $sgpr1, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX10-W32-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX10-W32-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX10-W32-NEXT: {{  $}}
  ; GFX10-W32-NEXT: bb.2 (%ir-block.8):
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ; GFX10-W32-NEXT: {{  $}}
  ; GFX10-W32-NEXT: bb.1 (%ir-block.4):
  ...
  ; GFX10-W32-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-W64-LABEL: name: wg_rmw_add_seq_cst_single32
  ; GFX10-W64: bb.0 (%ir-block.0):
  ; GFX10-W64-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX10-W64-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT:   $sgpr0_sgpr1 = S_MOV_B64 $exec
  ; GFX10-W64-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr0 = V_MBCNT_HI_U32_B32_e64 $sgpr1, killed $vgpr0, implicit $exec
  ...
  ; GFX10-W64-NEXT:   dead renamable $sgpr2_sgpr3 = S_AND_SAVEEXEC_B64 killed renamable $sgpr2_sgpr3, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX10-W64-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX10-W64-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT: bb.2 (%ir-block.13):
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT: bb.1 (%ir-block.8):
  ...
  ; GFX10-W64-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-W32-LABEL: name: wg_rmw_add_seq_cst_single32
  ; GFX12-W32: bb.0 (%ir-block.0):
  ; GFX12-W32-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX12-W32-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX12-W32-NEXT: {{  $}}
  ; GFX12-W32-NEXT:   $sgpr0 = S_MOV_B32 $exec_lo
  ; GFX12-W32-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ...
  ; GFX12-W32-NEXT:   dead renamable $sgpr1 = S_AND_SAVEEXEC_B32 killed renamable $sgpr1, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX12-W32-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX12-W32-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX12-W32-NEXT: {{  $}}
  ; GFX12-W32-NEXT: bb.2 (%ir-block.8):
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ; GFX12-W32-NEXT: {{  $}}
  ; GFX12-W32-NEXT: bb.1 (%ir-block.4):
  ...
  ; GFX12-W32-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx12 0, killed $sgpr0, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-W32-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-W64-LABEL: name: wg_rmw_add_seq_cst_single32
  ; GFX12-W64: bb.0 (%ir-block.0):
  ; GFX12-W64-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX12-W64-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT:   $sgpr0_sgpr1 = S_MOV_B64 $exec
  ; GFX12-W64-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr0 = V_MBCNT_HI_U32_B32_e64 $sgpr1, killed $vgpr0, implicit $exec
  ...
  ; GFX12-W64-NEXT:   dead renamable $sgpr2_sgpr3 = S_AND_SAVEEXEC_B64 killed renamable $sgpr2_sgpr3, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX12-W64-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX12-W64-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT: bb.2 (%ir-block.13):
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT: bb.1 (%ir-block.8):
  ...
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ; GFX1250-LABEL: name: wg_rmw_add_seq_cst_single32
  ; GFX1250: bb.0 (%ir-block.0):
  ; GFX1250-NEXT:   successors: %bb.1(0x30000000), %bb.2(0x50000000)
  ; GFX1250-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX1250-NEXT: {{  $}}
  ; GFX1250-NEXT:   S_SETREG_IMM32_B32 1, 1601, implicit-def $mode, implicit $mode
  ; GFX1250-NEXT:   $sgpr0 = S_MOV_B32 $exec_lo
  ; GFX1250-NEXT:   $vgpr0 = V_MBCNT_LO_U32_B32_e64 $sgpr0, 0, implicit $exec
  ...
  ; GFX1250-NEXT:   dead renamable $sgpr1 = S_AND_SAVEEXEC_B32 killed renamable $sgpr1, implicit-def $exec, implicit-def $scc, implicit $exec
  ; GFX1250-NEXT:   SI_WAVE_CF_EDGE implicit-def $scc
  ; GFX1250-NEXT:   S_CBRANCH_EXECNZ %bb.1, implicit $exec
  ; GFX1250-NEXT: {{  $}}
  ; GFX1250-NEXT: bb.2 (%ir-block.8):
  ; GFX1250-NEXT:   S_ENDPGM 0
  ; GFX1250-NEXT: {{  $}}
  ; GFX1250-NEXT: bb.1 (%ir-block.4):
  ...
  ; GFX1250-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx1250 0, killed $sgpr0, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_rmw_add_seq_cst_single64(ptr addrspace(1) %p) #1 {
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 8, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_rmw_add_seq_cst_multi(ptr addrspace(1) %p) #2 {
  ...
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_ADD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr2_sgpr3, 0, 8, implicit $exec :: (load store syncscope("workgroup") seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
...
define amdgpu_kernel void @wg_rmw_xchg_acq_rel_single64(ptr addrspace(1) %p, i32 %x) #1 {
  ...
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX9-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX9-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX942-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX942-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_cmpxchg_acq_rel_monotonic_single64(ptr addrspace(1) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX9-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX9-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr0, killed $vgpr2_vgpr3, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   $vgpr2 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX10-W32-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Vmcnt_0_Lgkmcnt_0
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   $vgpr2 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   $vgpr2, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx12 0, killed $sgpr2, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr2 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   $vgpr2, $vgpr0 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_e96_gfx1250 0, killed $sgpr3, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_cmpxchg_seq_cst_seq_cst_multi(ptr addrspace(1) %p, i32 %cmp, i32 %new) #2 {
  ...
  ; GFX9-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX9-NEXT:   S_WAITCNT_lds_direct
  ; GFX9-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX942-NEXT:   S_WAITCNT_lds_direct
  ; GFX942-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr0, killed $vgpr2_vgpr3, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   $vgpr2 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX10-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-NEXT:   S_WAITCNT_soft .Vmcnt_0_Lgkmcnt_0
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") seq_cst seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") seq_cst seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") seq_cst seq_cst (s32) on %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @wg_cmpxchg_acquire_acquire_single64(ptr addrspace(1) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX9-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX9-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX942-NEXT:   $vgpr3 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX942-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr0, killed $vgpr2_vgpr3, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX10-W32-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W32-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   $vgpr2, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx12 0, killed $sgpr2, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-W32-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX12-W32-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @lds_wg_ld_seq_cst_single32(ptr addrspace(3) %p) #0 {
  ...
  ; GFX9-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX12-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @lds_wg_ld_seq_cst_single64(ptr addrspace(3) %p) #1 {
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ...
  ; GFX10-W64-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   dead $vgpr0 = DS_READ_B32_gfx9 killed $vgpr0, 0, 0, implicit $exec :: (load syncscope("workgroup") seq_cst (s32) from %ir.p.load, addrspace 3)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @lds_wg_st_release_single64(ptr addrspace(3) %p, i32 %x) #1 {
  ...
  ; GFX9-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @lds_wg_rmw_add_acq_rel_single64(ptr addrspace(3) %p) #1 {
  ...
  ; GFX9-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ...
  ; GFX10-W64-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   DS_ADD_U32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 3)
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @lds_wg_cmpxchg_acq_rel_monotonic_single64(ptr addrspace(3) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX9-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-W32-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX10-W32-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ...
  ; GFX10-W64-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   DS_CMPSTORE_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   DS_CMPSTORE_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   DS_CMPSTORE_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @lds_wg_cmpxchg_monotonic_acquire_single64(ptr addrspace(3) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX9-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX9-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX9-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX942-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX942-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX10-W32-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W32-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx12 killed $sgpr0, killed $sgpr2, implicit $exec, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-W32-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX12-W32-NEXT:   DS_CMPSTORE_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   DS_CMPSTORE_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx1250 killed $sgpr0, killed $sgpr2, implicit $exec, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX1250-NEXT:   DS_CMPSTORE_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @flat_wg_ld_acquire_single64(ptr addrspace(0) %p) #1 {
  ...
  ; GFX9-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 0, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 0, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W32-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 1, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX10-W32-NEXT:   S_WAITCNT_soft .Vmcnt_0_Lgkmcnt_0
  ; GFX10-W32-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 0, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 8, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX12-W32-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ...
  ; GFX12-W64-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 0, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 32 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX1250-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX1250-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 0, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX1250-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @flat_wg_st_seq_cst_multi(ptr addrspace(0) %p, i32 %x) #2 {
  ...
  ; GFX9-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX9-NEXT:   S_WAITCNT_lds_direct
  ; GFX9-NEXT:   FLAT_STORE_DWORD killed $vgpr0_vgpr1, killed $vgpr2, 0, 0, implicit $exec, implicit $flat_scr :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load)
  ; GFX9-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX942-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX942-NEXT:   S_WAITCNT_lds_direct
  ; GFX942-NEXT:   FLAT_STORE_DWORD killed $vgpr0_vgpr1, killed $vgpr2, 0, 1, implicit $exec, implicit $flat_scr :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   FLAT_STORE_DWORD killed $vgpr0_vgpr1, killed $vgpr2, 0, 0, implicit $exec, implicit $flat_scr :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W32-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W32-NEXT:   FLAT_STORE_DWORD killed $vgpr0_vgpr1, killed $vgpr2, 0, 8, implicit $exec, implicit $flat_scr :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load)
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   FLAT_STORE_DWORD killed $vgpr0_vgpr1, killed $vgpr2, 0, 8, implicit $exec, implicit $flat_scr :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX1250-NEXT:   S_WAIT_XCNT_soft 0
  ; GFX1250-NEXT:   FLAT_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec, implicit $flat_scr :: (store syncscope("workgroup") seq_cst (s32) into %ir.p.load)
  ; GFX1250-NEXT:   S_ENDPGM 0
