...
define amdgpu_kernel void @wg_rmw_add_seq_cst_single32(ptr addrspace(1) %p) #0 {
  ...
  ; GFX9-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX9-NEXT: {{  $}}
  ; GFX9-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX9-NEXT:   renamable $vgpr0 = V_MBCNT_HI_U32_B32_e64 $exec_hi, killed $vgpr0, implicit $exec
  ; GFX9-NEXT:   renamable $sgpr0_sgpr1 = S_MOV_B64 $exec
  ...
  ; GFX9-NEXT: {{  $}}
  ; GFX9-NEXT: bb.1 (%ir-block.12):
  ; GFX9-NEXT:   successors: %bb.2(0x80000000)
  ; GFX9-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX9-NEXT: {{  $}}
  ...
  ; GFX942-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX942-NEXT: {{  $}}
  ; GFX942-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX942-NEXT:   renamable $vgpr0 = V_MBCNT_HI_U32_B32_e64 $exec_hi, killed $vgpr0, implicit $exec
  ; GFX942-NEXT:   renamable $sgpr0_sgpr1 = S_MOV_B64 $exec
  ...
  ; GFX942-NEXT: {{  $}}
  ; GFX942-NEXT: bb.1 (%ir-block.12):
  ; GFX942-NEXT:   successors: %bb.2(0x80000000)
  ; GFX942-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX942-NEXT: {{  $}}
  ...
  ; GFX10-W32-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-W32-NEXT: {{  $}}
  ; GFX10-W32-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX10-W32-NEXT:   renamable $sgpr0 = S_MOV_B32 $exec_lo
  ...
  ; GFX10-W32-NEXT: {{  $}}
  ; GFX10-W32-NEXT: bb.1 (%ir-block.8):
  ...
  ; GFX10-W32-NEXT: {{  $}}
  ; GFX10-W32-NEXT: bb.2 (%ir-block.10):
  ; GFX10-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-W64-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX10-W64-NEXT:   renamable $sgpr0_sgpr1 = S_MOV_B64 $exec
  ; GFX10-W64-NEXT:   renamable $sgpr0 = S_BCNT1_I32_B64 killed renamable $sgpr0_sgpr1, implicit-def dead $scc
  ; GFX10-W64-NEXT:   renamable $vgpr0 = V_MBCNT_HI_U32_B32_e64 $exec_hi, killed $vgpr0, implicit $exec
  ...
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT: bb.1 (%ir-block.12):
  ; GFX10-W64-NEXT:   successors: %bb.2(0x80000000)
  ; GFX10-W64-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX10-W64-NEXT: {{  $}}
  ...
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT: bb.2 (%ir-block.14):
  ; GFX10-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W32-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX12-W32-NEXT: {{  $}}
  ; GFX12-W32-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX12-W32-NEXT:   renamable $sgpr0 = S_MOV_B32 $exec_lo
  ...
  ; GFX12-W32-NEXT: {{  $}}
  ; GFX12-W32-NEXT: bb.1 (%ir-block.8):
  ...
  ; GFX12-W32-NEXT: {{  $}}
  ; GFX12-W32-NEXT: bb.2 (%ir-block.10):
  ; GFX12-W32-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX12-W64-NEXT:   renamable $sgpr0_sgpr1 = S_MOV_B64 $exec
  ...
  ; GFX12-W64-NEXT:   renamable $vgpr0 = V_MBCNT_HI_U32_B32_e64 $exec_hi, killed $vgpr0, implicit $exec
  ...
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT: bb.1 (%ir-block.12):
  ; GFX12-W64-NEXT:   successors: %bb.2(0x80000000)
  ; GFX12-W64-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX12-W64-NEXT: {{  $}}
  ...
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT: bb.2 (%ir-block.14):
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX1250-NEXT: {{  $}}
  ; GFX1250-NEXT:   S_SETREG_IMM32_B32 1, 1601, implicit-def $mode, implicit $mode
  ; GFX1250-NEXT:   renamable $vgpr0 = V_MBCNT_LO_U32_B32_e64 $exec_lo, 0, implicit $exec
  ; GFX1250-NEXT:   renamable $sgpr0 = S_MOV_B32 $exec_lo
...
define amdgpu_kernel void @lds_wg_rmw_add_acq_rel_single64(ptr addrspace(3) %p) #1 {
  ...
  ; GFX9-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX9-NEXT: {{  $}}
  ; GFX9-NEXT:   renamable $sgpr1 = S_LOAD_DWORD_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s32) from %ir.p.kernarg.offset, addrspace 4)
  ; GFX9-NEXT:   renamable $sgpr0 = S_MUL_I32 killed renamable $sgpr0, 3
  ; GFX9-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX9-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ...
  ; GFX942-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX942-NEXT: {{  $}}
  ; GFX942-NEXT:   renamable $sgpr1 = S_LOAD_DWORD_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s32) from %ir.p.kernarg.offset, addrspace 4)
  ; GFX942-NEXT:   renamable $sgpr0 = S_MUL_I32 killed renamable $sgpr0, 3
  ; GFX942-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX942-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ...
  ; GFX10-W64-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX10-W64-NEXT: {{  $}}
  ; GFX10-W64-NEXT:   renamable $sgpr1 = S_LOAD_DWORD_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s32) from %ir.p.kernarg.offset, addrspace 4)
  ; GFX10-W64-NEXT:   renamable $sgpr0 = S_MUL_I32 killed renamable $sgpr0, 3
  ; GFX10-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX10-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ...
  ; GFX12-W64-NEXT:   liveins: $sgpr0, $sgpr4_sgpr5
  ; GFX12-W64-NEXT: {{  $}}
  ; GFX12-W64-NEXT:   renamable $sgpr1 = S_LOAD_DWORD_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s32) from %ir.p.kernarg.offset, addrspace 4)
  ; GFX12-W64-NEXT:   renamable $sgpr0 = S_MUL_I32 killed renamable $sgpr0, 3
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
