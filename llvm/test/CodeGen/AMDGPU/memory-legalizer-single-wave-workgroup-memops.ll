...
define amdgpu_kernel void @wg_ld_acquire_single64(ptr addrspace(1) %p) #1 {
  ...
  ; GFX942-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX942-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX942-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX10-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX10-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 1, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_WAITCNT_soft .Vmcnt_0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64) from %ir.p.kernarg.offset, align 4, addrspace 4)
  ; GFX12-NEXT:   $vgpr0 = V_MOV_B32_e32 0, implicit $exec
  ; GFX12-NEXT:   dead $vgpr0 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr0_sgpr1, killed $vgpr0, 0, 8, implicit $exec :: ("amdgpu-noclobber" load syncscope("workgroup") acquire (s32) from %ir.p.load, addrspace 1)
  ; GFX12-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_st_release_single64(ptr addrspace(1) %p, i32 %x) #1 {
  ...
  ; GFX942-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX942-NEXT:   S_WAITCNT_lds_direct
  ; GFX942-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 1, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_STORE_DWORD_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_rmw_xchg_acq_rel_single64(ptr addrspace(1) %p, i32 %x) #1 {
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_SWAP_SADDR killed $vgpr0, killed $vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") acq_rel (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_cmpxchg_acq_rel_monotonic_single64(ptr addrspace(1) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @wg_cmpxchg_acquire_acquire_single64(ptr addrspace(1) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX10-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX10-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr3, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX12-W64-NEXT:   GLOBAL_ATOMIC_CMPSWAP_SADDR killed $vgpr2, killed $vgpr0_vgpr1, killed renamable $sgpr0_sgpr1, 0, 8, implicit $exec :: (load store syncscope("workgroup") acquire acquire (s32) on %ir.p.load, addrspace 1)
  ; GFX12-W64-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W64-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @lds_wg_st_release_single64(ptr addrspace(3) %p, i32 %x) #1 {
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   DS_WRITE_B32_gfx9 killed $vgpr0, killed $vgpr1, 0, 0, implicit $exec :: (store syncscope("workgroup") release (s32) into %ir.2, addrspace 3)
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @lds_wg_cmpxchg_acq_rel_monotonic_single64(ptr addrspace(3) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") acq_rel monotonic (s32) on %ir.2, addrspace 3)
  ; GFX10-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX10-NEXT:   S_WAITCNT_lds_direct
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @lds_wg_cmpxchg_monotonic_acquire_single64(ptr addrspace(3) %p, i32 %cmp, i32 %new) #1 {
  ...
  ; GFX10-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX10-NEXT:   $vgpr2 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX10-NEXT:   DS_CMPST_B32_gfx9 killed $vgpr0, killed $vgpr1, killed $vgpr2, 0, 0, implicit $exec :: (load store syncscope("workgroup") monotonic acquire (s32) on %ir.2, addrspace 3)
  ; GFX10-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_kernel void @flat_wg_ld_acquire_single64(ptr addrspace(0) %p) #1 {
  ...
  ; GFX942-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 1, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX942-NEXT:   S_WAITCNT_soft .Lgkmcnt_0
  ; GFX942-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX10-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 1, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX10-NEXT:   S_WAITCNT_soft .Vmcnt_0_Lgkmcnt_0
  ; GFX10-NEXT:   BUFFER_GL0_INV implicit $exec
  ; GFX10-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-W64-NEXT:   dead $vgpr0 = FLAT_LOAD_DWORD killed $vgpr0_vgpr1, 0, 8, implicit $exec, implicit $flat_scr :: (load syncscope("workgroup") acquire (s32) from %ir.p.load)
  ; GFX12-W64-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-W64-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-W64-NEXT:   GLOBAL_INV 8, implicit $exec
  ; GFX12-W64-NEXT:   S_ENDPGM 0
