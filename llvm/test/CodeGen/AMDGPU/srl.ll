...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu6.01 < %s | FileCheck %s -check-prefixes=SI
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck %s -check-prefixes=VI
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_lshr_b32 s0, s9, s11
; VI-NEXT:    s_lshr_b32 s1, s8, s10
...
; VI-NEXT:    s_mov_b32 s5, s1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_lshr_b64 s[0:1], s[8:9], s10
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; VI-NEXT:    s_endpgm
...
; SI-NEXT:    s_mov_b32 s4, s2
; SI-NEXT:    s_mov_b32 s5, s3
; SI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:48
; SI-NEXT:    buffer_load_dwordx4 v[3:6], off, s[4:7], 0 offset:16
; SI-NEXT:    buffer_load_dwordx4 v[7:10], off, s[4:7], 0
; SI-NEXT:    buffer_load_dwordx4 v[11:14], off, s[4:7], 0 offset:32
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
...
; VI-NEXT:    s_mov_b32 s23, 0xf000
; VI-NEXT:    s_mov_b32 s22, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
; VI-NEXT:    s_mov_b32 s20, s16
; VI-NEXT:    s_mov_b32 s21, s17
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[20:23], 0 offset:16
; VI-NEXT:    s_nop 0
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mov_b32_e32 v2, s2
; VI-NEXT:    v_mov_b32_e32 v3, s3
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[20:23], 0
; VI-NEXT:    s_endpgm
;
; EG-LABEL: lshr_v4i64:
; EG:       ; %bb.0:
...
; SI-NEXT:    s_load_dword s4, s[4:5], 0x14
...
; VI-NEXT:    s_load_dword s4, s[4:5], 0x50
...
; SI-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64 offset:4
