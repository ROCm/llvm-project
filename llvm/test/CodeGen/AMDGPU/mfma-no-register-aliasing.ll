...
; RUN: llc -mtriple=amdgcn -mcpu=gfx90a --regalloc-npm='regallocfast<filter=sgpr;no-clear-vregs>,greedy<wwm>,regallocfast<filter=vgpr;no-clear-vregs>' < %s | FileCheck -enable-var-scope --check-prefixes=FAST90A %s
