...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu6.00 -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-GISEL %s
; RUN: llc -mtriple=amdgpu8.02 -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=VI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu8.02 -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=VI-GISEL %s
; RUN: llc -mtriple=amdgpu9.00 -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00 -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -global-isel=1 -mattr=-real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-FAKE16 %s
...
define float @canonicalize_fmin_legacy(float %a, float %b) #3 {
; SI-LABEL: canonicalize_fmin_legacy:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; VI-GISEL-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; VI-GISEL-NEXT:    v_mul_f32_e32 v0, 1.0, v0
; VI-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: canonicalize_fmin_legacy:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: canonicalize_fmin_legacy:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
define float @med3_fmin_legacy(float %a, float %b) #3 {
...
; VI-GISEL-NEXT:    v_cmp_lt_f32_e32 vcc, v0, v1
; VI-GISEL-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; VI-GISEL-NEXT:    v_cmp_lt_f32_e32 vcc, 2.0, v0
; VI-GISEL-NEXT:    v_cndmask_b32_e32 v0, 2.0, v0, vcc
; VI-GISEL-NEXT:    v_cmp_gt_f32_e32 vcc, 4.0, v0
...
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, v0, v1
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v0, v1
; GFX11-SDAG-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc_lo
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f32_e32 v0, v0, v0
