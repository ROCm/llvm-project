...
; VI-SDAG-NEXT:    v_med3_f32 v3, v0, 2.0, 4.0
...
; VI-GISEL-NEXT:    v_add_f32_e32 v3, 1.0, v3
; VI-GISEL-NEXT:    v_med3_f32 v3, v3, 2.0, 4.0
...
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_add_f32_e32 v0, 1.0, v0
; VI-SDAG-NEXT:    v_max_f32_e32 v0, 4.0, v0
; VI-SDAG-NEXT:    v_min_f32_e32 v3, 2.0, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    v_add_f32_e32 v3, 1.0, v3
; VI-GISEL-NEXT:    v_max_f32_e32 v3, 4.0, v3
; VI-GISEL-NEXT:    v_min_f32_e32 v3, 2.0, v3
; VI-GISEL-NEXT:    flat_store_dword v[0:1], v3
; VI-GISEL-NEXT:    s_endpgm
;
...
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v4, vcc
; VI-SDAG-NEXT:    flat_load_dword v0, v[0:1] glc
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_med3_f32 v3, -v5, v3, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_add_f32_e32 v4, 1.0, v5
; VI-SDAG-NEXT:    v_add_f32_e32 v3, 2.0, v3
; VI-SDAG-NEXT:    v_add_f32_e32 v0, 4.0, v0
; VI-SDAG-NEXT:    v_med3_f32 v3, v4, v3, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_med3_f32 v3, v3, v5, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_mul_f32_e32 v4, 1.0, v5
; VI-SDAG-NEXT:    v_mul_f32_e32 v3, 1.0, v3
; VI-SDAG-NEXT:    v_min_f32_e32 v5, v4, v3
; VI-SDAG-NEXT:    v_max_f32_e32 v3, v4, v3
; VI-SDAG-NEXT:    v_mul_f32_e32 v0, 1.0, v0
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v5
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_min_f32_e32 v0, v3, v0
; VI-SDAG-NEXT:    v_max_f32_e32 v3, v5, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-SDAG-NEXT:    v_mul_f32_e32 v0, 1.0, v0
; VI-SDAG-NEXT:    v_min_f32_e32 v0, v3, v0
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v0
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_max_f32_e32 v3, v5, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_min_f32_e64 v4, -v5, v3
; VI-SDAG-NEXT:    v_max_f32_e32 v3, v5, v3
; VI-SDAG-NEXT:    v_min_f32_e32 v0, v3, v0
; VI-SDAG-NEXT:    v_max_f32_e32 v3, v4, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_max_f32_e32 v3, v5, v3
; VI-SDAG-NEXT:    v_min_f32_e32 v3, v3, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-SDAG-NEXT:    v_min_f16_e32 v3, 4.0, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; VI-GISEL-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    v_add_f16_e32 v3, 1.0, v3
; VI-GISEL-NEXT:    v_max_f16_e32 v3, 2.0, v3
; VI-GISEL-NEXT:    v_min_f16_e32 v3, 4.0, v3
...
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    v_mov_b32_e32 v3, s5
; VI-SDAG-NEXT:    flat_load_ushort v5, v[0:1] glc
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s4, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v3, vcc
; VI-SDAG-NEXT:    v_mov_b32_e32 v4, s7
...
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s6, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v4, vcc
; VI-SDAG-NEXT:    flat_load_ushort v0, v[0:1] glc
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    v_add_f16_e32 v4, 1.0, v5
; VI-SDAG-NEXT:    v_add_f16_e32 v3, 2.0, v3
; VI-SDAG-NEXT:    v_min_f16_e32 v5, v4, v3
; VI-SDAG-NEXT:    v_max_f16_e32 v3, v4, v3
; VI-SDAG-NEXT:    v_add_f16_e32 v0, 4.0, v0
; VI-SDAG-NEXT:    v_min_f16_e32 v0, v3, v0
; VI-SDAG-NEXT:    v_max_f16_e32 v3, v5, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_short v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-GISEL-NEXT:    v_addc_u32_e32 v1, vcc, 0, v3, vcc
; VI-GISEL-NEXT:    v_mov_b32_e32 v5, s7
; VI-GISEL-NEXT:    flat_load_ushort v2, v[0:1] glc
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    v_add_u32_e32 v0, vcc, v4, v6
; VI-GISEL-NEXT:    v_addc_u32_e32 v1, vcc, 0, v5, vcc
...
; VI-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    v_add_f32_e32 v0, 0.5, v0
; VI-SDAG-NEXT:    v_max_f32_e32 v0, 0x41000000, v0
; VI-SDAG-NEXT:    v_min_f32_e32 v3, 0x41800000, v0
; VI-SDAG-NEXT:    v_add_u32_e32 v0, vcc, s0, v2
; VI-SDAG-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-SDAG-NEXT:    flat_store_dword v[0:1], v3
; VI-SDAG-NEXT:    s_endpgm
...
; VI-GISEL-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    v_add_f32_e32 v3, 0.5, v3
; VI-GISEL-NEXT:    v_max_f32_e32 v3, 0x41000000, v3
; VI-GISEL-NEXT:    v_min_f32_e32 v3, 0x41800000, v3
; VI-GISEL-NEXT:    flat_store_dword v[0:1], v3
; VI-GISEL-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    v_cvt_f32_f16_e32 v1, v1
; SI-SDAG-NEXT:    v_max_f32_e32 v4, 2.0, v1
