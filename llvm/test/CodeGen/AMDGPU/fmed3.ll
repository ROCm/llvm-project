...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=VI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=tonga -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=VI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx900 -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 -mattr=-real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-SDAG,GFX11-SDAG-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -mattr=-real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 -mattr=+real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-SDAG,GFX11-SDAG-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -mattr=+real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-TRUE16 %s
...
; SI-SDAG-NEXT:    buffer_load_dword v4, v[0:1], s[16:19], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[8:9], s[0:1]
; SI-SDAG-NEXT:    v_add_f32_e32 v2, 1.0, v2
; SI-SDAG-NEXT:    v_add_f32_e32 v3, 2.0, v3
; SI-SDAG-NEXT:    v_add_f32_e32 v4, 4.0, v4
; SI-SDAG-NEXT:    v_med3_f32 v2, v2, v3, v4
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[8:11], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_mov_b64 s[18:19], s[10:11]
; SI-SDAG-NEXT:    s_mov_b64 s[22:23], s[10:11]
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[8:9], s[2:3]
; SI-SDAG-NEXT:    s_mov_b64 s[16:17], s[4:5]
; SI-SDAG-NEXT:    s_mov_b64 s[20:21], s[6:7]
; SI-SDAG-NEXT:    buffer_load_dword v2, v[0:1], s[8:11], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    buffer_load_dword v3, v[0:1], s[16:19], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    buffer_load_dword v4, v[0:1], s[20:23], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_mov_b32 s15, s11
; SI-SDAG-NEXT:    s_mov_b64 s[8:9], s[0:1]
...
; SI-SDAG-NEXT:    buffer_store_dword v5, off, s[12:15], 0
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; SI-SDAG-NEXT:    v_min_f32_e32 v5, v2, v3
; SI-SDAG-NEXT:    v_max_f32_e32 v2, v2, v3
; SI-SDAG-NEXT:    buffer_store_dword v2, off, s[12:15], 0
...
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[2:3], s[10:11]
; SI-SDAG-NEXT:    s_mov_b64 s[8:9], s[6:7]
; SI-SDAG-NEXT:    buffer_load_dword v4, v[0:1], s[8:11], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_mul_f32_e32 v2, 1.0, v2
; SI-SDAG-NEXT:    v_mul_f32_e32 v3, 1.0, v3
; SI-SDAG-NEXT:    v_min_f32_e32 v5, v2, v3
...
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx8 s[4:11], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s2, 0
; SI-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; SI-SDAG-NEXT:    v_mov_b32_e32 v1, 0
; SI-SDAG-NEXT:    s_mov_b64 s[14:15], s[2:3]
; SI-SDAG-NEXT:    s_mov_b64 s[18:19], s[2:3]
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[0:1], s[6:7]
; SI-SDAG-NEXT:    s_mov_b64 s[12:13], s[8:9]
; SI-SDAG-NEXT:    s_mov_b64 s[16:17], s[10:11]
; SI-SDAG-NEXT:    buffer_load_ushort v2, v[0:1], s[0:3], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[0:1], s[4:5]
; SI-SDAG-NEXT:    v_cvt_f32_f16_e32 v2, v2
...
; SI-SDAG-NEXT:    buffer_store_dword v3, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    buffer_store_dword v2, off, s[0:3], 0
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SI-SDAG-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_mov_b32 s8, 0x41000000
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
; SI-SDAG-NEXT:    v_mov_b32_e32 v3, 0x41800000
; SI-SDAG-NEXT:    s_mov_b32 s3, s7
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
...
; SI-SDAG-NEXT:    v_med3_f32 v3, v4, s8, v3
; SI-SDAG-NEXT:    buffer_store_dword v3, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    buffer_store_dword v5, off, s[0:3], 0
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    buffer_store_dword v2, off, s[0:3], 0
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_endpgm
...
; SI-GISEL-NEXT:    v_med3_f32 v0, v0, 2.0, 4.0
; SI-GISEL-NEXT:    v_cmp_o_f32_e32 vcc, 4.0, v2
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; SI-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-GISEL-NEXT:    v_cmp_o_f32_e32 vcc, 4.0, v1
...
; GFX11-GISEL-NEXT:    v_med3_f32 v0, v0, 2.0, 4.0
; GFX11-GISEL-NEXT:    v_cmp_o_f32_e32 vcc_lo, 4.0, v1
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0x7fc00000, v0, vcc_lo
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
  %a.add = fadd nnan float %a, 1.0
...
; GFX9-GISEL-NEXT:    v_pk_max_f16 v0, v0, 2.0 op_sel_hi:[1,0]
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v2, 0x4400
; GFX9-GISEL-NEXT:    v_pk_min_f16 v1, v0, 4.0 op_sel_hi:[1,0]
...
; GFX11-GISEL-FAKE16-NEXT:    v_pk_max_f16 v0, v0, 2.0 op_sel_hi:[1,0]
; GFX11-GISEL-FAKE16-NEXT:    v_pk_min_f16 v1, v0, 4.0 op_sel_hi:[1,0]
...
; GFX11-GISEL-FAKE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, 4.0, v2
...
; GFX11-GISEL-TRUE16-NEXT:    v_pk_max_f16 v0, v0, 2.0 op_sel_hi:[1,0]
...
; GFX9-GISEL-NEXT:    v_med3_f16 v0, v0, 2.0, 4.0
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v2, 0x7e00
...
; GFX11-GISEL-FAKE16-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v0, vcc_lo
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-GISEL-TRUE16-NEXT:    v_med3_f16 v0.l, v0.l, 2.0, 4.0
; GFX11-GISEL-TRUE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, 4.0, v0.h
; GFX11-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-GISEL-TRUE16-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v0, vcc_lo
; GFX11-GISEL-TRUE16-NEXT:    s_setpc_b64 s[30:31]
  %a.add = fadd nnan half %a, 1.0
...
; SI-GISEL-NEXT:    v_max_f64 v[0:1], v[0:1], 2.0
...
; VI-GISEL-NEXT:    v_mov_b32_e32 v1, 0x7ff80000
; VI-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0, v2, vcc
; VI-GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; VI-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-GISEL-NEXT:    v_max_f64 v[0:1], v[0:1], 2.0
...
; GFX11-GISEL-NEXT:    v_max_f64 v[0:1], v[0:1], 2.0
