...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.10 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefix=GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-GISEL-REAL16 %s
