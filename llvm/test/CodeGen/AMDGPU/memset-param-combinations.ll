...
; GFX942-GISEL-NEXT:    v_and_b32_e32 v4, -16, v2
; GFX942-GISEL-NEXT:    v_and_b32_e32 v10, 15, v2
...
; GFX942-GISEL-NEXT:  ; %bb.1: ; %dynamic-memset-expansion-main-body.preheader
; GFX942-GISEL-NEXT:    s_mov_b32 s4, 0x4040404
; GFX942-GISEL-NEXT:    v_perm_b32 v6, v1, v1, s4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v3, v6
...
; GFX942-GISEL-NEXT:    ds_write2_b32 v9, v8, v7 offset0:2 offset1:3
; GFX942-GISEL-NEXT:    ds_write2_b32 v9, v6, v3 offset1:1
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX942-GISEL-NEXT:    v_add_u32_e32 v9, 16, v9
; GFX942-GISEL-NEXT:    s_andn2_b64 exec, exec, s[0:1]
...
; GFX942-GISEL-NEXT:    s_addc_u32 s5, s5, 0
; GFX942-GISEL-NEXT:    v_cmp_ge_u64_e32 vcc, s[4:5], v[4:5]
; GFX942-GISEL-NEXT:    scratch_store_dwordx4 v3, v[6:9], off
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX942-GISEL-NEXT:    v_add_u32_e32 v3, 16, v3
; GFX942-GISEL-NEXT:    s_andn2_b64 exec, exec, s[0:1]
...
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v60, v2
; GFX942-SDAG-NEXT:    s_mov_b32 s0, 0x4040404
; GFX942-SDAG-NEXT:    v_perm_b32 v4, v60, v60, s0
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v5, v4
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v6, v4
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v7, v4
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[36:37], v[38:39], 0, s[20:21]
...
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[36:37], v[8:11]
; GFX942-SDAG-NEXT:    s_cbranch_vccnz .LBB4_1
; GFX942-SDAG-NEXT:  ; %bb.2: ; %static-memset-post-expansion
; GFX942-SDAG-NEXT:    s_mov_b32 s0, 0x4040404
; GFX942-SDAG-NEXT:    v_perm_b32 v4, v60, v60, s0
; GFX942-SDAG-NEXT:    v_lshlrev_b16_e32 v2, 8, v60
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v5, v4
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v6, v4
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v7, v4
; GFX942-SDAG-NEXT:    v_or_b32_sdwa v2, v60, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[4:7] offset:1024
; GFX942-SDAG-NEXT:    flat_store_dwordx3 v[0:1], v[4:6] offset:1040
; GFX942-SDAG-NEXT:    flat_store_short v[0:1], v2 offset:1052
; GFX942-SDAG-NEXT:    flat_store_byte v[0:1], v60 offset:1054
...
; GFX942-GISEL:       ; %bb.0: ; %entry
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a0, v40 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a1, v41 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a2, v42 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a3, v43 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a4, v44 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a5, v45 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a6, v46 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a7, v47 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a8, v56 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a9, v57 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a10, v58 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a11, v59 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a12, v60 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_write_b32 a13, v61 ; Reload Reuse
; GFX942-GISEL-NEXT:    s_mov_b32 s0, 0x4040404
; GFX942-GISEL-NEXT:    v_perm_b32 v4, v2, v2, s0
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v5, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v6, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v7, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v8, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v9, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v10, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v11, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v12, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v13, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v14, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v15, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v16, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v17, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v18, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v19, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v20, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v21, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v22, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v23, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v24, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v25, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v26, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v27, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v28, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v29, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v30, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v31, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v32, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v33, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v34, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v35, v4
; GFX942-GISEL-NEXT:    s_mov_b64 s[0:1], 0
; GFX942-GISEL-NEXT:    s_mov_b64 s[2:3], 0x70
; GFX942-GISEL-NEXT:    s_mov_b64 s[4:5], 0x60
; GFX942-GISEL-NEXT:    s_mov_b64 s[6:7], 0x50
; GFX942-GISEL-NEXT:    s_mov_b64 s[8:9], 0xf0
; GFX942-GISEL-NEXT:    s_mov_b64 s[10:11], 0xe0
; GFX942-GISEL-NEXT:    s_mov_b64 s[12:13], 0xd0
; GFX942-GISEL-NEXT:    s_mov_b64 s[14:15], 0xc0
; GFX942-GISEL-NEXT:    s_mov_b64 s[16:17], 0xb0
; GFX942-GISEL-NEXT:    s_mov_b64 s[18:19], 0xa0
; GFX942-GISEL-NEXT:    s_mov_b64 s[20:21], 0x90
; GFX942-GISEL-NEXT:    v_mov_b64_e32 v[36:37], 0x400
; GFX942-GISEL-NEXT:  .LBB4_1: ; %static-memset-expansion-main-body
; GFX942-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[38:39], v[0:1], 0, s[0:1]
; GFX942-GISEL-NEXT:    s_add_u32 s0, s0, 0x100
; GFX942-GISEL-NEXT:    s_addc_u32 s1, s1, 0
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e32 vcc, s[0:1], v[36:37]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[48:49], v[38:39], 0, s[2:3]
; GFX942-GISEL-NEXT:    s_and_b64 vcc, exec, vcc
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[50:51], v[38:39], 0, s[4:5]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[52:53], v[38:39], 0, s[6:7]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[38:39], v[20:23] offset:64
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[54:55], v[38:39], 0, 48
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[38:39], v[12:15] offset:32
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[38:39], v[8:11] offset:16
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[38:39], v[4:7]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[40:41], v[38:39], 0, s[8:9]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[42:43], v[38:39], 0, s[10:11]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[44:45], v[38:39], 0, s[12:13]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[46:47], v[38:39], 0, s[14:15]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[56:57], v[38:39], 0, s[16:17]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[58:59], v[38:39], 0, s[18:19]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[60:61], v[38:39], 0, s[20:21]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[38:39], v[4:7] offset:128
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[48:49], v[32:35]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[50:51], v[28:31]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[52:53], v[24:27]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[54:55], v[16:19]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[40:41], v[32:35]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[42:43], v[28:31]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[44:45], v[24:27]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[46:47], v[20:23]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[56:57], v[16:19]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[58:59], v[12:15]
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[60:61], v[8:11]
; GFX942-GISEL-NEXT:    s_cbranch_vccnz .LBB4_1
; GFX942-GISEL-NEXT:  ; %bb.2: ; %static-memset-post-expansion
; GFX942-GISEL-NEXT:    s_mov_b32 s0, 0x4040404
; GFX942-GISEL-NEXT:    v_perm_b32 v4, v2, v2, s0
; GFX942-GISEL-NEXT:    v_lshlrev_b16_e32 v3, 8, v2
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v5, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v6, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v7, v4
...
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v61, a13 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v60, a12 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v59, a11 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v58, a10 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v57, a9 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v56, a8 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v47, a7 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v46, a6 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v45, a5 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v44, a4 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v43, a3 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v42, a2 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v41, a1 ; Reload Reuse
; GFX942-GISEL-NEXT:    v_accvgpr_read_b32 v40, a0 ; Reload Reuse
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-GISEL-NEXT:    s_setpc_b64 s[30:31]
entry:
