...
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v11, v0
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX942-SDAG-NEXT:    ds_write2_b32 v11, v9, v10 offset0:2 offset1:3
; GFX942-SDAG-NEXT:    ds_write2_b32 v11, v5, v8 offset1:1
; GFX942-SDAG-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX942-SDAG-NEXT:    v_add_u32_e32 v11, 16, v11
; GFX942-SDAG-NEXT:    s_andn2_b64 exec, exec, s[0:1]
...
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v34, v35 offset0:30 offset1:31
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v32, v33 offset0:28 offset1:29
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v30, v31 offset0:26 offset1:27
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v28, v29 offset0:24 offset1:25
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v26, v27 offset0:22 offset1:23
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v24, v25 offset0:20 offset1:21
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v22, v23 offset0:18 offset1:19
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v20, v21 offset0:16 offset1:17
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v18, v19 offset0:14 offset1:15
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v16, v17 offset0:12 offset1:13
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v14, v15 offset0:10 offset1:11
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v12, v13 offset0:8 offset1:9
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v10, v11 offset0:6 offset1:7
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v8, v9 offset0:4 offset1:5
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v6, v7 offset0:2 offset1:3
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v4, v5 offset1:1
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v34, v35 offset0:62 offset1:63
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v32, v33 offset0:60 offset1:61
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v30, v31 offset0:58 offset1:59
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v28, v29 offset0:56 offset1:57
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v26, v27 offset0:54 offset1:55
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v24, v25 offset0:52 offset1:53
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v22, v23 offset0:50 offset1:51
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v20, v21 offset0:48 offset1:49
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v18, v19 offset0:46 offset1:47
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v16, v17 offset0:44 offset1:45
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v14, v15 offset0:42 offset1:43
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v12, v13 offset0:40 offset1:41
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v10, v11 offset0:38 offset1:39
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v8, v9 offset0:36 offset1:37
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v6, v7 offset0:34 offset1:35
; GFX942-SDAG-NEXT:    ds_write2_b32 v36, v4, v5 offset0:32 offset1:33
...
; GFX942-SDAG-NEXT:    s_addc_u32 s1, s1, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[0:1], v[2:3]
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v33, v34 offset0:30 offset1:31
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v31, v32 offset0:28 offset1:29
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v29, v30 offset0:26 offset1:27
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v27, v28 offset0:24 offset1:25
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v25, v26 offset0:22 offset1:23
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v23, v24 offset0:20 offset1:21
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v21, v22 offset0:18 offset1:19
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v19, v20 offset0:16 offset1:17
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v17, v18 offset0:14 offset1:15
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v15, v16 offset0:12 offset1:13
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v13, v14 offset0:10 offset1:11
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v11, v12 offset0:8 offset1:9
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v9, v10 offset0:6 offset1:7
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v7, v8 offset0:4 offset1:5
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v5, v6 offset0:2 offset1:3
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v1, v4 offset1:1
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v33, v34 offset0:62 offset1:63
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v31, v32 offset0:60 offset1:61
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v29, v30 offset0:58 offset1:59
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v27, v28 offset0:56 offset1:57
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v25, v26 offset0:54 offset1:55
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v23, v24 offset0:52 offset1:53
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v21, v22 offset0:50 offset1:51
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v19, v20 offset0:48 offset1:49
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v17, v18 offset0:46 offset1:47
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v15, v16 offset0:44 offset1:45
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v13, v14 offset0:42 offset1:43
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v11, v12 offset0:40 offset1:41
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v9, v10 offset0:38 offset1:39
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v7, v8 offset0:36 offset1:37
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v5, v6 offset0:34 offset1:35
; GFX942-SDAG-NEXT:    ds_write2_b32 v0, v1, v4 offset0:32 offset1:33
