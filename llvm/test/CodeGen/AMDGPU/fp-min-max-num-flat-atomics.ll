...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -global-isel=1 -mtriple=amdgpu12.00 | FileCheck %s -check-prefixes=GCN,GFX12,GFX12-GISEL
; RUN: llc < %s -global-isel=0 -mtriple=amdgpu12.50 | FileCheck %s -check-prefixes=GCN,GFX1250,GFX1250-SDAG
; RUN: llc -amdgpu-late-wave-transform=1 < %s -global-isel=1 -mtriple=amdgpu12.50 | FileCheck %s -check-prefixes=GCN,GFX1250,GFX1250-GISEL
