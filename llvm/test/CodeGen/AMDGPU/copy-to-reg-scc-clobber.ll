...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -O3 -pre-RA-sched=source < %s | FileCheck -check-prefix=RRLIST %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx90a -O3 -pre-RA-sched=fast < %s | FileCheck -check-prefix=FAST %s
...
; RRLIST-NEXT:    global_store_dword v2, v0, s[0:1]
...
; FAST-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x44
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    s_load_dword s12, s[12:13], 0x0
; FAST-NEXT:    s_nop 0
...
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    s_min_i32 s9, s12, 0
; FAST-NEXT:    v_pk_mov_b32 v[0:1], s[2:3], s[2:3] op_sel:[0,1]
; FAST-NEXT:    v_cmp_lt_i64_e32 vcc, s[4:5], v[0:1]
; FAST-NEXT:    s_and_b64 s[6:7], vcc, exec
; FAST-NEXT:    s_cselect_b32 s6, s12, s8
; FAST-NEXT:    s_cmp_eq_u64 s[4:5], s[2:3]
; FAST-NEXT:    s_cselect_b32 s2, s9, s6
; FAST-NEXT:    v_mov_b32_e32 v0, s2
; FAST-NEXT:    global_store_dword v2, v0, s[0:1]
; FAST-NEXT:    s_endpgm
entry:
