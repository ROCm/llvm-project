...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a -O3 -pre-RA-sched=source < %s | FileCheck -check-prefix=RRLIST %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a -O3 -pre-RA-sched=fast < %s | FileCheck -check-prefix=FAST %s
