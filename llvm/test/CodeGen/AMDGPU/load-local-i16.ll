...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=SI %s
...
; SI-NEXT:    v_and_b32_e32 v25, 0xffff, v0
; SI-NEXT:    buffer_store_dword v25, off, s[12:15], 0 offset:8 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v26, off, s[12:15], 0 offset:12 ; 4-byte Folded Spill
...
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    ds_write2_b64 v0, v[40:41], v[1:2] offset0:14 offset1:15
...
; SI-NEXT:    ds_write2_b64 v0, v[4:5], v[24:25] offset0:22 offset1:23
; SI-NEXT:    ds_write2_b64 v0, v[26:27], v[32:33] offset0:20 offset1:21
...
; SI-NEXT:    buffer_load_dword v3, off, s[12:15], 0 offset:8 ; 4-byte Folded Reload
; SI-NEXT:    buffer_load_dword v4, off, s[12:15], 0 offset:12 ; 4-byte Folded Reload
...
; SI-NEXT:    ds_read2_b64 v[16:19], v24 offset1:1
; SI-NEXT:    ds_read2_b64 v[20:23], v24 offset0:2 offset1:3
; SI-NEXT:    ds_read2_b64 v[34:37], v24 offset0:4 offset1:5
; SI-NEXT:    ds_read2_b64 v[38:41], v24 offset0:6 offset1:7
; SI-NEXT:    s_waitcnt lgkmcnt(7)
; SI-NEXT:    v_ashrrev_i32_e32 v25, 16, v5
; SI-NEXT:    v_ashrrev_i32_e32 v26, 16, v4
...
; SI-NEXT:    s_waitcnt lgkmcnt(2)
; SI-NEXT:    v_ashrrev_i32_e32 v53, 16, v21
; SI-NEXT:    v_bfe_i32 v52, v21, 0, 16
; SI-NEXT:    v_ashrrev_i32_e32 v21, 16, v20
; SI-NEXT:    v_bfe_i32 v20, v20, 0, 16
; SI-NEXT:    v_ashrrev_i32_e32 v55, 16, v23
; SI-NEXT:    v_bfe_i32 v54, v23, 0, 16
...
; SI-NEXT:    v_ashrrev_i32_e32 v2, 16, v41
; SI-NEXT:    v_bfe_i32 v1, v41, 0, 16
...
; SI-NEXT:    ds_write2_b64 v0, v[36:37], v[58:59] offset0:10 offset1:11
; SI-NEXT:    ds_write2_b64 v0, v[34:35], v[56:57] offset0:8 offset1:9
; SI-NEXT:    ds_write2_b64 v0, v[22:23], v[54:55] offset0:6 offset1:7
; SI-NEXT:    ds_write2_b64 v0, v[20:21], v[52:53] offset0:4 offset1:5
...
; SI-NEXT:    ds_write2_b64 v0, v[8:9], v[3:4] offset0:24 offset1:25
; SI-NEXT:    ds_write2_b64 v0, v[5:6], v[24:25] offset0:22 offset1:23
; SI-NEXT:    ds_write2_b64 v0, v[26:27], v[32:33] offset0:20 offset1:21
; SI-NEXT:    ds_write2_b64 v0, v[30:31], v[28:29] offset0:18 offset1:19
; SI-NEXT:    buffer_load_dword v1, off, s[12:15], 0 ; 4-byte Folded Reload
; SI-NEXT:    buffer_load_dword v2, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
