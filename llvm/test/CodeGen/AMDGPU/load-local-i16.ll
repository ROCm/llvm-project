...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -mattr=-enable-ds128 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=VI,VI-NO-DS128 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=-enable-ds128 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX9,GFX9-NO-DS128 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -mattr=+enable-ds128 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=VI,VI-DS128 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=+enable-ds128 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX9,GFX9-DS128 %s
...
; VI-DS128-NEXT:    v_lshrrev_b32_e32 v7, 16, v42
; VI-DS128-NEXT:    v_lshrrev_b32_e32 v5, 16, v41
; VI-DS128-NEXT:    v_and_b32_e32 v6, 0xffff, v42
; VI-DS128-NEXT:    v_and_b32_e32 v4, 0xffff, v41
; VI-DS128-NEXT:    ds_write_b128 v28, v[0:3] offset:224
; VI-DS128-NEXT:    ds_write_b128 v28, v[4:7] offset:240
; VI-DS128-NEXT:    ds_write_b128 v28, v[8:11] offset:192
; VI-DS128-NEXT:    ds_write_b128 v28, v[58:61] offset:208
...
; GFX9-DS128-NEXT:    v_lshrrev_b32_e32 v7, 16, v42
; GFX9-DS128-NEXT:    v_lshrrev_b32_e32 v5, 16, v41
; GFX9-DS128-NEXT:    v_and_b32_e32 v6, 0xffff, v42
; GFX9-DS128-NEXT:    v_and_b32_e32 v4, 0xffff, v41
; GFX9-DS128-NEXT:    ds_write_b128 v28, v[0:3] offset:224
; GFX9-DS128-NEXT:    ds_write_b128 v28, v[4:7] offset:240
; GFX9-DS128-NEXT:    ds_write_b128 v28, v[8:11] offset:192
; GFX9-DS128-NEXT:    ds_write_b128 v28, v[58:61] offset:208
