...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdhsa -mcpu=fiji < %s | FileCheck -check-prefix=CHECK-SDAG -enable-var-scope %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn--amdhsa -mcpu=fiji -global-isel -new-reg-bank-select -global-isel-abort=2 < %s | FileCheck -check-prefix=CHECK-GISEL -enable-var-scope %s
