...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03--amdhsa < %s | FileCheck -check-prefix=CHECK-SDAG -enable-var-scope %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu8.03--amdhsa -global-isel -global-isel-abort=2 < %s | FileCheck -check-prefix=CHECK-GISEL -enable-var-scope %s
