...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti -amdgpu-s-branch-bits=4 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64 -amdgpu-s-branch-bits=5 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-s-branch-bits=5 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GFX12 %s


; FIXME: We should use llvm-mc for this, but we can't even parse our own output.
;        See PR33579.
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -amdgpu-s-branch-bits=4 -amdgpu-long-branch-factor=0 -o %t.o -filetype=obj -simplifycfg-require-and-preserve-domtree=1 %s
...
; GCN-NEXT:    s_xor_b64 s[0:1], exec, s[4:5]
...
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX11-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_xor_b64 s[0:1], exec, s[2:3]
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB5_2-.Lpost_getpc5)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB5_2-.Lpost_getpc5)>>32
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB6_1-.Lpost_getpc6)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB6_1-.Lpost_getpc6)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB7_2-.Lpost_getpc8)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB7_2-.Lpost_getpc8)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
; GCN-NEXT:  .LBB7_1: ; %bb1
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB7_3-.Lpost_getpc7)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB7_3-.Lpost_getpc7)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
; GCN-NEXT:  .LBB7_2: ; %bb2
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    v_nop_e64
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s0, s0, (.LBB7_3-.Lpost_getpc7)&4294967295
; GFX11-NEXT:    s_addc_u32 s1, s1, (.LBB7_3-.Lpost_getpc7)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[0:1]
; GFX11-NEXT:  .LBB7_2: ; %bb2
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    v_nop_e64
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_cmp_eq_u32 s0, 3
; GFX12-NEXT:    s_cbranch_scc0 .LBB7_2
; GFX12-NEXT:  ; %bb.4: ; %bb1
; GFX12-NEXT:    s_getpc_b64 s[0:1]
; GFX12-NEXT:  .Lpost_getpc7:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s0, s0, (.LBB7_3-.Lpost_getpc7)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB7_3-.Lpost_getpc7)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[0:1]
; GFX12-NEXT:  .LBB7_2: ; %bb2
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    v_nop_e64
; GFX12-NEXT:    v_nop_e64
; GFX12-NEXT:    v_nop_e64
...
; GCN:       ; %bb.0: ; %entry
; GCN-NEXT:    v_cmp_lt_u32_e32 vcc, 15, v0
; GCN-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GCN-NEXT:    s_xor_b64 s[6:7], exec, s[0:1]
...
; GFX11-NEXT:    v_cmp_lt_u32_e32 vcc, 15, v0
; GFX11-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX11-NEXT:    s_xor_b64 s[0:1], exec, s[2:3]
; GFX11-NEXT:    s_mov_b64 exec, s[2:3]
; GFX11-NEXT:    s_mov_b64 s[2:3], 0
...
; GFX12-NEXT:    v_cmp_lt_u32_e32 vcc_lo, 15, v0
; GFX12-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX12-NEXT:    s_xor_b32 s3, exec_lo, s0
; GFX12-NEXT:    s_mov_b32 exec_lo, s0
; GFX12-NEXT:    s_mov_b32 s0, 0
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB8_3
; GFX12-NEXT:  .LBB8_1: ; %if
; GFX12-NEXT:    s_mov_b32 s0, 0
...
; GCN-NEXT:    s_add_u32 s6, s6, (.LBB9_3-.Lpost_getpc10)&4294967295
; GCN-NEXT:    s_addc_u32 s7, s7, (.LBB9_3-.Lpost_getpc10)>>32
...
; GCN-NEXT:    s_add_u32 s6, s6, (.LBB9_2-.Lpost_getpc11)&4294967295
; GCN-NEXT:    s_addc_u32 s7, s7, (.LBB9_2-.Lpost_getpc11)>>32
; GCN-NEXT:    s_setpc_b64 s[6:7]
; GCN-NEXT:  .LBB9_3:
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB9_5-.Lpost_getpc12)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB9_5-.Lpost_getpc12)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
; GCN-NEXT:  .LBB9_4: ; %ret
; GCN-NEXT:    s_mov_b64 s[0:1], 0
; GCN-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX11-NEXT:    s_mov_b64 s[2:3], 0
; GFX11-NEXT:    s_mov_b64 s[2:3], 0
; GFX11-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; GFX11-NEXT:    s_mov_b64 exec, s[6:7]
; GFX11-NEXT:    s_mov_b64 s[6:7], 0
; GFX11-NEXT:    ; divergent control-flow edge
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s6, s6, (.LBB9_3-.Lpost_getpc8)&4294967295
; GFX11-NEXT:    s_addc_u32 s7, s7, (.LBB9_3-.Lpost_getpc8)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s6, s6, (.LBB9_2-.Lpost_getpc9)&4294967295
; GFX11-NEXT:    s_addc_u32 s7, s7, (.LBB9_2-.Lpost_getpc9)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[6:7]
; GFX11-NEXT:  .LBB9_3:
; GFX11-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b64 s[4:5], exec, s[0:1]
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_xor_b32 s2, exec_lo, s3
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s4, s4, (.LBB9_3-.Lpost_getpc8)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s5, s5, (.LBB9_3-.Lpost_getpc8)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s4, s4, (.LBB9_2-.Lpost_getpc9)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s5, s5, (.LBB9_2-.Lpost_getpc9)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[4:5]
; GFX12-NEXT:  .LBB9_3:
...
; GCN-NEXT:    s_add_u32 s8, s8, (.LBB10_3-.Lpost_getpc16)&4294967295
; GCN-NEXT:    s_addc_u32 s9, s9, (.LBB10_3-.Lpost_getpc16)>>32
; GCN-NEXT:    s_setpc_b64 s[8:9]
; GCN-NEXT:  .LBB10_1: ; %bb9
; GCN-NEXT:    s_min_i32 s0, s2, 10
; GCN-NEXT:    s_cmp_lt_i32 s0, s3
; GCN-NEXT:    s_cbranch_scc1 .LBB10_2
; GCN-NEXT:  ; %bb.8: ; %bb9
; GCN-NEXT:    s_getpc_b64 s[8:9]
; GCN-NEXT:  .Lpost_getpc14:
; GCN-NEXT:    s_add_u32 s8, s8, (.LBB10_4-.Lpost_getpc14)&4294967295
; GCN-NEXT:    s_addc_u32 s9, s9, (.LBB10_4-.Lpost_getpc14)>>32
; GCN-NEXT:    s_setpc_b64 s[8:9]
; GCN-NEXT:  .LBB10_2:
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB10_5-.Lpost_getpc13)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB10_5-.Lpost_getpc13)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
; GCN-NEXT:  .LBB10_3: ; %bb13
...
; GCN-NEXT:    v_nop_e64
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    s_cbranch_vccz .LBB10_4
; GCN-NEXT:  ; %bb.10: ; %bb13
; GCN-NEXT:    s_getpc_b64 s[0:1]
; GCN-NEXT:  .Lpost_getpc15:
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB10_2-.Lpost_getpc15)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB10_2-.Lpost_getpc15)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
; GCN-NEXT:  .LBB10_4: ; %bb14
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s8, s8, (.LBB10_3-.Lpost_getpc13)&4294967295
; GFX11-NEXT:    s_addc_u32 s9, s9, (.LBB10_3-.Lpost_getpc13)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[8:9]
; GFX11-NEXT:  .LBB10_1: ; %bb9
; GFX11-NEXT:    s_min_i32 s0, s2, 10
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_cmp_lt_i32 s0, s3
; GFX11-NEXT:    s_cbranch_scc1 .LBB10_2
; GFX11-NEXT:  ; %bb.8: ; %bb9
; GFX11-NEXT:    s_getpc_b64 s[8:9]
; GFX11-NEXT:  .Lpost_getpc11:
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s8, s8, (.LBB10_4-.Lpost_getpc11)&4294967295
; GFX11-NEXT:    s_addc_u32 s9, s9, (.LBB10_4-.Lpost_getpc11)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[8:9]
; GFX11-NEXT:  .LBB10_2:
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s0, s0, (.LBB10_5-.Lpost_getpc10)&4294967295
; GFX11-NEXT:    s_addc_u32 s1, s1, (.LBB10_5-.Lpost_getpc10)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[0:1]
; GFX11-NEXT:  .LBB10_3: ; %bb13
; GFX11-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    v_nop_e64
...
; GFX11-NEXT:  ; %bb.10: ; %bb13
; GFX11-NEXT:    s_getpc_b64 s[0:1]
; GFX11-NEXT:  .Lpost_getpc12:
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s0, s0, (.LBB10_2-.Lpost_getpc12)&4294967295
; GFX11-NEXT:    s_addc_u32 s1, s1, (.LBB10_2-.Lpost_getpc12)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[0:1]
; GFX11-NEXT:  .LBB10_4: ; %bb14
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s6, s6, (.LBB10_3-.Lpost_getpc13)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s7, s7, (.LBB10_3-.Lpost_getpc13)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[6:7]
; GFX12-NEXT:  .LBB10_1: ; %bb9
; GFX12-NEXT:    s_min_i32 s6, s2, 10
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_cmp_lt_i32 s6, s3
; GFX12-NEXT:    s_cbranch_scc1 .LBB10_2
; GFX12-NEXT:  ; %bb.8: ; %bb9
; GFX12-NEXT:    s_getpc_b64 s[6:7]
; GFX12-NEXT:  .Lpost_getpc11:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s6, s6, (.LBB10_4-.Lpost_getpc11)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s7, s7, (.LBB10_4-.Lpost_getpc11)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[6:7]
; GFX12-NEXT:  .LBB10_2:
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s0, s0, (.LBB10_5-.Lpost_getpc10)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB10_5-.Lpost_getpc10)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[0:1]
; GFX12-NEXT:  .LBB10_3: ; %bb13
...
; GFX12-NEXT:  ; %bb.10: ; %bb13
; GFX12-NEXT:    s_getpc_b64 s[0:1]
; GFX12-NEXT:  .Lpost_getpc12:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s0, s0, (.LBB10_2-.Lpost_getpc12)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB10_2-.Lpost_getpc12)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[0:1]
; GFX12-NEXT:  .LBB10_4: ; %bb14
