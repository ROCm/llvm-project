...
;        See PR33579.
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -amdgpu-s-branch-bits=4 -amdgpu-long-branch-factor=0 -o %t.o -filetype=obj -simplifycfg-require-and-preserve-domtree=1 %s
...
; GFX11-NEXT:    s_xor_b64 exec, vcc, exec
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s0, s0, (.LBB3_2-.Lpost_getpc3)&4294967295
; GFX11-NEXT:    s_addc_u32 s1, s1, (.LBB3_2-.Lpost_getpc3)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s0, s0, (.LBB3_2-.Lpost_getpc3)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB3_2-.Lpost_getpc3)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GCN-NEXT:    s_add_u32 s8, s8, (.LBB10_3-.Lpost_getpc15)&4294967295
; GCN-NEXT:    s_addc_u32 s9, s9, (.LBB10_3-.Lpost_getpc15)>>32
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB10_5-.Lpost_getpc12)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB10_5-.Lpost_getpc12)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB10_2-.Lpost_getpc14)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB10_2-.Lpost_getpc14)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
