...
; RUN: llc -amdgpu-late-wave-transform=0 --global-isel=1 -mtriple=amdgcn -mcpu=tahiti %s -o - | FileCheck %s
; RUN: llc --global-isel=0 -mtriple=amdgcn -mcpu=tonga %s -o - | FileCheck %s
; RUN: llc -amdgpu-late-wave-transform=0 --global-isel=1 -mtriple=amdgcn -mcpu=tonga %s -o - | FileCheck %s
; RUN: llc --global-isel=0 -mtriple=amdgcn -mcpu=gfx90a %s -o - | FileCheck %s
; RUN: llc -amdgpu-late-wave-transform=0 --global-isel=1 -mtriple=amdgcn -mcpu=gfx90a %s -o - | FileCheck %s
