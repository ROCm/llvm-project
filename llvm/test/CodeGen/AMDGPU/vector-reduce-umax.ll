...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx700 < %s | FileCheck -check-prefixes=GFX7,GFX7-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx801 < %s | FileCheck -check-prefixes=GFX8,GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx801 < %s | FileCheck -check-prefixes=GFX8,GFX8-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GFX10,GFX10-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GFX10,GFX10-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL,GFX12-GISEL-FAKE16 %s
...
; GFX7-SDAG-NEXT:    v_and_b32_e32 v2, 0xff, v2
; GFX7-SDAG-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GFX7-SDAG-NEXT:    v_max_u32_e32 v1, v1, v3
...
; GFX7-SDAG-NEXT:    v_and_b32_e32 v2, 0xffff, v0
; GFX7-SDAG-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX7-SDAG-NEXT:    v_and_b32_e32 v3, 0xffff, v1
; GFX7-SDAG-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GFX7-SDAG-NEXT:    v_max_u32_e32 v0, v0, v1
; GFX7-SDAG-NEXT:    v_max3_u32 v0, v2, v3, v0
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG:       ; %bb.0: ; %entry
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_max_u32_e32 v1, v1, v3
...
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_max_u32_e32 v1, v1, v3
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_max_u32_e32 v1, v1, v3
...
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_max_u32_e32 v1, v1, v3
...
; GFX12-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_max_u32_e32 v1, v1, v3
...
; GFX8-SDAG-NEXT:    v_max_u32_e32 v3, v3, v7
...
; GFX9-SDAG-NEXT:    v_max_u32_e32 v3, v3, v7
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_max_u32_e32 v3, v3, v7
...
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_max_u32_e32 v3, v3, v7
...
; GFX12-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_max_u32_e32 v3, v3, v7
...
; GFX8-SDAG:       ; %bb.0: ; %entry
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_max_u32_e32 v7, v7, v15
; GFX8-SDAG-NEXT:    v_max_u32_e32 v6, v6, v14
; GFX8-SDAG-NEXT:    v_max_u32_e32 v4, v4, v12
; GFX8-SDAG-NEXT:    v_max_u32_e32 v0, v0, v8
; GFX8-SDAG-NEXT:    v_max_u32_e32 v5, v5, v13
; GFX8-SDAG-NEXT:    v_max_u32_e32 v1, v1, v9
...
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_max_u32_e32 v7, v7, v15
; GFX9-SDAG-NEXT:    v_max_u32_e32 v6, v6, v14
; GFX9-SDAG-NEXT:    v_max_u32_e32 v4, v4, v12
; GFX9-SDAG-NEXT:    v_max_u32_e32 v0, v0, v8
; GFX9-SDAG-NEXT:    v_max_u32_e32 v5, v5, v13
; GFX9-SDAG-NEXT:    v_max_u32_e32 v1, v1, v9
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_max_u32_e32 v7, v7, v15
; GFX10-SDAG-NEXT:    v_max_u32_e32 v6, v6, v14
; GFX10-SDAG-NEXT:    v_max_u32_e32 v4, v4, v12
; GFX10-SDAG-NEXT:    v_max_u32_e32 v0, v0, v8
; GFX10-SDAG-NEXT:    v_max_u32_e32 v5, v5, v13
; GFX10-SDAG-NEXT:    v_max_u32_e32 v1, v1, v9
...
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_max_u32_e32 v7, v7, v15
; GFX11-SDAG-NEXT:    v_max_u32_e32 v6, v6, v14
; GFX11-SDAG-NEXT:    v_max_u32_e32 v4, v4, v12
; GFX11-SDAG-NEXT:    v_max_u32_e32 v0, v0, v8
; GFX11-SDAG-NEXT:    v_max_u32_e32 v5, v5, v13
; GFX11-SDAG-NEXT:    v_max_u32_e32 v1, v1, v9
...
; GFX12-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_max_u32_e32 v7, v7, v15
; GFX12-SDAG-NEXT:    v_max_u32_e32 v6, v6, v14
; GFX12-SDAG-NEXT:    v_max_u32_e32 v4, v4, v12
; GFX12-SDAG-NEXT:    v_max_u32_e32 v0, v0, v8
; GFX12-SDAG-NEXT:    v_max_u32_e32 v5, v5, v13
; GFX12-SDAG-NEXT:    v_max_u32_e32 v1, v1, v9
