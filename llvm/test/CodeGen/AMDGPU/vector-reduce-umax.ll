...
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s5, v[8:9], v[24:25]
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s8, v[10:11], v[26:27]
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s9, v[2:3], v[18:19]
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e32 vcc_lo, v[4:5], v[20:21]
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s4, v[6:7], v[22:23]
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s6, v[0:1], v[16:17]
; GFX10-SDAG-NEXT:    v_cndmask_b32_e64 v9, v25, v9, s5
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s7, v[12:13], v[28:29]
...
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s4, v[4:5], v[12:13]
...
; GFX10-SDAG-NEXT:    v_cmp_gt_u64_e64 s5, v[14:15], v[30:31]
...
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s5, v[0:1], v[16:17]
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s9, v[8:9], v[24:25]
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e32 vcc_lo, v[10:11], v[26:27]
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s4, v[12:13], v[28:29]
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s6, v[2:3], v[18:19]
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s7, v[4:5], v[20:21]
; GFX10-GISEL-NEXT:    v_cndmask_b32_e64 v0, v16, v0, s5
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s8, v[6:7], v[22:23]
...
; GFX10-GISEL-NEXT:    v_cmp_gt_u64_e64 s5, v[14:15], v[30:31]
...
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s1, v[8:9], v[24:25]
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s4, v[10:11], v[26:27]
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s5, v[2:3], v[18:19]
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e32 vcc_lo, v[4:5], v[20:21]
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s0, v[6:7], v[22:23]
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s2, v[0:1], v[16:17]
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v9, v25, v9, s1
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s3, v[12:13], v[28:29]
...
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s0, v[4:5], v[12:13]
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v5, v13, v5, s0
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v4, v12, v4, s0
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_gt_u64_e64 s1, v[14:15], v[30:31]
...
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s1, v[0:1], v[16:17]
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s5, v[8:9], v[24:25]
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e32 vcc_lo, v[10:11], v[26:27]
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s0, v[12:13], v[28:29]
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s2, v[2:3], v[18:19]
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s3, v[4:5], v[20:21]
; GFX11-GISEL-NEXT:    v_cndmask_b32_e64 v0, v16, v0, s1
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s4, v[6:7], v[22:23]
...
; GFX11-GISEL-NEXT:    v_cmp_gt_u64_e64 s1, v[14:15], v[30:31]
...
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s1, v[8:9], v[24:25]
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s4, v[10:11], v[26:27]
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s5, v[2:3], v[18:19]
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e32 vcc_lo, v[4:5], v[20:21]
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s0, v[6:7], v[22:23]
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s2, v[0:1], v[16:17]
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-SDAG-NEXT:    v_cndmask_b32_e64 v9, v25, v9, s1
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s3, v[12:13], v[28:29]
...
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s0, v[4:5], v[12:13]
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX12-SDAG-NEXT:    v_cmp_gt_u64_e64 s1, v[14:15], v[30:31]
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s1, v[0:1], v[16:17]
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s5, v[8:9], v[24:25]
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e32 vcc_lo, v[10:11], v[26:27]
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s0, v[12:13], v[28:29]
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s2, v[2:3], v[18:19]
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s3, v[4:5], v[20:21]
; GFX12-GISEL-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-GISEL-NEXT:    v_cndmask_b32_e64 v0, v16, v0, s1
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s4, v[6:7], v[22:23]
...
; GFX12-GISEL-NEXT:    v_cmp_gt_u64_e64 s1, v[14:15], v[30:31]
; GFX12-GISEL-NEXT:    s_wait_alu depctr_va_sdst(0)
