...
; RUN: opt -mtriple=amdgpu-- -S -structurizecfg -si-annotate-control-flow %s | FileCheck -check-prefix=IR %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 < %s | FileCheck -check-prefix=GCN %s
...
; GCN-NEXT:    buffer_load_dword v0, off, s[0:3], 0 glc
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_cmp_gt_i32_e32 vcc, 9, v0
; GCN-NEXT:    s_cbranch_vccnz .LBB1_2
; GCN-NEXT:  .LBB1_5: ; %bb31
