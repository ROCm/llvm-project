...
define amdgpu_kernel void @loop_mix_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GFX90A-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_64 = V_CMP_NE_U32_e64 [[PHI2]], 0, implicit $exec
  ; GFX90A-NEXT:   SI_BRCOND %bb.5, [[V_CMP_NE_U32_e64_]], implicit-def dead $exec, implicit-def dead $vcc, implicit $exec
  ...
  ; GFX90A-NEXT:   [[S_MOV_B32_5:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GFX90A-NEXT:   [[V_LSHLREV_B32_e64_1:%[0-9]+]]:vgpr_32 = nuw nsw V_LSHLREV_B32_e64 killed [[S_MOV_B32_5]], [[COPY5]], implicit $exec
  ...
  ; GFX1200-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_32 = V_CMP_NE_U32_e64 0, killed [[COPY8]], implicit $exec
  ; GFX1200-NEXT:   SI_BRCOND %bb.6, killed [[V_CMP_NE_U32_e64_]], implicit-def dead $exec, implicit-def dead $vcc_lo, implicit $exec
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI:%[0-9]+]]:sreg_64 = PHI [[COPY2]], %bb.2, %31, %bb.3
  ; GISEL-NEXT:   [[PHI1:%[0-9]+]]:sreg_32 = PHI %81, %bb.3, [[S_MOV_B32_2]], %bb.2
  ; GISEL-NEXT:   [[S_LOAD_DWORD_IMM:%[0-9]+]]:sreg_32_xm0_xexec = S_LOAD_DWORD_IMM [[PHI]], 0, 0 :: ("amdgpu-noclobber" load (i32) from %ir.lsr.iv, addrspace 1)
  ; GISEL-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sreg_32 = S_MOV_B32 7
  ; GISEL-NEXT:   S_CMP_LT_I32 [[S_LOAD_DWORD_IMM]], [[S_MOV_B32_3]], implicit-def $scc
  ; GISEL-NEXT:   [[COPY7:%[0-9]+]]:sreg_32 = COPY $scc
  ; GISEL-NEXT:   [[S_XOR_B32_:%[0-9]+]]:sreg_32 = S_XOR_B32 [[PHI1]], [[COPY7]], implicit-def dead $scc
  ...
  ; GISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 [[S_XOR_B32_]], [[S_MOV_B32_6]], implicit-def dead $scc
  ...
  ; GISEL-NEXT:   S_CMP_GT_I32 [[S_LOAD_DWORD_IMM]], [[S_MOV_B32_7]], implicit-def $scc
  ; GISEL-NEXT:   [[COPY8:%[0-9]+]]:sreg_32 = COPY $scc
  ; GISEL-NEXT:   [[S_MOV_B64_:%[0-9]+]]:sreg_64 = S_MOV_B64 64
  ; GISEL-NEXT:   [[COPY9:%[0-9]+]]:sreg_32 = COPY [[PHI]].sub0
  ; GISEL-NEXT:   [[COPY10:%[0-9]+]]:sreg_32 = COPY [[S_MOV_B64_]].sub0
  ; GISEL-NEXT:   [[COPY11:%[0-9]+]]:sreg_32 = COPY [[PHI]].sub1
  ; GISEL-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[S_MOV_B64_]].sub1
  ; GISEL-NEXT:   [[S_ADD_U32_:%[0-9]+]]:sreg_32 = S_ADD_U32 [[COPY9]], [[COPY10]], implicit-def $scc
  ; GISEL-NEXT:   [[S_ADDC_U32_:%[0-9]+]]:sreg_32 = S_ADDC_U32 [[COPY11]], [[COPY12]], implicit-def dead $scc, implicit $scc
  ; GISEL-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sreg_64_xexec = REG_SEQUENCE [[S_ADD_U32_]], %subreg.sub0, [[S_ADDC_U32_]], %subreg.sub1
  ; GISEL-NEXT:   $scc = COPY [[COPY8]]
  ; GISEL-NEXT:   S_CBRANCH_SCC1 %bb.3, implicit $scc
  ...
  ; GISEL-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_8]]
  ; GISEL-NEXT:   [[V_LSHLREV_B32_e64_:%[0-9]+]]:vgpr_32 = nuw nsw V_LSHLREV_B32_e64 [[COPY13]], [[V_AND_B32_e64_]], implicit $exec
  ; GISEL-NEXT:   [[COPY14:%[0-9]+]]:sreg_64_xexec_xnull = COPY [[COPY2]]
  ; GISEL-NEXT:   [[GLOBAL_LOAD_DWORD_SADDR:%[0-9]+]]:vgpr_32 = GLOBAL_LOAD_DWORD_SADDR [[COPY14]], [[V_LSHLREV_B32_e64_]], 0, 0, implicit $exec :: (load (i32) from %ir.arrayidx7, addrspace 1)
  ; GISEL-NEXT:   [[S_MOV_B32_9:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_9]]
  ; GISEL-NEXT:   [[V_CMP_GT_I32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_GT_I32_e64 [[GLOBAL_LOAD_DWORD_SADDR]], [[COPY15]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_10:%[0-9]+]]:sreg_32 = S_MOV_B32 -1
  ; GISEL-NEXT:   [[S_MOV_B32_11:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_10]]
  ; GISEL-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_11]]
  ; GISEL-NEXT:   [[V_CNDMASK_B32_e64_:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, [[COPY17]], 0, [[COPY16]], [[V_CMP_GT_I32_e64_]], implicit $exec
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.5.if.end:
  ; GISEL-NEXT:   successors: %bb.6(0x40000000), %bb.7(0x40000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI2:%[0-9]+]]:vgpr_32 = PHI [[V_CNDMASK_B32_e64_]], %bb.4, [[S_CSELECT_B32_]], %bb.3
  ; GISEL-NEXT:   [[S_MOV_B32_12:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY18:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_12]]
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 [[PHI2]], [[COPY18]], implicit $exec
  ; GISEL-NEXT:   [[COPY19:%[0-9]+]]:sreg_32_xm0_xexec = COPY $exec_lo
  ; GISEL-NEXT:   [[S_XOR_B32_1:%[0-9]+]]:sreg_32_xm0_xexec = S_XOR_B32 [[V_CMP_NE_U32_e64_]], [[COPY19]], implicit-def dead $scc
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[COPY20:%[0-9]+]]:sreg_64 = COPY [[S_LOAD_DWORDX4_IMM]].sub0_sub1
  ; GISEL-NEXT:   [[COPY21:%[0-9]+]]:sreg_64 = COPY [[S_LOAD_DWORDX4_IMM]].sub2_sub3
  ; GISEL-NEXT:   [[COPY22:%[0-9]+]]:sreg_64_xexec_xnull = COPY [[COPY21]]
  ; GISEL-NEXT:   [[S_MOV_B32_13:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY23:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_13]]
  ; GISEL-NEXT:   [[V_LSHLREV_B32_e64_1:%[0-9]+]]:vgpr_32 = nuw nsw V_LSHLREV_B32_e64 [[COPY23]], [[V_AND_B32_e64_]], implicit $exec
  ; GISEL-NEXT:   GLOBAL_STORE_DWORD_SADDR [[V_LSHLREV_B32_e64_1]], [[V_AND_B32_e64_]], [[COPY22]], 0, 0, implicit $exec :: (store (i32) into %ir.arrayidx13, addrspace 1)
  ; GISEL-NEXT: {{  $}}
