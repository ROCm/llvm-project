...
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -verify-machineinstrs -stop-after=finalize-isel -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GISEL %s
...
define amdgpu_kernel void @loop_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GFX90A-NEXT: {{  $}}
  ; GFX90A-NEXT:   [[PHI:%[0-9]+]]:vreg_64_align2 = PHI [[COPY12]], %bb.1, %64, %bb.2
  ; GFX90A-NEXT:   [[PHI1:%[0-9]+]]:vgpr_32 = PHI [[V_CNDMASK_B32_e64_]], %bb.1, %69, %bb.2
  ; GFX90A-NEXT:   [[PHI2:%[0-9]+]]:vgpr_32 = PHI [[COPY5]], %bb.1, %65, %bb.2
  ...
  ; GFX90A-NEXT:   [[V_CMP_NE_U32_e64_1:%[0-9]+]]:sreg_64 = V_CMP_NE_U32_e64 [[PHI3]], 0, implicit $exec
  ; GFX90A-NEXT:   SI_BRCOND %bb.5, [[V_CMP_NE_U32_e64_1]], implicit-def dead $exec, implicit-def dead $vcc, implicit $exec
  ...
  ; GFX90A-NEXT:   [[V_LSHLREV_B64_e64_:%[0-9]+]]:vreg_64_align2 = nsw V_LSHLREV_B64_e64 killed [[S_MOV_B32_7]], killed [[REG_SEQUENCE5]], implicit $exec
  ...
  ; GFX1200-NEXT:   [[PHI1:%[0-9]+]]:vgpr_32 = PHI [[V_CNDMASK_B32_e64_]], %bb.1, %55, %bb.2
  ...
  ; GFX1200-NEXT:   [[V_CMP_NE_U32_e64_1:%[0-9]+]]:sreg_32 = V_CMP_NE_U32_e64 [[PHI3]], 0, implicit $exec
  ; GFX1200-NEXT:   SI_BRCOND %bb.5, [[V_CMP_NE_U32_e64_1]], implicit-def dead $exec, implicit-def dead $vcc_lo, implicit $exec
  ...
  ; GFX1200-NEXT:   [[V_LSHLREV_B64_pseudo_e64_:%[0-9]+]]:vreg_64 = nsw V_LSHLREV_B64_pseudo_e64 killed [[S_MOV_B32_8]], killed [[REG_SEQUENCE5]], implicit $exec
  ...
  ; GISEL: bb.1.entry:
  ; GISEL-NEXT:   successors: %bb.2(0x40000000), %bb.4(0x40000000)
  ...
  ; GISEL-NEXT:   [[V_CMP_LE_U32_e64_:%[0-9]+]]:sreg_32 = V_CMP_LE_U32_e64 [[V_AND_B32_e64_]], [[COPY5]], implicit $exec
  ; GISEL-NEXT:   [[COPY6:%[0-9]+]]:sreg_32_xm0_xexec = COPY [[V_CMP_LE_U32_e64_]]
  ; GISEL-NEXT:   SI_BRCOND %bb.4, [[COPY6]], implicit-def $exec, implicit-def $vcc_lo, implicit $exec
  ; GISEL-NEXT:   S_BRANCH %bb.2
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.2.do.body.preheader:
  ...
  ; GISEL-NEXT:   [[S_MOV_B32_4:%[0-9]+]]:sreg_32 = S_MOV_B32 -1
  ; GISEL-NEXT:   [[S_MOV_B32_5:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   $scc = COPY [[S_MOV_B32_3]]
  ; GISEL-NEXT:   [[S_CSELECT_B32_:%[0-9]+]]:sreg_32 = S_CSELECT_B32 [[S_MOV_B32_4]], [[S_MOV_B32_5]], implicit $scc
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.3.do.body:
  ; GISEL-NEXT:   successors: %bb.3(0x7c000000), %bb.5(0x04000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI:%[0-9]+]]:vreg_64 = PHI [[REG_SEQUENCE1]], %bb.2, %38, %bb.3
  ; GISEL-NEXT:   [[PHI1:%[0-9]+]]:vgpr_32 = PHI %77, %bb.3, [[S_CSELECT_B32_]], %bb.2
  ; GISEL-NEXT:   [[PHI2:%[0-9]+]]:vgpr_32 = PHI %34, %bb.3, [[V_AND_B32_e64_]], %bb.2
  ; GISEL-NEXT:   [[S_MOV_B32_6:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_6]]
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 [[PHI1]], [[COPY13]], implicit $exec
  ; GISEL-NEXT:   [[GLOBAL_LOAD_DWORD:%[0-9]+]]:vgpr_32 = GLOBAL_LOAD_DWORD [[PHI]], 0, 0, implicit $exec :: (load (i32) from %ir.lsr.iv, addrspace 1)
  ; GISEL-NEXT:   [[S_MOV_B32_7:%[0-9]+]]:sreg_32 = S_MOV_B32 7
  ...
  ; GISEL-NEXT:   [[S_XOR_B32_:%[0-9]+]]:sreg_32_xm0_xexec = S_XOR_B32 [[V_CMP_NE_U32_e64_]], [[V_CMP_LT_I32_e64_]], implicit-def dead $scc
  ; GISEL-NEXT:   [[S_MOV_B32_8:%[0-9]+]]:sreg_32 = S_MOV_B32 -1
  ; GISEL-NEXT:   [[S_MOV_B32_9:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_8]]
  ; GISEL-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_9]]
  ; GISEL-NEXT:   [[V_CNDMASK_B32_e64_:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, [[COPY16]], 0, [[COPY15]], [[S_XOR_B32_]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_10:%[0-9]+]]:sreg_32 = S_MOV_B32 64
  ; GISEL-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_10]]
  ; GISEL-NEXT:   [[V_ADD_U32_e64_:%[0-9]+]]:vgpr_32 = nuw V_ADD_U32_e64 [[PHI2]], [[COPY17]], 0, implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_11:%[0-9]+]]:sreg_32 = S_MOV_B32 11
  ; GISEL-NEXT:   [[COPY18:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_11]]
  ; GISEL-NEXT:   [[V_CMP_GT_I32_e64_:%[0-9]+]]:sreg_32 = V_CMP_GT_I32_e64 [[GLOBAL_LOAD_DWORD]], [[COPY18]], implicit $exec
  ; GISEL-NEXT:   [[COPY19:%[0-9]+]]:sreg_32_xm0_xexec = COPY [[V_CMP_GT_I32_e64_]]
  ; GISEL-NEXT:   [[S_MOV_B:%[0-9]+]]:sreg_64 = S_MOV_B64_IMM_PSEUDO 256
  ; GISEL-NEXT:   [[COPY20:%[0-9]+]]:vreg_64 = COPY [[S_MOV_B]]
  ; GISEL-NEXT:   [[COPY21:%[0-9]+]]:vgpr_32 = COPY [[PHI]].sub0
  ; GISEL-NEXT:   [[COPY22:%[0-9]+]]:vgpr_32 = COPY [[COPY20]].sub0
  ; GISEL-NEXT:   [[COPY23:%[0-9]+]]:vgpr_32 = COPY [[PHI]].sub1
  ; GISEL-NEXT:   [[COPY24:%[0-9]+]]:vgpr_32 = COPY [[COPY20]].sub1
  ; GISEL-NEXT:   [[V_ADD_CO_U32_e64_2:%[0-9]+]]:vgpr_32, [[V_ADD_CO_U32_e64_3:%[0-9]+]]:sreg_32_xm0_xexec = V_ADD_CO_U32_e64 [[COPY21]], [[COPY22]], 0, implicit $exec
  ; GISEL-NEXT:   [[V_ADDC_U32_e64_2:%[0-9]+]]:vgpr_32, dead [[V_ADDC_U32_e64_3:%[0-9]+]]:sreg_32_xm0_xexec = V_ADDC_U32_e64 [[COPY23]], [[COPY24]], killed [[V_ADD_CO_U32_e64_3]], 0, implicit $exec
  ; GISEL-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:vreg_64 = REG_SEQUENCE [[V_ADD_CO_U32_e64_2]], %subreg.sub0, [[V_ADDC_U32_e64_2]], %subreg.sub1
  ; GISEL-NEXT:   SI_BRCOND %bb.3, [[COPY19]], implicit-def $exec, implicit-def $vcc_lo, implicit $exec
  ; GISEL-NEXT:   S_BRANCH %bb.5
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.4.if.else:
  ; GISEL-NEXT:   successors: %bb.5(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[S_MOV_B32_12:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY25:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_12]]
  ; GISEL-NEXT:   [[V_LSHLREV_B32_e64_1:%[0-9]+]]:vgpr_32 = nuw nsw V_LSHLREV_B32_e64 [[COPY25]], [[V_AND_B32_e64_]], implicit $exec
  ; GISEL-NEXT:   [[COPY26:%[0-9]+]]:sreg_64_xexec_xnull = COPY [[COPY2]]
  ; GISEL-NEXT:   [[GLOBAL_LOAD_DWORD_SADDR:%[0-9]+]]:vgpr_32 = GLOBAL_LOAD_DWORD_SADDR [[COPY26]], [[V_LSHLREV_B32_e64_1]], 0, 0, implicit $exec :: (load (i32) from %ir.arrayidx7, addrspace 1)
  ; GISEL-NEXT:   [[S_MOV_B32_13:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY27:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_13]]
  ; GISEL-NEXT:   [[V_CMP_GT_I32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_GT_I32_e64 [[GLOBAL_LOAD_DWORD_SADDR]], [[COPY27]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_14:%[0-9]+]]:sreg_32 = S_MOV_B32 -1
  ; GISEL-NEXT:   [[S_MOV_B32_15:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY28:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_14]]
  ; GISEL-NEXT:   [[COPY29:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_15]]
  ; GISEL-NEXT:   [[V_CNDMASK_B32_e64_1:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, [[COPY29]], 0, [[COPY28]], [[V_CMP_GT_I32_e64_1]], implicit $exec
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.5.if.end:
  ; GISEL-NEXT:   successors: %bb.6(0x40000000), %bb.7(0x40000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI3:%[0-9]+]]:vgpr_32 = PHI [[V_CNDMASK_B32_e64_1]], %bb.4, [[V_CNDMASK_B32_e64_]], %bb.3
  ; GISEL-NEXT:   [[PHI4:%[0-9]+]]:vgpr_32 = PHI [[V_AND_B32_e64_]], %bb.4, [[V_ADD_U32_e64_]], %bb.3
  ; GISEL-NEXT:   [[S_MOV_B32_16:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY30:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_16]]
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 [[PHI3]], [[COPY30]], implicit $exec
  ; GISEL-NEXT:   [[COPY31:%[0-9]+]]:sreg_32_xm0_xexec = COPY $exec_lo
  ; GISEL-NEXT:   [[S_XOR_B32_1:%[0-9]+]]:sreg_32_xm0_xexec = S_XOR_B32 [[V_CMP_NE_U32_e64_1]], [[COPY31]], implicit-def dead $scc
  ; GISEL-NEXT:   SI_BRCOND %bb.7, [[S_XOR_B32_1]], implicit-def $exec, implicit-def $vcc_lo, implicit $exec
  ; GISEL-NEXT:   S_BRANCH %bb.6
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.6.if.then11:
  ; GISEL-NEXT:   successors: %bb.7(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[COPY32:%[0-9]+]]:sreg_64 = COPY [[S_LOAD_DWORDX4_IMM]].sub0_sub1
  ; GISEL-NEXT:   [[COPY33:%[0-9]+]]:sreg_64 = COPY [[S_LOAD_DWORDX4_IMM]].sub2_sub3
  ; GISEL-NEXT:   [[V_MOV_B32_e32_1:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 31, implicit $exec
  ; GISEL-NEXT:   [[V_ASHRREV_I32_e64_:%[0-9]+]]:vgpr_32 = V_ASHRREV_I32_e64 [[V_MOV_B32_e32_1]], [[PHI4]], implicit $exec
  ; GISEL-NEXT:   [[REG_SEQUENCE3:%[0-9]+]]:vreg_64 = REG_SEQUENCE [[PHI4]], %subreg.sub0, [[V_ASHRREV_I32_e64_]], %subreg.sub1
  ; GISEL-NEXT:   [[S_MOV_B32_17:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY34:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_17]]
  ; GISEL-NEXT:   [[V_LSHLREV_B64_pseudo_e64_:%[0-9]+]]:vreg_64 = nsw V_LSHLREV_B64_pseudo_e64 [[COPY34]], [[REG_SEQUENCE3]], implicit $exec
  ; GISEL-NEXT:   [[COPY35:%[0-9]+]]:vreg_64 = COPY [[COPY33]]
  ; GISEL-NEXT:   [[COPY36:%[0-9]+]]:vgpr_32 = COPY [[COPY35]].sub0
  ; GISEL-NEXT:   [[COPY37:%[0-9]+]]:vgpr_32 = COPY [[V_LSHLREV_B64_pseudo_e64_]].sub0
  ; GISEL-NEXT:   [[COPY38:%[0-9]+]]:vgpr_32 = COPY [[COPY35]].sub1
  ; GISEL-NEXT:   [[COPY39:%[0-9]+]]:vgpr_32 = COPY [[V_LSHLREV_B64_pseudo_e64_]].sub1
  ; GISEL-NEXT:   [[V_ADD_CO_U32_e64_4:%[0-9]+]]:vgpr_32, [[V_ADD_CO_U32_e64_5:%[0-9]+]]:sreg_32_xm0_xexec = V_ADD_CO_U32_e64 [[COPY36]], [[COPY37]], 0, implicit $exec
  ; GISEL-NEXT:   [[V_ADDC_U32_e64_4:%[0-9]+]]:vgpr_32, dead [[V_ADDC_U32_e64_5:%[0-9]+]]:sreg_32_xm0_xexec = V_ADDC_U32_e64 [[COPY38]], [[COPY39]], killed [[V_ADD_CO_U32_e64_5]], 0, implicit $exec
  ; GISEL-NEXT:   [[REG_SEQUENCE4:%[0-9]+]]:vreg_64 = REG_SEQUENCE [[V_ADD_CO_U32_e64_4]], %subreg.sub0, [[V_ADDC_U32_e64_4]], %subreg.sub1
  ; GISEL-NEXT:   GLOBAL_STORE_DWORD [[REG_SEQUENCE4]], [[PHI4]], 0, 0, implicit $exec :: (store (i32) into %ir.arrayidx13, addrspace 1)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.7.if.end14:
