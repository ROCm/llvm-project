...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GCN,SDAG,GCN-IEEE,SDAG-IEEE %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GCN,GISEL,GCN-IEEE,GISEL-IEEE %s

; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GCN,SDAG,GCN-DAZ,SDAG-DAZ %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GCN,GISEL,GCN-DAZ,GISEL-DAZ %s
...
; SDAG-IEEE-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x9
...
; SDAG-IEEE-NEXT:    v_cmp_class_f32_e32 vcc, v0, v2
; SDAG-IEEE-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; SDAG-IEEE-NEXT:    buffer_store_dword v0, off, s[8:11], 0
...
; SDAG-DAZ-NEXT:    s_load_dword s4, s[4:5], 0xb
; SDAG-DAZ-NEXT:    v_mov_b32_e32 v0, 0xf800000
; SDAG-DAZ-NEXT:    v_mov_b32_e32 v1, 0x4f800000
; SDAG-DAZ-NEXT:    s_mov_b32 s3, 0xf000
; SDAG-DAZ-NEXT:    s_mov_b32 s2, -1
; SDAG-DAZ-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-DAZ-NEXT:    v_mul_f32_e32 v1, s4, v1
; SDAG-DAZ-NEXT:    v_mov_b32_e32 v2, s4
; SDAG-DAZ-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
; SDAG-DAZ-NEXT:    v_cndmask_b32_e32 v0, v2, v1, vcc
; SDAG-DAZ-NEXT:    v_rsq_f32_e32 v1, v0
; SDAG-DAZ-NEXT:    v_mul_f32_e32 v2, v0, v1
...
; SDAG-IEEE-NEXT:    v_mov_b32_e32 v3, s3
...
; SDAG-IEEE-NEXT:    v_mov_b32_e32 v5, s2
