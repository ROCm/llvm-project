...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu8.02 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX8DAGISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX9DAGISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10DAGISEL,GFX1064DAGISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel=0 < %s | FileCheck -check-prefixes=GFX10DAGISEL,GFX1032DAGISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -mattr=-real-true16 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164DAGISEL,GFX1164DAGISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -mattr=-real-true16 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1132DAGISEL,GFX1132DAGISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -mattr=+real-true16 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164DAGISEL,GFX1164DAGISEL-TRUE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00 -mattr=+real-true16 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1132DAGISEL,GFX1132DAGISEL-TRUE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.00 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12DAGISEL %s
