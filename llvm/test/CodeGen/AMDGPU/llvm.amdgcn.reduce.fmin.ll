...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12DAGISEL %s
...
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v4, s10
; GFX8DAGISEL-NEXT:    s_bitset0_b64 s[6:7], s9
; GFX8DAGISEL-NEXT:    v_min_f32_e32 v4, s8, v4
...
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v4, s10
; GFX9DAGISEL-NEXT:    s_bitset0_b64 s[6:7], s9
; GFX9DAGISEL-NEXT:    v_min_f32_e32 v4, s8, v4
...
; GFX9DAGISEL-NEXT:    s_or_b64 exec, exec, s[6:7]
...
; GFX1064DAGISEL-NEXT:  .LBB6_1: ; %else
...
; GFX1064DAGISEL-NEXT:    v_min_f32_e64 v4, s8, s10
...
; GFX1064DAGISEL-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GFX1064DAGISEL-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1064DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1064DAGISEL-NEXT:    s_cbranch_execz .LBB6_8
; GFX1064DAGISEL-NEXT:  .LBB6_5: ; %if
; GFX1064DAGISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX1064DAGISEL-NEXT:    s_mov_b32 s8, 0x7fc00000
; GFX1064DAGISEL-NEXT:  .LBB6_6: ; =>This Inner Loop Header: Depth=1
; GFX1064DAGISEL-NEXT:    s_ff1_i32_b64 s9, s[4:5]
; GFX1064DAGISEL-NEXT:    v_readlane_b32 s10, v3, s9
; GFX1064DAGISEL-NEXT:    s_bitset0_b64 s[4:5], s9
; GFX1064DAGISEL-NEXT:    s_cmp_lg_u64 s[4:5], 0
...
; GFX1064DAGISEL-NEXT:    s_or_b64 exec, exec, s[6:7]
...
; GFX1064GISEL-NEXT:    v_min_f32_e64 v4, s8, s10
...
; GFX1032DAGISEL-NEXT:  .LBB6_1: ; %else
...
; GFX1032DAGISEL-NEXT:    v_min_f32_e64 v4, s6, s8
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s6, v4
...
; GFX1032DAGISEL-NEXT:    s_xor_b32 s5, exec_lo, s4
; GFX1032DAGISEL-NEXT:    s_mov_b32 exec_lo, s4
; GFX1032DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1032DAGISEL-NEXT:    s_cbranch_execz .LBB6_8
; GFX1032DAGISEL-NEXT:  .LBB6_5: ; %if
; GFX1032DAGISEL-NEXT:    s_mov_b32 s4, exec_lo
; GFX1032DAGISEL-NEXT:    s_mov_b32 s6, 0x7fc00000
; GFX1032DAGISEL-NEXT:  .LBB6_6: ; =>This Inner Loop Header: Depth=1
; GFX1032DAGISEL-NEXT:    s_ff1_i32_b32 s7, s4
; GFX1032DAGISEL-NEXT:    v_readlane_b32 s8, v3, s7
; GFX1032DAGISEL-NEXT:    s_bitset0_b32 s4, s7
; GFX1032DAGISEL-NEXT:    s_cmp_lg_u32 s4, 0
...
; GFX1032DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s5
...
; GFX1164DAGISEL-NEXT:  .LBB6_1: ; %else
...
; GFX1164DAGISEL-NEXT:    v_min_f32_e64 v4, s4, s6
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1164DAGISEL-NEXT:    s_xor_b64 s[2:3], exec, s[0:1]
; GFX1164DAGISEL-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1164DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1164DAGISEL-NEXT:    s_cbranch_execz .LBB6_8
; GFX1164DAGISEL-NEXT:  .LBB6_5: ; %if
; GFX1164DAGISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX1164DAGISEL-NEXT:    s_mov_b32 s4, 0x7fc00000
...
; GFX1164GISEL-NEXT:    s_xor_b64 s[0:1], vcc, exec
...
; GFX1164GISEL-NEXT:    v_min_f32_e64 v4, s4, s6
; GFX1164GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1132DAGISEL-NEXT:  .LBB6_1: ; %else
...
; GFX1132DAGISEL-NEXT:    v_min_f32_e64 v4, s2, s4
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s2, v4
...
; GFX1132DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, s0
; GFX1132DAGISEL-NEXT:    s_mov_b32 exec_lo, s0
; GFX1132DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1132DAGISEL-NEXT:    s_cbranch_execz .LBB6_8
; GFX1132DAGISEL-NEXT:  .LBB6_5: ; %if
; GFX1132DAGISEL-NEXT:    s_mov_b32 s0, exec_lo
; GFX1132DAGISEL-NEXT:    s_mov_b32 s2, 0x7fc00000
; GFX1132DAGISEL-NEXT:  .LBB6_6: ; =>This Inner Loop Header: Depth=1
; GFX1132DAGISEL-NEXT:    s_ctz_i32_b32 s3, s0
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1132DAGISEL-NEXT:    v_readlane_b32 s4, v3, s3
; GFX1132DAGISEL-NEXT:    s_bitset0_b32 s0, s3
; GFX1132DAGISEL-NEXT:    s_cmp_lg_u32 s0, 0
...
; GFX1132GISEL-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
...
; GFX12DAGISEL-NEXT:    v_min_num_f32_e64 v4, s2, s4
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s2, v4
...
; GFX12DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, s0
; GFX12DAGISEL-NEXT:    s_mov_b32 exec_lo, s0
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB6_8
; GFX12DAGISEL-NEXT:  .LBB6_5: ; %if
; GFX12DAGISEL-NEXT:    s_mov_b32 s0, exec_lo
; GFX12DAGISEL-NEXT:    s_mov_b32 s2, 0x7fc00000
; GFX12DAGISEL-NEXT:  .LBB6_6: ; =>This Inner Loop Header: Depth=1
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_ctz_i32_b32 s3, s0
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    v_readlane_b32 s4, v3, s3
; GFX12DAGISEL-NEXT:    s_bitset0_b32 s0, s3
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_cmp_lg_u32 s0, 0
...
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s1
...
; GFX8DAGISEL-NEXT:    v_min_f64 v[6:7], s[10:11], v[6:7]
; GFX8DAGISEL-NEXT:    s_bitset0_b64 s[6:7], s12
; GFX8DAGISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s8, v6
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s9, v7
...
; GFX8DAGISEL-NEXT:  .LBB9_5: ; %if
; GFX8DAGISEL-NEXT:    s_mov_b32 s8, 0
; GFX8DAGISEL-NEXT:    s_mov_b32 s9, 0x7ff80000
; GFX8DAGISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX8DAGISEL-NEXT:  .LBB9_6: ; =>This Inner Loop Header: Depth=1
; GFX8DAGISEL-NEXT:    s_ff1_i32_b64 s12, s[4:5]
...
; GFX8DAGISEL-NEXT:    s_bitset0_b64 s[4:5], s12
; GFX8DAGISEL-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s8, v2
...
; GFX8GISEL-NEXT:    v_min_f64 v[6:7], s[10:11], v[6:7]
; GFX8GISEL-NEXT:    s_bitset0_b64 s[6:7], s12
; GFX8GISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
; GFX8GISEL-NEXT:    v_readfirstlane_b32 s8, v6
; GFX8GISEL-NEXT:    v_readfirstlane_b32 s9, v7
; GFX8GISEL-NEXT:    s_cbranch_scc1 .LBB9_2
; GFX8GISEL-NEXT:  ; %bb.3:
; GFX8GISEL-NEXT:    v_mov_b32_e32 v6, s8
; GFX8GISEL-NEXT:    v_mov_b32_e32 v7, s9
; GFX8GISEL-NEXT:  .LBB9_4:
; GFX8GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8GISEL-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GFX8GISEL-NEXT:    s_mov_b64 exec, s[4:5]
; GFX8GISEL-NEXT:    ; divergent control-flow edge
; GFX8GISEL-NEXT:    s_cbranch_execz .LBB9_8
; GFX8GISEL-NEXT:  .LBB9_5: ; %if
; GFX8GISEL-NEXT:    s_mov_b32 s8, 0
; GFX8GISEL-NEXT:    s_mov_b32 s9, 0x7ff80000
; GFX8GISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX8GISEL-NEXT:  .LBB9_6: ; =>This Inner Loop Header: Depth=1
; GFX8GISEL-NEXT:    s_ff1_i32_b64 s12, s[4:5]
...
; GFX8GISEL-NEXT:    s_bitset0_b64 s[4:5], s12
; GFX8GISEL-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX8GISEL-NEXT:    v_readfirstlane_b32 s8, v2
...
; GFX9DAGISEL-NEXT:    v_min_f64 v[6:7], s[10:11], v[6:7]
; GFX9DAGISEL-NEXT:    s_bitset0_b64 s[6:7], s12
; GFX9DAGISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s8, v6
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s9, v7
...
; GFX9DAGISEL-NEXT:  .LBB9_5: ; %if
; GFX9DAGISEL-NEXT:    s_mov_b32 s8, 0
; GFX9DAGISEL-NEXT:    s_mov_b32 s9, 0x7ff80000
; GFX9DAGISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX9DAGISEL-NEXT:  .LBB9_6: ; =>This Inner Loop Header: Depth=1
; GFX9DAGISEL-NEXT:    s_ff1_i32_b64 s12, s[4:5]
...
; GFX9DAGISEL-NEXT:    s_bitset0_b64 s[4:5], s12
; GFX9DAGISEL-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s8, v2
...
; GFX9GISEL-NEXT:    v_min_f64 v[6:7], s[10:11], v[6:7]
; GFX9GISEL-NEXT:    s_bitset0_b64 s[6:7], s12
; GFX9GISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
; GFX9GISEL-NEXT:    v_readfirstlane_b32 s8, v6
; GFX9GISEL-NEXT:    v_readfirstlane_b32 s9, v7
; GFX9GISEL-NEXT:    s_cbranch_scc1 .LBB9_2
; GFX9GISEL-NEXT:  ; %bb.3:
; GFX9GISEL-NEXT:    v_mov_b32_e32 v6, s8
; GFX9GISEL-NEXT:    v_mov_b32_e32 v7, s9
; GFX9GISEL-NEXT:  .LBB9_4:
; GFX9GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX9GISEL-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GFX9GISEL-NEXT:    s_mov_b64 exec, s[4:5]
; GFX9GISEL-NEXT:    ; divergent control-flow edge
; GFX9GISEL-NEXT:    s_cbranch_execz .LBB9_8
; GFX9GISEL-NEXT:  .LBB9_5: ; %if
; GFX9GISEL-NEXT:    s_mov_b32 s8, 0
; GFX9GISEL-NEXT:    s_mov_b32 s9, 0x7ff80000
; GFX9GISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX9GISEL-NEXT:  .LBB9_6: ; =>This Inner Loop Header: Depth=1
; GFX9GISEL-NEXT:    s_ff1_i32_b64 s12, s[4:5]
...
; GFX9GISEL-NEXT:    s_bitset0_b64 s[4:5], s12
; GFX9GISEL-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX9GISEL-NEXT:    v_readfirstlane_b32 s8, v2
...
; GFX1064DAGISEL-NEXT:  .LBB9_1: ; %else
...
; GFX1064DAGISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
; GFX1064DAGISEL-NEXT:    v_min_f64 v[6:7], s[10:11], s[8:9]
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s8, v6
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s9, v7
...
; GFX1032DAGISEL-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX1032DAGISEL-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX1032DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1032DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX1032DAGISEL-NEXT:  .LBB9_1: ; %else
; GFX1032DAGISEL-NEXT:    s_mov_b32 s4, 0
; GFX1032DAGISEL-NEXT:    s_mov_b32 s5, 0x7ff80000
...
; GFX1032DAGISEL-NEXT:    v_min_f64 v[6:7], s[8:9], s[4:5]
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s4, v6
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s5, v7
...
; GFX1032DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s7
...
; GFX1032GISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s7
...
; GFX1164DAGISEL-NEXT:  .LBB9_1: ; %else
...
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1164DAGISEL-NEXT:    s_cmp_lg_u64 s[2:3], 0
; GFX1164DAGISEL-NEXT:    v_min_f64 v[6:7], s[6:7], s[4:5]
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s4, v6
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s5, v7
...
; GFX1164GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1164GISEL-NEXT:    s_cmp_lg_u64 s[2:3], 0
; GFX1164GISEL-NEXT:    v_min_f64 v[6:7], s[6:7], s[4:5]
; GFX1164GISEL-NEXT:    v_readfirstlane_b32 s4, v6
; GFX1164GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1164GISEL-NEXT:    v_readfirstlane_b32 s5, v7
; GFX1164GISEL-NEXT:    s_cbranch_scc1 .LBB9_2
; GFX1164GISEL-NEXT:  ; %bb.3:
; GFX1164GISEL-NEXT:    v_mov_b32_e32 v7, s5
; GFX1164GISEL-NEXT:    v_mov_b32_e32 v6, s4
; GFX1164GISEL-NEXT:  .LBB9_4:
; GFX1164GISEL-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX1164GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164GISEL-NEXT:    s_xor_b64 s[2:3], exec, s[0:1]
; GFX1164GISEL-NEXT:    s_mov_b64 exec, s[0:1]
...
; GFX1132DAGISEL-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX1132DAGISEL-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX1132DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1132DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX1132DAGISEL-NEXT:  .LBB9_1: ; %else
; GFX1132DAGISEL-NEXT:    s_mov_b32 s0, 0
; GFX1132DAGISEL-NEXT:    s_mov_b32 s1, 0x7ff80000
...
; GFX1132DAGISEL-NEXT:    v_min_f64 v[6:7], s[4:5], s[0:1]
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s0, v6
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s1, v7
...
; GFX1132GISEL-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX1132GISEL-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX1132GISEL-NEXT:    ; divergent control-flow edge
; GFX1132GISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX1132GISEL-NEXT:  .LBB9_1: ; %else
; GFX1132GISEL-NEXT:    s_mov_b32 s0, 0
; GFX1132GISEL-NEXT:    s_mov_b32 s1, 0x7ff80000
...
; GFX12DAGISEL-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX12DAGISEL-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX12DAGISEL-NEXT:  .LBB9_1: ; %else
; GFX12DAGISEL-NEXT:    s_mov_b32 s0, 0
; GFX12DAGISEL-NEXT:    s_mov_b32 s1, 0x7ff80000
...
; GFX12DAGISEL-NEXT:    v_min_num_f64_e64 v[6:7], s[4:5], s[0:1]
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s0, v6
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s1, v7
...
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s3
