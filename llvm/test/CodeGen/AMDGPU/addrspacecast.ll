...
; CI-NEXT:    v_cndmask_b32_e32 v54, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v1
; CI-NEXT:    v_cndmask_b32_e32 v32, 0, v1, vcc
; CI-NEXT:    v_cndmask_b32_e32 v33, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v2
; CI-NEXT:    v_cndmask_b32_e32 v34, 0, v2, vcc
; CI-NEXT:    v_cndmask_b32_e32 v35, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v3
; CI-NEXT:    v_cndmask_b32_e32 v36, 0, v3, vcc
; CI-NEXT:    v_cndmask_b32_e32 v37, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v4
...
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v6
; CI-NEXT:    v_cndmask_b32_e32 v50, 0, v6, vcc
; CI-NEXT:    v_cndmask_b32_e32 v51, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v7
; CI-NEXT:    v_cndmask_b32_e32 v52, 0, v7, vcc
; CI-NEXT:    v_cndmask_b32_e32 v53, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v8
; CI-NEXT:    v_cndmask_b32_e32 v16, 0, v8, vcc
; CI-NEXT:    v_cndmask_b32_e32 v17, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v9
; CI-NEXT:    v_cndmask_b32_e32 v18, 0, v9, vcc
; CI-NEXT:    v_cndmask_b32_e32 v19, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v10
; CI-NEXT:    v_cndmask_b32_e32 v20, 0, v10, vcc
; CI-NEXT:    v_cndmask_b32_e32 v21, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v11
; CI-NEXT:    v_cndmask_b32_e32 v22, 0, v11, vcc
; CI-NEXT:    v_cndmask_b32_e32 v23, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v12
; CI-NEXT:    v_cndmask_b32_e32 v24, 0, v12, vcc
; CI-NEXT:    v_cndmask_b32_e32 v25, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v13
; CI-NEXT:    v_cndmask_b32_e32 v26, 0, v13, vcc
; CI-NEXT:    v_cndmask_b32_e32 v27, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v14
; CI-NEXT:    v_cndmask_b32_e32 v28, 0, v14, vcc
; CI-NEXT:    v_cndmask_b32_e32 v29, 0, v31, vcc
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v15
; CI-NEXT:    v_cndmask_b32_e32 v30, 0, v15, vcc
; CI-NEXT:    v_cndmask_b32_e32 v31, 0, v31, vcc
; CI-NEXT:    v_mov_b32_e32 v1, v54
; CI-NEXT:    v_mov_b32_e32 v2, v32
; CI-NEXT:    v_mov_b32_e32 v3, v33
; CI-NEXT:    v_mov_b32_e32 v4, v34
; CI-NEXT:    v_mov_b32_e32 v5, v35
; CI-NEXT:    v_mov_b32_e32 v6, v36
; CI-NEXT:    v_mov_b32_e32 v7, v37
; CI-NEXT:    v_mov_b32_e32 v8, v38
; CI-NEXT:    v_mov_b32_e32 v9, v39
; CI-NEXT:    v_mov_b32_e32 v10, v48
; CI-NEXT:    v_mov_b32_e32 v11, v49
; CI-NEXT:    v_mov_b32_e32 v12, v50
; CI-NEXT:    v_mov_b32_e32 v13, v51
; CI-NEXT:    v_mov_b32_e32 v14, v52
; CI-NEXT:    v_mov_b32_e32 v15, v53
; CI-NEXT:    s_setpc_b64 s[30:31]
;
