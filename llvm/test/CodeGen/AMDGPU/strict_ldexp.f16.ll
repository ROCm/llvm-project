...
; XUN: llc -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GCN,GFX6,GFX6-SDAG %s
...
; XUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GCN,GFX6,GFX6-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefixes=GCN,GFX8,GFX8-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GCN,GFX11,GFX11-GISEL,GFX11-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GCN,GFX11,GFX11-GISEL,GFX11-GISEL-FAKE16 %s
...
; GFX9-NEXT:    s_movk_i32 s4, 0x8000
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x7fff
; GFX9-NEXT:    v_med3_i32 v1, v3, s4, v0
; GFX9-NEXT:    v_med3_i32 v0, v4, s4, v0
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v2, v1
; GFX9-NEXT:    v_ldexp_f16_sdwa v0, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    s_movk_i32 s0, 0x8000
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v0, v3, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v1, v4, s0, 0x7fff
...
; GFX11-GISEL-FAKE16-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-NEXT:    v_med3_i32 v0, v4, s4, v1
; GFX9-NEXT:    v_med3_i32 v4, v5, s4, v1
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v2, v0
; GFX9-NEXT:    v_ldexp_f16_sdwa v2, v2, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    s_mov_b32 s5, 0x5040100
; GFX9-NEXT:    v_med3_i32 v1, v6, s4, v1
; GFX9-NEXT:    v_perm_b32 v0, v2, v0, s5
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v3, v1
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-GISEL-FAKE16-NEXT:    s_movk_i32 s0, 0x8000
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v0, v4, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v1, v5, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v2
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v0, v2, v0
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v2, v6, s0, 0x7fff
...
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v1, v3, v2
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-NEXT:    s_movk_i32 s4, 0x8000
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x7fff
; GFX9-NEXT:    v_med3_i32 v1, v6, s4, v0
; GFX9-NEXT:    v_med3_i32 v6, v7, s4, v0
; GFX9-NEXT:    v_med3_i32 v4, v4, s4, v0
; GFX9-NEXT:    v_med3_i32 v0, v5, s4, v0
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v3, v1
; GFX9-NEXT:    v_ldexp_f16_sdwa v3, v3, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    v_ldexp_f16_e32 v4, v2, v4
; GFX9-NEXT:    v_ldexp_f16_sdwa v0, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    s_mov_b32 s4, 0x5040100
...
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v0, v6, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v1, v7, s0, 0x7fff
...
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v3, v3, v0
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v0, v2, v4
...
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v1, v7, v1
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-FAKE16-NEXT:    v_perm_b32 v0, v2, v0, 0x5040100
; GFX11-GISEL-FAKE16-NEXT:    v_perm_b32 v1, v1, v3, 0x5040100
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
