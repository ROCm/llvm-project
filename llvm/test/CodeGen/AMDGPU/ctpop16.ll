...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu6.00 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -enable-var-scope -check-prefixes=SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu8.02 -mattr=-flat-for-global -global-isel=1 -global-isel-abort=2 < %s | FileCheck -enable-var-scope -check-prefixes=VI-GISEL %s
