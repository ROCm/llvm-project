...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -enable-var-scope -check-prefixes=SI %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=r600 -mcpu=cypress < %s | FileCheck -enable-var-scope -check-prefix=EG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=tahiti -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=SI-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=VI-GISEL %s
...
; SI-NEXT:    buffer_load_dwordx4 v[4:7], v[4:5], s[0:3], 0 addr64
; SI-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 offset:2
...
; VI-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 offset:2
