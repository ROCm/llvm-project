...
; RUN: llc -amdgpu-late-wave-transform=1 -O0 -mtriple=amdgpu9.00- -amdgpu-dpp-combine=false < %s | FileCheck -check-prefix=GFX9-O0 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00- -amdgpu-dpp-combine=false < %s | FileCheck -check-prefix=GFX9-O3 %s
