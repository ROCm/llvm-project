...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck --check-prefixes=SI,GCN,FUNC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02  < %s | FileCheck --check-prefixes=VI,GCN,FUNC %s
