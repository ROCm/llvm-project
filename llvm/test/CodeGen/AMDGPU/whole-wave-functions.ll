...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.00--amdpal < %s | FileCheck --check-prefix=GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.00--amdpal -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL64 %s
...
; GFX1250-DAGISEL:       ; %bb.0:
; GFX1250-DAGISEL-NEXT:    global_prefetch_b8 v0, null scope:SCOPE_SE
