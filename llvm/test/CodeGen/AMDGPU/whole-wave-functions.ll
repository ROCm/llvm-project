...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu12.00--amdpal < %s | FileCheck --check-prefix=DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.00--amdpal < %s | FileCheck --check-prefix=GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu12.00--amdpal -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=DAGISEL64 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu12.50--amdpal < %s | FileCheck --check-prefix=GFX1250-DAGISEL %s
