...
; DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; DAGISEL-NEXT:    s_and_saveexec_b32 s1, s1
...
; DAGISEL64-NEXT:    s_xor_b64 s[2:3], vcc, exec
; DAGISEL64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; DAGISEL64-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX1250-DAGISEL-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1250-DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-DAGISEL-NEXT:    s_and_saveexec_b32 s1, s1
