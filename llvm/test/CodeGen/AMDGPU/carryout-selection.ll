...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -stop-after=amdgpu-isel < %s | FileCheck -enable-var-scope -check-prefixes=GCN-ISEL                %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -stop-after=amdgpu-isel -enable-new-pm < %s | FileCheck -enable-var-scope -check-prefixes=GCN-ISEL                %s
...
; GFX9-NEXT:    s_mul_hi_u32 s11, s3, s4
; GFX9-NEXT:    s_mul_i32 s4, s3, s4
; GFX9-NEXT:    s_add_u32 s4, s9, s4
; GFX9-NEXT:    s_mul_hi_u32 s10, s3, s5
; GFX9-NEXT:    s_addc_u32 s4, s8, s11
...
; GFX1010-NEXT:    s_mul_hi_u32 s10, s8, s5
; GFX1010-NEXT:    s_mul_i32 s11, s8, s5
; GFX1010-NEXT:    s_mul_i32 s8, s8, s4
; GFX1010-NEXT:    s_mul_i32 s9, s9, s5
; GFX1010-NEXT:    s_add_i32 s8, s10, s8
; GFX1010-NEXT:    s_mul_i32 s10, s4, s11
; GFX1010-NEXT:    s_add_i32 s8, s8, s9
; GFX1010-NEXT:    s_mul_hi_u32 s9, s5, s11
; GFX1010-NEXT:    s_mul_i32 s14, s5, s8
; GFX1010-NEXT:    s_mul_hi_u32 s13, s5, s8
; GFX1010-NEXT:    s_add_u32 s9, s9, s14
; GFX1010-NEXT:    s_mul_hi_u32 s12, s4, s11
; GFX1010-NEXT:    s_addc_u32 s13, 0, s13
; GFX1010-NEXT:    s_mul_hi_u32 s11, s4, s8
; GFX1010-NEXT:    s_add_u32 s9, s9, s10
; GFX1010-NEXT:    s_mul_i32 s8, s4, s8
; GFX1010-NEXT:    s_addc_u32 s9, s13, s12
; GFX1010-NEXT:    s_addc_u32 s10, s11, 0
...
; GFX1030W32-NEXT:    s_mul_hi_u32 s10, s8, s7
; GFX1030W32-NEXT:    s_mul_i32 s11, s8, s7
; GFX1030W32-NEXT:    s_mul_i32 s8, s8, s6
; GFX1030W32-NEXT:    s_mul_i32 s9, s9, s7
; GFX1030W32-NEXT:    s_add_i32 s8, s10, s8
; GFX1030W32-NEXT:    s_mul_i32 s10, s6, s11
; GFX1030W32-NEXT:    s_add_i32 s8, s8, s9
; GFX1030W32-NEXT:    s_mul_hi_u32 s9, s7, s11
; GFX1030W32-NEXT:    s_mul_i32 s14, s7, s8
; GFX1030W32-NEXT:    s_mul_hi_u32 s13, s7, s8
; GFX1030W32-NEXT:    s_add_u32 s9, s9, s14
; GFX1030W32-NEXT:    s_mul_hi_u32 s12, s6, s11
; GFX1030W32-NEXT:    s_addc_u32 s13, 0, s13
; GFX1030W32-NEXT:    s_mul_hi_u32 s11, s6, s8
; GFX1030W32-NEXT:    s_add_u32 s9, s9, s10
; GFX1030W32-NEXT:    s_mul_i32 s8, s6, s8
; GFX1030W32-NEXT:    s_addc_u32 s9, s13, s12
; GFX1030W32-NEXT:    s_addc_u32 s10, s11, 0
...
; GFX11-NEXT:    s_mul_hi_u32 s10, s8, s7
; GFX11-NEXT:    s_mul_i32 s11, s8, s7
; GFX11-NEXT:    s_mul_i32 s8, s8, s6
; GFX11-NEXT:    s_mul_i32 s9, s9, s7
; GFX11-NEXT:    s_add_i32 s8, s10, s8
; GFX11-NEXT:    s_mul_i32 s10, s6, s11
; GFX11-NEXT:    s_add_i32 s8, s8, s9
; GFX11-NEXT:    s_mul_hi_u32 s9, s7, s11
; GFX11-NEXT:    s_mul_i32 s14, s7, s8
; GFX11-NEXT:    s_mul_hi_u32 s13, s7, s8
; GFX11-NEXT:    s_add_u32 s9, s9, s14
; GFX11-NEXT:    s_mul_hi_u32 s12, s6, s11
; GFX11-NEXT:    s_addc_u32 s13, 0, s13
; GFX11-NEXT:    s_mul_hi_u32 s11, s6, s8
; GFX11-NEXT:    s_add_u32 s9, s9, s10
; GFX11-NEXT:    s_mul_i32 s8, s6, s8
; GFX11-NEXT:    s_addc_u32 s9, s13, s12
; GFX11-NEXT:    s_addc_u32 s10, s11, 0
