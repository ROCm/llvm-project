...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti -amdgpu-remove-redundant-endcf -amdgpu-codegenprepare-break-large-phis=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s

; Disabled endcf collapse at -O0.
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti -O0 -amdgpu-remove-redundant-endcf -amdgpu-codegenprepare-break-large-phis=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN-O0 %s
...
; GCN-O0-NEXT:    buffer_store_dword v1, off, s[16:19], 0 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b32 s0, 1
; GCN-O0-NEXT:    v_cmp_gt_u32_e64 s[0:1], v0, s0
; GCN-O0-NEXT:    s_mov_b64 s[2:3], -1
; GCN-O0-NEXT:    s_xor_b64 s[0:1], s[0:1], s[2:3]
; GCN-O0-NEXT:    s_and_b64 s[2:3], exec, s[0:1]
; GCN-O0-NEXT:    s_xor_b64 s[0:1], s[0:1], -1
; GCN-O0-NEXT:    s_mov_b64 s[2:3], 0
...
; GCN-O0-NEXT:    buffer_store_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:    s_mov_b64 exec, s[0:1]
; GCN-O0-NEXT:    s_mov_b64 s[0:1], 0
...
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
...
; GCN-O0-NEXT:    v_readlane_b32 s8, v4, 0
; GCN-O0-NEXT:    v_readlane_b32 s9, v4, 1
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    v_writelane_b32 v4, s4, 6
; GCN-O0-NEXT:    v_writelane_b32 v4, s5, 7
; GCN-O0-NEXT:    buffer_load_dword v0, off, s[16:19], 0 ; 4-byte Folded Reload
...
; GCN-O0-NEXT:    ; kill: def $sgpr8_sgpr9 killed $sgpr8_sgpr9 def $sgpr8_sgpr9_sgpr10_sgpr11
...
; GCN-O0-NEXT:    buffer_store_dword v1, v[2:3], s[8:11], 0 addr64
; GCN-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, s4
; GCN-O0-NEXT:    s_xor_b64 s[4:5], s[4:5], exec
...
; GCN-O0-NEXT:    buffer_store_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:    buffer_load_dword v1, off, s[16:19], 0 ; 4-byte Folded Reload
...
; GCN-O0-NEXT:  .LBB0_3: ; %bb.outer.end
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
...
; GCN-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GCN-NEXT:    s_or_b64 s[10:11], s[10:11], s[0:1]
; GCN-NEXT:    s_xor_b64 s[0:1], exec, s[10:11]
...
; GCN-O0-NEXT:    v_readlane_b32 s9, v4, 1
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    v_writelane_b32 v4, s4, 8
; GCN-O0-NEXT:    v_writelane_b32 v4, s5, 9
; GCN-O0-NEXT:    buffer_load_dword v0, off, s[16:19], 0 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b32 s6, 0xf000
; GCN-O0-NEXT:    s_mov_b32 s4, 0
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_sgpr5
...
; GCN-O0-NEXT:    s_mov_b64 s[2:3], s[4:5]
; GCN-O0-NEXT:    buffer_store_dword v0, v[1:2], s[0:3], 0 addr64
; GCN-O0-NEXT:  .LBB1_3: ; %bb.inner.end
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
...
; GCN-O0-NEXT:    buffer_store_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:  .LBB1_4: ; %bb.outer.end
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
...
; GCN-NEXT:    s_xor_b64 s[2:3], exec, s[10:11]
; GCN-NEXT:    s_mov_b64 s[12:13], 0
; GCN-NEXT:    s_mov_b64 exec, s[10:11]
; GCN-NEXT:    s_mov_b64 s[10:11], 0
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execz .LBB2_5
; GCN-NEXT:  .LBB2_1: ; %bb.outer.then
...
; GCN-NEXT:    s_xor_b64 s[0:1], exec, s[8:9]
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
...
; GCN-NEXT:    s_mov_b64 s[0:1], 0
; GCN-NEXT:    buffer_store_dword v3, v[0:1], s[4:7], 0 addr64 offset:8
...
; GCN-O0-NEXT:    v_mov_b32_e32 v1, v0
; GCN-O0-NEXT:    buffer_store_dword v1, off, s[12:15], 0 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b32 s2, 0xf000
; GCN-O0-NEXT:    s_mov_b32 s4, 0
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_sgpr5
; GCN-O0-NEXT:    s_mov_b32 s5, s2
...
; GCN-O0-NEXT:    s_xor_b64 s[2:3], exec, s[0:1]
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    v_writelane_b32 v4, s2, 8
; GCN-O0-NEXT:    v_writelane_b32 v4, s3, 9
...
; GCN-O0-NEXT:    v_readlane_b32 s0, v4, 2
; GCN-O0-NEXT:    v_readlane_b32 s1, v4, 3
; GCN-O0-NEXT:    v_readlane_b32 s2, v4, 6
; GCN-O0-NEXT:    v_readlane_b32 s3, v4, 7
; GCN-O0-NEXT:    v_readlane_b32 s4, v4, 4
; GCN-O0-NEXT:    v_readlane_b32 s5, v4, 5
; GCN-O0-NEXT:    s_mov_b64 s[6:7], 0
; GCN-O0-NEXT:    v_writelane_b32 v4, s6, 10
; GCN-O0-NEXT:    v_writelane_b32 v4, s7, 11
; GCN-O0-NEXT:    buffer_load_dword v0, off, s[12:15], 0 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b32 s6, 2
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_cmp_eq_u32_e64 s[6:7], v0, s6
; GCN-O0-NEXT:    s_mov_b64 s[8:9], -1
; GCN-O0-NEXT:    s_xor_b64 s[6:7], s[6:7], s[8:9]
; GCN-O0-NEXT:    s_and_b64 s[8:9], exec, s[6:7]
; GCN-O0-NEXT:    s_xor_b64 s[8:9], s[6:7], -1
; GCN-O0-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; GCN-O0-NEXT:    s_or_b64 s[0:1], s[0:1], s[8:9]
; GCN-O0-NEXT:    s_and_b64 s[6:7], exec, s[6:7]
; GCN-O0-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN-O0-NEXT:    v_writelane_b32 v4, s4, 4
; GCN-O0-NEXT:    v_writelane_b32 v4, s5, 5
; GCN-O0-NEXT:    s_xor_b64 s[4:5], exec, s[0:1]
; GCN-O0-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-O0-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; GCN-O0-NEXT:    v_writelane_b32 v4, s2, 6
...
; GCN-O0-NEXT:    s_mov_b64 exec, s[10:11]
; GCN-O0-NEXT:    ; divergent control-flow edge
; GCN-O0-NEXT:    s_cbranch_execz .LBB2_3
; GCN-O0-NEXT:  .LBB2_2: ; %bb.then
; GCN-O0-NEXT:    s_or_saveexec_b64 s[10:11], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[10:11]
...
; GCN-O0-NEXT:    s_mov_b64 exec, s[10:11]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s4, v4, 6
; GCN-O0-NEXT:    v_readlane_b32 s5, v4, 7
; GCN-O0-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-O0-NEXT:    v_readlane_b32 s0, v4, 4
; GCN-O0-NEXT:    v_readlane_b32 s1, v4, 5
; GCN-O0-NEXT:    v_readlane_b32 s2, v4, 8
; GCN-O0-NEXT:    v_readlane_b32 s3, v4, 9
; GCN-O0-NEXT:    s_xor_b64 s[4:5], exec, s[0:1]
; GCN-O0-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-O0-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; GCN-O0-NEXT:    v_writelane_b32 v4, s2, 8
...
; GCN-O0-NEXT:    s_mov_b64 s[2:3], s[4:5]
; GCN-O0-NEXT:    buffer_store_dword v0, v[1:2], s[0:3], 0 addr64
; GCN-O0-NEXT:  .LBB2_5: ; %bb.outer.end
; GCN-O0-NEXT:    s_or_saveexec_b64 s[10:11], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[10:11]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s0, v4, 8
; GCN-O0-NEXT:    v_readlane_b32 s1, v4, 9
; GCN-O0-NEXT:    s_or_b64 exec, exec, s[0:1]
; GCN-O0-NEXT:    v_mov_b32_e32 v1, 3
; GCN-O0-NEXT:    v_mov_b32_e32 v0, 0
; GCN-O0-NEXT:    s_mov_b32 m0, -1
...
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, 0
; GCN-NEXT:    v_cmp_gt_u32_e64 s[8:9], 2, v0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v2, s1
; GCN-NEXT:    v_add_i32_e32 v1, vcc, s0, v3
; GCN-NEXT:    buffer_store_dword v4, v[3:4], s[0:3], 0 addr64
; GCN-NEXT:    s_xor_b64 s[0:1], s[8:9], exec
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:    v_addc_u32_e32 v2, vcc, 0, v2, vcc
...
; GCN-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GCN-NEXT:    s_or_b64 s[12:13], s[12:13], s[0:1]
; GCN-NEXT:    s_xor_b64 s[0:1], exec, s[12:13]
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_or_b64 s[10:11], s[10:11], s[0:1]
...
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execz .LBB3_3
; GCN-NEXT:  .LBB3_2: ; %bb.inner.then
; GCN-NEXT:    s_mov_b32 s14, 0
; GCN-NEXT:    s_mov_b32 s15, 0xf000
; GCN-NEXT:    s_mov_b32 s12, s14
; GCN-NEXT:    s_mov_b32 s13, s14
; GCN-NEXT:    v_mov_b32_e32 v0, 2
; GCN-NEXT:    s_mov_b64 s[0:1], 0
; GCN-NEXT:    buffer_store_dword v0, v[1:2], s[12:15], 0 addr64 offset:8
; GCN-NEXT:  .LBB3_3:
; GCN-NEXT:    s_or_b64 exec, exec, s[10:11]
; GCN-NEXT:    s_xor_b64 s[0:1], exec, s[8:9]
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_or_b64 s[4:5], s[4:5], s[0:1]
; GCN-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-NEXT:    s_mov_b64 s[0:1], 0
; GCN-NEXT:    s_mov_b64 s[0:1], 0
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execz .LBB3_6
; GCN-NEXT:  .LBB3_4: ; %bb.outer.else
; GCN-NEXT:    s_mov_b64 s[0:1], 0
; GCN-NEXT:    s_mov_b32 s0, s2
; GCN-NEXT:    s_mov_b32 s1, s2
; GCN-NEXT:    s_waitcnt expcnt(0)
...
; GCN-O0-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GCN-O0-NEXT:    v_mov_b32_e32 v1, v0
; GCN-O0-NEXT:    buffer_store_dword v1, off, s[16:19], 0 offset:8 ; 4-byte Folded Spill
; GCN-O0-NEXT:    v_ashrrev_i32_e64 v3, 31, v0
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    v_mov_b32_e32 v1, v0
; GCN-O0-NEXT:    v_mov_b32_e32 v2, v3
...
; GCN-O0-NEXT:    buffer_store_dword v4, off, s[16:19], 0 ; 4-byte Folded Spill
; GCN-O0-NEXT:    buffer_store_dword v5, off, s[16:19], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b32 s2, 0xf000
; GCN-O0-NEXT:    s_mov_b32 s4, 0
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_sgpr5
; GCN-O0-NEXT:    s_mov_b32 s5, s2
...
; GCN-O0-NEXT:    s_and_b64 s[0:1], exec, s[2:3]
; GCN-O0-NEXT:    s_xor_b64 s[0:1], s[2:3], -1
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
...
; GCN-O0-NEXT:    s_and_b64 s[2:3], exec, s[2:3]
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
...
; GCN-O0-NEXT:    s_mov_b64 s[2:3], 0
; GCN-O0-NEXT:    v_writelane_b32 v6, s2, 8
; GCN-O0-NEXT:    v_writelane_b32 v6, s3, 9
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    buffer_store_dword v6, off, s[16:19], 0 offset:12 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:    s_mov_b64 exec, s[0:1]
; GCN-O0-NEXT:    s_mov_b64 s[0:1], 0
; GCN-O0-NEXT:    ; divergent control-flow edge
; GCN-O0-NEXT:    s_cbranch_execz .LBB3_3
; GCN-O0-NEXT:  .LBB3_1: ; %bb.outer.then
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v6, off, s[16:19], 0 offset:12 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s0, v6, 0
; GCN-O0-NEXT:    v_readlane_b32 s1, v6, 1
; GCN-O0-NEXT:    v_readlane_b32 s2, v6, 6
; GCN-O0-NEXT:    v_readlane_b32 s3, v6, 7
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    v_writelane_b32 v6, s4, 10
; GCN-O0-NEXT:    v_writelane_b32 v6, s5, 11
; GCN-O0-NEXT:    buffer_load_dword v0, off, s[16:19], 0 offset:8 ; 4-byte Folded Reload
; GCN-O0-NEXT:    buffer_load_dword v2, off, s[16:19], 0 ; 4-byte Folded Reload
; GCN-O0-NEXT:    buffer_load_dword v3, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
...
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    buffer_store_dword v1, v[2:3], s[4:7], 0 addr64 offset:4
; GCN-O0-NEXT:    s_mov_b32 s4, 2
; GCN-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, s4
; GCN-O0-NEXT:    s_mov_b64 s[6:7], -1
; GCN-O0-NEXT:    s_xor_b64 s[4:5], s[4:5], s[6:7]
; GCN-O0-NEXT:    s_and_b64 s[6:7], exec, s[4:5]
; GCN-O0-NEXT:    s_xor_b64 s[4:5], s[4:5], -1
; GCN-O0-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-O0-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GCN-O0-NEXT:    s_xor_b64 s[4:5], exec, s[0:1]
; GCN-O0-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GCN-O0-NEXT:    ; divergent control-flow edge
; GCN-O0-NEXT:    s_cbranch_execz .LBB3_3
; GCN-O0-NEXT:  .LBB3_2: ; %bb.inner.then
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v6, off, s[16:19], 0 offset:12 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
...
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:    buffer_load_dword v1, off, s[16:19], 0 ; 4-byte Folded Reload
; GCN-O0-NEXT:    buffer_load_dword v2, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
...
; GCN-O0-NEXT:    v_readlane_b32 s2, v6, 8
; GCN-O0-NEXT:    v_readlane_b32 s3, v6, 9
; GCN-O0-NEXT:    s_xor_b64 s[4:5], exec, s[0:1]
; GCN-O0-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-O0-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; GCN-O0-NEXT:    v_writelane_b32 v6, s2, 8
...
; GCN-O0-NEXT:    buffer_load_dword v2, off, s[16:19], 0 ; 4-byte Folded Reload
; GCN-O0-NEXT:    buffer_load_dword v3, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b32 s5, 0xf000
; GCN-O0-NEXT:    s_mov_b32 s4, 0
...
; GCN-O0-NEXT:    v_mov_b32_e32 v1, 3
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    buffer_store_dword v1, v[2:3], s[8:11], 0 addr64 offset:12
; GCN-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, s4
; GCN-O0-NEXT:    s_mov_b64 s[6:7], -1
; GCN-O0-NEXT:    s_xor_b64 s[4:5], s[4:5], s[6:7]
; GCN-O0-NEXT:    s_and_b64 s[6:7], exec, s[4:5]
...
; GCN-O0-NEXT:  .LBB3_6: ; %bb.outer.end
; GCN-O0-NEXT:    s_or_saveexec_b64 s[12:13], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v6, off, s[16:19], 0 offset:12 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s0, v6, 8
; GCN-O0-NEXT:    v_readlane_b32 s1, v6, 9
; GCN-O0-NEXT:    s_or_b64 exec, exec, s[0:1]
; GCN-O0-NEXT:    v_mov_b32_e32 v1, 3
; GCN-O0-NEXT:    v_mov_b32_e32 v0, 0
; GCN-O0-NEXT:    s_mov_b32 m0, -1
...
; GCN-O0-NEXT:    s_mov_b64 s[2:3], 0
; GCN-O0-NEXT:    v_writelane_b32 v3, s2, 4
; GCN-O0-NEXT:    v_writelane_b32 v3, s3, 5
; GCN-O0-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GCN-O0-NEXT:    buffer_store_dword v3, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[6:7]
; GCN-O0-NEXT:    buffer_load_dword v0, off, s[12:15], 0 ; 4-byte Folded Reload
...
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    v_cmp_ne_u32_e64 s[4:5], 1, v0
; GCN-NEXT:    s_mov_b64 s[8:9], 0
; GCN-NEXT:    s_mov_b64 s[10:11], 0
; GCN-NEXT:    s_mov_b64 s[12:13], 0
...
; GCN-NEXT:    s_and_b64 s[24:25], exec, vcc
; GCN-NEXT:    s_mov_b64 s[6:7], 0
...
; GCN-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-NEXT:    s_or_b64 s[22:23], s[22:23], s[6:7]
; GCN-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-NEXT:    s_mov_b64 s[8:9], 0
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execz .LBB5_8
; GCN-NEXT:  .LBB5_2: ; %bb2
; GCN-NEXT:    ; in Loop: Header=BB5_1 Depth=1
; GCN-NEXT:    s_and_b64 s[6:7], exec, s[4:5]
; GCN-NEXT:    s_xor_b64 s[6:7], s[4:5], -1
; GCN-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-NEXT:    s_or_b64 s[10:11], s[10:11], s[6:7]
; GCN-NEXT:    s_and_b64 s[6:7], exec, s[4:5]
; GCN-NEXT:    s_or_b64 s[14:15], s[14:15], s[6:7]
...
; GCN-NEXT:    v_cmp_ngt_f32_e64 s[6:7], 0, v0
; GCN-NEXT:    s_xor_b64 s[6:7], s[6:7], exec
; GCN-NEXT:    s_or_b64 s[12:13], s[12:13], s[6:7]
; GCN-NEXT:    s_xor_b64 s[6:7], exec, s[12:13]
; GCN-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-NEXT:    s_or_b64 s[20:21], s[20:21], s[6:7]
; GCN-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-NEXT:    s_mov_b64 s[12:13], 0
...
; GCN-NEXT:  .LBB5_5: ; in Loop: Header=BB5_1 Depth=1
; GCN-NEXT:    s_or_b64 exec, exec, s[20:21]
; GCN-NEXT:    s_xor_b64 s[6:7], exec, s[14:15]
; GCN-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GCN-NEXT:  .LBB5_6: ; in Loop: Header=BB5_1 Depth=1
; GCN-NEXT:    v_mov_b32_e32 v5, v4
; GCN-NEXT:    v_mov_b32_e32 v4, v3
; GCN-NEXT:    v_mov_b32_e32 v3, v2
; GCN-NEXT:    v_mov_b32_e32 v2, v1
; GCN-NEXT:  .LBB5_7: ; %bb10
; GCN-NEXT:    ; in Loop: Header=BB5_1 Depth=1
; GCN-NEXT:    s_or_b64 exec, exec, s[18:19]
; GCN-NEXT:    s_and_b64 s[6:7], exec, s[4:5]
; GCN-NEXT:    s_or_b64 s[24:25], s[24:25], s[6:7]
; GCN-NEXT:    s_mov_b64 s[18:19], 0
; GCN-NEXT:  .LBB5_8: ; in Loop: Header=BB5_1 Depth=1
; GCN-NEXT:    s_or_b64 exec, exec, s[22:23]
; GCN-NEXT:    s_xor_b64 s[6:7], exec, s[24:25]
; GCN-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-NEXT:    s_or_b64 s[16:17], s[16:17], s[6:7]
; GCN-NEXT:    s_mov_b64 exec, s[24:25]
; GCN-NEXT:    s_mov_b64 s[22:23], 0
; GCN-NEXT:    s_mov_b64 s[6:7], 0
; GCN-NEXT:    ; divergent control-flow edge
; GCN-NEXT:    s_cbranch_execnz .LBB5_1
; GCN-NEXT:  .LBB5_9: ; %bb12
...
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    v_writelane_b32 v7, s4, 18
; GCN-O0-NEXT:    v_writelane_b32 v7, s5, 19
; GCN-O0-NEXT:    s_or_saveexec_b64 s[14:15], -1
; GCN-O0-NEXT:    buffer_store_dword v7, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
; GCN-O0-NEXT:  .LBB5_1: ; %bb1
; GCN-O0-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-O0-NEXT:    s_or_saveexec_b64 s[14:15], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v7, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-O0-NEXT:    s_mov_b64 s[10:11], -1
; GCN-O0-NEXT:    s_xor_b64 s[8:9], s[8:9], s[10:11]
; GCN-O0-NEXT:    s_and_b64 s[10:11], exec, s[8:9]
; GCN-O0-NEXT:    v_writelane_b32 v7, s10, 2
; GCN-O0-NEXT:    v_writelane_b32 v7, s11, 3
; GCN-O0-NEXT:    s_and_b64 s[10:11], exec, s[8:9]
; GCN-O0-NEXT:    s_xor_b64 s[8:9], s[8:9], -1
; GCN-O0-NEXT:    s_and_b64 s[8:9], s[8:9], exec
...
; GCN-O0-NEXT:    s_mov_b64 s[8:9], 0
; GCN-O0-NEXT:    v_writelane_b32 v7, s8, 4
; GCN-O0-NEXT:    v_writelane_b32 v7, s9, 5
; GCN-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b32 s8, 0
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_cmp_eq_u32_e64 s[8:9], v0, s8
; GCN-O0-NEXT:    s_mov_b32 s10, 0
; GCN-O0-NEXT:    v_mov_b32_e32 v0, s10
; GCN-O0-NEXT:    v_mov_b32_e32 v6, s10
; GCN-O0-NEXT:    v_mov_b32_e32 v5, s10
...
; GCN-O0-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[8:9]
...
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s4, v7, 8
; GCN-O0-NEXT:    v_readlane_b32 s5, v7, 9
; GCN-O0-NEXT:    v_readlane_b32 s6, v7, 12
; GCN-O0-NEXT:    v_readlane_b32 s7, v7, 13
; GCN-O0-NEXT:    s_mov_b64 s[8:9], 0
; GCN-O0-NEXT:    v_writelane_b32 v7, s8, 6
; GCN-O0-NEXT:    v_writelane_b32 v7, s9, 7
; GCN-O0-NEXT:    ; implicit-def: $sgpr8
; GCN-O0-NEXT:    v_mov_b32_e32 v0, s8
; GCN-O0-NEXT:    buffer_load_dword v0, v0, s[0:3], 0 offen
; GCN-O0-NEXT:    s_mov_b32 s10, 0
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_cmp_lt_f32_e64 s[8:9], v0, s10
; GCN-O0-NEXT:    v_mov_b32_e32 v0, s10
; GCN-O0-NEXT:    v_mov_b32_e32 v6, s10
; GCN-O0-NEXT:    v_mov_b32_e32 v5, s10
; GCN-O0-NEXT:    v_mov_b32_e32 v4, s10
...
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s8, v7, 14
; GCN-O0-NEXT:    v_readlane_b32 s9, v7, 15
...
; GCN-O0-NEXT:    v_cmp_ne_u32_e64 s[8:9], v4, 0
; GCN-O0-NEXT:    s_waitcnt vmcnt(3)
...
; GCN-O0-NEXT:    s_xor_b64 s[8:9], s[8:9], exec
; GCN-O0-NEXT:    s_or_b64 s[4:5], s[4:5], s[8:9]
; GCN-O0-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
; GCN-O0-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; GCN-O0-NEXT:    s_or_b64 s[6:7], s[6:7], s[8:9]
...
; GCN-O0-NEXT:    s_mov_b64 s[8:9], 0
; GCN-O0-NEXT:    v_writelane_b32 v7, s8, 10
; GCN-O0-NEXT:    v_writelane_b32 v7, s9, 11
; GCN-O0-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-O0-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN-O0-NEXT:    v_writelane_b32 v7, s4, 2
; GCN-O0-NEXT:    v_writelane_b32 v7, s5, 3
; GCN-O0-NEXT:    s_or_saveexec_b64 s[14:15], -1
; GCN-O0-NEXT:    buffer_store_dword v7, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
; GCN-O0-NEXT:  .LBB5_8: ; in Loop: Header=BB5_1 Depth=1
; GCN-O0-NEXT:    s_or_saveexec_b64 s[14:15], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v7, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
...
; GCN-O0-NEXT:    v_readlane_b32 s4, v7, 2
; GCN-O0-NEXT:    v_readlane_b32 s5, v7, 3
; GCN-O0-NEXT:    v_readlane_b32 s6, v7, 18
; GCN-O0-NEXT:    v_readlane_b32 s7, v7, 19
; GCN-O0-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
; GCN-O0-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; GCN-O0-NEXT:    s_or_b64 s[6:7], s[6:7], s[8:9]
...
; GCN-O0-NEXT:    s_branch .LBB5_1
; GCN-O0-NEXT:  .LBB5_9: ; %bb12
; GCN-O0-NEXT:    s_or_saveexec_b64 s[14:15], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v7, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[14:15]
...
; GCN-O0-NEXT:    s_mov_b64 s[4:5], 0
; GCN-O0-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; GCN-O0-NEXT:    buffer_load_dword v7, off, s[0:3], s32 offset:60 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[4:5]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
