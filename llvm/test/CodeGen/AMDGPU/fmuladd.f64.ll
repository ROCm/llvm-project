...
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=tahiti -fp-contract=on < %s | FileCheck -check-prefixes=SI,SI-STRICT,SI-GFX600-STRICT %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=verde  -fp-contract=on < %s | FileCheck -check-prefixes=SI,SI-STRICT,SI-GFX601-STRICT %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=tahiti -fp-contract=fast < %s | FileCheck -check-prefixes=SI,SI-CONTRACT %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=verde  -fp-contract=fast < %s | FileCheck -check-prefixes=SI,SI-CONTRACT %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global  -fp-contract=on < %s | FileCheck -check-prefixes=VI,VI-STRICT %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global  -fp-contract=fast < %s | FileCheck -check-prefixes=VI,VI-CONTRACT %s
...
; SI-GFX600-STRICT-LABEL: fmul_fadd_f64:
; SI-GFX600-STRICT:       ; %bb.0:
; SI-GFX600-STRICT-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x9
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s11, 0xf000
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s10, -1
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s14, s10
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s15, s11
; SI-GFX600-STRICT-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s8, s2
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s9, s3
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s12, s4
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s13, s5
; SI-GFX600-STRICT-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; SI-GFX600-STRICT-NEXT:    buffer_load_dwordx2 v[2:3], off, s[12:15], 0
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s4, s6
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s5, s7
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s6, s10
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s7, s11
; SI-GFX600-STRICT-NEXT:    buffer_load_dwordx2 v[4:5], off, s[4:7], 0
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s2, s10
; SI-GFX600-STRICT-NEXT:    s_mov_b32 s3, s11
; SI-GFX600-STRICT-NEXT:    s_waitcnt vmcnt(1)
; SI-GFX600-STRICT-NEXT:    v_mul_f64 v[0:1], v[0:1], v[2:3]
; SI-GFX600-STRICT-NEXT:    s_waitcnt vmcnt(0)
; SI-GFX600-STRICT-NEXT:    v_add_f64 v[0:1], v[0:1], v[4:5]
; SI-GFX600-STRICT-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-GFX600-STRICT-NEXT:    s_endpgm
;
; SI-GFX601-STRICT-LABEL: fmul_fadd_f64:
; SI-GFX601-STRICT:       ; %bb.0:
; SI-GFX601-STRICT-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x9
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s11, 0xf000
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s10, -1
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s14, s10
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s15, s11
; SI-GFX601-STRICT-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s8, s2
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s9, s3
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s12, s4
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s13, s5
; SI-GFX601-STRICT-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; SI-GFX601-STRICT-NEXT:    buffer_load_dwordx2 v[2:3], off, s[12:15], 0
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s8, s6
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s9, s7
; SI-GFX601-STRICT-NEXT:    buffer_load_dwordx2 v[4:5], off, s[8:11], 0
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s2, s10
; SI-GFX601-STRICT-NEXT:    s_mov_b32 s3, s11
; SI-GFX601-STRICT-NEXT:    s_waitcnt vmcnt(1)
; SI-GFX601-STRICT-NEXT:    v_mul_f64 v[0:1], v[0:1], v[2:3]
; SI-GFX601-STRICT-NEXT:    s_waitcnt vmcnt(0)
; SI-GFX601-STRICT-NEXT:    v_add_f64 v[0:1], v[0:1], v[4:5]
; SI-GFX601-STRICT-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-GFX601-STRICT-NEXT:    s_endpgm
;
...
; SI-CONTRACT-NEXT:    s_mov_b32 s8, s2
; SI-CONTRACT-NEXT:    s_mov_b32 s9, s3
; SI-CONTRACT-NEXT:    s_mov_b32 s12, s4
; SI-CONTRACT-NEXT:    s_mov_b32 s13, s5
...
; SI-CONTRACT-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; SI-CONTRACT-NEXT:    buffer_load_dwordx2 v[2:3], off, s[12:15], 0
; SI-CONTRACT-NEXT:    buffer_load_dwordx2 v[4:5], off, s[4:7], 0
; SI-CONTRACT-NEXT:    s_mov_b32 s2, s10
; SI-CONTRACT-NEXT:    s_mov_b32 s3, s11
; SI-CONTRACT-NEXT:    s_waitcnt vmcnt(0)
; SI-CONTRACT-NEXT:    v_fma_f64 v[0:1], v[0:1], v[2:3], v[4:5]
; SI-CONTRACT-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
...
; VI-STRICT-NEXT:    s_mov_b32 s8, s2
; VI-STRICT-NEXT:    s_mov_b32 s9, s3
; VI-STRICT-NEXT:    s_mov_b32 s12, s4
; VI-STRICT-NEXT:    s_mov_b32 s13, s5
; VI-STRICT-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; VI-STRICT-NEXT:    buffer_load_dwordx2 v[2:3], off, s[12:15], 0
; VI-STRICT-NEXT:    s_mov_b32 s8, s6
; VI-STRICT-NEXT:    s_mov_b32 s9, s7
; VI-STRICT-NEXT:    buffer_load_dwordx2 v[4:5], off, s[8:11], 0
; VI-STRICT-NEXT:    s_mov_b32 s2, s10
; VI-STRICT-NEXT:    s_mov_b32 s3, s11
...
; VI-STRICT-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
...
; VI-CONTRACT-NEXT:    s_mov_b32 s8, s2
; VI-CONTRACT-NEXT:    s_mov_b32 s9, s3
; VI-CONTRACT-NEXT:    s_mov_b32 s12, s4
; VI-CONTRACT-NEXT:    s_mov_b32 s13, s5
...
; VI-CONTRACT-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; VI-CONTRACT-NEXT:    buffer_load_dwordx2 v[2:3], off, s[12:15], 0
; VI-CONTRACT-NEXT:    buffer_load_dwordx2 v[4:5], off, s[4:7], 0
; VI-CONTRACT-NEXT:    s_mov_b32 s2, s10
; VI-CONTRACT-NEXT:    s_mov_b32 s3, s11
; VI-CONTRACT-NEXT:    s_waitcnt vmcnt(0)
; VI-CONTRACT-NEXT:    v_fma_f64 v[0:1], v[0:1], v[2:3], v[4:5]
; VI-CONTRACT-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
