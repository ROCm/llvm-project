...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX11-SDAG,GFX11-SDAG-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX11-SDAG,GFX11-SDAG-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11-GISEL,GFX11-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11-GISEL,GFX11-GISEL-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11-GISEL,GFX11-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11-GISEL,GFX11-GISEL-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX12-SDAG,GFX12-SDAG-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX12-SDAG,GFX12-SDAG-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX12-GISEL,GFX12-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX12-GISEL,GFX12-GISEL-FAKE16
...
; GFX11-SDAG-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmpx_eq_u32_e32 v1, v0
...
; GFX12-SDAG-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmpx_eq_u32_e32 v1, v0
...
; GFX12-SDAG-NEXT:    s_mov_b32 s6, exec_lo
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmpx_eq_u32_e32 v1, v0
...
; GFX12-SDAG-NEXT:    v_cmpx_ne_u32_e32 0, v0
...
; GFX11-SDAG-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmpx_eq_u64_e32 v[2:3], v[0:1]
; GFX11-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmpx_eq_u64_e32 v[2:3], v[0:1]
; GFX12-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX11-SDAG-TRUE16-NEXT:    v_cmpx_eq_u32_e32 v1, v0
...
; GFX11-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v1, v0
...
; GFX12-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v1, v0
...
;
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_v4i16:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX12-GISEL-NEXT:    s_pack_ll_b32_b16 s5, s5, s6
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    v_cmp_ne_u32_e32 vcc_lo, s5, v0
; GFX12-GISEL-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX12-GISEL-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
...
; GFX11-SDAG-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmpx_eq_u32_e32 v4, v0
; GFX11-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmpx_eq_u32_e32 v5, v0
; GFX12-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-NEXT:    ; divergent control-flow edge
