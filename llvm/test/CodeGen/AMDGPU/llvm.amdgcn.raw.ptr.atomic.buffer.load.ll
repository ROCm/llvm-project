...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.50 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.50 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-FAKE16
...
; GFX12-GISEL-TRUE16-NEXT:  .LBB4_2: ; %bb2
...
; GFX12-GISEL-FAKE16-NEXT:  .LBB4_2: ; %bb2
