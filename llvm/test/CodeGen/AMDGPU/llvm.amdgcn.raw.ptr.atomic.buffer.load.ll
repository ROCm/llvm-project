...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX11,GFX11-SDAG-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX11,GFX11-SDAG-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX12,GFX12-SDAG-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX12,GFX12-SDAG-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -global-isel=1 | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-FAKE16

define amdgpu_kernel void @raw_ptr_atomic_buffer_ptr_load_i32(ptr addrspace(8) %ptr) {
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_ptr_load_i32:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB0_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], 0 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX11-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
...
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB0_1
...
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB0_1
...
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB0_1
...
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB0_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_ptr_load_i32:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX12-SDAG-NEXT:  .LBB0_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX12-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-SDAG-NEXT:    s_or_b32 s4, s4, s5
...
; GFX12-SDAG-NEXT:  .LBB0_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_ptr_load_i32:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:  .LBB0_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], null th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX12-GISEL-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_i32_off:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB1_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], 0 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB1_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB1_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB1_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB1_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_i32_off:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX12-SDAG-NEXT:  .LBB1_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_i32_off:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_i32_soff:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB2_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], 4 offset:4 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX11-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    ; divergent control-flow edge
; GFX11-SDAG-NEXT:    s_cbranch_execnz .LBB2_1
; GFX11-SDAG-NEXT:  .LBB2_2: ; %bb2
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB2_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB2_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-SDAG-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:4 th:TH_LOAD_NT
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX12-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:4 th:TH_LOAD_NT
; GFX12-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
...
; GFX12-GISEL-TRUE16-NEXT:    s_mov_b32 s4, 4
; GFX12-GISEL-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-TRUE16-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:4 th:TH_LOAD_NT
; GFX12-GISEL-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX12-GISEL-TRUE16-NEXT:  .LBB2_1: ; %bb1
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB2_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    s_mov_b32 s4, 4
; GFX12-GISEL-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:4 th:TH_LOAD_NT
; GFX12-GISEL-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX12-GISEL-FAKE16-NEXT:  .LBB2_1: ; %bb1
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB2_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_i32_soff:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 4
; GFX12-SDAG-NEXT:    s_mov_b32 s5, 0
; GFX12-SDAG-NEXT:  .LBB2_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:4 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX12-SDAG-NEXT:    s_xor_b32 s6, exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-SDAG-NEXT:    s_or_b32 s5, s5, s6
; GFX12-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    ; divergent control-flow edge
; GFX12-SDAG-NEXT:    s_cbranch_execnz .LBB2_1
; GFX12-SDAG-NEXT:  .LBB2_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_i32_soff:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_mov_b32 s5, 4
; GFX12-GISEL-NEXT:  .LBB2_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], s5 offset:4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX12-GISEL-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_i32_dlc:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB3_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], 0 offset:4 dlc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX11-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    ; divergent control-flow edge
; GFX11-SDAG-NEXT:    s_cbranch_execnz .LBB3_1
; GFX11-SDAG-NEXT:  .LBB3_2: ; %bb2
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB3_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB3_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB3_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB3_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_i32_dlc:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX12-SDAG-NEXT:  .LBB3_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:4 th:TH_LOAD_NT_RT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX12-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12-SDAG-NEXT:  .LBB3_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_i32_dlc:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:  .LBB3_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:4 th:TH_LOAD_NT_RT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX12-GISEL-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-SDAG-LABEL: raw_nonptr_atomic_buffer_load_i32:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], 0 offset:4 glc
; GFX11-SDAG-NEXT:    s_mov_b32 s0, 0
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc_lo
; GFX11-SDAG-NEXT:  .LBB4_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX11-SDAG-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    s_or_b32 s0, s0, s1
; GFX11-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    ; divergent control-flow edge
; GFX11-SDAG-NEXT:    s_cbranch_execnz .LBB4_1
; GFX11-SDAG-NEXT:  .LBB4_2: ; %bb2
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB4_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB4_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB4_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB4_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_nonptr_atomic_buffer_load_i32:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s0, 0
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v0
; GFX12-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc_lo
; GFX12-SDAG-NEXT:  .LBB4_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX12-SDAG-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX12-SDAG-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    s_or_b32 s0, s0, s1
; GFX12-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    ; divergent control-flow edge
; GFX12-SDAG-NEXT:    s_cbranch_execnz .LBB4_1
; GFX12-SDAG-NEXT:  .LBB4_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_nonptr_atomic_buffer_load_i32:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX12-GISEL-NEXT:  .LBB4_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_and_b32 s1, exec_lo, vcc_lo
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_or_b32 s0, s1, s0
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_i64:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB5_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], 0 offset:4 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[2:3], v[0:1]
; GFX11-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    ; divergent control-flow edge
; GFX11-SDAG-NEXT:    s_cbranch_execnz .LBB5_1
; GFX11-SDAG-NEXT:  .LBB5_2: ; %bb2
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %bb
; GFX11-GISEL-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_and_b32 v3, 0x3ff, v0
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], 0 offset:4 glc
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[1:2], v[3:4]
; GFX11-GISEL-TRUE16-NEXT:  .LBB5_1: ; %bb1
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB5_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %bb
; GFX11-GISEL-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-GISEL-FAKE16-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_and_b32 v3, 0x3ff, v0
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], 0 offset:4 glc
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[1:2], v[3:4]
; GFX11-GISEL-FAKE16-NEXT:  .LBB5_1: ; %bb1
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB5_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB5_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB5_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_i64:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
...
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX12-SDAG-NEXT:  .LBB5_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[2:3], v[0:1]
; GFX12-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
...
; GFX12-SDAG-NEXT:  .LBB5_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_i64:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:  .LBB5_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cmp_ne_u64_e32 vcc_lo, v[2:3], v[0:1]
; GFX12-GISEL-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_v2i16:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB6_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], 0 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB6_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB6_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB6_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB6_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_v2i16:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX12-SDAG-NEXT:  .LBB6_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_v2i16:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    v_readfirstlane_b32 s0, v1
; GFX11-GISEL-TRUE16-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-GISEL-TRUE16-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX11-GISEL-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s0, v0
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB7_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    v_readfirstlane_b32 s0, v1
; GFX11-GISEL-FAKE16-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-GISEL-FAKE16-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s0, v0
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB7_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-TRUE16-NEXT:    v_readfirstlane_b32 s0, v2
; GFX12-GISEL-TRUE16-NEXT:    v_readfirstlane_b32 s1, v3
; GFX12-GISEL-TRUE16-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX12-GISEL-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s0, v0
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB7_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    v_readfirstlane_b32 s0, v2
; GFX12-GISEL-FAKE16-NEXT:    v_readfirstlane_b32 s1, v3
; GFX12-GISEL-FAKE16-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX12-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s0, v0
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB7_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
bb:
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_v4i32:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB8_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b128 v[1:4], off, s[0:3], 0 offset:4 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v0
; GFX11-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
...
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v0
; GFX11-GISEL-TRUE16-NEXT:  .LBB8_1: ; %bb1
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB8_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v0
; GFX11-GISEL-FAKE16-NEXT:  .LBB8_1: ; %bb1
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB8_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v5, v0
; GFX12-GISEL-TRUE16-NEXT:  .LBB8_1: ; %bb1
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB8_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v5, v0
; GFX12-GISEL-FAKE16-NEXT:  .LBB8_1: ; %bb1
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB8_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_v4i32:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX12-SDAG-NEXT:  .LBB8_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b128 v[2:5], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v5, v0
; GFX12-SDAG-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-SDAG-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-NEXT:    s_mov_b32 exec_lo, vcc_lo
...
; GFX12-SDAG-NEXT:  .LBB8_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_v4i32:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:  .LBB8_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[2:5], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v5, v0
; GFX12-GISEL-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
...
; GFX11-SDAG-LABEL: raw_ptr_atomic_buffer_load_ptr:
; GFX11-SDAG:       ; %bb.0: ; %bb
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX11-SDAG-NEXT:  .LBB9_1: ; %bb1
; GFX11-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], 0 offset:4 glc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    flat_load_b32 v1, v[1:2]
...
; GFX11-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB9_1
; GFX11-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB9_1
; GFX11-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-TRUE16-NEXT:    s_cbranch_vccnz .LBB9_1
; GFX12-GISEL-TRUE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-GISEL-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-FAKE16-NEXT:    s_cbranch_vccnz .LBB9_1
; GFX12-GISEL-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX12-GISEL-FAKE16-NEXT:    s_endpgm
; GFX12-SDAG-LABEL: raw_ptr_atomic_buffer_load_ptr:
; GFX12-SDAG:       ; %bb.0: ; %bb
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 0
; GFX12-SDAG-NEXT:  .LBB9_1: ; %bb1
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    flat_load_b32 v1, v[2:3]
...
; GFX12-SDAG-NEXT:  .LBB9_2: ; %bb2
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-GISEL-LABEL: raw_ptr_atomic_buffer_load_ptr:
; GFX12-GISEL:       ; %bb.0: ; %bb
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX12-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:  .LBB9_1: ; %bb1
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    flat_load_b32 v1, v[2:3]
