...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -global-isel=0 < %s | FileCheck  -check-prefixes=GFX8DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=tonga -global-isel=1 < %s | FileCheck  -check-prefixes=GFX8GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX9DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx900 -global-isel=1 < %s | FileCheck  -check-prefixes=GFX9GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1064DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1010 -global-isel=1 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1064GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1032DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1010 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1032GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164DAGISEL,GFX1164DAGISEL-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164GISEL,GFX1164GISEL-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1132DAGISEL,GFX1132DAGISEL-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1132GISEL,GFX1132GISEL-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164DAGISEL,GFX1164DAGISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164GISEL,GFX1164GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1132DAGISEL,GFX1132DAGISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1132GISEL,GFX1132GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12DAGISEL %s
...
; GFX1032DAGISEL-NEXT:    v_sub_f32_e64 v2, s2, s5
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1032DAGISEL-NEXT:    s_cbranch_scc1 .LBB0_1
; GFX1032DAGISEL-NEXT:  ; %bb.2:
; GFX1032DAGISEL-NEXT:    v_cvt_f16_f32_e32 v1, s2
...
; GFX1132DAGISEL-FAKE16-NEXT:    s_mov_b32 s2, 0
; GFX1132DAGISEL-FAKE16-NEXT:  .LBB0_1: ; =>This Inner Loop Header: Depth=1
; GFX1132DAGISEL-FAKE16-NEXT:    s_ctz_i32_b32 s4, s3
...
; GFX1132DAGISEL-FAKE16-NEXT:    s_bitset0_b32 s3, s4
; GFX1132DAGISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1132DAGISEL-FAKE16-NEXT:    s_cmp_lg_u32 s3, 0
; GFX1132DAGISEL-FAKE16-NEXT:    v_sub_f32_e64 v2, s2, s5
; GFX1132DAGISEL-FAKE16-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1132DAGISEL-FAKE16-NEXT:    s_cbranch_scc1 .LBB0_1
; GFX1132DAGISEL-FAKE16-NEXT:  ; %bb.2:
; GFX1132DAGISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, s2
...
; GFX1132DAGISEL-TRUE16-NEXT:    s_mov_b32 s2, 0
; GFX1132DAGISEL-TRUE16-NEXT:  .LBB0_1: ; =>This Inner Loop Header: Depth=1
; GFX1132DAGISEL-TRUE16-NEXT:    s_ctz_i32_b32 s4, s3
...
; GFX1132DAGISEL-TRUE16-NEXT:    s_bitset0_b32 s3, s4
; GFX1132DAGISEL-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1132DAGISEL-TRUE16-NEXT:    s_cmp_lg_u32 s3, 0
; GFX1132DAGISEL-TRUE16-NEXT:    v_sub_f32_e64 v2, s2, s5
; GFX1132DAGISEL-TRUE16-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1132DAGISEL-TRUE16-NEXT:    s_cbranch_scc1 .LBB0_1
; GFX1132DAGISEL-TRUE16-NEXT:  ; %bb.2:
; GFX1132DAGISEL-TRUE16-NEXT:    v_cvt_f16_f32_e32 v1.l, s2
...
; GFX1032DAGISEL-NEXT:    v_sub_f32_e64 v3, s4, s7
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s4, v3
; GFX1032DAGISEL-NEXT:    s_cbranch_scc1 .LBB1_1
; GFX1032DAGISEL-NEXT:  ; %bb.2:
; GFX1032DAGISEL-NEXT:    v_cvt_f16_f32_e32 v2, s4
...
; GFX1132DAGISEL-FAKE16-NEXT:    v_sub_f32_e64 v3, s0, s3
; GFX1132DAGISEL-FAKE16-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1132DAGISEL-FAKE16-NEXT:    s_cbranch_scc1 .LBB1_1
; GFX1132DAGISEL-FAKE16-NEXT:  ; %bb.2:
; GFX1132DAGISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v2, s0
...
; GFX1132DAGISEL-TRUE16-NEXT:    v_sub_f32_e64 v3, s0, s3
; GFX1132DAGISEL-TRUE16-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1132DAGISEL-TRUE16-NEXT:    s_cbranch_scc1 .LBB1_1
; GFX1132DAGISEL-TRUE16-NEXT:  ; %bb.2:
; GFX1132DAGISEL-TRUE16-NEXT:    v_cvt_f16_f32_e32 v2.l, s0
...
; GFX1132DAGISEL-NEXT:    v_sub_f32_e64 v3, s0, s3
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s0, v3
...
; GFX8DAGISEL-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s1, v0
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s1
...
; GFX8DAGISEL-NEXT:  .LBB6_3: ; %else
; GFX8DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[6:7]
; GFX8DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s1
...
; GFX9DAGISEL-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s1, v0
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, s1
...
; GFX9DAGISEL-NEXT:  .LBB6_3: ; %else
; GFX9DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[6:7]
; GFX9DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s1
...
; GFX1064DAGISEL-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s1, v0
; GFX1064DAGISEL-NEXT:    v_mov_b32_e32 v0, s1
...
; GFX1064DAGISEL-NEXT:  .LBB6_3: ; %else
; GFX1064DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[6:7]
; GFX1064DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s1
...
; GFX1032DAGISEL-NEXT:    s_and_saveexec_b32 s2, s2
...
; GFX1032DAGISEL-NEXT:  .LBB6_3: ; %else
...
; GFX1164DAGISEL-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s1, v0
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164DAGISEL-NEXT:    v_mov_b32_e32 v0, s1
; GFX1164DAGISEL-NEXT:  .LBB6_2:
; GFX1164DAGISEL-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1164DAGISEL-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX1164DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1164DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1164DAGISEL-NEXT:  .LBB6_3: ; %else
; GFX1164DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[6:7]
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s1
...
; GFX1132DAGISEL-NEXT:    s_and_saveexec_b32 s2, s2
...
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; GFX1132DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1132DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1132DAGISEL-NEXT:  .LBB6_3: ; %else
...
; GFX12DAGISEL-NEXT:    s_and_saveexec_b32 s2, s2
...
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX12DAGISEL-NEXT:  .LBB6_3: ; %else
...
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s6, s[0:1]
; GFX1064DAGISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX1064DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s6
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032DAGISEL-NEXT:    s_bcnt1_i32_b32 s6, s0
; GFX1032DAGISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX1032DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s6
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8DAGISEL-NEXT:    v_add_f64 v[4:5], -s[6:7], v[4:5]
...
; GFX9DAGISEL-NEXT:    v_add_f64 v[4:5], -s[6:7], v[4:5]
...
; GFX1064DAGISEL-NEXT:    v_add_f64 v[4:5], -s[8:9], s[4:5]
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s4, v4
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s5, v5
...
; GFX1164DAGISEL-NEXT:    v_add_f64 v[4:5], -s[4:5], s[0:1]
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s0, v4
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s1, v5
...
; GFX8DAGISEL:       ; %bb.0: ; %entry
; GFX8DAGISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8DAGISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; GFX8DAGISEL-NEXT:    v_cmp_lt_u32_e32 vcc, 15, v0
...
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[6:7], v[0:1]
...
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s7, v1
...
; GFX9DAGISEL-NEXT:  .LBB9_3: ; %else
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX9DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s6
; GFX9DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s3, v1
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s7, v1
...
; GFX1064DAGISEL-NEXT:  .LBB9_3: ; %else
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX1064DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s6
...
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s7, v1
...
; GFX1032DAGISEL-NEXT:  .LBB9_3: ; %else
; GFX1032DAGISEL-NEXT:    s_mov_b32 s5, exec_lo
; GFX1032DAGISEL-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX1032DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s5
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164DAGISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1164DAGISEL-NEXT:    s_load_b64 s[6:7], s[4:5], 0x34
; GFX1164DAGISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164DAGISEL-NEXT:    v_cmp_lt_u32_e32 vcc, 15, v0
; GFX1164DAGISEL-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX1164DAGISEL-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX1164DAGISEL-NEXT:    ; divergent control-flow edge
...
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[6:7], v[0:1]
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s6, v0
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s7, v1
...
; GFX1164DAGISEL-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX1164DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1164DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX1164DAGISEL-NEXT:  .LBB9_3: ; %else
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
...
; GFX1132DAGISEL-NEXT:    s_and_saveexec_b32 s6, s6
; GFX1132DAGISEL-NEXT:    ; divergent control-flow edge
...
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_and_saveexec_b32 s4, vcc_lo
; GFX1132DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1132DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX1132DAGISEL-NEXT:  .LBB9_3: ; %else
; GFX1132DAGISEL-NEXT:    s_mov_b32 s5, exec_lo
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132DAGISEL-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX1132DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s5
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1132DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX1132DAGISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132DAGISEL-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1132DAGISEL-NEXT:    s_endpgm
;
...
; GFX12DAGISEL-NEXT:    s_and_saveexec_b32 s6, s6
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
...
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_and_saveexec_b32 s4, vcc_lo
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX12DAGISEL-NEXT:  .LBB9_3: ; %else
; GFX12DAGISEL-NEXT:    s_mov_b32 s5, exec_lo
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s5
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_mul_f64_e64 v[0:1], -s[2:3], v[0:1]
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
...
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX12DAGISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX12DAGISEL-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX12DAGISEL-NEXT:    s_endpgm
entry:
