...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=tonga -global-isel=1 -global-isel-abort=2 < %s | FileCheck  -check-prefixes=GFX8GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -global-isel=0 < %s | FileCheck  -check-prefixes=GFX9DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx900 -global-isel=1 -global-isel-abort=2 < %s | FileCheck  -check-prefixes=GFX9GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1010 -global-isel=1 -global-isel-abort=2 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1064GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1010 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX1032GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 -global-isel-abort=2 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164GISEL,GFX1164GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX1132GISEL,GFX1132GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 -global-isel-abort=2 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164GISEL,GFX1164GISEL-TRUE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX1132GISEL,GFX1132GISEL-TRUE16 %s
...
; GFX8DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8DAGISEL-NEXT:    s_xor_b64 s[2:3], exec, vcc
...
; GFX9DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9DAGISEL-NEXT:    s_xor_b64 s[2:3], exec, vcc
...
; GFX1064DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064DAGISEL-NEXT:    s_xor_b64 s[2:3], exec, vcc
...
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
...
; GFX1164DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1164DAGISEL-NEXT:    s_xor_b64 s[2:3], exec, vcc
...
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
...
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
...
; GFX12DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, vcc_lo
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_xor_b32 s4, exec_lo, vcc_lo
; GFX12DAGISEL-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
