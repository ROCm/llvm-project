...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1164GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1132DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1132GISEL %s
...
; GFX1064DAGISEL-NEXT:  .LBB4_3: ; %else
...
; GFX1032DAGISEL-NEXT:  .LBB4_3: ; %else
; GFX1032DAGISEL-NEXT:    s_mov_b32 s2, exec_lo
; GFX1032DAGISEL-NEXT:    s_bcnt1_i32_b32 s2, s2
; GFX1032DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
...
; GFX1164DAGISEL-NEXT:  .LBB4_3: ; %else
...
; GFX1132DAGISEL-NEXT:  .LBB4_3: ; %else
; GFX1132DAGISEL-NEXT:    s_mov_b32 s2, exec_lo
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132DAGISEL-NEXT:    s_bcnt1_i32_b32 s2, s2
; GFX1132DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
...
; GFX1164DAGISEL-NEXT:  .LBB7_3: ; %else
; GFX1164DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX1164DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s6
...
; GFX1132DAGISEL-NEXT:  .LBB7_3: ; %else
