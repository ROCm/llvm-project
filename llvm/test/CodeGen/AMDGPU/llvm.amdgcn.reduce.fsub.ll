...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -global-isel=0 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1064DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -global-isel=1 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1064GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1032DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1032GISEL %s
...
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8DAGISEL-NEXT:  .LBB6_2:
; GFX8DAGISEL-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX8DAGISEL-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
; GFX8DAGISEL-NEXT:    s_mov_b64 exec, s[2:3]
; GFX8DAGISEL-NEXT:    ; divergent control-flow edge
; GFX8DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX8DAGISEL-NEXT:  .LBB6_3: ; %if
; GFX8DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s0, s[2:3]
; GFX8DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s0
...
; GFX9DAGISEL-NEXT:  .LBB6_2:
; GFX9DAGISEL-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX9DAGISEL-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
; GFX9DAGISEL-NEXT:    s_mov_b64 exec, s[2:3]
; GFX9DAGISEL-NEXT:    ; divergent control-flow edge
; GFX9DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX9DAGISEL-NEXT:  .LBB6_3: ; %if
; GFX9DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s0, s[2:3]
; GFX9DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s0
...
; GFX1064DAGISEL-NEXT:  .LBB6_2:
; GFX1064DAGISEL-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1064DAGISEL-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
; GFX1064DAGISEL-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1064DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1064DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1064DAGISEL-NEXT:  .LBB6_3: ; %if
; GFX1064DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s0, s[2:3]
...
; GFX1032DAGISEL-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
...
; GFX1032GISEL-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
...
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1132DAGISEL-NEXT:  .LBB6_2:
; GFX1132DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX1132DAGISEL-NEXT:    s_mov_b32 exec_lo, s2
; GFX1132DAGISEL-NEXT:    ; divergent control-flow edge
; GFX1132DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1132DAGISEL-NEXT:  .LBB6_3: ; %if
...
; GFX1132GISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1132GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1132GISEL-NEXT:  .LBB6_2:
; GFX1132GISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX1132GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132GISEL-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX1132GISEL-NEXT:    s_mov_b32 exec_lo, s2
; GFX1132GISEL-NEXT:    ; divergent control-flow edge
; GFX1132GISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1132GISEL-NEXT:  .LBB6_3: ; %if
...
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_cmp_lt_u32_e32 vcc_lo, 15, v0
...
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12DAGISEL-NEXT:  .LBB6_2:
; GFX12DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX12DAGISEL-NEXT:    s_mov_b32 exec_lo, s2
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX12DAGISEL-NEXT:  .LBB6_3: ; %if
...
; GFX8DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s8
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s3, v1
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v1, s3
; GFX8DAGISEL-NEXT:  .LBB9_2:
; GFX8DAGISEL-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8GISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s8
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX8GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX8GISEL-NEXT:    v_readfirstlane_b32 s3, v1
...
; GFX9DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s8
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s3, v1
...
; GFX9GISEL-NEXT:    s_bcnt1_i32_b64 s8, s[8:9]
; GFX9GISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s8
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX9GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX9GISEL-NEXT:    v_readfirstlane_b32 s3, v1
...
; GFX1032DAGISEL-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX1032DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s5
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s3, v1
...
; GFX1032GISEL-NEXT:    s_bcnt1_i32_b32 s7, s7
; GFX1032GISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s7
; GFX1032GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032GISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX1032GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1032GISEL-NEXT:    v_readfirstlane_b32 s3, v1
...
; GFX1132DAGISEL-NEXT:    s_mov_b32 s7, exec_lo
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132DAGISEL-NEXT:    s_bcnt1_i32_b32 s7, s7
; GFX1132DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s7
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
...
; GFX1132GISEL-NEXT:    s_mov_b32 s7, exec_lo
; GFX1132GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1132GISEL-NEXT:    s_bcnt1_i32_b32 s7, s7
; GFX1132GISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s7
; GFX1132GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132GISEL-NEXT:    v_mul_f64 v[0:1], -s[2:3], v[0:1]
; GFX1132GISEL-NEXT:    v_readfirstlane_b32 s2, v0
...
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_cmp_lt_u32_e32 vcc_lo, 15, v0
; GFX12DAGISEL-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX12DAGISEL-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX12DAGISEL-NEXT:    s_mov_b32 exec_lo, vcc_lo
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB9_2
; GFX12DAGISEL-NEXT:  .LBB9_1: ; %else
; GFX12DAGISEL-NEXT:    s_mov_b32 s7, exec_lo
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12DAGISEL-NEXT:    s_bcnt1_i32_b32 s7, s7
; GFX12DAGISEL-NEXT:    v_cvt_f64_i32_e32 v[0:1], s7
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_mul_f64_e64 v[0:1], -s[2:3], v[0:1]
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
...
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12DAGISEL-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX12DAGISEL-NEXT:  .LBB9_2:
; GFX12DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_xor_b32 s2, exec_lo, s6
; GFX12DAGISEL-NEXT:    s_mov_b32 exec_lo, s6
; GFX12DAGISEL-NEXT:    ; divergent control-flow edge
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB9_4
; GFX12DAGISEL-NEXT:  .LBB9_3: ; %if
; GFX12DAGISEL-NEXT:    s_mov_b32 s3, exec_lo
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_bcnt1_i32_b32 s3, s3
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
