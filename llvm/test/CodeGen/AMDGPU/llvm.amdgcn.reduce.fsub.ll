...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel=1 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1064GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -global-isel=0 < %s | FileCheck -check-prefixes=GFX1032DAGISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10 -global-isel=1 < %s | FileCheck -check-prefixes=GFX1032GISEL %s
