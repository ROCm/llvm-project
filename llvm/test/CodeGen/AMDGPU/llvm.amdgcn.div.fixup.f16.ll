...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -check-prefix=VI-GISEL %s
...
; VI-SDAG:    s_mov_b32 s12, s4
; VI-SDAG:    s_mov_b32 s13, s5
; VI-SDAG:    s_mov_b32 s4, s6
; VI-SDAG:    s_mov_b32 s5, s7
; VI-SDAG:    s_mov_b32 s6, s10
; VI-SDAG:    s_mov_b32 s7, s11
; VI-SDAG:    s_mov_b32 s2, s10
; VI-SDAG:    s_mov_b32 s3, s11
...
; VI-SDAG:    s_mov_b32 s4, s2
; VI-SDAG:    s_mov_b32 s5, s3
; VI-SDAG:    s_mov_b32 s11, s7
; VI-SDAG:    s_movk_i32 s4, 0x4200
; VI-SDAG:    s_mov_b32 s2, s6
; VI-SDAG:    s_mov_b32 s3, s7
; VI-SDAG:    v_div_fixup_f16 v0, s4, v0, v1
; VI-SDAG:    s_endpgm
;
...
; VI-SDAG:    s_mov_b32 s2, s6
; VI-SDAG:    s_mov_b32 s3, s7
; VI-SDAG:    v_div_fixup_f16 v0, v0, s4, v1
; VI-SDAG:    s_endpgm
;
...
; VI-SDAG:    s_mov_b32 s2, s6
; VI-SDAG:    s_mov_b32 s3, s7
; VI-SDAG:    v_div_fixup_f16 v0, v0, v1, s4
; VI-SDAG:    s_endpgm
;
...
; VI-SDAG:    s_mov_b32 s2, s6
; VI-SDAG:    s_mov_b32 s3, s7
; VI-SDAG:    v_div_fixup_f16 v0, s4, s4, v0
; VI-SDAG:    s_endpgm
;
...
; VI-SDAG:    s_mov_b32 s2, s6
; VI-SDAG:    s_mov_b32 s3, s7
; VI-SDAG:    v_div_fixup_f16 v0, v0, s4, s4
; VI-SDAG:    s_endpgm
;
...
; VI-SDAG:    s_mov_b32 s2, s6
; VI-SDAG:    s_mov_b32 s3, s7
; VI-SDAG:    v_div_fixup_f16 v0, s4, v0, s4
; VI-SDAG:    s_endpgm
;
