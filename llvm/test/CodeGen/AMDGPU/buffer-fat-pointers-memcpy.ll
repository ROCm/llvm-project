...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42 -mattr=+unaligned-access-mode -global-isel=1 < %s | FileCheck -check-prefix=GISEL-GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+unaligned-access-mode -global-isel=1 < %s | FileCheck -check-prefix=GISEL-GFX1100 %s
