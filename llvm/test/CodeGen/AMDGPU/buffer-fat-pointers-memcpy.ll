...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx942 < %s | FileCheck -check-prefix=SDAG-GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck -check-prefix=SDAG-GFX1100 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx942 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefix=GISEL-GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefix=GISEL-GFX1100 %s
...
; SDAG-GFX1100-NEXT:    s_mov_b32 s14, 0
; SDAG-GFX1100-NEXT:    s_mov_b32 s5, s16
; SDAG-GFX1100-NEXT:    s_mov_b32 s19, s16
; SDAG-GFX1100-NEXT:    s_mov_b32 s12, 0
; SDAG-GFX1100-NEXT:    s_mov_b32 s21, s16
; SDAG-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-GFX1100-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX1100-NEXT:    s_mov_b32 s15, s2
; SDAG-GFX1100-NEXT:    s_mov_b32 s18, s1
; SDAG-GFX1100-NEXT:    s_mov_b32 s20, s11
...
; SDAG-GFX1100-NEXT:    s_or_b64 s[4:5], s[18:19], s[14:15]
; SDAG-GFX1100-NEXT:    s_or_b64 s[14:15], s[20:21], s[12:13]
...
; SDAG-GFX1100-NEXT:    s_mov_b32 s6, 0
; SDAG-GFX1100-NEXT:    s_mov_b32 s10, 0
; SDAG-GFX1100-NEXT:    s_mov_b32 s9, s6
; SDAG-GFX1100-NEXT:    s_mov_b32 s13, s6
; SDAG-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-GFX1100-NEXT:    s_mov_b32 s11, s2
; SDAG-GFX1100-NEXT:    s_mov_b32 s12, s1
; SDAG-GFX1100-NEXT:    s_mov_b32 s8, s3
; SDAG-GFX1100-NEXT:    v_mov_b32_e32 v4, s0
; SDAG-GFX1100-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; SDAG-GFX1100-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; SDAG-GFX1100-NEXT:    s_clause 0x1
; SDAG-GFX1100-NEXT:    s_load_b128 s[8:11], s[4:5], 0x44
; SDAG-GFX1100-NEXT:    s_load_b32 s7, s[4:5], 0x54
; SDAG-GFX1100-NEXT:    s_mov_b32 s4, s6
; SDAG-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-GFX1100-NEXT:    v_mov_b32_e32 v5, s8
; SDAG-GFX1100-NEXT:    buffer_load_b128 v[0:3], v4, s[0:3], 0 offen
; SDAG-GFX1100-NEXT:    s_mov_b32 s12, s11
; SDAG-GFX1100-NEXT:    s_mov_b32 s5, s10
; SDAG-GFX1100-NEXT:    s_mov_b32 s10, s9
; SDAG-GFX1100-NEXT:    s_mov_b32 s11, s6
; SDAG-GFX1100-NEXT:    s_or_b64 s[6:7], s[12:13], s[6:7]
; SDAG-GFX1100-NEXT:    s_or_b64 s[4:5], s[10:11], s[4:5]
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0)
