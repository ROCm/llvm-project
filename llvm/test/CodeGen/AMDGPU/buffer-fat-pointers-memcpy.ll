...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx942 -global-isel=1 < %s | FileCheck -check-prefix=GISEL-GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 < %s | FileCheck -check-prefix=GISEL-GFX1100 %s
