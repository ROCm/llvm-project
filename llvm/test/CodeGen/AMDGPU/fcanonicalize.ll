...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.01-amd-amdhsa < %s | FileCheck -check-prefixes=GFX678,GFX678-GISEL,GFX6-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefixes=GFX678,GFX678-GISEL,GFX8-GISEL %s
...
; GFX1251-SDAG-TRUE16-NEXT:    global_wb
...
; GFX1251-GISEL-TRUE16-NEXT:    global_wb
...
; GFX1251-SDAG-FAKE16-NEXT:    global_wb
...
; GFX1251-GISEL-FAKE16-NEXT:    global_wb
