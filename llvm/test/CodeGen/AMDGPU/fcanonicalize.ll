...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.01-amd-amdhsa < %s | FileCheck -check-prefixes=GFX678,GFX678-GISEL,GFX6-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -check-prefixes=GFX678,GFX678-GISEL,GFX8-GISEL %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00-amd-amdhsa -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-GISEL,GFX11-TRUE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00-amd-amdhsa -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-GISEL,GFX11-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.00-amd-amdhsa -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL,GFX12-GISEL-TRUE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.00-amd-amdhsa -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL,GFX12-GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.51-amd-amdhsa -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1251,GFX1251-TRUE16,GFX1251-GISEL-TRUE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.51-amd-amdhsa -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1251,GFX1251-FAKE16,GFX1251-GISEL-FAKE16 %s
