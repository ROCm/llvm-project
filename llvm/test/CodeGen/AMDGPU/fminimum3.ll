...
; GFX942-NEXT:    v_min_f32_e32 v8, v0, v2
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v2
...
; GFX942-NEXT:    v_min_f32_e32 v3, v5, v1
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_min_f32_e32 v3, v1, v5
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v2, vcc
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v7, 0x7fc00000
; GFX942-NEXT:    v_min_f32_e64 v8, |v0|, |v2|
; GFX942-NEXT:    v_cmp_o_f32_e64 vcc, |v0|, |v2|
...
; GFX942-NEXT:    v_min_f32_e64 v3, v1, |v5|
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v2, vcc
...
; GFX942-NEXT:    v_min_f32_e32 v6, v0, v2
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v10, v11, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v5
; GFX942-NEXT:    v_min_f32_e32 v4, v1, v7
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v10, v9, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v6
; GFX942-NEXT:    v_min_f32_e32 v5, v2, v8
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v10, v3, vcc
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v10, 0x7fc00000
; GFX942-NEXT:    v_min_f32_e64 v12, |v0|, |v3|
; GFX942-NEXT:    v_cmp_o_f32_e64 vcc, |v0|, |v3|
; GFX942-NEXT:    v_min_f32_e64 v11, |v1|, |v4|
...
; GFX942-NEXT:    v_min_f32_e64 v4, v1, |v7|
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v10, v9, vcc
; GFX942-NEXT:    v_cmp_o_f32_e64 vcc, v0, |v6|
; GFX942-NEXT:    v_min_f32_e64 v5, v2, |v8|
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v10, v3, vcc
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v7, 0x7fc00000
; GFX942-NEXT:    v_min_f32_e32 v9, 2.0, v0
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v0
; GFX942-NEXT:    v_min_f32_e32 v8, 2.0, v1
; GFX942-NEXT:    v_min_f32_e32 v6, 2.0, v2
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v9, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v1, v1
; GFX942-NEXT:    v_min_f32_e32 v9, v0, v3
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v8, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v2
; GFX942-NEXT:    v_min_f32_e32 v8, v1, v4
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v8, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v5
; GFX942-NEXT:    v_min_f32_e32 v4, 4.0, v1
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v6, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v0
; GFX942-NEXT:    v_min_f32_e32 v5, 4.0, v2
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v3, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v1, v1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v4, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v2
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v5, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_sdwa v5, v4, v3, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v0, v1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v4, v3, vcc
; GFX942-NEXT:    v_perm_b32 v1, v5, v0, s0
; GFX942-NEXT:    v_pk_min_f16 v1, v2, v1
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v2, v5 src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    s_nop 1
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v2, v3, v1, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v0, v0
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v3, v1, vcc
; GFX942-NEXT:    v_perm_b32 v0, v2, v0, s0
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v4, v6
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v2, vcc
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v5, v8
...
; GFX942-NEXT:    v_pk_min_f16 v1, v1, v5
; GFX942-NEXT:    v_cndmask_b32_sdwa v0, v7, v2, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v6, v4
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v2, vcc
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v8, v5
; GFX942-NEXT:    v_perm_b32 v0, v0, v2, s0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v1, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v8, vcc
; GFX942-NEXT:    v_pk_min_f16 v8, v1, v3 neg_lo:[1,1] neg_hi:[1,1]
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, -v1, -v3
; GFX942-NEXT:    v_perm_b32 v2, v0, v6, s0
; GFX942-NEXT:    v_lshrrev_b32_e32 v9, 16, v8
; GFX942-NEXT:    v_cndmask_b32_e32 v8, v7, v8, vcc
...
; GFX942-NEXT:    v_cndmask_b32_sdwa v0, v7, v2, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, v6, -v4
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v2, vcc
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, v8, -v5
; GFX942-NEXT:    v_perm_b32 v0, v0, v2, s0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v1, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:    v_mov_b32_e32 v5, 0x7e00
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v0, v2
; GFX942-NEXT:    v_lshrrev_b32_e32 v6, 16, v4
; GFX942-NEXT:    s_mov_b32 s0, 0x5040100
...
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v1, v3
; GFX942-NEXT:    v_perm_b32 v2, v0, v4, s0
; GFX942-NEXT:    v_lshrrev_b32_e32 v7, 16, v6
; GFX942-NEXT:    v_cndmask_b32_e32 v6, v5, v6, vcc
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v1, v3 src0_sel:WORD_1 src1_sel:WORD_1
...
; GFX942-NEXT:    v_perm_b32 v2, v0, v6, s0
; GFX942-NEXT:    v_pk_min_f16 v2, v4, v2
; GFX942-NEXT:    v_cndmask_b32_sdwa v9, v7, v8, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v1, v3
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v8, vcc
; GFX942-NEXT:    v_perm_b32 v3, v9, v1, s0
; GFX942-NEXT:    v_pk_min_f16 v3, v5, v3
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v5, v9 src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v8, v7, v3, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v4, v0 src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v0, v7, v2, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v4, v6
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v2, vcc
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v5, v1
; GFX942-NEXT:    v_perm_b32 v0, v0, v2, s0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v3, vcc
...
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v9, v5 src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v8, v7, v3, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v0, v4 src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    s_nop 1
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v2, vcc
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v1, v5
; GFX942-NEXT:    v_perm_b32 v0, v0, v2, s0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v3, vcc
; GFX942-NEXT:    v_perm_b32 v1, v8, v1, s0
...
; GFX942-NEXT:    v_perm_b32 v2, v0, v4, s0
; GFX942-NEXT:    v_pk_min_f16 v2, v2, 4.0 op_sel_hi:[1,0]
; GFX942-NEXT:    v_cndmask_b32_sdwa v7, v5, v6, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v1, v3
; GFX942-NEXT:    s_nop 1
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v6, v5, v3, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v0, v0
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v0, v5, v2, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v4, v4
...
; GFX942-NEXT:    v_min_f16_e32 v1, s2, v0
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, s2, v0
; GFX942-NEXT:    v_and_b32_e32 v3, 0xffff, v0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v2, v1, vcc
; GFX942-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX942-NEXT:    v_readfirstlane_b32 s0, v3
; GFX942-NEXT:    v_readfirstlane_b32 s1, v0
; GFX942-NEXT:    ; return to shader part epilog
;
...
; GFX942-NEXT:    v_perm_b32 v0, v5, v1, s0
; GFX942-NEXT:    v_pk_min_f16 v3, v0, v2
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v5, v2 src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v5, v4, v3, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v1, v2
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v4, v3, vcc
