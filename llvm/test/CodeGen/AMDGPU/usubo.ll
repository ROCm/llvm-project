...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=tonga | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx900 | FileCheck %s --check-prefix=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1010 | FileCheck %s --check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1100 | FileCheck %s --check-prefix=GFX11
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_sub_co_u32 v0, s4, s6, s7
...
; SI-NEXT:    s_mov_b32 s5, s3
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_sub_i32_e64 v0, s[0:1], v0, v1
...
; VI-NEXT:    v_mov_b32_e32 v3, s3
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_sub_u32_e64 v4, s[0:1], v4, v5
...
; GFX9-NEXT:    global_load_dword v2, v0, s[14:15]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_sub_co_u32_e64 v1, s[0:1], v1, v2
...
; GFX10-NEXT:    s_and_b32 s0, s2, exec_lo
; GFX10-NEXT:    s_cselect_b32 s0, 1, 0
...
; GFX10-NEXT:    v_sub_co_u32 v0, s1, v0, v2
; GFX10-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX10-NEXT:    s_cselect_b32 s0, 1, 0
...
; GFX11-NEXT:    v_sub_co_u32 v0, s5, v0, v2
; GFX11-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX11-NEXT:    s_cselect_b32 s4, 1, 0
; GFX11-NEXT:    s_and_b32 s5, s5, exec_lo
; GFX11-NEXT:    s_cselect_b32 s5, 1, 0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v3, s4 :: v_dual_mov_b32 v2, s5
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    global_store_byte v1, v0, s[10:11]
; GFX9-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_and_b64 s[0:1], s[2:3], exec
; GFX9-NEXT:    s_cselect_b32 s0, 1, 0
; GFX9-NEXT:    global_store_dword v0, v1, s[8:9]
; GFX9-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-NEXT:    global_store_byte v0, v1, s[10:11]
...
; SI-NEXT:    v_sub_i32_e32 v0, vcc, s6, v0
; SI-NEXT:    s_sub_i32 s6, s4, s5
; SI-NEXT:    s_and_b64 s[4:5], vcc, exec
; SI-NEXT:    s_cselect_b32 s4, 1, 0
; SI-NEXT:    v_mov_b32_e32 v1, s4
; SI-NEXT:    v_sub_i32_e32 v1, vcc, s6, v1
; SI-NEXT:    s_and_b64 s[4:5], vcc, exec
; SI-NEXT:    s_cselect_b32 s4, 1, 0
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v0, s3
; GFX9-NEXT:    s_sub_i32 s3, s0, s1
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, s2, v0
; GFX9-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX9-NEXT:    s_cselect_b32 s0, 1, 0
; GFX9-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-NEXT:    v_sub_co_u32_e32 v1, vcc, s3, v1
; GFX9-NEXT:    s_and_b64 s[0:1], vcc, exec
; GFX9-NEXT:    s_cselect_b32 s0, 1, 0
...
; GFX10-NEXT:    s_and_b32 s1, s2, exec_lo
; GFX10-NEXT:    s_cselect_b32 s1, 1, 0
; GFX10-NEXT:    v_sub_co_u32 v1, s0, s0, s1
; GFX10-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX10-NEXT:    s_cselect_b32 s0, 1, 0
; GFX10-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX11-NEXT:    s_and_b32 s1, s2, exec_lo
; GFX11-NEXT:    s_cselect_b32 s1, 1, 0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    v_sub_co_u32 v1, s0, s0, s1
; GFX11-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX11-NEXT:    s_cselect_b32 s0, 1, 0
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_sub_u32 s6, s6, s7
; SI-NEXT:    s_subb_u32 s4, s4, s5
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
;
