...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.02 | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00 | FileCheck %s --check-prefix=GFX9
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.10 | FileCheck %s --check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 | FileCheck %s --check-prefix=GFX11
