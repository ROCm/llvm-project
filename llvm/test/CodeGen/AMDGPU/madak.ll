...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX6 %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GFX10-MAD %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GFX11-MAD %s

; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx942 -fp-contract=fast < %s | FileCheck -check-prefixes=GFX942-FMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -fp-contract=fast < %s | FileCheck -check-prefixes=GFX10-FMA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -fp-contract=fast < %s | FileCheck -check-prefixes=GFX11-FMA %s
...
; GFX942-FMA:       ; %bb.0:
; GFX942-FMA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX942-FMA-NEXT:    s_nop 0
; GFX942-FMA-NEXT:    s_load_dword s4, s[4:5], 0x34
; GFX942-FMA-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX942-FMA-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; GFX942-FMA-NEXT:    global_load_dword v1, v0, s[2:3]
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    v_fmac_f32_e32 v2, s4, v1
...
; GFX6-NEXT:    v_mac_f32_e32 v3, s4, v2
; GFX6-NEXT:    buffer_store_dword v3, v[0:1], s[0:3], 0 addr64
; GFX6-NEXT:    s_endpgm
;
