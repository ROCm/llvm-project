...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-NODL %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11-DL,GFX11-DL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11-DL,GFX11-DL-FAKE16 %s
...
; GFX7-NEXT:    v_bfe_u32 v5, v0, 8, 8
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_u32_u24 v8, v1, v3, s0
; GFX7-NEXT:    v_mad_u32_u24 v4, v4, v5, v8
; GFX7-NEXT:    v_bfe_u32 v6, v2, 16, 8
; GFX7-NEXT:    v_bfe_u32 v7, v0, 16, 8
...
; GFX7-NEXT:    v_and_b32_e32 v3, 0xff, v0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_u32_u24 v4, v4, v5, s0
; GFX7-NEXT:    v_bfe_u32 v6, v2, 16, 8
; GFX7-NEXT:    v_bfe_u32 v7, v0, 16, 8
; GFX7-NEXT:    v_mad_u32_u24 v1, v1, v3, v4
; GFX7-NEXT:    v_lshrrev_b32_e32 v2, 24, v2
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, 24, v0
; GFX7-NEXT:    v_mad_u32_u24 v1, v6, v7, v1
; GFX7-NEXT:    v_add_i32_e32 v5, vcc, s0, v4
; GFX7-NEXT:    v_mad_u32_u24 v0, v2, v0, v1
; GFX7-NEXT:    v_add_i32_e32 v0, vcc, v0, v5
; GFX7-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, v6.l
...
; GFX7-NEXT:    v_and_b32_e32 v4, 0xff, v0
; GFX7-NEXT:    v_bfe_i32 v7, v2, 16, 8
; GFX7-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_mad_u32_u24 v1, v6, v5, v1
; GFX7-NEXT:    v_bfe_u32 v8, v0, 16, 8
...
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    global_load_dword v1, v0, s[0:1]
; GFX9-NODL-NEXT:    s_nop 0
; GFX9-NODL-NEXT:    global_load_dword v0, v0, s[2:3]
; GFX9-NODL-NEXT:    s_movk_i32 s0, 0xff
; GFX9-NODL-NEXT:    global_load_ushort v3, v2, s[6:7]
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v7, 8, v1
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v8, 8, v0
; GFX9-NODL-NEXT:    v_and_b32_e32 v7, 0xff, v7
; GFX9-NODL-NEXT:    v_bfe_i32 v8, v8, 0, 8
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GFX9-NODL-NEXT:    v_bfe_i32 v5, v1, 0, 8
; GFX9-NODL-NEXT:    v_and_b32_e32 v6, 0xff, v0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_mad_legacy_u16 v3, v7, v8, v3
; GFX9-NODL-NEXT:    v_and_b32_sdwa v9, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v0, 24, v0
...
; GFX9-NODL-NEXT:    v_mad_legacy_u16 v0, v1, v0, v3
; GFX9-NODL-NEXT:    global_store_short v2, v0, s[6:7]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v8, 8, v0
; GFX9-DL-NEXT:    v_and_b32_e32 v7, 0xff, v7
; GFX9-DL-NEXT:    v_bfe_i32 v8, v8, 0, 8
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GFX9-DL-NEXT:    v_bfe_i32 v5, v1, 0, 8
; GFX9-DL-NEXT:    v_and_b32_e32 v6, 0xff, v0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_mad_legacy_u16 v3, v7, v8, v3
; GFX9-DL-NEXT:    v_and_b32_sdwa v9, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v0, 24, v0
...
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v2.l
; GFX11-DL-TRUE16-NEXT:    v_mad_u16 v0.l, v3.l, v0.h, v0.l
; GFX11-DL-TRUE16-NEXT:    global_store_b16 v5, v0, s[4:5]
; GFX11-DL-TRUE16-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_u32_u24 v0, v2, v0, s0
...
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_lshrrev_b16_e32 v6, 8, v0
; GFX9-NODL-NEXT:    v_lshrrev_b32_e32 v7, 24, v0
...
; GFX9-NODL-NEXT:    v_and_b32_e32 v9, 0xff, v0
; GFX9-NODL-NEXT:    v_and_b32_sdwa v0, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NODL-NEXT:    v_perm_b32 v0, v7, v0, s1
; GFX9-NODL-NEXT:    v_perm_b32 v1, v5, v1, s1
; GFX9-NODL-NEXT:    v_perm_b32 v5, v6, v9, s1
; GFX9-NODL-NEXT:    v_perm_b32 v4, v4, v8, s1
; GFX9-NODL-NEXT:    v_pk_mul_lo_u16 v0, v1, v0
; GFX9-NODL-NEXT:    v_pk_mul_lo_u16 v1, v4, v5
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NODL-NEXT:    v_add_u16_e32 v1, v1, v0
; GFX9-NODL-NEXT:    v_add_u16_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX9-NODL-NEXT:    global_store_short v2, v0, s[6:7]
; GFX9-NODL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_lshrrev_b16_e32 v6, 8, v0
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v7, 24, v0
...
; GFX9-DL-NEXT:    v_and_b32_e32 v9, 0xff, v0
; GFX9-DL-NEXT:    v_and_b32_sdwa v0, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-DL-NEXT:    v_perm_b32 v0, v7, v0, s1
...
; GFX9-DL-NEXT:    v_pk_mul_lo_u16 v1, v4, v5
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX7-NEXT:    s_mov_b64 s[8:9], s[2:3]
; GFX7-NEXT:    buffer_load_dword v0, v[0:1], s[8:11], 0 addr64
; GFX7-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x11
; GFX7-NEXT:    s_and_b32 s0, s6, 0xffff
; GFX7-NEXT:    s_mov_b32 s10, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    v_mad_u32_u24 v1, v1, s0, v5
; GFX7-NEXT:    v_bfe_u32 v0, v0, 16, 8
; GFX7-NEXT:    v_bfe_u32 v2, v2, 16, 8
; GFX7-NEXT:    v_mad_u32_u24 v1, v3, v4, v1
; GFX7-NEXT:    v_mad_u32_u24 v0, v2, v0, v1
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_mul_u32_u24_sdwa v2, v1, s3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_perm_b32 v0, v0, v0, 0xc0c0201
; GFX10-DL-NEXT:    v_perm_b32 v1, v1, v1, 0xc0c0201
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, s2, v2
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v1, v0, v2
...
; GFX7:       ; %bb.0: ; %entry
; GFX7-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX7-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0xf
; GFX7-NEXT:    s_mov_b32 s7, 0xf000
; GFX7-NEXT:    s_mov_b32 s6, 0
; GFX7-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    v_bfe_u32 v2, v2, 8, 8
; GFX7-NEXT:    s_waitcnt vmcnt(1)
; GFX7-NEXT:    v_bfe_u32 v1, v3, 8, 8
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mad_u32_u24 v4, v1, v1, s0
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_bfe_u32 v0, v0, 16, 8
; GFX7-NEXT:    v_bfe_u32 v3, v3, 16, 8
; GFX7-NEXT:    v_mad_u32_u24 v1, v2, v1, v4
...
; GFX7-NEXT:    buffer_load_dword v3, v[0:1], s[0:3], 0 addr64
; GFX7-NEXT:    s_mov_b64 s[0:1], s[12:13]
; GFX7-NEXT:    buffer_load_dword v4, v[0:1], s[0:3], 0 addr64
; GFX7-NEXT:    s_mov_b64 s[0:1], s[14:15]
...
; GFX7-NEXT:    v_bfe_u32 v0, v0, 8, 8
; GFX7-NEXT:    v_mad_u32_u24 v1, v6, v4, v1
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_and_b32_e32 v5, 0xff, v0
; GFX7-NEXT:    v_bfe_u32 v3, v0, 16, 8
; GFX7-NEXT:    v_mul_u32_u24_e32 v4, v4, v5
; GFX7-NEXT:    v_bfe_u32 v6, v2, 8, 8
...
; GFX10-DL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; GFX10-DL-NEXT:    v_lshlrev_b32_e32 v1, 8, v0
; GFX10-DL-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    global_load_dword v2, v0, s[2:3]
; GFX10-DL-NEXT:    global_load_dword v3, v1, s[0:1] offset:252
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
...
; GFX11-DL-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX11-DL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_lshlrev_b32 v1, 8, v0
; GFX11-DL-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX11-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-DL-NEXT:    global_load_b32 v0, v0, s[2:3]
; GFX11-DL-NEXT:    global_load_b32 v1, v1, s[0:1] offset:252
; GFX11-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX11-DL-NEXT:    v_perm_b32 v0, v0, v0, 0x3020001
; GFX11-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DL-NEXT:    v_perm_b32 v1, v1, v1, 0x1000302
; GFX11-DL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DL-NEXT:    v_dot4_u32_u8 v0, v1, v0, 0
; GFX11-DL-NEXT:    global_store_b32 v2, v0, s[4:5]
; GFX11-DL-NEXT:    s_endpgm
