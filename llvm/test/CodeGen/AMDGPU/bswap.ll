...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=gfx600 | FileCheck %s --check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-flat-for-global,+real-true16 | FileCheck %s --check-prefixes=GFX11,GFX11-REAL16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-flat-for-global,-real-true16 | FileCheck %s --check-prefixes=GFX11,GFX11-FAKE16
...
; SI-NEXT:    v_bfi_b32 v1, s0, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s2, s2, 8
; SI-NEXT:    v_alignbit_b32 v2, s2, s2, 24
...
; SI-NEXT:    v_alignbit_b32 v0, s3, s3, 8
; SI-NEXT:    v_alignbit_b32 v1, s3, s3, 24
; SI-NEXT:    s_mov_b32 s3, 0xff00ff
; SI-NEXT:    v_bfi_b32 v3, s3, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s2, s2, 8
; SI-NEXT:    v_alignbit_b32 v1, s2, s2, 24
; SI-NEXT:    v_bfi_b32 v2, s3, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s1, s1, 8
; SI-NEXT:    v_alignbit_b32 v1, s1, s1, 24
; SI-NEXT:    v_bfi_b32 v1, s3, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s0, s0, 8
; SI-NEXT:    v_alignbit_b32 v4, s0, s0, 24
; SI-NEXT:    v_bfi_b32 v0, s3, v4, v0
; SI-NEXT:    v_alignbit_b32 v4, s7, s7, 8
; SI-NEXT:    v_alignbit_b32 v5, s7, s7, 24
; SI-NEXT:    v_bfi_b32 v7, s3, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s6, s6, 8
; SI-NEXT:    v_alignbit_b32 v5, s6, s6, 24
; SI-NEXT:    v_bfi_b32 v6, s3, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s5, s5, 8
; SI-NEXT:    v_alignbit_b32 v5, s5, s5, 24
; SI-NEXT:    v_bfi_b32 v5, s3, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s4, s4, 8
; SI-NEXT:    v_alignbit_b32 v8, s4, s4, 24
; SI-NEXT:    v_bfi_b32 v4, s3, v8, v4
...
; SI-NEXT:    v_bfi_b32 v1, s0, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s3, s3, 8
; SI-NEXT:    v_alignbit_b32 v2, s3, s3, 24
; SI-NEXT:    v_bfi_b32 v0, s0, v2, v0
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; SI-NEXT:    s_endpgm
;
...
; SI-NEXT:    v_alignbit_b32 v0, s3, s3, 8
; SI-NEXT:    v_alignbit_b32 v1, s3, s3, 24
; SI-NEXT:    v_bfi_b32 v2, s2, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s0, s0, 8
; SI-NEXT:    v_alignbit_b32 v1, s0, s0, 24
; SI-NEXT:    v_bfi_b32 v1, s2, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s1, s1, 8
; SI-NEXT:    v_alignbit_b32 v4, s1, s1, 24
; SI-NEXT:    v_bfi_b32 v0, s2, v4, v0
; SI-NEXT:    v_alignbit_b32 v4, s6, s6, 8
; SI-NEXT:    v_alignbit_b32 v5, s6, s6, 24
; SI-NEXT:    v_bfi_b32 v7, s2, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s7, s7, 8
; SI-NEXT:    v_alignbit_b32 v5, s7, s7, 24
; SI-NEXT:    v_bfi_b32 v6, s2, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s4, s4, 8
; SI-NEXT:    v_alignbit_b32 v5, s4, s4, 24
; SI-NEXT:    v_bfi_b32 v5, s2, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s5, s5, 8
; SI-NEXT:    v_alignbit_b32 v8, s5, s5, 24
; SI-NEXT:    v_bfi_b32 v4, s2, v8, v4
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[12:15], 0 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0
; SI-NEXT:    s_endpgm
;
