...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.00-- | FileCheck %s --check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02-- -mattr=-flat-for-global | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00-- -mattr=-flat-for-global,+real-true16 | FileCheck %s --check-prefixes=GFX11,GFX11-REAL16
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00-- -mattr=-flat-for-global,-real-true16 | FileCheck %s --check-prefixes=GFX11,GFX11-FAKE16
