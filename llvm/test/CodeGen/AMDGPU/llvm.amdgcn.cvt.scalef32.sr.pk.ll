...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx950 < %s | FileCheck -check-prefixes=GCN,GFX950-GISEL %s
