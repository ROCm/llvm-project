...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 -start-before=amdgpu-isel -stop-after=amdgpu-isel < %s | FileCheck %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 -enable-new-pm -start-before=amdgpu-isel -stop-after=amdgpu-isel < %s | FileCheck %s
