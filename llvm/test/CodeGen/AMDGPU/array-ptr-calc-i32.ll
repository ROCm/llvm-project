...
; SI-ALLOCA: v_add_i32_e32 [[PTRREG:v[0-9]+]], vcc, v3, v{{[0-9]+}}
; SI-ALLOCA: buffer_store_dword [[PTRREG]], {{v[0-9]+}}, s[{{[0-9]+:[0-9]+}}], 0 offen offset:64
; SI-ALLOCA: s_barrier
; SI-ALLOCA: buffer_load_dword [[PTRREG]], {{v[0-9]+}}, s[{{[0-9]+:[0-9]+}}], 0 offen offset:64
;
