...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.04 < %s | FileCheck -check-prefixes=SI,FUNC,GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=SI,FUNC,GFX8 %s
