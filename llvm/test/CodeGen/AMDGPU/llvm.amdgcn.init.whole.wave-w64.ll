...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -O2 -mtriple=amdgpu12.00 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL12 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -O2 -mtriple=amdgpu10.30 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL10 %s
