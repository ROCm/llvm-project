...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -O2 -mtriple=amdgpu12.00 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -O2 -mtriple=amdgpu12.00 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=DAGISEL12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -O2 -mtriple=amdgpu10.30 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=GISEL10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -O2 -mtriple=amdgpu10.30 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefix=DAGISEL10 %s
...
; GISEL12-NEXT:    s_xor_b64 s[6:7], s[10:11], exec
; GISEL12-NEXT:    s_mov_b32 s8, s3
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_and_b64 s[6:7], exec, s[6:7]
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_xor_b64 exec, s[6:7], exec
...
; GISEL10-NEXT:    s_xor_b64 s[6:7], s[10:11], exec
; GISEL10-NEXT:    s_mov_b32 s8, s3
; GISEL10-NEXT:    s_and_b64 s[6:7], exec, s[6:7]
; GISEL10-NEXT:    s_xor_b64 exec, s[6:7], exec
