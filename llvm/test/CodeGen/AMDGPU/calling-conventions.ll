...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s5, s4, 0x80008
...
; SI-NEXT:    s_bfe_u32 s10, s8, 0x80008
...
; SI-NEXT:    s_lshr_b32 s11, s8, 24
; SI-NEXT:    s_bfe_u32 s12, s8, 0x80008
; SI-NEXT:    s_add_i32 s8, s8, s8
; SI-NEXT:    s_add_i32 s9, s9, s9
...
; SI-NEXT:    v_mov_b32_e32 v0, s9
; SI-NEXT:    s_lshl_b32 s9, s11, 24
; SI-NEXT:    s_and_b32 s10, s10, 0xff
; SI-NEXT:    s_lshl_b32 s11, s12, 8
...
; SI-NEXT:    s_bfe_u32 s10, s4, 0x80008
; SI-NEXT:    s_bfe_u32 s11, s5, 0x80008
; SI-NEXT:    s_add_i32 s5, s5, s5
; SI-NEXT:    s_add_i32 s4, s4, s4
; SI-NEXT:    s_add_i32 s9, s9, s9
; SI-NEXT:    s_add_i32 s8, s8, s8
...
; SI-NEXT:    s_bfe_u32 s16, s4, 0x80008
; SI-NEXT:    s_bfe_u32 s17, s5, 0x80008
; SI-NEXT:    s_bfe_u32 s18, s6, 0x80008
; SI-NEXT:    s_bfe_u32 s19, s7, 0x80008
; SI-NEXT:    s_add_i32 s7, s7, s7
; SI-NEXT:    s_add_i32 s6, s6, s6
; SI-NEXT:    s_add_i32 s5, s5, s5
; SI-NEXT:    s_add_i32 s4, s4, s4
...
; SI-NEXT:    s_mov_b64 s[4:5], 16
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_mov_b64 s[0:1], 0
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_lshr_b32 s16, s12, 16
; SI-NEXT:    s_lshr_b32 s17, s12, 24
; SI-NEXT:    s_lshr_b32 s18, s13, 16
; SI-NEXT:    s_lshr_b32 s19, s13, 24
; SI-NEXT:    s_lshr_b32 s20, s14, 16
; SI-NEXT:    s_lshr_b32 s21, s14, 24
; SI-NEXT:    s_lshr_b32 s22, s15, 16
; SI-NEXT:    s_lshr_b32 s23, s15, 24
; SI-NEXT:    s_lshr_b32 s24, s8, 16
; SI-NEXT:    s_lshr_b32 s25, s8, 24
; SI-NEXT:    s_lshr_b32 s26, s9, 16
; SI-NEXT:    s_lshr_b32 s27, s9, 24
; SI-NEXT:    s_lshr_b32 s28, s10, 16
; SI-NEXT:    s_lshr_b32 s29, s10, 24
; SI-NEXT:    s_lshr_b32 s30, s11, 16
; SI-NEXT:    s_lshr_b32 s31, s11, 24
; SI-NEXT:    s_bfe_u32 s33, s12, 0x80008
; SI-NEXT:    s_bfe_u32 s34, s13, 0x80008
; SI-NEXT:    s_bfe_u32 s35, s14, 0x80008
; SI-NEXT:    s_bfe_u32 s36, s15, 0x80008
; SI-NEXT:    s_bfe_u32 s37, s8, 0x80008
; SI-NEXT:    s_bfe_u32 s38, s9, 0x80008
; SI-NEXT:    s_bfe_u32 s39, s10, 0x80008
; SI-NEXT:    s_bfe_u32 s40, s11, 0x80008
; SI-NEXT:    s_add_i32 s11, s11, s11
; SI-NEXT:    s_add_i32 s10, s10, s10
; SI-NEXT:    s_add_i32 s9, s9, s9
; SI-NEXT:    s_add_i32 s8, s8, s8
...
; SI-NEXT:    s_or_b32 s10, s10, s39
; SI-NEXT:    s_lshl_b32 s26, s26, 16
; SI-NEXT:    s_or_b32 s9, s9, s38
; SI-NEXT:    s_lshl_b32 s24, s24, 16
; SI-NEXT:    s_or_b32 s8, s8, s37
; SI-NEXT:    s_lshl_b32 s22, s22, 16
; SI-NEXT:    s_or_b32 s15, s15, s36
; SI-NEXT:    s_lshl_b32 s20, s20, 16
; SI-NEXT:    s_or_b32 s14, s14, s35
; SI-NEXT:    s_lshl_b32 s18, s18, 16
; SI-NEXT:    s_or_b32 s13, s13, s34
; SI-NEXT:    s_lshl_b32 s16, s16, 16
; SI-NEXT:    s_or_b32 s12, s12, s33
...
; SI-NEXT:    s_lshl_b32 s6, s6, 2
; SI-NEXT:    s_or_b32 s4, s4, s5
; SI-NEXT:    s_lshl_b32 s5, s17, 2
; SI-NEXT:    s_or_b32 s0, s0, s1
; SI-NEXT:    s_or_b32 s1, s15, s14
; SI-NEXT:    s_and_b32 s9, s12, 3
; SI-NEXT:    s_or_b32 s10, s11, s10
...
; SI-NEXT:    s_or_b32 s7, s8, s10
; SI-NEXT:    s_or_b32 s4, s4, s6
; SI-NEXT:    s_or_b32 s0, s0, s5
; SI-NEXT:    s_lshl_b32 s1, s1, 12
; SI-NEXT:    s_and_b32 s5, s7, 15
...
; SI-NEXT:    s_lshl_b32 s6, s6, 2
; SI-NEXT:    s_or_b32 s4, s4, s5
; SI-NEXT:    s_lshl_b32 s5, s34, 2
; SI-NEXT:    s_or_b32 s0, s0, s1
; SI-NEXT:    s_or_b32 s1, s31, s30
; SI-NEXT:    s_and_b32 s9, s28, 3
; SI-NEXT:    s_or_b32 s13, s27, s26
; SI-NEXT:    s_and_b32 s17, s24, 3
; SI-NEXT:    s_or_b32 s21, s23, s22
...
; SI-NEXT:    s_or_b32 s6, s7, s6
; SI-NEXT:    s_and_b32 s4, s4, 3
; SI-NEXT:    s_or_b32 s5, s33, s5
; SI-NEXT:    s_and_b32 s0, s0, 3
; SI-NEXT:    s_or_b32 s1, s9, s1
; SI-NEXT:    s_or_b32 s7, s17, s13
; SI-NEXT:    s_or_b32 s9, s20, s21
; SI-NEXT:    s_or_b32 s11, s16, s18
...
; SI-NEXT:    s_and_b32 s7, s11, 15
; SI-NEXT:    s_lshl_b32 s9, s12, 12
