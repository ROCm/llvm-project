...
; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 | FileCheck -check-prefixes=MUBUF,DEFAULTSIZE %s
; RUN: sed 's/CODE_OBJECT_VERSION/500/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 | FileCheck -check-prefixes=MUBUF,DEFAULTSIZE-V5 %s
; RUN: sed 's/CODE_OBJECT_VERSION/600/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 | FileCheck -check-prefixes=MUBUF,DEFAULTSIZE-V5 %s
; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -amdgpu-assume-dynamic-stack-object-size=1024 | FileCheck -check-prefixes=MUBUF,ASSUME1024 %s
; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -mattr=+enable-flat-scratch | FileCheck -check-prefixes=FLATSCR,DEFAULTSIZE %s
; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -mattr=+enable-flat-scratch -amdgpu-assume-dynamic-stack-object-size=1024 | FileCheck -check-prefixes=FLATSCR,ASSUME1024 %s
...
; MUBUF-NEXT:    s_xor_b64 s[4:5], vcc, exec
; MUBUF-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
...
; MUBUF-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; MUBUF-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; MUBUF-NEXT:    ; divergent control-flow edge
; MUBUF-NEXT:    s_cbranch_execz .LBB2_3
...
; FLATSCR-NEXT:    s_xor_b64 s[0:1], vcc, exec
; FLATSCR-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
...
; FLATSCR-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; FLATSCR-NEXT:    s_or_b64 s[0:1], s[0:1], s[2:3]
; FLATSCR-NEXT:    ; divergent control-flow edge
; FLATSCR-NEXT:    s_cbranch_execz .LBB2_3
