...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu11.50 < %s | FileCheck %s --check-prefixes=CHECK,GISEL-GFX11
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00 < %s | FileCheck %s --check-prefixes=CHECK,SDAG
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.00 < %s | FileCheck %s --check-prefixes=CHECK,GISEL-GFX12
