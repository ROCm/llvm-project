...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1150 < %s | FileCheck %s --check-prefixes=CHECK,GISEL-GFX11
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck %s --check-prefixes=CHECK,SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck %s --check-prefixes=CHECK,GISEL-GFX12
...
; SDAG-LABEL: frint_f32:
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_rndne_f32 s0, s0
; SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; SDAG-NEXT:    v_mov_b32_e32 v0, s0
; SDAG-NEXT:    ; return to shader part epilog
;
; GISEL-GFX11-LABEL: frint_f32:
; GISEL-GFX11:       ; %bb.0:
; GISEL-GFX11-NEXT:    v_rndne_f32_e32 v0, s0
; GISEL-GFX11-NEXT:    ; return to shader part epilog
;
; GISEL-GFX12-LABEL: frint_f32:
; GISEL-GFX12:       ; %bb.0:
; GISEL-GFX12-NEXT:    v_rndne_f32_e32 v0, s0
