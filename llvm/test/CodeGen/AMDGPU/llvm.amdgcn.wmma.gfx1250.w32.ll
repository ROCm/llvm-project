...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.50 -mattr=-real-true16 -global-isel -global-isel-abort=2 < %s | FileCheck %s --check-prefixes=GISEL,GISEL-FAKE16
; RUN: llc -mtriple=amdgpu12.50 -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=GFX1250,GFX1250-REAL16
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.50 -mattr=+real-true16 -global-isel -global-isel-abort=2 < %s | FileCheck %s --check-prefixes=GISEL,GISEL-REAL16
