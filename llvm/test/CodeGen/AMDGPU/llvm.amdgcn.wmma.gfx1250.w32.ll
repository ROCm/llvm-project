...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck %s --check-prefix=GFX1250
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1250 -global-isel -global-isel-abort=2 -mattr=-real-true16 < %s | FileCheck %s --check-prefix=GISEL
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=GFX1250,GFX1250-REAL16
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -global-isel -global-isel-abort=2 < %s | FileCheck %s --check-prefixes=GISEL,GISEL-REAL16
