...
; GFX90A-NEXT:    v_add_co_u32_e64 v5, s[4:5], -1, v2
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_addc_co_u32_e64 v6, s[4:5], -1, v3, s[4:5]
; GFX90A-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[2:3]
...
; GFX950-NEXT:    s_nop 1
; GFX950-NEXT:    v_cndmask_b32_e64 v6, -1, v2, s[0:1]
...
; GFX90A-NEXT:    v_add_co_u32_e64 v5, s[4:5], -1, v0
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_addc_co_u32_e64 v6, s[4:5], -1, v1, s[4:5]
