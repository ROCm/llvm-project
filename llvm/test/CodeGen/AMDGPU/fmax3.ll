...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -enable-var-scope -check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1170 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX1170,GFX1170-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1170 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX1170,GFX1170-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250,GFX1250-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250,GFX1250-FAKE16 %s
...
; SI-NEXT:    buffer_load_dword v1, off, s[12:15], 0 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_dword v2, off, s[16:19], 0 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    buffer_load_b32 v0, off, s[8:11], 0 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_load_b32 v1, off, s[12:15], 0 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_load_b32 v2, off, s[16:19], 0 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1170-NEXT:    s_mov_b32 s8, s2
; GFX1170-NEXT:    s_mov_b32 s9, s3
; GFX1170-NEXT:    s_mov_b32 s12, s4
; GFX1170-NEXT:    s_mov_b32 s13, s5
; GFX1170-NEXT:    s_mov_b32 s16, s6
; GFX1170-NEXT:    s_mov_b32 s17, s7
; GFX1170-NEXT:    buffer_load_b32 v0, off, s[8:11], 0 glc dlc
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    buffer_load_b32 v1, off, s[12:15], 0 glc dlc
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    buffer_load_b32 v2, off, s[16:19], 0 glc dlc
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_mov_b32 s2, s10
; GFX1170-NEXT:    s_mov_b32 s3, s11
; GFX1170-NEXT:    v_max3_num_f32 v0, v0, v1, v2
; GFX1170-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
...
; GFX12-NEXT:    s_mov_b32 s13, s5
; GFX12-NEXT:    s_mov_b32 s16, s6
; GFX12-NEXT:    s_mov_b32 s17, s7
; GFX12-NEXT:    buffer_load_b32 v0, off, s[8:11], null scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b32 v1, off, s[12:15], null scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b32 v2, off, s[16:19], null scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_mov_b32 s5, s13
; GFX1250-NEXT:    s_mov_b32 s16, s14
; GFX1250-NEXT:    s_mov_b32 s17, s15
; GFX1250-NEXT:    buffer_load_b32 v0, off, s[0:3], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_load_b32 v1, off, s[4:7], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_load_b32 v2, off, s[16:19], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s10, s2
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_load_ushort v1, off, s[4:7], 0 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s12, s4
; GFX11-TRUE16-NEXT:    s_mov_b32 s13, s5
; GFX11-TRUE16-NEXT:    s_mov_b32 s16, s6
; GFX11-TRUE16-NEXT:    s_mov_b32 s17, s7
; GFX11-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[8:11], 0 glc dlc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[12:15], 0 glc dlc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[16:19], 0 glc dlc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s12, s4
; GFX11-FAKE16-NEXT:    s_mov_b32 s13, s5
; GFX11-FAKE16-NEXT:    s_mov_b32 s16, s6
; GFX11-FAKE16-NEXT:    s_mov_b32 s17, s7
; GFX11-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], 0 glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    buffer_load_u16 v1, off, s[12:15], 0 glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    buffer_load_u16 v2, off, s[16:19], 0 glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1170-TRUE16-NEXT:    s_mov_b32 s8, s2
; GFX1170-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX1170-TRUE16-NEXT:    s_mov_b32 s12, s4
; GFX1170-TRUE16-NEXT:    s_mov_b32 s13, s5
; GFX1170-TRUE16-NEXT:    s_mov_b32 s16, s6
; GFX1170-TRUE16-NEXT:    s_mov_b32 s17, s7
; GFX1170-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[8:11], 0 glc dlc
; GFX1170-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[12:15], 0 glc dlc
; GFX1170-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[16:19], 0 glc dlc
; GFX1170-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-TRUE16-NEXT:    s_mov_b32 s2, s10
; GFX1170-TRUE16-NEXT:    s_mov_b32 s3, s11
; GFX1170-TRUE16-NEXT:    v_max3_num_f16 v0.l, v0.l, v0.h, v1.l
; GFX1170-TRUE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; GFX1170-FAKE16-NEXT:    s_mov_b32 s8, s2
; GFX1170-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX1170-FAKE16-NEXT:    s_mov_b32 s12, s4
; GFX1170-FAKE16-NEXT:    s_mov_b32 s13, s5
; GFX1170-FAKE16-NEXT:    s_mov_b32 s16, s6
; GFX1170-FAKE16-NEXT:    s_mov_b32 s17, s7
; GFX1170-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], 0 glc dlc
; GFX1170-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-FAKE16-NEXT:    buffer_load_u16 v1, off, s[12:15], 0 glc dlc
; GFX1170-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-FAKE16-NEXT:    buffer_load_u16 v2, off, s[16:19], 0 glc dlc
; GFX1170-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-FAKE16-NEXT:    s_mov_b32 s2, s10
; GFX1170-FAKE16-NEXT:    s_mov_b32 s3, s11
; GFX1170-FAKE16-NEXT:    v_max3_num_f16 v0, v0, v1, v2
; GFX1170-FAKE16-NEXT:    buffer_store_b16 v0, off, s[0:3], 0
...
; GFX12-TRUE16-NEXT:    s_mov_b32 s12, s4
; GFX12-TRUE16-NEXT:    s_mov_b32 s13, s5
; GFX12-TRUE16-NEXT:    s_mov_b32 s16, s6
; GFX12-TRUE16-NEXT:    s_mov_b32 s17, s7
; GFX12-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[8:11], null scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[12:15], null scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[16:19], null scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    s_mov_b32 s2, s10
; GFX12-TRUE16-NEXT:    s_mov_b32 s3, s11
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s12, s4
; GFX12-FAKE16-NEXT:    s_mov_b32 s13, s5
; GFX12-FAKE16-NEXT:    s_mov_b32 s16, s6
; GFX12-FAKE16-NEXT:    s_mov_b32 s17, s7
; GFX12-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], null scope:SCOPE_SYS
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_load_u16 v1, off, s[12:15], null scope:SCOPE_SYS
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_load_u16 v2, off, s[16:19], null scope:SCOPE_SYS
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    s_mov_b32 s2, s10
...
; GFX1250-TRUE16-NEXT:    s_mov_b32 s0, s10
; GFX1250-TRUE16-NEXT:    s_mov_b32 s1, s11
; GFX1250-TRUE16-NEXT:    s_mov_b32 s4, s12
; GFX1250-TRUE16-NEXT:    s_mov_b32 s5, s13
; GFX1250-TRUE16-NEXT:    s_mov_b32 s16, s14
; GFX1250-TRUE16-NEXT:    s_mov_b32 s17, s15
; GFX1250-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[0:3], null scope:SCOPE_SYS
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[4:7], null scope:SCOPE_SYS
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[16:19], null scope:SCOPE_SYS
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    s_mov_b32 s10, s2
; GFX1250-TRUE16-NEXT:    s_mov_b32 s11, s3
...
; GFX1250-FAKE16-NEXT:    s_mov_b32 s0, s10
; GFX1250-FAKE16-NEXT:    s_mov_b32 s1, s11
; GFX1250-FAKE16-NEXT:    s_mov_b32 s4, s12
; GFX1250-FAKE16-NEXT:    s_mov_b32 s5, s13
; GFX1250-FAKE16-NEXT:    s_mov_b32 s16, s14
; GFX1250-FAKE16-NEXT:    s_mov_b32 s17, s15
; GFX1250-FAKE16-NEXT:    buffer_load_u16 v0, off, s[0:3], null scope:SCOPE_SYS
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    buffer_load_u16 v1, off, s[4:7], null scope:SCOPE_SYS
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    buffer_load_u16 v2, off, s[16:19], null scope:SCOPE_SYS
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    s_mov_b32 s10, s2
; GFX1250-FAKE16-NEXT:    s_mov_b32 s11, s3
