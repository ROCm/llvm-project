...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.00 | FileCheck %s --check-prefixes=GFX6,GCN
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 | FileCheck %s --check-prefixes=GFX8,GCN
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.30-amd-amdpal | FileCheck %s --check-prefixes=GFX10,GCN
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00-amd-amdpal -amdgpu-enable-vopd=0 | FileCheck %s --check-prefixes=GFX11,GCN
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.42 | FileCheck %s --check-prefixes=GFX942,GCN
