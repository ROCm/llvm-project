...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=SI -check-prefix=FUNC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=bonaire < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=CI -check-prefix=FUNC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=CI -check-prefix=FUNC %s
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[8:9], s[2:3], 0
...
; SI-NEXT:    s_add_i32 s11, s3, 0xfffffc01
; SI-NEXT:    s_mov_b32 s3, 0xfffff
; SI-NEXT:    s_lshr_b64 s[8:9], s[2:3], s11
...
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[6:7], v[0:1]
...
; SI-NEXT:    s_add_i32 s11, s6, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[2:3], s11
...
; SI-NEXT:    s_mov_b32 s14, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s11, s3, 0xb0014
; SI-NEXT:    s_add_i32 s15, s11, 0xfffffc01
; SI-NEXT:    s_mov_b32 s11, 0xfffff
; SI-NEXT:    s_lshr_b64 s[12:13], s[10:11], s15
; SI-NEXT:    s_andn2_b64 s[12:13], s[2:3], s[12:13]
; SI-NEXT:    s_and_b32 s16, s3, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s15, 0
; SI-NEXT:    s_cselect_b32 s12, 0, s12
; SI-NEXT:    s_cselect_b32 s13, s16, s13
...
; SI-NEXT:    s_and_b64 s[2:3], s[6:7], vcc
; SI-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; SI-NEXT:    s_cselect_b32 s2, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v5, s2
...
; SI-NEXT:    s_and_b64 s[0:1], s[4:5], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s0, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v5, s0
; SI-NEXT:    v_add_f64 v[4:5], s[2:3], v[4:5]
; SI-NEXT:    s_mov_b32 s11, s14
...
; SI-NEXT:    s_bfe_u32 s2, s1, 0xb0014
; SI-NEXT:    s_add_i32 s23, s2, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[2:3], s[18:19], s23
; SI-NEXT:    s_andn2_b64 s[2:3], s[0:1], s[2:3]
; SI-NEXT:    s_and_b32 s24, s1, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s23, 0
; SI-NEXT:    s_cselect_b32 s2, 0, s2
; SI-NEXT:    s_cselect_b32 s3, s24, s3
; SI-NEXT:    s_cmp_gt_i32 s23, 51
; SI-NEXT:    s_cselect_b32 s2, s0, s2
; SI-NEXT:    s_cselect_b32 s3, s1, s3
; SI-NEXT:    v_mov_b32_e32 v0, s2
...
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[0:1], v[0:1]
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[0:1], 0
; SI-NEXT:    v_add_f64 v[2:3], s[20:21], v[8:9]
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s0, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v9, s0
; SI-NEXT:    s_bfe_u32 s0, s7, 0xb0014
; SI-NEXT:    s_add_i32 s20, s0, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[18:19], s20
; SI-NEXT:    s_andn2_b64 s[0:1], s[6:7], s[0:1]
; SI-NEXT:    s_and_b32 s21, s7, 0x80000000
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[10:11], 0
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[8:9], 0
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[14:15], 0
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[12:13], 0
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx16 s[12:27], s[4:5], 0x29
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_mov_b32 s3, 0xfffff
...
; SI-NEXT:    s_andn2_b64 s[0:1], s[14:15], s[0:1]
; SI-NEXT:    s_and_b32 s7, s15, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s6, 0
; SI-NEXT:    s_cselect_b32 s0, 0, s0
; SI-NEXT:    s_cselect_b32 s1, s7, s1
; SI-NEXT:    s_cmp_gt_i32 s6, 51
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[6:7], s[14:15], 0
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], vcc
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SI-NEXT:    s_cselect_b32 s8, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s6, s13, 0xb0014
; SI-NEXT:    s_add_i32 s9, s6, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[2:3], s9
...
; SI-NEXT:    s_cselect_b32 s28, s12, s6
; SI-NEXT:    s_cselect_b32 s29, s13, s7
...
; SI-NEXT:    s_cselect_b32 s7, s10, s7
; SI-NEXT:    s_cmp_gt_i32 s9, 51
; SI-NEXT:    s_cselect_b32 s38, s16, s6
; SI-NEXT:    s_cselect_b32 s39, s17, s7
...
; SI-NEXT:    s_cselect_b32 s7, s10, s7
; SI-NEXT:    s_cmp_gt_i32 s9, 51
; SI-NEXT:    s_cselect_b32 s40, s22, s6
; SI-NEXT:    s_cselect_b32 s41, s23, s7
...
; SI-NEXT:    s_and_b32 s10, s21, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s9, 0
; SI-NEXT:    s_cselect_b32 s6, 0, s6
; SI-NEXT:    s_cselect_b32 s7, s10, s7
; SI-NEXT:    s_cmp_gt_i32 s9, 51
; SI-NEXT:    s_cselect_b32 s36, s20, s6
; SI-NEXT:    s_cselect_b32 s37, s21, s7
...
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], vcc
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SI-NEXT:    s_cselect_b32 s45, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s6, s27, 0xb0014
; SI-NEXT:    s_add_i32 s8, s6, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[2:3], s8
; SI-NEXT:    s_andn2_b64 s[6:7], s[26:27], s[6:7]
; SI-NEXT:    s_and_b32 s9, s27, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s8, 0
; SI-NEXT:    s_cselect_b32 s7, s9, s7
; SI-NEXT:    s_cselect_b32 s6, 0, s6
; SI-NEXT:    s_cmp_gt_i32 s8, 51
; SI-NEXT:    s_cselect_b32 s30, s26, s6
; SI-NEXT:    s_cselect_b32 s31, s27, s7
; SI-NEXT:    v_mov_b32_e32 v0, s30
; SI-NEXT:    v_mov_b32_e32 v1, s31
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[26:27], v[0:1]
; SI-NEXT:    v_cmp_gt_f64_e64 s[6:7], s[26:27], 0
; SI-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x39
; SI-NEXT:    s_and_b64 s[0:1], s[6:7], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s26, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s0, s25, 0xb0014
; SI-NEXT:    s_add_i32 s6, s0, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[2:3], s6
; SI-NEXT:    s_andn2_b64 s[0:1], s[24:25], s[0:1]
; SI-NEXT:    s_and_b32 s7, s25, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s6, 0
; SI-NEXT:    s_cselect_b32 s1, s7, s1
; SI-NEXT:    s_cselect_b32 s0, 0, s0
; SI-NEXT:    s_cmp_gt_i32 s6, 51
; SI-NEXT:    s_cselect_b32 s7, s25, s1
; SI-NEXT:    s_cselect_b32 s6, s24, s0
; SI-NEXT:    v_mov_b32_e32 v9, s7
; SI-NEXT:    v_mov_b32_e32 v8, s6
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[24:25], v[8:9]
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[24:25], 0
; SI-NEXT:    v_add_f64 v[0:1], s[28:29], v[16:17]
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s24, 0x3ff00000, 0
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s0, s11, 0xb0014
; SI-NEXT:    s_add_i32 s25, s0, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[2:3], s25
; SI-NEXT:    s_andn2_b64 s[0:1], s[10:11], s[0:1]
; SI-NEXT:    s_and_b32 s27, s11, 0x80000000
...
; SI-NEXT:    s_add_i32 s27, s10, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[10:11], s[2:3], s27
; SI-NEXT:    s_andn2_b64 s[10:11], s[8:9], s[10:11]
; SI-NEXT:    s_and_b32 s28, s9, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s27, 0
; SI-NEXT:    s_cselect_b32 s10, 0, s10
; SI-NEXT:    s_cselect_b32 s11, s28, s11
...
; SI-NEXT:    v_add_f64 v[6:7], s[34:35], v[16:17]
...
; SI-NEXT:    s_add_i32 s28, s8, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[8:9], s[2:3], s28
; SI-NEXT:    s_andn2_b64 s[8:9], s[14:15], s[8:9]
; SI-NEXT:    s_and_b32 s29, s15, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s28, 0
; SI-NEXT:    s_cselect_b32 s8, 0, s8
; SI-NEXT:    s_cselect_b32 s9, s29, s9
; SI-NEXT:    s_cmp_gt_i32 s28, 51
; SI-NEXT:    s_cselect_b32 s9, s15, s9
; SI-NEXT:    s_cselect_b32 s8, s14, s8
; SI-NEXT:    v_mov_b32_e32 v13, s9
; SI-NEXT:    v_mov_b32_e32 v12, s8
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[14:15], v[12:13]
; SI-NEXT:    v_cmp_gt_f64_e64 s[14:15], s[14:15], 0
; SI-NEXT:    v_mov_b32_e32 v17, s43
; SI-NEXT:    v_add_f64 v[4:5], s[38:39], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s44
; SI-NEXT:    s_and_b64 s[14:15], s[14:15], vcc
; SI-NEXT:    v_add_f64 v[10:11], s[40:41], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s45
...
; SI-NEXT:    s_add_i32 s28, s14, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[14:15], s[2:3], s28
; SI-NEXT:    s_andn2_b64 s[14:15], s[12:13], s[14:15]
; SI-NEXT:    s_and_b32 s29, s13, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s28, 0
; SI-NEXT:    s_cselect_b32 s14, 0, s14
; SI-NEXT:    s_cselect_b32 s15, s29, s15
; SI-NEXT:    s_cmp_gt_i32 s28, 51
...
; SI-NEXT:    v_add_f64 v[14:15], s[30:31], v[16:17]
...
; SI-NEXT:    s_lshr_b64 s[12:13], s[2:3], s29
; SI-NEXT:    s_andn2_b64 s[12:13], s[18:19], s[12:13]
; SI-NEXT:    s_and_b32 s30, s19, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s29, 0
; SI-NEXT:    s_cselect_b32 s12, 0, s12
; SI-NEXT:    s_cselect_b32 s13, s30, s13
...
; SI-NEXT:    s_add_i32 s29, s18, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[18:19], s[2:3], s29
; SI-NEXT:    s_andn2_b64 s[18:19], s[16:17], s[18:19]
; SI-NEXT:    s_and_b32 s30, s17, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s29, 0
; SI-NEXT:    s_cselect_b32 s18, 0, s18
; SI-NEXT:    s_cselect_b32 s19, s30, s19
; SI-NEXT:    s_cmp_gt_i32 s29, 51
...
; SI-NEXT:    s_and_b64 s[6:7], s[16:17], vcc
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SI-NEXT:    s_cselect_b32 s29, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s6, s23, 0xb0014
; SI-NEXT:    s_add_i32 s16, s6, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[2:3], s16
; SI-NEXT:    s_andn2_b64 s[6:7], s[22:23], s[6:7]
...
; SI-NEXT:    s_cselect_b32 s7, s23, s7
; SI-NEXT:    s_cselect_b32 s6, s22, s6
; SI-NEXT:    v_mov_b32_e32 v18, s7
; SI-NEXT:    v_mov_b32_e32 v17, s6
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[22:23], v[17:18]
; SI-NEXT:    v_cmp_gt_f64_e64 s[16:17], s[22:23], 0
...
; SI-NEXT:    s_bfe_u32 s16, s21, 0xb0014
; SI-NEXT:    s_add_i32 s23, s16, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[16:17], s[2:3], s23
; SI-NEXT:    s_andn2_b64 s[16:17], s[20:21], s[16:17]
; SI-NEXT:    s_and_b32 s3, s21, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s23, 0
; SI-NEXT:    s_cselect_b32 s3, s3, s17
; SI-NEXT:    s_cselect_b32 s16, 0, s16
; SI-NEXT:    s_cmp_gt_i32 s23, 51
; SI-NEXT:    s_cselect_b32 s17, s21, s3
; SI-NEXT:    s_cselect_b32 s16, s20, s16
; SI-NEXT:    v_mov_b32_e32 v19, s17
; SI-NEXT:    v_mov_b32_e32 v18, s16
; SI-NEXT:    v_add_f64 v[20:21], s[0:1], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s27
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[20:21], v[18:19]
; SI-NEXT:    v_add_f64 v[18:19], s[10:11], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s26
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[20:21], 0
...
; SI-NEXT:    s_cselect_b32 s0, 0x3ff00000, 0
; SI-NEXT:    v_add_f64 v[32:33], s[6:7], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s0
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-NEXT:    v_add_f64 v[30:31], s[16:17], v[16:17]
