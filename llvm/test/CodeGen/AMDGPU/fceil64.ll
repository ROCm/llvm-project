...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=SI -check-prefix=FUNC %s
...
; SI-NEXT:    s_add_i32 s9, s4, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[4:5], s[6:7], s9
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s28, s3, 0xb0014
; SI-NEXT:    s_and_b32 s30, s3, 0x80000000
; SI-NEXT:    v_cmp_gt_f64_e64 s[22:23], s[2:3], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[24:25], s[0:1], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[26:27], s[6:7], 0
; SI-NEXT:    s_add_i32 s31, s28, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[28:29], s[20:21], s31
; SI-NEXT:    s_andn2_b64 s[28:29], s[2:3], s[28:29]
; SI-NEXT:    s_cmp_lt_i32 s31, 0
; SI-NEXT:    s_cselect_b32 s28, 0, s28
; SI-NEXT:    s_cselect_b32 s29, s30, s29
; SI-NEXT:    s_cmp_gt_i32 s31, 51
; SI-NEXT:    s_cselect_b32 s29, s3, s29
; SI-NEXT:    s_cselect_b32 s28, s2, s28
; SI-NEXT:    v_cmp_gt_f64_e64 s[30:31], s[4:5], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[34:35], s[10:11], 0
...
; SI-NEXT:    s_cselect_b32 s3, s1, s3
; SI-NEXT:    s_cselect_b32 s2, s0, s2
; SI-NEXT:    v_add_f64 v[2:3], s[28:29], v[4:5]
...
; SI-NEXT:    s_add_i32 s25, s1, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[20:21], s25
; SI-NEXT:    s_andn2_b64 s[0:1], s[6:7], s[0:1]
; SI-NEXT:    s_cmp_lt_i32 s25, 0
; SI-NEXT:    s_cselect_b32 s1, s24, s1
; SI-NEXT:    s_cselect_b32 s0, 0, s0
; SI-NEXT:    s_cmp_gt_i32 s25, 51
; SI-NEXT:    s_cselect_b32 s1, s7, s1
; SI-NEXT:    s_cselect_b32 s0, s6, s0
; SI-NEXT:    v_add_f64 v[0:1], s[2:3], v[4:5]
; SI-NEXT:    v_cmp_gt_f64_e64 s[2:3], s[14:15], 0
; SI-NEXT:    v_mov_b32_e32 v6, s1
; SI-NEXT:    v_mov_b32_e32 v5, s0
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[6:7], v[5:6]
; SI-NEXT:    s_and_b64 s[6:7], s[26:27], vcc
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; SI-NEXT:    s_add_i32 s25, s7, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[20:21], s25
; SI-NEXT:    s_andn2_b64 s[6:7], s[4:5], s[6:7]
; SI-NEXT:    s_cmp_lt_i32 s25, 0
...
; SI-NEXT:    s_and_b64 s[6:7], s[34:35], vcc
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SI-NEXT:    s_cselect_b32 s6, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s7, s9, 0xb0014
; SI-NEXT:    s_and_b32 s10, s9, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v5, s6
; SI-NEXT:    s_add_i32 s11, s7, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[20:21], s11
...
; SI-NEXT:    v_add_f64 v[7:8], s[4:5], v[4:5]
; SI-NEXT:    v_mov_b32_e32 v5, s6
; SI-NEXT:    v_mov_b32_e32 v6, s7
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[8:9], v[5:6]
; SI-NEXT:    s_and_b64 s[4:5], s[22:23], vcc
; SI-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SI-NEXT:    s_cselect_b32 s4, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s5, s15, 0xb0014
; SI-NEXT:    s_and_b32 s8, s15, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v5, s4
; SI-NEXT:    s_add_i32 s9, s5, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[4:5], s[20:21], s9
...
; SI-NEXT:    s_and_b32 s7, s13, 0x80000000
...
; SI-NEXT:    s_cmp_gt_i32 s6, 51
; SI-NEXT:    s_cselect_b32 s29, s9, s1
; SI-NEXT:    s_cselect_b32 s28, s8, s0
...
; SI-NEXT:    s_cselect_b32 s1, s3, s1
; SI-NEXT:    s_cmp_gt_i32 s6, 51
; SI-NEXT:    s_cselect_b32 s31, s15, s1
; SI-NEXT:    s_cselect_b32 s30, s14, s0
...
; SI-NEXT:    s_and_b32 s3, s13, 0x80000000
; SI-NEXT:    s_add_i32 s6, s0, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[24:25], s6
...
; SI-NEXT:    s_cselect_b32 s1, s3, s1
; SI-NEXT:    s_cmp_gt_i32 s6, 51
; SI-NEXT:    s_cselect_b32 s35, s13, s1
; SI-NEXT:    s_cselect_b32 s34, s12, s0
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[12:13], 0
...
; SI-NEXT:    s_cselect_b32 s1, s3, s1
; SI-NEXT:    s_cmp_gt_i32 s6, 51
; SI-NEXT:    s_cselect_b32 s37, s19, s1
; SI-NEXT:    s_cselect_b32 s36, s18, s0
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[18:19], 0
; SI-NEXT:    v_mov_b32_e32 v0, s36
; SI-NEXT:    v_mov_b32_e32 v1, s37
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[18:19], v[0:1]
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s46, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s0, s17, 0xb0014
; SI-NEXT:    s_and_b32 s3, s17, 0x80000000
; SI-NEXT:    s_add_i32 s6, s0, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[24:25], s6
...
; SI-NEXT:    s_cselect_b32 s1, s3, s1
; SI-NEXT:    s_cmp_gt_i32 s6, 51
; SI-NEXT:    s_cselect_b32 s39, s17, s1
; SI-NEXT:    s_cselect_b32 s38, s16, s0
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[16:17], 0
; SI-NEXT:    v_mov_b32_e32 v0, s38
; SI-NEXT:    v_mov_b32_e32 v1, s39
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[16:17], v[0:1]
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s47, 0x3ff00000, 0
...
; SI-NEXT:    s_cselect_b32 s0, 0, s0
; SI-NEXT:    s_cmp_gt_i32 s3, 51
; SI-NEXT:    s_cselect_b32 s41, s23, s1
; SI-NEXT:    s_cselect_b32 s40, s22, s0
; SI-NEXT:    v_mov_b32_e32 v0, s40
; SI-NEXT:    v_mov_b32_e32 v1, s41
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[22:23], 0
...
; SI-NEXT:    s_load_dwordx2 s[16:17], s[4:5], 0x9
; SI-NEXT:    s_cmp_gt_i32 s3, 51
; SI-NEXT:    s_cselect_b32 s43, s21, s1
; SI-NEXT:    s_cselect_b32 s42, s20, s0
...
; SI-NEXT:    v_add_f64 v[6:7], s[36:37], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s47
; SI-NEXT:    v_add_f64 v[4:5], s[38:39], v[16:17]
; SI-NEXT:    v_cmp_gt_f64_e64 s[34:35], s[6:7], 0
; SI-NEXT:    v_mov_b32_e32 v17, s22
; SI-NEXT:    v_add_f64 v[14:15], s[40:41], v[16:17]
; SI-NEXT:    v_cmp_gt_f64_e64 s[22:23], s[4:5], 0
; SI-NEXT:    v_mov_b32_e32 v12, s42
; SI-NEXT:    v_mov_b32_e32 v13, s43
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[20:21], v[12:13]
; SI-NEXT:    s_and_b64 s[20:21], s[26:27], vcc
; SI-NEXT:    s_and_b64 s[20:21], s[20:21], exec
; SI-NEXT:    s_cselect_b32 s20, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s21, s3, 0xb0014
; SI-NEXT:    s_and_b32 s26, s3, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v17, s20
; SI-NEXT:    s_add_i32 s27, s21, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[20:21], s[24:25], s27
...
; SI-NEXT:    s_cselect_b32 s27, s3, s21
; SI-NEXT:    s_cselect_b32 s26, s2, s20
; SI-NEXT:    v_add_f64 v[12:13], s[42:43], v[16:17]
; SI-NEXT:    v_cmp_gt_f64_e64 s[20:21], s[10:11], 0
; SI-NEXT:    v_mov_b32_e32 v17, s26
; SI-NEXT:    v_mov_b32_e32 v18, s27
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[2:3], v[17:18]
...
; SI-NEXT:    v_mov_b32_e32 v17, s2
; SI-NEXT:    s_add_i32 s29, s3, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[2:3], s[24:25], s29
; SI-NEXT:    s_andn2_b64 s[2:3], s[0:1], s[2:3]
; SI-NEXT:    s_cmp_lt_i32 s29, 0
; SI-NEXT:    s_cselect_b32 s3, s28, s3
; SI-NEXT:    s_cselect_b32 s2, 0, s2
; SI-NEXT:    s_cmp_gt_i32 s29, 51
; SI-NEXT:    buffer_store_dwordx4 v[8:11], off, s[16:19], 0 offset:16
; SI-NEXT:    s_cselect_b32 s3, s1, s3
; SI-NEXT:    s_cselect_b32 s2, s0, s2
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_add_f64 v[10:11], s[26:27], v[16:17]
; SI-NEXT:    v_cmp_gt_f64_e64 s[26:27], s[8:9], 0
...
; SI-NEXT:    s_cselect_b32 s0, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s1, s7, 0xb0014
; SI-NEXT:    s_and_b32 s28, s7, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v17, s0
; SI-NEXT:    s_add_i32 s29, s1, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[24:25], s29
; SI-NEXT:    s_andn2_b64 s[0:1], s[6:7], s[0:1]
; SI-NEXT:    s_cmp_lt_i32 s29, 0
...
; SI-NEXT:    s_cselect_b32 s1, s7, s1
; SI-NEXT:    s_cselect_b32 s0, s6, s0
; SI-NEXT:    v_add_f64 v[8:9], s[2:3], v[16:17]
; SI-NEXT:    v_cmp_gt_f64_e64 s[2:3], s[14:15], 0
; SI-NEXT:    v_mov_b32_e32 v18, s1
; SI-NEXT:    v_mov_b32_e32 v17, s0
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[6:7], v[17:18]
; SI-NEXT:    s_and_b64 s[6:7], s[34:35], vcc
; SI-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; SI-NEXT:    s_cselect_b32 s6, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s7, s5, 0xb0014
; SI-NEXT:    s_and_b32 s28, s5, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v17, s6
; SI-NEXT:    s_add_i32 s29, s7, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[24:25], s29
; SI-NEXT:    s_andn2_b64 s[6:7], s[4:5], s[6:7]
; SI-NEXT:    s_cmp_lt_i32 s29, 0
; SI-NEXT:    s_cselect_b32 s7, s28, s7
; SI-NEXT:    s_cselect_b32 s6, 0, s6
; SI-NEXT:    s_cmp_gt_i32 s29, 51
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:32
; SI-NEXT:    s_cselect_b32 s7, s5, s7
; SI-NEXT:    s_cselect_b32 s6, s4, s6
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_add_f64 v[6:7], s[0:1], v[16:17]
; SI-NEXT:    v_cmp_gt_f64_e64 s[0:1], s[12:13], 0
; SI-NEXT:    buffer_store_dwordx4 v[12:15], off, s[16:19], 0 offset:48
; SI-NEXT:    buffer_store_dwordx4 v[8:11], off, s[16:19], 0 offset:64
...
; SI-NEXT:    v_add_f64 v[4:5], s[6:7], v[16:17]
; SI-NEXT:    s_add_i32 s6, s5, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[4:5], s[24:25], s6
; SI-NEXT:    s_andn2_b64 s[4:5], s[10:11], s[4:5]
; SI-NEXT:    s_cmp_lt_i32 s6, 0
; SI-NEXT:    s_cselect_b32 s4, 0, s4
...
; SI-NEXT:    s_cselect_b32 s5, s11, s5
; SI-NEXT:    s_cselect_b32 s4, s10, s4
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:80
; SI-NEXT:    s_waitcnt expcnt(0)
...
; SI-NEXT:    v_mov_b32_e32 v17, s6
; SI-NEXT:    s_add_i32 s11, s7, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[6:7], s[24:25], s11
; SI-NEXT:    s_andn2_b64 s[6:7], s[8:9], s[6:7]
; SI-NEXT:    s_cmp_lt_i32 s11, 0
; SI-NEXT:    s_cselect_b32 s6, 0, s6
; SI-NEXT:    s_cselect_b32 s7, s10, s7
...
; SI-NEXT:    s_cselect_b32 s7, s9, s7
; SI-NEXT:    s_cselect_b32 s6, s8, s6
; SI-NEXT:    v_add_f64 v[6:7], s[4:5], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v4, s6
; SI-NEXT:    v_mov_b32_e32 v5, s7
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[8:9], v[4:5]
; SI-NEXT:    s_and_b64 s[4:5], s[26:27], vcc
; SI-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SI-NEXT:    s_cselect_b32 s4, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s5, s15, 0xb0014
; SI-NEXT:    s_and_b32 s8, s15, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v17, s4
; SI-NEXT:    s_add_i32 s9, s5, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[4:5], s[24:25], s9
; SI-NEXT:    s_andn2_b64 s[4:5], s[14:15], s[4:5]
; SI-NEXT:    s_cmp_lt_i32 s9, 0
; SI-NEXT:    s_cselect_b32 s4, 0, s4
; SI-NEXT:    s_cselect_b32 s5, s8, s5
...
; SI-NEXT:    s_cselect_b32 s3, s13, s3
; SI-NEXT:    s_cselect_b32 s2, s12, s2
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:96
; SI-NEXT:    v_mov_b32_e32 v17, s6
; SI-NEXT:    s_waitcnt expcnt(0)
...
; SI-NEXT:    v_add_f64 v[6:7], s[4:5], v[16:17]
; SI-NEXT:    v_mov_b32_e32 v17, s0
; SI-NEXT:    v_add_f64 v[4:5], s[2:3], v[16:17]
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:112
; SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0
; SI-NEXT:    s_endpgm
