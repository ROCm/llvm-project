...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00-- -o - %s | FileCheck -check-prefix=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-- -o - %s | FileCheck -check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-- -mattr=+real-true16 -o - %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-- -mattr=-real-true16 -o - %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
