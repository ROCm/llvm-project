...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -o - %s | FileCheck -check-prefix=SI %s
...
; SI-NEXT:    v_cndmask_b32_e32 v7, v3, v4, vcc
...
; SI-NEXT:    v_cmp_eq_u32_e64 s[40:41], 0, v4
; SI-NEXT:    s_mov_b32 s38, 0
; SI-NEXT:    s_xor_b64 s[36:37], s[40:41], exec
; SI-NEXT:    s_mov_b64 s[34:35], 0
; SI-NEXT:    s_mov_b64 s[34:35], 0
; SI-NEXT:    s_xor_b64 s[42:43], exec, s[36:37]
; SI-NEXT:    s_mov_b64 s[34:35], 0
; SI-NEXT:    s_mov_b64 s[34:35], 0
...
; SI-NEXT:  .LBB7_1: ; %T
; SI-NEXT:    s_mov_b64 s[36:37], 0
; SI-NEXT:    s_mov_b32 s44, 0xf000
; SI-NEXT:    s_mov_b32 s39, s38
; SI-NEXT:    s_mov_b64 s[36:37], s[38:39]
; SI-NEXT:    s_mov_b32 s39, s44
...
; SI-NEXT:  .LBB7_2:
; SI-NEXT:    s_or_b64 exec, exec, s[42:43]
; SI-NEXT:    s_xor_b64 s[36:37], exec, s[40:41]
; SI-NEXT:    s_and_b64 s[36:37], s[36:37], exec
; SI-NEXT:    s_or_b64 s[34:35], s[34:35], s[36:37]
; SI-NEXT:    s_mov_b64 exec, s[40:41]
; SI-NEXT:    s_mov_b64 s[36:37], 0
; SI-NEXT:    s_mov_b64 s[36:37], 0
; SI-NEXT:    ; divergent control-flow edge
...
; SI-NEXT:  .LBB7_3: ; %F
; SI-NEXT:    s_mov_b64 s[36:37], 0
; SI-NEXT:    s_mov_b32 s40, 0xf000
; SI-NEXT:    s_mov_b32 s39, s38
; SI-NEXT:    s_mov_b64 s[36:37], s[38:39]
; SI-NEXT:    s_mov_b32 s39, s40
...
; SI-NEXT:    v_or_b32_e32 v2, v12, v4
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[36:37], 0, v4
; GFX9-NEXT:    s_xor_b64 s[40:41], s[36:37], exec
; GFX9-NEXT:    s_xor_b64 s[38:39], exec, s[40:41]
...
; GFX9-NEXT:    s_and_b64 s[38:39], s[38:39], exec
...
; GFX11-FAKE16-NEXT:    v_cmp_eq_u32_e64 s1, 0, v4
...
; SI-NEXT:    s_mov_b64 s[36:37], s[38:39]
; SI-NEXT:    s_mov_b32 s39, s44
; SI-NEXT:    buffer_load_ushort v3, v[0:1], s[36:39], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_ushort v4, v[0:1], s[36:39], 0 addr64 offset:2 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_ushort v2, v[0:1], s[36:39], 0 addr64 offset:4 glc
...
; SI-NEXT:    v_or_b32_e32 v0, v0, v3
; SI-NEXT:    v_or_b32_e32 v1, v1, v2
; SI-NEXT:    v_or_b32_e32 v2, v13, v4
