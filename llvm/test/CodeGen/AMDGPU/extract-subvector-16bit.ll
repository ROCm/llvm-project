...
; GFX11-TRUE16-NEXT:    v_cmp_nge_f16_e64 s0, 0.5, v1.l
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s2, 0.5, v1.l
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s1, 0.5, v3.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, v2.l, 0x3d00, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.h, 0x3d00, v2.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.l, v2.l, 0x3d00, s2
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, v2.l, 0x3d00, s1
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v4
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v6, 0x3900, v1, vcc_lo
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v2, v3, v6, 0x5040100
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v0, v4, 0x5040100
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v1, 0x3900, v1, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_lt_u16_e32 vcc_lo, 0x3800, v8
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v1, v5, 0x5040100
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v8, 0x3d00, v9, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_perm_b32 v3, v8, v7, 0x5040100
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  br i1 %cond, label %T, label %F
...
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v2, v6, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v0, v4, v0
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v1, 0x3900, v1, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_nge_f16_e32 vcc_lo, 0.5, v8
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v1, v5, v1
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v8, 0x3d00, v9, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v3, v7, v8
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  br i1 %cond, label %T, label %F
