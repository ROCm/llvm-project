...
; GCN-NEXT:    s_mul_i32 s13, s10, s1
; GCN-NEXT:    s_mul_i32 s14, s4, s1
...
; GCN-IR-NEXT:  .LBB1_8:
; GCN-IR-NEXT:    v_cndmask_b32_e64 v5, v1, 0, s[20:21]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v4, v0, 0, s[20:21]
; GCN-IR-NEXT:    s_mov_b64 s[24:25], 0
...
; GCN-NEXT:    s_lshr_b64 s[6:7], s[2:3], 24
; GCN-NEXT:    v_cvt_f32_i32_e32 v1, s6
; GCN-NEXT:    s_xor_b32 s2, s6, s4
; GCN-NEXT:    v_rcp_iflag_f32_e32 v2, v0
...
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-IR-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0xd
; GCN-IR-NEXT:    s_mov_b32 s8, 0xf000
; GCN-IR-NEXT:    s_mov_b32 s9, -1
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    s_xor_b32 s2, s6, s4
; GCN-IR-NEXT:    v_rcp_iflag_f32_e32 v2, v0
...
; GCN-NEXT:    s_add_u32 s11, s11, s13
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    v_mul_hi_u32 v0, v1, s10
; GCN-NEXT:    s_addc_u32 s13, 0, s13
...
; GCN-NEXT:    s_add_u32 s6, s11, s6
; GCN-NEXT:    s_addc_u32 s6, s12, s10
; GCN-NEXT:    v_readfirstlane_b32 s10, v1
; GCN-NEXT:    s_addc_u32 s10, s10, 0
; GCN-NEXT:    s_mul_i32 s7, s8, s7
...
; GCN-IR-NEXT:    v_subb_u32_e64 v13, s[4:5], 0, 0, vcc
...
; GCN-IR-NEXT:    v_addc_u32_e64 v13, s[4:5], 0, -1, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
...
; GCN-IR-NEXT:    v_or_b32_e32 v6, v6, v4
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, s4, v6
