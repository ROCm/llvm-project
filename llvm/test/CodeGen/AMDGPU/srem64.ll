...
; GCN-NEXT:    s_mul_i32 s13, s1, s11
; GCN-NEXT:    s_mul_i32 s14, s0, s11
...
; GCN-NEXT:    v_readfirstlane_b32 s10, v0
; GCN-NEXT:    s_mul_i32 s12, s0, s5
; GCN-NEXT:    v_readfirstlane_b32 s15, v2
; GCN-NEXT:    s_mul_i32 s13, s1, s10
...
; GCN-NEXT:    v_mul_hi_u32 v4, v1, s14
; GCN-NEXT:    v_readfirstlane_b32 s13, v3
; GCN-NEXT:    s_mul_i32 s15, s10, s12
; GCN-NEXT:    s_add_u32 s13, s13, s15
; GCN-NEXT:    v_readfirstlane_b32 s15, v0
...
; GCN-NEXT:    s_addc_u32 s14, s14, 0
; GCN-NEXT:    s_mul_i32 s12, s5, s12
; GCN-NEXT:    s_add_u32 s12, s13, s12
; GCN-NEXT:    s_addc_u32 s13, 0, s14
; GCN-NEXT:    s_add_u32 s10, s10, s12
; GCN-NEXT:    v_mov_b32_e32 v1, s10
; GCN-NEXT:    v_mul_hi_u32 v1, s0, v1
; GCN-NEXT:    s_addc_u32 s5, s5, s13
; GCN-NEXT:    s_mul_i32 s12, s0, s10
...
; GCN-NEXT:    s_add_u32 s0, s1, s0
; GCN-NEXT:    s_addc_u32 s1, 0, s12
; GCN-NEXT:    s_add_u32 s12, s10, s0
; GCN-NEXT:    s_addc_u32 s13, s5, s1
...
; GCN-NEXT:    s_addc_u32 s7, s7, s10
; GCN-NEXT:    s_mul_i32 s9, s2, s8
; GCN-NEXT:    s_mul_i32 s2, s2, s7
; GCN-NEXT:    v_readfirstlane_b32 s10, v1
; GCN-NEXT:    s_add_i32 s2, s10, s2
...
; GCN-NEXT:    s_mul_i32 s10, s8, s2
; GCN-NEXT:    s_mul_i32 s9, s7, s9
; GCN-NEXT:    v_readfirstlane_b32 s12, v0
; GCN-NEXT:    v_mul_hi_u32 v0, s7, v1
...
; GCN-NEXT:    s_add_u32 s9, s10, s9
; GCN-NEXT:    s_addc_u32 s6, s11, s6
; GCN-NEXT:    v_readfirstlane_b32 s9, v0
; GCN-NEXT:    s_addc_u32 s9, s9, 0
; GCN-NEXT:    s_mul_i32 s2, s7, s2
; GCN-NEXT:    s_add_u32 s2, s6, s2
...
; GCN-IR-NEXT:    v_or_b32_e32 v6, v6, v4
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, s8, v6
...
; GCN-NEXT:    s_sub_i32 s1, s2, s1
; GCN-NEXT:    s_add_i32 s2, s1, 0xffffa481
; GCN-NEXT:    s_min_u32 s1, s2, s1
; GCN-NEXT:    s_add_i32 s2, s1, 0xffffa481
; GCN-NEXT:    s_min_u32 s1, s2, s1
; GCN-NEXT:    s_xor_b32 s1, s1, s0
; GCN-NEXT:    s_sub_i32 s0, s1, s0
...
; GCN-IR-NEXT:    s_sub_i32 s1, s2, s1
; GCN-IR-NEXT:    s_add_i32 s2, s1, 0xffffa481
; GCN-IR-NEXT:    s_min_u32 s1, s2, s1
; GCN-IR-NEXT:    s_add_i32 s2, s1, 0xffffa481
; GCN-IR-NEXT:    s_min_u32 s1, s2, s1
; GCN-IR-NEXT:    s_xor_b32 s1, s1, s0
; GCN-IR-NEXT:    s_sub_i32 s0, s1, s0
