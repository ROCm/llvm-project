...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -amdgpu-bypass-slow-div=0 < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 -amdgpu-bypass-slow-div=0 -amdgpu-codegenprepare-expand-div64 < %s | FileCheck -check-prefix=GCN-IR %s
...
; GCN-NEXT:    s_mul_i32 s12, s4, s11
; GCN-NEXT:    s_mul_i32 s4, s4, s10
; GCN-NEXT:    v_readfirstlane_b32 s13, v1
; GCN-NEXT:    s_add_i32 s4, s13, s4
; GCN-NEXT:    s_mul_i32 s5, s5, s11
...
; GCN-NEXT:    s_add_u32 s12, s13, s12
; GCN-NEXT:    s_addc_u32 s5, s14, s5
; GCN-NEXT:    v_readfirstlane_b32 s12, v0
; GCN-NEXT:    s_addc_u32 s12, s12, 0
; GCN-NEXT:    s_mul_i32 s4, s10, s4
; GCN-NEXT:    s_add_u32 s4, s5, s4
; GCN-NEXT:    s_addc_u32 s5, 0, s12
; GCN-NEXT:    s_add_u32 s4, s11, s4
; GCN-NEXT:    s_addc_u32 s5, s10, s5
; GCN-NEXT:    v_mov_b32_e32 v0, s5
; GCN-NEXT:    v_mul_hi_u32 v1, s6, v0
; GCN-NEXT:    v_mov_b32_e32 v2, s4
; GCN-NEXT:    v_mul_hi_u32 v3, s6, v2
; GCN-NEXT:    s_mul_i32 s10, s6, s5
...
; GCN-IR-NEXT:    ; implicit-def: $sgpr16_sgpr17
; GCN-IR-NEXT:    s_cbranch_vccnz .LBB0_5
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    s_add_u32 s15, s12, 1
...
; GCN-IR-NEXT:    s_and_b64 vcc, exec, s[16:17]
; GCN-IR-NEXT:    ; implicit-def: $sgpr12_sgpr13
; GCN-IR-NEXT:    ; implicit-def: $sgpr12_sgpr13
; GCN-IR-NEXT:    s_cbranch_vccnz .LBB0_4
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    s_lshr_b64 s[12:13], s[2:3], s15
...
; GCN-IR-NEXT:    s_and_b64 s[18:19], s[14:15], s[4:5]
...
; GCN-NEXT:    v_mul_lo_u32 v8, v6, v4
; GCN-NEXT:    v_mul_lo_u32 v9, v6, v5
...
; GCN-IR-NEXT:    s_xor_b64 s[4:5], s[4:5], exec
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GCN-IR-NEXT:    ; divergent control-flow edge
...
; GCN-IR-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
...
; GCN-NEXT:    s_load_dword s4, s[4:5], 0xe
; GCN-NEXT:    s_mov_b32 s6, 0xf000
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_ashr_i32 s8, s3, 9
; GCN-NEXT:    s_ashr_i32 s7, s4, 9
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s7
; GCN-NEXT:    v_cvt_f32_i32_e32 v1, s8
; GCN-NEXT:    s_xor_b32 s3, s8, s7
...
; GCN-NEXT:    v_mul_lo_u32 v0, v0, s7
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-IR-NEXT:    s_load_dword s4, s[4:5], 0xe
; GCN-IR-NEXT:    s_mov_b32 s6, 0xf000
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_ashr_i32 s8, s3, 9
; GCN-IR-NEXT:    s_ashr_i32 s7, s4, 9
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s7
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v1, s8
; GCN-IR-NEXT:    s_xor_b32 s3, s8, s7
...
; GCN-IR-NEXT:    v_mul_lo_u32 v0, v0, s7
; GCN-IR-NEXT:    s_mov_b32 s3, s6
...
; GCN-NEXT:    s_addc_u32 s9, s6, s6
; GCN-NEXT:    s_xor_b64 s[6:7], s[8:9], s[6:7]
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s6
; GCN-NEXT:    v_cvt_f32_u32_e32 v1, s7
; GCN-NEXT:    s_sub_u32 s5, 0, s6
...
; GCN-NEXT:    s_addc_u32 s9, s9, s13
; GCN-NEXT:    s_mul_i32 s12, s5, s11
; GCN-NEXT:    s_mul_i32 s5, s5, s9
; GCN-NEXT:    v_readfirstlane_b32 s13, v1
; GCN-NEXT:    s_add_i32 s5, s13, s5
; GCN-NEXT:    s_mul_i32 s8, s8, s11
; GCN-NEXT:    v_mov_b32_e32 v0, s12
; GCN-NEXT:    s_add_i32 s5, s5, s8
; GCN-NEXT:    v_mul_hi_u32 v2, s9, v0
; GCN-NEXT:    v_mov_b32_e32 v1, s5
; GCN-NEXT:    v_mul_hi_u32 v0, s11, v0
; GCN-NEXT:    v_mul_hi_u32 v3, s11, v1
; GCN-NEXT:    s_mul_i32 s13, s11, s5
; GCN-NEXT:    s_mul_i32 s12, s9, s12
; GCN-NEXT:    v_readfirstlane_b32 s15, v0
; GCN-NEXT:    v_mul_hi_u32 v0, s9, v1
; GCN-NEXT:    v_readfirstlane_b32 s14, v3
; GCN-NEXT:    s_add_u32 s13, s15, s13
; GCN-NEXT:    s_addc_u32 s14, 0, s14
; GCN-NEXT:    v_readfirstlane_b32 s8, v2
; GCN-NEXT:    s_add_u32 s12, s13, s12
; GCN-NEXT:    s_addc_u32 s8, s14, s8
; GCN-NEXT:    v_readfirstlane_b32 s12, v0
; GCN-NEXT:    s_addc_u32 s12, s12, 0
; GCN-NEXT:    s_mul_i32 s5, s9, s5
; GCN-NEXT:    s_add_u32 s5, s8, s5
; GCN-NEXT:    s_addc_u32 s8, 0, s12
; GCN-NEXT:    s_add_u32 s11, s11, s5
; GCN-NEXT:    s_addc_u32 s12, s9, s8
; GCN-NEXT:    s_add_u32 s8, s3, s4
; GCN-NEXT:    s_mov_b32 s5, s4
; GCN-NEXT:    s_addc_u32 s9, s4, s4
; GCN-NEXT:    s_xor_b64 s[8:9], s[8:9], s[4:5]
; GCN-NEXT:    v_mov_b32_e32 v0, s12
; GCN-NEXT:    v_mul_hi_u32 v1, s8, v0
; GCN-NEXT:    v_mov_b32_e32 v2, s11
; GCN-NEXT:    v_mul_hi_u32 v3, s8, v2
; GCN-NEXT:    s_mul_i32 s3, s8, s12
; GCN-NEXT:    v_readfirstlane_b32 s13, v1
; GCN-NEXT:    v_mul_hi_u32 v1, s9, v2
; GCN-NEXT:    v_readfirstlane_b32 s14, v3
...
; GCN-NEXT:    s_or_b32 s10, s10, s11
; GCN-NEXT:    s_subb_u32 s9, s9, s14
; GCN-NEXT:    s_cmp_ge_u32 s9, s7
; GCN-NEXT:    s_cselect_b32 s10, -1, 0
; GCN-NEXT:    s_cmp_ge_u32 s8, s6
; GCN-NEXT:    s_cselect_b32 s6, -1, 0
; GCN-NEXT:    s_cmp_eq_u32 s9, s7
; GCN-NEXT:    s_cselect_b32 s6, s6, s10
; GCN-NEXT:    s_cmp_lg_u32 s6, 0
; GCN-NEXT:    s_cselect_b32 s7, s12, s9
; GCN-NEXT:    s_cselect_b32 s6, s13, s8
...
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_mov_b32 s2, s7
; GCN-IR-NEXT:    s_ashr_i32 s9, s3, 31
; GCN-IR-NEXT:    s_mov_b32 s8, s3
; GCN-IR-NEXT:    s_mov_b32 s4, s9
; GCN-IR-NEXT:    s_mov_b32 s5, s9
; GCN-IR-NEXT:    s_ashr_i32 s3, s7, 31
; GCN-IR-NEXT:    s_xor_b64 s[6:7], s[8:9], s[4:5]
; GCN-IR-NEXT:    s_sub_u32 s6, s6, s9
; GCN-IR-NEXT:    s_subb_u32 s7, s7, s9
; GCN-IR-NEXT:    s_mov_b32 s8, s3
...
; GCN-IR-NEXT:    s_flbit_i32_b64 s16, s[6:7]
...
; GCN-NEXT:    s_addc_u32 s11, s11, s9
...
; GCN-NEXT:    v_readfirstlane_b32 s14, v1
; GCN-NEXT:    s_add_u32 s10, s12, s10
; GCN-NEXT:    s_addc_u32 s10, s13, s14
; GCN-NEXT:    v_readfirstlane_b32 s12, v0
; GCN-NEXT:    s_addc_u32 s12, s12, 0
...
; GCN-NEXT:    s_mul_i32 s10, s6, s8
; GCN-NEXT:    v_readfirstlane_b32 s13, v2
; GCN-NEXT:    s_mul_i32 s11, s7, s9
; GCN-NEXT:    s_mul_i32 s12, s6, s9
...
; GCN-NEXT:    s_addc_u32 s13, 0, s13
; GCN-NEXT:    s_mul_i32 s12, s8, s12
; GCN-NEXT:    v_readfirstlane_b32 s14, v0
; GCN-NEXT:    s_add_u32 s11, s11, s12
; GCN-NEXT:    s_addc_u32 s11, s13, s14
; GCN-NEXT:    v_readfirstlane_b32 s12, v1
; GCN-NEXT:    s_addc_u32 s12, s12, 0
; GCN-NEXT:    s_mul_i32 s10, s8, s10
; GCN-NEXT:    s_add_u32 s10, s11, s10
; GCN-NEXT:    s_addc_u32 s11, 0, s12
; GCN-NEXT:    s_add_u32 s9, s9, s10
; GCN-NEXT:    v_mov_b32_e32 v1, s9
; GCN-NEXT:    v_mul_hi_u32 v1, s6, v1
; GCN-NEXT:    s_addc_u32 s8, s8, s11
; GCN-NEXT:    s_mul_i32 s10, s6, s9
; GCN-NEXT:    s_mul_i32 s6, s6, s8
; GCN-NEXT:    v_readfirstlane_b32 s11, v1
; GCN-NEXT:    s_add_i32 s6, s11, s6
; GCN-NEXT:    s_mul_i32 s7, s7, s9
; GCN-NEXT:    v_mov_b32_e32 v0, s10
; GCN-NEXT:    s_add_i32 s6, s6, s7
; GCN-NEXT:    v_mul_hi_u32 v2, s8, v0
; GCN-NEXT:    v_mov_b32_e32 v1, s6
; GCN-NEXT:    v_mul_hi_u32 v0, s9, v0
; GCN-NEXT:    v_mul_hi_u32 v3, s9, v1
; GCN-NEXT:    s_mul_i32 s11, s9, s6
; GCN-NEXT:    s_mul_i32 s10, s8, s10
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    v_mul_hi_u32 v0, s8, v1
; GCN-NEXT:    v_readfirstlane_b32 s12, v3
; GCN-NEXT:    s_add_u32 s11, s13, s11
; GCN-NEXT:    s_addc_u32 s12, 0, s12
; GCN-NEXT:    v_readfirstlane_b32 s7, v2
; GCN-NEXT:    s_add_u32 s10, s11, s10
; GCN-NEXT:    s_addc_u32 s7, s12, s7
; GCN-NEXT:    v_readfirstlane_b32 s10, v0
; GCN-NEXT:    s_addc_u32 s10, s10, 0
; GCN-NEXT:    s_mul_i32 s6, s8, s6
; GCN-NEXT:    s_add_u32 s6, s7, s6
; GCN-NEXT:    s_addc_u32 s7, 0, s10
; GCN-NEXT:    s_add_u32 s6, s9, s6
; GCN-NEXT:    s_addc_u32 s7, s8, s7
; GCN-NEXT:    v_mul_hi_u32 v1, s6, 24
; GCN-NEXT:    v_mul_hi_u32 v0, s7, 24
; GCN-NEXT:    s_mul_i32 s7, s7, 24
; GCN-NEXT:    v_readfirstlane_b32 s8, v1
; GCN-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-NEXT:    s_add_u32 s7, s8, s7
...
; GCN-IR-NEXT:    s_and_b64 s[16:17], s[10:11], exec
; GCN-IR-NEXT:    s_cselect_b32 s6, 0, 24
; GCN-IR-NEXT:    s_or_b64 s[10:11], s[10:11], s[14:15]
; GCN-IR-NEXT:    s_mov_b32 s7, 0
; GCN-IR-NEXT:    s_and_b64 vcc, exec, s[10:11]
; GCN-IR-NEXT:    ; implicit-def: $sgpr10_sgpr11
...
; GCN-IR-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execz .LBB18_4
; GCN-IR-NEXT:  .LBB18_2: ; %udiv-preheader
; GCN-IR-NEXT:    v_add_i32_e32 v12, vcc, 0xffffffcf, v8
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], v[0:1], v6
; GCN-IR-NEXT:    v_addc_u32_e64 v13, s[10:11], 0, -1, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
