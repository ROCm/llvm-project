...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-NEXT:    s_mov_b32 s6, 0xf000
; SI-NEXT:    s_mov_b32 s7, -1
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s5, 0x31016000
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, -1
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_lshl_b32 s4, s4, 4
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s5, 0x31016000
; GFX11-FAKE16-NEXT:    s_mov_b32 s6, -1
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_lshl_b32 s4, s4, 4
...
; SI-NEXT:    buffer_load_dword v3, v[1:2], s[4:7], 0 addr64 offset:4
...
; SI-NEXT:    buffer_load_dwordx4 v[1:4], v[8:9], s[0:3], 0 addr64
; SI-NEXT:    buffer_load_dwordx4 v[5:8], v[8:9], s[0:3], 0 addr64 offset:16
; SI-NEXT:    s_load_dword s4, s[4:5], 0xd
