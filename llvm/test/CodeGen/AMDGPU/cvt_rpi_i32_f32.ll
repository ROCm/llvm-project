...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -check-prefix=SI-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn -global-isel < %s | FileCheck -check-prefix=SI-GISEL %s
