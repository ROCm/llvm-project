...
; RUN: llc -global-isel=0 -stop-after=finalize-isel -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -check-prefix=SDAG -enable-var-scope %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -stop-after=finalize-isel -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -check-prefix=GISEL -enable-var-scope %s
