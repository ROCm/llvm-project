...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -stop-after=finalize-isel -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -check-prefix=GISEL -enable-var-scope %s
