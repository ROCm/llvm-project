...
; RUN: opt < %s -S -mtriple=amdgpu9.06-amd-amdhsa -stop-after=amdgpu-unify-divergent-exit-nodes | FileCheck %s --check-prefix=UNIFY
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.06-amd-amdhsa | FileCheck %s
...
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[0:1], 9, v0
