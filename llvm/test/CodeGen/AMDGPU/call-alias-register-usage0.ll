; RUN: llc -amdgpu-late-wave-transform=1 -O0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck %s
...
; CHECK-LABEL: {{^}}kernel0:
; CHECK:      .set kernel0.num_vgpr, max(32, .Laliasee_default_vgpr64_sgpr102.num_vgpr)
