...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 -start-before=amdgpu-unify-divergent-exit-nodes -mattr=+flat-for-global < %s | FileCheck -enable-var-scope --check-prefixes=GCN,SI %s

; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -start-before=amdgpu-unify-divergent-exit-nodes < %s | FileCheck -enable-var-scope --check-prefixes=GCN,VI %s
