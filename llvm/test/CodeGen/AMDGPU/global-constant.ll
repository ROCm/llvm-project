; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00--amdpal < %s | FileCheck -check-prefixes=GCN,GCN-PAL %s
; RUN: llc -mtriple=amdgpu7.00-- < %s | FileCheck -check-prefixes=GCN,GCN-DEFAULT %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00-mesa-mesa3d < %s | FileCheck -check-prefixes=GCN,GCN-MESA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00--amdhsa < %s | FileCheck -check-prefixes=GCN,GCN-DEFAULT %s
