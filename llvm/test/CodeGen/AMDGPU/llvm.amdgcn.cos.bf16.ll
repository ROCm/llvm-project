...
; FAKE16-NEXT:    v_cos_bf16_e32 v1, s2
...
define amdgpu_kernel void @cos_bf16_constant_4_strictfp(ptr addrspace(1) %out) #2 {
...
; FAKE16-NEXT:    v_mov_b32_e32 v0, 0
; FAKE16-NEXT:    v_cos_bf16_e64 v1, 4.0 op_sel:[1,0]
; FAKE16-NEXT:    s_wait_kmcnt 0x0
; FAKE16-NEXT:    global_store_b16 v0, v1, s[0:1]
; FAKE16-NEXT:    s_endpgm
;
...
define amdgpu_kernel void @cos_bf16_constant_100_strictfp(ptr addrspace(1) %out) #2 {
...
; FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; FAKE16-NEXT:    v_mov_b32_e32 v0, 0
; FAKE16-NEXT:    v_cos_bf16_e32 v1, 0x42c8
; FAKE16-NEXT:    s_wait_kmcnt 0x0
; FAKE16-NEXT:    global_store_b16 v0, v1, s[0:1]
; FAKE16-NEXT:    s_endpgm
;
