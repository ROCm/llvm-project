...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck %s --check-prefix=GFX9
...
; GFX9-NEXT:    ; kill: killed $sgpr2 killed $sgpr3
; GFX9-NEXT:    s_nop 0
