...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03-- -mattr=-flat-for-global < %s | FileCheck %s --check-prefix=VI
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-- -mattr=-flat-for-global < %s | FileCheck %s --check-prefix=GFX9
