...
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-SDAG %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-GISEL %s
...
; SI-SDAG-NEXT:    s_load_dword s4, s[4:5], 0x1c
...
; SI-SDAG-NEXT:    s_load_dword s4, s[4:5], 0x1d
; SI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s4
...
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[0:1]
; SI-SDAG-NEXT:    buffer_store_dword v0, v[3:4], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
