...
; RUN:  llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-SDAG %s
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-GISEL %s
...
; SI-SDAG-NEXT:    s_load_dword s4, s[4:5], 0x13
...
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s6
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], |s4|, v0
...
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], s4, 1
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[4:5]
; SI-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], s4, 64
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[4:5]
; SI-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[0:1], v2, s2
...
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SI-SDAG-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_mov_b32 s2, 0x44800000
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e32 vcc, s2, v2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-SDAG-NEXT:    s_load_dword s6, s[4:5], 0x1d
...
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s6
; SI-SDAG-NEXT:    v_cmp_class_f64_e64 s[4:5], |s[4:5]|, v0
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[4:5]
; SI-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f64_e64 s[0:1], v[1:2], s2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[0:1]
; SI-SDAG-NEXT:    buffer_store_dword v0, v[3:4], s[8:11], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_mov_b32 s3, 0x40900000
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, s[2:3], v2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SI-SDAG-NEXT:    buffer_load_dword v0, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_mov_b32 s6, -1
; SI-SDAG-NEXT:    s_mov_b32 s4, s0
; SI-SDAG-NEXT:    s_mov_b32 s5, s1
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; SI-SDAG-NEXT:    s_mov_b32 s4, s0
; SI-SDAG-NEXT:    s_mov_b32 s5, s1
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[0:1], s8, 8
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
