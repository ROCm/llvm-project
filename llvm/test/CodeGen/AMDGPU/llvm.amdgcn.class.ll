...
; RUN:  llc -amdgpu-late-wave-transform=0 -global-isel=0 -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu6.00 < %s | FileCheck -enable-var-scope -check-prefixes=SI,SI-SDAG %s
