...
;RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx600 | FileCheck --check-prefixes=SI %s
;RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global | FileCheck --check-prefixes=VI %s
...
; VI-NEXT:    s_mov_b32 s8, 0xf000
; VI-NEXT:    s_mov_b32 s9, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; VI-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x0
; VI-NEXT:    s_mov_b32 s2, s9
; VI-NEXT:    s_mov_b32 s3, s8
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v1, s5
; VI-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-NEXT:    s_mov_b32 s16, 0xf000
; VI-NEXT:    s_mov_b32 s17, -1
; VI-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x44
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x0
; VI-NEXT:    s_load_dwordx4 s[12:15], s[12:13], 0x0
; VI-NEXT:    s_mov_b32 s2, s17
; VI-NEXT:    s_mov_b32 s3, s16
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_cmp_gt_i32 s10, s14
; VI-NEXT:    s_cselect_b32 s6, s6, s10
; VI-NEXT:    s_cmp_gt_i32 s9, s13
; VI-NEXT:    s_cselect_b32 s5, s5, s9
; VI-NEXT:    s_cmp_gt_i32 s11, s15
; VI-NEXT:    s_cselect_b32 s7, s7, s11
