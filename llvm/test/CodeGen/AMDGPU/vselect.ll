...
;RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.00 | FileCheck --check-prefixes=SI %s
;RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 -mattr=-flat-for-global | FileCheck --check-prefixes=VI %s
