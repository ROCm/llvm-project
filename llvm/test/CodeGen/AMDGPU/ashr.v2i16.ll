...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope --check-prefix=GFX11 %s
...
; GFX9-NEXT:    s_nop 0
; GFX9-NEXT:    s_load_dword s4, s[4:5], 0x38
...
; GFX10-NEXT:    s_load_dword s6, s[4:5], 0x30
; GFX10-NEXT:    s_nop 0
; GFX10-NEXT:    s_load_dword s4, s[4:5], 0x38
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_mov_b32 s2, -1
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_pk_ashrrev_i16 v0, s4, s6
...
; GFX11-NEXT:    s_load_b32 s6, s[4:5], 0x30
; GFX11-NEXT:    s_load_b32 s4, s[4:5], 0x38
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_mov_b32 s2, -1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_pk_ashrrev_i16 v0, s4, s6
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_pk_ashrrev_i16 v1, s4, v1
...
; CI-NEXT:    v_ashrrev_i32_e32 v2, 16, v2
; CI-NEXT:    v_ashrrev_i32_e32 v2, s2, v2
...
; GFX9-NEXT:    global_load_dword v1, v0, s[2:3]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_pk_ashrrev_i16 v1, v1, s4
; GFX9-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; CI-NEXT:    v_mov_b32_e32 v1, 0
; CI-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64
; CI-NEXT:    s_ashr_i32 s2, s8, 16
; CI-NEXT:    s_sext_i32_i16 s3, s8
; CI-NEXT:    s_mov_b64 s[4:5], s[0:1]
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_lshrrev_b32_e32 v3, 16, v2
; CI-NEXT:    v_ashr_i32_e32 v2, s3, v2
; CI-NEXT:    v_ashr_i32_e32 v3, s2, v3
