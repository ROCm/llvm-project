...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=+real-true16 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=GFX11-FAKE16 %s
