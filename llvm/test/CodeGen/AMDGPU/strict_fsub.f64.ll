...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx900 < %s | FileCheck -check-prefix=GCN %s

; RUN: llc -global-isel=0 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 < %s | FileCheck -check-prefix=GFX10 %s

; RUN: llc -global-isel=0 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefix=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefix=GFX11 %s
...
; GFX10G-LABEL: s_constained_fsub_f64_fpexcept_strict:
; GFX10G:       ; %bb.0:
; GFX10G-NEXT:    v_add_f64 v[0:1], s[2:3], -s[4:5]
; GFX10G-NEXT:    v_readfirstlane_b32 s0, v0
; GFX10G-NEXT:    v_readfirstlane_b32 s1, v1
; GFX10G-NEXT:    v_mov_b32_e32 v0, s0
; GFX10G-NEXT:    v_mov_b32_e32 v1, s1
; GFX10G-NEXT:    ; return to shader part epilog
;
; GFX11G-LABEL: s_constained_fsub_f64_fpexcept_strict:
; GFX11G:       ; %bb.0:
; GFX11G-NEXT:    v_add_f64 v[0:1], s[2:3], -s[4:5]
; GFX11G-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11G-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11G-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX11G-NEXT:    ; return to shader part epilog
  %val = call double @llvm.experimental.constrained.fsub.f64(double %x, double %y, metadata !"round.tonearest", metadata !"fpexcept.strict")
