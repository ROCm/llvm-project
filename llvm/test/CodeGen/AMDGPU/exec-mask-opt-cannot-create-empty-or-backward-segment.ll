...
; CHECK:       ; %bb.0: ; %bb
; CHECK-NEXT:    s_mov_b64 s[30:31], s[2:3]
; CHECK-NEXT:    s_mov_b64 s[28:29], s[0:1]
; CHECK-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; CHECK-NEXT:    s_add_u32 s28, s28, s17
...
; CHECK-NEXT:    s_xor_b64 s[2:3], s[10:11], -1
...
; CHECK-NEXT:    s_and_b64 s[4:5], exec, s[12:13]
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[6:7], 1, v0
...
; CHECK-NEXT:    s_mov_b64 s[24:25], s[12:13]
...
; CHECK-NEXT:    s_mov_b64 s[20:21], -1
; CHECK-NEXT:    s_mov_b64 s[18:19], 0
; CHECK-NEXT:    s_mov_b64 s[24:25], s[16:17]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    s_mov_b64 s[22:23], -1
; CHECK-NEXT:    s_mov_b64 s[24:25], s[14:15]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    s_xor_b64 s[24:25], s[22:23], -1
; CHECK-NEXT:    s_mov_b64 s[22:23], -1
; CHECK-NEXT:    s_and_b64 vcc, exec, s[24:25]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    buffer_store_dword v0, off, s[28:31], 0 offset:4
; CHECK-NEXT:    buffer_store_dword v0, off, s[28:31], 0
