...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32,-wavefrontsize64 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX1032 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=-wavefrontsize32,+wavefrontsize64 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX1064 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32,-wavefrontsize64 -amdgpu-early-ifcvt=1 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX1032 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -mattr=-wavefrontsize32,+wavefrontsize64 -amdgpu-early-ifcvt=1 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX1064 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GCN,GFX1032,GFX10DEFWAVE %s
...
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    v_cmp_gt_u32_e32 vcc, 11, v0
...
; GFX1032-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX1032-NEXT:    s_or_b32 s3, s3, s6
; GFX1032-NEXT:    s_or_b32 s4, s4, vcc_lo
; GFX1032-NEXT:    s_and_saveexec_b32 s3, s3
; GFX1032-NEXT:    s_or_b32 s5, s5, s3
; GFX1032-NEXT:    s_mov_b32 s3, 0
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB10_5
; GFX1032-NEXT:  .LBB10_4: ; %bb10
; GFX1032-NEXT:    ; in Loop: Header=BB10_2 Depth=1
; GFX1032-NEXT:    global_store_dword v[2:3], v0, off
; GFX1032-NEXT:  .LBB10_5: ; in Loop: Header=BB10_2 Depth=1
; GFX1032-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX1032-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX1032-NEXT:    s_and_saveexec_b32 s4, s4
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB10_1
; GFX1032-NEXT:  .LBB10_6: ; %bb11
; GFX1032-NEXT:    ; in Loop: Header=BB10_2 Depth=1
; GFX1032-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
; GFX1032-NEXT:    v_add_nc_u32_e32 v1, v1, v2
; GFX1032-NEXT:    v_ashrrev_i32_e32 v1, 1, v1
; GFX1032-NEXT:    s_branch .LBB10_1
; GFX1032-NEXT:  .LBB10_7: ; %bb1
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
; GFX1064-NEXT:    s_or_b64 s[6:7], s[6:7], vcc
; GFX1064-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX1064-NEXT:    s_or_b64 s[8:9], s[8:9], s[4:5]
; GFX1064-NEXT:    s_mov_b64 s[4:5], 0
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB10_5
; GFX1064-NEXT:  .LBB10_4: ; %bb10
; GFX1064-NEXT:    ; in Loop: Header=BB10_2 Depth=1
; GFX1064-NEXT:    global_store_dword v[2:3], v0, off
; GFX1064-NEXT:  .LBB10_5: ; in Loop: Header=BB10_2 Depth=1
; GFX1064-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX1064-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX1064-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB10_1
; GFX1064-NEXT:  .LBB10_6: ; %bb11
; GFX1064-NEXT:    ; in Loop: Header=BB10_2 Depth=1
; GFX1064-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
; GFX1064-NEXT:    v_add_nc_u32_e32 v1, v1, v2
; GFX1064-NEXT:    v_ashrrev_i32_e32 v1, 1, v1
; GFX1064-NEXT:    s_branch .LBB10_1
; GFX1064-NEXT:  .LBB10_7: ; %bb1
; GFX1064-NEXT:    s_endpgm
bb:
...
; GFX1032-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; GFX1032-NEXT:    s_and_saveexec_b32 s7, s0
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB11_4
; GFX1032-NEXT:  .LBB11_1: ; %.preheader
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
...
; GFX1032-NEXT:    s_add_i32 s6, s6, 1
; GFX1032-NEXT:    s_mov_b64 s[2:3], s[0:1]
; GFX1032-NEXT:    v_cmp_lt_u32_e32 vcc_lo, s6, v1
; GFX1032-NEXT:    s_add_u32 s0, s2, 4
; GFX1032-NEXT:    s_addc_u32 s1, s3, 0
; GFX1032-NEXT:    global_store_dword v2, v0, s[2:3]
; GFX1032-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX1032-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX1032-NEXT:    s_or_b32 s7, s7, s2
; GFX1032-NEXT:    ; divergent control-flow edge
...
; GFX1064-NEXT:  .LBB11_1: ; %.preheader
; GFX1064-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x24
...
; GFX1064-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX1064-NEXT:    v_cmp_lt_u32_e32 vcc, s8, v1
; GFX1064-NEXT:    s_add_u32 s2, s4, 4
; GFX1064-NEXT:    s_addc_u32 s3, s5, 0
; GFX1064-NEXT:    global_store_dword v2, v0, s[4:5]
; GFX1064-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
...
; GFX1032-NEXT:    s_sub_u32 s8, 0, s0
; GFX1032-NEXT:    s_subb_u32 s9, 0, s1
...
; GFX1032-NEXT:    s_mul_i32 s10, s8, s4
; GFX1032-NEXT:    s_mul_hi_u32 s12, s8, s5
; GFX1032-NEXT:    s_mul_i32 s11, s9, s5
; GFX1032-NEXT:    s_add_i32 s10, s12, s10
; GFX1032-NEXT:    s_mul_i32 s13, s8, s5
; GFX1032-NEXT:    s_add_i32 s10, s10, s11
; GFX1032-NEXT:    s_mul_hi_u32 s12, s5, s13
; GFX1032-NEXT:    s_mul_i32 s15, s5, s10
; GFX1032-NEXT:    s_mul_hi_u32 s14, s4, s13
; GFX1032-NEXT:    s_mul_i32 s11, s4, s13
; GFX1032-NEXT:    s_mul_hi_u32 s13, s5, s10
; GFX1032-NEXT:    s_add_u32 s12, s12, s15
; GFX1032-NEXT:    s_addc_u32 s13, 0, s13
; GFX1032-NEXT:    s_mul_hi_u32 s16, s4, s10
; GFX1032-NEXT:    s_add_u32 s11, s12, s11
; GFX1032-NEXT:    s_mul_i32 s10, s4, s10
; GFX1032-NEXT:    s_addc_u32 s11, s13, s14
; GFX1032-NEXT:    s_addc_u32 s12, s16, 0
; GFX1032-NEXT:    s_add_u32 s10, s11, s10
; GFX1032-NEXT:    s_addc_u32 s11, 0, s12
; GFX1032-NEXT:    s_add_u32 s5, s5, s10
; GFX1032-NEXT:    s_addc_u32 s4, s4, s11
; GFX1032-NEXT:    s_mul_i32 s10, s8, s5
; GFX1032-NEXT:    s_mul_hi_u32 s11, s8, s5
; GFX1032-NEXT:    s_mul_i32 s8, s8, s4
; GFX1032-NEXT:    s_mul_i32 s9, s9, s5
; GFX1032-NEXT:    s_add_i32 s8, s11, s8
; GFX1032-NEXT:    s_mul_hi_u32 s12, s4, s10
; GFX1032-NEXT:    s_add_i32 s8, s8, s9
; GFX1032-NEXT:    s_mul_hi_u32 s9, s5, s10
; GFX1032-NEXT:    s_mul_i32 s13, s5, s8
; GFX1032-NEXT:    s_mul_i32 s11, s4, s10
; GFX1032-NEXT:    s_mul_hi_u32 s10, s5, s8
; GFX1032-NEXT:    s_add_u32 s9, s9, s13
; GFX1032-NEXT:    s_addc_u32 s10, 0, s10
; GFX1032-NEXT:    s_mul_hi_u32 s14, s4, s8
; GFX1032-NEXT:    s_add_u32 s9, s9, s11
; GFX1032-NEXT:    s_mul_i32 s8, s4, s8
; GFX1032-NEXT:    s_addc_u32 s9, s10, s12
; GFX1032-NEXT:    s_addc_u32 s10, s14, 0
; GFX1032-NEXT:    s_add_u32 s8, s9, s8
; GFX1032-NEXT:    s_addc_u32 s9, 0, s10
; GFX1032-NEXT:    s_add_u32 s5, s5, s8
; GFX1032-NEXT:    s_addc_u32 s4, s4, s9
; GFX1032-NEXT:    s_mul_hi_u32 s8, s2, s5
; GFX1032-NEXT:    s_mul_i32 s11, s2, s4
; GFX1032-NEXT:    s_mul_hi_u32 s10, s2, s4
; GFX1032-NEXT:    s_mul_hi_u32 s9, s3, s5
; GFX1032-NEXT:    s_mul_i32 s5, s3, s5
; GFX1032-NEXT:    s_add_u32 s8, s8, s11
; GFX1032-NEXT:    s_addc_u32 s10, 0, s10
; GFX1032-NEXT:    s_mul_hi_u32 s12, s3, s4
; GFX1032-NEXT:    s_add_u32 s5, s8, s5
; GFX1032-NEXT:    s_mul_i32 s4, s3, s4
; GFX1032-NEXT:    s_addc_u32 s5, s10, s9
; GFX1032-NEXT:    s_addc_u32 s8, s12, 0
; GFX1032-NEXT:    s_add_u32 s4, s5, s4
; GFX1032-NEXT:    s_addc_u32 s5, 0, s8
; GFX1032-NEXT:    s_mul_hi_u32 s8, s0, s4
; GFX1032-NEXT:    s_mul_i32 s9, s0, s5
; GFX1032-NEXT:    s_mul_i32 s10, s1, s4
; GFX1032-NEXT:    s_add_i32 s8, s8, s9
; GFX1032-NEXT:    s_mul_i32 s9, s0, s4
; GFX1032-NEXT:    s_add_i32 s8, s8, s10
; GFX1032-NEXT:    s_sub_i32 s10, s3, s8
; GFX1032-NEXT:    s_sub_u32 s2, s2, s9
; GFX1032-NEXT:    s_cselect_b32 s9, -1, 0
; GFX1032-NEXT:    s_subb_u32 s10, s10, s1
; GFX1032-NEXT:    s_sub_u32 s11, s2, s0
; GFX1032-NEXT:    s_subb_u32 s10, s10, 0
; GFX1032-NEXT:    s_cmp_ge_u32 s10, s1
; GFX1032-NEXT:    s_cselect_b32 s12, -1, 0
; GFX1032-NEXT:    s_cmp_ge_u32 s11, s0
; GFX1032-NEXT:    s_cselect_b32 s11, -1, 0
; GFX1032-NEXT:    s_cmp_eq_u32 s10, s1
; GFX1032-NEXT:    s_cselect_b32 s10, s11, s12
; GFX1032-NEXT:    s_add_u32 s11, s4, 1
; GFX1032-NEXT:    s_addc_u32 s12, s5, 0
; GFX1032-NEXT:    s_add_u32 s13, s4, 2
; GFX1032-NEXT:    s_addc_u32 s14, s5, 0
; GFX1032-NEXT:    s_cmp_lg_u32 s10, 0
; GFX1032-NEXT:    s_cselect_b32 s10, s13, s11
; GFX1032-NEXT:    s_cselect_b32 s11, s14, s12
; GFX1032-NEXT:    s_cmp_lg_u32 s9, 0
; GFX1032-NEXT:    s_subb_u32 s3, s3, s8
; GFX1032-NEXT:    s_cmp_ge_u32 s3, s1
; GFX1032-NEXT:    s_cselect_b32 s8, -1, 0
; GFX1032-NEXT:    s_cmp_ge_u32 s2, s0
; GFX1032-NEXT:    s_cselect_b32 s0, -1, 0
; GFX1032-NEXT:    s_cmp_eq_u32 s3, s1
; GFX1032-NEXT:    s_cselect_b32 s0, s0, s8
; GFX1032-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1032-NEXT:    s_cselect_b32 s4, s10, s4
; GFX1032-NEXT:    s_cselect_b32 s5, s11, s5
...
; GFX1064-NEXT:    ; implicit-def: $sgpr8_sgpr9
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_add_u32 s9, s5, s4
; GFX1064-NEXT:    s_addc_u32 s8, 0, s8
; GFX1064-NEXT:    s_mul_hi_u32 s4, s0, s9
; GFX1064-NEXT:    s_mul_i32 s5, s0, s8
; GFX1064-NEXT:    s_mul_i32 s10, s1, s9
; GFX1064-NEXT:    s_add_i32 s4, s4, s5
; GFX1064-NEXT:    s_add_i32 s10, s4, s10
; GFX1064-NEXT:    s_mul_i32 s4, s0, s9
; GFX1064-NEXT:    s_sub_i32 s11, s3, s10
; GFX1064-NEXT:    s_sub_u32 s2, s2, s4
; GFX1064-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX1064-NEXT:    s_subb_u32 s11, s11, s1
; GFX1064-NEXT:    s_sub_u32 s12, s2, s0
; GFX1064-NEXT:    s_subb_u32 s11, s11, 0
; GFX1064-NEXT:    s_cmp_ge_u32 s11, s1
; GFX1064-NEXT:    s_cselect_b32 s13, -1, 0
; GFX1064-NEXT:    s_cmp_ge_u32 s12, s0
; GFX1064-NEXT:    s_cselect_b32 s12, -1, 0
; GFX1064-NEXT:    s_cmp_eq_u32 s11, s1
; GFX1064-NEXT:    s_cselect_b32 s11, s12, s13
; GFX1064-NEXT:    s_add_u32 s12, s9, 1
; GFX1064-NEXT:    s_addc_u32 s13, s8, 0
; GFX1064-NEXT:    s_add_u32 s14, s9, 2
; GFX1064-NEXT:    s_addc_u32 s15, s8, 0
; GFX1064-NEXT:    s_cmp_lg_u32 s11, 0
; GFX1064-NEXT:    s_cselect_b32 s11, s14, s12
; GFX1064-NEXT:    s_cselect_b32 s12, s15, s13
; GFX1064-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX1064-NEXT:    s_subb_u32 s3, s3, s10
; GFX1064-NEXT:    s_cmp_ge_u32 s3, s1
; GFX1064-NEXT:    s_cselect_b32 s4, -1, 0
; GFX1064-NEXT:    s_cmp_ge_u32 s2, s0
; GFX1064-NEXT:    s_cselect_b32 s0, -1, 0
; GFX1064-NEXT:    s_cmp_eq_u32 s3, s1
; GFX1064-NEXT:    s_cselect_b32 s0, s0, s4
; GFX1064-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1064-NEXT:    s_cselect_b32 s4, s11, s9
; GFX1064-NEXT:    s_cselect_b32 s5, s12, s8
...
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    global_load_dwordx3 v[1:3], v1, s[2:3]
; GFX1032-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX1032-NEXT:    s_mov_b32 s2, 0
; GFX1032-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s2
; GFX1032-NEXT:    s_xor_b32 s2, vcc_lo, exec_lo
; GFX1032-NEXT:    s_and_saveexec_b32 s2, s2
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB22_2
; GFX1032-NEXT:  .LBB22_1: ; %bb
; GFX1032-NEXT:    v_mov_b32_e32 v0, 0
; GFX1032-NEXT:    global_load_dword v0, v0, s[6:7] glc dlc
; GFX1032-NEXT:    s_waitcnt vmcnt(0)
; GFX1032-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
...
; GFX1032-NEXT:    global_store_dword v0, v1, s[0:1] offset:8
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:    global_store_dword v0, v1, s[0:1] offset:8
; GFX1064-NEXT:    s_endpgm
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x() nounwind readnone
...
; GFX1032-NEXT:    s_cbranch_vccz .LBB25_2
; GFX1032-NEXT:  ; %bb.1: ; %store
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v0, 0
; GFX1032-NEXT:    v_mov_b32_e32 v1, 0xde
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX1032-NEXT:  .LBB25_2: ; %end
; GFX1032-NEXT:    s_endpgm
;
; GFX1064-LABEL: test_brcc_i1:
; GFX1064:       ; %bb.0:
...
; GFX1064-NEXT:    s_cbranch_vccz .LBB25_2
; GFX1064-NEXT:  ; %bb.1: ; %store
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v0, 0
; GFX1064-NEXT:    v_mov_b32_e32 v1, 0xde
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX1064-NEXT:  .LBB25_2: ; %end
; GFX1064-NEXT:    s_endpgm
...
; GFX1032-NEXT:    v_mov_b32_e32 v4, 0
; GFX1032-NEXT:  .LBB33_1: ; %loop
; GFX1032-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1032-NEXT:    v_cmp_lt_f32_e32 vcc_lo, 0x40e00000, v4
; GFX1032-NEXT:    s_cbranch_vccnz .LBB33_3
; GFX1032-NEXT:  ; %bb.2: ; %body
; GFX1032-NEXT:    ; in Loop: Header=BB33_1 Depth=1
; GFX1032-NEXT:    s_waitcnt vmcnt(0)
; GFX1032-NEXT:    image_sample v[0:3], v0, s[0:7], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX1032-NEXT:    v_add_f32_e32 v4, 2.0, v4
; GFX1032-NEXT:    s_branch .LBB33_1
; GFX1032-NEXT:  .LBB33_3: ; %break
...
; GFX1064-NEXT:    v_mov_b32_e32 v4, 0
; GFX1064-NEXT:  .LBB33_1: ; %loop
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-NEXT:    v_cmp_lt_f32_e32 vcc, 0x40e00000, v4
; GFX1064-NEXT:    s_cbranch_vccnz .LBB33_3
; GFX1064-NEXT:  ; %bb.2: ; %body
; GFX1064-NEXT:    ; in Loop: Header=BB33_1 Depth=1
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-NEXT:    image_sample v[0:3], v0, s[0:7], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX1064-NEXT:    v_add_f32_e32 v4, 2.0, v4
; GFX1064-NEXT:    s_branch .LBB33_1
; GFX1064-NEXT:  .LBB33_3: ; %break
...
; GFX1032-NEXT:    v_cmp_lt_u32_e32 vcc_lo, 15, v0
; GFX1032-NEXT:    v_mov_b32_e32 v0, 0
; GFX1032-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1032-NEXT:    s_and_saveexec_b32 s1, s1
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB35_2
; GFX1032-NEXT:  .LBB35_1: ; %if
...
; GFX1064-NEXT:    v_cmp_lt_u32_e32 vcc, 15, v0
; GFX1064-NEXT:    v_mov_b32_e32 v0, 0
; GFX1064-NEXT:    s_xor_b64 s[2:3], vcc, exec
; GFX1064-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB35_2
; GFX1064-NEXT:  .LBB35_1: ; %if
; GFX1064-NEXT:    s_or_saveexec_b64 s[4:5], -1
...
; GFX1032-NEXT:    s_cbranch_execnz .LBB45_4
; GFX1032-NEXT:  ; %bb.1: ; %for.body.lr.ph
; GFX1032-NEXT:  ; %bb.2: ; %for.body
; GFX1032-NEXT:    s_mov_b32 vcc_lo, 0
; GFX1032-NEXT:  ; %bb.3: ; %for.end.loopexit
; GFX1032-NEXT:  .LBB45_4: ; %for.end
; GFX1032-NEXT:    s_endpgm
;
; GFX1064-LABEL: test_branch_true:
; GFX1064:       ; %bb.0: ; %entry
; GFX1064-NEXT:    s_mov_b64 vcc, exec
; GFX1064-NEXT:    s_cbranch_execnz .LBB45_4
; GFX1064-NEXT:  ; %bb.1: ; %for.body.lr.ph
; GFX1064-NEXT:  ; %bb.2: ; %for.body
; GFX1064-NEXT:    s_mov_b64 vcc, 0
; GFX1064-NEXT:  ; %bb.3: ; %for.end.loopexit
; GFX1064-NEXT:  .LBB45_4: ; %for.end
; GFX1064-NEXT:    s_endpgm
entry:
...
; GFX1032-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB50_2
; GFX1032-NEXT:  .LBB50_1: ; %if.then
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB50_2
; GFX1064-NEXT:  .LBB50_1: ; %if.then
...
; GFX1032-NEXT:    s_and_saveexec_b32 s2, s2
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB51_5
; GFX1032-NEXT:  .LBB51_1: ; %frem.compute
...
; GFX1032-NEXT:    v_div_scale_f32 v3, s4, v1, v1, 1.0
; GFX1032-NEXT:    v_div_scale_f32 v5, vcc_lo, 1.0, v1, 1.0
; GFX1032-NEXT:    v_rcp_f32_e32 v4, v3
; GFX1032-NEXT:    v_fma_f32 v2, -v3, v4, 1.0
; GFX1032-NEXT:    v_fmac_f32_e32 v4, v2, v4
; GFX1032-NEXT:    v_mul_f32_e32 v8, v5, v4
; GFX1032-NEXT:    v_fma_f32 v2, -v3, v8, v5
; GFX1032-NEXT:    v_fmac_f32_e32 v8, v2, v4
...
; GFX1032-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 13, v3
; GFX1032-NEXT:    v_ldexp_f32 v5, v9, 12
; GFX1032-NEXT:    v_div_fixup_f32 v4, v4, v1, 1.0
; GFX1032-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; GFX1032-NEXT:    s_and_saveexec_b32 s4, s4
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB51_4
; GFX1032-NEXT:  .LBB51_2: ; %frem.loop_body.preheader
...
; GFX1032-NEXT:  .LBB51_3: ; %frem.loop_body
; GFX1032-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1032-NEXT:    s_or_b32 s4, s4, s3
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execnz .LBB51_3
; GFX1032-NEXT:  .LBB51_4: ; %frem.loop_exit
; GFX1032-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX1032-NEXT:    v_add_nc_u32_e32 v3, -11, v3
; GFX1032-NEXT:    v_ldexp_f32 v3, v5, v3
; GFX1032-NEXT:    v_mul_f32_e32 v4, v3, v4
; GFX1032-NEXT:    v_rndne_f32_e32 v4, v4
; GFX1032-NEXT:    v_fma_f32 v3, -v4, v1, v3
...
; GFX1032-NEXT:    s_lshr_b32 s0, vcc_lo, 1
; GFX1032-NEXT:    v_cmp_lg_f32_e32 vcc_lo, 0, v0
; GFX1032-NEXT:    s_ff1_i32_b64 s0, s[0:1]
; GFX1032-NEXT:    s_cmp_lt_u32 s0, 10
; GFX1032-NEXT:    s_cselect_b32 s0, -1, 0
; GFX1032-NEXT:    s_or_b32 s0, vcc_lo, s0
...
; GFX1032-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB51_9
; GFX1032-NEXT:  .LBB51_8: ; %if.then
; GFX1032-NEXT:    ; divergent unreachable
; GFX1032-NEXT:  .LBB51_9: ; %UnifiedReturnBlock
; GFX1032-NEXT:    s_endpgm
;
; GFX1064-LABEL: fcmp64:
; GFX1064:       ; %bb.0: ; %entry
; GFX1064-NEXT:    s_load_dword s8, s[4:5], 0x28
; GFX1064-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GFX1064-NEXT:    s_mov_b64 s[4:5], -1
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    v_cmp_gt_f32_e64 s[2:3], v0, |s8|
; GFX1064-NEXT:    s_xor_b64 s[0:1], s[2:3], exec
; GFX1064-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB51_5
; GFX1064-NEXT:  .LBB51_1: ; %frem.compute
; GFX1064-NEXT:    v_frexp_mant_f32_e64 v1, |s8|
; GFX1064-NEXT:    v_frexp_exp_i32_f32_e32 v6, s8
; GFX1064-NEXT:    v_frexp_exp_i32_f32_e32 v7, v0
; GFX1064-NEXT:    v_frexp_mant_f32_e32 v9, v0
; GFX1064-NEXT:    v_ldexp_f32 v1, v1, 1
; GFX1064-NEXT:    v_div_scale_f32 v3, s[6:7], v1, v1, 1.0
; GFX1064-NEXT:    v_div_scale_f32 v5, vcc, 1.0, v1, 1.0
; GFX1064-NEXT:    v_rcp_f32_e32 v4, v3
; GFX1064-NEXT:    v_fma_f32 v2, -v3, v4, 1.0
; GFX1064-NEXT:    v_fmac_f32_e32 v4, v2, v4
; GFX1064-NEXT:    v_mul_f32_e32 v8, v5, v4
; GFX1064-NEXT:    v_fma_f32 v2, -v3, v8, v5
; GFX1064-NEXT:    v_fmac_f32_e32 v8, v2, v4
...
; GFX1064-NEXT:    v_cmp_gt_i32_e32 vcc, 13, v3
; GFX1064-NEXT:    v_ldexp_f32 v5, v9, 12
; GFX1064-NEXT:    v_div_fixup_f32 v4, v4, v1, 1.0
; GFX1064-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX1064-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB51_4
; GFX1064-NEXT:  .LBB51_2: ; %frem.loop_body.preheader
...
; GFX1064-NEXT:  .LBB51_3: ; %frem.loop_body
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX1064-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execnz .LBB51_3
; GFX1064-NEXT:  .LBB51_4: ; %frem.loop_exit
; GFX1064-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX1064-NEXT:    v_add_nc_u32_e32 v3, -11, v3
; GFX1064-NEXT:    v_ldexp_f32 v3, v5, v3
; GFX1064-NEXT:    v_mul_f32_e32 v4, v3, v4
; GFX1064-NEXT:    v_rndne_f32_e32 v4, v4
; GFX1064-NEXT:    v_fma_f32 v3, -v4, v1, v3
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB51_9
; GFX1064-NEXT:  .LBB51_8: ; %if.then
; GFX1064-NEXT:    ; divergent unreachable
; GFX1064-NEXT:  .LBB51_9: ; %UnifiedReturnBlock
; GFX1064-NEXT:    s_endpgm
entry:
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX1032-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB52_2
; GFX1032-NEXT:  .LBB52_1: ; %if.then
; GFX1032-NEXT:    ; divergent unreachable
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB52_2
; GFX1064-NEXT:  .LBB52_1: ; %if.then
; GFX1064-NEXT:    ; divergent unreachable
...
; GFX1032-NEXT:    s_and_saveexec_b32 s2, s2
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB53_5
; GFX1032-NEXT:  .LBB53_1: ; %frem.compute
; GFX1032-NEXT:    v_frexp_mant_f32_e64 v1, |s0|
; GFX1032-NEXT:    v_frexp_exp_i32_f32_e32 v6, s0
; GFX1032-NEXT:    v_frexp_exp_i32_f32_e32 v7, v0
; GFX1032-NEXT:    v_frexp_mant_f32_e32 v9, v0
...
; GFX1032-NEXT:    s_and_saveexec_b32 s4, s4
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB53_4
; GFX1032-NEXT:  .LBB53_2: ; %frem.loop_body.preheader
; GFX1032-NEXT:    v_sub_nc_u32_e32 v3, v7, v6
; GFX1032-NEXT:    v_mov_b32_e32 v6, v5
; GFX1032-NEXT:    s_and_b32 s3, s3, exec_lo
; GFX1032-NEXT:    v_add_nc_u32_e32 v3, 12, v3
; GFX1032-NEXT:  .LBB53_3: ; %frem.loop_body
; GFX1032-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1032-NEXT:    v_mov_b32_e32 v5, v6
; GFX1032-NEXT:    v_add_nc_u32_e32 v3, -12, v3
; GFX1032-NEXT:    v_mul_f32_e32 v6, v5, v4
...
; GFX1032-NEXT:    s_or_b32 s4, s4, s3
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execnz .LBB53_3
; GFX1032-NEXT:  .LBB53_4: ; %frem.loop_exit
; GFX1032-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX1032-NEXT:    v_add_nc_u32_e32 v3, -11, v3
; GFX1032-NEXT:    v_ldexp_f32 v3, v5, v3
; GFX1032-NEXT:    v_mul_f32_e32 v4, v3, v4
...
; GFX1032-NEXT:    v_ldexp_f32 v1, v1, v2
; GFX1032-NEXT:    v_bfi_b32 v0, 0x7fffffff, v1, v0
; GFX1032-NEXT:  .LBB53_5:
; GFX1032-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX1032-NEXT:    s_and_saveexec_b32 s1, s1
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB53_7
; GFX1032-NEXT:  .LBB53_6: ; %frem.else
; GFX1032-NEXT:    v_and_b32_e32 v1, 0x80000000, v0
; GFX1032-NEXT:    v_cmp_eq_f32_e64 vcc_lo, v0, |s0|
; GFX1032-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc_lo
; GFX1032-NEXT:  .LBB53_7:
; GFX1032-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX1032-NEXT:    v_cmp_lg_f32_e64 vcc_lo, s0, 0
; GFX1032-NEXT:    v_cndmask_b32_e32 v0, 0x7fc00000, v0, vcc_lo
; GFX1032-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v0
...
; GFX1032-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1032-NEXT:    ; divergent control-flow edge
; GFX1032-NEXT:    s_cbranch_execz .LBB53_9
; GFX1032-NEXT:  .LBB53_8: ; %if.then
; GFX1032-NEXT:    ; divergent unreachable
; GFX1032-NEXT:  .LBB53_9: ; %UnifiedReturnBlock
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB53_5
; GFX1064-NEXT:  .LBB53_1: ; %frem.compute
; GFX1064-NEXT:    v_frexp_mant_f32_e64 v1, |s8|
; GFX1064-NEXT:    v_frexp_exp_i32_f32_e32 v6, s8
; GFX1064-NEXT:    v_frexp_exp_i32_f32_e32 v7, v0
; GFX1064-NEXT:    v_frexp_mant_f32_e32 v9, v0
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB53_4
; GFX1064-NEXT:  .LBB53_2: ; %frem.loop_body.preheader
; GFX1064-NEXT:    v_sub_nc_u32_e32 v3, v7, v6
; GFX1064-NEXT:    v_mov_b32_e32 v6, v5
; GFX1064-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1064-NEXT:    v_add_nc_u32_e32 v3, 12, v3
; GFX1064-NEXT:  .LBB53_3: ; %frem.loop_body
; GFX1064-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-NEXT:    v_mov_b32_e32 v5, v6
; GFX1064-NEXT:    v_add_nc_u32_e32 v3, -12, v3
; GFX1064-NEXT:    v_mul_f32_e32 v6, v5, v4
...
; GFX1064-NEXT:    s_or_b64 s[6:7], s[6:7], s[4:5]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execnz .LBB53_3
; GFX1064-NEXT:  .LBB53_4: ; %frem.loop_exit
; GFX1064-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX1064-NEXT:    v_add_nc_u32_e32 v3, -11, v3
; GFX1064-NEXT:    v_ldexp_f32 v3, v5, v3
; GFX1064-NEXT:    v_mul_f32_e32 v4, v3, v4
...
; GFX1064-NEXT:    v_ldexp_f32 v1, v1, v2
; GFX1064-NEXT:    v_bfi_b32 v0, 0x7fffffff, v1, v0
; GFX1064-NEXT:  .LBB53_5:
; GFX1064-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1064-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB53_7
; GFX1064-NEXT:  .LBB53_6: ; %frem.else
; GFX1064-NEXT:    v_and_b32_e32 v1, 0x80000000, v0
; GFX1064-NEXT:    v_cmp_eq_f32_e64 vcc, v0, |s8|
; GFX1064-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
...
; GFX1064-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1064-NEXT:    ; divergent control-flow edge
; GFX1064-NEXT:    s_cbranch_execz .LBB53_9
; GFX1064-NEXT:  .LBB53_8: ; %if.then
; GFX1064-NEXT:    ; divergent unreachable
; GFX1064-NEXT:  .LBB53_9: ; %UnifiedReturnBlock
; GFX1064-NEXT:    s_endpgm
entry:
  %id = tail call i32 @llvm.amdgcn.workitem.id.x()
  %id.f = uitofp i32 %id to float
