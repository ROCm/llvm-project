...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck --check-prefixes=GFX6 %s
...
; GFX6-NEXT:    s_lshl_b64 s[2:3], s[2:3], s5
; GFX6-NEXT:    s_min_u32 s2, s2, 1
; GFX6-NEXT:    s_or_b32 s2, s3, s2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX6-NEXT:    s_sub_i32 s3, 32, s5
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    v_ldexp_f32_e64 v0, v0, s3
...
; GFX6-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0xd
...
; GFX6-NEXT:    s_xor_b32 s7, s4, s5
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s6
; GFX6-NEXT:    s_flbit_i32 s6, s5
; GFX6-NEXT:    s_ashr_i32 s7, s7, 31
; GFX6-NEXT:    s_add_i32 s6, s6, -1
; GFX6-NEXT:    s_add_i32 s7, s7, 32
; GFX6-NEXT:    s_min_u32 s6, s6, s7
; GFX6-NEXT:    s_lshl_b64 s[4:5], s[4:5], s6
...
; GFX6-NEXT:    buffer_load_dwordx4 v[1:4], v[8:9], s[0:3], 0 addr64 offset:16
; GFX6-NEXT:    buffer_load_dwordx4 v[5:8], v[8:9], s[0:3], 0 addr64
...
; GFX6-NEXT:    s_or_b32 s6, s7, s6
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s6
; GFX6-NEXT:    s_sub_i32 s6, 32, s8
; GFX6-NEXT:    s_xor_b32 s8, s4, s5
; GFX6-NEXT:    s_flbit_i32 s7, s5
; GFX6-NEXT:    s_ashr_i32 s8, s8, 31
; GFX6-NEXT:    s_add_i32 s7, s7, -1
; GFX6-NEXT:    s_add_i32 s8, s8, 32
; GFX6-NEXT:    s_min_u32 s7, s7, s8
; GFX6-NEXT:    s_lshl_b64 s[4:5], s[4:5], s7
; GFX6-NEXT:    s_min_u32 s4, s4, 1
; GFX6-NEXT:    s_or_b32 s4, s5, s4
...
; GFX6-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX6-NEXT:    v_ldexp_f32_e64 v1, v1, s4
...
; GFX8-NEXT:    s_xor_b32 s6, s0, s1
; GFX8-NEXT:    s_flbit_i32 s3, s1
; GFX8-NEXT:    s_ashr_i32 s6, s6, 31
; GFX8-NEXT:    s_add_i32 s3, s3, -1
; GFX8-NEXT:    s_add_i32 s6, s6, 32
; GFX8-NEXT:    s_min_u32 s3, s3, s6
