...
; GFX8-NEXT:    v_mov_b32_e32 v2, s1
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, s0, v0
; GFX8-NEXT:    v_ldexp_f32 v3, v1, v3
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v2, vcc
...
; GFX8-NEXT:    v_lshlrev_b32_e32 v9, 4, v0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v2, s3
...
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v9
; GFX8-NEXT:    v_ldexp_f32 v1, v3, v14
; GFX8-NEXT:    v_ldexp_f32 v3, v5, v11
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v10, vcc
...
; GFX8-NEXT:    flat_load_dwordx4 v[5:8], v[5:6]
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_xor_b32_e32 v9, v3, v4
; GFX8-NEXT:    v_xor_b32_e32 v11, v1, v2
; GFX8-NEXT:    v_ffbh_i32_e32 v10, v4
; GFX8-NEXT:    v_ffbh_i32_e32 v12, v2
; GFX8-NEXT:    v_ashrrev_i32_e32 v9, 31, v9
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_xor_b32_e32 v13, v7, v8
; GFX8-NEXT:    v_xor_b32_e32 v15, v5, v6
; GFX8-NEXT:    v_ffbh_i32_e32 v14, v8
; GFX8-NEXT:    v_ffbh_i32_e32 v16, v6
; GFX8-NEXT:    v_ashrrev_i32_e32 v11, 31, v11
; GFX8-NEXT:    v_ashrrev_i32_e32 v13, 31, v13
; GFX8-NEXT:    v_ashrrev_i32_e32 v15, 31, v15
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, -1, v10
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, -1, v12
; GFX8-NEXT:    v_add_u32_e32 v14, vcc, -1, v14
; GFX8-NEXT:    v_add_u32_e32 v16, vcc, -1, v16
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 32, v9
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 32, v11
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, 32, v13
; GFX8-NEXT:    v_add_u32_e32 v15, vcc, 32, v15
; GFX8-NEXT:    v_min_u32_e32 v9, v10, v9
; GFX8-NEXT:    v_min_u32_e32 v10, v12, v11
; GFX8-NEXT:    v_min_u32_e32 v11, v14, v13
; GFX8-NEXT:    v_min_u32_e32 v12, v16, v15
; GFX8-NEXT:    v_lshlrev_b64 v[3:4], v9, v[3:4]
; GFX8-NEXT:    v_lshlrev_b64 v[1:2], v10, v[1:2]
...
; GFX8-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GFX8-NEXT:    v_sub_u32_e32 v9, vcc, 32, v9
; GFX8-NEXT:    v_sub_u32_e32 v10, vcc, 32, v10
; GFX8-NEXT:    v_sub_u32_e32 v11, vcc, 32, v11
; GFX8-NEXT:    v_sub_u32_e32 v12, vcc, 32, v12
; GFX8-NEXT:    v_ldexp_f32 v3, v3, v9
; GFX8-NEXT:    v_ldexp_f32 v1, v1, v10
; GFX8-NEXT:    v_ldexp_f32 v2, v2, v11
...
; GFX8-NEXT:    v_or_b32_e32 v1, v4, v2
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, s0, v5
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v6, vcc
; GFX8-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX8-NEXT:    s_endpgm
;
