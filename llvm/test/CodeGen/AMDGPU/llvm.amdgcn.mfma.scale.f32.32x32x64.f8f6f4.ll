...
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.50-amd-amdhsa -global-isel=0 < %s | FileCheck -check-prefixes=GCN,SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.50-amd-amdhsa -global-isel=1 < %s | FileCheck -check-prefixes=GCN,GISEL %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.50-amd-amdhsa -global-isel=0 --amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=AGPR,AGPR-SDAG %s
