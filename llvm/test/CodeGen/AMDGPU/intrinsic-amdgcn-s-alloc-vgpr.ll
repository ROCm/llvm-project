...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn--amdpal -mcpu=gfx1250 < %s | FileCheck %s --check-prefix=GISEL
...
; DAGISEL:       ; %bb.0: ; %entry
; DAGISEL-NEXT:    global_prefetch_b8 v0, null scope:SCOPE_SE
; DAGISEL-NEXT:    v_nop
...
; NRBS:       ; %bb.0: ; %entry
; NRBS-NEXT:    global_prefetch_b8 v0, null scope:SCOPE_SE
; NRBS-NEXT:    v_nop
