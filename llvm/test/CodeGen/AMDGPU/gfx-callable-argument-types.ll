...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx900 < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx1010 < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdpal -mcpu=gfx1010 -mattr=+enable-flat-scratch < %s | FileCheck --check-prefix=GFX10-SCRATCH %s
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, 2 :: v_dual_mov_b32 v3, 0
; GFX11-TRUE16-NEXT:    v_readlane_b32 s30, v42, 0
; GFX11-TRUE16-NEXT:    v_perm_b32 v1, v0, v1, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_readlane_b32 s31, v42, 1
; GFX11-TRUE16-NEXT:    s_mov_b32 s32, s33
; GFX11-TRUE16-NEXT:    s_clause 0x1
; GFX11-TRUE16-NEXT:    global_store_d16_hi_b8 v[2:3], v0, off
; GFX11-TRUE16-NEXT:    global_store_b16 v[40:41], v1, off
; GFX11-TRUE16-NEXT:    s_clause 0x1 ; 8-byte Folded Reload
; GFX11-TRUE16-NEXT:    scratch_load_b32 v41, off, s33
; GFX11-TRUE16-NEXT:    scratch_load_b32 v40, off, s33 offset:4
; GFX11-TRUE16-NEXT:    v_readlane_b32 s0, v42, 2
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v3, v2, v3, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_readlane_b32 s30, v42, 0
; GFX11-TRUE16-NEXT:    v_perm_b32 v4, v0, v1, 0xc0c0004
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v1, 4 :: v_dual_mov_b32 v2, 0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v3, v3, 16, v4
; GFX11-TRUE16-NEXT:    v_readlane_b32 s31, v42, 1
; GFX11-TRUE16-NEXT:    s_mov_b32 s32, s33
; GFX11-TRUE16-NEXT:    v_readlane_b32 s0, v42, 2
; GFX11-TRUE16-NEXT:    s_clause 0x1
; GFX11-TRUE16-NEXT:    global_store_d16_hi_b8 v[1:2], v0, off
; GFX11-TRUE16-NEXT:    global_store_b32 v[40:41], v3, off
; GFX11-TRUE16-NEXT:    s_clause 0x1 ; 8-byte Folded Reload
; GFX11-TRUE16-NEXT:    scratch_load_b32 v41, off, s33
; GFX11-TRUE16-NEXT:    scratch_load_b32 v40, off, s33 offset:4
; GFX11-TRUE16-NEXT:    s_or_saveexec_b32 s1, -1
...
; GFX9-NEXT:    v_writelane_b32 v40, s31, 9
; GFX9-NEXT:    s_load_dwordx2 s[34:35], s[34:35], 0x0
; GFX9-NEXT:    s_mov_b32 s37, external_void_func_v8i32_inreg@abs32@hi
; GFX9-NEXT:    s_mov_b32 s36, external_void_func_v8i32_inreg@abs32@lo
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_load_dwordx2 s[34:35], s[34:35], 0x0
; GFX9-NEXT:    s_mov_b32 s37, external_void_func_v16i32_inreg@abs32@hi
; GFX9-NEXT:    s_mov_b32 s36, external_void_func_v16i32_inreg@abs32@lo
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v5, s51
