...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdpal -mattr=+architected-sgprs < %s | FileCheck -check-prefix=GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00-amd-amdpal -mattr=+architected-sgprs -global-isel < %s | FileCheck -check-prefix=GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdpal < %s | FileCheck -check-prefix=GFX12-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.00-amd-amdpal -global-isel < %s | FileCheck -check-prefix=GFX12-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdpal < %s | FileCheck -check-prefix=GFX1250-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.50-amd-amdpal -global-isel < %s | FileCheck -check-prefix=GFX1250-GISEL %s
