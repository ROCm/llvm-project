...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=verde | FileCheck %s -check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=hawaii | FileCheck %s  -check-prefix=GFX7
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1010 | FileCheck %s -check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1030 | FileCheck %s -check-prefix=GFX1030

; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=verde | FileCheck %s -check-prefix=G_SI
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=hawaii | FileCheck %s  -check-prefix=G_GFX7
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1010 | FileCheck %s -check-prefix=G_GFX10
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1030 | FileCheck %s -check-prefix=G_GFX1030
...
; SI-LABEL: raw_ptr_buffer_atomic_min_noret_f64:
; SI:       ; %bb.0: ; %main_body
...
; SI-NEXT:    s_endpgm
;
; GFX7-LABEL: raw_ptr_buffer_atomic_min_noret_f64:
; GFX7:       ; %bb.0: ; %main_body
; GFX7-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX7-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0xd
; GFX7-NEXT:    s_load_dword s4, s[4:5], 0xf
...
; GFX7-NEXT:    s_endpgm
;
; GFX10-LABEL: raw_ptr_buffer_atomic_min_noret_f64:
...
; GFX1030-NEXT:    s_load_dword s4, s[4:5], 0x3c
; GFX1030-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030-NEXT:    v_mov_b32_e32 v0, s6
; GFX1030-NEXT:    v_mov_b32_e32 v1, s7
; GFX1030-NEXT:    v_mov_b32_e32 v2, s4
...
; G_SI-NEXT:    s_endpgm
;
; G_GFX7-LABEL: raw_ptr_buffer_atomic_min_noret_f64:
...
;
; G_GFX10-LABEL: raw_ptr_buffer_atomic_min_noret_f64:
...
; SI-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; SI:       ; %bb.0: ; %main_body
...
; SI-NEXT:    s_endpgm
;
; GFX7-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; GFX7:       ; %bb.0: ; %main_body
...
; GFX7-NEXT:    s_endpgm
;
; GFX10-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; GFX10:       ; %bb.0: ; %main_body
...
; GFX10-NEXT:    s_endpgm
;
; GFX1030-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; GFX1030:       ; %bb.0: ; %main_body
...
; G_SI-NEXT:    s_endpgm
;
; G_GFX7-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; G_GFX7:       ; %bb.0: ; %main_body
...
; G_GFX7-NEXT:    s_endpgm
;
; G_GFX10-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; G_GFX10:       ; %bb.0: ; %main_body
...
; G_GFX10-NEXT:    s_endpgm
;
; G_GFX1030-LABEL: raw_ptr_buffer_atomic_min_rtn_f64:
; G_GFX1030:       ; %bb.0: ; %main_body
...
define amdgpu_ps void @raw_ptr_buffer_atomic_min_rtn_f64_off4_slc(ptr addrspace(8) inreg %rsrc, double %data, i32 %vindex, ptr addrspace(3) %out) {
; SI-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; SI:       ; %bb.0: ; %main_body
...
; SI-NEXT:    s_endpgm
;
; GFX7-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; GFX7:       ; %bb.0: ; %main_body
...
; GFX7-NEXT:    s_endpgm
;
; GFX10-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; GFX10:       ; %bb.0: ; %main_body
...
; GFX10-NEXT:    s_endpgm
;
; GFX1030-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; GFX1030:       ; %bb.0: ; %main_body
...
; G_SI-NEXT:    s_endpgm
;
; G_GFX7-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; G_GFX7:       ; %bb.0: ; %main_body
...
; G_GFX7-NEXT:    s_endpgm
;
; G_GFX10-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; G_GFX10:       ; %bb.0: ; %main_body
...
; G_GFX10-NEXT:    s_endpgm
;
; G_GFX1030-LABEL: raw_ptr_buffer_atomic_min_rtn_f64_off4_slc:
; G_GFX1030:       ; %bb.0: ; %main_body
...
; SI-LABEL: raw_ptr_buffer_atomic_max_noret_f64:
; SI:       ; %bb.0: ; %main_body
; SI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0xd
; SI-NEXT:    s_load_dword s4, s[4:5], 0xf
...
; SI-NEXT:    s_endpgm
;
; GFX7-LABEL: raw_ptr_buffer_atomic_max_noret_f64:
; GFX7:       ; %bb.0: ; %main_body
; GFX7-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX7-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0xd
; GFX7-NEXT:    s_load_dword s4, s[4:5], 0xf
...
; GFX7-NEXT:    s_endpgm
;
; GFX10-LABEL: raw_ptr_buffer_atomic_max_noret_f64:
; GFX10:       ; %bb.0: ; %main_body
; GFX10-NEXT:    s_clause 0x2
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
...
; G_SI-NEXT:    s_endpgm
;
; G_GFX7-LABEL: raw_ptr_buffer_atomic_max_noret_f64:
; G_GFX7:       ; %bb.0: ; %main_body
; G_GFX7-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0xd
; G_GFX7-NEXT:    s_load_dword s8, s[4:5], 0xf
; G_GFX7-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
...
; G_GFX7-NEXT:    s_endpgm
;
; G_GFX10-LABEL: raw_ptr_buffer_atomic_max_noret_f64:
; G_GFX10:       ; %bb.0: ; %main_body
; G_GFX10-NEXT:    s_clause 0x2
; G_GFX10-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; G_GFX10-NEXT:    s_load_dword s8, s[4:5], 0x3c
...
; SI-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; SI:       ; %bb.0: ; %main_body
...
; SI-NEXT:    s_endpgm
;
; GFX7-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; GFX7:       ; %bb.0: ; %main_body
...
; GFX7-NEXT:    s_endpgm
;
; GFX10-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; GFX10:       ; %bb.0: ; %main_body
...
; GFX10-NEXT:    s_endpgm
;
; GFX1030-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; GFX1030:       ; %bb.0: ; %main_body
...
; G_SI-NEXT:    s_endpgm
;
; G_GFX7-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; G_GFX7:       ; %bb.0: ; %main_body
...
; G_GFX7-NEXT:    s_endpgm
;
; G_GFX10-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; G_GFX10:       ; %bb.0: ; %main_body
...
; G_GFX10-NEXT:    s_endpgm
;
; G_GFX1030-LABEL: raw_ptr_buffer_atomic_max_rtn_f64:
; G_GFX1030:       ; %bb.0: ; %main_body
...
define amdgpu_kernel void @raw_ptr_buffer_atomic_max_rtn_f64_off4_slc(ptr addrspace(8) inreg %rsrc, double %data, i32 %vindex, ptr addrspace(3) %out) {
; SI-LABEL: raw_ptr_buffer_atomic_max_rtn_f64_off4_slc:
; SI:       ; %bb.0: ; %main_body
...
; SI-NEXT:    s_endpgm
;
; GFX7-LABEL: raw_ptr_buffer_atomic_max_rtn_f64_off4_slc:
; GFX7:       ; %bb.0: ; %main_body
