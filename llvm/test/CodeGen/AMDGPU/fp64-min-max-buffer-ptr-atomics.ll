...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu6.01 | FileCheck %s -check-prefix=SI
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu7.01 | FileCheck %s  -check-prefix=GFX7
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 | FileCheck %s -check-prefix=GFX10
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.30 | FileCheck %s -check-prefix=GFX1030
