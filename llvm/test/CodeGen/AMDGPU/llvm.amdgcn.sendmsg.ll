;RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu6.01 < %s | FileCheck --check-prefixes=GCN,SIVI %s
;RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.02 < %s | FileCheck --check-prefixes=GCN,VIPLUS,SIVI %s
;RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck --check-prefixes=GCN,VIPLUS,GFX9 %s
;RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.00 < %s | FileCheck --check-prefixes=GCN,VIPLUS,GFX9 %s
