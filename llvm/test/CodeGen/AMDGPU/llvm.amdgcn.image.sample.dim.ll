...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=VERDE %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX6789 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9 --amdhsa-code-object-version=6 < %s | FileCheck -check-prefixes=GFX6789 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.1 --amdhsa-code-object-version=6 < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11 --amdhsa-code-object-version=6 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu13.10 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13 %s
