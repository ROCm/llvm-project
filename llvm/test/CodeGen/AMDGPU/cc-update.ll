...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck --check-prefix=GFX803 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck --check-prefix=GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa < %s | FileCheck --check-prefix=GFX1010 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefix=GFX1100 %s
