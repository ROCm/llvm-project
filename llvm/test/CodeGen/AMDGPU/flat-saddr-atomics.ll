...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu12.50-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu9.50-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX950,GFX950-SDAG %s
