...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgpu12.50-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgpu9.50-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX950,GFX950-SDAG %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgpu9.50-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX950,GFX950-GISEL %s
...
; GFX1250-SDAG-NEXT:    s_cbranch_scc1 .LBB110_2
...
; GFX950-SDAG-NEXT:    s_cbranch_scc1 .LBB110_2
...
; GFX1250-SDAG-NEXT:    s_cselect_b32 s2, 1, 0
; GFX1250-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX1250-SDAG-NEXT:    s_cbranch_scc1 .LBB111_2
; GFX1250-SDAG-NEXT:  ; %bb.1: ; %atomicrmw.shared
; GFX1250-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1250-SDAG-NEXT:    s_cselect_b32 s0, s0, -1
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1250-SDAG-NEXT:    s_cselect_b32 s2, 1, 0
; GFX1250-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX1250-SDAG-NEXT:    s_cbranch_scc1 .LBB111_4
; GFX1250-SDAG-NEXT:  ; %bb.3: ; %atomicrmw.private
; GFX1250-SDAG-NEXT:    s_sub_co_i32 s2, s0, src_flat_scratch_base_lo
; GFX1250-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1250-SDAG-NEXT:    s_cselect_b32 s0, s2, -1
...
; GFX950-SDAG-NEXT:    s_cselect_b32 s2, 1, 0
; GFX950-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX950-SDAG-NEXT:    s_cbranch_scc1 .LBB111_2
; GFX950-SDAG-NEXT:  ; %bb.1: ; %atomicrmw.shared
; GFX950-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX950-SDAG-NEXT:    s_cselect_b32 s0, s0, -1
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX950-SDAG-NEXT:    s_cselect_b32 s2, 1, 0
; GFX950-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX950-SDAG-NEXT:    s_cbranch_scc1 .LBB111_4
; GFX950-SDAG-NEXT:  ; %bb.3: ; %atomicrmw.private
; GFX950-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX950-SDAG-NEXT:    s_cselect_b32 s0, s0, -1
; GFX950-SDAG-NEXT:    scratch_load_dwordx2 v[2:3], off, s0
...
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX1250-SDAG-NEXT:    s_cbranch_scc1 .LBB113_2
; GFX1250-SDAG-NEXT:  ; %bb.1: ; %atomicrmw.private
; GFX1250-SDAG-NEXT:    s_sub_co_i32 s2, s0, src_flat_scratch_base_lo
; GFX1250-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1250-SDAG-NEXT:    v_max_num_f64_e32 v[0:1], v[0:1], v[0:1]
...
; GFX950-SDAG-NEXT:    s_cselect_b32 s2, 1, 0
; GFX950-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX950-SDAG-NEXT:    s_cbranch_scc1 .LBB113_2
; GFX950-SDAG-NEXT:  ; %bb.1: ; %atomicrmw.private
; GFX950-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX950-SDAG-NEXT:    s_cselect_b32 s0, s0, -1
; GFX950-SDAG-NEXT:    scratch_load_dwordx2 v[2:3], off, s0
...
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX1250-SDAG-NEXT:    s_cbranch_scc1 .LBB115_2
; GFX1250-SDAG-NEXT:  ; %bb.1: ; %atomicrmw.private
; GFX1250-SDAG-NEXT:    s_sub_co_i32 s2, s0, src_flat_scratch_base_lo
; GFX1250-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1250-SDAG-NEXT:    v_max_num_f64_e32 v[0:1], v[0:1], v[0:1]
...
; GFX950-SDAG-NEXT:    s_cselect_b32 s2, 1, 0
; GFX950-SDAG-NEXT:    s_cmp_lg_u32 s2, 1
; GFX950-SDAG-NEXT:    s_cbranch_scc1 .LBB115_2
; GFX950-SDAG-NEXT:  ; %bb.1: ; %atomicrmw.private
; GFX950-SDAG-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX950-SDAG-NEXT:    s_cselect_b32 s0, s0, -1
; GFX950-SDAG-NEXT:    scratch_load_dwordx2 v[2:3], off, s0
