...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu12.00 -mattr=+real-true16 < %s | FileCheck -check-prefixes=ASM-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu12.00 -mattr=-real-true16 < %s | FileCheck -check-prefixes=ASM-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.00 -mattr=+real-true16 < %s | FileCheck -check-prefixes=ASM-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.00 -mattr=-real-true16 < %s | FileCheck -check-prefixes=ASM-GISEL-FAKE16 %s
...
; ASM-GISEL-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v1
; ASM-GISEL-TRUE16-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; ASM-GISEL-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-TRUE16-NEXT:    s_xor_b32 exec_lo, s0, exec_lo
; ASM-GISEL-TRUE16-NEXT:    ; divergent control-flow edge
; ASM-GISEL-TRUE16-NEXT:    s_cbranch_execz .LBB0_2
; ASM-GISEL-TRUE16-NEXT:  .LBB0_1: ; %if.then
...
; ASM-GISEL-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v1
; ASM-GISEL-FAKE16-NEXT:    s_xor_b32 s0, vcc_lo, exec_lo
; ASM-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-FAKE16-NEXT:    s_xor_b32 exec_lo, s0, exec_lo
; ASM-GISEL-FAKE16-NEXT:    ; divergent control-flow edge
; ASM-GISEL-FAKE16-NEXT:    s_cbranch_execz .LBB0_2
; ASM-GISEL-FAKE16-NEXT:  .LBB0_1: ; %if.then
...
; ASM-GISEL-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
; ASM-GISEL-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-TRUE16-NEXT:    s_xor_b32 s0, vcc_lo, s0
; ASM-GISEL-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-TRUE16-NEXT:    s_xor_b32 s1, s0, exec_lo
; ASM-GISEL-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-TRUE16-NEXT:    s_mov_b32 exec_lo, s1
; ASM-GISEL-TRUE16-NEXT:    ; divergent control-flow edge
; ASM-GISEL-TRUE16-NEXT:    s_cbranch_execz .LBB1_2
; ASM-GISEL-TRUE16-NEXT:  .LBB1_1: ; %if.then
...
; ASM-GISEL-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
; ASM-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-FAKE16-NEXT:    s_xor_b32 s0, vcc_lo, s0
; ASM-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-FAKE16-NEXT:    s_xor_b32 s1, s0, exec_lo
; ASM-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-FAKE16-NEXT:    s_mov_b32 exec_lo, s1
; ASM-GISEL-FAKE16-NEXT:    ; divergent control-flow edge
; ASM-GISEL-FAKE16-NEXT:    s_cbranch_execz .LBB1_2
; ASM-GISEL-FAKE16-NEXT:  .LBB1_1: ; %if.then
...
; ASM-GISEL-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v32
; ASM-GISEL-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-TRUE16-NEXT:    s_xor_b32 s0, vcc_lo, s0
; ASM-GISEL-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-TRUE16-NEXT:    s_xor_b32 exec_lo, s0, exec_lo
...
; ASM-GISEL-TRUE16-NEXT:  .LBB2_1: ; %if.then
...
; ASM-GISEL-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v32
; ASM-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-FAKE16-NEXT:    s_xor_b32 s0, vcc_lo, s0
; ASM-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-GISEL-FAKE16-NEXT:    s_xor_b32 exec_lo, s0, exec_lo
...
; ASM-GISEL-FAKE16-NEXT:  .LBB2_1: ; %if.then
...
; ASM-GISEL-TRUE16-NEXT:  .LBB3_1: ; %if.then
...
; ASM-GISEL-FAKE16-NEXT:  .LBB3_1: ; %if.then
