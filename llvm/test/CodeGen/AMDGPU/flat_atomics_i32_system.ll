...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.04 < %s | FileCheck -check-prefixes=GCN1 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefixes=GCN2 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GCN3 %s
...
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GCN1-NEXT:    s_xor_b64 s[38:39], vcc, exec
; GCN1-NEXT:    s_xor_b64 s[40:41], exec, s[38:39]
; GCN1-NEXT:    v_mov_b32_e32 v1, v0
; GCN1-NEXT:    s_or_b64 s[36:37], s[36:37], s[40:41]
; GCN1-NEXT:    s_mov_b64 exec, s[38:39]
; GCN1-NEXT:    ; divergent control-flow edge
...
; GCN2-NEXT:    buffer_wbinvl1_vol
; GCN2-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GCN2-NEXT:    s_xor_b64 s[38:39], vcc, exec
; GCN2-NEXT:    s_xor_b64 s[40:41], exec, s[38:39]
; GCN2-NEXT:    v_mov_b32_e32 v1, v0
; GCN2-NEXT:    s_or_b64 s[36:37], s[36:37], s[40:41]
; GCN2-NEXT:    s_mov_b64 exec, s[38:39]
; GCN2-NEXT:    ; divergent control-flow edge
...
; GCN1-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
...
; GCN2-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
...
; GCN3-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
...
; GCN1-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GCN1-NEXT:    v_mov_b32_e32 v1, v0
; GCN1-NEXT:    s_or_b64 s[2:3], s[2:3], s[8:9]
; GCN1-NEXT:    s_mov_b64 exec, s[6:7]
; GCN1-NEXT:    ; divergent control-flow edge
...
; GCN2-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; GCN2-NEXT:    v_mov_b32_e32 v1, v0
; GCN2-NEXT:    s_or_b64 s[2:3], s[2:3], s[8:9]
; GCN2-NEXT:    s_mov_b64 exec, s[6:7]
; GCN2-NEXT:    ; divergent control-flow edge
...
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    s_or_b64 s[2:3], s[2:3], s[8:9]
...
; GCN1-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GCN1-NEXT:    s_xor_b64 s[34:35], vcc, exec
; GCN1-NEXT:    s_xor_b64 s[40:41], exec, s[34:35]
; GCN1-NEXT:    v_mov_b32_e32 v1, v0
; GCN1-NEXT:    s_or_b64 s[38:39], s[38:39], s[40:41]
; GCN1-NEXT:    s_mov_b64 exec, s[34:35]
; GCN1-NEXT:    ; divergent control-flow edge
...
; GCN2-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GCN2-NEXT:    s_xor_b64 s[34:35], vcc, exec
; GCN2-NEXT:    s_xor_b64 s[40:41], exec, s[34:35]
; GCN2-NEXT:    v_mov_b32_e32 v1, v0
; GCN2-NEXT:    s_or_b64 s[38:39], s[38:39], s[40:41]
; GCN2-NEXT:    s_mov_b64 exec, s[34:35]
; GCN2-NEXT:    ; divergent control-flow edge
