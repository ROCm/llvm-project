...
; GCN-NOHSA-SI-NEXT:    s_addc_u32 s13, s13, 0
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(7)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v7, 16, v21
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v5, 16, v20
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v6, v21, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v4, v20, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(3)
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s16, s7, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s17, s7, 16
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s30, s7, 31
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s28, s5, 31
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[14:17], off, s[0:3], 0 offset:16
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[27:30], off, s[0:3], 0 offset:32
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[31:34], off, s[0:3], 0 offset:48
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[66:67], s[18:19], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s23, 16
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s22, v2
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s23, 31
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(2)
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s19, 16
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s26, v6
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s38, s19
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s40, s27
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s42, s25
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[70:71], s[10:11], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s41, s37, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s43, s31, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s18
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s19, 31
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s24, v4
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s30, v10
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s44, s31
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s52, s22, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[64:65], s[26:27], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s45, s31, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[42:43], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s18
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s42, s27, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s27, s27, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[40:41], 0x100000
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s29, v9
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s60, s30, 16
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[44:45], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s44, s25, 31
...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s28, v8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s46, s29
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s48, s37
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s28, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[28:29], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s38, s29, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s39, s29, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[28:29], s[46:47], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s50, s35
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s36, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[36:37], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s37, 31
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[36:37], s[48:49], 0x100000
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:112
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s56, s26, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s58, s24, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s62, s34, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[34:35], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s24, s35, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s26, s35, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[50:51], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x100000
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:224
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x100000
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:192
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[62:63], 0x100000
