...
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.0a < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.0a < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A-GISEL %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.42 < %s | FileCheck -enable-var-scope --check-prefixes=GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.42 < %s | FileCheck -enable-var-scope --check-prefixes=GFX942-GISEL %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.0a -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A-VGPR %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.0a -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A-VGPR-GISEL %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.42 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefixes=GFX942-VGPR %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.42 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefixes=GFX942-VGPR-GISEL %s
