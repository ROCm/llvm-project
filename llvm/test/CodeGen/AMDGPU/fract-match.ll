...
; GFX6-NEXT:    v_cndmask_b32_e32 v1, v4, v0, vcc
...
; GFX6-NEXT:    v_cndmask_b32_e32 v3, v8, v2, vcc
; GFX6-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX6-NEXT:    v_cndmask_b32_e32 v4, v9, v0, vcc
; GFX6-NEXT:    v_cmp_class_f32_e32 vcc, v0, v10
; GFX6-NEXT:    v_cndmask_b32_e64 v0, v4, 0, vcc
; GFX6-NEXT:    v_cmp_class_f32_e32 vcc, v2, v10
; GFX6-NEXT:    v_cndmask_b32_e64 v2, v3, 0, vcc
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-NEXT:    v_cndmask_b32_e32 v2, v7, v1, vcc
; GFX6-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX6-NEXT:    v_cndmask_b32_e32 v3, v6, v0, vcc
...
; GFX7-NEXT:    v_cndmask_b32_e32 v2, v7, v1, vcc
; GFX7-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX7-NEXT:    v_cndmask_b32_e32 v3, v6, v0, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v7, v1, vcc
; GFX8-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v6, v0, vcc
...
; GFX6-NEXT:    buffer_store_dword v3, v[1:2], s[4:7], 0 addr64
; GFX6-NEXT:    v_cndmask_b32_e32 v1, v0, v4, vcc
; GFX6-NEXT:    v_cmp_neq_f32_e64 vcc, |v0|, s8
; GFX6-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    v_mov_b32_e32 v8, 0x204
; GFX6-NEXT:    buffer_store_dwordx2 v[4:5], v[2:3], s[4:7], 0 addr64
; GFX6-NEXT:    v_cndmask_b32_e32 v2, v6, v1, vcc
; GFX6-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX6-NEXT:    v_cndmask_b32_e32 v3, v7, v0, vcc
; GFX6-NEXT:    v_cmp_class_f32_e32 vcc, v0, v8
; GFX6-NEXT:    v_cndmask_b32_e64 v0, v3, 0, vcc
; GFX6-NEXT:    v_cmp_class_f32_e32 vcc, v1, v8
; GFX6-NEXT:    v_cndmask_b32_e64 v1, v2, 0, vcc
...
; GFX6-NEXT:    v_bfe_u32 v10, v0, 16, 15
...
; GFX7-NEXT:    v_bfe_u32 v10, v0, 16, 15
...
; GFX6-NEXT:    s_mov_b32 s8, 0x7f800000
; GFX6-NEXT:    buffer_store_dword v3, v[1:2], s[4:7], 0 addr64
; GFX6-NEXT:    v_cndmask_b32_e32 v1, v6, v5, vcc
; GFX6-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
...
; GFX6-NEXT:    v_mov_b32_e32 v2, gv@abs32@lo
; GFX6-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
