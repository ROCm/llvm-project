...
; GCN-NEXT:    buffer_load_dwordx4 v[0:3], v[4:5], s[8:11], 0 addr64
...
; GCN-NEXT:    s_addc_u32 s2, s14, s6
; GCN-NEXT:    s_addc_u32 s3, s15, s7
...
; GCN-NEXT:    s_addc_u32 s2, s6, s14
; GCN-NEXT:    s_addc_u32 s3, s7, s15
; GCN-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NEXT:    v_mov_b32_e32 v2, s2
; GCN-NEXT:    v_mov_b32_e32 v3, s3
...
; GCN-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0xb
; GCN-NEXT:    s_mov_b32 s11, 0xf000
; GCN-NEXT:    s_mov_b32 s10, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_add_u32 s0, s0, s4
; GCN-NEXT:    s_addc_u32 s1, s1, s5
; GCN-NEXT:    s_addc_u32 s2, s2, s6
; GCN-NEXT:    s_addc_u32 s3, s3, s7
; GCN-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NEXT:    v_mov_b32_e32 v2, s2
; GCN-NEXT:    v_mov_b32_e32 v3, s3
