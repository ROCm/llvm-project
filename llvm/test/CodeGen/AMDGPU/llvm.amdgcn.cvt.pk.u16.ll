...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefixes=SI-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefixes=SI-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu7.04 < %s | FileCheck %s -check-prefixes=SI-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu7.04 < %s | FileCheck %s -check-prefixes=SI-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck %s -check-prefixes=VI,VI-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck %s -check-prefixes=VI,VI-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s -check-prefixes=GFX9,GFX9-SDAG
