...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -amdgpu-sdwa-peephole=0 < %s | FileCheck %s --check-prefixes=VI
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 < %s | FileCheck %s --check-prefixes=VI-SDWA
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.04 < %s | FileCheck %s --check-prefixes=CI
