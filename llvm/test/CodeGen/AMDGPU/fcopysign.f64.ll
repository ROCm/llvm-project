...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=SIVI,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=SIVI,VI %s
...
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    v_mov_b32_e32 v2, s2
; SI-NEXT:    buffer_store_dwordx2 v[4:5], off, s[16:19], 0 offset:16
...
; SI-NEXT:    v_bfi_b32 v7, s8, v0, v2
; SI-NEXT:    v_mov_b32_e32 v0, s5
; SI-NEXT:    v_mov_b32_e32 v2, s13
; SI-NEXT:    v_bfi_b32 v5, s8, v0, v2
; SI-NEXT:    v_mov_b32_e32 v4, s4
