...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -check-prefix=GFX6-NOHSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn--amdhsa -mcpu=kaveri < %s | FileCheck -check-prefix=GFX7-HSA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefix=GFX8-NOHSA %s
; RUN: llc -mtriple=r600 -mcpu=redwood < %s | FileCheck -check-prefix=EG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-FAKE16 %s
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s4, s2
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s3
; GFX6-NOHSA-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, s6
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s7
; GFX6-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NOHSA-NEXT:    buffer_store_byte v0, off, s[0:3], 0
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s4, s2
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s3
; GFX6-NOHSA-NEXT:    buffer_load_ushort v0, off, s[4:7], 0
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, s6
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s7
; GFX6-NOHSA-NEXT:    s_waitcnt vmcnt(0)
...
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s0, s2, 16
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s0
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s2
; GFX6-NOHSA-NEXT:    buffer_store_byte v1, off, s[4:7], 0 offset:2
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-HSA-NEXT:    s_add_u32 s4, s0, 2
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s0, 2
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX6-NOHSA:       ; %bb.0: ; %entry
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX6-NOHSA-NEXT:    s_mov_b32 s4, 0xf000
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dword s6, s[2:3], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, s5
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s4
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA:       ; %bb.0: ; %entry
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX6-NOHSA-NEXT:    s_mov_b32 s6, 0xf000
; GFX6-NOHSA-NEXT:    s_mov_b32 s7, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, s7
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s6
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA:       ; %bb.0: ; %entry
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX6-NOHSA-NEXT:    s_mov_b32 s8, 0xf000
; GFX6-NOHSA-NEXT:    s_mov_b32 s9, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, s9
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s8
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s4
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s5
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s4, s2
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s3
; GFX6-NOHSA-NEXT:    buffer_load_sbyte v0, off, s[4:7], 0
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, s6
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s7
; GFX6-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NOHSA-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; GFX6-NOHSA-NEXT:    s_and_b32 s1, s2, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s2, s2, 0x80010
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s2
; GFX6-NOHSA-NEXT:    buffer_store_dword v0, off, s[4:7], 0 offset:8
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_bfe_i32 s0, s2, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s1, s2
; GFX6-NOHSA-NEXT:    s_bfe_i32 s2, s2, 0x80010
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s2
; GFX6-NOHSA-NEXT:    buffer_store_dword v0, off, s[4:7], 0 offset:8
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s1
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s0, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s1, s2, 0x80008
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s0
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s2, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s3, s2, 0x80008
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s8, s3, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s9, s3, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s11, s3, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s3, s3, 0x80010
; GFX6-NOHSA-NEXT:    s_lshr_b32 s0, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s1, s2, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s10, s2, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s2, s2, 0x80010
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_ashr_i32 s9, s3, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s10, s3, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s11, s3, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s3, s3
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s2, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s8, s2, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s2, s2
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s3
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s14, s11, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s15, s11, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s19, s11, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s11, s11, 0x80010
; GFX6-NOHSA-NEXT:    s_lshr_b32 s12, s10, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s13, s10, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s18, s10, 0xff
...
; GFX6-NOHSA-NEXT:    s_lshr_b32 s2, s9, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s3, s9, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s17, s9, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s9, s9, 0x80010
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:48
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s18
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s13
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s10
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s12
; GFX6-NOHSA-NEXT:    s_lshr_b32 s0, s8, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s1, s8, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s16, s8, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s8, s8, 0x80010
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:32
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_ashr_i32 s17, s11, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s18, s11, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s19, s11, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s11, s11
; GFX6-NOHSA-NEXT:    s_ashr_i32 s14, s10, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s15, s10, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s16, s10, 0x80008
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s8, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s8, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s2, s8, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s3, s8
; GFX6-NOHSA-NEXT:    s_ashr_i32 s8, s9, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s12, s9, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s13, s9, 0x80008
...
; GFX12-NEXT:    s_sext_i32_i8 s27, s9
; GFX12-NEXT:    v_dual_mov_b32 v4, s10 :: v_dual_mov_b32 v7, s28
; GFX12-NEXT:    s_bfe_i32 s9, s9, 0x80008
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v6, s29 :: v_dual_mov_b32 v9, s9
...
; GFX12-NEXT:    v_dual_mov_b32 v8, s27 :: v_dual_mov_b32 v11, s25
...
; GFX6-NOHSA-NEXT:    s_and_b32 s63, s10, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s10, s10, 0x80010
...
; GFX6-NOHSA-NEXT:    s_and_b32 s62, s9, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s9, s9, 0x80010
; GFX6-NOHSA-NEXT:    s_and_b32 s64, s11, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s11, s11, 0x80010
; GFX6-NOHSA-NEXT:    s_and_b32 s65, s12, 0xff
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:240
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_and_b32 s61, s8, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s8, s8, 0x80010
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:224
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[16:19], 0 offset:208
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[16:19], 0 offset:192
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[16:19], 0 offset:176
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:160
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_and_b32 s60, s7, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s7, s7, 0x80010
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:144
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_and_b32 s59, s6, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s6, s6, 0x80010
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:128
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_and_b32 s58, s5, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s5, s5, 0x80010
...
; GFX6-NOHSA-NEXT:    s_and_b32 s57, s4, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s4, s4, 0x80010
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s5
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s30
; GFX6-NOHSA-NEXT:    s_lshr_b32 s26, s3, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s27, s3, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s56, s3, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s3, s3, 0x80010
...
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s56
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s27
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s3
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s26
; GFX6-NOHSA-NEXT:    s_lshr_b32 s22, s1, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s23, s1, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s54, s1, 0xff
...
; GFX6-NOHSA-NEXT:    s_bfe_u32 s21, s0, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s53, s0, 0xff
...
; GFX7-HSA-NEXT:    s_lshr_b32 s24, s3, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s25, s3, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s26, s4, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s27, s4, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s28, s5, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s29, s5, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s30, s6, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s31, s6, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s33, s7, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s34, s7, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s35, s8, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s36, s8, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s37, s9, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s38, s9, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s39, s10, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s40, s10, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s41, s11, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s42, s11, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s43, s12, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s44, s12, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s45, s13, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s46, s13, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s47, s14, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s48, s14, 0x80008
; GFX7-HSA-NEXT:    s_lshr_b32 s49, s15, 24
; GFX7-HSA-NEXT:    s_bfe_u32 s50, s15, 0x80008
; GFX7-HSA-NEXT:    s_and_b32 s51, s0, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s52, s0, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s53, s1, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s54, s1, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s55, s2, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s56, s2, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s57, s3, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s58, s3, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s59, s4, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s60, s4, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s61, s5, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s62, s5, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s63, s6, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s64, s6, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s4, s7, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s6, s7, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s2, s8, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s5, s8, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s3, s9, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s7, s9, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s8, s10, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s9, s10, 0x80010
; GFX7-HSA-NEXT:    s_and_b32 s10, s11, 0xff
; GFX7-HSA-NEXT:    s_bfe_u32 s11, s11, 0x80010
...
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0xf0
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0xe0
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0xd0
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0xc0
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0xb0
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0xa0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s66
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s46
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s13
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s45
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s67
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s47
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[20:23]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0x90
...
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[12:15]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[24:27]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s7
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s63
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s33
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s6
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 0x50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s3
; GFX7-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[20:23]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[24:25], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s38
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s37
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s2
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s5
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s1
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s36
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s35
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s4
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[16:19]
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s27
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 32
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GFX7-HSA-NEXT:    s_add_u32 s0, s16, 16
...
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s53
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s21
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s54
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s20
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s16
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s51
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s19
...
; GFX8-NOHSA-NEXT:    s_lshr_b32 s27, s4, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s28, s4, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s29, s5, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s30, s5, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s31, s6, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s33, s6, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s34, s7, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s35, s7, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s36, s8, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s37, s8, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s38, s9, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s39, s9, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s40, s10, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s41, s10, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s42, s11, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s43, s11, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s44, s12, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s45, s12, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s46, s13, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s47, s13, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s48, s14, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s49, s14, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s50, s15, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s51, s15, 0x80008
; GFX8-NOHSA-NEXT:    s_and_b32 s24, s0, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s0, s0, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s52, s1, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s1, s1, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s53, s2, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s54, s2, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s55, s3, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s56, s3, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s57, s4, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s4, s4, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s58, s5, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s5, s5, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s59, s6, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s6, s6, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s60, s7, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s7, s7, 0x80010
...
; GFX8-NOHSA-NEXT:    s_and_b32 s2, s15, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s3, s15, 0x80010
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0xf0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s3
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0xe0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s51
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s50
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0xd0
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0xc0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s66
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s47
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s13
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s46
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0xb0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s65
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s45
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s12
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s44
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0xa0
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0x90
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s63
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s41
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s10
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s40
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0x80
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s62
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s39
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s9
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s38
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0x70
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0x60
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 0x50
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 64
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s16, 48
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s53
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s23
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s51, s10, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s52, s10, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s53, s10, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s10, s10
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s48, s9, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s49, s9, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s50, s9, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s9, s9
; GFX6-NOHSA-NEXT:    s_ashr_i32 s54, s11, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s55, s11, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s56, s11, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s11, s11
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s51
; GFX6-NOHSA-NEXT:    s_ashr_i32 s45, s8, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s46, s8, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s47, s8, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s8, s8
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s56
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s55
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s42, s7, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s43, s7, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s44, s7, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s7, s7
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:144
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s47
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s46
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s45
; GFX6-NOHSA-NEXT:    s_ashr_i32 s39, s6, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s40, s6, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s41, s6, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s6, s6
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:128
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s7
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s36, s5, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s37, s5, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s38, s5, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s5, s5
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:112
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s6
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s39
; GFX6-NOHSA-NEXT:    s_ashr_i32 s33, s4, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s34, s4, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s35, s4, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s4, s4
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:96
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s5
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s38
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s37
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s36
; GFX6-NOHSA-NEXT:    s_ashr_i32 s29, s3, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s30, s3, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s31, s3, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s3, s3
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:80
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s23, s1, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s24, s1, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s25, s1, 0x80008
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s26
; GFX6-NOHSA-NEXT:    s_ashr_i32 s20, s0, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s21, s0, 0x80010
; GFX6-NOHSA-NEXT:    s_bfe_i32 s22, s0, 0x80008
...
; GFX7-HSA-NEXT:    s_ashr_i32 s28, s3, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s29, s3, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s30, s3, 0x80008
; GFX7-HSA-NEXT:    s_ashr_i32 s33, s4, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s34, s4, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s35, s4, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s36, s4
; GFX7-HSA-NEXT:    s_ashr_i32 s37, s5, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s38, s5, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s39, s5, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s40, s5
; GFX7-HSA-NEXT:    s_ashr_i32 s41, s6, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s42, s6, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s43, s6, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s44, s6
; GFX7-HSA-NEXT:    s_ashr_i32 s45, s7, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s46, s7, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s47, s7, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s6, s7
; GFX7-HSA-NEXT:    s_ashr_i32 s7, s8, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s48, s8, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s49, s8, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s4, s8
; GFX7-HSA-NEXT:    s_ashr_i32 s5, s9, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s8, s9, 0x80010
...
; GFX7-HSA-NEXT:    s_sext_i32_i8 s27, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0xf0
; GFX7-HSA-NEXT:    s_sext_i32_i8 s31, s3
; GFX7-HSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0xe0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0xd0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0xc0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0xb0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s3
; GFX7-HSA-NEXT:    s_sext_i32_i8 s13, s13
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0xa0
; GFX7-HSA-NEXT:    s_sext_i32_i8 s14, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s13
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s62
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s61
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s60
; GFX7-HSA-NEXT:    s_addc_u32 s3, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s65
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s63
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[20:23]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s4
; GFX7-HSA-NEXT:    s_add_u32 s4, s16, 0x90
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[10:11], v[16:19]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s6
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s5
; GFX7-HSA-NEXT:    s_addc_u32 s5, s17, 0
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s9
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    s_addc_u32 s9, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    s_sext_i32_i8 s10, s10
; GFX7-HSA-NEXT:    s_sext_i32_i8 s11, s11
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s15
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s68
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s67
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s66
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 0x60
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[24:25], v[12:15]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s10
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s11
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s56
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s55
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s54
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s53
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s7
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s49
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s6
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[16:19]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[8:11]
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s16, 48
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s30
...
; GFX8-NOHSA-NEXT:    s_sext_i32_i8 s34, s4
; GFX8-NOHSA-NEXT:    s_ashr_i32 s35, s5, 24
; GFX8-NOHSA-NEXT:    s_bfe_i32 s36, s5, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_i32 s37, s5, 0x80008
; GFX8-NOHSA-NEXT:    s_sext_i32_i8 s38, s5
; GFX8-NOHSA-NEXT:    s_ashr_i32 s39, s6, 24
; GFX8-NOHSA-NEXT:    s_bfe_i32 s40, s6, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_i32 s41, s6, 0x80008
; GFX8-NOHSA-NEXT:    s_ashr_i32 s42, s7, 24
; GFX8-NOHSA-NEXT:    s_bfe_i32 s43, s7, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_i32 s44, s7, 0x80008
...
; GFX8-NOHSA-NEXT:    s_ashr_i32 s4, s15, 24
; GFX8-NOHSA-NEXT:    s_bfe_i32 s5, s15, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_i32 s66, s15, 0x80008
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s4
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0xf0
...
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0xe0
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0xd0
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0xc0
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0xb0
; GFX8-NOHSA-NEXT:    s_sext_i32_i8 s11, s11
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    s_addc_u32 s5, s17, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0xa0
; GFX8-NOHSA-NEXT:    s_sext_i32_i8 s10, s10
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    s_addc_u32 s5, s17, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0x90
; GFX8-NOHSA-NEXT:    s_sext_i32_i8 s9, s9
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    s_addc_u32 s5, s17, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s48
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s16, 0x80
; GFX8-NOHSA-NEXT:    s_sext_i32_i8 s8, s8
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    s_addc_u32 s5, s17, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s4
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s43
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s42
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
...
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s0, s2, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s8, s2, 24
; GFX6-NOHSA-NEXT:    s_lshr_b32 s10, s2, 8
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s4, s0
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s1, s3, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s8, s3, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s11, s3, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s3, s3, 0x80010
; GFX6-NOHSA-NEXT:    s_lshr_b32 s0, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s9, s2, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s10, s2, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s2, s2, 0x80010
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s3
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s1
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, 0
; GFX6-NOHSA-NEXT:    s_mov_b32 s9, s5
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s4, s7, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s8, s7, 8
; GFX6-NOHSA-NEXT:    s_mov_b32 s10, s7
; GFX6-NOHSA-NEXT:    s_mov_b32 s11, s5
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s6, s7, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s7, s7, 24
...
; GFX8-NOHSA-NEXT:    s_mov_b32 s9, s5
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NOHSA-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x0
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-NEXT:    s_ashr_i32 s9, s3, 24
...
; GFX12-NEXT:    s_ashr_i32 s2, s3, 31
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v2, s9 :: v_dual_mov_b32 v5, s17
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v3, s2
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[8:11], s[6:7], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s0, s4
; GFX6-NOHSA-NEXT:    s_mov_b32 s1, s5
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_lshr_b32 s7, s10, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s12, s10, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s19, s10, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s10, s10, 0x80010
; GFX6-NOHSA-NEXT:    s_lshr_b32 s6, s11, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s13, s11, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s18, s11, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s11, s11, 0x80010
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s10
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s7
; GFX6-NOHSA-NEXT:    s_lshr_b32 s5, s8, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s14, s8, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s17, s8, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s8, s8, 0x80010
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:80
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s11
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s6
; GFX6-NOHSA-NEXT:    s_lshr_b32 s4, s9, 24
; GFX6-NOHSA-NEXT:    s_bfe_u32 s15, s9, 0x80008
; GFX6-NOHSA-NEXT:    s_and_b32 s16, s9, 0xff
; GFX6-NOHSA-NEXT:    s_bfe_u32 s9, s9, 0x80010
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:112
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s8
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s21, s9
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s16
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s17
; GFX6-NOHSA-NEXT:    s_mov_b32 s23, s9
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:80
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s36
...
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x0
; GFX7-HSA-NEXT:    s_mov_b32 s3, 0
; GFX7-HSA-NEXT:    s_mov_b32 s9, s3
; GFX7-HSA-NEXT:    s_mov_b32 s17, s3
; GFX7-HSA-NEXT:    s_mov_b32 s19, s3
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_lshr_b32 s2, s7, 16
; GFX7-HSA-NEXT:    s_bfe_i64 s[26:27], s[2:3], 0x80000
; GFX7-HSA-NEXT:    s_lshr_b32 s8, s7, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s10, s6, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s12, s6, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s14, s6, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s16, s5, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s18, s5, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s20, s4, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s22, s4, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s24, s4, 8
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s27
; GFX7-HSA-NEXT:    s_bfe_i64 s[2:3], s[4:5], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[26:27], s[6:7], 0x80000
; GFX7-HSA-NEXT:    s_mov_b32 s4, s5
; GFX7-HSA-NEXT:    s_mov_b32 s6, s7
...
; GFX7-HSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GFX7-HSA-NEXT:    s_add_u32 s28, s0, 0x70
; GFX7-HSA-NEXT:    s_addc_u32 s29, s1, 0
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s9
...
; GFX8-NOHSA-NEXT:    s_mov_b32 s23, s11
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NOHSA-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x0
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NOHSA-NEXT:    s_lshr_b32 s28, s4, 16
; GFX8-NOHSA-NEXT:    s_lshr_b32 s30, s4, 24
...
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[4:5], s[22:23], 0x80000
...
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX8-NOHSA-NEXT:    s_ashr_i32 s22, s7, 31
; GFX8-NOHSA-NEXT:    s_ashr_i32 s23, s7, 24
...
; GFX12-NEXT:    s_mov_b32 s26, s7
; GFX12-NEXT:    s_lshr_b32 s12, s6, 16
; GFX12-NEXT:    s_lshr_b32 s14, s6, 24
; GFX12-NEXT:    s_lshr_b32 s16, s6, 8
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[6:7], 0x80000
; GFX12-NEXT:    s_ashr_i32 s6, s7, 31
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x80000
; GFX12-NEXT:    s_ashr_i32 s7, s7, 24
; GFX12-NEXT:    s_ashr_i32 s13, s5, 31
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s3
; GFX12-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, s6
; GFX12-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v5, s27
; GFX12-NEXT:    s_ashr_i32 s15, s5, 24
; GFX12-NEXT:    v_dual_mov_b32 v4, s26 :: v_dual_mov_b32 v7, s11
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[12:13], 0x80000
; GFX12-NEXT:    v_mov_b32_e32 v6, s10
; GFX12-NEXT:    s_lshr_b32 s8, s5, 16
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[14:15], 0x80000
...
; GFX12-NEXT:    v_dual_mov_b32 v1, s7 :: v_dual_mov_b32 v2, s2
...
; GFX12-NEXT:    v_dual_mov_b32 v4, s30 :: v_dual_mov_b32 v7, s17
; GFX12-NEXT:    v_dual_mov_b32 v6, s16 :: v_dual_mov_b32 v9, s9
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v8, s8 :: v_dual_mov_b32 v11, s13
; GFX12-NEXT:    v_dual_mov_b32 v10, s15 :: v_dual_mov_b32 v13, s29
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v12, s28 :: v_dual_mov_b32 v15, s19
; GFX12-NEXT:    v_dual_mov_b32 v14, s18 :: v_dual_mov_b32 v17, s21
; GFX12-NEXT:    v_dual_mov_b32 v16, s20 :: v_dual_mov_b32 v19, s23
; GFX12-NEXT:    v_dual_mov_b32 v18, s22 :: v_dual_mov_b32 v21, s5
; GFX12-NEXT:    v_dual_mov_b32 v20, s4 :: v_dual_mov_b32 v23, s25
; GFX12-NEXT:    v_mov_b32_e32 v22, s24
; GFX12-NEXT:    s_clause 0x5
...
; GFX7-HSA-NEXT:    s_bfe_u32 s10, s10, 0x80010
; GFX7-HSA-NEXT:    s_bfe_u32 s11, s11, 0x80010
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0xf0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0xd0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0xb0
; GFX7-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0x90
; GFX7-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0x70
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s12
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0xc0
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0xa0
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 0x80
...
; GFX8-NOHSA-NEXT:    s_lshr_b32 s2, s11, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s15, s11, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s16, s10, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s17, s10, 0x80008
; GFX8-NOHSA-NEXT:    s_bfe_u32 s18, s9, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s19, s8, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s20, s8, 0x80008
; GFX8-NOHSA-NEXT:    s_bfe_u32 s21, s7, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s22, s6, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s23, s6, 0x80008
; GFX8-NOHSA-NEXT:    s_bfe_u32 s24, s5, 0x80008
; GFX8-NOHSA-NEXT:    s_lshr_b32 s25, s4, 24
; GFX8-NOHSA-NEXT:    s_bfe_u32 s26, s4, 0x80008
; GFX8-NOHSA-NEXT:    s_and_b32 s27, s4, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s4, s4, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s28, s5, 0xff
; GFX8-NOHSA-NEXT:    s_and_b32 s29, s6, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s6, s6, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s30, s7, 0xff
; GFX8-NOHSA-NEXT:    s_and_b32 s31, s8, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s8, s8, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s33, s9, 0xff
; GFX8-NOHSA-NEXT:    s_and_b32 s34, s10, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s10, s10, 0x80010
; GFX8-NOHSA-NEXT:    s_and_b32 s35, s11, 0xff
; GFX8-NOHSA-NEXT:    s_bfe_u32 s5, s5, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_u32 s7, s7, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_u32 s9, s9, 0x80010
; GFX8-NOHSA-NEXT:    s_bfe_u32 s3, s11, 0x80010
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0xf0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s3
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0xb0
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0xe0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s5
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s12
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0xd0
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0xc0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s10
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s16
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0xa0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s34
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0x90
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s33
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s18
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 0x80
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s8
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s19
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s27, s25
; GFX6-NOHSA-NEXT:    s_mov_b32 s23, s25
; GFX6-NOHSA-NEXT:    s_mov_b32 s37, s25
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s19, s25
; GFX6-NOHSA-NEXT:    s_mov_b32 s21, s25
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[10:11], s[24:25], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[30:31], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[36:37], 0x80000
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s22
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s23
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s15
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v19, s13
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX6-NOHSA-NEXT:    s_lshr_b32 s18, s3, 16
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[8:11], 0 offset:208
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[8:11], 0 offset:192
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[8:11], 0 offset:176
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s14
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s15
; GFX6-NOHSA-NEXT:    s_lshr_b32 s20, s3, 8
; GFX6-NOHSA-NEXT:    s_ashr_i32 s43, s3, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s49, s3, 24
; GFX6-NOHSA-NEXT:    s_mov_b32 s6, s3
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s16
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s17
; GFX6-NOHSA-NEXT:    s_lshr_b32 s38, s2, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s40, s2, 24
; GFX6-NOHSA-NEXT:    s_ashr_i32 s39, s1, 24
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[38:39], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[24:25], s[42:43], 0x80000
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s26, s1
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[36:37], s[46:47], 0x80000
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s33
; GFX6-NOHSA-NEXT:    s_lshr_b32 s52, s0, 8
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[30:31], s[50:51], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[34:35], s[48:49], 0x80000
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s37
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[28:29], s[52:53], 0x80000
...
; GFX7-HSA-NEXT:    s_mov_b32 s35, s11
; GFX7-HSA-NEXT:    s_mov_b32 s43, s11
; GFX7-HSA-NEXT:    s_mov_b32 s45, s11
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_lshr_b32 s10, s7, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s34, s7, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s36, s6, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s38, s6, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s40, s6, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s42, s5, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s44, s5, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s46, s4, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s48, s4, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s50, s4, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s52, s3, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s54, s3, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s28, s2, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s26, s2, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s24, s2, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s22, s1, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s30, s1, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s16, s0, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s14, s0, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s12, s0, 8
; GFX7-HSA-NEXT:    s_bfe_i64 s[18:19], s[10:11], 0x80000
; GFX7-HSA-NEXT:    s_mov_b32 s53, s11
; GFX7-HSA-NEXT:    s_mov_b32 s55, s11
; GFX7-HSA-NEXT:    s_mov_b32 s23, s11
; GFX7-HSA-NEXT:    s_mov_b32 s31, s11
; GFX7-HSA-NEXT:    s_bfe_i64 s[10:11], s[0:1], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[20:21], s[2:3], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[56:57], s[4:5], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[58:59], s[6:7], 0x80000
; GFX7-HSA-NEXT:    s_mov_b32 s0, s1
; GFX7-HSA-NEXT:    s_mov_b32 s2, s3
; GFX7-HSA-NEXT:    s_mov_b32 s4, s5
; GFX7-HSA-NEXT:    s_mov_b32 s6, s7
; GFX7-HSA-NEXT:    s_ashr_i32 s33, s1, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s60, s1, 24
; GFX7-HSA-NEXT:    s_ashr_i32 s61, s3, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s62, s3, 24
; GFX7-HSA-NEXT:    s_ashr_i32 s63, s5, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s64, s5, 24
; GFX7-HSA-NEXT:    s_ashr_i32 s65, s7, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s66, s7, 24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s18
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s19
; GFX7-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
...
; GFX7-HSA-NEXT:    s_bfe_i64 s[0:1], s[30:31], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
...
; GFX7-HSA-NEXT:    s_bfe_i64 s[2:3], s[54:55], 0x80000
...
; GFX7-HSA-NEXT:    s_add_u32 s54, s8, 0xf0
; GFX7-HSA-NEXT:    s_addc_u32 s55, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s6
; GFX7-HSA-NEXT:    s_add_u32 s6, s8, 0xe0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s7
; GFX7-HSA-NEXT:    s_addc_u32 s7, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s4
; GFX7-HSA-NEXT:    s_add_u32 s4, s8, 0xd0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s7
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s5
; GFX7-HSA-NEXT:    s_addc_u32 s5, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s6
; GFX7-HSA-NEXT:    s_add_u32 s6, s8, 0xc0
; GFX7-HSA-NEXT:    s_addc_u32 s7, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s34
; GFX7-HSA-NEXT:    s_add_u32 s34, s8, 0xb0
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s40
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[24:25], v[20:23]
; GFX7-HSA-NEXT:    s_add_u32 s40, s8, 0x80
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s7
; GFX7-HSA-NEXT:    s_add_u32 s4, s8, 0x70
...
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s63
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s35
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[24:25], v[16:19]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[12:15]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s5
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s8, 0x50
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s46
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s40
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s8, 64
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s8, 48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s20
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s21
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s25
...
; GFX8-NOHSA-NEXT:    s_mov_b32 s41, 0
; GFX8-NOHSA-NEXT:    s_mov_b32 s53, s41
; GFX8-NOHSA-NEXT:    s_mov_b32 s63, s41
; GFX8-NOHSA-NEXT:    s_mov_b32 s65, s41
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NOHSA-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NOHSA-NEXT:    s_lshr_b32 s40, s7, 16
; GFX8-NOHSA-NEXT:    s_lshr_b32 s42, s7, 8
; GFX8-NOHSA-NEXT:    s_mov_b32 s44, s7
...
; GFX8-NOHSA-NEXT:    s_lshr_b32 s54, s5, 8
; GFX8-NOHSA-NEXT:    s_mov_b32 s56, s5
; GFX8-NOHSA-NEXT:    s_lshr_b32 s58, s4, 16
; GFX8-NOHSA-NEXT:    s_lshr_b32 s60, s4, 24
; GFX8-NOHSA-NEXT:    s_lshr_b32 s38, s4, 8
; GFX8-NOHSA-NEXT:    s_lshr_b32 s62, s3, 16
; GFX8-NOHSA-NEXT:    s_lshr_b32 s36, s3, 8
; GFX8-NOHSA-NEXT:    s_mov_b32 s34, s3
...
; GFX8-NOHSA-NEXT:    s_ashr_i32 s43, s1, 24
...
; GFX8-NOHSA-NEXT:    s_ashr_i32 s64, s3, 31
; GFX8-NOHSA-NEXT:    s_ashr_i32 s65, s3, 24
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[2:3], s[62:63], 0x80000
...
; GFX8-NOHSA-NEXT:    s_ashr_i32 s62, s5, 31
; GFX8-NOHSA-NEXT:    s_ashr_i32 s63, s5, 24
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[4:5], s[52:53], 0x80000
...
; GFX8-NOHSA-NEXT:    s_ashr_i32 s52, s7, 31
; GFX8-NOHSA-NEXT:    s_ashr_i32 s53, s7, 24
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[6:7], s[42:43], 0x80000
; GFX8-NOHSA-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x80000
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s40
; GFX8-NOHSA-NEXT:    s_add_u32 s40, s8, 0xf0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s41
; GFX8-NOHSA-NEXT:    s_addc_u32 s41, s9, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s40
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v2, s53
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s52
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v1, s45
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s7
; GFX8-NOHSA-NEXT:    s_add_u32 s6, s8, 0xd0
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    s_addc_u32 s7, s9, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s6
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v3, s62
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
...
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX8-NOHSA-NEXT:    s_add_u32 s4, s8, 0x90
; GFX8-NOHSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NOHSA-NEXT:    s_addc_u32 s5, s9, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v4, s4
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v0, s58
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_load_b128 s[8:11], s[4:5], 0x24
; GFX12-NEXT:    s_mov_b32 s25, 0
; GFX12-NEXT:    s_mov_b32 s27, 0
; GFX12-NEXT:    s_mov_b32 s55, s25
...
; GFX12-NEXT:    s_lshr_b32 s26, s3, 16
; GFX12-NEXT:    s_lshr_b32 s54, s1, 16
; GFX12-NEXT:    s_mov_b32 s56, s7
; GFX12-NEXT:    s_mov_b32 s58, s5
; GFX12-NEXT:    s_mov_b32 s60, s3
; GFX12-NEXT:    s_ashr_i32 s57, s3, 31
; GFX12-NEXT:    s_ashr_i32 s59, s3, 24
; GFX12-NEXT:    s_lshr_b32 s28, s7, 8
; GFX12-NEXT:    s_lshr_b32 s30, s6, 16
; GFX12-NEXT:    s_lshr_b32 s34, s6, 24
; GFX12-NEXT:    s_lshr_b32 s16, s5, 16
; GFX12-NEXT:    s_lshr_b32 s38, s5, 8
; GFX12-NEXT:    s_lshr_b32 s40, s4, 16
; GFX12-NEXT:    s_lshr_b32 s42, s4, 24
; GFX12-NEXT:    s_lshr_b32 s46, s3, 8
; GFX12-NEXT:    s_lshr_b32 s48, s2, 16
; GFX12-NEXT:    s_lshr_b32 s50, s2, 24
; GFX12-NEXT:    s_lshr_b32 s52, s2, 8
; GFX12-NEXT:    s_lshr_b32 s22, s1, 8
; GFX12-NEXT:    s_mov_b32 s62, s1
; GFX12-NEXT:    s_lshr_b32 s18, s0, 16
...
; GFX12-NEXT:    s_bfe_i64 s[54:55], s[60:61], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[26:27], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[44:45], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[44:45], s[58:59], 0x80000
; GFX12-NEXT:    s_ashr_i32 s58, s5, 31
; GFX12-NEXT:    s_ashr_i32 s60, s5, 24
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[36:37], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[36:37], s[56:57], 0x80000
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s24 :: v_dual_mov_b32 v3, s56
; GFX12-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v5, s37
; GFX12-NEXT:    v_dual_mov_b32 v4, s36 :: v_dual_mov_b32 v7, s29
; GFX12-NEXT:    v_dual_mov_b32 v6, s28 :: v_dual_mov_b32 v9, s31
; GFX12-NEXT:    v_dual_mov_b32 v8, s30 :: v_dual_mov_b32 v11, s35
; GFX12-NEXT:    v_dual_mov_b32 v10, s34 :: v_dual_mov_b32 v13, s67
; GFX12-NEXT:    v_dual_mov_b32 v12, s66 :: v_dual_mov_b32 v15, s5
; GFX12-NEXT:    v_mov_b32_e32 v14, s4
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[16:17], 0x80000
...
; GFX12-NEXT:    v_dual_mov_b32 v7, s39 :: v_dual_mov_b32 v6, s38
; GFX12-NEXT:    v_dual_mov_b32 v9, s41 :: v_dual_mov_b32 v8, s40
; GFX12-NEXT:    v_dual_mov_b32 v11, s43 :: v_dual_mov_b32 v10, s42
; GFX12-NEXT:    v_mov_b32_e32 v13, s65
...
; GFX12-NEXT:    v_dual_mov_b32 v12, s64 :: v_dual_mov_b32 v15, s27
; GFX12-NEXT:    v_dual_mov_b32 v14, s26 :: v_dual_mov_b32 v17, s3
; GFX12-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v16, s2 :: v_dual_mov_b32 v19, s57
; GFX12-NEXT:    v_dual_mov_b32 v18, s59 :: v_dual_mov_b32 v21, s55
; GFX12-NEXT:    v_dual_mov_b32 v20, s54 :: v_dual_mov_b32 v23, s47
; GFX12-NEXT:    v_mov_b32_e32 v22, s46
; GFX12-NEXT:    s_clause 0x5
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s48 :: v_dual_mov_b32 v3, s51
; GFX12-NEXT:    v_dual_mov_b32 v1, s49 :: v_dual_mov_b32 v2, s50
; GFX12-NEXT:    v_mov_b32_e32 v5, s21
; GFX12-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v4, s20 :: v_dual_mov_b32 v7, s53
; GFX12-NEXT:    v_dual_mov_b32 v6, s52 :: v_dual_mov_b32 v9, s1
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v8, s0 :: v_dual_mov_b32 v11, s6
; GFX12-NEXT:    v_dual_mov_b32 v10, s33 :: v_dual_mov_b32 v13, s63
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v12, s62 :: v_dual_mov_b32 v15, s23
; GFX12-NEXT:    v_dual_mov_b32 v14, s22 :: v_dual_mov_b32 v17, s19
; GFX12-NEXT:    v_dual_mov_b32 v16, s18 :: v_dual_mov_b32 v19, s15
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_and_b32 s0, s2, 0xff00
; GFX6-NOHSA-NEXT:    s_lshr_b32 s3, s2, 24
; GFX6-NOHSA-NEXT:    s_and_b32 s1, s2, 0xff
; GFX6-NOHSA-NEXT:    s_lshl_b32 s0, s0, 8
; GFX6-NOHSA-NEXT:    s_or_b32 s8, s1, s0
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s2, 0x80010
; GFX6-NOHSA-NEXT:    s_lshl_b32 s0, s0, 16
; GFX6-NOHSA-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX6-NOHSA-NEXT:    s_or_b32 s0, s1, s0
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s2, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s2, s2
; GFX6-NOHSA-NEXT:    s_lshl_b32 s1, s1, 16
; GFX6-NOHSA-NEXT:    s_and_b32 s2, s2, 0xffff
; GFX6-NOHSA-NEXT:    s_or_b32 s1, s2, s1
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s1
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s0
; GFX6-NOHSA-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX6-NOHSA-NEXT:    s_endpgm
...
; GFX7-HSA-NEXT:    s_and_b32 s1, s2, 0xffff
; GFX7-HSA-NEXT:    s_or_b32 s1, s1, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s0
; GFX7-HSA-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; GFX7-HSA-NEXT:    s_endpgm
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_and_b32 s9, s3, 0xff00
; GFX6-NOHSA-NEXT:    s_and_b32 s0, s2, 0xff00
; GFX6-NOHSA-NEXT:    s_and_b32 s10, s3, 0xff
...
; GFX6-NOHSA-NEXT:    s_lshr_b32 s8, s2, 24
; GFX6-NOHSA-NEXT:    s_lshr_b32 s1, s3, 24
; GFX6-NOHSA-NEXT:    s_or_b32 s10, s10, s0
; GFX6-NOHSA-NEXT:    s_mov_b32 s0, s3
; GFX6-NOHSA-NEXT:    s_lshr_b64 s[0:1], s[0:1], 16
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, s8
; GFX6-NOHSA-NEXT:    s_and_b32 s11, s0, 0xff00ff
; GFX6-NOHSA-NEXT:    s_lshr_b64 s[0:1], s[2:3], 16
; GFX6-NOHSA-NEXT:    s_and_b32 s0, s0, 0xff00ff
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s10
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX7-HSA-NEXT:    s_and_b32 s6, s2, 0xff
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s0, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s4, s2, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s1, s3, 24
; GFX7-HSA-NEXT:    s_or_b32 s6, s6, s0
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s3, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s3, 0x80010
; GFX6-NOHSA-NEXT:    s_lshl_b32 s0, s0, 16
; GFX6-NOHSA-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX6-NOHSA-NEXT:    s_or_b32 s0, s1, s0
; GFX6-NOHSA-NEXT:    s_bfe_i32 s1, s3, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s3, s3
; GFX6-NOHSA-NEXT:    s_lshl_b32 s1, s1, 16
; GFX6-NOHSA-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX6-NOHSA-NEXT:    s_or_b32 s1, s3, s1
; GFX6-NOHSA-NEXT:    s_ashr_i32 s3, s2, 24
; GFX6-NOHSA-NEXT:    s_bfe_i32 s8, s2, 0x80010
; GFX6-NOHSA-NEXT:    s_lshl_b32 s3, s3, 16
; GFX6-NOHSA-NEXT:    s_and_b32 s8, s8, 0xffff
; GFX6-NOHSA-NEXT:    s_or_b32 s3, s8, s3
; GFX6-NOHSA-NEXT:    s_bfe_i32 s8, s2, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s2, s2
; GFX6-NOHSA-NEXT:    s_lshl_b32 s8, s8, 16
; GFX6-NOHSA-NEXT:    s_and_b32 s2, s2, 0xffff
; GFX6-NOHSA-NEXT:    s_or_b32 s2, s2, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s2
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s3
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s1
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s0
...
; GFX7-HSA-NEXT:    s_or_b32 s0, s1, s0
; GFX7-HSA-NEXT:    s_and_b32 s1, s3, 0xffff
; GFX7-HSA-NEXT:    s_or_b32 s1, s1, s4
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s1, s5
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_and_b32 s15, s9, 0xff00
; GFX6-NOHSA-NEXT:    s_and_b32 s6, s8, 0xff00
; GFX6-NOHSA-NEXT:    s_and_b32 s16, s9, 0xff
; GFX6-NOHSA-NEXT:    s_lshl_b32 s15, s15, 8
; GFX6-NOHSA-NEXT:    s_or_b32 s15, s16, s15
; GFX6-NOHSA-NEXT:    s_and_b32 s16, s8, 0xff
; GFX6-NOHSA-NEXT:    s_lshl_b32 s6, s6, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s14, s8, 24
; GFX6-NOHSA-NEXT:    s_lshr_b32 s7, s9, 24
; GFX6-NOHSA-NEXT:    s_or_b32 s16, s16, s6
; GFX6-NOHSA-NEXT:    s_mov_b32 s6, s9
; GFX6-NOHSA-NEXT:    s_lshr_b64 s[6:7], s[6:7], 16
; GFX6-NOHSA-NEXT:    s_mov_b32 s9, s14
; GFX6-NOHSA-NEXT:    s_and_b32 s13, s11, 0xff00
; GFX6-NOHSA-NEXT:    s_and_b32 s17, s6, 0xff00ff
; GFX6-NOHSA-NEXT:    s_lshr_b64 s[6:7], s[8:9], 16
; GFX6-NOHSA-NEXT:    s_and_b32 s4, s10, 0xff00
; GFX6-NOHSA-NEXT:    s_and_b32 s7, s11, 0xff
; GFX6-NOHSA-NEXT:    s_lshl_b32 s8, s13, 8
; GFX6-NOHSA-NEXT:    s_or_b32 s7, s7, s8
; GFX6-NOHSA-NEXT:    s_and_b32 s8, s10, 0xff
; GFX6-NOHSA-NEXT:    s_lshl_b32 s4, s4, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s12, s10, 24
; GFX6-NOHSA-NEXT:    s_lshr_b32 s5, s11, 24
; GFX6-NOHSA-NEXT:    s_or_b32 s8, s8, s4
; GFX6-NOHSA-NEXT:    s_mov_b32 s4, s11
; GFX6-NOHSA-NEXT:    s_lshr_b64 s[4:5], s[4:5], 16
; GFX6-NOHSA-NEXT:    s_mov_b32 s11, s12
; GFX6-NOHSA-NEXT:    s_and_b32 s9, s4, 0xff00ff
; GFX6-NOHSA-NEXT:    s_lshr_b64 s[4:5], s[10:11], 16
...
; GFX8-NOHSA-NEXT:    s_and_b32 s3, s5, 0xff0000
; GFX8-NOHSA-NEXT:    s_lshl_b32 s5, s4, 8
; GFX8-NOHSA-NEXT:    s_lshr_b32 s2, s4, 24
; GFX8-NOHSA-NEXT:    s_or_b32 s10, s10, s3
; GFX8-NOHSA-NEXT:    s_and_b32 s3, s4, 0xff
; GFX8-NOHSA-NEXT:    s_and_b32 s5, s5, 0xff0000
; GFX8-NOHSA-NEXT:    s_or_b32 s11, s3, s5
...
; GFX7-HSA-NEXT:    s_or_b32 s9, s3, s2
; GFX7-HSA-NEXT:    s_and_b32 s2, s5, 0xffff
; GFX7-HSA-NEXT:    s_or_b32 s5, s2, s8
; GFX7-HSA-NEXT:    s_ashr_i32 s2, s4, 24
...
; GFX7-HSA-NEXT:    s_bfe_i32 s10, s6, 0x80010
; GFX7-HSA-NEXT:    s_lshl_b32 s7, s7, 16
; GFX7-HSA-NEXT:    s_and_b32 s10, s10, 0xffff
; GFX7-HSA-NEXT:    s_or_b32 s7, s10, s7
; GFX7-HSA-NEXT:    s_bfe_i32 s10, s6, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s6, s6
...
; GFX8-NOHSA-NEXT:    s_sext_i32_i16 s11, s4
...
; GFX7-HSA-NEXT:    s_and_b32 s25, s1, 0xff00
; GFX7-HSA-NEXT:    s_lshr_b32 s24, s0, 24
; GFX7-HSA-NEXT:    s_and_b32 s26, s1, 0xff
; GFX7-HSA-NEXT:    s_and_b32 s27, s0, 0xff
; GFX7-HSA-NEXT:    s_lshl_b32 s25, s25, 8
; GFX7-HSA-NEXT:    s_lshl_b32 s16, s16, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s17, s1, 24
; GFX7-HSA-NEXT:    s_or_b32 s25, s26, s25
; GFX7-HSA-NEXT:    s_or_b32 s26, s27, s16
; GFX7-HSA-NEXT:    s_mov_b32 s16, s1
; GFX7-HSA-NEXT:    s_mov_b32 s1, s24
; GFX7-HSA-NEXT:    s_and_b32 s23, s3, 0xff00
; GFX7-HSA-NEXT:    s_lshr_b64 s[16:17], s[16:17], 16
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[0:1], 16
; GFX7-HSA-NEXT:    s_and_b32 s14, s2, 0xff00
; GFX7-HSA-NEXT:    s_and_b32 s28, s3, 0xff
; GFX7-HSA-NEXT:    s_and_b32 s17, s0, 0xff00ff
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s23, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s22, s2, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s15, s3, 24
; GFX7-HSA-NEXT:    s_and_b32 s29, s2, 0xff
; GFX7-HSA-NEXT:    s_or_b32 s23, s28, s0
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s14, 8
; GFX7-HSA-NEXT:    s_mov_b32 s14, s3
; GFX7-HSA-NEXT:    s_or_b32 s24, s29, s0
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[14:15], 16
; GFX7-HSA-NEXT:    s_mov_b32 s3, s22
; GFX7-HSA-NEXT:    s_and_b32 s21, s5, 0xff00
; GFX7-HSA-NEXT:    s_and_b32 s14, s0, 0xff00ff
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[2:3], 16
; GFX7-HSA-NEXT:    s_and_b32 s12, s4, 0xff00
; GFX7-HSA-NEXT:    s_and_b32 s30, s5, 0xff
; GFX7-HSA-NEXT:    s_and_b32 s2, s0, 0xff00ff
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s21, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s20, s4, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s13, s5, 24
; GFX7-HSA-NEXT:    s_and_b32 s31, s4, 0xff
; GFX7-HSA-NEXT:    s_or_b32 s3, s30, s0
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s12, 8
; GFX7-HSA-NEXT:    s_mov_b32 s12, s5
; GFX7-HSA-NEXT:    s_or_b32 s15, s31, s0
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[12:13], 16
; GFX7-HSA-NEXT:    s_mov_b32 s5, s20
; GFX7-HSA-NEXT:    s_and_b32 s19, s7, 0xff00
; GFX7-HSA-NEXT:    s_and_b32 s12, s0, 0xff00ff
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[4:5], 16
; GFX7-HSA-NEXT:    s_and_b32 s10, s6, 0xff00
; GFX7-HSA-NEXT:    s_and_b32 s33, s7, 0xff
; GFX7-HSA-NEXT:    s_and_b32 s4, s0, 0xff00ff
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s19, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s18, s6, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s11, s7, 24
; GFX7-HSA-NEXT:    s_and_b32 s34, s6, 0xff
; GFX7-HSA-NEXT:    s_or_b32 s5, s33, s0
; GFX7-HSA-NEXT:    s_lshl_b32 s0, s10, 8
; GFX7-HSA-NEXT:    s_mov_b32 s10, s7
; GFX7-HSA-NEXT:    s_or_b32 s13, s34, s0
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[10:11], 16
; GFX7-HSA-NEXT:    s_mov_b32 s7, s18
; GFX7-HSA-NEXT:    s_and_b32 s10, s0, 0xff00ff
; GFX7-HSA-NEXT:    s_lshr_b64 s[0:1], s[6:7], 16
; GFX7-HSA-NEXT:    s_and_b32 s16, s16, 0xff00ff
; GFX7-HSA-NEXT:    s_and_b32 s0, s0, 0xff00ff
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX12-NEXT:    s_bfe_u32 s14, s7, 0x80010
; GFX12-NEXT:    s_and_b32 s7, s7, 0xff
...
; GFX6-NOHSA-NEXT:    s_bfe_i32 s13, s1, 0x80008
; GFX6-NOHSA-NEXT:    s_sext_i32_i8 s1, s1
...
; GFX7-HSA-NEXT:    s_ashr_i32 s2, s5, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s3, s5, 0x80010
; GFX7-HSA-NEXT:    s_bfe_i32 s12, s5, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s5, s5
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s2, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s13, s4, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s14, s4, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s35, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s12, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s5, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s15, s4, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s4, s4
; GFX7-HSA-NEXT:    s_or_b32 s5, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s13, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s14, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s16, s7, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s17, s7, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s12, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s15, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s4, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s18, s7, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s7, s7
; GFX7-HSA-NEXT:    s_or_b32 s4, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s16, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s17, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s19, s6, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s20, s6, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s13, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s18, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s7, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s21, s6, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s6, s6
; GFX7-HSA-NEXT:    s_or_b32 s7, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s19, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s20, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s22, s9, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s23, s9, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s14, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s21, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s6, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s24, s9, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s9, s9
; GFX7-HSA-NEXT:    s_or_b32 s6, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s22, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s23, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s25, s8, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s26, s8, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s15, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s24, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s9, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s27, s8, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s8, s8
; GFX7-HSA-NEXT:    s_or_b32 s9, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s25, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s26, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s28, s11, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s29, s11, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s16, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s27, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s8, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s30, s11, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s11, s11
; GFX7-HSA-NEXT:    s_or_b32 s8, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s2, s28, 16
; GFX7-HSA-NEXT:    s_and_b32 s3, s29, 0xffff
; GFX7-HSA-NEXT:    s_ashr_i32 s31, s10, 24
; GFX7-HSA-NEXT:    s_bfe_i32 s33, s10, 0x80010
; GFX7-HSA-NEXT:    s_or_b32 s2, s3, s2
; GFX7-HSA-NEXT:    s_lshl_b32 s3, s30, 16
; GFX7-HSA-NEXT:    s_and_b32 s11, s11, 0xffff
; GFX7-HSA-NEXT:    s_bfe_i32 s34, s10, 0x80008
; GFX7-HSA-NEXT:    s_sext_i32_i8 s10, s10
; GFX7-HSA-NEXT:    s_or_b32 s3, s11, s3
; GFX7-HSA-NEXT:    s_lshl_b32 s11, s31, 16
; GFX7-HSA-NEXT:    s_and_b32 s17, s33, 0xffff
; GFX7-HSA-NEXT:    s_or_b32 s11, s17, s11
; GFX7-HSA-NEXT:    s_lshl_b32 s17, s34, 16
; GFX7-HSA-NEXT:    s_and_b32 s10, s10, 0xffff
; GFX7-HSA-NEXT:    s_or_b32 s10, s10, s17
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s2
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s3
; GFX7-HSA-NEXT:    s_addc_u32 s3, s1, 0
...
; GFX12-NEXT:    s_sext_i32_i16 s18, s5
...
; GFX12-NEXT:    s_ashr_i32 s19, s4, 24
; GFX12-NEXT:    s_bfe_i32 s12, s12, 0x80000
; GFX12-NEXT:    s_pack_ll_b32_b16 s5, s5, s18
; GFX12-NEXT:    s_sext_i32_i16 s18, s4
; GFX12-NEXT:    s_pack_ll_b32_b16 s12, s12, s19
; GFX12-NEXT:    s_bfe_i32 s4, s4, 0x80000
; GFX12-NEXT:    s_lshr_b32 s18, s18, 8
