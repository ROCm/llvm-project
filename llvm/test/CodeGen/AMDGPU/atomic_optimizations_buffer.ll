...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    buffer_atomic_add v0, off, s[12:15], 0 glc
; GFX6-NEXT:  .LBB2_4:
; GFX6-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX10W64-NEXT:    s_mov_b64 s[2:3], 0
; GFX10W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W64-NEXT:    buffer_atomic_add v0, off, s[12:15], 0 glc
...
; GFX12W64-NEXT:    s_mov_b64 s[2:3], 0
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    buffer_atomic_add_u32 v1, off, s[12:15], null th:TH_ATOMIC_RETURN
...
; GFX10W64-NEXT:    v_mov_b32_e32 v0, s8
; GFX10W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W64-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX11W64-NEXT:    v_mov_b32_e32 v1, s8
; GFX11W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W64-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX11W32-NEXT:  .LBB3_3:
; GFX11W32-NEXT:    s_mov_b32 s2, 0
; GFX11W32-NEXT:    s_clause 0x1
; GFX11W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34
; GFX11W32-NEXT:    s_load_b32 s2, s[4:5], 0x44
; GFX11W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W32-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v2, s2
...
; GFX12W64-NEXT:    v_mov_b32_e32 v1, s8
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX12W32-NEXT:  .LBB3_3:
; GFX12W32-NEXT:    s_mov_b32 s2, 0
; GFX12W32-NEXT:    s_clause 0x1
; GFX12W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34
; GFX12W32-NEXT:    s_load_b32 s2, s[4:5], 0x44
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v2, s2
...
; GFX6-NEXT:    v_mov_b32_e32 v0, s8
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    buffer_atomic_sub v0, off, s[12:15], 0 glc
; GFX6-NEXT:  .LBB7_4:
; GFX6-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX10W64-NEXT:    s_mov_b64 s[2:3], 0
; GFX10W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W64-NEXT:    buffer_atomic_sub v0, off, s[12:15], 0 glc
...
; GFX12W64-NEXT:    s_mov_b64 s[2:3], 0
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    buffer_atomic_sub_u32 v1, off, s[12:15], null th:TH_ATOMIC_RETURN
