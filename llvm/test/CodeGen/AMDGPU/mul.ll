...
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=verde < %s | FileCheck -check-prefixes=SI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -check-prefixes=VI %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX9 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx1010 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX10 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX11 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx1200 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx1250 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX1250 %s
; RUN:  llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx1310 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX13 %s
...
; GFX12-NEXT:    buffer_load_b128 v[0:3], off, s[4:7], null
...
; GFX1250-NEXT:    buffer_load_b128 v[0:3], off, s[4:7], null
...
; GFX13-NEXT:    s_mov_b32 s2, s6
; GFX13-NEXT:    buffer_load_b128 v[0:3], off, s[4:7], null
; GFX13-NEXT:    s_mov_b32 s3, s7
...
; GFX10-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; GFX10-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; GFX10-NEXT:    s_mov_b32 s2, s6
; GFX10-NEXT:    s_mov_b32 s3, s7
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    buffer_load_b128 v[0:3], off, s[4:7], null
; GFX12-NEXT:    buffer_load_b128 v[4:7], off, s[4:7], null offset:16
; GFX12-NEXT:    s_mov_b32 s2, s6
; GFX12-NEXT:    s_mov_b32 s3, s7
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    buffer_load_b128 v[0:3], off, s[4:7], null
; GFX1250-NEXT:    buffer_load_b128 v[4:7], off, s[4:7], null offset:16
; GFX1250-NEXT:    s_mov_b32 s2, s6
; GFX1250-NEXT:    s_mov_b32 s3, s7
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    buffer_load_b128 v[0:3], off, s[4:7], null
; GFX13-NEXT:    buffer_load_b128 v[4:7], off, s[4:7], null offset:16
; GFX13-NEXT:    s_mov_b32 s2, s6
; GFX13-NEXT:    s_mov_b32 s3, s7
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_mul_i32 s2, s6, s2
...
; GFX13-NEXT:    s_mov_b32 s2, s10
; GFX13-NEXT:    s_mov_b32 s3, s11
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mad_i64_i32 v[0:1], s[4:5], s4, v0, 0
; VI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; VI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_load_dword s4, s[4:5], 0x2c
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s4, s6, 0x50
; GFX10-NEXT:    s_mul_hi_i32 s5, s6, 0x50
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_i32 s5, s4, 0x50
; GFX11-NEXT:    s_mul_hi_i32 s4, s4, 0x50
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v1, s4
; GFX11-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX11-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s4, 0x31016000
...
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], s4, v0, 0
; VI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; VI-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s4, s6, 0x50
; GFX10-NEXT:    s_mul_hi_u32 s5, s6, 0x50
; GFX10-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-NEXT:    v_mov_b32_e32 v1, s5
; GFX10-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; GFX10-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_i32 s5, s4, 0x50
; GFX11-NEXT:    s_mul_hi_u32 s4, s4, 0x50
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v1, s4
; GFX11-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX11-NEXT:    s_endpgm
...
; VI-NEXT:    s_load_dword s4, s[4:5], 0x70
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_mul_i32 s4, s6, s4
...
; GFX10-NEXT:    s_load_dword s6, s[4:5], 0x4c
; GFX10-NEXT:    s_load_dword s7, s[4:5], 0x70
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_mov_b32 s2, -1
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s4, s6, s7
; GFX10-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_load_b32 s6, s[4:5], 0x4c
; GFX11-NEXT:    s_load_b32 s7, s[4:5], 0x70
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_mov_b32 s2, -1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-NEXT:    s_load_b32 s6, s[4:5], 0x4c
; GFX12-NEXT:    s_load_b32 s7, s[4:5], 0x70
; GFX12-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX12-NEXT:    s_mov_b32 s3, 0x31016000
; GFX12-NEXT:    s_mov_b32 s2, -1
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mul_i32 s4, s6, s7
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1250-NEXT:    s_load_b32 s6, s[4:5], 0x4c nv
; GFX1250-NEXT:    s_load_b32 s7, s[4:5], 0x70 nv
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX1250-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1250-NEXT:    s_mov_b32 s2, -1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_mul_i32 s4, s6, s7
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX13-NEXT:    s_load_b32 s6, s[4:5], 0x4c nv
; GFX13-NEXT:    s_load_b32 s7, s[4:5], 0x70 nv
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_mul_i32 s4, s6, s7
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_mov_b32_e32 v0, s4
; GFX13-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX13-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i32:
...
; GFX10-NEXT:    s_load_dword s6, s[4:5], 0x70
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s4, s2, s6
; GFX10-NEXT:    s_mov_b32 s2, -1
...
; GFX11-NEXT:    s_load_b32 s6, s[4:5], 0x70
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_and_b32 s4, s2, s6
; GFX11-NEXT:    s_mov_b32 s2, -1
...
; GFX12-NEXT:    s_load_b32 s6, s[4:5], 0x70
; GFX12-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX12-NEXT:    s_mov_b32 s3, 0x31016000
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_and_b32 s4, s2, s6
; GFX12-NEXT:    s_mov_b32 s2, -1
...
; GFX1250-NEXT:    s_load_b32 s6, s[4:5], 0x70 nv
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX1250-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_and_b32 s4, s2, s6
; GFX1250-NEXT:    s_mov_b32 s2, -1
...
; GFX13-NEXT:    s_load_b32 s6, s[4:5], 0x70 nv
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_and_b32 s4, s2, s6
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    s_and_b32 s4, s4, 1
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_mov_b32_e32 v0, s4
...
; SI-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:4
; SI-NEXT:    s_mov_b32 s2, s6
; SI-NEXT:    s_mov_b32 s3, s7
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; VI-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:4
; VI-NEXT:    s_mov_b32 s2, s6
; VI-NEXT:    s_mov_b32 s3, s7
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    s_mov_b32 s4, s2
; GFX9-NEXT:    s_mov_b32 s5, s3
; GFX9-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0
; GFX9-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:4
; GFX9-NEXT:    s_mov_b32 s2, s6
; GFX9-NEXT:    s_mov_b32 s3, s7
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    s_mov_b32 s5, s3
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0
; GFX10-NEXT:    buffer_load_ubyte v1, off, s[4:7], 0 offset:4
; GFX10-NEXT:    s_mov_b32 s2, s6
; GFX10-NEXT:    s_mov_b32 s3, s7
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    buffer_load_u8 v1, off, s[4:7], 0 offset:4
; GFX11-NEXT:    s_mov_b32 s2, s6
; GFX11-NEXT:    s_mov_b32 s3, s7
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    s_mov_b32 s5, s3
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    buffer_load_u8 v0, off, s[4:7], null
; GFX12-NEXT:    buffer_load_u8 v1, off, s[4:7], null offset:4
; GFX12-NEXT:    s_mov_b32 s2, s6
; GFX12-NEXT:    s_mov_b32 s3, s7
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_mov_b32 s5, s3
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    buffer_load_u8 v0, off, s[4:7], null
; GFX1250-NEXT:    buffer_load_u8 v1, off, s[4:7], null offset:4
; GFX1250-NEXT:    s_mov_b32 s2, s6
; GFX1250-NEXT:    s_mov_b32 s3, s7
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    s_mov_b32 s5, s3
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_load_u8 v0, off, s[4:7], null
; GFX13-NEXT:    buffer_load_u8 v1, off, s[4:7], null offset:4
; GFX13-NEXT:    s_mov_b32 s2, s6
; GFX13-NEXT:    s_mov_b32 s3, s7
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
; GFX10-NEXT:    s_mov_b32 s4, 0x31016000
; GFX10-NEXT:    s_mov_b32 s5, -1
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s7, s2, s7
; GFX10-NEXT:    s_mul_hi_u32 s8, s2, s6
; GFX10-NEXT:    s_mul_i32 s3, s3, s6
; GFX10-NEXT:    s_add_i32 s7, s8, s7
; GFX10-NEXT:    s_mul_i32 s2, s2, s6
; GFX10-NEXT:    s_add_i32 s7, s7, s3
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    v_mov_b32_e32 v1, s7
; GFX10-NEXT:    s_mov_b32 s2, s5
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX11-NEXT:    s_mov_b32 s6, 0x31016000
; GFX11-NEXT:    s_mov_b32 s7, -1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_i32 s5, s2, s5
; GFX11-NEXT:    s_mul_hi_u32 s8, s2, s4
; GFX11-NEXT:    s_mul_i32 s3, s3, s4
; GFX11-NEXT:    s_add_i32 s5, s8, s5
...
; GFX12-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX12-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX12-NEXT:    s_mov_b32 s6, 0x31016000
...
; GFX1250-NEXT:    s_mov_b32 s5, -1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_mul_u64 s[2:3], s[2:3], s[6:7]
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_mov_b64_e32 v[0:1], s[2:3]
; GFX1250-NEXT:    s_mov_b32 s2, s5
; GFX1250-NEXT:    s_mov_b32 s3, s4
...
; GFX13-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34 nv
; GFX13-NEXT:    s_mov_b32 s6, 0x31016000
; GFX13-NEXT:    s_mov_b32 s7, -1
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_mul_u64 s[2:3], s[2:3], s[4:5]
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; VI-NEXT:    buffer_load_dwordx2 v[2:3], off, s[4:7], 0
; VI-NEXT:    s_mov_b32 s4, s0
; VI-NEXT:    s_mov_b32 s5, s1
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    buffer_load_dwordx2 v[2:3], off, s[4:7], 0
; GFX9-NEXT:    s_mov_b32 s4, s0
; GFX9-NEXT:    s_mov_b32 s5, s1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    buffer_load_dwordx2 v[2:3], off, s[4:7], 0
; GFX10-NEXT:    s_mov_b32 s2, s6
; GFX10-NEXT:    s_mov_b32 s3, s7
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    s_mov_b32 s9, s3
; GFX11-NEXT:    buffer_load_b64 v[0:1], off, s[4:7], 0
; GFX11-NEXT:    buffer_load_b64 v[2:3], off, s[8:11], 0
; GFX11-NEXT:    s_mov_b32 s2, s10
; GFX11-NEXT:    s_mov_b32 s3, s11
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    s_mov_b32 s9, s3
; GFX12-NEXT:    buffer_load_b64 v[0:1], off, s[4:7], null
; GFX12-NEXT:    buffer_load_b64 v[2:3], off, s[8:11], null
; GFX12-NEXT:    s_mov_b32 s2, s10
; GFX12-NEXT:    s_mov_b32 s3, s11
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    s_mov_b32 s9, s3
; GFX13-NEXT:    buffer_load_b64 v[0:1], off, s[4:7], null
; GFX13-NEXT:    buffer_load_b64 v[2:3], off, s[8:11], null
; GFX13-NEXT:    s_mov_b32 s2, s10
; GFX13-NEXT:    s_mov_b32 s3, s11
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
; GFX9-NEXT:  ; %bb.1: ; %else
; GFX9-NEXT:    s_mul_i32 s2, s6, s7
; GFX9-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NEXT:    s_branch .LBB15_3
; GFX9-NEXT:  .LBB15_2: ; %if
; GFX9-NEXT:    s_mov_b32 s7, 0xf000
; GFX9-NEXT:    s_mov_b32 s6, -1
; GFX9-NEXT:    s_mov_b32 s4, s2
; GFX9-NEXT:    s_mov_b32 s5, s3
; GFX9-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; GFX9-NEXT:  .LBB15_3: ; %endif
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; GFX10-NEXT:    s_mul_i32 s2, s6, s7
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    s_branch .LBB15_3
; GFX10-NEXT:  .LBB15_2: ; %if
; GFX10-NEXT:    s_mov_b32 s7, 0x31016000
; GFX10-NEXT:    s_mov_b32 s6, -1
; GFX10-NEXT:    s_mov_b32 s4, s2
; GFX10-NEXT:    s_mov_b32 s5, s3
; GFX10-NEXT:    buffer_load_dword v0, off, s[4:7], 0
; GFX10-NEXT:  .LBB15_3: ; %endif
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_mov_b32 s2, -1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; GFX11-NEXT:  .LBB15_2: ; %if
; GFX11-NEXT:    s_mov_b32 s7, 0x31016000
; GFX11-NEXT:    s_mov_b32 s6, -1
; GFX11-NEXT:    s_mov_b32 s4, s2
; GFX11-NEXT:    s_mov_b32 s5, s3
; GFX11-NEXT:    buffer_load_b32 v0, off, s[4:7], 0
; GFX11-NEXT:  .LBB15_3: ; %endif
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_mov_b32 s2, -1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
...
; GFX12-NEXT:    s_mul_i32 s2, s6, s7
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_mov_b32_e32 v0, s2
; GFX12-NEXT:    s_branch .LBB15_3
; GFX12-NEXT:  .LBB15_2: ; %if
; GFX12-NEXT:    s_mov_b32 s7, 0x31016000
; GFX12-NEXT:    s_mov_b32 s6, -1
; GFX12-NEXT:    s_mov_b32 s4, s2
; GFX12-NEXT:    s_mov_b32 s5, s3
; GFX12-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX12-NEXT:  .LBB15_3: ; %endif
; GFX12-NEXT:    s_mov_b32 s3, 0x31016000
; GFX12-NEXT:    s_mov_b32 s2, -1
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_store_b32 v0, off, s[0:3], null
...
; GFX1250-NEXT:    s_mul_i32 s2, s6, s7
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_mov_b32_e32 v0, s2
; GFX1250-NEXT:    s_branch .LBB15_3
; GFX1250-NEXT:  .LBB15_2: ; %if
; GFX1250-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1250-NEXT:    s_mov_b32 s6, -1
; GFX1250-NEXT:    s_mov_b32 s4, s2
; GFX1250-NEXT:    s_mov_b32 s5, s3
; GFX1250-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX1250-NEXT:  .LBB15_3: ; %endif
; GFX1250-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1250-NEXT:    s_mov_b32 s2, -1
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_store_b32 v0, off, s[0:3], null
...
; GFX13-NEXT:    s_mul_i32 s2, s6, s7
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_mov_b32_e32 v0, s2
; GFX13-NEXT:    s_branch .LBB15_3
; GFX13-NEXT:  .LBB15_2: ; %if
; GFX13-NEXT:    s_mov_b32 s7, 0x31016000
; GFX13-NEXT:    s_mov_b32 s6, -1
; GFX13-NEXT:    s_mov_b32 s4, s2
; GFX13-NEXT:    s_mov_b32 s5, s3
; GFX13-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX13-NEXT:  .LBB15_3: ; %endif
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    buffer_store_b32 v0, off, s[0:3], null
...
; SI-NEXT:    s_mul_i32 s2, s4, s7
; SI-NEXT:    s_mul_i32 s3, s5, s6
; SI-NEXT:    v_add_i32_e32 v0, vcc, s2, v0
; SI-NEXT:    s_mul_i32 s2, s4, s6
; SI-NEXT:    v_add_i32_e32 v1, vcc, s3, v0
; SI-NEXT:    v_mov_b32_e32 v0, s2
...
; VI-NEXT:    s_mul_i32 s2, s4, s7
; VI-NEXT:    s_mul_i32 s3, s5, s6
; VI-NEXT:    v_add_u32_e32 v1, vcc, s2, v1
; VI-NEXT:    v_add_u32_e32 v1, vcc, s3, v1
...
; GFX11-NEXT:  ; %bb.1: ; %else
; GFX11-NEXT:    s_mul_i32 s2, s4, s7
; GFX11-NEXT:    s_mul_hi_u32 s3, s4, s6
; GFX11-NEXT:    s_mul_i32 s5, s5, s6
; GFX11-NEXT:    s_add_i32 s3, s3, s2
; GFX11-NEXT:    s_mul_i32 s2, s4, s6
...
; GFX13-NEXT:  ; %bb.1: ; %else
; GFX13-NEXT:    s_mul_u64 s[2:3], s[4:5], s[6:7]
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
...
; SI-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x1f
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    v_mul_hi_u32 v1, s6, v1
; SI-NEXT:    s_mul_i32 s11, s4, s11
; SI-NEXT:    v_add_i32_e32 v0, vcc, s11, v0
; SI-NEXT:    s_mul_i32 s11, s5, s10
; SI-NEXT:    v_add_i32_e32 v0, vcc, s11, v0
; SI-NEXT:    s_mul_i32 s11, s6, s9
; SI-NEXT:    v_add_i32_e32 v1, vcc, s11, v1
; SI-NEXT:    s_mul_i32 s7, s7, s8
; SI-NEXT:    s_mul_i32 s6, s6, s8
; SI-NEXT:    s_mul_i32 s10, s4, s10
; SI-NEXT:    v_add_i32_e32 v1, vcc, s7, v1
; SI-NEXT:    v_mov_b32_e32 v2, s6
; SI-NEXT:    v_add_i32_e32 v2, vcc, s10, v2
...
; SI-NEXT:    s_mul_i32 s7, s9, s4
; SI-NEXT:    v_add_i32_e32 v5, vcc, s7, v5
; SI-NEXT:    s_mul_i32 s6, s8, s5
...
; VI-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x7c
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s10
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], s4, v0, 0
; VI-NEXT:    s_mul_i32 s11, s4, s11
; VI-NEXT:    v_mov_b32_e32 v5, s4
; VI-NEXT:    s_mul_i32 s12, s5, s10
; VI-NEXT:    v_add_u32_e32 v2, vcc, s11, v4
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s8, v5, 0
; VI-NEXT:    v_add_u32_e32 v4, vcc, s12, v2
; VI-NEXT:    v_mov_b32_e32 v2, 0
; VI-NEXT:    v_mad_u64_u32 v[5:6], s[10:11], s9, v5, v[1:2]
; VI-NEXT:    v_mov_b32_e32 v1, s8
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[10:11], s6, v1, v[3:4]
; VI-NEXT:    v_mov_b32_e32 v7, s5
; VI-NEXT:    v_mov_b32_e32 v1, v5
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], s8, v7, v[1:2]
; VI-NEXT:    s_mul_i32 s7, s7, s8
; VI-NEXT:    v_add_u32_e32 v8, vcc, s7, v4
; VI-NEXT:    v_add_u32_e32 v4, vcc, v6, v2
; VI-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, 0, vcc
; VI-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], s9, v7, v[4:5]
; VI-NEXT:    s_mul_i32 s6, s6, s9
...
; GFX10-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x4c
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-NEXT:    s_mov_b32 s4, 0
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_mov_b32 s2, -1
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s5, s8, s15
; GFX10-NEXT:    s_mul_hi_u32 s6, s8, s14
; GFX10-NEXT:    s_mul_i32 s15, s10, s13
; GFX10-NEXT:    s_mul_hi_u32 s16, s10, s12
; GFX10-NEXT:    s_mul_i32 s7, s9, s14
; GFX10-NEXT:    s_mul_i32 s11, s11, s12
; GFX10-NEXT:    s_add_i32 s5, s6, s5
; GFX10-NEXT:    s_add_i32 s6, s16, s15
; GFX10-NEXT:    s_mul_i32 s14, s8, s14
; GFX10-NEXT:    s_mul_i32 s10, s10, s12
; GFX10-NEXT:    s_add_i32 s5, s5, s7
; GFX10-NEXT:    s_add_i32 s6, s6, s11
; GFX10-NEXT:    s_mul_i32 s20, s13, s8
; GFX10-NEXT:    s_mul_hi_u32 s21, s12, s8
; GFX10-NEXT:    s_add_u32 s7, s10, s14
; GFX10-NEXT:    s_mul_hi_u32 s19, s13, s8
; GFX10-NEXT:    s_addc_u32 s10, s6, s5
; GFX10-NEXT:    s_mul_i32 s18, s12, s9
; GFX10-NEXT:    s_add_u32 s5, s20, s21
; GFX10-NEXT:    s_mul_hi_u32 s17, s12, s9
; GFX10-NEXT:    s_addc_u32 s11, s19, 0
; GFX10-NEXT:    s_add_u32 s5, s18, s5
; GFX10-NEXT:    s_mul_hi_u32 s22, s13, s9
; GFX10-NEXT:    s_mul_i32 s9, s13, s9
; GFX10-NEXT:    s_addc_u32 s13, s17, 0
; GFX10-NEXT:    s_mul_i32 s6, s12, s8
; GFX10-NEXT:    s_add_u32 s8, s11, s13
; GFX10-NEXT:    s_addc_u32 s11, 0, 0
; GFX10-NEXT:    s_add_u32 s8, s9, s8
; GFX10-NEXT:    s_addc_u32 s9, s22, s11
; GFX10-NEXT:    s_add_u32 s8, s8, s7
; GFX10-NEXT:    s_mov_b32 s7, s4
; GFX10-NEXT:    s_addc_u32 s9, s9, s10
; GFX10-NEXT:    s_or_b64 s[4:5], s[6:7], s[4:5]
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_clause 0x2
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x7c
; GFX11-NEXT:    s_load_b128 s[8:11], s[4:5], 0x4c
...
; GFX11-NEXT:    s_mul_hi_u32 s13, s0, s10
; GFX11-NEXT:    s_mul_i32 s15, s2, s9
; GFX11-NEXT:    s_mul_hi_u32 s16, s2, s8
; GFX11-NEXT:    s_mul_i32 s14, s1, s10
; GFX11-NEXT:    s_mul_i32 s3, s3, s8
; GFX11-NEXT:    s_mul_hi_u32 s17, s8, s1
; GFX11-NEXT:    s_mul_i32 s18, s8, s1
; GFX11-NEXT:    s_mul_hi_u32 s19, s9, s0
; GFX11-NEXT:    s_mul_i32 s20, s9, s0
; GFX11-NEXT:    s_mul_hi_u32 s22, s9, s1
; GFX11-NEXT:    s_mul_i32 s1, s9, s1
; GFX11-NEXT:    s_add_i32 s9, s13, s11
; GFX11-NEXT:    s_add_i32 s11, s16, s15
; GFX11-NEXT:    s_mul_i32 s10, s0, s10
; GFX11-NEXT:    s_mul_i32 s2, s2, s8
; GFX11-NEXT:    s_add_i32 s9, s9, s14
; GFX11-NEXT:    s_add_i32 s11, s11, s3
; GFX11-NEXT:    s_mul_hi_u32 s21, s8, s0
; GFX11-NEXT:    s_add_u32 s2, s2, s10
; GFX11-NEXT:    s_addc_u32 s3, s11, s9
; GFX11-NEXT:    s_add_u32 s9, s20, s21
; GFX11-NEXT:    s_addc_u32 s10, s19, 0
; GFX11-NEXT:    s_add_u32 s13, s18, s9
; GFX11-NEXT:    s_addc_u32 s9, s17, 0
; GFX11-NEXT:    s_mul_i32 s0, s8, s0
; GFX11-NEXT:    s_add_u32 s8, s10, s9
; GFX11-NEXT:    s_addc_u32 s9, 0, 0
; GFX11-NEXT:    s_add_u32 s1, s1, s8
; GFX11-NEXT:    s_addc_u32 s8, s22, s9
; GFX11-NEXT:    s_add_u32 s2, s1, s2
; GFX11-NEXT:    s_mov_b32 s1, s12
; GFX11-NEXT:    s_addc_u32 s3, s8, s3
...
; GFX12-NEXT:    s_clause 0x2
; GFX12-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX12-NEXT:    s_load_b128 s[8:11], s[4:5], 0x4c
; GFX12-NEXT:    s_load_b128 s[4:7], s[4:5], 0x7c
; GFX12-NEXT:    s_mov_b32 s13, 0
; GFX12-NEXT:    s_mov_b32 s17, 0
; GFX12-NEXT:    s_mov_b32 s15, 0
; GFX12-NEXT:    s_mov_b32 s19, 0
; GFX12-NEXT:    s_mov_b32 s21, 0
; GFX12-NEXT:    s_mov_b32 s3, 0x31016000
; GFX12-NEXT:    s_mov_b32 s2, -1
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mov_b32 s16, s8
; GFX12-NEXT:    s_mov_b32 s12, s4
; GFX12-NEXT:    s_mov_b32 s14, s9
; GFX12-NEXT:    s_mul_u64 s[22:23], s[16:17], s[12:13]
; GFX12-NEXT:    s_mul_u64 s[24:25], s[14:15], s[12:13]
; GFX12-NEXT:    s_mov_b32 s12, s23
; GFX12-NEXT:    s_mov_b32 s18, s5
; GFX12-NEXT:    s_add_nc_u64 s[24:25], s[24:25], s[12:13]
; GFX12-NEXT:    s_mul_u64 s[16:17], s[16:17], s[18:19]
; GFX12-NEXT:    s_mov_b32 s12, s24
; GFX12-NEXT:    s_mul_u64 s[14:15], s[14:15], s[18:19]
; GFX12-NEXT:    s_add_nc_u64 s[16:17], s[16:17], s[12:13]
; GFX12-NEXT:    s_mov_b32 s12, s25
; GFX12-NEXT:    s_mov_b32 s20, s17
; GFX12-NEXT:    s_mul_u64 s[4:5], s[4:5], s[10:11]
; GFX12-NEXT:    s_add_nc_u64 s[18:19], s[12:13], s[20:21]
; GFX12-NEXT:    s_mul_u64 s[6:7], s[6:7], s[8:9]
; GFX12-NEXT:    s_add_nc_u64 s[10:11], s[14:15], s[18:19]
; GFX12-NEXT:    s_mov_b32 s8, s13
; GFX12-NEXT:    s_mov_b32 s9, s16
; GFX12-NEXT:    s_mov_b32 s23, s13
; GFX12-NEXT:    s_add_nc_u64 s[4:5], s[6:7], s[4:5]
; GFX12-NEXT:    s_or_b64 s[6:7], s[22:23], s[8:9]
; GFX12-NEXT:    s_add_nc_u64 s[4:5], s[10:11], s[4:5]
...
; GFX1250-NEXT:    s_clause 0x2
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX1250-NEXT:    s_load_b128 s[8:11], s[4:5], 0x4c nv
; GFX1250-NEXT:    s_load_b128 s[12:15], s[4:5], 0x7c nv
; GFX1250-NEXT:    s_mov_b64 s[6:7], 0xffffffff
; GFX1250-NEXT:    s_wait_xcnt 0x0
...
; GFX1250-NEXT:    s_mov_b32 s2, -1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_and_b64 s[6:7], s[8:9], s[6:7]
; GFX1250-NEXT:    s_mov_b32 s4, s12
; GFX1250-NEXT:    s_mov_b32 s16, s9
; GFX1250-NEXT:    s_mul_u64 s[22:23], s[6:7], s[4:5]
; GFX1250-NEXT:    s_mul_u64 s[24:25], s[16:17], s[4:5]
; GFX1250-NEXT:    s_mov_b32 s4, s23
; GFX1250-NEXT:    s_mov_b32 s18, s13
; GFX1250-NEXT:    s_add_nc_u64 s[24:25], s[24:25], s[4:5]
; GFX1250-NEXT:    s_mul_u64 s[6:7], s[6:7], s[18:19]
; GFX1250-NEXT:    s_mov_b32 s4, s24
; GFX1250-NEXT:    s_mul_u64 s[16:17], s[16:17], s[18:19]
; GFX1250-NEXT:    s_add_nc_u64 s[6:7], s[6:7], s[4:5]
; GFX1250-NEXT:    s_mov_b32 s4, s25
; GFX1250-NEXT:    s_mov_b32 s20, s7
; GFX1250-NEXT:    s_mul_u64 s[10:11], s[12:13], s[10:11]
; GFX1250-NEXT:    s_add_nc_u64 s[20:21], s[4:5], s[20:21]
; GFX1250-NEXT:    s_mul_u64 s[8:9], s[14:15], s[8:9]
; GFX1250-NEXT:    s_add_nc_u64 s[16:17], s[16:17], s[20:21]
; GFX1250-NEXT:    s_mov_b32 s12, s5
; GFX1250-NEXT:    s_mov_b32 s13, s6
; GFX1250-NEXT:    s_mov_b32 s23, s5
; GFX1250-NEXT:    s_add_nc_u64 s[4:5], s[8:9], s[10:11]
; GFX1250-NEXT:    s_or_b64 s[6:7], s[22:23], s[12:13]
; GFX1250-NEXT:    s_add_nc_u64 s[4:5], s[16:17], s[4:5]
...
; GFX13-NEXT:    s_clause 0x2
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GFX13-NEXT:    s_load_b128 s[8:11], s[4:5], 0x4c nv
; GFX13-NEXT:    s_load_b128 s[4:7], s[4:5], 0x7c nv
; GFX13-NEXT:    s_mov_b64 s[14:15], 0xffffffff
; GFX13-NEXT:    s_mov_b32 s13, 0
; GFX13-NEXT:    s_mov_b32 s17, 0
; GFX13-NEXT:    s_mov_b32 s19, 0
; GFX13-NEXT:    s_mov_b32 s21, 0
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_and_b64 s[14:15], s[8:9], s[14:15]
; GFX13-NEXT:    s_mov_b32 s12, s4
; GFX13-NEXT:    s_mov_b32 s16, s9
; GFX13-NEXT:    s_mul_u64 s[22:23], s[14:15], s[12:13]
; GFX13-NEXT:    s_mul_u64 s[24:25], s[16:17], s[12:13]
; GFX13-NEXT:    s_mov_b32 s12, s23
; GFX13-NEXT:    s_mov_b32 s18, s5
; GFX13-NEXT:    s_add_nc_u64 s[24:25], s[24:25], s[12:13]
; GFX13-NEXT:    s_mul_u64 s[14:15], s[14:15], s[18:19]
; GFX13-NEXT:    s_mov_b32 s12, s24
; GFX13-NEXT:    s_mul_u64 s[16:17], s[16:17], s[18:19]
; GFX13-NEXT:    s_add_nc_u64 s[14:15], s[14:15], s[12:13]
; GFX13-NEXT:    s_mov_b32 s12, s25
; GFX13-NEXT:    s_mov_b32 s20, s15
; GFX13-NEXT:    s_mul_u64 s[4:5], s[4:5], s[10:11]
; GFX13-NEXT:    s_add_nc_u64 s[10:11], s[12:13], s[20:21]
; GFX13-NEXT:    s_mul_u64 s[6:7], s[6:7], s[8:9]
; GFX13-NEXT:    s_add_nc_u64 s[8:9], s[16:17], s[10:11]
; GFX13-NEXT:    s_mov_b32 s10, s13
; GFX13-NEXT:    s_mov_b32 s11, s14
; GFX13-NEXT:    s_mov_b32 s23, s13
; GFX13-NEXT:    s_add_nc_u64 s[4:5], s[6:7], s[4:5]
; GFX13-NEXT:    s_or_b64 s[6:7], s[22:23], s[10:11]
; GFX13-NEXT:    s_add_nc_u64 s[4:5], s[8:9], s[4:5]
; GFX13-NEXT:    v_dual_mov_b32 v0, s6 :: v_dual_mov_b32 v1, s7
; GFX13-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null
; GFX13-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i128:
