...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck -check-prefix=ATTRIB %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-nsa-threshold=2 < %s | FileCheck -check-prefix=FORCE-2 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-nsa-threshold=3 < %s | FileCheck -check-prefix=FORCE-3 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -amdgpu-nsa-threshold=4 < %s | FileCheck -check-prefix=FORCE-4 %s
