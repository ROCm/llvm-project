...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 | FileCheck -check-prefixes=TONGA %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.10 | FileCheck -check-prefixes=GFX81 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.00 | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX10PLUS,GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX10PLUS,GFX11,GFX11-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX12PLUS,GFX12PLUS-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX12PLUS,GFX12-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu13.10 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX12PLUS,GFX12PLUS-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu13.10 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX12PLUS,GFX13-FAKE16 %s
