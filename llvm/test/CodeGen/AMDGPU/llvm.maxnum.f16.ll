...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=fiji -mattr=-flat-for-global < %s | FileCheck -enable-var-scope --check-prefix=VI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope --check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1010 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-flat-for-global,+real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx1100 -mattr=-flat-for-global,-real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-FAKE16 %s
...
; GFX10-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 glc dlc
...
; GFX10-NEXT:    v_pk_max_f16 v1, s2, s2
...
; SI-NEXT:    v_max_f32_e32 v2, v4, v3
; SI-NEXT:    v_cvt_f16_f32_e32 v1, v1
...
; GFX10-NEXT:    s_nop 0
; GFX10-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x0
; GFX10-NEXT:    s_mov_b32 s2, -1
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_pk_max_f16 v1, s5, s5
; GFX10-NEXT:    v_pk_max_f16 v2, s7, s7
; GFX10-NEXT:    v_pk_max_f16 v0, s4, s4
; GFX10-NEXT:    v_pk_max_f16 v3, s6, s6
...
; GFX11-NEXT:    v_pk_max_f16 v2, s7, s7
; GFX11-NEXT:    v_pk_max_f16 v0, s4, s4
; GFX11-NEXT:    v_pk_max_f16 v3, s6, s6
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_pk_max_f16 v0, s5, s5
; GFX9-NEXT:    v_pk_max_f16 v1, s7, s7
...
; GFX10-NEXT:    v_pk_max_f16 v3, s2, s2
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; SI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; SI-NEXT:    v_max_f32_e32 v3, 0x41000000, v3
; SI-NEXT:    v_cvt_f16_f32_e32 v3, v3
...
; VI-NEXT:    v_max_f16_e64 v0, s3, s3
; VI-NEXT:    v_max_f16_e64 v1, s0, s0
; VI-NEXT:    v_max_f16_e32 v0, 0x4200, v0
; VI-NEXT:    v_max_f16_sdwa v1, v1, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    s_lshr_b32 s0, s2, 16
...
; VI-NEXT:    v_max_f16_e32 v0, 0x4800, v0
...
; GFX9-NEXT:    s_mov_b32 s4, s0
; GFX9-NEXT:    s_mov_b32 s0, 0x40004800
; GFX9-NEXT:    s_mov_b32 s5, s1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
