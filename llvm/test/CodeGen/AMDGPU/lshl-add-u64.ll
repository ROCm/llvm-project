...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu9.42 < %s | FileCheck -check-prefixes=GISEL,GFX942-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.50 < %s | FileCheck -check-prefixes=GISEL,GFX1250-GISEL %s
