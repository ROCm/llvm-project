...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 < %s | FileCheck %s --check-prefixes=SI
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck %s --check-prefixes=VI
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu11.00 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu11.00 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
...
; VI-NEXT:    s_mov_b32 s5, 0x2f800000
; VI-NEXT:    v_mul_f32_e64 v1, |v0|, s5
...
; VI-NEXT:    s_mov_b32 s8, 0xcf800000
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_trunc_f32_e32 v0, s5
...
; VI-NEXT:    v_mul_f32_e64 v6, |v8|, s5
; VI-NEXT:    v_floor_f32_e32 v6, v6
; VI-NEXT:    v_cvt_u32_f32_e32 v9, v6
; VI-NEXT:    v_fma_f32 v6, v6, s8, |v8|
