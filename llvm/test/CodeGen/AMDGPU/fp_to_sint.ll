...
; VI-NEXT:    v_floor_f32_e32 v1, v1
; VI-NEXT:    v_trunc_f32_e32 v3, s4
; VI-NEXT:    v_fma_f32 v2, v1, s7, |v0|
; VI-NEXT:    v_mul_f32_e64 v4, |v3|, s6
; VI-NEXT:    v_cvt_u32_f32_e32 v2, v2
; VI-NEXT:    v_floor_f32_e32 v4, v4
; VI-NEXT:    v_cvt_u32_f32_e32 v1, v1
; VI-NEXT:    v_fma_f32 v5, v4, s7, |v3|
...
; VI-NEXT:    v_ashrrev_i32_e32 v6, 31, v3
; VI-NEXT:    v_sub_u32_e32 v2, vcc, v2, v0
; VI-NEXT:    v_xor_b32_e32 v5, v5, v6
; VI-NEXT:    v_subb_u32_e32 v3, vcc, v1, v0, vcc
; VI-NEXT:    v_xor_b32_e32 v4, v4, v6
; VI-NEXT:    v_sub_u32_e32 v0, vcc, v5, v6
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    v_subb_u32_e32 v1, vcc, v4, v6, vcc
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; VI-NEXT:    s_endpgm
;
...
; VI-NEXT:    v_fma_f32 v2, v1, s5, |v0|
; VI-NEXT:    v_cvt_u32_f32_e32 v2, v2
; VI-NEXT:    v_ashrrev_i32_e32 v4, 31, v0
; VI-NEXT:    v_cvt_u32_f32_e32 v0, v1
; VI-NEXT:    v_trunc_f32_e32 v1, s8
; VI-NEXT:    v_xor_b32_e32 v5, v2, v4
; VI-NEXT:    v_mul_f32_e64 v2, |v1|, s4
; VI-NEXT:    v_floor_f32_e32 v2, v2
; VI-NEXT:    v_fma_f32 v3, v2, s5, |v1|
; VI-NEXT:    v_cvt_u32_f32_e32 v3, v3
; VI-NEXT:    v_ashrrev_i32_e32 v7, 31, v1
; VI-NEXT:    v_trunc_f32_e32 v1, s11
; VI-NEXT:    v_xor_b32_e32 v6, v0, v4
; VI-NEXT:    v_cvt_u32_f32_e32 v0, v2
; VI-NEXT:    v_mul_f32_e64 v2, |v1|, s4
; VI-NEXT:    v_floor_f32_e32 v2, v2
; VI-NEXT:    v_xor_b32_e32 v8, v3, v7
; VI-NEXT:    v_fma_f32 v3, v2, s5, |v1|
; VI-NEXT:    v_cvt_u32_f32_e32 v3, v3
; VI-NEXT:    v_ashrrev_i32_e32 v1, 31, v1
; VI-NEXT:    v_xor_b32_e32 v9, v0, v7
; VI-NEXT:    v_cvt_u32_f32_e32 v0, v2
; VI-NEXT:    v_xor_b32_e32 v2, v3, v1
; VI-NEXT:    v_trunc_f32_e32 v3, s10
; VI-NEXT:    v_mul_f32_e64 v10, |v3|, s4
; VI-NEXT:    v_floor_f32_e32 v10, v10
; VI-NEXT:    v_fma_f32 v11, v10, s5, |v3|
; VI-NEXT:    v_cvt_u32_f32_e32 v11, v11
; VI-NEXT:    v_cvt_u32_f32_e32 v10, v10
; VI-NEXT:    v_xor_b32_e32 v0, v0, v1
; VI-NEXT:    v_ashrrev_i32_e32 v12, 31, v3
; VI-NEXT:    v_sub_u32_e32 v2, vcc, v2, v1
; VI-NEXT:    v_xor_b32_e32 v11, v11, v12
; VI-NEXT:    v_subb_u32_e32 v3, vcc, v0, v1, vcc
; VI-NEXT:    v_xor_b32_e32 v10, v10, v12
; VI-NEXT:    v_sub_u32_e32 v0, vcc, v11, v12
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    v_subb_u32_e32 v1, vcc, v10, v12, vcc
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:16
; VI-NEXT:    s_nop 0
; VI-NEXT:    v_sub_u32_e32 v2, vcc, v5, v4
; VI-NEXT:    v_subb_u32_e32 v3, vcc, v6, v4, vcc
; VI-NEXT:    v_sub_u32_e32 v0, vcc, v8, v7
; VI-NEXT:    v_subb_u32_e32 v1, vcc, v9, v7, vcc
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; VI-NEXT:    s_endpgm
;
