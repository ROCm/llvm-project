; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -enable-amdgpu-aa=0 -misched=gcn-iterative-minreg < %s | FileCheck --check-prefix=SI-MINREG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -enable-amdgpu-aa=0 -misched=gcn-iterative-max-occupancy-experimental < %s | FileCheck --check-prefix=SI-MAXOCC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -enable-amdgpu-aa=0 -amdgpu-sched-strategy=iterative-minreg < %s | FileCheck --check-prefix=SI-MINREG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu6.00 -enable-amdgpu-aa=0 -amdgpu-sched-strategy=iterative-maxocc < %s | FileCheck --check-prefix=SI-MAXOCC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -enable-amdgpu-aa=0 -misched=gcn-iterative-minreg < %s | FileCheck --check-prefix=VI-MINREG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -enable-amdgpu-aa=0 -misched=gcn-iterative-max-occupancy-experimental < %s | FileCheck --check-prefix=VI-MAXOCC %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -enable-amdgpu-aa=0 -amdgpu-sched-strategy=iterative-minreg < %s | FileCheck --check-prefix=VI-MINREG %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu8.03 -enable-amdgpu-aa=0 -amdgpu-sched-strategy=iterative-maxocc < %s | FileCheck --check-prefix=VI-MAXOCC %s
