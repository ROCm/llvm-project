...
; SI-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v1
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_add_i32_e64 v0, s[0:1], v2, v0
; SI-NEXT:    v_addc_u32_e64 v1, s[0:1], v3, v1, s[0:1]
; SI-NEXT:    v_cmp_lt_i64_e64 s[0:1], v[0:1], v[2:3]
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[8:11], 0
; SI-NEXT:    s_xor_b64 s[0:1], vcc, s[0:1]
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
...
; VI-NEXT:    v_mov_b32_e32 v0, s4
; VI-NEXT:    flat_load_dwordx2 v[2:3], v[1:2]
; VI-NEXT:    v_mov_b32_e32 v1, s5
...
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_add_u32_e64 v2, s[0:1], v0, v2
; VI-NEXT:    v_addc_u32_e64 v3, s[0:1], v1, v3, s[0:1]
; VI-NEXT:    v_cmp_lt_i64_e64 s[0:1], v[2:3], v[0:1]
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dwordx2 v[0:1], v4, s[14:15]
; GFX9-NEXT:    global_load_dwordx2 v[2:3], v4, s[12:13]
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_add_co_u32_e64 v0, s[0:1], v2, v0
; GFX9-NEXT:    v_addc_co_u32_e64 v1, s[0:1], v3, v1, s[0:1]
; GFX9-NEXT:    v_cmp_lt_i64_e64 s[0:1], v[0:1], v[2:3]
