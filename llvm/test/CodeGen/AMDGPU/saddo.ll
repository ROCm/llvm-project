...
; GFX10-NEXT:    s_add_u32 s2, s4, s2
; GFX10-NEXT:    s_addc_u32 s3, s5, s3
...
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_xor_b64 s[8:9], s[10:11], s[8:9]
...
; SI-NEXT:    v_cmp_lt_i64_e32 vcc, v[4:5], v[0:1]
