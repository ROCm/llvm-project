...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42-amd-amdhsa %s -o - | FileCheck -check-prefixes=GFX942,GFX942-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel -mtriple=amdgpu9.42-amd-amdhsa %s -o - | FileCheck -check-prefixes=GFX942,GFX942-GISEL %s
...
; GFX942-SDAG:       ; %bb.0:
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e64 s[0:1], 0, v[2:3]
...
; GFX942-SDAG-NEXT:  .LBB7_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[2:3], v[2:3]
...
; GFX942-SDAG-NEXT:  .LBB7_3: ; %memset.pattern-post-expansion
...
; GFX942-GISEL-NEXT:  .LBB7_1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-GISEL-NEXT:    s_mov_b32 s4, 0xdddddddd
; GFX942-GISEL-NEXT:    s_mov_b32 s5, 0xcccccccc
; GFX942-GISEL-NEXT:    s_mov_b32 s6, 0xbbbbbbbb
; GFX942-GISEL-NEXT:    s_mov_b32 s7, 0xaaaaaaaa
...
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[2:3], v[2:3]
...
; GFX942-GISEL-NEXT:  .LBB7_3: ; %memset.pattern-post-expansion
...
; GFX942-SDAG-NEXT:  .LBB8_1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v2, 0xdddddddd
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v3, 0xcccccccc
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v4, 0xbbbbbbbb
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v5, 0xaaaaaaaa
...
; GFX942-SDAG-NEXT:    s_add_u32 s2, s2, 1
; GFX942-SDAG-NEXT:    s_addc_u32 s3, s3, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[2:3], v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GFX942-SDAG-NEXT:    ds_write_b128 v0, v[2:5]
...
; GFX942-SDAG-NEXT:  .LBB8_3: ; %memset.pattern-post-expansion
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-GISEL-NEXT:  .LBB8_1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-GISEL-NEXT:    s_mov_b32 s4, 0xdddddddd
; GFX942-GISEL-NEXT:    s_mov_b32 s5, 0xcccccccc
; GFX942-GISEL-NEXT:    s_mov_b32 s6, 0xbbbbbbbb
; GFX942-GISEL-NEXT:    s_mov_b32 s7, 0xaaaaaaaa
...
; GFX942-GISEL-NEXT:    s_add_u32 s2, s2, 1
; GFX942-GISEL-NEXT:    s_addc_u32 s3, s3, 0
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[2:3], v[6:7]
; GFX942-GISEL-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GFX942-GISEL-NEXT:    ds_write_b128 v0, v[2:5]
...
; GFX942-GISEL-NEXT:  .LBB8_3: ; %memset.pattern-post-expansion
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-SDAG-NEXT:  .LBB9_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-SDAG-NEXT:  .LBB9_3: ; %memset.pattern-expansion-residual-cond
...
; GFX942-SDAG-NEXT:  .LBB9_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-SDAG-NEXT:  .LBB9_6: ; %memset.pattern-post-expansion
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-GISEL-NEXT:  .LBB9_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-GISEL-NEXT:    s_add_u32 s4, s4, 4
...
; GFX942-GISEL-NEXT:  .LBB9_3: ; %memset.pattern-expansion-residual-cond
...
; GFX942-GISEL-NEXT:  .LBB9_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-GISEL-NEXT:  .LBB9_6: ; %memset.pattern-post-expansion
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX942-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-SDAG-NEXT:  .LBB10_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-SDAG-NEXT:  .LBB10_3: ; %memset.pattern-expansion-residual-cond
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[2:3]
...
; GFX942-SDAG-NEXT:  .LBB10_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-SDAG-NEXT:  .LBB10_6: ; %memset.pattern-post-expansion
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-GISEL-NEXT:  .LBB10_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-GISEL-NEXT:  .LBB10_3: ; %memset.pattern-expansion-residual-cond
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-GISEL-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[6:7]
; GFX942-GISEL-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX942-GISEL-NEXT:    s_mov_b64 s[2:3], 0
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], s[0:1], vcc
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX942-GISEL-NEXT:  .LBB10_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-GISEL-NEXT:  .LBB10_6: ; %memset.pattern-post-expansion
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX942-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-SDAG-NEXT:    s_xor_b64 s[4:5], s[0:1], exec
; GFX942-SDAG-NEXT:    s_mov_b64 s[2:3], 0
; GFX942-SDAG-NEXT:  .LBB11_1: ; %memset.pattern-expansion-main-body
; GFX942-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
; GFX942-SDAG-NEXT:    s_cbranch_execz .LBB11_3
; GFX942-SDAG-NEXT:  .LBB11_2: ; %memset.pattern-expansion-main-body
; GFX942-SDAG-NEXT:    ; in Loop: Header=BB11_1 Depth=1
; GFX942-SDAG-NEXT:    s_add_u32 s2, s2, 1
; GFX942-SDAG-NEXT:    s_addc_u32 s3, s3, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[2:3], v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, 16
; GFX942-SDAG-NEXT:    s_or_b64 s[0:1], s[0:1], s[6:7]
; GFX942-SDAG-NEXT:    s_branch .LBB11_1
; GFX942-SDAG-NEXT:  .LBB11_3: ; %memset.pattern-post-expansion
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-GISEL-NEXT:    s_xor_b64 s[4:5], s[0:1], exec
; GFX942-GISEL-NEXT:    s_mov_b64 s[2:3], 0
; GFX942-GISEL-NEXT:  .LBB11_1: ; %memset.pattern-expansion-main-body
; GFX942-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[4:5]
; GFX942-GISEL-NEXT:    ; divergent control-flow edge
; GFX942-GISEL-NEXT:    s_cbranch_execz .LBB11_3
; GFX942-GISEL-NEXT:  .LBB11_2: ; %memset.pattern-expansion-main-body
; GFX942-GISEL-NEXT:    ; in Loop: Header=BB11_1 Depth=1
; GFX942-GISEL-NEXT:    s_add_u32 s2, s2, 1
; GFX942-GISEL-NEXT:    s_addc_u32 s3, s3, 0
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[2:3], v[8:9]
...
; GFX942-GISEL-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], s[0:1], s[6:7]
; GFX942-GISEL-NEXT:    s_branch .LBB11_1
; GFX942-GISEL-NEXT:  .LBB11_3: ; %memset.pattern-post-expansion
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[10:11]
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-SDAG-NEXT:    v_and_b32_e32 v6, 1, v8
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v7, 0
; GFX942-SDAG-NEXT:    s_mov_b64 s[8:9], 0
; GFX942-SDAG-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-SDAG-NEXT:    s_mov_b64 exec, s[10:11]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
; GFX942-SDAG-NEXT:    s_cbranch_execz .LBB12_3
; GFX942-SDAG-NEXT:  .LBB12_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e64 s[10:11], s[8:9], v[10:11]
; GFX942-SDAG-NEXT:    s_xor_b64 s[12:13], exec, s[10:11]
; GFX942-SDAG-NEXT:    buffer_store_dwordx4 v[2:5], v1, s[0:3], 0 offen
; GFX942-SDAG-NEXT:    v_add_u32_e32 v1, 32, v1
; GFX942-SDAG-NEXT:    s_or_b64 s[6:7], s[6:7], s[12:13]
; GFX942-SDAG-NEXT:    s_mov_b64 exec, s[10:11]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
; GFX942-SDAG-NEXT:    s_cbranch_execnz .LBB12_2
; GFX942-SDAG-NEXT:  .LBB12_3: ; %memset.pattern-expansion-residual-cond
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX942-SDAG-NEXT:    s_or_b64 s[4:5], s[4:5], vcc
; GFX942-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
; GFX942-SDAG-NEXT:    s_cbranch_execz .LBB12_6
; GFX942-SDAG-NEXT:  .LBB12_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-SDAG-NEXT:  .LBB12_6: ; %memset.pattern-post-expansion
...
; GFX942-GISEL-NEXT:    s_nop 0
; GFX942-GISEL-NEXT:    v_subbrev_co_u32_e32 v11, vcc, 0, v9, vcc
; GFX942-GISEL-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[10:11]
; GFX942-GISEL-NEXT:    s_mov_b64 s[8:9], 0
; GFX942-GISEL-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; GFX942-GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[10:11]
; GFX942-GISEL-NEXT:    ; divergent control-flow edge
; GFX942-GISEL-NEXT:    s_cbranch_execz .LBB12_3
; GFX942-GISEL-NEXT:  .LBB12_1: ; %memset.pattern-expansion-main-body.preheader
...
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[10:11], s[8:9], v[10:11]
; GFX942-GISEL-NEXT:    s_xor_b64 s[12:13], exec, s[10:11]
; GFX942-GISEL-NEXT:    buffer_store_dwordx4 v[2:5], v1, s[0:3], 0 offen
; GFX942-GISEL-NEXT:    v_add_u32_e32 v1, 32, v1
; GFX942-GISEL-NEXT:    s_or_b64 s[6:7], s[6:7], s[12:13]
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[10:11]
; GFX942-GISEL-NEXT:    ; divergent control-flow edge
; GFX942-GISEL-NEXT:    s_cbranch_execnz .LBB12_2
; GFX942-GISEL-NEXT:  .LBB12_3: ; %memset.pattern-expansion-residual-cond
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX942-GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[6:7]
; GFX942-GISEL-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX942-GISEL-NEXT:    s_xor_b64 s[8:9], s[6:7], exec
; GFX942-GISEL-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[8:9]
; GFX942-GISEL-NEXT:    ; divergent control-flow edge
; GFX942-GISEL-NEXT:    s_cbranch_execz .LBB12_6
; GFX942-GISEL-NEXT:  .LBB12_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[8:9], s[6:7], v[6:7]
; GFX942-GISEL-NEXT:    s_xor_b64 s[10:11], exec, s[8:9]
; GFX942-GISEL-NEXT:    buffer_store_dwordx2 v[0:1], v2, s[0:3], 0 offen
; GFX942-GISEL-NEXT:    v_add_u32_e32 v2, 8, v2
; GFX942-GISEL-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[8:9]
; GFX942-GISEL-NEXT:    ; divergent control-flow edge
; GFX942-GISEL-NEXT:    s_cbranch_execnz .LBB12_5
; GFX942-GISEL-NEXT:  .LBB12_6: ; %memset.pattern-post-expansion
...
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[6:7]
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v8, v3
...
; GFX942-SDAG-NEXT:  .LBB13_1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-SDAG-NEXT:    v_add_u32_e32 v1, s16, v0
...
; GFX942-SDAG-NEXT:    s_add_u32 s8, s8, 2
; GFX942-SDAG-NEXT:    s_addc_u32 s9, s9, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e64 s[10:11], s[8:9], v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[12:13], exec, s[10:11]
...
; GFX942-SDAG-NEXT:  .LBB13_3: ; %memset.pattern-expansion-residual-cond
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX942-SDAG-NEXT:    s_or_b64 s[4:5], s[4:5], vcc
; GFX942-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
; GFX942-SDAG-NEXT:    s_cbranch_execz .LBB13_6
; GFX942-SDAG-NEXT:  .LBB13_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-SDAG-NEXT:    s_add_u32 s6, s6, 1
; GFX942-SDAG-NEXT:    s_addc_u32 s7, s7, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e64 s[8:9], s[6:7], v[2:3]
; GFX942-SDAG-NEXT:    s_xor_b64 s[10:11], exec, s[8:9]
...
; GFX942-SDAG-NEXT:  .LBB13_6: ; %memset.pattern-post-expansion
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-GISEL-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[4:5]
; GFX942-GISEL-NEXT:    s_mov_b64 s[8:9], 0
; GFX942-GISEL-NEXT:    s_xor_b64 s[10:11], s[6:7], exec
; GFX942-GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-GISEL-NEXT:    s_mov_b64 exec, s[10:11]
...
; GFX942-GISEL-NEXT:  .LBB13_1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-GISEL-NEXT:    v_add_u32_e32 v1, s16, v0
...
; GFX942-GISEL-NEXT:    s_add_u32 s8, s8, 2
; GFX942-GISEL-NEXT:    s_addc_u32 s9, s9, 0
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[10:11], s[8:9], v[4:5]
; GFX942-GISEL-NEXT:    s_xor_b64 s[12:13], exec, s[10:11]
...
; GFX942-GISEL-NEXT:  .LBB13_3: ; %memset.pattern-expansion-residual-cond
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[6:7]
...
; GFX942-GISEL-NEXT:  .LBB13_4: ; %memset.pattern-expansion-residual-body.preheader
...
; GFX942-GISEL-NEXT:    s_add_u32 s6, s6, 1
; GFX942-GISEL-NEXT:    s_addc_u32 s7, s7, 0
; GFX942-GISEL-NEXT:    v_cmp_lt_u64_e64 s[8:9], s[6:7], v[2:3]
; GFX942-GISEL-NEXT:    s_xor_b64 s[10:11], exec, s[8:9]
...
; GFX942-GISEL-NEXT:  .LBB13_6: ; %memset.pattern-post-expansion
; GFX942-GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX942-GISEL-NEXT:    s_setpc_b64 s[30:31]
  %p = getelementptr inbounds i8, ptr addrspace(7) %a, i32 %offset
