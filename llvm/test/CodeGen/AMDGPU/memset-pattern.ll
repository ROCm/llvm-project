...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 %s -o - | FileCheck -check-prefixes=GFX942,GFX942-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx942 %s -o - | FileCheck -check-prefixes=GFX942,GFX942-GISEL %s
...
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], s[0:1], exec
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], -1
...
; GFX942-SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[2:3], v[2:3]
...
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v4, 0xdddddddd
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v5, 0xcccccccc
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v6, 0xbbbbbbbb
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v7, 0xaaaaaaaa
...
; GFX942-GISEL-NEXT:    v_cmp_ge_u64_e32 vcc, s[4:5], v[2:3]
; GFX942-GISEL-NEXT:    global_store_dwordx4 v[0:1], v[4:7], off
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, 16
...
; GFX942-GISEL-NEXT:  ; %bb.1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v2, 0xdddddddd
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v3, 0xcccccccc
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v4, 0xbbbbbbbb
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v5, 0xaaaaaaaa
; GFX942-GISEL-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX942-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-SDAG-NEXT:    s_add_u32 s6, s6, 4
...
; GFX942-SDAG-NEXT:    s_and_b64 s[2:3], s[2:3], exec
...
; GFX942-GISEL:       ; %bb.0:
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-GISEL-NEXT:    v_and_b32_e32 v10, -4, v2
...
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[12:13], v[12:13], 0, 64
; GFX942-GISEL-NEXT:    s_andn2_b64 exec, exec, s[0:1]
...
; GFX942-GISEL-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, 4
; GFX942-GISEL-NEXT:    s_andn2_b64 exec, exec, s[0:1]
...
; GFX942-SDAG-NEXT:    s_add_u32 s4, s4, 1
; GFX942-SDAG-NEXT:    s_addc_u32 s5, s5, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[4:5], v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[2:3], exec, vcc
; GFX942-SDAG-NEXT:    global_store_dword v[0:1], v2, off
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, 4
; GFX942-SDAG-NEXT:    s_or_b64 s[0:1], s[0:1], s[2:3]
...
; GFX942-GISEL-NEXT:    v_and_b32_e32 v10, -4, v8
...
; GFX942-GISEL-NEXT:  ; %bb.4: ; %memset.pattern-expansion-residual-body.preheader
; GFX942-GISEL-NEXT:    v_lshlrev_b64 v[4:5], 2, v[8:9]
; GFX942-GISEL-NEXT:    v_and_b32_e32 v4, -16, v4
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, v[4:5]
; GFX942-GISEL-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX942-SDAG-NEXT:  .LBB11_1: ; %memset.pattern-expansion-main-body.preheader
; GFX942-SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v6, v5
; GFX942-GISEL-NEXT:    s_mov_b64 s[0:1], 0
; GFX942-GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[6:7]
; GFX942-GISEL-NEXT:    s_and_saveexec_b64 s[2:3], vcc
...
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e64 s[8:9], 0, v[10:11]
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-SDAG-NEXT:    v_and_b32_e32 v6, 1, v8
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v7, 0
; GFX942-SDAG-NEXT:    s_mov_b64 s[10:11], 0
; GFX942-SDAG-NEXT:    s_xor_b64 s[12:13], s[8:9], exec
; GFX942-SDAG-NEXT:    s_mov_b64 s[6:7], -1
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX942-SDAG-NEXT:    s_and_b64 s[12:13], s[6:7], exec
...
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[10:11], v[10:11]
; GFX942-SDAG-NEXT:    s_xor_b64 s[12:13], exec, vcc
; GFX942-SDAG-NEXT:    buffer_store_dwordx4 v[2:5], v1, s[0:3], 0 offen
; GFX942-SDAG-NEXT:    v_add_u32_e32 v1, 32, v1
; GFX942-SDAG-NEXT:    s_or_b64 s[8:9], s[8:9], s[12:13]
; GFX942-SDAG-NEXT:    s_mov_b64 exec, vcc
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[8:9], vcc, exec
...
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v11, v2
; GFX942-GISEL-NEXT:    v_and_b32_e32 v10, -2, v8
...
; GFX942-GISEL-NEXT:  ; %bb.4: ; %memset.pattern-expansion-residual-body.preheader
; GFX942-GISEL-NEXT:    v_lshlrev_b32_e32 v1, 3, v8
; GFX942-GISEL-NEXT:    v_and_b32_e32 v1, -16, v1
...
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e64 s[8:9], 0, v[6:7]
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-SDAG-NEXT:    v_mov_b32_e32 v8, v3
...
; GFX942-SDAG-NEXT:    s_add_u32 s10, s10, 2
; GFX942-SDAG-NEXT:    s_addc_u32 s11, s11, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[10:11], v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[12:13], exec, vcc
...
; GFX942-SDAG-NEXT:    s_add_u32 s8, s8, 1
; GFX942-SDAG-NEXT:    s_addc_u32 s9, s9, 0
; GFX942-SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[8:9], v[2:3]
; GFX942-SDAG-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v7, v2
; GFX942-GISEL-NEXT:    v_and_b32_e32 v6, -2, v4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v8, v3
...
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v11, v9
; GFX942-GISEL-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX942-GISEL-NEXT:  ; %bb.4: ; %memset.pattern-expansion-residual-body.preheader
; GFX942-GISEL-NEXT:    v_lshlrev_b32_e32 v1, 3, v4
; GFX942-GISEL-NEXT:    v_and_b32_e32 v1, -16, v1
