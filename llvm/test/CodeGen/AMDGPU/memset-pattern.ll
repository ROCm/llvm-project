...
; GFX942-SDAG-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX942-SDAG-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX942-SDAG-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX942-SDAG-NEXT:    s_mov_b64 s[2:3], -1
; GFX942-SDAG-NEXT:    s_mov_b64 s[6:7], 0
; GFX942-SDAG-NEXT:    s_and_saveexec_b64 s[6:7], s[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX942-SDAG-NEXT:    s_or_b64 s[6:7], s[6:7], s[8:9]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX942-SDAG-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
...
; GFX942-SDAG-NEXT:    s_and_saveexec_b64 s[10:11], s[4:5]
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX942-SDAG-NEXT:    s_and_saveexec_b64 s[12:13], vcc
; GFX942-SDAG-NEXT:    s_or_b64 s[10:11], s[10:11], s[12:13]
; GFX942-SDAG-NEXT:    ; divergent control-flow edge
; GFX942-SDAG-NEXT:    s_cbranch_execnz .LBB12_2
; GFX942-SDAG-NEXT:  .LBB12_3: ; %memset.pattern-expansion-residual-cond
; GFX942-SDAG-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX942-SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[6:7]
; GFX942-SDAG-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX942-SDAG-NEXT:    s_and_saveexec_b64 s[8:9], s[8:9]
