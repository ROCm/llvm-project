...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01-amd-amdhsa -mattr=-unaligned-access-mode < %s | FileCheck --check-prefix=GFX7-ALIGNED %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX7-UNALIGNED %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX11 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX12 %s
