; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 --amdgpu-xnack=false -enable-misched=0 < %s | FileCheck -check-prefix=GCN %s
...
attributes #0 = {"amdgpu-num-vgpr"="11"}
