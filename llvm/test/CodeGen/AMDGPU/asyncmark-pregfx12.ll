...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck %s -check-prefixes=SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck %s -check-prefixes=GISEL
...
; SDAG-NEXT:    v_mov_b32_e32 v12, v9
...
; SDAG-NEXT:    v_mov_b32_e32 v17, v11
; SDAG-NEXT:    v_mov_b32_e32 v11, v8
; SDAG-NEXT:    v_mov_b32_e32 v15, v10
; SDAG-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
; SDAG-NEXT:    ; asyncmark
; SDAG-NEXT:    ; wait_asyncmark(2)
; SDAG-NEXT:    s_mov_b64 exec, s[8:9]
...
; SDAG-NEXT:    v_add_u32_e32 v1, v9, v14
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
