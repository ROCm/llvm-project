...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00-- -denormal-fp-math-f32=preserve-sign -mattr=+fast-fmaf -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=SI-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.01--  -denormal-fp-math-f32=preserve-sign -mattr=-fast-fmaf -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=SI-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00-- -denormal-fp-math-f32=ieee -mattr=+fast-fmaf -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=SI-DENORM-FASTFMA,SI-DENORM-FASTFMA-STRICT %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.01--  -denormal-fp-math-f32=ieee -mattr=-fast-fmaf -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=SI-DENORM-SLOWFMA %s

; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00-- -denormal-fp-math-f32=preserve-sign -mattr=+fast-fmaf -fp-contract=fast < %s | FileCheck -enable-var-scope -check-prefixes=SI-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.01--  -denormal-fp-math-f32=preserve-sign -mattr=-fast-fmaf -fp-contract=fast < %s | FileCheck -enable-var-scope -check-prefixes=SI-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00-- -denormal-fp-math-f32=ieee -mattr=+fast-fmaf -fp-contract=fast < %s | FileCheck -enable-var-scope -check-prefixes=SI-DENORM-FASTFMA,SI-DENORM-FASTFMA-CONTRACT %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.01--  -denormal-fp-math-f32=ieee -mattr=-fast-fmaf -fp-contract=fast < %s | FileCheck -enable-var-scope -check-prefixes=SI-DENORM-SLOWFMA %s

; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00-- -denormal-fp-math-f32=preserve-sign -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-FLUSH,GFX9-FLUSH-MAD %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00-- -denormal-fp-math-f32=ieee -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-DENORM,GFX9-DENORM-FASTFMA-MAD %s

; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.06-- -denormal-fp-math-f32=preserve-sign -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-FLUSH,GFX9-FLUSH-FMAC %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.06-- -denormal-fp-math-f32=ieee -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-DENORM,GFX9-DENORM-FASTFMA-FMAC %s

; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.30-- -denormal-fp-math-f32=preserve-sign -mattr=+mad-mac-f32-insts -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=GFX10,GFX10-FLUSH %s
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.30-- -denormal-fp-math-f32=ieee -mattr=+mad-mac-f32-insts -fp-contract=on < %s | FileCheck -enable-var-scope -check-prefixes=GFX10,GFX10-DENORM %s
...
; SI-FLUSH-NEXT:    s_mov_b32 s8, s2
; SI-FLUSH-NEXT:    s_mov_b32 s9, s3
; SI-FLUSH-NEXT:    s_mov_b32 s12, s4
; SI-FLUSH-NEXT:    s_mov_b32 s13, s5
; SI-FLUSH-NEXT:    s_mov_b32 s4, s6
; SI-FLUSH-NEXT:    s_mov_b32 s5, s7
; SI-FLUSH-NEXT:    s_mov_b32 s6, s10
; SI-FLUSH-NEXT:    s_mov_b32 s7, s11
; SI-FLUSH-NEXT:    buffer_load_dword v0, off, s[8:11], 0
; SI-FLUSH-NEXT:    buffer_load_dword v1, off, s[12:15], 0
; SI-FLUSH-NEXT:    buffer_load_dword v2, off, s[4:7], 0
; SI-FLUSH-NEXT:    s_mov_b32 s2, s10
; SI-FLUSH-NEXT:    s_mov_b32 s3, s11
; SI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; SI-FLUSH-NEXT:    v_mac_f32_e32 v2, v0, v1
; SI-FLUSH-NEXT:    buffer_store_dword v2, off, s[0:3], 0
...
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s8, s2
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s9, s3
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s12, s4
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s13, s5
...
; SI-DENORM-FASTFMA-NEXT:    buffer_load_dword v0, off, s[8:11], 0
; SI-DENORM-FASTFMA-NEXT:    buffer_load_dword v1, off, s[12:15], 0
; SI-DENORM-FASTFMA-NEXT:    buffer_load_dword v2, off, s[4:7], 0
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s2, s10
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s3, s11
; SI-DENORM-FASTFMA-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-NEXT:    v_fma_f32 v0, v0, v1, v2
; SI-DENORM-FASTFMA-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s8, s2
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s9, s3
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s12, s4
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s13, s5
...
; SI-DENORM-SLOWFMA-NEXT:    buffer_load_dword v0, off, s[8:11], 0
; SI-DENORM-SLOWFMA-NEXT:    buffer_load_dword v1, off, s[12:15], 0
; SI-DENORM-SLOWFMA-NEXT:    buffer_load_dword v2, off, s[4:7], 0
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s2, s10
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s3, s11
...
; SI-DENORM-SLOWFMA-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-FLUSH-NEXT:    s_mov_b32 s6, s10
; SI-FLUSH-NEXT:    s_mov_b32 s7, s11
; SI-FLUSH-NEXT:    buffer_load_dword v0, off, s[8:11], 0 glc
; SI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; SI-FLUSH-NEXT:    buffer_load_dword v1, off, s[12:15], 0 glc
; SI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
...
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_mov_b32 s8, s2
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_mov_b32 s9, s3
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_mov_b32 s12, s4
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_mov_b32 s13, s5
...
; SI-DENORM-FASTFMA-STRICT-NEXT:    buffer_load_dword v0, off, s[8:11], 0 glc
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-STRICT-NEXT:    buffer_load_dword v1, off, s[12:15], 0 glc
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-STRICT-NEXT:    buffer_load_dword v2, off, s[4:7], 0 glc
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_mov_b32 s2, s10
; SI-DENORM-FASTFMA-STRICT-NEXT:    s_mov_b32 s3, s11
; SI-DENORM-FASTFMA-STRICT-NEXT:    v_mul_f32_e32 v0, v0, v1
; SI-DENORM-FASTFMA-STRICT-NEXT:    v_add_f32_e32 v0, v0, v2
; SI-DENORM-FASTFMA-STRICT-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s6, s10
; SI-DENORM-SLOWFMA-NEXT:    s_mov_b32 s7, s11
; SI-DENORM-SLOWFMA-NEXT:    buffer_load_dword v0, off, s[8:11], 0 glc
; SI-DENORM-SLOWFMA-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-SLOWFMA-NEXT:    buffer_load_dword v1, off, s[12:15], 0 glc
; SI-DENORM-SLOWFMA-NEXT:    s_waitcnt vmcnt(0)
...
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_mov_b32 s8, s2
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_mov_b32 s9, s3
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_mov_b32 s12, s4
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_mov_b32 s13, s5
...
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    buffer_load_dword v0, off, s[8:11], 0 glc
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    buffer_load_dword v1, off, s[12:15], 0 glc
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    buffer_load_dword v2, off, s[4:7], 0 glc
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_mov_b32 s2, s10
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    s_mov_b32 s3, s11
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    v_fma_f32 v0, v0, v1, v2
; SI-DENORM-FASTFMA-CONTRACT-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s6, s10
; SI-DENORM-FASTFMA-NEXT:    s_mov_b32 s7, s11
; SI-DENORM-FASTFMA-NEXT:    buffer_load_dword v0, off, s[8:11], 0 glc
; SI-DENORM-FASTFMA-NEXT:    s_waitcnt vmcnt(0)
; SI-DENORM-FASTFMA-NEXT:    buffer_load_dword v1, off, s[12:15], 0 glc
; SI-DENORM-FASTFMA-NEXT:    s_waitcnt vmcnt(0)
