...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=tahiti < %s | FileCheck -check-prefix=GFX6 %s
...
; GFX12-NEXT:    s_mov_b32 s0, 0
; GFX12-NEXT:    ds_load_b64 v[0:1], v2
...
; GFX942-NEXT:    ds_read_b64 v[4:5], v2
; GFX942-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    ds_load_b64 v[0:1], v2
...
; GFX10-NEXT:    s_mov_b32 s4, 0
; GFX10-NEXT:    ds_read_b64 v[0:1], v2
...
; GFX90A-NEXT:    ds_read_b64 v[4:5], v2
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX908-NEXT:    ds_read_b64 v[0:1], v2
; GFX908-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    ds_read_b64 v[0:1], v2
; GFX8-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    ds_read_b64 v[0:1], v2
; GFX7-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX12-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-NEXT:    s_mov_b32 s0, 0
; GFX12-NEXT:    ds_load_b64 v[0:1], v2 offset:65528
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v2, v0
; GFX942-NEXT:    ds_read_b64 v[4:5], v2 offset:65528
; GFX942-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    ds_load_b64 v[0:1], v2 offset:65528
...
; GFX10-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-NEXT:    s_mov_b32 s4, 0
; GFX10-NEXT:    ds_read_b64 v[0:1], v2 offset:65528
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-NEXT:    ds_read_b64 v[4:5], v2 offset:65528
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX908-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_mov_b32_e32 v2, v0
; GFX908-NEXT:    ds_read_b64 v[0:1], v2 offset:65528
; GFX908-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX8-NEXT:    v_mov_b32_e32 v2, v0
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    ds_read_b64 v[0:1], v2 offset:65528
; GFX8-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    ds_read_b64 v[0:1], v2 offset:65528
; GFX7-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX12-TRUE16-NEXT:  .LBB8_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:  .LBB8_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-TRUE16-NEXT:  .LBB8_2: ; %atomicrmw.end
...
; GFX11-FAKE16-NEXT:  .LBB8_2: ; %atomicrmw.end
...
; GFX12-TRUE16-NEXT:  .LBB9_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:  .LBB9_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:  .LBB9_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:  .LBB9_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_e32 v4, v0, v2
; GFX908-NEXT:    v_add_f16_e32 v4, -4.0, v4
; GFX908-NEXT:    v_lshlrev_b32_e32 v4, v0, v4
; GFX908-NEXT:    v_and_or_b32 v4, v2, v3, v4
; GFX908-NEXT:    ds_cmpst_rtn_b32 v4, v1, v2, v4
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_e32 v4, v0, v2
; GFX8-NEXT:    v_add_f16_e32 v4, -4.0, v4
; GFX8-NEXT:    v_lshlrev_b32_e32 v4, v0, v4
; GFX8-NEXT:    v_and_b32_e32 v5, v2, v3
; GFX8-NEXT:    v_or_b32_e32 v4, v5, v4
; GFX8-NEXT:    ds_cmpst_rtn_b32 v4, v1, v2, v4
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_lshrrev_b32_e32 v4, v0, v2
...
; GFX7-NEXT:    ds_cmpst_rtn_b32 v4, v1, v2, v4
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_lshrrev_b32_e32 v4, v0, v2
...
; GFX6-NEXT:    ds_cmpst_rtn_b32 v4, v1, v2, v4
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_e32 v4, v1, v2
; GFX908-NEXT:    v_add_f16_e32 v4, -4.0, v4
; GFX908-NEXT:    v_lshlrev_b32_e32 v4, v1, v4
; GFX908-NEXT:    v_and_or_b32 v4, v2, v3, v4
; GFX908-NEXT:    ds_cmpst_rtn_b32 v4, v0, v2, v4
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v2
; GFX908-NEXT:    v_mov_b32_e32 v2, v4
; GFX908-NEXT:    s_xor_b64 s[6:7], vcc, exec
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_e32 v4, v1, v2
; GFX8-NEXT:    v_add_f16_e32 v4, -4.0, v4
...
; GFX12-TRUE16-NEXT:  .LBB12_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:  .LBB12_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:  .LBB12_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:  .LBB12_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX12-TRUE16-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v1, v3
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v1, v3
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-TRUE16-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v1, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB15_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v1, v3
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v1, v3
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB16_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_sdwa v4, v0, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_sdwa v4, v0, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX11-TRUE16-NEXT:  .LBB17_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB17_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_sdwa v4, v1, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX908-NEXT:    v_add_f32_e32 v4, -4.0, v4
; GFX908-NEXT:    v_bfe_u32 v5, v4, 16, 1
; GFX908-NEXT:    v_add3_u32 v5, v5, v4, s6
; GFX908-NEXT:    v_or_b32_e32 v6, 0x400000, v4
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_sdwa v4, v1, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX8-NEXT:    v_add_f32_e32 v4, -4.0, v4
; GFX8-NEXT:    v_bfe_u32 v5, v4, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v5, v4
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, 0x7fff, v5
...
; GFX12-TRUE16-NEXT:  .LBB18_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v1.l
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB18_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-TRUE16-NEXT:  .LBB18_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v1.l
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB18_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v0, v1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB19_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB19_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    v_bfe_u32 v5, v1, 16, 1
; GFX942-NEXT:    v_add3_u32 v5, v5, v1, s2
...
; GFX90A-NEXT:    v_bfe_u32 v5, v1, 16, 1
; GFX90A-NEXT:    v_add3_u32 v5, v5, v1, s6
; GFX90A-NEXT:    v_or_b32_e32 v6, 0x400000, v1
; GFX90A-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v5, v6, vcc
...
; GFX90A-NEXT:    v_or_b32_e32 v7, 0x400000, v5
; GFX90A-NEXT:    v_cmp_u_f32_e32 vcc, v5, v5
; GFX90A-NEXT:    v_cndmask_b32_e32 v5, v6, v7, vcc
; GFX90A-NEXT:    v_perm_b32 v1, v5, v1, s7
...
; GFX6-NEXT:    ds_cmpst_rtn_b32 v4, v0, v3, v5
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    v_alignbit_b32 v5, v6, v5, 16
; GFX7-NEXT:    v_alignbit_b32 v3, v3, v4, 16
; GFX7-NEXT:    ds_cmpst_rtn_b32 v4, v0, v3, v5 offset:65532
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v3
; GFX7-NEXT:    v_and_b32_e32 v3, 0xffff0000, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v5, v6, v7, vcc
; GFX942-NEXT:    v_perm_b32 v4, v5, v4, s3
...
; GFX90A-NEXT:    v_cmp_u_f32_e32 vcc, v5, v5
; GFX90A-NEXT:    v_cndmask_b32_e32 v5, v6, v7, vcc
; GFX90A-NEXT:    v_perm_b32 v4, v5, v4, s7
...
; GFX908-NEXT:    v_add3_u32 v6, v6, v5, s6
; GFX908-NEXT:    v_or_b32_e32 v7, 0x400000, v5
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v5, v5
; GFX908-NEXT:    v_cndmask_b32_e32 v5, v6, v7, vcc
; GFX908-NEXT:    v_perm_b32 v4, v5, v4, s7
...
; GFX12-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:  .LBB28_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    v_mov_b32_e32 v0, v1
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:  .LBB29_2: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
