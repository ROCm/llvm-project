...
; GISEL-NEXT:    v_xor_b32_e32 v1, v10, v1
; GISEL-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v10
; GISEL-NEXT:    v_xor_b32_e32 v2, v10, v2
; GISEL-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v10, vcc
; GISEL-NEXT:    v_xor_b32_e32 v3, v10, v3
; GISEL-NEXT:    v_subb_co_u32_e32 v8, vcc, v2, v10, vcc
; GISEL-NEXT:    v_subb_co_u32_e32 v9, vcc, v3, v10, vcc
; GISEL-NEXT:    v_ffbh_u32_e32 v3, v0
; GISEL-NEXT:    v_ffbh_u32_e32 v2, v1
; GISEL-NEXT:    v_add_u32_e32 v3, 32, v3
; GISEL-NEXT:    v_ffbh_u32_e32 v4, v8
...
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v3, v2, vcc
; GISEL-NEXT:    v_sub_u32_e32 v11, 0x80, v13
; GISEL-NEXT:    v_cmp_ge_i32_e32 vcc, 24, v11
...
; GISEL-NEXT:    v_sub_u32_e32 v6, 0x66, v13
; GISEL-NEXT:    v_sub_u32_e32 v4, 64, v6
; GISEL-NEXT:    v_lshrrev_b64 v[2:3], v6, v[0:1]
; GISEL-NEXT:    v_lshlrev_b64 v[4:5], v4, v[8:9]
; GISEL-NEXT:    v_add_u32_e32 v7, 0xffffffc0, v6
; GISEL-NEXT:    v_or_b32_e32 v4, v2, v4
; GISEL-NEXT:    v_or_b32_e32 v5, v3, v5
; GISEL-NEXT:    v_lshrrev_b64 v[2:3], v7, v[8:9]
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v6
; GISEL-NEXT:    v_add_u32_e32 v14, 26, v13
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v6
; GISEL-NEXT:    v_sub_u32_e32 v5, 64, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v7, v2, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v3, v1, vcc
; GISEL-NEXT:    v_lshrrev_b64 v[3:4], v14, -1
; GISEL-NEXT:    v_lshlrev_b64 v[5:6], v5, -1
; GISEL-NEXT:    v_add_u32_e32 v13, 0xffffffda, v13
; GISEL-NEXT:    v_or_b32_e32 v15, v3, v5
; GISEL-NEXT:    v_or_b32_e32 v16, v4, v6
; GISEL-NEXT:    v_lshrrev_b64 v[5:6], v13, -1
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v5, v15, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v6, v6, v16, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v6, v6, -1, s[4:5]
; GISEL-NEXT:    v_and_b32_e32 v3, v3, v8
; GISEL-NEXT:    v_and_b32_e32 v4, v4, v9
; GISEL-NEXT:    v_and_or_b32 v0, v5, v0, v3
; GISEL-NEXT:    v_and_or_b32 v1, v6, v1, v4
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v1, v7, v0
...
; GISEL-NEXT:    v_and_b32_e32 v0, 0x80000000, v10
; GISEL-NEXT:    v_lshl_add_u32 v1, v12, 23, 1.0
...
; GISEL-NEXT:    v_add_u32_e32 v2, 0xffffff98, v13
...
; GISEL-NEXT:    v_lshlrev_b64 v[12:13], v4, -1
; GISEL-NEXT:    v_add_u32_e32 v4, 0xffffffda, v5
; GISEL-NEXT:    v_lshrrev_b64 v[4:5], v4, -1
; GISEL-NEXT:    v_cndmask_b32_e32 v8, v8, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v9, v9, v1, vcc
; GISEL-NEXT:    v_or_b32_e32 v12, v10, v12
; GISEL-NEXT:    v_or_b32_e32 v13, v11, v13
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v4, v12, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v5, v13, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v10, 0, v10, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v11, 0, v11, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v4, -1, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v5, -1, s[4:5]
; GISEL-NEXT:    v_and_b32_e32 v2, v10, v2
; GISEL-NEXT:    v_and_b32_e32 v3, v11, v3
; GISEL-NEXT:    v_and_or_b32 v0, v4, v0, v2
; GISEL-NEXT:    v_and_or_b32 v1, v5, v1, v3
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    ; implicit-def: $vgpr10_vgpr11
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GISEL-NEXT:  ; %bb.1: ; %itofp-if-end
; GISEL-NEXT:    v_ashrrev_i32_e32 v10, 31, v3
; GISEL-NEXT:    v_xor_b32_e32 v0, v10, v4
; GISEL-NEXT:    v_xor_b32_e32 v1, v10, v5
; GISEL-NEXT:    v_xor_b32_e32 v4, v10, v2
; GISEL-NEXT:    v_sub_co_u32_e32 v2, vcc, v0, v10
; GISEL-NEXT:    v_xor_b32_e32 v5, v10, v3
; GISEL-NEXT:    v_subb_co_u32_e32 v3, vcc, v1, v10, vcc
; GISEL-NEXT:    v_subb_co_u32_e32 v4, vcc, v4, v10, vcc
; GISEL-NEXT:    v_ffbh_u32_e32 v1, v2
; GISEL-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v10, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v1, v0, vcc
; GISEL-NEXT:    v_sub_u32_e32 v11, 0x80, v13
; GISEL-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GISEL-NEXT:    v_cmp_ge_i32_e32 vcc, 53, v11
...
; GISEL-NEXT:  ; %bb.3: ; %itofp-if-then4
; GISEL-NEXT:    v_cmp_le_i32_e32 vcc, 55, v11
...
; GISEL-NEXT:  ; %bb.4: ; %LeafBlock
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 55, v11
; GISEL-NEXT:    s_and_saveexec_b64 s[12:13], vcc
; GISEL-NEXT:    s_cbranch_execz .LBB2_6
; GISEL-NEXT:  ; %bb.5: ; %itofp-sw-default
; GISEL-NEXT:    v_sub_u32_e32 v0, 0x49, v13
; GISEL-NEXT:    v_mov_b32_e32 v5, v1
; GISEL-NEXT:    v_sub_u32_e32 v8, 64, v0
; GISEL-NEXT:    v_lshrrev_b64 v[6:7], v0, v[2:3]
; GISEL-NEXT:    v_lshlrev_b64 v[8:9], v8, v[4:5]
; GISEL-NEXT:    v_add_u32_e32 v16, 0xffffffc0, v0
; GISEL-NEXT:    v_lshrrev_b64 v[14:15], v0, v[4:5]
; GISEL-NEXT:    v_or_b32_e32 v8, v6, v8
; GISEL-NEXT:    v_lshrrev_b64 v[5:6], v16, v[4:5]
...
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v0
; GISEL-NEXT:    v_add_u32_e32 v0, 55, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v16, v5, v2, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v6, v3, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e32 v6, 0, v14, vcc
; GISEL-NEXT:    v_sub_u32_e32 v14, 64, v0
; GISEL-NEXT:    v_lshrrev_b64 v[8:9], v0, -1
; GISEL-NEXT:    v_lshlrev_b64 v[14:15], v14, -1
; GISEL-NEXT:    v_add_u32_e32 v13, -9, v13
; GISEL-NEXT:    v_or_b32_e32 v17, v8, v14
; GISEL-NEXT:    v_lshrrev_b64 v[13:14], v13, -1
; GISEL-NEXT:    v_or_b32_e32 v15, v9, v15
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, v13, -1, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v13, v14, -1, s[4:5]
; GISEL-NEXT:    v_and_b32_e32 v4, v8, v4
; GISEL-NEXT:    v_and_b32_e32 v1, v9, v1
; GISEL-NEXT:    v_and_or_b32 v0, v0, v2, v4
; GISEL-NEXT:    v_and_or_b32 v1, v13, v3, v1
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    ; implicit-def: $vgpr7
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v4, v16, v0
; GISEL-NEXT:    v_mov_b32_e32 v2, v4
; GISEL-NEXT:    v_mov_b32_e32 v3, v5
; GISEL-NEXT:    v_mov_b32_e32 v4, v6
; GISEL-NEXT:    v_mov_b32_e32 v5, v7
; GISEL-NEXT:  .LBB2_6: ; %Flow1
; GISEL-NEXT:    s_or_b64 exec, exec, s[12:13]
; GISEL-NEXT:    v_mov_b32_e32 v9, v5
; GISEL-NEXT:    v_mov_b32_e32 v8, v4
; GISEL-NEXT:    v_mov_b32_e32 v7, v3
; GISEL-NEXT:    v_mov_b32_e32 v6, v2
; GISEL-NEXT:    ; implicit-def: $vgpr2
...
; GISEL-NEXT:    v_or_b32_e32 v8, v0, v1
; GISEL-NEXT:    ; implicit-def: $vgpr0
; GISEL-NEXT:  ; %bb.9: ; %itofp-sw-epilog
; GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GISEL-NEXT:    v_addc_co_u32_e32 v4, vcc, 0, v8, vcc
...
; GISEL-NEXT:    v_and_b32_e32 v1, 0x80000000, v10
; GISEL-NEXT:    v_lshl_add_u32 v2, v12, 20, v2
...
; GISEL-NEXT:    v_add_u32_e32 v4, 0xffffffb5, v13
