...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-SDAG-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-SDAG-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-GISEL
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX12,GFX12-SDAG-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX12,GFX12-SDAG-FAKE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-TRUE16
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-FAKE16
...
; GFX11-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_and_b32 v0, 0x3ff, v0
...
; GFX11-SDAG-TRUE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-TRUE16-NEXT:    v_cmpx_eq_u32_e32 v2, v0
...
; GFX11-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_and_b32 v0, 0x3ff, v0
...
; GFX11-SDAG-FAKE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v2, v0
...
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_cmpx_eq_u32_e32 v2, v0
...
; GFX12-SDAG-FAKE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v2, v0
...
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s6, exec_lo
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_cmpx_eq_u32_e32 v2, v0
; GFX12-SDAG-TRUE16-NEXT:    s_or_b32 s5, s5, s6
; GFX12-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-FAKE16-NEXT:    buffer_load_b32 v2, v1, s[0:3], s4 idxen offset:4 th:TH_LOAD_NT
; GFX12-SDAG-FAKE16-NEXT:    s_mov_b32 s6, exec_lo
; GFX12-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v2, v0
; GFX12-SDAG-FAKE16-NEXT:    s_or_b32 s5, s5, s6
; GFX12-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX11-SDAG-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-TRUE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-TRUE16-NEXT:    v_cmpx_ne_u32_e32 0, v0
...
; GFX11-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-SDAG-FAKE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_cmpx_ne_u32_e32 0, v0
...
; GFX12-SDAG-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-TRUE16-NEXT:    v_cmpx_ne_u32_e32 0, v0
...
; GFX12-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-FAKE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_cmpx_ne_u32_e32 0, v0
...
; GFX11-SDAG-TRUE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-TRUE16-NEXT:    v_cmpx_eq_u64_e32 v[3:4], v[0:1]
; GFX11-SDAG-TRUE16-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
...
; GFX11-SDAG-FAKE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-FAKE16-NEXT:    v_cmpx_eq_u64_e32 v[3:4], v[0:1]
; GFX11-SDAG-FAKE16-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_cmpx_eq_u64_e32 v[4:5], v[0:1]
; GFX12-SDAG-TRUE16-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-FAKE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    v_cmpx_eq_u64_e32 v[4:5], v[0:1]
; GFX12-SDAG-FAKE16-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX11-SDAG-TRUE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-TRUE16-NEXT:    v_cmpx_eq_u32_e32 v5, v0
; GFX11-SDAG-TRUE16-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
...
; GFX11-SDAG-FAKE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX11-SDAG-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v5, v0
; GFX11-SDAG-FAKE16-NEXT:    s_or_b32 s4, s4, s5
; GFX11-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_cmpx_eq_u32_e32 v5, v0
; GFX12-SDAG-TRUE16-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
...
; GFX12-SDAG-FAKE16-NEXT:    s_mov_b32 s5, exec_lo
; GFX12-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-FAKE16-NEXT:    v_cmpx_eq_u32_e32 v5, v0
; GFX12-SDAG-FAKE16-NEXT:    s_or_b32 s4, s4, s5
; GFX12-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
