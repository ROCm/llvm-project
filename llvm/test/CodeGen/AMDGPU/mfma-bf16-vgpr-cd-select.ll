; RUN: llc -mtriple=amdgpu9.0a < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel -mtriple=amdgpu9.0a < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
...
define amdgpu_kernel void @test_mfma_f64_4x4x4f64(ptr addrspace(1) %arg) #0 {
bb:
...
define amdgpu_kernel void @test_mfma_f64_16x16x4f64(ptr addrspace(1) %arg) #0 {
bb:
