...
; RUN: llc -amdgpu-late-wave-transform=1 -verify-machineinstrs -mtriple=amdgpu9.08 < %s | FileCheck -enable-var-scope -check-prefixes=GFX908 %s
; RUN: llc -amdgpu-late-wave-transform=1 -verify-machineinstrs -mtriple=amdgpu9.0a < %s | FileCheck -enable-var-scope -check-prefixes=GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=1 -verify-machineinstrs -mtriple=amdgpu9.42 < %s | FileCheck -enable-var-scope -check-prefixes=GFX942 %s
