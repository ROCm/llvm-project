...
; GFX12-NEXT:    ; divergent control-flow edge
; GFX12-NEXT:    s_cbranch_execz .LBB16_2
; GFX12-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX12-NEXT:    v_add_f64_e64 v[6:7], v[4:5], -v[2:3]
; GFX12-NEXT:    scratch_store_b64 v8, v[6:7], off
; GFX12-NEXT:  .LBB16_2:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-NEXT:  .LBB16_4: ; %atomicrmw.start
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX942-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX942-NEXT:    s_mov_b64 exec, s[2:3]
; GFX942-NEXT:    ; divergent control-flow edge
; GFX942-NEXT:    s_cbranch_execnz .LBB16_4
...
; GFX11-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX11-NEXT:    v_add_f64 v[6:7], v[4:5], -v[2:3]
; GFX11-NEXT:    scratch_store_b64 v8, v[6:7], off
; GFX11-NEXT:  .LBB16_2:
...
; GFX10-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX10-NEXT:    v_add_f64 v[6:7], v[4:5], -v[2:3]
; GFX10-NEXT:    buffer_store_dword v6, v8, s[0:3], 0 offen
; GFX10-NEXT:    buffer_store_dword v7, v8, s[0:3], 0 offen offset:4
; GFX10-NEXT:  .LBB16_2:
...
; GFX90A-NEXT:    buffer_store_dword v6, v8, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_store_dword v7, v8, s[0:3], 0 offen offset:4
; GFX90A-NEXT:  .LBB16_2:
; GFX90A-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX90A-NEXT:    s_xor_b64 s[4:5], exec, s[8:9]
...
; GFX908-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX908-NEXT:    v_add_f64 v[6:7], v[4:5], -v[2:3]
; GFX908-NEXT:    buffer_store_dword v6, v8, s[0:3], 0 offen
; GFX908-NEXT:    buffer_store_dword v7, v8, s[0:3], 0 offen offset:4
; GFX908-NEXT:  .LBB16_2:
...
; GFX8-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX8-NEXT:    v_add_f64 v[6:7], v[4:5], -v[2:3]
; GFX8-NEXT:    buffer_store_dword v6, v8, s[0:3], 0 offen
...
; GFX8-NEXT:  .LBB16_3: ; %atomicrmw.global
...
; GFX8-NEXT:  .LBB16_4: ; %atomicrmw.start
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX7-NEXT:    ; divergent control-flow edge
; GFX7-NEXT:    s_cbranch_execz .LBB16_2
; GFX7-NEXT:  .LBB16_1: ; %atomicrmw.private
...
; GFX7-NEXT:    v_add_f64 v[6:7], v[4:5], -v[2:3]
; GFX7-NEXT:    buffer_store_dword v6, v8, s[0:3], 0 offen
; GFX7-NEXT:    buffer_store_dword v7, v9, s[0:3], 0 offen
; GFX7-NEXT:  .LBB16_2:
...
; GFX7-NEXT:  .LBB16_3: ; %atomicrmw.global
...
; GFX7-NEXT:  .LBB16_4: ; %atomicrmw.start
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX12-NEXT:  .LBB17_1: ; %atomicrmw.private
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_add_f64_e64 v[4:5], v[0:1], -v[2:3]
; GFX12-NEXT:    scratch_store_b64 v6, v[4:5], off
; GFX12-NEXT:  .LBB17_2:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX942-NEXT:  .LBB17_1: ; %atomicrmw.private
; GFX942-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v6, -1, v8, vcc
; GFX942-NEXT:    scratch_load_dwordx2 v[0:1], v6, off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_add_f64 v[4:5], v[0:1], -v[2:3]
; GFX942-NEXT:    scratch_store_dwordx2 v6, v[4:5], off
; GFX942-NEXT:  .LBB17_2:
; GFX942-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX942-NEXT:    s_xor_b64 s[0:1], exec, s[4:5]
; GFX942-NEXT:    s_and_b64 s[0:1], s[0:1], exec
...
; GFX11-NEXT:  .LBB17_1: ; %atomicrmw.private
...
; GFX11-NEXT:    scratch_store_b64 v6, v[4:5], off
; GFX11-NEXT:  .LBB17_2:
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_xor_b32 s0, exec_lo, s2
...
; GFX10-NEXT:  .LBB17_1: ; %atomicrmw.private
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[8:9]
; GFX10-NEXT:    v_cndmask_b32_e32 v6, -1, v8, vcc_lo
; GFX10-NEXT:    s_clause 0x1
...
; GFX10-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX10-NEXT:    buffer_store_dword v5, v6, s[0:3], 0 offen offset:4
; GFX10-NEXT:  .LBB17_2:
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX10-NEXT:    s_xor_b32 s5, exec_lo, s6
...
; GFX908-NEXT:  .LBB17_1: ; %atomicrmw.private
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_add_f64 v[4:5], v[0:1], -v[2:3]
; GFX908-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX908-NEXT:    buffer_store_dword v5, v6, s[0:3], 0 offen offset:4
; GFX908-NEXT:  .LBB17_2:
; GFX908-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX908-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX908-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GFX8-NEXT:  .LBB17_1: ; %atomicrmw.private
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_f64 v[4:5], v[0:1], -v[2:3]
; GFX8-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX8-NEXT:    buffer_store_dword v5, v7, s[0:3], 0 offen
; GFX8-NEXT:  .LBB17_2:
; GFX8-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX8-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX8-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GFX7-NEXT:  .LBB17_1: ; %atomicrmw.private
; GFX7-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; GFX7-NEXT:    v_cndmask_b32_e32 v6, -1, v8, vcc
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_add_f64 v[4:5], v[0:1], -v[2:3]
; GFX7-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX7-NEXT:    buffer_store_dword v5, v7, s[0:3], 0 offen
; GFX7-NEXT:  .LBB17_2:
; GFX7-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX7-NEXT:    s_xor_b64 s[6:7], exec, s[8:9]
; GFX7-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_add_f64_e64 v[4:5], v[4:5], -v[2:3]
; GFX12-NEXT:    scratch_store_b64 v6, v[4:5], off
; GFX12-NEXT:  .LBB19_2:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s2
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX942-NEXT:    scratch_store_dwordx2 v6, v[4:5], off
; GFX942-NEXT:  .LBB19_2:
; GFX942-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX942-NEXT:    s_xor_b64 s[0:1], exec, s[4:5]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX11-NEXT:    scratch_store_b64 v6, v[4:5], off
; GFX11-NEXT:  .LBB19_2:
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
...
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX10-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX10-NEXT:    buffer_store_dword v5, v6, s[0:3], 0 offen offset:4
; GFX10-NEXT:  .LBB19_2:
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX90A-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX90A-NEXT:    buffer_store_dword v5, v6, s[0:3], 0 offen offset:4
; GFX90A-NEXT:  .LBB19_2:
; GFX90A-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX908-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX908-NEXT:    buffer_store_dword v5, v6, s[0:3], 0 offen offset:4
; GFX908-NEXT:  .LBB19_2:
; GFX908-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[8:9]
; GFX908-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX908-NEXT:    s_mov_b64 exec, s[8:9]
; GFX908-NEXT:    ; divergent control-flow edge
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX8-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX8-NEXT:    buffer_store_dword v5, v7, s[0:3], 0 offen
; GFX8-NEXT:  .LBB19_2:
; GFX8-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_add_f64 v[4:5], v[4:5], -v[2:3]
; GFX7-NEXT:    buffer_store_dword v4, v6, s[0:3], 0 offen
; GFX7-NEXT:    buffer_store_dword v5, v7, s[0:3], 0 offen
; GFX7-NEXT:  .LBB19_2:
; GFX7-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GFX12-TRUE16-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB36_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB37_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB39_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-FAKE16-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-TRUE16-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB40_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, v3, v5
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:  .LBB41_2: ; %atomicrmw.end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
