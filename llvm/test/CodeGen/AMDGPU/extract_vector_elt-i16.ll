...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX89,GFX89-TONGA %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX89,GFX89-DEFAULT %s
...
; GFX89:       ; %bb.0:
; GFX89-TONGA-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-TONGA-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x4c
; GFX89-TONGA-NEXT:    s_load_dword s4, s[4:5], 0x54
; GFX89-DEFAULT-NEXT:  s_load_dwordx2 s[6:7], s[4:5], 0x4c
; GFX89-DEFAULT-NEXT:  s_load_dword s8, s[4:5], 0x54
; GFX89-DEFAULT-NEXT:  s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-TONGA-NEXT:    s_lshl_b32 s4, s4, 4
; GFX89-DEFAULT-NEXT:  s_lshl_b32 s4, s8, 4
