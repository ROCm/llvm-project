...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX89 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=GFX89 %s
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_lshr_b32_e32 v0, s0, v0
...
; GCN-NEXT:    buffer_load_dwordx4 v[1:4], v[8:9], s[0:3], 0 addr64
; GCN-NEXT:    buffer_load_dwordx4 v[5:8], v[8:9], s[0:3], 0 addr64 offset:16
