...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX9 %s
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX8-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x34
...
; GFX6-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x11
...
; GFX6-NEXT:    v_add_f32_e32 v0, v0, v4
; GFX6-NEXT:    v_trunc_f32_e32 v4, s7
; GFX6-NEXT:    v_sub_f32_e32 v5, s7, v4
...
; GFX6-NEXT:    v_trunc_f32_e32 v4, s6
; GFX6-NEXT:    v_sub_f32_e32 v5, s6, v4
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v5|, 0.5
; GFX6-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[0:1]
; GFX6-NEXT:    v_mov_b32_e32 v6, s6
; GFX6-NEXT:    v_bfi_b32 v5, s14, v5, v6
; GFX6-NEXT:    v_add_f32_e32 v6, v4, v5
; GFX6-NEXT:    v_trunc_f32_e32 v4, s5
; GFX6-NEXT:    v_sub_f32_e32 v5, s5, v4
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v5|, 0.5
; GFX6-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[0:1]
...
; GFX6-NEXT:    v_sub_f32_e32 v8, s4, v4
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x24
; GFX8-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x44
...
; GFX8-NEXT:    v_add_f32_e32 v0, v0, v4
; GFX8-NEXT:    v_trunc_f32_e32 v4, s7
; GFX8-NEXT:    v_sub_f32_e32 v5, s7, v4
...
; GFX8-NEXT:    v_trunc_f32_e32 v4, s6
; GFX8-NEXT:    v_sub_f32_e32 v5, s6, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v5|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[0:1]
; GFX8-NEXT:    v_mov_b32_e32 v6, s6
; GFX8-NEXT:    v_bfi_b32 v5, s14, v5, v6
; GFX8-NEXT:    v_add_f32_e32 v6, v4, v5
; GFX8-NEXT:    v_trunc_f32_e32 v4, s5
; GFX8-NEXT:    v_sub_f32_e32 v5, s5, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v5|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[0:1]
...
; GFX8-NEXT:    v_sub_f32_e32 v8, s4, v4
...
; GFX8-NEXT:    buffer_store_dwordx4 v[4:7], off, s[8:11], 0 offset:16
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    s_load_b64 s[8:9], s[4:5], 0x24
; GFX11-NEXT:    s_load_b256 s[0:7], s[4:5], 0x44
...
; GFX11-NEXT:    v_trunc_f32_e32 v1, s2
; GFX11-NEXT:    v_trunc_f32_e32 v4, s1
; GFX11-NEXT:    v_trunc_f32_e32 v5, s7
; GFX11-NEXT:    v_trunc_f32_e32 v6, s6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_dual_sub_f32 v2, s3, v0 :: v_dual_sub_f32 v3, s2, v1
; GFX11-NEXT:    v_dual_sub_f32 v7, s1, v4 :: v_dual_sub_f32 v12, s7, v5
; GFX11-NEXT:    v_trunc_f32_e32 v10, s4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_cmp_ge_f32_e64 s12, |v2|, 0.5
; GFX11-NEXT:    v_trunc_f32_e32 v8, s0
; GFX11-NEXT:    v_trunc_f32_e32 v9, s5
; GFX11-NEXT:    v_sub_f32_e32 v15, s4, v10
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, s12
; GFX11-NEXT:    v_cmp_ge_f32_e64 s12, |v3|, 0.5
; GFX11-NEXT:    v_dual_sub_f32 v11, s0, v8 :: v_dual_sub_f32 v14, s5, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_bfi_b32 v2, 0x7fffffff, v2, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v3, 0, 1.0, s12
; GFX11-NEXT:    v_cmp_ge_f32_e64 s12, |v7|, 0.5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_bfi_b32 v16, 0x7fffffff, v3, s2
; GFX11-NEXT:    v_sub_f32_e32 v13, s6, v6
; GFX11-NEXT:    v_cndmask_b32_e64 v7, 0, 1.0, s12
; GFX11-NEXT:    v_cmp_ge_f32_e64 s12, |v12|, 0.5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_dual_add_f32 v3, v0, v2 :: v_dual_add_f32 v2, v1, v16
; GFX11-NEXT:    v_bfi_b32 v7, 0x7fffffff, v7, s1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_cndmask_b32_e64 v12, 0, 1.0, s12
; GFX11-NEXT:    v_cmp_ge_f32_e64 s12, |v13|, 0.5
; GFX11-NEXT:    v_cmp_ge_f32_e64 s1, |v15|, 0.5
; GFX11-NEXT:    v_add_f32_e32 v1, v4, v7
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_bfi_b32 v4, 0x7fffffff, v12, s7
; GFX11-NEXT:    v_cndmask_b32_e64 v13, 0, 1.0, s12
; GFX11-NEXT:    v_cmp_ge_f32_e64 s12, |v14|, 0.5
; GFX11-NEXT:    v_cndmask_b32_e64 v15, 0, 1.0, s1
; GFX11-NEXT:    v_cmp_ge_f32_e64 s1, |v11|, 0.5
; GFX11-NEXT:    v_add_f32_e32 v7, v5, v4
; GFX11-NEXT:    v_bfi_b32 v11, 0x7fffffff, v13, s6
; GFX11-NEXT:    v_cndmask_b32_e64 v14, 0, 1.0, s12
; GFX11-NEXT:    v_bfi_b32 v13, 0x7fffffff, v15, s4
; GFX11-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_add_f32_e32 v6, v6, v11
; GFX11-NEXT:    v_bfi_b32 v12, 0x7fffffff, v14, s5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_add_f32_e32 v4, v10, v13
; GFX11-NEXT:    v_bfi_b32 v0, 0x7fffffff, v0, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_f32_e32 v5, v9, v12
...
; GFX8-NEXT:    s_mov_b32 s2, -1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_trunc_f16_e32 v0, s4
; GFX8-NEXT:    v_sub_f16_e32 v1, s4, v0
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_trunc_f16_e32 v0, s4
; GFX9-NEXT:    v_sub_f16_e32 v1, s4, v0
...
; GFX6-NEXT:    v_cvt_f32_f16_e32 v0, s4
; GFX6-NEXT:    v_cvt_f32_f16_e32 v3, s6
; GFX6-NEXT:    v_trunc_f32_e32 v1, v0
; GFX6-NEXT:    v_sub_f32_e32 v2, v0, v1
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v2|, 0.5
; GFX6-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_bfi_b32 v0, s7, v2, v0
; GFX6-NEXT:    v_add_f32_e32 v0, v1, v0
; GFX6-NEXT:    v_trunc_f32_e32 v1, v3
; GFX6-NEXT:    v_sub_f32_e32 v2, v3, v1
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v2|, 0.5
; GFX6-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_bfi_b32 v2, s7, v2, v3
; GFX6-NEXT:    v_cvt_f16_f32_e32 v0, v0
...
; GFX8-NEXT:    v_trunc_f16_e32 v0, s5
; GFX8-NEXT:    v_sub_f16_e32 v1, s5, v0
; GFX8-NEXT:    v_cmp_ge_f16_e64 vcc, |v1|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e32 v1, 0, v2, vcc
...
; GFX8-NEXT:    v_sub_f16_e32 v3, s4, v1
...
; GFX9-NEXT:    v_trunc_f16_e32 v0, s5
; GFX9-NEXT:    v_sub_f16_e32 v1, s5, v0
; GFX9-NEXT:    v_cmp_ge_f16_e64 vcc, |v1|, 0.5
; GFX9-NEXT:    v_cndmask_b32_e32 v1, 0, v2, vcc
...
; GFX9-NEXT:    v_sub_f16_e32 v3, s4, v1
