...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50-amd-amdhsa -show-mc-encoding < %s | FileCheck -check-prefix=GFX1250 %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu12.50-amd-amdhsa -show-mc-encoding < %s | FileCheck -check-prefix=GFX1250 %s
