...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX6-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX6-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s  | FileCheck -check-prefixes=GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global < %s  | FileCheck -check-prefixes=GFX8-GISEL %s
...
; GFX6-SDAG-NEXT:    s_load_dword s4, s[4:5], 0xb
...
; GFX8-SDAG-NEXT:    s_load_dword s4, s[4:5], 0x2c
...
; GFX6-SDAG-NEXT:    s_mov_b32 s6, 0xf000
; GFX6-SDAG-NEXT:    s_mov_b32 s7, -1
; GFX6-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX6-SDAG-NEXT:    s_mov_b32 s2, s7
; GFX6-SDAG-NEXT:    s_mov_b32 s3, s6
; GFX6-SDAG-NEXT:    v_frexp_exp_i32_f32_e32 v0, s4
; GFX6-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX6-SDAG-NEXT:    s_endpgm
;
...
; GFX8-SDAG-NEXT:    s_mov_b32 s6, 0xf000
; GFX8-SDAG-NEXT:    s_mov_b32 s7, -1
; GFX8-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX8-SDAG-NEXT:    s_mov_b32 s2, s7
; GFX8-SDAG-NEXT:    s_mov_b32 s3, s6
; GFX8-SDAG-NEXT:    v_frexp_exp_i32_f32_e32 v0, s4
; GFX8-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX8-SDAG-NEXT:    s_endpgm
;
