...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GFX6-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GFX6-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s  | FileCheck -check-prefixes=GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s  | FileCheck -check-prefixes=GFX8-GISEL %s
