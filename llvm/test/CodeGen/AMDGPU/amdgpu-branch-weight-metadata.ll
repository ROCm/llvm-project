...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GFX10,GFX1010 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX10,GFX1030 %s
...
; GFX1010-NEXT:    s_mov_b32 s10, 0
; GFX1010-NEXT:    s_xor_b32 s9, vcc_lo, exec_lo
; GFX1010-NEXT:    s_xor_b32 s8, exec_lo, s9
; GFX1010-NEXT:    s_mov_b32 exec_lo, s9
...
; GFX1030-NEXT:    s_mov_b32 s8, 0
; GFX1030-NEXT:    s_mov_b32 s10, 0
; GFX1030-NEXT:    s_xor_b32 s9, vcc_lo, exec_lo
; GFX1030-NEXT:    s_xor_b32 s8, exec_lo, s9
; GFX1030-NEXT:    s_mov_b32 exec_lo, s9
; GFX1030-NEXT:    s_mov_b32 s9, 0
