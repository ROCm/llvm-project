...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GFX10,GFX1010 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.30 < %s | FileCheck -check-prefixes=GFX10,GFX1030 %s
