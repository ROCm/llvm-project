...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.00-amd-amdhsa %s -o - | FileCheck -check-prefix=GCN %s
...
; GCN-NEXT:  .LBB0_6: ; %LeafBlock5
; GCN-NEXT:    v_cmp_eq_u32_e64 s[6:7], 2, v0
