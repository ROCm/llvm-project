...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 -O2 -tail-dup-size=1000 -tail-dup-placement-threshold=1000 -enable-tail-merge=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s
...
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 1, v3
