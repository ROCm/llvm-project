...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=SI-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=SI-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck %s -enable-var-scope -check-prefixes=VI,VI-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck %s -enable-var-scope -check-prefixes=VI,VI-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX9,GFX9-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu9.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX9,GFX9-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu10.10 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX10,GFX10-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu10.10 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX10,GFX10-GISEL
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu11.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX11,GFX11-SDAG
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu11.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX11,GFX11-GISEL
