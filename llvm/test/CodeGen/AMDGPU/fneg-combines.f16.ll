...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu7.01 -mattr=+flat-for-global < %s | FileCheck -enable-var-scope --check-prefixes=SI %s
...
; XUN: llc -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11,GFX11-SAFE-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck -enable-var-scope --check-prefixes=GFX11 %s
