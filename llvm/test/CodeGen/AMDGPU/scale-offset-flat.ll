...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu12.50 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GCN,SDAG,GCN-FAKE16,SDAG-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.50 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GCN,GISEL,GCN-FAKE16,GISEL-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu12.50 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GCN,SDAG,GCN-REAL16,SDAG-REAL16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu12.50 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GCN,GISEL,GCN-REAL16,GISEL-REAL16 %s
...
; GCN-FAKE16-NEXT:    s_mov_b64 s[64:65], 0
; GCN-FAKE16-NEXT:    v_nop
; GCN-FAKE16-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; GCN-REAL16-NEXT:    s_mov_b64 s[64:65], 0
; GCN-REAL16-NEXT:    v_nop
; GCN-REAL16-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; SDAG-NEXT:  .LBB21_1: ; %atomicrmw.global
...
; SDAG-NEXT:  .LBB21_3: ; %atomicrmw.private
...
; GISEL-NEXT:    s_xor_b32 s0, exec_lo, s2
; GISEL-NEXT:    s_mov_b32 exec_lo, s2
; GISEL-NEXT:    ; divergent control-flow edge
; GISEL-NEXT:    s_cbranch_execz .LBB21_4
; GISEL-NEXT:  .LBB21_3: ; %atomicrmw.private
...
; GISEL-NEXT:  .LBB21_4: ; %atomicrmw.phi
; GISEL-NEXT:    s_wait_xcnt 0x0
