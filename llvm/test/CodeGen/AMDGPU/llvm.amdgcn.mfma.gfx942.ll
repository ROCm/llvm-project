...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu9.42 < %s | FileCheck --check-prefixes=GFX942,GFX942-VGPRCD,GFX942-SDAG,GFX942-VGPRCD-SDAG %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=0 -mtriple=amdgpu9.50 < %s | FileCheck --check-prefixes=GFX950,GFX950-VGPRCD,GFX950-SDAG,GFX950-VGPRCD-SDAG %s
