...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX1250 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.51 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX1251 %s
