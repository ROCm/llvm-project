...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX1250 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1251 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX1251 %s
...
; GFX1251-NEXT:    global_load_b128 v[0:3], v32, s[2:3]
; GFX1251-NEXT:    global_load_b128 v[4:7], v32, s[2:3] offset:16
...
; GFX1251-NEXT:    global_load_b128 v[24:27], v32, s[2:3] offset:112
; GFX1251-NEXT:    global_load_b128 v[28:31], v32, s[2:3] offset:96
...
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[12:13], v26, v[22:23]
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[18:19], v30, v[18:19]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[16:17], v28, v[16:17]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[10:11], v24, v[20:21]
; GFX1251-NEXT:    s_clause 0x3
; GFX1251-NEXT:    global_store_b128 v32, v[16:19], s[0:1] offset:32
; GFX1251-NEXT:    global_store_b128 v32, v[10:13], s[0:1] offset:48
; GFX1251-NEXT:    global_store_b128 v32, v[0:3], s[0:1]
; GFX1251-NEXT:    global_store_b128 v32, v[4:7], s[0:1] offset:16
; GFX1251-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
...
; GFX1250-NEXT:    global_load_b128 v[16:19], v20, s[2:3] offset:432
; GFX1250-NEXT:    global_load_b128 v[22:25], v20, s[2:3] offset:176
; GFX1250-NEXT:    global_load_b128 v[26:29], v20, s[2:3] offset:160
; GFX1250-NEXT:    global_load_b128 v[30:33], v20, s[2:3] offset:416
; GFX1250-NEXT:    global_load_b128 v[34:37], v20, s[2:3] offset:464
; GFX1250-NEXT:    global_load_b128 v[38:41], v20, s[2:3] offset:208
; GFX1250-NEXT:    global_load_b128 v[42:45], v20, s[2:3] offset:192
; GFX1250-NEXT:    global_load_b128 v[46:49], v20, s[2:3] offset:448
; GFX1250-NEXT:    global_load_b128 v[50:53], v20, s[2:3] offset:496
; GFX1250-NEXT:    global_load_b128 v[54:57], v20, s[2:3] offset:240
; GFX1250-NEXT:    global_load_b128 v[58:61], v20, s[2:3] offset:224
; GFX1250-NEXT:    global_load_b128 v[62:65], v20, s[2:3] offset:480
; GFX1250-NEXT:    global_load_b128 v[66:69], v20, s[2:3] offset:16
; GFX1250-NEXT:    global_load_b128 v[70:73], v20, s[2:3]
...
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[10:11], v18, v[24:25]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[8:9], v16, v[22:23]
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_load_b128 v[22:25], v20, s[2:3] offset:272
; GFX1250-NEXT:    global_load_b128 v[74:77], v20, s[2:3] offset:256
; GFX1250-NEXT:    s_wait_loadcnt 0xc
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[14:15], v32, v[28:29]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[12:13], v30, v[26:27]
; GFX1250-NEXT:    global_load_b128 v[26:29], v20, s[2:3] offset:32
; GFX1250-NEXT:    s_wait_loadcnt 0xb
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[18:19], v36, v[40:41]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[16:17], v34, v[38:39]
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_load_b128 v[30:33], v20, s[2:3] offset:288
; GFX1250-NEXT:    global_load_b128 v[38:41], v20, s[2:3] offset:80
; GFX1250-NEXT:    s_wait_loadcnt 0xb
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[36:37], v48, v[44:45]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[34:35], v46, v[42:43]
; GFX1250-NEXT:    global_load_b128 v[46:49], v20, s[2:3] offset:336
; GFX1250-NEXT:    s_wait_loadcnt 0xa
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[44:45], v52, v[56:57]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[42:43], v50, v[54:55]
; GFX1250-NEXT:    s_wait_loadcnt 0x8
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[52:53], v64, v[60:61]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[50:51], v62, v[58:59]
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_load_b128 v[54:57], v20, s[2:3] offset:368
; GFX1250-NEXT:    global_load_b128 v[58:61], v20, s[2:3] offset:64
; GFX1250-NEXT:    s_wait_loadcnt 0x7
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[24:25], v24, v[68:69]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[22:23], v22, v[66:67]
; GFX1250-NEXT:    global_load_b128 v[66:69], v20, s[2:3] offset:320
; GFX1250-NEXT:    s_wait_loadcnt 0x7
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[64:65], v76, v[72:73]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[62:63], v74, v[70:71]
; GFX1250-NEXT:    s_wait_loadcnt 0x5
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[28:29], v32, v[28:29]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[26:27], v30, v[26:27]
; GFX1250-NEXT:    s_wait_loadcnt 0x3
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[32:33], v48, v[40:41]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[30:31], v46, v[38:39]
; GFX1250-NEXT:    s_clause 0x2
; GFX1250-NEXT:    global_load_b128 v[38:41], v20, s[2:3] offset:112
; GFX1250-NEXT:    global_load_b128 v[46:49], v20, s[2:3] offset:96
; GFX1250-NEXT:    global_load_b128 v[70:73], v20, s[2:3] offset:352
; GFX1250-NEXT:    s_wait_loadcnt 0x3
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[60:61], v68, v[60:61]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[58:59], v66, v[58:59]
; GFX1250-NEXT:    global_load_b128 v[66:69], v20, s[2:3] offset:304
; GFX1250-NEXT:    s_wait_loadcnt 0x3
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[40:41], v56, v[40:41]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[38:39], v54, v[38:39]
; GFX1250-NEXT:    global_load_b128 v[54:57], v20, s[2:3] offset:48
; GFX1250-NEXT:    s_wait_loadcnt 0x2
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[48:49], v72, v[48:49]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[46:47], v70, v[46:47]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[56:57], v68, v[56:57]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[54:55], v66, v[54:55]
; GFX1250-NEXT:    s_clause 0xf
; GFX1250-NEXT:    global_store_b128 v20, v[46:49], s[0:1] offset:96
; GFX1250-NEXT:    global_store_b128 v20, v[38:41], s[0:1] offset:112
; GFX1250-NEXT:    global_store_b128 v20, v[58:61], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v20, v[30:33], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v20, v[26:29], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v20, v[54:57], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v20, v[62:65], s[0:1]
; GFX1250-NEXT:    global_store_b128 v20, v[22:25], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v20, v[50:53], s[0:1] offset:224
; GFX1250-NEXT:    global_store_b128 v20, v[42:45], s[0:1] offset:240
; GFX1250-NEXT:    global_store_b128 v20, v[34:37], s[0:1] offset:192
; GFX1250-NEXT:    global_store_b128 v20, v[16:19], s[0:1] offset:208
...
; GFX1251-NEXT:    global_load_b128 v[50:53], v24, s[2:3] offset:224
; GFX1251-NEXT:    global_load_b128 v[54:57], v24, s[2:3] offset:240
; GFX1251-NEXT:    global_load_b128 v[58:61], v24, s[2:3] offset:496
...
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[48:49], v64, v[52:53]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[46:47], v62, v[50:51]
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[50:53], v24, s[2:3] offset:336
; GFX1251-NEXT:    global_load_b128 v[34:37], v24, s[2:3] offset:32
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[40:41], v60, v[56:57]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[38:39], v58, v[54:55]
; GFX1251-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:288
; GFX1251-NEXT:    s_wait_loadcnt 0x6
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[56:57], v76, v[68:69]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[54:55], v74, v[66:67]
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[62:65], v24, s[2:3] offset:80
; GFX1251-NEXT:    global_load_b128 v[66:69], v24, s[2:3] offset:64
...
; GFX1251-NEXT:    s_wait_loadcnt 0x2
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[52:53], v52, v[64:65]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[50:51], v50, v[62:63]
; GFX1251-NEXT:    global_load_b128 v[62:65], v24, s[2:3] offset:352
; GFX1251-NEXT:    s_wait_loadcnt 0x1
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[32:33], v32, v[68:69]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[30:31], v30, v[66:67]
; GFX1251-NEXT:    s_clause 0x2
; GFX1251-NEXT:    global_load_b128 v[66:69], v24, s[2:3] offset:96
; GFX1251-NEXT:    global_load_b128 v[70:73], v24, s[2:3] offset:112
; GFX1251-NEXT:    global_load_b128 v[74:77], v24, s[2:3] offset:368
; GFX1251-NEXT:    s_wait_loadcnt 0x2
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[64:65], v64, v[68:69]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[62:63], v62, v[66:67]
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[68:69], v76, v[72:73]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[66:67], v74, v[70:71]
; GFX1251-NEXT:    s_clause 0xf
; GFX1251-NEXT:    global_store_b128 v24, v[62:65], s[0:1] offset:96
; GFX1251-NEXT:    global_store_b128 v24, v[66:69], s[0:1] offset:112
; GFX1251-NEXT:    global_store_b128 v24, v[30:33], s[0:1] offset:64
; GFX1251-NEXT:    global_store_b128 v24, v[50:53], s[0:1] offset:80
; GFX1251-NEXT:    global_store_b128 v24, v[34:37], s[0:1] offset:32
; GFX1251-NEXT:    global_store_b128 v24, v[26:29], s[0:1] offset:48
; GFX1251-NEXT:    global_store_b128 v24, v[58:61], s[0:1]
