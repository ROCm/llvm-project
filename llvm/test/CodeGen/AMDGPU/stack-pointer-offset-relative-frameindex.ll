...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 | FileCheck -check-prefix=MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 -mattr=+enable-flat-scratch | FileCheck -check-prefix=FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefix=MUBUF11 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -mattr=+enable-flat-scratch | FileCheck -check-prefix=FLATSCR11 %s
