...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1010 | FileCheck -check-prefix=MUBUF %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1010 -mattr=+enable-flat-scratch | FileCheck -check-prefix=FLATSCR %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefix=MUBUF11 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 -mattr=+enable-flat-scratch | FileCheck -check-prefix=FLATSCR11 %s
...
; MUBUF-NEXT:    s_and_saveexec_b32 s0, s0
...
; FLATSCR-NEXT:    s_and_saveexec_b32 s0, s0
...
; MUBUF11:       ; %bb.0: ; %entry
; MUBUF11-NEXT:    s_load_b32 s2, s[4:5], 0x24
...
; MUBUF11-NEXT:    s_and_saveexec_b32 s0, s0
...
; FLATSCR11-NEXT:    s_load_b32 s2, s[4:5], 0x24
...
; FLATSCR11-NEXT:    s_and_saveexec_b32 s0, s0
