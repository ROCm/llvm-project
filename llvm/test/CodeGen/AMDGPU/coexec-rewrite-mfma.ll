...
; CHECK-NEXT:    v_mov_b32_e32 v50, v2
...
; CHECK-NEXT:    ds_read_b128 a[12:15], v2
...
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[10:13], v[68:71], v[72:75], v[10:13]
; CHECK-NEXT:    s_nop 2
; CHECK-NEXT:    v_accvgpr_write_b32 a17, v52
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[14:17], v[84:87], v[88:91], v[14:17]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[38:41], v[192:195], v[196:199], v[38:41]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[42:45], v[208:211], v[212:215], v[42:45]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[10:13], v[76:79], v[80:83], v[10:13]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[14:17], v[92:95], v[96:99], v[14:17]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[38:41], v[200:203], v[204:207], v[38:41]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[42:45], v[216:219], v[220:223], v[42:45]
; CHECK-NEXT:    ; implicit-def: $vgpr3
; CHECK-NEXT:    v_mov_b32_e32 v52, v0
; CHECK-NEXT:    v_mov_b32_e32 v53, v1
; CHECK-NEXT:    ; implicit-def: $vgpr54
; CHECK-NEXT:    v_mov_b32_e32 v55, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[32:35], v[52:55], v[180:183], v[34:37]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[34:37], v[184:187], v[188:191], v[32:35]
; CHECK-NEXT:    v_mov_b32_e32 v6, v2
; CHECK-NEXT:    v_mov_b32_e32 v7, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[6:9], v[0:3], v[56:59], v[6:9]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[6:9], v[60:63], v[64:67], v[6:9]
; CHECK-NEXT:    v_mov_b32_e32 v21, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[18:21], v[100:103], v[104:107], v[18:21]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[18:21], v[108:111], v[112:115], v[18:21]
; CHECK-NEXT:    v_mov_b32_e32 v24, v2
; CHECK-NEXT:    v_mov_b32_e32 v25, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[22:25], v[132:135], v[136:139], v[22:25]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[22:25], v[140:143], v[144:147], v[22:25]
; CHECK-NEXT:    v_mov_b32_e32 v28, v2
; CHECK-NEXT:    v_mov_b32_e32 v29, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[24:27], v[148:151], v[152:155], v[26:29]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[26:29], v[156:159], v[160:163], v[24:27]
; CHECK-NEXT:    ; implicit-def: $vgpr31
; CHECK-NEXT:    ; implicit-def: $vgpr32
; CHECK-NEXT:    ; implicit-def: $vgpr33
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[28:31], v[164:167], v[168:171], v[30:33]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[30:33], v[172:175], v[176:179], v[28:31]
; CHECK-NEXT:    v_mov_b32_e32 v48, v2
; CHECK-NEXT:    v_mov_b32_e32 v49, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[46:49], v[224:227], v[228:231], v[46:49]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[46:49], v[232:235], v[236:239], v[46:49]
; CHECK-NEXT:    v_mov_b32_e32 v52, v2
; CHECK-NEXT:    v_mov_b32_e32 v53, v2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[48:51], v[240:243], v[244:247], v[50:53]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[50:53], v[248:251], v[252:255], v[48:51]
; CHECK-NEXT:    v_mov_b32_e32 v3, v2
; CHECK-NEXT:    v_mov_b32_e32 v0, 0
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[4:7], v[116:119], v[120:123], v[2:5]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[4:7], v[124:127], v[128:131], v[4:7]
; CHECK-NEXT:    s_nop 7
; CHECK-NEXT:    v_accvgpr_read_b32 v5, a16
; CHECK-NEXT:    v_mov_b32_e32 v3, 1.0
; CHECK-NEXT:    v_accvgpr_read_b32 v4, a17
; CHECK-NEXT:    v_accvgpr_mov_b32 a16, a17
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[52:55], a[0:3], a[4:7], v[2:5]
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[52:55], a[8:11], a[12:15], v[52:55]
; CHECK-NEXT:    s_nop 1
