...
; GFX7LESS-NEXT:    s_xor_b64 exec, vcc, exec
...
; GFX7LESS-DPP-NEXT:    s_xor_b64 exec, vcc, exec
...
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmax v0, off, s[0:3], 0
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX1064-DPP-NEXT:    s_xor_b64 exec, vcc, exec
...
; GFX1032-DPP-NEXT:    s_xor_b32 exec_lo, vcc_lo, exec_lo
...
; GFX9-NEXT:    v_max_f32_e64 v1, s7, s7
...
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmax v0, off, s[36:39], 0
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-DPP-NEXT:    v_max_f32_e64 v6, s6, s6
...
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-DPP-NEXT:    v_dual_max_f32 v1, v1, v2 :: v_dual_mov_b32 v2, 0x7fc00000
...
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_atomic_fmax_x2 v[0:1], off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmax_x2 v[0:1], off, s[0:3], 0
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_max_f64 v[4:5], s[6:7], s[6:7]
...
; GFX1164-NEXT:    v_max_f64 v[4:5], s[6:7], s[6:7]
...
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmax_x2 v[0:1], off, s[36:39], 0
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    v_max_f64 v[1:2], s[2:3], s[2:3]
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1132-DPP-NEXT:    s_mov_b32 s3, -1
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1132-DPP-NEXT:    v_cmp_ne_u32_e64 s2, 0, v0
