...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=GCN,GFX90A %s

define amdgpu_kernel void @max_16regs_13a_used(i32 %cond, ptr addrspace(1) %arg, ptr addrspace(1) %out) #2 {
; GFX908-LABEL: max_16regs_13a_used:
; GFX908:       ; %bb.0: ; %bb
...
; GFX908-NEXT:    v_accvgpr_write_b32 a8, 1
; GFX908-NEXT:    v_accvgpr_write_b32 a9, 2
; GFX908-NEXT:    v_accvgpr_write_b32 a10, 3
; GFX908-NEXT:    v_accvgpr_write_b32 a11, 4
; GFX908-NEXT:    v_accvgpr_write_b32 a12, 5
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
...
; GFX908-NEXT:    s_endpgm
;
; GFX90A-LABEL: max_16regs_13a_used:
; GFX90A:       ; %bb.0: ; %bb
...
; GFX90A-NEXT:    v_accvgpr_write_b32 a8, 1
; GFX90A-NEXT:    v_accvgpr_write_b32 a9, 2
; GFX90A-NEXT:    v_accvgpr_write_b32 a10, 3
; GFX90A-NEXT:    v_accvgpr_write_b32 a11, 4
; GFX90A-NEXT:    v_accvgpr_write_b32 a12, 5
; GFX90A-NEXT:    ;;#ASMSTART
; GFX90A-NEXT:    ;;#ASMEND
...
; GFX908-NEXT:    v_accvgpr_read_b32 v4, a1 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_read_b32 v3, a2 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_read_b32 v2, a3 ; Reload Reuse
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
...
; GFX908-NEXT:    v_accvgpr_write_b32 a0, v5 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_write_b32 a1, v4 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_write_b32 a2, v3 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_write_b32 a3, v2 ; Reload Reuse
; GFX908-NEXT:    ;;#ASMSTART
; GFX908-NEXT:    ;;#ASMEND
...
define amdgpu_kernel void @max_9regs_used_8a(ptr addrspace(1) %arg) #4 {
; GFX908-LABEL: max_9regs_used_8a:
; GFX908:       ; %bb.0:
; GFX908-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
...
; GFX908-NEXT:    v_accvgpr_read_b32 v5, a7 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_read_b32 v7, a5 ; Reload Reuse
; GFX908-NEXT:    buffer_store_dword v8, off, s[8:11], 0 ; 4-byte Folded Spill
; GFX908-NEXT:    v_accvgpr_read_b32 v8, a1 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_read_b32 v6, a6 ; Reload Reuse
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_accvgpr_write_b32 a0, v8 ; Reload Reuse
; GFX908-NEXT:    buffer_load_dword v8, off, s[8:11], 0 offset:4 ; 4-byte Folded Reload
; GFX908-NEXT:    v_accvgpr_write_b32 a5, v7 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_write_b32 a6, v6 ; Reload Reuse
; GFX908-NEXT:    global_store_dwordx4 v4, v[0:3], s[2:3]
; GFX908-NEXT:    s_waitcnt vmcnt(1)
; GFX908-NEXT:    v_accvgpr_write_b32 a1, v8 ; Reload Reuse
; GFX908-NEXT:    buffer_load_dword v8, off, s[8:11], 0 offset:8 ; 4-byte Folded Reload
; GFX908-NEXT:    v_accvgpr_read_b32 v2, a6
; GFX908-NEXT:    v_accvgpr_read_b32 v1, a5
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_accvgpr_write_b32 a2, v8 ; Reload Reuse
; GFX908-NEXT:    buffer_load_dword v8, off, s[8:11], 0 offset:12 ; 4-byte Folded Reload
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_accvgpr_write_b32 a3, v8 ; Reload Reuse
; GFX908-NEXT:    buffer_load_dword v8, off, s[8:11], 0 offset:16 ; 4-byte Folded Reload
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_accvgpr_write_b32 a4, v8 ; Reload Reuse
; GFX908-NEXT:    v_accvgpr_write_b32 a7, v5 ; Reload Reuse
; GFX908-NEXT:    s_nop 1
...
; GFX908-NEXT:    s_endpgm
;
; GFX90A-LABEL: max_9regs_used_8a:
; GFX90A:       ; %bb.0:
...
; GFX90A-NEXT:    v_mov_b32_e32 v2, 1.0
; GFX90A-NEXT:    v_accvgpr_read_b32 v8, a2 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_read_b32 v7, a3 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_read_b32 v3, a7 ; Reload Reuse
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    global_load_dwordx4 a[0:3], v0, s[2:3]
; GFX90A-NEXT:    v_accvgpr_read_b32 v6, a4 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_read_b32 v5, a5 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_read_b32 v4, a6 ; Reload Reuse
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v2, v2, a[0:3]
; GFX90A-NEXT:    s_nop 4
; GFX90A-NEXT:    global_store_dwordx4 v0, a[0:3], s[2:3]
; GFX90A-NEXT:    buffer_load_dword a0, off, s[8:11], 0 ; 4-byte Folded Reload
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    buffer_load_dword a1, off, s[8:11], 0 offset:4 ; 4-byte Folded Reload
; GFX90A-NEXT:    v_accvgpr_write_b32 a2, v8 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_write_b32 a3, v7 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_write_b32 a4, v6 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_write_b32 a5, v5 ; Reload Reuse
; GFX90A-NEXT:    v_accvgpr_write_b32 a6, v4 ; Reload Reuse
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_accvgpr_write_b32 a7, v3 ; Reload Reuse
...
; GFX90A-NEXT:    s_endpgm
  ...
  %a4 = call <8 x float> asm sideeffect "; def $0", "=a"()
  ...
  store volatile <8 x float> %a4, ptr addrspace(1) poison
...
attributes #1 = { nounwind "amdgpu-num-vgpr"="9" "amdgpu-no-dispatch-id" "amdgpu-no-dispatch-ptr" "amdgpu-no-implicitarg-ptr" "amdgpu-no-lds-kernel-id" "amdgpu-no-queue-ptr" "amdgpu-no-workgroup-id-x" "amdgpu-no-cluster-id-x" "amdgpu-no-workgroup-id-y" "amdgpu-no-cluster-id-y" "amdgpu-no-workgroup-id-z" "amdgpu-no-cluster-id-z" "amdgpu-no-workitem-id-y" "amdgpu-no-workitem-id-z" }
attributes #2 = { nounwind "amdgpu-num-vgpr"="16" "amdgpu-no-dispatch-id" "amdgpu-no-dispatch-ptr" "amdgpu-no-implicitarg-ptr" "amdgpu-no-lds-kernel-id" "amdgpu-no-queue-ptr" "amdgpu-no-workgroup-id-x" "amdgpu-no-cluster-id-x" "amdgpu-no-workgroup-id-y" "amdgpu-no-cluster-id-y" "amdgpu-no-workgroup-id-z" "amdgpu-no-cluster-id-z" "amdgpu-no-workitem-id-y" "amdgpu-no-workitem-id-z" }
...
attributes #4 = { nounwind "amdgpu-num-vgpr"="9" "amdgpu-no-dispatch-id" "amdgpu-no-dispatch-ptr" "amdgpu-no-implicitarg-ptr" "amdgpu-no-lds-kernel-id" "amdgpu-no-queue-ptr" "amdgpu-no-workgroup-id-x" "amdgpu-no-cluster-id-x" "amdgpu-no-workgroup-id-y" "amdgpu-no-cluster-id-y" "amdgpu-no-workgroup-id-z" "amdgpu-no-cluster-id-z" "amdgpu-no-workitem-id-y" "amdgpu-no-workitem-id-z" }

attributes #1 = { nounwind "amdgpu-num-vgpr"="9" "amdgpu-no-dispatch-id" "amdgpu-no-dispatch-ptr" "amdgpu-no-implicitarg-ptr" "amdgpu-no-lds-kernel-id" "amdgpu-no-queue-ptr" "amdgpu-no-workgroup-id-x" "amdgpu-no-workgroup-id-y" "amdgpu-no-workgroup-id-z" "amdgpu-no-workitem-id-y" "amdgpu-no-workitem-id-z" }
attributes #2 = { nounwind "amdgpu-num-vgpr"="16" "amdgpu-no-dispatch-id" "amdgpu-no-dispatch-ptr" "amdgpu-no-implicitarg-ptr" "amdgpu-no-lds-kernel-id" "amdgpu-no-queue-ptr" "amdgpu-no-workgroup-id-x" "amdgpu-no-workgroup-id-y" "amdgpu-no-workgroup-id-z" "amdgpu-no-workitem-id-y" "amdgpu-no-workitem-id-z" }
...
attributes #4 = { nounwind "amdgpu-num-vgpr"="9" "amdgpu-no-dispatch-id" "amdgpu-no-dispatch-ptr" "amdgpu-no-implicitarg-ptr" "amdgpu-no-lds-kernel-id" "amdgpu-no-queue-ptr" "amdgpu-no-workgroup-id-x" "amdgpu-no-workgroup-id-y" "amdgpu-no-workgroup-id-z" "amdgpu-no-workitem-id-y" "amdgpu-no-workitem-id-z" }
