...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=kaveri -mattr=-flat-for-global,+max-private-element-size-16 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=tonga -mattr=-flat-for-global -mattr=+max-private-element-size-16 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI %s
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; SI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x2
; SI-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; VI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x8
; VI-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; VI-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x4
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_load_dword s7, s[8:9], 0x8
; SI-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, -1
...
; VI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x10
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dword s7, s[8:9], 0x20
; VI-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; VI-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; SI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x4
; SI-NEXT:    s_load_dword s8, s[8:9], 0x8
; SI-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; VI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x10
; VI-NEXT:    s_load_dword s8, s[8:9], 0x20
; VI-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; VI-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    s_load_dword s8, s[8:9], 0x11
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_load_dword s8, s[8:9], 0x44
; VI-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_cselect_b32 s5, s8, s5
; VI-NEXT:    s_cmp_eq_u32 s10, 0
; VI-NEXT:    s_cselect_b32 s4, s8, s4
; VI-NEXT:    v_mov_b32_e32 v0, s4
; VI-NEXT:    v_mov_b32_e32 v1, s5
; VI-NEXT:    v_mov_b32_e32 v2, s6
; VI-NEXT:    v_mov_b32_e32 v3, s7
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; SI-NEXT:    s_mov_b32 s6, 0x100f000
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; VI-NEXT:    s_mov_b32 s6, 0x1100f000
...
; SI-NEXT:    s_cmp_lg_u32 s8, 7
; SI-NEXT:    s_cselect_b32 s9, s9, 5
; SI-NEXT:    s_lshl_b32 s9, s9, 24
; SI-NEXT:    s_lshr_b32 s10, s5, 16
; SI-NEXT:    s_cmp_lg_u32 s8, 6
; SI-NEXT:    s_cselect_b32 s10, s10, 5
; SI-NEXT:    s_and_b32 s10, s10, 0xff
; SI-NEXT:    s_lshl_b32 s10, s10, 16
; SI-NEXT:    s_or_b32 s9, s9, s10
; SI-NEXT:    s_lshr_b32 s10, s5, 8
; SI-NEXT:    s_cmp_lg_u32 s8, 5
; SI-NEXT:    s_cselect_b32 s10, s10, 5
; SI-NEXT:    s_lshl_b32 s10, s10, 8
; SI-NEXT:    s_cmp_lg_u32 s8, 4
; SI-NEXT:    s_cselect_b32 s5, s5, 5
...
; VI-NEXT:    s_lshr_b32 s9, s6, 24
; VI-NEXT:    s_cmp_lg_u32 s8, 11
; VI-NEXT:    s_cselect_b32 s9, s9, 5
; VI-NEXT:    s_lshl_b32 s9, s9, 8
; VI-NEXT:    s_lshr_b32 s10, s6, 16
; VI-NEXT:    s_cmp_lg_u32 s8, 10
; VI-NEXT:    s_cselect_b32 s10, s10, 5
; VI-NEXT:    s_and_b32 s10, s10, 0xff
; VI-NEXT:    s_or_b32 s9, s10, s9
; VI-NEXT:    s_lshl_b32 s9, s9, 16
; VI-NEXT:    s_lshr_b32 s10, s6, 8
; VI-NEXT:    s_cmp_lg_u32 s8, 9
; VI-NEXT:    s_cselect_b32 s10, s10, 5
; VI-NEXT:    s_lshl_b32 s10, s10, 8
; VI-NEXT:    s_cmp_lg_u32 s8, 8
; VI-NEXT:    s_cselect_b32 s6, s6, 5
; VI-NEXT:    s_and_b32 s6, s6, 0xff
; VI-NEXT:    s_or_b32 s6, s6, s10
; VI-NEXT:    s_and_b32 s6, s6, 0xffff
; VI-NEXT:    s_or_b32 s6, s6, s9
; VI-NEXT:    s_lshr_b32 s9, s5, 24
; VI-NEXT:    s_cmp_lg_u32 s8, 7
; VI-NEXT:    s_cselect_b32 s9, s9, 5
; VI-NEXT:    s_lshl_b32 s9, s9, 8
; VI-NEXT:    s_lshr_b32 s10, s5, 16
; VI-NEXT:    s_cmp_lg_u32 s8, 6
; VI-NEXT:    s_cselect_b32 s10, s10, 5
; VI-NEXT:    s_and_b32 s10, s10, 0xff
; VI-NEXT:    s_or_b32 s9, s10, s9
; VI-NEXT:    s_lshl_b32 s9, s9, 16
; VI-NEXT:    s_lshr_b32 s10, s5, 8
; VI-NEXT:    s_cmp_lg_u32 s8, 5
; VI-NEXT:    s_cselect_b32 s10, s10, 5
; VI-NEXT:    s_lshl_b32 s10, s10, 8
; VI-NEXT:    s_cmp_lg_u32 s8, 4
; VI-NEXT:    s_cselect_b32 s5, s5, 5
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; SI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0xc
; SI-NEXT:    s_load_dword s8, s[8:9], 0x18
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; VI-NEXT:    s_load_dwordx4 s[4:7], s[8:9], 0x30
; VI-NEXT:    s_load_dword s8, s[8:9], 0x60
; VI-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    v_mov_b32_e32 v2, s6
; VI-NEXT:    v_mov_b32_e32 v3, s7
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0 offset:16
; VI-NEXT:    s_nop 0
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mov_b32_e32 v2, s2
