...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -mattr=+real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GCN,GCN-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -mattr=-real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GCN,GCN-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=+real-true16,+d16-write-vgpr32 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX12-TRUE16,GFX12-TRUE16-D16W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=+real-true16,-d16-write-vgpr32 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX12-TRUE16,GFX12-TRUE16-D16W16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=+real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX1250,GFX1250-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=-real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX1250,GFX1250-FAKE16
...
; GFX12-TRUE16-NEXT:    scratch_load_d16_b16 v0, off, s32 offset:2 ; 2-byte Folded Reload
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-TRUE16-NEXT:    scratch_load_u16 v1, off, s32 offset:2 nv ; 2-byte Folded Reload
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-FAKE16-NEXT:    scratch_load_b32 v0, off, s32 offset:4 nv ; 4-byte Folded Reload
; GFX1250-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-TRUE16-D16W32-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-D16W32-NEXT:    scratch_load_d16_hi_b16 v0, off, s32 offset:6 ; 2-byte Folded Reload
; GFX12-TRUE16-D16W32-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-D16W32-NEXT:    v_add_nc_u16 v0.l, 0x7b, v0.l
...
; GFX12-TRUE16-D16W16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-D16W16-NEXT:    scratch_load_d16_hi_b16 v0, off, s32 offset:6 ; 2-byte Folded Reload
; GFX12-TRUE16-D16W16-NEXT:    v_add_nc_u16 v0.l, 0x7b, v0.l
; GFX12-TRUE16-D16W16-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    scratch_load_u16 v1, off, s32 offset:6 nv ; 2-byte Folded Reload
; GFX1250-TRUE16-NEXT:    v_add_nc_u16 v0.l, 0x7b, v0.l
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    scratch_load_b32 v1, off, s32 offset:8 nv ; 4-byte Folded Reload
; GFX1250-FAKE16-NEXT:    v_add_nc_u16 v0, 0x7b, v0
; GFX1250-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    ;;#ASMEND
; GFX1250-NEXT:    scratch_load_b32 v0, off, s32 offset:4 nv ; 4-byte Folded Reload
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-TRUE16-NEXT:    ;;#ASMSTART
; GFX12-TRUE16-NEXT:    ;;#ASMEND
; GFX12-TRUE16-NEXT:    scratch_load_d16_b16 v0, off, s32 offset:8 ; 2-byte Folded Reload
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    ;;#ASMSTART
; GFX1250-NEXT:    ;;#ASMEND
; GFX1250-NEXT:    scratch_load_b32 v0, off, s32 offset:8 nv ; 4-byte Folded Reload
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-TRUE16-NEXT:    scratch_store_b16 off, v0, s32 offset:2 scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    scratch_load_d16_b16 v0, off, s32 offset:10 ; 2-byte Folded Reload
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    scratch_store_b16 off, v0, s32 scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1250-TRUE16-NEXT:    ;;#ASMSTART
; GFX1250-TRUE16-NEXT:    ;;#ASMEND
; GFX1250-TRUE16-NEXT:    scratch_load_b32 v0, off, s32 offset:12 nv ; 4-byte Folded Reload
; GFX1250-TRUE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    scratch_store_b16 off, v0, s32 offset:2 scope:SCOPE_SYS
; GFX1250-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX1250-TRUE16-NEXT:    scratch_load_b32 v0, off, s32 offset:8 nv ; 4-byte Folded Reload
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    scratch_store_b16 off, v0, s32 scope:SCOPE_SYS
; GFX1250-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-FAKE16-NEXT:    ;;#ASMSTART
; GFX1250-FAKE16-NEXT:    ;;#ASMEND
; GFX1250-FAKE16-NEXT:    scratch_load_b32 v0, off, s32 offset:8 nv ; 4-byte Folded Reload
; GFX1250-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    scratch_store_b16 off, v0, s32 offset:2 scope:SCOPE_SYS
; GFX1250-FAKE16-NEXT:    s_wait_storecnt 0x0
; GFX1250-FAKE16-NEXT:    scratch_load_b32 v0, off, s32 offset:12 nv ; 4-byte Folded Reload
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    scratch_store_b16 off, v0, s32 scope:SCOPE_SYS
; GFX1250-FAKE16-NEXT:    s_wait_storecnt 0x0
; GFX1250-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX12-TRUE16-NEXT:    ;;#ASMSTART
; GFX12-TRUE16-NEXT:    ;;#ASMEND
; GFX12-TRUE16-NEXT:    scratch_load_b32 v0, off, s32 offset:8 ; 4-byte Folded Reload
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
