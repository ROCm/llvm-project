...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -mattr=+real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GCN,GCN-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -mattr=-real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GCN,GCN-FAKE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa -mattr=+real-true16,+d16-write-vgpr32 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX12-TRUE16,GFX12-TRUE16-D16W32
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa -mattr=+real-true16,-d16-write-vgpr32 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX12-TRUE16,GFX12-TRUE16-D16W16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX1250,GFX1250-TRUE16
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 -enable-misched=0 -post-RA-scheduler=0 -stress-regalloc=8 < %s | FileCheck %s -check-prefixes=GFX1250,GFX1250-FAKE16
