...
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v4, v0
; SDAG-NEXT:    v_bfe_u32 v11, v4, 23, 8
; SDAG-NEXT:    s_movk_i32 s4, 0x7e
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
; SDAG-NEXT:    v_cmp_lt_u32_e32 vcc, s4, v11
; SDAG-NEXT:    s_and_saveexec_b64 s[6:7], vcc
...
; SDAG-NEXT:    v_ashrrev_i32_e32 v9, 31, v7
; SDAG-NEXT:    v_or_b32_e32 v10, 1, v7
...
; SDAG-NEXT:    v_sub_u32_e32 v0, 0xd6, v11
; SDAG-NEXT:    v_add_u32_e32 v2, 0xffffff2a, v11
; SDAG-NEXT:    v_add_u32_e32 v4, 0xffffff6a, v11
...
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v8, v10, 0
; SDAG-NEXT:    v_cndmask_b32_e32 v13, 0, v1, vcc
; SDAG-NEXT:    v_mul_lo_u32 v11, v9, v2
; SDAG-NEXT:    v_mul_lo_u32 v12, v10, v3
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v10, v[5:6]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v2, 0
; SDAG-NEXT:    v_mul_lo_u32 v10, v7, v13
; SDAG-NEXT:    v_mov_b32_e32 v5, v0
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v9, v[5:6]
; SDAG-NEXT:    v_add3_u32 v3, v3, v12, v11
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v8, v[2:3]
; SDAG-NEXT:    v_mul_lo_u32 v7, v7, v8
...
; SDAG-NEXT:    v_add3_u32 v3, v7, v3, v10
...
; SDAG-NEXT:  ; %bb.4: ; %fp-to-i-if-exp.small
; SDAG-NEXT:    v_sub_u32_e32 v0, 0x96, v11
; SDAG-NEXT:    v_lshrrev_b32_e32 v3, v0, v5
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v3, v10, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v6, v2
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[8:9], v3, v9, v[1:2]
