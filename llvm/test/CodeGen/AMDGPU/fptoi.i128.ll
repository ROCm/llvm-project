...
; SDAG-NEXT:    v_lshrrev_b64 v[10:11], v0, v[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v9, 0
; SDAG-NEXT:    v_mul_lo_u32 v7, v8, v11
; SDAG-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v11, v9, v[1:2]
; SDAG-NEXT:    v_mov_b32_e32 v1, v12
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v10, v8, v[1:2]
; SDAG-NEXT:    v_add_co_u32_e64 v2, s[4:5], v13, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v11, v8, v[2:3]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v10, v[2:3]
; SDAG-NEXT:    v_mul_lo_u32 v10, v8, v10
; SDAG-NEXT:    v_add3_u32 v3, v10, v3, v7
; SDAG-NEXT:  .LBB0_3:
...
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[6:7], s4, v10
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
...
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v13, v2
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v3, v7, v[1:2]
; SDAG-NEXT:    v_mad_i64_i32 v[2:3], s[4:5], v8, v3, v[12:13]
...
; SDAG-NEXT:    v_mul_lo_u32 v11, v7, v2
...
; SDAG-NEXT:    v_mul_lo_u32 v9, v8, v13
; SDAG-NEXT:    v_mov_b32_e32 v5, v0
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v7, v[5:6]
; SDAG-NEXT:    v_add3_u32 v3, v3, v12, v11
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v10, v[2:3]
; SDAG-NEXT:    v_mul_lo_u32 v8, v8, v10
; SDAG-NEXT:    v_add_co_u32_e32 v0, vcc, v1, v6
; SDAG-NEXT:    v_addc_co_u32_e64 v1, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v7, v[0:1]
; SDAG-NEXT:    v_add3_u32 v3, v8, v3, v9
...
; SDAG-NEXT:    s_movk_i32 s4, 0x7f
; SDAG-NEXT:    v_cmp_gt_u16_e64 s[6:7], s4, v8
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
...
; SDAG-NEXT:    v_ashrrev_i16_e32 v5, 15, v4
; SDAG-NEXT:    s_movk_i32 s5, 0x85
; SDAG-NEXT:    v_bfe_i32 v6, v5, 0, 16
; SDAG-NEXT:    v_and_b32_e32 v4, 0x7f, v4
; SDAG-NEXT:    v_cmp_lt_u16_e32 vcc, s5, v8
; SDAG-NEXT:    s_mov_b32 s4, 0
; SDAG-NEXT:    v_ashrrev_i32_e32 v5, 31, v6
; SDAG-NEXT:    v_or_b32_e32 v7, 1, v6
...
; SDAG-NEXT:    v_mul_hi_i32_i24_e32 v1, v0, v7
; SDAG-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; SDAG-NEXT:    v_mul_i32_i24_e32 v0, v0, v7
...
; SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v10, v[8:9]
; SDAG-NEXT:    v_mul_lo_u32 v9, v6, v13
; SDAG-NEXT:    v_add_co_u32_e32 v2, vcc, v4, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_mul_lo_u32 v6, v6, v10
