...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GISEL %s
...
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; SDAG-NEXT:    ; divergent control-flow edge
...
; SDAG-NEXT:    v_cmp_gt_u32_e32 vcc, s4, v7
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
...
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v7, v6, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v6, v2
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[8:9], v7, v5, v[1:2]
; SDAG-NEXT:    v_mad_i64_i32 v[2:3], s[8:9], v3, v7, v[5:6]
...
; SDAG-NEXT:    s_movk_i32 s4, 0x7f
; SDAG-NEXT:    v_cmp_gt_u32_e32 vcc, s4, v5
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    v_mov_b32_e32 v1, 0
...
; SDAG-NEXT:    s_movk_i32 s4, 0x7f
; SDAG-NEXT:    v_cmp_gt_u16_e32 vcc, s4, v7
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
