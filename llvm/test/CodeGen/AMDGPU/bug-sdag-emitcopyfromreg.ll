...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 < %s | FileCheck %s -check-prefix=ISA
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10 -stop-before=si-fix-sgpr-copies < %s | FileCheck %s -check-prefix=MIR
...
; ISA-NEXT:    v_mov_b32_e32 v8, 0
; ISA-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc_lo
