...
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.02 | FileCheck -check-prefixes=PREGFX10-UNPACKED %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu8.10 | FileCheck -check-prefixes=PREGFX10-PACKED %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu9.00 | FileCheck -check-prefixes=PREGFX10-PACKED %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu10.10 | FileCheck -check-prefixes=GFX10-PACKED %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX11-PACKED,GFX11-PACKED-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX11-PACKED,GFX11-PACKED-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX12-PACKED,GFX12-PACKED-SDAG,GFX12-PACKED-SDAG-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 < %s -mtriple=amdgpu12.00 -mattr=-real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX12-PACKED,GFX12-PACKED-SDAG,GFX12-PACKED-SDAG-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -global-isel-abort=2 -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX12-PACKED,GFX12-PACKED-GISEL,GFX12-PACKED-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -global-isel-abort=2 -mtriple=amdgpu12.00 -mattr=-real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX12-PACKED,GFX12-PACKED-GISEL,GFX12-PACKED-GISEL-FAKE16 %s
