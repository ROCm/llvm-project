...
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX12-PACKED,GFX12-PACKED-GISEL,GFX12-PACKED-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 < %s -global-isel -mtriple=amdgpu12.00 -mattr=-real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX12-PACKED,GFX12-PACKED-GISEL,GFX12-PACKED-GISEL-FAKE16 %s
