...
; RUN: llc -amdgpu-late-wave-transform=1 -amdgpu-scalar-ir-passes=0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=GCN %s
...
; GCN-NEXT:    ds_read_b64 v[11:12], v6 offset:16
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_add_co_u32_e64 v4, s[0:1], v11, v4
; GCN-NEXT:    v_addc_co_u32_e64 v5, s[0:1], v12, v5, s[0:1]
; GCN-NEXT:    v_add_co_u32_e64 v2, s[0:1], v9, v2
; GCN-NEXT:    v_addc_co_u32_e64 v3, s[0:1], v10, v3, s[0:1]
