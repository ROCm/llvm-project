...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu7.04 -stop-before=machine-scheduler < %s | FileCheck -enable-var-scope -check-prefixes=MIR,GISEL %s
