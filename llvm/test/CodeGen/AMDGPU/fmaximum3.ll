...
; GFX942-NEXT:    v_max_f32_e32 v8, v0, v2
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v2
...
; GFX942-NEXT:    v_max_f32_e32 v3, v5, v1
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_max_f32_e32 v3, v1, v5
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v2, vcc
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v7, 0x7fc00000
; GFX942-NEXT:    v_max_f32_e64 v8, |v0|, |v2|
; GFX942-NEXT:    v_cmp_o_f32_e64 vcc, |v0|, |v2|
...
; GFX942-NEXT:    v_max_f32_e64 v3, v1, |v5|
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v2, vcc
...
; GFX942-NEXT:    v_max_f32_e32 v6, v0, v2
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_max_f32_e32 v12, v0, v3
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v3
; GFX942-NEXT:    v_max_f32_e32 v11, v1, v4
...
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v10, v11, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v5
; GFX942-NEXT:    v_max_f32_e32 v4, v1, v7
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v10, v9, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v6
; GFX942-NEXT:    v_max_f32_e32 v5, v2, v8
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v10, v3, vcc
...
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v10, 0x7fc00000
; GFX942-NEXT:    v_max_f32_e64 v12, |v0|, |v3|
; GFX942-NEXT:    v_cmp_o_f32_e64 vcc, |v0|, |v3|
; GFX942-NEXT:    v_max_f32_e64 v11, |v1|, |v4|
...
; GFX942-NEXT:    v_max_f32_e64 v4, v1, |v7|
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v10, v9, vcc
; GFX942-NEXT:    v_cmp_o_f32_e64 vcc, v0, |v6|
; GFX942-NEXT:    v_max_f32_e64 v5, v2, |v8|
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v10, v3, vcc
...
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v7, v8, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v5
; GFX942-NEXT:    v_max_f32_e32 v4, 4.0, v1
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v7, v6, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v0
; GFX942-NEXT:    v_max_f32_e32 v5, 4.0, v2
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v8, vcc
; GFX942-NEXT:    v_pk_max_f16 v8, v1, v3
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v7, v8, vcc
; GFX942-NEXT:    v_pk_max_f16 v8, v1, v3 neg_lo:[1,1] neg_hi:[1,1]
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, -v1, -v3
; GFX942-NEXT:    v_perm_b32 v2, v0, v6, s0
; GFX942-NEXT:    v_lshrrev_b32_e32 v9, 16, v8
; GFX942-NEXT:    v_cndmask_b32_e32 v8, v7, v8, vcc
