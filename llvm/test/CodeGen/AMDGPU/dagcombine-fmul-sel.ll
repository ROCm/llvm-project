...
; GFX7-NEXT:    v_cndmask_b32_e64 v2, 1.0, 2.0, vcc
; GFX7-NEXT:    v_mul_f32_e32 v1, v1, v2
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v5, 0xbff00000
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, v2, v3
; GFX7-NEXT:    v_mov_b32_e32 v4, 0
; GFX7-NEXT:    v_cndmask_b32_e64 v5, v5, 2.0, vcc
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v5, 0xbff00000
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v2, v3
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, 2.0, vcc
...
; GFX7-SDAG:       ; %bb.0:
; GFX7-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-SDAG-NEXT:    v_mov_b32_e32 v9, 0xbff00000
; GFX7-SDAG-NEXT:    v_mov_b32_e32 v10, 0x3fe00000
; GFX7-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v6
; GFX7-SDAG-NEXT:    v_cndmask_b32_e32 v9, v9, v10, vcc
...
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v9, 0xbff00000
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v10, 0x3fe00000
; GFX9-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v6
; GFX9-SDAG-NEXT:    v_cndmask_b32_e32 v9, v9, v10, vcc
...
; GFX10-SDAG:       ; %bb.0:
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v9, 0x3fe00000
; GFX10-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v6
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-SDAG-NEXT:    v_cndmask_b32_e32 v9, 0xbff00000, v9, vcc_lo
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v9, 0x3fe00000 :: v_dual_mov_b32 v8, 0
...
; GFX11-SDAG-NEXT:    v_cndmask_b32_e32 v9, 0xbff00000, v9, vcc_lo
...
; GFX7-GISEL-NEXT:    v_ldexp_f32_e32 v0, v0, v1
; GFX7-GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX7-GISEL-NEXT:    v_ldexp_f32_e32 v1, v5, v1
...
; GFX9-GISEL-NEXT:    v_med3_i32 v1, v1, v5, v6
...
; GFX11-GISEL-TRUE16-NEXT:    v_med3_i32 v1, 0xffff8000, v1, v5
...
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v1, 0xffff8000, v1, v5
...
; GFX7-NEXT:    v_cndmask_b32_e64 v2, 1.0, 2.0, vcc
; GFX7-NEXT:    v_mul_f32_e32 v0, v0, v2
; GFX7-NEXT:    v_mul_f32_e32 v1, v5, v1
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
