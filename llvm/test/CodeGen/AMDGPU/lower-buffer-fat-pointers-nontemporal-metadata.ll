...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -global-isel=0 -mcpu=gfx900 < %s | FileCheck --check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -global-isel=1 -mcpu=gfx900 < %s | FileCheck --check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -global-isel=0 -mcpu=gfx942 < %s | FileCheck --check-prefixes=GFX942,GFX942-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -global-isel=1 -mcpu=gfx942 < %s | FileCheck --check-prefixes=GFX942,GFX942-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -global-isel=0 -mcpu=gfx1010 < %s | FileCheck --check-prefixes=GFX10,GFX10-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -global-isel=1 -mcpu=gfx1010 < %s | FileCheck --check-prefixes=GFX10,GFX10-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -global-isel=0 -mcpu=gfx1100 < %s | FileCheck --check-prefixes=GFX11,GFX11-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -global-isel=1 -mcpu=gfx1100 < %s | FileCheck --check-prefixes=GFX11,GFX11-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdhsa -global-isel=0 -mcpu=gfx1200 < %s | FileCheck --check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgcn-amd-amdhsa -global-isel=1 -mcpu=gfx1200 < %s | FileCheck --check-prefixes=GFX12,GFX12-GISEL %s
...
; GFX10-SDAG-NEXT:    s_load_dword s7, s[8:9], 0x10
; GFX10-SDAG-NEXT:    s_mov_b32 s6, 0
; GFX10-SDAG-NEXT:    s_mov_b32 s10, 0
; GFX10-SDAG-NEXT:    s_mov_b32 s5, s6
...
; GFX10-SDAG-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX10-SDAG-NEXT:    s_or_b64 s[2:3], s[4:5], s[6:7]
; GFX10-SDAG-NEXT:    s_mov_b32 s4, s6
; GFX10-SDAG-NEXT:    buffer_load_dword v0, v0, s[0:3], 0 offen slc
; GFX10-SDAG-NEXT:    s_clause 0x1
; GFX10-SDAG-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x20
; GFX10-SDAG-NEXT:    s_load_dword s7, s[8:9], 0x30
; GFX10-SDAG-NEXT:    s_mov_b32 s9, s6
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX10-SDAG-NEXT:    s_mov_b32 s8, s3
; GFX10-SDAG-NEXT:    s_mov_b32 s5, s2
; GFX10-SDAG-NEXT:    s_mov_b32 s2, s1
; GFX10-SDAG-NEXT:    s_mov_b32 s3, s6
; GFX10-SDAG-NEXT:    s_or_b64 s[6:7], s[8:9], s[6:7]
; GFX10-SDAG-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
...
; GFX11-SDAG-NEXT:    s_load_b32 s7, s[4:5], 0x10
; GFX11-SDAG-NEXT:    s_mov_b32 s6, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s10, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s9, s6
; GFX11-SDAG-NEXT:    s_mov_b32 s13, s6
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-SDAG-NEXT:    s_mov_b32 s11, s2
; GFX11-SDAG-NEXT:    s_mov_b32 s12, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s8, s3
; GFX11-SDAG-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX11-SDAG-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GFX11-SDAG-NEXT:    buffer_load_b32 v0, v0, s[0:3], 0 offen slc dlc
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x20
; GFX11-SDAG-NEXT:    s_load_b32 s7, s[4:5], 0x30
; GFX11-SDAG-NEXT:    s_mov_b32 s4, s6
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX11-SDAG-NEXT:    s_mov_b32 s8, s3
; GFX11-SDAG-NEXT:    s_mov_b32 s5, s2
; GFX11-SDAG-NEXT:    s_mov_b32 s2, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s3, s6
; GFX11-SDAG-NEXT:    s_or_b64 s[6:7], s[8:9], s[6:7]
; GFX11-SDAG-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
...
; GFX12-SDAG-NEXT:    s_load_b32 s7, s[4:5], 0x10
; GFX12-SDAG-NEXT:    s_mov_b32 s6, 0
; GFX12-SDAG-NEXT:    s_mov_b32 s10, 0
; GFX12-SDAG-NEXT:    s_mov_b32 s9, s6
; GFX12-SDAG-NEXT:    s_mov_b32 s13, s6
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-SDAG-NEXT:    s_mov_b32 s11, s2
; GFX12-SDAG-NEXT:    s_mov_b32 s12, s1
; GFX12-SDAG-NEXT:    s_mov_b32 s8, s3
; GFX12-SDAG-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX12-SDAG-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x20
; GFX12-SDAG-NEXT:    s_load_b32 s7, s[4:5], 0x30
; GFX12-SDAG-NEXT:    s_mov_b32 s4, s6
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX12-SDAG-NEXT:    s_mov_b32 s8, s3
; GFX12-SDAG-NEXT:    s_mov_b32 s5, s2
; GFX12-SDAG-NEXT:    s_mov_b32 s2, s1
; GFX12-SDAG-NEXT:    s_mov_b32 s3, s6
; GFX12-SDAG-NEXT:    s_or_b64 s[6:7], s[8:9], s[6:7]
; GFX12-SDAG-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
...
; GFX10-SDAG-NEXT:    s_or_b64 s[2:3], s[4:5], s[6:7]
; GFX10-SDAG-NEXT:    s_mov_b32 s4, s6
; GFX10-SDAG-NEXT:    buffer_load_dword v0, v0, s[0:3], 0 offen glc dlc
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    s_clause 0x1
; GFX10-SDAG-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x20
...
; GFX11-SDAG-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX11-SDAG-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GFX11-SDAG-NEXT:    buffer_load_b32 v0, v0, s[0:3], 0 offen glc dlc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x20
; GFX11-SDAG-NEXT:    s_load_b32 s7, s[4:5], 0x30
...
; GFX12-SDAG-NEXT:    s_or_b64 s[0:1], s[12:13], s[10:11]
; GFX12-SDAG-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen th:TH_LOAD_NT scope:SCOPE_SYS
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x20
; GFX12-SDAG-NEXT:    s_load_b32 s7, s[4:5], 0x30
