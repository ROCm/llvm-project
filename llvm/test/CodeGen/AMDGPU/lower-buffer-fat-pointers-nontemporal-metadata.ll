...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.00-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.00-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX942,GFX942-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu9.42-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX942,GFX942-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu10.10-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX10,GFX10-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu10.10-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX10,GFX10-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX11,GFX11-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu11.00-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX11,GFX11-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -mtriple=amdgpu12.00-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX12,GFX12-GISEL %s
