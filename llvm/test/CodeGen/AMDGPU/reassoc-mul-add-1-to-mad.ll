...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx600 < %s | FileCheck -check-prefixes=GFX67,GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx700 < %s | FileCheck -check-prefixes=GFX67,GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx803 < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9,GFX900 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx90a < %s | FileCheck -check-prefixes=GFX9,GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-REAL16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1310 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1310 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX13,GFX13-REAL16 %s
...
; GFX1250-REAL16-NEXT:    v_mad_u16 v0.l, v0.l, v0.h, v0.l
...
; GFX13-REAL16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX13-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-REAL16-NEXT:    v_mad_u16 v0.l, v0.l, v0.h, v0.l
...
; GFX1250-REAL16-NEXT:    v_mul_lo_u16 v0.h, v0.l, v0.h
...
; GFX13-REAL16-NEXT:    s_wait_kmcnt 0x0
; GFX13-REAL16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX13-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-REAL16-NEXT:    v_mul_lo_u16 v0.h, v0.l, v0.h
...
; GFX67-NEXT:    s_add_i32 s6, s0, 1
; GFX67-NEXT:    v_mul_lo_u32 v1, s6, v0
...
; GFX67-NEXT:    v_add_i32_e32 v2, vcc, s6, v1
...
; GFX67-NEXT:    v_mul_lo_u32 v1, v2, v1
; GFX67-NEXT:    v_mul_lo_u32 v2, v1, v3
; GFX67-NEXT:    v_mov_b32_e32 v3, s1
; GFX67-NEXT:    v_add_i32_e32 v2, vcc, v2, v1
; GFX67-NEXT:    v_mul_lo_u32 v1, v2, v1
; GFX67-NEXT:    v_add_i32_e32 v2, vcc, v1, v2
...
; GFX13-NEXT:    s_load_b96 s[8:10], s[4:5], 0x10 nv
; GFX13-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_add_co_i32 s6, s10, 1
; GFX13-NEXT:    s_load_b32 s2, s[2:3], 0x4 nv
; GFX13-NEXT:    v_mul_lo_u32 v1, s6, v0
...
; GFX13-NEXT:    v_mad_co_u64_u32 v[0:1], null, s3, s2, v[0:1]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_mul_lo_u32 v1, v3, v2
; GFX13-NEXT:    v_add_co_u32 v2, s0, s0, v0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v3, null, s1, 0, s0
...
; GFX13-NEXT:    v_add_co_u32 v1, vcc_lo, s8, v2
; GFX13-NEXT:    v_add_co_ci_u32_e64 v2, null, s9, v3, vcc_lo
...
; GFX1250-REAL16-NEXT:    v_mad_u16 v1.l, v1.l, v1.h, v1.l
; GFX1250-REAL16-NEXT:    v_mad_u16 v0.l, v0.l, v0.h, v0.l
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1250-REAL16-NEXT:    v_lshlrev_b16 v0.h, 8, v1.l
; GFX1250-REAL16-NEXT:    v_and_b16 v1.l, 0xff, v1.l
; GFX1250-REAL16-NEXT:    v_bitop3_b16 v0.l, v0.l, v0.h, 0xff bitop3:0xec
; GFX1250-REAL16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX13-REAL16-NEXT:    s_wait_bvhcnt 0x0
; GFX13-REAL16-NEXT:    s_wait_kmcnt 0x0
; GFX13-REAL16-NEXT:    v_mov_b16_e32 v1.h, v3.l
; GFX13-REAL16-NEXT:    v_mov_b16_e32 v0.h, v2.l
; GFX13-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-REAL16-NEXT:    v_mad_u16 v1.l, v1.l, v1.h, v1.l
; GFX13-REAL16-NEXT:    v_mad_u16 v0.l, v0.l, v0.h, v0.l
; GFX13-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX13-REAL16-NEXT:    v_lshlrev_b16 v0.h, 8, v1.l
; GFX13-REAL16-NEXT:    v_and_b16 v1.l, 0xff, v1.l
; GFX13-REAL16-NEXT:    v_bitop3_b16 v0.l, v0.l, v0.h, 0xff bitop3:0xec
; GFX13-REAL16-NEXT:    s_set_pc_i64 s[30:31]
