...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mad_u16 v0.l, v0.l, v1.l, v0.l
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %add = add i16 %y, 1
  %mul = mul i16 %x, %add
  ret i16 %mul
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_add_nc_u16 v1.l, v1.l, -1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_mul_lo_u16 v0.l, v0.l, v1.l
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %sub = sub i16 %y, 1
  %mul = mul i16 %x, %sub
  ret i16 %mul
...
; GFX1250-NEXT:    v_add_nc_u16 v1.l, v1.l, -1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_mul_lo_u16 v0.l, v1.l, v0.l
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %sub = sub i16 %y, 1
  %mul = mul i16 %sub, %x
  ret i16 %mul
...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_sub_nc_u16 v0.l, v0.h, v0.l
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %mul = mul i16 %x, %y
  %sub = sub i16 %mul, %x
  ret i16 %sub
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_add_nc_u16 v1.l, v1.l, 2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_mul_lo_u16 v0.l, v0.l, v1.l
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %add = add i16 %y, 2
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mad_u16 v0.l, v0.l, 9, 52
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %mul = mul i16 %arg, 9
  %add = add i16 %mul, 52
  ret i16 %add
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mad_u16 v0.l, v0.l, 5, 1
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %mul = mul i16 %arg, 5
  %add = add i16 %mul, 1
  ret i16 %add
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mov_b16_e32 v1.l, 0x11c
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_mad_u16 v0.l, v0.l, v1.l, 0x52
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %mul = mul i16 %arg, 284
  %add = add i16 %mul, 82
  ret i16 %add
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mad_u16 v0.h, v1.l, v3.l, v1.l
; GFX1250-NEXT:    v_mad_u16 v0.l, v0.l, v2.l, v0.l
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b16 v1.l, 8, v0.h
; GFX1250-NEXT:    v_bitop3_b16 v0.l, v0.l, v1.l, 0xff bitop3:0xec
; GFX1250-NEXT:    v_and_b16 v1.l, 0xff, v0.h
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
