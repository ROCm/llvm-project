...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GCN,GFX678,GFX6 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=hawaii < %s | FileCheck -check-prefixes=GCN,GFX678,GFX7 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -check-prefixes=GCN,GFX678,GFX8 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GFX9 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GCN,GFX1011,GFX10 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GCN,GFX1011,GFX11 %s
...
; GFX10-NEXT:    s_add_i32 s36, s4, -4
; GFX10-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-NEXT:    s_min_u32 s36, s4, s36
...
; GFX11-NEXT:    s_add_i32 s2, s4, -4
; GFX11-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-NEXT:    s_min_u32 s2, s4, s2
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_getreg_b32 s5, hwreg(HW_REG_MODE, 0, 4)
; GFX10-NEXT:    s_mov_b32 s4, 0xeb24da71
; GFX10-NEXT:    s_lshl_b32 s6, s5, 2
...
; GFX10-NEXT:    s_cselect_b32 s6, s4, s5
; GFX10-NEXT:    s_mov_b32 s5, 0xb73e62d9
; GFX10-NEXT:    s_add_i32 s7, s6, -4
; GFX10-NEXT:    s_mov_b32 s4, 0x1c84a50f
; GFX10-NEXT:    s_min_u32 s6, s6, s7
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_getreg_b32 s1, hwreg(HW_REG_MODE, 0, 4)
; GFX11-NEXT:    s_mov_b32 s0, 0xeb24da71
; GFX11-NEXT:    s_lshl_b32 s2, s1, 2
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_sext_i32_i16 s36, s4
; GFX10-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-NEXT:    s_add_i32 s37, s36, -4
; GFX10-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-NEXT:    s_min_u32 s36, s36, s37
; GFX10-NEXT:    s_lshl_b32 s36, s36, 2
; GFX10-NEXT:    s_lshr_b64 s[34:35], s[34:35], s36
; GFX10-NEXT:    s_setreg_b32 hwreg(HW_REG_MODE, 0, 4), s34
; GFX10-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s36, 0xffff, s4
; GFX10-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-NEXT:    s_add_i32 s37, s36, -4
; GFX10-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-NEXT:    s_min_u32 s36, s36, s37
...
; GFX10-NEXT:    s_cmp_eq_u32 s4, 0
; GFX10-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-NEXT:    s_cselect_b32 s36, 4, 0
; GFX10-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-NEXT:    s_add_i32 s37, s36, -4
; GFX10-NEXT:    s_min_u32 s36, s36, s37
; GFX10-NEXT:    s_lshl_b32 s36, s36, 2
...
; GFX11-NEXT:    s_cmp_eq_u32 s4, 0
; GFX11-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-NEXT:    s_cselect_b32 s2, 4, 0
; GFX11-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-NEXT:    s_add_i32 s3, s2, -4
; GFX11-NEXT:    s_min_u32 s2, s2, s3
; GFX11-NEXT:    s_lshl_b32 s2, s2, 2
...
; GFX10-NEXT:    s_cmp_eq_u32 s4, 0
; GFX10-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-NEXT:    s_cselect_b32 s36, 3, 5
; GFX10-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-NEXT:    s_add_i32 s37, s36, -4
; GFX10-NEXT:    s_min_u32 s36, s36, s37
; GFX10-NEXT:    s_lshl_b32 s36, s36, 2
...
; GFX11-NEXT:    s_cmp_eq_u32 s4, 0
; GFX11-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-NEXT:    s_cselect_b32 s2, 3, 5
; GFX11-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-NEXT:    s_add_i32 s3, s2, -4
; GFX11-NEXT:    s_min_u32 s2, s2, s3
; GFX11-NEXT:    s_lshl_b32 s2, s2, 2
