...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX678,GFX6,GFX678-SDAG,GFX6-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GFX678,GFX6,GFX678-GISEL,GFX6-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=hawaii < %s | FileCheck -check-prefixes=GFX678,GFX7,GFX678-SDAG,GFX7-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgcn -mcpu=hawaii < %s | FileCheck -check-prefixes=GFX678,GFX7,GFX678-GISEL,GFX7-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -check-prefixes=GFX678,GFX678-SDAG,GFX8-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -check-prefixes=GFX678,GFX678-GISEL,GFX8-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX1011,GFX10,GFX10-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX1011,GFX10,GFX10-GISEL %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1011,GFX11,GFX11-SDAG %s
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1011,GFX11,GFX11-GISEL %s
...
; GFX678-GISEL-NEXT:    s_add_i32 s34, s4, -4
...
; GFX9-GISEL-NEXT:    s_add_i32 s34, s4, -4
...
; GFX10-SDAG-NEXT:    s_add_i32 s36, s4, -4
; GFX10-SDAG-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-SDAG-NEXT:    s_min_u32 s36, s4, s36
...
; GFX11-SDAG-NEXT:    s_add_i32 s2, s4, -4
; GFX11-SDAG-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-SDAG-NEXT:    s_min_u32 s2, s4, s2
...
; GFX6-GISEL-NEXT:    s_add_i32 s3, s2, -4
...
; GFX7-GISEL-NEXT:    s_add_i32 s3, s2, -4
...
; GFX9-GISEL-NEXT:    s_add_i32 s3, s2, -4
...
; GFX10-SDAG-NEXT:    s_cselect_b32 s6, s4, s5
; GFX10-SDAG-NEXT:    s_mov_b32 s5, 0xb73e62d9
; GFX10-SDAG-NEXT:    s_add_i32 s7, s6, -4
; GFX10-SDAG-NEXT:    s_mov_b32 s4, 0x1c84a50f
; GFX10-SDAG-NEXT:    s_min_u32 s6, s6, s7
...
; GFX11-SDAG-NEXT:    s_cselect_b32 s2, s0, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-SDAG-NEXT:    s_add_i32 s3, s2, -4
; GFX11-SDAG-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-SDAG-NEXT:    s_min_u32 s2, s2, s3
...
; GFX6-GISEL-NEXT:    s_add_i32 s34, s4, -4
...
; GFX7-GISEL-NEXT:    s_add_i32 s34, s4, -4
...
; GFX10-SDAG:       ; %bb.0:
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    s_sext_i32_i16 s36, s4
; GFX10-SDAG-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-SDAG-NEXT:    s_add_i32 s37, s36, -4
; GFX10-SDAG-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-SDAG-NEXT:    s_min_u32 s36, s36, s37
; GFX10-SDAG-NEXT:    s_lshl_b32 s36, s36, 2
; GFX10-SDAG-NEXT:    s_lshr_b64 s[34:35], s[34:35], s36
; GFX10-SDAG-NEXT:    s_setreg_b32 hwreg(HW_REG_MODE, 0, 4), s34
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_sext_i32_i16 s2, s4
; GFX11-SDAG-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-SDAG-NEXT:    s_add_i32 s3, s2, -4
; GFX11-SDAG-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-SDAG-NEXT:    s_min_u32 s2, s2, s3
...
; GFX10-SDAG:       ; %bb.0:
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    s_and_b32 s36, 0xffff, s4
; GFX10-SDAG-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-SDAG-NEXT:    s_add_i32 s37, s36, -4
; GFX10-SDAG-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-SDAG-NEXT:    s_min_u32 s36, s36, s37
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_and_b32 s2, 0xffff, s4
; GFX11-SDAG-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-SDAG-NEXT:    s_add_i32 s3, s2, -4
; GFX11-SDAG-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-SDAG-NEXT:    s_min_u32 s2, s2, s3
...
; GFX10-SDAG-NEXT:    s_cmp_eq_u32 s4, 0
; GFX10-SDAG-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-SDAG-NEXT:    s_cselect_b32 s36, 4, 0
; GFX10-SDAG-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-SDAG-NEXT:    s_add_i32 s37, s36, -4
; GFX10-SDAG-NEXT:    s_min_u32 s36, s36, s37
; GFX10-SDAG-NEXT:    s_lshl_b32 s36, s36, 2
...
; GFX11-SDAG-NEXT:    s_cmp_eq_u32 s4, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-SDAG-NEXT:    s_cselect_b32 s2, 4, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-SDAG-NEXT:    s_add_i32 s3, s2, -4
; GFX11-SDAG-NEXT:    s_min_u32 s2, s2, s3
; GFX11-SDAG-NEXT:    s_lshl_b32 s2, s2, 2
...
; GFX10-SDAG-NEXT:    s_cmp_eq_u32 s4, 0
; GFX10-SDAG-NEXT:    s_mov_b32 s35, 0xb73e62d9
; GFX10-SDAG-NEXT:    s_cselect_b32 s36, 3, 5
; GFX10-SDAG-NEXT:    s_mov_b32 s34, 0x1c84a50f
; GFX10-SDAG-NEXT:    s_add_i32 s37, s36, -4
; GFX10-SDAG-NEXT:    s_min_u32 s36, s36, s37
; GFX10-SDAG-NEXT:    s_lshl_b32 s36, s36, 2
...
; GFX11-SDAG-NEXT:    s_cmp_eq_u32 s4, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s1, 0xb73e62d9
; GFX11-SDAG-NEXT:    s_cselect_b32 s2, 3, 5
; GFX11-SDAG-NEXT:    s_mov_b32 s0, 0x1c84a50f
; GFX11-SDAG-NEXT:    s_add_i32 s3, s2, -4
; GFX11-SDAG-NEXT:    s_min_u32 s2, s2, s3
; GFX11-SDAG-NEXT:    s_lshl_b32 s2, s2, 2
