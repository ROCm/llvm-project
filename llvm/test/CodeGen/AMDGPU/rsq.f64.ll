...
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI,SI-IR,SI-SDAG,SI-SDAG-IR %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI,SI-IR,SI-GISEL,SI-GISEL-IR %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=VI,VI-IR,VI-SDAG,VI-SDAG-IR %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=VI,VI-IR,VI-GISEL,VI-GISEL-IR %s

; Test codegen implementation.
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-codegenprepare-disable-fdiv-expansion -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI,SI-CG,SI-SDAG,SI-SDAG-CG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-codegenprepare-disable-fdiv-expansion -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI,SI-CG,SI-GISEL,SI-GISEL-CG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=0 -amdgpu-codegenprepare-disable-fdiv-expansion -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=VI,VI-CG,VI-SDAG,VI-SDAG-CG %s
; RUN: llc -amdgpu-late-wave-transform=1 -global-isel=1 -amdgpu-codegenprepare-disable-fdiv-expansion -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=VI,VI-CG,VI-GISEL,VI-GISEL-CG %s
