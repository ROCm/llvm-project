...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI,SI-IR,SI-GISEL,SI-GISEL-IR %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=VI,VI-IR,VI-GISEL,VI-GISEL-IR %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -amdgpu-codegenprepare-disable-fdiv-expansion -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=SI,SI-CG,SI-GISEL,SI-GISEL-CG %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -amdgpu-codegenprepare-disable-fdiv-expansion -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=VI,VI-CG,VI-GISEL,VI-GISEL-CG %s
