...
; GFX1250-TRUE16-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24 nv
; GFX1250-TRUE16-NEXT:    v_ashr_pk_u8_i32 v0.l, s0, s1, v0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    global_store_b16 v1, v0, s[2:3]
; GFX1250-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-FAKE16-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24 nv
; GFX1250-FAKE16-NEXT:    v_ashr_pk_u8_i32 v0, s0, s1, v0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    global_store_b16 v1, v0, s[2:3]
; GFX1250-FAKE16-NEXT:    s_endpgm
;
...
; GFX13-TRUE16-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24 nv
; GFX13-TRUE16-NEXT:    v_ashr_pk_u8_i32 v0.l, s0, s1, v0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    global_store_b16 v1, v0, s[2:3]
; GFX13-TRUE16-NEXT:    s_endpgm
;
...
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v0, s2
; GFX13-FAKE16-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24 nv
; GFX13-FAKE16-NEXT:    v_ashr_pk_u8_i32 v0, s0, s1, v0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    global_store_b16 v1, v0, s[2:3]
; GFX13-FAKE16-NEXT:    s_endpgm
  %insert.0 = insertelement <2 x i32> poison, i32 %src0, i64 0
  %build_vector = insertelement <2 x i32> %insert.0, i32 %src1, i64 1
  %src2.clamp = and i32 %src2, 31
