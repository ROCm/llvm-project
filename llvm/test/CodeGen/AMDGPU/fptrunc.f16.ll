...
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -global-isel=1 < %s | FileCheck -check-prefixes=SI-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03 -global-isel=1 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=VI-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00 -global-isel=1 -mattr=-flat-for-global -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.50 -global-isel=1 -mattr=-flat-for-global -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX950-GISEL %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -global-isel=1 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -global-isel=1 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.50 -global-isel=1 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-GISEL-TRUE16 %s
; RUN: llc -amdgpu-late-wave-transform=0 -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.50 -global-isel=1 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-GISEL-FAKE16 %s
