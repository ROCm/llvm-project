...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.08 < %s | FileCheck -check-prefix=GFX908 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.0a < %s | FileCheck -check-prefix=GFX90A %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu9.42 < %s | FileCheck -check-prefix=GFX942 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu11.00 < %s | FileCheck -check-prefix=GFX1100 %s
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefix=GFX1200 %s
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
