...
; CHECK-NEXT:    vmov.8 q5[3], r7
; CHECK-NEXT:    ldrb r1, [r1]
; CHECK-NEXT:    ldrb r5, [r3]
; CHECK-NEXT:    vmov.8 q6[0], r1
; CHECK-NEXT:    ldrb.w r3, [r10]
; CHECK-NEXT:    vmov.8 q6[1], r5
; CHECK-NEXT:    vmov r1, r7, d0
; CHECK-NEXT:    vmov.8 q6[2], r3
; CHECK-NEXT:    vmov r3, r10, d1
; CHECK-NEXT:    vmov.8 q6[3], r4
; CHECK-NEXT:    vldrw.u32 q0, [sp, #96] @ 16-byte Reload
; CHECK-NEXT:    vmov.8 q6[4], r6
; CHECK-NEXT:    ldrb.w r6, [r11]
; CHECK-NEXT:    vadd.i32 q0, q0, r0
; CHECK-NEXT:    vmov.8 q6[5], r6
; CHECK-NEXT:    ldrb r1, [r1]
; CHECK-NEXT:    ldrb r4, [r3]
; CHECK-NEXT:    vmov r3, r5, d15
; CHECK-NEXT:    ldrb r7, [r7]
