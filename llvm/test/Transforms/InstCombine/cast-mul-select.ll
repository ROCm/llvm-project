...
; DIOP-DBGINFO-NEXT:      #dbg_value(i32 [[X:%.*]], [[META64:![0-9]+]], !DIExpression(DIOpArg(0, i32), DIOpConvert(i16)), [[META69:![0-9]+]])
; DIOP-DBGINFO-NEXT:    [[A:%.*]] = and i32 [[X]], 5, !dbg [[DBG70:![0-9]+]]
; DIOP-DBGINFO-NEXT:      #dbg_value(i32 [[X]], [[META66:![0-9]+]], !DIExpression(DIOpArg(0, i32), DIOpConvert(i16), DIOpConstant(i16 5), DIOpAnd()), [[DBG70]])
