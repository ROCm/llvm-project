...
; CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <2 x double> [[TMP1]], <2 x double> [[TMP8]], <2 x i32> <i32 1, i32 3>
...
; CHECK:       bb:
; CHECK-NEXT:    [[TMP10:%.*]] = shufflevector <2 x double> [[TMP8]], <2 x double> [[TMP1]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP9:%.*]] = fmul <4 x double> [[TMP10]], zeroinitializer
