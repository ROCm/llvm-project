...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr getelementptr inbounds ([13 x double], ptr null, i64 0, i64 5), align 8
; CHECK-NEXT:    [[TMP2:%.*]] = load double, ptr getelementptr inbounds ([13 x double], ptr null, i64 0, i64 9), align 8
; CHECK-NEXT:    [[TMP8:%.*]] = load <2 x double>, ptr getelementptr inbounds ([13 x double], ptr null, i64 0, i64 8), align 16
...
; CHECK:       bb:
; CHECK-NEXT:    [[TMP12:%.*]] = fmul <2 x double> [[TMP8]], zeroinitializer
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <2 x double> [[TMP12]], i32 0
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <2 x double> [[TMP12]], i32 1
; CHECK-NEXT:    [[TMP11:%.*]] = fadd double [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[TMP18:%.*]] = fmul <2 x double> [[TMP1]], zeroinitializer
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <2 x double> [[TMP18]], i32 1
; CHECK-NEXT:    [[TMP14:%.*]] = fadd double [[TMP13]], [[TMP11]]
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <2 x double> [[TMP18]], i32 0
