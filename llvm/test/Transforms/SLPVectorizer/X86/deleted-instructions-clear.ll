...
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <2 x i32> <i32 0, i32 poison>, i32 [[ARG]], i32 1
...
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <2 x i32> [[TMP27]], i32 [[TRUNC28]], i32 1
...
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <8 x i32> [[TMP24]], i32 [[XOR31]], i32 5
...
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <8 x i32> [[TMP31]], <8 x i32> [[TMP30]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
