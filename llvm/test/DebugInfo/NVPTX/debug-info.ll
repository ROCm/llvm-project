...
; CHECK-NEXT: 	{
; CHECK-NEXT: .b32 2409                               // Length of Unit
; CHECK-NEXT: .b8 2                                   // DWARF version number
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b32 .debug_abbrev                      // Offset Into Abbrev. Section
; CHECK-NEXT: .b8 8                                   // Address Size (in bytes)
; CHECK-NEXT: .b8 1                                   // Abbrev [1] 0xb:0x962 DW_TAG_compile_unit
...
; CHECK-NEXT: .b32 2100                               // DW_AT_type
; CHECK-NEXT: .b8 23                                  // Abbrev [23] 0x842:0xea DW_TAG_subprogram
...
; CHECK-NEXT: .b8 1                                   // DW_AT_decl_file
; CHECK-NEXT: .b8 5                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 2405                               // DW_AT_type
...
; CHECK-NEXT: .b8 5                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 2100                               // DW_AT_type
; CHECK-NEXT: .b8 25                                  // Abbrev [25] 0x88a:0xd DW_TAG_formal_parameter
...
; CHECK-NEXT: .b8 5                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 2109                               // DW_AT_type
; CHECK-NEXT: .b8 25                                  // Abbrev [25] 0x897:0xd DW_TAG_formal_parameter
...
; CHECK-NEXT: .b8 5                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 2109                               // DW_AT_type
; CHECK-NEXT: .b8 26                                  // Abbrev [26] 0x8a4:0xd DW_TAG_variable
...
; CHECK-NEXT: .b32 2405                               // DW_AT_type
; CHECK-NEXT: .b8 27                                  // Abbrev [27] 0x8b1:0x18 DW_TAG_inlined_subroutine
...
; CHECK-NEXT: .b8 27                                  // Abbrev [27] 0x8c9:0x18 DW_TAG_inlined_subroutine
...
; CHECK-NEXT: .b8 27                                  // Abbrev [27] 0x8e1:0x18 DW_TAG_inlined_subroutine
...
; CHECK-NEXT: .b8 28                                  // Abbrev [28] 0x8f9:0x32 DW_TAG_inlined_subroutine
...
; CHECK-NEXT: .b8 29                                  // Abbrev [29] 0x911:0xc DW_TAG_formal_parameter
; CHECK-NEXT: .b8 2                                   // DW_AT_address_class
; CHECK-NEXT: .b8 5                                   // DW_AT_location
; CHECK-NEXT: .b8 144
; CHECK-NEXT: .b8 184
...
; CHECK-NEXT: .b8 29                                  // Abbrev [29] 0x91d:0xd DW_TAG_formal_parameter
; CHECK-NEXT: .b8 2                                   // DW_AT_address_class
...
; CHECK-NEXT: .b8 0                                   // End Of Children Mark
; CHECK-NEXT: .b8 0                                   // End Of Children Mark
; CHECK-NEXT: .b8 30                                  // Abbrev [30] 0x92c:0xd DW_TAG_namespace
; CHECK-NEXT: .b8 115                                 // DW_AT_name
; CHECK-NEXT: .b8 116
; CHECK-NEXT: .b8 100
; CHECK-NEXT: .b8 0
...
; CHECK-NEXT: .b32 2361                               // DW_AT_import
; CHECK-NEXT: .b8 0                                   // End Of Children Mark
; CHECK-NEXT: .b8 32                                  // Abbrev [32] 0x939:0x1b DW_TAG_subprogram
; CHECK-NEXT: .b8 95                                  // DW_AT_MIPS_linkage_name
; CHECK-NEXT: .b8 90
; CHECK-NEXT: .b8 76
; CHECK-NEXT: .b8 51
...
; CHECK-NEXT: .b32 2388                               // DW_AT_type
; CHECK-NEXT: .b8 1                                   // DW_AT_declaration
; CHECK-NEXT: .b8 7                                   // Abbrev [7] 0x94e:0x5 DW_TAG_formal_parameter
; CHECK-NEXT: .b32 2388                               // DW_AT_type
; CHECK-NEXT: .b8 0                                   // End Of Children Mark
; CHECK-NEXT: .b8 10                                  // Abbrev [10] 0x954:0x11 DW_TAG_base_type
...
; CHECK-NEXT: .b8 10                                  // Abbrev [10] 0x965:0x7 DW_TAG_base_type
; CHECK-NEXT: .b8 105                                 // DW_AT_name
; CHECK-NEXT: .b8 110
; CHECK-NEXT: .b8 116
; CHECK-NEXT: .b8 0
