...
if(LLVM_ENABLE_LIBXML2)
  ...
  if(LibXml2_FOUND)
    ...
    if(LLVM_USE_STATIC_LIBXML2)
      ...
      get_target_property(_libxml2_static_location LibXml2::LibXml2Static LOCATION)
      message(STATUS "Found LibXml2: ${_libxml2_static_location}")
      cmake_push_check_state()
      ...
      get_target_property(_libxml2_location LibXml2::LibXml2 LOCATION)
      message(STATUS "Found LibXml2: ${_libxml2_location}")
    endif()
  endif()
