...
void TargetOp::build(OpBuilder &builder, OperationState &state,
  ...
  TargetOp::build(builder, state, /*allocate_vars=*/{}, /*allocator_vars=*/{},
                  ...
                  /*private_maps=*/nullptr, clauses.kernelType);
}
...
LogicalResult TeamsOp::verify() {
  ...
  auto parentTarget = dyn_cast_if_present<TargetOp>((*this)->getParentOp());
  if (!parentTarget && !opInGlobalImplicitParallelRegion(*this))
