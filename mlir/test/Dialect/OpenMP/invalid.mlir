...
func.func @omp_target_host_eval2(%x : i1) {
  // expected-error @below {{op host_eval argument illegal use in 'omp.teams' operation}}
...
func.func @omp_target_host_eval3(%x : i32) {
  // expected-error @below {{op host_eval argument illegal use in 'omp.parallel' operation}}
...
func.func @omp_target_host_eval3(%x : i32) {
  // expected-error @below {{op host_eval argument illegal use in 'omp.loop_nest' operation}}
  omp.target host_eval(%x -> %arg0 : i32) {
    omp.wsloop {
