...
// CHECK: %[[FIRST_MEMBER:.*]] = getelementptr { float, [10 x i32], { float, i32 }, i32 }, ptr %[[ALLOCA]], i32 1
// CHECK: %[[FIRST_MEMBER_OFF:.*]] = ptrtoaddr ptr %[[FIRST_MEMBER]] to i64
// CHECK: %[[SECOND_MEMBER_OFF:.*]] = ptrtoaddr ptr %[[ALLOCA]] to i64
...
// CHECK: store ptr %[[ALLOCA]], ptr %[[PTR_ARR]], align 8
